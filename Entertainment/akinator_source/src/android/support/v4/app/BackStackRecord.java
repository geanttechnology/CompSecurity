...
_L10:
    ...
    private boolean configureTransitions(int i, TransitionState transitionstate, boolean flag, SparseArray sparsearray, SparseArray sparsearray1)
    {
        ...
        Object obj2 = (Fragment)sparsearray1.get(i);
        Object obj4 = (Fragment)sparsearray.get(i);
        Object obj3 = getEnterTransition(((Fragment) (obj2)), flag);
        Object obj = getSharedElementTransition(((Fragment) (obj2)), ((Fragment) (obj4)), flag);
        Object obj5 = getExitTransition(((Fragment) (obj4)), flag);
        sparsearray = null;
        ArrayList arraylist = new ArrayList();
        sparsearray1 = ((SparseArray) (obj));
        if (obj != null)
        {
            ArrayMap arraymap = remapSharedElements(transitionstate, ((Fragment) (obj4)), flag);
            if (arraymap.isEmpty())
            {
                sparsearray1 = null;
                sparsearray = null;
            } else
            {
                if (flag)
                {
                    sparsearray = ((Fragment) (obj4)).mEnterTransitionCallback;
                } else
                {
                    sparsearray = ((Fragment) (obj2)).mEnterTransitionCallback;
                }
                if (sparsearray != null)
                {
                    sparsearray.onSharedElementStart(new ArrayList(arraymap.keySet()), new ArrayList(arraymap.values()), null);
                }
                prepareSharedElementTransition(transitionstate, viewgroup, obj, ((Fragment) (obj2)), ((Fragment) (obj4)), flag, arraylist);
                sparsearray1 = ((SparseArray) (obj));
                sparsearray = arraymap;
            }
        }
        if (obj3 == null && sparsearray1 == null && obj5 == null)
        {
            return false;
        }
        obj = new ArrayList();
        Object obj1 = captureExitingViews(obj5, ((Fragment) (obj4)), ((ArrayList) (obj)), sparsearray, transitionstate.nonExistentView);
        if (mSharedElementTargetNames != null && sparsearray != null)
        {
            obj4 = (View)sparsearray.get(mSharedElementTargetNames.get(0));
            if (obj4 != null)
            {
                if (obj1 != null)
                {
                    FragmentTransitionCompat21.setEpicenter(obj1, ((View) (obj4)));
                }
                if (sparsearray1 != null)
                {
                    FragmentTransitionCompat21.setEpicenter(sparsearray1, ((View) (obj4)));
                }
            }
        }
        obj4 = new _cls1(((Fragment) (obj2)));
        obj5 = new ArrayList();
        ...
        if (obj2 != null)
        {
            if (flag)
            {
                flag1 = ((Fragment) (obj2)).getAllowReturnTransitionOverlap();
            } else
            {
                flag1 = ((Fragment) (obj2)).getAllowEnterTransitionOverlap();
            }
        }
        obj2 = FragmentTransitionCompat21.mergeTransitions(obj3, obj1, sparsearray1, flag1);
        if (obj2 != null)
        {
            FragmentTransitionCompat21.addTransitionTargets(obj3, sparsearray1, viewgroup, ((FragmentTransitionCompat21.ViewRetriever) (obj4)), transitionstate.nonExistentView, transitionstate.enteringEpicenterView, transitionstate.nameOverrides, ((ArrayList) (obj5)), sparsearray, arraymap1, arraylist);
            excludeHiddenFragmentsAfterEnter(viewgroup, transitionstate, i, obj2);
            FragmentTransitionCompat21.excludeTarget(obj2, transitionstate.nonExistentView, true);
            excludeHiddenFragments(transitionstate, i, obj2);
            FragmentTransitionCompat21.beginDelayedTransition(viewgroup, obj2);
            FragmentTransitionCompat21.cleanupTransitions(viewgroup, transitionstate.nonExistentView, obj3, ((ArrayList) (obj5)), obj1, ((ArrayList) (obj)), sparsearray1, arraylist, obj2, transitionstate.hiddenFragmentViews, arraymap1);
        }
        return obj2 != null;
    }
    ...
    {
        view.getViewTreeObserver().addOnPreDrawListener(new _cls3(view, transitionstate, i, obj));
    }
...
label0:
    ...
    private void prepareSharedElementTransition(TransitionState transitionstate, View view, Object obj, Fragment fragment, Fragment fragment1, boolean flag, ArrayList arraylist)
    {
        view.getViewTreeObserver().addOnPreDrawListener(new _cls2(view, obj, arraylist, transitionstate, flag, fragment, fragment1));
    }
