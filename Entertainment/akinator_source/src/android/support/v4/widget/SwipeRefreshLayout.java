...
_L6:
    ...
    private void finishSpinner(float f)
    {
        ...
        animateOffsetToStartPosition(mCurrentTargetOffsetTop, _lcls5);
...
label0:
    ...
    private Animation startAlphaAnimation(int i, int j)
    {
...
_L7:
    ...
    {
        if (isEnabled() && !mReturningToStart && !canChildScrollUp() && !mRefreshing && (i & 2) != 0)
        {
...
*/
    ...
    // Unreferenced inner class android/support/v4/widget/SwipeRefreshLayout$OnRefreshListener
