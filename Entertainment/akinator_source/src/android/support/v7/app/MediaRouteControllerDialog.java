...
_L3:
            ...
            if (view != null)
            {
                ...
                {
                    Log.e("MediaRouteControllerDialog", "Error opening route settings.", view);
                }
                return;
            }
...
_L5:
    ...
    private void setMediaSession(android.support.v4.media.session.MediaSessionCompat.Token token)
    {
        ...
        {
            Log.e("MediaRouteControllerDialog", "Error creating media controller in setMediaSession.", token);
        }
        if (mMediaController != null)
        {
