...
public static final class setName
{
    ...
    public mControlFilters setCanDisconnect(boolean flag)
    {
        mBundle.putBoolean("canDisconnect", flag);
        return this;
    }

    public mBundle setConnecting(boolean flag)
    {
    ...
    public mBundle setSettingsActivity(IntentSender intentsender)
    {
