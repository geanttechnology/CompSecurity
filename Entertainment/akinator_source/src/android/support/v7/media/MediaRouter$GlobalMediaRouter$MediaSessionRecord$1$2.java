    ...
    implements Runnable
{
    ...
    final val.direction this$2;
    final int val$direction;

    public void run()
    {
        if (val.direction(_fld0) != null)
        {
            ._mth0(_fld0)._mth0(val$direction);
        }
    }
...
/* anonymous class */
    class MediaRouter.GlobalMediaRouter.MediaSessionRecord._cls1 extends VolumeProviderCompat
    {
        ...
        {
            MediaRouter.GlobalMediaRouter.access$1300(this$0).post(i. new MediaRouter.GlobalMediaRouter.MediaSessionRecord._cls1._cls2());
        }

        public void onSetVolumeTo(final int volume)
        {
            MediaRouter.GlobalMediaRouter.access$1300(this$0).post(new MediaRouter.GlobalMediaRouter.MediaSessionRecord._cls1._cls1());
        }
