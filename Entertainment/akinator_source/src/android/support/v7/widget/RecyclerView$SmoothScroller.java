...
public static abstract class mTargetPosition
{
        ...
        private void runIfNecessary(RecyclerView recyclerview)
        {
            if (changed)
            {
                ...
                if (mInterpolator == null)
                {
                    ...
                    {
                        RecyclerView.access$5000(recyclerview).smoothScrollBy(mDx, mDy);
                    } else
                    {
                        RecyclerView.access$5000(recyclerview).smoothScrollBy(mDx, mDy, mDuration);
                    }
                } else
                {
                    RecyclerView.access$5000(recyclerview).smoothScrollBy(mDx, mDy, mDuration, mInterpolator);
                }
    ...
    void start(RecyclerView recyclerview, mTargetPosition mtargetposition)
    {
        ...
        } else
        {
            ...
            onStart();
            RecyclerView.access$5000(mRecyclerView).tOnAnimation();
            return;
        }
    }
    ...
    protected final void stop()
    {
        ...
        } else
        {
            ...
            mPendingInitialRun = false;
            mRunning = false;
            ccess._mth5100(mLayoutManager, this);
            mLayoutManager = null;
            mRecyclerView = null;
            return;
        }
