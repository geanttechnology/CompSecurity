...
//            BoltsExecutors, AndroidExecutors, CancellationToken, Continuation, 
...
label0:
    ...
    {
        return delay(l, BoltsExecutors.scheduled(), null);
    }
    ...
    static Task delay(long l, ScheduledExecutorService scheduledexecutorservice, CancellationToken cancellationtoken)
    {
        ...
        TaskCompletionSource taskcompletionsource = create();
        scheduledexecutorservice = scheduledexecutorservice.schedule(new Runnable(taskcompletionsource) {
        ...
        {
            cancellationtoken.register(new Runnable(scheduledexecutorservice, taskcompletionsource) {
