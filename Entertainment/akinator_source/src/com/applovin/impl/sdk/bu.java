...
class bu
{
    ...
    bu(AppLovinSdkImpl applovinsdkimpl)
    {
        a = applovinsdkimpl;
    ...
    private static bt a(String s)
    {
        for (Iterator iterator = br.a().iterator(); iterator.hasNext();)
        {
            bt bt1 = (bt)iterator.next();
            if (bt1.b().equals(s))
            {
                return bt1;
            }
    ...
    private String e()
    {
        return (new StringBuilder()).append("com.applovin.sdk.").append(da.a(a.getSdkKey())).append(".").toString();
    }
...
_L1:
    ...
    public void a(bt bt1, Object obj)
    {
        if (bt1 == null)
        {
            throw new IllegalArgumentException("No setting type specified");
        ...
        b.d("SettingsManager", (new StringBuilder()).append("Setting update: ").append(bt1.b()).append(" set to \"").append(obj).append("\"").toString());
        return;
        bt1;
        aobj;
        JVM INSTR monitorexit ;
    ...
    void a(AppLovinSdkSettings applovinsdksettings)
    {
        ...
        JVM INSTR monitorenter ;
        long l1;
        d[br.j.a()] = Boolean.valueOf(applovinsdksettings.isVerboseLoggingEnabled());
...
_L1:
        ...
        l = Math.max(30L, l1);
        d[br.A.a()] = Long.valueOf(l);
        d[br.z.a()] = Boolean.valueOf(true);
_L7:
...
_L6:
        d[br.z.a()] = Boolean.valueOf(false);
          goto _L7
        applovinsdksettings;
        aobj;
        JVM INSTR monitorexit ;
...
_L4:
        ...
        d[br.J.a()] = "";
        d[br.K.a()] = Boolean.valueOf(flag2);
        if (applovinsdksettings instanceof av)
        {
            for (applovinsdksettings = ((av)applovinsdksettings).b().entrySet().iterator(); applovinsdksettings.hasNext();)
            {
                entry = (java.util.Map.Entry)applovinsdksettings.next();
                d[((bt)entry.getKey()).a()] = entry.getValue();
            }
...
_L1:
        bt bt1 = a(((String) (obj1)));
        if (bt1 == null)
        {
            break MISSING_BLOCK_LABEL_178;
        }
        obj1 = a(((String) (obj1)), jsonobject, bt1.c());
        d[bt1.a()] = obj1;
        b.d("SettingsManager", (new StringBuilder()).append("Setting update: ").append(bt1.b()).append(" set to \"").append(obj1).append("\"").toString());
          goto _L2
        Object obj;
        obj;
    ...
    void b()
    {
        ...
        aobj;
        JVM INSTR monitorenter ;
        Iterator iterator = br.a().iterator();
_L1:
        Object obj;
        Object obj1;
        do
        {
            ...
            obj1 = (bt)iterator.next();
            obj = d[((bt) (obj1)).a()];
        } while (obj == null);
        obj1 = (new StringBuilder()).append(s).append(((bt) (obj1)).b()).toString();
        if (!(obj instanceof Boolean))
        {
...
_L1:
        ...
        Object obj;
        Object obj1;
        obj = (new StringBuilder()).append(s).append(bt1.b()).toString();
        obj1 = bt1.c();
...
_L6:
        b.e("SettingsManager", (new StringBuilder()).append("Unable to load \"").append(bt1.b()).append("\"").toString(), ((Throwable) (obj)));
        continue; /* Loop/switch isn't completed */
        obj;
        aobj;
        JVM INSTR monitorexit ;
