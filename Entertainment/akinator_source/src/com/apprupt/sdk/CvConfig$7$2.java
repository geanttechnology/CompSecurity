    ...
    implements ler
{
    ...
    final solve this$1;
    final solve val$resolver;

    public void onSuccess(Object obj)
    {
        val$resolver.solve(obj);
    }
...
/* anonymous class */
        ...
        implements Q.Task
    {
            ...
            throws Exception
        {
            ...
            if (flag)
            {
                q.success(resolver. new CvConfig._cls7._cls2()).failure(new CvConfig._cls7._cls1());
                return;
            } else
            {
        ...
        // Unreferenced inner class com/apprupt/sdk/CvConfig$7$1

/* anonymous class */
        class CvConfig._cls7._cls1
            implements Q.FailureHandler
        {
