...
//            AddQuestionActivity, GameOverActivity
...
class mProgressDialog extends AsyncTask
{
    ...
    {
        return Integer.valueOf(SessionFactory.sharedInstance().getSession().modifyQuestionWithId(AddQuestionActivity.access$200(_fld0).etId(), AddQuestionActivity.access$200(_fld0).etQuestion(), aarraylist[0]));
    }
...
_L3:
        ...
        // Unreferenced inner class com/digidust/elokence/akinator/activities/AddQuestionActivity$2$2

/* anonymous class */
        class AddQuestionActivity._cls2._cls2 extends AsyncTask
        {
            ...
            protected void onPreExecute()
            {
                ...
                mQuestionText = AddQuestionActivity.access$300(this$0).getText().toString();
            }
