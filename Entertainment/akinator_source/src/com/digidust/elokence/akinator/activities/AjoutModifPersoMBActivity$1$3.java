...
class mProgressDialog extends AsyncTask
{
    ...
    {
        return Integer.valueOf(MinibaseFactory.sharedInstance().addCharacterToMinibase(mNomEdit, AjoutModifPersoMBActivity.access$100(_fld0)));
    }
    ...
    protected void onPostExecute(Integer integer)
    {
        ...
        if (integer.intValue() == 0)
        {
            ...
            if (AjoutModifPersoMBActivity.access$100(_fld0) != null)
            {
                flag = true;
            }
            integer.logAjoutProcheMW(flag);
            AjoutModifPersoMBActivity.access$200(_fld0);
            return;
        } else
        {
