...
class mProgressDialog extends AsyncTask
{
    ...
    {
        return Integer.valueOf(MinibaseFactory.sharedInstance().modifyCharacterMinibase(AjoutModifPersoMBActivity.access$300(_fld0).getElementMinibaseId(), mNomEdit, AjoutModifPersoMBActivity.access$100(_fld0)));
    }
    ...
    protected void onPostExecute(Integer integer)
    {
        ...
        AjoutModifPersoMBActivity.access$300(_fld0).setName(mNomEdit);
    ...
    protected void onPreExecute()
    {
        ...
        mNomEdit = AjoutModifPersoMBActivity.access$000(_fld0).getText().toString();
    }
...
/* anonymous class */
        ...
        // Unreferenced inner class com/digidust/elokence/akinator/activities/AjoutModifPersoMBActivity$1$2

/* anonymous class */
        class AjoutModifPersoMBActivity._cls1._cls2
            implements android.content.DialogInterface.OnClickListener
        {
