...
//            ReportActivity, GameOverActivity

class mReport extends AsyncTask
{
    ...
    // Unreferenced inner class com/digidust/elokence/akinator/activities/GameOverActivity$16

/* anonymous class */
    class GameOverActivity._cls16
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            {
                (new GameOverActivity._cls16._cls1()).execute(new Void[0]);
            } else
            {
