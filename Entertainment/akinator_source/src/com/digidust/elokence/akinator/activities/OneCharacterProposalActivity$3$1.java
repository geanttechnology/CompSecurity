...
class mProgressDialog extends AsyncTask
{
    ...
    {
        return Integer.valueOf(MinibaseFactory.sharedInstance().validateMBCharacter(OneCharacterProposalActivity.access$100(_fld0).getElementMinibaseId()));
    }
...
_L1:
            Object obj2;
            final boolean finalIsAwardAlreadyWon;
            boolean flag;
            flag = true;
            finalIsAwardAlreadyWon = flag;
            if (!AkGameFactory.sharedInstance().winFirstTry())
            {
            ...
            finalIsAwardAlreadyWon = ((AkDBAdapter) (obj)).isAwardAlreadyWonForCharacter(TraductionFactory.sharedInstance().getApplicationLanguage(), proposedlimuleobjectminibase.getIdBase());
            flag = finalIsAwardAlreadyWon;
            finalIsAwardAlreadyWon = flag;
            if (obj != null)
            {
...
_L3:
            (new OneCharacterProposalActivity._cls3._cls2()).execute(new Void[0]);
...
_L4:
        ...
        // Unreferenced inner class com/digidust/elokence/akinator/activities/OneCharacterProposalActivity$3$2

/* anonymous class */
        class OneCharacterProposalActivity._cls3._cls2 extends AsyncTask
        {
            ...
            protected transient Integer doInBackground(Void avoid[])
            {
                ...
                {
                    return Integer.valueOf(SessionFactory.sharedInstance().getSession().validateObjectWithId(OneCharacterProposalActivity.access$100(this$0).getIdSession()));
                } else
                {
                    return Integer.valueOf(SessionFactory.sharedInstance().getSession().validateObjectWithIdWithJackpot(OneCharacterProposalActivity.access$100(this$0).getIdSession()));
                }
            }
