...
class this._cls0
    implements android.view.eCharacterProposalActivity._cls3
{
    ...
    {
        com.elokence.limuleapi.ibase ibase;
        ...
        ibase = OneCharacterProposalActivity.access$100(OneCharacterProposalActivity.this);
        AkSessionFactory.sharedInstance().setCharacterNameProposed(ibase.getName());
...
_L1:
        ...
        finalIsAwardAlreadyWon = ((AkDBAdapter) (obj)).isAwardAlreadyWonForCharacter(TraductionFactory.sharedInstance().getApplicationLanguage(), ibase.getIdBase());
