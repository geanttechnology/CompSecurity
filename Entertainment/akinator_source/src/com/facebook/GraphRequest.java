...
label1:
    ...
    public static List executeBatchAndWait(GraphRequestBatch graphrequestbatch)
    {
        ...
        httpurlconnection = httpurlconnection1;
        Object obj = toHttpConnection(graphrequestbatch);
        httpurlconnection1 = ((HttpURLConnection) (obj));
        httpurlconnection = httpurlconnection1;
        graphrequestbatch = executeConnectionAndWait(httpurlconnection1, graphrequestbatch);
        Utility.disconnectQuietly(httpurlconnection1);
        return graphrequestbatch;
        Exception exception;
        exception;
        httpurlconnection = httpurlconnection1;
        exception = GraphResponse.constructErrorResponses(graphrequestbatch.getRequests(), null, new FacebookException(exception));
        httpurlconnection = httpurlconnection1;
        runCallbacks(graphrequestbatch, exception);
...
label0:
    ...
    public static HttpURLConnection toHttpConnection(GraphRequestBatch graphrequestbatch)
    {
        ...
        if (graphrequestbatch.size() != 1) goto _L2; else goto _L1
_L1:
        Object obj = new URL(graphrequestbatch.get(0).getUrlForSingleRequest());
_L4:
        HttpURLConnection httpurlconnection;
        HttpURLConnection httpurlconnection1;
        httpurlconnection1 = null;
