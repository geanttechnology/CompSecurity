...
class WebViewLoginMethodHandler extends LoginMethodHandler
{
    ...
    void onWebDialogComplete(LoginClient.Request request, Bundle bundle, FacebookException facebookexception)
    {
        ...
        } else
        {
            ...
            request = LoginClient.Result.createErrorResult(loginClient.getPendingRequest(), null, bundle, request);
        }
    ...
    boolean tryAuthorize(final LoginClient.Request request)
    {
        ...
        loginDialog = (new AuthDialogBuilder(((Context) (obj)), request.getApplicationId(), bundle)).setE2E(e2e).setIsRerequest(request.isRerequest()).setOnCompleteListener(oncompletelistener).build();
