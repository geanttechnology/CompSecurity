...
public class zzh
{
    ...
    class zza {}
        ...
        zzCX = new zza(context, "google_inapp_purchase.db");
    }
...
_L2:
        ...
        sqliteexception;
        obj1 = obj;
        com.google.android.gms.ads.internal.util.client.zzb.zzaH((new StringBuilder()).append("Error getting record count").append(sqliteexception.getMessage()).toString());
...
_L1:
    ...
    public SQLiteDatabase getWritableDatabase()
    {
        ...
        try
        {
            sqlitedatabase = zzCX.getWritableDatabase();
        }
...
_L4:
        obj = cursor;
        com.google.android.gms.ads.internal.util.client.zzb.zzaH((new StringBuilder()).append("Error remove oldest record").append(sqliteexception.getMessage()).toString());
...
_L7:
        obj = cursor;
        com.google.android.gms.ads.internal.util.client.zzb.zzaH((new StringBuilder()).append("Error extracing purchase info: ").append(sqliteexception.getMessage()).toString());
...
_L5:
    ...
    static 
    {
        zzCW = String.format(Locale.US, "CREATE TABLE IF NOT EXISTS %s ( %s INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, %s TEXT NOT NULL, %s TEXT NOT NULL, %s INTEGER)", new Object[] {
