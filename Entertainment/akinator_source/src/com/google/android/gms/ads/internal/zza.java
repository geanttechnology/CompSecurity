    ...
    implements com.google.android.gms.ads.internal.client.zza, zzn, com.google.android.gms.ads.internal.request.zza, zzdg, com.google.android.gms.internal.zzgg.zza, zzhw
{
    ...
    Bundle zza(zzbk zzbk1)
    {
        if (zzbk1 != null)
        {
            ...
            {
                zzbk1 = zzbh1.zzcm();
                com.google.android.gms.ads.internal.util.client.zzb.zzaF((new StringBuilder()).append("In AdManger: loadAd, ").append(zzbh1.toString()).toString());
            } else
            {
                zzbk1 = null;
            }
    ...
    public boolean zzb(AdRequestParcel adrequestparcel)
    {
        ...
        {
            com.google.android.gms.ads.internal.util.client.zzb.zzaG((new StringBuilder()).append("Use AdRequest.Builder.addTestDevice(\"").append(zzl.zzcF().zzQ(zzot.context)).append("\") to get test ads on this device.").toString());
        }
