    ...
    implements zzdo
{
    ...
    public zzk(Context context, AdSizeParcel adsizeparcel, String s, zzem zzem, VersionInfoParcel versioninfoparcel, zzd zzd1)
    {
        ...
        zzpk = false;
        zzpn = (new StringBuilder()).append("background").append(hashCode()).append(".").append("png").toString();
    }
    ...
    protected boolean zzbl()
    {
        ...
        {
            if ((window = ((Activity)zzot.context).getWindow()) != null && window.getDecorView() != null)
            {
                Rect rect = new Rect();
                Rect rect1 = new Rect();
