...
public class zzb extends zzd
{
    ...
    public void zza(String s, Runnable runnable)
    {
        ...
        zziw().zzg(new Runnable(s, runnable) {
    ...
    {
        zziE();
        Future future = zziw().zzb(new Callable() {
