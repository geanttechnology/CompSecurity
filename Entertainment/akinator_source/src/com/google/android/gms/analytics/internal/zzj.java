...
_L1:
    ...
    private static final String zzNm = String.format("CREATE TABLE IF NOT EXISTS %s ( '%s' INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, '%s' INTEGER NOT NULL, '%s' TEXT NOT NULL, '%s' TEXT NOT NULL, '%s' INTEGER);", new Object[] {
        "hits2", "hit_id", "hit_time", "hit_url", "hit_string", "hit_app_id"
    });
    private static final String zzNn = String.format("SELECT MAX(%s) FROM %s WHERE 1;", new Object[] {
        "hit_time", "hits2"
    });
    private final zza zzNo;
    private final zzaj zzNp = new zzaj(zzit());
    private final zzaj zzNq = new zzaj(zzit());

    zzj(zzf zzf1)
    {
        super(zzf1);
        String s = zziZ();
        zzNo = new zza(zzf1.getContext(), s);
    }

    private static String zzB(Map map)
    {
        zzx.zzw(map);
...
_L3:
    ...
    SQLiteDatabase getWritableDatabase()
    {
        ...
        try
        {
            sqlitedatabase = zzNo.getWritableDatabase();
        }
        catch (SQLiteException sqliteexception)
        {
    ...
    public void zzb(zzh zzh1)
    {
        ...
        String s = zzB(zzh1.zzn());
        ContentValues contentvalues = new ContentValues();
        contentvalues.put("app_uid", Long.valueOf(zzh1.zziM()));
        contentvalues.put("cid", zzh1.getClientId());
        contentvalues.put("tid", zzh1.zziN());
        int i;
        if (zzh1.zziO())
        {
            i = 1;
        ...
        contentvalues.put("hits_count", Long.valueOf(zzh1.zziP()));
    ...
    public void zzc(zzab zzab1)
    {
        ...
        if (s.length() > 8192)
        {
            zziu().zza(zzab1, "Hit length exceeds the maximum allowed size");
            return;
        }
        zziY();
        sqlitedatabase = getWritableDatabase();
        ...
        contentvalues.put("hit_time", Long.valueOf(zzab1.zzkA()));
        contentvalues.put("hit_app_id", Integer.valueOf(zzab1.zzky()));
    ...
    public int zziW()
    {
        ...
        } else
        {
            ...
            int i = getWritableDatabase().delete("hits2", "hit_time < ?", new String[] {
                Long.toString(zzit().currentTimeMillis() - 0x9a7ec800L)
            });
    ...
    public long zziX()
    {
        zzis();
        zziE();
        return zza(zzNn, ((String []) (null)), 0L);
    }

    public void zzk(List list)
    {
        zzx.zzw(list);
        zzis();
        zziE();
...
_L1:
        ...
        obj = obj1;
        ((List) (obj2)).add(new zzab(this, zzbf(s), l1, zzam.zzbu(s1), l, i));
        obj = obj1;
