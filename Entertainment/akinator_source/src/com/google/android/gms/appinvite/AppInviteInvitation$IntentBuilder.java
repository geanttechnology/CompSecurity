...
public static final class mIntent
{
    ...
    public mIntent setAdditionalReferralParameters(Map map)
    {
        if (map != null)
        {
    ...
    public mIntent setAndroidMinimumVersionCode(int i)
    {
        mIntent.putExtra("com.google.android.gms.appinvite.appMinimumVersionCode", i);
        return this;
    }

    public mIntent setCallToActionText(CharSequence charsequence)
    {
    ...
    public mIntent setCustomImage(Uri uri)
    {
        zzx.zzw(uri);
    ...
    public PlatformMode(CharSequence charsequence)
    {
