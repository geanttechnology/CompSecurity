...
public final class zzf
{
    ...
    private static final Pattern zzZj = Pattern.compile("urn:x-cast:[-A-Za-z0-9_]+(\\.[-A-Za-z0-9_]+)*");
    ...
    public static void zzbM(String s)
    ...
    public static String zzbO(String s)
    {
        if (zzZj.matcher(s).matches())
        {
            return s;
        }
