...
//            OnResourceIdSetResponse, OnStartStreamSession, OnSyncMoreResponse, StringListResponse
    ...
    extends IInterface
{
        ...
        implements zzan
    {
        ...
        public static zzan zzaT(IBinder ibinder)
        {
            if (ibinder == null)
            {
                return null;
            ...
            throws RemoteException
        {
            ...
            case 11: // '\013'
                ...
                zza(((OnLoadRealtimeResponse) (obj)), com.google.android.gms.drive.realtime.internal.zzm.zza.zzbg(parcel.readStrongBinder()));
                parcel1.writeNoException();
                return true;
            ...
            case 21: // '\025'
                ...
                if (parcel.readInt() != 0)
                {
                    obj = (StringListResponse)StringListResponse.CREATOR.createFromParcel(parcel);
                }
                zza(((StringListResponse) (obj)));
                parcel1.writeNoException();
                return true;
            ...
            if (parcel.readInt() != 0)
            {
                obj = (OnStartStreamSession)OnStartStreamSession.CREATOR.createFromParcel(parcel);
            }
            zza(((OnStartStreamSession) (obj)));
            parcel1.writeNoException();
            return true;
        }
...
_L1:
    ...
    public abstract void zza(OnStartStreamSession onstartstreamsession)
        throws RemoteException;

    public abstract void zza(OnSyncMoreResponse onsyncmoreresponse)
        throws RemoteException;

    public abstract void zza(StringListResponse stringlistresponse)
        throws RemoteException;
