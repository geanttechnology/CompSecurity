    ...
    implements SearchableCollectionMetadataField
{
    ...
    public static final zze.zza zzamI = new zze.zza() {
    ...
    private void zzc(DataHolder dataholder)
    {
        ...
        Object obj = (DataHolder)dataholder.zzor().getParcelable("parentsExtraHolder");
        if (obj != null)
        {
...
_L3:
        dataholder.zzor().putParcelableArrayList("parentsExtra", arraylist);
        ((DataHolder) (obj)).close();
        dataholder.zzor().remove("parentsExtraHolder");
        dataholder;
        JVM INSTR monitorexit ;
        return;
        obj;
