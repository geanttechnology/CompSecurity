    ...
    implements SafeParcelable
{
    ...
    private static final Map zzaqu = new HashMap() {
            ...
            
            {
                ...
                put(DataType.zzaqq, Collections.singletonList(DataType.zzaqs));
                put(DataType.zzaqp, Collections.singletonList(DataType.zzaqt));
                ...
                put(DataType.zzaqn, Collections.singletonList(DataType.zzaqr));
    ...
    {
        this(1, s, ((List) (zzmj.zzb(afield))));
    }

    public static List getAggregatesForInput(DataType datatype)
    {
        datatype = (List)zzaqu.get(datatype);
        if (datatype == null)
        {
    ...
    {
        return mName.equals(datatype.mName) && zzaqw.equals(datatype.zzaqw);
    }
    ...
    static 
    {
        ...
        zzaqn = new DataType("com.google.floor_change", new Field[] {
            Field.FIELD_ACTIVITY, Field.FIELD_CONFIDENCE, Field.zzaqF, Field.zzaqI
        });
        ...
        zzaqo = new DataType("com.google.accelerometer", new Field[] {
            Field.zzaqL, Field.zzaqM, Field.zzaqN
        });
        ...
        zzaqp = new DataType("com.google.body.waist.circumference", new Field[] {
            Field.FIELD_CIRCUMFERENCE
        });
        zzaqq = new DataType("com.google.body.hip.circumference", new Field[] {
            Field.FIELD_CIRCUMFERENCE
        });
        ...
        AGGREGATE_INPUT_TYPES = Collections.unmodifiableSet(new HashSet(Arrays.asList(new DataType[] {
            TYPE_STEP_COUNT_DELTA, TYPE_DISTANCE_DELTA, TYPE_ACTIVITY_SEGMENT, zzaqn, TYPE_SPEED, TYPE_HEART_RATE_BPM, TYPE_WEIGHT, TYPE_LOCATION_SAMPLE, TYPE_CALORIES_CONSUMED, TYPE_CALORIES_EXPENDED, 
            TYPE_BODY_FAT_PERCENTAGE, zzaqq, zzaqp, TYPE_NUTRITION
        })));
        ...
        zzaqr = new DataType("com.google.floor_change.summary", new Field[] {
            Field.zzaqD, Field.zzaqE, Field.zzaqG, Field.zzaqH, Field.zzaqJ, Field.zzaqK
        });
        ...
        zzaqs = new DataType("com.google.body.hip.circumference.summary", new Field[] {
            Field.FIELD_AVERAGE, Field.FIELD_MAX, Field.FIELD_MIN
        });
        zzaqt = new DataType("com.google.body.waist.circumference.summary", new Field[] {
            Field.FIELD_AVERAGE, Field.FIELD_MAX, Field.FIELD_MIN
        });
        ...
        zzaqv = (new DataType[] {
            zzaqo, TYPE_WORKOUT_EXERCISE, TYPE_ACTIVITY_SAMPLE, TYPE_ACTIVITY_SEGMENT, AGGREGATE_ACTIVITY_SUMMARY, TYPE_BODY_FAT_PERCENTAGE, AGGREGATE_BODY_FAT_PERCENTAGE_SUMMARY, zzaqq, zzaqs, zzaqp, 
            zzaqt, TYPE_BASAL_METABOLIC_RATE, AGGREGATE_BASAL_METABOLIC_RATE_SUMMARY, TYPE_CALORIES_CONSUMED, TYPE_CALORIES_EXPENDED, TYPE_CYCLING_PEDALING_CADENCE, TYPE_CYCLING_PEDALING_CUMULATIVE, TYPE_CYCLING_WHEEL_REVOLUTION, TYPE_CYCLING_WHEEL_RPM, TYPE_DISTANCE_CUMULATIVE, 
            TYPE_DISTANCE_DELTA, zzaqn, zzaqr, TYPE_HEART_RATE_BPM, AGGREGATE_HEART_RATE_SUMMARY, TYPE_HEIGHT, AGGREGATE_LOCATION_BOUNDING_BOX, TYPE_LOCATION_SAMPLE, TYPE_LOCATION_TRACK, TYPE_NUTRITION, 
