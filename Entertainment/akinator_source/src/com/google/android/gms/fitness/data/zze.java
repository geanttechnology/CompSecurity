    ...
    implements android.os.Parcelable.Creator
{
    ...
    static void zza(DataSet dataset, Parcel parcel, int i)
    {
        ...
        zzb.zzd(parcel, 3, dataset.zzsp(), false);
        zzb.zzc(parcel, 4, dataset.zzsq(), false);
        zzb.zza(parcel, 5, dataset.zzsh());
        zzb.zzI(parcel, j);
    }
    ...
    public DataSet zzcI(Parcel parcel)
    {
        boolean flag = false;
