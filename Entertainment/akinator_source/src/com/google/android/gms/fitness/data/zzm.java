    ...
    implements android.os.Parcelable.Creator
{
    ...
    static void zza(RawBucket rawbucket, Parcel parcel, int i)
    {
        ...
        zzb.zza(parcel, 1, rawbucket.zzNY);
        zzb.zzc(parcel, 1000, rawbucket.mVersionCode);
        zzb.zza(parcel, 2, rawbucket.zzapN);
        zzb.zza(parcel, 3, rawbucket.zzapP, i, false);
        zzb.zzc(parcel, 4, rawbucket.zzaqT);
        zzb.zzc(parcel, 5, rawbucket.zzapY, false);
        zzb.zzc(parcel, 6, rawbucket.zzapZ);
        zzb.zza(parcel, 7, rawbucket.zzaqa);
        zzb.zzI(parcel, j);
    }
    ...
    public RawBucket zzcO(Parcel parcel)
    {
        long l1 = 0L;
