    ...
    implements android.os.Parcelable.Creator
{
    ...
    static void zza(StartBleScanRequest startblescanrequest, Parcel parcel, int i)
    {
        ...
        zzb.zza(parcel, 2, startblescanrequest.zztk(), false);
        zzb.zzc(parcel, 3, startblescanrequest.getTimeoutSecs());
        zzb.zza(parcel, 4, startblescanrequest.zzsO(), false);
        zzb.zzI(parcel, i);
    }
    ...
    public StartBleScanRequest zzdv(Parcel parcel)
    {
        int i = 0;
        ...
        do
        {
            ...
            {
                return new StartBleScanRequest(j, arraylist, ibinder1, i, ibinder);
            }
        } while (true);
    }

    public StartBleScanRequest[] zzfn(int i)
    {
