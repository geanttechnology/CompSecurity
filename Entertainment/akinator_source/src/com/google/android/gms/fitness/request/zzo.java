    ...
    implements android.os.Parcelable.Creator
{
    ...
    {
        i = zzb.zzaq(parcel);
        zzb.zza(parcel, 1, listclaimedbledevicesrequest.zzsO(), false);
    ...
    public ListClaimedBleDevicesRequest zzdj(Parcel parcel)
    {
    ...
    public ListClaimedBleDevicesRequest[] zzfa(int i)
    {
