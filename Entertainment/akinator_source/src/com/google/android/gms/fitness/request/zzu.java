    ...
    implements android.os.Parcelable.Creator
{
    ...
    static void zza(SessionInsertRequest sessioninsertrequest, Parcel parcel, int i)
    {
        ...
        zzb.zza(parcel, 4, sessioninsertrequest.zzsO(), false);
        zzb.zzI(parcel, j);
    }
    ...
    public SessionInsertRequest zzdp(Parcel parcel)
    {
        ...
        do
        {
            ...
            {
                return new SessionInsertRequest(i, session, arraylist1, arraylist, ibinder);
            }
        } while (true);
    }

    public SessionInsertRequest[] zzfh(int i)
    {
