    ...
    implements android.os.Parcelable.Creator
{
    ...
    static void zza(DataReadResult datareadresult, Parcel parcel, int i)
    {
        ...
        zzb.zzd(parcel, 1, datareadresult.zztp(), false);
        zzb.zzc(parcel, 1000, datareadresult.getVersionCode());
        zzb.zza(parcel, 2, datareadresult.getStatus(), i, false);
        zzb.zzd(parcel, 3, datareadresult.zzto(), false);
        zzb.zzc(parcel, 5, datareadresult.zztn());
        zzb.zzc(parcel, 6, datareadresult.zzsq(), false);
        zzb.zzc(parcel, 7, datareadresult.zztq(), false);
        zzb.zzI(parcel, j);
    }
    ...
    public DataReadResult zzdC(Parcel parcel)
    {
        int i = 0;
    ...
    public DataReadResult[] zzfu(int i)
    {
