    ...
    implements android.os.Parcelable.Creator
{
    ...
    static void zza(DataSourceStatsResult datasourcestatsresult, Parcel parcel, int i)
    {
        ...
        zzb.zza(parcel, 1, datasourcestatsresult.zzapM, i, false);
        zzb.zzc(parcel, 1000, datasourcestatsresult.mVersionCode);
        zzb.zza(parcel, 2, datasourcestatsresult.zzRr);
        zzb.zza(parcel, 3, datasourcestatsresult.zzatg);
        zzb.zza(parcel, 4, datasourcestatsresult.zzath);
        zzb.zza(parcel, 5, datasourcestatsresult.zzati);
        zzb.zzI(parcel, j);
    }
    ...
    public DataSourceStatsResult zzdD(Parcel parcel)
    {
        boolean flag = false;
        long l = 0L;
    ...
    public DataSourceStatsResult[] zzfv(int i)
    {
