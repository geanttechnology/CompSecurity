...
public final class GamesContract
{
    public static interface AccountMetadataColumns
    {
        ...
        public static final String zzawH[] = {
    ...
    public static interface GameInstancesColumns
    {
        ...
        public static final String zzawI[] = {
    ...
    public static interface PlayerStatsColumns
    {
        ...
        public static final String zzawH[] = {
            "ave_session_length_minutes", "churn_probability", "days_since_last_played", "game_id", "num_purchases", "num_sessions", "num_sessions_percentile", "player_id", "spend_percentile"
        };
