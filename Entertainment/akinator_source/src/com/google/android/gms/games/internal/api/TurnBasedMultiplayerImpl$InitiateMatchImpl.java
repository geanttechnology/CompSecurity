...
private static abstract class <init> extends com.google.android.gms.games.ateMatchImpl
{
    ...
    public com.google.android.gms.games.multiplayer.turnbased. zzaF(Status status)
    {
        return new com.google.android.gms.games.multiplayer.turnbased.TurnBasedMultiplayer.InitiateMatchResult(status) {

            final Status zzVb;
            final TurnBasedMultiplayerImpl.InitiateMatchImpl zzayS;
            ...
            {
                zzayS = TurnBasedMultiplayerImpl.InitiateMatchImpl.this;
                zzVb = status;
                super();
            }
        };
