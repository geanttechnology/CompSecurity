    ...
    implements SafeParcelable, GameRequest
{
    ...
    private void zzvp()
    {
        ...
        zzb.zzZ(flag);
        gamerequest = (GameRequest)zzazQ.get(0);
        j = zzazQ.size();
        i = 1;
        while (i < j) 
        {
            GameRequest gamerequest1 = (GameRequest)zzazQ.get(i);
    ...
    public boolean equals(Object obj)
    {
        ...
        if (((GameRequestCluster) (obj)).zzazQ.size() != zzazQ.size())
        {
            return false;
        }
        int j = zzazQ.size();
        for (int i = 0; i < j; i++)
        {
            if (!((GameRequest)zzazQ.get(i)).equals((GameRequest)((GameRequestCluster) (obj)).zzazQ.get(i)))
            {
                return false;
            }
        }
    ...
    {
        return ((GameRequestEntity)zzazQ.get(0)).getRequestId();
    }

    public Player getSender()
    {
        return ((GameRequestEntity)zzazQ.get(0)).getSender();
    }
    ...
    public int getType()
    {
        return ((GameRequestEntity)zzazQ.get(0)).getType();
    }
    ...
    public int hashCode()
    {
        return zzw.hashCode(zzazQ.toArray());
    }
    ...
    public ArrayList zzvD()
    {
        return new ArrayList(zzazQ);
    }

    public ArrayList zzvE()
    {
        throw new UnsupportedOperationException("Method not supported on a cluster");
    }
