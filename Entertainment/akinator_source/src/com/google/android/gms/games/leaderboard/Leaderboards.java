...
public interface Leaderboards
{
    ...
    public abstract Intent getLeaderboardIntent(GoogleApiClient googleapiclient, String s, int i);

    public abstract Intent getLeaderboardIntent(GoogleApiClient googleapiclient, String s, int i, int j);
