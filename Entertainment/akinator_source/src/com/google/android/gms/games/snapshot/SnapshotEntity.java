    ...
    implements SafeParcelable, Snapshot
{
    ...
    {
        mVersionCode = i;
        zzaBF = new SnapshotMetadataEntity(snapshotmetadata);
        zzaBG = snapshotcontentsentity;
    }
...
_L5:
    ...
    {
        com.google.android.gms.common.internal.zzw.zza zza1 = zzw.zzv(snapshot).zzg("Metadata", snapshot.getMetadata());
        boolean flag;
