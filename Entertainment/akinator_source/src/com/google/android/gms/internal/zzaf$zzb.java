...
_L2:
        flag = flag1;
        if (!(obj instanceof zzhP)) goto _L4; else goto _L3
_L3:
        obj = (zzhP)obj;
        flag = flag1;
        if (!zzsc.equals(zzhQ, ((zzhQ) (obj)).zzhQ)) goto _L4; else goto _L5
_L5:
        flag = flag1;
        if (zzhR != ((zzhR) (obj)).zzhR) goto _L4; else goto _L6
_L6:
        flag = flag1;
        if (name != ((name) (obj)).name) goto _L4; else goto _L7
_L7:
        flag = flag1;
        if (zzhS != ((zzhS) (obj)).zzhS) goto _L4; else goto _L8
_L8:
        flag = flag1;
        if (zzhT != ((zzhT) (obj)).zzhT) goto _L4; else goto _L9
_L9:
