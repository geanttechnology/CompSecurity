    ...
    implements SafeParcelable
{
    ...
    {
        return (new StringBuilder()).append("ActivityRecognitionResult [probableActivities=").append(zzaEb).append(", timeMillis=").append(zzaEc).append(", elapsedRealtimeMillis=").append(zzaEd).append("]").toString();
    }
