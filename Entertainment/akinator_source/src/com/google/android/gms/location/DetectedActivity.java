    ...
    implements SafeParcelable
{
    ...
    public static final Comparator zzaEf = new Comparator() {
    ...
    {
        return (new StringBuilder()).append("DetectedActivity [type=").append(zzgL(getType())).append(", confidence=").append(zzaEh).append("]").toString();
    }
