    ...
    implements SafeParcelable
{
    ...
    {
        return (new StringBuilder()).append("SharedContent[viewableItems=").append(Arrays.toString(zzaRn)).append(", localContents=").append(Arrays.toString(zzaRo)).append("]").toString();
    }
