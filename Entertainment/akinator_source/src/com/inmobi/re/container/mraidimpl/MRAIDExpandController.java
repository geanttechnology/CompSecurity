...
_L7:
        ...
        {
            Log.debug("[InMobi]-[RE]-4.5.5", "Exception in doexpand ", bundle);
            a.setState(com.inmobi.re.container.IMWebView.ViewState.DEFAULT);
            synchronized (a.mutex)
            {
                a.isMutexAquired.set(false);
...
_L4:
        IMBrowserActivity.setExpandedWebview(a);
          goto _L6
        obj;
        Log.internal("[InMobi]-[RE]-4.5.5", "Exception in expand in separate activity ", ((Throwable) (obj)));
          goto _L7
        bundle;
        obj;
        JVM INSTR monitorexit ;
    ...
    public void handleOrientationFor2Piece()
    {
        ...
        {
            Log.internal("[InMobi]-[RE]-4.5.5", "IMWebview Handle orientation for 2 piece ", exception);
            return;
        }
