...
public abstract class ADCVideo extends Activity
{
    ...
    void a(String s1)
    {
        ...
        P.addView(S);
        setContentView(P);
        M.setOnCompletionListener(new android.media.MediaPlayer.OnCompletionListener() {
        ...
        M.setOnPreparedListener(new android.media.MediaPlayer.OnPreparedListener() {
    ...
    public void onCreate(Bundle bundle)
    {
        ...
        for (i1 = 0; i1 < com.jirbo.adcolony.a.ah.size(); i1++)
        {
            if (com.jirbo.adcolony.a.ah.get(i1) != null)
            {
                bundle = (AdColonyNativeAdView)com.jirbo.adcolony.a.ah.get(i1);
...
_L4:
        ...
        {
            com.jirbo.adcolony.a.e((new StringBuilder()).append("Unable to play video: ").append(com.jirbo.adcolony.a.j("video_filepath")).toString());
            finish();
            return;
        }
        if (!j)
