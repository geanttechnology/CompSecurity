...
/* anonymous class */
        ...
        implements Runnable
    {
        ...
        // Unreferenced inner class com/loopj/android/http/JsonHttpResponseHandler$1$1
...
/* anonymous class */
            ...
            implements Runnable
        {
            ...
            public void run()
            {
                if (!JsonHttpResponseHandler.access$000(this$0) && jsonResponse == null)
                {
                ...
                {
                    if (JsonHttpResponseHandler.access$000(this$0))
                    {
