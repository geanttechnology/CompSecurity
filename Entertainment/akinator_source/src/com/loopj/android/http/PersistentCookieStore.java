...
//            SerializableCookie, AsyncHttpClient, LogInterface
    ...
    implements CookieStore
{
    ...
    protected Cookie decodeCookie(String s)
    {
        ...
        {
            AsyncHttpClient.log.d("PersistentCookieStore", "IOException in decodeCookie", s);
            return null;
        }
        // Misplaced declaration of an exception variable
        catch (String s)
        {
            AsyncHttpClient.log.d("PersistentCookieStore", "ClassNotFoundException in decodeCookie", s);
            return null;
        }
        return s;
    }
    ...
    protected String encodeCookie(SerializableCookie serializablecookie)
    {
        ...
        {
            AsyncHttpClient.log.d("PersistentCookieStore", "IOException in encodeCookie", serializablecookie);
            return null;
        }
