    ...
    implements Closeable
{
    ...
    public DiskLruCacheStrictLineReader(InputStream inputstream, int i, Charset charset1)
    {
        ...
        if (!charset1.equals(DiskLruCacheUtil.US_ASCII))
        {
    ...
    public DiskLruCacheStrictLineReader(InputStream inputstream, Charset charset1)
    {
