...
//            CustomEventBanner, AdViewController, HtmlBannerWebView, MoPubErrorCode
...
public class HtmlBanner extends CustomEventBanner
{
    ...
    protected void loadBanner(Context context, CustomEventBanner.CustomEventBannerListener customeventbannerlistener, Map map, Map map1)
    {
        if (extrasAreValid(map1))
        {
            ...
            mHtmlBannerWebView = HtmlBannerWebViewFactory.create(context, map, customeventbannerlistener, map1.booleanValue(), s1, s2);
            AdViewController.setShouldHonorServerDimensions(mHtmlBannerWebView);
            mHtmlBannerWebView.loadHtmlResponse(s);
            return;
        } else
        {
