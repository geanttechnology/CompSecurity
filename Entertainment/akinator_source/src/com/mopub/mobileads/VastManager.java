...
//            VastVideoConfig, VastXmlManagerAggregator, VastVideoDownloadTask
    ...
    implements VastXmlManagerAggregator.VastXmlManagerAggregatorListener
{
    ...
    public void onAggregationComplete(final VastVideoConfig vastVideoConfig)
    {
        ...
        VastVideoDownloadTask vastvideodownloadtask = new VastVideoDownloadTask(new VastVideoDownloadTask.VastVideoDownloadTaskListener() {
        ...
        try
        {
            AsyncTasks.safeExecuteOnExecutor(vastvideodownloadtask, new String[] {
                vastVideoConfig.getNetworkMediaFileUrl()
            });
            return;
        }
        // Misplaced declaration of an exception variable
        catch (final VastVideoConfig vastVideoConfig)
        {
            MoPubLog.d("Failed to download vast video", vastVideoConfig);
        }
        mVastManagerListener.onVastVideoConfigurationPrepared(null);
    }
