...
//            MoPubNativeAdRenderer, RequestParameters, MoPubAdRenderer, ViewBinder
...
public class MoPubAdAdapter extends BaseAdapter
{
    ...
    public final void registerViewBinder(ViewBinder viewbinder)
    {
        if (!com.mopub.common.Preconditions.NoThrow.checkNotNull(viewbinder, "Tried to set a null view binder on the placer."))
        {
            return;
        } else
        {
