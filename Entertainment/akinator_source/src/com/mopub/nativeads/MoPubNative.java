...
//            NativeUrlGenerator, CustomEventNativeAdapter, RequestParameters, NativeErrorCode, 
...
public class MoPubNative
{
    public static interface MoPubNativeEventListener
    {
        ...
        public abstract void onNativeClick(View view);

        public abstract void onNativeImpression(View view);
    }

    public static interface MoPubNativeListener
        extends MoPubNativeNetworkListener, MoPubNativeEventListener
    {
    }
