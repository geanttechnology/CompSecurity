...
/* anonymous class */
        ...
        implements fs
    {
        ...
        public final void a(String s, String s1)
        {
            ...
            {
                s = new FiveRocksIntegration._cls1._cls1._cls1(s);
        ...
        public final void a(String s, String s1, int i, String s2)
        {
            ...
            if (tjplacement != null && tjplacement.a() != null)
            {
                s = new FiveRocksIntegration._cls1._cls1._cls2(this, s, s2);
        ...
        // Unreferenced inner class com/tapjoy/FiveRocksIntegration$1$1$1

/* anonymous class */
        final class FiveRocksIntegration._cls1._cls1._cls1
            implements TJActionRequest
        {

            final String a;
            final FiveRocksIntegration._cls1._cls1 b;
            ...
            public final String getToken()
            {
                return null;
                    ...
                    {
                        b = FiveRocksIntegration._cls1._cls1.this;
                        a = s;
                        super();
                    }
        }
