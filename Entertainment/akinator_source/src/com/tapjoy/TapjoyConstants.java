...
public class TapjoyConstants
{
    ...
    public static final long PAID_APP_TIME = 0xdbba0L;
    ...
    public static final long SESSION_ID_INACTIVITY_TIME = 0x1b7740L;
    ...
    public static final String TJC_BRIDGE_VERSION_NUMBER = "1.0.7";
    ...
    public static final int TJC_LIBRARY_VERSION_INT = 1122;
    public static final String TJC_LIBRARY_VERSION_NUMBER = "11.2.2";
    ...
    public static final String dependencyClassNames[] = {
        "com.tapjoy.TJAdUnitActivity", "com.tapjoy.mraid.view.ActionHandler", "com.tapjoy.mraid.view.Browser"
    };
    public static final String dependencyPermissions[] = {
        "android.permission.INTERNET", "android.permission.ACCESS_NETWORK_STATE"
    };
    public static final String optionalPermissions[] = {
        "android.permission.ACCESS_FINE_LOCATION", "android.permission.ACCESS_COARSE_LOCATION", "android.permission.READ_PHONE_STATE", "android.permission.ACCESS_WIFI_STATE"
    };

    public TapjoyConstants()
    {
    }
