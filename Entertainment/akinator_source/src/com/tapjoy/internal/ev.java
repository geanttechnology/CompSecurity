...
class ev extends fp
{
    ...
    private static final String i = com/tapjoy/internal/ev.getName();
    ...
    public ev(Context context, ew ew1, boolean flag)
    {
label0:
        {
            super();
