...
label0:
            ...
            a.setVisibility(8);
            MraidView.j(a).setOnPreparedListener(new MraidView._cls5._cls1(this));
            MraidView.j(a).setOnCompletionListener(new MraidView._cls5._cls2());
            MraidView.j(a).setOnErrorListener(new MraidView._cls5._cls3());
            MraidView.j(a).start();
        }
...
/* anonymous class */
        final class MraidView._cls5._cls3
