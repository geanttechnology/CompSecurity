...
public interface RouteInfo
{
    public static final class LayerType extends Enum
    {
        ...
        {
            return (LayerType)Enum.valueOf(cz/msebera/android/httpclient/conn/routing/RouteInfo$LayerType, s);
        }
    ...
    public static final class TunnelType extends Enum
    {
        ...
        {
            return (TunnelType)Enum.valueOf(cz/msebera/android/httpclient/conn/routing/RouteInfo$TunnelType, s);
        }
