...
import shared_presage.com.google.android.exoplayer.chunk.InitializationChunk;
import shared_presage.com.google.android.exoplayer.chunk.MediaChunk;
import shared_presage.com.google.android.exoplayer.chunk.SingleSampleMediaChunk;
import shared_presage.com.google.android.exoplayer.dash.mpd.AdaptationSet;
import shared_presage.com.google.android.exoplayer.dash.mpd.ContentProtection;
import shared_presage.com.google.android.exoplayer.dash.mpd.MediaPresentationDescription;
import shared_presage.com.google.android.exoplayer.dash.mpd.Period;
...
import shared_presage.com.google.android.exoplayer.extractor.webm.WebmExtractor;
    ...
    implements ChunkSource
{
    ...
    private static final class a
    {
        ...
        public a(Representation representation, ChunkExtractorWrapper chunkextractorwrapper)
        {
            a = representation;
            ...
            long l, long l1, boolean flag, Handler handler, EventListener eventlistener)
    {
        ...
        while (i < mediapresentationdescription.length) 
        {
            ...
            representationHolders.put(formats[i].id, new a(mediapresentationdescription[i], new ChunkExtractorWrapper(manifestfetcher)));
            i++;
        }
        maxWidth = k;
        maxHeight = j;
    ...
    private static DrmInitData getDrmInitData(MediaPresentationDescription mediapresentationdescription, int i)
    {
        ...
        obj = null;
        Object obj2 = null;
        mediapresentationdescription = (AdaptationSet)((Period)mediapresentationdescription.periods.get(0)).adaptationSets.get(i);
        if (mimeTypeIsWebm(((Representation)((AdaptationSet) (mediapresentationdescription)).representations.get(0)).format.mimeType))
        {
            s = "video/webm";
        } else
        {
        ...
        if (!((AdaptationSet) (mediapresentationdescription)).contentProtections.isEmpty()) goto _L2; else goto _L1
_L1:
        obj = obj2;
_L4:
        return ((DrmInitData) (obj));
_L2:
        Iterator iterator = ((AdaptationSet) (mediapresentationdescription)).contentProtections.iterator();
        ...
        do
        {
            ...
            if (contentprotection.uuid != null && contentprotection.data != null)
            {
                ...
                {
                    obj1 = new shared_presage.com.google.android.exoplayer.drm.DrmInitData.Mapped(s);
                }
                ((shared_presage.com.google.android.exoplayer.drm.DrmInitData.Mapped) (obj1)).put(contentprotection.uuid, contentprotection.data);
...
_L3:
    ...
    private Chunk newInitializationChunk(RangedUri rangeduri, RangedUri rangeduri1, Representation representation, ChunkExtractorWrapper chunkextractorwrapper, DataSource datasource, int i)
    {
        ...
        if (rangeduri == null) goto _L2; else goto _L1
_L1:
        rangeduri1 = rangeduri.attemptMerge(rangeduri1);
        rangeduri2 = rangeduri1;
        if (rangeduri1 != null) goto _L2; else goto _L3
_L3:
        return new InitializationChunk(datasource, new DataSpec(rangeduri.getUri(), rangeduri.start, rangeduri.length, representation.getCacheKey()), i, representation.format, chunkextractorwrapper);
_L2:
...
_L4:
    ...
    private Chunk newMediaChunk(a a1, DataSource datasource, int i, int j)
    {
        Representation representation = a1.a;
        Object obj = a1.c;
        ...
        if (representation.format.mimeType.equals("text/vtt"))
        {
            if (a1.f != l2)
            {
                ...
                headerBuilder.append("EXO-HEADER=OFFSET:").append(l2).append("\n");
                a1.g = headerBuilder.toString().getBytes();
                a1.f = l2;
            }
            return new SingleSampleMediaChunk(datasource, ((DataSpec) (obj)), 1, representation.format, l, l1, k, flag, MediaFormat.createTextFormat("text/vtt"), null, a1.g);
        } else
        {
            return new ContainerMediaChunk(datasource, ((DataSpec) (obj)), j, representation.format, l, l1, k, flag, l2, a1.b, a1.d, drmInitData, true);
        }
    }

    private void notifySeekRangeChanged(TimeRange timerange)
    {
        if (eventHandler != null && eventListener != null)
        {
            eventHandler.post(new shared_presage.com.google.android.exoplayer.dash.a(this, timerange));
        }
    }
    ...
    private void updateAvailableSegmentBounds(DashSegmentIndex dashsegmentindex, long l)
    {
        ...
        int k = dashsegmentindex.getLastSegmentNum();
        int i;
        if (k == -1)
        {
            ...
            j = dashsegmentindex.getSegmentNum(l);
            j--;
        } else
        {
            i = j;
    ...
    private void updateSeekRange(DashSegmentIndex dashsegmentindex, long l)
    {
        ...
        l1 = dashsegmentindex.getTimeUs(lastAvailableSegmentNum);
        l1 = dashsegmentindex.getDurationUs(lastAvailableSegmentNum) + l1;
...
_L5:
        ...
        if (manifestFetcher != null && currentManifest.dynamic && fatalError == null)
        {
            ...
            if (currentManifest != mediapresentationdescription && mediapresentationdescription != null)
            {
                ...
                while (i < k) 
                {
                    ...
                    a a1 = (a)representationHolders.get(((Representation) (obj)).format.id);
                    DashSegmentIndex dashsegmentindex = a1.c;
            ...
            if (finishedCurrentManifest && android.os.SystemClock.elapsedRealtime() > l + manifestFetcher.getManifestLoadStartTimestamp())
            {
    ...
    public void enable()
    {
        ...
        DashSegmentIndex dashsegmentindex = ((a)representationHolders.get(formats[0].id)).a.getIndex();
    ...
    public final void getChunkOperation(List list, long l, long l1, ChunkOperationHolder chunkoperationholder)
    {
        ...
        } else
        {
            ...
            {
                chunkoperationholder.chunk = null;
                a a1 = (a)representationHolders.get(((Format) (obj)).id);
                Representation representation = a1.a;
                DashSegmentIndex dashsegmentindex = a1.c;
                ChunkExtractorWrapper chunkextractorwrapper = a1.b;
                obj = null;
                ...
                } else
                {
                    ...
                    {
                        j = (((MediaChunk) (list)).chunkIndex + 1) - a1.e;
                    }
                }
                if (currentManifest.dynamic)
                {
                ...
                if (j != -1)
                {
                    list = newMediaChunk(a1, dataSource, j, evaluation.trigger);
    ...
    public void onChunkLoadCompleted(Chunk chunk)
    {
        if (chunk instanceof InitializationChunk)
        {
            ...
            obj = (a)representationHolders.get(obj);
            if (chunk.hasFormat())
            {
                obj.d = chunk.getFormat();
            }
            if (chunk.hasSeekMap())
            {
                obj.c = new b((ChunkIndex)chunk.getSeekMap(), ((InitializationChunk) (chunk)).dataSpec.uri.toString(), ((a) (obj)).a.periodStartMs * 1000L);
            }
