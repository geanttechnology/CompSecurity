...
import shared_presage.com.google.android.exoplayer.chunk.FormatWrapper;
    ...
    implements FormatWrapper
{
    ...
    public static class SingleSegmentRepresentation extends Representation
    {
                ...
                Format format1, SegmentBase.SingleSegmentBase singlesegmentbase, long l3)
        {
            ...
            {
                s = new a(l * 1000L, l1 * 1000L, new RangedUri(singlesegmentbase.uri, null, 0L, -1L));
            }
            segmentIndex = s;
        }
    }
    ...
    Representation(long l, long l1, String s, long l2, 
            Format format1, SegmentBase segmentbase, b b)
    {
