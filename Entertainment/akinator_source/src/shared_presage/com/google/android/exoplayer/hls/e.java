    ...
    implements Runnable
{
    ...
    e(HlsSampleSource hlssamplesource, long l, int j, int k, Format format, long l1, long l2, long l3, long l4)
    {
        i = hlssamplesource;
        a = l;
        b = j;
    ...
    {
        HlsSampleSource.access$100(i).onLoadCompleted(HlsSampleSource.access$000(i), a, b, c, d, i.usToMs(e), i.usToMs(f), g, h);
    }
}
