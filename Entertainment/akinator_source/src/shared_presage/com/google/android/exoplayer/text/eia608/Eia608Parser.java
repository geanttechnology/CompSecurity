...
public final class Eia608Parser
{
    ...
    private void addBufferedText()
    {
        ...
        {
            captions.add(new d(stringBuilder.toString()));
    ...
    {
        addBufferedText();
        captions.add(new b(byte0, byte1));
    }
    ...
    final c parse(SampleHolder sampleholder)
    {
        int i = 0;
        ...
        {
            a aa[] = new a[captions.size()];
            captions.toArray(aa);
            return new c(sampleholder.timeUs, sampleholder.isDecodeOnly(), aa);
        }
    }
