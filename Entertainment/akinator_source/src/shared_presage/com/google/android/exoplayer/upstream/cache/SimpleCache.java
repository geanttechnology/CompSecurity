...
//            Cache, a, CacheSpan, CacheEvictor
...
_L6:
        ...
        long l;
        obj = cachespan.key;
        l = cachespan.position;
        treeset = (TreeSet)cachedSpans.get(obj);
...
_L2:
        ...
        cachespan1 = (CacheSpan)treeset.floor(cachespan);
        if (cachespan1 == null || cachespan1.position > l || l >= cachespan1.position + cachespan1.length)
        {
            break; /* Loop/switch isn't completed */
        }
        obj = cachespan1;
        if (cachespan1.file.exists()) goto _L4; else goto _L3
_L3:
        removeStaleSpans();
...
_L5:
        ...
        if (cachespan2 == null)
        {
            return CacheSpan.createOpenHole(((String) (obj)), cachespan.position);
        } else
        {
            return CacheSpan.createClosedHole(((String) (obj)), cachespan.position, cachespan2.position - cachespan.position);
        }
    }
...
_L3:
        ...
        long l2 = ((CacheSpan) (obj)).position;
        l = Math.max(l, ((CacheSpan) (obj)).length + l2);
        if (l >= l1)
        {
            flag = true;
            continue; /* Loop/switch isn't completed */
