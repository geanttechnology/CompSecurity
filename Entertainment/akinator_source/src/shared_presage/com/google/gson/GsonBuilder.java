...
//            LongSerializationPolicy, FieldNamingPolicy, a, n, 
...
_L1:
        s = new a(s);
_L6:
        list.add(n.a(TypeToken.get(java/util/Date), s));
        list.add(n.a(TypeToken.get(java/sql/Timestamp), s));
        list.add(n.a(TypeToken.get(java/sql/Date), s));
_L4:
        return;
_L2:
...
_L5:
    ...
    public final GsonBuilder registerTypeAdapter(Type type, Object obj)
    {
        ...
        shared_presage.com.google.gson.internal..Gson.Preconditions.checkArgument(flag);
        ...
        if ((obj instanceof JsonSerializer) || (obj instanceof JsonDeserializer))
        {
            ...
            factories.add(n.b(typetoken, obj));
        }
    ...
    public final GsonBuilder registerTypeHierarchyAdapter(Class class1, Object obj)
    {
        ...
        {
            hierarchyFactories.add(0, n.a(class1, obj));
        }
        if (obj instanceof TypeAdapter)
        {
