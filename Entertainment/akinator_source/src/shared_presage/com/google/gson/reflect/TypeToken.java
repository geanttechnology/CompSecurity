...
package shared_presage.com.google.gson.reflect;
...
public class TypeToken
{
    ...
    protected TypeToken()
    {
        ...
        rawType = shared_presage.com.google.gson.internal..Gson.Types.getRawType(type);
        hashCode = type.hashCode();
    }

    TypeToken(Type type1)
    {
        type = shared_presage.com.google.gson.internal..Gson.Types.canonicalize((Type)shared_presage.com.google.gson.internal..Gson.Preconditions.checkNotNull(type1));
        rawType = shared_presage.com.google.gson.internal..Gson.Types.getRawType(type);
        hashCode = type.hashCode();
    }
    ...
    static Type getSuperclassTypeParameter(Class class1)
    {
        ...
        {
            return shared_presage.com.google.gson.internal..Gson.Types.canonicalize(((ParameterizedType)class1).getActualTypeArguments()[0]);
        }
    }
...
_L3:
    ...
    private static boolean isAssignableFrom(Type type1, ParameterizedType parameterizedtype, Map map)
    {
        do
        {
            ...
            Class class1 = shared_presage.com.google.gson.internal..Gson.Types.getRawType(type1);
            int k;
            ...
            type1 = class1.getGenericSuperclass();
            map = new HashMap(map);
        } while (true);
    }
...
_L4:
    ...
    {
        return (obj instanceof TypeToken) && shared_presage.com.google.gson.internal..Gson.Types.equals(type, ((TypeToken)obj).type);
    }
    ...
    public boolean isAssignableFrom(Type type1)
    {
        ...
        {
            return rawType.isAssignableFrom(shared_presage.com.google.gson.internal..Gson.Types.getRawType(type1));
        }
        ...
        {
            return rawType.isAssignableFrom(shared_presage.com.google.gson.internal..Gson.Types.getRawType(type1)) && isAssignableFrom(type1, (GenericArrayType)type);
        } else
        {
    ...
    {
        return shared_presage.com.google.gson.internal..Gson.Types.typeToString(type);
    }
}
