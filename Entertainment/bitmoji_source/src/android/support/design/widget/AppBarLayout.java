...
public class AppBarLayout extends LinearLayout
{
    public static class Behavior extends ViewOffsetBehavior
    {
        ...
        private boolean canDragAppBarLayout()
        {
            ...
            {
                View view = (View)mLastNestedScrollingChildRef.get();
                flag = flag1;
                if (view != null)
                {
                    flag = flag1;
...
_L4:
            ...
            if (i != -1)
            {
                ...
                if (i != -1)
                {
                    i = (int)MotionEventCompat.getY(motionevent, i);
...
_L2:
            ...
            if (coordinatorlayout.isPointInChildBounds(appbarlayout, j, k) && canDragAppBarLayout())
            {
                mLastMotionY = k;
        ...
        public boolean onLayoutChild(CoordinatorLayout coordinatorlayout, AppBarLayout appbarlayout, int i)
        {
            ...
            if (j != 0)
            {
                ...
                if ((j & 2) != 0)
                {
                    ...
                    {
                        setAppBarTopBottomOffset(coordinatorlayout, appbarlayout, j);
                    }
                } else
                if ((j & 1) != 0)
                {
...
_L2:
            flag = flag1;
            if (!coordinatorlayout.isPointInChildBounds(appbarlayout, i, j)) goto _L6; else goto _L5
_L5:
            flag = flag1;
            if (!canDragAppBarLayout()) goto _L6; else goto _L7
_L7:
            mLastMotionY = j;
            mActivePointerId = MotionEventCompat.getPointerId(motionevent, 0);
            continue; /* Loop/switch isn't completed */
...
_L9:
        ...
        public volatile boolean onTouchEvent(CoordinatorLayout coordinatorlayout, View view, MotionEvent motionevent)
        {
...
label0:
            {
                ...
                if (j < i1)
                {
                    ...
                    if ((j1 & 1) != 0)
                    {
                        i += layoutparams.topMargin + l + layoutparams.bottomMargin;
                        if ((j1 & 2) == 0)
                        {
                            break label0;
                        }
