...
_L7:
    ...
    {
        float f = (float)mOriginalCapturedViewLeft + (float)view.getWidth() * SwipeDismissBehavior.access$500(SwipeDismissBehavior.this);
        float f1 = (float)mOriginalCapturedViewLeft + (float)view.getWidth() * SwipeDismissBehavior.access$600(SwipeDismissBehavior.this);
        if ((float)i <= f)
        {
