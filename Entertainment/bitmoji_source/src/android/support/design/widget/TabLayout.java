...
label0:
        {
            ...
            if (mMode == 1 && getChildCount() == 1)
            {
                ...
                {
                    int l = getChildMeasureSpec(j, getPaddingTop() + getPaddingBottom(), view.getLayoutParams().height);
                    view.measure(android.view.View.MeasureSpec.makeMeasureSpec(k, 0x40000000), l);
                }
            }
            int i1 = mRequestedTabMaxWidth;
            int j1 = getMeasuredWidth() - dpToPx(56);
            if (i1 != 0)
            {
                k = i1;
                if (i1 <= j1)
...
/*
    static int access$1202(TabLayout tablayout, int i)
    {
...
/*
    static ValueAnimatorCompat access$1502(TabLayout tablayout, ValueAnimatorCompat valueanimatorcompat)
    {
