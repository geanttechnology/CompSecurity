...
private class <init> extends AccessibilityDelegateCompat
{
    ...
    public void onInitializeAccessibilityNodeInfo(View view, AccessibilityNodeInfoCompat accessibilitynodeinfocompat)
    {
        ...
        view = TextInputLayout.access$200(TextInputLayout.this).getText();
        if (!TextUtils.isEmpty(view))
        {
            accessibilitynodeinfocompat.setText(view);
        }
        if (TextInputLayout.access$300(TextInputLayout.this) != null)
        {
            accessibilitynodeinfocompat.setLabelFor(TextInputLayout.access$300(TextInputLayout.this));
        }
