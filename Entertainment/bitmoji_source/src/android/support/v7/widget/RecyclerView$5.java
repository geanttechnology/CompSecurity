    ...
    implements allback
{
    ...
    void dispatchUpdate(pdateOp pdateop)
    {
        ...
        case 0: // '\0'
            RecyclerView.access$1300(RecyclerView.this).onItemsAdded(RecyclerView.this, pdateop.positionStart, pdateop.itemCount);
            return;

        case 1: // '\001'
            RecyclerView.access$1300(RecyclerView.this).onItemsRemoved(RecyclerView.this, pdateop.positionStart, pdateop.itemCount);
            return;

        case 2: // '\002'
            RecyclerView.access$1300(RecyclerView.this).onItemsUpdated(RecyclerView.this, pdateop.positionStart, pdateop.itemCount, pdateop.payload);
            return;

        case 3: // '\003'
            RecyclerView.access$1300(RecyclerView.this).onItemsMoved(RecyclerView.this, pdateop.positionStart, pdateop.itemCount, 1);
            break;
        }
    }
