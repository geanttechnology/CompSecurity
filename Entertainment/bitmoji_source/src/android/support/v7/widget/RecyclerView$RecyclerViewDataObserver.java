...
private class <init> extends <init>
{
    ...
    {
        if (RecyclerView.access$3400(RecyclerView.this) && RecyclerView.access$3500(RecyclerView.this) && RecyclerView.access$3600(RecyclerView.this))
        {
            ViewCompat.postOnAnimation(RecyclerView.this, RecyclerView.access$3700(RecyclerView.this));
            return;
        } else
        {
