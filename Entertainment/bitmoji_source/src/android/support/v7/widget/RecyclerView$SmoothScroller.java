        ...
        private void runIfNecessary(RecyclerView recyclerview)
        {
            ...
            if (changed)
            {
                ...
                if (mInterpolator == null)
                {
                    ...
                    {
                        RecyclerView.access$4900(recyclerview).smoothScrollBy(mDx, mDy);
                    } else
                    {
                        RecyclerView.access$4900(recyclerview).smoothScrollBy(mDx, mDy, mDuration);
                    }
                } else
                {
                    RecyclerView.access$4900(recyclerview).smoothScrollBy(mDx, mDy, mDuration, mInterpolator);
                }
...
label0:
    ...
    {
        return RecyclerView.access$1300(mRecyclerView).indViewByPosition(i);
    }

    public int getChildCount()
    {
        return RecyclerView.access$1300(mRecyclerView).etChildCount();
    }
    ...
    void start(RecyclerView recyclerview, mTargetPosition mtargetposition)
    {
        ...
        } else
        {
            ...
            onStart();
            RecyclerView.access$4900(mRecyclerView).tOnAnimation();
            return;
        }
    }
