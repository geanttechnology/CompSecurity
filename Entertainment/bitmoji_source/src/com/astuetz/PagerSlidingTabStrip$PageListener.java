    ...
    implements android.support.v4.view.
{
    ...
    private void updateTabStates(int i)
    {
        for (Iterator iterator = PagerSlidingTabStrip.access$600(PagerSlidingTabStrip.this).iterator(); iterator.hasNext(); ((View)iterator.next()).setSelected(false)) { }
        ((View)PagerSlidingTabStrip.access$600(PagerSlidingTabStrip.this).get(i)).setSelected(true);
    }
