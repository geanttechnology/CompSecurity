...
class this._cls2
    implements android.content.ge._cls7._cls1
{
    ...
    {
        ss._mth400(_fld1).loadUrl("javascript:imoji_app.getValueCallback(false)");
    }
...
/* anonymous class */
        ...
        implements Runnable
    {
        ...
        // Unreferenced inner class com/bitstrips/imoji/ui/AvatarBuilderActivity$AndroidNativeBridge$7$2

/* anonymous class */
        class AvatarBuilderActivity.AndroidNativeBridge._cls7._cls2
