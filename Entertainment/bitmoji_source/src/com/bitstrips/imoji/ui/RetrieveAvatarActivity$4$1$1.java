...
/* anonymous class */
    ...
    // Unreferenced inner class com/bitstrips/imoji/ui/RetrieveAvatarActivity$4$1

/* anonymous class */
    class RetrieveAvatarActivity._cls4._cls1
        implements Callback
    {
        ...
        public void success(LinkAccountsResult linkaccountsresult, Response response)
        {
            if (linkaccountsresult.success().booleanValue())
            {
                ...
                bitstripsService.getAvatarInfo(fbToken, bsauthToken, linkaccountsresult, new RetrieveAvatarActivity._cls4._cls1._cls1());
                return;
            } else
            {
                RetrieveAvatarActivity.access$000(this$0);
