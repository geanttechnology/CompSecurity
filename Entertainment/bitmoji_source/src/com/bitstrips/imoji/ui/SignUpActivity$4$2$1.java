...
//            RetrieveAvatarActivity, SignUpActivity, ImageLoader

class nit> extends GetImageTask
{

    final onPostExecute this$2;
    ...
    self(Activity activity, ImageLoader imageloader)
    {
...
/* anonymous class */
    ...
    // Unreferenced inner class com/bitstrips/imoji/ui/SignUpActivity$4$2

/* anonymous class */
    class SignUpActivity._cls4._cls2
        implements Callback
    {
        ...
        public void success(BSAuthEmailLookup bsauthemaillookup, Response response)
        {
            if (bsauthemaillookup.matchFound().booleanValue())
            {
                try
                {
                    (new SignUpActivity._cls4._cls2._cls1(self, imageLoader)).execute(new String[] {
