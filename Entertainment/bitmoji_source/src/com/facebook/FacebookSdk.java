...
public final class FacebookSdk
{
    ...
    static GraphResponse publishInstallAndWaitForResponse(Context context, String s)
    {
        ...
        context = AppEventsLoggerUtility.getJSONObjectForGraphAPICall(com.facebook.internal.AppEventsLoggerUtility.GraphAPIActivityType.MOBILE_INSTALL_EVENT, ((AttributionIdentifiers) (obj)), AppEventsLogger.getAnonymousAppDeviceGUID(context), getLimitEventAndDataUsage(context), context);
