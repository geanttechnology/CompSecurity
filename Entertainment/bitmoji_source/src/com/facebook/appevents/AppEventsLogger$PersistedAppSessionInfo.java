...
_L4:
        obj1 = obj;
        Log.d(AppEventsLogger.access$1400(), (new StringBuilder()).append("Got unexpected exception: ").append(((Exception) (obj2)).toString()).toString());
        Utility.closeQuietly(((java.io.Closeable) (obj)));
        context.deleteFile("AppEventsLogger.persistedsessioninfo");
        if (appSessionInfoMap == null)
        {
...
_L4:
        obj = context;
        Log.d(AppEventsLogger.access$1400(), (new StringBuilder()).append("Got unexpected exception: ").append(((Exception) (obj1)).toString()).toString());
        Utility.closeQuietly(context);
          goto _L1
_L2:
        obj2;
