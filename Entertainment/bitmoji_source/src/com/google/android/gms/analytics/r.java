...
class r extends af
{
    ...
    private void bD()
    {
        mHandler = new Handler(mContext.getMainLooper(), new android.os.Handler.Callback() {
            ...
            public boolean handleMessage(Message message)
            {
                if (1 == message.what && r.bG().equals(message.obj))
                {
                    ...
                    if (r.b(rv) > 0 && !r.c(rv))
                    {
                        r.d(rv).sendMessageDelayed(r.d(rv).obtainMessage(1, r.bG()), r.b(rv) * 1000);
                    }
                }
                return true;
            }
        ...
        if (rl > 0)
        {
            mHandler.sendMessageDelayed(mHandler.obtainMessage(1, ri), rl * 1000);
        }
    }
...
_L2:
        ...
        aa.v(stringbuilder.append(((String) (obj))).toString());
        rt = flag;
        rp = flag1;
