...
_L4:
        ...
        {
            wT.putString(((String) (obj1)), (String)obj);
        }
        continue; /* Loop/switch isn't completed */
_L7:
        try
...
_L5:
        ...
        {
            wT.putInt(((String) (obj1)), ((Integer)obj).intValue());
        }
        continue; /* Loop/switch isn't completed */
_L6:
        if (obj instanceof Double)
        {
            wT.putDouble(((String) (obj1)), ((Double)obj).doubleValue());
        }
        continue; /* Loop/switch isn't completed */
_L2:
        ...
        {
            wT.putString(((String) (obj)), (String)obj1);
            continue; /* Loop/switch isn't completed */
        }
        if (obj1 instanceof Integer)
        {
            wT.putInt(((String) (obj)), ((Integer)obj1).intValue());
            continue; /* Loop/switch isn't completed */
        }
        try
        {
            ...
            {
                wT.putDouble(((String) (obj)), ((Double)obj1).doubleValue());
            }
            continue; /* Loop/switch isn't completed */
        }
        // Misplaced declaration of an exception variable
...
_L8:
    ...
    public boolean equals(Object obj)
    {
        if (this != obj)
        {
            ...
            if (!a(wT, ((MediaMetadata) (obj)).wT) || !wl.equals(((MediaMetadata) (obj)).wl))
            {
                return false;
            }
        }
    ...
    public int hashCode()
    {
        ...
        String s;
        int i;
        for (i = 17; iterator.hasNext(); i = wT.get(s).hashCode() + i * 31)
        {
            s = (String)iterator.next();
        }
