...
//            GooglePlayServicesRepairableException, GooglePlayServicesNotAvailableException, b, ErrorDialogFragment
...
_L4:
    ...
    public static Dialog a(int i, Activity activity, int j, android.content.DialogInterface.OnCancelListener oncancellistener, int k)
    {
        ...
        oncancellistener = new ef(activity, a(((Context) (activity)), i, k), j);
...
_L2:
        ...
        context = ((Context) (obj));
        if (!E(j)) goto _L10; else goto _L9
_L9:
...
_L3:
        ...
        context = ((Context) (obj));
        if (!E(j)) goto _L10; else goto _L11
_L11:
        return (new StringBuilder()).append(((String) (obj))).append(" (via Bazaar)").toString();
_L7:
...
_L8:
    ...
    public static int isGooglePlayServicesAvailable(Context context)
    {
        ...
        try
        {
            context = packagemanager.getPackageInfo("com.google.android.gms", 64);
        }
        // Misplaced declaration of an exception variable
        catch (Context context)
        {
        ...
        abyte0 = a(packageinfo, yL);
        if (abyte0 == null)
        {
            Log.w("GooglePlayServicesUtil", "Google Play Store signature invalid.");
            return 9;
        }
        if (a(context, new byte[][] {
    abyte0
}) == null)
        {
        ...
        if (((PackageInfo) (context)).versionCode < 0x41f6b8)
        {
            Log.w("GooglePlayServicesUtil", (new StringBuilder()).append("Google Play services out of date.  Requires 4323000 but found ").append(((PackageInfo) (context)).versionCode).toString());
            return 2;
        }
        try
        {
    ...
    public static boolean showErrorDialogFragment(int i, Activity activity, int j, android.content.DialogInterface.OnCancelListener oncancellistener)
    {
        ...
        boolean flag;
        flag = false;
        dialog = getErrorDialog(i, activity, j, oncancellistener);
        if (dialog == null)
        {
            return false;
        }
...
_L2:
        if (flag)
        {
            ...
            com.google.android.gms.common.b.a(dialog, oncancellistener).show(activity, "GooglePlayServicesErrorDialog");
        } else
        if (fr.eJ())
        {
            activity = activity.getFragmentManager();
            ErrorDialogFragment.newInstance(dialog, oncancellistener).show(activity, "GooglePlayServicesErrorDialog");
        } else
        {
...
_L1:
    ...
    private static boolean u(Context context)
    {
        ...
        } else
        {
            try
            {
                context = a(context.getPackageManager().getPackageInfo("com.google.android.apps.bazaar", 64), yR);
            }
            // Misplaced declaration of an exception variable
            catch (Context context)
            {
