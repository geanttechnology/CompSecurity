...
public class co
{
    ...
    public Bundle toBundle()
    {
        ...
        ArrayList arraylist;
        obj1 = new Bundle();
        ((Bundle) (obj1)).putString("seqnum", pk);
        ((Bundle) (obj1)).putString("slotid", pl);
        ((Bundle) (obj1)).putBoolean("ismediation", oI);
        ((Bundle) (obj1)).putLong("treq", pq);
        ((Bundle) (obj1)).putLong("tresponse", pr);
        ((Bundle) (obj1)).putLong("timp", pn);
        ((Bundle) (obj1)).putLong("tload", po);
        ((Bundle) (obj1)).putLong("pcc", pp);
        ((Bundle) (obj1)).putLong("tfetch", pm);
