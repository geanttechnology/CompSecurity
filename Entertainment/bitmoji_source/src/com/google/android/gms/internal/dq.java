...
public final class dq extends eh
{
    ...
    private void a(String s, double d1, boolean flag)
    {
        ...
        xE.b("hasChange=%b, mFirstStatusUpdate=%b", new Object[] {
            Boolean.valueOf(flag2), Boolean.valueOf(xL)
        });
        if (wz != null && (flag2 || xL))
        {
            wz.onVolumeChanged();
...
label0:
        ...
        throws IllegalArgumentException, RemoteException
    {
        ...
        xE.a(illegalstateexception, "Error unregistering namespace (%s): %s", new Object[] {
        ...
        throws RemoteException
    {
        ...
        xE.b("getServiceFromBroker(): mLastApplicationId=%s, mLastSessionId=%s", new Object[] {
            xO, xP
        });
...
_L2:
        ...
        Object obj;
        obj;
        xE.b("Error while disconnecting the controller interface: %s", new Object[] {
