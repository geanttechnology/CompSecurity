...
public class dz
{
    ...
    public static Calendar V(String s)
    {
        ...
        {
            xE.b("Error parsing string: %s", new Object[] {
                s.getMessage()
            });
            return null;
        }
    ...
    private static String W(String s)
    {
        ...
        {
            xE.c("Error extracting the date: %s", new Object[] {
                s.getMessage()
            });
            return null;
        }
...
_L2:
        ...
        {
            xE.b("Error extracting the time substring: %s", new Object[] {
                s.getMessage()
            });
            return null;
        }
...
_L3:
        return null;
_L4:
        if (!Y(s)) goto _L7; else goto _L6
_L6:
        return s.replaceAll("([\\+\\-]\\d\\d):(\\d\\d)", "$1$2");
        if (s.length() != "HHmmss".length() + yE[0].length()) goto _L7; else goto _L8
_L8:
    ...
    private static boolean Y(String s)
    {
        int i = s.length();
        int j = "HHmmss".length();
        return i == yE[1].length() + j || i == yE[2].length() + j || i == j + yE[3].length();
    }
    ...
    public static String a(Calendar calendar)
    {
        ...
        } else
        {
            ...
            {
                return ((String) (obj)).replace("+0000", yE[0]);
            }
        }
        return calendar;
    }
...
_L1:
    ...
    public static void a(JSONObject jsonobject, List list)
    {
        ...
        for (list = list.iterator(); list.hasNext(); jsonarray.put(((WebImage)list.next()).cT())) { }
