    ...
    implements SafeParcelable
{
    ...
    {
        Object obj = fb1.getClass();
        if (!fe1.b(((Class) (obj))))
        {
            HashMap hashmap = fb1.en();
            fe1.a(((Class) (obj)), fb1.en());
            ...
            do
            {
                ...
                fb1 = (fb.a)hashmap.get((String)((Iterator) (obj)).next());
                Class class1 = fb1.ev();
                if (class1 != null)
                {
                    try
                    {
                        a(fe1, (fb)class1.newInstance());
                    }
                    // Misplaced declaration of an exception variable
                    catch (fe fe1)
                    {
                        throw new IllegalStateException((new StringBuilder()).append("Could not instantiate an object of type ").append(fb1.ev().getCanonicalName()).toString(), fe1);
                    }
                    // Misplaced declaration of an exception variable
                    catch (fe fe1)
                    {
                        throw new IllegalStateException((new StringBuilder()).append("Could not access object of type ").append(fb1.ev().getCanonicalName()).toString(), fe1);
                    }
                }
            } while (true);
        }
    ...
    private void a(StringBuilder stringbuilder, HashMap hashmap, Parcel parcel)
    {
        ...
        do
        {
            ...
            java.util.Map.Entry entry = (java.util.Map.Entry)hashmap.get(Integer.valueOf(com.google.android.gms.common.internal.safeparcel.a.S(j)));
            if (entry != null)
            {
                if (flag)
                {
...
_L13:
        ...
        while (i < j) 
        {
            ...
            a(stringbuilder, a1.ez(), parcel[i]);
            i++;
        }
...
_L2:
        ...
        case 7: // '\007'
            ...
            stringbuilder.append("\"").append(fp.ap(a1)).append("\"");
            return;

        case 8: // '\b'
            a1 = com.google.android.gms.common.internal.safeparcel.a.p(parcel, i);
            stringbuilder.append("\"").append(fk.d(a1)).append("\"");
            return;

        case 9: // '\t'
            a1 = com.google.android.gms.common.internal.safeparcel.a.p(parcel, i);
            stringbuilder.append("\"").append(fk.e(a1));
            stringbuilder.append("\"");
            return;
        ...
        case 10: // '\n'
            ...
            for (i = 1; parcel.hasNext(); i = 0)
            {
                ...
                stringbuilder.append("\"").append(s).append("\"");
                stringbuilder.append(":");
                stringbuilder.append("\"").append(fp.ap(a1.getString(s))).append("\"");
            }
    ...
    private void b(StringBuilder stringbuilder, fb.a a1, ArrayList arraylist)
    {
        ...
        for (int i = 0; i < j; i++)
        {
            ...
            a(stringbuilder, a1.el(), arraylist.get(i));
        }
    ...
    private static HashMap c(HashMap hashmap)
    {
        ...
        for (hashmap = hashmap.entrySet().iterator(); hashmap.hasNext(); hashmap1.put(Integer.valueOf(((fb.a)entry.getValue()).eu()), entry))
        {
