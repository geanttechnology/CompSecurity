...
public static final class nd extends nd
{
...
_L1:
        ...
        bundle = nd.createPendingResult(Bq, intent, 0x40000000);
...
_L2:
        ...
        if (bundle.hasResolution())
        {
            try
            {
                bundle.startResolutionForResult(nd, Bq);
                return;
            }
            // Misplaced declaration of an exception variable
            catch (Bundle bundle)
        ...
        bundle = nd.createPendingResult(Bq, new Intent(), 0x40000000);
        if (bundle != null)
        {
            try
            {
