    ...
    implements Function
{
        ...
        implements Serializable
    {
        ...
        public String toString()
        {
            ...
            return (new StringBuilder(String.valueOf(s).length() + 10 + String.valueOf(s1).length())).append(s).append(".andThen(").append(s1).append(")").toString();
        }
        ...
        implements Serializable
    {
        ...
        public String toString()
        {
            String s = String.valueOf(forwardFunction);
            String s1 = String.valueOf(backwardFunction);
            return (new StringBuilder(String.valueOf(s).length() + 18 + String.valueOf(s1).length())).append("Converter.from(").append(s).append(", ").append(s1).append(")").toString();
        }
