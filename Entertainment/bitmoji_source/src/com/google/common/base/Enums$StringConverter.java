    ...
    implements Serializable
{
    ...
    {
        String s = String.valueOf(enumClass.getName());
        return (new StringBuilder(String.valueOf(s).length() + 29)).append("Enums.stringConverter(").append(s).append(".class)").toString();
    }
