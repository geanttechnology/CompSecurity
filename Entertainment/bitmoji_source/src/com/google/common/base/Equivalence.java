...
public abstract class Equivalence
{
        ...
        implements Predicate, Serializable
    {
        ...
        {
            String s = String.valueOf(equivalence);
            String s1 = String.valueOf(target);
            return (new StringBuilder(String.valueOf(s).length() + 15 + String.valueOf(s1).length())).append(s).append(".equivalentTo(").append(s1).append(")").toString();
        }
        ...
        implements Serializable
    {
        ...
        {
            String s = String.valueOf(equivalence);
            String s1 = String.valueOf(reference);
            return (new StringBuilder(String.valueOf(s).length() + 7 + String.valueOf(s1).length())).append(s).append(".wrap(").append(s1).append(")").toString();
        }
