...
public final class Functions
{
        ...
        implements Function, Serializable
    {
        ...
        {
            String s = String.valueOf(map);
            return (new StringBuilder(String.valueOf(s).length() + 18)).append("Functions.forMap(").append(s).append(")").toString();
        }
        ...
        implements Function, Serializable
    {
        ...
        public String toString()
        {
            ...
            return (new StringBuilder(String.valueOf(s).length() + 24)).append("Functions.forPredicate(").append(s).append(")").toString();
        }
        ...
        implements Function, Serializable
    {
        ...
        public String toString()
        {
            String s = String.valueOf(supplier);
            return (new StringBuilder(String.valueOf(s).length() + 23)).append("Functions.forSupplier(").append(s).append(")").toString();
        }
