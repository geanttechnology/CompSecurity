...
public final class Predicates
{
        ...
        implements Predicate, Serializable
    {
        ...
        {
            String s = Predicates.COMMA_JOINER.join(components);
            return (new StringBuilder(String.valueOf(s).length() + 16)).append("Predicates.and(").append(s).append(")").toString();
        }
        ...
        implements Predicate, Serializable
    {
        ...
        public String toString()
        {
            ...
            return (new StringBuilder(String.valueOf(s).length() + 27)).append("Predicates.assignableFrom(").append(s).append(")").toString();
        }
    ...
    private static class ContainsPatternFromStringPredicate extends ContainsPatternPredicate
    {
        ...
        public String toString()
        {
            String s = String.valueOf(pattern.pattern());
            return (new StringBuilder(String.valueOf(s).length() + 28)).append("Predicates.containsPattern(").append(s).append(")").toString();
        }
        ...
        implements Predicate, Serializable
    {
        ...
        public String toString()
        {
            String s = Objects.toStringHelper(pattern).add("pattern", pattern.pattern()).add("pattern.flags", pattern.flags()).toString();
        ...
        implements Predicate, Serializable
    {
        ...
        {
            String s = Predicates.COMMA_JOINER.join(components);
            return (new StringBuilder(String.valueOf(s).length() + 15)).append("Predicates.or(").append(s).append(")").toString();
        }
