...
_L2:
        ...
        {
            String s = String.valueOf(_flddelegate);
            long l = durationNanos;
            return (new StringBuilder(String.valueOf(s).length() + 62)).append("Suppliers.memoizeWithExpiration(").append(s).append(", ").append(l).append(", NANOS)").toString();
        }
...
_L2:
        ...
        {
            String s = String.valueOf(_flddelegate);
            return (new StringBuilder(String.valueOf(s).length() + 19)).append("Suppliers.memoize(").append(s).append(")").toString();
        }
        ...
        implements Supplier, Serializable
    {
        ...
        public String toString()
        {
            ...
            String s1 = String.valueOf(supplier);
            return (new StringBuilder(String.valueOf(s).length() + 21 + String.valueOf(s1).length())).append("Suppliers.compose(").append(s).append(", ").append(s1).append(")").toString();
        }
        ...
        implements Supplier, Serializable
    {
        ...
        {
            String s = String.valueOf(_flddelegate);
            return (new StringBuilder(String.valueOf(s).length() + 32)).append("Suppliers.synchronizedSupplier(").append(s).append(")").toString();
        }
