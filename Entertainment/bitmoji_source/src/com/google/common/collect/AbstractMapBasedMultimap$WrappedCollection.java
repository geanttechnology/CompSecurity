...
private class ancestorDelegate extends AbstractCollection
{
    ...
    public boolean addAll(Collection collection)
    {
        ...
        } else
        {
            ...
            if (flag1)
            {
                ...
                AbstractMapBasedMultimap.access$202(AbstractMapBasedMultimap.this, AbstractMapBasedMultimap.access$200(AbstractMapBasedMultimap.this) + (j - i));
                flag = flag1;
                if (i == 0)
                {
                    addToMap();
    ...
    public void clear()
    {
        ...
        {
            _flddelegate.clear();
            AbstractMapBasedMultimap.access$202(AbstractMapBasedMultimap.this, AbstractMapBasedMultimap.access$200(AbstractMapBasedMultimap.this) - i);
            removeIfEmpty();
            return;
        }
    }
