...
_L2:
        ...
        public String toString()
        {
            ...
            return (new StringBuilder(String.valueOf(s).length() + 30)).append("orderedPermutationCollection(").append(s).append(")").toString();
        }
    ...
    private static final class PermutationCollection extends AbstractCollection
    {
        ...
        {
            String s = String.valueOf(inputList);
            return (new StringBuilder(String.valueOf(s).length() + 14)).append("permutations(").append(s).append(")").toString();
        }
