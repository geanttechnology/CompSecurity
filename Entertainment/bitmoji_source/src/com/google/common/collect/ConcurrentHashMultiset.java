...
//            CollectPreconditions, Maps, Iterators, Multiset, 
    ...
    public int add(Object obj, int i)
    {
        ...
        do
        {
            ...
            do
            {
                ...
                try
                {
                    flag = atomicinteger.compareAndSet(j, IntMath.checkedAdd(j, i));
                }
        ...
        } while (countMap.putIfAbsent(obj, atomicinteger1) != null && !countMap.replace(obj, atomicinteger, atomicinteger1));
        return 0;
    }
...
_L2:
        CollectPreconditions.checkPositive(i, "occurences");
        AtomicInteger atomicinteger = (AtomicInteger)Maps.safeGet(countMap, obj);
