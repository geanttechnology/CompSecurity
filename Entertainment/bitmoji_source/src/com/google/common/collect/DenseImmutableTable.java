...
//            RegularImmutableTable, ImmutableSet, Maps, ImmutableMap, 
//            ImmutableList, UnmodifiableIterator, AbstractIterator
...
final class DenseImmutableTable extends RegularImmutableTable
{
    ...
    DenseImmutableTable(ImmutableList immutablelist, ImmutableSet immutableset, ImmutableSet immutableset1)
    {
        ...
        rowKeyToIndex = Maps.indexMap(immutableset);
        columnKeyToIndex = Maps.indexMap(immutableset1);
