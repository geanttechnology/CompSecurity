...
//            ImmutableList, Maps, ImmutableMultiset, ImmutableSet, 
//            Ordering, ImmutableSortedSet, ImmutableListMultimap, ImmutableMap
    ...
    implements Iterable
{
        ...
        implements Function
    {
        ...
        public FluentIterable apply(Iterable iterable1)
        {
            return FluentIterable.from(iterable1);
        }
    ...
    public static FluentIterable from(Iterable iterable1)
    {
        ...
        {
            return new FluentIterable(iterable1, iterable1) {
