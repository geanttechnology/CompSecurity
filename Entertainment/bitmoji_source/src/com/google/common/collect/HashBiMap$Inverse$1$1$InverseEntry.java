...
//            AbstractMapEntry, HashBiMap, Hashing
...
class delegate extends AbstractMapEntry
{
    ...
    public Object setValue(Object obj)
    {
        ...
        boolean flag;
        if (HashBiMap.access$300(this._cls3.this._flddelegate._flddelegate._flddelegate, obj, i) == null)
        {
            flag = true;
        } else
        {
        ...
        HashBiMap.access$500(this._cls3.this._flddelegate._flddelegate._flddelegate, ((this._cls3) (obj)), null);
        unt = HashBiMap.access$100(unt);
        return obj1;
    }
