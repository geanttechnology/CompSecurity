...
//            RangeMap, ImmutableList, ImmutableMap, ImmutableSortedMap, 
//            RegularImmutableSortedSet, Range, Ordering, Cut, 
...
label0:
            {
                ...
                obj = String.valueOf(entry);
                throw new IllegalArgumentException((new StringBuilder(String.valueOf(range).length() + 47 + String.valueOf(obj).length())).append("Overlapping ranges: range ").append(range).append(" overlaps with entry ").append(((String) (obj))).toString());
            }
            keyRanges.add(range);
        ...
        implements Serializable
    {
        ...
        Object createRangeMap()
        {
            ...
            java.util.Map.Entry entry;
            for (UnmodifiableIterator unmodifiableiterator = mapOfRanges.entrySet().iterator(); unmodifiableiterator.hasNext(); builder1.put((Range)entry.getKey(), entry.getValue()))
            {
