...
//            ImmutableSortedMultisetFauxverideShim, SortedMultiset, Ordering, RegularImmutableSortedMultiset, 
//            ImmutableSet, Lists, TreeMultiset, Iterables, 
//            RegularImmutableSortedSet, ImmutableSortedSet, DescendingImmutableSortedMultiset, BoundType, 
    ...
    implements SortedMultiset
{
    ...
    private static ImmutableSortedMultiset copyOfSortedEntries(Comparator comparator1, Collection collection)
    {
        ...
        for (Iterator iterator = collection.iterator(); iterator.hasNext();)
        {
            ...
            al[i + 1] = al[i] + (long)entry.getCount();
            i++;
        }

        return new RegularImmutableSortedMultiset(new RegularImmutableSortedSet(builder.build(), comparator1), al, 0, collection.size());
    }
    ...
    static ImmutableSortedMultiset emptyMultiset(Comparator comparator1)
    {
        ...
        {
            return new RegularImmutableSortedMultiset(comparator1);
        }
    }
    ...
    {
        return new RegularImmutableSortedMultiset((RegularImmutableSortedSet)ImmutableSortedSet.of(comparable), new long[] {
            0L, 1L
        }, 0, 1);
    }
    ...
    public ImmutableSortedMultiset descendingMultiset()
    {
        ...
        if (obj == null)
        {
            if (isEmpty())
            {
                obj = emptyMultiset(Ordering.from(comparator()).reverse());
            } else
            {
