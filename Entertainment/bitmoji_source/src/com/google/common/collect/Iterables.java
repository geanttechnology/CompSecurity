...
//            Multiset, ObjectArrays, ImmutableCollection, FluentIterable, 
//            CollectPreconditions, ConsumingQueueIterator, TransformedIterator
...
_L3:
    ...
    static Object[] toArray(Iterable iterable, Object aobj[])
    {
        return toCollection(iterable).toArray(aobj);
    }
