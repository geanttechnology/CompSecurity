...
//            ConsumingQueueIterator, Lists, UnmodifiableIterator, PeekingIterator, 
...
public final class Iterators
{
    ...
    public static Iterator concat(Iterator iterator, Iterator iterator1)
    {
        ...
        return concat(((Iterator) (new ConsumingQueueIterator(new Iterator[] {
            iterator, iterator1
        }))));
    }
    ...
    {
        Iterator aiterator1[] = (Iterator[])Preconditions.checkNotNull(aiterator);
        int j = aiterator1.length;
        for (int i = 0; i < j; i++)
        {
            Preconditions.checkNotNull(aiterator1[i]);
        }

        return concat(((Iterator) (new ConsumingQueueIterator(aiterator))));
    }
    ...
    public static Iterator cycle(Iterable iterable)
    {
        ...
        return new Iterator(iterable) {
            ...
            
            {
                iterable = iterable1;
                super();
                iterator = Iterators.emptyModifiableIterator();
            }
        };
    }
