    ...
    implements Serializable
{
    ...
    {
        String s = String.valueOf(elementOrder);
        return (new StringBuilder(String.valueOf(s).length() + 18)).append(s).append(".lexicographical()").toString();
    }
}
