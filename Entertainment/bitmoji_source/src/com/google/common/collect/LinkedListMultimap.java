...
//            Lists, Iterators, Multiset, TransformedListIterator, 
//            Sets, CollectPreconditions, AbstractMapEntry

public class LinkedListMultimap extends AbstractMultimap
    implements ListMultimap, Serializable
{
    class _cls1EntriesImpl extends AbstractSequentialList
    {
    ...
    class _cls1KeySetImpl extends Sets.ImprovedAbstractSet
    {
    ...
    class _cls1ValuesImpl extends AbstractSequentialList
    {
