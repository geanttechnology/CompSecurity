...
public final class Lists
{
    ...
    public static transient List cartesianProduct(List alist[])
    {
    ...
    static boolean equalsImpl(List list, Object obj)
    {
        if (obj != Preconditions.checkNotNull(list))
        {
            ...
            if ((list instanceof RandomAccess) && (obj instanceof RandomAccess))
            {
                ...
                while (i < j) 
                {
                    if (!Objects.equal(list.get(i), ((List) (obj)).get(i)))
                    {
                        return false;
                    }
                    i++;
            ...
            {
                return Iterators.elementsEqual(list.iterator(), ((List) (obj)).iterator());
            }
        }
        return true;
    }
