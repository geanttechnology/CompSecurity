...
public final class MapMaker extends GenericMapMaker
{
        ...
        implements Serializable
    {
        ...
        public Object get(Object obj)
        {
            ...
            if (obj1 == null)
            {
                obj1 = String.valueOf(computingFunction);
                obj = String.valueOf(obj);
                throw new NullPointerException((new StringBuilder(String.valueOf(obj1).length() + 24 + String.valueOf(obj).length())).append(((String) (obj1))).append(" returned null for key ").append(((String) (obj))).append(".").toString());
            } else
            {
                return obj1;
            }
    ...
    volatile GenericMapMaker softValues()
    {
        return softValues();
    }
