...
//            MapMaker, Iterators, ForwardingConcurrentMap, CollectPreconditions, 
//            AbstractSequentialIterator, AbstractMapEntry
    ...
    implements ConcurrentMap, Serializable
{
    ...
    private static abstract class SafeToArraySet extends AbstractSet
    {
        ...
        {
            return MapMakerInternalMap.toArrayList(this).toArray(aobj);
        }
