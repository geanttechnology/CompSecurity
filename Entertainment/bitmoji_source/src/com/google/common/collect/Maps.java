...
//            TransformedIterator, ForwardingSet, ForwardingMapEntry, Iterables, 
...
public final class Maps
{
    ...
    class AsMapView._cls1EntrySetImpl extends EntrySet
    {
        ...
        implements Serializable
    {
        ...
        {
            String s = String.valueOf(bimap);
            return (new StringBuilder(String.valueOf(s).length() + 18)).append("Maps.asConverter(").append(s).append(")").toString();
        }
    ...
    class DescendingMap._cls1EntrySetImpl extends EntrySet
    {
        ...
        DescendingMap._cls1EntrySetImpl()
        {
...
label0:
    ...
    static abstract class IteratorBasedAbstractMap extends AbstractMap
    {
        ...
        public Set entrySet()
        {
            ...
            {
                this$0 = IteratorBasedAbstractMap.this;
                super();
            }
            };
        }
        ...
        implements MapDifference.ValueDifference
    {
        ...
        public String toString()
        {
            ...
            String s1 = String.valueOf(right);
    ...
    public static MapDifference difference(Map map, Map map1, Equivalence equivalence)
    {
        ...
        doDifference(map, map1, equivalence, linkedhashmap, linkedhashmap1, linkedhashmap2, linkedhashmap3);
        return new MapDifferenceImpl(linkedhashmap, linkedhashmap1, linkedhashmap2, linkedhashmap3);
    }
    ...
    static ImmutableMap indexMap(Collection collection)
    {
        ...
        {
            builder.put(collection.next(), Integer.valueOf(i));
            i++;
        }
    ...
    public static ImmutableMap uniqueIndex(Iterator iterator, Function function)
    {
        ...
        {
            throw new IllegalArgumentException(String.valueOf(iterator.getMessage()).concat(". To index multiple values under a key, use Multimaps.index."));
        }
        return iterator;
    }
    ...
    static UnmodifiableIterator unmodifiableEntryIterator(Iterator iterator)
    {
        return new UnmodifiableIterator(iterator) {
            ...
            {
                return Maps.unmodifiableEntry((java.util.Map.Entry)entryIterator.next());
            }
