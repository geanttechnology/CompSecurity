...
public final class Multisets
{
        ...
        implements Multiset.Entry
    {
        ...
        public String toString()
        {
            ...
            {
                return (new StringBuilder(String.valueOf(s).length() + 14)).append(s).append(" x ").append(i).toString();
            }
        }
    ...
    static abstract class ElementSet extends Sets.ImprovedAbstractSet
    {
        ...
        {
            return multiset().remove(obj, 0x7fffffff) > 0;
        }
    ...
    static class ImmutableEntry extends AbstractEntry
...
_L3:
    ...
    {
        if (!(iterable instanceof Multiset)) goto _L2; else goto _L1
_L1:
        boolean flag1 = removeOccurrences(multiset, (Multiset)iterable);
_L4:
        return flag1;
_L2:
        Preconditions.checkNotNull(multiset);
