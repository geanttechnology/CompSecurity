...
private final class <init> extends ImmutableBiMap
{
    final class InverseEntrySet extends ImmutableMapEntrySet
    {
        ...
        ImmutableList createAsList()
        {
            return new ImmutableAsList() {
                ...
                {
                    java.util.Map.Entry entry = RegularImmutableBiMap.access$400(this$0)[i];
        ...
        public int hashCode()
        {
            return RegularImmutableBiMap.access$300(this$0);
        }
    ...
    public Object get(Object obj)
    {
        if (obj != null && RegularImmutableBiMap.access$100(RegularImmutableBiMap.this) != null)
        {
            ...
            int j = RegularImmutableBiMap.access$200(RegularImmutableBiMap.this);
            ImmutableMapEntry immutablemapentry = RegularImmutableBiMap.access$100(RegularImmutableBiMap.this)[i & j];
