...
_L6:
    ...
    ImmutableSortedSet createDescendingSet()
    {
        ...
        {
            return new RegularImmutableSortedSet(elements.reverse(), ordering);
        }
    }
...
_L6:
        if (!unmodifiableiterator.hasNext()) goto _L1; else goto _L4
_L4:
        Object obj1;
        Object obj2;
...
_L5:
    ...
    RegularImmutableSortedSet getSubSet(int i, int j)
    {
        if (i == 0 && j == size())
        {
            return this;
