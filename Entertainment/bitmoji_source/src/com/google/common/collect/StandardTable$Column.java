...
private class ll extends actMap
{
    ...
    private class EntrySetIterator extends AbstractIterator
    {
        ...
        EntrySetIterator(StandardTable._cls1 _pcls1)
        {
            this();
        }
    }

    class EntrySetIterator._cls1EntryImpl extends AbstractMapEntry
    {
        ...
        {
            return ((Map)entry.getValue()).put(columnKey, Precondit