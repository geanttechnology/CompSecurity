...
//            TransformedIterator, ForwardingMapEntry
...
_L3:
    ...
    private static class SynchronizedAsMapEntries extends SynchronizedSet
    {
        ...
        public Iterator iterator()
        {
            ...
            {
                this$0 = SynchronizedAsMapEntries.this;
                super(iterator);
            }
            };
        }
    ...
    private static class SynchronizedAsMapValues extends SynchronizedCollection
    {
        ...
        public Iterator iterator()
        {
            return new TransformedIterator(super.iterator()) {
                ...
                Collection transform(Collection collection1)
                {
                    return Synchronized.typePreservingCollection(collection1, mutex);
                }

            
            {
                this$0 = SynchronizedAsMapValues.this;
                super(iterator);
            }
            };
        }
    ...
    private static final class SynchronizedDeque extends SynchronizedQueue
        implements Deque
    {
    ...
    private static class SynchronizedEntry extends SynchronizedObject
        implements java.util.Map.Entry
    {
        ...
        {
            return (java.util.Map.Entry)super._mthdelegate();
        }
        ...
        implements NavigableMap
    {
        ...
        public java.util.Map.Entry ceilingEntry(Object obj)
        {
            synchronized (mutex)
            {
                obj = Synchronized.nullableSynchronizedEntry(_mthdelegate().ceilingEntry(obj), mutex);
            }
        ...
        public Object ceilingKey(Object obj)
        {
            synchronized (mutex)
            {
                obj = _mthdelegate().ceilingKey(obj);
            }
            return obj;
            obj;
            obj1;
        ...
        {
            return (NavigableMap)super._mthdelegate();
        }
...
label0:
            {
                ...
                synchronized (mutex)
                {
                    ...
                    navigableset = Synchronized.navigableSet(_mthdelegate().descendingKeySet(), mutex);
                    descendingKeySet = navigableset;
                }
                return navigableset;
            }
            NavigableSet navigableset1 = descendingKeySet;
            obj;
            JVM INSTR monitorexit ;
...
label0:
            {
                ...
                synchronized (mutex)
                {
                    ...
                    navigablemap = Synchronized.navigableMap(_mthdelegate().descendingMap(), mutex);
                    descendingMap = navigablemap;
                }
                return navigablemap;
            }
            NavigableMap navigablemap1 = descendingMap;
            obj;
            JVM INSTR monitorexit ;
        ...
        public java.util.Map.Entry firstEntry()
        {
            ...
            synchronized (mutex)
            {
                entry = Synchronized.nullableSynchronizedEntry(_mthdelegate().firstEntry(), mutex);
            }
            return entry;
            exception;
            obj;
        ...
        public java.util.Map.Entry floorEntry(Object obj)
        {
            synchronized (mutex)
            {
                obj = Synchronized.nullableSynchronizedEntry(_mthdelegate().floorEntry(obj), mutex);
            }
            return ((java.util.Map.Entry) (obj));
            obj;
            obj1;
        ...
        public NavigableMap headMap(Object obj, boolean flag)
        {
            synchronized (mutex)
            {
                obj = Synchronized.navigableMap(_mthdelegate().headMap(obj, flag), mutex);
            }
        ...
        public java.util.Map.Entry higherEntry(Object obj)
        {
            synchronized (mutex)
            {
                obj = Synchronized.nullableSynchronizedEntry(_mthdelegate().higherEntry(obj), mutex);
            }
            return ((java.util.Map.Entry) (obj));
            obj;
            obj1;
        ...
        public Object higherKey(Object obj)
        {
            synchronized (mutex)
            {
                obj = _mthdelegate().higherKey(obj);
            }
            return obj;
            obj;
            obj1;
        ...
        public java.util.Map.Entry lastEntry()
        {
            ...
            synchronized (mutex)
            {
                entry = Synchronized.nullableSynchronizedEntry(_mthdelegate().lastEntry(), mutex);
            }
            return entry;
            exception;
            obj;
        ...
        public java.util.Map.Entry lowerEntry(Object obj)
        {
            synchronized (mutex)
            {
                obj = Synchronized.nullableSynchronizedEntry(_mthdelegate().lowerEntry(obj), mutex);
            }
            return ((java.util.Map.Entry) (obj));
            obj;
            obj1;
...
label0:
            {
                ...
                synchronized (mutex)
                {
                    ...
                    navigableset = Synchronized.navigableSet(_mthdelegate().navigableKeySet(), mutex);
                    navigableKeySet = navigableset;
                }
                return navigableset;
            }
            NavigableSet navigableset1 = navigableKeySet;
            obj;
            JVM INSTR monitorexit ;
            return navigableset1;
            exception;
        ...
        public java.util.Map.Entry pollFirstEntry()
        {
            ...
            synchronized (mutex)
            {
                entry = Synchronized.nullableSynchronizedEntry(_mthdelegate().pollFirstEntry(), mutex);
            }
            return entry;
            exception;
            obj;
        ...
        public java.util.Map.Entry pollLastEntry()
        {
            ...
            synchronized (mutex)
            {
                entry = Synchronized.nullableSynchronizedEntry(_mthdelegate().pollLastEntry(), mutex);
            }
            return entry;
            exception;
            obj;
        ...
        public NavigableMap subMap(Object obj, boolean flag, Object obj1, boolean flag1)
        {
            synchronized (mutex)
            {
                obj = Synchronized.navigableMap(_mthdelegate().subMap(obj, flag, obj1, flag1), mutex);
            }
            return ((NavigableMap) (obj));
            obj;
            obj2;
        ...
        public NavigableMap tailMap(Object obj, boolean flag)
        {
            synchronized (mutex)
            {
                obj = Synchronized.navigableMap(_mthdelegate().tailMap(obj, flag), mutex);
            }
            return ((NavigableMap) (obj));
            obj;
            obj1;
        ...
        implements NavigableSet
    {
        ...
        {
            return (NavigableSet)super._mthdelegate();
        }
...
label0:
    ...
    private static class SynchronizedQueue extends SynchronizedCollection
        implements Queue
    {
    ...
    {
        return new SynchronizedDeque(deque1, obj);
    }
    ...
    {
        if (queue1 instanceof SynchronizedQueue)
        {
            return queue1;
        } else
        {
            return new SynchronizedQueue(queue1, obj);
        }
    }
