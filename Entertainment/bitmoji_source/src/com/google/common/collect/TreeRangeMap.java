...
_L1:
    ...
    private static final RangeMap EMPTY_SUB_RANGE_MAP = new RangeMap() {
        ...
        public void put(Range range, Object obj)
        {
            ...
            throw new IllegalArgumentException((new StringBuilder(String.valueOf(range).length() + 46)).append("Cannot insert range ").append(range).append(" into an empty subRangeMap").toString());
        }
