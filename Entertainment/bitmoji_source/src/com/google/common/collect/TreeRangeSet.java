...
public class TreeRangeSet extends AbstractRangeSet
{
    ...
    {
        Set set = asDescendingSetOfRanges;
        Object obj = set;
        if (set == null)
        {
            obj = new AsRanges(rangesByLowerBound.descendingMap().values());
            asDescendingSetOfRanges = ((Set) (obj));
        }
        return ((Set) (obj));
    }
    ...
    public Set asRanges()
    {
        ...
        if (set == null)
        {
            obj = new AsRanges(rangesByLowerBound.values());
            asRanges = ((Set) (obj));
        }
        return ((Set) (obj));
    }
