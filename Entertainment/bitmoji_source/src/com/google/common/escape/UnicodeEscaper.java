        ...
        if (i < j)
        {
            ...
            if (c <= '\uDBFF')
            {
                ...
                } else
                {
                    ...
                    throw new IllegalArgumentException((new StringBuilder(String.valueOf(charsequence).length() + 89)).append("Expected low surrogate but got char '").append(c1).append("' with value ").append(c1).append(" at index ").append(k).append(" in '").append(charsequence).append("'").toString());
                }
            } else
            {
                charsequence = String.valueOf(charsequence);
                throw new IllegalArgumentException((new StringBuilder(String.valueOf(charsequence).length() + 88)).append("Unexpected low surrogate character '").append(c).append("' with value ").append(c).append(" at index ").append(k - 1).append(" in '").append(charsequence).append("'").toString());
            }
        } else
        {
