    ...
    implements Predicate, Serializable
{
    ...
    {
        return create(funnel1, i);
    }

    public static BloomFilter create(Funnel funnel1, int i, double d)
    {
        return create(funnel1, i, d);
    }

    public static BloomFilter create(Funnel funnel1, long l)
    {
        return create(funnel1, l, 0.029999999999999999D);
    }

    public static BloomFilter create(Funnel funnel1, long l, double d)
    {
        return create(funnel1, l, d, ((Strategy) (BloomFilterStrategies.MURMUR128_MITZ_64)));
    }

    static BloomFilter create(Funnel funnel1, long l, double d, Strategy strategy1)
    {
        ...
        l = optimalNumOfBits(l1, d);
        i = optimalNumOfHashFunctions(l1, l);
        try
        {
        ...
        throws IOException
    {
        ...
        {
            funnel1 = String.valueOf("Unable to deserialize BloomFilter from InputStream. strategyOrdinal: ");
            funnel1 = new IOException((new StringBuilder(String.valueOf(funnel1).length() + 65)).append(funnel1).append(byte0).append(" numHashFunctions: ").append(j).append(" dataLength: ").append(i).toString());
