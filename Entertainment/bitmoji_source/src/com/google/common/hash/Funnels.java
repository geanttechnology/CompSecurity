...
public final class Funnels
{
        ...
        implements Funnel, Serializable
    {
        ...
        public String toString()
        {
            String s = String.valueOf(elementFunnel);
            return (new StringBuilder(String.valueOf(s).length() + 26)).append("Funnels.sequentialFunnel(").append(s).append(")").toString();
        }
    ...
    private static class SinkAsStream extends OutputStream
    {
        ...
        public String toString()
        {
            String s = String.valueOf(sink);
            return (new StringBuilder(String.valueOf(s).length() + 24)).append("Funnels.asOutputStream(").append(s).append(")").toString();
        }
        ...
        implements Funnel, Serializable
    {
        ...
        public String toString()
        {
            String s = String.valueOf(charset.name());
            return (new StringBuilder(String.valueOf(s).length() + 22)).append("Funnels.stringFunnel(").append(s).append(")").toString();
        }
