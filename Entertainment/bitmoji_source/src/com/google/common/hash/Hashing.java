...
public final class Hashing
{
    ...
    private static final class ConcatenatedHashFunction extends AbstractCompositeHashFunction
    {
        ...
        public boolean equals(Object obj)
        {
            if (obj instanceof ConcatenatedHashFunction)
            {
                ...
                return Arrays.equals(functions, ((ConcatenatedHashFunction) (obj)).functions);
            } else
            {
                return false;
            }
        ...
        private transient ConcatenatedHashFunction(HashFunction ahashfunction[])
        {
            super(ahashfunction);
            int j = 0;
    ...
    public static transient HashFunction concatenating(HashFunction hashfunction, HashFunction hashfunction1, HashFunction ahashfunction[])
    {
        ArrayList arraylist = new ArrayList();
        arraylist.add(hashfunction);
        arraylist.add(hashfunction1);
        int j = ahashfunction.length;
        for (int i = 0; i < j; i++)
        {
            arraylist.add(ahashfunction[i]);
        }
    ...
    public static HashFunction concatenating(Iterable iterable)
    {
        ...
        ArrayList arraylist = new ArrayList();
        for (iterable = iterable.iterator(); iterable.hasNext(); arraylist.add((HashFunction)iterable.next())) { }
        boolean flag;
        if (arraylist.size() > 0)
        {
            flag = true;
        ...
        Preconditions.checkArgument(flag, "number of hash functions (%s) must be > 0", new Object[] {
