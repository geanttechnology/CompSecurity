...
public final class InetAddresses
{
    ...
    private static String convertDottedQuadToHex(String s)
    {
        ...
        } else
        {
            ...
            return (new StringBuilder(String.valueOf(s1).length() + 1 + String.valueOf(s).length() + String.valueOf(s2).length())).append(s1).append(s).append(":").append(s2).toString();
        }
    }
...
_L17:
    ...
    public static String toUriString(InetAddress inetaddress)
    {
        ...
        {
            inetaddress = toAddrString(inetaddress);
            return (new StringBuilder(String.valueOf(inetaddress).length() + 2)).append("[").append(inetaddress).append("]").toString();
        } else
        {
