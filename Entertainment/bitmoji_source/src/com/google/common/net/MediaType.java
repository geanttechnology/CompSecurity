...
_L4:
        ...
        {
            throw new IllegalArgumentException((new StringBuilder(String.valueOf(s).length() + 18)).append("Could not parse '").append(s).append("'").toString(), ((Throwable) (obj)));
        }
          goto _L5
_L2:
...
_L7:
    ...
    public Optional charset()
    {
        ...
        default:
            ...
            throw new IllegalStateException((new StringBuilder(String.valueOf(obj).length() + 33)).append("Multiple charset values defined: ").append(((String) (obj))).toString());
    ...
    public MediaType withParameter(String s, String s1)
    {
        ...
        com.google.common.collect.UnmodifiableIterator unmodifiableiterator = parameters.entries().iterator();
        do
        {
