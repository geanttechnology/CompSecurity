...
public final class UnsignedInts
{
    ...
    public static int parseUnsignedInt(String s, int i)
    {
        ...
        if ((0xffffffffL & l) != l)
        {
            throw new NumberFormatException((new StringBuilder(String.valueOf(s).length() + 69)).append("Input ").append(s).append(" in base ").append(i).append(" is not in the range of an unsigned integer").toString());
        } else
        {
            return (int)l;
        }
