...
_L4:
            ...
            throws InvocationTargetException, IllegalAccessException
        {
            ...
            {
                aobj = String.valueOf(constructor);
                throw new RuntimeException((new StringBuilder(String.valueOf(((Object) (aobj))).length() + 8)).append(((String) (aobj))).append(" failed.").toString(), ((Throwable) (obj)));
            }
            return obj;
        }
    ...
    public final Invokable returning(TypeToken typetoken)
    {
        ...
        {
            String s = String.valueOf(getReturnType());
            typetoken = String.valueOf(typetoken);
            throw new IllegalArgumentException((new StringBuilder(String.valueOf(s).length() + 35 + String.valueOf(typetoken).length())).append("Invokable is known to return ").append(s).append(", not ").append(typetoken).toString());
        } else
        {
            return this;
        }
