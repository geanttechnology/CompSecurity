    ...
    implements AnnotatedElement
{
    ...
    public Annotation getAnnotation(Class class1)
    {
        ...
        for (com.google.common.collect.UnmodifiableIterator unmodifiableiterator = annotations.iterator(); unmodifiableiterator.hasNext();)
        {
    ...
    public String toString()
    {
        ...
        int i = position;
        return (new StringBuilder(String.valueOf(s).length() + 15)).append(s).append(" arg").append(i).toString();
    }
}
