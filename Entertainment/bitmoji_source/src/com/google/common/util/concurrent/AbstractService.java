    ...
    implements Service
{
    ...
    private void checkCurrentState(Service.State state1)
    {
        ...
        if (obj != state1)
        {
            if (obj == Service.State.FAILED)
            {
                ...
                throw new IllegalStateException((new StringBuilder(String.valueOf(state1).length() + 55)).append("Expected the service to be ").append(state1).append(", but the service has FAILED").toString(), failureCause());
            } else
            {
                state1 = String.valueOf(state1);
                obj = String.valueOf(obj);
                throw new IllegalStateException((new StringBuilder(String.valueOf(state1).length() + 37 + String.valueOf(obj).length())).append("Expected the service to be ").append(state1).append(", but was ").append(((String) (obj))).toString());
            }
        } else
        {
            return;
    ...
    private void failed(Service.State state1, Throwable throwable)
    {
        ...
        String s1 = String.valueOf(throwable);
    ...
    {
        String s = String.valueOf(state1);
        return new ListenerCallQueue.Callback((new StringBuilder(String.valueOf(s).length() + 19)).append("stopping({from = ").append(s).append("})").toString(), state1) {
    ...
    private void terminated(Service.State state1)
    {
        ...
        switch (_cls6..SwitchMap.com.google.common.util.concurrent.Service.State[state1.ordinal()])
        {
        case 2: // '\002'
        default:
            throw new AssertionError();
    ...
    {
        String s = String.valueOf(state1);
        return new ListenerCallQueue.Callback((new StringBuilder(String.valueOf(s).length() + 21)).append("terminated({from = ").append(s).append("})").toString(), state1) {
        ...
        throws TimeoutException
    {
        ...
        monitor.leave();
        throw timeunit;
        timeunit = String.valueOf(this);
        throw new TimeoutException((new StringBuilder(String.valueOf(timeunit).length() + 50)).append("Timed out waiting for ").append(timeunit).append(" to reach the RUNNING state.").toString());
    }
        ...
        throws TimeoutException
    {
        ...
        throw new TimeoutException((new StringBuilder(String.valueOf(timeunit).length() + 65 + String.valueOf(s).length())).append("Timed out waiting for ").append(timeunit).append(" to reach a terminal state. ").append("Current state: ").append(s).toString());
    }
    ...
    protected final void notifyFailed(Throwable throwable)
    {
        ...
        monitor.enter();
        Object obj = state();
        _cls6..SwitchMap.com.google.common.util.concurrent.Service.State[((Service.State) (obj)).ordinal()];
...
_L1:
        throwable = String.valueOf(obj);
        throw new AssertionError((new StringBuilder(String.valueOf(throwable).length() + 18)).append("Unexpected state: ").append(throwable).toString());
        throwable;
        monitor.leave();
        executeListeners();
        throw throwable;
_L2:
        obj = String.valueOf(obj);
        throw new IllegalStateException((new StringBuilder(String.valueOf(obj).length() + 22)).append("Failed while in state:").append(((String) (obj))).toString(), throwable);
_L3:
...
_L4:
    ...
    protected final void notifyStarted()
    {
        ...
        {
            Object obj = String.valueOf(snapshot.state);
            obj = new IllegalStateException((new StringBuilder(String.valueOf(obj).length() + 43)).append("Cannot notifyStarted() when the service is ").append(((String) (obj))).toString());
...
_L1:
    ...
    protected final void notifyStopped()
    {
        ...
        {
            obj = String.valueOf(obj);
            obj = new IllegalStateException((new StringBuilder(String.valueOf(obj).length() + 43)).append("Cannot notifyStopped() when the service is ").append(((String) (obj))).toString());
            notifyFailed(((Throwable) (obj)));
            throw obj;
        }
    ...
    public final Service startAsync()
    {
        ...
        throw new IllegalStateException((new StringBuilder(String.valueOf(s).length() + 33)).append("Service ").append(s).append(" has already been started").toString());
    }
...
_L3:
        obj = String.valueOf(obj);
        throw new AssertionError((new StringBuilder(String.valueOf(obj).length() + 18)).append("Unexpected state: ").append(((String) (obj))).toString());
_L10:
        notifyFailed(((Throwable) (obj)));
        monitor.leave();
        executeListeners();
...
_L7:
        ...
        {
            obj = String.valueOf(obj);
            throw new AssertionError((new StringBuilder(String.valueOf(obj).length() + 45)).append("isStoppable is incorrectly implemented, saw: ").append(((String) (obj))).toString());
        }
