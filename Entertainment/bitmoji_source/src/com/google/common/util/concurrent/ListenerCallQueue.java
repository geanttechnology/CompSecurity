    ...
    implements Runnable
{
    ...
    void execute()
    {
        ...
        String s = String.valueOf(listener);
        String s1 = String.valueOf(executor);
        logger1.log(level, (new StringBuilder(String.valueOf(s).length() + 42 + String.valueOf(s1).length())).append("Exception while running callbacks for ").append(s).append(" on ").append(s1).toString(), ((Throwable) (obj)));
        throw obj;
        obj;
        this;
        JVM INSTR monitorexit ;
...
_L2:
        ...
        String s = String.valueOf(listener);
        flag = flag1;
        obj1 = ((Callback) (obj1)).methodCall;
        flag = flag1;
        logger1.log(level, (new StringBuilder(String.valueOf(s).length() + 37 + String.valueOf(obj1).length())).append("Exception while executing callback: ").append(s).append(".").append(((String) (obj1))).toString(), ((Throwable) (obj)));
          goto _L3
        obj;
