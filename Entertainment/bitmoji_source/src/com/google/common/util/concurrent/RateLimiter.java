...
public abstract class RateLimiter
{
    ...
    public static RateLimiter create(double d, long l, TimeUnit timeunit)
    {
        ...
        return create(SleepingStopwatch.createFromSystemTimer(), d, l, timeunit, 3D);
    }
    ...
    static RateLimiter create(SleepingStopwatch sleepingstopwatch, double d, long l, TimeUnit timeunit, double d1)
    {
        sleepingstopwatch = new SmoothRateLimiter.SmoothWarmingUp(sleepingstopwatch, l, timeunit, d1);
        sleepingstopwatch.setRate(d);
        return sleepingstopwatch;
    }
...
_L3:
    ...
    {
        return String.format(Locale.ROOT, "RateLimiter[stableRate=%3.1fqps]", new Object[] {
