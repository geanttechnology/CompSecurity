...
public final class ReflectiveAtInjectBinding extends Binding
{
    ...
    public static Binding create(Class class1, boolean flag)
    {
        ...
        if (obj1 != null)
        {
            if ((((Constructor) (obj1)).getModifiers() & 2) != 0)
            {
                throw new IllegalStateException((new StringBuilder()).append("Can't inject private constructor: ").append(obj1).toString());
            }
            String s = Keys.get(class1);
            ((Constructor) (obj1)).setAccessible(true);
            java.lang.reflect.Type atype[] = ((Constructor) (obj1)).getGenericParameterTypes();
            int j1 = atype.length;
            obj = s;
            i1 = j1;
            if (j1 != 0)
            {
                java.lang.annotation.Annotation aannotation[][] = ((Constructor) (obj1)).getParameterAnnotations();
                int k = 0;
                do
                {
                    obj = s;
        ...
        return new ReflectiveAtInjectBinding(((String) (obj)), Keys.getMembersKey(class1), flag1, class1, (Field[])arraylist1.toArray(new Field[arraylist1.size()]), ((Constructor) (obj1)), i1, class3, (String[])arraylist.toArray(new String[arraylist.size()]));
    }
