...
//            MediaRouteProviderService, MediaRouteDiscoveryRequest
...
_L8:
        return MediaRouteProviderService.access$1700(mediarouteproviderservice, messenger, j, k);
_L9:
    ...
    public void handleMessage(Message message)
    {
        ...
        if (MediaRouteProviderService.isValidRemoteMessenger(messenger))
        {
            ...
            if (!processMessage(i, messenger, j, k, obj, message))
            {
                ...
                {
                    Log.d("MediaRouteProviderSrv", (new StringBuilder()).append(MediaRouteProviderService.access$1000(messenger)).append(": Message failed, what=").append(i).append(", requestId=").append(j).append(", arg=").append(k).append(", obj=").append(obj).append(", data=").append(message).toString());
                }
