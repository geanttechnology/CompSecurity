...
public final class MediaRouter
{
        ...
        implements SystemMediaRouteProvider.SyncCallback
    {
        ...
        {
            providerinfo = (new StringBuilder()).append(providerinfo.getPackageName()).append(":").append(s).toString();
...
_L2:
        ...
        public void start()
        {
            mRegisteredProviderWatcher = new RegisteredMediaRouteProviderWatcher(mApplicationContext, mApplicationRouter);
...
_L5:
        ...
        GlobalMediaRouter(Context context)
        {
            ...
            mApplicationRouter = getRouter(context);
