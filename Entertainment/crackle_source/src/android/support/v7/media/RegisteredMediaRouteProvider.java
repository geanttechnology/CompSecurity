...
//            MediaRouteProvider, MediaRouteProviderDescriptor, MediaRouteDescriptor, MediaRouteProviderService, 
...
_L8:
    ...
    {
        super(context, new MediaRouteProvider.ProviderMetadata(componentname.getPackageName()));
...
_L1:
        ...
        if (!MediaRouteProviderService.isValidRemoteMessenger(componentname))
        {
