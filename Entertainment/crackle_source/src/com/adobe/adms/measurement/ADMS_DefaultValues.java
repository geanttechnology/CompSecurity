...
final class ADMS_DefaultValues
{
    ...
    private static final int kADMS_EvarMax = 75;
    protected static final String kADMS_Events = "events";
    private static final int kADMS_HierMax = 5;
    ...
    private static final int kADMS_ListMax = 3;
    ...
    private static final int kADMS_PropMax = 75;
    ...
    protected static final ArrayList requiredLightVarList = new ArrayList() {
    ...
    protected static final ArrayList requiredVarList = new ArrayList() {
