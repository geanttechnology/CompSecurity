...
class n extends TimerTask
{
    ...
    public void run()
    {
        CSLog.d("StreamSenseVideoView", (new StringBuilder()).append("startEventTimer -> lastPosition:").append(a).append(" currentPosition:").append(StreamSenseVideoView.a(c)).toString());
        ...
        if (l1 >= 500L)
        {
            ...
            if (l1 > 0L)
            {
                ...
                CSLog.d("StreamSenseVideoView", (new StringBuilder()).append("addToBufferingTotal=").append(l1).toString());
