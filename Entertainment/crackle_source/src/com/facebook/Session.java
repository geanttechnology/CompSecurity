...
//            SessionDefaultAudience, NativeProtocol
    ...
    implements Serializable
{
        ...
        implements Serializable
    {
        ...
        AuthorizationClient.AuthorizationRequest getAuthorizationClientRequest()
        {
            ...
            return new AuthorizationClient.AuthorizationRequest(loginBehavior, requestCode, isLegacy, permissions, defaultAudience, applicationId, validateSameFbidAsToken, startactivitydelegate);
        }
        ...
        implements Serializable
    {
        ...
        private Object readResolve()
        {
            return new Session(applicationId, state, tokenInfo, lastAttemptedTokenExtendDate, shouldAutoPublish, pendingRequest);
        }
