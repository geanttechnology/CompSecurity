...
public class FriendPickerFragment extends PickerFragment
{
    ...
    {
        super(com/facebook/model/GraphUser, 0x7f03002d, bundle);
        multiSelect = true;
    ...
    public void onInflate(Activity activity, AttributeSet attributeset, Bundle bundle)
    {
        ...
        activity = activity.obtainStyledAttributes(attributeset, com.gotv.crackle.handset.R.styleable.com_facebook_friend_picker_fragment);
