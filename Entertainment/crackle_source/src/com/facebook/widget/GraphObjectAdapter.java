...
label1:
    ...
    private View getActivityCircleView(View view, ViewGroup viewgroup)
    {
        ...
        if (view == null)
        {
            viewgroup = inflater.inflate(0x7f03002f, null);
        }
        ((ProgressBar)viewgroup.findViewById(0x7f0a00a8)).setVisibility(0);
        return viewgroup;
    }
    ...
    protected View createGraphObjectView(GraphObject graphobject, View view)
    {
        ...
        view = (ViewStub)graphobject.findViewById(0x7f0a00ad);
        if (view != null)
        {
            if (!getShowCheckbox())
            {
        ...
        view = (ViewStub)graphobject.findViewById(0x7f0a00ab);
        if (!getShowPicture())
        {
            view.setVisibility(8);
            return graphobject;
    ...
    {
        Object obj = (ImageView)createGraphObjectView(null, null).findViewById(0x7f0a00aa);
        if (obj == null)
        {
            return null;
        } else
...
label0:
    ...
    protected View getSectionHeaderView(String s, View view, ViewGroup viewgroup)
    {
        ...
        if (viewgroup == null)
        {
            view = (TextView)inflater.inflate(0x7f030033, null);
        }
        view.setText(s);
        return view;
    }
...
label0:
        {
            ...
            TextView textview = (TextView)view.findViewById(0x7f0a00ac);
            if (textview != null)
            {
            ...
            if (getShowCheckbox())
            {
                updateCheckboxState((CheckBox)view.findViewById(0x7f0a00a9), isGraphObjectSelected(s));
            }
            if (getShowPicture())
            {
                ...
                if (graphobject != null)
                {
                    view = (ImageView)view.findViewById(0x7f0a00aa);
