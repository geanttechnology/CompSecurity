...
_L3:
            String s = getResources().getString(0x7f0b004e);
            String s1 = getResources().getString(0x7f0b004f);
            if (user != null && user.getName() != null)
            {
                view = String.format(getResources().getString(0x7f0b004c), new Object[] {
                    user.getName()
                });
            } else
            {
                view = getResources().getString(0x7f0b004d);
            }
...
_L7:
    ...
    public LoginButton(Context context, AttributeSet attributeset)
    {
        ...
        {
            setTextColor(getResources().getColor(0x7f07002e));
            setTextSize(0, getResources().getDimension(0x7f08001f));
            setPadding(getResources().getDimensionPixelSize(0x7f080019), getResources().getDimensionPixelSize(0x7f08001b), getResources().getDimensionPixelSize(0x7f08001a), getResources().getDimensionPixelSize(0x7f08001c));
            setWidth(getResources().getDimensionPixelSize(0x7f08001d));
            setHeight(getResources().getDimensionPixelSize(0x7f08001e));
            setGravity(17);
            if (isInEditMode())
            {
                setBackgroundColor(getResources().getColor(0x7f07002a));
                loginText = "Log in";
            } else
            {
                setBackgroundResource(0x7f020086);
            }
        }
    ...
    {
        attributeset = getContext().obtainStyledAttributes(attributeset, com.gotv.crackle.handset.R.styleable.com_facebook_login_view);
    ...
    private void setButtonText()
    {
        if (sessionTracker != null && sessionTracker.getOpenSession() != null)
        {
            ...
            {
                s = getResources().getString(0x7f0b004a);
            }
            setText(s);
            return;
        }
        ...
        {
            s1 = getResources().getString(0x7f0b004b);
        }
        setText(s1);
    }
