...
//            ImageResponse, ImageRequest, ImageDownloader
...
_L8:
    ...
    {
        attributeset = getContext().obtainStyledAttributes(attributeset, com.gotv.crackle.handset.R.styleable.com_facebook_profile_picture_view);
...
_L7:
    ...
    private void sendImageRequest(boolean flag)
    {
        try
        {
            ImageRequest imagerequest = (new ImageRequest.Builder(getContext(), ImageRequest.getProfilePictureUrl(profileId, queryWidth, queryHeight))).setAllowCachedRedirects(flag).setCallerTag(this).setCallback(new ImageRequest.Callback() {
        ...
        {
            Logger.log(LoggingBehavior.REQUESTS, 6, TAG, malformedurlexception.toString());
        }
    }
