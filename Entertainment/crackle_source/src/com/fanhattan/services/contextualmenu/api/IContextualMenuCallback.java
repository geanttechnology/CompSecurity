    ...
    extends IInterface
{
        ...
        implements IContextualMenuCallback
    {
        ...
        public static IContextualMenuCallback asInterface(IBinder ibinder)
        {
            ...
            IInterface iinterface = ibinder.queryLocalInterface("com.fanhattan.services.contextualmenu.api.IContextualMenuCallback");
...
_L3:
    ...
    public abstract ContextualMenu onCreateContextualMenu()
        throws RemoteException;
}
