...
_L1:
    ...
    public static IContextualMenuService asInterface(IBinder ibinder)
    {
        ...
        android.os.IInterface iinterface = ibinder.queryLocalInterface("com.fanhattan.services.contextualmenu.api.IContextualMenuService");
        ...
        throws RemoteException
    {
        ...
        case 1: // '\001'
            ...
            registerContextualMenu(.asInterface(parcel.readStrongBinder()), parcel.readString());
        ...
        case 3: // '\003'
            ...
            if (parcel.readInt() != 0)
            {
                parcel = (ContextualMenu)ContextualMenu.CREATOR.mParcel(parcel);
            } else
            {
                parcel = null;
            }
