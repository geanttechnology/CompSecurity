    ...
    extends IInterface
{
        ...
        implements INotificationService
    {
        ...
        public static INotificationService asInterface(IBinder ibinder)
        {
            ...
            IInterface iinterface = ibinder.queryLocalInterface("com.fanhattan.services.notification.api.INotificationService");
    ...
    public abstract void showNotification(String s, String s1, int i, long l)
        throws RemoteException;

    public abstract void showNotificationImageResource(String s, int i, String s1, int j, long l)
        throws RemoteException;

    public abstract void showNotificationImageUrl(String s, String s1, String s2, int i, long l)
        throws RemoteException;
}
