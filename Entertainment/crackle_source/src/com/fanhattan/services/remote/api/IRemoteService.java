    ...
    extends IInterface
{
        ...
        implements IRemoteService
    {
        ...
        public static IRemoteService asInterface(IBinder ibinder)
        {
            ...
            IInterface iinterface = ibinder.queryLocalInterface("com.fanhattan.services.remote.api.IRemoteService");
            ...
            throws RemoteException
        {
            ...
            case 1: // '\001'
                ...
                registerListener(IRemoteServiceListener.Stub.asInterface(parcel.readStrongBinder()));
                parcel1.writeNoException();
                return true;

            case 2: // '\002'
                parcel.enforceInterface("com.fanhattan.services.remote.api.IRemoteService");
                unregisterListener(IRemoteServiceListener.Stub.asInterface(parcel.readStrongBinder()));
                parcel1.writeNoException();
                return true;
...
_L1:
    ...
    public abstract int getBatteryLevel(int i)
        throws RemoteException;

    public abstract String getHardwareVersion(int i)
        throws RemoteException;

    public abstract String getSoftwareBuild(int i)
        throws RemoteException;

    public abstract String getSoftwareVersion(int i)
        throws RemoteException;

    public abstract boolean isConnected(int i)
        throws RemoteException;

    public abstract void registerListener(IRemoteServiceListener iremoteservicelistener)
        throws RemoteException;

    public abstract void unregisterListener(IRemoteServiceListener iremoteservicelistener)
        throws RemoteException;
}
