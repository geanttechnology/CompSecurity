    ...
    extends IInterface
{
        ...
        implements IRemoteServiceListener
    {
        ...
        public static IRemoteServiceListener asInterface(IBinder ibinder)
        {
            ...
            IInterface iinterface = ibinder.queryLocalInterface("com.fanhattan.services.remote.api.IRemoteServiceListener");
    ...
    public abstract boolean onTouchEvent(int i, int j, float f, float f1, float f2, float f3, int k, 
            long l)
        throws RemoteException;
}
