...
public interface IRemoteManagerCallback
    extends IInterface
{
        ...
        implements IRemoteManagerCallback
    {
        ...
        public static IRemoteManagerCallback asInterface(IBinder ibinder)
        {
            ...
            IInterface iinterface = ibinder.queryLocalInterface("com.fanhattan.services.remotemanager.api.IRemoteManagerCallback");
    ...
    public abstract void onRemoteEvent(byte abyte0[])
        throws RemoteException;
}
