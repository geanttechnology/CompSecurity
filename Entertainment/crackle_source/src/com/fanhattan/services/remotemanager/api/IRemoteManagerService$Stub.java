...
_L1:
    ...
    public static IRemoteManagerService asInterface(IBinder ibinder)
    {
        ...
        android.os.IInterface iinterface = ibinder.queryLocalInterface("com.fanhattan.services.remotemanager.api.IRemoteManagerService");
        ...
        throws RemoteException
    {
        ...
        case 1: // '\001'
            ...
            registerCallback(parcel.readInt(), .asInterface(parcel.readStrongBinder()));
