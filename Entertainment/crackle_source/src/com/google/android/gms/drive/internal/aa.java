    ...
    implements android.os.Parcelable.Creator
{
    ...
    static void a(UpdateMetadataRequest updatemetadatarequest, Parcel parcel, int i)
    {
        ...
        b.a(parcel, 2, updatemetadatarequest.rr, i, false);
        b.a(parcel, 3, updatemetadatarequest.rB, i, false);
        b.D(parcel, j);
    }

    public UpdateMetadataRequest O(Parcel parcel)
    {
    ...
    public UpdateMetadataRequest[] ao(int i)
    {
