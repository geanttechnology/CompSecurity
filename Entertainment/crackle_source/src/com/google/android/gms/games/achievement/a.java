    ...
    implements Achievement
{
    ...
    {
        com.google.android.gms.internal.ee.a a1 = ee.e(this).a("id", getAchievementId()).a("name", getName()).a("state", Integer.valueOf(getState())).a("type", Integer.valueOf(getType()));
        if (getType() == 1)
        {
