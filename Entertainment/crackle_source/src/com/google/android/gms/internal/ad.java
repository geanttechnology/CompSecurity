        ...
        implements ad
    {
            ...
            throws RemoteException
        {
            ...
            case 1: // '\001'
                ...
                b = com.google.android.gms.dynamic.b.a.E(parcel.readStrongBinder());
                break;
            }
            x x1;
            if (parcel.readInt() != 0)
            ...
            parcel = a(b, x1, parcel.readString(), bb.a.i(parcel.readStrongBinder()), parcel.readInt());
...
_L4:
    ...
    public abstract IBinder a(b b, x x, String s, bb bb, int i)
        throws RemoteException;
}
