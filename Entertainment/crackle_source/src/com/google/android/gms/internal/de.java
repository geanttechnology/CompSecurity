...
_L1:
    ...
    public abstract void a(dd dd, int i)
        throws RemoteException;

    public abstract void a(dd dd, int i, String s, byte abyte0[])
        throws RemoteException;

    public abstract void a(dd dd, int i, byte abyte0[])
        throws RemoteException;

    public abstract void b(dd dd)
        throws RemoteException;

    public abstract void b(dd dd, int i)
        throws RemoteException;

    public abstract void c(dd dd)
        throws RemoteException;
