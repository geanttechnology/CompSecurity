...
public class dp
{
    ...
    private static final String my = (new StringBuilder()).append("yyyyMMdd'T'HHmmss").append(mx[0]).toString();
    ...
    public static Calendar G(String s)
    {
        ...
        {
            lA.b("Error parsing string: %s", new Object[] {
                s.getMessage()
            });
            return null;
        }
    ...
    private static String H(String s)
    {
        ...
        {
            lA.c("Error extracting the date: %s", new Object[] {
                s.getMessage()
            });
            return null;
        }
...
_L2:
        ...
        {
            lA.b("Error extracting the time substring: %s", new Object[] {
                s.getMessage()
            });
            return null;
        }
...
_L3:
        return null;
_L4:
        if (!J(s)) goto _L7; else goto _L6
_L6:
        return s.replaceAll("([\\+\\-]\\d\\d):(\\d\\d)", "$1$2");
        if (s.length() != "HHmmss".length() + mx[0].length()) goto _L7; else goto _L8
_L8:
    ...
    public static String a(Calendar calendar)
    {
        ...
        } else
        {
            ...
            {
                return ((String) (obj)).replace("+0000", mx[0]);
            }
        }
        return calendar;
    }
...
_L1:
    ...
    public static void a(JSONObject jsonobject, List list)
    {
        ...
        for (list = list.iterator(); list.hasNext(); jsonarray.put(((WebImage)list.next()).aP())) { }
