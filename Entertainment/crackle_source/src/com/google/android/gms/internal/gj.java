    ...
    extends IInterface
{
        ...
        implements gj
    {
        ...
        public static gj J(IBinder ibinder)
        {
            ...
            IInterface iinterface = ibinder.queryLocalInterface("com.google.android.gms.location.internal.ICopresenceCallbacks");
...
_L1:
    ...
    public abstract void a(int i, gh gh)
        throws RemoteException;

    public abstract void a(int i, boolean flag)
        throws RemoteException;

    public abstract void b(int i, gh gh)
        throws RemoteException;
}
