...
_L1:
        return;
_L2:
        if (!(obj instanceof iz)) goto _L4; else goto _L3
_L3:
        Class class1;
        Object aobj[];
        int i;
        ...
        if (s != null)
        {
            stringbuffer1.append(stringbuffer).append(aE(s)).append(" <\n");
            stringbuffer.append("  ");
        }
        class1 = obj.getClass();
...
_L4:
    ...
    private static String aF(String s)
    {
        String s1 = s;
    ...
    public static String b(iz iz1)
    {
        ...
        try
        {
            a(null, iz1, new StringBuffer(), stringbuffer);
        }
        // Misplaced declaration of an exception variable
        catch (iz iz1)
        {
            return (new StringBuilder()).append("Error printing proto: ").append(iz1.getMessage()).toString();
        }
        // Misplaced declaration of an exception variable
        catch (iz iz1)
        {
