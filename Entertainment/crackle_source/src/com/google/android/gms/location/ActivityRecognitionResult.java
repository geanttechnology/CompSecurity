    ...
    implements SafeParcelable
{
    ...
    public ActivityRecognitionResult(List list, long l, long l1)
    {
        ...
        eg.b(flag, "Must have at least 1 detected activity");
        kg = 1;
        xm = list;
        xn = l;
        xo = l1;
    ...
    {
        for (Iterator iterator = xm.iterator(); iterator.hasNext();)
        {
    ...
    {
        return (DetectedActivity)xm.get(0);
    }
    ...
    {
        return (new StringBuilder()).append("ActivityRecognitionResult [probableActivities=").append(xm).append(", timeMillis=").append(xn).append(", elapsedRealtimeMillis=").append(xo).append("]").toString();
    }
