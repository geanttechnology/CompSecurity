...
public final class PlusShare
{
    public static class Builder
    {
        ...
        {
            eg.a(DI, "Must include the launching activity with PlusShare.Builder constructor before setting call-to-action");
            Bundle bundle;
            boolean flag;
            ...
            eg.b(flag, "Must provide a call to action URL");
            bundle = new Bundle();
            ...
            {
                eg.a(PlusShare.aw(s1), "The specified deep-link ID was malformed.");
        ...
        public Intent getIntent()
        {
            ...
            eg.a(flag1, "Call-to-action buttons are only available for URLs.");
            ...
            eg.a(flag1, "The content URL is required for interactive posts.");
            flag1 = flag2;
            if (flag4)
            {
                flag1 = flag2;
            ...
            eg.a(flag1, "Must set content URL or content deep-link ID to use a call-to-action button.");
            if (mIntent.hasExtra("com.google.android.apps.plus.CONTENT_DEEP_LINK_ID"))
            {
                eg.a(PlusShare.aw(mIntent.getStringExtra("com.google.android.apps.plus.CONTENT_DEEP_LINK_ID")), "The specified deep-link ID was malformed.");
            }
            if (!flag && flag3)
            {
                ...
                {
                    mIntent.putExtra("android.intent.extra.STREAM", (Parcelable)DJ.get(0));
                } else
                {
            ...
            if (flag && !flag3)
            {
                ...
                if (DJ != null && !DJ.isEmpty())
                {
                    mIntent.putParcelableArrayListExtra("android.intent.extra.STREAM", DJ);
                } else
                {
                    mIntent.removeExtra("android.intent.extra.STREAM");
                }
        ...
        {
            eg.b(DI, "Must include the launching activity with PlusShare.Builder constructor before setting deep links");
            boolean flag;
            if (!TextUtils.isEmpty(s))
            {
                flag = true;
            ...
            eg.b(flag, "The deepLinkId parameter is required.");
        ...
        public Builder(Activity activity, PlusClient plusclient)
        {
            ...
            eg.a(flag, "PlusClient must not be null.");
            eg.a(plusclient.isConnected(), "PlusClient must be connected to create an interactive post.");
            eg.a(plusclient.eK().az("https://www.googleapis.com/auth/plus.login"), "Must request PLUS_LOGIN scope in PlusClient to create an interactive post.");
    ...
    public static Person createPerson(String s, String s1)
    {
        ...
        {
            return new ig(s1, s, null, 0, null);
        }
    }
