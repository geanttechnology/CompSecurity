    ...
    implements Runnable
{
    ...
    public void run()
    {
        if (mDetailsProvider.getMediaDetailsItem() != null && !mDetailsProvider.getMediaDetailsItem().getAmazonLink().isEmpty() && !mDetailsProvider.getMediaDetailsItem().getAmazonLink().equalsIgnoreCase("null") && mBuyItem != null)
        {
            ...
            BaseMediaDetailsActivity.access$102(_fld0, mDetailsProvider.getMediaDetailsItem().getAmazonLink());
        }
    }
...
label0:
        ...
        // Unreferenced inner class com/gotv/crackle/BaseMediaDetailsActivity$1$1

/* anonymous class */
        class BaseMediaDetailsActivity._cls1._cls1
            implements Runnable
        {
