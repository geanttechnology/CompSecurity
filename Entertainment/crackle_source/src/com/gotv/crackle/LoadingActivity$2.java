    ...
    implements Runnable
{
    ...
    public void run()
    {
        if (LoadingActivity.access$000(LoadingActivity.this) || !val$tag.equalsIgnoreCase("GetAllowedLocations") && !val$tag.equalsIgnoreCase("GetLocation")) goto _L2; else goto _L1
_L1:
...
_L6:
        ...
        r.setPositiveButton(getResources().getString(0x7f0b00b5), new android.content.DialogInterface.OnClickListener() {
            ...
            {
                this$1 = LoadingActivity._cls2.this;
                super();
            }
        });
        r.create().show();
...
_L2:
        if (LoadingActivity.access$300(LoadingActivity.this) != null && LoadingActivity.access$400(LoadingActivity.this) != null && LoadingActivity.access$500(LoadingActivity.this) != null)
        {
            ...
            if (LoadingActivity.access$300(LoadingActivity.this).getRequestState() == com.gotv.crackle.data.tState.COMPLETE && LoadingActivity.access$400(LoadingActivity.this).getRequestState() == com.gotv.crackle.data.tState.COMPLETE && LoadingActivity.access$500(LoadingActivity.this).getRequestState() == com.gotv.crackle.data.tState.COMPLETE)
            {
