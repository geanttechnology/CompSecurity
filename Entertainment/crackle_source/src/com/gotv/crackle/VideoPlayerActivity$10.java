...
class this._cls0
    implements com.gotv.crackle.views.trollerListener
{
    ...
    public void onVideoPlaybackStarted()
    {
        ...
        if (!VideoPlayerActivity.access$3500(VideoPlayerActivity.this))
        {
            ...
            VideoPlayerActivity.access$3900(VideoPlayerActivity.this).postDelayed(new Runnable() {

                final VideoPlayerActivity._cls10 this$1;

                public void run()
                {
                    if (SharedPrefsManager.getSocialOnEnabled() && CrackleAccountManager.isLoggedIn() && VideoPlayerActivity.access$3600(this$0) != null)
                    {
                        String s = CrackleAccountManager.getUserID();
                        VideoPlayerActivity.access$3800(this$0).publishWatchedhMediaItem(this$0, s, VideoPlayerActivity.access$3700(this$0));
                    }
                }

            
            {
                this$1 = VideoPlayerActivity._cls10.this;
                super();
            }
            }, 10000L);
        }
    ...
    public void onVisibilityChanged(boolean flag)
    {
        ...
        android.widget.rams rams = (android.widget.rams)VideoPlayerActivity.access$1500(VideoPlayerActivity.this).getLayoutParams();
        if (flag)
        {
            rams.setMargins(0, 0, 0, Application.getDisplayIndependantPixelSize(60));
        } else
        {
            rams.setMargins(0, 0, 0, Application.getDisplayIndependantPixelSize(10));
        }
        VideoPlayerActivity.access$1500(VideoPlayerActivity.this).setLayoutParams(rams);
    }
