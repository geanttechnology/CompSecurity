...
_L1:
        ...
        VideoPlayerActivity.access$6300(VideoPlayerActivity.this).setOnEventListener(new android.drm.DrmManagerClient.OnEventListener() {
        ...
        VideoPlayerActivity.access$6300(VideoPlayerActivity.this).setOnErrorListener(new android.drm.DrmManagerClient.OnErrorListener() {
...
_L4:
        ...
        if (!SharedPrefsManager.getIsParentalLockEnabled(com.gotv.crackle.helpers.ntalControl.RESTRICT_MATURE_CONTENT) && !SharedPrefsManager.getIsParentalLockEnabled(com.gotv.crackle.helpers.ntalControl.RESTRICT_ALL_CONTENT))
        {
