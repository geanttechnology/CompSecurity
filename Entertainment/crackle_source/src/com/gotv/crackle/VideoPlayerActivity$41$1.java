    ...
    implements android.widget.stener
{
    ...
    public void onItemClick(final AdapterView display, View view, int i, long l)
    {
        display = (Display)VideoPlayerActivity.access$8500(_fld0).getItem(i);
        VideoPlayerActivity.access$8500(_fld0).setCurIndex(i);
        VideoPlayerActivity.access$8500(_fld0).notifyDataSetChanged();
        VideoPlayerActivity.access$8600(_fld0).setAdapter(null);
        VideoPlayerActivity.access$8600(_fld0).setAdapter(VideoPlayerActivity.access$8500(_fld0));
        VideoPlayerActivity.access$8000(_fld0).getButton(-1).setEnabled(true);
        VideoPlayerActivity.access$8000(_fld0).getButton(-1).setOnClickListener(new android.view.View.OnClickListener() {

            final VideoPlayerActivity._cls41._cls1 this$2;
            ...
            {
                this$2 = VideoPlayerActivity._cls41._cls1.this;
                display = display1;
                super();
            }
        });
