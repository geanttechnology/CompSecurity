    ...
    implements android.content.nClickListener
{
    ...
    // Unreferenced inner class com/gotv/crackle/base/BaseActivity$5

/* anonymous class */
    class BaseActivity._cls5
        implements Runnable
    {
...
_L1:
            if (!Application.getInstance().getLocalization().isCurrentCountryCodeValid())
            {
                ...
                builder.setPositiveButton(getResources().getString(0x7f0b00b5), new BaseActivity._cls5._cls1());
                builder.create().show();
            }
_L4:
            return;
