...
public class CaptionWindowSettingsFragment extends CaptionSettingsFragment
    implements com.gotv.crackle.captions.listrows.CaptionColorRow.CaptionColorRowSelectionChangeListener, android.widget.SeekBar.OnSeekBarChangeListener
{
    ...
    public CaptionWindowSettingsFragment()
    {
    }

    public void OnColorChanged(CaptionColorRow captioncolorrow, CaptionColorRowItem captioncolorrowitem)
    {
        _captionSettings.setWindowColor(captioncolorrowitem.getCaptionColor());
        updatePreview();
    }

    public String getFragmentTitle()
    {
        return Application.getInstance().getString(0x7f0b014d);
    }
    ...
    public void onProgressChanged(SeekBar seekbar, int i, boolean flag)
    {
        ...
        } else
        {
            ...
            _captionSettings.setWindowTransparency((int)Math.round(d * 255D));
            updatePreview();
            return;
        }
    }
    ...
    protected void setAdapterRows()
    {
        ...
        _colorRow.getTitleView().setText(getString(0x7f0b0156));
        ...
        for (Iterator iterator = CaptionSettings.getTextColors().iterator(); iterator.hasNext(); _colorRow.addColorItem(captioncolorrowitem1))
        {
            ...
            if (captioncolor.getColor() == _captionSettings.getWindowColor().getColor())
            {
                captioncolorrowitem = captioncolorrowitem1;
            }
        }
        ...
        _transparencyRow.getTitleView().setText(getString(0x7f0b0157));
        _listAdapter.add(_transparencyRow);
        _transparencyRow.getSeekBar().setOnSeekBarChangeListener(this);
        double d = (double)(_captionSettings.getWindowTransparency() + 0) / 255D;
