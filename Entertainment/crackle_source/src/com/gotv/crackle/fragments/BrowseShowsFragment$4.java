    ...
    implements android.widget.ctedListener
{
    ...
    public void onItemSelected(AdapterView adapterview, View view, int i, long l)
    {
        if (view != null)
        {
            view.startAnimation(AnimationUtils.loadAnimation(BrowseShowsFragment.access$000(BrowseShowsFragment.this), 0x7f040006));
        }
        if (mLastAnimatedView != null && mLastAnimatedView != view)
        {
            mLastAnimatedView.startAnimation(AnimationUtils.loadAnimation(BrowseShowsFragment.access$000(BrowseShowsFragment.this), 0x7f040007));
        }
