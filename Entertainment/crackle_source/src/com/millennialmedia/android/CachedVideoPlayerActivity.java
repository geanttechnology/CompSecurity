...
_L1:
    ...
    private void fadeButtons()
    {
        if (videoAd != null && videoAd.buttons != null)
        {
            for (int i = 0; i < videoAd.buttons.size(); i++)
            {
                ...
                MMSDK.Log.v("Button: %d alpha: %f", new Object[] {
    ...
    private void initWebOverlay()
    {
        ...
        mWebView.setId(413);
        Object obj = new MMWebViewClient.MMWebViewClientListener() {

            final CachedVideoPlayerActivity this$0;

            public void onPageFinished(String s)
            {
                MMSDK.Log.d((new StringBuilder()).append("@@ ON PAGE FINISHED").append(s).toString());
...
_L4:
        ...
        {
            fadeButton(message);
            MMSDK.Log.v("Beginning animation to visibility. Fade duration: %d Button: %d Time: %d", new Object[] {
...
_L3:
        ...
        } else
        {
            ...
            MMSDK.Log.v("Button: %d Anchor: %d Position: %d Anchor2: %d Position2: %d", new Object[] {
