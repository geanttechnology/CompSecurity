    ...
    implements Serializable
{
    static class InlineParams
    {
        ...
        void inflateFromGson(String s)
        {
            ...
            MMSDK.Log.d((new StringBuilder()).append("gson*****").append(s).toString());
            MMSDK.Log.d((new StringBuilder()).append("PARAMS*****").append(inlineparams).toString());
        }
    ...
    class MediaController extends android.widget.MediaController
    {
        ...
        public void setAnchorView(View view)
        {
            ...
            if (inDrawable == null)
            {
                ...
                {
                    MMSDK.Log.e((new StringBuilder()).append("Exception image:").append(exception.getMessage()).toString());
                }
            }
            if (outDrawable == null)
            {
                ...
                {
                    MMSDK.Log.e((new StringBuilder()).append("Exception image:").append(exception1.getMessage()).toString());
                }
            }
            if (inlineParams.goingFullScreen)
            {
                view.setBackgroundDrawable(inDrawable);
            } else
            {
                view.setBackgroundDrawable(outDrawable);
            }
...
_L7:
    ...
    public InlineVideoView(MMLayout mmlayout)
    {
        ...
        transparentHandler = new Handler() {
...
_L4:
    ...
    {
        return new android.media.MediaPlayer.OnErrorListener() {
    ...
    private void updateVideoSeekTime()
    {
        ...
        if (i >= 0)
        {
            MMSDK.Log.d((new StringBuilder()).append("Time is ").append(i).toString());
    ...
    private void updateVideoSeekTime(double d)
    {
        ...
        mmlayout.loadUrl((new StringBuilder()).append("javascript:MMJS.inlineVideo.updateVideoSeekTime(").append(d).append(");").toString());
    }
    ...
    private void updateVideoSeekTimeFinal()
    {
        if (duration > 0)
        {
            MMSDK.Log.d((new StringBuilder()).append("Time is ").append(duration).toString());
    ...
    public android.widget.RelativeLayout.LayoutParams getCustomLayoutParams()
    {
        ...
        } else
        {
            ...
            MMSDK.Log.d((new StringBuilder()).append("lp height = ").append(layoutparams.height).toString());
            return layoutparams;
        }
    }
...
_L3:
    ...
    public void onRestoreInstanceState(Parcelable parcelable)
    {
        ...
        {
            parcelable = (AdViewOverlayView.SavedState)parcelable;
            super.onRestoreInstanceState(parcelable.getSuperState());
            inlineParams.inflateFromGson(((AdViewOverlayView.SavedState) (parcelable)).gson);
            return;
        }
    }
