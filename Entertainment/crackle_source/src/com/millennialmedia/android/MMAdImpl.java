...
_L1:
    ...
    class MMAdImplRedirectionListenerImpl extends HttpRedirection.RedirectionListenerImpl
    {
        ...
        {
            uri = getContext();
            return uri == null || !(uri instanceof Activity) || !((Activity)uri).isFinishing();
        }
    ...
    public MMAdImpl(Context context)
    {
        ...
        nextAdViewId++;
        MMSDK.Log.v("Assigning MMAdImpl internal id: %d", new Object[] {
    ...
    {
        MMSDK.Log.d((new StringBuilder()).append("Returning a client for user: DefaultWebViewClient, adimpl=").append(this).toString());
    ...
    void insertUrlAdMetaValues(Map map)
    {
        ...
        if (adType != null)
        {
            ...
            {
                MMSDK.Log.e((new StringBuilder()).append("******* ERROR: INCORRECT AD TYPE IN MMADVIEW OBJECT PARAMETERS (").append(adType).append(") **********").toString());
                return;
            }
        } else
        {
    ...
    boolean isRefreshable()
    {
        ...
        {
            MMSDK.Log.d("Cannot request ad. Last ad request was %d seconds ago. Next ad can be requested in %d seconds.", new Object[] {
                Integer.valueOf(i), Integer.valueOf(15 - i)
            });
            return false;
        }
    }
