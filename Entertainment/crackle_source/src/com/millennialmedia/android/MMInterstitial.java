...
//            MMAdImplController, MMRequest, RequestListener, AdProperties
...
_L5:
    ...
    int displayInternal()
    {
        ...
        Exception exception;
        exception;
        MMSDK.Log.e("There was an exception displaying a cached ad. %s", new Object[] {
...
_L3:
        ...
        Exception exception;
        exception;
        MMSDK.Log.e("There was an exception checking for a cached ad. %s", new Object[] {
            exception.getMessage()
        });
        exception.printStackTrace();
        return false;
