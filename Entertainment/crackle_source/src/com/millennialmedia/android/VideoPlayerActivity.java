...
label0:
    ...
    {
        redirectListenerImpl = new HttpRedirection.RedirectionListenerImpl() {
    ...
    protected void playVideo(int i)
    {
        ...
        {
            MMSDK.Log.e((new StringBuilder()).append("error: ").append(exception.getMessage()).toString(), new Object[] {
                exception
            });
            errorPlayVideo((new StringBuilder()).append("error: ").append(exception.getMessage()).toString());
            return;
        }
        if (s == null)
        {
