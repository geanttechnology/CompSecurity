    ...
    implements TypeAdapterFactory, Cloneable
{
    ...
    {
        if (version != -1D && !isValidVersion((Since)class1.getAnnotation(com/millennialmedia/google/gson/annotations/Since), (Until)class1.getAnnotation(com/millennialmedia/google/gson/annotations/Until)))
        {
            return true;
        }
...
label0:
        {
            ...
            if (version != -1D && !isValidVersion((Since)field.getAnnotation(com/millennialmedia/google/gson/annotations/Since), (Until)field.getAnnotation(com/millennialmedia/google/gson/annotations/Until)))
            {
                return true;
            }
            ...
            if (requireExpose)
            {
                Expose expose = (Expose)field.getAnnotation(com/millennialmedia/google/gson/annotations/Expose);
