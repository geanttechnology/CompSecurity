...
public final class ArrayTypeAdapter extends TypeAdapter
{
    ...
    public static final TypeAdapterFactory FACTORY = new TypeAdapterFactory() {
        ...
        public TypeAdapter create(Gson gson, TypeToken typetoken)
        {
            ...
            {
                typetoken = com.millennialmedia.google.gson.internal..Gson.Types.getArrayComponentType(typetoken);
                return new ArrayTypeAdapter(gson, gson.getAdapter(TypeToken.get(typetoken)), com.millennialmedia.google.gson.internal..Gson.Types.getRawType(typetoken));
            }
        }
