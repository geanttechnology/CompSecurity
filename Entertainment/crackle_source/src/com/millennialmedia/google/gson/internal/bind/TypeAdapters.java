...
public final class TypeAdapters
{
    private static final class EnumTypeAdapter extends TypeAdapter
    {
        ...
        public EnumTypeAdapter(Class class1)
        {
            ...
            enum = aenum[i];
            s = enum.name();
            serializedname = (SerializedName)class1.getField(s).getAnnotation(com/millennialmedia/google/gson/annotations/SerializedName);
...
_L2:
                ...
                switch (_cls32..SwitchMap.com.millennialmedia.google.gson.stream.JsonToken[jsontoken.ordinal()])
                {
                default:
...
_L3:
        ...
        JSON_ELEMENT = new TypeAdapter() {
                ...
                throws IOException
            {
                ...
                switch (_cls32..SwitchMap.com.millennialmedia.google.gson.stream.JsonToken[jsonreader.peek().ordinal()])
                {
                default:
        ...
        JSON_ELEMENT_FACTORY = newTypeHierarchyFactory(com/millennialmedia/google/gson/JsonElement, JSON_ELEMENT);
    }
}
