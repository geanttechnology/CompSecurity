...
public class TypeToken
{
    ...
    protected TypeToken()
    {
        ...
        rawType = com.millennialmedia.google.gson.internal..Gson.Types.getRawType(type);
        hashCode = type.hashCode();
    }

    TypeToken(Type type1)
    {
        type = com.millennialmedia.google.gson.internal..Gson.Types.canonicalize((Type)com.millennialmedia.google.gson.internal..Gson.Preconditions.checkNotNull(type1));
        rawType = com.millennialmedia.google.gson.internal..Gson.Types.getRawType(type);
        hashCode = type.hashCode();
    }
    ...
    static Type getSuperclassTypeParameter(Class class1)
    {
        ...
        {
            return com.millennialmedia.google.gson.internal..Gson.Types.canonicalize(((ParameterizedType)class1).getActualTypeArguments()[0]);
        }
    }
...
_L2:
    ...
    private static boolean isAssignableFrom(Type type1, ParameterizedType parameterizedtype, Map map)
    {
        ...
        Class class1 = com.millennialmedia.google.gson.internal..Gson.Types.getRawType(type1);
...
_L4:
    ...
    {
        return (obj instanceof TypeToken) && com.millennialmedia.google.gson.internal..Gson.Types.equals(type, ((TypeToken)obj).type);
    }
    ...
    public boolean isAssignableFrom(Type type1)
    {
        ...
        {
            return rawType.isAssignableFrom(com.millennialmedia.google.gson.internal..Gson.Types.getRawType(type1));
        }
        ...
        {
            boolean flag;
            if (rawType.isAssignableFrom(com.millennialmedia.google.gson.internal..Gson.Types.getRawType(type1)) && isAssignableFrom(type1, (GenericArrayType)type))
            {
                flag = true;
            } else
            {
    ...
    {
        return com.millennialmedia.google.gson.internal..Gson.Types.typeToString(type);
    }
}
