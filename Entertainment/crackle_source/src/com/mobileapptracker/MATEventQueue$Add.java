    ...
    implements Runnable
{
    ...
    public void run()
    {
        ...
        jsonobject.put("run_date", e.getTime());
        int i = a.getQueueSize() + 1;
        a.setQueueSize(i);
        String s = Integer.toString(i);
        a.setQueueItemForKey(jsonobject, s);
    ...
    protected (MATEventQueue mateventqueue, String s, String s1, JSONObject jsonobject, Date date)
    {
        a = mateventqueue;
        super();
        b = null;
