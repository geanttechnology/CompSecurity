...
public class Parameters
{
    ...
    private String a(String s1, String s2)
    {
        ...
        s1 = a.getSharedPreferences(s1, 0).getString(s2, "");
        this;
    ...
    static void a(Parameters parameters, String s1)
    {
        parameters.an = s1;
    }
    ...
    private boolean a(Context context, String s1)
    {
        ...
        setCurrencyCode("USD");
        (new Handler(Looper.getMainLooper())).post(new bt(this, a));
        s1 = a.getPackageName();
        setPackageName(s1);
        ...
        setAppVersion(Integer.toString(packagemanager.getPackageInfo(s1, 0).versionCode));
_L5:
