...
public class uestHandler extends uestHandler
{
        ...
        throws Exception
    {
        ...
        String s = a.a();
        if (new AppTaskUploader(AppConfig.g(a), 1000L * l, s) != null)
        {
    ...
    public void onFinish(String s, long l, String s1)
    {
        ...
        if (a.c(s1)) goto _L2; else goto _L1
_L1:
        if (AppSdk.a())
        {
...
_L2:
    ...
    {
        String s = (new StringBuilder()).append("%%%").append(AppConfig.c(a).getNuid()).append("%%%").toString();
        try
        {
