...
public class b extends andler
{
    ...
    public void startRequest()
    {
        ...
        {
            com.nielsen.app.sdk.c.a(interruptedexception, true, 'E', (new StringBuilder()).append("startRequest() failed. Exception:").append(interruptedexception).toString(), new Object[0]);
        }
...
_L6:
        ...
        l3 = ((a) (obj)).a();
        l = l1;
        obj1 = (new StringBuilder()).append("code=").append(String.valueOf(l3)).append(",count=").append(String.valueOf(l2)).append(",t1=").append(String.valueOf(((a) (obj)).())).append(",t2=").append(String.valueOf((() (obj))._mth2())).append(",t3=").append(String.valueOf(((_cls2) (obj))._mth3())).append(",msg=").append(((_cls3) (obj))._mth3()).toString();
        l = l1;
        obj = obj1;
        ...
        obj = new boolean[1];
        obj[0] = 0;
        apprequestmanager = andler._mth3(apprequestmanager, ((boolean []) (obj)));
        if (!obj[0] || apprequestmanager == null)
        {
        ...
        obj = AppLogUploader.h(apploguploader);
        obj.getClass();
        AppLogUploader.a(apploguploader, new <init>(((AppRequestManager) (obj)), "AppLogRequest", this, 60000, 60000, 0x3e800));
        b = apprequestmanager;
