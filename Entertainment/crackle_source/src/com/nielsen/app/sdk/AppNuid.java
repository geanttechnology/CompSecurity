...
public class AppNuid extends Thread
{
    ...
    private static final String b = (new StringBuilder()).append("aa.").append(Integer.toString(1)).append(".").append(Integer.toString(1)).append(".").append(Integer.toString(0)).toString();
    private static final String c = (new StringBuilder()).append("aa.").append(Integer.toString(1)).append(".").append(Integer.toString(1)).append(".").append(Integer.toString(0)).append(".").append(Integer.toString(4)).toString();
