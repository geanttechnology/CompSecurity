...
class AppPreferencesManager extends AppCryptoManager
{
    public class EditorManager extends AppCryptoManager
    {
        ...
        public EditorManager putBoolean(String s, boolean flag)
            throws NoSuchAlgorithmException, NoSuchPaddingException, Exception
        {
            b.putString(encrypt((new StringBuilder()).append('B').append(s).toString(), 1), encrypt(Boolean.toString(flag), 0));
            return this;
        }
        ...
        public EditorManager putDouble(String s, double d1)
            throws NoSuchAlgorithmException, NoSuchPaddingException, Exception
        {
            b.putString(encrypt((new StringBuilder()).append('D').append(s).toString(), 1), encrypt(Double.toString(d1), 0));
            return this;
        }
        ...
        public EditorManager putFloat(String s, float f1)
            throws NoSuchAlgorithmException, NoSuchPaddingException, Exception
        {
            b.putString(encrypt((new StringBuilder()).append('F').append(s).toString(), 1), encrypt(Float.toString(f1), 0));
            return this;
        }
        ...
        public EditorManager putInt(String s, int k)
            throws NoSuchAlgorithmException, NoSuchPaddingException, Exception
        {
            b.putString(encrypt((new StringBuilder()).append('I').append(s).toString(), 1), encrypt(Integer.toString(k), 0));
            return this;
        }
        ...
        public EditorManager putLong(String s, long l)
            throws NoSuchAlgorithmException, NoSuchPaddingException, Exception
        {
            b.putString(encrypt((new StringBuilder()).append('L').append(s).toString(), 1), encrypt(Long.toString(l), 0));
            return this;
        }
    ...
    public char a(String s)
        throws NoSuchAlgorithmException, NoSuchPaddingException, Exception
    {
        String s1 = encrypt((new StringBuilder()).append('B').append(s).toString(), 1);
        if (b.contains(s1))
        {
            return 'B';
        }
        s1 = encrypt((new StringBuilder()).append('F').append(s).toString(), 1);
        if (b.contains(s1))
        {
            return 'F';
        }
        s1 = encrypt((new StringBuilder()).append('D').append(s).toString(), 1);
        if (b.contains(s1))
        {
            return 'D';
        }
        s1 = encrypt((new StringBuilder()).append('I').append(s).toString(), 1);
        if (b.contains(s1))
        {
            return 'I';
        }
        s1 = encrypt((new StringBuilder()).append('L').append(s).toString(), 1);
        if (b.contains(s1))
        {
            return 'L';
        }
    ...
    public double a(String s, double d1)
        throws NoSuchAlgorithmException, NoSuchPaddingException, Exception
    {
        s = encrypt((new StringBuilder()).append('D').append(s).toString(), 1);
    ...
    public float a(String s, float f1)
        throws NoSuchAlgorithmException, NoSuchPaddingException, Exception
    {
        s = encrypt((new StringBuilder()).append('F').append(s).toString(), 1);
        s = b.getString(s, null);
        if (s != null)
        {
    ...
    public int a(String s, int k)
        throws NoSuchAlgorithmException, NoSuchPaddingException, Exception
    {
        s = encrypt((new StringBuilder()).append('I').append(s).toString(), 1);
        s = b.getString(s, null);
        if (s != null)
        {
...
_L3:
        ...
        c1 = '\001';
_L7:
        if (c1 != 0) goto _L4; else goto _L5
_L5:
        k++;
          goto _L6
_L4:
...
_L2:
    ...
    public boolean a(String s, boolean flag)
        throws NoSuchAlgorithmException, NoSuchPaddingException, Exception
    {
        s = encrypt((new StringBuilder()).append('B').append(s).toString(), 1);
        s = b.getString(s, null);
        if (s != null)
        {
    ...
    public long c(String s, long l)
        throws NoSuchAlgorithmException, NoSuchPaddingException, Exception
    {
        s = encrypt((new StringBuilder()).append('L').append(s).toString(), 1);
        s = b.getString(s, null);
        if (s != null)
        {
