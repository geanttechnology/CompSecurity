...
private class setParams extends DefaultHttpClient
{
    ...
    private class AppSocketFactory.a
        implements X509TrustManager
    {
        ...
        private AppSocketFactory.a(AppSocketFactory appsocketfactory)
        {
            a = appsocketfactory;
            super();
        }

        AppSocketFactory.a(AppSocketFactory appsocketfactory, AppRequestManager._cls1 _pcls1)
        {
            this(appsocketfactory);
        }
    }
...
_L12:
    ...
    public AppSocketFactory.a(AppRequestManager apprequestmanager, int i, int j, int k)
    {
        a = apprequestmanager;
        super();
        d = null;
