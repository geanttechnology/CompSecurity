...
_L6:
        ...
        throws Exception
    {
        ...
        if (k1 != 200 && k1 != 201)
        {
            throw new Exception((new StringBuilder()).append("Request failed. Reason(").append(((String) (obj1))).append(") Code(").append(String.valueOf(k1)).append(") Protocol(").append(s).append(") Version(").append(String.valueOf(i1)).append(".").append(String.valueOf(j1)).append(")").toString());
        }
        obj = (new StringBuilder()).append("Request executed. Reason(").append(((String) (obj1))).append(") Code(").append(String.valueOf(k1)).append(") Protocol(").append(s).append(") Version(").append(String.valueOf(i1)).append(".").append(String.valueOf(j1)).append(")").toString();
        if (e != null)
        {
            long l1 = com.nielsen.app.sdk.h.g();
