...
_L3:
        s = a(s);
        d = s.toLowerCase(Locale.getDefault()).contains("\"nol_devdebug\":\"true\"");
        if (d)
        {
            Log.d("AppSdk", (new StringBuilder()).append("Nielsen AppSDK: getInstance API - ").append(s).toString());
        }
        if (c == null)
        {
        ...
        {
            {
                ...
                s = (new StringBuilder()).append("Nielsen AppSDK: getInstance API - ");
                if (e)
                {
                    context = "SUCCESS";
                } else
...
_L2:
        ...
        context;
        Log.e("AppSdk", (new StringBuilder()).append("Nielsen AppSDK: getInstance API - JSON EXCEPTION; ").append(context.getMessage()).toString());
        if (d)
        {
            s = (new StringBuilder()).append("Nielsen AppSDK: getInstance API - ");
            if (e)
          ...
          goto _L4
        context;
        Log.e("AppSdk", (new StringBuilder()).append("Nielsen AppSDK: getInstance API - EXCEPTION; ").append(context.getMessage()).toString());
        if (d)
        {
            s = (new StringBuilder()).append("Nielsen AppSDK: getInstance API - ");
            if (e)
          ...
          goto _L4
        context;
        Log.e("AppSdk", (new StringBuilder()).append("Nielsen AppSDK: getInstance API - ERROR; ").append(context.getMessage()).toString());
...
_L7:
        ...
        if (d)
        {
            iappnotifier = (new StringBuilder()).append("Nielsen AppSDK: getInstance API - ");
            if (e)
            {
                context = "SUCCESS";
            } else
...
_L8:
        ...
        throws JSONException
    {
        if (d)
        {
            Log.d("AppSdk", (new StringBuilder()).append("Nielsen AppSDK: trimJSONString API - JSON input : ").append(s).toString());
        }
        s = new JSONObject(s);
        ...
        if (d)
        {
            Log.d("AppSdk", (new StringBuilder()).append("Nielsen AppSDK: trimJSONString API - JSON output : ").append(s).toString());
        }
        return s;
    }
    ...
    public static String getLastError()
    {
        ...
        if (d)
        {
            StringBuilder stringbuilder = (new StringBuilder()).append("Nielsen AppSDK: getLastError API - ");
            String s;
    ...
    public static String getLastEvent()
    {
        ...
        if (d)
        {
            StringBuilder stringbuilder = (new StringBuilder()).append("Nielsen AppSDK: getLastEvent API - ");
            String s;
            if (s1 != null && !s1.isEmpty())
            {
                s = s1;
    ...
    public static String getMeterVersion()
    {
        ...
        if (d)
        {
            StringBuilder stringbuilder = (new StringBuilder()).append("Nielsen AppSDK: getMeterVersion API - ");
            String s;
            if (s1 != null && !s1.isEmpty())
            {
                s = s1;
    ...
    public static boolean isValid()
    {
        ...
        if (d)
        {
            StringBuilder stringbuilder = (new StringBuilder()).append("Nielsen AppSDK: isValid API - ");
            String s;
            if (e)
            {
                s = "TRUE";
    ...
    public AppSdk appDisableApi(boolean flag)
    {
        ...
        if (d)
        {
            StringBuilder stringbuilder = (new StringBuilder()).append("Nielsen AppSDK: appDisableApi API - ");
        ...
        if (d)
        {
            stringbuilder1 = (new StringBuilder()).append("Nielsen AppSDK: appDisableApi API - ");
            String s;
            if (obj == null)
            {
                s = "FAILED";
    ...
    public String getDeviceId()
    {
        ...
        if (d)
        {
            StringBuilder stringbuilder = (new StringBuilder()).append("Nielsen AppSDK: getDeviceId API - ");
            String s1;
            if (s != null && !s.isEmpty())
            {
                s1 = s;
    ...
    public String getNielsenId()
    {
        ...
        if (d)
        {
            StringBuilder stringbuilder = (new StringBuilder()).append("Nielsen AppSDK: getNielsenId API - ");
            String s1;
            if (s != null && !s.isEmpty())
            {
                s1 = s;
    ...
    public AppSdk loadMetadata(String s)
    {
        ...
        if (d)
        {
            stringbuilder = (new StringBuilder()).append("Nielsen AppSDK: loadMetadata API - ");
            if (s != null && !s.isEmpty())
            {
                obj = s;
            } else
...
_L5:
        obj = b;
          goto _L4
        s;
        Log.e("AppSdk", (new StringBuilder()).append("Nielsen AppSDK: loadMetadata API - JSON EXCEPTION; ").append(s.getMessage()).toString());
        obj = stringbuilder;
          goto _L4
        s;
        Log.e("AppSdk", (new StringBuilder()).append("Nielsen AppSDK: loadMetadata API - EXCEPTION; ").append(s.getMessage()).toString());
        obj = stringbuilder;
          goto _L4
    }
    ...
    public AppSdk play(String s)
    {
        ...
        if (d)
        {
            obj = (new StringBuilder()).append("Nielsen AppSDK: play API - ");
            if (s != null && !s.isEmpty())
            {
                s1 = s;
            } else
...
_L3:
        s = b;
          goto _L4
        s;
        Log.e("AppSdk", (new StringBuilder()).append("Nielsen AppSDK: play API - JSON EXCEPTION; ").append(s.getMessage()).toString());
        s = s1;
          goto _L4
        s;
        Log.e("AppSdk", (new StringBuilder()).append("Nielsen AppSDK: play API - EXCEPTION; ").append(s.getMessage()).toString());
        s = s1;
          goto _L4
    }
    ...
    public AppSdk sendID3(String s)
    {
        ...
        if (d)
        {
            stringbuilder = (new StringBuilder()).append("Nielsen AppSDK: sendID3 API - ");
            if (s != null && !s.isEmpty())
            {
                obj = s;
            } else
...
_L2:
        ...
        catch (Exception exception)
        {
            if (d)
            {
                exception = (new StringBuilder()).append("Nielsen AppSDK: sendID3 API - FAILED - ").append(exception.getMessage()).append(" - ");
                if (s == null || s.isEmpty())
                {
                    s = "EMPTY";
                }
...
_L4:
        if (d && appsdk == null)
        {
            Log.d("AppSdk", (new StringBuilder()).append("Nielsen AppSDK: setPlayheadPosition API - FAILED; ").append(String.valueOf(l)).toString());
        }
        return appsdk;
_L2:
        if (c.a(l))
...
_L3:
    ...
    public AppSdk stop()
    {
        ...
        if (d)
        {
            StringBuilder stringbuilder = (new StringBuilder()).append("Nielsen AppSDK: stop API - ");
            String s;
            if (flag)
            {
                s = "BACKGROUND";
    ...
    public AppSdk suspend()
    {
        ...
        if (d)
        {
            StringBuilder stringbuilder = (new StringBuilder()).append("Nielsen AppSDK: suspend API - ");
            String s;
            if (b == null)
            {
                s = "TERMINATED";
    ...
    public AppSdk userOptOut(String s)
    {
        ...
        if (d)
        {
            StringBuilder stringbuilder = (new StringBuilder()).append("Nielsen AppSDK: userOptOut API - ");
            if (s != null && !s.isEmpty())
            {
                obj = s;
            } else
        ...
        if (d)
        {
            stringbuilder = (new StringBuilder()).append("Nielsen AppSDK: userOptOut API - ");
            if (obj == null)
            {
                s = "FAILED";
            } else
    ...
    public String userOptOutURLString()
    {
        ...
        {
            Log.d("AppSdk", (new StringBuilder()).append("Nielsen AppSDK: userOptOutURLString API - SUCCESS; ").append(s).toString());
        }
        return s;
    }
