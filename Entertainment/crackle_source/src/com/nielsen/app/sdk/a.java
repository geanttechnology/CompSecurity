...
_L11:
        ...
        {
            throw new Exception((new StringBuilder()).append("Incorrect AppId provided - ").append(s1).toString());
        }
          goto _L6
        context;
_L10:
        try
        {
            throw new Exception((new StringBuilder()).append("Failed to parse JSON - ").append(s1).append("; ").append(context.getMessage()).toString());
        }
...
_L2:
        ...
        boolean flag = p.h();
        StringBuilder stringbuilder = (new StringBuilder()).append("Session stopped ");
        String s1;
        if (flag)
        {
            s1 = "successfully";
...
_L2:
        ...
        s3 = s1;
        s4 = s1;
        throw new Exception((new StringBuilder()).append("Invalid ID3. Length too short(").append(Integer.valueOf(i1)).append(")").toString());
        s1;
        if (AppSdk.a())
        {
            Log.d("AppSdk", (new StringBuilder()).append("Nielsen AppSDK: ").append(s1.getMessage()).toString());
        }
