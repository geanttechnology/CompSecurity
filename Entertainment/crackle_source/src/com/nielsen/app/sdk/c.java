...
_L12:
        if (s1.length() > 0)
        {
            (new StringBuilder()).append("").append(String.format(s1, aobj)).toString();
        }
_L13:
        a(c1, ab.toString());
        return;
...
_L14:
    ...
    private static void g()
    {
        if (V.isEmpty())
        {
            ...
            if (!V.isEmpty())
            {
                V = (new StringBuilder()).append(" | libAppSdk.so ").append(V).toString();
            }
            V = (new StringBuilder()).append("AppSdk.jar ").append(com.nielsen.app.sdk.h.q()).append(V).toString();
        }
    }
