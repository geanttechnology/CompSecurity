...
public class AchievementActivity extends Activity
{
        ...
        throws AchievementActivityIllegalStateException
    {
        ...
        Activity activity = f1.getCurrentActivity();
        if (!equals(activity))
        {
        ...
        } else
        {
            ...
            achievement.a(com.sessionm.core.AchievementImpl.AchievementState.J);
            f1.b(this);
            return;
        }
    }
...
_L3:
        ...
        throws AchievementActivityIllegalStateException
    {
        this;
        JVM INSTR monitorenter ;
        if (!state.equals(AchievementActivityState.UNPRESENTED) || !getAchievementImpl().b().equals(com.sessionm.core.AchievementImpl.AchievementState.H))
        {
        ...
        achievement.a(com.sessionm.core.AchievementImpl.AchievementState.I);
        f1.ar();
        this;
        JVM INSTR monitorexit ;
    }
