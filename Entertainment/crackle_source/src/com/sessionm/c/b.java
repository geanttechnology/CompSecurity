...
_L3:
        ...
        request;
        throw request;
        if (request.ba() == null || request.ba().equals(com.sessionm.net.Request.State.fe))
        {
...
_L5:
        Log.e("SessionM", String.format("Attempt to save inflight request: %s", new Object[] {
            request
        }));
        flag = flag2;
          goto _L4
...
_L6:
        Log.e("SessionM", (new StringBuilder()).append("Object already in a request store: ").append(request.aX()).toString());
        flag = flag2;
          goto _L4
        if (getSize() + 1L <= gQ)
        {
...
_L5:
        ...
        flag = flag1;
          goto _L4
        if (request.ba() == com.sessionm.net.Request.State.ff && Log.isLoggable("SessionM.Store", 6))
        {
            Log.e("SessionM.Store", String.format("Attempting to delete inflight request. %s", new Object[] {
                request
            }));
        }
        if (Log.isLoggable("SessionM.Store", 3))
...
_L12:
        ...
        if (Log.isLoggable("SessionM.Store", 6))
        {
            Log.e("SessionM.Store", String.format(Locale.US, "Deleted wrong number of requests from store. Expected %d actual: %d.", new Object[] {
                Integer.valueOf(i1), Integer.valueOf(j)
            }));
        }
        sqlitedatabase.close();
        if (Log.isLoggable("SessionM.Store", 3))
...
_L13:
    ...
    public void onUpgrade(SQLiteDatabase sqlitedatabase, int j, int i1)
    {
        this;
        JVM INSTR monitorenter ;
    }
...
_L3:
        ...
        com.sessionm.core.i.a(((java.io.Closeable) (obj1)));
        com.sessionm.core.i.a(bytearrayinputstream);
          goto _L5
        obj;
        throw obj;
        obj;
...
_L9:
        ...
        com.sessionm.core.i.a(((java.io.Closeable) (obj)));
        com.sessionm.core.i.a(bytearrayinputstream);
_L4:
        cursor.close();
        sqlitedatabase.close();
