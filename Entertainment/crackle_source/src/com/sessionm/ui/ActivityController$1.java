    ...
    implements Runnable
{
    ...
    public void run()
    {
        Object obj = ActivityController.access$000(ActivityController.this).at();
        if (((b) (obj)).a(ActivityController.access$100(ActivityController.this)))
        {
            obj = ((b) (obj)).f(ActivityController.access$100(ActivityController.this));
            if (obj == null)
            {
