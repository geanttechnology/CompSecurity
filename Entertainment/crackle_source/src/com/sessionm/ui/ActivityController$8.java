...
_L2:
        ...
        if (s == null)
        {
            ...
            ActivityController.access$000(ActivityController.this).logError("jsinterface-message-error", "JS command handler not specified", null);
            return;
        }
...
_L5:
        if (obj == null)
        {
            try
            {
                ...
                ActivityController.access$000(ActivityController.this).logError("jsinterface-message-error", ((String) (obj)), null);
                return;
            }
            ...
            ActivityController.access$000(ActivityController.this).logError("jsinterface-message-exception", ((String) (obj1)), ((Throwable) (obj)));
            return;
        }
