...
//            VideoErrorListener, VideoProgressListener, SessionMViewContainer, SessionMVideoActivity, 
//            JSInterfaceListener, SessionMActivity, SessionMVideoView
    ...
    implements SessionMViewContainer.SessionMViewContainerListener, VideoErrorListener, VideoProgressListener
{
    public static final class ContentError extends Enum
    {
        ...
        private ContentError(String s, int j, int k, String s1)
        {
            super(s, j);
            code = k;
            message = s1;
    ...
    static int convertDpToPixels(Context context, int j)
    {
        if (context == null || j <= 0)
        {
            return 0;
        ...
        {
            return (int)(context.getResources().getDisplayMetrics().density * (float)j);
        }
    }

    static int convertPixelsToDp(Context context, int j)
    {
        if (context == null || j <= 0)
        {
            return 0;
    ...
    public static transient ActivityController createActivityController(boolean flag, Activity activity, String s, Object aobj[])
    {
        int j = f.E().getFragmentFrameLayoutId();
        Object obj;
        if (j != -1)
        {
        ...
        } else
        {
            ...
            activity = activity.getActivityController(f.E().J());
            activity.setFragmentFrameLayoutId(j);
            activity.setActivityContent(null);
            return activity;
        }
    }
    ...
    private void downloadImage(String s, final a message)
    {
        ...
        s = new Request(com.sessionm.net.Request.Type.fm, new Object[] {
            s
        });
        s.d(com.sessionm.net.Request.Header.eM.getKey(), "no-cache");
        s.a(new c() {
            ...
            {
                request = getFileNameForUriAndHeaderFields(URI.create(request.getURL()), request.a(com.sessionm.net.Request.Header.eO));
    ...
    private a getActivityData()
    {
        ...
        if (activityData == null)
        {
            ...
            activityData.put("connection_type", i.k(getActivityContext()));
...
label0:
    ...
    private android.view.ViewGroup.LayoutParams getViewLayoutParams(a a1)
    {
        ...
        i1 = a1.getInt("horizontal_offset");
        j1 = a1.getInt("vertical_offset");
        k1 = ((Integer)xPosFlagMap.get(s1)).intValue();
        l1 = ((Integer)yPosFlagMap.get(s)).intValue();
        k = convertDpToPixels(activity, a1.getInt("width"));
        int l = convertDpToPixels(activity, a1.getInt("height"));
...
_L1:
        a1 = new android.widget.FrameLayout.LayoutParams(j, k);
        if (l1 == 48)
        {
            a1.topMargin = convertDpToPixels(activity, j1);
        }
        if (l1 == 80)
        {
            a1.bottomMargin = convertDpToPixels(activity, j1);
        }
        if (k1 != 3) goto _L4; else goto _L3
_L3:
        a1.leftMargin = convertDpToPixels(activity, i1);
_L5:
        a1.gravity = k1 | l1;
        return a1;
_L4:
        if (k1 == 5)
        {
            a1.rightMargin = convertDpToPixels(activity, i1);
        }
...
_L2:
            ...
            public void run()
            {
                ...
                if (aa != null)
                {
                    ...
                    for (int j = 0; j < k; j++)
                    {
                        ...
                        String s1 = com.sessionm.a.a.b(((String) (obj)), s);
                        a a2 = a.aG();
                        a2.put("value", s1);
                ...
                a1.put("limitadtracking", com.sessionm.a.a.r(session.getApplicationContext()));
    ...
    private void handleMakeRequestMessageAsync(final a message)
    {
        ...
        if (s == null)
        {
            notifyContentAboutError(ContentError.MISSING_URL, s);
            finishMessageHandling(message, null);
            return;
        } else
        {
    ...
    private void handleOptinMessageAsync(final a message)
    {
        ...
        h1.a(session.getApplicationContext(), false, new com.sessionm.core.h.a() {
    ...
    private void handlePlayMessage(a a1)
    {
        ...
        if (a1 == null)
        {
            notifyContentAboutError(ContentError.MISSING_URL, a1);
        }
...
_L2:
        ...
        if (a1 == null)
        {
            ...
            ((com.sessionm.api.ActivityListener.UserAction) (obj)).setCode(k);
        }
        a1 = new HashMap();
        if (a2 != null)
        {
...
_L3:
    ...
    {
        List list = getActivityContext().getPackageManager().getInstalledPackages(8192);
        int k = list.size();
        for (int j = 0; j < k; j++)
        {
            if (s.equalsIgnoreCase(((PackageInfo)list.get(j)).packageName))
            {
                return true;
            }
        }
    ...
    private void sendContentRequest(final LoadContentListener loadContentListener)
    {
        ...
        request.a(com.sessionm.net.Request.Priority.fc);
        request.a(new c() {
                ...
                getActivityContext().runOnUiThread(request1. new Runnable() {
                    ...
                    public void run()
                    {
                        if (request.aQ() == null)
                        {
                            ...
                            if (request.aR() != null)
                            {
                                setActivityContent(request.aR().bA());
                            }
                        ...
                        if (Log.isLoggable("SessionM.Activity", 3))
                        {
                            Log.d("SessionM.Activity", (new StringBuilder()).append("Failed to load activity content, reason: ").append(request.aQ().getMessage()).toString());
                        }
                        setState(State.UNPRESENTABLE);
                        loadContentListener.onFailure(request.aQ());
                    }
    ...
    private void sendMakeRequest(final a message)
    {
        ...
        a a1 = message.x("params");
        RequestQueue requestqueue = session.M();
                ...
                } else
                {
                    activity.runOnUiThread(request. new Runnable() {
                        ...
                        public void run()
                        {
                            ...
                            if (request.ba().equals(com.sessionm.net.Request.State.fg))
                            {
                                a a1 = request.aW();
                                finishMessageHandling(message, a1);
                                return;
...
_L2:
                ...
                if (s == null)
                {
                    ...
                    session.logError("jsinterface-message-error", "JS command handler not specified", null);
                    return;
                }
...
_L5:
                if (obj == null)
                {
                    try
                    {
                        ...
                        session.logError("jsinterface-message-error", ((String) (obj)), null);
                        return;
                    }
                    // Misplaced declaration of an exception variable
                    catch (Object obj)
                    ...
                    session.logError("jsinterface-message-exception", ((String) (obj1)), ((Throwable) (obj)));
                    return;
                }
...
_L3:
    ...
    public void displayView()
    {
        ...
        if (flag && !isFullScreenActivity())
        {
            ...
            session.ar();
            StatsCollector.a(com.sessionm.core.StatsCollector.Stat.dk, presentationStartTime - System.currentTimeMillis());
            return;
        } else
        {
...
_L5:
    ...
    protected void handleOpenMessageAsync(final a message)
    {
        ...
        if (url == null)
        {
            ...
            session.logError("open-error", message, null);
            dismiss();
            return;
        }
        if (isFullScreenActivity())
        {
            final ActivityController controller = createActivityController(true, getActivityContext(), url, new Object[0]);
...
label0:
    ...
    public void loadActivity(final LoadContentListener loadContentListener)
    {
        ...
        session.getExecutorService().execute(new Runnable() {
            ...
            public void run()
            {
                Object obj = session.at();
                if (((b) (obj)).a(contentUrl))
                {
                    obj = ((b) (obj)).f(contentUrl);
                    if (obj == null)
                    {
    ...
    void notifyAboutVideoError(String s, int j, int k)
    {
        s = a.aG();
        ...
        s.put("what", j);
        s.put("extra", k);
        dispatchMessage("error", s.aI().toString());
    }
    ...
    void notifyContentAboutError(ContentError contenterror, String s)
    {
        ...
        dispatchMessage("error", a1.aI().toString());
    }
    ...
    public void onFailure(SessionMViewContainer sessionmviewcontainer, int j, final String description, String s)
    {
        ...
        StatsCollector.a(com.sessionm.core.StatsCollector.Stat.dm, 1L);
    }
    ...
    {
        a a1 = a.aG();
        int j = sessionmvideoview.getDuration();
        int k = sessionmvideoview.getCurrentPosition();
        a1.put("percentComplete", (float)k / (float)j);
        a1.put("timeRemaining", j - k);
        a1.put("currentTime", k);
        dispatchMessage("video.completed", a1.toString());
    }

    public boolean onVideoError(SessionMVideoView sessionmvideoview, int j, int k)
    {
        dispatchMessage("video.error", "{}");
        notifyAboutVideoError(sessionmvideoview.getUrl(), j, k);
        return false;
    }

    public void onVideoProgress(SessionMVideoView sessionmvideoview, int j)
    {
        a a1 = a.aG();
        j = sessionmvideoview.getDuration();
        int k = sessionmvideoview.getCurrentPosition();
        a1.put("percentComplete", (float)k / (float)j);
        a1.put("timeRemaining", j - k);
        a1.put("currentTime", k);
        dispatchMessage("video.progress", a1.toString());
    }
    ...
    public void onViewLoadStarted(SessionMViewContainer sessionmviewcontainer, String s)
    {
        ...
        {
            sessionmviewcontainer = a.aG();
            sessionmviewcontainer.put("url", s);
            dispatchMessage("loadURL.callback", sessionmviewcontainer.aI().toString());
        }
    }
    ...
    public void prepare(final PrepareListener prepareListener)
    {
        ...
        if (!session.getSessionState().isStarted() && !session.D().isOptedOut())
        {
            setState(State.UNPRESENTABLE);
