...
_L3:
        ...
        if (videostate == VideoState.STOPPED && (videoState != VideoState.STARTED || videoState != VideoState.COMPLETE || videoState != VideoState.PAUSED) && Log.isLoggable("SessionM.Video", 6))
        {
            Log.e("SessionM.Video", String.format("Invalid State transition: %s", new Object[] {
                videostate
            }));
...
_L3:
    ...
    public void hide()
    {
        ...
        if (Log.isLoggable("SessionM.Video", 3))
        {
            Log.d("SessionM.Video", String.format(Locale.US, "SessionM.Video", new Object[] {
                "hide video called"
            }));
        }
        activity = mActivity;
