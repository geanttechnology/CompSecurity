...
class this._cls0 extends c
{
    ...
    public void onReplyReceived(Request request)
    {
        ...
        if (request.ba() == com.sessionm.net.his._fld0)
        {
        ...
        } else
        {
            ((Activity)getContext()).runOnUiThread(new Runnable() {
                ...
                public void run()
                {
                    ImageViewContainer.access$500(this$0).setReloadPropmptState(ProgressViewController.ReloadPromptState.UNAVAILABLE);
                }
