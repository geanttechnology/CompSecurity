...
//            SessionMActivity, ProgressViewController, ActivityController

class this._cls1
    implements Runnable
{

    final r.ReloadPromptState.RELOAD this$1;

    public void run()
    {
        getLoadingIndicator().setReloadPropmptState(r.ReloadPromptState.RELOAD);
    }
