    ...
    implements com.tremorvideo.sdk.android.videoad.a.a, l
{
    ...
    public b()
    {
        ...
        f = new BroadcastReceiver() {
            ...
            {
                a.c = false;
                com.tremorvideo.sdk.android.richmedia.a.b.a(a).l();
            }
        ...
        g = new BroadcastReceiver() {
            ...
            {
                a.c = true;
                com.tremorvideo.sdk.android.richmedia.a.b.a(a).k();
            }
        ...
        h = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent)
            {
                if (a.c)
                {
                    com.tremorvideo.sdk.android.richmedia.a.b.a(a).d();
                }
            }
    ...
    static com.tremorvideo.sdk.android.richmedia.a.a a(b b1)
    {
        return b1.i;
    }
    ...
    public void a(Bundle bundle, Activity activity)
    {
        ...
        i = new com.tremorvideo.sdk.android.richmedia.a.a(this, j, a);
        bundle = j.getIntent().getExtras().getString("path");
        activity = j.getIntent().getExtras().getString("params");
        k = new c(j, this);
        ((c)k).a(activity);
        activity = a.t();
        k.setPadding(0, 0, 0, 0);
        e = new Timer();
        e.schedule(new a((new StringBuilder()).append("file://").append(activity).append("/").append(bundle).toString()), 1000L);
        j.setContentView(k);
        l = b;
