...
public class com.tremorvideo.sdk.android.richmedia.b
{
    ...
    public com.tremorvideo.sdk.android.richmedia.b(q q1)
    {
        c = q1;
    }
    ...
    public static PointF a(k k1, b b1)
    {
        switch (_cls1.a[b1.ordinal()])
        {
        default:
        ...
        case 1: // '\001'
            return new PointF(k1.a, k1.b);

        case 2: // '\002'
            return new PointF(k1.a + k1.f / 2.0F, k1.b);

        case 3: // '\003'
            return new PointF(k1.a + k1.f, k1.b);

        case 4: // '\004'
            return new PointF(k1.a, k1.b + k1.g / 2.0F);

        case 5: // '\005'
            return new PointF(k1.a + k1.f / 2.0F, k1.b + k1.g / 2.0F);

        case 6: // '\006'
            return new PointF(k1.a + k1.f, k1.b + k1.g / 2.0F);

        case 7: // '\007'
            return new PointF(k1.a, k1.b + k1.g);

        case 8: // '\b'
            return new PointF(k1.a + k1.f / 2.0F, k1.b + k1.g);

        case 9: // '\t'
            return new PointF(k1.a + k1.f, k1.b + k1.g);
        }
    }
