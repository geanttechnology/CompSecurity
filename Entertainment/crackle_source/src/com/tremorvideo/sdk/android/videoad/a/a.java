...
_L2:
            ...
            if (s.length() > 0)
            {
                if (b)
                {
                    if (a == b.f)
                    {
                        ((com.tremorvideo.sdk.android.videoad.a.b)c.get(c.size() - 1)).b = s;
                    } else
                    if (a == b.g)
                    {
                        d = s;
                    ...
                    if (a == b.h)
                    {
                        c.add(new com.tremorvideo.sdk.android.videoad.a.b("click", s));
                    } else
                    if (a == b.i)
                    {
                        if (c(f.d) && b(s))
                ...
                if (a == b.c)
                {
                    c.add(new com.tremorvideo.sdk.android.videoad.a.b("impression", s));
                } else
                if (a == b.k)
                {
                    h = s;
...
_L3:
            ...
            throws SAXException
        {
            ...
            } else
            {
                ...
                if (b)
                {
                    if (a == b.f)
                    {
                        c.add(new com.tremorvideo.sdk.android.videoad.a.b(attributes.getValue("event")));
                        return;
                    }
                    if (a == b.i)
                    {
    ...
    {
        Collections.sort(list, new Comparator(Math.max(ad.l(), ad.m()), Math.min(ad.l(), ad.m())) {

            final int a;
            final int b;
            final com.tremorvideo.sdk.android.videoad.a.a c;
            ...
            {
                c = com.tremorvideo.sdk.android.videoad.a.a.this;
                a = i;
                b = j;
                super();
            }
