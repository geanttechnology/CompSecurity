...
public class ac
{
    ...
    private void c()
    {
        ...
        for (obj = ((List) (obj)).iterator(); ((Iterator) (obj)).hasNext(); a.remove(a1.a))
        {
            ...
            ad.d((new StringBuilder()).append("Cleaning cookie: ").append(a1.toString()).toString());
        }
    ...
    {
        Object obj;
        ad.d("Loading cookies...");
        obj = y.a(b, "cookies.cookies").getAbsoluteFile();
        if (!((File) (obj)).exists())
        {
...
_L2:
        ...
        ad.d((new StringBuilder()).append("Loading cookie: ").append(a1.toString()).toString());
        hashmap.put(a1.a, a1);
        i++;
...
_L1:
        ...
        {
            ad.d((new StringBuilder()).append("Removing cookie: ").append(a1.toString()).toString());
            a.remove(a1.a);
            c = true;
        }
_L5:
...
_L3:
        ad.d((new StringBuilder()).append("Adding cookie: ").append(a1.toString()).toString());
        a.put(a1.a, a1);
        c = true;
          goto _L5
        a1;
...
_L6:
        ad.d((new StringBuilder()).append("Updating cookie: ").append(a1.toString()).toString());
        a.remove(a1.a);
        a.put(a1.a, a1);
        c = true;
          goto _L5
...
_L1:
        ad.d("No changes in cookies detected, no need to save.");
_L5:
        this;
        JVM INSTR monitorexit ;
        return;
...
_L3:
        ...
        obj;
        throw obj;
        File file = y.a(b, "cookies.cookies").getAbsoluteFile();
        if (file.exists())
        {
            file.delete();
        }
