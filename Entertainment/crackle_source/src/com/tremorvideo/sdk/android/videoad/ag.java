...
public class ag extends DatePickerDialog
{
    ...
    public ag(Context context, android.app.DatePickerDialog.OnDateSetListener ondatesetlistener, int i, int j, int k)
    {
    ...
    public static DatePickerDialog a(Context context, android.app.DatePickerDialog.OnDateSetListener ondatesetlistener, int i, int j, int k)
    {
        ...
        {
            return new ag(context, ondatesetlistener, i, j, k);
        } else
        {
            return new ah(context, ondatesetlistener, i, j, k);
        }
    }
