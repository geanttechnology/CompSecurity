...
public class bt
{
    ...
    private void b()
    {
        ...
        for (obj = ((List) (obj)).iterator(); ((Iterator) (obj)).hasNext(); a.remove(a1.a))
        {
            ...
            ad.d((new StringBuilder()).append("Cleaning data: ").append(a1.toString()).toString());
        }
    ...
    private void c()
    {
        Object obj;
        ad.d("Loading data...");
        obj = y.a(b, "savedata.savedata").getAbsoluteFile();
        if (!((File) (obj)).exists())
        {
...
_L2:
        ...
        ad.d((new StringBuilder()).append("Loading data: ").append(a1.toString()).toString());
        hashmap.put(a1.a, a1);
        i++;
...
_L1:
        s = (new StringBuilder()).append(s).append(d.i()).toString();
        if (!a.containsKey(s)) goto _L2; else goto _L3
_L3:
        s = ((a)a.get(s)).b;
_L5:
        this;
...
_L1:
        ad.d("No changes in save data detected, no need to save.");
_L5:
        this;
        JVM INSTR monitorexit ;
        return;
...
_L3:
        ...
        obj;
        throw obj;
        File file = y.a(b, "savedata.savedata").getAbsoluteFile();
        if (file.exists())
        {
            file.delete();
        }
