...
public class TIOStreamTransport extends TTransport
{
    ...
    private static final Logger a = LoggerFactory.getLogger(org/apache/thrift/transport/TIOStreamTransport.getName());
    ...
    public void close()
    {
        if (inputStream_ != null)
        {
            ...
            {
                a.warn("Error closing input stream.", ioexception);
            }
            inputStream_ = null;
        }
        if (outputStream_ != null)
        {
            ...
            {
                a.warn("Error closing output stream.", ioexception1);
            }
            outputStream_ = null;
        }
    }
