    ...
    implements IAdManager
{
    ...
    {
        version = -1;
        adManagerVersion = "5.15.2-r10578-1407080530";
    ...
    public void registerExtension(String s, Class class1)
    {
        ExtensionManager.registerExtension(s, class1);
    }

    public void registerRenderer(String s, Class class1)
    {
        AdRenderer.registerRenderer(s, class1);
    }
