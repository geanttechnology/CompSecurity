...
public class CreativeRendition extends ParametersHolder
    implements ICreativeRendition, Comparable
{
    ...
    public ArrayList getOtherRenditionAssets()
    {
        ArrayList arraylist = new ArrayList();
        for (Iterator iterator = otherCreativeRenditionAssets.iterator(); iterator.hasNext(); arraylist.add(iterator.next())) { }
        return arraylist;
    }
