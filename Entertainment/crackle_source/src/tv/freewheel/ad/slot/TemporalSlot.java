...
// Referenced classes of package tv.freewheel.ad.slot:
//            Slot
...
public class TemporalSlot extends Slot
{
    ...
    public int getHeight()
    {
        ...
        if (framelayout != null)
        {
            DisplayMetrics displaymetrics = context.getActivity().getResources().getDisplayMetrics();
            i = byte0;
            if (framelayout.getHeight() > 0)
            {
                i = (int)((float)framelayout.getHeight() / displaymetrics.density);
            }
        }
        return i;
    }
    ...
    public int getWidth()
    {
        ...
        if (framelayout != null)
        {
            ...
            {
                i = (int)((float)framelayout.getWidth() / displaymetrics.density);
            }
        }
        return i;
    }

    public void init(String s, String s1, double d, String s2, int i, double d1, String s3, String s4, double d2)
    {
        super.init(s, s1, s2, s4, s3);
        timePosition = d;
        cuePointSequence = i;
        maxDuration = d1;
        minDuration = d2;
        embeddedAdsDuration = -1D;
        endTimePosition = -1D;
    }
