...
//            RendererState, RendererFailedState, RendererStopPendingState, RendererPausedState
...
public class RendererStartedState extends RendererState
{
    ...
    public void pause(AdInstance adinstance)
    {
        ...
        ((RendererPausedState)adinstance.rendererState).rendererStartedBeforePause = true;
