    ...
    implements IExtension
{
    ...
    public void stop()
    {
        ...
        if (adContext != null)
        {
            ...
            adContext.removeEventListener(constants.EVENT_USER_ACTION_NOTIFIED(), userActionNotified);
            adContext.removeEventListener(constants.EVENT_SLOT_STARTED(), slotStartedListener);
            adContext.removeEventListener(constants.EVENT_SLOT_ENDED(), slotEndedListener);
            adContext.removeEventListener(constants.EVENT_AD_IMPRESSION(), adImpressionListener);
            adContext.removeEventListener(constants.EVENT_ERROR(), adErrorListener);
            adContext = null;
        }
    }
