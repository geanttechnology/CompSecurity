    ...
    implements VPAIDEventListener
{
    ...
    public void onEvent(VPAIDEvent vpaidevent)
    {
        ...
        LiveRailFWRenderer.access$0(LiveRailFWRenderer.this, true);
        Log.v("LiveRailRenderer", "Dispatching EVENT_AD_LOADED");
        LiveRailFWRenderer.access$1(LiveRailFWRenderer.this).dispatchEvent(LiveRailFWRenderer.access$1(LiveRailFWRenderer.this).getConstants().EVENT_AD_LOADED());
    }
