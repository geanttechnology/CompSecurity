    ...
    implements VPAIDEventListener
{
    ...
    {
        Log.v("LiveRailRenderer", (new StringBuilder("VPAID Event ")).append(vpaidevent.getType()).append(" at least one impression=").append(LiveRailFWRenderer.access$2(LiveRailFWRenderer.this)).toString());
