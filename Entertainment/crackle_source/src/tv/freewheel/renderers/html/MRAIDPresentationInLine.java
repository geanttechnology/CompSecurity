...
class MRAIDPresentationInLine extends MRAIDBasePresentation
{
    ...
    private void calculateAdSize()
    {
        ...
        {
            width = (int)((float)creativeRendition.getWidth() * displaymetrics.density);
            height = (int)((float)creativeRendition.getHeight() * displaymetrics.density);
        } else
        if (slot.getTimePositionClass() == rendererContext.getConstants().TIME_POSITION_CLASS_OVERLAY())
        {
            width = (int)((float)OVERLAY_SLOT_WIDTH * displaymetrics.density);
            height = (int)((float)OVERLAY_SLOT_HEIGHT * displaymetrics.density);
        } else
        {
            width = (int)((float)slot.getWidth() * displaymetrics.density);
            height = (int)((float)slot.getHeight() * displaymetrics.density);
        }
    ...
    public void expand(String s, int i, int j)
    {
        ...
        } else
        {
            ...
            betaView.loadCreativeWithScript(s, null, "mraid.state='expanded';");
...
_L3:
    ...
    public void loadCreativeWithScript(String s, String s1, String s2)
    {
        ...
        alphaView.loadCreativeWithScript(s, s1, s2);
    }
        ...
        if (slot.getType() == rendererContext.getConstants().SLOT_TYPE_TEMPORAL())
        {
            if (slot.getTimePositionClass() == rendererContext.getConstants().TIME_POSITION_CLASS_OVERLAY())
            {
                ...
                if (((String) (obj)).contains("t"))
                {
                    ...
                    if (integer1 != null)
                    {
                        layoutparams.topMargin = (int)((float)integer1.intValue() * displaymetrics.density);
                    }
                }
                if (((String) (obj)).contains("l"))
                {
                    ...
                    if (integer != null)
                    {
                        layoutparams.leftMargin = (int)((float)integer.intValue() * displaymetrics.density);
                    }
                }
                if (((String) (obj)).contains("r"))
                {
                    ...
                    if (integer != null)
                    {
                        layoutparams.rightMargin = (int)((float)integer.intValue() * displaymetrics.density);
                    }
                }
                if (((String) (obj)).contains("b"))
                {
                    ...
                    if (integer1 != null)
                    {
                        layoutparams.bottomMargin = (int)((float)integer1.intValue() * displaymetrics.density);
                    }
                }
