...
_L5:
    ...
    private final ILoggerBridge loggerBridge = new ILoggerBridge() {
        ...
        {
            logger.debug((new StringBuilder()).append("-console-").append(s).toString());
        }

        public void log(String s)
        {
            logger.info((new StringBuilder()).append("-console-").append(s).toString());
        }
...
label0:
    ...
    {
        logger.debug((new StringBuilder()).append("resize(").append(i).append(",").append(j).append(")").toString());
