    ...
    implements Runnable
{
    ...
    public void run()
    {
        ...
        if (MillennialRenderer.access$100(MillennialRenderer.this))
        {
            ...
            MillennialRenderer.access$702(MillennialRenderer.this, new IActivityCallbackListener() {

                final MillennialRenderer._cls1 this$1;

                public void onActivityCallback(int i)
                {
label0:
                    {
                        MillennialRenderer.access$000(this$0).debug((new StringBuilder()).append("onActivityCallback(").append(i).append(")").toString());
                        if (i == MillennialRenderer.access$800(this$0).ACTIVITY_CALLBACK_RESUME())
                        {
                            MillennialRenderer.access$000(this$0).debug("Content activity resumed");
                            if (MillennialRenderer.access$900(this$0).getTimePositionClass() != MillennialRenderer.access$800(this$0).TIME_POSITION_CLASS_DISPLAY())
                            {
                                break label0;
                            }
                            MillennialRenderer.access$1000(this$0).dispatchEvent(MillennialRenderer.access$800(this$0).EVENT_REQUEST_CONTENT_VIDEO_RESUME());
                        }
                        return;
                    }
                    if (MillennialRenderer.access$900(this$0).getTimePositionClass() == MillennialRenderer.access$800(this$0).TIME_POSITION_CLASS_OVERLAY())
                    {
                        MillennialRenderer.access$1000(this$0).dispatchEvent(MillennialRenderer.access$800(this$0).EVENT_REQUEST_CONTENT_VIDEO_RESUME());
                        MillennialRenderer.access$600(this$0);
                        return;
                    } else
                    {
                        stop();
            ...
            {
                this$1 = MillennialRenderer._cls1.this;
                super();
            }
            });
