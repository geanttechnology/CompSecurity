...
_L5:
    ...
    public GregorianCalendar parseCalendar(String s, GregorianCalendar gregoriancalendar, String s1)
    {
        ...
        if ((obj instanceof GregorianCalendar) && obj != null)
        {
        ...
        s1;
        Log.w("ParamParser", (new StringBuilder()).append("IllegalArgumentException when parsing parameter ").append(s).append(" as date whose value is ").append(((String) (obj))).toString());
_L2:
        return gregoriancalendar;
        s1;
        Log.w("ParamParser", (new StringBuilder()).append("ParseException when parsing parameter ").append(s).append(" as date whose value is ").append(((String) (obj))).toString());
...
_L1:
    ...
    public int parseColor(String s, int i)
    {
        ...
        if (s1 != null)
        {
            ...
            {
                Log.w("ParamParser", (new StringBuilder()).append("IllegalArgumentException when parsing parameter ").append(s).append(" as color whose value is ").append(s1).toString());
                return i;
            }
            return j;
        } else
    ...
    public int parseInt(String s, int i, int j)
    {
        ...
        if (s1 != null)
        {
            ...
            {
                Log.w("ParamParser", (new StringBuilder()).append("NumberFormatException when parsing parameter ").append(s).append(" as int whose value is ").append(s1).toString());
                return i;
            }
        }
        return k;
