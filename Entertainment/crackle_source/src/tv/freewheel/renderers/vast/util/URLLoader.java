...
import tv.freewheel.renderers.vast.util.cookie.AndroidCookieStore;
import tv.freewheel.renderers.vast.util.cookie.DummyAndroidCookieStore;
import tv.freewheel.renderers.vast.util.cookie.IAndroidCookieStore;
import tv.freewheel.renderers.vast.util.events.Event;
import tv.freewheel.renderers.vast.util.events.EventDispatcher;
import tv.freewheel.renderers.vast.util.http.ISimpleHttpClient;
import tv.freewheel.renderers.vast.util.http.SimpleHttpClient;
...
public class URLLoader extends EventDispatcher
{
    public static final class URLLoaderErrorException extends Exception
    {
        ...
        private static final long serialVersionUID = 0x2529e5afbec66d4L;
