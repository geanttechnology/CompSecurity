...
import tv.freewheel.renderers.vast.util.URLLoader;
    ...
    implements IAndroidCookieStore
{
    ...
    {
        Class.forName("android.webkit.CookieManager", true, tv/freewheel/renderers/vast/util/URLLoader.getClassLoader());
