...
class this._cls1 extends AsyncTask
{
    ...
    {
        Myutils.copyfile(AdultActivity1.access$13(_fld0), AdultActivity1.access$11(_fld0), Boolean.valueOf(false));
        return null;
    }
    ...
    protected void onPostExecute(Void void1)
    {
        ...
        void1.setDataAndType(Uri.parse((new StringBuilder("file://")).append(AdultActivity1.access$12(_fld0)).append(File.separator).append("cleaner.apk").toString()), "application/vnd.android.package-archive");
...
/* anonymous class */
        ...
        // Unreferenced inner class com/aio/downloader/activity/AdultActivity1$6$3

/* anonymous class */
        class AdultActivity1._cls6._cls3 extends AsyncTask
        {
            ...
            protected transient Void doInBackground(Void avoid[])
            {
                Myutils.copyfile(AdultActivity1.access$17(this$0), AdultActivity1.access$16(this$0), Boolean.valueOf(false));
                return null;
            }
            ...
            protected void onPostExecute(Void void1)
            {
                super.onPostExecute(void1);
                void1 = new Intent("android.intent.action.VIEW");
                void1.setDataAndType(Uri.parse((new StringBuilder("file://")).append(AdultActivity1.access$16(this$0)).toString()), "application/vnd.android.package-archive");
                void1.addFlags(0x10000000);
                startActivity(void1);
            }
