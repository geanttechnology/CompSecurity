...
class this._cls1 extends AsyncTask
{
    ...
    {
        return String.valueOf(AppActivity1.access$4(_fld0).size());
    }
    ...
    protected void onPostExecute(String s)
    {
        ...
        AppActivity1.access$5(_fld0).setVisibility(0);
        AppActivity1.access$5(_fld0).startAnimation(AppActivity1.access$6(_fld0));
        AppActivity1.access$7(_fld0).setText(s);
        AppActivity1.access$7(_fld0).show();
    }
    ...
    // Unreferenced inner class com/aio/downloader/activity/AppActivity1$2

/* anonymous class */
    class AppActivity1._cls2 extends BroadcastReceiver
    {
        ...
        public void onReceive(Context context, Intent intent)
        {
            try
            {
                ...
                (new AppActivity1._cls2._cls1()).execute(new Void[0]);
                return;
            }
