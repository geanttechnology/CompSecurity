    ...
    implements Runnable
{
    ...
    // Unreferenced inner class com/aio/downloader/activity/AppDetailsActivity$11

/* anonymous class */
    class AppDetailsActivity._cls11 extends Handler
    {
...
_L1:
            ...
            return;
_L2:
            (new Thread(new AppDetailsActivity._cls11._cls1())).start();
