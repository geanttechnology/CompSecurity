...
class this._cls1 extends AsyncTask
{
    ...
    // Unreferenced inner class com/aio/downloader/activity/AppDetailsActivity$18

/* anonymous class */
    class AppDetailsActivity._cls18
...
_L1:
            ...
            {
                (new AppDetailsActivity._cls18._cls1()).execute(new Void[0]);
                return;
            }
