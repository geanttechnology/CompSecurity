...
class this._cls1 extends AsyncTask
{
    ...
    // Unreferenced inner class com/aio/downloader/activity/AppDetailsActivity$24

/* anonymous class */
    class AppDetailsActivity._cls24
...
_L1:
            ...
            {
                (new AppDetailsActivity._cls24._cls1()).execute(new Void[0]);
                return;
            }
