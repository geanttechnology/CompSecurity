    ...
    implements Runnable
{
    ...
    public void run()
    {
        try
        {
            publicTools.getUrl((new StringBuilder("http://android.downloadatoz.com/_201409/market/hits.php?type=app&id=")).append(AppDetailsActivity.access$18(_fld0).getId()).append("&from=google").toString());
            return;
        }
    ...
    // Unreferenced inner class com/aio/downloader/activity/AppDetailsActivity$26

/* anonymous class */
    class AppDetailsActivity._cls26
...
_L1:
            (new AppDetailsActivity._cls26._cls1()).execute(new Void[0]);
...
_L5:
            (new Thread(new AppDetailsActivity._cls26._cls2())).start();
            AppDetailsActivity.access$32(AppDetailsActivity.this).setBackgroundResource(0x7f02006e);
        ...
        // Unreferenced inner class com/aio/downloader/activity/AppDetailsActivity$26$1

/* anonymous class */
        class AppDetailsActivity._cls26._cls1 extends AsyncTask
        {

            final AppDetailsActivity._cls26 this$1;
            ...
            protected transient Void doInBackground(Void avoid[])
            {
                try
                {
                    publicTools.getUrl((new StringBuilder("http://android.downloadatoz.com/_201409/market/hits.php?type=app&id=")).append(AppDetailsActivity.access$21(this$0)).append("&from=apk").toString());
                }
                // Misplaced declaration of an exception variable
                catch (Void avoid[]) { }
                return null;
                    ...
                    {
                        this$1 = AppDetailsActivity._cls26.this;
                        super();
                    }
        }
