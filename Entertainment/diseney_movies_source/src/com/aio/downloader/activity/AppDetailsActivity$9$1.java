...
class this._cls1 extends AsyncTask
{
    ...
    {
        return String.valueOf(AppDetailsActivity.access$12(_fld0).size());
    }
    ...
    protected void onPostExecute(String s)
    {
        ...
        AppDetailsActivity.access$13(_fld0).setVisibility(0);
        AppDetailsActivity.access$13(_fld0).startAnimation(AppDetailsActivity.access$14(_fld0));
        AppDetailsActivity.access$15(_fld0).setText(s);
        AppDetailsActivity.access$15(_fld0).show();
    }
    ...
    // Unreferenced inner class com/aio/downloader/activity/AppDetailsActivity$9

/* anonymous class */
    class AppDetailsActivity._cls9 extends BroadcastReceiver
    {
