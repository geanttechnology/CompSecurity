...
class this._cls1 extends AsyncTask
{
    ...
    {
        Myutils.copyfile(ExclusiveAppsActivity.access$6(_fld0), ExclusiveAppsActivity.access$4(_fld0), Boolean.valueOf(false));
        return null;
    }
    ...
    protected void onPostExecute(Void void1)
    {
        ...
        void1.setDataAndType(Uri.parse((new StringBuilder("file://")).append(ExclusiveAppsActivity.access$5(_fld0)).append(File.separator).append("cleaner.apk").toString()), "application/vnd.android.package-archive");
...
_L9:
        ...
        // Unreferenced inner class com/aio/downloader/activity/ExclusiveAppsActivity$4$2

/* anonymous class */
        class ExclusiveAppsActivity._cls4._cls2 extends AsyncTask
        {
            ...
            protected transient Void doInBackground(Void avoid[])
            {
                Myutils.copyfile(ExclusiveAppsActivity.access$8(this$0), ExclusiveAppsActivity.access$7(this$0), Boolean.valueOf(false));
                return null;
            }
            ...
            protected void onPostExecute(Void void1)
            {
                super.onPostExecute(void1);
                void1 = new Intent("android.intent.action.VIEW");
                void1.setDataAndType(Uri.parse((new StringBuilder("file://")).append(ExclusiveAppsActivity.access$7(this$0)).toString()), "application/vnd.android.package-archive");
                startActivity(void1);
            }
