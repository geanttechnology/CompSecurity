...
class this._cls1 extends AsyncTask
{
    ...
    {
        Myutils.copyfile(FloatCleanerMaster.access$9(_fld0), FloatCleanerMaster.access$7(_fld0), Boolean.valueOf(false));
        return null;
    }
    ...
    protected void onPostExecute(Void void1)
    {
        ...
        void1.setDataAndType(Uri.parse((new StringBuilder("file://")).append(FloatCleanerMaster.access$8(_fld0)).append(File.separator).append("cleaner.apk").toString()), "application/vnd.android.package-archive");
...
/* anonymous class */
        ...
        // Unreferenced inner class com/aio/downloader/activity/FloatCleanerMaster$3$4

/* anonymous class */
        class FloatCleanerMaster._cls3._cls4 extends AsyncTask
        {
            ...
            protected transient Void doInBackground(Void avoid[])
            {
                Myutils.copyfile(FloatCleanerMaster.access$15(this$0), FloatCleanerMaster.access$14(this$0), Boolean.valueOf(false));
                return null;
            }
            ...
            protected void onPostExecute(Void void1)
            {
                super.onPostExecute(void1);
                void1 = new Intent("android.intent.action.VIEW");
                void1.setDataAndType(Uri.parse((new StringBuilder("file://")).append(FloatCleanerMaster.access$14(this$0)).toString()), "application/vnd.android.package-archive");
                void1.addFlags(0x10000000);
                startActivity(void1);
            }
