...
class this._cls1 extends AsyncTask
{
    ...
    {
        Myutils.copyfile(FloatCleanerMaster.access$13(_fld0), FloatCleanerMaster.access$12(_fld0), Boolean.valueOf(false));
        return null;
    }
    ...
    protected void onPostExecute(Void void1)
    {
        ...
        void1.setDataAndType(Uri.parse((new StringBuilder("file://")).append(FloatCleanerMaster.access$12(_fld0)).toString()), "application/vnd.android.package-archive");
