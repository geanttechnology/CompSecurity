...
class this._cls1 extends AsyncTask
{
    ...
    {
        Myutils.copyfile(FunActivity1.access$13(_fld0), FunActivity1.access$11(_fld0), Boolean.valueOf(false));
        return null;
    }
    ...
    protected void onPostExecute(Void void1)
    {
        ...
        void1.setDataAndType(Uri.parse((new StringBuilder("file://")).append(FunActivity1.access$12(_fld0)).append(File.separator).append("cleaner.apk").toString()), "application/vnd.android.package-archive");
...
_L9:
        ...
        // Unreferenced inner class com/aio/downloader/activity/FunActivity1$6$2

/* anonymous class */
        class FunActivity1._cls6._cls2 extends AsyncTask
        {
            ...
            protected transient Void doInBackground(Void avoid[])
            {
                Myutils.copyfile(FunActivity1.access$15(this$0), FunActivity1.access$14(this$0), Boolean.valueOf(false));
                return null;
            }
            ...
            protected void onPostExecute(Void void1)
            {
                super.onPostExecute(void1);
                void1 = new Intent("android.intent.action.VIEW");
                void1.setDataAndType(Uri.parse((new StringBuilder("file://")).append(FunActivity1.access$14(this$0)).toString()), "application/vnd.android.package-archive");
                startActivity(void1);
            }
