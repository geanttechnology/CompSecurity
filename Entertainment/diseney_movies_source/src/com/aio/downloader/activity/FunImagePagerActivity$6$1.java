...
class this._cls1 extends Thread
{
    ...
    // Unreferenced inner class com/aio/downloader/activity/FunImagePagerActivity$6

/* anonymous class */
    class FunImagePagerActivity._cls6
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            (new FunImagePagerActivity._cls6._cls1()).start();
        }
