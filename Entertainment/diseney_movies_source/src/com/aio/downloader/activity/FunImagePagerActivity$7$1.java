...
class this._cls1 extends Thread
{
    ...
    // Unreferenced inner class com/aio/downloader/activity/FunImagePagerActivity$7

/* anonymous class */
    class FunImagePagerActivity._cls7
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            (new FunImagePagerActivity._cls7._cls1()).start();
