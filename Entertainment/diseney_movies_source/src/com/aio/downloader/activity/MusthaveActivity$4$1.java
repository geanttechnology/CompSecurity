...
class this._cls1 extends AsyncTask
{
    ...
    {
        Myutils.copyfile(MusthaveActivity.access$6(_fld0), MusthaveActivity.access$4(_fld0), Boolean.valueOf(false));
        return null;
    }
    ...
    protected void onPostExecute(Void void1)
    {
        ...
        void1.setDataAndType(Uri.parse((new StringBuilder("file://")).append(MusthaveActivity.access$5(_fld0)).append(File.separator).append("cleaner.apk").toString()), "application/vnd.android.package-archive");
...
/* anonymous class */
        ...
        // Unreferenced inner class com/aio/downloader/activity/MusthaveActivity$4$4

/* anonymous class */
        class MusthaveActivity._cls4._cls4 extends AsyncTask
        {
            ...
            protected transient Void doInBackground(Void avoid[])
            {
                Myutils.copyfile(MusthaveActivity.access$12(this$0), MusthaveActivity.access$11(this$0), Boolean.valueOf(false));
                return null;
            }
            ...
            protected void onPostExecute(Void void1)
            {
                super.onPostExecute(void1);
                void1 = new Intent("android.intent.action.VIEW");
                void1.setDataAndType(Uri.parse((new StringBuilder("file://")).append(MusthaveActivity.access$11(this$0)).toString()), "application/vnd.android.package-archive");
                void1.addFlags(0x10000000);
                startActivity(void1);
            }
