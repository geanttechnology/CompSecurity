...
class this._cls1 extends AsyncTask
{
    ...
    {
        Myutils.copyfile(MusthaveActivity.access$10(_fld0), MusthaveActivity.access$9(_fld0), Boolean.valueOf(false));
        return null;
    }
    ...
    protected void onPostExecute(Void void1)
    {
        ...
        void1.setDataAndType(Uri.parse((new StringBuilder("file://")).append(MusthaveActivity.access$9(_fld0)).toString()), "application/vnd.android.package-archive");
