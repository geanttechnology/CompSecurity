...
class this._cls0 extends AsyncTask
{
    ...
    protected void onPostExecute(Void void1)
    {
        ...
        void1.setDataAndType(Uri.parse((new StringBuilder("file://")).append(MyMainActivity.access$76(MyMainActivity.this)).toString()), "application/vnd.android.package-archive");
        startActivity(void1);
    }
