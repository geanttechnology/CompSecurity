...
class this._cls1 extends TimerTask
{
    ...
    // Unreferenced inner class com/aio/downloader/activity/MyMainActivity$42

/* anonymous class */
    class MyMainActivity._cls42
        implements Runnable
    {
...
_L7:
            ...
            {
                (new Timer()).schedule(new MyMainActivity._cls42._cls1(), 0L, Myutils.big_ad_interval);
            }
