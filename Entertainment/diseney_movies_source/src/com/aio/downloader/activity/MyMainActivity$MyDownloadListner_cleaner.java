    ...
    implements DownloadStatusListener
{
    ...
    public void onDownloadComplete(int i)
    {
        ...
        Myutils.copyfile(MyMainActivity.access$69(MyMainActivity.this), MyMainActivity.access$70(MyMainActivity.this), Boolean.valueOf(false));
        Intent intent = new Intent("diyicianzhuang");
        sendBroadcast(intent);
        try
        {
            Log.e("cleaner", (new StringBuilder("cleaner=")).append(getFileSizes(MyMainActivity.access$69(MyMainActivity.this))).toString());
            return;
        }
    ...
    public void onDownloadFailed(int i, int j, String s)
    {
        ...
        if (i == MyMainActivity.access$71(MyMainActivity.this))
        {
