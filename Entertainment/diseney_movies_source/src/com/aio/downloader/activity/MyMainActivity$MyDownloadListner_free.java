    ...
    implements DownloadStatusListener
{
    ...
    public void onDownloadComplete(int i)
    {
        ...
        Myutils.copyfile(MyMainActivity.access$63(MyMainActivity.this), MyMainActivity.access$64(MyMainActivity.this), Boolean.valueOf(false));
        try
        {
            Log.e("jone", (new StringBuilder("free=")).append(getFileSizes(MyMainActivity.access$63(MyMainActivity.this))).toString());
            return;
        }
    ...
    public void onDownloadFailed(int i, int j, String s)
    {
        ...
        if (i == MyMainActivity.access$65(MyMainActivity.this))
        {
