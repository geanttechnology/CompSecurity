    ...
    implements DownloadStatusListener
{
    ...
    public void onDownloadComplete(int i)
    {
        ...
        Myutils.copyfile(MyMainActivity.access$66(MyMainActivity.this), MyMainActivity.access$67(MyMainActivity.this), Boolean.valueOf(false));
        try
        {
            Log.e("gallery", (new StringBuilder("gallery=")).append(getFileSizes(MyMainActivity.access$66(MyMainActivity.this))).toString());
            return;
        }
    ...
    public void onDownloadFailed(int i, int j, String s)
    {
        ...
        if (i == MyMainActivity.access$68(MyMainActivity.this))
        {
