...
class this._cls0 extends AsyncTask
{
    ...
    {
        avoid = (new StringBuilder("http://android.downloadatoz.com/_201409/market/app_list_recommend.php?tab=home&page=")).append(MyMainActivity.access$34(MyMainActivity.this)).toString();
