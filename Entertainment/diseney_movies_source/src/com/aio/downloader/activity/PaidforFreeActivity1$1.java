...
class this._cls0 extends Handler
{
    ...
    public void handleMessage(Message message)
    {
        ...
        {
            PaidforFreeActivity1.access$0(PaidforFreeActivity1.this).setImageResource(0x7f0200d8);
            message = AnimationUtils.loadAnimation(getApplicationContext(), 0x7f04001e);
            PaidforFreeActivity1.access$0(PaidforFreeActivity1.this).startAnimation(message);
        }
    }
