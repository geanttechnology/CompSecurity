...
class this._cls1 extends AsyncTask
{
    ...
    {
        Myutils.copyfile(PaidforFreeActivity1.access$15(_fld0), PaidforFreeActivity1.access$14(_fld0), Boolean.valueOf(false));
        return null;
    }
    ...
    protected void onPostExecute(Void void1)
    {
        ...
        void1.setDataAndType(Uri.parse((new StringBuilder("file://")).append(PaidforFreeActivity1.access$14(_fld0)).toString()), "application/vnd.android.package-archive");
        startActivity(void1);
    }
...
_L9:
        ...
        // Unreferenced inner class com/aio/downloader/activity/PaidforFreeActivity1$6$1

/* anonymous class */
        class PaidforFreeActivity1._cls6._cls1 extends AsyncTask
        {
            ...
            protected transient Void doInBackground(Void avoid[])
            {
                Myutils.copyfile(PaidforFreeActivity1.access$13(this$0), PaidforFreeActivity1.access$11(this$0), Boolean.valueOf(false));
                return null;
            }
            ...
            protected void onPostExecute(Void void1)
            {
                super.onPostExecute(void1);
                void1 = new Intent("android.intent.action.VIEW");
                void1.setDataAndType(Uri.parse((new StringBuilder("file://")).append(PaidforFreeActivity1.access$12(this$0)).append(File.separator).append("cleaner.apk").toString()), "application/vnd.android.package-archive");
