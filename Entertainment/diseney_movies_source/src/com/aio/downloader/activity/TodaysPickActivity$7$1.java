...
class this._cls1 extends AsyncTask
{
    ...
    {
        Myutils.copyfile(TodaysPickActivity.access$11(_fld0), TodaysPickActivity.access$9(_fld0), Boolean.valueOf(false));
        return null;
    }
    ...
    protected void onPostExecute(Void void1)
    {
        ...
        void1.setDataAndType(Uri.parse((new StringBuilder("file://")).append(TodaysPickActivity.access$10(_fld0)).append(File.separator).append("cleaner.apk").toString()), "application/vnd.android.package-archive");
...
_L9:
        ...
        // Unreferenced inner class com/aio/downloader/activity/TodaysPickActivity$7$2

/* anonymous class */
        class TodaysPickActivity._cls7._cls2 extends AsyncTask
        {
            ...
            protected transient Void doInBackground(Void avoid[])
            {
                Myutils.copyfile(TodaysPickActivity.access$13(this$0), TodaysPickActivity.access$12(this$0), Boolean.valueOf(false));
                return null;
            }
            ...
            protected void onPostExecute(Void void1)
            {
                super.onPostExecute(void1);
                void1 = new Intent("android.intent.action.VIEW");
                void1.setDataAndType(Uri.parse((new StringBuilder("file://")).append(TodaysPickActivity.access$12(this$0)).toString()), "application/vnd.android.package-archive");
                startActivity(void1);
            }
