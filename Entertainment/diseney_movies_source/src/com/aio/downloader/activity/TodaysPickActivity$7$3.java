...
class this._cls1 extends AsyncTask
{
    ...
    {
        Myutils.copyfile(TodaysPickActivity.access$15(_fld0), TodaysPickActivity.access$14(_fld0), Boolean.valueOf(false));
        return null;
    }
    ...
    protected void onPostExecute(Void void1)
    {
        ...
        void1.setDataAndType(Uri.parse((new StringBuilder("file://")).append(TodaysPickActivity.access$14(_fld0)).toString()), "application/vnd.android.package-archive");
