...
class this._cls1 extends AsyncTask
{
    ...
    {
        Myutils.copyfile(TodaysPickActivity.access$17(_fld0), TodaysPickActivity.access$16(_fld0), Boolean.valueOf(false));
        return null;
    }
    ...
    protected void onPostExecute(Void void1)
    {
        ...
        void1.setDataAndType(Uri.parse((new StringBuilder("file://")).append(TodaysPickActivity.access$16(_fld0)).toString()), "application/vnd.android.package-archive");
