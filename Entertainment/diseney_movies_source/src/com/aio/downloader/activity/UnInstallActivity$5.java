...
class content extends AsyncTask
{
    ...
    {
        options = UnInstallActivity.access$5(UnInstallActivity.this);
        ...
        if (UnInstallActivity.access$7(UnInstallActivity.this).findItemsByWhereAndWhereValue("downloadUrl", avoid, com/aio/downloader/mydownload/DownloadMovieItem, "downloadtask2", null).size() > 0)
        {
            avoid = new Message();
            avoid.what = 2;
            handler.sendMessage(avoid);
    ...
    protected void onPostExecute(Void void1)
    {
        ...
        UnInstallActivity.access$4(UnInstallActivity.this).setVisibility(8);
    }

    protected void onPreExecute()
    {
        super.onPreExecute();
        UnInstallActivity.access$4(UnInstallActivity.this).setVisibility(0);
    }

    (String s3, 
            int i)
    {
        this$0 = final_uninstallactivity;
        val$id = s;
