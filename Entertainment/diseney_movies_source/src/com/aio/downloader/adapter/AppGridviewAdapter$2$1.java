...
_L1:
            (new Thread(in_fo. new AppGridviewAdapter._cls2._cls1())).start();
...
_L2:
            if (has_apk.equals("0"))
            {
                (new Thread(new AppGridviewAdapter._cls2._cls2())).start();
...
_L5:
        ...
        // Unreferenced inner class com/aio/downloader/adapter/AppGridviewAdapter$2$2

/* anonymous class */
        class AppGridviewAdapter._cls2._cls2
            implements Runnable
        {
