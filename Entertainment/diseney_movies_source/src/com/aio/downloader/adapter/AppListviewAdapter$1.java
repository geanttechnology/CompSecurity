...
class this._cls0 extends Handler
{
    ...
    public void handleMessage(Message message)
    {
        ...
        (new Thread(new Runnable() {
            ...
            final AppListviewAdapter._cls1 this$1;

            public void run()
            {
                publicTools.getUrl((new StringBuilder("http://android.downloadatoz.com/_201409/market/hits.php?type=app&id=")).append(AppListviewAdapter.access$4(this$0).getString("appid", "invalid")).append("&from=apk&add_to_list=1").toString());
            }

            
            {
                this$1 = AppListviewAdapter._cls1.this;
                super();
            }
        })).start();
        message = new Intent();
