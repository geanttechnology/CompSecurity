    ...
    implements Runnable
{
    ...
    public void run()
    {
        publicTools.getUrl((new StringBuilder("http://android.downloadatoz.com/_201409/market/hits.php?type=app&id=")).append(((DownloadMovieItem)AppListviewAdapter.access$8(_fld0).get(val$myPosition)).getId()).append("&from=apk").toString());
    }
...
_L1:
            (new Thread(myPosition. new AppListviewAdapter._cls3._cls1())).start();
