    ...
    implements Runnable
{
    ...
    public void run()
    {
        try
        {
            publicTools.getUrl((new StringBuilder("http://android.downloadatoz.com/_201409/market/hits.php?type=app&id=")).append(((DownloadMovieItem)AppListviewAdapter.access$8(_fld0).get(val$myPosition)).getId()).append("&from=google").toString());
            return;
        }
...
_L2:
            ...
            {
                (new Thread(myPosition. new AppListviewAdapter._cls3._cls2())).start();
...
/* anonymous class */
        ...
        // Unreferenced inner class com/aio/downloader/adapter/AppListviewAdapter$3$3

/* anonymous class */
        class AppListviewAdapter._cls3._cls3
            implements Runnable
        {
