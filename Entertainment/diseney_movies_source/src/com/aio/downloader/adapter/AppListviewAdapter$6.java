...
class content extends AsyncTask
{
    ...
    {
        options = AppListviewAdapter.access$12(AppListviewAdapter.this);
        ...
        if (AppListviewAdapter.access$14(AppListviewAdapter.this).findItemsByWhereAndWhereValue("downloadUrl", avoid, com/aio/downloader/mydownload/DownloadMovieItem, "downloadtask2", null).size() > 0)
        {
            avoid = new Message();
            avoid.what = 2;
            handler.sendMessage(avoid);
        ...
        {
            String s = (new File((new StringBuilder(String.valueOf(Environment.getExternalStorageDirectory().getAbsolutePath()))).append(File.separator).append(AppListviewAdapter.access$0(AppListviewAdapter.this).getPackageName()).toString(), (new StringBuilder(String.valueOf(val$id))).append(".apk").toString())).getAbsolutePath();
    ...
    protected void onPostExecute(Void void1)
    {
        ...
        void1 = new Intent();
        if (AppListviewAdapter.access$5(AppListviewAdapter.this).equals("app1"))
        {
            void1.setAction("hideapp1");
        } else
        if (AppListviewAdapter.access$5(AppListviewAdapter.this).equals("app2"))
        {
            void1.setAction("hideapp2");
        } else
        if (AppListviewAdapter.access$5(AppListviewAdapter.this).equals("app3"))
        {
            void1.setAction("hideapp3");
        } else
        if (AppListviewAdapter.access$5(AppListviewAdapter.this).equals("app4"))
        {
            void1.setAction("hideapp4");
        } else
        if (AppListviewAdapter.access$5(AppListviewAdapter.this).equals("app5"))
        {
            void1.setAction("hideapp5");
        }
        if (AppListviewAdapter.access$5(AppListviewAdapter.this).equals("game1"))
        {
            void1.setAction("hidegame1");
        } else
        if (AppListviewAdapter.access$5(AppListviewAdapter.this).equals("game2"))
        {
            void1.setAction("hidegame2");
        } else
        if (AppListviewAdapter.access$5(AppListviewAdapter.this).equals("game3"))
        {
            void1.setAction("hidegame3");
        } else
        if (AppListviewAdapter.access$5(AppListviewAdapter.this).equals("game4"))
        {
            void1.setAction("hidegame4");
        } else
        if (AppListviewAdapter.access$5(AppListviewAdapter.this).equals("game5"))
        {
            void1.setAction("hidegame5");
        }
        if (AppListviewAdapter.access$5(AppListviewAdapter.this).equals("paid1"))
        {
            void1.setAction("hidepaid1");
        } else
        if (AppListviewAdapter.access$5(AppListviewAdapter.this).equals("paid2"))
        {
            void1.setAction("hidepaid2");
        } else
        if (AppListviewAdapter.access$5(AppListviewAdapter.this).equals("paid3"))
        {
            void1.setAction("hidepaid3");
        } else
        if (AppListviewAdapter.access$5(AppListviewAdapter.this).equals("paid4"))
        {
            void1.setAction("hidepaid4");
        } else
        if (AppListviewAdapter.access$5(AppListviewAdapter.this).equals("paid5"))
        {
            void1.setAction("hidepaid5");
        }
        if (AppListviewAdapter.access$5(AppListviewAdapter.this).equals("adult1"))
        {
            void1.setAction("hideadult1");
        } else
        if (AppListviewAdapter.access$5(AppListviewAdapter.this).equals("adult2"))
        {
            void1.setAction("hideadult2");
        } else
        if (AppListviewAdapter.access$5(AppListviewAdapter.this).equals("adult3"))
        {
            void1.setAction("hideadult3");
        } else
        if (AppListviewAdapter.access$5(AppListviewAdapter.this).equals("adult4"))
        {
        ...
        AppListviewAdapter.access$0(AppListviewAdapter.this).sendBroadcast(void1);
    }
    ...
    protected void onPreExecute()
    {
        ...
        AppListviewAdapter.access$0(AppListviewAdapter.this).sendBroadcast(intent);
    }
