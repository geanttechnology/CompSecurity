...
class this._cls1 extends Thread
{
    ...
    final l_pics_bt this$1;

    public void run()
    {
        super.run();
        Log.e("www", (new StringBuilder("url=+")).append(l_pics_bt).toString());
        publicTools.getUrl(l_pics_bt);
    }
    ...
    // Unreferenced inner class com/aio/downloader/adapter/FunAllAdapter$2

/* anonymous class */
    class FunAllAdapter._cls2
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            url_pics_bt = (new StringBuilder("http://welaf.com/fun/stat.php?type=hit&serial=")).append(((FunModel)FunAllAdapter.access$0(FunAllAdapter.this).get(position)).getSerial()).toString();
            (new FunAllAdapter._cls2._cls1()).start();
