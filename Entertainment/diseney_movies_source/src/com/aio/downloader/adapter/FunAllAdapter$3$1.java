...
class this._cls1 extends Thread
{
    ...
    // Unreferenced inner class com/aio/downloader/adapter/FunAllAdapter$3

/* anonymous class */
    class FunAllAdapter._cls3
        implements android.view.View.OnClickListener
    {
        ...
        {
            url_gif = (new StringBuilder("http://welaf.com/fun/stat.php?type=hit&serial=")).append(((FunModel)FunAllAdapter.access$0(FunAllAdapter.this).get(position)).getSerial()).toString();
            (new FunAllAdapter._cls3._cls1()).start();
