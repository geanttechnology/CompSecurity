    ...
    implements android.view.ener
{
    ...
    {
        url_gif = (new StringBuilder("http://welaf.com/fun/stat.php?type=hit&serial=")).append(((FunModel)FunAllAdapter.access$0(FunAllAdapter.this).get(val$position)).getSerial()).toString();
        (new Thread() {

            final FunAllAdapter._cls3 this$1;
            ...
            {
                this$1 = FunAllAdapter._cls3.this;
                super();
            }
        }).start();
