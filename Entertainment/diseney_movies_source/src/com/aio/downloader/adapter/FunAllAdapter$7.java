    ...
    implements android.view.ener
{
    ...
    public void onClick(View view)
    {
        ...
        url = (new StringBuilder("http://welaf.com/fun/stat.php?type=hit&serial=")).append(((FunModel)FunAllAdapter.access$0(FunAllAdapter.this).get(val$position)).getSerial()).toString();
        (new Thread() {

            final FunAllAdapter._cls7 this$1;
            ...
            {
                this$1 = FunAllAdapter._cls7.this;
                super();
            }
        }).start();
