...
class content extends AsyncTask
{
    ...
    {
        options = Home_Gridview_Adapter.access$6(Home_Gridview_Adapter.this);
        ...
        if (Home_Gridview_Adapter.access$8(Home_Gridview_Adapter.this).findItemsByWhereAndWhereValue("downloadUrl", avoid, com/aio/downloader/mydownload/DownloadMovieItem, "downloadtask2", null).size() > 0)
        {
            avoid = new Message();
            avoid.what = 2;
            handler.sendMessage(avoid);
