    ...
    implements android.view.ew_Adapter._cls10
{
    ...
    {
        url_video = (new StringBuilder("http://welaf.com/fun/stat.php?type=hit&serial=")).append(((FunModel)Home_Listview_Adapter.access$1(Home_Listview_Adapter.this).get(val$ppp)).getSerial()).toString();
        (new Thread() {

            final Home_Listview_Adapter._cls10 this$1;
            ...
            {
                this$1 = Home_Listview_Adapter._cls10.this;
                super();
            }
        }).start();
