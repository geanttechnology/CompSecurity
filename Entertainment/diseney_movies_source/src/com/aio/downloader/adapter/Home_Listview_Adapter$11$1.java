...
class this._cls1 extends Thread
{
    ...
    // Unreferenced inner class com/aio/downloader/adapter/Home_Listview_Adapter$11

/* anonymous class */
    class Home_Listview_Adapter._cls11
        implements android.view.View.OnClickListener
    {
        ...
        {
            url_video_bt = (new StringBuilder("http://welaf.com/fun/stat.php?type=hit&serial=")).append(((FunModel)Home_Listview_Adapter.access$1(Home_Listview_Adapter.this).get(ppp)).getSerial()).toString();
            (new Home_Listview_Adapter._cls11._cls1()).start();
