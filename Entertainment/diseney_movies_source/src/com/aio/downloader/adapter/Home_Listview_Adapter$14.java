    ...
    implements android.view.ew_Adapter._cls14
{
    ...
    {
        url_share = (new StringBuilder("http://welaf.com/fun/stat.php?serial=")).append(((FunModel)Home_Listview_Adapter.access$1(Home_Listview_Adapter.this).get(val$ppp)).getSerial()).append("&type=share").toString();
        (new Thread() {

            final Home_Listview_Adapter._cls14 this$1;
            ...
            {
                this$1 = Home_Listview_Adapter._cls14.this;
                super();
            }
        }).start();
