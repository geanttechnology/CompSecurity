...
class this._cls1 extends Thread
{
    ...
    // Unreferenced inner class com/aio/downloader/adapter/Home_Listview_Adapter$6

/* anonymous class */
    class Home_Listview_Adapter._cls6
        implements android.view.View.OnClickListener
    {
        ...
        {
            Log.e("www", (new StringBuilder("(Serializable) Myutils.list_fun_array=")).append(((FunModel)Home_Listview_Adapter.access$1(Home_Listview_Adapter.this).get(ppp)).getFunlist()).toString());
            url_adult = (new StringBuilder("http://welaf.com/fun/stat.php?type=hit&serial=")).append(((FunModel)Home_Listview_Adapter.access$1(Home_Listview_Adapter.this).get(ppp)).getSerial()).toString();
            (new Home_Listview_Adapter._cls6._cls1()).start();
