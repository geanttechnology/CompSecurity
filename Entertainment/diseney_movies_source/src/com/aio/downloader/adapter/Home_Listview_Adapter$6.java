...
class val.ppp
    implements android.view.iew_Adapter._cls6
{
    ...
    {
        Log.e("www", (new StringBuilder("(Serializable) Myutils.list_fun_array=")).append(((FunModel)Home_Listview_Adapter.access$1(Home_Listview_Adapter.this).get(val$ppp)).getFunlist()).toString());
        url_adult = (new StringBuilder("http://welaf.com/fun/stat.php?type=hit&serial=")).append(((FunModel)Home_Listview_Adapter.access$1(Home_Listview_Adapter.this).get(val$ppp)).getSerial()).toString();
        (new Thread() {

            final Home_Listview_Adapter._cls6 this$1;
            ...
            {
                this$1 = Home_Listview_Adapter._cls6.this;
                super();
            }
        }).start();
