    ...
    implements android.view.ew_Adapter._cls13
{
    ...
    {
        Log.e("www", (new StringBuilder("(Serializable) Myutils.list_array=")).append(((Fun_appModel)Home_app_Listview_Adapter.access$1(Home_app_Listview_Adapter.this).get(val$ppp)).getFunlist()).toString());
        url_gag = (new StringBuilder("http://welaf.com/fun/stat.php?type=hit&serial=")).append(((Fun_appModel)Home_app_Listview_Adapter.access$1(Home_app_Listview_Adapter.this).get(val$ppp)).getSerial()).toString();
        (new Thread() {

            final Home_app_Listview_Adapter._cls13 this$1;
            ...
            {
                this$1 = Home_app_Listview_Adapter._cls13.this;
                super();
            }
        }).start();
