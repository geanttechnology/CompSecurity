...
class this._cls1 extends Thread
{
    ...
    // Unreferenced inner class com/aio/downloader/adapter/Home_app_Listview_Adapter$15

/* anonymous class */
    class Home_app_Listview_Adapter._cls15
        implements android.view.View.OnClickListener
    {
        ...
        {
            url_share = (new StringBuilder("http://welaf.com/fun/stat.php?serial=")).append(((Fun_appModel)Home_app_Listview_Adapter.access$1(Home_app_Listview_Adapter.this).get(ppp)).getSerial()).append("&type=share").toString();
            (new Home_app_Listview_Adapter._cls15._cls1()).start();
