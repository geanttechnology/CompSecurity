...
class val.list
    implements android.view.iew_Adapter._cls3
{
    ...
    {
        view = new Intent(Home_app_Listview_Adapter.access$0(Home_app_Listview_Adapter.this), com/aio/downloader/activity/AppSearchResultActivity);
        view.putExtra("searchkeywords", ((DownloadMovieItem)val$list.get(0)).getSearch_keyword());
        Log.e("bbb", (new StringBuilder("search=")).append(((DownloadMovieItem)val$list.get(0)).getSearch_keyword()).toString());
