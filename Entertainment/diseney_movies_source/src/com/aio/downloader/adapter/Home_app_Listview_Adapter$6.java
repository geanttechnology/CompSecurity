    ...
    implements android.view.iew_Adapter._cls6
{
    ...
    {
        view = new Intent(Home_app_Listview_Adapter.access$0(Home_app_Listview_Adapter.this), com/aio/downloader/activity/MiniGamePlayActivity);
        view.putExtra("playurl", ((DownloadMovieItem)val$list.get(0)).getLink());
        view.putExtra("proc", "");
        view.putExtra("sound", "");
