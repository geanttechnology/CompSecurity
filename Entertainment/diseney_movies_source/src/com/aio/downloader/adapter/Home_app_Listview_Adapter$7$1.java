...
class this._cls1 extends Thread
{
    ...
    final l_adult this$1;

    public void run()
    {
        super.run();
        Log.e("www", (new StringBuilder("url=+")).append(l_adult).toString());
        publicTools.getUrl(l_adult);
    }
    ...
    // Unreferenced inner class com/aio/downloader/adapter/Home_app_Listview_Adapter$7

/* anonymous class */
    class Home_app_Listview_Adapter._cls7
        implements android.view.View.OnClickListener
    {
        ...
        {
            Log.e("www", (new StringBuilder("(Serializable) Myutils.list_fun_array=")).append(((Fun_appModel)Home_app_Listview_Adapter.access$1(Home_app_Listview_Adapter.this).get(ppp)).getFunlist()).toString());
            url_adult = (new StringBuilder("http://welaf.com/fun/stat.php?type=hit&serial=")).append(((Fun_appModel)Home_app_Listview_Adapter.access$1(Home_app_Listview_Adapter.this).get(ppp)).getSerial()).toString();
            (new Home_app_Listview_Adapter._cls7._cls1()).start();
            ...
            view.putExtra("detailserial", ((Fun_appModel)Home_app_Listview_Adapter.access$1(Home_app_Listview_Adapter.this).get(ppp)).getSerial());
            view.putExtra("gag", 0);
