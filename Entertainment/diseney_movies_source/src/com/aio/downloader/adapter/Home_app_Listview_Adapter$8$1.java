...
class this._cls1 extends Thread
{
    ...
    // Unreferenced inner class com/aio/downloader/adapter/Home_app_Listview_Adapter$8

/* anonymous class */
    class Home_app_Listview_Adapter._cls8
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            url_adult_bt = (new StringBuilder("http://welaf.com/fun/stat.php?type=hit&serial=")).append(((Fun_appModel)Home_app_Listview_Adapter.access$1(Home_app_Listview_Adapter.this).get(ppp)).getSerial()).toString();
            (new Home_app_Listview_Adapter._cls8._cls1()).start();
