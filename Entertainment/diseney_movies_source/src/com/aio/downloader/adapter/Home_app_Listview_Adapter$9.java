    ...
    implements android.view.iew_Adapter._cls9
{
    ...
    {
        url_gif = (new StringBuilder("http://welaf.com/fun/stat.php?type=hit&serial=")).append(((Fun_appModel)Home_app_Listview_Adapter.access$1(Home_app_Listview_Adapter.this).get(val$ppp)).getSerial()).toString();
        (new Thread() {

            final Home_app_Listview_Adapter._cls9 this$1;
            ...
            {
                this$1 = Home_app_Listview_Adapter._cls9.this;
                super();
            }
        }).start();
