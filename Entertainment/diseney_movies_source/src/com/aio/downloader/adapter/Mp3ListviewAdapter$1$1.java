    ...
    implements Runnable
{
    ...
    public void run()
    {
        publicTools.getUrl((new StringBuilder("http://android.downloadatoz.com/_201409/market/hits.php?type=mp3&id=")).append(val$in_fo.getId()).append("&title=").append(val$in_fo.getTitle()).append("&album_title=").append(val$in_fo.getAlbum_title()).append("&artist_title=").append(val$in_fo.getArtist_title()).append("&size=").append(val$in_fo.getSize()).toString());
    }
...
/* anonymous class */
        ...
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            (new Thread(in_fo. new Mp3ListviewAdapter._cls1._cls1())).start();
            ...
            {
                (new Mp3ListviewAdapter._cls1._cls2()).execute(new Void[0]);
                return;
            } else
            {
        ...
        // Unreferenced inner class com/aio/downloader/adapter/Mp3ListviewAdapter$1$2

/* anonymous class */
        class Mp3ListviewAdapter._cls1._cls2 extends AsyncTask
        {
            ...
            protected void onPostExecute(Void void1)
            {
                ...
                {
                    Toast.makeText(Mp3ListviewAdapter.access$2(this$0), Mp3ListviewAdapter.access$2(this$0).getString(0x7f0b0064), 1).show();
                }
                void1 = new Intent();
