    ...
    implements Runnable
{
    ...
    public void run()
    {
        publicTools.getUrl((new StringBuilder("http://android.downloadatoz.com/_201409/market/hits.php?type=ringtone&id=")).append(val$in_fo.getId()).append("&title=").append(val$in_fo.getTitle()).append("&cat=").append(val$in_fo.getCat()).append("&downloads=").append(val$in_fo.getDownloads()).toString());
    }
    ...
    // Unreferenced inner class com/aio/downloader/adapter/RingtoneListviewAdapter$1
...
/* anonymous class */
        ...
        implements android.view.View.OnClickListener
    {
        ...
        {
            (new Thread(in_fo. new RingtoneListviewAdapter._cls1._cls1())).start();
            ...
            {
                (new RingtoneListviewAdapter._cls1._cls2()).execute(new Void[0]);
                return;
            } else
            {
        ...
        // Unreferenced inner class com/aio/downloader/adapter/RingtoneListviewAdapter$1$2

/* anonymous class */
        class RingtoneListviewAdapter._cls1._cls2 extends AsyncTask
        {
