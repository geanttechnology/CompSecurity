...
class val.in_fo extends AsyncTask
{
    ...
    protected void onPostExecute(Void void1)
    {
        ...
        {
            Toast.makeText(RingtoneListviewAdapter.access$1(_fld0), RingtoneListviewAdapter.access$1(_fld0).getString(0x7f0b0064), 1).show();
        }
        void1 = new Intent();
...
/* anonymous class */
        ...
        implements android.view.View.OnClickListener
    {
        ...
        // Unreferenced inner class com/aio/downloader/adapter/RingtoneListviewAdapter$1$1
