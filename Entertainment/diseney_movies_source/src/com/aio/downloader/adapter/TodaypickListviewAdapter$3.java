...
class content extends AsyncTask
{
    ...
    {
        options = TodaypickListviewAdapter.access$8(TodaypickListviewAdapter.this);
        ...
        if (TodaypickListviewAdapter.access$10(TodaypickListviewAdapter.this).findItemsByWhereAndWhereValue("downloadUrl", avoid, com/aio/downloader/mydownload/DownloadMovieItem, "downloadtask2", null).size() > 0)
        {
            avoid = new Message();
            avoid.what = 2;
            handler.sendMessage(avoid);
        ...
        {
            String s = (new File((new StringBuilder(String.valueOf(Environment.getExternalStorageDirectory().getAbsolutePath()))).append(File.separator).append(TodaypickListviewAdapter.access$0(TodaypickListviewAdapter.this).getPackageName()).toString(), (new StringBuilder(String.valueOf(val$id))).append(".apk").toString())).getAbsolutePath();
            ...
            Log.v("rtrt", (new StringBuilder(String.valueOf(val$icon))).append("///").toString());
            d.setFile_id(val$id);
    ...
    protected void onPostExecute(Void void1)
    {
        ...
        void1 = new Intent();
        if (TodaypickListviewAdapter.access$7(TodaypickListviewAdapter.this).equals("todaypick"))
        {
            void1.setAction("hidetodayapp");
        }
        TodaypickListviewAdapter.access$0(TodaypickListviewAdapter.this).sendBroadcast(void1);
    }
    ...
    protected void onPreExecute()
    {
        ...
        TodaypickListviewAdapter.access$0(TodaypickListviewAdapter.this).sendBroadcast(intent);
    }
