...
class content extends AsyncTask
{
    ...
    {
        options = WidgetPaidGridviewAdapter.access$5(WidgetPaidGridviewAdapter.this);
        ...
        if (WidgetPaidGridviewAdapter.access$7(WidgetPaidGridviewAdapter.this).findItemsByWhereAndWhereValue("downloadUrl", avoid, com/aio/downloader/mydownload/DownloadMovieItem, "downloadtask2", null).size() > 0)
        {
            avoid = new Message();
            avoid.what = 2;
            handler.sendMessage(avoid);
        ...
        {
            String s = (new File((new StringBuilder(String.valueOf(Environment.getExternalStorageDirectory().getAbsolutePath()))).append(File.separator).append(WidgetPaidGridviewAdapter.access$0(WidgetPaidGridviewAdapter.this).getPackageName()).toString(), (new StringBuilder(String.valueOf(val$id))).append(".apk").toString())).getAbsolutePath();
...
_L4:
        WidgetPaidGridviewAdapter.access$0(WidgetPaidGridviewAdapter.this).sendBroadcast(void1);
        return;
_L2:
...
_L4:
        WidgetPaidGridviewAdapter.access$0(WidgetPaidGridviewAdapter.this).sendBroadcast(intent);
        return;
_L2:
        if (WidgetPaidGridviewAdapter.access$3(WidgetPaidGridviewAdapter.this).equals("appgvhome"))
        {
