    ...
    implements android.view.er
{
    ...
    public void onClick(View view)
    {
        ...
        view = packageinfo;
_L1:
        android.content.pm.eNotFoundException enotfoundexception;
        if (view == null)
        {
            RubActivity.access$15(_fld0);
        } else
        {
...
/* anonymous class */
    class RubActivity._cls1._cls1 extends AsyncTask
    {
        ...
        protected void onPostExecute(final Void dialog1)
        {
            ...
            button.setOnClickListener(new RubActivity._cls1._cls1._cls2());
            button1.setOnClickListener(dialog1. new RubActivity._cls1._cls1._cls3());
        }
...
/* anonymous class */
        ...
        // Unreferenced inner class com/aio/downloader/cleaner/RubActivity$1$1$2
