...
class content extends AsyncTask
{
    ...
    {
        options = RubActivity.access$55(RubActivity.this);
        ...
        if (RubActivity.access$57(RubActivity.this).findItemsByWhereAndWhereValue("downloadUrl", avoid, com/aio/downloader/mydownload/DownloadMovieItem, "downloadtask2", null).size() > 0)
        {
            avoid = new Message();
            avoid.what = 2;
            handler.sendMessage(avoid);
    ...
    protected void onPostExecute(Void void1)
    {
        ...
        RubActivity.access$54(RubActivity.this).setVisibility(8);
    }

    protected void onPreExecute()
    {
        super.onPreExecute();
        RubActivity.access$54(RubActivity.this).setVisibility(0);
    }

    eItem(String s3, 
            int i)
    {
        this$0 = final_rubactivity;
        val$id = s;
