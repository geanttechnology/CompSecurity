    ...
    public void run()
    {
        ...
        do
        {
            ...
            
            {
                ...
                if (RubActivity.access$39(_fld0) > 80)
                {
                    try
                    {
                        sleep(45L);
            ...
            } while (RubActivity.access$39(_fld0) != 100);
            RubActivity.access$37(_fld0, false);
            obj = new Message();
            obj.what = 200;
            RubActivity.access$42(_fld0).sendMessage(((Message) (obj)));
        } while (true);
    }
