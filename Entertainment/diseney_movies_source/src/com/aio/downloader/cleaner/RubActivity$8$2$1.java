    ...
    implements Runnable
{
    ...
    public void run()
    {
        RubActivity.access$35(_fld0).setText((new StringBuilder("This time released: ")).append(RubActivity.roundDouble(RubActivity.access$45(_fld0), 2)).append("MB").toString());
    }
