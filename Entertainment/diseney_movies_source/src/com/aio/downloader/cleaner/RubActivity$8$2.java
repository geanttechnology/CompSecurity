...
class this._cls1 extends Thread
{
    ...
    public void run()
    {
        ...
        do
        {
            ...
            } while (RubActivity.access$45(_fld0) < RubActivity.access$11(_fld0).doubleValue());
            RubActivity.access$43(_fld0, false);
        } while (true);
    }
...
/* anonymous class */
        ...
        // Unreferenced inner class com/aio/downloader/cleaner/RubActivity$8$1$1

/* anonymous class */
        class RubActivity._cls8._cls1._cls1
            implements Runnable
        {

            final RubActivity._cls8._cls1 this$2;

            public void run()
            {
                RubActivity.access$41(this$0).setProgress(RubActivity.access$39(this$0));
            }

                    
                    {
                        this$2 = RubActivity._cls8._cls1.this;
                        super();
                    }
        }
