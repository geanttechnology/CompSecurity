...
class content extends AsyncTask
{
    ...
    {
        options = ShowCleanActivity_Rub.access$13(ShowCleanActivity_Rub.this);
        ...
        if (ShowCleanActivity_Rub.access$15(ShowCleanActivity_Rub.this).findItemsByWhereAndWhereValue("downloadUrl", avoid, com/aio/downloader/mydownload/DownloadMovieItem, "downloadtask2", null).size() > 0)
        {
            avoid = new Message();
            avoid.what = 2;
            handler.sendMessage(avoid);
    ...
    protected void onPostExecute(Void void1)
    {
        ...
        ShowCleanActivity_Rub.access$12(ShowCleanActivity_Rub.this).setVisibility(8);
    }

    protected void onPreExecute()
    {
        super.onPreExecute();
        ShowCleanActivity_Rub.access$12(ShowCleanActivity_Rub.this).setVisibility(0);
    }
