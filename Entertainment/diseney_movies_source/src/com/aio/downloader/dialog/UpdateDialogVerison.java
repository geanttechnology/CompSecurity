...
public class UpdateDialogVerison extends Dialog
{
    ...
    public UpdateDialogVerison(Context context, int i, android.view.View.OnClickListener onclicklistener)
    {
        super(context, i);
    ...
    protected void onCreate(Bundle bundle)
    {
        ...
        btnCancel = (Button)findViewById(0x7f070157);
        btnEnter = (Button)findViewById(0x7f070158);
        timeupdate = (TextView)findViewById(0x7f070156);
