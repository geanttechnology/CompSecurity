    ...
    implements Runnable
{
    ...
    // Unreferenced inner class com/aio/downloader/fragments/AdultFeaturedFragment$3

/* anonymous class */
    class AdultFeaturedFragment._cls3 extends Handler
    {
...
_L1:
            ...
            return;
_L2:
            (new Thread(new AdultFeaturedFragment._cls3._cls1())).start();
