    ...
    implements Runnable
{
    ...
    // Unreferenced inner class com/aio/downloader/fragments/AdultGamesFragment$3

/* anonymous class */
    class AdultGamesFragment._cls3 extends Handler
    {
...
_L1:
            ...
            return;
_L2:
            (new Thread(new AdultGamesFragment._cls3._cls1())).start();
