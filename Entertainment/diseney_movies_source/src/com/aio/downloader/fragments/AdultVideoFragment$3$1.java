    ...
    implements Runnable
{
    ...
    // Unreferenced inner class com/aio/downloader/fragments/AdultVideoFragment$3

/* anonymous class */
    class AdultVideoFragment._cls3 extends Handler
    {
...
_L1:
            ...
            return;
_L2:
            (new Thread(new AdultVideoFragment._cls3._cls1())).start();
