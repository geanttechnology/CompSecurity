    ...
    implements Runnable
{
    ...
    // Unreferenced inner class com/aio/downloader/fragments/AppGlobalNewFragment$3

/* anonymous class */
    class AppGlobalNewFragment._cls3 extends Handler
    {
...
_L1:
            ...
            return;
_L2:
            (new Thread(new AppGlobalNewFragment._cls3._cls1())).start();
