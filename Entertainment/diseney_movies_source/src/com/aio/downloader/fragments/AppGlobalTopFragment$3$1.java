    ...
    implements Runnable
{
    ...
    // Unreferenced inner class com/aio/downloader/fragments/AppGlobalTopFragment$3

/* anonymous class */
    class AppGlobalTopFragment._cls3 extends Handler
    {
...
_L1:
            ...
            return;
_L2:
            (new Thread(new AppGlobalTopFragment._cls3._cls1())).start();
