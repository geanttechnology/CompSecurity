    ...
    implements Runnable
{
    ...
    // Unreferenced inner class com/aio/downloader/fragments/AppIndiaNewFragment$3

/* anonymous class */
    class AppIndiaNewFragment._cls3 extends Handler
    {
...
_L1:
            ...
            return;
_L2:
            (new Thread(new AppIndiaNewFragment._cls3._cls1())).start();
