    ...
    implements Runnable
{
    ...
    // Unreferenced inner class com/aio/downloader/fragments/AppIndiaTopFragment$3

/* anonymous class */
    class AppIndiaTopFragment._cls3 extends Handler
    {
...
_L1:
            ...
            return;
_L2:
            (new Thread(new AppIndiaTopFragment._cls3._cls1())).start();
