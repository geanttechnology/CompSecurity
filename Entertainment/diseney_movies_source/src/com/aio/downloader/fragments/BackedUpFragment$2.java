        ...
        if (Environment.getExternalStorageState().equals("mounted"))
        {
            if (BackedUpFragment.access$3(BackedUpFragment.this).size() == 0)
            {
                (new Thread(new Runnable() {
                    ...
                    File file;
                    final BackedUpFragment._cls2 this$1;

                    public void run()
                    {
                        BackedUpFragment.access$6(this$0, file, ext);
                        BackedUpFragment.access$7(this$0).sendEmptyMessage(0);
                    }

            
            {
                this$1 = BackedUpFragment._cls2.this;
                super();
