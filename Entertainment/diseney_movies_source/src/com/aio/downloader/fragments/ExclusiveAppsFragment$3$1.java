    ...
    implements Runnable
{
    ...
    // Unreferenced inner class com/aio/downloader/fragments/ExclusiveAppsFragment$3

/* anonymous class */
    class ExclusiveAppsFragment._cls3 extends Handler
    {
...
_L1:
            ...
            return;
_L2:
            (new Thread(new ExclusiveAppsFragment._cls3._cls1())).start();
