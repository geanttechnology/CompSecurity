...
public class FunTrendingFragment extends Fragment
    implements OnDismissCallback, ContentValue, AdListener, com.aio.downloader.refresh.PullableListView_load.OnLoadListener
{
    class Mya1 extends AsyncTask
    {
        ...
        final FunTrendingFragment this$0;
        ...
        {
            avoid = publicTools.getUrl((new StringBuilder("http://welaf.com/fun/list.php?tab=trending&page=")).append(page).toString());
            Log.e("www", (new StringBuilder("jsonData=")).append(avoid).toString());
            return avoid;
        }
        ...
        Mya1()
        {
            this$0 = FunTrendingFragment.this;
            super();
        }
    }
