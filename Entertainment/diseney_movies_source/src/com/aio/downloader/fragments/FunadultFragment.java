...
public class FunadultFragment extends Fragment
    implements OnDismissCallback, ContentValue, AdListener, com.aio.downloader.refresh.PullableListView_load.OnLoadListener
{
    class Mya1 extends AsyncTask
    {
        ...
        {
            avoid = publicTools.getUrl((new StringBuilder("http://welaf.com/fun/list.php?cat=adult&page=")).append(page).toString());
