...
public class FunallFragment extends Fragment
    implements OnDismissCallback, ContentValue, AdListener, com.aio.downloader.refresh.PullableListView_load.OnLoadListener
{
    class Mya1 extends AsyncTask
    {
        ...
        {
            avoid = publicTools.getUrl((new StringBuilder("http://welaf.com/fun/list.php?tab=new&page=")).append(page).toString());
