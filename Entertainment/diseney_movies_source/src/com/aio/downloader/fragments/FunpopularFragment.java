...
public class FunpopularFragment extends Fragment
    implements OnDismissCallback, ContentValue, AdListener, com.aio.downloader.refresh.PullableListView_load.OnLoadListener
{
    class Mya1 extends AsyncTask
    {
        ...
        final FunpopularFragment this$0;
        ...
        {
            avoid = publicTools.getUrl((new StringBuilder("http://welaf.com/fun/list.php?tab=top&page=")).append(page).toString());
        ...
        Mya1()
        {
            this$0 = FunpopularFragment.this;
            super();
        }
    }
