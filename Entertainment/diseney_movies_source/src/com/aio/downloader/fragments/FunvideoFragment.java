...
public class FunvideoFragment extends Fragment
    implements com.aio.downloader.refresh.PullableListView_load.OnLoadListener, OnDismissCallback, ContentValue, AdListener
{
    class Mya1 extends AsyncTask
    {
        ...
        {
            return publicTools.getUrl((new StringBuilder("http://welaf.com/fun/list.php?cat=video&page=")).append(page).toString());
        }
