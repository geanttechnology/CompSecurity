    ...
    implements Runnable
{
    ...
    // Unreferenced inner class com/aio/downloader/fragments/GameGlobalNewFragment$3

/* anonymous class */
    class GameGlobalNewFragment._cls3 extends Handler
    {
...
_L1:
            ...
            return;
_L2:
            (new Thread(new GameGlobalNewFragment._cls3._cls1())).start();
