    ...
    implements Runnable
{
    ...
    // Unreferenced inner class com/aio/downloader/fragments/GameGlobalTopFragment$3

/* anonymous class */
    class GameGlobalTopFragment._cls3 extends Handler
    {
...
_L1:
            ...
            return;
_L2:
            (new Thread(new GameGlobalTopFragment._cls3._cls1())).start();
