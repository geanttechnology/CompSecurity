    ...
    implements Runnable
{
    ...
    // Unreferenced inner class com/aio/downloader/fragments/GameIndiaNewFragment$3

/* anonymous class */
    class GameIndiaNewFragment._cls3 extends Handler
    {
...
_L1:
            ...
            return;
_L2:
            (new Thread(new GameIndiaNewFragment._cls3._cls1())).start();
