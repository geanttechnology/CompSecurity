    ...
    implements Runnable
{
    ...
    // Unreferenced inner class com/aio/downloader/fragments/GameIndiaTopFragment$3

/* anonymous class */
    class GameIndiaTopFragment._cls3 extends Handler
    {
...
_L1:
            ...
            return;
_L2:
            (new Thread(new GameIndiaTopFragment._cls3._cls1())).start();
