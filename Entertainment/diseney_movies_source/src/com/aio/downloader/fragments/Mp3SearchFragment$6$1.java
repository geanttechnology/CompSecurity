    ...
    implements Runnable
{
    ...
    // Unreferenced inner class com/aio/downloader/fragments/Mp3SearchFragment$6

/* anonymous class */
    class Mp3SearchFragment._cls6 extends Handler
    {
...
_L1:
            ...
            return;
_L2:
            (new Thread(new Mp3SearchFragment._cls6._cls1())).start();
