    ...
    implements Runnable
{
    ...
    // Unreferenced inner class com/aio/downloader/fragments/Mp3_Popular_Fragment$5

/* anonymous class */
    class Mp3_Popular_Fragment._cls5 extends Handler
    {
...
_L1:
            ...
            return;
_L2:
            (new Thread(new Mp3_Popular_Fragment._cls5._cls1())).start();
