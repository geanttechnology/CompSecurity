    ...
    implements android.widget.Listener
{
    ...
    public void onItemClick(AdapterView adapterview, View view, final int arg2, long l)
    {
        ...
        adapterview.putInt("mp3_popular_selector", arg2);
        adapterview.commit();
        Mp3_Popular_Fragment.access$3(Mp3_Popular_Fragment.this).setVisibility(0);
        Mp3_Popular_Fragment.access$8(Mp3_Popular_Fragment.this).setText(((DownloadMovieItem)Mp3_Popular_Fragment.access$9(Mp3_Popular_Fragment.this).get(arg2)).getTitle());
        ...
        (new AsyncTask() {
            ...
            protected transient Void doInBackground(Void avoid[])
            {
                ...
                try
                {
                    ...
                    Mp3_Popular_Fragment.access$14(this$0, new TimerTask() {
            ...
            {
                this$1 = Mp3_Popular_Fragment._cls6.this;
                arg2 = i;
                super();
            }
        }).execute(new Void[0]);
