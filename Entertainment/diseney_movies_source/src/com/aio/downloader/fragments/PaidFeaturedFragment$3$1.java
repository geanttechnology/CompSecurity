    ...
    implements Runnable
{
    ...
    // Unreferenced inner class com/aio/downloader/fragments/PaidFeaturedFragment$3

/* anonymous class */
    class PaidFeaturedFragment._cls3 extends Handler
    {
...
_L1:
            ...
            return;
_L2:
            (new Thread(new PaidFeaturedFragment._cls3._cls1())).start();
