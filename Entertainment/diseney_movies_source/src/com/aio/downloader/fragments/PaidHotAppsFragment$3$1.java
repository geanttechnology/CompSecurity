    ...
    implements Runnable
{
    ...
    // Unreferenced inner class com/aio/downloader/fragments/PaidHotAppsFragment$3

/* anonymous class */
    class PaidHotAppsFragment._cls3 extends Handler
    {
...
_L1:
            ...
            return;
_L2:
            (new Thread(new PaidHotAppsFragment._cls3._cls1())).start();
