    ...
    implements Runnable
{
    ...
    // Unreferenced inner class com/aio/downloader/fragments/PaidHotGamesFragment$3

/* anonymous class */
    class PaidHotGamesFragment._cls3 extends Handler
    {
...
_L1:
            ...
            return;
_L2:
            (new Thread(new PaidHotGamesFragment._cls3._cls1())).start();
