    ...
    implements Runnable
{
    ...
    // Unreferenced inner class com/aio/downloader/fragments/PaidNewAppsFragment$3

/* anonymous class */
    class PaidNewAppsFragment._cls3 extends Handler
    {
...
_L1:
            ...
            return;
_L2:
            (new Thread(new PaidNewAppsFragment._cls3._cls1())).start();
