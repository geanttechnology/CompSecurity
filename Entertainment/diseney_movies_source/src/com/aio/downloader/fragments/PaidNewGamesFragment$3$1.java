    ...
    implements Runnable
{
    ...
    // Unreferenced inner class com/aio/downloader/fragments/PaidNewGamesFragment$3

/* anonymous class */
    class PaidNewGamesFragment._cls3 extends Handler
    {
...
_L1:
            ...
            return;
_L2:
            (new Thread(new PaidNewGamesFragment._cls3._cls1())).start();
