    ...
    implements android.widget.stener
{
    ...
    public void onItemClick(AdapterView adapterview, View view, final int arg2, long l)
    {
        ...
        adapterview.putInt("ringtone_search_selector", arg2);
        adapterview.commit();
        RingtoneSearchFragment.access$3(RingtoneSearchFragment.this).setVisibility(0);
        RingtoneSearchFragment.access$10(RingtoneSearchFragment.this).setText(((DownloadMovieItem)RingtoneSearchFragment.access$5(RingtoneSearchFragment.this).get(arg2)).getTitle());
        ...
        (new AsyncTask() {
            ...
            protected transient Void doInBackground(Void avoid[])
            {
                ...
                try
                {
                    ...
                    RingtoneSearchFragment.access$15(this$0, new TimerTask() {
            ...
            {
                this$1 = RingtoneSearchFragment._cls7.this;
                arg2 = i;
                super();
            }
        }).execute(new Void[0]);
