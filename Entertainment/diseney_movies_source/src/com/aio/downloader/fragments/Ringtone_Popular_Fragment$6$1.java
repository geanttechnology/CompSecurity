...
class val.arg2 extends AsyncTask
{
    ...
    {
        avoid = publicTools.getUrl((new StringBuilder("http://t.zedge.net/ringtone/")).append(((DownloadMovieItem)Ringtone_Popular_Fragment.access$9(_fld0).get(val$arg2)).getId()).append("/?page=1").toString());
        HashMap hashmap = new HashMap();
        hashmap.put("content", avoid);
        avoid = publicTools.doHttpPost((new StringBuilder("http://android.downloadatoz.com/_201409/market/ringtone_pdt_parser.php?content=")).append(((DownloadMovieItem)Ringtone_Popular_Fragment.access$9(_fld0).get(val$arg2)).getId()).toString(), hashmap);
        try
        {
            avoid = new JSONObject(avoid);
            if (avoid.getInt("status") == 1)
            {
                Ringtone_Popular_Fragment.access$11(_fld0, new Model());
                Ringtone_Popular_Fragment.access$12(_fld0).setRingtoneurl(avoid.getString("url"));
            }
        }
        ...
        try
        {
            Ringtone_Popular_Fragment.access$2(_fld0).playUrl(Ringtone_Popular_Fragment.access$12(_fld0).getRingtoneurl());
            Ringtone_Popular_Fragment.access$13(_fld0, new Timer());
            Ringtone_Popular_Fragment.access$14(_fld0, new TimerTask() {

                final Ringtone_Popular_Fragment._cls6._cls1 this$2;
            ...
            {
                this$2 = Ringtone_Popular_Fragment._cls6._cls1.this;
                super();
            }
            });
            Ringtone_Popular_Fragment.access$15(_fld0).schedule(Ringtone_Popular_Fragment.access$16(_fld0), 0L, 1000L);
        }
        // Misplaced declaration of an exception variable
        catch (Void avoid[]) { }
        return null;
    ...
    protected void onPostExecute(Void void1)
    {
        ...
        Ringtone_Popular_Fragment.access$0(_fld0).setVisibility(8);
        if (void1 != null);
    }
    ...
    {
        super.onPreExecute();
        Ringtone_Popular_Fragment.access$0(_fld0).setVisibility(0);
    }
