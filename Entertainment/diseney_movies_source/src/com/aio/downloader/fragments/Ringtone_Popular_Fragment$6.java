    ...
    implements android.widget.ner
{
    ...
    public void onItemClick(AdapterView adapterview, View view, final int arg2, long l)
    {
        ...
        adapterview.Int("ringtone_popular_selector", arg2);
        adapterview.mit();
        Ringtone_Popular_Fragment.access$3(Ringtone_Popular_Fragment.this).setVisibility(0);
        Ringtone_Popular_Fragment.access$8(Ringtone_Popular_Fragment.this).setText(((DownloadMovieItem)Ringtone_Popular_Fragment.access$9(Ringtone_Popular_Fragment.this).get(arg2)).getTitle());
        ...
        (new AsyncTask() {
            ...
            protected transient Void doInBackground(Void avoid[])
            {
                ...
                try
                {
                    ...
                    Ringtone_Popular_Fragment.access$14(this$0, new TimerTask() {
            ...
            {
                this$1 = Ringtone_Popular_Fragment._cls6.this;
                arg2 = i;
                super();
            }
        }).execute(new Void[0]);
