    ...
    implements Runnable
{
    ...
    // Unreferenced inner class com/aio/downloader/fragments/Ringtone_Recent_Fragment$5

/* anonymous class */
    class Ringtone_Recent_Fragment._cls5 extends Handler
    {
...
_L1:
            ...
            return;
_L2:
            (new Thread(new Ringtone_Recent_Fragment._cls5._cls1())).start();
