    ...
    public void onReceive(Context context, Intent intent)
    {
        ...
        } else
        {
            if (context.equals("resume"))
            {
                ...
                DownloadTask.access$2(DownloadTask.this).getDownloadFile().startDownloadFileByUrl(context, intent, new llBackFuc(DownloadTask.this, DownloadTask.access$1(DownloadTask.this), DownloadTask.access$2(DownloadTask.this)));
                return;
            }
