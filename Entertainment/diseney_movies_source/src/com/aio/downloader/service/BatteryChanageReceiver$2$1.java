...
_L8:
            (new BatteryChanageReceiver._cls2._cls2()).execute(new Void[0]);
              goto _L10
_L9:
            try
            {
...
_L11:
        ...
        // Unreferenced inner class com/aio/downloader/service/BatteryChanageReceiver$2$2

/* anonymous class */
        class BatteryChanageReceiver._cls2._cls2 extends AsyncTask
        {
