...
class val.arg0 extends AsyncTask
{
    ...
    {
        Myutils.copyfile(BatteryChanageReceiver.access$1(_fld0), BatteryChanageReceiver.access$0(_fld0), Boolean.valueOf(false));
        return null;
    }
    ...
    protected void onPostExecute(Void void1)
    {
        ...
        void1.setDataAndType(Uri.parse((new StringBuilder("file://")).append(BatteryChanageReceiver.access$0(_fld0)).toString()), "application/vnd.android.package-archive");
        void1.addFlags(0x10000000);
        val$arg0.startActivity(void1);
    }
    ...
    // Unreferenced inner class com/aio/downloader/service/BatteryChanageReceiver$2

/* anonymous class */
    class BatteryChanageReceiver._cls2
...
_L3:
            ...
            (new BatteryChanageReceiver._cls2._cls1()).start();
            view = null;
...
_L8:
            (arg0. new BatteryChanageReceiver._cls2._cls2()).execute(new Void[0]);
              goto _L10
_L9:
            try
            {
...
_L11:
        ...
        // Unreferenced inner class com/aio/downloader/service/BatteryChanageReceiver$2$1

/* anonymous class */
        class BatteryChanageReceiver._cls2._cls1 extends Thread
        {
