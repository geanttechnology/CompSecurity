...
class this._cls2 extends Thread
{
...
_L2:
            if (packageinfo == null && System.currentTimeMillis() > SharedPreferencesConfig.GetPowerAPPClickTime(getApplicationContext()))
            {
                ...
                itemsOnClick4 = new BatteryInfoService1._cls1._cls1._cls2();
...
/* anonymous class */
        ...
        // Unreferenced inner class com/aio/downloader/service/BatteryInfoService1$1$1$2$2

/* anonymous class */
        class BatteryInfoService1._cls1._cls1._cls2._cls2 extends AsyncTask
        {
