            ...
            public void onReceive(Context context1, Intent intent)
            {
                ...
                if (intent.getAction().equals("android.intent.action.BATTERY_CHANGED"))
                {
                    ...
                    if (i <= 30 && author == 0)
                    {
                        ...
                        intent.author = ((BatteryInfoService1) (intent)).author + 1;
                        Log.e("asd", (new StringBuilder("level=")).append(i).toString());
                        (new Handler()).postDelayed(context1. new Runnable() {
...
_L2:
            ...
            
            {
                ...
                super();
                                    ...
                                    itemsOnClick4 = context. new android.view.View.OnClickListener() {
...
_L1:
    ...
    {
        super.onCreate();
        registerReceiver(myBatteryReceiver, new IntentFilter("android.intent.action.BATTERY_CHANGED"));
    }
