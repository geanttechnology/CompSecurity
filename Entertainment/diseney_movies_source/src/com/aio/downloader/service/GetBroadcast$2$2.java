...
_L1:
            ...
            if (view == null)
            {
                ...
                {
                    (context. new GetBroadcast._cls2._cls2()).execute(new Void[0]);
                } else
                {
        ...
        // Unreferenced inner class com/aio/downloader/service/GetBroadcast$2$1

/* anonymous class */
        class GetBroadcast._cls2._cls1 extends Thread
        {
