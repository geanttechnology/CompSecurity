...
_L1:
            ...
            if (view == null)
            {
                ...
                {
                    (new GetBroadcast._cls5._cls2()).execute(new Void[0]);
                } else
                {
        ...
        // Unreferenced inner class com/aio/downloader/service/GetBroadcast$5$2

/* anonymous class */
        class GetBroadcast._cls5._cls2 extends AsyncTask
        {
