...
class val.context extends AsyncTask
{
    ...
    // Unreferenced inner class com/aio/downloader/service/PhoneStateReceiver$1

/* anonymous class */
    class PhoneStateReceiver._cls1
...
_L2:
            ...
            {
                (context. new PhoneStateReceiver._cls1._cls1()).execute(new Void[0]);
