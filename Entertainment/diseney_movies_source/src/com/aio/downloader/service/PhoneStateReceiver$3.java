...
class val.context
    implements android.view.ateReceiver._cls3
{
    ...
    public void onClick(View view)
    {
        ...
        case 2131166059: 
            MobclickAgent.onEvent(val$context, "simulate_call_click");
            break;
        }
...
_L2:
        if (PhoneStateReceiver.access$2(PhoneStateReceiver.this).exists() && getFileSizes(PhoneStateReceiver.access$2(PhoneStateReceiver.this)) >= 0x4e87bdL)
        {
            (new AsyncTask() {
                ...
                final PhoneStateReceiver._cls3 this$1;
                private final Context val$context;
            ...
            {
                this$1 = PhoneStateReceiver._cls3.this;
                context = context1;
                super();
            }
            }).execute(new Void[0]);
