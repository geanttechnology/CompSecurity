...
/* anonymous class */
    class ScreenReceiver._cls1 extends Handler
    {
        ...
        public void handleMessage(final Message dialog)
        {
            ...
            button.setOnClickListener(dialog. new ScreenReceiver._cls1._cls1());
            button1.setOnClickListener(new ScreenReceiver._cls1._cls2());
        }
...
_L1:
        ...
        // Unreferenced inner class com/aio/downloader/service/ScreenReceiver$1$2$1

/* anonymous class */
        class ScreenReceiver._cls1._cls2._cls1 extends AsyncTask
        {
