...
class this._cls2 extends AsyncTask
{
    ...
    {
        Myutils.copyfile(ScreenReceiver.access$3(_fld0), ScreenReceiver.access$1(_fld0), Boolean.valueOf(false));
        return null;
    }
    ...
    protected void onPostExecute(Void void1)
    {
        ...
        void1.setDataAndType(Uri.parse((new StringBuilder("file://")).append(ScreenReceiver.access$2(_fld0)).append(File.separator).append("cleaner.apk").toString()), "application/vnd.android.package-archive");
        void1.addFlags(0x10000000);
        ScreenReceiver.access$0(_fld0).startActivity(void1);
    }
...
/* anonymous class */
    ...
    // Unreferenced inner class com/aio/downloader/service/ScreenReceiver$1$2

/* anonymous class */
    class ScreenReceiver._cls1._cls2
        implements android.view.View.OnClickListener
    {
...
_L1:
            ...
            if (view == null)
            {
                ...
                {
                    (new ScreenReceiver._cls1._cls2._cls1()).execute(new Void[0]);
                }
            }
            dialog.dismiss();
            return;
