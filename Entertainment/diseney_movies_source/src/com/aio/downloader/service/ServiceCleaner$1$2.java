    ...
    implements android.view.r
{
    ...
    public void onClick(View view)
    {
        ...
        if (!ServiceCleaner.access$3(_fld0).exists() || getFileSizes(ServiceCleaner.access$3(_fld0)) < 0x4e87bdL) goto _L2; else goto _L1
_L1:
        view = new Intent("android.intent.action.VIEW");
        view.setDataAndType(Uri.parse((new StringBuilder("file://")).append(ServiceCleaner.access$3(_fld0)).toString()), "application/vnd.android.package-archive");
...
_L4:
        ...
        return;
_L2:
        if (ServiceCleaner.access$4(_fld0).exists() && getFileSizes(ServiceCleaner.access$4(_fld0)) >= 0x4e87bdL)
        {
            (new AsyncTask() {
...
/* anonymous class */
        ...
        // Unreferenced inner class com/aio/downloader/service/ServiceCleaner$1$6

/* anonymous class */
        class ServiceCleaner._cls1._cls6
            implements android.view.View.OnClickListener
        {
...
_L2:
                if (ServiceCleaner.access$9(this$0).exists() && getFileSizes(ServiceCleaner.access$9(this$0)) >= 0x19ee4cL)
                {
                    (new ServiceCleaner._cls1._cls6._cls1()).execute(new Void[0]);
                    continue; /* Loop/switch isn't completed */
                }
                try
                {
...
_L3:
        ...
        // Unreferenced inner class com/aio/downloader/service/ServiceCleaner$1$6$1

/* anonymous class */
        class ServiceCleaner._cls1._cls6._cls1 extends AsyncTask
        {
