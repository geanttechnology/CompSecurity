...
class this._cls2 extends AsyncTask
{
    ...
    {
        Myutils.copyfile(ServiceCleaner.access$7(_fld0), ServiceCleaner.access$5(_fld0), Boolean.valueOf(false));
        return null;
    }
    ...
    protected void onPostExecute(Void void1)
    {
        ...
        void1.setDataAndType(Uri.parse((new StringBuilder("file://")).append(ServiceCleaner.access$6(_fld0)).append(File.separator).append("cleaner.apk").toString()), "application/vnd.android.package-archive");
