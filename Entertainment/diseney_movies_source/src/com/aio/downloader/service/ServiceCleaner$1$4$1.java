...
class this._cls2 extends AsyncTask
{
    ...
    {
        Myutils.copyfile(ServiceCleaner.access$9(_fld0), ServiceCleaner.access$8(_fld0), Boolean.valueOf(false));
        return null;
    }
    ...
    protected void onPostExecute(Void void1)
    {
        ...
        void1.setDataAndType(Uri.parse((new StringBuilder("file://")).append(ServiceCleaner.access$8(_fld0)).toString()), "application/vnd.android.package-archive");
