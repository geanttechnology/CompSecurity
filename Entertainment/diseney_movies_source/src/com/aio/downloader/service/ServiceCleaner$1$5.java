    ...
    implements android.view.r
{
    ...
    public void onClick(View view)
    {
        ...
        if (ServiceCleaner.access$5(_fld0).exists())
        {
            view = new Intent("android.intent.action.VIEW");
            view.setDataAndType(Uri.parse((new StringBuilder("file://")).append(ServiceCleaner.access$6(_fld0)).append(File.separator).append("cleaner.apk").toString()), "application/vnd.android.package-archive");
            view.addFlags(0x10000000);
            startActivity(view);
        } else
        if (ServiceCleaner.access$7(_fld0).exists())
        {
            (new AsyncTask() {
