...
class this._cls1 extends AsyncTask
{
    ...
    {
        Myutils.copyfile(ServiceGallery.access$6(_fld0), ServiceGallery.access$4(_fld0), Boolean.valueOf(false));
        return null;
    }
    ...
    protected void onPostExecute(Void void1)
    {
        ...
        void1.setDataAndType(Uri.parse((new StringBuilder("file://")).append(ServiceGallery.access$5(_fld0)).append(File.separator).append("cleaner.apk").toString()), "application/vnd.android.package-archive");
...
_L4:
        ...
        // Unreferenced inner class com/aio/downloader/service/ServiceGallery$3$1

/* anonymous class */
        class ServiceGallery._cls3._cls1 extends Thread
        {
