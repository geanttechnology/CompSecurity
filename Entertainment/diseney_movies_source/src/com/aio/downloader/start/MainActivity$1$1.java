...
class this._cls1 extends Thread
{
    ...
    {
        super.run();
        File _tmp = MainActivity.access$2(_fld0);
        File _tmp1 = MainActivity.access$3(_fld0);
    }
    ...
    // Unreferenced inner class com/aio/downloader/start/MainActivity$1

/* anonymous class */
    class MainActivity._cls1 extends AsyncTask
    {
        ...
        protected void onPostExecute(Void void1)
        {
            ...
            (new MainActivity._cls1._cls1()).start();
        }
