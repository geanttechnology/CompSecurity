...
class this._cls1 extends AsyncTask
{
    ...
    protected void onPostExecute(Void void1)
    {
        ...
        (new Handler()).postDelayed(new Runnable() {
            ...
            final BackupNoRootAdapterlist._cls1._cls1 this$2;
            ...
            {
                this$2 = BackupNoRootAdapterlist._cls1._cls1.this;
                super();
            }
        }, 2500L);
    }
    ...
    {
        super.onPreExecute();
        BackupNoRootAdapterlist.access$5(_fld0, ProgressDialog.show(BackupNoRootAdapterlist.access$1(_fld0), "", "Waiting for backup...", true));
        BackupNoRootAdapterlist.access$6(_fld0).setCancelable(true);
    }
