...
class val.position
    implements android.view.Adapterlist._cls1
{
    ...
    public void onClick(View view)
    {
        ...
        view = null;
        PackageInfo packageinfo = BackupNoRootAdapterlist.access$1(BackupNoRootAdapterlist.this).getPackageManager().getPackageInfo(((Info)BackupNoRootAdapterlist.access$3(BackupNoRootAdapterlist.this).get(val$position)).getPackagename(), 0);
        view = packageinfo;
_L1:
        if (view != null)
        {
            ...
            BackupNoRootAdapterlist.access$0(BackupNoRootAdapterlist.this).insertApk(((Info)BackupNoRootAdapterlist.access$3(BackupNoRootAdapterlist.this).get(val$position)).getPackagename(), s, "game_app", ((String) (obj)), view, s1);
        }
        (new AsyncTask() {
            ...
            protected void onPostExecute(Void void1)
            {
                ...
                (new Handler()).postDelayed(new Runnable() {
                    ...
                    public void run()
                    {
                        BackupNoRootAdapterlist.access$6(this$0).dismiss();
                        Toast.makeText(BackupNoRootAdapterlist.access$1(this$0), "Backup successfully", 0).show();
                    }
