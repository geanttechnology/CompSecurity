...
public class BackupNoRootAdapterlist extends BaseAdapter
{
    class ViewHold
    {
        ...
        ViewHold()
        {
            this$0 = BackupNoRootAdapterlist.this;
            super();
        }
    }
    ...
    public BackupNoRootAdapterlist(Context context1, List list)
    {
        typeFace = null;
        typeFace2 = null;
        dbUtils = null;
    ...
    public View getView(final int position, View view, ViewGroup viewgroup)
    {
        ...
        ((ViewHold) (viewgroup)).tv_uninstall.setOnClickListener(new android.view.View.OnClickListener() {
            ...
            public void onClick(View view1)
            {
                if (dbUtils == null)
                {
                    dbUtils = new TypeDbUtilsBackup(context);
                }
                view1 = null;
                PackageInfo packageinfo = context.getPackageManager().getPackageInfo(((Info)infos.get(position)).getPackagename(), 0);
                view1 = packageinfo;
_L1:
                if (view1 != null)
                {
                    String s = ((PackageInfo) (view1)).applicationInfo.loadLabel(context.getPackageManager()).toString();
                    Object obj = ((PackageInfo) (view1)).applicationInfo.loadIcon(context.getPackageManager());
                    String s1 = String.valueOf(((PackageInfo) (view1)).versionName);
                    long l1 = (new File(((PackageInfo) (view1)).applicationInfo.publicSourceDir)).length() / 1024L;
                    float f1 = (float)((double)(int)(((double)l1 / 1024D) * 100D) / 100D);
                    android.content.pm.PackageManager.NameNotFoundException namenotfoundexception1;
                    if (l1 >= 1024L)
                    {
                        view1 = (new StringBuilder(String.valueOf(f1))).append("MB").toString();
                    } else
                    {
                        view1 = (new StringBuilder(String.valueOf(l1))).append("KB").toString();
                    }
                    obj = BackupNoRootAdapterlist.bitmaptoString(drawable2Bitmap(((Drawable) (obj))));
                    dbUtils.insertApk(((Info)infos.get(position)).getPackagename(), s, "game_app", ((String) (obj)), view1, s1);
                }
                (new AsyncTask() {
            ...
            
            {
                ...
                super();
                    ...
                    {
                        super.onPreExecute();
                        pd = ProgressDialog.show(context, "", "Waiting for backup...", true);
