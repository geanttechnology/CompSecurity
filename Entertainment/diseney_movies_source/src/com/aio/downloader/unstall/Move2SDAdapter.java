...
public class Move2SDAdapter extends BaseAdapter
{
    class ViewHold
    {
    ...
    public Move2SDAdapter(Context context1, List list)
    {
        typeFace = null;
        typeFace2 = null;
    ...
    public View getView(final int position, View view, ViewGroup viewgroup)
    {
        ...
        ((ViewHold) (viewgroup)).tv_uninstall.setText("Move2SD");
        ...
        ((ViewHold) (viewgroup)).tv_uninstall.setOnClickListener(new android.view.View.OnClickListener() {
            ...
            {
                view1 = new Intent("android.settings.APPLICATION_DETAILS_SETTINGS", Uri.parse((new StringBuilder("package:")).append(((Info)infos.get(position)).getPackagename()).toString()));
