...
label0:
        {
            if (position > 0)
            {
                ...
                out.write(MyBase64.access$3(b4, buffer, position, options));
                position = 0;
            }
            return;
        }
...
_L2:
        ...
        {
            out.write(MyBase64.access$3(b4, buffer, bufferLength, options));
...
_L5:
        i = MyBase64.access$2(buffer, 0, b4, 0, options);
        out.write(b4, 0, i);
        position = 0;
        return;
