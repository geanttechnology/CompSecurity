...
public class FailReason
{
    public static final class FailType extends Enum
    {
        ...
        private static final FailType ENUM$VALUES[];
        ...
        {
            FailType afailtype[] = ENUM$VALUES;
            int i = afailtype.length;
            FailType afailtype1[] = new FailType[i];
            System.arraycopy(afailtype, 0, afailtype1, 0, i);
            return afailtype1;
        }
