...
public class JunkBoostAdapter extends MyBaseAdapter
{
    class ViewHolder
    {
    ...
    public JunkBoostAdapter(Context context)
    {
        super(context);
    }
    ...
    public View MygetView(int i, View view, ViewGroup viewgroup)
    {
        ...
        if (view == null)
        {
            view = inflater.inflate(0x7f030060, null);
        ...
        ((ViewHolder) (viewgroup)).tv_appsize.setText((new StringBuilder(String.valueOf(runingapp.memory))).toString());
        ((ViewHolder) (viewgroup)).check_box.setChecked(runingapp.ischecked);
        return view;
    }

    // Unreferenced inner class com/wjj/adapter/base/JunkBoostAdapter$ViewHolder$1
