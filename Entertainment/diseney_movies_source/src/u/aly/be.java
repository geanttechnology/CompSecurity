...
_L2:
            ...
            if (ct1.b == 0)
            {
                ...
                if (!be1.e())
                {
                    throw new cz((new StringBuilder("Required field 'upload_traffic' was not found in serialized data! Struct: ")).append(((Object)this).toString()).toString());
                }
...
_L1:
            ...
            if (!be1.i())
            {
                throw new cz((new StringBuilder("Required field 'download_traffic' was not found in serialized data! Struct: ")).append(((Object)this).toString()).toString());
            } else
            {
                be1.j();
                return;
        ...
        implements cg
    {
        ...
        static 
        {
            ...
            c = new HashMap();
            Iterator iterator = EnumSet.allOf(u/aly/be$e).iterator();
            do
            {
                if (!iterator.hasNext())
                {
