...
.field public static final enum ACCOUNT_DEACTIVATED:Lco/vine/android/api/VineError$VineKnownErrors;
...
.field public static final enum CAPTCHA:Lco/vine/android/api/VineError$VineKnownErrors;
...
.field public static final enum MESSAGE_RECIPIENT_INVALID_EMAIL_ADDRESS:Lco/vine/android/api/VineError$VineKnownErrors;

.field public static final enum MESSAGE_RECIPIENT_OUT_OF_NETWORK:Lco/vine/android/api/VineError$VineKnownErrors;
...
.field public static final enum VERIFY_CONTACT_MISMATCH:Lco/vine/android/api/VineError$VineKnownErrors;

.field public static final enum VERIFY_PHONE_WRONG_USER:Lco/vine/android/api/VineError$VineKnownErrors;

.field public static final enum VERIFY_TOKEN_EXPIRED:Lco/vine/android/api/VineError$VineKnownErrors;

.field public static final enum VERIFY_TOKEN_NOT_FOUND:Lco/vine/android/api/VineError$VineKnownErrors;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lco/vine/android/api/VineError$VineKnownErrors;->ACCOUNT_DEACTIVATED:Lco/vine/android/api/VineError$VineKnownErrors;
    ...
    const-string v1, "MESSAGE_RECIPIENT_INVALID_EMAIL_ADDRESS"

    const/16 v2, 0x27

    const/16 v3, 0x14d

    invoke-direct {v0, v1, v2, v3, v5}, Lco/vine/android/api/VineError$VineKnownErrors;-><init>(Ljava/lang/String;III)V

    sput-object v0, Lco/vine/android/api/VineError$VineKnownErrors;->MESSAGE_RECIPIENT_INVALID_EMAIL_ADDRESS:Lco/vine/android/api/VineError$VineKnownErrors;
    ...
    sput-object v0, Lco/vine/android/api/VineError$VineKnownErrors;->CAPTCHA:Lco/vine/android/api/VineError$VineKnownErrors;
    ...
    const-string v1, "VERIFY_TOKEN_EXPIRED"
    ...
    sput-object v0, Lco/vine/android/api/VineError$VineKnownErrors;->VERIFY_TOKEN_EXPIRED:Lco/vine/android/api/VineError$VineKnownErrors;

    .line 62
    new-instance v0, Lco/vine/android/api/VineError$VineKnownErrors;

    const-string v1, "VERIFY_CONTACT_MISMATCH"
    ...
    sput-object v0, Lco/vine/android/api/VineError$VineKnownErrors;->VERIFY_CONTACT_MISMATCH:Lco/vine/android/api/VineError$VineKnownErrors;

    .line 63
    new-instance v0, Lco/vine/android/api/VineError$VineKnownErrors;

    const-string v1, "VERIFY_PHONE_WRONG_USER"
    ...
    sput-object v0, Lco/vine/android/api/VineError$VineKnownErrors;->VERIFY_PHONE_WRONG_USER:Lco/vine/android/api/VineError$VineKnownErrors;

    .line 64
    new-instance v0, Lco/vine/android/api/VineError$VineKnownErrors;

    const-string v1, "VERIFY_TOKEN_NOT_FOUND"
    ...
    sput-object v0, Lco/vine/android/api/VineError$VineKnownErrors;->VERIFY_TOKEN_NOT_FOUND:Lco/vine/android/api/VineError$VineKnownErrors;

    .line 66
    new-instance v0, Lco/vine/android/api/VineError$VineKnownErrors;

    const-string v1, "MESSAGE_RECIPIENT_OUT_OF_NETWORK"
    ...
    sput-object v0, Lco/vine/android/api/VineError$VineKnownErrors;->MESSAGE_RECIPIENT_OUT_OF_NETWORK:Lco/vine/android/api/VineError$VineKnownErrors;
    ...
    sget-object v2, Lco/vine/android/api/VineError$VineKnownErrors;->ACCOUNT_DEACTIVATED:Lco/vine/android/api/VineError$VineKnownErrors;
    ...
    sget-object v2, Lco/vine/android/api/VineError$VineKnownErrors;->MESSAGE_RECIPIENT_INVALID_EMAIL_ADDRESS:Lco/vine/android/api/VineError$VineKnownErrors;
    ...
    sget-object v2, Lco/vine/android/api/VineError$VineKnownErrors;->CAPTCHA:Lco/vine/android/api/VineError$VineKnownErrors;
    ...
    sget-object v2, Lco/vine/android/api/VineError$VineKnownErrors;->VERIFY_TOKEN_EXPIRED:Lco/vine/android/api/VineError$VineKnownErrors;

    aput-object v2, v0, v1

    const/16 v1, 0x2e

    sget-object v2, Lco/vine/android/api/VineError$VineKnownErrors;->VERIFY_CONTACT_MISMATCH:Lco/vine/android/api/VineError$VineKnownErrors;

    aput-object v2, v0, v1

    const/16 v1, 0x2f

    sget-object v2, Lco/vine/android/api/VineError$VineKnownErrors;->VERIFY_PHONE_WRONG_USER:Lco/vine/android/api/VineError$VineKnownErrors;

    aput-object v2, v0, v1

    const/16 v1, 0x30

    sget-object v2, Lco/vine/android/api/VineError$VineKnownErrors;->VERIFY_TOKEN_NOT_FOUND:Lco/vine/android/api/VineError$VineKnownErrors;

    aput-object v2, v0, v1

    const/16 v1, 0x31

    sget-object v2, Lco/vine/android/api/VineError$VineKnownErrors;->MESSAGE_RECIPIENT_OUT_OF_NETWORK:Lco/vine/android/api/VineError$VineKnownErrors;
...
.method public static valueOf(I)Lco/vine/android/api/VineError$VineKnownErrors;
    ...
    .line 161
    :sswitch_25
    sget-object v0, Lco/vine/android/api/VineError$VineKnownErrors;->MESSAGE_RECIPIENT_INVALID_EMAIL_ADDRESS:Lco/vine/android/api/VineError$VineKnownErrors;
    ...
    .line 165
    :sswitch_27
    sget-object v0, Lco/vine/android/api/VineError$VineKnownErrors;->CAPTCHA:Lco/vine/android/api/VineError$VineKnownErrors;
    ...
    .line 169
    :sswitch_29
    sget-object v0, Lco/vine/android/api/VineError$VineKnownErrors;->VERIFY_TOKEN_EXPIRED:Lco/vine/android/api/VineError$VineKnownErrors;

    goto :goto_0

    .line 171
    :sswitch_2a
    sget-object v0, Lco/vine/android/api/VineError$VineKnownErrors;->VERIFY_CONTACT_MISMATCH:Lco/vine/android/api/VineError$VineKnownErrors;

    goto/16 :goto_0

    .line 173
    :sswitch_2b
    sget-object v0, Lco/vine/android/api/VineError$VineKnownErrors;->VERIFY_PHONE_WRONG_USER:Lco/vine/android/api/VineError$VineKnownErrors;

    goto/16 :goto_0

    .line 175
    :sswitch_2c
    sget-object v0, Lco/vine/android/api/VineError$VineKnownErrors;->VERIFY_TOKEN_NOT_FOUND:Lco/vine/android/api/VineError$VineKnownErrors;

    goto/16 :goto_0

    .line 177
    :sswitch_2d
    sget-object v0, Lco/vine/android/api/VineError$VineKnownErrors;->MESSAGE_RECIPIENT_OUT_OF_NETWORK:Lco/vine/android/api/VineError$VineKnownErrors;
...
.method public static valueOf(Lco/vine/android/api/VineError;)Lco/vine/android/api/VineError$VineKnownErrors;
    .locals 1
    .param p0, "error"    # Lco/vine/android/api/VineError;
