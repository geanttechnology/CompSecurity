...
public abstract class DraftFragmentStatePagerAdapter extends DraftPagerAdapter
{
    ...
    public DraftFragmentStatePagerAdapter(FragmentManager fragmentmanager)
    {
    ...
    public void destroyItem(View view, int i, Object obj)
    {
        ...
        mSavedState.set(i, mFragmentManager.saveFragmentInstanceState(view));
        mFragments.set(i, null);
        mCurTransaction.remove(view);
    }
    ...
    public Object instantiateItem(View view, int i)
    {
        ...
        mCurTransaction.add(view.getId(), fragment1);
        return fragment1;
    }
