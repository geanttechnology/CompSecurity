    ...
    implements Runnable
{
    ...
    public void run()
    {
        if (!goToCamera)
        {
            AbstractRecordingActivity.access$900(_fld0).setVisibility(8);
            AbstractRecordingActivity.access$1000(_fld0).setVisibility(8);
        }
    }
    ...
    // Unreferenced inner class co/vine/android/AbstractRecordingActivity$9

/* anonymous class */
    class AbstractRecordingActivity._cls9 extends SimpleAnimationListener
    {
        ...
        public void onAnimationEnd(Animation animation)
        {
            ...
            AbstractRecordingActivity.access$1500(AbstractRecordingActivity.this).setAnimationListener(new AbstractRecordingActivity._cls9._cls1());
            AbstractRecordingActivity.access$1200(AbstractRecordingActivity.this).postDelayed(new AbstractRecordingActivity._cls9._cls2(), 150L);
        ...
        // Unreferenced inner class co/vine/android/AbstractRecordingActivity$9$2

/* anonymous class */
        class AbstractRecordingActivity._cls9._cls2
            implements Runnable
        {
    ...
    // Unreferenced inner class co/vine/android/AbstractRecordingActivity$9$1

/* anonymous class */
    class AbstractRecordingActivity._cls9._cls1 extends SimpleAnimationListener
    {
        ...
        public void onAnimationEnd(Animation animation)
        {
            ...
            AbstractRecordingActivity.access$1200(this$0).postDelayed(new AbstractRecordingActivity._cls9._cls1._cls2(), 300L);
        }
        ...
        public void onAnimationStart(Animation animation)
        {
            if (goToCamera)
            {
                ...
                AbstractRecordingActivity.access$1200(this$0).postDelayed(new AbstractRecordingActivity._cls9._cls1._cls1(), AbstractRecordingActivity.access$1600(this$0).getDuration());
            }
        }
        ...
        // Unreferenced inner class co/vine/android/AbstractRecordingActivity$9$1$1

/* anonymous class */
        class AbstractRecordingActivity._cls9._cls1._cls1
            implements Runnable
        {

            final AbstractRecordingActivity._cls9._cls1 this$2;
            ...
            public void run()
            {
                AbstractRecordingActivity.access$800(this$0).setVisibility(8);
                    ...
                    {
                        this$2 = AbstractRecordingActivity._cls9._cls1.this;
                        super();
                    }
        }
