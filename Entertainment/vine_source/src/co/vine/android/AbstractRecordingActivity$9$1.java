...
class ner extends SimpleAnimationListener
{
    ...
    {
        AbstractRecordingActivity.access$1702(_fld0, false);
        AbstractRecordingActivity.access$1200(_fld0).postDelayed(new Runnable() {
    ...
    public void onAnimationStart(Animation animation)
    {
        if (goToCamera)
        {
            AbstractRecordingActivity.access$1400(_fld0).setVisibility(0);
            AbstractRecordingActivity.access$1400(_fld0).setAlpha(0.0F);
            AbstractRecordingActivity.access$1400(_fld0).animate().alpha(1.0F).setDuration(AbstractRecordingActivity.access$1500(_fld0).getDuration()).setListener(new ViewGoneAnimationListener(AbstractRecordingActivity.access$1400(_fld0))).start();
            AbstractRecordingActivity.access$1200(_fld0).postDelayed(new Runnable() {
            ...
            }, AbstractRecordingActivity.access$1600(_fld0).getDuration());
        }
    }
