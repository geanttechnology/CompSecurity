    ...
    implements Runnable
{
    ...
    public void run()
    {
        AbstractRecordingActivity.access$1800(_fld0).setVisibility(8);
    }
...
/* anonymous class */
        ...
        // Unreferenced inner class co/vine/android/AbstractRecordingActivity$9$1$2

/* anonymous class */
        class AbstractRecordingActivity._cls9._cls1._cls2
            implements Runnable
        {
