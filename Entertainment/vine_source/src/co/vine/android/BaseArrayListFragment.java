...
//            BaseAdapterFragment, HomeTabActivity, PendingRequestHelper, ListState, 
//            ScrollListener

public class BaseArrayListFragment extends BaseAdapterFragment
    implements android.widget.AbsListView.OnScrollListener, OnTabChangedListener, RefreshListener, co.vine.android.widget.PinnedHeaderListView.ScrollDeltaListener
{
    ...
    private int mChildFormerTop;
    private View mChildObservedForScrollDistance;
    ...
    private final android.widget.AdapterView.OnItemClickListener mOnItemClickListener = new android.widget.AdapterView.OnItemClickListener() {
        ...
        final BaseArrayListFragment this$0;
        ...
        public void onItemClick(AdapterView adapterview, View view, int i, long l)
        {
            ...
            {
                this$0 = BaseArrayListFragment.this;
                super();
            }
    };
    ...
    public View createView(LayoutInflater layoutinflater, int i, ViewGroup viewgroup)
    {
        ...
        {
            ((PinnedHeaderListView)mListView).setScrollDeltaListener(this);
        }
...
_L7:
    ...
    public void onScroll(int i)
    {
        ...
        if (fragmentactivity instanceof ScrollListener)
        {
            ((ScrollListener)fragmentactivity).onScroll(i);
        }
    }
    ...
    public void onScroll(AbsListView abslistview, int i, int j, int k)
    {
        ...
        for (mListState.totalItemCount = k; j == 0 || i <= 0 || mAdapter == null || i + j < k - 1 || mAdapter.getCount() <= 0 || !mListState.hasNewScrollState;)
        {
            return;
        }
    ...
    public void setNavBottom(int i)
    {
        if (mListView instanceof PinnedHeaderListView)
        {
            ((PinnedHeaderListView)mListView).setNavBottom(i);
        }
    }
