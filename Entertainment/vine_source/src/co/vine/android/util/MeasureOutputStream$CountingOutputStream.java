...
//            MeasureOutputStream, VineProgressEvent, VineProgressListener

public static class mProgressListener extends FilterOutputStream
{
    ...
    public (OutputStream outputstream, VineProgressListener vineprogresslistener)
    {
        super(outputstream);
