...
public final class MessageFormatter
{
    ...
    public static FormattingTuple arrayFormat(String s, Object aobj[])
    {
    ...
    public static FormattingTuple format(String s, Object obj)
    {
    ...
    public static FormattingTuple format(String s, Object obj, Object obj1)
    {
        return arrayFormat(s, new Object[] {
            obj, obj1
        });
    ...
    public static FormattingTuple format(String s, Object obj, Object obj1, Object obj2)
    {
        return arrayFormat(s, new Object[] {
            obj, obj1, obj2
        });
    ...
    public static FormattingTuple format(String s, Object aobj[])
    {
        return arrayFormat(s, aobj);
    }

    private static Throwable getThrowableCandidate(Object aobj[])
    {
    ...
    private static boolean isDoubleEscaped(String s, int i)
    {
        return i >= 2 && s.charAt(i - 2) == '\\';
    }

    private static boolean isEscapedDelimeter(String s, int i)
    {
