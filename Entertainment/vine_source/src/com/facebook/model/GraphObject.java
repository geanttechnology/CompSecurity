...
_L2:
        ...
        {
            boolean flag1 = true;
            if (graphobject != null && graphobject1 != null && graphobject.asMap().containsKey("id") && graphobject1.asMap().containsKey("id")) goto _L2; else goto _L1
_L1:
            boolean flag = false;
_L4:
            return flag;
_L2:
            flag = flag1;
            if (graphobject.equals(graphobject1)) goto _L4; else goto _L3
_L3:
            ...
            flag = flag1;
            if (graphobject.equals(graphobject1)) goto _L4; else goto _L5
_L5:
            return false;
        }
