...
_L6:
        ...
        continue; /* Loop/switch isn't completed */
_L2:
        serializablestring = _parseNumber(i);
...
_L3:
        ...
        throws IOException, JsonParseException
    {
        ...
        case 56: // '8'
        case 57: // '9'
            JsonToken jsontoken7 = _parseNumber(i);
...
_L4:
        ...
        _inputPtr = i + 1;
        j = abyte1[i] & 0xff;
        if (j <= 32) goto _L12; else goto _L11
_L11:
        i = j;
        if (j != 47) goto _L14; else goto _L13
_L13:
        _skipComment();
          goto _L4
_L9:
...
_L3:
    ...
    public static int[] growArrayBy(int ai[], int i)
    {
        ...
        {
            return ArraysCompat.copyOf(ai, ai.length + i);
        }
    }
...
_L2:
        ...
        throws IOException, JsonParseException
    {
        ...
        do
        {
            if (_inputPtr >= j)
            {
                return _parserNumber2(ac, i, flag1, k);
            }
            byte abyte1[] = _inputBuffer;
            int l = _inputPtr;
            _inputPtr = l + 1;
            ...
            if (i1 < 48 || i1 > 57)
            {
                ...
                {
                    return _parseFloat(ac, i, i1, flag1, k);
                }
                break;
            }
            k++;
...
_L3:
        ...
        throws IOException, JsonParseException
    {
        ...
        if (_parsingContext.expectComma())
        {
            if (k != 44)
            {
                _reportUnexpectedChar(k, (new StringBuilder()).append("was expecting comma to separate ").append(_parsingContext.getTypeDesc()).append(" entries").toString());
            }
            i = _skipWS();
        }
        if (!_parsingContext.inObject())
...
_L7:
        ...
        if (abyte0[j] == _inputBuffer[j1 + j]) goto _L5; else goto _L2
_L2:
...
_L3:
        j;
        JVM INSTR lookupswitch 18: default 524
    //                   45: 603
    //                   48: 603
    //                   49: 603
    //                   50: 603
