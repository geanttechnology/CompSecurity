...
_L5:
    ...
    private void expandCollision()
    {
        ...
        _collList = (Bucket[])ArraysCompat.copyOf(abucket, abucket.length * 2);
    }
...
label0:
    ...
    private void unshareCollision()
    {
        ...
        {
            _collList = (Bucket[])ArraysCompat.copyOf(abucket, abucket.length);
        }
        _collListShared = false;
    }
    ...
    {
        int ai[] = _mainHash;
        _mainHash = ArraysCompat.copyOf(ai, ai.length);
    ...
    {
        Name aname[] = _mainNames;
        _mainNames = (Name[])ArraysCompat.copyOf(aname, aname.length);
        _mainNamesShared = false;
    }
