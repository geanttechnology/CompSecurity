...
public final class TextBuffer
{
    ...
    private void expand(int i)
    {
        ...
        _currentSize = 0;
        _currentSegment = carr(Math.min(0x40000, k + i));
    }
    ...
    private char[] resultArray()
    {
        ...
        if (_inputStart >= 0)
        {
            ...
            if (k == 0)
            {
                return ArraysCompat.copyOf(_inputBuffer, i);
            } else
            {
                return ArraysCompat.copyOfRange(_inputBuffer, k, i + k);
            }
        }
        int j = size();
        if (j < 1)
    ...
    public char[] expandCurrentSegment()
    {
        ...
        {
            i = Math.min(0x40000, i + (i >> 1));
        }
        ac = ArraysCompat.copyOf(ac, i);
        _currentSegment = ac;
        return ac;
    }
    ...
    public char[] finishCurrentSegment()
    {
        ...
        char ac[] = carr(Math.min(i + (i >> 1), 0x40000));
        _currentSize = 0;
        _currentSegment = ac;
        return ac;
    }
