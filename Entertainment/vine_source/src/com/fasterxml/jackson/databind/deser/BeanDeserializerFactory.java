...
_L3:
        ...
        throws JsonMappingException
    {
        ...
        if (obj == com/fasterxml/jackson/annotation/ObjectIdGenerators$PropertyGenerator)
        {
            ...
            obj = beandeserializerbuilder.findProperty(((PropertyName) (obj1)));
            if (obj == null)
            {
                throw new IllegalArgumentException((new StringBuilder()).append("Invalid Object Id definition for ").append(beandescription.getBeanClass().getName()).append(": can not find property with name '").append(obj1).append("'").toString());
            }
