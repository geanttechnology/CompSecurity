...
label0:
        {
            ...
            Class class1 = annotatedmethod.getDeclaringClass();
            Class class2 = annotatedmethod1.getDeclaringClass();
            if (class1 == class2)
            {
                break label0;
            }
...
_L6:
        ...
        {
            throw new IllegalArgumentException((new StringBuilder()).append("Conflicting getter definitions for property \"").append(getName()).append("\": ").append(annotatedmethod.getFullName()).append(" vs ").append(annotatedmethod1.getFullName()).toString());
        }
          goto _L6
    }
...
_L8:
        if (!class2.isAssignableFrom(class1)) goto _L6; else goto _L10
_L6:
        throw new IllegalArgumentException((new StringBuilder()).append("Conflicting setter definitions for property \"").append(getName()).append("\": ").append(annotatedmethod.getFullName()).append(" vs ").append(annotatedmethod1.getFullName()).toString());
    }
