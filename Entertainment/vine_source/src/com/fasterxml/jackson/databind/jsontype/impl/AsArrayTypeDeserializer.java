    ...
    implements Serializable
{
        ...
        throws IOException, JsonProcessingException
    {
        ...
        {
            jsonparser = ((JsonParser) (_deserializeWithNativeTypeId(jsonparser, deserializationcontext)));
        } else
        {
            boolean flag = jsonparser.isExpectedStartArrayToken();
            String s = _locateTypeId(jsonparser, deserializationcontext);
            Object obj1 = _findDeserializer(deserializationcontext, s);
            ...
            if (_typeIdVisible)
            {
                ...
                {
                    obj = new TokenBuffer(null, false);
            ...
            obj1 = ((JsonDeserializer) (obj1)).deserialize(((JsonParser) (obj)), deserializationcontext);
            jsonparser = ((JsonParser) (obj1));
            if (flag)
            {
                jsonparser = ((JsonParser) (obj1));
                if (((JsonParser) (obj)).nextToken() != JsonToken.END_ARRAY)
                {
