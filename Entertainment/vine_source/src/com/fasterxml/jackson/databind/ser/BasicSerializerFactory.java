...
_L3:
        ...
        obj = StdContainerSerializers.enumSetSerializer(typeserializer);
_L2:
        Object obj2;
        Class class1;
        if (_factoryConfig.hasSerializerModifiers())
...
label0:
        ...
        {
            obj2 = StdContainerSerializers.indexedListSerializer(collectiontype.getContentType(), flag, typeserializer, jsonserializer);
        }
_L8:
        obj = obj2;
        if (obj2 == null)
...
_L3:
        ...
        throws JsonMappingException
    {
        ...
        if (jsonserializer2 == null)
        {
            ...
            {
                obj = maptype.getKeyType();
                jsonserializer = null;
                if (((JavaType) (obj)).isEnumType())
                {
                    jsonserializer = EnumValues.construct(((JavaType) (obj)).getRawClass(), serializationconfig.getAnnotationIntrospector());
                }
                obj = new EnumMapSerializer(maptype.getContentType(), flag, jsonserializer, typeserializer, jsonserializer1);
            } else
            {
