...
_L6:
        ...
        throws JsonMappingException
    {
        ...
        Object obj1 = findSerializerFromAnnotation(serializerprovider, ((BeanDescription) (obj)).getClassInfo());
        if (obj1 != null)
        {
            return ((JsonSerializer) (obj1));
        }
        obj1 = modifyTypeByAnnotation(serializationconfig, ((BeanDescription) (obj)).getClassInfo(), javatype);
        JavaType javatype1;
        boolean flag;
        if (obj1 == javatype)
        {
        ...
        if (!((JavaType) (obj1)).hasRawClass(javatype.getRawClass()))
        {
            javatype = serializationconfig.introspect(((JavaType) (obj1)));
            flag = true;
        } else
        {
            flag = true;
        ...
        obj = javatype.findSerializationConverter();
        if (obj == null)
        {
            return _createSerializer2(serializerprovider, ((JavaType) (obj1)), javatype, flag);
        }
        javatype1 = ((Converter) (obj)).getOutputType(serializerprovider.getTypeFactory());
        if (!javatype1.hasRawClass(((JavaType) (obj1)).getRawClass()))
        {
            javatype = serializationconfig.introspect(javatype1);
        }
        return new StdDelegatingSerializer(((Converter) (obj)), javatype1, _createSerializer2(serializerprovider, javatype1, javatype, true));
    }
