    ...
    protected JavaType findSerializationType(Annotated annotated, boolean flag, JavaType javatype)
    {
        ...
        if (obj != null)
        {
            ...
            } else
            {
                ...
                {
                    throw new IllegalArgumentException((new StringBuilder()).append("Illegal concrete-type annotation for method '").append(annotated.getName()).append("': class ").append(((Class) (obj)).getName()).append(" not a super-type of (declared) class ").append(((Class) (obj1)).getName()).toString());
                }
                javatype = _config.constructSpecializedType(javatype, ((Class) (obj)));
            }
            flag = true;
        }
        obj1 = BeanSerializerFactory.modifySecondaryTypesByAnnotation(_config, annotated, javatype);
        obj = javatype;
        if (obj1 != javatype)
        {
            obj = obj1;
