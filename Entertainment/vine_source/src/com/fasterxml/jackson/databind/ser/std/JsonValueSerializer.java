        ...
        throws JsonMappingException
    {
        ...
        if (jsonserializer == null)
        {
            ...
            if (javatype == null)
            {
                ...
                if (javatype == null)
                {
                    javatype1 = jsonformatvisitorwrapper.getProvider().constructType(_accessorMethod.getReturnType());
                }
            }
...
label1:
            {
                ...
                serializerprovider = serializerprovider.findPrimaryPropertySerializer(((JavaType) (obj)), _property);
