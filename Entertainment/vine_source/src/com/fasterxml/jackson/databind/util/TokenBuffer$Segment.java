...
protected static final class 
{
    ...
    public assignNativeIds append(int i, JsonToken jsontoken)
    {
        if (i < 16)
        {
            set(i, jsontoken);
    ...
    public _next append(int i, JsonToken jsontoken, Object obj, Object obj1)
    {
        if (i < 16)
        {
    ...
    public _next append(int i, JsonToken jsontoken, Object obj, Object obj1, Object obj2)
    {
        if (i < 16)
        {
    ...
    public _next appendRaw(int i, int j, Object obj, Object obj1, Object obj2)
    {
        if (i < 16)
        {
