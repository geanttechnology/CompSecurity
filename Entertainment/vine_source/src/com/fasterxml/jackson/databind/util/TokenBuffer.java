...
label0:
    ...
    {
        Object obj = _last.findObjectId(_appendOffset - 1);
        if (obj != null)
        {
            stringbuilder.append("[objectId=").append(String.valueOf(obj)).append(']');
        }
        obj = _last.findTypeId(_appendOffset - 1);
        if (obj != null)
        {
    ...
    protected final void _append(JsonToken jsontoken)
    {
        if (_hasNativeId)
        {
            jsontoken = _last.append(_appendOffset, jsontoken, _objectId, _typeId);
        } else
        {
    ...
    protected final void _append(JsonToken jsontoken, Object obj)
    {
        if (_hasNativeId)
        {
            jsontoken = _last.append(_appendOffset, jsontoken, obj, _objectId, _typeId);
        } else
        {
    ...
    protected final void _appendRaw(int i, Object obj)
    {
        if (_hasNativeId)
        {
            obj = _last.appendRaw(_appendOffset, i, obj, _objectId, _typeId);
        } else
        {
...
_L12:
        ...
        {
            throw new JsonGenerationException((new StringBuilder()).append("Unrecognized value type for VALUE_NUMBER_FLOAT: ").append(obj3.getClass().getName()).append(", can not serialize").toString());
        }
          goto _L18
_L13:
