...
public final class FlurryAgent
{
    ...
    public static void endTimedEvent(String s, Map map)
    {
        ...
        {
            el.a(a, (new StringBuilder()).append("Failed to signify the end of event: ").append(s).toString(), map);
        }
    }
    ...
    public static void logEvent(String s, Map map)
    {
        ...
        {
            el.a(a, (new StringBuilder()).append("Failed to log event: ").append(s).toString(), map);
        }
    }
    ...
    public static void setCaptureUncaughtExceptions(boolean flag)
    {
        ...
        {
            dm.a().a("CaptureUncaughtExceptions", Boolean.valueOf(flag));
            return;
        }
    }
    ...
    public static void setContinueSessionMillis(long l)
    {
        ...
        {
            dm.a().a("ContinueSessionMillis", Long.valueOf(l));
            return;
        }
    }
    ...
    public static void setGender(byte byte0)
    {
        ...
        case 0: // '\0'
        case 1: // '\001'
            dm.a().a("Gender", Byte.valueOf(byte0));
            break;
        }
    }
    ...
    public static void setLocationCriteria(Criteria criteria)
    {
        ...
        {
            dm.a().a("LocationCriteria", criteria);
            return;
        }
    }
    ...
    public static void setLogEvents(boolean flag)
    {
        ...
        {
            dm.a().a("LogEvents", Boolean.valueOf(flag));
            return;
        }
    }
    ...
    public static void setReportLocation(boolean flag)
    {
        ...
        {
            dm.a().a("ReportLocation", Boolean.valueOf(flag));
            return;
        }
    }
    ...
    public static void setUseHttps(boolean flag)
    {
        ...
        {
            dm.a().a("UseHttps", Boolean.valueOf(flag));
            return;
        }
    }
