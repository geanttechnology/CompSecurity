...
public class dc
{
    ...
    private static final String d = com/flurry/sdk/dc.getSimpleName();
    String a;
    long b;
    int c;
    private File e;
    ...
    public dc()
    {
        ...
        e = dl.a().b().getFileStreamPath((new StringBuilder()).append(".flurrydatasenderblock.").append(a).toString());
    }
