...
_L3:
    ...
    static String b()
    {
        String s = android.provider.Settings.Secure.getString(dl.a().b().getContentResolver(), "android_id");
        if (!a(s))
        {
            return null;
        } else
    ...
    static void b(String s)
    {
        ...
        {
            if (fa.a(file = dl.a().b().getFileStreamPath(h())))
            {
                a(s, file);
                return;
            }
    ...
    static String d()
    {
        ...
        long l2 = du.c(dl.a().b()).hashCode() * 37;
    ...
    {
        Object obj;
        obj = dl.a().b().getFileStreamPath(h());
...
_L4:
        obj = obj1;
        el.a(6, a, "Error when loading phoneId", ((Throwable) (obj3)));
        fb.a(((java.io.Closeable) (obj1)));
        return null;
        obj;
        obj3 = null;
...
_L3:
        as = as[0];
        as = dl.a().b().getFileStreamPath(as);
