...
public static class allocateArray extends Pointer
{
    ...
    public native allocateArray end_frame(int i);
    ...
    public native position qscale(int i);

    public native float quality_factor();

    public native position quality_factor(float f);

    public native int start_frame();

    public native position start_frame(int i);
