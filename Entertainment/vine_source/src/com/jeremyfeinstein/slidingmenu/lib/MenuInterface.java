...
public interface MenuInterface
{
    ...
    public abstract void drawSelector(View view, Canvas canvas, float f);
    ...
    public abstract boolean menuOpenTouchAllowed(View view, int i, int j);

    public abstract boolean menuTouchInQuickReturn(View view, int i, int j);
