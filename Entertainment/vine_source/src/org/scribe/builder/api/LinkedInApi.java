...
public class LinkedInApi extends DefaultApi10a
{
    ...
    private String scopesAsString()
    {
        ...
        String s;
        for (Iterator iterator = scopes.iterator(); iterator.hasNext(); stringbuilder.append((new StringBuilder()).append("+").append(s).toString()))
        {
    ...
    public String getRequestTokenEndpoint()
    {
        ...
        {
            return (new StringBuilder()).append("https://api.linkedin.com/uas/oauth/requestToken?scope=").append(scopesAsString()).toString();
        }
    }
}
