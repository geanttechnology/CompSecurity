...
//            RequestTokenExtractor, AccessTokenExtractor
    ...
    implements RequestTokenExtractor, AccessTokenExtractor
{
    ...
    private String extract(String s, Pattern pattern)
    {
        ...
        {
            throw new OAuthException((new StringBuilder()).append("Response body is incorrect. Can't extract token and secret from this: '").append(s).append("'").toString(), null);
        }
    }
