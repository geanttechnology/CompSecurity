...
//            TwitterResponse, ExceptionDiagnosis, Version
...
_L2:
        return -1;
        if (statusCode == 400 || statusCode != 420) goto _L2; else goto _L1
_L1:
        String s;
        int i;
        try
...
_L3:
    ...
    public String toString()
    {
        ...
        return stringbuilder.append(s).append("statusCode=").append(statusCode).append(", message=").append(errorMessage).append(", code=").append(errorCode).append(", retryAfter=").append(getRetryAfter()).append(", version=").append(Version.getVersion()).append('}').toString();
    }
