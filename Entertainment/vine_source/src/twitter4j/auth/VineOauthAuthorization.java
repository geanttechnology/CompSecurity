...
public class VineOauthAuthorization
    implements Authorization, Serializable, OAuthSupport
{
    ...
    public VineOauthAuthorization(Configuration configuration)
    {
        consumerKey = "";
        realm = null;
        oauthToken = null;
...
_L1:
        s = z_T4JInternalStringUtil.split(s.substring(i + 1), "&");
        int j = s.length;
        i = 0;
_L8:
...
_L7:
    ...
    public boolean equals(Object obj)
    {
        if (this != obj)
        {
            ...
            obj = (VineOauthAuthorization)obj;
            if (consumerKey == null ? ((VineOauthAuthorization) (obj)).consumerKey != null : !consumerKey.equals(((VineOauthAuthorization) (obj)).consumerKey))
            {
                return false;
            }
            if (consumerSecret == null ? ((VineOauthAuthorization) (obj)).consumerSecret != null : !consumerSecret.equals(((VineOauthAuthorization) (obj)).consumerSecret))
            {
                return false;
            }
            if (oauthToken == null ? ((VineOauthAuthorization) (obj)).oauthToken != null : !oauthToken.equals(((VineOauthAuthorization) (obj)).oauthToken))
            {
                return false;
            }
        }
    ...
    String generateAuthorizationHeader(String s, String s1, HttpParameter ahttpparameter[], String s2, String s3, OAuthToken oauthtoken)
    {
        ...
        if (LOGGABLE)
        {
            Log.v("t4jVineOauth", (new StringBuilder()).append("OAuth base string: ").append(s).toString());
        }
        s = generateSignature(s, oauthtoken);
        if (LOGGABLE)
        {
            Log.v("t4jVineOauth", (new StringBuilder()).append("OAuth signature: ").append(s).toString());
        }
    ...
    String generateSignature(String s, OAuthToken oauthtoken)
    {
        ...
        catch (String s)
        {
            if (LOGGABLE)
            {
                Log.v("t4jVineOauth", "Failed initialize \"Message Authentication Code\" (MAC)", s);
            }
        ...
        catch (String s)
        {
            if (LOGGABLE)
            {
                Log.v("t4jVineOauth", "Failed to get HmacSHA1 \"Message Authentication Code\" (MAC)", s);
            }
            throw new AssertionError(s);
        }
...
_L3:
        ...
        throws TwitterException
    {
        ...
        oauthToken = new AccessToken(http.post(s2, new HttpParameter[] {
            new HttpParameter("x_auth_username", s), new HttpParameter("x_auth_password", s1), new HttpParameter("x_auth_mode", "client_auth"), new HttpParameter("send_error_codes", true)
        }, this));
