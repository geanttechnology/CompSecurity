    ...
    implements Configuration, Serializable
{
    ...
    {
        if ("https://api.twitter.com/1.1/".equals(fixURL(false, restBaseURL)))
        {
            restBaseURL = fixURL(useSSL, restBaseURL);
        }
        if ("https://api.twitter.com/oauth/access_token".equals(fixURL(false, oAuthAccessTokenURL)))
        {
            oAuthAccessTokenURL = fixURL(useSSL, oAuthAccessTokenURL);
        }
        if ("https://api.twitter.com/oauth/authenticate".equals(fixURL(false, oAuthAuthenticationURL)))
        {
            oAuthAuthenticationURL = fixURL(useSSL, oAuthAuthenticationURL);
        }
        if ("https://api.twitter.com/oauth/authorize".equals(fixURL(false, oAuthAuthorizationURL)))
        {
            oAuthAuthorizationURL = fixURL(useSSL, oAuthAuthorizationURL);
        }
        if ("https://api.twitter.com/oauth/request_token".equals(fixURL(false, oAuthRequestTokenURL)))
        {
    ...
    public int hashCode()
    {
        ...
        return (((((((((((((((((((((((((((((((((((((((((((((((((((((i * 31 + j) * 31 + k) * 31 + l) * 31 + i1) * 31 + j1) * 31 + k1) * 31 + l1) * 31 + i2) * 31 + j2) * 31 + j11) * 31 + k11) * 31 + l11) * 31 + i12) * 31 + j12) * 31 + k12) * 31 + l12) * 31 + i13) * 31 + k2) * 31 + l2) * 31 + i3) * 31 + j3) * 31 + k3) * 31 + l3) * 31 + i4) * 31 + j4) * 31 + k4) * 31 + l4) * 31 + i5) * 31 + j5) * 31 + k5) * 31 + l5) * 31 + i6) * 31 + j6) * 31 + k6) * 31 + l6) * 31 + j13) * 31 + k13) * 31 + i7) * 31 + j7) * 31 + k7) * 31 + l7) * 31 + i8) * 31 + j8) * 31 + k8) * 31 + l8) * 31 + i9) * 31 + j9) * 31 + k9) * 31 + l9) * 31 + i10) * 31 + j10) * 31 + k10) * 31 + l10) * 31 + i11;
    }
