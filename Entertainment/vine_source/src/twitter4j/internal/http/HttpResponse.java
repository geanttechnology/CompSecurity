...
_L5:
        ...
        obj1 = obj2;
        obj = obj2;
        Log.d("T4JHttpResposne", jsonArray.toString(1));
_L11:
        if (obj2 != null)
        {
            try
...
_L4:
        ...
        obj2;
        obj = obj1;
        if (!LOGGABLE) goto _L9; else goto _L8
_L8:
        obj = obj1;
...
_L6:
        obj1 = obj2;
        obj = obj2;
        if (!LOGGABLE) goto _L11; else goto _L10
_L10:
        obj1 = obj2;
        obj = obj2;
        if (responseAsString == null) goto _L13; else goto _L12
_L12:
        obj1 = obj2;
        obj = obj2;
        s = responseAsString;
...
_L5:
        ...
        obj1 = obj2;
        obj = obj2;
        Log.d("T4JHttpResposne", json.toString(1));
_L11:
        if (obj2 != null)
        {
            try
...
_L4:
        ...
        if (LOGGABLE)
        {
            Log.d("T4JHttpResposne", responseAsString);
        }
        ((InputStream) (obj)).close();
        streamConsumed = true;
        if (obj != null)
