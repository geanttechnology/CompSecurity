...
.method protected prepareStatements()V
    ...
    .line 144
    :try_start_0
    iget-object v1, p0, Lcom/adobe/mobile/ThirdPartyQueue;->database:Landroid/database/sqlite/SQLiteDatabase;

    const-string v2, "INSERT INTO HITS (URL, POSTBODY, POSTTYPE, TIMESTAMP, TIMEOUT) VALUES (?, ?, ?, ?, ?)"

    invoke-virtual {v1, v2}, Landroid/database/sqlite/SQLiteDatabase;->compileStatement(Ljava/lang/String;)Landroid/database/sqlite/SQLiteStatement;

    move-result-object v1

    iput-object v1, p0, Lcom/adobe/mobile/ThirdPartyQueue;->_preparedInsertStatement:Landroid/database/sqlite/SQLiteStatement;
    :try_end_0
...
.method protected queue(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;JJ)V
    ...
    .line 83
    const-string v2, "%s - Cannot send hit, MobileConfig is null (this really shouldn\'t happen)"
    ...
    .line 88
    const-string v2, "%s - Ignoring hit due to privacy status being opted out"
    ...
    .line 93
    :cond_1
    iget-object v3, p0, Lcom/adobe/mobile/ThirdPartyQueue;->dbMutex:Ljava/lang/Object;

    monitor-enter v3

    .line 96
    :try_start_0
    iget-object v2, p0, Lcom/adobe/mobile/ThirdPartyQueue;->_preparedInsertStatement:Landroid/database/sqlite/SQLiteStatement;
    ...
    invoke-virtual {v2, v4, p3}, Landroid/database/sqlite/SQLiteStatement;->bindString(ILjava/lang/String;)V
    ...
    invoke-virtual {v2, v4, p4, p5}, Landroid/database/sqlite/SQLiteStatement;->bindLong(IJ)V
    ...
    invoke-virtual {v2, v4, p6, p7}, Landroid/database/sqlite/SQLiteStatement;->bindLong(IJ)V
    ...
    .line 120
    iget-wide v4, p0, Lcom/adobe/mobile/ThirdPartyQueue;->numberOfUnsentHits:J

    const-wide/16 v6, 0x1

    add-long/2addr v4, v6

    iput-wide v4, p0, Lcom/adobe/mobile/ThirdPartyQueue;->numberOfUnsentHits:J
    ...
    invoke-virtual {p0, v2}, Lcom/adobe/mobile/ThirdPartyQueue;->kick(Z)V
    ...
    :try_start_3
    const-string v2, "%s - Unable to insert url (%s)"
    ...
    :try_start_5
    const-string v2, "%s - Unknown error while inserting url (%s)"
...
.method protected selectOldestHit()Lcom/adobe/mobile/AbstractHitDatabase$Hit;
    ...
    iget-object v13, p0, Lcom/adobe/mobile/ThirdPartyQueue;->dbMutex:Ljava/lang/Object;
    ...
    .line 170
    new-instance v12, Lcom/adobe/mobile/AbstractHitDatabase$Hit;

    invoke-direct {v12}, Lcom/adobe/mobile/AbstractHitDatabase$Hit;-><init>()V
    :try_end_0
    .catch Landroid/database/SQLException; {:try_start_0 .. :try_end_0} :catch_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_1
    ...
    iput-object v0, v12, Lcom/adobe/mobile/AbstractHitDatabase$Hit;->identifier:Ljava/lang/String;
    ...
    iput-object v0, v12, Lcom/adobe/mobile/AbstractHitDatabase$Hit;->urlFragment:Ljava/lang/String;
    ...
    iput-object v0, v12, Lcom/adobe/mobile/AbstractHitDatabase$Hit;->postBody:Ljava/lang/String;
    ...
    iput-object v0, v12, Lcom/adobe/mobile/AbstractHitDatabase$Hit;->postType:Ljava/lang/String;
    ...
    iput-wide v0, v12, Lcom/adobe/mobile/AbstractHitDatabase$Hit;->timestamp:J
    ...
    iput v0, v12, Lcom/adobe/mobile/AbstractHitDatabase$Hit;->timeout:I
    :try_end_1
