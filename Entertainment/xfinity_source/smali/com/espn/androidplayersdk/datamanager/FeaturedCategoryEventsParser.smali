.class Lcom/espn/androidplayersdk/datamanager/FeaturedCategoryEventsParser;
.super Lcom/espn/androidplayersdk/datamanager/JSONParserAbstract;
.source "FeaturedCategoryEventsParser.java"
...
.method constructor <init>()V
    ...
    iput-boolean v0, p0, Lcom/espn/androidplayersdk/datamanager/FeaturedCategoryEventsParser;->sendSuccessBroadcast:Z
...
.method public errorHandler(I)V
    ...
    .line 99
    :cond_0
    const-string v0, "com.espn.action.ACTION_FEATURED_CATEGORY_EVENT_DATA_ERROR"

    invoke-virtual {p0, v0}, Lcom/espn/androidplayersdk/datamanager/FeaturedCategoryEventsParser;->sendBroadcast(Ljava/lang/String;)V
...
.method getListings(Lorg/json/JSONObject;Ljava/util/HashMap;)V
    ...
    iput-boolean v3, p0, Lcom/espn/androidplayersdk/datamanager/FeaturedCategoryEventsParser;->sendSuccessBroadcast:Z
...
.method public parse(Lorg/json/JSONObject;Ljava/util/HashMap;)V
    ...
    .line 27
    const-string v9, "FeaturedCategoryEventsParser"
    ...
    .line 34
    :cond_0
    const-string v9, "featuredCatEventType"
    ...
    iput-boolean v9, p0, Lcom/espn/androidplayersdk/datamanager/FeaturedCategoryEventsParser;->sendSuccessBroadcast:Z
    ...
    .line 76
    iget-boolean v9, p0, Lcom/espn/androidplayersdk/datamanager/FeaturedCategoryEventsParser;->sendSuccessBroadcast:Z

    if-eqz v9, :cond_3

    .line 77
    const-string v9, "com.espn.action.ACTION_FEATURED_CATEGORY_EVENT_UPDATE"

    invoke-virtual {p0, v9}, Lcom/espn/androidplayersdk/datamanager/FeaturedCategoryEventsParser;->sendBroadcast(Ljava/lang/String;)V
    ...
    :try_start_2
    const-string v9, "FeaturedCategoryEventsParser: No HLS Video"
    ...
    invoke-virtual {p0, v9}, Lcom/espn/androidplayersdk/datamanager/FeaturedCategoryEventsParser;->errorHandler(I)V
    :try_end_3
    ...
    .line 59
    invoke-virtual {p0, p1, p2}, Lcom/espn/androidplayersdk/datamanager/FeaturedCategoryEventsParser;->getListings(Lorg/json/JSONObject;Ljava/util/HashMap;)V
    ...
    .line 76
    iget-boolean v10, p0, Lcom/espn/androidplayersdk/datamanager/FeaturedCategoryEventsParser;->sendSuccessBroadcast:Z

    if-eqz v10, :cond_7

    .line 77
    const-string v10, "com.espn.action.ACTION_FEATURED_CATEGORY_EVENT_UPDATE"

    invoke-virtual {p0, v10}, Lcom/espn/androidplayersdk/datamanager/FeaturedCategoryEventsParser;->sendBroadcast(Ljava/lang/String;)V
