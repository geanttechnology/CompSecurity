...
.method private openLink(Ljava/lang/String;)V
    ...
    .prologue
    .line 21
    iget-object v2, p0, Ltv/freewheel/ad/handler/ClickCallbackHandler;->adInstance:Ltv/freewheel/ad/AdInstance;

    invoke-virtual {v2}, Ltv/freewheel/ad/AdInstance;->getActivity()Landroid/app/Activity;
...
.method public send(Landroid/os/Bundle;)V
    ...
    .line 30
    iget-object v9, p0, Ltv/freewheel/ad/handler/ClickCallbackHandler;->adInstance:Ltv/freewheel/ad/AdInstance;

    if-eqz v9, :cond_0

    iget-object v9, p0, Ltv/freewheel/ad/handler/ClickCallbackHandler;->adInstance:Ltv/freewheel/ad/AdInstance;

    invoke-virtual {v9}, Ltv/freewheel/ad/AdInstance;->getActiveCreativeRendition()Ltv/freewheel/ad/CreativeRendition;
    ...
    iget-object v10, p0, Ltv/freewheel/ad/handler/ClickCallbackHandler;->adInstance:Ltv/freewheel/ad/AdInstance;

    invoke-virtual {v10}, Ltv/freewheel/ad/AdInstance;->getActiveCreativeRendition()Ltv/freewheel/ad/CreativeRendition;

    move-result-object v10

    iget v10, v10, Ltv/freewheel/ad/CreativeRendition;->creativeRenditionId:I

    invoke-static {v10}, Ljava/lang/String;->valueOf(I)Ljava/lang/String;

    move-result-object v10

    invoke-virtual {p0, v9, v10}, Ltv/freewheel/ad/handler/ClickCallbackHandler;->setParameter(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v9}, Ltv/freewheel/ad/handler/ClickCallbackHandler;->getUrlParameter(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v9}, Ltv/freewheel/ad/AdInstance;->getAdContext()Ltv/freewheel/ad/AdContext;

    move-result-object v9

    iget-object v9, v9, Ltv/freewheel/ad/AdContext;->serverUrl:Ljava/lang/String;
    ...
    invoke-virtual {v10}, Ltv/freewheel/ad/AdInstance;->getAdContext()Ltv/freewheel/ad/AdContext;

    move-result-object v10

    iget-object v10, v10, Ltv/freewheel/ad/AdContext;->serverUrl:Ljava/lang/String;
    ...
    .line 67
    :goto_2
    iget-object v9, p0, Ltv/freewheel/ad/handler/ClickCallbackHandler;->logger:Ltv/freewheel/utils/Logger;
    ...
    .line 110
    invoke-virtual {p0}, Ltv/freewheel/ad/handler/ClickCallbackHandler;->sendTrackingCallback()V
    ...
    invoke-virtual {v9, v10}, Ltv/freewheel/utils/Logger;->warn(Ljava/lang/String;)V
    ...
    .line 97
    :cond_9
    invoke-virtual {p0, v0}, Ltv/freewheel/ad/handler/ClickCallbackHandler;->sendRequest(Ljava/lang/String;)V
    ...
    .line 103
    :try_start_3
    invoke-direct {p0, v7}, Ltv/freewheel/ad/handler/ClickCallbackHandler;->openLink(Ljava/lang/String;)V
    :try_end_3
