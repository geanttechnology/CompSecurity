...
.method static constructor <clinit>()V
    ...
    sput-object v0, Ltv/freewheel/utils/renderer/RendererTimer;->CLASSTAG:Ljava/lang/String;
...
.method public constructor <init>(ILtv/freewheel/utils/renderer/RendererTimer$IRendererTimerService;)V
    .locals 3
    .param p1, "duration"    # I
    .param p2, "timeOut"    # Ltv/freewheel/utils/renderer/RendererTimer$IRendererTimerService;
    ...
    iput-object v0, p0, Ltv/freewheel/utils/renderer/RendererTimer;->state:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method static synthetic access$000(Ltv/freewheel/utils/renderer/RendererTimer;)I
    .locals 1
    .param p0, "x0"    # Ltv/freewheel/utils/renderer/RendererTimer;
...
.method static synthetic access$300(Ltv/freewheel/utils/renderer/RendererTimer;)Ljava/util/concurrent/atomic/AtomicInteger;
    .locals 1
    .param p0, "x0"    # Ltv/freewheel/utils/renderer/RendererTimer;

    .prologue
    .line 9
    iget-object v0, p0, Ltv/freewheel/utils/renderer/RendererTimer;->state:Ljava/util/concurrent/atomic/AtomicInteger;

    return-object v0
.end method

.method static synthetic access$400(Ltv/freewheel/utils/renderer/RendererTimer;)Ljava/util/Timer;
    .locals 1
    .param p0, "x0"    # Ltv/freewheel/utils/renderer/RendererTimer;
...
.method static synthetic access$402(Ltv/freewheel/utils/renderer/RendererTimer;Ljava/util/Timer;)Ljava/util/Timer;
    .locals 0
    .param p0, "x0"    # Ltv/freewheel/utils/renderer/RendererTimer;
...
.method static synthetic access$500(Ltv/freewheel/utils/renderer/RendererTimer;)Ltv/freewheel/utils/renderer/RendererTimer$IRendererTimerService;
    .locals 1
    .param p0, "x0"    # Ltv/freewheel/utils/renderer/RendererTimer;

    .prologue
    .line 9
    iget-object v0, p0, Ltv/freewheel/utils/renderer/RendererTimer;->timerService:Ltv/freewheel/utils/renderer/RendererTimer$IRendererTimerService;
...
.method public start()V
    ...
    .line 36
    new-instance v1, Ltv/freewheel/utils/renderer/RendererTimer$1;

    invoke-direct {v1, p0}, Ltv/freewheel/utils/renderer/RendererTimer$1;-><init>(Ltv/freewheel/utils/renderer/RendererTimer;)V
