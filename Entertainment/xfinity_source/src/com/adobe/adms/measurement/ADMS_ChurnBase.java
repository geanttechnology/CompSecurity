...
//            ADMS_Measurement, ADMS_MeasurementBase

abstract class ADMS_ChurnBase
{

    private static HashMap _lifecycleContextData = null;
    ...
    private HashMap GenerateLifecycleToBeSaved(Hashtable hashtable)
    {
    ...
    public static HashMap getLifecycleContextData()
    {
    ...
    protected final void startSession()
    {
        ...
        _lifecycleContextData = GenerateLifecycleToBeSaved(contextData);
