...
public final class ADMS_Measurement extends ADMS_MeasurementBase
{
    ...
    private static Integer MINIMUM_LIFECYCLE_SESSION_TIMEOUT = Integer.valueOf(1);
    ...
    private static void setStaticContext(Context context1)
    {
        ...
        if (context1 == null || setStaticContext_pred)
        {
        ...
        if (worker == null)
        {
            worker = new ADMS_Worker((new File(adms_measurement.context.getCacheDir(), "AppMeasurementOfflineCacheDatabase.sqlite")).getPath());
        }
        ...
        context1 = new File(adms_measurement.context.getCacheDir(), "ADMS_OfflineCache.offline");
        if (context1.exists())
        {
            worker.upgradeQueueToSQL(context1.getPath());
        }
    ...
    {
        sharedInstance().setContext(context1);
        return ADMS_MeasurementHolder.baseInstance;
    }
...
_L6:
    ...
    public void setContext(Context context1)
    {
        ...
        {
            setStaticContext(context1.getApplicationContext());
        } else
        if (context1 != null)
        {
...
label0:
        ...
        debugLog((new StringBuilder()).append("Increasing lifecycleSessionTimeout to ").append(MINIMUM_LIFECYCLE_SESSION_TIMEOUT).append(" to protect from false lifecycle events.").toString());
    ...
    public void startActivity(Context context1)
    {
        setContext(context1);
