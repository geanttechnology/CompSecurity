...
public class Version
{
    ...
    private static final String _buildChangeList = "1314461";
    private static final String _major = "1";
    private static final String _minor = "4.16";
    private static final String _psdkDescription = "1.4.16.1454 ( release, 1314461)";
    private static final String _psdkVersion = "1.4.16.1454";
    private static final String _revision = "1454";
