...
_L1:
    ...
    public void release()
    {
        ...
        MetadataNode metadatanode = new MetadataNode();
        metadatanode.setValue("DESCRIPTION", ((VideoEngineException) (obj)).getMessage());
        metadatanode.setValue("NATIVE_ERROR_CODE", (new StringBuilder()).append(((VideoEngineException) (obj)).getErrorCode().getValue()).append("").toString());
        metadatanode.setValue("NATIVE_ERROR_NAME", ((VideoEngineException) (obj)).getErrorCode().name());
        error.setMetadata(metadatanode);
        if (_videoEngineDispatcher != null)
        {
            _videoEngineDispatcher.dispatch(ErrorEvent.createVideoErrorEvent(error));
...
_L1:
        ...
        MetadataNode metadatanode = new MetadataNode();
        metadatanode.setValue("DESCRIPTION", videoengineexception.getMessage());
        metadatanode.setValue("NATIVE_ERROR_CODE", (new StringBuilder()).append(videoengineexception.getErrorCode().getValue()).append("").toString());
        metadatanode.setValue("NATIVE_ERROR_NAME", videoengineexception.getErrorCode().name());
        error.setMetadata(metadatanode);
        if (_videoEngineDispatcher != null)
        {
            _videoEngineDispatcher.dispatch(ErrorEvent.createVideoErrorEvent(error));
