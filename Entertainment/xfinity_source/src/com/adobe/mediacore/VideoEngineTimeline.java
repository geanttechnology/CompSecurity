...
final class VideoEngineTimeline
{
    ...
    private void endAdBreakPlacement()
    {
        ...
        Object obj2 = adbreakplacement.getAdBreak();
        Object obj1 = adbreakplacement.getPlacement();
        ...
        if (_acceptedAds.size() > 0)
        {
            ...
            long l1 = ((PlacementInformation) (obj1)).getTime();
            long l = l1;
            ...
            obj = new PlacementInformation(((PlacementInformation) (obj1)).getType(), l, ((PlacementInformation) (obj1)).getDuration());
            obj1 = AdBreak.createAdBreak(_acceptedAds, l, _acceptedReplaceDuration, ((AdBreak) (obj2)).getTag());
            ((AdBreak) (obj1)).setIsWatched(((AdBreak) (obj2)).isWatched());
        } else
        {
            obj1 = null;
        }
...
_L4:
        ...
        list = AdBreak.createAdBreak(list, l, 0L, adbreakplacement.getAdBreak().getTag());
        list.setIsWatched(adbreakplacement.getAdBreak().isWatched());
        list = new AdBreakPlacement(list, new PlacementInformation(adbreakplacement.getPlacement().getType(), l, l1));
