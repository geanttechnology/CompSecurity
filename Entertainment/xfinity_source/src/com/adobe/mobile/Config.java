...
public final class Config
{
    ...
    public static void setPushIdentifier(String s)
    {
    ...
    public static void submitAdvertisingIdentifierTask(Callable callable)
    {
        StaticMethods.getAnalyticsExecutor().execute(new Runnable(callable) {
