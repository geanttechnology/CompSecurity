...
final class Constants
{
    ...
    protected static final String ADVERTISING_IDENTIFIER_KEY = "ADOBEMOBILE_STOREDDEFAULTS_ADVERTISING_IDENTIFIER";
    ...
    protected static final String ANALYTICS_LOG_PREFIX = "Analytics";
    ...
    protected static final String DATAPATH_CONFIG_AD_ID = "/abdmobile/data/config/adId";
    ...
    protected static final String DATAPATH_CONFIG_PUSH_ENABLED = "/abdmobile/data/config/pushEnabled";
    ...
    protected static final String DATA_ADID = "a.adid";
    ...
    protected static final String DATA_MESSAGE_ID = "a.push.payloadId";
    ...
    protected static final String DEFAULTS_KEY_PUSH_ENABLED = "ADBMOBILE_KEY_PUSH_ENABLED";
    ...
    protected static final String EVENT_PUSH_STATUS = "a.push.optin";
    ...
    protected static final String HTTP_REQUEST_LOG_PREFIX = "LogPrefix";
    protected static final String HTTP_REQUEST_PATH = "/abdmobile/data/request";
    protected static final String HTTP_REQUEST_POST_TYPE = "PostType";
    protected static final String HTTP_REQUEST_TIMEOUT = "Timeout";
    ...
    protected static final String HTTP_REQUEST_TYPE_THIRD_PARTY = "ThirdParty";
    ...
    protected static final String REFERRER_CONTEXTDATA_JSON_STRING = "ADMS_Referrer_ContextData_Json_String";
