    ...
    implements Runnable
{
    ...
    // Unreferenced inner class com/adobe/mobile/MobileConfig$6

/* anonymous class */
    class MobileConfig._cls6
        implements RemoteDownload.RemoteDownloadBlock
    {
        ...
        {
            StaticMethods.getAnalyticsExecutor().execute(file1. new MobileConfig._cls6._cls1());
        }
