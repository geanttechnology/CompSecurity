    ...
    implements Runnable
{
    ...
    public void run()
    {
        if (MobileConfig.access$300(MobileConfig.this) == null || MobileConfig.access$300(MobileConfig.this).size() <= 0)
        {
            RemoteDownload.deleteFilesInDirectory("messageImages");
            return;
        }
        ArrayList arraylist = new ArrayList();
        for (Iterator iterator = MobileConfig.access$300(MobileConfig.this).iterator(); iterator.hasNext();)
        {
