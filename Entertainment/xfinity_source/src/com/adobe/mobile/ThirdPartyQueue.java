...
_L5:
    ...
    protected AbstractHitDatabase.Hit selectOldestHit()
    {
        ...
        obj4.postBody = ((Cursor) (obj)).getString(2);
        obj4.postType = ((Cursor) (obj)).getString(3);
        obj4.timestamp = ((Cursor) (obj)).getLong(4);
        obj4.timeout = ((Cursor) (obj)).getInt(5);
        obj1 = obj4;
        if (obj == null)
        {
...
_L6:
        ...
        StaticMethods.logErrorFormat("%s - Unable to read from database (%s)", new Object[] {
            logPrefix, ((SQLException) (obj4)).getMessage()
        });
        obj1 = obj3;
...
_L5:
        ...
        StaticMethods.logErrorFormat("%s - Unknown error reading from database (%s)", new Object[] {
            logPrefix, ((Exception) (obj4)).getMessage()
        });
        obj1 = obj2;
