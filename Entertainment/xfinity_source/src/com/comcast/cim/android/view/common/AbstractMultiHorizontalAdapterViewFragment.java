...
public abstract class AbstractMultiHorizontalAdapterViewFragment extends AbstractMultiViewFragment
{

    public AbstractMultiHorizontalAdapterViewFragment()
    {
    }

    protected abstract it.sephiroth.android.library.widget.AdapterView.OnItemClickListener getOnItemClickListener();

    protected abstract it.sephiroth.android.library.widget.AdapterView.OnItemLongClickListener getOnItemLongClickListener();
