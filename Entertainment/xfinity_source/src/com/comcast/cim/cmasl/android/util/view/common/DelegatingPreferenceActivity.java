...
public class DelegatingPreferenceActivity extends PreferenceActivity
{

    private static final Logger LOG = LoggerFactory.getLogger(com/comcast/cim/cmasl/android/util/view/common/DelegatingPreferenceActivity);
    private List delegateList;

    public DelegatingPreferenceActivity()
    {
