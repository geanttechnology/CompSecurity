...
public class DelegatingPreferenceFragment extends PreferenceFragment
{

    private static final Logger LOG = LoggerFactory.getLogger(com/comcast/cim/cmasl/android/util/view/common/DelegatingPreferenceFragment);
    private List delegateList;

    public DelegatingPreferenceFragment()
    {
