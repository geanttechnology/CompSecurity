    ...
    implements Runnable
{
    ...
    public void run()
    {
        ...
        for (Iterator iterator = DownloadServiceManager.access$1200(DownloadServiceManager.this).iterator(); iterator.hasNext(); ((DownloadServiceListener)iterator.next()).onDownloadServiceConnected()) { }
