...
public interface RouteInfo
{
    public static final class LayerType extends Enum
    {
        ...
        {
            return (LayerType)Enum.valueOf(com/comcast/cim/httpcomponentsandroid/conn/routing/RouteInfo$LayerType, s);
        }
    ...
    public static final class TunnelType extends Enum
    {
        ...
        {
            return (TunnelType)Enum.valueOf(com/comcast/cim/httpcomponentsandroid/conn/routing/RouteInfo$TunnelType, s);
        }
