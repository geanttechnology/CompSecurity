...
import com.comcast.cim.httpcomponentsandroid.conn.util.InetAddressUtils;
    ...
    implements X509HostnameVerifier
{
    ...
    private static String[] getSubjectAlts(X509Certificate x509certificate, String s)
    {
        ...
        {
            Logger.getLogger(com/comcast/cim/httpcomponentsandroid/conn/ssl/AbstractVerifier.getName()).log(Level.FINE, "Error parsing certificate.", x509certificate);
            x509certificate = s;
        }
