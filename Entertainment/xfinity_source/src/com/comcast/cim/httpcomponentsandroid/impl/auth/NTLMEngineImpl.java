...
_L2:
    ...
    private static byte[] createBlob(byte abyte0[], byte abyte1[])
    {
        ...
        byte abyte6[] = new byte[abyte2.length + abyte3.length + abyte5.length + 8 + abyte4.length + abyte1.length];
        System.arraycopy(abyte2, 0, abyte6, 0, abyte2.length);
        int j = 0 + abyte2.length;
        System.arraycopy(abyte3, 0, abyte6, j, abyte3.length);
        j += abyte3.length;
        System.arraycopy(abyte5, 0, abyte6, j, abyte5.length);
        j += abyte5.length;
        System.arraycopy(abyte0, 0, abyte6, j, 8);
        j += 8;
        System.arraycopy(abyte4, 0, abyte6, j, abyte4.length);
        System.arraycopy(abyte1, 0, abyte6, j + abyte4.length, abyte1.length);
        return abyte6;
    }
        ...
        throws NTLMEngineException
    {
        ...
        try
        {
            s = s.toUpperCase().getBytes("US-ASCII");
        ...
        throws NTLMEngineException
    {
        try
        {
            ...
            s2.update(s1.toUpperCase().getBytes("UnicodeLittleUnmarked"));
