...
import com.comcast.cim.httpcomponentsandroid.auth.NTCredentials;
...
public class NTLMScheme extends AuthSchemeBase
{
    static final class State extends Enum
    {
        ...
        {
            return (State)Enum.valueOf(com/comcast/cim/httpcomponentsandroid/impl/auth/NTLMScheme$State, s);
        }
