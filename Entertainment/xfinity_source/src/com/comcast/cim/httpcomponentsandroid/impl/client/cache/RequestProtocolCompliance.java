...
import com.comcast.cim.httpcomponentsandroid.entity.AbstractHttpEntity;
...
_L4:
    ...
    public HttpResponse getErrorForRequest(RequestProtocolError requestprotocolerror)
    {
        ...
        switch (_cls1..SwitchMap.com.comcast.cim.httpcomponentsandroid.impl.client.cache.RequestProtocolError[requestprotocolerror.ordinal()])
        {
        default:
