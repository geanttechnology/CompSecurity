...
//            LineParser, BasicRequestLine, BasicStatusLine, ParserCursor, 
//            BufferedHeader
...
_L8:
        ...
        throws ParseException
    {
        ...
        if (j1 + i1 + 4 > k)
        {
            throw new ParseException("Not a valid protocol version: " + chararraybuffer.substring(l, k));
        }
        boolean flag = true;
        int j = 0;
        while (flag && j < i1) 
        ...
        if (i == -1)
        {
            throw new ParseException("Invalid protocol version number: " + chararraybuffer.substring(l, k));
        }
        try
        {
        ...
        {
            throw new ParseException("Invalid protocol major version number: " + chararraybuffer.substring(l, k));
        }
        j1 = i + 1;
        ...
        {
            throw new ParseException("Invalid protocol minor version number: " + chararraybuffer.substring(l, k));
        }
        ...
        throws ParseException
    {
        ...
        {
            throw new ParseException("Invalid request line: " + chararraybuffer.substring(i, j));
        }
        if (l >= 0)
        {
        ...
        throws ParseException
    {
        ...
        {
            throw new ParseException("Invalid status line: " + chararraybuffer.substring(l, k));
        }
        i = j;
        if (j < 0)
        {
...
_L2:
        ...
        {
            throw new ParseException("Status line contains invalid status code: " + chararraybuffer.substring(l, k));
        }
        j++;
