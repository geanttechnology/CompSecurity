...
public class ScrubMessageEnded extends AbstractXMessageBuilder
{
    ...
    public ScrubMessageEnded(long l, long l1, AbstractXuaAsset abstractxuaasset)
    {
        evtTimestamp = l;
        currentPosition = l1;
    ...
    {
        XuaEvent xuaevent = new XuaEvent(evtTimestamp, XuaEventType.xuaScrubEnded.name(), getMessage().getValue());
