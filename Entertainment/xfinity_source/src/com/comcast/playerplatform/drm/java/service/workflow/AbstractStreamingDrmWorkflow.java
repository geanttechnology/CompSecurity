...
public abstract class AbstractStreamingDrmWorkflow extends AbstractDRMWorkflow
{

    public AbstractStreamingDrmWorkflow(ClientStateInterface clientstateinterface, AuthenticationDelegate authenticationdelegate, Context context, HttpClient httpclient, MoneyTrace moneytrace)
    {
...
_L2:
        ...
        abstractdrmlicenseeventlistener.drmComplete(manifestUri, drmlicense.getLicenseStartDate(), drmlicense.getLicenseEndDate());
        if (true) goto _L2; else goto _L1
_L1:
        drmlicense;
        vector;
