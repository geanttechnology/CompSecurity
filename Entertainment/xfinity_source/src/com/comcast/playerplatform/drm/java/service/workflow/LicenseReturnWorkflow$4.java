    ...
    implements Runnable
{
    ...
    public void run()
    {
        drmManager.setAuthenticationToken(drmMetadata, drmMetadata.getPolicies()[0].getAuthenticationDomain(), val$drmKey.getBytes(), drmOperationErrorCallback, returnLicenseBlock);
...
_L1:
    ...
    ()
    {
        this$0 = final_licensereturnworkflow;
