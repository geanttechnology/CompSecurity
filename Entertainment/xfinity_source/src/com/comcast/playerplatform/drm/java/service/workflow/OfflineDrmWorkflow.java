...
public class OfflineDrmWorkflow extends AbstractOfflineDrmWorkflow
{
    ...
    public OfflineDrmWorkflow(ClientStateInterface clientstateinterface, AuthenticationDelegate authenticationdelegate, HttpClient httpclient, Context context, MoneyTrace moneytrace)
    {
    ...
    public void validate()
    {
        ...
        if (obj != null && ((SecurityToken) (obj)).isValid() || requestLicenseAnonymously.booleanValue())
        {
            ...
            acquireVoucher(DrmUtil.generateDrmKeyString(requestLicenseAnonymously, ((String) (obj)), messageId, true, true));
            return;
        }
