...
class val.manifestString
    implements Runnable
{

    final val.manifestString this$0;
    final String val$manifestString;

    public void run()
    {
        responseEventListener.responseReceived(val$manifestString);
    }

    l.manifestUri()
    {
        this$0 = final_manifesturi;
        val$manifestString = String.this;
        super();
    }
...
/* anonymous class */
        ...
        implements Runnable
    {
        ...
        public void run()
        {
            ...
            s = MetadataUtil.access$000(URI.create("file:/").resolve(uri));
_L1:
            ThreadManager.getInstance().executeOnUIThread(s. new MetadataUtil._cls1._cls1());
            return;
            try
            {
                s = MetadataUtil.access$000(uri);
            }
        ...
        // Unreferenced inner class com/comcast/playerplatform/drm/java/util/MetadataUtil$1$2

/* anonymous class */
        class MetadataUtil._cls1._cls2
            implements Runnable
        {
