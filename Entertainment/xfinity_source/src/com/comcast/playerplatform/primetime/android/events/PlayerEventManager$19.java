    ...
    implements Runnable
{
    ...
    public void run()
    {
        ...
        for (Iterator iterator = listeners.iterator(); iterator.hasNext(); ((AbstractPlayerPlatformVideoEventListener)iterator.next()).drmMetaDataAvailable(val$drmManager, val$drmMetadata)) { }
    ...
    VideoEventListener()
    {
        ...
        val$drmManager = drmmanager;
        val$drmMetadata = DRMMetadata.this;
        super();
    }
}
