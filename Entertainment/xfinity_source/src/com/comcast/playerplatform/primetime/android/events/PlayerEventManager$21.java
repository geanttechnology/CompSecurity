    ...
    implements Runnable
{
    ...
    public void run()
    {
        ...
        for (Iterator iterator = listeners.iterator(); iterator.hasNext(); ((AbstractPlayerPlatformVideoEventListener)iterator.next()).offlineDRMFailure(val$code, val$description)) { }
