    ...
    implements Runnable
{
    ...
    public void run()
    {
        ...
        for (Iterator iterator = listeners.iterator(); iterator.hasNext(); ((AbstractPlayerPlatformVideoEventListener)iterator.next()).adProgress(val$adBreak, val$ad, val$progress, val$timeRemaining)) { }
    ...
    VideoEventListener()
    {
        ...
        val$adBreak = videoadbreak;
        val$ad = videoad;
        val$progress = i;
        val$timeRemaining = J.this;
        super();
    }
}
