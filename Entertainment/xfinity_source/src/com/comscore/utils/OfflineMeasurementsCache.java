...
label0:
    ...
    public static String[] copyOfRange(String as[], int i1, int j1)
    {
        if (i1 > j1)
        {
...
_L2:
        ...
        {
            a(i1);
            return copyOfRange(as, i1, as.length);
        }
...
_L7:
        ...
        obj = s;
_L2:
        if (j == null || j.length() <= 0) goto _L6; else goto _L5
_L5:
        flag = a(j, a());
        if (!flag)
        {
...
_L8:
    ...
    public void saveEvent(String s)
    {
        this;
        JVM INSTR monitorenter ;
        if (a.getOfflineTransmissionMode() == TransmissionMode.DISABLED || a.getCustomerC2() == null || !Utils.isNotEmpty(XMLBuilder.getLabelFromEvent(s, "ns_ts"))) goto _L2; else goto _L1
_L1:
        String s1 = h();
        if (s1 == null)
        {
        ...
        if (c(s1) >= getCacheMaxBatchFiles()) goto _L4; else goto _L3
_L3:
