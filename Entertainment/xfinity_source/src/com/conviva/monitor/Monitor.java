    ...
    implements IMonitorNotifier
{
    ...
    private void InferPlayingState(double d)
    {
        if (_streamer != null)
        {
            ...
            if (com/conviva/streamerProxies/NativeStreamerProxy.isInstance(_streamer) && _lastPHTSpeeds != null && _lastPHTSpeeds.size() >= 3)
            {
        ...
        throws Exception
    {
        ...
        try
        {
            if (Class.forName("android.media.MediaPlayer").isAssignableFrom(class1))
            {
                obj1 = Class.forName("com.conviva.streamerProxies.MediaPlayerProxy");
            }
        }
        ...
        try
        {
            if (Class.forName("android.widget.VideoView").isAssignableFrom(class1))
            {
                obj2 = Class.forName("com.conviva.streamerProxies.VideoViewProxy");
            }
        }
        ...
        try
        {
            if (Class.forName("com.nexstreaming.nexplayerengine.NexPlayer").isAssignableFrom(class1))
            {
                obj1 = Class.forName("com.conviva.streamerProxies.NexStreamingProxy");
            }
        }
        // Misplaced declaration of an exception variable
        catch (Object obj1)
        ...
        try
        {
            if (Class.forName("com.visualon.OSMPBasePlayer.voOSBasePlayer").isAssignableFrom(class1))
            {
                obj2 = Class.forName("com.conviva.streamerProxies.VisualOnProxy");
            }
        }
        // Misplaced declaration of an exception variable
        catch (Object obj2)
        ...
        try
        {
            if (Class.forName("com.visualon.OSMPPlayer.VOCommonPlayer").isAssignableFrom(class1))
            {
                obj1 = Class.forName("com.conviva.streamerProxies.VisualOnImplProxy");
            }
        }
        // Misplaced declaration of an exception variable
        catch (Object obj1)
        ...
        if (obj1 != null)
        {
            return (ConvivaStreamerProxy)((Class) (obj1)).getConstructor(new Class[] {
                java/lang/Object
    ...
    public void adEnd()
    {
        ...
        _adStartTimeMs = 0.0D;
        enqueueStateChange("pj", boolean1, new Boolean(false));
    }
        ...
        throws Exception
    {
        ...
        _streamer.startMonitoring(this);
        _lastPollTimeMs = 0.0D;
    ...
    public void pauseMonitor()
    {
        ...
        if (_streamer != null)
        {
            _streamer.startMonitoring(null);
    ...
    public void updateHeartbeat(Map map)
    {
        ...
        if (boolean1.booleanValue())
        {
            i = ((Integer)_cumulativeTimePerState.get(Integer.valueOf(6))).intValue();
        } else
        {
            i = 0;
        }
        ...
        {
            j = (int)((_playingFpsTotal + 0.0D) / (double)_playingFpsObservationCount);
        } else
        {
            j = -1;
        }
        if (j >= 0)
        {
            map.put("afps", Integer.valueOf(j));
        }
        map.put("tpt", Integer.valueOf(k));
        map.put("tbt", Integer.valueOf(i));
        ...
        if (boolean1.booleanValue() && _nominalPlayingBitsTotal >= 0.0D)
        {
            i = (int)((_nominalPlayingBitsTotal + 0.0D) / (double)k);
        } else
        {
            i = -1;
        }
