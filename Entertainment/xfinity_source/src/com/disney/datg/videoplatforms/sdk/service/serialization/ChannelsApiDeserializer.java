...
public class ChannelsApiDeserializer extends CacheableApiDeserializer
{

    protected static int CACHE_CAPACITY = 100;
    protected static String CACHE_CONTAINER = "Channels";

    public ChannelsApiDeserializer()
    {
        super(null, CACHE_CONTAINER, CACHE_CAPACITY, com/disney/datg/videoplatforms/sdk/models/api/Channels);
    }
