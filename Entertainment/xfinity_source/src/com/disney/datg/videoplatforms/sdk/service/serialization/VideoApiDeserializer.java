...
public class VideoApiDeserializer extends CacheableApiDeserializer
{

    protected static int CACHE_CAPACITY = 100;
    protected static String CACHE_CONTAINER = "Videos";

    public VideoApiDeserializer()
    {
        super(null, CACHE_CONTAINER, CACHE_CAPACITY, com/disney/datg/videoplatforms/sdk/models/api/Videos);
    }
