...
//            DeviceData, FeedsServerCom, FeedsCommListener, EPSDKPrefs

class feedsServerCom extends AsyncTask
{
...
_L1:
    ...
    public _cls1.this._cls1()
    {
        ...
        url = "";
        msg = "";
        DeviceDataListener = new FeedsCommListener() {

            final DeviceData.DeviceDataTask this$1;
            ...
            {
                this$1 = DeviceData.DeviceDataTask.this;
                super();
            }
        };
