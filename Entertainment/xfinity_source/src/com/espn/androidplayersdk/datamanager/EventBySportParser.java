...
class EventBySportParser extends JSONParserAbstract
{
    ...
    public void errorHandler(int i)
    {
        if (i == 1 || i == 2)
        {
            ...
            {
                sendBroadcast("com.espn.action.EVENTSBYSPORT_LIVE_DATA_ERROR");
            } else
            {
                if (contentType.equals(EPEventType.UPCOMING.getEventStr()))
                {
                    sendBroadcast("com.espn.action.EVENTSBYSPORT_UPCOMING_DATA_ERROR");
                    return;
                }
                if (contentType.equals(EPEventType.REPLAY.getEventStr()))
                {
                    sendBroadcast("com.espn.action.EVENTSBYSPORT_REPLAY_DATA_ERROR");
                    return;
                }
            }
        }
    ...
    {
        Utils.sdkLog("EventBySportParser:", 3, null);
...
_L15:
        ...
        contentvalues.put("eventRelationId", "4");
        DataManager.feedsDbConn.insertOrUpdateMetaEventsTable(contentvalues);
_L2:
        if (!sendSuccessBroadcast) goto _L9; else goto _L8
_L8:
        if (!contentType.equals(EPEventType.LIVE.getEventStr())) goto _L11; else goto _L10
_L10:
        sendBroadcast("com.espn.action.EVENTSBYSPORT_LIVE_UPDATED");
_L17:
        return;
_L4:
        ...
        {
            Object obj1 = jsonobject1.getJSONArray("broadcasts");
            if (((JSONArray) (obj1)).length() > 0)
            {
                ...
                {
                    contentvalues1.put("networkCode", ((JSONObject) (obj1)).getString("abbreviation"));
                }
                if (((JSONObject) (obj1)).has("name") && !((JSONObject) (obj1)).isNull("name"))
                {
                    contentvalues1.put("networkName", ((JSONObject) (obj1)).getString("name"));
                }
                if (((JSONObject) (obj1)).has("ncsId") && !((JSONObject) (obj1)).isNull("ncsId"))
                {
                    contentvalues1.put("networkId", ((JSONObject) (obj1)).getString("ncsId"));
                    contentvalues.put("networkId", ((JSONObject) (obj1)).getString("ncsId"));
                }
                if (((JSONObject) (obj1)).has("adobeResource") && !((JSONObject) (obj1)).isNull("adobeResource"))
                {
                    contentvalues1.put("networkResourceId", ((JSONObject) (obj1)).getString("adobeResource"));
                }
            }
        }
        ...
        contentvalues1.put("metaEventRelationId", "4");
        if (hashmap == null)
        {
...
_L13:
        ...
        exception1;
        Utils.sdkLog("EventBySportParser - Error:  ", 5, exception1);
        sendSuccessBroadcast = false;
        sendPartialErrorBroadcast = true;
        if (true) goto _L13; else goto _L12
_L12:
        jsonobject;
        Utils.sdkLog("EventBySportParser - Error:  ", 5, jsonobject);
        sendSuccessBroadcast = false;
        sendPartialErrorBroadcast = false;
        errorHandler(2);
        ...
        if (contentType.equals(EPEventType.UPCOMING.getEventStr()))
        {
            sendBroadcast("com.espn.action.EVENTSBYSPORT_UPCOMING_UPDATED");
            return;
        }
        continue; /* Loop/switch isn't completed */
        exception;
        Utils.sdkLog("EventBySportParser - Error:  ", 5, exception);
        ...
        if (sendSuccessBroadcast)
        {
            ...
            if (contentType.equals(EPEventType.REPLAY.getEventStr()))
            {
                sendBroadcast("com.espn.action.EVENTSBYSPORT_REPLAY_UPDATED");
            }
        } else
        if (sendPartialErrorBroadcast)
        {
            if (contentType.equals(EPEventType.LIVE.getEventStr()))
            {
                sendBroadcast("com.espn.action.EVENTSBYSPORT_LIVE_PARTIAL_DATA_ERROR");
            } else
            if (contentType.equals(EPEventType.UPCOMING.getEventStr()))
            {
                sendBroadcast("com.espn.action.EVENTSBYSPORT_UPCOMING_PARTIAL_DATA_ERROR");
            } else
            if (contentType.equals(EPEventType.REPLAY.getEventStr()))
            {
                sendBroadcast("com.espn.action.EVENTSBYSPORT_REPLAY_PARTIAL_DATA_ERROR");
            }
        }
        throw jsonobject;
_L6:
        contentvalues.put("eventsType", "");
          goto _L15
        if (!contentType.equals(EPEventType.REPLAY.getEventStr())) goto _L17; else goto _L16
_L16:
        sendBroadcast("com.espn.action.EVENTSBYSPORT_REPLAY_UPDATED");
        return;
        if (!sendPartialErrorBroadcast) goto _L17; else goto _L18
_L18:
        if (contentType.equals(EPEventType.LIVE.getEventStr()))
        {
            sendBroadcast("com.espn.action.EVENTSBYSPORT_LIVE_PARTIAL_DATA_ERROR");
...
_L11:
        ...
        if (!contentType.equals(EPEventType.REPLAY.getEventStr())) goto _L17; else goto _L19
_L19:
        sendBroadcast("com.espn.action.EVENTSBYSPORT_REPLAY_UPDATED");
        return;
_L9:
        if (!sendPartialErrorBroadcast) goto _L17; else goto _L20
_L20:
        if (contentType.equals(EPEventType.LIVE.getEventStr()))
        {
            sendBroadcast("com.espn.action.EVENTSBYSPORT_LIVE_PARTIAL_DATA_ERROR");
        ...
        if (!contentType.equals(EPEventType.REPLAY.getEventStr())) goto _L17; else goto _L21
_L21:
        sendBroadcast("com.espn.action.EVENTSBYSPORT_REPLAY_PARTIAL_DATA_ERROR");
        return;
