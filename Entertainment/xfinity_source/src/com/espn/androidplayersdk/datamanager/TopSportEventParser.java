...
class TopSportEventParser extends JSONParserAbstract
{
    ...
    public void errorHandler(int i)
    {
        if (i == 1 || i == 2)
        {
            sendBroadcast("com.espn.action.ACTION_TOP_SPORT_EVENT_DATA_ERROR");
        }
    }
...
_L5:
    ...
    {
        Utils.sdkLog("TopSportEventParser", 3, null);
        ...
        if ((EPFeaturedEventType)hashmap.get("featuredTopSportEventType") != EPFeaturedEventType.VOD) goto _L2; else goto _L1
_L1:
        Object obj1 = "VOD";
        Object obj2;
        int j;
...
_L4:
        ...
        {
            sendBroadcast("com.espn.action.ACTION_TOP_SPORT_EVENT_UPDATE");
        }
_L9:
        return;
_L17:
...
_L7:
        ...
        obj;
        Utils.sdkLog("TopSportEventParser: No HLS Video", 3, ((Exception) (obj)));
        if (true) goto _L7; else goto _L6
_L6:
        jsonobject;
        Utils.sdkLog("TopSportEventParser", 5, jsonobject);
        sendSuccessBroadcast = false;
        errorHandler(2);
...
_L10:
        obj2 = jsonobject.getJSONArray("categories");
        j = ((JSONArray) (obj2)).length();
        obj = obj1;
        if (j <= 0)
        {
...
_L12:
        ...
        getListings(((JSONArray) (obj2)).getJSONObject(i), hashmap);
        i++;
        if (true) goto _L12; else goto _L11
_L11:
        if (!jsonobject.has("subcategories") || jsonobject.isNull("subcategories")) goto _L14; else goto _L13
_L13:
        obj2 = jsonobject.getJSONArray("subcategories");
        j = ((JSONArray) (obj2)).length();
        obj = obj1;
        if (j <= 0)
        {
