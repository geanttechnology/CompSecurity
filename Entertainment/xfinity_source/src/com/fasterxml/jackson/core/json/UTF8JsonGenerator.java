...
public class UTF8JsonGenerator extends JsonGeneratorImpl
{
    ...
    private void _writeBytes(byte abyte0[])
        throws IOException
    {
        int i = abyte0.length;
    ...
    private void _writeBytes(byte abyte0[], int i, int j)
        throws IOException
    {
    ...
    private void _writeSegmentedRaw(char ac[], int i, int j)
        throws IOException, JsonGenerationException
    {
        int l = _outputEnd;
        byte abyte0[] = _outputBuffer;
label0:
    ...
    private void _writeStringSegment(char ac[], int i, int j)
        throws IOException, JsonGenerationException
    {
        int l = j + i;
        int k = _outputTail;
...
label1:
    ...
    private void _writeStringSegment2(char ac[], int i, int j)
        throws IOException, JsonGenerationException
    {
        if (_outputTail + (j - i) * 6 > _outputEnd)
        {
    ...
    private void _writeStringSegmentASCII2(char ac[], int i, int j)
        throws IOException, JsonGenerationException
    {
        if (_outputTail + (j - i) * 6 > _outputEnd)
        {
    ...
    private void _writeStringSegments(String s)
        throws IOException, JsonGenerationException
    {
        int i = s.length();
        int j = 0;
    ...
    private void _writeStringSegments(char ac[], int i, int j)
        throws IOException, JsonGenerationException
    {
        int k;
        do
