...
_L3:
    ...
    protected ObjectMapper(ObjectMapper objectmapper)
    {
        ...
        _serializationConfig = new SerializationConfig(objectmapper._serializationConfig, _mixInAnnotations);
        _deserializationConfig = new DeserializationConfig(objectmapper._deserializationConfig, _mixInAnnotations);
...
label0:
        ...
        throws JsonMappingException
    {
        ...
        {
            DefaultSerializerProvider defaultserializerprovider = _serializerProvider(getSerializationConfig());
            jsonformatvisitorwrapper.setProvider(defaultserializerprovider);
