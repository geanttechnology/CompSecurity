    ...
    implements VisibilityChecker, Serializable
{
    ...
    public <init> with(JsonAutoDetect jsonautodetect)
    {
        ...
        {
            <init>2 = <init>1.withGetterVisibility(jsonautodetect.getterVisibility()).withIsGetterVisibility(jsonautodetect.isGetterVisibility()).withSetterVisibility(jsonautodetect.setterVisibility()).withCreatorVisibility(jsonautodetect.creatorVisibility()).withFieldVisibility(jsonautodetect.fieldVisibility());
        }
        return <init>2;
    }
