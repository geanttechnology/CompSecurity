...
public class UnwrappingBeanPropertyWriter extends BeanPropertyWriter
{
        ...
        throws JsonMappingException
    {
        ...
        serializerprovider = nametransformer;
        if (propertyserializermap.isUnwrappingSerializer())
        {
            serializerprovider = NameTransformer.chainedTransformer(nametransformer, ((UnwrappingBeanSerializer)propertyserializermap)._nameTransformer);
        }
    ...
    public void assignSerializer(JsonSerializer jsonserializer)
    {
        ...
        if (_serializer != null)
        {
            ...
            jsonserializer = nametransformer;
            if (_serializer.isUnwrappingSerializer())
            {
                jsonserializer = NameTransformer.chainedTransformer(nametransformer, ((UnwrappingBeanSerializer)_serializer)._nameTransformer);
            }
