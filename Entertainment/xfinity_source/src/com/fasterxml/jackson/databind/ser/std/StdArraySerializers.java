...
public class StdArraySerializers
{
    public static final class BooleanArraySerializer extends ArraySerializerBase
    {
        ...
        {
            jsonformatvisitorwrapper.expectArrayFormat(javatype).itemsFormat(JsonFormatTypes.BOOLEAN);
        }
    ...
    public static final class ByteArraySerializer extends StdSerializer
    {
        ...
        public void acceptJsonFormatVisitor(JsonFormatVisitorWrapper jsonformatvisitorwrapper, JavaType javatype)
        {
            jsonformatvisitorwrapper.expectArrayFormat(javatype).itemsFormat(JsonFormatTypes.STRING);
        }
