...
//            CacheBuilder, RemovalNotification, RemovalListener, CacheLoader, 
    ...
    implements ConcurrentMap
{
        ...
        implements Serializable
    {
        ...
        CacheBuilder recreateCacheBuilder()
        {
            ...
            cachebuilder = CacheBuilder.newBuilder().setKeyStrength(keyStrength).setValueStrength(valueStrength).keyEquivalence(keyEquivalence).valueEquivalence(valueEquivalence).concurrencyLevel(concurrencyLevel);
...
_L6:
        ...
        ReferenceEntry copyEntry(ReferenceEntry referenceentry, ReferenceEntry referenceentry1)
        {
            ...
            referenceentry.setValueReference(valuereference.copyFor(valueReferenceQueue, referenceentry));
            return referenceentry;
        }
...
_L5:
            k = i;
            if (referenceentry1 == referenceentry2) goto _L4; else goto _L3
_L3:
            if (isCollected(referenceentry1))
            {
                removeCollectedEntry(referenceentry1);
                i--;
            } else
            {
                int l = referenceentry1.getHash() & l1;
                atomicreferencearray1.set(l, copyEntry(referenceentry1, (ReferenceEntry)atomicreferencearray1.get(l)));
            }
...
_L1:
            ...
            flag = ((ValueReference) (obj)).isLoading();
            if (flag)
            {
                unlock();
                postWriteCleanup();
        ...
        boolean isCollected(ReferenceEntry referenceentry)
        {
            if (referenceentry.getKey() != null)
            {
                if ((referenceentry = referenceentry.getValueReference()).get() != null || !referenceentry.isActive())
                {
                    return false;
                }
            }
...
_L1:
        ...
        Object scheduleRefresh(ReferenceEntry referenceentry, Object obj, int i, Object obj1, long l, CacheLoader cacheloader)
        {
            ...
            {
                referenceentry = ((ReferenceEntry) (refresh(obj, i, cacheloader)));
                if (referenceentry != null)
                {
                    return referenceentry;
                }
        ...
        boolean storeLoadedValue(Object obj, int i, LoadingValueReference loadingvaluereference, Object obj1)
        {
            ...
            k = count + 1;
            obj4 = table;
            j = i & ((AtomicReferenceArray) (obj4)).length() - 1;
            obj3 = (ReferenceEntry)((AtomicReferenceArray) (obj4)).get(j);
            Object obj2 = obj3;
_L4:
            if (obj2 == null)
            {
            ...
            obj3 = ((ReferenceEntry) (obj2)).getValueReference();
            obj4 = ((ValueReference) (obj3)).get();
            if (obj4 != null && loadingvaluereference != obj3)
            {
...
_L2:
            ...
            ((AtomicReferenceArray) (obj4)).set(j, loadingvaluereference);
            count = k;
            evictEntries();
            unlock();
            postWriteCleanup();
    ...
    LocalCache(CacheBuilder cachebuilder, CacheLoader cacheloader)
    {
        ...
        i1 = 0;
        for (j = 1; j < concurrencyLevel && (!evictsBySize() || customWeigher() || (long)(j * 2) <= maxWeight); j <<= 1)
        {
            i1++;
        }
