...
public static class createDatabase
{
    private static class InternalDatabaseHelper extends SQLiteOpenHelper
    {
        ...
        {
            com.penthera.virtuososdk.utility.CommonUtil.Log.d(VSdkDb.access$0(), "Creating fragment table");
        ...
        {
            com.penthera.virtuososdk.utility.CommonUtil.Log.d(VSdkDb.access$0(), "Creating Provider table");
        ...
        {
            com.penthera.virtuososdk.utility.CommonUtil.Log.d(VSdkDb.access$0(), "Creating file table");
        ...
        {
            com.penthera.virtuososdk.utility.CommonUtil.Log.d(VSdkDb.access$0(), (new StringBuilder("Upgrading database from version ")).append(i).append(" to ").append(j).toString());
