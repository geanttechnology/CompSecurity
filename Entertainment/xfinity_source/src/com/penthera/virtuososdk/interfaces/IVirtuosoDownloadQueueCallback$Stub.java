...
_L1:
    ...
    public static IVirtuosoDownloadQueueCallback asInterface(IBinder ibinder)
    {
        ...
        android.os.IInterface iinterface = ibinder.queryLocalInterface("com.penthera.virtuososdk.interfaces.IVirtuosoDownloadQueueCallback");
        ...
        throws RemoteException
    {
        ...
        case 6: // '\006'
            ...
            if (parcel.readInt() != 0)
            {
                parcel = (IVirtuosoIdentifier)IVirtuosoIdentifier.CREATOR.CREATOR(parcel);
            } else
            {
                parcel = null;
            }
        ...
        case 11: // '\013'
            ...
            if (parcel.readInt() != 0)
            {
                ivirtuosoidentifier = (IVirtuosoIdentifier)IVirtuosoIdentifier.CREATOR.CREATOR(parcel);
            } else
            {
