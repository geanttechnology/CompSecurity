...
public interface IVirtuosoEngineCallback
    extends IInterface
{
        ...
        implements IVirtuosoEngineCallback
    {
        ...
        public static IVirtuosoEngineCallback asInterface(IBinder ibinder)
        {
            ...
            IInterface iinterface = ibinder.queryLocalInterface("com.penthera.virtuososdk.interfaces.IVirtuosoEngineCallback");
            ...
            throws RemoteException
        {
            ...
            case 1: // '\001'
                ...
                if (parcel.readInt() != 0)
                {
                    parcel = (IVirtuosoDownloadEngineStatus)IVirtuosoDownloadEngineStatus.CREATOR.createFromParcel(parcel);
                } else
                {
                    parcel = null;
                }
...
_L1:
    ...
    public abstract void collectionsChanged(IVirtuosoIdentifier aivirtuosoidentifier[])
        throws RemoteException;

    public abstract void collectionsDeleted(String as[])
        throws RemoteException;

    public abstract void downloadEngineStatusDidChange(IVirtuosoDownloadEngineStatus ivirtuosodownloadenginestatus)
        throws RemoteException;

    public abstract void engineContentInList(IVirtuosoIdentifier ivirtuosoidentifier, int i, int j)
        throws RemoteException;

    public abstract void engineListChanged()
        throws RemoteException;

    public abstract void itemUpdated(IVirtuosoIdentifier ivirtuosoidentifier)
        throws RemoteException;
