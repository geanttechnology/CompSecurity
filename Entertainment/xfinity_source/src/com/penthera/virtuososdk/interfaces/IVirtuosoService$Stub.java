...
_L1:
    ...
    public static IVirtuosoService asInterface(IBinder ibinder)
    {
        ...
        android.os.IInterface iinterface = ibinder.queryLocalInterface("com.penthera.virtuososdk.interfaces.IVirtuosoService");
        ...
        throws RemoteException
    {
        ...
        case 3: // '\003'
            ...
            if (parcel.readInt() != 0)
            {
                ivirtuosoidentifier = (IVirtuosoIdentifier)IVirtuosoIdentifier.CREATOR.ateFromParcel(parcel);
            } else
            {
        ...
        case 4: // '\004'
            ...
            if (parcel.readInt() != 0)
            {
                ivirtuosoidentifier1 = (IVirtuosoIdentifier)IVirtuosoIdentifier.CREATOR.ateFromParcel(parcel);
            } else
            {
        ...
        case 6: // '\006'
            ...
            if (parcel.readInt() != 0)
            {
                bundle = (Bundle)Bundle.CREATOR.ateFromParcel(parcel);
            } else
            {
                bundle = null;
            }
        ...
        case 8: // '\b'
            ...
            if (parcel.readInt() != 0)
            {
                bundle1 = (Bundle)Bundle.CREATOR.ateFromParcel(parcel);
            } else
            {
                bundle1 = null;
            }
        ...
        case 10: // '\n'
            ...
            if (parcel.readInt() != 0)
            {
                parcel = (IVirtuosoIdentifier)IVirtuosoIdentifier.CREATOR.ateFromParcel(parcel);
            } else
            {
                parcel = null;
            }
        ...
        case 13: // '\r'
            parcel.enforceInterface("com.penthera.virtuososdk.interfaces.IVirtuosoService");
            registerDownloadCallbackHandler(lback.Stub.asInterface(parcel.readStrongBinder()), parcel.readString());
            parcel1.writeNoException();
            return true;

        case 14: // '\016'
            parcel.enforceInterface("com.penthera.virtuososdk.interfaces.IVirtuosoService");
            unregisterDownloadCallbackHandler(lback.Stub.asInterface(parcel.readStrongBinder()), parcel.readString());
            parcel1.writeNoException();
            return true;

        case 15: // '\017'
            parcel.enforceInterface("com.penthera.virtuososdk.interfaces.IVirtuosoService");
            registerEngineCallbackHandler(k.Stub.asInterface(parcel.readStrongBinder()), parcel.readString());
            parcel1.writeNoException();
            return true;

        case 16: // '\020'
            parcel.enforceInterface("com.penthera.virtuososdk.interfaces.IVirtuosoService");
            unregisterEngineCallbackHandler(k.Stub.asInterface(parcel.readStrongBinder()), parcel.readString());
            parcel1.writeNoException();
            return true;

        case 17: // '\021'
            parcel.enforceInterface("com.penthera.virtuososdk.interfaces.IVirtuosoService");
            registerQueueCallbackHandler(Callback.Stub.asInterface(parcel.readStrongBinder()), parcel.readString());
            parcel1.writeNoException();
            return true;

        case 18: // '\022'
            parcel.enforceInterface("com.penthera.virtuososdk.interfaces.IVirtuosoService");
            unregisterQueueCallbackHandler(Callback.Stub.asInterface(parcel.readStrongBinder()), parcel.readString());
            parcel1.writeNoException();
            return true;
