...
//            Request, Headers, HttpUrl, RequestBody
...
public static class <init>
{
    ...
    public set method(String s, RequestBody requestbody)
    {
    ...
    public body removeHeader(String s)
    {
        headers.removeAll(s);
        return this;
    }

    public removeAll url(HttpUrl httpurl)
    {
        if (httpurl == null)
        {
