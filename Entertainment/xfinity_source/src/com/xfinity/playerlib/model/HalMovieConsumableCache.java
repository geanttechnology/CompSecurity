...
public class HalMovieConsumableCache extends RevalidatingCachingTask
{
    ...
    public HalMovieConsumableCache(HalObjectFactory halobjectfactory, HalHttpClient halhttpclient, RevalidationPolicy revalidationpolicy, Task task, AndroidDevice androiddevice, MerlinId merlinid)
    {
    ...
    protected HalMovieConsumable fetchResourceWithNoCache()
    {
        ...
        return (HalMovieConsumable)entityFactory.createWithUrl(uri.toString(), halHttpClient);
    }
