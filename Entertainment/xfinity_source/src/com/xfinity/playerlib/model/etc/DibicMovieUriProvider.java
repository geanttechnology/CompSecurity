...
public class DibicMovieUriProvider
    implements Provider
{

    private final Task hypermediaServiceCache;

    public DibicMovieUriProvider(Task task)
    {
    ...
    public URI get()
    {
        return ((ConsumablesHypermediaService)hypermediaServiceCache.execute()).getDibicMoviesUri();
    }
}
