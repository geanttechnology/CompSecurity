...
_L2:
        ...
        printwriter.print((new StringBuilder()).append("Date: ").append(NanoHTTPD.access$100().format(new Date())).append("\r\n").toString());
        if (properties == null)
        {
...
_L3:
        ...
        s = new byte[NanoHTTPD.access$200()];
_L9:
        if (i <= 0) goto _L4; else goto _L5
_L5:
        int j;
        if (i <= NanoHTTPD.access$200())
        {
            break MISSING_BLOCK_LABEL_348;
        }
        j = NanoHTTPD.access$200();
_L10:
