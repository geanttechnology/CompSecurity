    ...
    implements VideoState
{
    ...
    private static final Logger LOG = LoggerFactory.getLogger(com/xfinity/playerlib/model/videoplay/adobeplayer/DestroyedState);
    private VideoStateController stateController;

    public DestroyedState(VideoStateController videostatecontroller)
    {
    ...
    {
        LOG.warn("Not allowed to transition from DestroyedState.  Attempted transition to {}", videostate.getStateName());
    }
