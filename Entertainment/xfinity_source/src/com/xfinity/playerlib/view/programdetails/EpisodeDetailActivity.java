...
public class EpisodeDetailActivity extends DetailActivity
    implements DetailFragment.PlayPressedListener
{

    private static final Logger LOG = LoggerFactory.getLogger(com/xfinity/playerlib/view/programdetails/EpisodeDetailActivity);
    ...
    {
        return com.xfinity.playerlib.R.layout.flyin_episode_detail;
    }
