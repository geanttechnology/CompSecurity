...
_L5:
    ...
    // Unreferenced inner class com/xfinity/playerlib/view/programdetails/PreDownloadFlowFragment$13$1

/* anonymous class */
    class PreDownloadFlowFragment._cls13._cls1
        implements Provider
    {
        ...
        public CALDialogFragment get()
        {
            ...
            obj = new ArrayList();
            ((List) (obj)).add(new com.comcast.cim.android.view.common.CALDialogFragment.CDFButton(getResources().getString(com.xfinity.playerlib.R.string.dlg_btn_try_again), new PreDownloadFlowFragment._cls13._cls1._cls1()));
