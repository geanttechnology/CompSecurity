        ...
        } else
        {
            PreDownloadFlowFragment.access$1700(PreDownloadFlowFragment.this, new Provider() {
                ...
                public CALDialogFragment get()
                {
                    ...
                    obj = new ArrayList();
                    ((List) (obj)).add(new com.comcast.cim.android.view.common.CALDialogFragment.CDFButton(getResources().getString(com.xfinity.playerlib.R.string.dlg_btn_try_again), new android.content.DialogInterface.OnClickListener() {
