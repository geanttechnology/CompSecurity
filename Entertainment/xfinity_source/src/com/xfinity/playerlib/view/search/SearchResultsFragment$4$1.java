...
class is._cls0 extends alloutClickListener
{
    ...
    {
        val$networkFilters.add(network);
    }
    ...
    (Set set)
    {
        ...
        super(final_._fld0, Network.this);
    }
...
/* anonymous class */
    class SearchResultsFragment._cls4 extends RetryingTaskExecutionListener
    {
        ...
        public void onPostExecute(final Tuple final_orderedtag)
        {
            Object obj = (TagsRoot)final_orderedtag.e1;
            ...
            SearchResultsFragment.access$602(SearchResultsFragment.this, (DibicResource)final_orderedtag.e2);
            ...
            if (((Set) (obj2)).size() < 3)
            {
                final_orderedtag = (Network)SearchResultsFragment.access$700(SearchResultsFragment.this, titleQuery, SearchResultsFragment.access$500(SearchResultsFragment.this), ((Set) (obj1)));
                if (final_orderedtag != null)
                {
                    obj = getResources().getString(com.xfinity.playerlib.R.string.search_network_callout);
                    SearchResultsFragment._cls4._cls1 _lcls1 = final_orderedtag. new SearchResultsFragment._cls4._cls1(((Set) (obj1)));
                    SearchResultsFragment.access$800(SearchResultsFragment.this, final_orderedtag, ((String) (obj)), _lcls1);
                } else
                {
                    final_orderedtag = (OrderedTag)SearchResultsFragment.access$700(SearchResultsFragment.this, titleQuery, SearchResultsFragment.access$400(SearchResultsFragment.this), set);
                    if (final_orderedtag != null)
                    {
                        obj = getResources().getString(com.xfinity.playerlib.R.string.search_genre_callout);
                        obj3 = new SearchResultsFragment._cls4._cls2(set);
                        SearchResultsFragment.access$800(SearchResultsFragment.this, final_orderedtag, ((String) (obj)), ((SearchResultsFragment.TagCalloutClickListener) (obj3)));
                    } else
                    {
            ...
            final_orderedtag = SearchResultsFragment.access$600(SearchResultsFragment.this).getProgramsMatchingTitleFilter(titleQuery);
            obj = final_orderedtag;
            if (!((Set) (obj2)).isEmpty())
            {
                if (titleQuery.isEmpty())
                {
                    final_orderedtag = SearchResultsFragment.access$600(SearchResultsFragment.this).getPrograms();
                }
                obj2 = final_orderedtag.iterator();
                do
                {
                    obj = final_orderedtag;
            ...
            final_orderedtag = Lists.newArrayList();
            DibicProgram dibicprogram;
            for (obj = ((List) (obj)).iterator(); ((Iterator) (obj)).hasNext(); final_orderedtag.add(new Tuple(SearchResultsFragment.ListSection.FULL, dibicprogram)))
            {
            ...
            ((List) (obj)).addAll(final_orderedtag);
        ...
        // Unreferenced inner class com/xfinity/playerlib/view/search/SearchResultsFragment$4$2

/* anonymous class */
        class SearchResultsFragment._cls4._cls2 extends SearchResultsFragment.TagCalloutClickListener
        {
