...
class er extends RetryingTaskExecutionListener
{
    ...
    public void onPostExecute(final Tuple final_network)
    {
        ...
        Object obj1 = val$searchQuery.getNetworkFilters();
        Set set = val$searchQuery.getGenreFilters();
        Object obj2 = val$searchQuery.getTagFilters();
        Object obj3;
        if (((Set) (obj2)).size() < 3)
        {
            final_network = (Network)SearchResultsFragment.access$700(SearchResultsFragment.this, val$titleQuery, SearchResultsFragment.access$500(SearchResultsFragment.this), ((Set) (obj1)));
            if (final_network != null)
            {
                obj = getResources().getString(com.xfinity.playerlib.callout);
                gCalloutClickListener gcalloutclicklistener = new SearchResultsFragment.TagCalloutClickListener(((Set) (obj1))) {
            ...
            
            {
                ...
                SearchResultsFragment.access$800(SearchResultsFragment.this, final_network, ((String) (obj)), gcalloutclicklistener);
            } else
            {
                final_network = (OrderedTag)SearchResultsFragment.access$700(SearchResultsFragment.this, val$titleQuery, SearchResultsFragment.access$400(SearchResultsFragment.this), set);
                if (final_network != null)
                {
                    obj = getResources().getString(com.xfinity.playerlib.llout);
                    obj3 = new SearchResultsFragment.TagCalloutClickListener(set) {
            ...
            
            {
                ...
                super(this$0, final_orderedtag);
                    ...
                    SearchResultsFragment.access$800(SearchResultsFragment.this, final_network, ((String) (obj)), ((gCalloutClickListener) (obj3)));
                } else
                {
        ...
        final_network = SearchResultsFragment.access$600(SearchResultsFragment.this).getProgramsMatchingTitleFilter(val$titleQuery);
        obj = final_network;
        if (!((Set) (obj2)).isEmpty())
        {
            if (val$titleQuery.isEmpty())
            {
        ...
        for (obj = ((List) (obj)).iterator(); ((Iterator) (obj)).hasNext(); final_network.add(new Tuple(stSection.FULL, dibicprogram)))
        {
            dibicprogram = (DibicProgram)((Iterator) (obj)).next();
            if (dibicprogram.isNew())
            {
                ((List) (obj1)).add(new Tuple(stSection.NEW, dibicprogram));
            }
        }
        ...
        {
            SearchResultsFragment.access$1502(SearchResultsFragment.this, new eakResultsRunnable(SearchResultsFragment.this, ((List) (obj))));
    ...
    this._cls0(ErrorDialogFactory errordialogfactory, android.content.Listener listener, SearchQuery searchquery, String s)
    {
        this$0 = final_searchresultsfragment;
        val$searchQuery = searchquery;
        val$titleQuery = s;
        super(final_taskexecutor, Context.this, errordialogfactory, listener);
    }
}
