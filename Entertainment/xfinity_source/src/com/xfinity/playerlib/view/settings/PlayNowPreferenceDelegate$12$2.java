    ...
    implements android.content.r
{
    ...
    {
        dialoginterface = PlayNowPreferenceDelegate.access$1600(_fld0, PlayNowPreferenceDelegate.access$200(_fld0).getString(com.xfinity.playerlib.s_loading_key));
        if (dialoginterface != null)
        {
            PlayNowPreferenceDelegate.access$1300(_fld0).removePreference(dialoginterface);
        }
    }
