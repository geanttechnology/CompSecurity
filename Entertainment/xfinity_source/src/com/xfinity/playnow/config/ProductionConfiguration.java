...
public class ProductionConfiguration extends PlayNowConfiguration
{

    public ProductionConfiguration()
    {
        XIP_URI = "https://xip.comcast.net/xip/";
        CONSUMABLES_HYPERMEDIA_SERVICES_URL = "http://xfinitytv.comcast.net/api/hypermedia/consumables/";
        TVE_HYPERMEDIA_SERVICES_URL = "http://xfinitytv.comcast.net/xtvapi/tve/android/home/";
