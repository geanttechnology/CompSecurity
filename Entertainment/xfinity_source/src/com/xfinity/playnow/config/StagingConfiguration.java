...
public class StagingConfiguration extends PlayNowConfiguration
{
    ...
    public StagingConfiguration()
    {
        ...
        CONSUMABLES_HYPERMEDIA_SERVICES_URL = "http://staging.xfinitytv.comcast.net/api/hypermedia/consumables/";
        TVE_HYPERMEDIA_SERVICES_URL = "http://staging.xfinitytv.comcast.net/xtvapi/tve/android/home/";
