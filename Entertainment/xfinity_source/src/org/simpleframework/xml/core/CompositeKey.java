    ...
    implements Converter
{
        ...
        throws Exception
    {
        ...
        for (s = type.getType(); inputnode == null || inputnode.isEmpty();)
        {
            return true;
        }

        return root.validate(inputnode, s);
    }
        ...
        throws Exception
    {
        ...
        if (entry.isAttribute())
        {
            throw new ElementException("Can not have %s as an attribute for %s at %s", new Object[] {
                class1, entry, position
            });
        } else
        {
