    ...
    implements Decorator
{
    ...
    {
        contact = (Namespace)contact.getAnnotation(org/simpleframework/xml/Namespace);
        if (contact != null)
        {
    ...
    {
        contact = (NamespaceList)contact.getAnnotation(org/simpleframework/xml/NamespaceList);
        if (contact != null)
        {
