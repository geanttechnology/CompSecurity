    ...
    implements IAdManager
{
    ...
    {
        version = -1;
        adManagerVersion = FreeWheelVersion.FW_SDK_INTERFACE_VERSION;
    ...
    public void setServer(String s)
    {
        ...
        String as[] = s.split("\\?");
        if (as[0].endsWith("ad/p/1") || as[0].endsWith("ad/g/1"))
        {
            s = "";
        } else
        if (as[0].endsWith("ad/p/") || as[0].endsWith("ad/g/"))
        {
            s = "1";
        } else
        if (as[0].endsWith("ad/p") || as[0].endsWith("ad/g"))
