...
_L5:
    ...
    public boolean match(String s, String s1, String s2, String s3, String s4, String s5)
    {
        ...
        if (adUnit.size() == 0 || adUnit.contains(s))
        {
            flag = true;
        } else
        {
        ...
        if (flag && (soAdUnit.size() == 0 || soAdUnit.contains(s1)))
        {
            flag = true;
        } else
        {
        ...
        if (flag && (contentType.size() == 0 || contentType.contains(s2)))
        {
            flag = true;
        } else
        {
        ...
        if (flag && (slotType.size() == 0 || slotType.contains(s3)))
        {
            flag = true;
        } else
        {
        ...
        return flag && (creativeApi.size() == 0 || creativeApi.contains(s4));
    }
    ...
    static 
    {
        ...
        RENDERERS.put("null/null", tv/freewheel/hybrid/renderers/nullnull/NullAdRenderer);
        RENDERERS.put("test/ad", tv/freewheel/hybrid/renderers/test/TestRenderer);
        RENDERERS.put("VideoRenderer", tv/freewheel/hybrid/renderers/temporal/VideoRenderer);
        RENDERERS.put("HTMLRenderer", tv/freewheel/hybrid/renderers/html/HTMLRenderer);
        RENDERERS.put("VastTranslator", tv/freewheel/hybrid/renderers/vast/VastTranslator);
    }
}
