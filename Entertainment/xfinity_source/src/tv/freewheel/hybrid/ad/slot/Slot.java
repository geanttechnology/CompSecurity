...
import tv.freewheel.hybrid.ad.EventCallbackHolder;
import tv.freewheel.hybrid.ad.handler.SlotImpressionCallbackHandler;
import tv.freewheel.hybrid.ad.interfaces.ISlot;
import tv.freewheel.hybrid.ad.state.SlotEndedState;
import tv.freewheel.hybrid.ad.state.SlotInitState;
import tv.freewheel.hybrid.ad.state.SlotPauseState;
...
label0:
    ...
    public Slot copy()
    {
        ...
        Slot slot1 = (Slot)getClass().getConstructor(new Class[] {
            tv/freewheel/hybrid/ad/AdContext, Integer.TYPE
...
_L1:
    ...
    public void notifyAdDone(AdInstance adinstance)
    {
        ...
        if (!StreamStitcherHelper.isHybridSDK) goto _L2; else goto _L1
_L1:
        return;
_L2:
        AdInstance adinstance1 = findNextAdToWork(adinstance);
        if (adinstance1 == null)
        {
...
_L4:
    ...
    public void processSlotEvent(String s)
    {
        logger.info("processSlotEvent");
        if (callbackHandler != null && s == "slotStarted")
        {
            callbackHandler.send();
        }
    }
