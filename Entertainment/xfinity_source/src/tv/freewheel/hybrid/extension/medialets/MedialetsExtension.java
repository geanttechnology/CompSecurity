    ...
    implements IExtension
{
    private static final class MedialetsAdmanagerState extends Enum
    {
        ...
        {
            return (MedialetsAdmanagerState)Enum.valueOf(tv/freewheel/hybrid/extension/medialets/MedialetsExtension$MedialetsAdmanagerState, s);
        }
...
_L2:
        ...
        static class _cls5
        {
            ...
            static final int $SwitchMap$tv$freewheel$hybrid$extension$medialets$MedialetsExtension$MedialetsAdmanagerState[];

            static 
            {
                $SwitchMap$tv$freewheel$hybrid$extension$medialets$MedialetsExtension$MedialetsAdmanagerState = new int[MedialetsAdmanagerState.values().length];
                try
                {
                    $SwitchMap$tv$freewheel$hybrid$extension$medialets$MedialetsExtension$MedialetsAdmanagerState[MedialetsAdmanagerState.START.ordinal()] = 1;
                }
        ...
        int i = _cls5..SwitchMap.tv.freewheel.hybrid.extension.medialets.MedialetsExtension.MedialetsAdmanagerState[medialetsadmanagerstate.ordinal()];
        i;
...
_L1:
    ...
    {
        logger.debug("stop");
        adContext.setParameter("extension.medialets.service_connected", "false", constants.PARAMETER_LEVEL_OVERRIDE());
        sAdContextCounter--;
        ...
        if (sAdContextCounter == 0 && !sFailedToBuildReflection)
        {
            ...
            if (sServiceConnected)
            {
                ...
                adContext.removeEventListener(constants.EVENT_ACTIVITY_STATE_CHANGED(), activityStateChangedEventListener);
                sPauseCounter = 0;
