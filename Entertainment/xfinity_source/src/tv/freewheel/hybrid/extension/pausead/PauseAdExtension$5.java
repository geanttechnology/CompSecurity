    ...
    implements IEventListener
{
    ...
    {
        PauseAdExtension.access$100(PauseAdExtension.this).debug("adImpressionListener");
        if (PauseAdExtension.access$800(PauseAdExtension.this, ievent).booleanValue())
        {
            PauseAdExtension.access$100(PauseAdExtension.this).debug("adImpressionListener, ad played successfully");
            PauseAdExtension.access$702(PauseAdExtension.this, Boolean.valueOf(true));
        }
    }
