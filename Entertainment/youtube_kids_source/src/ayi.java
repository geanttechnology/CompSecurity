...
public abstract class ayi extends Binder
    implements ayh
{
    ...
    public static ayh a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof ayh))
        {
            return (ayh)iinterface;
        } else
        {
            return new ayj(ibinder);
        }
    }
