...
public abstract class azr extends Binder
    implements azq
{

    public static azq a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof azq))
        {
            return (azq)iinterface;
        } else
        {
            return new azs(ibinder);
        }
    }
