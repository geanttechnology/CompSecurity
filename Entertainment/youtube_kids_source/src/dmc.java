...
public final class dmc extends eul
{
...
label0:
        {
            ...
            obj = (dmc)obj;
            if (Arrays.equals(a, ((dmc) (obj)).a) && (b != null ? b.equals(((dmc) (obj)).b) : ((dmc) (obj)).b == null))
            {
                break label0;
            } else
            {
...
_L3:
        if (((dmc) (obj)).O == null) goto _L1; else goto _L5
_L5:
        return false;
_L4:
        if (O.equals(((dmc) (obj)).O))
        {
            return true;
        }
