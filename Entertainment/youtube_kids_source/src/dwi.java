...
public final class dwi extends eul
{
...
label0:
        {
            ...
            obj = (dwi)obj;
            if (Arrays.equals(a, ((dwi) (obj)).a) && (b != null ? b.equals(((dwi) (obj)).b) : ((dwi) (obj)).b == null))
            {
                break label0;
            } else
            {
...
_L3:
        if (((dwi) (obj)).O == null) goto _L1; else goto _L5
_L5:
        return false;
_L4:
        if (O.equals(((dwi) (obj)).O))
        {
            return true;
        }
