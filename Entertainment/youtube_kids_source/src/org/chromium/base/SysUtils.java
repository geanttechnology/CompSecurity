...
_L1:
        ...
        if (!CommandLine.b().a("enable-low-end-device-mode")) goto _L4; else goto _L3
_L3:
        boolean flag = true;
_L6:
...
_L4:
        if (!CommandLine.b().a("disable-low-end-device-mode") && android.os.Build.VERSION.SDK_INT > 18)
        {
            Context context = ApplicationStatus.a();
            if (context != null)
            {
