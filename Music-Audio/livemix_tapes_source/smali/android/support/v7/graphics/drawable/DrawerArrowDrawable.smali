...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    invoke-static {v0, v4, v1}, Landroid/support/v7/graphics/drawable/DrawerArrowDrawable;->lerp(FFF)F
    ...
    invoke-static/range {v17 .. v19}, Landroid/support/v7/graphics/drawable/DrawerArrowDrawable;->lerp(FFF)F
    ...
    .line 350
    .local v6, "arrowShaftCut":F
    const/16 v17, 0x0

    sget v18, Landroid/support/v7/graphics/drawable/DrawerArrowDrawable;->ARROW_HEAD_ANGLE:F
    ...
    .line 363
    .local v15, "topBottomBarOffset":F
    neg-float v0, v7
    ...
    invoke-virtual {v0, v3, v15}, Landroid/graphics/Path;->moveTo(FF)V
    ...
    invoke-virtual {v0, v8, v5}, Landroid/graphics/Path;->rLineTo(FF)V
    ...
    .line 326
    .end local v3    # "arrowEdge":F
    .end local v4    # "arrowHeadBarLength":F
    .end local v5    # "arrowHeight":F
    .end local v6    # "arrowShaftCut":F
    .end local v7    # "arrowShaftLength":F
    .end local v8    # "arrowWidth":F
    .end local v9    # "barThickness":F
    .end local v11    # "canvasRotate":F
    .end local v12    # "flipToPointRight":Z
    .end local v13    # "remainingSpace":I
    .end local v14    # "rotation":F
    .end local v15    # "topBottomBarOffset":F
    .end local v16    # "yOffset":F
    :pswitch_1
    const/4 v12, 0x0

    .line 327
    .restart local v12    # "flipToPointRight":Z
    goto/16 :goto_0
    ...
    .line 353
    .restart local v4    # "arrowHeadBarLength":F
    .restart local v6    # "arrowShaftCut":F
    .restart local v7    # "arrowShaftLength":F
    .restart local v12    # "flipToPointRight":Z
    .restart local v14    # "rotation":F
    :cond_3
    ...
    .line 389
    .restart local v3    # "arrowEdge":F
    .restart local v5    # "arrowHeight":F
    .restart local v8    # "arrowWidth":F
    .restart local v9    # "barThickness":F
    .restart local v11    # "canvasRotate":F
    .restart local v13    # "remainingSpace":I
    .restart local v15    # "topBottomBarOffset":F
    .restart local v16    # "yOffset":F
    :cond_5
    const/16 v17, 0x1
