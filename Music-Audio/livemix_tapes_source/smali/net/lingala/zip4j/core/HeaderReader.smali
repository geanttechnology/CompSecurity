...
.method private readCentralDirectory()Lnet/lingala/zip4j/model/CentralDirectory;
    ...
    const-string v28, "random access file was null"
    ...
    const-string v28, "EndCentralRecord was null, maybe a corrupt zip file"
    ...
    .line 218
    .end local v5    # "digitalSignature":Lnet/lingala/zip4j/model/DigitalSignature;
    ...
    const-wide/32 v29, 0x2014b50    # 1.6619997E-316
    ...
    const-string v29, "Expected central directory entry not found (#"
    ...
    const-string v28, "fileName is null when reading central directory"
    ...
    const-string v28, "file.separator"
    ...
    .end local v16    # "firstByte":I
    .end local v22    # "result":I
    .restart local v5    # "digitalSignature":Lnet/lingala/zip4j/model/DigitalSignature;
    :cond_f
    move/from16 v0, v25
...
.method private readEndOfCentralDirectoryRecord()Lnet/lingala/zip4j/model/EndCentralDirRecord;
    ...
    const-string v18, "random access file was null"
    ...
    const-string v18, "zip headers not found. probably not a zip file"
    ...
    const-string v18, "Probably not a zip file or a corrupted zip file"
...
.method private readZip64EndCentralDirRec()Lnet/lingala/zip4j/model/Zip64EndCentralDirRecord;
    ...
    const-string v12, "invalid zip64 end of central directory locator"
    ...
    const-string v12, "invalid offset for start of end of central directory record"
    ...
    const-string v12, "invalid signature for zip64 end of central directory record"
...
.method public readLocalFileHeader(Lnet/lingala/zip4j/model/FileHeader;)Lnet/lingala/zip4j/model/LocalFileHeader;
    ...
    const-string v21, "invalid read parameters for local header"
    ...
    const-string v21, "invalid local header offset"
    ...
    const-string v22, "invalid local header signature for file: "
    ...
    const-string v21, "file name is null, cannot assign file name to local file header"
    ...
    const-string v21, "file.separator"
