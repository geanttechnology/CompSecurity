...
.method public writeLocalFileHeader(Lnet/lingala/zip4j/model/ZipModel;Lnet/lingala/zip4j/model/LocalFileHeader;Ljava/io/OutputStream;)I
    ...
    const-string v19, "input parameters are null, cannot write local file header"
    ...
    invoke-static {v11, v0, v1}, Lnet/lingala/zip4j/util/Raw;->writeIntLittleEndian([BII)V

    .line 56
    move-object/from16 v0, p0

    invoke-direct {v0, v11, v5}, Lnet/lingala/zip4j/core/HeaderWriter;->copyByteArrayToArrayList([BLjava/util/List;)V
    ...
    invoke-static {v14, v0, v1}, Lnet/lingala/zip4j/util/Raw;->writeShortLittleEndian([BIS)V
    ...
    invoke-static {v11, v0, v6}, Lnet/lingala/zip4j/util/Raw;->writeIntLittleEndian([BII)V
    ...
    invoke-static {v13, v0, v11, v1, v2}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V
    ...
    invoke-direct {v0, v13, v5}, Lnet/lingala/zip4j/core/HeaderWriter;->copyByteArrayToArrayList([BLjava/util/List;)V
    ...
    .end local v13    # "longByte":[B
    .end local v14    # "shortByte":[B
    .end local v15    # "uncompressedSize":J
    ...
    .restart local v13    # "longByte":[B
    .restart local v14    # "shortByte":[B
    .restart local v15    # "uncompressedSize":J
    ...
    invoke-static/range {v18 .. v18}, Lnet/lingala/zip4j/util/Zip4jUtil;->convertCharset(Ljava/lang/String;)[B
