...
.method public constructor <init>(Ljava/io/RandomAccessFile;JJLnet/lingala/zip4j/unzip/UnzipEngine;)V
    ...
    iput-object v2, p0, Lnet/lingala/zip4j/io/PartInputStream;->oneByteBuff:[B
    ...
    iput-object v2, p0, Lnet/lingala/zip4j/io/PartInputStream;->aesBlockByte:[B
...
.method protected checkAndReadAESMacBytes()V
    ...
    .line 127
    iget-boolean v3, p0, Lnet/lingala/zip4j/io/PartInputStream;->isAESEncryptedFile:Z

    if-eqz v3, :cond_0

    .line 128
    iget-object v3, p0, Lnet/lingala/zip4j/io/PartInputStream;->decrypter:Lnet/lingala/zip4j/crypto/IDecrypter;

    if-eqz v3, :cond_0

    iget-object v3, p0, Lnet/lingala/zip4j/io/PartInputStream;->decrypter:Lnet/lingala/zip4j/crypto/IDecrypter;

    instance-of v3, v3, Lnet/lingala/zip4j/crypto/AESDecrypter;
    ...
    check-cast v3, Lnet/lingala/zip4j/crypto/AESDecrypter;

    invoke-virtual {v3}, Lnet/lingala/zip4j/crypto/AESDecrypter;->getStoredMac()[B
    ...
    invoke-virtual {v3}, Lnet/lingala/zip4j/unzip/UnzipEngine;->getDecrypter()Lnet/lingala/zip4j/crypto/IDecrypter;

    move-result-object v3

    check-cast v3, Lnet/lingala/zip4j/crypto/AESDecrypter;

    invoke-virtual {v3, v0}, Lnet/lingala/zip4j/crypto/AESDecrypter;->setStoredMac([B)V
...
.method public read()I
    ...
    .line 59
    iget-wide v1, p0, Lnet/lingala/zip4j/io/PartInputStream;->bytesRead:J

    iget-wide v3, p0, Lnet/lingala/zip4j/io/PartInputStream;->length:J
    ...
    .line 67
    iput v5, p0, Lnet/lingala/zip4j/io/PartInputStream;->aesBytesReturned:I
    ...
    invoke-virtual {p0, v1, v5, v2}, Lnet/lingala/zip4j/io/PartInputStream;->read([BII)I
...
.method public read([BII)I
    ...
    iget-wide v4, p0, Lnet/lingala/zip4j/io/PartInputStream;->length:J

    iget-wide v6, p0, Lnet/lingala/zip4j/io/PartInputStream;->bytesRead:J
    ...
    .line 88
    :cond_0
    iget-object v2, p0, Lnet/lingala/zip4j/io/PartInputStream;->unzipEngine:Lnet/lingala/zip4j/unzip/UnzipEngine;

    invoke-virtual {v2}, Lnet/lingala/zip4j/unzip/UnzipEngine;->getDecrypter()Lnet/lingala/zip4j/crypto/IDecrypter;

    move-result-object v2

    instance-of v2, v2, Lnet/lingala/zip4j/crypto/AESDecrypter;
    ...
    invoke-virtual {v2}, Lnet/lingala/zip4j/unzip/UnzipEngine;->getZipModel()Lnet/lingala/zip4j/model/ZipModel;
    ...
    invoke-virtual {v2}, Lnet/lingala/zip4j/unzip/UnzipEngine;->startNextSplitFile()Ljava/io/RandomAccessFile;

    move-result-object v2

    iput-object v2, p0, Lnet/lingala/zip4j/io/PartInputStream;->raf:Ljava/io/RandomAccessFile;
    ...
    iget v4, p0, Lnet/lingala/zip4j/io/PartInputStream;->count:I

    iget v5, p0, Lnet/lingala/zip4j/io/PartInputStream;->count:I
    ...
    .line 109
    iget-object v2, p0, Lnet/lingala/zip4j/io/PartInputStream;->decrypter:Lnet/lingala/zip4j/crypto/IDecrypter;
    ...
    invoke-interface {v2, p1, p2, v3}, Lnet/lingala/zip4j/crypto/IDecrypter;->decryptData([BII)I
    :try_end_1
