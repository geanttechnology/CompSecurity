...
public static final class ut extends ut
{
    ...
    public Action build()
    {
        zzx.zzb(zzQe.get("object"), "setObject is required before calling build().");
        zzx.zzb(zzQe.get("type"), "setType is required before calling build().");
        Bundle bundle = (Bundle)zzQe.getParcelable("object");
