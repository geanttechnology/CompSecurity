...
public final class AppInviteInvitation
{
    public static final class IntentBuilder
    {
        ...
        public IntentBuilder setAdditionalReferralParameters(Map map)
        {
            if (map != null)
            {
                mIntent.putExtra("com.google.android.gms.appinvite.REFERRAL_PARAMETERS_URI", AppInviteInvitation.zzB(map));
                return this;
            } else
            {
