...
_L3:
        break MISSING_BLOCK_LABEL_249;
_L4:
        jsonobject.put(zzUo.zzbE(s), zzUp.getString(s));
        break MISSING_BLOCK_LABEL_249;
_L5:
        jsonobject.put(zzUo.zzbE(s), zzUp.getInt(s));
        break MISSING_BLOCK_LABEL_249;
_L6:
        jsonobject.put(zzUo.zzbE(s), zzUp.getDouble(s));
        break MISSING_BLOCK_LABEL_249;
_L2:
        as = zzUp.keySet().iterator();
_L9:
        do
        {
            if (!as.hasNext())
...
_L4:
        ...
        {
            zzUp.putString(((String) (obj1)), (String)obj);
        }
        continue; /* Loop/switch isn't completed */
_L7:
        try
        {
            if ((obj instanceof String) && zzkk.zzbS((String)obj) != null)
            {
                zzUp.putString(((String) (obj1)), (String)obj);
            }
        }
...
_L5:
        ...
        {
            zzUp.putInt(((String) (obj1)), ((Integer)obj).intValue());
        }
        continue; /* Loop/switch isn't completed */
_L6:
        if (obj instanceof Double)
        {
            zzUp.putDouble(((String) (obj1)), ((Double)obj).doubleValue());
        }
        continue; /* Loop/switch isn't completed */
_L2:
        ...
        {
            zzUp.putString(((String) (obj)), (String)obj1);
            continue; /* Loop/switch isn't completed */
        }
        if (obj1 instanceof Integer)
        {
            zzUp.putInt(((String) (obj)), ((Integer)obj1).intValue());
            continue; /* Loop/switch isn't completed */
        }
        try
        {
            ...
            {
                zzUp.putDouble(((String) (obj)), ((Double)obj1).doubleValue());
            }
            continue; /* Loop/switch isn't completed */
        }
        // Misplaced declaration of an exception variable
...
label1:
        ...
        throws IllegalArgumentException
    {
        ...
        if (j != i && j != 0)
        {
            throw new IllegalArgumentException((new StringBuilder()).append("Value for ").append(s).append(" must be a ").append(zzUn[i]).toString());
        } else
        {
            return;
        }
    ...
    public boolean equals(Object obj)
    {
        if (this != obj)
        {
            ...
            if (!zzb(zzUp, ((MediaMetadata) (obj)).zzUp) || !zzvL.equals(((MediaMetadata) (obj)).zzvL))
            {
                return false;
            }
        }
    ...
    {
        zzg(s, 4);
        return zzUp.getString(s);
    }

    public double getDouble(String s)
    {
        zzg(s, 3);
        return zzUp.getDouble(s);
    }
    ...
    {
        return zzvL != null && !zzvL.isEmpty();
    }

    public int hashCode()
    {
        Iterator iterator = zzUp.keySet().iterator();
        String s;
        int i;
        for (i = 17; iterator.hasNext(); i = zzUp.get(s).hashCode() + i * 31)
        {
            s = (String)iterator.next();
        }

        return i * 31 + zzvL.hashCode();
    }
    ...
    {
        zzg(s, 4);
        zzUp.putString(s, zzkk.zza(calendar));
    }
    ...
    public JSONObject toJson()
    {
        ...
        try
        {
            jsonobject.put("metadataType", zzUq);
        }
        catch (JSONException jsonexception) { }
        zzkk.zza(jsonobject, zzvL);
        switch (zzUq)
        {
        default:
    ...
    public void zzf(JSONObject jsonobject)
    {
        ...
        try
        {
            zzUq = jsonobject.getInt("metadataType");
        }
        catch (JSONException jsonexception) { }
        zzkk.zza(zzvL, jsonobject);
        switch (zzUq)
        {
        default:
