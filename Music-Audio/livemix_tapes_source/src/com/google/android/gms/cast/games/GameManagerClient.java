...
public final class GameManagerClient
{
    ...
    public GameManagerClient(zzkd zzkd1)
    {
        zzVO = zzkd1;
    }
    ...
    {
        return zza(new zzkd(googleapiclient, s, Cast.CastApi));
    }

    static PendingResult zza(zzkd zzkd1)
        throws IllegalArgumentException
    {
        return zzkd1.zza(new GameManagerClient(zzkd1));
    }

    private PendingResult zza(String s, int i, JSONObject jsonobject)
        throws IllegalStateException
    {
        return zzVO.zza(s, i, jsonobject);
    }
        ...
        throws IllegalStateException
    {
        ...
        GameManagerState gamemanagerstate = zzVO.getCurrentState();
        this;
    ...
    public String getLastUsedPlayerId()
        throws IllegalStateException
    {
        return zzVO.getLastUsedPlayerId();
    }

    public boolean isDisposed()
    {
        return zzVO.isDisposed();
    }

    public void sendGameMessage(String s, JSONObject jsonobject)
        throws IllegalStateException
    {
        zzVO.sendGameMessage(s, jsonobject);
    }
    ...
    public PendingResult sendGameRequest(String s, JSONObject jsonobject)
        throws IllegalStateException
    {
        return zzVO.sendGameRequest(s, jsonobject);
    }
    ...
    {
        zzVO.setListener(listener);
    }

    public void setSessionLabel(String s)
    {
        zzVO.setSessionLabel(s);
    }
}
