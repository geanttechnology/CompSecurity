...
public class InFilter extends AbstractFilter
{
    ...
    InFilter(int i, MetadataBundle metadatabundle)
    {
        ...
        zzalJ = (zzb)com.google.android.gms.drive.query.internal.zze.zzb(metadatabundle);
    }
    ...
    {
        return ((Collection)zzalw.zza(zzalJ)).iterator().next();
    }
    ...
    {
        return zzf1.zzb(zzalJ, getValue());
    }
