    ...
    implements SafeParcelable
{
    ...
    private static final Map zzanV = new HashMap() {
    ...
    {
        this(1, s, ((List) (zzli.zzb(afield))));
    }

    public static List getAggregatesForInput(DataType datatype)
    {
        datatype = (List)zzanV.get(datatype);
        if (datatype == null)
        {
    ...
    {
        return mName.equals(datatype.mName) && zzanX.equals(datatype.zzanX);
    }
    ...
    static 
    {
        ...
        zzanN = new DataType("com.google.floor_change", new Field[] {
            Field.FIELD_ACTIVITY, Field.FIELD_CONFIDENCE, Field.zzaog, Field.zzaoj
        });
        ...
        zzanO = new DataType("com.google.activity.edge", new Field[] {
            Field.FIELD_ACTIVITY, Field.zzaom
        });
        zzanP = new DataType("com.google.accelerometer", new Field[] {
            Field.zzaon, Field.zzaoo, Field.zzaop
        });
        ...
        zzanQ = new DataType("com.google.body.waist.circumference", new Field[] {
            Field.FIELD_CIRCUMFERENCE
        });
        zzanR = new DataType("com.google.body.hip.circumference", new Field[] {
            Field.FIELD_CIRCUMFERENCE
        });
        ...
        AGGREGATE_INPUT_TYPES = Collections.unmodifiableSet(new HashSet(Arrays.asList(new DataType[] {
            TYPE_STEP_COUNT_DELTA, TYPE_DISTANCE_DELTA, TYPE_ACTIVITY_SEGMENT, zzanN, TYPE_SPEED, TYPE_HEART_RATE_BPM, TYPE_WEIGHT, TYPE_LOCATION_SAMPLE, TYPE_CALORIES_CONSUMED, TYPE_CALORIES_EXPENDED, 
            TYPE_BODY_FAT_PERCENTAGE, zzanR, zzanQ, TYPE_NUTRITION
        })));
        ...
        zzanS = new DataType("com.google.floor_change.summary", new Field[] {
            Field.zzaoe, Field.zzaof, Field.zzaoh, Field.zzaoi, Field.zzaok, Field.zzaol
        });
        ...
        zzanT = new DataType("com.google.body.hip.circumference.summary", new Field[] {
            Field.FIELD_AVERAGE, Field.FIELD_MAX, Field.FIELD_MIN
        });
        zzanU = new DataType("com.google.body.waist.circumference.summary", new Field[] {
            Field.FIELD_AVERAGE, Field.FIELD_MAX, Field.FIELD_MIN
        });
        ...
        zzanW = (new DataType[] {
            zzanP, zzanO, TYPE_WORKOUT_EXERCISE, TYPE_ACTIVITY_SAMPLE, TYPE_ACTIVITY_SEGMENT, AGGREGATE_ACTIVITY_SUMMARY, TYPE_BODY_FAT_PERCENTAGE, AGGREGATE_BODY_FAT_PERCENTAGE_SUMMARY, zzanR, zzanT, 
            zzanQ, zzanU, TYPE_BASAL_METABOLIC_RATE, AGGREGATE_BASAL_METABOLIC_RATE_SUMMARY, TYPE_CALORIES_CONSUMED, TYPE_CALORIES_EXPENDED, TYPE_CYCLING_PEDALING_CADENCE, TYPE_CYCLING_PEDALING_CUMULATIVE, TYPE_CYCLING_WHEEL_REVOLUTION, TYPE_CYCLING_WHEEL_RPM, 
            TYPE_DISTANCE_CUMULATIVE, TYPE_DISTANCE_DELTA, zzanN, zzanS, TYPE_HEART_RATE_BPM, AGGREGATE_HEART_RATE_SUMMARY, TYPE_HEIGHT, AGGREGATE_LOCATION_BOUNDING_BOX, TYPE_LOCATION_SAMPLE, TYPE_LOCATION_TRACK, 
            TYPE_NUTRITION, AGGREGATE_NUTRITION_SUMMARY, TYPE_POWER_SAMPLE, AGGREGATE_POWER_SUMMARY, TYPE_SPEED, AGGREGATE_SPEED_SUMMARY, TYPE_STEP_COUNT_CADENCE, TYPE_STEP_COUNT_CUMULATIVE, TYPE_STEP_COUNT_DELTA, TYPE_WEIGHT, 
