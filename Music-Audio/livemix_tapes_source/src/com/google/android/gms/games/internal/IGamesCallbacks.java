        ...
        implements IGamesCallbacks
    {
            ...
            throws RemoteException
        {
            ...
            case 5002: 
                ...
                if (parcel.readInt() != 0)
                {
                    parcel = DataHolder.CREATOR.zzaa(parcel);
                } else
                {
                    parcel = null;
                }
...
_L4:
            zznI.transact(12004, parcel, parcel1, 0);
            parcel1.readException();
            parcel1.recycle();
            parcel.recycle();
            return;
...
_L1:
            ...
            throws RemoteException
        {
            ...
            dataholder.writeToParcel(parcel, 0);
_L1:
            zznI.transact(5010, parcel, parcel1, 0);
            parcel1.readException();
            parcel1.recycle();
            parcel.recycle();
            return;
            ...
            throws RemoteException
        {
            ...
            dataholder.writeToParcel(parcel, 0);
_L1:
            zznI.transact(5011, parcel, parcel1, 0);
            parcel1.readException();
            parcel1.recycle();
            parcel.recycle();
            return;
...
_L1:
    ...
    public abstract void zzfI(int i)
        throws RemoteException;

    public abstract void zzfJ(int i)
        throws RemoteException;
