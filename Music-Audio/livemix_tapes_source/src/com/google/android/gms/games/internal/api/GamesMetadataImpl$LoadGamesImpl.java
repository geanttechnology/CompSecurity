...
private static abstract class <init> extends com.google.android.gms.games.oadGamesImpl
{
    ...
    public com.google.android.gms.games.oadGamesImpl zzaf(Status status)
    {
        return new com.google.android.gms.games.GamesMetadata.LoadGamesResult(status) {

            final Status zzQs;
            final GamesMetadataImpl.LoadGamesImpl zzauP;
            ...
            {
                zzauP = GamesMetadataImpl.LoadGamesImpl.this;
                zzQs = status;
                super();
            }
        };
