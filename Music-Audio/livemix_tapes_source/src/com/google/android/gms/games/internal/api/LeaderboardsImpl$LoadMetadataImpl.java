...
private static abstract class <init> extends com.google.android.gms.games.MetadataImpl
{
    ...
    public com.google.android.gms.games.leaderboard.sult zzah(Status status)
    {
        return new com.google.android.gms.games.leaderboard.Leaderboards.LeaderboardMetadataResult(status) {

            final Status zzQs;
            final LeaderboardsImpl.LoadMetadataImpl zzavd;
            ...
            {
                zzavd = LeaderboardsImpl.LoadMetadataImpl.this;
                zzQs = status;
                super();
            }
        };
