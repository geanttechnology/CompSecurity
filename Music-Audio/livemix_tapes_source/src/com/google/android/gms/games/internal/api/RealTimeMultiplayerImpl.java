    ...
    implements RealTimeMultiplayer
{
    ...
    private static zzl zza(GoogleApiClient googleapiclient, Object obj)
    {
        if (obj == null)
        {
            return null;
        ...
        {
            return googleapiclient.zzp(obj);
        }
    }
    ...
    public void create(GoogleApiClient googleapiclient, RoomConfig roomconfig)
    {
        ...
        {
            gamesclientimpl.zza(googleapiclient.zzp(roomconfig.getRoomUpdateListener()), zza(googleapiclient, roomconfig.getRoomStatusUpdateListener()), zza(googleapiclient, roomconfig.getMessageReceivedListener()), roomconfig);
            return;
        }
    }
    ...
    public void join(GoogleApiClient googleapiclient, RoomConfig roomconfig)
    {
        ...
        {
            gamesclientimpl.zzb(googleapiclient.zzp(roomconfig.getRoomUpdateListener()), zza(googleapiclient, roomconfig.getRoomStatusUpdateListener()), zza(googleapiclient, roomconfig.getMessageReceivedListener()), roomconfig);
            return;
        }
    }
    ...
    public void leave(GoogleApiClient googleapiclient, RoomUpdateListener roomupdatelistener, String s)
    {
        ...
        if (gamesclientimpl != null)
        {
            gamesclientimpl.zza(googleapiclient.zzp(roomupdatelistener), s);
        }
    }
