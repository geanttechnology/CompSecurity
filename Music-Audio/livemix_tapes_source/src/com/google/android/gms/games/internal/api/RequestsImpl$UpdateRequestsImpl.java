...
private static abstract class <init> extends com.google.android.gms.games.RequestsImpl
{
    ...
    public com.google.android.gms.games.request.Impl zzaz(Status status)
    {
        return new com.google.android.gms.games.request.Requests.UpdateRequestsResult(status) {

            final Status zzQs;
            final RequestsImpl.UpdateRequestsImpl zzavU;
            ...
            {
                zzavU = RequestsImpl.UpdateRequestsImpl.this;
                zzQs = status;
                super();
            }
        };
