    ...
    implements Participant
{
    ...
    {
        super(dataholder, i);
        zzayi = new PlayerRef(dataholder, i);
    }
    ...
    public void getDisplayName(CharArrayBuffer chararraybuffer)
    {
        ...
        {
            zzayi.getDisplayName(chararraybuffer);
            return;
        }
    }
    ...
    public Uri getHiResImageUri()
    {
        if (zzcf("external_player_id"))
        {
            return zzce("default_display_hi_res_image_uri");
        } else
        {
            return zzayi.getHiResImageUri();
        }
    }
