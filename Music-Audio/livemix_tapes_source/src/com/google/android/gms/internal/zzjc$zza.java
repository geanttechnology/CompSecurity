...
_L1:
        ...
        throws RemoteException
    {
        ...
        case 1: // '\001'
            ...
            zza(zzag(parcel.readStrongBinder()), parcel.readString(), (UsageInfo[])parcel.createTypedArray(UsageInfo.CREATOR));
        ...
        case 4: // '\004'
            parcel.enforceInterface("com.google.android.gms.appdatasearch.internal.ILightweightAppDataSearch");
            zzjd zzjd = zzag(parcel.readStrongBinder());
            boolean flag;
            if (parcel.readInt() != 0)
            {
                flag = true;
        ...
        case 5: // '\005'
            ...
            if (parcel.readInt() != 0)
            {
                request = com.google.android.gms.appdatasearch.ContextCall.Request.CREATOR.zzw(parcel);
            } else
            {
                request = null;
            }
            zza(request, zzag(parcel.readStrongBinder()));
            parcel1.writeNoException();
            return true;

        case 6: // '\006'
            parcel.enforceInterface("com.google.android.gms.appdatasearch.internal.ILightweightAppDataSearch");
            zza(zzag(parcel.readStrongBinder()), parcel.readString(), parcel.readString());
            parcel1.writeNoException();
            return true;
        }
    }
