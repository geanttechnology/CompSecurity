        ...
        implements zzjl
    {
            ...
            throws RemoteException
        {
            ...
            case 1: // '\001'
                ...
                zzb(zzjk.zza.zzaj(parcel.readStrongBinder()), parcel.readString());
                parcel1.writeNoException();
                return true;

            case 2: // '\002'
                parcel.enforceInterface("com.google.android.gms.appinvite.internal.IAppInviteService");
                zza(zzjk.zza.zzaj(parcel.readStrongBinder()), parcel.readString());
                parcel1.writeNoException();
                return true;
            }
        }
...
_L1:
    ...
    public abstract void zza(zzjk zzjk, String s)
        throws RemoteException;

    public abstract void zzb(zzjk zzjk, String s)
        throws RemoteException;
}
