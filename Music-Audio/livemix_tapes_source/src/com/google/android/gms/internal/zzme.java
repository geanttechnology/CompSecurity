...
public class zzme extends zzj
{
    ...
    {
        long l = dataholder.zznP().getLong("dbInstanceId");
        int k;
        if ("application/vnd.google-apps.folder".equals(dataholder.zzd(zzmb.zzakL.getName(), i, j)))
        {
            k = 1;
        } else
        {
