    ...
    extends IInterface
{
        ...
        implements zzoz
    {
        ...
        public static zzoz zzdc(IBinder ibinder)
        {
            ...
            IInterface iinterface = ibinder.queryLocalInterface("com.google.android.gms.nearby.bootstrap.internal.INearbyBootstrapService");
            ...
            throws RemoteException
        {
            ...
            case 10: // '\n'
                parcel.enforceInterface("com.google.android.gms.nearby.bootstrap.internal.INearbyBootstrapService");
                zza(zzoy.zza.zzdb(parcel.readStrongBinder()));
                return true;
            }
        }
    }
...
_L1:
    ...
    public abstract void zza(zzoy zzoy)
        throws RemoteException;

    public abstract void zza(ConnectRequest connectrequest)
        throws RemoteException;

    public abstract void zza(ContinueConnectRequest continueconnectrequest)
        throws RemoteException;

    public abstract void zza(DisableTargetRequest disabletargetrequest)
        throws RemoteException;

    public abstract void zza(DisconnectRequest disconnectrequest)
        throws RemoteException;

    public abstract void zza(EnableTargetRequest enabletargetrequest)
        throws RemoteException;

    public abstract void zza(SendDataRequest senddatarequest)
        throws RemoteException;

    public abstract void zza(StartScanRequest startscanrequest)
        throws RemoteException;

    public abstract void zza(StopScanRequest stopscanrequest)
        throws RemoteException;
}
