    ...
    extends IInterface
{
        ...
        implements zzpf
    {
        ...
        public static zzpf zzdg(IBinder ibinder)
        {
            ...
            if (iinterface != null && (iinterface instanceof zzpf))
            {
                return (zzpf)iinterface;
            } else
            {
            ...
            throws RemoteException
        {
            ...
            case 1001: 
                ...
                zzpe zzpe = com.google.android.gms.internal.zzpe.zza.zzdf(parcel.readStrongBinder());
                ...
                zza(zzpe, s, appmetadata, parcel.readLong(), parcel.readLong());
            ...
            case 1003: 
                parcel.enforceInterface("com.google.android.gms.nearby.internal.connection.INearbyConnectionService");
                zza(com.google.android.gms.internal.zzpe.zza.zzdf(parcel.readStrongBinder()), parcel.readString(), parcel.readLong(), parcel.readLong());
                parcel1.writeNoException();
                return true;
            ...
            case 1005: 
                parcel.enforceInterface("com.google.android.gms.nearby.internal.connection.INearbyConnectionService");
                zza(com.google.android.gms.internal.zzpe.zza.zzdf(parcel.readStrongBinder()), parcel.readInt(), parcel.readLong(), parcel.readLong());
                parcel1.writeNoException();
                return true;
            ...
            case 1007: 
                parcel.enforceInterface("com.google.android.gms.nearby.internal.connection.INearbyConnectionService");
                zza(com.google.android.gms.internal.zzpe.zza.zzdf(parcel.readStrongBinder()), parcel.readString(), parcel.readString(), parcel.createByteArray(), parcel.readLong());
                parcel1.writeNoException();
                return true;

            case 1008: 
                parcel.enforceInterface("com.google.android.gms.nearby.internal.connection.INearbyConnectionService");
                zza(com.google.android.gms.internal.zzpe.zza.zzdf(parcel.readStrongBinder()), parcel.readString(), parcel.createByteArray(), parcel.readLong());
                parcel1.writeNoException();
                return true;

            case 1009: 
                parcel.enforceInterface("com.google.android.gms.nearby.internal.connection.INearbyConnectionService");
                zza(com.google.android.gms.internal.zzpe.zza.zzdf(parcel.readStrongBinder()), parcel.readString(), parcel.readLong());
                parcel1.writeNoException();
                return true;
...
_L1:
    ...
    public abstract void zza(zzpe zzpe, int i, long l, long l1)
        throws RemoteException;

    public abstract void zza(zzpe zzpe, String s, long l)
        throws RemoteException;

    public abstract void zza(zzpe zzpe, String s, long l, long l1)
        throws RemoteException;

    public abstract void zza(zzpe zzpe, String s, AppMetadata appmetadata, long l, long l1)
        throws RemoteException;

    public abstract void zza(zzpe zzpe, String s, String s1, byte abyte0[], long l)
        throws RemoteException;

    public abstract void zza(zzpe zzpe, String s, byte abyte0[], long l)
        throws RemoteException;
