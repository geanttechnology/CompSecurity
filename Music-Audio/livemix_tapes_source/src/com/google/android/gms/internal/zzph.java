    ...
    extends IInterface
{
        ...
        implements zzph
    {
        ...
        public static zzph zzdr(IBinder ibinder)
        {
            ...
            if (iinterface != null && (iinterface instanceof zzph))
            {
                return (zzph)iinterface;
            } else
            {
            ...
            throws RemoteException
        {
            ...
            case 1: // '\001'
                ...
                zzpg = com.google.android.gms.internal.zzpg.zza.zzdq(parcel.readStrongBinder());
                break;
            }
            Bundle bundle;
            boolean flag;
...
_L4:
    ...
    public abstract void zza(zzpg zzpg, Uri uri, Bundle bundle, boolean flag)
        throws RemoteException;
}
