...
public final class PlusShare
{
    public static class Builder
    {
        ...
        private ArrayList zzaLn;

        public Builder addCallToAction(String s, Uri uri, String s1)
        {
            zzx.zza(zzaLm, "Must include the launching activity with PlusShare.Builder constructor before setting call-to-action");
            Bundle bundle;
            boolean flag;
            ...
            {
                zzx.zza(PlusShare.zzeg(s1), "The specified deep-link ID was malformed.");
        ...
        public Intent getIntent()
        {
            ...
            if (mIntent.hasExtra("com.google.android.apps.plus.CONTENT_DEEP_LINK_ID"))
            {
                zzx.zza(PlusShare.zzeg(mIntent.getStringExtra("com.google.android.apps.plus.CONTENT_DEEP_LINK_ID")), "The specified deep-link ID was malformed.");
            }
            if (!flag && flag3)
            {
                mIntent.setAction("android.intent.action.SEND");
                if (zzaLn != null && !zzaLn.isEmpty())
                {
                    mIntent.putExtra("android.intent.extra.STREAM", (Parcelable)zzaLn.get(0));
                } else
                {
            ...
            if (flag && !flag3)
            {
                ...
                if (zzaLn != null && !zzaLn.isEmpty())
                {
                    mIntent.putParcelableArrayListExtra("android.intent.extra.STREAM", zzaLn);
                } else
                {
                    mIntent.removeExtra("android.intent.extra.STREAM");
                }
        ...
        {
            zzx.zzb(zzaLm, "Must include the launching activity with PlusShare.Builder constructor before setting deep links");
            boolean flag;
            if (!TextUtils.isEmpty(s))
            {
                flag = true;
    ...
    public static Person createPerson(String s, String s1)
    {
        ...
        {
            return new PersonEntity(s1, s, null, 0, null);
        }
    }
    ...
    protected static boolean zzeg(String s)
    {
        if (TextUtils.isEmpty(s))
        {
