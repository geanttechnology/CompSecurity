...
_L10:
    ...
    {
        if (!zzaYk.containsKey(s))
        {
            if ((typedarray = typedarray.peekValue(i)) != null)
            {
                zzaYk.putLong(s, zza(((TypedValue) (typedarray))));
                return;
            }
        }
    }
    ...
    {
        if (!zzaYk.containsKey(s) && !zzaYk.containsKey(s1))
        {
            if ((typedarray = typedarray.peekValue(i)) != null)
            {
                if (((TypedValue) (typedarray)).type >= 28 && ((TypedValue) (typedarray)).type <= 31)
                {
                    zzaYk.putInt(s, ((TypedValue) (typedarray)).data);
                    return;
                } else
                {
                    zzaYk.putInt(s1, ((TypedValue) (typedarray)).resourceId);
                    return;
                }
            }
        }
    ...
    public int zza(String s, DisplayMetrics displaymetrics, int i)
    {
        if (zzaYk.containsKey(s))
        {
            i = zza(zzaYk.getLong(s), displaymetrics);
        }
        return i;
    }
