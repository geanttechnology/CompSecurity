...
public interface LMTBackground
    extends IInterface
{
        ...
        implements LMTBackground
    {
        ...
        public static LMTBackground asInterface(IBinder ibinder)
        {
            ...
            IInterface iinterface = ibinder.queryLocalInterface("com.livemixtapes.LMTBackground");
    ...
    public abstract void addTrack(String s, String s1)
        throws RemoteException;
    ...
    public abstract void playTrack(int i)
        throws RemoteException;
