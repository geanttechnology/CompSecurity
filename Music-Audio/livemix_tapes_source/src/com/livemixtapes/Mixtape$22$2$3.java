    ...
    implements Runnable
{
    ...
    public void run()
    {
        (new android.app.lder(mContext)).setTitle("Download Complete").setMessage("Your mixtape has finished downloading!  We extracted the zip for you too!").setPositiveButton("Thanks!", new android.content.DialogInterface.OnClickListener() {
