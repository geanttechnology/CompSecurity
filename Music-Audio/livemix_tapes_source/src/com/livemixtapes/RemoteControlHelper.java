...
public class RemoteControlHelper
{
    ...
    public static void registerRemoteControlClient(AudioManager audiomanager, RemoteControlClientCompat remotecontrolclientcompat)
    {
        ...
        {
            Log.e("RemoteControlHelper", audiomanager.getMessage(), audiomanager);
        }
    }
    ...
    static 
    {
        try
        {
            Class class1 = RemoteControlClientCompat.getActualRemoteControlClientClass(com/livemixtapes/RemoteControlHelper.getClassLoader());
