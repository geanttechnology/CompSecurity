...
class this._cls0 extends Animation
{
    ...
    {
        transformation = (android.widget..LayoutParams)SearchView.access$0(SearchView.this).getLayoutParams();
        float f1 = Utility.dpToPixel(SearchView.access$8(SearchView.this), 50F - 50F * f);
        ...
        transformation = (android.widget..LayoutParams)SearchView.access$1(SearchView.this).getLayoutParams();
