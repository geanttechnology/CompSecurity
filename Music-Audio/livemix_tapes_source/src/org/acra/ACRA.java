...
//            ACRAConfigurationException, ReportingInteractionMode, ACRAConfiguration, ErrorReporter
...
_L5:
    ...
    public static void init(Application application)
    {
        ...
        try
        {
            ErrorReporter errorreporter = new ErrorReporter(mApplication, application, flag);
