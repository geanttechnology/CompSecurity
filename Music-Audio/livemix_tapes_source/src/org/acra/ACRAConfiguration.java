...
//            ReportField, ReportingInteractionMode, ACRAConfigurationException, ACRA
    ...
    implements ReportsCrashes
{
    ...
    private org.acra.sender.HttpSender.Method mHttpMethod;
    ...
    private org.acra.sender.HttpSender.Type mReportType;
    ...
    public org.acra.sender.HttpSender.Method httpMethod()
    {
        if (mHttpMethod != null)
        {
            return mHttpMethod;
        ...
        {
            return org.acra.sender.HttpSender.Method.POST;
        }
    }
    ...
    public org.acra.sender.HttpSender.Type reportType()
    {
        if (mReportType != null)
        {
            return mReportType;
        ...
        {
            return org.acra.sender.HttpSender.Type.FORM;
        }
    }
    ...
    public void setHttpMethod(org.acra.sender.HttpSender.Method method)
    {
        mHttpMethod = method;
    }
    ...
    public void setReportType(org.acra.sender.HttpSender.Type type)
    {
        mReportType = type;
    }
