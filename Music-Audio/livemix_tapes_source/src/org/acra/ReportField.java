...
public class ReportField extends Enum
{
    ...
    static 
    {
        ...
        SETTINGS_GLOBAL = new ReportField("SETTINGS_GLOBAL", 33) {
        ...
        SHARED_PREFERENCES = new ReportField("SHARED_PREFERENCES", 34) {
        ...
        $VALUES = (new ReportField[] {
            ...
            ENVIRONMENT, SETTINGS_SYSTEM, SETTINGS_SECURE, SETTINGS_GLOBAL, SHARED_PREFERENCES, APPLICATION_LOG, MEDIA_CODEC_LIST, THREAD_DETAILS, USER_IP
        });
    }
}
