...
class LogCatCollector
{
    ...
    public static String collectLogCat(String s)
    {
        ...
        obj1 = Runtime.getRuntime().exec((String[])((List) (obj)).toArray(new String[((List) (obj)).size()]));
        obj = new BufferedReader(new InputStreamReader(((Process) (obj1)).getInputStream()), 8192);
        Log.d(ACRA.LOG_TAG, "Retrieving logcat output...");
        (new Thread(new Runnable(((Process) (obj1))) {
