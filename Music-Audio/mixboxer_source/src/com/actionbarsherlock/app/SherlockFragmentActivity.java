...
public class SherlockFragmentActivity extends Watson
    implements com.actionbarsherlock.ActionBarSherlock.OnActionModeFinishedListener, com.actionbarsherlock.ActionBarSherlock.OnActionModeStartedListener
{
    ...
    public final boolean onCreatePanelMenu(int i, Menu menu)
    {
        ...
        if (i == 0 && !mIgnoreNativeCreate)
        {
            ...
            mIgnoreNativeCreate = false;
            (new StringBuilder()).append("[onCreatePanelMenu] returning ").append(flag).toString();
            return flag;
        } else
        {
    ...
    public final boolean onMenuItemSelected(int i, MenuItem menuitem)
    {
        ...
        if (i == 0 && !mIgnoreNativeSelected)
        {
            ...
            mIgnoreNativeSelected = false;
            (new StringBuilder()).append("[onMenuItemSelected] returning ").append(flag).toString();
            return flag;
        } else
        {
