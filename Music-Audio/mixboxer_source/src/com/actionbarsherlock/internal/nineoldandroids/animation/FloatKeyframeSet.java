...
class FloatKeyframeSet extends KeyframeSet
{
    ...
    public float getFloatValue(float f)
    {
        ...
        Keyframe.FloatKeyframe floatkeyframe3;
        for (Keyframe.FloatKeyframe floatkeyframe = (Keyframe.FloatKeyframe)mKeyframes.get(0); i < mNumKeyframes; floatkeyframe = floatkeyframe3)
        {
            floatkeyframe3 = (Keyframe.FloatKeyframe)mKeyframes.get(i);
