    ...
    implements Cloneable
{
    ...
    private Method getPropertyFunction(Class class1, String s, Class class2)
    {
        ...
        if (class2 == null)
        {
            ...
            {
                (new StringBuilder()).append(class1.getSimpleName()).append(" - ").append("Couldn't find no-arg method for property ").append(mPropertyName).append(": ").append(s).toString();
                return null;
            }
            return s;
        }
...
_L1:
        (new StringBuilder()).append("Couldn't find ").append(s).append("ter property ").append(mPropertyName).append(" for ").append(class1.getSimpleName()).append(" with value type ").append(mValueType).toString();
        return method;
...
_L3:
    ...
    private void setupValue(Object obj, Keyframe keyframe)
    {
        ...
        {
            ((InvocationTargetException) (obj)).toString();
            return;
        }
        // Misplaced declaration of an exception variable
        catch (Object obj)
        {
            ((IllegalAccessException) (obj)).toString();
        }
    }
    ...
    private class IntPropertyValuesHolder extends PropertyValuesHolder
    {
