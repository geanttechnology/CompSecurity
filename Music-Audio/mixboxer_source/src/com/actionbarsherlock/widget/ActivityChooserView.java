...
_L4:
            View view1 = view;
            if (view.getId() == com.actionbarsherlock.R.id.abs__list_item) goto _L6; else goto _L5
_L5:
...
_L6:
            ...
            ((TextView)view1.findViewById(com.actionbarsherlock.R.id.abs__title)).setText(((ResolveInfo) (obj)).loadLabel(view));
            obj = view1;
