    ...
    implements CollapsibleActionView
{
    ...
    private void adjustDropDownSizeAndPosition()
    {
        if (mDropDownAnchor.getWidth() > 1)
        {
            ...
            {
                i = ((Resources) (obj)).getDimensionPixelSize(com.actionbarsherlock.R.dimen.abs__dropdownitem_icon_width);
                i = ((Resources) (obj)).getDimensionPixelSize(com.actionbarsherlock.R.dimen.abs__dropdownitem_text_padding_left) + i;
            } else
            {
                i = 0;
            }
            ...
            l = rect.left;
            ((SearchAutoComplete) (obj)).setDropDownWidth((i + (rect.right + (k + l))) - j);
        }
    }
...
_L6:
    ...
    private void launchIntent(Intent intent)
    {
        ...
        {
            (new StringBuilder()).append("Failed launch activity: ").append(intent).toString();
        }
    }
