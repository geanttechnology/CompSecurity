    ...
    implements android.view.View.OnClickListener
{
    ...
    private Drawable getDrawable(Uri uri)
    {
        ...
        {
            (new StringBuilder()).append("Icon not found: ").append(uri).append(", ").append(((FileNotFoundException) (obj1)).getMessage()).toString();
        }
        return null;
        ...
        return drawable;
        obj1;
        (new StringBuilder()).append("Error closing icon stream for ").append(uri).toString();
        return drawable;
        Exception exception;
        exception;
        ((InputStream) (obj1)).close();
...
_L2:
        ...
        continue; /* Loop/switch isn't completed */
        drawable;
        (new StringBuilder()).append("Icon resource not found: ").append(s).toString();
        return null;
...
_L3:
    ...
    public CharSequence convertToString(Cursor cursor)
    {
        if (cursor != null)
        {
            if ((cursor = getColumnString(cursor, "suggest_intent_query")) != null)
            {
                return cursor;
            }
        }
    ...
    public Cursor getSuggestions(String s, int i)
    {
        ...
        if (mSearchable != null)
        {
            if ((obj = mSearchable.getSuggestAuthority()) != null)
            {
                ...
                as = builder.build();
                return mContext.getContentResolver().query(as, null, s1, s, null);
            }
        }
        return null;
    }
