...
_L5:
    ...
    private class WebViewAuthHandler extends AuthHandler
    {
        ...
        boolean tryAuthorize(final AuthorizationRequest request)
        {
            ...
            request = new _cls1();
            loginDialog = ((com.facebook.widget.WebDialog.Builder)(new AuthDialogBuilder(getStartActivityDelegate().getActivityContext(), s, bundle)).setOnCompleteListener(request)).build();
            loginDialog.show();
            return true;
        }
