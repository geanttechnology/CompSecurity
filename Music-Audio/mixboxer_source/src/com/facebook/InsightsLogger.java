...
//            AccessToken, NonCachingTokenCachingStrategy
...
public class InsightsLogger
{
    ...
    private Session sessionToLogTo()
    {
        ...
        if (appAuthSession == null)
        {
            ...
            session1 = new Session(null, applicationId, new NonCachingTokenCachingStrategy(), false);
            appAuthSession = session1;
            session1.open(accesstoken, null);
        }
