...
label0:
        ...
        if (obj3 != null)
        {
            obj1 = ((Session) (obj3)).getPermissions();
        } else
        ...
        exception = (new com.facebook.Session.Builder(pendingAuthorizationActivity)).setApplicationId(mAppId).setTokenCachingStrategy(getTokenCache()).build();
        if (exception.getState() != SessionState.CREATED_TOKEN_LOADED)
        {
            return null;
        }
        obj3 = (new com.facebook.Session.OpenRequest(pendingAuthorizationActivity)).setPermissions(((List) (obj1)));
        boolean flag;
        ...
        openSession(exception, ((com.facebook.Session.OpenRequest) (obj3)), flag);
        obj3 = lock;
        obj3;
...
*/
    ...
    private class SetterTokenCachingStrategy extends TokenCachingStrategy
    {
        ...
        SetterTokenCachingStrategy(_cls1 _pcls1)
        {
            this();
        }
    }
    ...
    {
        private class TokenRefreshConnectionHandler extends Handler
        {
            ...
            TokenRefreshConnectionHandler(TokenRefreshServiceConnection tokenrefreshserviceconnection)
            {
                facebookWeakReference = new WeakReference(Facebook.this);
        ...
        public TokenRefreshServiceConnection(Context context, ServiceListener servicelistener)
        {
            this$0 = Facebook.this;
            super();
            messageReceiver = new Messenger(new TokenRefreshConnectionHandler(this));
            messageSender = null;
