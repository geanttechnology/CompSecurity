...
_L7:
    ...
    public static String openUrl(String s, String s1, Bundle bundle)
    {
        ...
        if (s1.equals("GET"))
        {
            s2 = (new StringBuilder()).append(s).append("?").append(encodeUrl(bundle)).toString();
        }
        Utility.logd("Facebook-Util", (new StringBuilder()).append(s1).append(" URL: ").append(s2).toString());
