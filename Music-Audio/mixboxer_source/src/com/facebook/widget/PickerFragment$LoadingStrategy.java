...
abstract class this._cls0
{
    ...
    public void attach(GraphObjectAdapter graphobjectadapter)
    {
            ...
            implements GraphObjectPagingLoader.OnErrorListener
        {
            ...
            {
                hideActivityCircle();
                if (PickerFragment.access$400(this$0) != null)
                {
                    PickerFragment.access$400(this$0).onError(this$0, facebookexception);
                }
            }
    ...
    {
        return new GraphObjectPagingLoader(getActivity(), PickerFragment.access$500(PickerFragment.this));
    }
