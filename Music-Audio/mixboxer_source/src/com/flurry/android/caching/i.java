    ...
    implements AppCloudResponseHandler
{
        ...
        throws Exception
    {
        if (appcloudresponse != null)
        {
            ...
            {
                Log.d("Trestle", (new StringBuilder()).append("increment object").append(appcloudresponse.toString()).toString());
                b.a(fo).it = 701;
            } else
            {
                Log.d("Trestle", (new StringBuilder()).append("increment object Fail: ").append(appcloudresponse.getResponseMessage().toString()).toString());
                b.a(fo).it = 731;
            }
