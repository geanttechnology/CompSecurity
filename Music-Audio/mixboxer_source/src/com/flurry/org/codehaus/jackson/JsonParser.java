    ...
    implements Closeable, Versioned
{
    public static final class Feature extends Enum
    {
        ...
        {
            return (Feature)Enum.valueOf(com/flurry/org/codehaus/jackson/JsonParser$Feature, s);
        }
    ...
    public static final class NumberType extends Enum
    {
        ...
        {
            return (NumberType)Enum.valueOf(com/flurry/org/codehaus/jackson/JsonParser$NumberType, s);
        }
