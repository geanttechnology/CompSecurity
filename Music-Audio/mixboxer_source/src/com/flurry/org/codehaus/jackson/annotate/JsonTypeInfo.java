    ...
    extends Annotation
{
    public static final class As extends Enum
    {
        ...
        {
            return (As)Enum.valueOf(com/flurry/org/codehaus/jackson/annotate/JsonTypeInfo$As, s);
        }
    ...
    public static final class Id extends Enum
    {
        ...
        {
            return (Id)Enum.valueOf(com/flurry/org/codehaus/jackson/annotate/JsonTypeInfo$Id, s);
        }
