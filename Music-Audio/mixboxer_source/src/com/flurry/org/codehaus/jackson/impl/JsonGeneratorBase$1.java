...
static class 
{
    ...
    static 
    {
        ...
        $SwitchMap$org$codehaus$jackson$JsonParser$NumberType = new int[com.flurry.org.codehaus.jackson.e.values().length];
        try
        {
            $SwitchMap$org$codehaus$jackson$JsonParser$NumberType[com.flurry.org.codehaus.jackson.e.INT.ordinal()] = 1;
        }
        catch (NoSuchFieldError nosuchfielderror3) { }
        try
        {
            $SwitchMap$org$codehaus$jackson$JsonParser$NumberType[com.flurry.org.codehaus.jackson.e.BIG_INTEGER.ordinal()] = 2;
        }
        catch (NoSuchFieldError nosuchfielderror2) { }
        try
        {
            $SwitchMap$org$codehaus$jackson$JsonParser$NumberType[com.flurry.org.codehaus.jackson.e.BIG_DECIMAL.ordinal()] = 3;
        }
        catch (NoSuchFieldError nosuchfielderror1) { }
        try
        {
            $SwitchMap$org$codehaus$jackson$JsonParser$NumberType[com.flurry.org.codehaus.jackson.e.FLOAT.ordinal()] = 4;
        }
