...
label0:
    ...
    {
        while (isEnabled(com.flurry.org.codehaus.jackson.JsonParser.Feature.ALLOW_BACKSLASH_ESCAPING_ANY_CHARACTER) || c == '\'' && isEnabled(com.flurry.org.codehaus.jackson.JsonParser.Feature.ALLOW_SINGLE_QUOTES)) 
        {
            return c;
        }
    ...
    protected void _throwUnquotedSpace(int i, String s)
        throws JsonParseException
    {
        if (!isEnabled(com.flurry.org.codehaus.jackson.JsonParser.Feature.ALLOW_UNQUOTED_CONTROL_CHARS) || i >= 32)
        {
            i = (char)i;
