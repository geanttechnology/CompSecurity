...
public class Utf8Generator extends JsonGeneratorBase
{
    ...
    public Utf8Generator(IOContext iocontext, int i, ObjectCodec objectcodec, OutputStream outputstream)
    {
        ...
        if (isEnabled(com.flurry.org.codehaus.jackson.JsonGenerator.Feature.ESCAPE_NON_ASCII))
        {
...
_L2:
        ...
        throws IOException, JsonGenerationException
    {
        ...
        if (!isEnabled(com.flurry.org.codehaus.jackson.JsonGenerator.Feature.QUOTE_FIELD_NAMES))
        {
        ...
        throws IOException, JsonGenerationException
    {
        ...
        flag = isEnabled(com.flurry.org.codehaus.jackson.JsonGenerator.Feature.QUOTE_FIELD_NAMES);
        if (flag)
        {
            if (_outputTail >= _outputEnd)
            {
    ...
    {
        super.close();
        if (_outputBuffer != null && isEnabled(com.flurry.org.codehaus.jackson.JsonGenerator.Feature.AUTO_CLOSE_JSON_CONTENT))
        {
            do
            {
...
_L1:
        if (!_ioContext.isResourceManaged() && !isEnabled(com.flurry.org.codehaus.jackson.JsonGenerator.Feature.AUTO_CLOSE_TARGET)) goto _L4; else goto _L3
_L3:
        _outputStream.close();
_L2:
        _releaseBuffers();
        return;
_L4:
        if (isEnabled(com.flurry.org.codehaus.jackson.JsonGenerator.Feature.FLUSH_PASSED_TO_STREAM))
        {
            _outputStream.flush();
        }
...
_L5:
    ...
    {
        _flushBuffer();
        if (_outputStream != null && isEnabled(com.flurry.org.codehaus.jackson.JsonGenerator.Feature.FLUSH_PASSED_TO_STREAM))
        {
            _outputStream.flush();
        }
    }
    ...
    public void writeNumber(double d)
        throws IOException, JsonGenerationException
    {
        if (_cfgNumbersAsStrings || (Double.isNaN(d) || Double.isInfinite(d)) && isEnabled(com.flurry.org.codehaus.jackson.JsonGenerator.Feature.QUOTE_NON_NUMERIC_NUMBERS))
        {
    ...
    public void writeNumber(float f)
        throws IOException, JsonGenerationException
    {
        if (_cfgNumbersAsStrings || (Float.isNaN(f) || Float.isInfinite(f)) && isEnabled(com.flurry.org.codehaus.jackson.JsonGenerator.Feature.QUOTE_NON_NUMERIC_NUMBERS))
        {
