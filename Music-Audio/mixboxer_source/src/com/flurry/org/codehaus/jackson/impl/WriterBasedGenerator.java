...
_L7:
        ...
        throws IOException, JsonGenerationException
    {
        ...
        int l1;
        ai = _outputEscapes;
        l1 = Math.min(ai.length, _maximumNonEscapedChar + 1);
        l = 0;
        k = 0;
        i1 = 0;
_L12:
...
label0:
        ...
        throws IOException, JsonGenerationException
    {
        ...
        k = _outputTail + i;
        ai = _outputEscapes;
        l = Math.min(ai.length, _maximumNonEscapedChar + 1);
_L8:
...
_L5:
    ...
    {
        _flushBuffer();
        if (_writer != null && isEnabled(com.flurry.org.codehaus.jackson.JsonGenerator.Feature.FLUSH_PASSED_TO_STREAM))
        {
            _writer.flush();
        }
    }
