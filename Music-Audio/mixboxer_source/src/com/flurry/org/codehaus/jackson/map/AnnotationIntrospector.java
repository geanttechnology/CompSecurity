...
label0:
            {
                ...
                {
                    class1 = class2;
                    if (class2 != com/flurry/org/codehaus/jackson/map/JsonDeserializer$None)
                    {
                        break label0;
                    }
                }
...
label0:
            {
                ...
                {
                    class1 = class2;
                    if (class2 != com/flurry/org/codehaus/jackson/map/KeyDeserializer$None)
                    {
                        break label0;
                    }
                }
...
label0:
        ...
        {
            com.flurry.org.codehaus.jackson.map.annotate.JsonSerialize.Typing typing1 = _primary.findSerializationTyping(annotated);
            com.flurry.org.codehaus.jackson.map.annotate.JsonSerialize.Typing typing = typing1;
            if (typing1 == null)
            {
...
label0:
    ...
    public static final class ReferenceProperty.Type extends Enum
    {
        ...
        {
            return (ReferenceProperty.Type)Enum.valueOf(com/flurry/org/codehaus/jackson/map/AnnotationIntrospector$ReferenceProperty$Type, s);
        }
    ...
    public abstract com.flurry.org.codehaus.jackson.map.annotate.JsonSerialize.Typing findSerializationTyping(Annotated annotated);
