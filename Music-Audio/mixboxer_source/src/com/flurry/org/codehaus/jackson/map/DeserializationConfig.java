...
public class DeserializationConfig extends MapperConfig.Impl
{
        ...
        implements MapperConfig.ConfigFeature
    {
        ...
        {
            return (Feature)Enum.valueOf(com/flurry/org/codehaus/jackson/map/DeserializationConfig$Feature, s);
        }
    ...
    {
        super(classintrospector, annotationintrospector, visibilitychecker, subtyperesolver, propertynamingstrategy, typefactory, handlerinstantiator, collectFeatureDefaults(com/flurry/org/codehaus/jackson/map/DeserializationConfig$Feature));
    ...
    public VisibilityChecker getDefaultVisibilityChecker()
    {
        ...
        {
            visibilitychecker = visibilitychecker1.withSetterVisibility(com.flurry.org.codehaus.jackson.annotate.JsonAutoDetect.Visibility.NONE);
        }
        visibilitychecker1 = visibilitychecker;
        if (!isEnabled(Feature.AUTO_DETECT_CREATORS))
        {
            visibilitychecker1 = visibilitychecker.withCreatorVisibility(com.flurry.org.codehaus.jackson.annotate.JsonAutoDetect.Visibility.NONE);
        }
    ...
    public DeserializationConfig withVisibility(JsonMethod jsonmethod, com.flurry.org.codehaus.jackson.annotate.JsonAutoDetect.Visibility visibility)
    {
