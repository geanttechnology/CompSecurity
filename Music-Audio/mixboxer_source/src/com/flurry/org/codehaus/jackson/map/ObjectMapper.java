...
_L6:
    ...
    public static final class DefaultTyping extends Enum
    {
        ...
        {
            return (DefaultTyping)Enum.valueOf(com/flurry/org/codehaus/jackson/map/ObjectMapper$DefaultTyping, s);
        }
    ...
    private static final JavaType JSON_NODE_TYPE = SimpleType.constructUnsafe(com/flurry/org/codehaus/jackson/JsonNode);
    protected static final VisibilityChecker STD_VISIBILITY_CHECKER = com.flurry.org.codehaus.jackson.map.introspect.VisibilityChecker.Std.defaultInstance();
...
label0:
    ...
    public ObjectMapper configure(com.flurry.org.codehaus.jackson.JsonGenerator.Feature feature, boolean flag)
    {
        _jsonFactory.configure(feature, flag);
        return this;
    }

    public ObjectMapper configure(com.flurry.org.codehaus.jackson.JsonParser.Feature feature, boolean flag)
    {
        _jsonFactory.configure(feature, flag);
        return this;
    }
    ...
    {
        return enableDefaultTyping(defaulttyping, com.flurry.org.codehaus.jackson.annotate.JsonTypeInfo.As.WRAPPER_ARRAY);
    }

    public ObjectMapper enableDefaultTyping(DefaultTyping defaulttyping, com.flurry.org.codehaus.jackson.annotate.JsonTypeInfo.As as)
    {
        return setDefaultTyping((new DefaultTypeResolverBuilder(defaulttyping)).init(com.flurry.org.codehaus.jackson.annotate.JsonTypeInfo.Id.CLASS, null).inclusion(as));
    }

    public ObjectMapper enableDefaultTypingAsProperty(DefaultTyping defaulttyping, String s)
    {
        return setDefaultTyping((new DefaultTypeResolverBuilder(defaulttyping)).init(com.flurry.org.codehaus.jackson.annotate.JsonTypeInfo.Id.CLASS, null).inclusion(com.flurry.org.codehaus.jackson.annotate.JsonTypeInfo.As.PROPERTY).typeProperty(s));
    }
    ...
    public boolean isEnabled(com.flurry.org.codehaus.jackson.JsonGenerator.Feature feature)
    {
        return _jsonFactory.isEnabled(feature);
    }

    public boolean isEnabled(com.flurry.org.codehaus.jackson.JsonParser.Feature feature)
    {
        return _jsonFactory.isEnabled(feature);
    }
    ...
    public ObjectMapper setSerializationInclusion(com.flurry.org.codehaus.jackson.map.annotate.JsonSerialize.Inclusion inclusion)
    {
    ...
    public ObjectMapper setVisibility(JsonMethod jsonmethod, com.flurry.org.codehaus.jackson.annotate.JsonAutoDetect.Visibility visibility)
    {
