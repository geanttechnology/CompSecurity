...
public class SerializationConfig extends MapperConfig.Impl
{
        ...
        implements MapperConfig.ConfigFeature
    {
        ...
        {
            return (Feature)Enum.valueOf(com/flurry/org/codehaus/jackson/map/SerializationConfig$Feature, s);
        }
    ...
    protected com.flurry.org.codehaus.jackson.map.annotate.JsonSerialize.Inclusion _serializationInclusion;
    ...
    {
        super(classintrospector, annotationintrospector, visibilitychecker, subtyperesolver, propertynamingstrategy, typefactory, handlerinstantiator, collectFeatureDefaults(com/flurry/org/codehaus/jackson/map/SerializationConfig$Feature));
    ...
    protected SerializationConfig(SerializationConfig serializationconfig, com.flurry.org.codehaus.jackson.map.annotate.JsonSerialize.Inclusion inclusion)
    {
        super(serializationconfig);
        _serializationInclusion = null;
        _serializationInclusion = inclusion;
        if (inclusion == com.flurry.org.codehaus.jackson.map.annotate.JsonSerialize.Inclusion.NON_NULL)
        {
    ...
    public void fromAnnotations(Class class1)
    {
        ...
        com.flurry.org.codehaus.jackson.map.annotate.JsonSerialize.Inclusion inclusion = annotationintrospector.findSerializationInclusion(class1, null);
        ...
        if (class1 != null)
        {
            ...
            boolean flag;
            if (class1 == com.flurry.org.codehaus.jackson.map.annotate.JsonSerialize.Typing.STATIC)
            {
                flag = true;
            } else
            {
    ...
    public VisibilityChecker getDefaultVisibilityChecker()
    {
        ...
        {
            visibilitychecker = visibilitychecker1.withGetterVisibility(com.flurry.org.codehaus.jackson.annotate.JsonAutoDetect.Visibility.NONE);
        }
        visibilitychecker1 = visibilitychecker;
        if (!isEnabled(Feature.AUTO_DETECT_IS_GETTERS))
        {
            visibilitychecker1 = visibilitychecker.withIsGetterVisibility(com.flurry.org.codehaus.jackson.annotate.JsonAutoDetect.Visibility.NONE);
        }
        visibilitychecker = visibilitychecker1;
        if (!isEnabled(Feature.AUTO_DETECT_FIELDS))
        {
            visibilitychecker = visibilitychecker1.withFieldVisibility(com.flurry.org.codehaus.jackson.annotate.JsonAutoDetect.Visibility.NONE);
        }
    ...
    public com.flurry.org.codehaus.jackson.map.annotate.JsonSerialize.Inclusion getSerializationInclusion()
    {
    ...
    public void setSerializationInclusion(com.flurry.org.codehaus.jackson.map.annotate.JsonSerialize.Inclusion inclusion)
    {
        _serializationInclusion = inclusion;
        if (inclusion == com.flurry.org.codehaus.jackson.map.annotate.JsonSerialize.Inclusion.NON_NULL)
        {
    ...
    public SerializationConfig withSerializationInclusion(com.flurry.org.codehaus.jackson.map.annotate.JsonSerialize.Inclusion inclusion)
    {
    ...
    public volatile MapperConfig withVisibility(JsonMethod jsonmethod, com.flurry.org.codehaus.jackson.annotate.JsonAutoDetect.Visibility visibility)
    {
        return withVisibility(jsonmethod, visibility);
    }

    public SerializationConfig withVisibility(JsonMethod jsonmethod, com.flurry.org.codehaus.jackson.annotate.JsonAutoDetect.Visibility visibility)
    {
