    ...
    extends Annotation
{
    public static final class Inclusion extends Enum
    {
        ...
        {
            return (Inclusion)Enum.valueOf(com/flurry/org/codehaus/jackson/map/annotate/JsonSerialize$Inclusion, s);
        }
    ...
    public static final class Typing extends Enum
    {
        ...
        {
            return (Typing)Enum.valueOf(com/flurry/org/codehaus/jackson/map/annotate/JsonSerialize$Typing, s);
        }
