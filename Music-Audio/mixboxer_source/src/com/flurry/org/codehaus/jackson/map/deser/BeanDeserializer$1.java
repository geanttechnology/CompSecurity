...
static class 
{
    ...
    static 
    {
        $SwitchMap$org$codehaus$jackson$JsonParser$NumberType = new int[com.flurry.org.codehaus.jackson.pe.values().length];
        try
        {
            $SwitchMap$org$codehaus$jackson$JsonParser$NumberType[com.flurry.org.codehaus.jackson.pe.INT.ordinal()] = 1;
        }
        catch (NoSuchFieldError nosuchfielderror12) { }
        try
        {
            $SwitchMap$org$codehaus$jackson$JsonParser$NumberType[com.flurry.org.codehaus.jackson.pe.LONG.ordinal()] = 2;
        }
        catch (NoSuchFieldError nosuchfielderror11) { }
        try
        {
            $SwitchMap$org$codehaus$jackson$JsonParser$NumberType[com.flurry.org.codehaus.jackson.pe.FLOAT.ordinal()] = 3;
        }
        catch (NoSuchFieldError nosuchfielderror10) { }
        try
        {
            $SwitchMap$org$codehaus$jackson$JsonParser$NumberType[com.flurry.org.codehaus.jackson.pe.DOUBLE.ordinal()] = 4;
        }
