...
_L3:
        ...
        throws JsonMappingException
    {
        if (_valueInstantiator.canCreateUsingDelegate())
        {
            ...
            _delegateDeserializer = findDeserializer(deserializationconfig, deserializerprovider, javatype, new com.flurry.org.codehaus.jackson.map.BeanProperty.Std(null, javatype, null, _valueInstantiator.getDelegateCreator()));
        }
    }
}
