...
public class PrimitiveArrayDeserializers
{
    ...
    static final class BooleanDeser extends Base
    {
        ...
        private final boolean[] handleNonArray(JsonParser jsonparser, DeserializationContext deserializationcontext)
            throws IOException, JsonProcessingException
        {
            if (jsonparser.getCurrentToken() == JsonToken.VALUE_STRING && deserializationcontext.isEnabled(com.flurry.org.codehaus.jackson.map.DeserializationConfig.Feature.ACCEPT_EMPTY_STRING_AS_NULL_OBJECT) && jsonparser.getText().length() == 0)
            {
                return null;
            }
            if (!deserializationcontext.isEnabled(com.flurry.org.codehaus.jackson.map.DeserializationConfig.Feature.ACCEPT_SINGLE_VALUE_AS_ARRAY))
            {
            ...
            throws IOException, JsonProcessingException
        {
            ...
            com.flurry.org.codehaus.jackson.map.util.ArrayBuilders.BooleanBuilder booleanbuilder = deserializationcontext.getArrayBuilders().getBooleanBuilder();
    ...
    static final class ByteDeser extends Base
    {
            ...
            throws IOException, JsonProcessingException
        {
            ...
            com.flurry.org.codehaus.jackson.map.util.ArrayBuilders.ByteBuilder bytebuilder = deserializationcontext.getArrayBuilders().getByteBuilder();
    ...
    static final class DoubleDeser extends Base
    {
            ...
            throws IOException, JsonProcessingException
        {
            ...
            com.flurry.org.codehaus.jackson.map.util.ArrayBuilders.DoubleBuilder doublebuilder = deserializationcontext.getArrayBuilders().getDoubleBuilder();
    ...
    static final class FloatDeser extends Base
    {
            ...
            throws IOException, JsonProcessingException
        {
            ...
            com.flurry.org.codehaus.jackson.map.util.ArrayBuilders.FloatBuilder floatbuilder = deserializationcontext.getArrayBuilders().getFloatBuilder();
    ...
    static final class IntDeser extends Base
    {
            ...
            throws IOException, JsonProcessingException
        {
            ...
            com.flurry.org.codehaus.jackson.map.util.ArrayBuilders.IntBuilder intbuilder = deserializationcontext.getArrayBuilders().getIntBuilder();
    ...
    static final class LongDeser extends Base
    {
            ...
            throws IOException, JsonProcessingException
        {
            ...
            com.flurry.org.codehaus.jackson.map.util.ArrayBuilders.LongBuilder longbuilder = deserializationcontext.getArrayBuilders().getLongBuilder();
    ...
    static final class ShortDeser extends Base
    {
            ...
            throws IOException, JsonProcessingException
        {
            ...
            com.flurry.org.codehaus.jackson.map.util.ArrayBuilders.ShortBuilder shortbuilder = deserializationcontext.getArrayBuilders().getShortBuilder();
