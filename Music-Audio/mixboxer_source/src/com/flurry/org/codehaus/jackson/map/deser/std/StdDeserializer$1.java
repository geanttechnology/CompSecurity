...
static class 
{
    ...
    static 
    {
        $SwitchMap$org$codehaus$jackson$JsonParser$NumberType = new int[com.flurry.org.codehaus.jackson.ype.values().length];
        try
        {
            $SwitchMap$org$codehaus$jackson$JsonParser$NumberType[com.flurry.org.codehaus.jackson.ype.INT.ordinal()] = 1;
        }
        catch (NoSuchFieldError nosuchfielderror4) { }
        try
        {
            $SwitchMap$org$codehaus$jackson$JsonParser$NumberType[com.flurry.org.codehaus.jackson.ype.LONG.ordinal()] = 2;
        }
