...
public static final class  extends StdScalarDeserializer
{
        ...
        throws IOException, JsonProcessingException
    {
        ...
        {
            if (deserializationcontext.isEnabled(com.flurry.org.codehaus.jackson.map.IG_INTEGER_FOR_INTS))
            {
        ...
        {
            if (deserializationcontext.isEnabled(com.flurry.org.codehaus.jackson.map.IG_DECIMAL_FOR_FLOATS))
            {
