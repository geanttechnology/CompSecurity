...
public final class AnnotatedClass extends Annotated
{
    ...
    protected final com.flurry.org.codehaus.jackson.map.ClassIntrospector.MixInResolver _mixInResolver;
    protected final Class _primaryMixIn;
    protected final List _superTypes;

    private AnnotatedClass(Class class1, List list, AnnotationIntrospector annotationintrospector, com.flurry.org.codehaus.jackson.map.ClassIntrospector.MixInResolver mixinresolver, AnnotationMap annotationmap)
    {
        _class = class1;
        _superTypes = list;
...
_L3:
    ...
    public static AnnotatedClass construct(Class class1, AnnotationIntrospector annotationintrospector, com.flurry.org.codehaus.jackson.map.ClassIntrospector.MixInResolver mixinresolver)
    {
    ...
    public static AnnotatedClass constructWithoutSuperTypes(Class class1, AnnotationIntrospector annotationintrospector, com.flurry.org.codehaus.jackson.map.ClassIntrospector.MixInResolver mixinresolver)
    {
...
label0:
    ...
    public void resolveMemberMethods(MethodFilter methodfilter)
    {
        ...
        if (_mixInResolver != null)
        {
            ...
            if (class2 != null)
            {
                _addMethodMixIns(methodfilter, _memberMethods, class2, ((AnnotatedMethodMap) (obj)));
            }
        }
