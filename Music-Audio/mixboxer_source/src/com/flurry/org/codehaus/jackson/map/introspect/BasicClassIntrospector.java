...
public class BasicClassIntrospector extends ClassIntrospector
{
    ...
    public AnnotatedClass classWithCreators(MapperConfig mapperconfig, JavaType javatype, com.flurry.org.codehaus.jackson.map.ClassIntrospector.MixInResolver mixinresolver)
    {
    ...
    public POJOPropertiesCollector collectProperties(MapperConfig mapperconfig, JavaType javatype, com.flurry.org.codehaus.jackson.map.ClassIntrospector.MixInResolver mixinresolver, boolean flag)
    {
    ...
    public volatile BeanDescription forClassAnnotations(MapperConfig mapperconfig, JavaType javatype, com.flurry.org.codehaus.jackson.map.ClassIntrospector.MixInResolver mixinresolver)
    {
        return forClassAnnotations(mapperconfig, javatype, mixinresolver);
    }

    public BasicBeanDescription forClassAnnotations(MapperConfig mapperconfig, JavaType javatype, com.flurry.org.codehaus.jackson.map.ClassIntrospector.MixInResolver mixinresolver)
    {
        boolean flag = mapperconfig.isAnnotationProcessingEnabled();
        com.flurry.org.codehaus.jackson.map.AnnotationIntrospector annotationintrospector = mapperconfig.getAnnotationIntrospector();
    ...
    public volatile BeanDescription forCreation(DeserializationConfig deserializationconfig, JavaType javatype, com.flurry.org.codehaus.jackson.map.ClassIntrospector.MixInResolver mixinresolver)
    {
        return forCreation(deserializationconfig, javatype, mixinresolver);
    }

    public BasicBeanDescription forCreation(DeserializationConfig deserializationconfig, JavaType javatype, com.flurry.org.codehaus.jackson.map.ClassIntrospector.MixInResolver mixinresolver)
    {
    ...
    public volatile BeanDescription forDeserialization(DeserializationConfig deserializationconfig, JavaType javatype, com.flurry.org.codehaus.jackson.map.ClassIntrospector.MixInResolver mixinresolver)
    {
        return forDeserialization(deserializationconfig, javatype, mixinresolver);
    }

    public BasicBeanDescription forDeserialization(DeserializationConfig deserializationconfig, JavaType javatype, com.flurry.org.codehaus.jackson.map.ClassIntrospector.MixInResolver mixinresolver)
    {
        BasicBeanDescription basicbeandescription1 = _findCachedDesc(javatype);
        BasicBeanDescription basicbeandescription = basicbeandescription1;
        if (basicbeandescription1 == null)
    ...
    public volatile BeanDescription forDirectClassAnnotations(MapperConfig mapperconfig, JavaType javatype, com.flurry.org.codehaus.jackson.map.ClassIntrospector.MixInResolver mixinresolver)
    {
        return forDirectClassAnnotations(mapperconfig, javatype, mixinresolver);
    }

    public BasicBeanDescription forDirectClassAnnotations(MapperConfig mapperconfig, JavaType javatype, com.flurry.org.codehaus.jackson.map.ClassIntrospector.MixInResolver mixinresolver)
    {
        boolean flag = mapperconfig.isAnnotationProcessingEnabled();
        com.flurry.org.codehaus.jackson.map.AnnotationIntrospector annotationintrospector = mapperconfig.getAnnotationIntrospector();
        Class class1 = javatype.getRawClass();
    ...
    public volatile BeanDescription forSerialization(SerializationConfig serializationconfig, JavaType javatype, com.flurry.org.codehaus.jackson.map.ClassIntrospector.MixInResolver mixinresolver)
    {
        return forSerialization(serializationconfig, javatype, mixinresolver);
    }

    public BasicBeanDescription forSerialization(SerializationConfig serializationconfig, JavaType javatype, com.flurry.org.codehaus.jackson.map.ClassIntrospector.MixInResolver mixinresolver)
    {
        BasicBeanDescription basicbeandescription1 = _findCachedDesc(javatype);
        BasicBeanDescription basicbeandescription = basicbeandescription1;
        if (basicbeandescription1 == null)
    ...
    {
        if (deserializationconfig.isEnabled(com.flurry.org.codehaus.jackson.map.DeserializationConfig.Feature.USE_GETTERS_AS_SETTERS))
        {
