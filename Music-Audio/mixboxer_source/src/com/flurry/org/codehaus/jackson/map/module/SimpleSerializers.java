...
public class SimpleSerializers extends com.flurry.org.codehaus.jackson.map.Serializers.Base
{
...
_L4:
    ...
    public void addSerializer(JsonSerializer jsonserializer)
    {
        ...
        {
            throw new IllegalArgumentException((new StringBuilder()).append("JsonSerializer of type ").append(jsonserializer.getClass().getName()).append(" does not define valid handledType() -- must either register with method that takes type argument ").append(" or make serializer extend 'org.codehaus.jackson.map.ser.std.SerializerBase'").toString());
        } else
        {
