...
label0:
        {
            ...
            {
                class1 = class2;
                if (class2 != com/flurry/org/codehaus/jackson/map/JsonSerializer$None)
                {
                    break label0;
                }
            }
        ...
        if (class1 != null && class1 != com/flurry/org/codehaus/jackson/map/JsonSerializer$None)
        {
...
label0:
    ...
    protected JsonSerializer buildArraySerializer(SerializationConfig serializationconfig, ArrayType arraytype, BasicBeanDescription basicbeandescription, BeanProperty beanproperty, boolean flag, TypeSerializer typeserializer, JsonSerializer jsonserializer)
    {
        ...
        {
            serializationconfig = new com.flurry.org.codehaus.jackson.map.ser.std.StdArraySerializers.StringArraySerializer(beanproperty);
        } else
        {
    ...
    {
        com.flurry.org.codehaus.jackson.map.introspect.AnnotatedClass annotatedclass = ((BasicBeanDescription)serializationconfig.introspectClassAnnotations(javatype.getRawClass())).getClassInfo();
        AnnotationIntrospector annotationintrospector = serializationconfig.getAnnotationIntrospector();
    ...
    {
        Class class1 = javatype.getRawClass();
        if (!com/flurry/org/codehaus/jackson/map/JsonSerializable.isAssignableFrom(class1)) goto _L2; else goto _L1
_L1:
        if (!com/flurry/org/codehaus/jackson/map/JsonSerializableWithType.isAssignableFrom(class1)) goto _L4; else goto _L3
_L3:
...
_L3:
        ...
        obj = (Class)obj;
        if (!com/flurry/org/codehaus/jackson/map/JsonSerializer.isAssignableFrom(((Class) (obj))))
        {
...
_L5:
    ...
    protected boolean usesStaticTyping(SerializationConfig serializationconfig, BasicBeanDescription basicbeandescription, TypeSerializer typeserializer, BeanProperty beanproperty)
    {
        if (typeserializer == null)
        {
            ...
            if (basicbeandescription != null)
            {
                if (basicbeandescription == com.flurry.org.codehaus.jackson.map.annotate.JsonSerialize.Typing.STATIC)
                {
                    return true;
                }
            } else
            if (serializationconfig.isEnabled(com.flurry.org.codehaus.jackson.map.SerializationConfig.Feature.USE_STATIC_TYPING))
            {
                return true;
            }
            if (beanproperty != null)
    ...
    static 
    {
        ...
        _concreteLazy.put(com/flurry/org/codehaus/jackson/util/TokenBuffer.getName(), com/flurry/org/codehaus/jackson/map/ser/std/TokenBufferSerializer);
        _arraySerializers = new HashMap();
        _arraySerializers.put([Z.getName(), new com.flurry.org.codehaus.jackson.map.ser.std.StdArraySerializers.BooleanArraySerializer());
        _arraySerializers.put([B.getName(), new com.flurry.org.codehaus.jackson.map.ser.std.StdArraySerializers.ByteArraySerializer());
        _arraySerializers.put([C.getName(), new com.flurry.org.codehaus.jackson.map.ser.std.StdArraySerializers.CharArraySerializer());
        _arraySerializers.put([S.getName(), new com.flurry.org.codehaus.jackson.map.ser.std.StdArraySerializers.ShortArraySerializer());
        _arraySerializers.put([I.getName(), new com.flurry.org.codehaus.jackson.map.ser.std.StdArraySerializers.IntArraySerializer());
        _arraySerializers.put([J.getName(), new com.flurry.org.codehaus.jackson.map.ser.std.StdArraySerializers.LongArraySerializer());
        _arraySerializers.put([F.getName(), new com.flurry.org.codehaus.jackson.map.ser.std.StdArraySerializers.FloatArraySerializer());
        _arraySerializers.put([D.getName(), new com.flurry.org.codehaus.jackson.map.ser.std.StdArraySerializers.DoubleArraySerializer());
    }
}
