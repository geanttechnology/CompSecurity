...
public static class _modifiers extends com.flurry.org.codehaus.jackson.map.mpl
{
    ...
    public com.flurry.org.codehaus.jackson.map.mpl withAdditionalKeySerializers(Serializers serializers1)
    {
    ...
    public com.flurry.org.codehaus.jackson.map.mpl withAdditionalSerializers(Serializers serializers1)
    {
        if (serializers1 == null)
        {
            throw new IllegalArgumentException("Can not pass null Serializers");
    ...
    public com.flurry.org.codehaus.jackson.map.mpl withSerializerModifier(BeanSerializerModifier beanserializermodifier)
    {
