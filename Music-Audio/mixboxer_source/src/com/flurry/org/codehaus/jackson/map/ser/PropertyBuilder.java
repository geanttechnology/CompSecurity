...
public class PropertyBuilder
{
    ...
    protected final com.flurry.org.codehaus.jackson.map.annotate.JsonSerialize.Inclusion _outputProps;
    ...
    protected BeanPropertyWriter buildWriter(String s, JavaType javatype, JsonSerializer jsonserializer, TypeSerializer typeserializer, TypeSerializer typeserializer1, AnnotatedMember annotatedmember, boolean flag)
    {
        ...
        JavaType javatype1;
        Object obj;
        com.flurry.org.codehaus.jackson.map.annotate.JsonSerialize.Inclusion inclusion;
        boolean flag1;
        boolean flag2;
...
_L1:
        static class _cls1
        {
            ...
            static 
            {
                $SwitchMap$org$codehaus$jackson$map$annotate$JsonSerialize$Inclusion = new int[com.flurry.org.codehaus.jackson.map.annotate.JsonSerialize.Inclusion.values().length];
                try
                {
                    $SwitchMap$org$codehaus$jackson$map$annotate$JsonSerialize$Inclusion[com.flurry.org.codehaus.jackson.map.annotate.JsonSerialize.Inclusion.NON_DEFAULT.ordinal()] = 1;
                }
                catch (NoSuchFieldError nosuchfielderror3) { }
                try
                {
                    $SwitchMap$org$codehaus$jackson$map$annotate$JsonSerialize$Inclusion[com.flurry.org.codehaus.jackson.map.annotate.JsonSerialize.Inclusion.NON_EMPTY.ordinal()] = 2;
                }
                catch (NoSuchFieldError nosuchfielderror2) { }
                try
                {
                    $SwitchMap$org$codehaus$jackson$map$annotate$JsonSerialize$Inclusion[com.flurry.org.codehaus.jackson.map.annotate.JsonSerialize.Inclusion.NON_NULL.ordinal()] = 3;
                }
                catch (NoSuchFieldError nosuchfielderror1) { }
                try
                {
                    $SwitchMap$org$codehaus$jackson$map$annotate$JsonSerialize$Inclusion[com.flurry.org.codehaus.jackson.map.annotate.JsonSerialize.Inclusion.ALWAYS.ordinal()] = 4;
                }
...
_L8:
    ...
    protected JavaType findSerializationType(Annotated annotated, boolean flag, JavaType javatype)
    {
        ...
        if (!flag)
        {
            ...
            if (annotated != null)
            {
                if (annotated == com.flurry.org.codehaus.jackson.map.annotate.JsonSerialize.Typing.STATIC)
                {
                    flag1 = true;
                } else
                {
    ...
    {
        if (!_config.isEnabled(com.flurry.org.codehaus.jackson.map.SerializationConfig.Feature.WRITE_EMPTY_JSON_ARRAYS))
        {
    ...
    protected Object getDefaultBean()
    {
        ...
        {
            _defaultBean = _beanDesc.instantiateBean(_config.isEnabled(com.flurry.org.codehaus.jackson.map.SerializationConfig.Feature.CAN_OVERRIDE_ACCESS_MODIFIERS));
            if (_defaultBean == null)
            {
