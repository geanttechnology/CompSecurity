    ...
    implements ResolvableSerializer, SchemaAware
{
    ...
    {
        for (Class class1 = javatype.getRawClass(); (javatype.isPrimitive() ? class1 != Integer.TYPE && class1 != Boolean.TYPE && class1 != Double.TYPE : class1 != java/lang/String && class1 != java/lang/Integer && class1 != java/lang/Boolean && class1 != java/lang/Double) || jsonserializer.getClass().getAnnotation(com/flurry/org/codehaus/jackson/map/annotate/JacksonStdImpl) == null;)
        {
            return false;
        }
    ...
    public void resolve(SerializerProvider serializerprovider)
        throws JsonMappingException
    {
        if (_valueSerializer == null && (serializerprovider.isEnabled(com.flurry.org.codehaus.jackson.map.SerializationConfig.Feature.USE_STATIC_TYPING) || Modifier.isFinal(_accessorMethod.getReturnType().getModifiers())))
        {
