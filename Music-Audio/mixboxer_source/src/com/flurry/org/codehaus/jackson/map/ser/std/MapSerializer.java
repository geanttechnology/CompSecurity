...
_L3:
        ...
        throws JsonMappingException
    {
        ...
        if (propertyserializermap != ((com.flurry.org.codehaus.jackson.map.ser.impl.PropertySerializerMap.SerializerAndMapResult) (javatype)).map)
        {
            _dynamicValueSerializers = ((com.flurry.org.codehaus.jackson.map.ser.impl.PropertySerializerMap.SerializerAndMapResult) (javatype)).map;
        }
        return ((com.flurry.org.codehaus.jackson.map.ser.impl.PropertySerializerMap.SerializerAndMapResult) (javatype)).serializer;
    }
        ...
        throws JsonMappingException
    {
        ...
        if (propertyserializermap != ((com.flurry.org.codehaus.jackson.map.ser.impl.PropertySerializerMap.SerializerAndMapResult) (class1)).map)
        {
            _dynamicValueSerializers = ((com.flurry.org.codehaus.jackson.map.ser.impl.PropertySerializerMap.SerializerAndMapResult) (class1)).map;
        }
        return ((com.flurry.org.codehaus.jackson.map.ser.impl.PropertySerializerMap.SerializerAndMapResult) (class1)).serializer;
    }
...
_L2:
        ...
        Iterator iterator;
        if (!serializerprovider.isEnabled(com.flurry.org.codehaus.jackson.map.SerializationConfig.Feature.WRITE_NULL_MAP_VALUES))
        {
            flag = true;
        } else
        {
