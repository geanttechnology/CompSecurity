...
public class BeanUtil
{
    ...
    {
        boolean flag1 = false;
        annotatedmethod = annotatedmethod.getParameterClass(0).getPackage();
        boolean flag = flag1;
...
label0:
    ...
    public static String okNameForSetter(AnnotatedMethod annotatedmethod)
    {
        ...
        if (s.startsWith("set"))
        {
            s = manglePropertyName(s.substring(3));
            break MISSING_BLOCK_LABEL_23;
        }
        do
        {
            return null;
        } while (s == null || "metaClass".equals(s) && isGroovyMetaClassSetter(annotatedmethod));
        return s;
    }
}
