...
public class BufferRecycler
{
    public static final class ByteBufferType extends Enum
    {
        ...
        {
            return (ByteBufferType)Enum.valueOf(com/flurry/org/codehaus/jackson/util/BufferRecycler$ByteBufferType, s);
        }
    ...
    public static final class CharBufferType extends Enum
    {
        ...
        {
            return (CharBufferType)Enum.valueOf(com/flurry/org/codehaus/jackson/util/BufferRecycler$CharBufferType, s);
        }
