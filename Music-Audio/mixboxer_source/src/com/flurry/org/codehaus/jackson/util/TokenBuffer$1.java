...
static class pe
{
    ...
    static 
    {
        $SwitchMap$org$codehaus$jackson$JsonParser$NumberType = new int[com.flurry.org.codehaus.jackson.berType.values().length];
        try
        {
            $SwitchMap$org$codehaus$jackson$JsonParser$NumberType[com.flurry.org.codehaus.jackson.berType.INT.ordinal()] = 1;
        }
        catch (NoSuchFieldError nosuchfielderror16) { }
        try
        {
            $SwitchMap$org$codehaus$jackson$JsonParser$NumberType[com.flurry.org.codehaus.jackson.berType.BIG_INTEGER.ordinal()] = 2;
        }
        catch (NoSuchFieldError nosuchfielderror15) { }
        try
        {
            $SwitchMap$org$codehaus$jackson$JsonParser$NumberType[com.flurry.org.codehaus.jackson.berType.BIG_DECIMAL.ordinal()] = 3;
        }
        catch (NoSuchFieldError nosuchfielderror14) { }
        try
        {
            $SwitchMap$org$codehaus$jackson$JsonParser$NumberType[com.flurry.org.codehaus.jackson.berType.FLOAT.ordinal()] = 4;
        }
        catch (NoSuchFieldError nosuchfielderror13) { }
        try
        {
            $SwitchMap$org$codehaus$jackson$JsonParser$NumberType[com.flurry.org.codehaus.jackson.berType.LONG.ordinal()] = 5;
        }
