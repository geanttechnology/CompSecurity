...
protected static final class ateRootContext extends JsonParserMinimalBase
{
    ...
    public com.flurry.org.codehaus.jackson.pe getNumberType()
        throws IOException, JsonParseException
    {
        Number number = getNumberValue();
        if (number instanceof Integer)
        {
            return com.flurry.org.codehaus.jackson.pe.INT;
        }
        if (number instanceof Long)
        {
            return com.flurry.org.codehaus.jackson.pe.LONG;
        }
        if (number instanceof Double)
        {
            return com.flurry.org.codehaus.jackson.pe.DOUBLE;
        }
        if (number instanceof BigDecimal)
        {
            return com.flurry.org.codehaus.jackson.pe.BIG_DECIMAL;
        }
        if (number instanceof Float)
        {
            return com.flurry.org.codehaus.jackson.pe.FLOAT;
        }
        if (number instanceof BigInteger)
        {
            return com.flurry.org.codehaus.jackson.pe.BIG_INTEGER;
        } else
        {
            return null;
        }
