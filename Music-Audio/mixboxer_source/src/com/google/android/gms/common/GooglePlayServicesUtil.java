...
public final class GooglePlayServicesUtil
{
    ...
    public static Dialog a(int i, Activity activity, int j, android.content.DialogInterface.OnCancelListener oncancellistener, int k)
    {
        ...
        oncancellistener = new du(activity, a(((Context) (activity)), i, k), j);
...
_L2:
        ...
        context = ((Context) (obj));
        if (!y(j)) goto _L10; else goto _L9
_L9:
...
_L3:
        ...
        context = ((Context) (obj));
        if (!y(j)) goto _L10; else goto _L11
_L11:
        return (new StringBuilder()).append(((String) (obj))).append(" (via Bazaar)").toString();
_L7:
...
_L8:
    ...
    context
        ...
        {
            Log.w("GooglePlayServicesUtil", (new StringBuilder()).append("Google Play services out of date.  Requires 4242000 but found ").append(packageinfo.versionCode).toString());
            return 2;
        }
        try
        {
    ...
    private static boolean o(Context context)
    {
        ...
        } else
        {
            try
            {
                context = a(context.getPackageManager().getPackageInfo("com.google.android.apps.bazaar", 64), mJ);
            }
            // Misplaced declaration of an exception variable
            catch (Context context)
            {
