...
public class c extends DataBuffer
{
    ...
    private final android.os.Parcelable.Creator nJ;
    ...
    {
        byte abyte0[] = nE.getByteArray("data", i, 0);
        Parcel parcel = Parcel.obtain();
        parcel.unmarshall(abyte0, 0, abyte0.length);
        parcel.setDataPosition(0);
        SafeParcelable safeparcelable = (SafeParcelable)nJ.createFromParcel(parcel);
        parcel.recycle();
