    ...
    implements d
{
    ...
    protected e(Context context, j j1, k k1)
    {
        ...
        try
        {
            dv = context.getResources().getDisplayMetrics();
            return;
        }
        // Misplaced declaration of an exception variable
        catch (Context context)
        {
            dv = new DisplayMetrics();
        }
        dv.density = 1.0F;
    }
...
_L1:
    ...
    public void a(int i, int l, int i1)
    {
        ...
        du = MotionEvent.obtain(0L, i1, 1, (float)i * dv.density, (float)l * dv.density, 0.0F, 0.0F, 0, 0.0F, 0.0F, 0, 0);
    }
    ...
    public void a(MotionEvent motionevent)
    {
        if (motionevent.getAction() == 1)
        {
            ...
            du = MotionEvent.obtain(motionevent);
        }
    }
        ...
        throws UnsupportedEncodingException
    {
        ...
        (new iv(s1.getBytes("UTF-8"))).h(abyte0);
    }
