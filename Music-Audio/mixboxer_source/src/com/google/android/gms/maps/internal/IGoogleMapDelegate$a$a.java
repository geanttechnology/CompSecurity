...
_L3:
        ...
        throws RemoteException
    {
        ...
        parcel1.readException();
        iprojectiondelegate = g(parcel1.readStrongBinder());
        parcel1.recycle();
        parcel.recycle();
        ...
        throws RemoteException
    {
        ...
        parcel1.readException();
        b1 = com.google.android.gms.dynamic.e.a.a.dU(parcel1.readStrongBinder());
        parcel1.recycle();
        parcel.recycle();
        return b1;
        Exception exception;
        ...
        throws RemoteException
    {
        ...
        parcel1.readException();
        iuisettingsdelegate = i(parcel1.readStrongBinder());
        parcel1.recycle();
        parcel.recycle();
