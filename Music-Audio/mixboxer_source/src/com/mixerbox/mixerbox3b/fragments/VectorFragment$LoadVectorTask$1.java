    ...
    implements Runnable
{
    ...
    public void run()
    {
        ...
        {
            String s = MixerBoxClient.getVectorUrl(vectorId, val$params[0].intValue() + 1, vectorType);
            if (!vectorId.equals(""))
            {
                class _cls1 extends MixerBoxAsyncHttpResponseHandler
                {

                    final VectorFragment.LoadVectorTask._cls1 this$2;
...
_L1:
            ...
            {
                this$2 = VectorFragment.LoadVectorTask._cls1.this;
                super(context);
            }
                }
