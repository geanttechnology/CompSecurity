...
_L1:
            int l;
            l = (viewholder2.getLayoutPosition() - mCurrentPosition) * mItemDirection;
            viewholder1 = viewholder;
            k = j;
...
_L6:
            ...
            if (viewholder1 != null)
            {
                mCurrentPosition = viewholder1.getLayoutPosition() + mItemDirection;
