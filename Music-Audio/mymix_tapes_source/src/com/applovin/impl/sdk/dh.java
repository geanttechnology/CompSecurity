...
//            bw, AppLovinSdkImpl, AppLovinAdImpl

public class dh extends AppLovinSdkUtils
{
    ...
    public static Bitmap a(Context context, int i, int j)
    {
        ...
        try
        {
            ...
            {
                k = (int)Math.pow(2D, (int)Math.ceil(Math.log((double)j / (double)Math.max(options.outHeight, options.outWidth)) / Math.log(0.5D)));
            }
...
_L3:
    ...
    {
        return a(s, (Integer)applovinsdkimpl.a(bw.s), (String)applovinsdkimpl.a(bw.r));
    }
...
_L7:
    ...
    {
        return a(s, Integer.valueOf(-1), "SHA-1");
    }
