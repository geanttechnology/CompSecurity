...
public class y
{
    ...
    {
        if (dh.isValidString(s)) goto _L2; else goto _L1
_L1:
        b.getLogger().d("FileManager", "Nothing to look up, skipping...");
_L4:
        return null;
_L2:
        a.d("FileManager", (new StringBuilder()).append("Looking up cached resource: ").append(s).toString());
        if (!a(context) && !flag) goto _L4; else goto _L3
_L3:
        Object obj;
        obj = s;
        if (s.contains("icon"))
...
_L5:
    ...
    boolean a()
    {
        return ((Boolean)b.a(bw.aA)).booleanValue();
    }
    ...
    protected boolean a(Context context)
    {
        ...
        return n.c() && !((Boolean)b.a(bw.bv)).booleanValue();
    }
...
_L2:
    ...
    boolean a(File file, String s)
    {
        ...
        s1 = s;
        if (((Boolean)b.a(bw.bk)).booleanValue())
        {
            s1 = s;
            if (!s.contains("https://"))
            {
                b.getLogger().w("FileManager", "Plaintext HTTP operation requested; upgrading to HTTPS due to universal SSL setting...");
                s1 = s.replace("http://", "https://");
            }
        }
        ...
        obj1 = abyte0;
        obj = inputstream;
        s.setConnectTimeout(((Integer)b.a(bw.t)).intValue());
        obj1 = abyte0;
        obj = inputstream;
        s.setReadTimeout(((Integer)b.a(bw.v)).intValue());
        obj1 = abyte0;
        obj = inputstream;
        s.setDefaultUseCaches(true);
        obj1 = abyte0;
        obj = inputstream;
        s.setUseCaches(true);
        obj1 = abyte0;
...
_L1:
        ...
        obj1 = inputstream;
        obj = inputstream;
        a.e("FileManager", (new StringBuilder()).append("Failed to cache \"").append(s1).append("\" into \"").append(file.getAbsolutePath()).append("\"").toString());
        if (inputstream != null)
        {
            try
            {
        ...
        bytearrayoutputstream = null;
_L5:
        a.e("FileManager", (new StringBuilder()).append("Failed to cache \"").append(s1).append("\" into \"").append(file.getAbsolutePath()).append("\"").toString(), ((Throwable) (obj1)));
        if (obj != null)
        {
            try
            {
...
_L4:
    ...
    long b()
    {
        long l = ((Long)b.a(bw.aB)).longValue();
        if (l >= 0L && a())
        {
            return l;
        } else
...
_L4:
    ...
    int c()
    {
        int i = ((Integer)b.a(bw.aC)).intValue();
        if (i >= 0 && a())
        {
            return i;
        } else
    ...
    void d(Context context)
    {
        ...
        b.getSettingsManager().a(bw.aA, Boolean.valueOf(false));
