...
//            AppLovinAdType, AppLovinSdk, AppLovinLogger, AppLovinSdkSettings
...
public class AppLovinSdkUtils
{
    ...
    public static void openUri(Context context, Uri uri, AppLovinSdk applovinsdk)
    {
        ...
        {
            applovinsdk.getLogger().e("AppLovinSdkUtils", (new StringBuilder()).append("Unable to open \"").append(uri).append("\".").toString(), context);
        }
    }

    public static void openUrl(Context context, String s, AppLovinSdk applovinsdk)
    {
        openUri(context, Uri.parse(s), applovinsdk);
    }
    ...
    {
        recycleImageView(imageview);
        uri = dh.a(new File(uri.getPath()), i);
        if (uri != null)
        {
