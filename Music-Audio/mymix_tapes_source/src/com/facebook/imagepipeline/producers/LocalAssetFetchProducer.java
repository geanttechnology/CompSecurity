...
public class LocalAssetFetchProducer extends LocalFetchProducer
{
    ...
    private int getLength(ImageRequest imagerequest)
    {
        ...
        try
        {
            imagerequest = mAssetManager.openFd(getAssetName(imagerequest));
        }
    ...
    protected EncodedImage getEncodedImage(ImageRequest imagerequest)
        throws IOException
    {
        return getByteBufferBackedEncodedImage(mAssetManager.open(getAssetName(imagerequest), 2), getLength(imagerequest));
    }
