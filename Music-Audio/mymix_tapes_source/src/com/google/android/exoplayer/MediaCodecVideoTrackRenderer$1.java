    ...
    implements Runnable
{
    ...
    public void run()
    {
        MediaCodecVideoTrackRenderer.access$000(MediaCodecVideoTrackRenderer.this).onVideoSizeChanged(val$currentWidth, val$currentHeight, val$currentPixelWidthHeightRatio);
    }
