    ...
    public long adjustReleaseTime(long l, long l1)
    {
        ...
        if (haveSync)
        {
            ...
            if (frameCount >= 6)
            {
                ...
                l5 = adjustedLastFrameTimeNs + l4;
                if (isDriftTooLarge(l5, l1))
                {
                    haveSync = false;
                    l5 = l2;
                    l4 = l3;
                ...
                {
                    l4 = (syncReleaseTimeNs + l5) - syncFrameTimeNs;
                }
            } else
            {
                l4 = l3;
        ...
        pendingAdjustedFrameTimeNs = l5;
        if (sampledVsyncTimeNs == 0L)
        {
            return l4;
        } else
        {
            return closestVsync(l4, sampledVsyncTimeNs, vsyncDurationNs) - vsyncOffsetNs;
        }
    }
