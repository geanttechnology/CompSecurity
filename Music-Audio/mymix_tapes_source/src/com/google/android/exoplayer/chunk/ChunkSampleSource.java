...
//            ChunkOperationHolder, BaseMediaChunk, Chunk, ChunkSource, 
//            MediaChunk, Format, BaseChunkSampleSourceEventListener
...
label0:
    ...
    public boolean prepare(long l)
    {
        ...
        {
            loader = new Loader((new StringBuilder()).append("Loader:").append(chunkSource.getTrackInfo().mimeType).toString());
            state = 2;
            return true;
        }
    }
