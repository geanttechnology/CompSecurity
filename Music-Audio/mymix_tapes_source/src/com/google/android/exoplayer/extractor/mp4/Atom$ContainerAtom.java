...
static final class endPosition extends Atom
{
    ...
    public void add(endPosition endposition)
    {
        containerChildren.add(endposition);
    }

    public void add(containerChildren containerchildren)
    {
        leafChildren.add(containerchildren);
    }

    public leafChildren getContainerAtomOfType(int i)
    {
    ...
    public type getLeafAtomOfType(int i)
    {
