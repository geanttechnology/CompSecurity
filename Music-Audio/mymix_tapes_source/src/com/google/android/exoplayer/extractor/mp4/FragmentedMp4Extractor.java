    ...
    implements Extractor
{
    ...
    private static void parseSaiz(TrackEncryptionBox trackencryptionbox, ParsableByteArray parsablebytearray, TrackFragment trackfragment)
    {
        ...
        if (l != trackfragment.length)
        {
            throw new IllegalStateException((new StringBuilder()).append("Length mismatch: ").append(l).append(", ").append(trackfragment.length).toString());
        }
        int i = 0;
        int k;
        if (j == 0)
        ...
        } else
        {
            ...
            k = 0 + j * l;
            Arrays.fill(trackfragment.sampleHasSubsampleEncryptionTable, 0, l, flag);
        }
    ...
    private static void parseSenc(ParsableByteArray parsablebytearray, int i, TrackFragment trackfragment)
    {
        ...
        {
            throw new IllegalStateException((new StringBuilder()).append("Length mismatch: ").append(i).append(", ").append(trackfragment.length).toString());
        } else
        {
    ...
    private static void parseTraf(Track track1, DefaultSampleValues defaultsamplevalues, Atom.ContainerAtom containeratom, TrackFragment trackfragment, int i, byte abyte0[])
    {
        ...
        leafatom = containeratom.getLeafAtomOfType(Atom.TYPE_saiz);
        if (leafatom != null)
        {
        ...
        j = containeratom.leafChildren.size();
        for (i = 0; i < j; i++)
        {
    ...
    private static void parseTrun(Track track1, DefaultSampleValues defaultsamplevalues, long l, int i, ParsableByteArray parsablebytearray, TrackFragment trackfragment)
    {
        ...
        ai = trackfragment.sampleSizeTable;
        ai1 = trackfragment.sampleCompositionTimeOffsetTable;
        al = trackfragment.sampleDecodingTimeTable;
        ...
        throws IOException, InterruptedException
    {
        ...
        for (l = extractorinput.getPosition(); !containerAtoms.isEmpty() && ((Atom.ContainerAtom)containerAtoms.peek()).endPosition == l; onContainerAtomRead((Atom.ContainerAtom)containerAtoms.pop())) { }
        enterReadingAtomHeaderState();
    }
