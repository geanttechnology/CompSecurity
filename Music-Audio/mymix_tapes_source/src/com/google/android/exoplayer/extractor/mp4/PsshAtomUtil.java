...
public final class PsshAtomUtil
{
    ...
    {
        if (parsablebytearray.limit() >= 32) goto _L2; else goto _L1
_L1:
        return false;
_L2:
        parsablebytearray.setPosition(0);
        if (parsablebytearray.readInt() != parsablebytearray.bytesLeft() + 4 || parsablebytearray.readInt() != Atom.TYPE_pssh) goto _L1; else goto _L3
_L3:
...
_L6:
        if (parsablebytearray.readInt() != parsablebytearray.bytesLeft()) goto _L1; else goto _L4
_L4:
        return true;
        if (parsablebytearray.readLong() != uuid.getMostSignificantBits()) goto _L1; else goto _L5
_L5:
