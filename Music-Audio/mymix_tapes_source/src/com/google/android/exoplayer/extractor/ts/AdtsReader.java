...
final class AdtsReader extends ElementaryStreamReader
{
    ...
    private void parseHeader()
    {
        ...
        if (!hasOutputFormat)
        {
            ...
            MediaFormat mediaformat = MediaFormat.createAudioFormat("audio/mp4a-latm", -1, ((Integer)pair.second).intValue(), ((Integer)pair.first).intValue(), Collections.singletonList(abyte0));
