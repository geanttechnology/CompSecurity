    ...
    implements EbmlReader
{
        ...
        throws IOException, InterruptedException
    {
        ...
        do
        {
            ...
            {
            default:
                throw new IllegalStateException((new StringBuilder()).append("Invalid element type ").append(i).toString());
            ...
            case 2: // '\002'
                ...
                {
                    throw new IllegalStateException((new StringBuilder()).append("Invalid integer size: ").append(elementContentSize).toString());
                } else
                {
            ...
            case 5: // '\005'
                ...
                {
                    throw new IllegalStateException((new StringBuilder()).append("Invalid float size: ").append(elementContentSize).toString());
                } else
                {
            ...
            case 3: // '\003'
                ...
                {
                    throw new IllegalStateException((new StringBuilder()).append("String element size: ").append(elementContentSize).toString());
                } else
                {
