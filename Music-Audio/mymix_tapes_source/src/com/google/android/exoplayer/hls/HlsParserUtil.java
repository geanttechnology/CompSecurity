...
final class HlsParserUtil
{
    ...
    {
        return Pattern.compile((new StringBuilder()).append(s).append("=(").append("YES").append("|").append("NO").append(")").toString());
    }
        ...
        throws ParserException
    {
        ...
        {
            throw new ParserException((new StringBuilder()).append("Couldn't match ").append(s1).append(" tag in ").append(s).toString());
        }
    }
}
