    ...
    implements com.google.android.exoplayer.upstream.UriLoadable.Parser
{
        ...
        throws IOException
    {
        ...
        do
        {
            ...
            {
                arraylist.add(new Variant(arraylist.size(), ((String) (obj)), j, s1, k, i));
                j = 0;
                s1 = null;
                k = -1;
                i = -1;
...
label1:
            do
            {
                do
                {
                    ...
                    {
                        j1 = HlsParserUtil.parseIntAttr(s4, MEDIA_SEQUENCE_REGEX, "#EXT-X-MEDIA-SEQUENCE");
                        k = j1;
                    } else
                    ...
                    {
                        flag1 = "AES-128".equals(HlsParserUtil.parseStringAttr(s4, METHOD_ATTR_REGEX, "METHOD"));
                        if (flag1)
                        {
                    ...
                    } else
                    {
                        ...
                        arraylist.add(new HlsMediaPlaylist.Segment(s4, d, flag, l2, flag1, s2, s3, k, j));
                        l2 += (long)(1000000D * d);
                        flag = false;
                        d = 0.0D;
                        i = k;
