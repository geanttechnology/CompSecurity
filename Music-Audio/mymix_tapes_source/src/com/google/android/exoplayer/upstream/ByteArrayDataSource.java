    ...
    implements DataSource
{
        ...
        throws IOException
    {
        ...
        {
            throw new IOException((new StringBuilder()).append("Unsatisfiable range: [").append(readPosition).append(", ").append(dataspec.length).append("], length: ").append(data.length).toString());
        } else
        {
