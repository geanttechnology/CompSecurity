...
public final class DataSpec
{
    ...
    {
        return (new StringBuilder()).append("DataSpec[").append(uri).append(", ").append(Arrays.toString(postBody)).append(", ").append(absoluteStreamPosition).append(", ").append(position).append(", ").append(length).append(", ").append(key).append(", ").append(flags).append("]").toString();
    }
}
