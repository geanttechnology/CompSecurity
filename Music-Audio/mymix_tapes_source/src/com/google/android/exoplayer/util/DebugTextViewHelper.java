    ...
    implements Runnable
{
    ...
    private String getBandwidthString()
    {
        ...
        {
            return (new StringBuilder()).append("bw:").append(bandwidthmeter.getBitrateEstimate() / 1000L).toString();
        }
    }
    ...
    private String getQualityString()
    {
        ...
        {
            return (new StringBuilder()).append("id:").append(format.id).append(" br:").append(format.bitrate).append(" h:").append(format.height).toString();
        }
    }
    ...
    {
        return (new StringBuilder()).append("ms(").append(debuggable.getCurrentPosition()).append(")").toString();
    }
