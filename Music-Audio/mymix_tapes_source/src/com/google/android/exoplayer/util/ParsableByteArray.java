...
public final class ParsableByteArray
{
    ...
    public int readUnsignedIntToInt()
    {
        ...
        if (i < 0)
        {
            throw new IllegalStateException((new StringBuilder()).append("Top bit not zero: ").append(i).toString());
        } else
        {
            return i;
        }
    ...
    public long readUnsignedLongToLong()
    {
        ...
        if (l < 0L)
        {
            throw new IllegalStateException((new StringBuilder()).append("Top bit not zero: ").append(l).toString());
        } else
        {
            return l;
        }
