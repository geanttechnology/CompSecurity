...
public final class PublisherAdRequest
{
    public static final class Builder
    {
        ...
        {
            com.google.android.gms.common.internal.zzx.zzb(s, "Content URL must be non-null.");
            com.google.android.gms.common.internal.zzx.zzh(s, "Content URL must be non-empty.");
            boolean flag;
            if (s.length() <= 512)
            {
                flag = true;
            ...
            com.google.android.gms.common.internal.zzx.zzb(flag, "Content URL must not exceed %d in length.  Provided length was %d.", new Object[] {
