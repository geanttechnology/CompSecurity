    ...
    implements Callable
{
        ...
        throws JSONException
    {
        ...
        {
            return zzCT.zza(jsonobject, new _cls5(flag, jsonobject));
        }
    }
        ...
        throws TimeoutException, JSONException
    {
        ...
        } else
        {
            zzie zzie1 = new zzie();
            zzb zzb1 = new zzb();
            _cls1 _lcls1 = new _cls1(zzbb1, zzb1, zzie1);
            zzb1.zzDk = _lcls1;
        ...
        throws JSONException, TimeoutException
    {
        ...
        if ("3".equals(s))
        {
            ...
            zzie zzie1 = new zzie();
            zzhu.zzHK.post(new _cls2(zzie1, s1));
        ...
        throws JSONException
    {
        ...
        } else
        {
            ...
            return zzig.zza(zza(jsonobject, "image", false, false), new _cls4(s, integer1, integer, i));
        }
    }
