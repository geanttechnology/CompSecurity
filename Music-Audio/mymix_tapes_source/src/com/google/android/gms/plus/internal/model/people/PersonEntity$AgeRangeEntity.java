...
public static final class zzaNl extends FastSafeParcelableJsonResponse
...
label1:
    ...
    {
        zzaLS = new HashMap();
        zzaLS.put("max", com.google.android.gms.common.server.response.ity.zzaLS("max", 2));
        zzaLS.put("min", com.google.android.gms.common.server.response.ity.zzaLS("min", 3));
    }
