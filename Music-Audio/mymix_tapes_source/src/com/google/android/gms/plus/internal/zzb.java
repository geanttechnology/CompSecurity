        ...
        implements zzb
    {
            ...
            throws RemoteException
        {
            ...
            case 5: // '\005'
                ...
                if (parcel.readInt() != 0)
                {
                    safeparcelresponse = SafeParcelResponse.CREATOR.zzat(parcel);
                }
                zza(i, bundle, safeparcelresponse);
                parcel1.writeNoException();
                return true;

            case 6: // '\006'
                parcel.enforceInterface("com.google.android.gms.plus.internal.IPlusCallbacks");
                DataHolder dataholder = obj1;
                if (parcel.readInt() != 0)
                {
                    dataholder = DataHolder.CREATOR.zzaa(parcel);
                }
                zza(dataholder, parcel.readString(), parcel.readString());
                parcel1.writeNoException();
                return true;
            ...
            case 9: // '\t'
                parcel.enforceInterface("com.google.android.gms.plus.internal.IPlusCallbacks");
                i = parcel.readInt();
                PersonEntity personentity = obj2;
                if (parcel.readInt() != 0)
                {
                    personentity = PersonEntity.CREATOR.zzfV(parcel);
                }
                zza(i, personentity);
                parcel1.writeNoException();
                return true;
...
_L1:
    ...
    public abstract void zzaX(Status status)
        throws RemoteException;

    public abstract void zzeh(String s)
        throws RemoteException;

    public abstract void zzei(String s)
        throws RemoteException;
