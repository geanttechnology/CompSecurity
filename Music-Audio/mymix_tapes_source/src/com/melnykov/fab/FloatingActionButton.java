...
//            ObservableScrollView, ScrollDirectionListener, AbsListViewScrollDetector, RecyclerViewScrollDetector, 
...
public class FloatingActionButton extends ImageButton
{
    ...
    private class RecyclerViewScrollDetectorImpl extends RecyclerViewScrollDetector
    {
        ...
        private android.support.v7.widget.RecyclerView.OnScrollListener mOnScrollListener;
        private ScrollDirectionListener mScrollDirectionListener;
        final FloatingActionButton this$0;
        ...
        public void onScrolled(RecyclerView recyclerview, int i, int j)
        {
            if (mOnScrollListener != null)
            {
                mOnScrollListener.onScrolled(recyclerview, i, j);
            }
...
_L6:
    ...
    public void attachToListView(AbsListView abslistview, ScrollDirectionListener scrolldirectionlistener, android.widget.AbsListView.OnScrollListener onscrolllistener)
    {
        ...
        abslistviewscrolldetectorimpl.setScrollThreshold(mScrollThreshold);
    ...
    public void attachToRecyclerView(RecyclerView recyclerview, ScrollDirectionListener scrolldirectionlistener, android.support.v7.widget.RecyclerView.OnScrollListener onscrolllistener)
    {
        ...
        recyclerviewscrolldetectorimpl.setScrollThreshold(mScrollThreshold);
