    ...
    implements Runnable
{
    ...
    final lityWatcher.stopWatching this$1;
...
label0:
        ...
        AdPlacementReporter.setDisplayed(InlineAd.access$300(inlineAd).acementReporter());
...
/* anonymous class */
    class InlineAd.ImpressionListener._cls1
...
_L3:
            impressionTimerRunnable = ThreadUtils.runOnWorkerThreadDelayed(new InlineAd.ImpressionListener._cls1._cls1(), 1000L);
_L5:
            impressionlistener;
            JVM INSTR monitorexit ;
            return;
