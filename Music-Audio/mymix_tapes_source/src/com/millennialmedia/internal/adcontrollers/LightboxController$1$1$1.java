    ...
    implements Runnable
{
    ...
    public void run()
    {
        if (LightboxController.access$300(_fld0) != null && LightboxController.access$000(_fld0).getParent() == null)
        {
            if (MMLog.isDebugEnabled())
            {
                MMLog.d(LightboxController.access$200(), "Attaching Lightbox in onPrepared.");
            }
            LightboxController.access$400(_fld0);
        }
    }

    oxControllerListener()
    {
...
/* anonymous class */
        ...
        // Unreferenced inner class com/millennialmedia/internal/adcontrollers/LightboxController$1$3

/* anonymous class */
        class LightboxController._cls1._cls3
