...
class val.mmActivity
    implements android.widget.dChangeListener
{

    final val.mmActivity this$1;
    ...
    {
        this$1 = final_;
        val$mmActivity = MMActivity.this;
        super();
    }
...
/* anonymous class */
    class InlineWebVideoView._cls5 extends com.millennialmedia.internal.MMActivity.MMActivityListener
    {
        ...
        public void onCreate(MMActivity mmactivity)
        {
            ...
            InlineWebVideoView.access$900(InlineWebVideoView.this).setOnCheckedChangeListener(mmactivity. new InlineWebVideoView._cls5._cls1());
        ...
        // Unreferenced inner class com/millennialmedia/internal/video/InlineWebVideoView$5$2

/* anonymous class */
        class InlineWebVideoView._cls5._cls2
