    ...
    implements com.millennialmedia.internal.ewListener
{
    ...
    public void onReady()
    {
        VASTVideoView.access$2200(VASTVideoView.this).callJavascript("MmJsBridge.vast.enableWebOverlay", new Object[0]);
        VASTVideoView.access$2200(VASTVideoView.this).callJavascript("MmJsBridge.vast.setDuration", new Object[] {
        ...
        {
            VASTVideoView.access$2200(VASTVideoView.this).callJavascript("MmJsBridge.vast.setState", new Object[] {
                "playing"
            });
        }
    }
