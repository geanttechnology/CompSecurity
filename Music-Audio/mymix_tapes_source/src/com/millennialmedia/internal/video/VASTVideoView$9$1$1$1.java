    ...
    implements Runnable
{
    ...
    final omGetRequest this$3;

    public void run()
    {
        Iterator iterator = VASTVideoView.access$1300().companionClickTracking.iterator();
        do
        {
            if (!iterator.hasNext())
            {
...
/* anonymous class */
    ...
    // Unreferenced inner class com/millennialmedia/internal/video/VASTVideoView$9$1$1

/* anonymous class */
    class VASTVideoView._cls9._cls1._cls1
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            {
                ThreadUtils.runOnWorkerThread(new VASTVideoView._cls9._cls1._cls1._cls1());
            }
        }
