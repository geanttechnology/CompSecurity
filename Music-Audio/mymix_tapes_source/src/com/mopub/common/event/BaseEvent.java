...
public abstract class BaseEvent
{
    ...
    public static final class Category extends Enum
    {
        ...
        public static final Category NATIVE_VIDEO;
        ...
        static 
        {
            ...
            NATIVE_VIDEO = new Category("NATIVE_VIDEO", 1, "native_video");
            $VALUES = (new Category[] {
    ...
    public static final class Name extends Enum
    {
        ...
        public static final Name DOWNLOAD_BUFFERING;
        public static final Name DOWNLOAD_FINISHED;
        public static final Name DOWNLOAD_START;
        public static final Name DOWNLOAD_VIDEO_READY;
        public static final Name ERROR_DURING_PLAYBACK;
        public static final Name ERROR_FAILED_TO_PLAY;
        ...
        static 
        {
            ...
            DOWNLOAD_START = new Name("DOWNLOAD_START", 3, "download_start");
            DOWNLOAD_VIDEO_READY = new Name("DOWNLOAD_VIDEO_READY", 4, "download_video_ready");
            DOWNLOAD_BUFFERING = new Name("DOWNLOAD_BUFFERING", 5, "download_video_buffering");
            DOWNLOAD_FINISHED = new Name("DOWNLOAD_FINISHED", 6, "download_finished");
            ERROR_DURING_PLAYBACK = new Name("ERROR_DURING_PLAYBACK", 7, "error_during_playback");
            ERROR_FAILED_TO_PLAY = new Name("ERROR_FAILED_TO_PLAY", 8, "error_failed_to_play");
            $VALUES = (new Name[] {
                AD_REQUEST, IMPRESSION_REQUEST, CLICK_REQUEST, DOWNLOAD_START, DOWNLOAD_VIDEO_READY, DOWNLOAD_BUFFERING, DOWNLOAD_FINISHED, ERROR_DURING_PLAYBACK, ERROR_FAILED_TO_PLAY
            });
        }
    ...
    public static final class SamplingRate extends Enum
    {
        ...
        public static final SamplingRate NATIVE_VIDEO;
        ...
        static 
        {
            ...
            NATIVE_VIDEO = new SamplingRate("NATIVE_VIDEO", 1, 0.10000000000000001D);
