...
public final class ResponseHeader extends Enum
{
    ...
    static 
    {
        ...
        PLAY_VISIBLE_PERCENT = new ResponseHeader("PLAY_VISIBLE_PERCENT", 22, "X-Play-Visible-Percent");
        PAUSE_VISIBLE_PERCENT = new ResponseHeader("PAUSE_VISIBLE_PERCENT", 23, "X-Pause-Visible-Percent");
        IMPRESSION_MIN_VISIBLE_PERCENT = new ResponseHeader("IMPRESSION_MIN_VISIBLE_PERCENT", 24, "X-Impression-Min-Visible-Percent");
        IMPRESSION_VISIBLE_MS = new ResponseHeader("IMPRESSION_VISIBLE_MS", 25, "X-Impression-Visible-Ms");
        MAX_BUFFER_MS = new ResponseHeader("MAX_BUFFER_MS", 26, "X-Max-Buffer-Ms");
        CUSTOM_SELECTOR = new ResponseHeader("CUSTOM_SELECTOR", 27, "X-Customselector");
        $VALUES = (new ResponseHeader[] {
            ...
            USER_AGENT, ACCEPT_LANGUAGE, PLAY_VISIBLE_PERCENT, PAUSE_VISIBLE_PERCENT, IMPRESSION_MIN_VISIBLE_PERCENT, IMPRESSION_VISIBLE_MS, MAX_BUFFER_MS, CUSTOM_SELECTOR
        });
    }
}
