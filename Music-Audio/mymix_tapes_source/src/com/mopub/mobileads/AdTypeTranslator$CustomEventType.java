...
public static final class mClassName extends Enum
{
    ...
    public static final UNSPECIFIED MOPUB_VIDEO_NATIVE;
    ...
    static 
    {
        ...
        MOPUB_VIDEO_NATIVE = new <init>("MOPUB_VIDEO_NATIVE", 10, "mopub_video_native", "com.mopub.nativeads.MoPubCustomEventVideoNative");
        UNSPECIFIED = new <init>("UNSPECIFIED", 11, "", null);
        $VALUES = (new .VALUES[] {
