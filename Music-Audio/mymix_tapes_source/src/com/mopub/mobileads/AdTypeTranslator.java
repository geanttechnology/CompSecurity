...
{
    public static final class CustomEventType extends Enum
    {

        private static final CustomEventType $VALUES[];
        ...
        private static CustomEventType fromString(String s)
        {
            ...
            for (int i = 0; i < j; i++)
            {
                ...
                if (customeventtype.mKey.equals(s))
                {
        ...
        static 
        {
            ...
            MOPUB_VIDEO_NATIVE = new CustomEventType("MOPUB_VIDEO_NATIVE", 10, "mopub_video_native", "com.mopub.nativeads.MoPubCustomEventVideoNative");
            UNSPECIFIED = new CustomEventType("UNSPECIFIED", 11, "", null);
            $VALUES = (new CustomEventType[] {
                ...
                MOPUB_VIDEO_NATIVE, UNSPECIFIED
            });
        }
    ...
    static String getAdNetworkType(String s, String s1)
    {
    ...
    public static String getCustomEventName(AdFormat adformat, String s, String s1, Map map)
    {
        ...
        if ("json_video".equalsIgnoreCase(s))
        {
        ...
        if ("html".equalsIgnoreCase(s) || "mraid".equalsIgnoreCase(s))
        {
            ...
            {
                adformat = CustomEventType.fromString((new StringBuilder()).append(s).append("_interstitial").toString());
            } else
            {
                adformat = CustomEventType.fromString((new StringBuilder()).append(s).append("_banner").toString());
            }
            return adformat.toString();
        }
        if ("interstitial".equalsIgnoreCase(s))
        {
            return CustomEventType.fromString((new StringBuilder()).append(s1).append("_interstitial").toString()).toString();
        } else
        {
            return CustomEventType.fromString((new StringBuilder()).append(s).append("_banner").toString()).toString();
        }
    }
}
