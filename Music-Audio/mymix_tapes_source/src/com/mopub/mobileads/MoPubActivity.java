...
//            BaseInterstitialActivity, HtmlInterstitialWebView, EventForwardingBroadcastReceiver, MoPubErrorCode
...
public class MoPubActivity extends BaseInterstitialActivity
{
    ...
    static void preRenderHtml(Context context, AdReport adreport, CustomEventInterstitial.CustomEventInterstitialListener customeventinterstitiallistener, String s)
    {
