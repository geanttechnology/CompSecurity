...
//            VastCompanionAdXmlManager, VastTracker, VastLinearXmlManager, VastExtensionParentXmlManager
...
abstract class VastBaseInLineWrapperXmlManager
{
    ...
    {
        Node node = XmlUtils.getFirstMatchingChildNode(mNode, "Extensions");
        if (node == null)
        {
            return null;
        } else
        {
            return new VastExtensionParentXmlManager(node);
        }
    }
}
