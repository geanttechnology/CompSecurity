...
{
    static class DownloadImageAsyncTask extends AsyncTask
    {

        private final Context mContext;
        private final DownloadImageAsyncTaskListener mListener;

        private String getFileNameForUriAndHeaders(URI uri, Map map)
        {
            Preconditions.checkNotNull(uri);
            uri = uri.getPath();
            if (uri != null && map != null) goto _L2; else goto _L1
_L1:
            uri = null;
_L4:
            return uri;
...
label0:
                {
                    ...
                    map = (new StringBuilder()).append(".").append(uri.split("/")[1]).toString();
                    uri = s;
                    if (!s.endsWith(map))
                    {
                        return (new StringBuilder()).append(s).append(map).toString();
                    }
                }
            }
...
_L6:
        ...
        protected Boolean doInBackground(String as[])
        {
            ...
            obj1 = as;
            obj = obj4;
            obj5 = MoPubHttpUrlConnection.getHttpUrlConnection(((String) (obj5)));
            obj1 = as;
            obj = obj4;
            as = new BufferedInputStream(((HttpURLConnection) (obj5)).getInputStream());
            try
            {
                obj1 = ((HttpURLConnection) (obj5)).getHeaderField(ResponseHeader.LOCATION.getKey());
            }
...
_L1:
            ...
            {
                obj = URI.create(((String) (obj1)));
            }
            obj1 = new File(file, getFileNameForUriAndHeaders(((URI) (obj)), ((HttpURLConnection) (obj5)).getHeaderFields()));
            obj = new FileOutputStream(((File) (obj1)));
            Streams.copyContent(as, ((java.io.OutputStream) (obj)));
            loadPictureIntoGalleryApp(((File) (obj1)).toString());
