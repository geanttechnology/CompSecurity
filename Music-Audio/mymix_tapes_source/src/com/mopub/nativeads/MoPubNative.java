...
//            AdRendererRegistry, NativeUrlGenerator, CustomEventNativeAdapter, RequestParameters, 
//            NativeErrorCode, MoPubAdRenderer, NativeAd, BaseNativeAd
...
public class MoPubNative
{
    public static interface MoPubNativeNetworkListener
    {
        ...
        public abstract void onNativeLoad(NativeAd nativead);
    }
    ...
    public MoPubNative(Context context, String s, AdRendererRegistry adrendererregistry, MoPubNativeNetworkListener mopubnativenetworklistener)
    {
    ...
    {
        this(context, s, new AdRendererRegistry(), mopubnativenetworklistener);
    }
    ...
    private void loadNativeAd(RequestParameters requestparameters, Integer integer)
    {
        ...
        {
            MoPubLog.d((new StringBuilder()).append("Loading ad from: ").append(requestparameters).toString());
        }
        ...
        } else
        {
            CustomEventNative.CustomEventNativeListener customeventnativelistener = new CustomEventNative.CustomEventNativeListener() {
                ...
                public void onNativeAdLoaded(BaseNativeAd basenativead)
                {
                    ...
                    {
                        mMoPubNativeNetworkListener.onNativeLoad(new NativeAd(context1, response.getImpressionTrackingUrl(), response.getClickTrackingUrl(), mAdUnitId, basenativead, mopubadrenderer));
                        return;
                    }
                }
    ...
    void onAdError(VolleyError volleyerror)
    {
        ...
        if (volleyerror instanceof MoPubNetworkError)
        {
            ...
            switch (_cls4..SwitchMap.com.mopub.network.MoPubNetworkError.Reason[volleyerror.getReason().ordinal()])
            {
            default:
            ...
            case 1: // '\001'
                mMoPubNativeNetworkListener.onNativeFail(NativeErrorCode.INVALID_RESPONSE);
                return;
