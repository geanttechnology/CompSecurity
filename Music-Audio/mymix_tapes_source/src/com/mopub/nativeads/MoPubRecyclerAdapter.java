...
//            NativeAd, MoPubRecyclerViewHolder, MoPubAdRenderer, RequestParameters
...
public final class MoPubRecyclerAdapter extends android.support.v7.widget.RecyclerView.Adapter
{
    ...
    public void onBindViewHolder(android.support.v7.widget.RecyclerView.ViewHolder viewholder, int i)
    {
        ...
        if (obj != null)
        {
            mStreamAdPlacer.bindAdView((NativeAd)obj, viewholder.itemView);
            return;
        } else
        {
    ...
    public android.support.v7.widget.RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewgroup, int i)
    {
        ...
        {
            MoPubAdRenderer mopubadrenderer = mStreamAdPlacer.getAdRendererForViewType(i + 56);
