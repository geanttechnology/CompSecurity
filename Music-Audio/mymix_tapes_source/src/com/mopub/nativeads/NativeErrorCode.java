...
public final class NativeErrorCode extends Enum
{
    ...
    private static final NativeErrorCode $VALUES[];
    ...
    static 
    {
        ...
        INVALID_RESPONSE = new NativeErrorCode("INVALID_RESPONSE", 1, "Unable to parse response from server.");
        ...
        NATIVE_RENDERER_CONFIGURATION_ERROR = new NativeErrorCode("NATIVE_RENDERER_CONFIGURATION_ERROR", 12, "A required renderer was not registered for the Custom Event Native.");
        NATIVE_ADAPTER_CONFIGURATION_ERROR = new NativeErrorCode("NATIVE_ADAPTER_CONFIGURATION_ERROR", 13, "Custom Event Native was configured incorrectly.");
        NATIVE_ADAPTER_NOT_FOUND = new NativeErrorCode("NATIVE_ADAPTER_NOT_FOUND", 14, "Unable to find Custom Event Native.");
        $VALUES = (new NativeErrorCode[] {
            EMPTY_AD_RESPONSE, INVALID_RESPONSE, IMAGE_DOWNLOAD_FAILURE, INVALID_REQUEST_URL, UNEXPECTED_RESPONSE_CODE, SERVER_ERROR_RESPONSE_CODE, CONNECTION_ERROR, UNSPECIFIED, NETWORK_INVALID_REQUEST, NETWORK_TIMEOUT, 
            NETWORK_NO_FILL, NETWORK_INVALID_STATE, NATIVE_RENDERER_CONFIGURATION_ERROR, NATIVE_ADAPTER_CONFIGURATION_ERROR, NATIVE_ADAPTER_NOT_FOUND
        });
    }
}
