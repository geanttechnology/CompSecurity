...
public class DynamicListView extends ListView
{
    ...
    private void handleCellSwitch()
    {
        ...
        if (switchViewStartTop != 0 || i)
        {
            ...
            if (getPositionForView(observer) >= getHeaderViewsCount())
            {
                swapElements(switchViewStartTop, getPositionForView(observer));
                ...
                mDownY = mLastEventY;
                mDownX = mLastEventX;
                switchViewStartTop = observer.getTop();
                view1.setVisibility(0);
                observer.setVisibility(4);
                updateNeighborViewsForId(mMobileItemId);
    ...
    public boolean onTouchEvent(MotionEvent motionevent)
    {
        ...
        if ((mOnTouchListener instanceof SwipeOnTouchListener) && ((SwipeOnTouchListener)mOnTouchListener).isSwiping())
        {
            ...
            return flag || onTouchEvent(motionevent);
        }
