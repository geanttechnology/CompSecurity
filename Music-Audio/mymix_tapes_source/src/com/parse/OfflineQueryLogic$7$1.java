    ...
    implements Continuation
{
    ...
    // Unreferenced inner class com/parse/OfflineQueryLogic$7

/* anonymous class */
    class OfflineQueryLogic._cls7
        implements OfflineQueryLogic.ConstraintMatcher
    {
        ...
        {
            return inQueryMatcher.matchesAsync(parseobject, parsesqlitedatabase).onSuccess(new OfflineQueryLogic._cls7._cls1());
        }

            
            {
                this$0 = final_offlinequerylogic;
                inQueryMatcher = OfflineQueryLogic.ConstraintMatcher.this;
                super();
            }
    }
