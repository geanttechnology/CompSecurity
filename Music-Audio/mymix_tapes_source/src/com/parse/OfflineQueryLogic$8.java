...
//            OfflineQueryLogic, ParseException, ParseObject, ParseQuery
...
class bQueryMatcher extends bQueryMatcher
{
        ...
        throws ParseException
    {
        ...
        for (list = list.iterator(); list.hasNext();)
        {
            ...
            if (OfflineQueryLogic.access$400(parseobject, OfflineQueryLogic.access$200(OfflineQueryLogic.this, parseobject1, val$resultKey)))
            {
                return true;
            }
        }
    ...
    bQueryMatcher(String s1)
    {
        this$0 = final_offlinequerylogic;
        val$key = String.this;
        val$resultKey = s1;
        super(final_offlinequerylogic, final_parsequery);
    }
}
