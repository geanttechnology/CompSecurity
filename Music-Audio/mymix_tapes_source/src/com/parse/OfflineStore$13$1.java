...
/* anonymous class */
        ...
        implements Continuation
    {
            ...
            throws Exception
        {
            ...
            (offlineObjects. new OfflineStore._cls13._cls1()).setTraverseParseObjects(false).setYieldRoot(false).traverse(json);
            return Task.whenAll(offlineObjects.values()).onSuccess(new OfflineStore._cls13._cls2());
        }
        ...
        // Unreferenced inner class com/parse/OfflineStore$13$2

/* anonymous class */
        class OfflineStore._cls13._cls2
            implements Continuation
        {
            ...
            public Void then(Task task)
                throws Exception
            {
                object.mergeREST(json, new OfflineStore.OfflineDecoder(this$0, offlineObjects, null));
                return null;
            }
