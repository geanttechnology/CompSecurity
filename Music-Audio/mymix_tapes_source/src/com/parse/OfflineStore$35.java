    ...
    implements Continuation
{
        ...
        throws Exception
    {
        ...
        String s2 = ((JSONObject)val$jsonObject.get()).toString();
        int i = ((JSONObject)val$jsonObject.get()).getInt("isDeletingEventually");
        ...
        task.put("isDeletingEventually", Integer.valueOf(i));
