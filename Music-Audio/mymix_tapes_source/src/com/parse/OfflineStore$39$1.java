    ...
    implements Continuation
{
        ...
        throws Exception
    {
        ...
        if (list.size() == 0)
        {
            return OfflineStore.access$900(_fld0, val$uuid, db);
        } else
        {
...
/* anonymous class */
        ...
        implements Continuation
    {
            ...
            throws Exception
        {
            ...
            {
                String s = task.getString(0);
                arraylist.add(OfflineStore.access$600(OfflineStore.this, s, db).onSuccessTask(new OfflineStore._cls39._cls2()).continueWithTask(s. new OfflineStore._cls39._cls1()));
            }
        ...
        // Unreferenced inner class com/parse/OfflineStore$39$2

/* anonymous class */
        class OfflineStore._cls39._cls2
            implements Continuation
        {
