    ...
    implements Continuation
{
    ...
    public Task then(Task task)
        throws Exception
    {
        val$object.set(task.getResult());
        return fetchLocallyAsync((ParseObject)val$object.get(), db);
    }
        ...
        implements Continuation
    {
            ...
            throws Exception
        {
            ...
            for (; !cursor.isAfterLast(); cursor.moveToNext())
            {
                ...
                task = task.onSuccessTask(new OfflineStore._cls8._cls4()).onSuccessTask(object. new OfflineStore._cls8._cls3()).onSuccessTask(new OfflineStore._cls8._cls2()).onSuccess(new OfflineStore._cls8._cls1());
            }
