        ...
        implements Continuation
    {
            ...
            throws Exception
        {
            ...
            for (; !cursor.isAfterLast(); cursor.moveToNext())
            {
                ...
                task = task.onSuccessTask(s. new OfflineStore._cls8._cls4()).onSuccessTask(new OfflineStore._cls8._cls3()).onSuccessTask(new OfflineStore._cls8._cls2()).onSuccess(new OfflineStore._cls8._cls1());
            }
