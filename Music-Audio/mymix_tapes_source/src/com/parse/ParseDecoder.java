...
//            ParseFieldOperations, Parse, ParseFile, ParseGeoPoint, 
    ...
    public Object decode(Object obj)
    {
        ...
        } else
        {
            ...
            if (obj instanceof JSONObject)
            {
                ...
                Object obj2 = ((JSONObject) (obj)).optString("__type", null);
                if (obj2 == null)
                {
                    return convertJSONObjectToMap(((JSONObject) (obj)));
                }
                if (((String) (obj2)).equals("Date"))
                {
                    return Parse.stringToDate(((JSONObject) (obj)).optString("iso"));
                }
                if (((String) (obj2)).equals("Bytes"))
                {
                    return Base64.decodeBase64(((JSONObject) (obj)).optString("base64"));
                }
                if (((String) (obj2)).equals("Pointer"))
                {
                    return decodePointer(((JSONObject) (obj)).optString("className"), ((JSONObject) (obj)).optString("objectId"));
                }
                if (((String) (obj2)).equals("File"))
                {
                    return new ParseFile(((JSONObject) (obj)), this);
                }
                if (((String) (obj2)).equals("GeoPoint"))
                {
                    double d;
                    double d1;
                    try
                ...
                if (((String) (obj2)).equals("Object"))
                {
                    ...
                    obj = ParseObject.createWithoutData(((JSONObject) (obj)).optString("className", null), ((JSONObject) (obj)).optString("objectId", null));
                    ((ParseObject) (obj)).mergeAfterFetch(((JSONObject) (obj2)), this, true);
                    return obj;
                }
                if (((String) (obj2)).equals("Relation"))
                {
                    return new ParseRelation(((JSONObject) (obj)), this);
                }
                if (((String) (obj2)).equals("OfflineObject"))
                {
