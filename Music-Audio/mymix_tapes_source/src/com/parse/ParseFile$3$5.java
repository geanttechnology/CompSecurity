...
//            ParseFile, ParseCommand, ParseUser, ProgressCallback, 
//            ParseFileUtils
    ...
    implements Callable
{
    ...
    public ParseCommand call()
        throws Exception
    {
        final ParseCommand command = ParseFile.access$300(_fld0, val$sessionToken);
        tcs.getTask().continueWith(new Continuation() {
            ...
            {
                this$2 = ParseFile._cls3._cls5.this;
...
/* anonymous class */
        ...
        implements Continuation
    {
            ...
            throws Exception
        {
            ...
            {
                Task.call(ParseUser.getCurrentSessionToken(). new ParseFile._cls3._cls5()).onSuccessTask(new ParseFile._cls3._cls4()).onSuccessTask(new ParseFile._cls3._cls3()).continueWithTask(new ParseFile._cls3._cls2()).continueWith(new ParseFile._cls3._cls1());
                return null;
            }
        }
...
/* anonymous class */
        ...
        // Unreferenced inner class com/parse/ParseFile$3$2

/* anonymous class */
        class ParseFile._cls3._cls2
            implements Continuation
        {
