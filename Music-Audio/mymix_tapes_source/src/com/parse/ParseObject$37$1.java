    ...
    implements Callable
{
    ...
    {
        boolean flag;
        if (((List)val$remaining.get()).size() > 0)
        {
            flag = true;
        } else
        {
...
/* anonymous class */
        ...
        implements Continuation
    {
            ...
            throws Exception
        {
            ...
            return Task.forResult(null).continueWhile(remaining. new ParseObject._cls37._cls1(), new ParseObject._cls37._cls2());
        }
