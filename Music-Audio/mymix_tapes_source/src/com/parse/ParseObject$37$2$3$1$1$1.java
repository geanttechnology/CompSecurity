...
//            ParseObject, ParseOperationSet, ParseUser, PointerEncodingStrategy, 
//            ParseCommand
    ...
    implements Continuation
{
        ...
        throws Exception
    {
        ...
        for (int i = 0; i < rrent.size(); i++)
        {
            org.json.JSONObject jsonobject = ((JSONArray)task.getResult()).getJSONObject(i);
            tasks.add(((ParseObject)rrent.get(i)).handleSaveResultAsync(jsonobject, (ParseOperationSet)erations.get(i)));
        }
...
label0:
            ...
            {
                this$5 = ParseObject._cls37._cls2._cls3._cls1._cls1._cls1.this;
                tasks = list;
                super();
            }
        });
