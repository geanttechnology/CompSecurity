...
//            ParseObject, ParseOperationSet, PointerEncodingStrategy, ParseCommand, 
//            ParseUser
    ...
    implements Continuation
{
        ...
        throws Exception
    {
        ...
        {
            task.put(((ParseObject)current.get(i)).constructSaveCommand((ParseOperationSet)operations.get(i), PointerEncodingStrategy.get(), ionToken).toJSONObject());
        }

        ParseCommand parsecommand = new ParseCommand("multi", ionToken);
        ...
        return parsecommand.executeAsync().cast().onSuccessTask(new Continuation() {
                ...
                throws Exception
            {
                ...
                {
                    org.json.JSONObject jsonobject = ((JSONArray)task1.getResult()).getJSONObject(j);
                    arraylist.add(((ParseObject)current.get(j)).handleSaveResultAsync(jsonobject, (ParseOperationSet)operations.get(j)));
                }
...
/* anonymous class */
        ...
        implements Continuation
    {
            ...
            throws Exception
        {
            ...
            if (ParseUser.getCurrentUser() != null)
            {
                ...
                if (ParseUser.getCurrentUser().isLazy())
                {
                    ...
                    {
                        task = task1.onSuccessTask(new ParseObject._cls37._cls2._cls2()).onSuccess(new ParseObject._cls37._cls2._cls1());
                    }
                }
            }
            return task.onSuccessTask((new ArrayList()). new ParseObject._cls37._cls2._cls3());
        }
        ...
        // Unreferenced inner class com/parse/ParseObject$37$2$1

/* anonymous class */
        class ParseObject._cls37._cls2._cls1
            implements Continuation
        {
