...
//            ParseObject, ParseUser, ParseOperationSet, PointerEncodingStrategy, 
//            ParseCommand
        ...
        throws Exception
    {
        ...
        return task.continueWithTask(new Continuation() {
                ...
                throws Exception
            {
                ...
                {
                    task1.put(((ParseObject)current.get(i)).constructSaveCommand((ParseOperationSet)operations.get(i), PointerEncodingStrategy.get(), sessionToken).toJSONObject());
                }
