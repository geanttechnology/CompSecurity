...
//            ParseObject, ParsePinningEventuallyQueue, EventuallyPin, ParseCommand, 
    ...
    implements Continuation
{
    ...
    public Task then(Task task)
        throws Exception
    {
        Object obj = val$saveTask.getResult();
        if (type == 1)
        {
...
/* anonymous class */
        ...
        implements Continuation
    {
            ...
            throws Exception
        {
            ...
            {
                return eventuallyPin.unpinInBackground("_eventuallyPin").continueWithTask(saveTask. new ParsePinningEventuallyQueue._cls13._cls1._cls2()).continueWithTask(new ParsePinningEventuallyQueue._cls13._cls1._cls1());
            }
        }
