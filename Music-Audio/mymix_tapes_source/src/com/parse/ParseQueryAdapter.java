...
//            FindCallback, OfflineStore, ParseException
...
public class ParseQueryAdapter extends BaseAdapter
{
    ...
    private void loadObjects(int i, final boolean shouldClear)
    {
        ...
        query.findInBackground(new FindCallback() {
            ...
            {
                if (!OfflineStore.isEnabled() && query.getCachePolicy() == ParseQuery.CachePolicy.CACHE_ONLY && parseexception != null && parseexception.getCode() == 120)
                {
                    return;
                }
