...
class PushHistory
{
    ...
    public boolean tryInsertPush(String s, String s1)
    {
        ...
        {
            Parse.logE("com.parse.PushHistory", (new StringBuilder()).append("Ignored old push ").append(s).append(" at ").append(s1).append(" before cutoff ").append(cutoff).toString());
            return false;
        }
        if (s != null)
        {
            ...
            {
                Parse.logE("com.parse.PushHistory", (new StringBuilder()).append("Ignored duplicate push ").append(s).toString());
                return false;
            }
