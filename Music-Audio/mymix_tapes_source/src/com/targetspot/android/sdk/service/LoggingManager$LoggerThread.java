...
class this._cls0 extends Thread
{
    ...
    {
        Looper.prepare();
        LoggingManager.access$002(LoggingManager.this, new Handler() {

            final LoggingManager.LoggerThread this$1;
...
_L2:
                ...
                loadLogInfo();
                if (LoggingManager.access$100(this$0).size() > 0)
                {
                    LoggingManager.access$000(this$0).sendEmptyMessageDelayed(4, 0xdbba0L);
                    return;
                }
                  goto _L1
_L3:
...
_L5:
                ...
                storeUnfilled((LoggingManager.Unfilled)message.obj);
                return;
_L6:
...
_L7:
            ...
            {
                this$1 = LoggingManager.LoggerThread.this;
                super();
            }
        });
        LoggingManager.access$000(LoggingManager.this).sendEmptyMessage(0);
        Looper.loop();
    }
