    ...
    implements X509TrustManager
{
    ...
    {
        a = ex1;
        ex1 = TrustManagerFactory.getInstance(TrustManagerFactory.getDefaultAlgorithm());
        ex1.init(null);
        b = (X509TrustManager)ex1.getTrustManagers()[0];
    }
...
label1:
                {
                    ...
                    if (i < ax509certificate.length)
                    {
                        s = bt.a(ax509certificate[i].getEncoded());
                        if (!a.c.equals(s))
                        {
                            break label1;
                        }
