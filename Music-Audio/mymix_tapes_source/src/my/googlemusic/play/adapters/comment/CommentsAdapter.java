    ...
    implements CommentsRequestListener
{
    ...
    public CommentsAdapter(Context context, List list, Server server, CommentsRequestListener commentsrequestlistener, CommentsClickListener commentsclicklistener)
    {
        if (context == null)
        {
            return;
    ...
    class ViewHolder {}
        ...
        mHolder.replies.setOnClickListener(new ProfileListener(comment, mClickListener));
        return view;
    }
    ...
    {
        boolean flag;
        if (!my/googlemusic/play/adapters/comment/CommentsAdapter.desiredAssertionStatus())
        {
            flag = true;
        } else
        {
