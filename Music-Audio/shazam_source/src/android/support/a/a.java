...
_L3:
        ...
        list = android.support.a.c.a(context, applicationinfo, file, false);
        if (!a(list))
        {
...
label0:
        {
            context = android.support.a.c.a(context, applicationinfo, file, true);
            if (!a(((List) (context))))
            {
                break label0;
            }
...
_L1:
    ...
    private static boolean a(List list)
    {
        ...
        {
            if (!android.support.a.c.a((File)list.next()))
            {
                return false;
            }
        }
