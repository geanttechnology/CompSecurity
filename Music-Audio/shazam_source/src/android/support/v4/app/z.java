...
final class z
{
        ...
        implements s, t
    {
        ...
        public final Notification b()
        {
            ...
            if (obj != null)
            {
                z.a(notification).putSparseParcelableArray("android.support.actionExtras", ((SparseArray) (obj)));
            }
            return notification;
        }
    ...
    public static Bundle a(android.app.Notification.Builder builder, x.a a1)
    {
        ...
        if (a1.e() != null)
        {
            builder.putParcelableArray("android.support.remoteInputs", ae.a(a1.e()));
        }
        return builder;
    }
