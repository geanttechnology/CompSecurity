...
static interface rawable
{

    public abstract void a(Drawable drawable);

    public abstract void a(Drawable drawable, float f, float f1);
    ...
    public abstract void a(Drawable drawable, android.graphics.erDuff.Mode mode);
