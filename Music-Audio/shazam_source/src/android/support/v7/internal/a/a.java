...
label0:
        {
            attributeset = context.obtainStyledAttributes(attributeset, android.support.v7.b.k.View, 0, 0);
            int i;
            if (flag)
            {
                i = attributeset.getResourceId(android.support.v7.b.k.View_android_theme, 0);
            } else
            {
                i = 0;
            }
            if (i == 0)
            {
                i = attributeset.getResourceId(android.support.v7.b.k.View_theme, 0);
            }
