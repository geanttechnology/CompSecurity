    ...
    implements m.a
{
    ...
    public ListMenuItemView(Context context, AttributeSet attributeset, int i1)
    {
        ...
        l = context;
        attributeset = context.obtainStyledAttributes(attributeset, android.support.v7.b.a.k.MenuView, i1, 0);
        g = attributeset.getDrawable(android.support.v7.b.a.k.MenuView_android_itemBackground);
        h = attributeset.getResourceId(android.support.v7.b.a.k.MenuView_android_itemTextAppearance, -1);
        j = attributeset.getBoolean(android.support.v7.b.a.k.MenuView_preserveIconSpacing, false);
        i = context;
    ...
    private void b()
    {
        c = (RadioButton)getInflater().inflate(android.support.v7.b.a.h.abc_list_menu_item_radio, this, false);
        addView(c);
    }

    private void c()
    {
        e = (CheckBox)getInflater().inflate(android.support.v7.b.a.h.abc_list_menu_item_checkbox, this, false);
        addView(e);
    }
...
_L6:
    ...
    protected void onFinishInflate()
    {
        ...
        d = (TextView)findViewById(android.support.v7.b.a.f.title);
        if (h != -1)
        {
            d.setTextAppearance(i, h);
        }
        f = (TextView)findViewById(android.support.v7.b.a.f.shortcut);
    }
...
_L3:
    ...
    public void setIcon(Drawable drawable)
    {
        ...
        if ((flag || j) && (b != null || drawable != null || j))
        {
            if (b == null)
            {
                b = (ImageView)getInflater().inflate(android.support.v7.b.a.h.abc_list_menu_item_icon, this, false);
                addView(b, 0);
            }
            if (drawable != null || j)
            {
