    ...
    implements android.support.v4.c.a.a
{
    ...
    public f(Context context)
    {
        ...
        r = new ArrayList();
        s = true;
        if (m.getConfiguration().keyboard == 1 || !m.getBoolean(android.support.v7.b.a.b.abc_config_showMenuShortcutsWhenKeyboardPresent))
        {
            flag = false;
        }
        o = flag;
        ...
        for (sparsearray = null; i1 < j1; sparsearray = sparsearray2)
        {
            ...
            if (view != null)
            {
                ...
                if (view.getId() != -1)
                {
                    ...
                    if (android.support.v4.view.m.d(menuitem))
                    {
    ...
    public final void b(Bundle bundle)
    {
        if (bundle != null)
        {
            ...
            if (j1 > 0)
            {
                ...
                if (bundle != null)
                {
                    android.support.v4.view.m.c(bundle);
                    return;
                }
            }
        }
