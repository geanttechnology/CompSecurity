...
public class ActionBarContainer extends FrameLayout
{
    ...
    public ActionBarContainer(Context context, AttributeSet attributeset)
    {
        ...
        context = context.obtainStyledAttributes(attributeset, android.support.v7.b.a.k.ActionBar);
        a = context.getDrawable(android.support.v7.b.a.k.ActionBar_background);
        b = context.getDrawable(android.support.v7.b.a.k.ActionBar_backgroundStacked);
        j = context.getDimensionPixelSize(android.support.v7.b.a.k.ActionBar_height, -1);
        if (getId() == android.support.v7.b.a.f.split_action_bar)
        {
            d = true;
            c = context.getDrawable(android.support.v7.b.a.k.ActionBar_backgroundSplit);
        }
        context.recycle();
        if (d)
        {
    ...
    public void onFinishInflate()
    {
        ...
        h = findViewById(android.support.v7.b.a.f.action_bar);
        i = findViewById(android.support.v7.b.a.f.action_context_bar);
    }
...
_L3:
    ...
    public void setTabContainer(m m1)
    {
        if (g != null)
        {
            removeView(g);
        ...
        {
            addView(m1);
            android.view.ViewGroup.LayoutParams layoutparams = m1.getLayoutParams();
            layoutparams.width = -1;
            layoutparams.height = -2;
            m1.setAllowCollapse(false);
        }
    }
