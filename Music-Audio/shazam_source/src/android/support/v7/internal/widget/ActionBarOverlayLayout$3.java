    ...
    implements Runnable
{
    ...
    public final void run()
    {
        ...
        ActionBarOverlayLayout.a(a, w.n(ActionBarOverlayLayout.d(a)).c(0.0F).a(ActionBarOverlayLayout.c(a)));
        if (ActionBarOverlayLayout.e(a) != null && ActionBarOverlayLayout.e(a).getVisibility() != 8)
        {
            ActionBarOverlayLayout.b(a, w.n(ActionBarOverlayLayout.e(a)).c(0.0F).a(ActionBarOverlayLayout.f(a)));
        }
    }
