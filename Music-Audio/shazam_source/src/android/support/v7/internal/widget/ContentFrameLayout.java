...
_L4:
        l = android.view.View.MeasureSpec.makeMeasureSpec(Math.min(k - (a.left + a.right), android.view.View.MeasureSpec.getSize(i)), 0x40000000);
        flag1 = true;
_L11:
        k = j;
        if (j1 == 0x80000000)
        {
            ...
            if (typedvalue != null)
            {
                ...
                if (typedvalue.type != 0)
                {
                    ...
                    if (i > 0)
                    {
                        k = android.view.View.MeasureSpec.makeMeasureSpec(Math.min(i - (a.top + a.bottom), android.view.View.MeasureSpec.getSize(j)), 0x40000000);
                    }
                }
            }
        }
