    ...
    implements t.a
{
    static interface a
    {
        ...
        public abstract RecyclerView.u a(int i);
...
_L6:
    ...
    final boolean e;
    final t f;
    private android.support.v4.f.g.a g;

    android.support.v7.widget.b(a a1)
    {
        this(a1, (byte)0);
    }

    private android.support.v7.widget.b(a a1, byte byte0)
    {
        g = new android.support.v4.f.g.b();
        a = new ArrayList();
        b = new ArrayList();
        c = a1;
        e = false;
