    ...
    implements android.view.View.OnClickListener
{
    private static final class a
    {
        ...
        public a(View view)
        {
            ...
            e = (ImageView)view.findViewById(android.support.v7.b.a.f.edit_query);
        }
    }
...
_L2:
        ...
        obj = android.support.v4.a.b.a(n, i);
        a(s2, ((Drawable) (obj)));
        return ((Drawable) (obj));
...
_L8:
    ...
    public final View a(Context context, Cursor cursor, ViewGroup viewgroup)
    {
        ...
        ((ImageView)context.findViewById(android.support.v7.b.a.f.edit_query)).setImageResource(p);
        return context;
    }
    ...
    public final void a(View view, Cursor cursor)
    {
        ...
        if (a1.b != null)
        {
            ...
            if (obj != null)
            {
                ...
                {
                    view = new TypedValue();
                    d.getTheme().resolveAttribute(android.support.v7.b.a.a.textColorSearchUrl, view, true);
