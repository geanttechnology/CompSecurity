...
final class n extends ImageButton
{
...
_L1:
        ...
        {
            obj = new android.widget.eLayout.LayoutParams(getLayoutParams());
            ((android.widget.eLayout.LayoutParams) (obj)).setMargins(0, 0, 0, 0);
            obj.gravity = 51;
            post(new Runnable(((android.widget.eLayout.LayoutParams) (obj))) {
    ...
    _cls1.a(k k1, Context context, x x1)
    {
        b = k1;
        a = x1;
        super(context);
