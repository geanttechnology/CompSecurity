    ...
    implements Runnable
{
    ...
    public final void run()
    {
        ...
        if (!flag && !flag1)
        {
            com.appnexus.opensdk.b.b.d(b.f, com.appnexus.opensdk.b.b.a(.response_no_ads));
        ...
        } else
        {
            ...
            if (a != null)
            {
                ...
                if (ar1 != null)
                {
                    ...
                    {
                        com.appnexus.opensdk.b.b.a(b.b, com.appnexus.opensdk.b.b.a(.webview_loading, ((String) (obj2))));
                        ...
                        i = (int)((float)ar1.b * f + 0.5F);
                        m1.setLayoutParams(new android.widget.eLayout.LayoutParams((int)(f * (float)ar1.c + 0.5F), i, 17));
    ...
    _cls1.a(l l1, ar ar1, com.appnexus.opensdk.k k1)
    {
        c = l1;
        a = ar1;
        b = k1;
