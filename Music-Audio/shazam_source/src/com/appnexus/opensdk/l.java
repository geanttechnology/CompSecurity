...
final class l extends ao
{
    ...
    l(com.appnexus.opensdk.k k1)
    {
        d = new WeakReference(k1);
    }

    public final void a(aq aq)
    {
        e();
        com.appnexus.opensdk.k k1 = (com.appnexus.opensdk.k)d.get();
        if (k1 != null)
        {
            k1.getAdDispatcher().a(aq);
        }
    }
