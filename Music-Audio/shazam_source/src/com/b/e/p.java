...
_L5:
    ...
    {
        Object obj = new X509EncodedKeySpec(g.b);
        ...
        obj = new String(com.b.e.b.a(cipher.doFinal(s.getBytes())));
        (new StringBuilder("encrypt(")).append(s).append(")=").append(((String) (obj)));
        com.b.e.c.a(com/b/e/p);
        return ((String) (obj));
    }
