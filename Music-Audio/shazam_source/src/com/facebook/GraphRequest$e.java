    ...
    implements d
{
    ...
    private void a(String s, Uri uri, String s1)
    {
        ...
        a(s, s, s2);
        s1 = k.g().getContentResolver().openInputStream(uri);
        int i;
        if (a instanceof v)
        {
            long l = t.a(uri);
    ...
    private void a(String s, ParcelFileDescriptor parcelfiledescriptor, String s1)
    {
        ...
        {
            i = t.a(new android.os.iptor.AutoCloseInputStream(parcelfiledescriptor), a) + 0;
        }
        b("", new Object[0]);
        b();
        if (b != null)
...
_L5:
    ...
    public tor(OutputStream outputstream, o o1, boolean flag)
    {
        c = true;
        d = false;
        a = outputstream;
