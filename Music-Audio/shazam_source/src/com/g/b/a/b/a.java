...
abstract class a extends HttpsURLConnection
{
    ...
    public Principal getLocalPrincipal()
    {
        ...
        if (n1 != null)
        {
            ...
            if (!n1.c.isEmpty())
            {
                x500principal = ((X509Certificate)n1.c.get(0)).getSubjectX500Principal();
            }
        }
    ...
    public Principal getPeerPrincipal()
    {
        ...
        if (n1 != null)
        {
            ...
            if (!n1.b.isEmpty())
            {
                x500principal = ((X509Certificate)n1.b.get(0)).getSubjectX500Principal();
            }
        }
        return x500principal;
    }
