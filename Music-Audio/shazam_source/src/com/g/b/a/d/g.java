        ...
        implements com.g.b.a.d.b
    {
        ...
        private List a(int i, short word0, byte byte0, int j)
        {
            ...
            for (obj = a; !((f.a) (obj)).b.e();)
            {
                ...
                if (i == 64)
                {
                    ((f.a) (obj)).a(new com.g.b.a.d.d(f.a(((f.a) (obj)).b()), ((f.a) (obj)).b()));
                } else
                if ((i & 0x40) == 64)
                {
                    ((f.a) (obj)).a(new com.g.b.a.d.d(((f.a) (obj)).b(((f.a) (obj)).a(i, 63) - 1), ((f.a) (obj)).b()));
                } else
                if ((i & 0x20) == 32)
                {
                ...
                if (i == 16 || i == 0)
                {
                    f f1 = f.a(((f.a) (obj)).b());
                    f f3 = ((f.a) (obj)).b();
                    ((f.a) (obj)).a.add(new com.g.b.a.d.d(f1, f3));
                } else
                {
                    f f2 = ((f.a) (obj)).b(((f.a) (obj)).a(i, 15) - 1);
                    f f4 = ((f.a) (obj)).b();
                    ((f.a) (obj)).a.add(new com.g.b.a.d.d(f2, f4));
                }
            }
...
_L3:
            ...
            a1.a(false, flag4, i2, a(g.a(k, byte1, i), i, byte1, i2), com.g.b.a.d.e.d);
            return true;
_L4:
            if (j2 != 5)
            {
...
_L5:
            ...
            int l = b.i();
            com.g.b.a.d.a a2 = com.g.b.a.d.a.b(l);
            if (a2 == null)
            {
...
_L7:
            ...
            a1.a(b.i() & 0x7fffffff, a(g.a(j2 - 4, byte1, word0), word0, byte1, i2));
            return true;
_L8:
            if (j2 != 8)
            {
...
_L1:
        ...
        public final void a(boolean flag, int i, c.c c1, int j)
        {
            byte byte0 = 0;
            this;
            JVM INSTR monitorenter ;
...
_L9:
    ...
    private static final Logger a = Logger.getLogger(com/g/b/a/d/g$b.getName());
    ...
    static int a(e e1)
    {
        return (e1.g() & 0xff) << 16 | (e1.g() & 0xff) << 8 | e1.g() & 0xff;
    }
    ...
    public final com.g.b.a.d.b a(e e1, boolean flag)
    {
        return new c(e1, flag);
    }

    public final com.g.b.a.d.c a(c.d d1, boolean flag)
    {
