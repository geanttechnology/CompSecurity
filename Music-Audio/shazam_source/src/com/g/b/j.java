...
public final class j
{
    ...
    {
        e = new ThreadPoolExecutor(0, 1, 60L, TimeUnit.SECONDS, new LinkedBlockingQueue(), k.c("OkHttp ConnectionPool"));
        b = l;
        c = l1 * 1000L * 1000L;
    }
...
_L4:
        ...
        l = (com.g.b.i)listiterator.previous();
        l5 = (l.d() + c) - l3;
...
_L6:
        ...
        do
        {
            ...
            i1 = (com.g.b.i)listiterator.previous();
        } while (!i1.c());
        ((List) (obj)).add(i1);
        listiterator.remove();
        j1--;
...
_L8:
        ...
        {
            k.a(((com.g.b.i)((List) (obj)).get(k1)).c);
        }
