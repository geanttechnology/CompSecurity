...
_L3:
        ...
        if (c1 != null)
        {
            ...
            if (c1.a())
            {
                ...
                if (((a) (message)).a.n)
                {
                    ah.a("Dispatcher", "canceled", ((a) (message)).b.a());
                }
            }
        }
        if (j.h.contains(((a) (message)).j))
        {
            ...
            if (((a) (message)).a.n)
            {
                ah.a("Dispatcher", "canceled", ((a) (message)).b.a(), "because paused request got canceled");
            }
        }
        message = (a)j.f.remove(message.c());
        if (message != null && ((a) (message)).a.n)
        {
            ah.a("Dispatcher", "canceled", ((a) (message)).b.a(), "from replaying");
            return;
        }
...
_L13:
    ...
    public ooper(Looper looper, i j)
    {
        super(looper);
        a = j;
    }
