...
final class v extends BitmapDrawable
{
    ...
    private v(Context context, Bitmap bitmap, Drawable drawable, u.d d1, boolean flag, boolean flag1)
    {
    ...
    static void a(ImageView imageview, Context context, Bitmap bitmap, u.d d1, boolean flag, boolean flag1)
    {
        ...
        imageview.setImageDrawable(new v(context, bitmap, drawable, d1, flag, flag1));
    }
