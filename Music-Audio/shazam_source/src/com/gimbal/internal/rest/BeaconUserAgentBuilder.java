...
public class BeaconUserAgentBuilder
    implements Keep
{

    public static final String CLOSE_BRACKETS = ")";
    public static final String COMMA = ",";
    public static final String GIMBAL_SDK_VERSION_KEY = "com.gimbal.beacon";
    public static final String OPEN_BRACKETS = "(";
    public static final String PLATFORM = "Android";
    public static final String SEPARATOR = "/";
    public static final String SPACE = " ";
    public static final String UNKNOWN = "UNKNOWN";
    private static final b publicLogger = c.f(com/gimbal/internal/rest/BeaconUserAgentBuilder.getName());
    private final Context context;

    public BeaconUserAgentBuilder(Context context1)
    {
        context = context1;
    }
    ...
    private String getGimbalSDKReleaseVersion()
    {
        ...
        URL url = com/gimbal/internal/rest/BeaconUserAgentBuilder.getResource("maven.properties");
        try
        {
            ((Properties) (obj)).load(url.openStream());
            obj = ((Properties) (obj)).getProperty("gimbal.beacon.sdk.version");
        }
        catch (Exception exception)
        {
    ...
    public String getUserAgent()
    {
        ...
        stringbuilder.append(" ");
        stringbuilder.append("com.gimbal.beacon");
        stringbuilder.append("/");
