...
public abstract class com.google.a.g.a.a
    implements j
{
    static final class a extends AbstractQueuedSynchronizer
    {
        ...
        final Object a()
        {
            ...
            case 4: // '\004'
            case 8: // '\b'
                throw com.google.a.g.a.a.a("Task was cancelled.", b);
            }
        }
    ...
    {
        boolean flag = a.a(null, (Throwable)g.a(throwable), 2);
        if (flag)
        {
            b.a();
        }
