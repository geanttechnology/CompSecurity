    ...
    extends IInterface
{
        ...
        implements f
    {
        ...
        public static f a(IBinder ibinder)
        {
            ...
            IInterface iinterface = ibinder.queryLocalInterface("com.google.android.youtube.player.internal.IEmbeddedPlayer");
        ...
        public boolean onTransact(int i1, Parcel parcel, Parcel parcel1, int j1)
        {
            ...
            case 41: // ')'
                ...
                boolean flag11 = a(i1, ((KeyEvent) (obj)));
                parcel1.writeNoException();
                i1 = ((flag) ? 1 : 0);
                if (flag11)
                {
            ...
            case 42: // '*'
                ...
                boolean flag12 = b(i1, ((KeyEvent) (obj)));
                parcel1.writeNoException();
                i1 = ((flag1) ? 1 : 0);
                if (flag12)
                {
...
_L3:
        ...
        public final v s()
        {
            ...
            parcel1.readException();
            v = com.google.android.a.a.a.v.a.a(parcel1.readStrongBinder());
            parcel1.recycle();
            parcel.recycle();
            return v;
            Exception exception;
    ...
    public abstract void a(String s1, int i1, int j1);

    public abstract void a(List list, int i1, int j1);
    ...
    public abstract void b(String s1, int i1);

    public abstract void b(String s1, int i1, int j1);

    public abstract void b(List list, int i1, int j1);
