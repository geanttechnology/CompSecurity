    ...
    extends IInterface
{
        ...
        implements n
    {
        ...
        public static n a(IBinder ibinder)
        {
            ...
            IInterface iinterface = ibinder.queryLocalInterface("com.google.android.youtube.player.internal.IYouTubeService");
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel1, int j)
        {
            ...
            case 2: // '\002'
                ...
                {
                    IInterface iinterface = parcel.queryLocalInterface("com.google.android.youtube.player.internal.IThumbnailLoaderClient");
                    if (iinterface != null && (iinterface instanceof l))
                    {
                        parcel = (l)iinterface;
                    } else
                    {
                        parcel = new l.a.a(parcel);
                    }
                }
                m1 = a(parcel);
                parcel1.writeNoException();
...
_L1:
            ...
            parcel1.readException();
            l1 = m.a.a(parcel1.readStrongBinder());
            parcel1.recycle();
            parcel.recycle();
            return l1;
            l1 = null;
