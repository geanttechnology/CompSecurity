    ...
    implements android.os.Parcelable.Creator
{
    ...
    static void a(SearchAdRequestParcel searchadrequestparcel, Parcel parcel)
    {
        ...
        b.b(parcel, 1, searchadrequestparcel.a);
        b.b(parcel, 2, searchadrequestparcel.b);
        b.b(parcel, 3, searchadrequestparcel.c);
        b.b(parcel, 4, searchadrequestparcel.d);
        b.b(parcel, 5, searchadrequestparcel.e);
        b.b(parcel, 6, searchadrequestparcel.f);
        b.b(parcel, 7, searchadrequestparcel.g);
        b.b(parcel, 8, searchadrequestparcel.h);
        b.b(parcel, 9, searchadrequestparcel.i);
        b.a(parcel, 10, searchadrequestparcel.j, false);
        b.b(parcel, 11, searchadrequestparcel.k);
        b.a(parcel, 12, searchadrequestparcel.l, false);
        b.b(parcel, 13, searchadrequestparcel.m);
        b.b(parcel, 14, searchadrequestparcel.n);
    ...
    public final Object createFromParcel(Parcel parcel)
    {
        ...
        do
        {
            if (parcel.dataPosition() < i3)
            {
                ...
                case 15: // '\017'
                    s = com.google.android.gms.common.internal.safeparcel.a.k(parcel, j3);
                    break;
                }
            } else
            if (parcel.dataPosition() != i3)
