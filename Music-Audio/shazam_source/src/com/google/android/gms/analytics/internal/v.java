...
_L1:
        ...
        public final SQLiteDatabase getWritableDatabase()
        {
            ...
            catch (SQLiteException sqliteexception)
            {
                ...
                Object obj = v.b(a);
                ((o) (a)).i.a.getDatabasePath(((String) (obj))).delete();
                try
                {
...
_L3:
    ...
    private List c(long l1)
    {
        ...
        ArrayList arraylist;
        obj1 = null;
        com.google.android.gms.analytics.internal.r.i();
        o();
        if (l1 <= 0L)
        {
...
_L4:
    ...
    private Map g(String s1)
    {
        ...
        if (!s1.startsWith("?"))
        {
            ...
            {
                e("Error parsing hit parameters", s1);
                return new HashMap(0);
            }
        }
    ...
    private Map h(String s1)
    {
        ...
        {
            e("Error parsing property parameters", s1);
            return new HashMap(0);
        }
        return s1;
    }
...
_L1:
        ...
        obj = obj1;
        ((List) (obj2)).add(new c(this, g(s1), l2, l.e(s2), l1, j));
        obj = obj1;
...
_L5:
    ...
    public final void a(c c1)
    {
        ...
        Object obj1 = c1.a.entrySet().iterator();
        do
        {
        ...
        {
            super.i.a().a(c1, "Hit length exceeds the maximum allowed size");
            return;
        }
        int j = ((Integer)com.google.android.gms.analytics.internal.ak.f.a()).intValue();
        l1 = q();
        if (l1 > (long)(j - 1))
        {
            obj1 = c((l1 - (long)j) + 1L);
        ...
        contentvalues.put("hit_app_id", Integer.valueOf(c1.e));
        if (c1.f)
        {
            obj = ad.h();
        } else
    ...
    public final void a(t t1)
    {
        ...
        ((ContentValues) (obj1)).put("app_uid", Long.valueOf(t1.a));
        ((ContentValues) (obj1)).put("cid", t1.b);
        ((ContentValues) (obj1)).put("tid", t1.c);
        int j;
        if (t1.d)
        {
            j = 1;
        ...
        ((ContentValues) (obj1)).put("hits_count", Long.valueOf(t1.e));
...
_L2:
        ...
        return ((List) (obj1));
_L4:
        ((List) (obj1)).add(new t(s1, s2, flag, l1, map));
        if (true) goto _L6; else goto _L5
_L5:
