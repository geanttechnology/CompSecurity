...
public final class ay
{
    ...
    {
        Object obj = com.google.android.gms.ads.internal.p.m();
        ArrayList arraylist = new ArrayList();
        obj = ((av) (obj)).b.iterator();
        do
        {
            ...
            Object obj1 = (au)((Iterator) (obj)).next();
            obj1 = (String)com.google.android.gms.ads.internal.p.n().a(((au) (obj1)));
            if (obj1 != null)
            {
                arraylist.add(obj1);
            }
...
label0:
        {
            ax1 = com.google.android.gms.ads.internal.p.n();
            synchronized (ax1.a)
            {
                if (!ax1.b)
                {
        ...
        ax1.c = context.getSharedPreferences("google_ads_flags", 1);
        ax1.b = true;
        obj;
        JVM INSTR monitorexit ;
    }
