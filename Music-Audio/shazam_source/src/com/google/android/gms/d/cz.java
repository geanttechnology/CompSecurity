...
public final class cz
{
    ...
    public cz(String s)
    {
        ...
        {
            cx cx1 = new cx(jsonarray.getJSONObject(l));
            arraylist.add(cx1);
            int j1 = i1;
            if (i1 < 0)
            {
    ...
    private static boolean a(cx cx1)
    {
        for (cx1 = cx1.c.iterator(); cx1.hasNext();)
        {
            if (((String)cx1.next()).equals("com.google.ads.mediation.admob.AdMobAdapter"))
            {
                return true;
            }
        }
