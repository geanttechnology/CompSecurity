...
public final class de
{
    ...
    public static void a(Context context, String s, gb gb1, String s1, boolean flag, List list)
    {
        if (list != null && !list.isEmpty())
        {
            ...
            {
                String s3 = ((String)iterator.next()).replaceAll("@gw_adlocid@", s1).replaceAll("@gw_adnetrefresh@", s2).replaceAll("@gw_qdata@", gb1.o.f).replaceAll("@gw_sdkver@", s).replaceAll("@gw_sessid@", p.h().b).replaceAll("@gw_seqnum@", gb1.i);
                list = s3;
                if (gb1.l != null)
                {
                    list = s3.replaceAll("@gw_adnetid@", gb1.l.b).replaceAll("@gw_allocid@", gb1.l.d);
                }
                gl.a(((gi) (new gt(context, s, list))).i);
            }
        }
    }
}
