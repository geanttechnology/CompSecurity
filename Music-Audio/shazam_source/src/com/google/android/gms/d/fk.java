    ...
    implements Thread.UncaughtExceptionHandler
{
    ...
    private static boolean a(String s)
    {
        ...
        try
        {
            flag = Class.forName(s).isAnnotationPresent(com/google/android/gms/d/fl);
        }
        // Misplaced declaration of an exception variable
        catch (String s)
        {
...
_L4:
        if (throwable != null)
        {
            ...
            p.e();
            arraylist.add(throwable.appendQueryParameter("device", com.google.android.gms.d.gm.b()).appendQueryParameter("js", d.b).appendQueryParameter("appid", c.getApplicationContext().getPackageName()).appendQueryParameter("stacktrace", stringwriter.toString()).appendQueryParameter("eids", TextUtils.join(",", ay.a())).appendQueryParameter("trapped", String.valueOf(flag)).toString());
            p.e();
            gm.a(c, d.b, arraylist, p.h().f());
            return;
        }
