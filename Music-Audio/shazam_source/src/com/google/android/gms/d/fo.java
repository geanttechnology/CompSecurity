...
public final class fo
{
    ...
    public static AdResponseParcel a(Context context, AdRequestInfoParcel adrequestinfoparcel, String s)
    {
        ...
        {
            (new StringBuilder("Could not parse the mediation config: ")).append(context.getMessage());
            b.a(5);
...
_L16:
        obj = com.google.android.gms.d.fn.a(adrequestinfoparcel, context, adrequestinfoparcel.k.b, s2, null, null);
...
_L17:
        ...
        adrequestinfoparcel.append(context).append(" or ad_url field.");
        b.a(5);
...
_L43:
    ...
    private static UsageInfo a(Context context, String s)
    {
        ...
        context.b();
        com.google.android.gms.appdatasearch.GetRecentContextCall.Request.a a1 = new com.google.android.gms.appdatasearch.GetRecentContextCall.Request.a();
        a1.c = true;
        a1.e = s;
        s = new com.google.android.gms.appdatasearch.GetRecentContextCall.Request(a1.a, a1.b, a1.c, a1.d, a1.e);
        s = (com.google.android.gms.appdatasearch.GetRecentContextCall.Response)a.c.a(context, s).a(TimeUnit.SECONDS);
        if (s == null) goto _L2; else goto _L1
_L1:
        if (((com.google.android.gms.appdatasearch.GetRecentContextCall.Response) (s)).a.b()) goto _L3; else goto _L2
_L2:
        b.a(4);
        if (context != null)
        {
...
_L7:
    ...
    public static JSONObject a(Context context, AdRequestInfoParcel adrequestinfoparcel, fs fs1, ar ar1, String s, List list)
    {
        ...
        try
        {
            ...
            list = com.google.android.gms.d.gh.a();
        }
        // Misplaced declaration of an exception variable
        catch (Context context)
        {
            (new StringBuilder("Problem serializing ad request to JSON: ")).append(context.getMessage());
            b.a(5);
            return null;
        }
        if (list == null)
...
_L3:
        ...
        JVM INSTR tableswitch 0 3: default 2469
    //                   0 2481
    //                   1 2489
    //                   2 2497
    //                   3 2505;
...
_L10:
        ...
        JVM INSTR tableswitch 0 2: default 2475
    //                   0 2521
    //                   1 2529
    //                   2 2513;
...
_L29:
        ...
        if (adrequestinfoparcel.c.a >= 2 && adrequestinfoparcel.c.k != null)
        {
            ...
            s.put("radius", Float.valueOf(f1 * 1000F));
...
_L39:
        ...
        if (flag)
        {
            break MISSING_BLOCK_LABEL_2094;
        }
...
_L36:
        if (f.a) goto _L42; else goto _L41
_L41:
        b.a(4);
          goto _L43
_L42:
...
_L32:
        i;
        JVM INSTR tableswitch 1 2: default 2560
    //                   1 2574
    //                   2 2581;
           goto _L55 _L56 _L57
_L61:
...
_L57:
    ...
    private static void a(UsageInfo usageinfo, String s, Bundle bundle)
    {
        if (usageinfo != null && usageinfo.f != null) goto _L2; else goto _L1
_L1:
        return;
_L2:
        Object obj = usageinfo.f;
        usageinfo = ((DocumentContents) (obj)).a("web_url");
        if (usageinfo != null)
        {
            usageinfo = ((DocumentSection) (usageinfo)).c;
        } else
        {
            usageinfo = null;
        }
        if (!TextUtils.isEmpty(usageinfo))
        {
            bundle.putString("web_url", usageinfo);
        }
        try
        {
            usageinfo = ((DocumentContents) (obj)).a("intent_data");
        }
        // Misplaced declaration of an exception variable
...
_L4:
        usageinfo = Uri.parse(((DocumentSection) (usageinfo)).c);
        s = (new android.net.Uri.Builder()).scheme("android-app").authority(s);
        if (usageinfo == null)
        {
            break MISSING_BLOCK_LABEL_190;
        }
        s.appendPath(usageinfo.getScheme());
        if (usageinfo.getAuthority() != null)
        {
            s.appendPath(usageinfo.getAuthority());
        }
        for (obj = usageinfo.getPathSegments().iterator(); ((Iterator) (obj)).hasNext(); s.appendPath((String)((Iterator) (obj)).next())) { }
        s.encodedQuery(usageinfo.getEncodedQuery()).encodedFragment(usageinfo.getEncodedFragment());
        bundle.putString("app_uri", (new com.google.android.gms.a.a(s.build())).toString());
        return;
    }
