...
public final class kv
{
    ...
    private kv(ByteBuffer bytebuffer)
    {
        a = bytebuffer;
    }

    private kv(byte abyte0[], int i)
    {
...
_L4:
    ...
    public static kv a(byte abyte0[], int i)
    {
        return new kv(abyte0, i);
    }
    ...
    public static int b(int i, lc lc1)
    {
        i = c(i);
        int j = lc1.f();
        return i + (j + e(j));
...
_L4:
    ...
    public final void a(int i, lc lc1)
    {
        c(i, 2);
        a(lc1);
    }
