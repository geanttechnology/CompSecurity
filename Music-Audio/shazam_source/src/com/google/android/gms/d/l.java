    ...
    implements k
{
    ...
    protected l(Context context, q q1, r r1)
    {
        c = q1;
        d = r1;
        try
...
_L2:
        ...
        (new kt(context.getBytes("UTF-8"))).a(messagedigest);
    ...
    public final void a(int i, int i1, int j1)
    {
        if (a != null)
        {
            a.recycle();
        }
        a = MotionEvent.obtain(0L, j1, 1, (float)i * b.density, (float)i1 * b.density, 0.0F, 0.0F, 0, 0.0F, 0.0F, 0, 0);
    }

    protected final void a(int i, long l1)
    {
        d.a(i, l1);
    }
