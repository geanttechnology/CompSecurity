...
public final class ld
{
    ...
    public static String a(lc lc1)
    {
        ...
        try
        {
            a(null, lc1, new StringBuffer(), stringbuffer);
        }
        // Misplaced declaration of an exception variable
        catch (lc lc1)
        {
            return (new StringBuilder("Error printing proto: ")).append(lc1.getMessage()).toString();
        }
        // Misplaced declaration of an exception variable
        catch (lc lc1)
        {
...
_L1:
        if (!(obj instanceof lc)) goto _L4; else goto _L3
_L3:
        Class class1;
        Object aobj[];
        int j;
