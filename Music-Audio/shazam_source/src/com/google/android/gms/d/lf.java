...
_L8:
        ...
        protected final void finalize()
        {
            if (!c)
            {
                ...
                lf.c("Marker log finalized without finish() - uncaught exit point for request", new Object[0]);
            }
        }
...
_L3:
        ...
        if (aobj[i].getClass().equals(com/google/android/gms/d/lf)) goto _L2; else goto _L1
_L1:
