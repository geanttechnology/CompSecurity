...
_L1:
        ...
        public final com.google.android.gms.maps.model.a.h a(TileOverlayOptions tileoverlayoptions)
        {
            Parcel parcel;
            Parcel parcel1;
            parcel = Parcel.obtain();
...
_L3:
    ...
    public boolean onTransact(int i, Parcel parcel, Parcel parcel1, int l)
    {
        ...
        case 12: // '\f'
            ...
            if (parcel.readInt() != 0)
            {
                h h1 = GroundOverlayOptions.CREATOR;
                parcel = h.a(parcel);
            } else
            {
                parcel = null;
        ...
        case 13: // '\r'
            parcel.enforceInterface("com.google.android.gms.maps.internal.IGoogleMapDelegate");
            com.google.android.gms.maps.model.a.h h2;
            if (parcel.readInt() != 0)
            {
        ...
        case 38: // '&'
            ...
            a(((ah) (obj1)), com.google.android.gms.b.a(parcel.readStrongBinder()));
            parcel1.writeNoException();
            return true;
