    ...
    implements android.os.Parcelable.Creator
{
    ...
    public static PersonEntity a(Parcel parcel)
    {
        ...
        do
        {
            ...
            if (parcel.dataPosition() != k1)
            {
                throw new com.google.android.gms.common.internal.safeparcel.a((new StringBuilder("Overread allowed size end=")).append(k1).toString(), parcel);
            } else
            {
    ...
    static void a(PersonEntity personentity, Parcel parcel, int i)
    {
        ...
        {
            b.a(parcel, 23, personentity.t, true);
        }
        if (set.contains(Integer.valueOf(22)))
        {
            b.a(parcel, 22, personentity.s, true);
        }
        if (set.contains(Integer.valueOf(25)))
        {
            b.b(parcel, 25, personentity.v);
        }
        if (set.contains(Integer.valueOf(24)))
        {
            b.b(parcel, 24, personentity.u);
        }
        ...
        {
            b.a(parcel, 28, personentity.y, true);
        }
        b.b(parcel, j);
    }
