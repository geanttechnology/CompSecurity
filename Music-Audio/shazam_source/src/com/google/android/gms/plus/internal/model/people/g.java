    ...
    implements android.os.Parcelable.Creator
{
    ...
    static void a(PersonEntity.NameEntity nameentity, Parcel parcel)
    {
        ...
        {
            b.b(parcel, 1, nameentity.b);
        }
        if (set.contains(Integer.valueOf(2)))
        {
            b.a(parcel, 2, nameentity.c, true);
        }
        if (set.contains(Integer.valueOf(3)))
        {
            b.a(parcel, 3, nameentity.d, true);
        }
        if (set.contains(Integer.valueOf(4)))
        {
            b.a(parcel, 4, nameentity.e, true);
        }
        if (set.contains(Integer.valueOf(5)))
        {
            b.a(parcel, 5, nameentity.f, true);
        }
        if (set.contains(Integer.valueOf(6)))
        {
            b.a(parcel, 6, nameentity.g, true);
        }
        if (set.contains(Integer.valueOf(7)))
        {
            b.a(parcel, 7, nameentity.h, true);
        }
        b.b(parcel, i);
    }
