...
//            e, CheckServerAuthResult, RecordConsentRequest
        ...
        implements f
    {
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel1, int j)
        {
            ...
            case 2: // '\002'
                ...
                a(authaccountrequest, e.a.a(parcel.readStrongBinder()));
            ...
            case 5: // '\005'
                ...
                } else
                {
                    ...
                    {
                        parcel = new com.google.android.gms.common.internal.u.a.a(parcel);
                    }
                }
            ...
            case 8: // '\b'
                ...
                a(i, account, e.a.a(parcel.readStrongBinder()));
                parcel1.writeNoException();
                return true;

            case 9: // '\t'
                parcel.enforceInterface("com.google.android.gms.signin.internal.ISignInService");
                q q = com.google.android.gms.common.internal.q.a.a(parcel.readStrongBinder());
                i = parcel.readInt();
                boolean flag1 = flag2;
                if (parcel.readInt() != 0)
                {
            ...
            case 10: // '\n'
                ...
                a(recordconsentrequest, e.a.a(parcel.readStrongBinder()));
                parcel1.writeNoException();
                return true;
...
_L2:
        ...
        public final void a(ResolveAccountRequest resolveaccountrequest, u u1)
        {
            Parcel parcel;
            Parcel parcel1;
            parcel = Parcel.obtain();
...
_L1:
    ...
    public abstract void a(int i, Account account, e e);

    public abstract void a(AuthAccountRequest authaccountrequest, e e);

    public abstract void a(ResolveAccountRequest resolveaccountrequest, u u);

    public abstract void a(q q, int i, boolean flag);

    public abstract void a(CheckServerAuthResult checkserverauthresult);

    public abstract void a(RecordConsentRequest recordconsentrequest, e e);
