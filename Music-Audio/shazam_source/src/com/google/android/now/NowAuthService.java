...
_L3:
        ...
        i;
        JVM INSTR tableswitch 0 3: default 249
    //                   0 181
    //                   1 189
    //                   2 203
    //                   3 217;
...
_L5:
        Log.e("NowAuthService", (new StringBuilder("Unknown error: ")).append(i).toString());
        throw new IOException((new StringBuilder("Unexpected error from Google Now app: ")).append(i).toString());
        s;
