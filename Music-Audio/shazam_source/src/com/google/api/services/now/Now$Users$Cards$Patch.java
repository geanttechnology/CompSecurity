...
public class cardId extends NowRequest
{
    ...
    public setAlt setCardId(String s)
    {
        cardId = s;
        return this;
    }

    public cardId setFields(String s)
    {
        return (cardId)super.setFields(s);
    }
    ...
    protected (String s, String s1, Card card)
    {
        this$2 = this._cls2.this;
        super(_fld2, "PATCH", "users/{userId}/cards/{cardId}", card, com/google/api/services/now/model/Card);
