...
label0:
        {
            ...
            {
                if (val$trackKey != null)
                {
                    break label0;
                }
                SingleTrackSequencerUnit.access$000(SingleTrackSequencerUnit.this).quenceReachedEnd(SingleTrackSequencerUnit.this);
            }
            return;
        }
        SingleTrackSequencerUnit.access$000(SingleTrackSequencerUnit.this).veToNextComplete(val$trackKey, SingleTrackSequencerUnit.this);
    }
