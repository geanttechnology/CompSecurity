    ...
    implements Runnable
{
    ...
    public void run()
    {
        ...
        {
            StationSequencerUnit.access$300(StationSequencerUnit.this).onMoveToPreviousComplete(((ApiModel)StationSequencerUnit.access$100(StationSequencerUnit.this).get(StationSequencerUnit.access$200(StationSequencerUnit.this))).key, StationSequencerUnit.this);
        }
    }
