        ...
        implements AudioPlayerListener
    {
        ...
        public void onInfo(AudioInfo audioinfo)
        {
            if (audioinfo.getDetail() == com.rdio.android.audioplayer.interfaces.AudioInfo.AudioInfoDetail.BufferingEnd)
            {
                ...
                for (audioinfo = PlayerManagerInternal.access$300(PlayerManagerInternal.this).iterator(); audioinfo.hasNext(); PlayerManagerInternal.access$400(PlayerManagerInternal.this).post(playerlistener. new PlayerManagerInternal._cls2._cls3()))
                {
