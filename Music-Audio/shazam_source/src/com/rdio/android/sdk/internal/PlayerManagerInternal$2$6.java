...
/* anonymous class */
        ...
        implements AudioPlayerListener
    {
        ...
        public void onError(final AudioError error)
        {
            ...
            final PlayerListener listener;
            for (Iterator iterator = PlayerManagerInternal.access$300(PlayerManagerInternal.this).iterator(); iterator.hasNext(); PlayerManagerInternal.access$400(PlayerManagerInternal.this).post(new PlayerManagerInternal._cls2._cls7()))
            {
                listener = (PlayerListener)iterator.next();
            }
        ...
        public void onSeekCompleted()
        {
            ...
            for (Iterator iterator = PlayerManagerInternal.access$300(PlayerManagerInternal.this).iterator(); iterator.hasNext(); PlayerManagerInternal.access$400(PlayerManagerInternal.this).post(playerlistener. new PlayerManagerInternal._cls2._cls6()))
            {
...
/* anonymous class */
        ...
        // Unreferenced inner class com/rdio/android/sdk/internal/PlayerManagerInternal$2$7

/* anonymous class */
        class PlayerManagerInternal._cls2._cls7
            implements Runnable
        {
