    ...
    implements android.view.ner
{
    ...
    {
        SignUpActivity.a(a).logEvent(view, AccountLoginEventFactory.signUp(com.shazam.android.analytics.event.factory.Factory.AccountLoginProviderName.FACEBOOK));
        SignUpActivity.b(a).c();
    }
