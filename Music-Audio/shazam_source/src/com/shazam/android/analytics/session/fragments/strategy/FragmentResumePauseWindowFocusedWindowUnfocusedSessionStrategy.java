...
public class FragmentResumePauseWindowFocusedWindowUnfocusedSessionStrategy extends NoOpFragmentSessionStrategy
{

    private final SessionManager sessionManager;

    public FragmentResumePauseWindowFocusedWindowUnfocusedSessionStrategy(SessionManager sessionmanager)
    {
