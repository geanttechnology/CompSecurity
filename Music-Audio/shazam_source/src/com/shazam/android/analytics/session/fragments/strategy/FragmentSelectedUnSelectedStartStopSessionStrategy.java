...
public class FragmentSelectedUnSelectedStartStopSessionStrategy extends NoOpFragmentSessionStrategy
{

    private final SessionManager sessionManager;

    public FragmentSelectedUnSelectedStartStopSessionStrategy(SessionManager sessionmanager)
    {
