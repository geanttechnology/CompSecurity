...
public final class ah
{
    ...
    public ah(Context context, CrittercismConfig crittercismconfig)
    {
        boolean flag;
        flag = true;
        super();
        break MISSING_BLOCK_LABEL_6;
        if (!crittercismconfig.g() || android.os.Build.VERSION.SDK_INT < 16 && !a("android.permission.READ_LOGS", context))
        {
            flag = false;
        }
        a = flag;
