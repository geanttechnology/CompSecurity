...
public final class ff
{
    ...
    public static Object a(Field field, Object obj)
    {
        ...
        {
            throw new cz("Unable to get value of field", field);
        }
        return field;
    }
    ...
    public static Field a(Class class1, Class class2)
    {
        ...
        for (int i = 0; i < afield.length;)
        {
            ...
            if (class2.isAssignableFrom(afield[i].getType()))
            {
                if (class1 != null)
                {
                    throw new cz((new StringBuilder("Field is ambiguous: ")).append(class1.getName()).append(", ").append(afield[i].getName()).toString());
                }
                obj = afield[i];
            }
            i++;
        ...
        if (class1 == null)
        {
            throw new cz((new StringBuilder("Could not find field matching type: ")).append(class2.getName()).toString());
        } else
        {
