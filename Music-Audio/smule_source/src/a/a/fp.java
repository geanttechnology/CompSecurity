...
public final class fp extends HttpsURLConnection
{
    ...
    public fp(HttpsURLConnection httpsurlconnection, eq eq1, ds ds1)
    {
        ...
        d = ds1;
        c = new cj(httpsurlconnection.getURL());
...
_L1:
        ...
        fm1 = new fm(b.getHeaderFields());
        i = fm1.b("Content-Length");
        if (i != -1)
        {
            long l;
            long l1;
        ...
        l = fm1.a("X-Android-Sent-Millis");
        l1 = fm1.a("X-Android-Received-Millis");
        i = ((flag) ? 1 : 0);
...
_L4:
    ...
    public final InputStream getErrorStream()
    {
        ...
        fq fq1 = new fq(((InputStream) (obj)), a, c);
        return fq1;
        obj;
        throw obj;
        Throwable throwable;
    ...
    public final InputStream getInputStream()
    {
        ...
        fq1 = new fq(((InputStream) (obj)), a, c);
        return fq1;
        obj;
        throw obj;
        Throwable throwable;
    ...
    public final OutputStream getOutputStream()
    {
        ...
        fr fr1 = new fr(((OutputStream) (obj)), c);
        return fr1;
        obj;
        throw obj;
        Throwable throwable;
    ...
    public final void setSSLSocketFactory(SSLSocketFactory sslsocketfactory)
    {
        ...
        try
        {
            ...
            {
                sslsocketfactory1 = ((c)sslsocketfactory).a();
            }
        }
        // Misplaced declaration of an exception variable
