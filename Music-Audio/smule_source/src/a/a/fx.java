...
public final class fx extends SSLContextSpi
{
    ...
    private fx(SSLContextSpi sslcontextspi, eq eq, ds ds)
    {
        c = sslcontextspi;
        d = eq;
        e = ds;
    ...
    public static fx a(SSLContextSpi sslcontextspi, eq eq, ds ds)
    {
        if (!b)
        {
            return null;
        ...
        {
            return new fx(sslcontextspi, eq, ds);
        }
    }
    ...
    protected final SSLSocketFactory engineGetSocketFactory()
    {
        ...
        if (sslsocketfactory != null)
        {
            try
            {
                obj = new c(sslsocketfactory, d, e);
            }
    ...
    static 
    {
        ...
        try
        {
            ...
            ff.a(a);
            fx fx1 = new fx(new fx(), null, null);
            fx1.engineCreateSSLEngine();
            fx1.engineCreateSSLEngine(null, 0);
            fx1.engineGetClientSessionContext();
            fx1.engineGetServerSessionContext();
            fx1.engineGetServerSocketFactory();
            fx1.engineGetSocketFactory();
            fx1.engineInit(null, null, null);
            b = true;
        }
        catch (Throwable throwable)
        {
