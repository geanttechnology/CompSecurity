...
public class SearchViewCompat
{
    ...
    private class SearchViewCompatImpl
    {
    ...
    private class SearchViewCompatIcsImpl extends SearchViewCompatHoneycombImpl
    {
        private class SearchViewCompatHoneycombImpl extends SearchViewCompatStubImpl
        {
            private class SearchViewCompatStubImpl
