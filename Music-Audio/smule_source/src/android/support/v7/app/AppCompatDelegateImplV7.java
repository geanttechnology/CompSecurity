...
_L3:
    ...
    public View createView(View view, String s, Context context, AttributeSet attributeset)
    {
        ...
        if (flag && mSubDecorInstalled && view != null && view.getId() != 0x1020002)
        {
            flag1 = true;
        } else
        {
        ...
        return mAppCompatViewInflater.createView(view, s, context, attributeset, flag1, flag);
    }
...
_L4:
    ...
    public boolean onMenuItemSelected(MenuBuilder menubuilder, MenuItem menuitem)
    {
        ...
        if (callback != null && !isDestroyed())
        {
            menubuilder = findMenuPanel(menubuilder.p());
            if (menubuilder != null)
            {
    ...
    ActionMode startSupportActionModeFromWindow(android.support.v7.view.ActionMode.Callback callback)
    {
        ...
        if (mActionModeView != null)
        {
            ...
            obj = new StandaloneActionMode(((Context) (obj)), ((ActionBarContextView) (obj1)), actionmodecallbackwrapper, flag);
