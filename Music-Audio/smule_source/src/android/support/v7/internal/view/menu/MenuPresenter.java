...
//            MenuBuilder, j, MenuView, v

public interface MenuPresenter
{

    public abstract boolean collapseItemActionView(MenuBuilder menubuilder, j j);

    public abstract boolean expandItemActionView(MenuBuilder menubuilder, j j);
    ...
    public abstract boolean onSubMenuSelected(v v);
