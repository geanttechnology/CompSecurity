    ...
    implements MenuItem
{
    ...
    {
        return new l(this, a, actionprovider);
    }
    ...
    public ActionProvider getActionProvider()
    {
        ...
        if (actionprovider instanceof l)
        {
            return ((l)actionprovider).a;
        } else
        {
            return null;
        }
    ...
    public MenuItem setActionView(int i)
    {
        ...
        {
            ((SupportMenuItem)b).setActionView(new m(view));
        }
        return this;
    }
    ...
    public MenuItem setOnActionExpandListener(android.view.MenuItem.OnActionExpandListener onactionexpandlistener)
    {
        ...
        {
            onactionexpandlistener = new n(this, onactionexpandlistener);
        } else
        {
    ...
    public MenuItem setOnMenuItemClickListener(android.view.MenuItem.OnMenuItemClickListener onmenuitemclicklistener)
    {
        ...
        {
            onmenuitemclicklistener = new o(this, onmenuitemclicklistener);
        } else
        {
