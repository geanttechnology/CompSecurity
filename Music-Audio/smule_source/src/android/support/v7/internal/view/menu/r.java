    ...
    implements MenuPresenter, android.view.View.OnKeyListener, android.view.ViewTreeObserver.OnGlobalLayoutListener, android.widget.AdapterView.OnItemClickListener, android.widget.PopupWindow.OnDismissListener
{
    ...
    public r(Context context, MenuBuilder menubuilder)
    {
        this(context, menubuilder, null, false, android.support.v7.appcompat.R.attr.popupMenuStyle);
    }

    public r(Context context, MenuBuilder menubuilder, View view)
    {
        this(context, menubuilder, view, false, android.support.v7.appcompat.R.attr.popupMenuStyle);
    }

    public r(Context context, MenuBuilder menubuilder, View view, boolean flag, int i)
    {
        this(context, menubuilder, view, flag, i, 0);
    }

    public r(Context context, MenuBuilder menubuilder, View view, boolean flag, int i, int j)
    {
        mDropDownGravity = 0;
        mContext = context;
        mInflater = LayoutInflater.from(context);
        mMenu = menubuilder;
        mAdapter = new s(this, mMenu);
        mOverflowOnly = flag;
        mPopupStyleAttr = i;
        mPopupStyleRes = j;
...
label0:
            {
                ...
                if (j < k1)
                {
                    ...
                    view = s1.getView(j, view, mMeasureParent);
                    view.measure(i1, j1);
    ...
    public boolean collapseItemActionView(MenuBuilder menubuilder, j j)
    {
        return false;
    }
    ...
    public boolean expandItemActionView(MenuBuilder menubuilder, j j)
    {
        return false;
    }
    ...
    public void onItemClick(AdapterView adapterview, View view, int i, long l)
    {
        ...
        s.a(adapterview).a(adapterview.a(i), 0);
    }
    ...
    {
        if (!v1.hasVisibleItems()) goto _L2; else goto _L1
_L1:
        r r1;
        int i;
        int j;
        r1 = new r(mContext, v1, mAnchorView);
        r1.setCallback(mPresenterCallback);
        j = v1.size();
        i = 0;
_L5:
        MenuItem menuitem;
        ...
        menuitem = v1.getItem(i);
        if (!menuitem.isVisible() || menuitem.getIcon() == null) goto _L4; else goto _L3
_L3:
        boolean flag = true;
_L6:
        r1.setForceShowIcon(flag);
        if (r1.tryShow())
        {
            if (mPresenterCallback != null)
            {
                mPresenterCallback.onOpenSubMenu(v1);
            }
            return true;
        }
          goto _L2
