...
public class AppCompatPopupWindow extends PopupWindow
{
    ...
    private static void wrapOnScrollChangedListener(final PopupWindow popup)
    {
        try
        {
            ...
            field.set(popup, new android.view.ViewTreeObserver.OnScrollChangedListener() {
        ...
        {
            Log.d("AppCompatPopupWindow", "Exception while installing workaround OnScrollChangedListener", popup);
        }
    }
