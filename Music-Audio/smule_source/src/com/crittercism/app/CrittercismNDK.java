...
public class CrittercismNDK
{
    ...
    public static void a(Context context, String s)
    {
        ...
        en.c("Unable to initialize NDK crash reporting.");
        return;
    }
    ...
    public static boolean a(Context context)
    {
        ...
        {
            en.a("Unable to install NDK library", context);
            file.delete();
            return false;
        }
        return true;
...
label0:
        {
            ...
            {
                en.b((new StringBuilder("Could not install breakpad library: ")).append(context.toString()).toString());
                return false;
            }
        }
          goto _L1
