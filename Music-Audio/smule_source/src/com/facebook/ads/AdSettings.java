...
public class AdSettings
{
    ...
    private static void a(String s1)
    {
        ...
        {
            a = true;
            Log.d(TAG, (new StringBuilder()).append("Test mode device hash: ").append(s1).toString());
            Log.d(TAG, (new StringBuilder()).append("When testing your app with Facebook's ad units you must specify the device hashed ID to ensure the delivery of test ads, add the following code before loading an ad: AdSettings.addTestDevice(\"").append(s1).append("\");").toString());
            return;
        }
    }
