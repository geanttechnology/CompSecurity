...
class <init> extends BroadcastReceiver
{
    ...
    public void a()
    {
        ...
        intentfilter.addAction((new StringBuilder()).append("com.facebook.ads.native.impression:").append(NativeAd.e(a).o()).toString());
        intentfilter.addAction((new StringBuilder()).append("com.facebook.ads.native.click:").append(NativeAd.e(a).o()).toString());
