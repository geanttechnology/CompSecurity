...
_L2:
    ...
    private static void c(Context context)
    {
        ...
        {
            Debug.v((new StringBuilder()).append("Failed to retrieve BUNDLE, APPVERS, APPBUILD").append(namenotfoundexception1.getMessage()).toString());
        }
...
_L1:
        ...
        {
            Debug.v((new StringBuilder()).append("Failed to retrieve APPNAME ").append(namenotfoundexception.getMessage()).toString());
        }
          goto _L1
    }
