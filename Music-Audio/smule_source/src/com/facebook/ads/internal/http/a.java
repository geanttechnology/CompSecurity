...
public class a
{
    ...
    public a(Context context, com.facebook.ads.internal.e e1)
    {
        ...
        HttpProtocolParams.setUserAgent(basichttpparams, (new StringBuilder()).append(h.a(context, e1)).append(" FacebookADsSDK/").append("4.3.0").append(" (").append("AB/").append(e.d).append(";").append("AV/").append(e.f).append(";").append("BV/").append(e.g).append(";").append("LC/").append(Locale.getDefault().toString()).append(")").toString());
