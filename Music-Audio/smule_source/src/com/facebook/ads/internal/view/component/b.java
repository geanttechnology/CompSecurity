...
public class b extends LinearLayout
{
    ...
    public b(Context context, NativeAd nativead, NativeAdViewAttributes nativeadviewattributes, boolean flag, int i)
    {
        ...
        if (flag)
        {
            ...
            h1.setText(nativead.getAdBody());
            f.b(h1, nativeadviewattributes);
            h1.setMinTextSize(nativeadviewattributes.getDescriptionTextSize() - 1);
            nativead = new android.widget.LinearLayout.LayoutParams(-1, 0);
            nativead.weight = 1.0F;
            h1.setLayoutParams(nativead);
            h1.setGravity(80);
            context.addView(h1);
        }
    }
