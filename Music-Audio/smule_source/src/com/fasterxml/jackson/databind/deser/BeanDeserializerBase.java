            ...
            if (annotationintrospector != null)
            {
                ...
                if (obj2 != null)
                {
                    ...
                    if (obj == com/fasterxml/jackson/annotation/ObjectIdGenerators$PropertyGenerator)
                    {
                        ...
                        if (obj2 == null)
                        {
                            throw new IllegalArgumentException((new StringBuilder()).append("Invalid Object Id definition for ").append(handledType().getName()).append(": can not find property with name '").append(obj).append("'").toString());
                        }
    ...
    public void resolve(DeserializationContext deserializationcontext)
    {
        ...
        do
        {
            ...
            } else
            {
                ...
                JsonDeserializer jsondeserializer1 = deserializationcontext.handlePrimaryContextualization(((JsonDeserializer) (obj)), ((BeanProperty) (obj1)));
                boolean flag;
                if (jsondeserializer1 != obj)
                {
                    obj = ((SettableBeanProperty) (obj1)).withValueDeserializer(jsondeserializer1);
                } else
                {
                    obj = obj1;
                }
        ...
        if (_valueInstantiator.canCreateUsingDelegate())
        {
            ...
            obj1 = _valueInstantiator.getDelegateCreator();
            _delegateDeserializer = findDeserializer(deserializationcontext, ((JavaType) (obj)), new com.fasterxml.jackson.databind.BeanProperty.Std(TEMP_PROPERTY_NAME, ((JavaType) (obj)), null, _classAnnotations, ((com.fasterxml.jackson.databind.introspect.AnnotatedMember) (obj1)), PropertyMetadata.STD_OPTIONAL));
        }
        if (builder1 != null)
        {
