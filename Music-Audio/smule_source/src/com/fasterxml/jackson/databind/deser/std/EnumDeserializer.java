...
_L5:
        throw deserializationcontext.weirdStringException(jsonparser, _resolver.getEnumClass(), (new StringBuilder()).append("value not one of declared Enum instance names: ").append(_resolver.getEnums()).toString());
    }
