...
_L1:
        ...
        if (jsonparser.nextToken() != JsonToken.END_ARRAY)
        {
          ...
          goto _L3
_L2:
        String s1 = jsonparser.getValueAsString();
...
_L8:
        ...
        {
            obj = "not a valid textual representation";
            if (jsonparser != null)
            {
                obj = (new StringBuilder()).append("not a valid textual representation").append("problem: ").append(jsonparser.getMessage()).toString();
            }
