...
//            FlurryAdInterstitialListener, FlurryAdTargeting, FlurryAdErrorType

public final class FlurryAdInterstitial
{

    private static final String a = com/flurry/android/ads/FlurryAdInterstitial.getSimpleName();
    private t b;
    private final fy c;
    private FlurryAdInterstitialListener d;

    public FlurryAdInterstitial(Context context, String s)
    {
        c = new fy() {
            ...
            public void a(d d1)
            {
                if (d1.a == FlurryAdInterstitial.a(a) && d1.b != null)
                {
                    ...
                    {
                        fp.a().a(new hq(this, d1, flurryadinterstitiallistener) {
    ...
    static t a(FlurryAdInterstitial flurryadinterstitial)
    {
        return flurryadinterstitial.b;
    }

    static FlurryAdInterstitialListener b(FlurryAdInterstitial flurryadinterstitial)
    {
        return flurryadinterstitial.d;
    }
    ...
    public void setListener(FlurryAdInterstitialListener flurryadinterstitiallistener)
    {
        try
        {
            d = flurryadinterstitiallistener;
            return;
        }
        // Misplaced declaration of an exception variable
        catch (FlurryAdInterstitialListener flurryadinterstitiallistener)
        {
            gd.a(a, "Exception: ", flurryadinterstitiallistener);
        }
    }
