...
_L12:
    ...
    private boolean m()
    {
        ...
        try
        {
            i1 = GooglePlayServicesUtil.isGooglePlayServicesAvailable(fp.a().c());
        }
        ...
        gd.e(a, (new StringBuilder()).append("Google Play Services not available - connection result: ").append(i1).toString());
        return false;
    }
