...
_L1:
    ...
    {
        throw new ka((new StringBuilder()).append(s1).append(" at line ").append(v()).append(" column ").append(w()).append(" path ").append(q()).toString());
    }
...
_L1:
    ...
    public double k()
    {
        ...
        do
        {
            ...
            {
                throw new ka((new StringBuilder()).append("JSON forbids NaN and infinities: ").append(d1).append(" at line ").append(v()).append(" column ").append(w()).append(" path ").append(q()).toString());
            } else
            {
                l = null;
                i = 0;
