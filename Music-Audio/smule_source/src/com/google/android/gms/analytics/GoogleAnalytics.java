...
public final class GoogleAnalytics extends zza
{
    ...
    {
        for (Iterator iterator = zzEy.iterator(); iterator.hasNext(); ((zza)iterator.next()).zzn(activity)) { }
    }

    void zzm(Activity activity)
    {
        for (Iterator iterator = zzEy.iterator(); iterator.hasNext(); ((zza)iterator.next()).zzo(activity)) { }
    }
