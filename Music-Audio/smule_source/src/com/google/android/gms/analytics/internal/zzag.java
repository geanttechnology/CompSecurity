...
_L5:
    ...
    String zza(zzaa zzaa1, boolean flag)
    {
        ...
        zza(stringbuilder, "ht", String.valueOf(zzaa1.zziP()));
        zza(stringbuilder, "qt", String.valueOf(zzgG().currentTimeMillis() - zzaa1.zziP()));
        if (zzgI().zzhP())
        {
...
label1:
        ...
        if (200 == i)
        {
            zza("Batched upload completed. Hits batched", Integer.valueOf(zza1.zzjc()));
            return arraylist;
        }
    ...
    public List zzg(List list)
    {
        ...
        zzv.zzr(list);
        boolean flag1;
        if (zzgI().zzij().isEmpty() || !zzIv.zzt(zzgI().zzic() * 1000L))
        {
            flag2 = false;
            flag1 = false;
        } else
