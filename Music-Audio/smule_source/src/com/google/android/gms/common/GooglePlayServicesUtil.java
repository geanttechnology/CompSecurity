...
public final class GooglePlayServicesUtil
{
    ...
    public static int isGooglePlayServicesAvailable(Context context)
    {
        ...
        zzc1 = com.google.android.gms.common.zzc.zzkA();
    ...
    obj1
        ...
        Log.w("GooglePlayServicesUtil", "Google Play services signature invalid.");
        return 9;
        int i = zzhs.zzbh(0x6fcd18);
        if (zzhs.zzbh(((PackageInfo) (obj)).versionCode) < i)
        {
            Log.w("GooglePlayServicesUtil", (new StringBuilder()).append("Google Play services out of date.  Requires 7327000 but found ").append(((PackageInfo) (obj)).versionCode).toString());
            return 2;
        }
...
_L1:
        ...
        if (com.google.android.gms.common.zzc.zzkA().zza(packagemanager, new zzb.zza[] {
            zzb.zzON[1]
...
_L4:
    ...
    {
        return com.google.android.gms.common.zzc.zzkA().zzb(packagemanager, s);
    }
