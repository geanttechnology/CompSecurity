    ...
    implements com.google.android.gms.common.api.Api.zza, zzj.zza
{
    ...
    protected zzi(Context context, Looper looper, int i, com.google.android.gms.common.api.GoogleApiClient.ConnectionCallbacks connectioncallbacks, com.google.android.gms.common.api.GoogleApiClient.OnConnectionFailedListener onconnectionfailedlistener, zze zze1)
    {
...
_L4:
        zzTp.zza(new zzd(), ((GetServiceRequest) (obj)));
        return;
_L2:
        if (zzlZ())
        {
...
_L3:
    ...
    private class zzd extends zzp.zza
    {
