...
_L10:
    ...
    zza zza(View view, zzab zzab1)
    {
        ...
        if (view instanceof ViewGroup)
        {
            ...
            {
                zza zza1 = zza(view.getChildAt(i), zzab1);
                k += zza1.zzpu;
                j += zza1.zzpv;
            }
...
label0:
    ...
    void zzg(View view)
    {
        ...
        view = zza(view, zzab1);
        zzab1.zzbw();
        if (((zza) (view)).zzpu == 0 && ((zza) (view)).zzpv == 0)
        {
            return;
        }
        try
        {
            if ((((zza) (view)).zzpv != 0 || zzab1.zzbx() != 0) && (((zza) (view)).zzpv != 0 || !zzpj.zza(zzab1)))
            {
                zzpj.zzc(zzab1);
                return;
            }
