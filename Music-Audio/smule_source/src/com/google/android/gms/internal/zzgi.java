...
public class zzgi extends WebChromeClient
{
    ...
    public final boolean onConsoleMessage(ConsoleMessage consolemessage)
    {
        ...
        class _cls7
        {
            ...
            static final int zzDE[];

            static 
            {
                zzDE = new int[android.webkit.ConsoleMessage.MessageLevel.values().length];
                try
                {
                    zzDE[android.webkit.ConsoleMessage.MessageLevel.ERROR.ordinal()] = 1;
                }
                catch (NoSuchFieldError nosuchfielderror4) { }
                try
                {
                    zzDE[android.webkit.ConsoleMessage.MessageLevel.WARNING.ordinal()] = 2;
                }
                catch (NoSuchFieldError nosuchfielderror3) { }
                try
                {
                    zzDE[android.webkit.ConsoleMessage.MessageLevel.LOG.ordinal()] = 3;
                }
                catch (NoSuchFieldError nosuchfielderror2) { }
                try
                {
                    zzDE[android.webkit.ConsoleMessage.MessageLevel.TIP.ordinal()] = 4;
                }
                catch (NoSuchFieldError nosuchfielderror1) { }
                try
                {
                    zzDE[android.webkit.ConsoleMessage.MessageLevel.DEBUG.ordinal()] = 5;
                }
        ...
        _cls7.zzDE[consolemessage.messageLevel().ordinal()];
