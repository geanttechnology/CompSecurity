...
public class zznt
{
    ...
    private Object zzA(List list)
    {
        ...
        {
            list = (zzoa)list.get(list.size() - 1);
            return zzaNJ.cast(zzA(zznq.zzv(((zzoa) (list)).zzaNU)));
        }
    }
    ...
    private Object zzz(List list)
    {
        ...
        {
            zzoa zzoa1 = (zzoa)list.get(i);
            if (zzoa1.zzaNU.length != 0)
            {
                zza(zzoa1, arraylist);
            }
        }
...
_L3:
    ...
    protected void zza(zzoa zzoa1, List list)
    {
        list.add(zzA(zznq.zzv(zzoa1.zzaNU)));
    }
