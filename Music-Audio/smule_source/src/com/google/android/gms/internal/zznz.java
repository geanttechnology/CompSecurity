...
_L1:
        return;
_L2:
        if (!(obj instanceof zzny)) goto _L4; else goto _L3
_L3:
        Class class1;
        Object aobj[];
        int i;
        ...
        if (s != null)
        {
            stringbuffer1.append(stringbuffer).append(zzeC(s)).append(" <\n");
            stringbuffer.append("  ");
        }
        class1 = obj.getClass();
...
_L4:
    ...
    private static String zzbY(String s)
    {
        int j = s.length();
    ...
    private static String zzeC(String s)
    {
    ...
    private static String zzeD(String s)
    {
        String s1 = s;
    ...
    public static String zzg(zzny zzny1)
    {
        if (zzny1 == null)
        {
            return "";
        ...
        try
        {
            zza(null, zzny1, new StringBuffer(), stringbuffer);
        }
        // Misplaced declaration of an exception variable
        catch (zzny zzny1)
        {
            return (new StringBuilder()).append("Error printing proto: ").append(zzny1.getMessage()).toString();
        }
        // Misplaced declaration of an exception variable
        catch (zzny zzny1)
        {
