...
class zzcp
{
    ...
    public zzcp(Context context, com.google.android.gms.internal.zzmq.zzc zzc1, DataLayer datalayer, zzt.zza zza1, zzt.zza zza2, zzah zzah1)
    {
        ...
        for (context = zzaER.zzyx().entrySet().iterator(); context.hasNext();)
        {
            ...
            while (datalayer.hasNext()) 
            {
                ...
                if (!zzdf.zzk((com.google.android.gms.internal.zzd.zza)zza1.zzyt().get(zzb.zzel.toString())).booleanValue())
                {
    ...
    {
        boolean flag1 = true;
        Object obj = (com.google.android.gms.internal.zzd.zza)zza1.zzyt().get(zzb.zzdy.toString());
        if (obj == null)
        {
    ...
    {
        return zzdf.zzg((com.google.android.gms.internal.zzd.zza)zza1.zzyt().get(zzb.zzdJ.toString()));
    }
