...
public interface DatabaseType
{
    ...
    public abstract void appendLimitValue(StringBuilder stringbuilder, int i, Integer integer);

    public abstract void appendOffsetValue(StringBuilder stringbuilder, int i);
