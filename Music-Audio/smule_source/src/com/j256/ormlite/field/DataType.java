...
public final class DataType extends Enum
{
    ...
    static 
    {
        ...
        BIG_DECIMAL = new DataType("BIG_DECIMAL", 28, BigDecimalType.getSingleton());
        UNKNOWN = new DataType("UNKNOWN", 29, null);
        $VALUES = (new DataType[] {
            ...
            FLOAT_OBJ, DOUBLE, DOUBLE_OBJ, SERIALIZABLE, ENUM_STRING, ENUM_INTEGER, UUID, BIG_INTEGER, BIG_DECIMAL, UNKNOWN
        });
    }
}
