...
public class CharacterObjectType extends BaseDataType
{
    ...
    public Object parseDefaultString(FieldType fieldtype, String s)
    {
        if (s.length() != 1)
        {
            throw new SQLException((new StringBuilder()).append("Problems with field ").append(fieldtype).append(", default string to long for Character: '").append(s).append("'").toString());
        } else
        {
