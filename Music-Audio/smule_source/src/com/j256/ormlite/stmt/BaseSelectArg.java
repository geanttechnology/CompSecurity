    ...
    implements ArgumentHolder
{
    ...
    public Object getSqlArgValue()
    {
        ...
        } else
        {
            ...
            if (fieldType != null)
            {
                if (fieldType.isForeign() && fieldType.getFieldType() == obj1.getClass())
                {
    ...
    public void setMetaInfo(FieldType fieldtype)
    {
        ...
        throw new IllegalArgumentException((new StringBuilder()).append("FieldType name cannot be set twice from ").append(fieldType).append(" to ").append(fieldtype).toString());
    }
    ...
    public void setMetaInfo(String s)
    {
        ...
        throw new IllegalArgumentException((new StringBuilder()).append("Column name cannot be set twice from ").append(columnName).append(" to ").append(s).toString());
    }
