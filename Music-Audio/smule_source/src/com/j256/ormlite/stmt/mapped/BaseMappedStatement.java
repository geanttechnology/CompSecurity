...
public abstract class BaseMappedStatement
{
    ...
    static void appendWhereId(DatabaseType databasetype, FieldType fieldtype, StringBuilder stringbuilder, List list)
    {
    ...
    {
        return (new StringBuilder()).append("MappedStatement: ").append(statement).toString();
    }
