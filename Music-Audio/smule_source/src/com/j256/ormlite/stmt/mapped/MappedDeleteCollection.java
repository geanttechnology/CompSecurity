...
_L2:
        logger.debug("delete-collection with statement '{}' and {} args, changed {} rows", new Object[] {
            mappeddeletecollection.statement, Integer.valueOf(aobj.length), Integer.valueOf(j)
        });
        if (aobj.length > 0)
        {
            logger.trace("delete-collection arguments: {}", new Object[] {
                aobj
            });
        }
        return j;
