...
public class MappedUpdate extends BaseMappedStatement
{
    ...
    public static MappedUpdate build(DatabaseType databasetype, TableInfo tableinfo)
    {
        ...
        stringbuilder.append(' ');
        appendWhereId(databasetype, fieldtype3, stringbuilder, null);
        i = k + 1;
    ...
    {
        return fieldtype != fieldtype1 && !fieldtype.isForeignCollection();
    }
...
_L4:
        logger.debug("update data with statement '{}' and {} args, changed {} rows", new Object[] {
