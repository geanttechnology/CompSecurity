    ...
    implements Clause, NeedsFutureClause
{
    ...
    public void appendSql(DatabaseType databasetype, StringBuilder stringbuilder, List list)
    {
        ...
        if (comparison == null)
        {
            ...
            exists.appendSql(databasetype, stringbuilder, list);
        } else
        {
            stringbuilder.append("(NOT ");
    ...
    public void setMissingClause(Clause clause)
    {
        ...
        {
            throw new IllegalArgumentException((new StringBuilder()).append("NOT operation can only work with comparison SQL clauses, not ").append(clause).toString());
        }
    }
    ...
    public String toString()
    {
        ...
        {
            return (new StringBuilder()).append("NOT comparison ").append(comparison).toString();
        }
    }
}
