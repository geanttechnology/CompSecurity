...
_L4:
        ...
        obj = list.getDeclaredField(databasefieldconfig.getFieldName());
        if (obj == null)
        {
            break MISSING_BLOCK_LABEL_140;
        }
        obj = new FieldType(connectionsource, s, ((java.lang.reflect.Field) (obj)), databasefieldconfig, dataClass);
        if (obj == null)
        {
            throw new SQLException((new StringBuilder()).append("Could not find declared field with name '").append(databasefieldconfig.getFieldName()).append("' for ").append(dataClass).toString());
        }
        continue; /* Loop/switch isn't completed */
        obj;
        list = list.getSuperclass();
...
_L2:
        ...
        {
            throw new SQLException((new StringBuilder()).append("No fields were configured for class ").append(dataClass).toString());
        } else
        {
    ...
    private static FieldType[] extractFieldTypes(ConnectionSource connectionsource, Class class1, String s)
    {
        ...
        for (Class class2 = class1; class2 != null; class2 = class2.getSuperclass())
        {
            ...
            for (int i = 0; i < j; i++)
            {
                FieldType fieldtype = FieldType.createFieldType(connectionsource, s, afield[i], class1);
                if (fieldtype != null)
                {
        ...
        if (arraylist.isEmpty())
        {
            throw new IllegalArgumentException((new StringBuilder()).append("No fields have a ").append(com/j256/ormlite/field/DatabaseField.getSimpleName()).append(" annotation in ").append(class1).toString());
        } else
        {
            return (FieldType[])arraylist.toArray(new FieldType[arraylist.size()]);
        }
    ...
    public static FieldType extractIdFieldType(ConnectionSource connectionsource, Class class1, String s)
    {
        for (Class class2 = class1; class2 != null; class2 = class2.getSuperclass())
        {
            java.lang.reflect.Field afield[] = class2.getDeclaredFields();
            ...
            {
                FieldType fieldtype = FieldType.createFieldType(connectionsource, s, afield[i], class1);
                if (fieldtype != null && (fieldtype.isId() || fieldtype.isGeneratedId() || fieldtype.isGeneratedIdSequence()))
                {
                    return fieldtype;
                }
            }
    ...
    {
        Object obj = (DatabaseTable)class1.getAnnotation(com/j256/ormlite/table/DatabaseTable);
        if (obj != null && ((DatabaseTable) (obj)).tableName() != null && ((DatabaseTable) (obj)).tableName().length() > 0)
        {
            obj = ((DatabaseTable) (obj)).tableName();
        } else
        {
            String s = JavaxPersistence.getEntityName(class1);
            obj = s;
            if (s == null)
            {
    ...
    public static Constructor findNoArgConstructor(Class class1)
    {
        ...
        {
            throw new IllegalArgumentException((new StringBuilder()).append("Can't lookup declared constructors for ").append(class1).toString(), exception);
        }
        ...
        for (int i = 0; i < j; i++)
        {
            ...
            if (constructor1.getParameterTypes().length == 0)
            {
                if (!constructor1.isAccessible())
                {
                    ...
                    {
                        throw new IllegalArgumentException((new StringBuilder()).append("Could not open access to constructor for ").append(class1).toString());
                    }
                }
                return constructor1;
            }
        ...
        {
            throw new IllegalArgumentException((new StringBuilder()).append("Can't find a no-arg constructor for ").append(class1).toString());
        } else
        {
            throw new IllegalArgumentException((new StringBuilder()).append("Can't find a no-arg constructor for ").append(class1).append(".  Missing static on inner class?").toString());
        }
    }

    public static DatabaseTableConfig fromClass(ConnectionSource connectionsource, Class class1)
    {
        String s1 = extractTableName(class1);
        String s = s1;
...
label0:
    ...
    public void initialize()
    {
        if (dataClass == null)
        {
            throw new IllegalStateException((new StringBuilder()).append("dataClass was never set on ").append(getClass().getSimpleName()).toString());
        }
        if (tableName == null)
        {
