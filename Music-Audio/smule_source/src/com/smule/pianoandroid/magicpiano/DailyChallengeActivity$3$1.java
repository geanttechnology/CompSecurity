...
_L1:
            a.runOnUiThread(new DailyChallengeActivity._cls3._cls1(this));
_L4:
...
_L2:
            ...
            {
                a.runOnUiThread(new DailyChallengeActivity._cls3._cls2());
            }
...
_L3:
        ...
        // Unreferenced inner class com/smule/pianoandroid/magicpiano/DailyChallengeActivity$3$2

/* anonymous class */
        class DailyChallengeActivity._cls3._cls2
            implements Runnable
        {
