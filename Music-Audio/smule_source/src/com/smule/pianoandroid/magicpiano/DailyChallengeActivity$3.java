    ...
    implements Observer
{
    ...
    {
        observable = (com.smule.android.network.models.)obj;
        if (observable != com.smule.android.network.models.UBMIT_ERROR) goto _L2; else goto _L1
_L1:
...
_L4:
        ...
        return;
_L2:
        if (observable == com.smule.android.network.models.UBMIT_EXPIRED)
        {
            a.runOnUiThread(new Runnable() {
...
_L3:
    ...
    _cls2.a(DailyChallengeActivity dailychallengeactivity)
    {
