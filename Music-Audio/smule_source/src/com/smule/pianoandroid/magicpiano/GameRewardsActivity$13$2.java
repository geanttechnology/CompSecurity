...
class a
    implements com.smule.android.network.managers.ommedationSelectCallback
{
    ...
    // Unreferenced inner class com/smule/pianoandroid/magicpiano/GameRewardsActivity$5

/* anonymous class */
    class GameRewardsActivity._cls5
        implements Runnable
    {
        ...
        public void run()
        {
            ...
            a.f.a(new GameRewardsActivity._cls5._cls1());
            a.f.show();
            (new n(a.i, a)).execute(new Void[0]);
            RecommendationManager.a().a(a.i, new GameRewardsActivity._cls13._cls2(this));
            a.e.dismiss();
            a.e = null;
        }
        ...
        // Unreferenced inner class com/smule/pianoandroid/magicpiano/GameRewardsActivity$5$1

/* anonymous class */
        class GameRewardsActivity._cls5._cls1
            implements ao
        {
