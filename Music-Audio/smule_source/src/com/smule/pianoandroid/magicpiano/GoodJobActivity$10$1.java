    ...
    implements com.smule.pianoandroid.magicpiano.q
{
    ...
    // Unreferenced inner class com/smule/pianoandroid/magicpiano/GoodJobActivity$10

/* anonymous class */
    class GoodJobActivity._cls10
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            (new s(a, null)).execute(new com.smule.pianoandroid.magicpiano.q[] {
                new GoodJobActivity._cls10._cls1(this), null, null
            });
        }
