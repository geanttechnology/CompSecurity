...
/* anonymous class */
    class MagicActivity._cls7 extends TimerTask
    {
        ...
        public void run()
        {
            a.runOnUiThread(new MagicActivity._cls7._cls1());
            MagicActivity.r(a);
            MagicActivity.a(a, new MagicActivity._cls7._cls2(this));
        ...
        // Unreferenced inner class com/smule/pianoandroid/magicpiano/MagicActivity$7$1

/* anonymous class */
        class MagicActivity._cls7._cls1
            implements Runnable
        {
