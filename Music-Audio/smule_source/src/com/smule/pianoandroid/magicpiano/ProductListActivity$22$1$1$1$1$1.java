    ...
    implements Runnable
{
    ...
    // Unreferenced inner class com/smule/pianoandroid/magicpiano/ProductListActivity$22

/* anonymous class */
    class ProductListActivity._cls22
        implements Observer
    {
        ...
        {
            observable = new ProductListActivity._cls22._cls1(this);
    ...
    // Unreferenced inner class com/smule/pianoandroid/magicpiano/ProductListActivity$22$1

/* anonymous class */
    class ProductListActivity._cls22._cls1
        implements Runnable
    {
        ...
        public void run()
        {
            if (!bb.d())
            {
                ...
                }), n.a(a.a, new ProductListActivity._cls22._cls1._cls1(this))).a();
                return;
            } else
            {
                o.b(a.a);
    ...
    // Unreferenced inner class com/smule/pianoandroid/magicpiano/ProductListActivity$22$1$1

/* anonymous class */
    class ProductListActivity._cls22._cls1._cls1
        implements Runnable
    {

        final ProductListActivity._cls22._cls1 a;
        ...
        public void run()
        {
            if (!bb.d() && !ap.a().b() && ap.a().e())
            {
                ...
                e.a(a.a.a, new ProductListActivity._cls22._cls1._cls1._cls1(this));
            }
        }
    ...
    // Unreferenced inner class com/smule/pianoandroid/magicpiano/ProductListActivity$22$1$1$1

/* anonymous class */
    class ProductListActivity._cls22._cls1._cls1._cls1
        implements f
    {

        final ProductListActivity._cls22._cls1._cls1 a;
...
_L2:
            ...
            {
                a.a.a.a.runOnUiThread(new ProductListActivity._cls22._cls1._cls1._cls1._cls1(this));
...
_L3:
    ...
    // Unreferenced inner class com/smule/pianoandroid/magicpiano/ProductListActivity$22$1$1$1$1

/* anonymous class */
    class ProductListActivity._cls22._cls1._cls1._cls1._cls1
        implements Runnable
    {

        final ProductListActivity._cls22._cls1._cls1._cls1 a;

        public void run()
        {
            o.a(a.a.a.a.a, new ProductListActivity._cls22._cls1._cls1._cls1._cls1._cls1(this), null, a.a.a.a.a.getResources().getString(0x7f0c02b9), a.a.a.a.a.getResources().getString(0x7f0c021b));
        }
