    ...
    implements Runnable
{
    ...
    public void run()
    {
        Iterator iterator = ap.b(c.c).iterator();
_L7:
...
_L6:
    ...
    // Unreferenced inner class com/smule/pianoandroid/magicpiano/ap$7
...
_L2:
            ...
            while (iterator.hasNext()) 
            {
                ...
                _lcls1 = new ap._cls7._cls1(this, f1.sku, ((u) (obj1)));
                obj1 = View.inflate(c, 0x7f03005c, null);
                com.smule.pianoandroid.magicpiano.ap.a(c, ((View) (obj1)), ((String) (obj)), s, Boolean.valueOf(true), f1.trial, _lcls1);
