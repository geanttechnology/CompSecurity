    ...
    implements Runnable
{
    ...
    // Unreferenced inner class com/smule/pianoandroid/magicpiano/registration/NewHandleActivity$1

/* anonymous class */
    class NewHandleActivity._cls1
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            if (NewHandleActivity.a(a).getText().toString().equals(UserManager.n().e()))
            {
                ...
                (new Handler()).postDelayed(new NewHandleActivity._cls1._cls1(this), 1000L);
                return;
            } else
            {
                view = a.getResources().getString(0x7f0c023f);
