...
_L1:
        obj2 = amethod[i];
        if (!Modifier.isPublic(((Method) (obj2)).getModifiers())) goto _L4; else goto _L3
_L3:
...
_L5:
        if (s.equals("getClass") || s.equals("getDeclaringClass"))
        {
          ...
          goto _L7
_L14:
        if (((String) (obj1)).length() <= 0 || !Character.isUpperCase(((String) (obj1)).charAt(0)) || ((Method) (obj2)).getParameterTypes().length != 0) goto _L4; else goto _L8
_L8:
...
_L11:
        obj1 = (new StringBuilder()).append(((String) (obj1)).substring(0, 1).toLowerCase()).append(((String) (obj1)).substring(1)).toString();
          goto _L12
_L2:
        return;
        obj1 = "";
