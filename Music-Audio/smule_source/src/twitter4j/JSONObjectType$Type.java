...
public final class  extends Enum
{
    ...
    public static final UNKNOWN USER_DELETE;
    ...
    public static final UNKNOWN USER_SUSPEND;
    ...
    static 
    {
        ...
        USER_DELETE = new <init>("USER_DELETE", 20);
        USER_SUSPEND = new <init>("USER_SUSPEND", 21);
        BLOCK = new <init>("BLOCK", 22);
        UNBLOCK = new <init>("UNBLOCK", 23);
        DISCONNECTION = new <init>("DISCONNECTION", 24);
        UNKNOWN = new <init>("UNKNOWN", 25);
        $VALUES = (new .VALUES[] {
            ...
            USER_DELETE, USER_SUSPEND, BLOCK, UNBLOCK, DISCONNECTION, UNKNOWN
        });
    }
