...
label0:
    ...
    private void init(JSONObject jsonobject)
    {
        ...
        obj = new URLEntity[0];
_L1:
        descriptionURLEntities = ((URLEntity []) (obj));
        obj = getURLEntitiesFromJSON(jsonobject, "url");
        if (obj == null)
        {
        ...
        obj = jsonobject.getJSONArray("withheld_in_countries");
        ...
        while (i < j) 
        {
            try
            {
                withheldInCountries[i] = ((JSONArray) (obj)).getString(i);
            }
