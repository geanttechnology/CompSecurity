...
class ShadowDrawableWrapper extends DrawableWrapper
{
    ...
    public ShadowDrawableWrapper(Resources resources, Drawable drawable, float f, float f1, float f2)
    {
        ...
        mShadowStartColor = resources.getColor(android.support.design.R.color.shadow_start_color);
        mShadowMiddleColor = resources.getColor(android.support.design.R.color.shadow_mid_color);
        mShadowEndColor = resources.getColor(android.support.design.R.color.shadow_end_color);
