...
public final class ClickStreamData extends Enum
{
    ...
    static 
    {
        ...
        SITE_VARIANT = new ClickStreamData("SITE_VARIANT", 15, "site_variant");
        ...
        WEBLAB_CLIENT_ID = new ClickStreamData("WEBLAB_CLIENT_ID", 25, "wl-client-id");
        WEBLAB = new ClickStreamData("WEBLAB", 26, "wl");
        ECOMMERCE_PAGE_ACTION = new ClickStreamData("ECOMMERCE_PAGE_ACTION", 27, "ecommerce-page-action");
        ORDER_DATA = new ClickStreamData("ORDER_DATA", 28, "order-data");
        IS_PRIME_ELIGIBLE_ITEM = new ClickStreamData("IS_PRIME_ELIGIBLE_ITEM", 29, "is-prime-eligible-item");
        IS_GLANCE_VIEW = new ClickStreamData("IS_GLANCE_VIEW", 30, "is-glance-view");
        IMPRESSION_PROGRAM_GROUP = new ClickStreamData("IMPRESSION_PROGRAM_GROUP", 31, "programGroup");
        IMPRESSION_TYPE = new ClickStreamData("IMPRESSION_TYPE", 32, "impressionType");
        IMPRESSION_DATA = new ClickStreamData("IMPRESSION_DATA", 33, "impressionData");
        IMPRESSION_METADATA = new ClickStreamData("IMPRESSION_METADATA", 34, "impressionMetadata");
        $VALUES = (new ClickStreamData[] {
            ...
            PAGE_ASSEMBLY_TYPE, IS_CUSTOMER_HIT, IS_PRIME_CUSTOMER, GROUPING_ASIN, PRODUCT_GLID, WEBLAB_CLIENT_ID, WEBLAB, ECOMMERCE_PAGE_ACTION, ORDER_DATA, IS_PRIME_ELIGIBLE_ITEM, 
            IS_GLANCE_VIEW, IMPRESSION_PROGRAM_GROUP, IMPRESSION_TYPE, IMPRESSION_DATA, IMPRESSION_METADATA
        });
    }
}
