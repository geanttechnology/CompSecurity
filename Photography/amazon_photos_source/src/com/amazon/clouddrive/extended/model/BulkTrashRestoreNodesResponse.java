...
public class BulkTrashRestoreNodesResponse
    implements BulkResponse
{
    ...
    public BulkTrashRestoreNodesResponse()
    {
    }
    ...
    public int compareTo(CloudDriveResponse clouddriveresponse)
    {
        ...
        } else
        {
            ...
            clouddriveresponse = (BulkTrashRestoreNodesResponse)clouddriveresponse;
    ...
    {
        while (obj == this || (obj instanceof BulkTrashRestoreNodesResponse) && compareTo((BulkTrashRestoreNodesResponse)obj) == 0) 
        {
            return true;
        }
        return false;
