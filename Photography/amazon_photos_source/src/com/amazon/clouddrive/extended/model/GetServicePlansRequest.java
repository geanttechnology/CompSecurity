...
public class GetServicePlansRequest
    implements CloudDriveRequest
{

    private Boolean filter;

    public GetServicePlansRequest()
    {
    }
...
_L2:
        ...
        obj = (GetServicePlansRequest)clouddriverequest;
        clouddriverequest = isFilter();
        obj = ((GetServicePlansRequest) (obj)).isFilter();
...
_L8:
    ...
    public boolean equals(Object obj)
    {
        if (obj != this)
        {
            if (obj instanceof GetServicePlansRequest)
            {
                if (compareTo((GetServicePlansRequest)obj) != 0)
                {
                    return false;
                }
            } else
