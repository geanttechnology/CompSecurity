...
_L2:
        ...
        obj = (GetSubscriptionsRequest)clouddriverequest;
        clouddriverequest = getInclude();
        obj = ((GetSubscriptionsRequest) (obj)).getInclude();
...
_L8:
    ...
    public boolean equals(Object obj)
    {
        if (obj != this)
        {
            ...
            {
                if (compareTo((GetSubscriptionsRequest)obj) != 0)
                {
                    return false;
                }
            } else
