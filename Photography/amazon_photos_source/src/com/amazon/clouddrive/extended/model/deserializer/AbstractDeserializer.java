    ...
    implements JsonDeserializer
{
    ...
    private final JsonFieldDeserializer mFieldDeserializer;

    protected AbstractDeserializer(JsonFieldDeserializer jsonfielddeserializer)
    {
        mFieldDeserializer = jsonfielddeserializer;
    }
...
_L2:
        ...
        do
        {
            ...
            if (!mFieldDeserializer.handleField(jsonparser, ((String) (obj)), obj1))
            {
