...
public class CreateNodeExtendedResponseDeserializer extends AbstractDeserializer
{
    static class CreateNodeExtendedResponseFieldDeserializer extends NodeExtendedDeserializer.NodeExtendedFieldDeserializer
    {
            ...
            throws IOException
        {
            ...
            if ((ieditablenode instanceof CreateNodeExtendedResponse) && "location".equals(s))
            {
                ((CreateNodeExtendedResponse)ieditablenode).setLocation(SimpleDeserializers.deserializeString(jsonparser));
                return true;
            } else
            {
                return false;
    ...
    public static final JsonDeserializer INSTANCE = new CreateNodeExtendedResponseDeserializer();
    ...
    protected CreateNodeExtendedResponse createValue()
    {
