...
public class ErrorMapDeserializer
    implements JsonDeserializer
{

    public static final JsonDeserializer INSTANCE = new ErrorMapDeserializer();

    private ErrorMapDeserializer()
    {
    }
...
_L2:
        ...
        do
        {
            ...
            hashmap.put(obj, SimpleDeserializers.deserializeInteger(jsonparser));
        } while (true);
