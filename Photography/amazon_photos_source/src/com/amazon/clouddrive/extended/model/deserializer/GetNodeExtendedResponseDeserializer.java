...
public class GetNodeExtendedResponseDeserializer extends AbstractDeserializer
{
    static class GetNodeExtendedResponseFieldDeserializer extends NodeExtendedDeserializer.NodeExtendedFieldDeserializer
    {
            ...
            throws IOException
        {
            ...
            if ((ieditablenode instanceof GetNodeExtendedResponse) && "location".equals(s))
            {
                ((GetNodeExtendedResponse)ieditablenode).setLocation(SimpleDeserializers.deserializeString(jsonparser));
                return true;
            } else
            {
                return false;
    ...
    public static final JsonDeserializer INSTANCE = new GetNodeExtendedResponseDeserializer();
    ...
    protected GetNodeExtendedResponse createValue()
    {
