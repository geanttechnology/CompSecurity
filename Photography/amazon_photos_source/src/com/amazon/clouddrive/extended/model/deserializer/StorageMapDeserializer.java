...
public class StorageMapDeserializer
    implements JsonDeserializer
{

    public static final JsonDeserializer INSTANCE = new StorageMapDeserializer();
...
_L2:
        ...
        do
        {
            ...
            hashmap.put(obj, SimpleDeserializers.deserializeLong(jsonparser));
        } while (true);
