...
public class SubscriptionProblemListDeserializer
    implements JsonDeserializer
{

    public static final JsonDeserializer INSTANCE = new SubscriptionProblemListDeserializer();

    private SubscriptionProblemListDeserializer()
    {
    }
...
_L2:
        ...
        do
        {
            ...
            arraylist.add(SubscriptionProblemDeserializer.INSTANCE.deserialize(jsonparser));
        } while (true);
