...
//            CloudDriveSubscriptionDeserializer

public class SubscriptionsListDeserializer
    implements JsonDeserializer
{

    public static final JsonDeserializer INSTANCE = new SubscriptionsListDeserializer();
...
_L2:
        ...
        do
        {
            ...
            arraylist.add(CloudDriveSubscriptionDeserializer.INSTANCE.deserialize(jsonparser));
        } while (true);
