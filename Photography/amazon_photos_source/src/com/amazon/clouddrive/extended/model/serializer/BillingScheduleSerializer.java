...
public class BillingScheduleSerializer
    implements JsonSerializer
{
    static class BillingScheduleFieldSerializer
    {
    ...
    public static final JsonSerializer INSTANCE = new BillingScheduleSerializer();
    ...
    public final void serialize(BillingSchedule billingschedule, JsonGenerator jsongenerator)
        throws IOException
    {
        ...
        } else
        {
            ...
            mFieldSerializer.serializeFields(billingschedule, jsongenerator);
    ...
    public volatile void serialize(Object obj, JsonGenerator jsongenerator)
        throws IOException
    {
        serialize((BillingSchedule)obj, jsongenerator);
    }
