...
//            PendingPlanSerializer, SubscriptionProblemListSerializer

public class CloudDriveSubscriptionSerializer
    implements JsonSerializer
{
    static class CloudDriveSubscriptionFieldSerializer
    {
    ...
    public static final JsonSerializer INSTANCE = new CloudDriveSubscriptionSerializer();
    ...
    public final void serialize(CloudDriveSubscription clouddrivesubscription, JsonGenerator jsongenerator)
        throws IOException
    {
        ...
        } else
        {
            ...
            mFieldSerializer.serializeFields(clouddrivesubscription, jsongenerator);
    ...
    public volatile void serialize(Object obj, JsonGenerator jsongenerator)
        throws IOException
    {
        serialize((CloudDriveSubscription)obj, jsongenerator);
    }
