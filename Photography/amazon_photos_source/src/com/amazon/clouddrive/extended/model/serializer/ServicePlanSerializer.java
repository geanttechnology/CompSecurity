...
//            StorageMapSerializer, BillingScheduleSerializer, PeriodSerializer

public class ServicePlanSerializer
    implements JsonSerializer
{
    static class ServicePlanFieldSerializer
    {
    ...
    public static final JsonSerializer INSTANCE = new ServicePlanSerializer();
    ...
    public void serialize(ServicePlan serviceplan, JsonGenerator jsongenerator)
        throws IOException
    {
        if (serviceplan == null)
        {
        ...
        } else
        {
            ...
            mFieldSerializer.serializeFields(serviceplan, jsongenerator);
    ...
    public volatile void serialize(Object obj, JsonGenerator jsongenerator)
        throws IOException
    {
        serialize((ServicePlan)obj, jsongenerator);
    }
