...
//            RequestAssertUtils, CloudDriveObjectMapper
...
class MultiPartPostBodyWriterHelper
{
    public static class Builder
    {
        ...
        private Builder addBodyAfterFileContents()
            throws IOException
        {
            if (mNeedsLineEnding)
            {
        ...
        public Builder addMetadata(Object obj, JsonSerializer jsonserializer)
    ...
    {
        mBodyBeforeFileContents = builder.mBodyBeforeFileContents;
        mBodyAfterFileContents = builder.mBodyAfterFileContents;
    }


    public ByteArrayOutputStream getBodyAfterFileContents()
    {
        return mBodyAfterFileContents;
    }

    public ByteArrayOutputStream getBodyBeforeFileContents()
    {
        return mBodyBeforeFileContents;
    }
}
