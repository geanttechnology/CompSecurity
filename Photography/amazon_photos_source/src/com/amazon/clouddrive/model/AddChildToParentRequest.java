    ...
    implements CloudDriveRequest
{
    ...
    public AddChildToParentRequest(String s, String s1)
    {
        parentId = s;
        childId = s1;
    }
...
_L2:
        ...
        clouddriverequest = (AddChildToParentRequest)clouddriverequest;
        s = getParentId();
...
_L11:
    ...
    public boolean equals(Object obj)
    {
        if (obj != this)
        {
            if (obj instanceof AddChildToParentRequest)
            {
                if (compareTo((AddChildToParentRequest)obj) != 0)
                {
                    return false;
                }
            } else
