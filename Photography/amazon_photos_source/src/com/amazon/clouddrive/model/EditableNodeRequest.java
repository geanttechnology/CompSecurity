...
//            CloudDriveRequest, IEditableNode, ContentProperties, CollectionProperties, 
//            Settings

public class EditableNodeRequest
    implements CloudDriveRequest, IEditableNode
{
...
_L2:
        ...
        clouddriverequest = (EditableNodeRequest)clouddriverequest;
        obj = getName();
...
_L10:
        obj = getParents();
        obj1 = clouddriverequest.getParents();
        if (obj == obj1)
        {
            break; /* Loop/switch isn't completed */
        }
...
_L18:
        ...
        obj1 = clouddriverequest.getContentProperties();
        if (obj == obj1)
        {
            break; /* Loop/switch isn't completed */
        }
...
_L22:
        obj = getProperties();
        obj1 = clouddriverequest.getProperties();
        if (obj == obj1)
        {
            break; /* Loop/switch isn't completed */
        }
...
_L26:
        obj = getKind();
        obj1 = clouddriverequest.getKind();
        if (obj == obj1)
        {
            break; /* Loop/switch isn't completed */
        }
...
_L34:
        obj = getStatus();
        obj1 = clouddriverequest.getStatus();
        if (obj == obj1)
        {
            break; /* Loop/switch isn't completed */
        }
...
_L38:
        ...
        obj1 = clouddriverequest.getCollectionProperties();
        if (obj == obj1)
        {
            break; /* Loop/switch isn't completed */
        }
...
_L42:
        obj = getParentMap();
        obj1 = clouddriverequest.getParentMap();
        if (obj == obj1)
        {
            break; /* Loop/switch isn't completed */
        }
...
_L46:
        obj = getSettings();
        obj1 = clouddriverequest.getSettings();
        if (obj == obj1)
        {
            break; /* Loop/switch isn't completed */
        }
...
_L50:
        obj = getTransforms();
        clouddriverequest = clouddriverequest.getTransforms();
...
_L55:
    ...
    public boolean equals(Object obj)
    {
        if (obj != this)
        {
            if (obj instanceof EditableNodeRequest)
            {
                if (compareTo((EditableNodeRequest)obj) != 0)
                {
                    return false;
                }
            } else
