...
public class ListChildrenResponse extends PaginatedCloudDriveResponse
...
_L2:
        ...
        obj = (ListChildrenResponse)clouddriveresponse;
        list = getData();
        obj = ((ListChildrenResponse) (obj)).getData();
        if (list == obj)
        {
...
_L8:
    ...
    public boolean equals(Object obj)
    {
        if (obj != this)
        {
            ...
            {
                if (compareTo((ListChildrenResponse)obj) != 0)
                {
                    return false;
                }
            } else
