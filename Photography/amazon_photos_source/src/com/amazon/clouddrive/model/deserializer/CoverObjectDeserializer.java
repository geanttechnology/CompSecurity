...
public class CoverObjectDeserializer
    implements JsonDeserializer
{

    public static final JsonDeserializer INSTANCE = new CoverObjectDeserializer();

    private CoverObjectDeserializer()
    {
    }

    public CoverObject deserialize(JsonParser jsonparser)
        throws IOException
    {
