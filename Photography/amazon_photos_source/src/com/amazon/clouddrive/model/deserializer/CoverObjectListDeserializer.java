...
//            JsonDeserializer, CoverObjectDeserializer

public class CoverObjectListDeserializer
    implements JsonDeserializer
{

    public static final JsonDeserializer INSTANCE = new CoverObjectListDeserializer();
...
_L2:
        ...
        do
        {
            ...
            arraylist.add(CoverObjectDeserializer.INSTANCE.deserialize(jsonparser));
        } while (true);
