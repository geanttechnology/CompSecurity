...
public class CreateNodeResponseDeserializer
    implements JsonDeserializer
{
    static class CreateNodeResponseFieldDeserializer extends NodeDeserializer.NodeFieldDeserializer
    {
    ...
    public static final JsonDeserializer INSTANCE = new CreateNodeResponseDeserializer();
    ...
    public CreateNodeResponse deserialize(JsonParser jsonparser)
        throws IOException
    {
...
_L2:
        ...
        do
        {
            ...
            if (!mFieldHandler.handleField(jsonparser, ((String) (obj)), createnoderesponse))
            {
