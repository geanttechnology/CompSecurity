...
//            JsonDeserializer, JsonFieldDeserializer, SimpleDeserializers, AuthorListDeserializer

public class DocumentPropertiesDeserializer
    implements JsonDeserializer
{
    static class DocumentPropertiesFieldDeserializer
    ...
    public static final JsonDeserializer INSTANCE = new DocumentPropertiesDeserializer();
    ...
    public DocumentProperties deserialize(JsonParser jsonparser)
        throws IOException
    {
...
_L2:
        ...
        do
        {
            ...
            if (!mFieldHandler.handleField(jsonparser, ((String) (obj)), documentproperties))
            {
