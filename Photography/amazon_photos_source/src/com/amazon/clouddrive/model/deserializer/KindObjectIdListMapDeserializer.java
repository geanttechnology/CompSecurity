...
//            JsonDeserializer, NodeIdListDeserializer

public class KindObjectIdListMapDeserializer
    implements JsonDeserializer
{

    public static final JsonDeserializer INSTANCE = new KindObjectIdListMapDeserializer();
...
_L2:
        ...
        do
        {
            ...
            hashmap.put(obj, NodeIdListDeserializer.INSTANCE.deserialize(jsonparser));
        } while (true);
