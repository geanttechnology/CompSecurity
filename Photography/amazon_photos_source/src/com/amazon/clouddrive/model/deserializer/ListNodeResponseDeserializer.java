...
public class ListNodeResponseDeserializer
    implements JsonDeserializer
{
    static class ListNodeResponseFieldDeserializer extends PaginatedCloudDriveResponseFieldDeserializer
    {
            ...
            throws IOException
        {
            ...
            if ((paginatedclouddriveresponse instanceof ListNodesResponse) && "data".equals(s))
            {
                ((ListNodesResponse)paginatedclouddriveresponse).setData((List)NodeListDeserializer.INSTANCE.deserialize(jsonparser));
                return true;
            } else
            {
                return false;
    ...
    public static final JsonDeserializer INSTANCE = new ListNodeResponseDeserializer();
    ...
    public ListNodesResponse deserialize(JsonParser jsonparser)
        throws IOException
    {
...
_L2:
        ...
        do
        {
            ...
            if (!mFieldHandler.handleField(jsonparser, ((String) (obj)), listnodesresponse))
            {
