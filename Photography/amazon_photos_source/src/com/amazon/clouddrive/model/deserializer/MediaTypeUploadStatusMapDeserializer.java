...
//            JsonDeserializer, MediaTypeUploadStatusDeserializer

public class MediaTypeUploadStatusMapDeserializer
    implements JsonDeserializer
{

    public static final JsonDeserializer INSTANCE = new MediaTypeUploadStatusMapDeserializer();
...
_L2:
        ...
        do
        {
            ...
            hashmap.put(obj, MediaTypeUploadStatusDeserializer.INSTANCE.deserialize(jsonparser));
        } while (true);
