...
public class MediaTypeUsageDeserializer
    implements JsonDeserializer
{

    public static final JsonDeserializer INSTANCE = new MediaTypeUsageDeserializer();

    private MediaTypeUsageDeserializer()
    {
    }

    public MediaTypeUsage deserialize(JsonParser jsonparser)
        throws IOException
    {
...
_L2:
        ...
        do
        {
            ...
            if ("lastUploadedTime".equals(obj))
            {
