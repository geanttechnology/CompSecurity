...
//            JsonDeserializer, MediaTypeUsageDeserializer

public class MediaTypeUsageMapDeserializer
    implements JsonDeserializer
{

    public static final JsonDeserializer INSTANCE = new MediaTypeUsageMapDeserializer();

    private MediaTypeUsageMapDeserializer()
    {
    }
...
_L2:
        ...
        do
        {
            ...
            hashmap.put(obj, MediaTypeUsageDeserializer.INSTANCE.deserialize(jsonparser));
        } while (true);
