...
//            JsonDeserializer, NodeDeserializer

public class NodeListDeserializer
    implements JsonDeserializer
{

    public static final JsonDeserializer INSTANCE = new NodeListDeserializer();

    private NodeListDeserializer()
    {
    }
...
_L2:
        ...
        do
        {
            ...
            arraylist.add(NodeDeserializer.INSTANCE.deserialize(jsonparser));
        } while (true);
