...
//            JsonDeserializer, PropertyMapDeserializer

public class PropertiesDeserializer
    implements JsonDeserializer
{

    public static final JsonDeserializer INSTANCE = new PropertiesDeserializer();
...
_L2:
        ...
        do
        {
            ...
            hashmap.put(obj, PropertyMapDeserializer.INSTANCE.deserialize(jsonparser));
        } while (true);
