...
//            JsonDeserializer, QueryAndBlockDeserializer

public class QueryAndBlockListDeserializer
    implements JsonDeserializer
{

    public static final JsonDeserializer INSTANCE = new QueryAndBlockListDeserializer();

    private QueryAndBlockListDeserializer()
    {
    }
...
_L2:
        ...
        do
        {
            ...
            arraylist.add(QueryAndBlockDeserializer.INSTANCE.deserialize(jsonparser));
        } while (true);
