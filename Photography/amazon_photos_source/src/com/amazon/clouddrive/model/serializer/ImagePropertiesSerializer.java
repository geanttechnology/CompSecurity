...
public class ImagePropertiesSerializer
    implements JsonSerializer
{
    ...
    public static final JsonSerializer INSTANCE = new ImagePropertiesSerializer();
        ...
        throws IOException
    {
        ...
        } else
        {
            ...
            mFieldSerializer.serializeFields(imageproperties, jsongenerator);
    ...
    public volatile void serialize(Object obj, JsonGenerator jsongenerator)
        throws IOException
    {
        serialize((ImageProperties)obj, jsongenerator);
    }
