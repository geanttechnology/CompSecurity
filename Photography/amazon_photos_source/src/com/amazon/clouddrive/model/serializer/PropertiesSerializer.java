...
//            JsonSerializer, PropertyMapSerializer

public class PropertiesSerializer
    implements JsonSerializer
{

    public static final JsonSerializer INSTANCE = new PropertiesSerializer();
        ...
        throws IOException
    {
        ...
        for (map = map.entrySet().iterator(); map.hasNext(); PropertyMapSerializer.INSTANCE.serialize(entry.getValue(), jsongenerator))
        {
