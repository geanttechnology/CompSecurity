    ...
    extends IInterface
{
        ...
        implements IInputStream
    {
        ...
        public static IInputStream asInterface(IBinder ibinder)
        {
            ...
            IInterface iinterface = ibinder.queryLocalInterface("com.amazon.communication.IInputStream");
    ...
    public abstract int readBytesIntoOffset(byte abyte0[], int i, int j)
        throws RemoteException;
}
