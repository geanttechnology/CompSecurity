...
class Metrics
{
    static final class MetricType extends Enum
    {
        ...
        {
            return (MetricType)Enum.valueOf(com/amazon/device/ads/identity/Metrics$MetricType, s);
        }
        ...
        static 
        {
            ...
            AD_FAILED_UNKNOWN_WEBVIEW_ISSUE = new MetricType("AD_FAILED_UNKNOWN_WEBVIEW_ISSUE", 32, "fuwi");
            AD_FAILED_NULL_LAYOUT_PARAMS = new MetricType("AD_FAILED_NULL_LAYOUT_PARAMS", 33, "fnlp");
            AD_FAILED_LAYOUT_NOT_RUN = new MetricType("AD_FAILED_LAYOUT_NOT_RUN", 34, "flnr");
            AD_FAILED_INVALID_AUTO_AD_SIZE = new MetricType("AD_FAILED_INVALID_AUTO_AD_SIZE", 35, "faas");
            SIS_COUNTER_IDENTIFIED_DEVICE_CHANGED = new MetricType("SIS_COUNTER_IDENTIFIED_DEVICE_CHANGED", 36, "sid");
            SIS_LATENCY_REGISTER = new MetricType("SIS_LATENCY_REGISTER", 37, "srl");
            SIS_LATENCY_UPDATE_DEVICE_INFO = new MetricType("SIS_LATENCY_UPDATE_DEVICE_INFO", 38, "sul");
            SIS_LATENCY_REGISTER_EVENT = new MetricType("SIS_LATENCY_REGISTER_EVENT", 39, "srel");
            CONFIG_DOWNLOAD_ERROR = new MetricType("CONFIG_DOWNLOAD_ERROR", 40, "cde");
            CONFIG_DOWNLOAD_LATENCY = new MetricType("CONFIG_DOWNLOAD_LATENCY", 41, "cdt");
            CONFIG_PARSE_ERROR = new MetricType("CONFIG_PARSE_ERROR", 42, "cpe");
            AAX_CONFIG_DOWNLOAD_LATENCY = new MetricType("AAX_CONFIG_DOWNLOAD_LATENCY", 43, "acl");
            AAX_CONFIG_DOWNLOAD_FAILED = new MetricType("AAX_CONFIG_DOWNLOAD_FAILED", 44, "acf");
            CUSTOM_RENDER_HANDLED = new MetricType("CUSTOM_RENDER_HANDLED", 45, "crh");
            TLS_ENABLED = new MetricType("TLS_ENABLED", 46, "tls");
            WIFI_PRESENT = new MetricType("WIFI_PRESENT", 47, "wifi");
            CARRIER_NAME = new MetricType("CARRIER_NAME", 48, "car");
            CONNECTION_TYPE = new MetricType("CONNECTION_TYPE", 49, "ct");
            AD_IS_INTERSTITIAL = new MetricType("AD_IS_INTERSTITIAL", 50, "i");
            INTERSTITIAL_AD_ACTIVITY_FAILED = new MetricType("INTERSTITIAL_AD_ACTIVITY_FAILED", 51, "iaaf");
            $VALUES = (new MetricType[] {
                ...
                ADLAYOUT_HEIGHT_ZERO, VIEWPORT_SCALE, AD_FAILED_UNKNOWN_WEBVIEW_ISSUE, AD_FAILED_NULL_LAYOUT_PARAMS, AD_FAILED_LAYOUT_NOT_RUN, AD_FAILED_INVALID_AUTO_AD_SIZE, SIS_COUNTER_IDENTIFIED_DEVICE_CHANGED, SIS_LATENCY_REGISTER, SIS_LATENCY_UPDATE_DEVICE_INFO, SIS_LATENCY_REGISTER_EVENT, 
                CONFIG_DOWNLOAD_ERROR, CONFIG_DOWNLOAD_LATENCY, CONFIG_PARSE_ERROR, AAX_CONFIG_DOWNLOAD_LATENCY, AAX_CONFIG_DOWNLOAD_FAILED, CUSTOM_RENDER_HANDLED, TLS_ENABLED, WIFI_PRESENT, CARRIER_NAME, CONNECTION_TYPE, 
                AD_IS_INTERSTITIAL, INTERSTITIAL_AD_ACTIVITY_FAILED
            });
        }
    ...
    private static final String LOG_TAG = com/amazon/device/ads/identity/Metrics.getSimpleName();
