...
//            AppFileArtifactSource, AmazonPackageLookup, DefaultCrashDescriptorStorageUtil, MetricsHeaderProcessorFactory, 
//            JavaCrashArtifactProcessor, ArtifactUploader, DomainChooser, DetEndpointConfig, 
    ...
    implements Thread.UncaughtExceptionHandler
{
    ...
    CrashDetectionHelper(String s, String s1, OAuthHelper oauthhelper, MetricsFactory metricsfactory, AppFileArtifactSource appfileartifactsource, AmazonPackageLookup amazonpackagelookup, DomainChooser domainchooser, 
            NetworkManager networkmanager, CrashDescriptorStorageUtil crashdescriptorstorageutil, CrashDetailsAggregator crashdetailsaggregator, boolean flag, boolean flag1)
    {
    ...
    void uploadCrashReport()
    {
        ...
        (new ArtifactUploader(DetEndpointConfig.getServiceEndpoint(mDomainChooser.chooseDomain()), mDeviceType, mDeviceId, linkedlist, linkedlist1, mCrashDescUtil, mStatusNotifier, mRequestSigner, mNetworkManager, mAllowWANUpload)).uploadArtifacts(metricevent);
