...
public class DetUtil
{
    ...
    public String createDetMfbsHeader(Long long1)
        throws Exception
    {
        ...
        throws IllegalAccessException, TimeoutException, RequestFailedException, MissingCredentialsException
    {
        ...
        Log.d("postFileToDet", String.format("Posting file to DET of size %d.", new Object[] {
            Long.valueOf(httppost.getEntity().getContentLength())
        }));
        srrmanager = srrmanager.makeRequestSync((new amazon.communication.srr.SrrRequest.Builder()).setRequest(httppost).setEndpointIdentity(endpointidentity).setTimeout(30000).setCompressionOption(CompressionOption.REQUIRED).setRequestContext(requestcontext).build());
        if (srrmanager == null)
        {
