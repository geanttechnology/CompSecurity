...
/* anonymous class */
        ...
        implements com.amazon.gallery.framework.network.NetworkExecutor.ResultHandler
    {
        ...
        {
            videoView.post(new VideoTrimmerActivity._cls6._cls1());
        }
        ...
        // Unreferenced inner class com/amazon/gallery/app/activity/VideoTrimmerActivity$6$1

/* anonymous class */
        class VideoTrimmerActivity._cls6._cls1
            implements Runnable
        {
