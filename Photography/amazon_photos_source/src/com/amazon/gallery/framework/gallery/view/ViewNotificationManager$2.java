    ...
    implements Runnable
{
    ...
    public void run()
    {
        for (Iterator iterator = ViewNotificationManager.access$000(ViewNotificationManager.this).iterator(); iterator.hasNext(); ((ViewStateListener)iterator.next()).onEnterFullScreen()) { }
    }
