    ...
    implements android.content.ener
{
    ...
    final howNewDialogForCurrentTags this$0;

    public void onClick(DialogInterface dialoginterface, int i)
    {
        AutoUploadNotification.access$000().trackEvent(icsEvent.AutoSaveDialogAccepted);
        SettingsFragment.setAutoUploadEnabled(activity, true, com.amazon.gallery.framework.kindle.fragment.urce.Dialog);
...
/* anonymous class */
    static final class AutoUploadNotification._cls2 extends ShowDialogSyncTask
    {
        ...
        protected Dialog createDialog()
        {
            ...
            {
                final View view = LayoutInflater.from(activity).inflate(0x7f030023, null, false);
                alertdialog.setView(view);
                helper.loadABText(activity, "Unlimited Cloud Storage", "ShowText", "UnlimitedPhotoText", new AutoUploadNotification._cls2._cls4());
            }
...
/* anonymous class */
        ...
        // Unreferenced inner class com/amazon/gallery/framework/kindle/AutoUploadNotification$2$4

/* anonymous class */
        class AutoUploadNotification._cls2._cls4
            implements com.amazon.gallery.foundation.metrics.amazoninsights.AmazonInsightsHelper.TextLoadedListener
        {
            ...
            {
                activity.runOnUiThread(s. new AutoUploadNotification._cls2._cls4._cls1());
            }
        ...
        // Unreferenced inner class com/amazon/gallery/framework/kindle/AutoUploadNotification$2$4$1

/* anonymous class */
        class AutoUploadNotification._cls2._cls4._cls1
            implements Runnable
        {
