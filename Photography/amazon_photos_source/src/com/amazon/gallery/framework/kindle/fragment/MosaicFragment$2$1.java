    ...
    implements Runnable
{
    ...
    // Unreferenced inner class com/amazon/gallery/framework/kindle/fragment/MosaicFragment$2

/* anonymous class */
    class MosaicFragment._cls2 extends android.support.v7.widget.RecyclerView.OnScrollListener
    {
...
_L4:
            ...
            
            {
                ...
                super();
                handler = new Handler();
                hideRunnable = new MosaicFragment._cls2._cls1();
                finished = false;
            }
    }
