    ...
    implements Runnable
{
    ...
    public void run()
    {
        PhotoView photoview = SingleViewFragment.access$800(_fld0, val$position);
        if (photoview != null)
        {
            android.support.v4.app.FragmentActivity fragmentactivity = getActivity();
            if (fragmentactivity != null)
            {
                GlideWrapper.loadFullQualityImage(fragmentactivity, val$mediaItem, photoview, SingleViewFragment.access$1300(_fld0).getWidth(val$position), SingleViewFragment.access$1300(_fld0).getHeight(val$position));
            }
        }
    }
    ...
    // Unreferenced inner class com/amazon/gallery/framework/kindle/fragment/SingleViewFragment$5

/* anonymous class */
    class SingleViewFragment._cls5 extends android.support.v4.view.ViewPager.SimpleOnPageChangeListener
    {
...
_L3:
        ...
        public void onPageSelected(final int position)
        {
            ...
            Object obj = SingleViewFragment.access$800(SingleViewFragment.this, i);
            if (obj != null)
            {
            ...
            SingleViewFragment.access$1000(SingleViewFragment.this, ((MediaItem) (obj)));
            ...
            SingleViewFragment.access$1200(SingleViewFragment.this).postDelayed(((SingleViewFragment._cls5._cls1) (obj)). new SingleViewFragment._cls5._cls1(), 750L);
        }
