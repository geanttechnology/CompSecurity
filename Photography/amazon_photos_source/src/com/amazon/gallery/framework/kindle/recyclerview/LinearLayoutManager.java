...
public class LinearLayoutManager extends android.support.v7.widget.RecyclerView.LayoutManager
{
    class AnchorInfo
    {
        ...
        public boolean assignFromViewIfValid(View view, android.support.v7.widget.RecyclerView.State state)
        {
...
_L2:
            ...
            viewholder2 = (android.support.v7.widget.RecyclerView.ViewHolder)mScrapList.get(i);
            if (mIsPreLayout)
            {
...
_L6:
    ...
    private void layoutForPredictiveAnimations(android.support.v7.widget.RecyclerView.Recycler recycler, android.support.v7.widget.RecyclerView.State state, int i, int j)
    {
        ...
        while (l < k1) 
        {
            android.support.v7.widget.RecyclerView.ViewHolder viewholder = (android.support.v7.widget.RecyclerView.ViewHolder)list.get(l);
            byte byte0;
            boolean flag;
...
_L4:
    ...
    private void updateLayoutState(int i, int j, boolean flag, android.support.v7.widget.RecyclerView.State state)
    {
        byte byte0 = -1;
        boolean flag1 = true;
    ...
    int fill(android.support.v7.widget.RecyclerView.Recycler recycler, LayoutState layoutstate, android.support.v7.widget.RecyclerView.State state, boolean flag)
    {
...
label0:
    ...
    {
        if (mOrientationHelper != null) goto _L2; else goto _L1
_L1:
        View view = null;
_L5:
        return view;
...
_L3:
        view1 = getChildAt(i);
        j1 = mOrientationHelper.getDecoratedStart(view1);
        k1 = mOrientationHelper.getDecoratedEnd(view1);
        if (j1 >= i1 || k1 <= l)
        {
...
_L4:
    ...
    protected View findReferenceChild(int i, int j, int k)
    {
label0:
        {
            View view1 = null;
            ...
            while (i != j) 
            {
                ...
                if (k1 >= 0)
                {
                    ...
                    if (k1 < k)
                    {
                        if (((android.support.v7.widget.RecyclerView.LayoutParams)view2.getLayoutParams()).isItemRemoved())
                        {
                            view3 = view1;
                            view4 = view;
                            if (view1 == null)
    ...
    void layoutChunk(android.support.v7.widget.RecyclerView.Recycler recycler, android.support.v7.widget.RecyclerView.State state, LayoutState layoutstate, LayoutChunkResult layoutchunkresult)
    {
        ...
        state = (android.support.v7.widget.RecyclerView.LayoutParams)recycler.getLayoutParams();
        int i;
        int j;
        int k;
        int l;
        ...
        layoutDecorated(recycler, j + ((android.support.v7.widget.RecyclerView.LayoutParams) (state)).leftMargin, l + ((android.support.v7.widget.RecyclerView.LayoutParams) (state)).topMargin, k - ((android.support.v7.widget.RecyclerView.LayoutParams) (state)).rightMargin, i - ((android.support.v7.widget.RecyclerView.LayoutParams) (state)).bottomMargin);
    ...
    public void onDetachedFromWindow(RecyclerView recyclerview, android.support.v7.widget.RecyclerView.Recycler recycler)
    {
...
_L3:
    ...
    int scrollBy(int i, android.support.v7.widget.RecyclerView.Recycler recycler, android.support.v7.widget.RecyclerView.State state)
    {
