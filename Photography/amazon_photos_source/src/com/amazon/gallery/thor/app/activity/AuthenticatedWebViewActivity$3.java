...
class lient extends AuthenticatedWebViewClient
{
    ...
    public void onPageFinished(WebView webview, String s)
    {
        ...
        {
            AuthenticatedWebViewActivity.access$400(AuthenticatedWebViewActivity.this).postDelayed(new Runnable() {

                final AuthenticatedWebViewActivity._cls3 this$1;

                public void run()
                {
                    if (mSpinner.isShowing())
                    {
                        AuthenticatedWebViewActivity.access$200(this$0);
                        finish();
                    }
                }
            ...
            {
                this$1 = AuthenticatedWebViewActivity._cls3.this;
                super();
            }
            }, AuthenticatedWebViewActivity.access$300());
            return;
        }
    }
    ...
    _cls1.this._cls1(Activity activity)
    {
