...
class val.onAnimationEnd
    implements android.view.animation.tener
{

    final val.onAnimationEnd this$1;
...
label0:
            {
                if (ColdBootUIHandler.access$600(ColdBootUIHandler.this).getVisibility() == 0)
                {
                    ...
                    runnable = new ColdBootUIHandler._cls5._cls1();
                    if (!ColdBootUIHandler.USE_JELLYBEAN_ANIMATIONS)
                    {
                        break label0;
                    }
                    ColdBootUIHandler.access$600(ColdBootUIHandler.this).animate().setDuration(400L).translationY(500F).withEndAction(runnable);
                }
                return;
            }
            int ai[] = new int[2];
            ...
            translateanimation.setAnimationListener(runnable. new ColdBootUIHandler._cls5._cls2());
        ...
        // Unreferenced inner class com/amazon/gallery/thor/cds/ColdBootUIHandler$5$1

/* anonymous class */
        class ColdBootUIHandler._cls5._cls1
            implements Runnable
        {
