    ...
    implements Runnable
{
    ...
    public void run()
    {
        FacebookScreen.access$1600(_fld0).hide();
        if (val$hasPhotos.booleanValue())
        {
            FacebookScreen.access$1800(_fld0).runOnUiThread(FacebookScreen.access$1700(_fld0));
            return;
        } else
        {
            (new android.support.v7.app.(FacebookScreen.access$2000(_fld0))).setMessage(0x7f0e00db).setTitle(0x7f0e00dd).setPositiveButton(0x7f0e0093, new android.content.DialogInterface.OnClickListener() {
            ...
            FacebookScreen.access$2100(_fld0);
            return;
        }
    }
