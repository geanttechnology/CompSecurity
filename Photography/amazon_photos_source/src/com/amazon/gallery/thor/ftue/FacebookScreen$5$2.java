    ...
    implements Runnable
{
    ...
    public void run()
    {
        FacebookScreen.access$2700(_fld0).hide();
        (new android.support.v7.app.(FacebookScreen.access$2800(_fld0))).setMessage(0x7f0e00d8).setTitle(0x7f0e0119).setPositiveButton(0x7f0e0093, new android.content.DialogInterface.OnClickListener() {
...
_L3:
        ...
        public void onSuccess(final Boolean hasPhotos)
        {
            ...
            FacebookScreen.access$2200(FacebookScreen.this).runOnUiThread(new FacebookScreen._cls5._cls1());
        }
...
/* anonymous class */
        class FacebookScreen._cls5._cls1._cls1
            implements android.content.DialogInterface.OnClickListener
        {

            final FacebookScreen._cls5._cls1 this$2;

            public void onClick(DialogInterface dialoginterface, int i)
            {
                dialoginterface.dismiss();
                FacebookScreen.access$1900(this$0).proceedToNext(this$0, true);
            }

                    
                    {
                        this$2 = FacebookScreen._cls5._cls1.this;
                        super();
                    }
        }
