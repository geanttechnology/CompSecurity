...
//            WhisperUploadSyncScheduler

public class WhisperUploadSAFSyncScheduler extends WhisperUploadSyncScheduler
{

    private static final String TAG = com/amazon/gallery/thor/syncframework/WhisperUploadSAFSyncScheduler.getName();

    protected WhisperUploadSAFSyncScheduler(Context context, String s)
    {
        super(context, s);
    }

    public void disableSyncForProfile(Object obj, Context context)
    {
    }
