    ...
    implements Runnable
{
    ...
    public void run()
    {
        ThisDayEmailFragment.access$200(_fld0);
        dismiss();
    }
...
/* anonymous class */
        ...
        implements com.amazon.gallery.framework.network.NetworkExecutor.ResultHandler
    {
        ...
        // Unreferenced inner class com/amazon/gallery/thor/thisday/ThisDayEmailFragment$1$1

/* anonymous class */
        class ThisDayEmailFragment._cls1._cls1
            implements Runnable
        {
