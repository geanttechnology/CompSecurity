    ...
    implements Runnable
{
    ...
    public void run()
    {
        ...
        Callback callback = this._cls1.this.callback;
        String s = val$accountType;
        AccountManagerLogic.access$500$70268062(accountmanagerlogic, registrationtype, bundle, callback, val$accountName, val$extras);
    }
