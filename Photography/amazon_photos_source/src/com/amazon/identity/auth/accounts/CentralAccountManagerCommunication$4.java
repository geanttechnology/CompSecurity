...
class  extends AccountManagerCallbackAdapter
{
    ...
    protected void onResult(Callback callback, Boolean boolean1)
    {
        ...
        {
            boolean1 = CentralAccountManagerCommunication.this;
            callback.onError(CentralAccountManagerCommunication.access$100$74f9fc51());
            return;
        } else
        {
            boolean1 = CentralAccountManagerCommunication.this;
            callback.onSuccess(CentralAccountManagerCommunication.access$200$74f9fc51());
            return;
        }
    }
