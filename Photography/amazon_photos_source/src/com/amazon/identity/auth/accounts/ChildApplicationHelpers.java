...
public final class ChildApplicationHelpers
{
    ...
    public static boolean isChildApplicationDeviceTypeRegistered(Context context, DataStorage datastorage, String s, String s1)
    {
        ...
        if (datastorage.getUserData(s, getIsRegisteredKeyForDeviceType(s1)) != null)
        {
            return true;
        }
        return false;
    ...
    public static boolean isOverridingDeviceAttributes(Context context, String s)
    {
        ...
        {
            return MetaDataUtils.getBooleanMetaDataForAPackage$a09a196(context, s, "MAPDeviceAttributeRuntimeOverride").booleanValue();
        }
    }
