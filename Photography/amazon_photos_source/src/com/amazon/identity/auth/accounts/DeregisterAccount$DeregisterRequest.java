...
label0:
    ...
    public void run()
    {
        ...
        } else
        {
            ...
            } else
            {
                ...
                obj1 = new RegistrarDeregistration(mContext, mDirectedId, mDeregisterAllOnAccountRemoval, ((AccountRegistrar) (obj1)), mRegistrarAuthenticator, mAccountCredentials, mTracer);
    ...
    public _cls2.val.creds(Context context, String s, Collection collection, AccountRegistrarAuthenticator accountregistrarauthenticator, AccountCredentials accountcredentials, Tracer tracer)
    {
        mContext = context;
