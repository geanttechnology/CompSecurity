    ...
    implements MultipleAccountPlugin
{
    ...
    private void setIntentPriority(Intent intent)
    {
        ...
        if ("com.amazon.dcp.sso.action.account.added".equals(s) || "com.amazon.dcp.sso.action.secondary.account.added".equals(s) || "com.amazon.dcp.sso.action.account.removed".equals(s) || "com.amazon.dcp.sso.action.secondary.account.removed".equals(s) || "com.amazon.identity.auth.account.added.on.device".equals(s) || "com.amazon.identity.auth.account.removed.on.device".equals(s) || "com.amazon.dcp.sso.action.AmazonAccountPropertyService.property.changed".equals(s) || "com.amazon.dcp.sso.broadcast.CORPFMHasChanged".equals(s))
        {
            String s1 = TAG;
    ...
    com.amazon.identity.auth.device.api.MultipleAccountManager.PrimaryUserMappingType.createPrimaryMappingForProfile(i)
            ...
            if (i != 0)
            {
                bundle1.putString("com.amazon.dcp.sso.property.account.extratokens.account_profiles", Integer.toString(bundle.intValue()));
            }
        }
    }
...
_L3:
    ...
    {
        sendBroadcastInternal$3f4fcad8(intent, s, mUserManWrapper.getMainUser());
    }
