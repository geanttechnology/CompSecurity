...
//            WebViewCookieUtils, AuthenticationWebViewClient, WebViewUtils, MAPSmsReceiver, 
...
_L7:
        ...
        obj1 = TAG;
        (new StringBuilder("Allowed signin domains after formatting ")).append(mAllowedSignInDomains).toString();
        return intent;
    }
        ...
        if (mOptions.containsKey("InjectCookiesToAuthPortalUIActivity"))
        {
            ...
            if (as != null)
            {
                ...
                for (int i = 0; i < j; i++)
                {
                    String s1 = as[i];
                    String s2 = TAG;
                    (new StringBuilder("Adding cookie to CookieManager: ")).append(s1).toString();
    ...
    private void setupFrcCookie(String s)
    {
        ...
        String s1 = TAG;
        (new StringBuilder("Setting up the frc cookie in AuthPortalUIActivity for domain : ")).append(s).toString();
    ...
    public void finish()
    {
        ...
        {
            Object obj = TAG;
            obj = AccountsCallbackHelpers.getAccountManagerErrorBundle(4, "Registration canceled");
            if (isEnsureAccountStateFlow())
            {
                ((Bundle) (obj)).putStringArrayList("AccountMissingAttributes", mOptions.getStringArrayList("AccountMissingAttributes"));
            }
            finishOnError(((Bundle) (obj)));
            return;
        } else
        {
            closeActivity();
...
_L3:
        ...
        safelySetUpJavascriptInterface(webview, new MAPJavascriptInterface.MAPJavascriptInterfaceCallback() {
...
_L49:
        ...
        JVM INSTR tableswitch 1 2: default 1989
    //                   1 1693
    //                   2 1859;
           goto _L14 _L15 _L16
_L14:
        ...
        i = 0;
        _cls9..SwitchMap.com.amazon.identity.auth.device.api.MAPAccountManager.AuthPortalActivityUIOptions.ProgressBarState[((com.amazon.identity.auth.device.api.MAPAccountManager.AuthPortalActivityUIOptions.ProgressBarState) (obj)).ordinal()];
        JVM INSTR tableswitch 3 5: default 1992
    //                   3 2035
    //                   4 2056
    //                   5 2077;
...
_L21:
        ...
        JVM INSTR tableswitch 1 9: default 1995
    //                   1 1877
    //                   2 1877
    //                   3 1877
    //                   4 1887
...
_L23:
        _cls9..SwitchMap.com.amazon.identity.auth.device.api.MAPAccountManager.AuthPortalActivityUIOptions.ScreenPosition[bundle.ordinal()];
        JVM INSTR tableswitch 1 9: default 1998
    //                   1 1907
    //                   2 1917
    //                   3 1927
    //                   4 1907
...
/*
    static void access$800(AuthPortalUIActivity authportaluiactivity, com.amazon.identity.auth.device.endpoint.OpenIdRequest.REQUEST_TYPE request_type, final OpenIdResponse response)
    {
        ...
        } else
        {
            ...
            String s1 = response.getDirectedId();
            final Object sid = authportaluiactivity.mCookieUrl;
            if (TextUtils.isEmpty(s1) || TextUtils.isEmpty(((CharSequence) (sid))))
            {
                sid = null;
            } else
            {
            ...
            if (request_type.equals(com.amazon.identity.auth.device.endpoint.OpenIdRequest.REQUEST_TYPE.CONFIRM_CREDENTIAL) || request_type.equals(com.amazon.identity.auth.device.endpoint.OpenIdRequest.REQUEST_TYPE.AUTHENTICATE))
            {
