    ...
    implements ContentProviderClientCallback
{
    ...
    public DeviceDataInfo useContentProviderClient(ContentProviderClient contentproviderclient)
        throws Exception
    {
        contentproviderclient = contentproviderclient.query(DeviceDataCommunication.DEVICE_DATA_STORE_URI, DeviceDataCommunication.COLUMNS, val$key, null, null);
        ...
        MAPLog.w(DeviceDataCommunication.access$000(), s);
        ...
        throw exception;
        Object obj;
        obj = DeviceDataCommunication.this;
        DeviceDataCommunication.access$100$4f195b05(contentproviderclient);
        ...
        DeviceDataCommunication.access$000();
