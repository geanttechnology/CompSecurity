...
public final class WebViewCookieUtils
{
    ...
    private static final String TAG = com/amazon/identity/auth/device/WebViewCookieUtils.getName();
    ...
    public static Cookie getCookieFromCookieManager(Context context, String s, String s1, String s2)
    {
        ...
        obj = ((CookieManager) (obj)).getCookie(context);
        s3 = TAG;
        (new StringBuilder("Extracting cookies from CookieManager for domain=")).append(context).toString();
        context = TAG;
        for (context = parseCookieString(s1, s, ((String) (obj))).iterator(); context.hasNext();)
        {
