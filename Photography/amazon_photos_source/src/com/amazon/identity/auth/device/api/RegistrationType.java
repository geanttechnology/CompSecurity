...
public final class RegistrationType extends Enum
{
    ...
    public static final RegistrationType FROM_ADP_TOKEN;
    ...
    public static final RegistrationType WITH_LINK_CODE;
    ...
    static 
    {
        ...
        FROM_ADP_TOKEN = new RegistrationType("FROM_ADP_TOKEN", 6, "AdpToken");
        REGISTER_DELEGATED_ACCOUNT = new RegistrationType("REGISTER_DELEGATED_ACCOUNT", 7, "RegisterDelegatedAccount");
        WITH_DIRECTEDID_CREDENTIALS = new RegistrationType("WITH_DIRECTEDID_CREDENTIALS", 8, "DirectedIdCredentials");
        WITH_LINK_CODE = new RegistrationType("WITH_LINK_CODE", 9, "LinkCode");
        $VALUES = (new RegistrationType[] {
            WITH_LOGIN_CREDENTIALS, WITH_DEVICE_SECRET, WITH_EXPLICIT_URL, FROM_ATMAIN, FROM_AUTH_TOKEN, FROM_ACCESS_TOKEN, FROM_ADP_TOKEN, REGISTER_DELEGATED_ACCOUNT, WITH_DIRECTEDID_CREDENTIALS, WITH_LINK_CODE
        });
    }
}
