...
_L2:
    ...
    public static IGenericIPC asInterface(IBinder ibinder)
    {
        ...
        android.os.IInterface iinterface = ibinder.queryLocalInterface("com.amazon.identity.auth.device.callback.IGenericIPC");
        ...
        throws RemoteException
    {
        ...
        call(s, bundle, tub.asInterface(parcel.readStrongBinder()));
