...
public class CBLLogic
{
    ...
    public void authorizeLinkCode(final Bundle directedId, Callback callback, final Tracer tracer)
    {
        ...
        publicCode = directedId.getString("link_code");
    ...
    public void generatePreAuthorizedLinkCode(Bundle bundle, Callback callback, final Tracer tracer)
    {
        ...
        directedId = bundle.getString("com.amazon.dcp.sso.property.account.acctId");
        if (TextUtils.isEmpty(directedId))
        {
...
/*
    static void access$100(CBLLogic cbllogic, String s, Bundle bundle, LocalKeyValueStore localkeyvaluestore, Callback callback, Tracer tracer)
    {
        ...
        int i = bundle.getInt("get_link_code_with_length", 0);
        ...
        obj = new PandaCreateCodePairEndpointUtils(ServiceWrappingContext.create(cbllogic.mContext), tracer);
        bundle = httpsurlconnection1;
        httpsurlconnection = httpsurlconnection1;
        s = httpsurlconnection1;
        obj1 = ((PandaCreateCodePairEndpointUtils) (obj)).getRequestJSON(i, l);
...
_L2:
        ...
        httpsurlconnection = httpsurlconnection1;
        s = httpsurlconnection1;
        StreamUtils.writeToStreamAndClose(httpsurlconnection1.getOutputStream(), ((String) (obj1)).getBytes());
        bundle = httpsurlconnection1;
        httpsurlconnection = httpsurlconnection1;
        s = httpsurlconnection1;
        int j = httpsurlconnection1.getResponseCode();
        bundle = httpsurlconnection1;
        httpsurlconnection = httpsurlconnection1;
        s = httpsurlconnection1;
        MAPLog.i(TAG, (new StringBuilder("The createCodePair call response code is ")).append(j).toString());
        bundle = httpsurlconnection1;
        httpsurlconnection = httpsurlconnection1;
        s = httpsurlconnection1;
        ...
        httpsurlconnection = httpsurlconnection1;
        s = httpsurlconnection1;
        obj1 = JSONHelpers.toJson(httpsurlconnection1);
        if (j != 200) goto _L4; else goto _L3
_L3:
        bundle = httpsurlconnection1;
        httpsurlconnection = httpsurlconnection1;
        s = httpsurlconnection1;
        obj = ((PandaCreateCodePairEndpointUtils) (obj)).parseSuccessResponse(((JSONObject) (obj1)));
        bundle = httpsurlconnection1;
        httpsurlconnection = httpsurlconnection1;
        s = httpsurlconnection1;
...
_L4:
        ...
        httpsurlconnection = httpsurlconnection1;
        s = httpsurlconnection1;
        localkeyvaluestore = PandaEndpointUtils.parseErrorAndLogMetrics(((JSONObject) (obj1)));
        bundle = httpsurlconnection1;
        httpsurlconnection = httpsurlconnection1;
        s = httpsurlconnection1;
        obj = (new StringBuilder("Response code : ")).append(j).append(" Error Code : ").append(((PandaEndpointUtils.PandaErrorResponse) (localkeyvaluestore)).mErrorCode).append(" Description : ").append(((PandaEndpointUtils.PandaErrorResponse) (localkeyvaluestore)).mErrorMessage).toString();
        bundle = httpsurlconnection1;
        httpsurlconnection = httpsurlconnection1;
        s = httpsurlconnection1;
        platformmetricstimer.setTimerName(MetricUtils.getUrlPathAndDomain(url, j, ((PandaEndpointUtils.PandaErrorResponse) (localkeyvaluestore)).mErrorCode));
        bundle = httpsurlconnection1;
        httpsurlconnection = httpsurlconnection1;
        s = httpsurlconnection1;
        ...
        if (httpsurlconnection == null) goto _L5; else goto _L7
_L7:
