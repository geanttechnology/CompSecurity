...
import com.amazon.identity.auth.device.MAPSmsReceiver;
...
_L1:
    ...
    static JSONObject getFraudMetaDataJSON(Context context, Tracer tracer)
    {
        ...
        try
        {
            ((JSONObject) (obj)).put("ApplicationName", servicewrappingcontext.getPackageName());
...
_L1:
        ((JSONObject) (obj)).put("ApplicationVersion", context);
        ((JSONObject) (obj)).put("DeviceOSVersion", getDeviceOSVersion(tracer));
        ((JSONObject) (obj)).put("DeviceName", String.format("%s/%s/%s", new Object[] {
            Build.HARDWARE, Build.MANUFACTURER, Build.MODEL
        }));
        ((JSONObject) (obj)).put("ThirdPartyDeviceId", getAndroidId(servicewrappingcontext, tracer));
        ((JSONObject) (obj)).put("ScreenWidthPixels", getScreenWidthPixels(servicewrappingcontext, tracer));
        ((JSONObject) (obj)).put("ScreenHeightPixels", getScreenHeightPixels(servicewrappingcontext, tracer));
        ((JSONObject) (obj)).put("DeviceLanguage", LocaleUtil.getLocaleAsLanguageTag(Locale.getDefault()));
        ((JSONObject) (obj)).put("TimeZone", getTimeZone(tracer));
        ((JSONObject) (obj)).put("Carrier", getCarrier(servicewrappingcontext, tracer));
        ((JSONObject) (obj)).put("PhoneNumber", getPhoneNumber(servicewrappingcontext, tracer));
        ((JSONObject) (obj)).put("IpAddress", getIpAddress(tracer));
        context = TAG;
        (new StringBuilder("Finish generating meta data:")).append(((JSONObject) (obj)).toString()).toString();
        return ((JSONObject) (obj));
        context = null;
          goto _L1
    }
...
_L3:
    ...
    public static String getMapToAuthPortalMetadataCookie(ServiceWrappingContext servicewrappingcontext, MAPSmsReceiver mapsmsreceiver, String s, Tracer tracer)
    {
        ...
        mapsmsreceiver = TAG;
        (new StringBuilder("Setting map to authportal metadata cookie:")).append(jsonobject.toString()).toString();
        return servicewrappingcontext;
    }
