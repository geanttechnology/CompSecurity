    ...
    implements TokenManagementDefinition
{
    ...
    public MAPFuture getToken(final String directedId, final String token, final Bundle options, Callback callback1, final Tracer tracer)
    {
        ...
        callback = mPendingRequestCallbackHolder.waitForInflightRequestOrMakeRequest(String.format("%s#%s", new Object[] {
            directedId, token
        }), callback1);
        if (callback == null)
        {
        ...
        } else
        {
            mExecutor.execute(new Runnable() {
                ...
                public void run()
                {
                    ...
                    TokenManagementLogic tokenmanagementlogic = TokenManagementLogic.this;
                    if (this = this.getKey())
                    {
                    ...
                    tokenmanagementlogic = TokenManagementLogic.this;
                    if (keyinfo.equals())
                    {
