...
public class PandaRegisterDeviceResponseJsonParser extends PandaResponseJsonParser
{
    ...
    {
        Object obj = authenticationchallenge.getReason();
        MAPLog.formattedInfo(TAG, " PandaResponseJsonParser: response received a %s challenge.", new Object[] {
            obj
        });
        if ("AuthenticationFailed".equals(obj) || "InvalidAuthenticationData".equals(obj))
        {
            obj = new RegisterDeviceError(RegisterDeviceErrorType.RegisterDeviceErrorTypeCustomerNotFound);
        } else
        {
            obj = new RegisterDeviceError(RegisterDeviceErrorType.RegisterDeviceErrorTypeChallengeResponse);
        }
        return new RegisterDeviceResponse(authenticationchallenge, ((RegisterDeviceError) (obj)));
    }
...
_L7:
        ...
        throws JSONException
    {
        if (jsonobject.has("tokens"))
        {
            ...
            if (jsonobject1.has("bearer"))
            {
                ...
                mAccessTokenExpiresIn = StringConversionHelpers.toInt$505cff29(jsonobject2.getString("expires_in"));
            }
            ...
            {
                mStoreAuthenticationCookie = jsonobject1.getJSONObject("store_authentication_cookie").optString("cookie", null);
            }
    ...
    protected RegisterDeviceResponse parseSpecificPandaErrorResponse(JSONObject jsonobject)
        throws JSONException
    {
        MAPLog.formattedInfo(TAG, " PandaResponseJsonParser: response received a %s error.", new Object[] {
            jsonobject.toString()
        });
