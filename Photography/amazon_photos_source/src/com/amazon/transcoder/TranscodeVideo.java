...
public class TranscodeVideo
{
    public static class Builder
    {
        ...
        public Builder withDestination(String s)
        {
            destination = s;
            return this;
        }
        ...
        public Builder withSource(String s)
        {
            source = s;
            return this;
        }
    ...
    public static final String TAG = com/amazon/transcoder/TranscodeVideo.getName();
    private final Builder builder;

    private TranscodeVideo(Builder builder1)
    {
        builder = builder1;
    }


    protected static native int transcode(String s, String s1, int i, int j, int k, int l, int i1, int j1);

    protected static native int transcodeV2(String s, String s1, int i, int j, int k, int l, int i1, int j1, 
    ...
    public int transcode()
    {
        ...
        try
        {
            i = transcodeV2(builder.source, builder.destination, builder.videoBitRate, builder.videoWidth.intValue(), builder.videoHeight.intValue(), builder.videoCodec, builder.audioBitRate, builder.audioCodec, builder.containerFormat, builder.start, builder.end.intValue());
        }
        catch (UnsatisfiedLinkError unsatisfiedlinkerror)
        {
            return transcode(builder.source, builder.destination, builder.videoBitRate, builder.videoWidth.intValue(), builder.videoHeight.intValue(), builder.audioBitRate, builder.start, builder.end.intValue());
        }
        return i;
    }
