    ...
    implements FutureListener
{
    ...
    final rsorWrapper val$currentPack;
...
_L2:
        ...
        AviaryCdsService.access$100(AviaryCdsService.this, getBaseContext(), future, val$currentPack, val$order, val$assetBaseUrl);
        val$notificationMap.put(val$currentPack.getPackType(), Boolean.valueOf(true));
