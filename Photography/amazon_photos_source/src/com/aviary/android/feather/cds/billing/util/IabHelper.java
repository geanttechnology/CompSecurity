...
public class IabHelper
{
    ...
    public static final int IABHELPER_MISSING_SIGNATURE = -1011;
        ...
        (new Thread(new Runnable() {
            ...
            public void run()
            {
                ...
                for (Iterator iterator = purchases.iterator(); iterator.hasNext();)
                {
                    ...
                    {
                        consume(purchase);
                        arraylist.add(new IabResult(0, (new StringBuilder()).append("Successful consume of sku ").append(purchase.getSku()).toString()));
                    }
...
_L3:
        ...
        throws IabException
    {
        ...
        {
            throw new IabException(-1008, "Unknown Error", list);
        }
        if (i == 0)
        {
        ...
        int j = querySkuDetails("subs", inventory, list1);
        if (j == 0)
        {
            break MISSING_BLOCK_LABEL_197;
        }
    ...
    {
        queryInventoryAsync(flag, null, null, queryinventoryfinishedlistener);
    }

    public void queryInventoryAsync(final boolean querySkuDetails, final List moreSkus, final List subSkus, final QueryInventoryFinishedListener listener)
    {
        final Handler handler = new Handler();
        checkNotDisposed();
        checkSetupDone("queryInventory");
...
_L1:
        ...
        throws JSONException, RemoteException
    {
        ...
        do
        {
            ...
            logDebug((new StringBuilder()).append("Owned items response: ").append(String.valueOf(j)).toString());
            if (j != 0)
            {
                logDebug((new StringBuilder()).append("getPurchases() failed: ").append(getResponseDesc(j)).toString());
                return j;
            }
            ...
            while (i < arraylist.size()) 
            {
                ...
                Object obj2 = (String)arraylist1.get(i);
                String s2 = (String)((ArrayList) (obj1)).get(i);
                ...
                } else
                {
                    ...
                    logDebug((new StringBuilder()).append("   Purchase data: ").append(s1).toString());
                    logDebug((new StringBuilder()).append("   Signature: ").append(((String) (obj2))).toString());
                    flag = true;
                }
                i++;
            }
            obj1 = ((Bundle) (obj)).getString("INAPP_CONTINUATION_TOKEN");
            logDebug((new StringBuilder()).append("Continuation token: ").append(((String) (obj1))).toString());
            obj = obj1;
            i = ((flag) ? 1 : 0);
        } while (!TextUtils.isEmpty(((CharSequence) (obj1))));
        if (flag)
        {
            i = -1003;
        } else
        ...
        throws RemoteException, JSONException
    {
        ...
        list = new ArrayList();
        int k = ((ArrayList) (obj)).size() / 20;
        int l = ((ArrayList) (obj)).size() % 20;
        for (int i = 0; i < k; i++)
        {
            ArrayList arraylist = new ArrayList();
            for (Iterator iterator = ((ArrayList) (obj)).subList(i * 20, i * 20 + 20).iterator(); iterator.hasNext(); arraylist.add((String)iterator.next())) { }
            list.add(arraylist);
        }
        ...
        if (l != 0)
        {
            ...
            for (obj = ((ArrayList) (obj)).subList(k * 20, k * 20 + l).iterator(); ((Iterator) (obj)).hasNext(); arraylist1.add((String)((Iterator) (obj)).next())) { }
            list.add(arraylist1);
        }
        for (list = list.iterator(); list.hasNext();)
        {
            Object obj1 = (ArrayList)list.next();
            logDebug((new StringBuilder()).append("Processing chunk of ").append(((ArrayList) (obj1)).size()).append(" items").toString());
            Bundle bundle = new Bundle();
            bundle.putStringArrayList("ITEM_ID_LIST", ((ArrayList) (obj1)));
            obj1 = mService.getSkuDetails(3, mContext.getPackageName(), s, bundle);
            if (!((Bundle) (obj1)).containsKey("DETAILS_LIST"))
            {
                int j = getResponseCodeFromBundle(((Bundle) (obj1)));
                if (j != 0)
                {
                    logDebug((new StringBuilder()).append("getSkuDetails() failed: ").append(getResponseDesc(j)).toString());
                    return j;
                } else
                {
            ...
            {
                SkuDetails skudetails = new SkuDetails(s, (String)((Iterator) (obj1)).next());
    ...
    public void startSetup(final OnIabSetupFinishedListener listener)
    {
        ...
        logWarn("Signature is null");
        if (!PackageManagerUtils.isStandalone(mContext))
        {
            break MISSING_BLOCK_LABEL_85;
        }
        Object obj = mSignatureLock;
        obj;
        JVM INSTR monitorenter ;
        loadKeysAsync();
        logDebug("waiting for mSignatureLock");
        mSignatureLock.wait(1000L);
        logDebug("Restored Signature..");
_L8:
        if (!TextUtils.isEmpty(mSignatureBase64)) goto _L2; else goto _L1
_L1:
        if (listener != null)
        {
            listener.onIabSetupFinished(new IabResult(-1011, "Signature cannot be null"));
        }
_L6:
        return;
        Object obj1;
        obj1;
        logError((new StringBuilder()).append("handled: ").append(((InterruptedException) (obj1)).getMessage()).toString());
        continue; /* Loop/switch isn't completed */
        listener;
        obj;
        JVM INSTR monitorexit ;
...
_L3:
        ...
        boolean flag1 = mContext.getPackageManager().queryIntentServices(((Intent) (obj)), 0).isEmpty();
        boolean flag;
        if (!flag1)
        {
            flag = true;
...
_L4:
        if (flag)
        {
            mContext.bindService(((Intent) (obj)), mServiceConn, 1);
            return;
        }
...
_L3:
        mServiceConn = null;
        if (listener == null) goto _L6; else goto _L5
_L5:
