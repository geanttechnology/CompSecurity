...
public abstract class AbstractSliderContentPanel extends AbstractContentPanel
    implements android.view.View.OnClickListener, android.widget.SeekBar.OnSeekBarChangeListener, com.aviary.android.feather.sdk.widget.AviaryWheel.OnWheelChangeListener
{
    static final class SliderStyle extends Enum
    {
        ...
        {
            return (SliderStyle)Enum.valueOf(com/aviary/android/feather/sdk/panels/AbstractSliderContentPanel$SliderStyle, s);
        }
    ...
    public AbstractSliderContentPanel(IAviaryController iaviarycontroller, ToolEntry toolentry)
    {
        ...
        mFilter = ToolLoaderFactory.get(toolentry.name);
    }
