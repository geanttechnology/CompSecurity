...
public abstract class AviaryAdapterView extends ViewGroup
{
    ...
    public static interface OnItemClickListener
    {
        ...
        public abstract void onItemClick(AviaryAdapterView aviaryadapterview, View view, int i, long l);
    }

    public static interface OnItemLongClickListener
    {

        public abstract boolean onItemLongClick(AviaryAdapterView aviaryadapterview, View view, int i, long l);
    }

    public static interface OnItemSelectedListener
    {

        public abstract void onItemSelected(AviaryAdapterView aviaryadapterview, View view, int i, long l);

        public abstract void onNothingSelected(AviaryAdapterView aviaryadapterview);
    }
...
label0:
    ...
    {
        Log.i("View", (new StringBuilder()).append("selectionChanged: ").append(mSelectedPosition).toString());
        if (mOnItemSelectedListener != null)
        {
...
_L6:
    ...
    {
        Log.i("View", (new StringBuilder()).append("setNextSelectedPositionInt: ").append(i).toString());
