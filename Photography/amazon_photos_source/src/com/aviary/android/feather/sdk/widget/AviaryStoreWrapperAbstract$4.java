...
class this._cls0 extends BroadcastReceiver
{
    ...
    {
        AviaryStoreWrapperAbstract.logger.gger("packInstalledReceiver::onReceive: %s", new Object[] {
            intent
        });
        if (intent != null && isActive())
        {
            ...
            AviaryStoreWrapperAbstract.access$000(AviaryStoreWrapperAbstract.this).onPackInstalled(l, context, i);
        }
    }
