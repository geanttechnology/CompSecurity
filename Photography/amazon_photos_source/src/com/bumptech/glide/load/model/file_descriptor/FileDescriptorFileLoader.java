    ...
    implements FileDescriptorModelLoader
{
        ...
        implements ModelLoaderFactory
    {
        ...
        {
            return new FileDescriptorFileLoader(genericloaderfactory.buildModelLoader(android/net/Uri, android/os/ParcelFileDescriptor));
        }
    ...
    public FileDescriptorFileLoader(ModelLoader modelloader)
    {
        super(modelloader);
    }
}
