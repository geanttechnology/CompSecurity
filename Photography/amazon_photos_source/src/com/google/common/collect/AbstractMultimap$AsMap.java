...
//            AbstractMultimap, Iterators, Maps, Collections2
...
private class submap extends AbstractMap
{
        ...
        implements Iterator
    {
        ...
        public java.util.Map.Entry next()
        {
            ...
            return Maps.immutableEntry(obj, AbstractMultimap.access$400(this$0, obj, collection));
        }
    ...
    public void clear()
    {
        if (submap == AbstractMultimap.access$000(AbstractMultimap.this))
        {
    ...
    public Collection get(Object obj)
    {
        ...
        {
            return AbstractMultimap.access$400(AbstractMultimap.this, obj, collection);
        }
    }
