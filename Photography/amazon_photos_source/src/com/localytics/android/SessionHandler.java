...
_L1:
        ...
        JVM INSTR tableswitch 1 2: default 425
    //                   1 164
    //                   2 96;
           goto _L3 _L4 _L3
_L4:
...
_L5:
    ...
    public void handleMessage(final Message msg)
    {
        ...
        msg.what;
        JVM INSTR tableswitch 0 21: default 1002
    //                   0 170
    //                   1 242
    //                   2 275
    //                   3 308
...
_L5:
        ...
        Object aobj2[] = (Object[])(Object[])msg.obj;
        msg = (String)aobj2[0];
        final Map attributes = (Map)aobj2[1];
        final Long clv = (Long)aobj2[2];
        mProvider.runBatchTransaction(new Runnable() {
...
_L16:
        ...
        msg = (JSONObject)aobj1[0];
        final int action = ((Integer)aobj1[1]).intValue();
        final String customerID = (String)mProvider.getUserIdAndType().get("id");
        mProvider.runBatchTransaction(new Runnable() {
...
_L2:
                ...
                int k = (new JSONObject(((String) (obj)))).getInt("ca");
                Object obj1;
                Object obj3;
                String s;
                int i;
                ...
                ((NotificationManager)mContext.getSystemService("notification")).notify(k, ((Notification) (obj)));
                return;
                obj;
                if (Constants.IS_LOGGABLE)
                {
...
_L8:
        ...
        cursor = cursor1;
        if (cursor1.getString(cursor1.getColumnIndexOrThrow("play_attribution")) != null || s == null)
        {
            break MISSING_BLOCK_LABEL_308;
        }
        cursor = cursor1;
...
_L12:
        ...
        obj = obj1;
        _cls17..SwitchMap.android.database.CursorJoiner.Result[result.ordinal()];
        JVM INSTR tableswitch 1 2: default 1072
    //                   1 336
    //                   2 260;
           goto _L5 _L6 _L5
_L5:
