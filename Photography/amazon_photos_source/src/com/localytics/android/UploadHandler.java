...
_L12:
        ...
        if (!LocalyticsProvider.AttributesDbColumns.ATTRIBUTE_CUSTOM_DIMENSION_2.equals(s))
        {
            break MISSING_BLOCK_LABEL_2017;
        }
        context = localyticsprovider;
        jsonobject.put("c1", obj);
        continue; /* Loop/switch isn't completed */
        ...
        if (!LocalyticsProvider.AttributesDbColumns.ATTRIBUTE_CUSTOM_DIMENSION_6.equals(s))
        {
            break MISSING_BLOCK_LABEL_2133;
        }
        context = localyticsprovider;
        jsonobject.put("c5", obj);
        continue; /* Loop/switch isn't completed */
...
_L15:
        ...
        {
            break MISSING_BLOCK_LABEL_2840;
        }
        obj = cursor;
        jsonobject.put("dt", "f");
        obj = cursor;
...
_L19:
        ...
        if (cursor.isNull(cursor.getColumnIndexOrThrow("customer_id")))
        {
            break MISSING_BLOCK_LABEL_3251;
        }
        obj = cursor;
        ...
        if (cursor.isNull(cursor.getColumnIndexOrThrow("ids")))
        {
            break MISSING_BLOCK_LABEL_3309;
        }
        obj = cursor;
        jsonobject.put("ids", new JSONObject(cursor.getString(cursor.getColumnIndexOrThrow("ids"))));
        s = null;
...
_L22:
        ...
        {
            break MISSING_BLOCK_LABEL_3477;
        }
        s = ((String) (obj1));
        ...
        if (s == null)
        {
            break MISSING_BLOCK_LABEL_3471;
        }
        obj = cursor;
        s.close();
        obj = cursor;
        ...
        {
            break MISSING_BLOCK_LABEL_3510;
        }
        s = ((String) (obj1));
        ...
        {
            break MISSING_BLOCK_LABEL_3543;
        }
        s = ((String) (obj1));
        ...
        {
            break MISSING_BLOCK_LABEL_3576;
        }
        s = ((String) (obj1));
        ...
        {
            break MISSING_BLOCK_LABEL_3609;
        }
        s = ((String) (obj1));
        ...
        {
            break MISSING_BLOCK_LABEL_3675;
        }
        s = ((String) (obj1));
        ...
        {
            break MISSING_BLOCK_LABEL_3741;
        }
        s = ((String) (obj1));
...
_L21:
        if (obj1 == null)
        {
            break MISSING_BLOCK_LABEL_3790;
        }
        obj = cursor;
        ((Cursor) (obj1)).close();
        obj = cursor;
...
_L15:
        ...
        s5 = s;
        s1 = s;
        s.setRequestProperty("x-client-version", "androida_2.70");
        obj = s;
        s5 = s;
        s1 = s;
...
_L4:
        ...
        s.addHeader("x-client-version", "androida_2.70");
...
_L23:
    ...
    public void handleMessage(Message message)
    {
        ...
        message.what;
        JVM INSTR tableswitch 1 4: default 635
    //                   1 69
    //                   2 331
    //                   3 367
    //                   4 598;
