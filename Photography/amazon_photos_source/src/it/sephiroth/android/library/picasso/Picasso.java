...
//            Cache, BitmapHunter, Stats, RequestCreator, 
//            RequestHandler, Target, StatsSnapshot, LruCache, 
//            PicassoExecutorService, Downloader, RequestWeakReference
...
public class Picasso
{
    ...
    public static final class LoadedFrom extends Enum
    {
        ...
        public static final LoadedFrom DISK_CACHE;
        ...
        {
            return (LoadedFrom)Enum.valueOf(it/sephiroth/android/library/picasso/Picasso$LoadedFrom, s);
        }
        ...
        static 
        {
            ...
            DISK_CACHE = new LoadedFrom("DISK_CACHE", 3, 0xff0000ff);
    ...
    public static final class Priority extends Enum
    {
        ...
        {
            return (Priority)Enum.valueOf(it/sephiroth/android/library/picasso/Picasso$Priority, s);
        }
...
_L5:
            ...
            ((BitmapHunter) (message)).picasso.complete(message);
            return;
        }
            ...
            boolean flag, boolean flag1)
    {
        ...
        requestHandlers = Collections.synchronizedList(cache1);
        stats = stats1;
        indicatorsEnabled = flag;
...
_L2:
    ...
    public void addRequestHandler(RequestHandler requesthandler)
    {
        ...
        {
            requestHandlers.add(1, requesthandler);
            return;
        }
    }
    ...
    void enqueueAndSubmit(Action action, long l)
    {
    ...
    Bitmap quickMemoryCacheCheck(Cache cache1, String s)
    {
        cache1 = cache1.get(s);
        if (cache1 != null)
        {
    ...
    public boolean removeRequestHandler(RequestHandler requesthandler)
    {
        return requestHandlers.remove(requesthandler);
    }
    ...
    public void resumeTag(Object obj, long l)
    {
        dispatcher.dispatchResumeTag(obj, l);
    }
    ...
    void submit(Action action, long l)
    {
        dispatcher.dispatchSubmit(action, l);
    }
