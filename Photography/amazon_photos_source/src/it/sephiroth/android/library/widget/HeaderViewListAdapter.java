...
label0:
        {
            ...
            } while (((HListView.FixedViewInfo)arraylist.next()).isSelectable);
            return false;
        }
        return true;
    }
    ...
    public Object getItem(int i)
    {
        ...
        if (i < j)
        {
            return ((HListView.FixedViewInfo)mHeaderViewInfos.get(i)).data;
        }
        int l = i - j;
        i = 0;
        if (mAdapter != null)
        ...
        return ((HListView.FixedViewInfo)mFooterViewInfos.get(l - i)).data;
    }
    ...
    public View getView(int i, View view, ViewGroup viewgroup)
    {
        ...
        if (i < j)
        {
            return ((HListView.FixedViewInfo)mHeaderViewInfos.get(i)).view;
        }
        int l = i - j;
        i = 0;
        if (mAdapter != null)
        ...
        return ((HListView.FixedViewInfo)mFooterViewInfos.get(l - i)).view;
    }
    ...
    public boolean isEnabled(int i)
    {
        ...
        if (i < j)
        {
            return ((HListView.FixedViewInfo)mHeaderViewInfos.get(i)).isSelectable;
        }
        int l = i - j;
        i = 0;
        if (mAdapter != null)
        ...
        return ((HListView.FixedViewInfo)mFooterViewInfos.get(l - i)).isSelectable;
    }
    ...
    public boolean removeFooter(View view)
    {
        ...
        {
            if (((HListView.FixedViewInfo)mFooterViewInfos.get(i)).view == view)
            {
    ...
    public boolean removeHeader(View view)
    {
        ...
        {
            if (((HListView.FixedViewInfo)mHeaderViewInfos.get(i)).view == view)
            {
