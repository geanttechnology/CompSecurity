...
public class AddressListField extends AbstractField
{
    ...
    static final FieldParser PARSER = new FieldParser() {
        ...
        {
            return new AddressListField(s, s1, bytesequence);
        }

    };
    private static Log log = LogFactory.getLog(org/apache/james/mime4j/field/AddressListField);
    private boolean parsed;

    AddressListField(String s, String s1, ByteSequence bytesequence)
    {
