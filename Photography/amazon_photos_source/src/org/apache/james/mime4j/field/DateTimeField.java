...
public class DateTimeField extends AbstractField
{
    ...
    static final FieldParser PARSER = new FieldParser() {
        ...
        {
            return new DateTimeField(s, s1, bytesequence);
        }

    };
    private static Log log = LogFactory.getLog(org/apache/james/mime4j/field/DateTimeField);
    private boolean parsed;

    DateTimeField(String s, String s1, ByteSequence bytesequence)
    {
