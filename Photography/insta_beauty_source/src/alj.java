...
public class alj extends Drawable
{
    ...
    public void e()
    {
        ...
        {
            c = b.getResources().getDrawable(0x7f020173);
            d = b.getResources().getDrawable(0x7f020174);
            if (e > f)
            {
                c = b.getResources().getDrawable(0x7f020174);
                d = b.getResources().getDrawable(0x7f020173);
            }
            if (e < getBounds().left)
            {
                e = getBounds().left;
