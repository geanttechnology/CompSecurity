...
public class alw extends AsyncTask
{
    ...
    public alw(String s, String s1, Context context, boolean flag, boolean flag1)
    {
        f = 0;
        c = new File(s);
        d = new File(s1);
    ...
    static int a(alw alw1)
    {
        return alw1.f;
    }

    static int a(alw alw1, int j)
    {
        alw1.f = j;
        return j;
    }
...
_L10:
    ...
    static void a(alw alw1, Object aobj[])
    {
        alw1.publishProgress(aobj);
    }
    ...
    protected void onPreExecute()
    {
        if (e != null && i)
        {
            e.a(com.fotoable.fotoproedit.view.ui.MyProgressDialog.MyProgressStyle.STYLE_MYSPINNER);
            e.setOnCancelListener(new alx(this));
            e.show();
        }
    }
