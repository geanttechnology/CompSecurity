...
public class ActionMenuItemView extends CompatTextView
    implements android.view.View.OnClickListener, android.view.View.OnLongClickListener, br, er
{
    ...
    private ez mForwardingListener;
    private Drawable mIcon;
    private MenuItemImpl mItemData;
    private bc mItemInvoker;
    private int mMaxIconSize;
    private int mMinWidth;
    private av mPopupCallback;
    ...
    public ActionMenuItemView(Context context, AttributeSet attributeset, int i)
    {
        ...
        mAllowTextWithIcon = resources.getBoolean(s.abc_config_allowActionMenuItemTextWithIcon);
        attributeset = context.obtainStyledAttributes(attributeset, ab.ActionMenuItemView, i, 0);
        mMinWidth = attributeset.getDimensionPixelSize(ab.ActionMenuItemView_android_minWidth, 0);
        attributeset.recycle();
        mMaxIconSize = (int)(resources.getDisplayMetrics().density * 32F + 0.5F);
        setOnClickListener(this);
        setOnLongClickListener(this);
        setTransformationMethod(new aj(context));
        mSavedPaddingLeft = -1;
    }
...
label0:
    ...
    public void initialize(MenuItemImpl menuitemimpl, int i)
    {
        ...
        {
            mForwardingListener = new au(this);
        }
    }
    ...
    public void onConfigurationChanged(Configuration configuration)
    {
        ...
        mAllowTextWithIcon = getContext().getResources().getBoolean(s.abc_config_allowActionMenuItemTextWithIcon);
    ...
    public void setItemInvoker(bc bc1)
    {
        mItemInvoker = bc1;
    }
    ...
    public void setPopupCallback(av av)
    {
        mPopupCallback = av;
    }
