    ...
    implements br
{
    ...
    public ListMenuItemView(Context context, AttributeSet attributeset, int i)
    {
        ...
        mContext = context;
        attributeset = context.obtainStyledAttributes(attributeset, ab.MenuView, i, 0);
        mBackground = attributeset.getDrawable(ab.MenuView_android_itemBackground);
        mTextAppearance = attributeset.getResourceId(ab.MenuView_android_itemTextAppearance, -1);
        mPreserveIconSpacing = attributeset.getBoolean(ab.MenuView_preserveIconSpacing, false);
    ...
    {
        mCheckBox = (CheckBox)getInflater().inflate(y.abc_list_menu_item_checkbox, this, false);
        addView(mCheckBox);
    }

    private void insertIconView()
    {
        mIconView = (ImageView)getInflater().inflate(y.abc_list_menu_item_icon, this, false);
        addView(mIconView, 0);
    }

    private void insertRadioButton()
    {
        mRadioButton = (RadioButton)getInflater().inflate(y.abc_list_menu_item_radio, this, false);
    ...
    protected void onFinishInflate()
    {
        ...
        mTitleView = (TextView)findViewById(w.title);
        if (mTextAppearance != -1)
        {
            mTitleView.setTextAppearance(mTextAppearanceContext, mTextAppearance);
        }
        mShortcutView = (TextView)findViewById(w.shortcut);
    }
...
_L3:
    ...
    public void setShortcut(boolean flag, char c)
    {
        ...
        if (c == 0)
        {
            mShortcutView.setText(mItemData.d());
        }
