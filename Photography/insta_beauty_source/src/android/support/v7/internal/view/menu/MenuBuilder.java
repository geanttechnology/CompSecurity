...
_L5:
    ...
    private boolean a(SubMenuBuilder submenubuilder, bo bo1)
    {
        boolean flag = false;
        if (w.isEmpty())
        {
        ...
        do
        {
            ...
            WeakReference weakreference = (WeakReference)bo1.next();
    ...
    {
        boolean flag1 = true;
        if (flag && f.getConfiguration().keyboard != 1 && f.getBoolean(s.abc_config_showMenuShortcutsWhenKeyboardPresent))
        {
            flag = flag1;
        } else
        {
...
_L4:
    ...
    public void a(Bundle bundle)
    {
        ...
        for (sparsearray = null; i1 < j1; sparsearray = sparsearray2)
        {
            ...
            {
                ((SubMenuBuilder)menuitem.getSubMenu()).a(bundle);
            }
            i1++;
        }
    ...
    public void a(bo bo1, Context context)
    {
        w.add(new WeakReference(bo1));
        bo1.a(context, this);
        o = true;
    }
    ...
    {
        return i != null && i.a(menubuilder, menuitem);
    }

    public boolean a(MenuItem menuitem, int i1)
    {
        return a(menuitem, ((bo) (null)), i1);
    }

    public boolean a(MenuItem menuitem, bo bo1, int i1)
    {
        Object obj;
        boolean flag1;
        boolean flag2;
...
_L5:
        if (((MenuItemImpl) (obj)).hasSubMenu() || flag)
        {
            ...
            {
                ((MenuItemImpl) (obj)).a(new SubMenuBuilder(e(), this, ((MenuItemImpl) (obj))));
            }
            ...
            boolean flag4 = a(((SubMenuBuilder) (obj)), bo1) | flag1;
            flag1 = flag4;
            if (!flag4)
            {
                a(true);
    ...
    public void b(Bundle bundle)
    {
        if (bundle != null)
        {
            ...
            for (int i1 = 0; i1 < k1; i1++)
            {
                ...
                if (menuitem.hasSubMenu())
                {
                    ((SubMenuBuilder)menuitem.getSubMenu()).b(bundle);
                }
            }
