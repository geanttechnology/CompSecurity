    ...
    implements SupportMenuItem
{
    ...
    public static MenuBuilder a(MenuItemImpl menuitemimpl)
    {
    ...
    CharSequence a(br br1)
    {
        if (br1 != null && br1.prefersCondensedTitle())
        {
...
_L5:
    ...
    public SupportMenuItem setSupportActionProvider(ActionProvider actionprovider)
    {
        ...
        if (s != null)
        {
            s.setVisibilityListener(new be(this));
        }
        return this;
    }
