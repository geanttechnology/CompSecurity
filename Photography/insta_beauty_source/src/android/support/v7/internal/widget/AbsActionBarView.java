...
public abstract class AbsActionBarView extends ViewGroup
{
    ...
    AbsActionBarView(Context context, AttributeSet attributeset, int i)
    {
        ...
        if (context.getTheme().resolveAttribute(r.actionBarPopupTheme, attributeset, true) && ((TypedValue) (attributeset)).resourceId != 0)
        {
    ...
    public void animateToVisibility(int i)
    {
        ...
        if (i == 0)
        {
            ...
            if (mSplitView != null && mMenuView != null)
            {
                ...
                as1.a(mVisAnimListener.a(viewpropertyanimatorcompat, i));
                as1.a(viewpropertyanimatorcompat).a(viewpropertyanimatorcompat2);
                as1.a();
                return;
            } else
            {
        ...
        if (mSplitView != null && mMenuView != null)
        {
            ...
            as2.a(mVisAnimListener.a(viewpropertyanimatorcompat1, i));
            as2.a(viewpropertyanimatorcompat1).a(viewpropertyanimatorcompat3);
            as2.a();
            return;
        } else
        {
    ...
    protected void onConfigurationChanged(Configuration configuration)
    {
        ...
        TypedArray typedarray = getContext().obtainStyledAttributes(null, ab.ActionBar, r.actionBarStyle, 0);
        setContentHeight(typedarray.getLayoutDimension(ab.ActionBar_height, 0));
        typedarray.recycle();
        if (mActionMenuPresenter != null)
        {
