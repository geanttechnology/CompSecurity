...
public class ActionBarContainer extends FrameLayout
{
    ...
    public ActionBarContainer(Context context, AttributeSet attributeset)
    {
        ...
        context = context.obtainStyledAttributes(attributeset, ab.ActionBar);
        mBackground = context.getDrawable(ab.ActionBar_background);
        mStackedBackground = context.getDrawable(ab.ActionBar_backgroundStacked);
        mHeight = context.getDimensionPixelSize(ab.ActionBar_height, -1);
        if (getId() == w.split_action_bar)
        {
            mIsSplit = true;
            mSplitBackground = context.getDrawable(ab.ActionBar_backgroundSplit);
        }
        context.recycle();
        if (mIsSplit)
        {
    ...
    public void onFinishInflate()
    {
        ...
        mActionBarView = findViewById(w.action_bar);
        mContextView = findViewById(w.action_context_bar);
    }
...
_L3:
    ...
    public ee startActionModeForChild(View view, ef ef)
    {
        return null;
    }
