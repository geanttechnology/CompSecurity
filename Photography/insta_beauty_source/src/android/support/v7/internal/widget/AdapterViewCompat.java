...
public abstract class AdapterViewCompat extends ViewGroup
{
    ...
    public cv mOnItemClickListener;
    cw mOnItemLongClickListener;
    cx mOnItemSelectedListener;
    public int mSelectedPosition;
    public long mSelectedRowId;
    private cy mSelectionNotifier;
    int mSpecificTop;
    long mSyncHeight;
    int mSyncMode;
    int mSyncPosition;
    ...
    private void fireOnSelected()
    {
        ...
        if (i >= 0)
        {
            ...
            mOnItemSelectedListener.a(this, view, i, getAdapter().getItemId(i));
            return;
        } else
        {
            mOnItemSelectedListener.a(this);
            return;
        }
    }
...
_L5:
    ...
    public final cv getOnItemClickListener()
    {
        return mOnItemClickListener;
    }

    public final cw getOnItemLongClickListener()
    {
        return mOnItemLongClickListener;
    }

    public final cx getOnItemSelectedListener()
    {
    ...
    void selectionChanged()
    {
        if (mOnItemSelectedListener != null)
        {
            if (mInLayout || mBlockLayoutRequests)
            {
                ...
                {
                    mSelectionNotifier = new cy(this, null);
                }
...
_L6:
    ...
    public void setOnItemClickListener(cv cv1)
    {
        mOnItemClickListener = cv1;
    }

    public void setOnItemLongClickListener(cw cw)
    {
        if (!isLongClickable())
        {
            setLongClickable(true);
        }
        mOnItemLongClickListener = cw;
    }

    public void setOnItemSelectedListener(cx cx1)
    {
        mOnItemSelectedListener = cx1;
    }
