...
public class ActionMenuPresenter extends aw
    implements android.support.v4.view.ActionProvider.SubUiVisibilityListener
{

    public final eo g = new eo(this, null);
    public int h;
    private View i;
    private boolean j;
    private boolean k;
...
_L3:
        ...
        if (!(view1 instanceof br))
        {
            continue; /* Loop/switch isn't completed */
        }
        view = view1;
        if (((br)view1).getItemData() == menuitem) goto _L6; else goto _L5
_L5:
        i1++;
          goto _L7
_L4:
    ...
    public static ei a(ActionMenuPresenter actionmenupresenter, ei ei1)
    {
        actionmenupresenter.w = ei1;
        return ei1;
    }

    public static ek a(ActionMenuPresenter actionmenupresenter, ek ek1)
    {
        actionmenupresenter.x = ek1;
        return ek1;
    }

    public static en a(ActionMenuPresenter actionmenupresenter)
    {
        return actionmenupresenter.v;
    }

    public static en a(ActionMenuPresenter actionmenupresenter, en en1)
    {
        actionmenupresenter.v = en1;
        return en1;
    }

    public static ek b(ActionMenuPresenter actionmenupresenter)
    {
    ...
    public static bq e(ActionMenuPresenter actionmenupresenter)
    {
    ...
    public static bq g(ActionMenuPresenter actionmenupresenter)
    {
        return actionmenupresenter.f;
    }

    public static ei h(ActionMenuPresenter actionmenupresenter)
    {
    ...
    public void a(Configuration configuration)
    {
        if (!o)
        {
            n = b.getResources().getInteger(x.abc_max_action_buttons);
        }
        if (c != null)
        {
            c.b(true);
    ...
    public void a(MenuItemImpl menuitemimpl, br br1)
    {
        br1.initialize(menuitemimpl, 0);
        menuitemimpl = (ActionMenuView)f;
        br1 = (ActionMenuItemView)br1;
        br1.setItemInvoker(menuitemimpl);
        if (y == null)
        {
            y = new ej(this, null);
        }
        br1.setPopupCallback(y);
    }
...
_L3:
    ...
    public boolean a(SubMenuBuilder submenubuilder)
    {
        ...
        w = new ei(this, b, submenubuilder);
        w.a(((View) (obj)));
        w.a();
...
label0:
    ...
    public boolean c()
    {
        ...
        {
            x = new ek(this, new en(this, b, c, i, true));
            ((View)f).post(x);
            super.a(null);
            return true;
        } else
