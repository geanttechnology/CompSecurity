    ...
    implements bc, bq
{
    ...
    private eu mOnMenuItemClickListener;
...
_L1:
        ...
        while (l2 < k4) 
        {
            ...
            if (((LayoutParams) (obj)).b < i)
            {
                j = ((LayoutParams) (obj)).b;
                l6 = 1 << l2;
                i = 1;
            } else
            if (((LayoutParams) (obj)).b == i)
...
_L6:
        if (j1 != 0)
        {
            ...
            while (i < k4) 
            {
                ...
                {
                    j = layoutparams.b;
                    ((View) (obj)).measure(android.view.View.MeasureSpec.makeMeasureSpec(layoutparams.c + j * j4, 0x40000000), l3);
                }
                i++;
            }
        }
...
_L7:
    ...
    public Menu getMenu()
    {
        if (mMenu == null)
        {
            ...
            {
                obj = new es(this, null);
            }
            actionmenupresenter.a(((bp) (obj)));
    ...
    protected boolean hasSupportDividerBeforeChildAt(int i)
    {
        ...
        if (i < getChildCount())
        {
            ...
            {
                flag = false | ((er)view).needsDividerAfter();
            }
        }
        if (i > 0 && (view1 instanceof er))
        {
            return ((er)view1).needsDividerBefore() | flag;
        } else
        {
            return flag;
        }
    ...
    {
        return mPresenter != null && mPresenter.d();
    }
    ...
    {
        return mPresenter != null && mPresenter.h();
    }

    public boolean isOverflowMenuShowing()
    {
        return mPresenter != null && mPresenter.g();
    }
...
_L3:
        ...
        while (j < i5) 
        {
            ...
            if (view3.getVisibility() != 8 && !layoutparams2.a)
            {
...
_L5:
    ...
    public void setOnMenuItemClickListener(eu eu)
    {
        mOnMenuItemClickListener = eu;
    }
...
label0:
    ...
    {
        return mPresenter != null && mPresenter.c();
    }
