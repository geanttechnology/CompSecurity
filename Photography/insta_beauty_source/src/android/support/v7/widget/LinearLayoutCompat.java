...
public class LinearLayoutCompat extends ViewGroup
{
    ...
    public LinearLayoutCompat(Context context, AttributeSet attributeset, int i)
    {
        ...
        mBaselineChildTop = 0;
        mGravity = 0x800033;
        context = dx.a(context, attributeset, ab.LinearLayoutCompat, i, 0);
        i = context.a(ab.LinearLayoutCompat_android_orientation, -1);
        if (i >= 0)
        {
            setOrientation(i);
        }
        i = context.a(ab.LinearLayoutCompat_android_gravity, -1);
        if (i >= 0)
        {
            setGravity(i);
        }
        boolean flag = context.a(ab.LinearLayoutCompat_android_baselineAligned, true);
        if (!flag)
        {
            setBaselineAligned(flag);
        }
        mWeightSum = context.a(ab.LinearLayoutCompat_android_weightSum, -1F);
        mBaselineAlignedChildIndex = context.a(ab.LinearLayoutCompat_android_baselineAlignedChildIndex, -1);
        mUseLargestChild = context.a(ab.LinearLayoutCompat_measureWithLargestChild, false);
        setDividerDrawable(context.a(ab.LinearLayoutCompat_divider));
        mShowDividers = context.a(ab.LinearLayoutCompat_showDividers, 0);
        mDividerPadding = context.d(ab.LinearLayoutCompat_dividerPadding, 0);
        context.b();
    }
    ...
    void measureHorizontal(int i, int j)
    {
        ...
        while (k2 < l5) 
        {
            ...
            } else
            {
                ...
                j5 = ed.a(l, ViewCompat.getMeasuredState(view1));
                if (flag1)
                {
                ...
                if (view1 != null)
                {
                    ...
                    } else
                    {
                        ...
                        if (f1 > 0.0F)
                        {
                            ...
                            k1 = ed.a(k1, ViewCompat.getMeasuredState(view1) & 0xff000000);
                            f -= f1;
                            j1 = j2;
                        }
                        if (flag)
...
_L6:
        ...
        k5 = Math.max(l, i5);
        j5 = ed.a(k, ViewCompat.getMeasuredState(view));
                ...
                while (i2 < l5) 
                {
                    ...
                    } else
                    {
                        ...
                        if (f1 > 0.0F)
                        {
                            ...
                            k = ed.a(k, ViewCompat.getMeasuredState(view) & 0xffffff00);
                            l1 = k1 - k2;
                            k1 = k;
                            f -= f1;
                            k = l1;
