...
public class ListPopupWindow
{
    ...
    {
        this(context, attributeset, r.listPopupWindowStyle);
    }
    ...
    public ListPopupWindow(Context context, AttributeSet attributeset, int i1, int j1)
    {
        ...
        B = new Rect();
        c = context;
        TypedArray typedarray = context.obtainStyledAttributes(attributeset, ab.ListPopupWindow, i1, j1);
        i = typedarray.getDimensionPixelOffset(ab.ListPopupWindow_android_dropDownHorizontalOffset, 0);
        j = typedarray.getDimensionPixelOffset(ab.ListPopupWindow_android_dropDownVerticalOffset, 0);
        if (j != 0)
        {
            k = true;
        }
    ...
    public static ey a(ListPopupWindow listpopupwindow)
    {
    ...
    public static fg c(ListPopupWindow listpopupwindow)
    {
...
_L1:
        ...
        f.setOnItemSelectedListener(new ex(this));
