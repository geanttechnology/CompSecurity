    ...
    implements eg
{
    ...
    public static final ft HIDDEN_METHOD_INVOKER = new ft();
    ...
    private fv mOnQueryChangeListener;
    ...
    private fw mOnSuggestionListener;
    ...
    {
        this(context, attributeset, r.searchViewStyle);
    }

    public SearchView(Context context, AttributeSet attributeset, int i)
    {
        super(context, attributeset, i);
        mShowImeRunnable = new fh(this);
        mUpdateDrawableStateRunnable = new fl(this);
        mReleaseCursorRunnable = new fm(this);
        mOutsideDrawablesCache = new WeakHashMap();
        mOnClickListener = new fq(this);
        mTextKeyListener = new fr(this);
        mOnEditorActionListener = new fs(this);
        mOnItemClickListener = new fi(this);
        mOnItemSelectedListener = new fj(this);
        mTextWatcher = new fk(this);
        attributeset = dx.a(context, attributeset, ab.SearchView, i, 0);
        mTintManager = attributeset.c();
        ((LayoutInflater)context.getSystemService("layout_inflater")).inflate(attributeset.f(ab.SearchView_layout, 0), this, true);
        mQueryTextView = (SearchAutoComplete)findViewById(w.search_src_text);
        mQueryTextView.setSearchView(this);
        mSearchEditFrame = findViewById(w.search_edit_frame);
        mSearchPlate = findViewById(w.search_plate);
        mSubmitArea = findViewById(w.submit_area);
        mSearchButton = (ImageView)findViewById(w.search_button);
        mSubmitButton = (ImageView)findViewById(w.search_go_btn);
        mCloseButton = (ImageView)findViewById(w.search_close_btn);
        mVoiceButton = (ImageView)findViewById(w.search_voice_btn);
        mSearchHintIcon = (ImageView)findViewById(w.search_mag_icon);
        mSearchPlate.setBackgroundDrawable(attributeset.a(ab.SearchView_queryBackground));
        mSubmitArea.setBackgroundDrawable(attributeset.a(ab.SearchView_submitBackground));
        mSearchIconResId = attributeset.f(ab.SearchView_searchIcon, 0);
        mSearchButton.setImageResource(mSearchIconResId);
        mSubmitButton.setImageDrawable(attributeset.a(ab.SearchView_goIcon));
        mCloseButton.setImageDrawable(attributeset.a(ab.SearchView_closeIcon));
        mVoiceButton.setImageDrawable(attributeset.a(ab.SearchView_voiceIcon));
        mSearchHintIcon.setImageDrawable(attributeset.a(ab.SearchView_searchIcon));
        mSuggestionRowLayout = attributeset.f(ab.SearchView_suggestionRowLayout, 0);
        mSuggestionCommitIconResId = attributeset.f(ab.SearchView_commitIcon, 0);
        ...
        mQueryTextView.setOnFocusChangeListener(new fn(this));
        setIconifiedByDefault(attributeset.a(ab.SearchView_iconifiedByDefault, true));
        i = attributeset.d(ab.SearchView_android_maxWidth, -1);
        if (i != -1)
        {
            setMaxWidth(i);
        }
        context = attributeset.b(ab.SearchView_queryHint);
        if (!TextUtils.isEmpty(context))
        {
            setQueryHint(context);
        }
        i = attributeset.a(ab.SearchView_android_imeOptions, -1);
        if (i != -1)
        {
            setImeOptions(i);
        }
        i = attributeset.a(ab.SearchView_android_inputType, -1);
        if (i != -1)
        {
            setInputType(i);
        }
        setFocusable(attributeset.a(ab.SearchView_android_focusable, true));
        attributeset.b();
    ...
    {
        mDropDownAnchor.getViewTreeObserver().addOnGlobalLayoutListener(new fp(this));
    }

    private void addOnLayoutChangeListenerToDropDownAnchorSDK11()
    {
        mDropDownAnchor.addOnLayoutChangeListener(new fo(this));
    }
    ...
    private void adjustDropDownSizeAndPosition()
    {
        if (mDropDownAnchor.getWidth() > 1)
        {
            ...
            {
                i = resources.getDimensionPixelSize(u.abc_dropdownitem_icon_width);
                i = resources.getDimensionPixelSize(u.abc_dropdownitem_text_padding_left) + i;
            } else
            {
                i = 0;
            }
    ...
    private Intent createIntentFromSuggestion(Cursor cursor, int i, String s)
    {
        ...
        try
        {
            obj1 = fy.a(cursor, "suggest_intent_action");
        }
...
_L1:
        ...
        if (android.os.Build.VERSION.SDK_INT >= 8)
        {
          ...
          goto _L2
_L7:
        obj2 = fy.a(cursor, "suggest_intent_data");
        obj = obj2;
        if (!IS_AT_LEAST_FROYO)
        {
...
_L3:
        s1 = fy.a(cursor, "suggest_intent_data_id");
        obj2 = obj;
...
_L5:
        obj2 = (new StringBuilder()).append(((String) (obj))).append("/").append(Uri.encode(s1)).toString();
          goto _L4
_L6:
        obj2 = fy.a(cursor, "suggest_intent_query");
        return createIntent(((String) (obj1)), ((Uri) (obj)), fy.a(cursor, "suggest_intent_extra_data"), ((String) (obj2)), i, s);
_L9:
...
_L8:
    ...
    {
        return getContext().getResources().getDimensionPixelSize(u.abc_search_view_preferred_width);
    }
...
_L6:
    ...
    {
        android.text.Editable editable = mQueryTextView.getText();
...
_L3:
    ...
    private void updateSearchAutoComplete()
    {
        ...
        if (mSearchable.getSuggestAuthority() != null)
        {
            mSuggestionsAdapter = new fy(getContext(), this, mSearchable, mOutsideDrawablesCache);
            mQueryTextView.setAdapter(mSuggestionsAdapter);
            fy fy1 = (fy)mSuggestionsAdapter;
            byte byte0 = flag;
            if (mQueryRefinement)
            {
                byte0 = 2;
...
_L5:
    ...
    public void setOnCloseListener(fu fu1)
    {
        mOnCloseListener = fu1;
    }
    ...
    public void setOnQueryTextListener(fv fv1)
    {
        mOnQueryChangeListener = fv1;
    }
    ...
    public void setOnSuggestionListener(fw fw1)
    {
        mOnSuggestionListener = fw1;
    }
    ...
    public void setQueryRefinementEnabled(boolean flag)
    {
        ...
        if (mSuggestionsAdapter instanceof fy)
        {
            fy fy1 = (fy)mSuggestionsAdapter;
            byte byte0;
            if (flag)
    ...
    private class SearchAutoComplete extends AutoCompleteTextView
    {
        ...
        public SearchAutoComplete(Context context, AttributeSet attributeset, int i)
        {
            ...
            context = dx.a(context, attributeset, POPUP_WINDOW_ATTRS, i, 0);
            if (context.d(0))
            {
