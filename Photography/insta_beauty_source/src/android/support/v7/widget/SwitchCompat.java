...
public class SwitchCompat extends CompoundButton
{
    ...
    {
        this(context, attributeset, r.switchStyle);
    }
    ...
    public SwitchCompat(Context context, AttributeSet attributeset, int i)
    {
        ...
        attributeset = dx.a(context, attributeset, ab.SwitchCompat, i, 0);
        mThumbDrawable = attributeset.a(ab.SwitchCompat_android_thumb);
        mTrackDrawable = attributeset.a(ab.SwitchCompat_track);
        mTextOn = attributeset.b(ab.SwitchCompat_android_textOn);
        mTextOff = attributeset.b(ab.SwitchCompat_android_textOff);
        mShowText = attributeset.a(ab.SwitchCompat_showText, true);
        mThumbTextPadding = attributeset.d(ab.SwitchCompat_thumbTextPadding, 0);
        mSwitchMinWidth = attributeset.d(ab.SwitchCompat_switchMinWidth, 0);
        mSwitchPadding = attributeset.d(ab.SwitchCompat_switchPadding, 0);
        mSplitTrack = attributeset.a(ab.SwitchCompat_splitTrack, false);
        i = attributeset.f(ab.SwitchCompat_switchTextAppearance, 0);
        if (i != 0)
        {
    ...
    private void animateThumbToCheckedState(boolean flag)
    {
        ...
        mPositionAnimator = new ga(this, f1, f - f1);
...
_L3:
        if (!ed.a(this)) goto _L6; else goto _L5
_L5:
        if (f >= 0.0F)
        {
            flag1 = false;
...
_L5:
    ...
    public void setSwitchTextAppearance(Context context, int i)
    {
        ...
        {
            mSwitchTransformationMethod = new aj(getContext());
        } else
        {
    ...
    static 
    {
        TEXT_APPEARANCE_ATTRS = (new int[] {
            0x1010098, 0x1010095, r.textAllCaps
        });
    }
