...
public class Toolbar extends ViewGroup
{
    ...
    private bp mActionMenuPresenterCallback;
    private int mButtonGravity;
    private ImageButton mCollapseButtonView;
    private CharSequence mCollapseDescription;
    private Drawable mCollapseIcon;
    private boolean mCollapsible;
    private final dg mContentInsets;
    private boolean mEatingTouch;
    public View mExpandedActionView;
    private ge mExpandedMenuPresenter;
    private int mGravity;
    private ImageView mLogoView;
    private int mMaxButtonHeight;
    private bb mMenuBuilderCallback;
    private ActionMenuView mMenuView;
    private final eu mMenuViewItemClickListener;
    private int mMinHeight;
    private ImageButton mNavButtonView;
    private gf mOnMenuItemClickListener;
    ...
    public Toolbar(Context context, AttributeSet attributeset, int i)
    {
        ...
        mContentInsets = new dg();
        mGravity = 0x800013;
        mTempViews = new ArrayList();
        mTempMargins = new int[2];
        mMenuViewItemClickListener = new gb(this);
        mShowOverflowMenuRunnable = new gc(this);
        context = dx.a(getContext(), attributeset, ab.Toolbar, i, 0);
        mTitleTextAppearance = context.f(ab.Toolbar_titleTextAppearance, 0);
        mSubtitleTextAppearance = context.f(ab.Toolbar_subtitleTextAppearance, 0);
        mGravity = context.b(ab.Toolbar_android_gravity, mGravity);
        mButtonGravity = 48;
        i = context.c(ab.Toolbar_titleMargins, 0);
        mTitleMarginBottom = i;
        mTitleMarginTop = i;
        mTitleMarginEnd = i;
        mTitleMarginStart = i;
        i = context.c(ab.Toolbar_titleMarginStart, -1);
        if (i >= 0)
        {
            mTitleMarginStart = i;
        }
        i = context.c(ab.Toolbar_titleMarginEnd, -1);
        if (i >= 0)
        {
            mTitleMarginEnd = i;
        }
        i = context.c(ab.Toolbar_titleMarginTop, -1);
        if (i >= 0)
        {
            mTitleMarginTop = i;
        }
        i = context.c(ab.Toolbar_titleMarginBottom, -1);
        if (i >= 0)
        {
            mTitleMarginBottom = i;
        }
        mMaxButtonHeight = context.d(ab.Toolbar_maxButtonHeight, -1);
        i = context.c(ab.Toolbar_contentInsetStart, 0x80000000);
        int j = context.c(ab.Toolbar_contentInsetEnd, 0x80000000);
        int k = context.d(ab.Toolbar_contentInsetLeft, 0);
        int l = context.d(ab.Toolbar_contentInsetRight, 0);
        mContentInsets.b(k, l);
        if (i != 0x80000000 || j != 0x80000000)
        {
            mContentInsets.a(i, j);
        }
        mCollapseIcon = context.a(ab.Toolbar_collapseIcon);
        mCollapseDescription = context.b(ab.Toolbar_collapseContentDescription);
        attributeset = context.b(ab.Toolbar_title);
        if (!TextUtils.isEmpty(attributeset))
        {
            setTitle(attributeset);
        }
        attributeset = context.b(ab.Toolbar_subtitle);
        if (!TextUtils.isEmpty(attributeset))
        {
            setSubtitle(attributeset);
        }
        mPopupContext = getContext();
        setPopupTheme(context.f(ab.Toolbar_popupTheme, 0));
        attributeset = context.a(ab.Toolbar_navigationIcon);
        if (attributeset != null)
        {
            setNavigationIcon(attributeset);
        }
        attributeset = context.b(ab.Toolbar_navigationContentDescription);
        if (!TextUtils.isEmpty(attributeset))
        {
            setNavigationContentDescription(attributeset);
        }
        mMinHeight = context.d(ab.Toolbar_android_minHeight, 0);
        context.b();
    ...
    private void ensureCollapseButtonView()
    {
        ...
        {
            mCollapseButtonView = new ImageButton(getContext(), null, r.toolbarNavigationButtonStyle);
            ...
            mCollapseButtonView.setOnClickListener(new gd(this));
        }
    }
    ...
    private void ensureMenu()
    {
        ...
        if (mMenuView.peekMenu() == null)
        {
            ...
            {
                mExpandedMenuPresenter = new ge(this, null);
            }
    ...
    private void ensureNavButtonView()
    {
        ...
        {
            mNavButtonView = new ImageButton(getContext(), null, r.toolbarNavigationButtonStyle);
            LayoutParams layoutparams = generateDefaultLayoutParams();
            layoutparams.a = 0x800003 | mButtonGravity & 0x70;
...
_L3:
    ...
    {
        TypedArray typedarray = context.obtainStyledAttributes(attributeset, ab.Toolbar, i, 0);
        i = typedarray.getResourceId(ab.Toolbar_theme, 0);
    ...
    public da getWrapper()
    {
        if (mWrapper == null)
        {
            mWrapper = new dy(this, true);
        }
        return mWrapper;
    }
...
_L11:
    ...
    protected void onMeasure(int i, int j)
    {
        ...
        if (shouldLayout(mNavButtonView))
        {
            ...
            i1 = ed.a(0, ViewCompat.getMeasuredState(mNavButtonView));
        }
        i2 = k;
        k = i1;
        l = j1;
        if (shouldLayout(mCollapseButtonView))
        {
            ...
            k = ed.a(i1, ViewCompat.getMeasuredState(mCollapseButtonView));
        }
        ...
        if (shouldLayout(mMenuView))
        {
            ...
            i1 = ed.a(k, ViewCompat.getMeasuredState(mMenuView));
        }
        ...
        if (shouldLayout(mExpandedActionView))
        {
            ...
            k = ed.a(i1, ViewCompat.getMeasuredState(mExpandedActionView));
        }
        i1 = l1;
        j1 = k;
        k1 = l;
        if (shouldLayout(mLogoView))
        {
            ...
            j1 = ed.a(k, ViewCompat.getMeasuredState(mLogoView));
        }
        i2 = getChildCount();
        l1 = 0;
        l = k1;
        ...
        while (j1 < i2) 
        {
            ...
            if (((LayoutParams)view.getLayoutParams()).b == 0 && shouldLayout(view))
            {
                ...
                k = ed.a(k, ViewCompat.getMeasuredState(view));
            }
            j1++;
        }
        k1 = 0;
        ...
        if (shouldLayout(mTitleTextView))
        {
            ...
            i1 = ed.a(k, ViewCompat.getMeasuredState(mTitleTextView));
        }
        j2 = j1;
        i2 = k1;
        k = i1;
        if (shouldLayout(mSubtitleTextView))
        {
            ...
            k = ed.a(i1, ViewCompat.getMeasuredState(mSubtitleTextView));
        }
        l = Math.max(l, j2);
        k1 = getPaddingLeft();
        j2 = getPaddingRight();
...
_L3:
    ...
    public void setMenuCallbacks(bp bp, bb bb)
    {
        mActionMenuPresenterCallback = bp;
        mMenuBuilderCallback = bb;
    }
...
_L3:
    ...
    public void setOnMenuItemClickListener(gf gf)
    {
        mOnMenuItemClickListener = gf;
    }
