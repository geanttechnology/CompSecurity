...
_L1:
    ...
    static String a(aoc aoc1)
    {
        return aoc1.i;
    }

    private void a(aob aob1)
    {
label0:
        {
            if (aob1.b != null && !aob1.b.isEmpty())
            {
                String s = (new StringBuilder()).append(g).append(File.separator).append(aob1.b.substring(aob1.b.lastIndexOf("/") + 1)).toString();
        ...
        String s1 = (new StringBuilder()).append(h).append(File.separator).append(aob1.b.substring(aob1.b.lastIndexOf("/") + 1)).toString();
        (new AsyncHttpClient()).get(aob1.b, new aoe(this, s1));
    }

    static void a(aoc aoc1, byte abyte0[], String s)
    {
        aoc1.a(abyte0, s);
    }
    ...
    {
        if (s.equalsIgnoreCase(ie.m))
        {
            return aaq.fullscreen_default_locker;
        }
        if (s.equalsIgnoreCase(ie.e))
        {
            return aaq.fullscreen_default_pip;
        }
        if (s.equalsIgnoreCase(ie.b))
        {
            return aaq.fullscreen_default_wantu;
        } else
        {
            return aaq.fullscreen_default_locker;
        }
...
_L6:
        ...
        {
            aob1.a = jsonobject.getInt("id");
        }
        if (jsonobject.has("imageurl"))
        {
            aob1.b = jsonobject.getString("imageurl");
        }
...
_L10:
        ...
        {
            aob1.c = jsonobject.getString("url");
        }
        if (l1 >= l3 || l2 <= l3)
        {
        ...
        {
            aob1.f = jsonobject.getInt("maxTimes");
        }
        if (jsonobject.has("interval"))
        {
            aob1.h = jsonobject.getLong("interval");
        }
        if (jsonobject.has("adSchemUrl"))
        {
            aob1.i = jsonobject.getString("adSchemUrl");
        }
        aob1.j = null;
        ...
        aob1.j = new Rect(j1, k1, jsonobject1.getInt("w") + j1, jsonobject1.getInt("h") + k1);
        if (jsonobject.has("analysizeUrl"))
        {
            aob1.k = jsonobject.getString("analysizeUrl");
        }
        a(aob1);
        i1++;
          goto _L9
...
_L8:
    ...
    public aob b(Context context)
    {
        context = c(context);
        aob aob1 = new aob();
        aob1.a = 998;
        aob1.c = context;
        aob1.g = b(((String) (context)));
        aob1.j = new Rect(0, 0, 320, 480);
        aob1.h = 3000L;
        return aob1;
    }
    ...
    public boolean g()
    {
        if (if.k(a) * 2 >= if.j(a) * 3) goto _L2; else goto _L1
_L1:
        boolean flag2 = false;
_L4:
        return flag2;
...
_L9:
        ...
        flag1 = flag;
        aob1.a = ((JSONObject) (obj1)).getInt("id");
        flag1 = flag;
        flag2 = flag;
        ...
        flag1 = flag;
        aob1.b = ((JSONObject) (obj1)).getString("imageurl");
        flag1 = flag;
        ...
        flag1 = flag;
        aob1.c = ((JSONObject) (obj1)).getString("url");
        flag1 = flag;
        ...
        flag1 = flag;
        aob1.h = ((JSONObject) (obj1)).getLong("interval");
        flag1 = flag;
        ...
        flag1 = flag;
        aob1.i = ((JSONObject) (obj1)).getString("adSchemUrl");
        if (aob1.i == null || aob1.i.length() <= 0)
        {
            break MISSING_BLOCK_LABEL_546;
        }
        flag1 = yp.a(a, aob1.i);
        ...
        flag1 = flag;
        aob1.j = new Rect(j1, k1, jsonobject.getInt("w") + j1, jsonobject.getInt("h") + k1);
        flag1 = flag;
        ...
        flag1 = flag;
        aob1.k = ((JSONObject) (obj1)).getString("analysizeUrl");
        flag2 = flag;
        if (l1 >= l3)
        {
            break MISSING_BLOCK_LABEL_841;
