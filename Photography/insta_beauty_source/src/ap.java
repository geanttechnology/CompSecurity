...
public class ap extends MenuInflater
{
...
_L9:
        if (i == 0)
        {
            ...
            if (s.equals("menu"))
            {
                a(xmlpullparser, attributeset, ((Menu) (ar1.c())));
            } else
            {
                menu = s;
                i = 1;
...
_L8:
        ...
        if (s1.equals("item"))
        {
            if (!ar1.d())
            {
                if (ar.a(ar1) != null && ar.a(ar1).hasSubMenu())
                {
                    ar1.c();
                } else
                {
...
_L6:
    ...
    static Object c(ap ap1)
    {
        return ap1.c();
    }

    static Object[] d(ap ap1)
    {
        return ap1.c;
    }
