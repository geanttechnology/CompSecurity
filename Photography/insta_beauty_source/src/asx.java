...
public class asx extends asp
{
    ...
    public Bitmap a(Context context, int l, int i1)
    {
        ...
        options.inSampleSize = yo.a(options, l, l);
        b(context);
        a(context);
        j1 = a();
...
_L1:
        ...
        if (obj != null && ((Cursor) (obj)).getCount() > 0)
        {
            ...
            if (aaj.g())
            {
                if (yp.l(context) > yp.a);
            }
            obj = yo.a(s, l, i1, true);
        } else
        {
            obj = null;
        }
        ...
        } else
        {
            ...
            if (cursor != null)
            {
                ...
                if (cursor.getCount() > 0)
                {
                    ...
                    cursor.close();
                    return yo.a(context, 90, 90, true);
                }
            }
        }
        return context;
