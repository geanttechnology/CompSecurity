...
public class blt extends bll
{
    ...
    public void b(int i1, int j1)
    {
        ...
        h = (bmn)ImageFilterFactory.a(b, com.wantu.piprender.renderengine.filters.ImageFilterFactory.TYPE.EXBLEND, hashmap);
        h.a(c.a, c.b);
        h.a(d);
    }

    public void b(bmx bmx1)
    {
        f = bmx1;
        if (f != null)
        {
