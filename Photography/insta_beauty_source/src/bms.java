...
public class bms extends BaseImageFilter
{
    ...
    {
        a = GLES20.glGetUniformLocation(i, "NoiseTex");
        b = GLES20.glGetUniformLocation(i, "PixelX");
        c = GLES20.glGetUniformLocation(i, "PixelY");
        o = GLES20.glGetUniformLocation(i, "Freq");
    }
    ...
    public void a(Context context, HashMap hashmap)
    {
        ...
        do
        {
            ...
            if (s1.equalsIgnoreCase("noiseImageAssetPath"))
            {
                p = (String)hashmap.get(s1);
            } else
            if (s1.equalsIgnoreCase("pixelX"))
            {
                r = ((Float)hashmap.get(s1)).floatValue();
            } else
            if (s1.equalsIgnoreCase("pixelY"))
            {
                s = ((Float)hashmap.get(s1)).floatValue();
            } else
            if (s1.equalsIgnoreCase("freq"))
            {
                t = ((Float)hashmap.get(s1)).floatValue();
            }
        } while (true);
        q = blj.a(context, p, false);
    }
