...
public class bnq extends BaseImageFilter
{
    ...
    public void a(Context context, HashMap hashmap)
    {
        ...
        b = (bmk)ImageFilterFactory.a(context, com.wantu.piprender.renderengine.filters.ImageFilterFactory.TYPE.DESATURATION, hashmap);
        c = (bna)ImageFilterFactory.a(context, com.wantu.piprender.renderengine.filters.ImageFilterFactory.TYPE.INVERT, hashmap);
        hashmap = new HashMap();
        hashmap.put("kSize", Integer.valueOf(2));
        o = (bmm)ImageFilterFactory.a(context, com.wantu.piprender.renderengine.filters.ImageFilterFactory.TYPE.ERODE, hashmap);
        hashmap = new HashMap();
        hashmap.put("blendMode", Integer.valueOf(BlendMode.COLORDODGE.ordinal()));
