    ...
    implements Closeable
{
    ...
    private static final Logger b = Logger.getLogger(buf.getName());
    int a;
    ...
    private buh a(int i)
    {
        ...
        {
            c.seek(i);
            return new buh(i, c.readInt());
        }
    }

    static RandomAccessFile a(buf buf1)
    {
        return buf1.c;
    }
    ...
    static void a(buf buf1, int i, byte abyte0[], int j, int k)
    {
        buf1.b(i, abyte0, j, k);
    }
...
_L2:
        ...
        buh buh1 = a(j);
        buj1.read(new bui(this, buh1, null), buh1.c);
        j = buh1.b;
        j = b(buh1.c + (j + 4));
        i++;
