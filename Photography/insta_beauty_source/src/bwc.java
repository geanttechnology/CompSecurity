...
final class bwc
{
    ...
    public static X509Certificate[] a(X509Certificate ax509certificate[], bwp bwp1)
    {
        boolean flag2 = true;
        ...
        ax509certificate = bwp1.b(ax509certificate[i - 1]);
