    ...
    implements bxa
{
    ...
    public JSONObject a()
    {
        ...
        obj2 = null;
        obj1 = null;
        bso.h().a("Fabric", "Reading cached settings...");
        Object obj = new File((new bwr(a)).a(), "com.crashlytics.settings.json");
...
_L2:
        bso.h().a("Fabric", "No cached settings found.");
        obj = null;
...
_L8:
        obj1 = obj;
        bso.h().e("Fabric", "Failed to fetch cached settings", ((Throwable) (obj2)));
...
_L7:
    ...
    {
        Object obj;
        bso.h().a("Fabric", "Writing settings to cache file...");
        if (jsonobject == null)
        {
        ...
        filewriter = new FileWriter(new File((new bwr(a)).a(), "com.crashlytics.settings.json"));
        obj = filewriter;
...
_L4:
        obj = jsonobject;
        bso.h().e("Fabric", "Failed to cache settings", exception);
