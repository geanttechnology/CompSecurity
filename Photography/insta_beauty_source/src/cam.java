...
public class cam extends byh
{
    ...
    static int a(cam cam1)
    {
        return cam1.f;
    }

    static int a(cam cam1, int i)
    {
        cam1.f = i;
        return i;
    }
    ...
    public void a(int i, FloatBuffer floatbuffer, FloatBuffer floatbuffer1)
    {
        ...
        GLES20.glUniform4fv(g.b("colorFill_exclusion"), 1, b);
        w.a(33988);
