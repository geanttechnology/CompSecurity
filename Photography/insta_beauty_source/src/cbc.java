...
public class cbc extends byh
{
    ...
    static int a(cbc cbc1)
    {
        return cbc1.f;
    }

    static int a(cbc cbc1, int i)
    {
        cbc1.f = i;
        return i;
    }
    ...
    public void a(int i, FloatBuffer floatbuffer, FloatBuffer floatbuffer1)
    {
        ...
        GLES20.glUniform4fv(g.b("colorFill_multiply"), 1, a);
        GLES20.glUniform3fv(g.b("bceShift"), 1, b);
        w.a(33988);
