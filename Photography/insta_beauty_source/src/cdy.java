...
public class cdy
{
    ...
    public cdy(EGLContext eglcontext, boolean flag, boolean flag1)
    {
        a = null;
    ...
    static EGLSurface a(cdy cdy1, Object obj)
    {
        return cdy1.b(obj);
    }
    ...
    static boolean a(cdy cdy1, EGLSurface eglsurface)
    {
        return cdy1.a(eglsurface);
    }
    ...
    static int b(cdy cdy1, EGLSurface eglsurface)
    {
        return cdy1.b(eglsurface);
    }
    ...
    static void c(cdy cdy1, EGLSurface eglsurface)
    {
        cdy1.c(eglsurface);
    }
    ...
    public cdz a(Object obj)
    {
        obj = new cdz(this, obj);
        ((cdz) (obj)).a();
        return ((cdz) (obj));
    }
