...
public class cee extends ced
{
    ...
    public cee(Context context, bzk bzk)
    {
        super(bzk);
        P = 1.0F;
        Q = 0.7F;
        ...
        N.put(x).position(0);
        O = ByteBuffer.allocateDirect(byq.d.length * 4).order(ByteOrder.nativeOrder()).asFloatBuffer();
        O.put(byq.d).position(0);
        W = null;
        V = null;
    ...
    public void onSurfaceCreated(GL10 gl10, EGLConfig eglconfig)
    {
        ...
        if (T == null)
        {
            T = (cco)GPUImageBeautyFilterFactory.a(M, jp.co.cyberagent.android.gpuimage.grafika.GPUImageBeautyFilterFactory.BEAUTYCAM_FILTER_TYPE.BEAUTYCAM_FILTER_SOFTEN);
            T.e();
            T.b(Q);
            T.b(R);
            T.c(true);
