...
public class cef extends ced
{
    ...
    public cef(Context context, bzk bzk)
    {
        super(bzk);
        H = 1.0F;
        I = null;
        ...
        Q.put(x).position(0);
        R = ByteBuffer.allocateDirect(byq.d.length * 4).order(ByteOrder.nativeOrder()).asFloatBuffer();
        R.put(byq.d).position(0);
    }
    ...
    public void onSurfaceCreated(GL10 gl10, EGLConfig eglconfig)
    {
        ...
        {
            S = new cci(H);
            S.a(bxv.a(G, "pipFrame/bottle.png"), new Rect(0, 0, 612, 612), bxv.a(G, "pipFrame/bottle_mask.png"), new Rect(59, 30, 335, 612));
            S.e();
        }
        if (T == null)
        {
            T = (cco)GPUImageBeautyFilterFactory.a(G, jp.co.cyberagent.android.gpuimage.grafika.GPUImageBeautyFilterFactory.BEAUTYCAM_FILTER_TYPE.BEAUTYCAM_FILTER_SOFTEN);
            T.e();
            T.b(0.0F);
            T.c(true);
            T.a(g());
