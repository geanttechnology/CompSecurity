...
public class cg extends DataSetObservable
{

    private static final String a = cg.getSimpleName();
    ...
    private cg(Context context, String s)
    {
        j = new ck(this, null);
        k = 50;
        l = true;
    ...
    public static cg a(Context context, String s)
    {
        Object obj = b;
        obj;
    ...
    private void e()
    {
        ...
        if (n)
        {
            ...
            {
                AsyncTaskCompat.executeParallel(new cn(this, null), new Object[] {
                    f, h
                });
                return;
            }
...
_L9:
        ...
        list.add(new cl(((XmlPullParser) (obj1)).getAttributeValue(null, "activity"), Long.parseLong(((XmlPullParser) (obj1)).getAttributeValue(null, "time")), Float.parseFloat(((XmlPullParser) (obj1)).getAttributeValue(null, "weight"))));
          goto _L8
        exception;
...
_L2:
        ...
        if (((ci)list.get(i1)).a != resolveinfo)
        {
...
label0:
        ...
        f();
        obj1 = (ci)e.get(i1);
        obj1 = new ComponentName(((ci) (obj1)).a.activityInfo.packageName, ((ci) (obj1)).a.activityInfo.name);
        intent = new Intent(i);
        ...
        JVM INSTR monitorexit ;
        return null;
        a(new cl(((ComponentName) (obj1)), System.currentTimeMillis(), 1.0F));
        obj;
        JVM INSTR monitorexit ;
        return intent;
        exception;
    ...
    public void c(int i1)
    {
        ...
        float f1 = (ci2.b - ci1.b) + 5F;
_L1:
        a(new cl(new ComponentName(ci1.a.activityInfo.packageName, ci1.a.activityInfo.name), System.currentTimeMillis(), f1));
        obj;
        JVM INSTR monitorexit ;
        return;
        Exception exception;
