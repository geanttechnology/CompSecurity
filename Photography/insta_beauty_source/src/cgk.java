...
public class cgk extends android.view.ScaleGestureDetector.SimpleOnScaleGestureListener
{

    final RotateZoomMoveImageViewTouch a;

    private cgk(RotateZoomMoveImageViewTouch rotatezoommoveimageviewtouch)
    {
        a = rotatezoommoveimageviewtouch;
        super();
    }

    public cgk(RotateZoomMoveImageViewTouch rotatezoommoveimageviewtouch, cgi cgi)
    {
