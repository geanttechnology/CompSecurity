...
public final class cl
{
    ...
    public cl(ComponentName componentname, long l, float f)
    {
        a = componentname;
        b = l;
        c = f;
    ...
    public cl(String s, long l, float f)
    {
    ...
    public boolean equals(Object obj)
    {
        if (this != obj)
        {
            ...
            if (Float.floatToIntBits(c) != Float.floatToIntBits(((cl) (obj)).c))
            {
                return false;
            }
        }
