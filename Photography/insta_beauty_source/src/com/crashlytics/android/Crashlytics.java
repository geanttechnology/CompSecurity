...
public class Crashlytics extends bsy
    implements bsz
{
    ...
    Crashlytics(Answers answers1, Beta beta1, CrashlyticsCore crashlyticscore)
    {
        ...
        kits = Collections.unmodifiableCollection(Arrays.asList(new bsy[] {
    ...
    {
        return (Crashlytics)bso.a(com/crashlytics/android/Crashlytics);
    }
    ...
    {
        bso.h().d("Crashlytics", "Use of Crashlytics.setPinningInfoProvider is deprecated");
    }
    ...
    {
        bso.h().d("Crashlytics", "Use of Crashlytics.getDebugMode is deprecated.");
        getFabric();
        return bso.i();
    }
    ...
    {
        bso.h().d("Crashlytics", "Use of Crashlytics.setDebugMode is deprecated.");
    }
