    ...
    implements btg
{
    ...
    public String load(Context context)
    {
        ...
        if (context != null)
        {
            ...
            {
                bso.h().e("Beta", "Failed to close the APK file", context);
                obj = obj1;
...
_L2:
        ...
        bso.h().a("Beta", (new StringBuilder()).append("Beta device token load took ").append(d).append("ms").toString());
        return ((String) (obj));
        context;
        obj = obj1;
        bso.h().e("Beta", "Failed to find this app in the PackageManager", context);
        obj = s;
        if (obj1 == null)
        {
            continue; /* Loop/switch isn't completed */
        ...
        context;
        obj = context1;
        bso.h().e("Beta", "Failed to find the APK file", context);
        obj = s;
        if (context1 == null)
        {
            continue; /* Loop/switch isn't completed */
        ...
        context;
        obj = context2;
        bso.h().e("Beta", "Failed to read the APK file", context);
        obj = s;
        if (context2 == null)
        {
            continue; /* Loop/switch isn't completed */
...
_L1:
        ...
        if (obj != null)
        {
            ...
            {
                bso.h().e("Beta", "Failed to close the APK file", ioexception);
            }
        }
        throw context;
    }
