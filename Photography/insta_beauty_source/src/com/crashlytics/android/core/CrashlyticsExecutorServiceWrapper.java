...
class CrashlyticsExecutorServiceWrapper
{
    ...
    Future executeAsync(final Runnable runnable)
    {
        ...
        {
            bso.h().a("CrashlyticsCore", "Executor is shut down because we're handling a fatal crash.");
            return null;
        }
        return runnable;
    }
    ...
    Object executeSyncLoggingException(Callable callable)
    {
        ...
        {
            bso.h().e("CrashlyticsCore", "Failed to execute task.", callable);
            return null;
        }
        return callable;
    }
        ...
        implements Runnable
    {
        ...
        public void run()
        {
            ...
            {
                bso.h().e("CrashlyticsCore", "Failed to execute task.", exception);
            }
        }
