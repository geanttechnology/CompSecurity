...
final class ExceptionUtils
{
    ...
    public static void writeStackTrace(Context context, Throwable throwable, String s)
    {
        ...
        CommonUtils.a(s, "Failed to close stack trace writer.");
        return;
        Exception exception;
        exception;
        throwable = null;
_L4:
        context = throwable;
        bso.h().e("CrashlyticsCore", "Failed to create PrintWriter", exception);
        CommonUtils.a(throwable, "Failed to close stack trace writer.");
        return;
        throwable;
        context = null;
_L2:
        CommonUtils.a(context, "Failed to close stack trace writer.");
        throw throwable;
        throwable;
...
_L1:
        ...
        if (true) goto _L4; else goto _L3
        throwable;
        bso.h().e("CrashlyticsCore", "Could not write stack trace", throwable);
_L3:
        return;
        if (i != 0)
        {
