...
class MetaDataStore
{
    ...
    public Map readKeyData(String s)
    {
        ...
        s = fileinputstream;
        Map map = jsonToKeysData(CommonUtils.a(fileinputstream));
...
_L4:
        s = fileinputstream;
        bso.h().e("CrashlyticsCore", "Error deserializing user metadata.", exception1);
        CommonUtils.a(fileinputstream, "Failed to close user metadata file.");
        return Collections.emptyMap();
        Exception exception;
        exception;
...
_L3:
    ...
    public UserMetaData readUserData(String s)
    {
        ...
        FileInputStream fileinputstream = new FileInputStream(s);
        s = fileinputstream;
        UserMetaData usermetadata = jsonToUserData(CommonUtils.a(fileinputstream));
        CommonUtils.a(fileinputstream, "Failed to close user metadata file.");
        return usermetadata;
        Exception exception1;
        exception1;
...
_L3:
    ...
    public void writeKeyData(String s, Map map)
    {
        ...
        s = map;
        map.flush();
        CommonUtils.a(map, "Failed to close key/value metadata file.");
        return;
        Object obj;
        obj;
        map = null;
_L4:
        s = map;
        bso.h().e("CrashlyticsCore", "Error serializing key/value metadata.", ((Throwable) (obj)));
        CommonUtils.a(map, "Failed to close key/value metadata file.");
        return;
        obj;
        map = s;
...
_L3:
    ...
    public void writeUserData(String s, UserMetaData usermetadata)
    {
        ...
        s = usermetadata;
        usermetadata.flush();
        CommonUtils.a(usermetadata, "Failed to close user metadata file.");
        return;
        Object obj;
        obj;
        usermetadata = null;
_L4:
        s = usermetadata;
        bso.h().e("CrashlyticsCore", "Error serializing user metadata.", ((Throwable) (obj)));
        CommonUtils.a(usermetadata, "Failed to close user metadata file.");
        return;
        obj;
        usermetadata = s;
