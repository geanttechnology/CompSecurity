...
label0:
    ...
    {
        return 0 + CodedOutputStream.computeBytesSize(1, ByteString.copyFromUtf8((new btr()).a(context)));
    }
...
label0:
    ...
    public void writeSessionApp(CodedOutputStream codedoutputstream, String s, String s1, String s2, String s3, int i)
    {
        ...
        codedoutputstream.writeString(1, (new btr()).a(context));
            ...
            float f, int i, boolean flag, int j, long l1, long l2, android.app.ActivityManager.RunningAppProcessInfo runningappprocessinfo, List list, StackTraceElement astacktraceelement[], LogFileManager logfilemanager, Map map)
    {
        ...
        if (athread == null)
        {
            bso.h().a("CrashlyticsCore", "No log data to include with this event.");
        }
