...
public class AdSettings
{
    ...
    private static void a(String s)
    {
        ...
        {
            a = true;
            Log.d(b, (new StringBuilder()).append("Test mode device hash: ").append(s).toString());
            Log.d(b, (new StringBuilder()).append("When testing your app with Facebook's ad units you must specify the device hashed ID to ensure the delivery of test ads, add the following code before loading an ad: AdSettings.addTestDevice(\"").append(s).append("\");").toString());
            return;
        }
    }
...
_L2:
        ...
        if (!r.a(((com.facebook.ads.internal.util.g.a) (context)).b))
        {
            g = r.b(((com.facebook.ads.internal.util.g.a) (context)).b);
        } else
        if (!r.a(((com.facebook.ads.internal.util.g.a) (context)).a))
        {
            g = r.b(((com.facebook.ads.internal.util.g.a) (context)).a);
        } else
        {
