...
label0:
            {
                AdErrorType aderrortype1 = aderrortype;
                if (j < k)
                {
                    aderrortype1 = aaderrortype[j];
                    if (aderrortype1.getErrorCode() != i)
                    {
                        break label0;
                    }
                }
    ...
    public AdError getAdError(String s)
    {
        return (new b(this, s)).b();
    }

    public b getAdErrorWrapper(String s)
    {
        return new b(this, s);
    }
