...
public class h extends BannerAdapter
{
    ...
    private void a(d d1)
    {
        ...
        {
            b = new a(g, new _cls1(k1), d1.e());
            b.a(d1.f(), d1.g());
            c = new l(g, b, new _cls2());
            c.a(k1);
    ...
    private class _cls1
        implements com.facebook.ads.internal.view.a.a
    {
    ...
    private class _cls2 extends com.facebook.ads.internal.adapters.b
    {
