...
public class b extends RelativeLayout
{
    ...
    public b(Context context, NativeAd nativead, com.facebook.ads.NativeAdView.Type type, NativeAdViewAttributes nativeadviewattributes)
    {
        ...
        setLayoutParams(new android.widget.RelativeLayout.LayoutParams(-1, Math.round((float)type.getHeight() * c.density)));
        nativeadviewattributes = new l(context);
        nativeadviewattributes.setMinWidth(Math.round(280F * c.density));
        nativeadviewattributes.setMaxWidth(Math.round(375F * c.density));
...
_L1:
        ...
        nativead.addRule(11);
        nativead.setMargins(Math.round(c.density * 4F), Math.round(c.density * 4F), Math.round(c.density * 4F), Math.round(c.density * 4F));
        nativeadviewattributes.addView(context);
        return;
_L2:
        b(context);
...
_L4:
    ...
    private void a(ViewGroup viewgroup)
    {
        ...
        relativelayout.setLayoutParams(new android.widget.LinearLayout.LayoutParams(-1, Math.round(c.density * 180F)));
        relativelayout.setBackgroundColor(a.getBackgroundColor());
        MediaView mediaview = new MediaView(getContext());
        relativelayout.addView(mediaview);
        android.widget.RelativeLayout.LayoutParams layoutparams = new android.widget.RelativeLayout.LayoutParams(-1, (int)(c.density * 180F));
        layoutparams.addRule(13, -1);
        mediaview.setLayoutParams(layoutparams);
        mediaview.setAutoplay(a.getAutoplay());
    ...
    private void a(ViewGroup viewgroup, com.facebook.ads.NativeAdView.Type type)
    {
        ...
        b1.setLayoutParams(new android.widget.LinearLayout.LayoutParams(-1, Math.round((float)b(type) * c.density)));
    ...
    private void b(ViewGroup viewgroup)
    {
        ...
        d1.setLayoutParams(new android.widget.LinearLayout.LayoutParams(-1, Math.round(110F * c.density)));
