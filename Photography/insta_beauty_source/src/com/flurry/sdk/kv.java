...
public class kv
{
    ...
    private void a(String s, List list, String s1)
    {
        ...
        s = new jz(js.a().c().getFileStreamPath(g(s)), s1, 1, new _cls7());
        s1 = new ArrayList();
    ...
    private void a(String s, byte abyte0[])
    {
        ...
        (new jz(js.a().c().getFileStreamPath(ku.a(s)), ".yflurrydatasenderblock.", 1, new _cls6())).a(new ku(abyte0));
        this;
        JVM INSTR monitorexit ;
        return;
        s;
...
_L7:
        ...
        do
        {
          ...
          goto _L3
_L2:
        s = (List)(new jz(js.a().c().getFileStreamPath(g(b)), s, 1, new _cls1())).a();
...
_L6:
    ...
    private List h(String s)
    {
        ...
        Object obj = (List)(new jz(js.a().c().getFileStreamPath(g(s)), ".YFlurrySenderIndex.info.", 1, new _cls5())).a();
        s = new ArrayList();
...
_L5:
    ...
    void b()
    {
        (new jz(js.a().c().getFileStreamPath(g(b)), ".YFlurrySenderIndex.info.", 1, new _cls4())).b();
    }

    boolean b(String s)
    {
        return (new jz(js.a().c().getFileStreamPath(ku.a(s)), ".yflurrydatasenderblock.", 1, new _cls2())).b();
    }
    ...
    public boolean d(String s)
    {
        ...
        Object obj;
        lt.b();
        jz1 = new jz(js.a().c().getFileStreamPath(g(s)), ".YFlurrySenderIndex.info.", 1, new _cls3());
        obj = c(s);
        if (obj == null)
        {
