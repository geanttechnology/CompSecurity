...
public class FotoAdFactory
{
    ...
    private static ans interstitialAd = null;
...
_L1:
    ...
    {
        if (context.getPackageName().equals(ie.e))
        {
            return "382743411764062_769274653110934";
        }
        if (context.getPackageName().equals(ie.a))
        {
            return "344391832332795_541702009268442";
        }
        if (context.getPackageName().equals(ie.c))
        {
            return "156379654548669_471510606368904";
        }
        if (context.getPackageName().equalsIgnoreCase(ie.b) || context.getPackageName().equalsIgnoreCase(ie.j))
        {
            return "116913278412853_754396101331231";
        }
        if (context.getPackageName().equals(ie.l))
        {
...
/*
    static ans access$002(ans ans1)
    {
        interstitialAd = ans1;
        return ans1;
    }
...
*/
        ...
        implements Runnable
    {
        ...
        public void run()
        {
            ...
            {
                FotoAdFactory.interstitialAd = anq.d(ctx);
            }
            if (FotoAdFactory.interstitialAd != null)
            {
