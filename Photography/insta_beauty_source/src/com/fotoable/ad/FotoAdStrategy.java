...
public class FotoAdStrategy
{
    ...
    static Handler handler = new _cls5();
...
_L9:
        (new Handler(((Context)mCtx.get()).getMainLooper())).post(new _cls3());
        return;
...
_L2:
        ...
        {
            s = ((Context)mCtx.get()).getResources().getString(aat.fotolang);
        }
        s4 = Build.MODEL;
...
_L4:
        ...
        if (mWebView == null)
        {
            ...
            mWebView.setWebViewClient(new TWebViewClient(null));
...
_L13:
        if (!if.a((Context)mCtx.get())) goto _L6; else goto _L5
_L5:
        Object obj1 = "api.fotoable.com";
        obj = if.i((Context)mCtx.get());
...
*/
    ...
    private class _cls1
        implements DownLoadFileTask.DownLoadFileTaskFinishedCallBack
    {
...
_L2:
            ...
            if (s.equalsIgnoreCase("zh"))
            {
                s = ((Context)FotoAdStrategy.mCtx.get()).getResources().getString(aat.fotolang);
            }
            s4 = Build.MODEL;
            s5 = android.os.Build.VERSION.RELEASE;
...
_L2:
        ...
        implements Runnable
    {
        ...
        public void run()
        {
            ...
            obj = (new StringBuilder()).append("http://api.fotoable.com/user/group/v1/?").append(FotoCustomReport.WTAppBaseParams((Context)FotoAdStrategy.mCtx.get())).toString();
_L1:
