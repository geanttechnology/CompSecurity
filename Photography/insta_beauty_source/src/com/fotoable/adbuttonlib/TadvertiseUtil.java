...
_L3:
    ...
    public static void refreshCoordinates(Context context)
    {
        ...
        finalizedLocationManager.requestLocationUpdates(((String) (obj1)), 0L, 0.0F, new _cls1(), context.getMainLooper());
        context;
        JVM INSTR monitorexit ;
    }
...
*/
    ...
    private class _cls1NetworkCheckTask extends AsyncTask
    {
