...
public class FotoAlert
{
    ...
    public static FotoAlert a(JSONObject jsonobject, Context context)
    {
        if (jsonobject != null)
        {
            ...
            {
                context.a = aqn.e(jsonobject, "alertId");
                if (!jsonobject.isNull("showTimes"))
                {
                    context.b = aqn.e(jsonobject, "showTimes");
                }
                ...
                {
                    context.c = aqn.a(jsonobject, "imageUrl");
                }
                if (((FotoAlert) (context)).c != null && ((FotoAlert) (context)).c.length() > 0)
                {
                    if (!jsonobject.isNull("alertType"))
                    {
                        context.h = c(aqn.e(jsonobject, "alertType"));
                    }
                    if (!jsonobject.isNull("stepUrl"))
                    {
                        context.d = aqn.a(jsonobject, "stepUrl");
                    }
                    if (!jsonobject.isNull("version"))
                    {
                        context.e = aqn.a(jsonobject, "version");
                    }
                    if (!jsonobject.isNull("schemUrl"))
                    {
                        context.f = aqn.a(jsonobject, "schemUrl");
                    }
                    if (!jsonobject.isNull("funName"))
                    {
                        context.g = aqn.a(jsonobject, "funName");
                    }
    ...
    public String a(String s)
    {
        ...
        {
            return (new StringBuilder()).append(s).append("/").append(yn.a(c)).toString();
        }
    }
