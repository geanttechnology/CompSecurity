...
public class TProEditRotateBottomBar extends LinearLayout
{
    ...
    public TProEditRotateBottomBar(Context context, AttributeSet attributeset)
    {
        ...
        bottom_1.setOnClickListener(new xp(this));
        bottom_2.setOnClickListener(new xq(this));
        bottom_3.setOnClickListener(new xr(this));
        bottom_4.setOnClickListener(new xs(this));
    }
