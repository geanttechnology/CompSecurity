...
public class NativeBaseView extends FrameLayout
{
    ...
    public NativeBaseView(Context context)
    {
        super(context);
        mContext = context;
        ((LayoutInflater)getContext().getSystemService("layout_inflater")).inflate(aas.native_ad_view, this, true);
        nativeFrame = (FrameLayout)findViewById(aar.nativeFrameLayout);
        imageFrame = (FrameLayout)findViewById(aar.imageFrame);
        actionFrame = (FrameLayout)findViewById(aar.action_frame);
        iconFrame = (FrameLayout)findViewById(aar.icon_frame);
        clickFrame = (FrameLayout)findViewById(aar.click_frame);
        textFrame = (FrameLayout)findViewById(aar.text_frame);
        nativeAdContainer = (FrameLayout)findViewById(aar.nativeAdContainer);
        nativeAdIcon = (ImageView)findViewById(aar.nativeAdIcon);
        nativeAdTitle = (TextView)findViewById(aar.nativeAdTitle);
        nativeAdBody = (TextView)findViewById(aar.nativeAdBody);
        nativeAdImage = (ImageView)findViewById(aar.nativeAdImage);
        nativeAdSocialContext = (TextView)findViewById(aar.nativeAdSocialContext);
        nativeAdCallToAction = (Button)findViewById(aar.nativeAdCallToAction);
        resetView();
    }
