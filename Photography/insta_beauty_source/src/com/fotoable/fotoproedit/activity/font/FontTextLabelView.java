...
public class FontTextLabelView extends View
{
    ...
    private Bitmap getTextBitmap()
    {
            ...
            if (bitmap1 != null)
            {
                ...
                if (labelinfo.n)
                {
                    for (int k = 0; k < txtLines; k++)
                    {
                        ...
                        canvas.drawBitmap(bitmap1, null, new Rect(0, (int)(fontmetrics1.ascent + f1) - yp.a(getContext(), 5F), j2, (int)(f1 + fontmetrics1.descent) + yp.a(getContext(), 5F)), paint1);
                    }
        ...
        float f7 = (float)yp.a(getContext(), labelinfo.d) * curLabelScale;
...
_L3:
        if (curTextSize <= yp.c(getContext(), 80F)) goto _L6; else goto _L5
_L5:
        f3 = f1;
        f2 = f;
_L4:
        mTextPaint.setTextSize(curTextSize);
        curLabelScale = (float)curTextSize / (float)yp.c(getContext(), 80F);
...
_L9:
    ...
    private void resetPaint()
    {
        ...
        if (fontInfo != null)
        {
            mStrokePaint.setTypeface(alr.a().a(fontInfo));
            mTextPaint.setTypeface(alr.a().a(fontInfo));
        }
        mStrokePaint.setFilterBitmap(true);
        mTextPaint.setFilterBitmap(true);
    }
...
_L3:
    ...
    {
        return aku.a(bgltPt, bgrtPt, bgrbPt, bglbPt, new PointF(i, j));
    }
    ...
    public void onTextCreate()
    {
        ...
        {
            int i = yp.a(getContext(), 21F);
            int l = yp.a(getContext(), 80F);
    ...
    public void setFontLabelFontInfo(ama ama)
    {
        fontInfo = ama;
    }
    ...
    public void setLabelTextStr(String s)
    {
        ...
        if (s.length() > 0)
        {
            if (!s.equals(getResources().getText(0x7f06029c)))
            {
                curText = s;
            }
            s1 = s;
    ...
    public void setListener(akn akn1)
    {
        mListener = akn1;
    }
