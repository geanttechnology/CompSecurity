...
public class MosaicIconScrollView extends HorizontalScrollView
{
    ...
    private View addItem(MosaicInfo mosaicinfo, Bitmap bitmap)
    {
        ...
        mosaiciconitemview.setOnClickListener(new alf(this));
    ...
    public void setListener(alg alg)
    {
        callback = alg;
    }
...
/*
    public static View access$002(MosaicIconScrollView mosaiciconscrollview, View view)
    {
