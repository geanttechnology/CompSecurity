                ...
                if (bitmap2 != null)
                {
                    ...
                    if (bitmap3 != null)
                    {
                        ...
                        if (lastProcessBitmap != null)
                        {
                            ...
                            try
                            {
                                bitmap4 = Bitmap.createBitmap((int)mOriginalWidth, (int)((float)mTempTectRect.height() * f), android.graphics.Bitmap.Config.ARGB_8888);
...
_L5:
    ...
    public void setStretchNewImageViewLisener(all all1)
    {
        lisener = all1;
    }
