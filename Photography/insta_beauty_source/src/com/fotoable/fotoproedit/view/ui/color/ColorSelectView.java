...
public class ColorSelectView extends FrameLayout
{
    ...
    public ColorSelectView(Context context, AttributeSet attributeset)
    {
        ...
        maxPerLineCount = 0;
        lineHeight = 0;
        ((LayoutInflater)getContext().getSystemService("layout_inflater")).inflate(0x7f0300f7, this, true);
        layout_color_container = (FrameLayout)findViewById(0x7f0d03ab);
        indicate_color = findViewById(0x7f0d03ad);
        layout_color_indi = findViewById(0x7f0d03ac);
        layout_color_indi.setVisibility(4);
    }

    private ams colorItemInstance(String s, int i, String s1)
    {
        s1 = new ams();
        s1.a(s);
        s1.a(i);
...
_L5:
    ...
    public void setMaxSizeWithDoubleLine(int i, int j)
    {
        ...
        colorAreaWidth = i;
        getLayoutParams().width = i + yp.a(getContext(), 15F);
        i = 0;
        while (i < colorItems.size()) 
        {
            int k = i / maxPerLineCount;
            Object obj = (ams)colorItems.get(i);
    ...
    public void setOnColorSelectorListener(amt amt1)
    {
        listener = amt1;
    }
}
