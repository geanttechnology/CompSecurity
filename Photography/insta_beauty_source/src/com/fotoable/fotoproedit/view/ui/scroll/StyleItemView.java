...
public class StyleItemView extends LinearLayout
{
    ...
    public StyleItemView(Context context, AttributeSet attributeset)
    {
        ...
        ((LayoutInflater)getContext().getSystemService("layout_inflater")).inflate(0x7f03012a, this, true);
        icon = (ImageView)findViewById(0x7f0d0419);
        container = findViewById(0x7f0d01eb);
        mask = findViewById(0x7f0d0452);
