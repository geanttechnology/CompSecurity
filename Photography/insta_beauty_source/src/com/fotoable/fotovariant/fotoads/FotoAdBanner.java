...
public abstract class FotoAdBanner extends FrameLayout
{
    ...
    private int getAppBannerImage(String s)
    {
        if (s.compareTo(Wantu_BundleName) == 0)
        {
            if (yp.a())
            {
                return ano.wantubanner_cn;
            } else
            {
                return ano.wantubanner_en;
            }
        }
        if (s.compareTo(InstaMag_BundleName) == 0)
        {
            if (yp.a())
            {
                return ano.magbanner_cn;
            } else
            {
                return ano.magbanner_en;
            }
        }
        if (s.compareTo(InstaBeauty_BundleName) == 0)
        {
            if (yp.a())
            {
                return ano.beautybanner_cn;
            } else
            {
                return ano.beautybanner_en;
            }
        }
        if (s.compareTo(PIP_BundleName) == 0)
        {
            if (yp.a())
            {
                return ano.pipbanner_cn;
            } else
            {
                return ano.pipbanner_en;
            }
        }
        if (s.compareTo(Helpr_BundleName) == 0)
        {
            return ano.helprbanner;
        } else
        {
            return ano.wantubanner_cn;
        }
    ...
    public void createDefaultBanner()
    {
        ...
        fotoView.setOnClickListener(new anr(this));
    }
