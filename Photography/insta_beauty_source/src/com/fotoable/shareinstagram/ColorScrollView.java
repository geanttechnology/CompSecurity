...
public class ColorScrollView extends FrameLayout
{
    ...
    {
        ((LayoutInflater)context.getSystemService("layout_inflater")).inflate(aas.view_color_scroll, this, true);
        colorContainer = (FrameLayout)findViewById(aar.layout_color_container);
    }
...
_L7:
    ...
    public void setMaxSizeWithMultyLine(int i, int j, int k)
    {
        ...
        {
            j = i / maxPerLineCount;
            Object obj = (aua)colorItems.get(i);
            FrameLayout framelayout = new FrameLayout(getContext());
            framelayout.setBackgroundColor(((aua) (obj)).a());
    ...
    public void setOnMultyColorSelectorLisener(aub aub1)
    {
        lisener = aub1;
    }
}
