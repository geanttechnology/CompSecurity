...
public class TTieZhiInfo extends TResInfo
{
    ...
    public Bitmap getIconImage()
    {
        ...
        try
        {
            if (resType == EResType.NETWORK)
            {
                ...
                return (Bitmap)awg.a().c().a(s, new ceo());
            }
            bitmap = yp.b(InstaBeautyApplication.a, icon);
        }
    ...
    public Bitmap getSrcImage()
    {
        ...
        try
        {
            ...
            bitmap = yp.b(InstaBeautyApplication.a, src);
        }
        catch (Exception exception)
        {
            return null;
    ...
    public boolean hasSrcImg()
    {
        ...
        obj = (Bitmap)awg.a().c().a(((String) (obj)), new ceo());
_L1:
        if (obj != null)
        {
            try
        ...
        obj = yp.b(InstaBeautyApplication.a, src);
          goto _L1
        return true;
    }
