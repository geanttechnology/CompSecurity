...
public class TTieZhiInfoView extends ImageView
{
    ...
    private float getDefaultR()
    {
        if (HWScale > 1.0F)
        {
            return (float)((double)(((float)TTieZhiInfo.kDefaultTZWidth * yp.c(getContext())) / 2.0F) * Math.sqrt(1.0F / (HWScale * HWScale) + 1.0F));
        } else
        {
            return (float)((double)(((float)TTieZhiInfo.kDefaultTZWidth * yp.c(getContext())) / 2.0F) * Math.sqrt(HWScale * HWScale + 1.0F));
        }
    }
    ...
    private void init()
    {
        ...
        deleteDrawable = context.getResources().getDrawable(0x7f0200b7);
        rotateDrawable = context.getResources().getDrawable(0x7f02015a);
        flipDrawable = context.getResources().getDrawable(0x7f0200f7);
        mPaint = new Paint();
    ...
    public RectF frameRect()
    {
        ...
        rectf.left = centerF.x - (yp.c(getContext()) * f1) / 2.0F;
        float f2 = centerF.x;
        rectf.right = (f1 * yp.c(getContext())) / 2.0F + f2;
        rectf.top = centerF.y - (yp.c(getContext()) * f) / 2.0F;
        f1 = centerF.y;
        rectf.bottom = (f * yp.c(getContext())) / 2.0F + f1;
        return rectf;
    }
    ...
    {
        float f = (float)TTieZhiInfo.kDefaultTZWidth * yp.c(getContext());
        if (HWScale > 1.0F)
        {
    ...
    {
        Rect rect = new Rect();
        float f = (float)kDefaultEditBtnWidth * yp.c(getContext());
