...
public class TTieZhiViewListCell extends FrameLayout
{
    ...
    public TTieZhiViewListCell(Context context, awf awf1)
    {
        super(context);
        mContext = context;
        imgWorker = awf1;
        ...
        ly4 = (FrameLayout)findViewById(0x7f0d0353);
        cellView1 = (TTieZhiViewCell)findViewById(0x7f0d027b);
        cellView2 = (TTieZhiViewCell)findViewById(0x7f0d027d);
        cellView3 = (TTieZhiViewCell)findViewById(0x7f0d027f);
        cellView4 = (TTieZhiViewCell)findViewById(0x7f0d0354);
    }

    public static int getItemDividerWidth()
    {
        return (int)(float)InstaBeautyApplication.a.getResources().getDisplayMetrics().widthPixels / 40;
    }
