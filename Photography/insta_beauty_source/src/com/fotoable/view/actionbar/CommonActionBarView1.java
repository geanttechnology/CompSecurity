...
public class CommonActionBarView1 extends FrameLayout
{
    ...
    public CommonActionBarView1(Context context, AttributeSet attributeset)
    {
        ...
        layout_accept.setOnClickListener(new ayj(this));
        layout_pre = findViewById(0x7f0d018c);
        layout_pre.setOnClickListener(new ayk(this));
        next_btn = (Button)findViewById(0x7f0d010b);
        next_btn.setOnClickListener(new ayl(this));
    }
    ...
    public void setOnAcceptListener(aym aym)
    {
        listener = aym;
    }
    ...
    private class ENextBottonMode extends Enum
    {
        ...
        {
            return (ENextBottonMode)Enum.valueOf(com/fotoable/view/actionbar/CommonActionBarView1$ENextBottonMode, s);
        }
