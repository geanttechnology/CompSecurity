...
label0:
    ...
    public boolean onError(MediaPlayer mediaplayer, int i, int j)
    {
        ...
        zzzV = -1;
        zzzW = -1;
        zzhl.zzGk.post(new _cls3(mediaplayer, s));
        return true;
    }
...
_L6:
    ...
    public void onPrepared(MediaPlayer mediaplayer)
    {
        ...
        zzzV = 2;
        zzhl.zzGk.post(new _cls1(mediaplayer));
