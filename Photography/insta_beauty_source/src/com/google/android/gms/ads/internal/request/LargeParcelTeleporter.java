    ...
    implements SafeParcelable
{
    ...
    protected ParcelFileDescriptor zzf(byte abyte0[])
    {
        ...
        try
        {
            ...
            (new Thread(new _cls1(new android.os.ParcelFileDescriptor.AutoCloseOutputStream(aparcelfiledescriptor[1]), abyte0))).start();
        }
        ...
        implements Runnable
    {
        ...
        _cls1(OutputStream outputstream, byte abyte0[])
        {
