...
_L2:
    ...
    private void zzmF()
    {
        zzWO = 2;
        zzWK.zzXw = zzmJ();
        zzWT.zza(zzWX, zzWK.zzXw, new zza());
    }
    ...
    public void begin()
    {
        ...
        if (i != 0)
        {
            ...
            zzWK.zzXs.post(new _cls1(connectionresult));
        } else
        {
            ...
            while (((Iterator) (obj)).hasNext()) 
            {
                ...
                hashmap.put(client1, new zzc(api, j));
                flag = flag1 | flag;
            }
            if (flag)
            {
    ...
    private class zza extends zzb
    {
        ...
        public void zza(ConnectionResult connectionresult, AuthAccountResult authaccountresult)
        {
            ...
            } else
            {
                ...
                com.google.android.gms.common.api.zze.zzb(authaccountresult).zzXs.post(authaccountresult. new _cls1(connectionresult));
                return;
            }
        }
        ...
        zza()
        {
            zzXe = new WeakReference(zze.this);
        }
    }
        ...
        implements GoogleApiClient.ConnectionProgressReportCallbacks
    {
        ...
        public void onReportAccountValidation(ConnectionResult connectionresult)
        {
            ...
            if (Looper.myLooper() != com.google.android.gms.common.api.zze.zzb(zze1).getLooper())
            {
                flag = false;
            }
        ...
        implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener
    {
        ...
        public void onConnected(Bundle bundle)
        {
            zze.zzc(zzXd).zza(zzXd. new zzb());
        }

        public void onConnectionFailed(ConnectionResult connectionresult)
        {
            zze.zza(zzXd).lock();
            if (!com.google.android.gms.common.api.zze.zzb(zzXd, connectionresult)) goto _L2; else goto _L1
_L1:
            zze.zzd(zzXd);
            zze.zze(zzXd);
_L4:
        ...
        private class zzb extends com.google.android.gms.common.internal.zzq.zza
        {
            ...
            public void zzb(ResolveAccountResponse resolveaccountresponse)
            {
                ...
                } else
                {
                    ...
                    _cls1(ResolveAccountResponse resolveaccountresponse)
                    {
                        zzXj = zzb.this;
                        zzXf = zze.this;
                    ...
                    com.google.android.gms.common.api.zze.zzb(zze1).zzXs.post(zze1. new _cls1(resolveaccountresponse));
                    return;
                }
            }
