    ...
    implements GoogleApiClient
{
    ...
    private final zzc zzXB = new _cls1();
    private final GoogleApiClient.ConnectionCallbacks zzXC = new _cls2();
    private final com.google.android.gms.common.internal.zzj.zza zzXD = new _cls3();
    ...
    private static Api.Client zza(Api.zza zza1, Object obj, Context context, Looper looper, zze zze1, GoogleApiClient.ConnectionCallbacks connectioncallbacks, GoogleApiClient.OnConnectionFailedListener onconnectionfailedlistener)
    {
    ...
    private static zzz zza(Api.zzc zzc1, Object obj, Context context, Looper looper, zze zze1, GoogleApiClient.ConnectionCallbacks connectioncallbacks, GoogleApiClient.OnConnectionFailedListener onconnectionfailedlistener)
    {
    ...
    {
        zzkl.zzabj.zzc(googleapiclient).setResultCallback(new _cls7(zzl1, flag, googleapiclient));
    }
...
_L1:
    ...
    public PendingResult clearDefaultAccountAndReconnect()
    {
        ...
        } else
        {
            ...
            Object obj = new _cls5(atomicreference, zzl1);
            _cls6 _lcls6 = new _cls6(zzl1);
            obj = (new GoogleApiClient.Builder(mContext)).addApi(zzkl.API).addConnectionCallbacks(((GoogleApiClient.ConnectionCallbacks) (obj))).addOnConnectionFailedListener(_lcls6).setHandler(zzXs).build();
...
_L4:
    ...
    private class _cls3
        implements com.google.android.gms.common.internal.zzj.zza
    {
        ...
        implements ResultCallback
    {
        ...
        _cls7(zzl zzl1, boolean flag, GoogleApiClient googleapiclient)
        {
            zzXE = zzg.this;
            zzXI = zzl1;
            zzXJ = flag;
        ...
        implements GoogleApiClient.ConnectionCallbacks
    {
        ...
        _cls5(AtomicReference atomicreference, zzl zzl1)
        {
            zzXE = zzg.this;
    ...
    private class zzb extends BroadcastReceiver
    {
        ...
        zzb()
        {
            zzXK = new WeakReference(zzg.this);
        }
    }
