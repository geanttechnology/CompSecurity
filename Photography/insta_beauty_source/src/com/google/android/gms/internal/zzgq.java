...
label0:
    ...
    public void zzdP()
    {
        ...
        zza.zzGF.post(new _cls1(zzeg1, adrequestparcel));
_L1:
        ...
        try
        {
            zza.zzGF.post(new _cls2(zzeg1, adrequestparcel, zzgt1));
        }
        ...
        implements Runnable
    {
        ...
        _cls1(zzeg zzeg1, AdRequestParcel adrequestparcel)
        {
            zzFa = zzgq.this;
            zzEZ = zzeg1;
        ...
        implements Runnable
    {
        ...
        public void run()
        {
            ...
            {
                com.google.android.gms.ads.internal.util.client.zzb.zzd((new StringBuilder()).append("Fail to initialize adapter ").append(com.google.android.gms.internal.zzgq.zzb(zzFa)).toString(), remoteexception);
            }
            zzFa.zzb(com.google.android.gms.internal.zzgq.zzb(zzFa), 0);
        }

        _cls2(zzeg zzeg1, AdRequestParcel adrequestparcel, zzgt zzgt1)
        {
            zzFa = zzgq.this;
            zzEZ = zzeg1;
            zzoN = adrequestparcel;
