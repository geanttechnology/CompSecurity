...
public class TagManager
{
    ...
    public static TagManager getInstance(Context context)
    {
        ...
        throw context;
        zzaOb = new TagManager(context, new _cls2(), new DataLayer(new zzw(context)), zzcu.zzzz());
        context = zzaOb;
        com/google/android/gms/tagmanager/TagManager;
        JVM INSTR monitorexit ;
        return context;
...
_L2:
        ...
        implements zza
    {
        ...
        public zzp zza(Context context, TagManager tagmanager, Looper looper, String s, int i, zzs zzs1)
        {
