...
public abstract class UnsafeAllocator
{
    ...
    public static UnsafeAllocator create()
    {
        ...
        catch (Exception exception)
        {
            ...
            try
            {
                newInstance = java/io/ObjectInputStream.getDeclaredMethod("newInstance", new Class[] {
            ...
            catch (Exception exception1)
            {
                try
                {
                    exception1 = java/io/ObjectStreamClass.getDeclaredMethod("getConstructorId", new Class[] {
                        java/lang/Class
                    });
                    exception1.setAccessible(true);
                    final int constructorId = ((Integer)exception1.invoke(null, new Object[] {
                        java/lang/Object
                    })).intValue();
                    exception1 = java/io/ObjectStreamClass.getDeclaredMethod("newInstance", new Class[] {
