...
public class StyleListItemView extends LinearLayout
{
    ...
    public StyleListItemView(Context context, zu zu1)
    {
        super(context);
        bShowNew = false;
    ...
    public StyleListItemView(Context context, zu zu1, InstaMagType instamagtype)
    {
        super(context);
        bShowNew = false;
        instatype = InstaMagType.RECT_LIB_SIZE_TYPE;
