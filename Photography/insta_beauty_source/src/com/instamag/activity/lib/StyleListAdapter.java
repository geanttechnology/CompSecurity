...
public class StyleListAdapter extends BaseAdapter
{
    ...
    public StyleListAdapter(Context context, bbx bbx1, ArrayList arraylist)
    {
        imageWorker = null;
    ...
    private void refreshItemUIByInfo(int i, TPhotoComposeInfo tphotocomposeinfo)
    {
        ...
        {
            obj = (bbw)((View) (obj)).getTag();
            if (obj != null)
            {
                setShareLogoByInfo(((bbw) (obj)).b, tphotocomposeinfo);
            }
        }
    }
...
_L11:
        setShareLogoByInfo(((bbw) (viewgroup)).b, tphotocomposeinfo);
        if (i != selectedIndex) goto _L5; else goto _L4
_L4:
        ((bbw) (viewgroup)).a.setIsSelected(true);
        mCurSelectedItem = ((bbw) (viewgroup)).a;
_L7:
        imageWorker.a(tphotocomposeinfo, ((bbw) (viewgroup)).a);
...
_L3:
        ...
        catch (View view)
        {
          ...
          goto _L6
_L5:
        ((bbw) (viewgroup)).a.setIsSelected(false);
          goto _L7
        obj;
        viewgroup = view;
_L9:
