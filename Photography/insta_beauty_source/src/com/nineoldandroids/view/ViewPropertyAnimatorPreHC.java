...
_L3:
        ...
        obj = (Animator)iterator.next();
        propertybundle = (PropertyBundle)mAnimatorMap.get(obj);
        if (!propertybundle.cancel(i) || propertybundle.mPropertyMask != 0) goto _L6; else goto _L5
_L5:
        if (obj != null)
        {
            ((Animator) (obj)).cancel();
...
*/
        ...
        implements com.nineoldandroids.animation.Animator.AnimatorListener, com.nineoldandroids.animation.ValueAnimator.AnimatorUpdateListener
    {
        ...
        AnimatorEventListener(_cls1 _pcls1)
        {
            this();
        }
    }
