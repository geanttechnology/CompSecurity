...
public class LinkBodyRight5 extends LinkBaseView
{
    ...
    public LinkBodyRight5(Context context)
    {
        super(context);
        TAG = "LinkBodySingle5";
        View.inflate(getContext(), 0x7f030086, this);
    ...
    {
        return (float)axw.a(InstaBeautyApplication.a().getApplicationContext(), 10F) * TPhotoComposeInfo.scale;
    }
