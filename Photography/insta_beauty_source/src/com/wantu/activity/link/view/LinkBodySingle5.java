...
public class LinkBodySingle5 extends LinkBaseView
{
    ...
    public LinkBodySingle5(Context context)
    {
        super(context);
        TAG = "LinkBodySingle5";
        View.inflate(getContext(), 0x7f03008b, this);
    ...
    {
        return (float)axw.a(InstaBeautyApplication.a().b(), 10F) * TPhotoComposeInfo.scale;
    }
