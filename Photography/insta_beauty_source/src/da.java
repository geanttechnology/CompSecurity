...
public interface da
{
    ...
    public abstract void a(ScrollingTabContainerView scrollingtabcontainerview);

    public abstract void a(SparseArray sparsearray);

    public abstract void a(Menu menu, bp bp);
    ...
    public abstract void b(SparseArray sparsearray);
