...
public class dx
{
    ...
    private dx(Context context, TypedArray typedarray)
    {
        a = context;
        b = typedarray;
    }

    public static dx a(Context context, AttributeSet attributeset, int ai[], int i, int j)
    {
        return new dx(context, context.obtainStyledAttributes(attributeset, ai, i, j));
    }
