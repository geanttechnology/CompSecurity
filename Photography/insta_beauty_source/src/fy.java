...
public class fy extends ResourceCursorAdapter
...
_L3:
    ...
    private CharSequence a(CharSequence charsequence)
    {
        if (i == null)
        {
            ...
            mContext.getTheme().resolveAttribute(r.textColorSearchUrl, typedvalue, true);
...
_L1:
    ...
    public void bindView(View view, Context context, Cursor cursor)
    {
        ...
        if (((fz) (context)).a != null)
        {
            view = a(cursor, j);
            a(((fz) (context)).a, view);
        }
        if (((fz) (context)).b == null) goto _L2; else goto _L1
_L1:
        view = a(cursor, l);
        if (view != null)
        {
...
_L3:
        if (((fz) (context)).a != null)
        {
            ((fz) (context)).a.setSingleLine(false);
            ((fz) (context)).a.setMaxLines(2);
        }
_L6:
        a(((fz) (context)).b, view);
_L2:
        if (((fz) (context)).c != null)
        {
            a(((fz) (context)).c, b(cursor), 4);
        }
        if (((fz) (context)).d != null)
        {
            a(((fz) (context)).d, c(cursor), 8);
        }
        if (h == 2 || h == 1 && (i1 & 1) != 0)
        {
            ((fz) (context)).e.setVisibility(0);
            ((fz) (context)).e.setTag(((fz) (context)).a.getText());
            ((fz) (context)).e.setOnClickListener(this);
            return;
        } else
        {
            ((fz) (context)).e.setVisibility(8);
            return;
        }
_L4:
        if (((fz) (context)).a != null)
        {
            ((fz) (context)).a.setSingleLine(true);
            ((fz) (context)).a.setMaxLines(1);
        }
...
_L3:
    ...
    public View getView(int i1, View view, ViewGroup viewgroup)
    {
        ...
        catch (View view)
        {
            ...
            if (viewgroup != null)
            {
                ((fz)viewgroup.getTag()).a.setText(view.toString());
            }
            return viewgroup;
        }
        return view;
    ...
    public View newView(Context context, Cursor cursor, ViewGroup viewgroup)
    {
        ...
        context.setTag(new fz(context));
        ((ImageView)context.findViewById(w.edit_query)).setImageResource(f);
        return context;
    }
