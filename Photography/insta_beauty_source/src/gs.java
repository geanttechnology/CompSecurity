...
public class gs
{
    ...
    public static void a(Context context, NativeAppInstallAdView nativeappinstalladview)
    {
        ...
        float f2 = f - f / 8F;
        f = (207F * f2) / 300F;
        context = (android.widget.FrameLayout.LayoutParams)nativeappinstalladview.findViewById(ayw.container_frame).getLayoutParams();
        context.width = (int)f2;
        context.height = (int)f;
        nativeappinstalladview.findViewById(ayw.container_frame).setLayoutParams(context);
        context = (android.widget.FrameLayout.LayoutParams)((ImageView)nativeappinstalladview.findViewById(ayw.logoicon)).getLayoutParams();
        context.width = (int)((31F * f2) / 300F);
        context.height = (int)((15F * f2) / 300F);
        ((ImageView)nativeappinstalladview.findViewById(ayw.logoicon)).setLayoutParams(context);
        f = f2 / b;
        float f1;
        float f3;
        if (b < 1.910828F)
        ...
        context = (android.widget.FrameLayout.LayoutParams)nativeappinstalladview.findViewById(ayw.content_frame).getLayoutParams();
        context.height = (int)((34F * f2) / 300F);
        context.rightMargin = (int)((64F * f2) / 300F);
        context.leftMargin = (int)((40F * f2) / 300F);
        nativeappinstalladview.findViewById(ayw.content_frame).setLayoutParams(context);
    ...
    public static void a(Context context, NativeContentAdView nativecontentadview)
    {
        ...
        float f2 = f - f / 8F;
        f = (207F * f2) / 300F;
        context = (android.widget.FrameLayout.LayoutParams)((ImageView)nativecontentadview.findViewById(ayw.logoicon)).getLayoutParams();
        context.width = (int)((31F * f2) / 300F);
        context.height = (int)((15F * f2) / 300F);
        ((ImageView)nativecontentadview.findViewById(ayw.logoicon)).setLayoutParams(context);
        context = (android.widget.FrameLayout.LayoutParams)nativecontentadview.findViewById(ayw.container_frame).getLayoutParams();
        context.width = (int)f2;
        context.height = (int)f;
        nativecontentadview.findViewById(ayw.container_frame).setLayoutParams(context);
        f = f2 / b;
        float f1;
        float f3;
        if (b < 1.910828F)
        ...
        context = (android.widget.FrameLayout.LayoutParams)nativecontentadview.findViewById(ayw.content_frame).getLayoutParams();
        context.height = (int)((f2 * 34F) / 300F);
        context.rightMargin = (int)((62F * f2) / 300F);
        context.leftMargin = (int)((f2 * 34F) / 300F);
        nativecontentadview.findViewById(ayw.content_frame).setLayoutParams(context);
    ...
    {
        nativeappinstalladview.setHeadlineView(nativeappinstalladview.findViewById(ayw.appinstall_headline));
        nativeappinstalladview.setImageView(nativeappinstalladview.findViewById(ayw.appinstall_image));
        nativeappinstalladview.setBodyView(nativeappinstalladview.findViewById(ayw.appinstall_body));
        nativeappinstalladview.setCallToActionView(nativeappinstalladview.findViewById(ayw.appinstall_call_to_action));
        nativeappinstalladview.setIconView(nativeappinstalladview.findViewById(ayw.appinstall_app_icon));
    ...
    {
        nativecontentadview.setHeadlineView(nativecontentadview.findViewById(ayw.contentad_headline));
        nativecontentadview.setImageView(nativecontentadview.findViewById(ayw.contentad_image));
        nativecontentadview.setBodyView(nativecontentadview.findViewById(ayw.contentad_body));
        nativecontentadview.setCallToActionView(nativecontentadview.findViewById(ayw.contentad_call_to_action));
        nativecontentadview.setLogoView(nativecontentadview.findViewById(ayw.contentad_logo));
