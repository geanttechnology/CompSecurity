    ...
    implements android.view.View.OnClickListener
{
    ...
    public kt(ActivityCamera activitycamera)
    {
        a = activitycamera;
        super();
    }
    ...
    public void onClick(View view)
    {
        ...
        ActivityCamera.d(a).getBackground().setColorFilter(a.getResources().getColor(0x7f0c000f), android.graphics.PorterDuff.Mode.SRC_IN);
        ...
        view.putExtra(contiCapturePhotoEditActivity1.A, ActivityCamera.e(a));
