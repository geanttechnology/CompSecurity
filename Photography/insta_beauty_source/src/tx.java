    ...
    implements android.view.View.OnTouchListener
{
    ...
    public tx(MNewFindFaceFragment mnewfindfacefragment)
    {
    ...
    public boolean onTouch(View view, MotionEvent motionevent)
    {
        ...
        pointf = a.a(MNewFindFaceFragment.e(a));
...
_L5:
        MNewFindFaceFragment.b(a, a.a(MNewFindFaceFragment.e(a)));
        return true;
_L2:
        view = (android.widget.FrameLayout.LayoutParams)view.getLayoutParams();
        MNewFindFaceFragment.c(a, i - ((android.widget.FrameLayout.LayoutParams) (view)).leftMargin);
        MNewFindFaceFragment.d(a, j - ((android.widget.FrameLayout.LayoutParams) (view)).topMargin);
...
_L3:
        ...
        motionevent.leftMargin = i - MNewFindFaceFragment.m(a);
        motionevent.topMargin = j - MNewFindFaceFragment.n(a);
