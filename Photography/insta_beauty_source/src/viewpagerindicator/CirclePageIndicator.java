    ...
    implements PageIndicator
{
    ...
    {
        this(context, attributeset, 0x7f0100e3);
    }
    ...
    public CirclePageIndicator(Context context, AttributeSet attributeset, int i)
    {
        ...
        int j = ((Resources) (obj)).getColor(0x7f0c003a);
        int k = ((Resources) (obj)).getColor(0x7f0c0039);
        int l = ((Resources) (obj)).getInteger(0x7f090003);
        int i1 = ((Resources) (obj)).getColor(0x7f0c003b);
        float f = ((Resources) (obj)).getDimension(0x7f080034);
        float f1 = ((Resources) (obj)).getDimension(0x7f080033);
        boolean flag = ((Resources) (obj)).getBoolean(0x7f070006);
        boolean flag1 = ((Resources) (obj)).getBoolean(0x7f070007);
        attributeset = context.obtainStyledAttributes(attributeset, com.fotoable.fotobeauty.R.styleable.CirclePageIndicator, i, 0);
        ...
        if (mViewPager != null)
        {
            if ((i1 = mViewPager.getAdapter().getCount()) != 0)
            {
                ...
                while (i < i1) 
                {
                    ...
                    {
                        canvas.drawCircle(f4, f3 + 5F, f2, mPaintPageFill);
                    }
                    if (f2 != mRadius)
                    {
                        canvas.drawCircle(f4, f3 + 5F, mRadius, mPaintStroke);
                    }
                    i++;
                }
                if (mSnap)
                ...
                canvas.drawCircle(f, f1 + 5F, mRadius, mPaintFill);
                return;
            }
        }
    }
...
_L8:
    ...
    private class SavedState extends android.view.View.BaseSavedState
    {
        ...
        public static final android.os.Parcelable.Creator CREATOR = new cfl();
        int a;
        ...
        public SavedState(Parcel parcel, cfk cfk)
        {
            this(parcel);
        }
