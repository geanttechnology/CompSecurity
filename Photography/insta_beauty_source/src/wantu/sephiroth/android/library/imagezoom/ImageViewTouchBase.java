...
public class ImageViewTouchBase extends ImageView
{
    ...
    public RectF getCenter(boolean flag, boolean flag1)
    {
        float f;
        float f1;
        RectF rectf;
...
_L10:
    ...
    public void panBy(double d, double d1)
    {
        if (!mNeedSetCenter)
        {
            float f = getCurScale();
    ...
    public void scrollBy(float f, float f1, double d)
    {
        ...
        mHandler.post(new cgf(this, d, l, d1, d2));
    }
    ...
    public void setImageBitmap(Bitmap bitmap, boolean flag, Matrix matrix, float f)
    {
        ...
        if (bitmap != null)
        {
            setImageDrawable(new cgn(bitmap), flag, matrix, f);
            return;
        } else
        {
    ...
    public void setImageDrawable(Drawable drawable, boolean flag, Matrix matrix, float f)
    {
        if (getWidth() <= 0)
        {
            mOnLayoutRunnable = new cge(this, drawable, flag, matrix, f);
            return;
        } else
        {
    ...
    public void setOnBitmapChangedListener(cgh cgh1)
    {
        mListener = cgh1;
    }
    ...
    public void zoomTo(float f, float f1, float f2, float f3)
    {
        ...
        f = (f - getScale()) / f3;
        float f4 = getScale();
        mHandler.post(new cgg(this, f3, l, f4, f, f1, f2));
    }
}
