...
public class yw extends android.view.GestureDetector.SimpleOnGestureListener
{

    final HorizontalListView a;

    private yw(HorizontalListView horizontallistview)
    {
        a = horizontallistview;
        super();
    }

    public yw(HorizontalListView horizontallistview, yt yt)
    {
