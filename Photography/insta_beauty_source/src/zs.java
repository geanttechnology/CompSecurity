...
public class zs extends zt
{
    ...
    public zs(Context context, int j)
    {
        super(context, j);
        h = true;
        i = new Object();
    ...
    public zs(Context context, int j, int l)
    {
        super(context, j, l);
        h = true;
        i = new Object();
...
_L8:
        if (!a(s, ((zl) (obj)).a(0))) goto _L11; else goto _L10
_L10:
        ((zl) (obj)).a();
_L9:
        obj = f.a(((String) (obj2)));
