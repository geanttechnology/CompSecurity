...
class zw extends UgentAsyncTask
{
    ...
    public zw(zu zu1, ImageView imageview)
    {
        a = zu1;
        super();
...
_L2:
        ...
        Object obj1;
        if (zu.b(a) != null && !c() && d() != null && !zu.c(a))
        {
            Bitmap bitmap = zu.b(a).b(s);
            obj = bitmap;
            if (bitmap != null)
            {
                obj = bitmap;
        ...
        if (obj1 != null)
        {
            if (aaj.c())
            {
                aobj = new zy(a.d, ((Bitmap) (obj1)));
            } else
            {
                aobj = new zz(a.d, ((Bitmap) (obj1)));
            }
            obj = ((Object) (aobj));
            if (zu.b(a) != null)
            {
                zu.b(a).a(s, ((BitmapDrawable) (aobj)));
                obj = ((Object) (aobj));
            }
        }
    ...
    protected void a(BitmapDrawable bitmapdrawable)
    {
        ...
        {
            zu.a(a, imageview, bitmapdrawable);
        }
    }
