...
public final class bj
{
    ...
    public bj()
    {
        ...
        LocalFilterInfo alocalfilterinfo[] = {
            new LocalFilterInfo(0, f.aH, "Original", 10), new LocalFilterInfo(46, f.ba, "V1", 11), new LocalFilterInfo(2, f.bl, "V2", 12), new LocalFilterInfo(4, f.bk, "V3", 13), new LocalFilterInfo(11, f.aV, "V4", 14), new LocalFilterInfo(12, f.aG, "V5", 15), new LocalFilterInfo(13, f.az, "V6", 16), new LocalFilterInfo(17, f.ad, "V7", 17), new LocalFilterInfo(18, f.aE, "V8", 18)
        };
        LocalFilterInfo localfilterinfo9 = new LocalFilterInfo(0, f.aH, "Original", 19);
        LocalFilterInfo localfilterinfo10 = new LocalFilterInfo(41, f.aR, "SC1", 20);
        LocalFilterInfo localfilterinfo11 = new LocalFilterInfo(3, f.be, "SC2", 21);
        LocalFilterInfo localfilterinfo12 = new LocalFilterInfo(5, f.aC, "SC3", 22);
        LocalFilterInfo localfilterinfo13 = new LocalFilterInfo(6, f.af, "SC4", 23);
        LocalFilterInfo localfilterinfo14 = new LocalFilterInfo(7, f.aA, "SC5", 24);
        LocalFilterInfo localfilterinfo15 = new LocalFilterInfo(8, f.ai, "SC6", 25);
        LocalFilterInfo localfilterinfo16 = new LocalFilterInfo(15, f.ag, "SC7", 26);
        LocalFilterInfo localfilterinfo17 = new LocalFilterInfo(16, f.bc, "SC8", 27);
        LocalFilterInfo localfilterinfo18 = new LocalFilterInfo(0, f.aH, "Original", 28);
        LocalFilterInfo localfilterinfo19 = new LocalFilterInfo(22, f.aJ, "H1", 29);
        LocalFilterInfo localfilterinfo20 = new LocalFilterInfo(26, f.ak, "H2", 30);
        LocalFilterInfo localfilterinfo21 = new LocalFilterInfo(23, f.aT, "H3", 31);
        LocalFilterInfo localfilterinfo22 = new LocalFilterInfo(42, f.k, "H4", 32);
        LocalFilterInfo localfilterinfo23 = new LocalFilterInfo(25, f.j, "H5", 33);
        LocalFilterInfo localfilterinfo24 = new LocalFilterInfo(27, f.aO, "H6", 34);
        LocalFilterInfo localfilterinfo25 = new LocalFilterInfo(35, f.aQ, "H7", 35);
        LocalFilterInfo localfilterinfo26 = new LocalFilterInfo(24, f.bn, "H8", 36);
