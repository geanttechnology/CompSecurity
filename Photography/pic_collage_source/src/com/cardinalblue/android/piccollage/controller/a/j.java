...
_L1:
        ...
        obj3 = new TreeMap();
        for (obj5 = ((List) (obj4)).iterator(); ((Iterator) (obj5)).hasNext(); ((Map) (obj3)).put(((DownloadMedia) (obj4)).getMediaDataFileName(), ((Map) (obj)).get(((DownloadMedia) (obj4)).getId())))
        {
            obj4 = (DownloadMedia)((Iterator) (obj5)).next();
        }
