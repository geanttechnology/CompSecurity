...
public class d
{
    ...
    public static void h(Context context)
    {
        ...
        context = obj.getClass().getMethod("isLimitAdTrackingEnabled", new Class[0]);
        b = method.invoke(obj, new Object[0]).toString();
        c = ((Boolean)context.invoke(obj, new Object[0])).booleanValue();
        if (false)
        {
