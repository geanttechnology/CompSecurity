    ...
    implements Runnable
{
    ...
    {
        LocalAd localad;
        com.vungle.publisher.db.model.Ad.a a1;
        Object obj;
        obj = i;
        localad = b.a(((String) (obj)));
        if (localad == null)
        {
            throw new IllegalArgumentException((new StringBuilder("no ad ")).append(((String) (obj))).toString());
        }
        a1 = localad.i();
...
_L1:
    ...
    class a {}
        ...
        {
            g.a("VunglePrepare", (new StringBuilder("error saving ad ")).append(localad.d()).append(" to database").toString(), exception);
        }
        return ((LocalAd) (obj));
_L2:
        throw new a((new StringBuilder("ad status: ")).append(a1).toString());
_L3:
        Logger.d("VunglePrepare", (new StringBuilder("ad already ")).append(com.vungle.publisher.db.model.Ad.a.e).append(": ").append(((String) (obj))).toString());
        return localad;
