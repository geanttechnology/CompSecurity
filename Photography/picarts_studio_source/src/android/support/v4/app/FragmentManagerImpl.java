...
_L3:
    ...
    final void moveToState(Fragment fragment, int i, int j, int k, boolean flag)
    {
        int l;
label0:
        {
...
_L10:
        if (i < 2)
        {
            ...
            private class AnimateOnHWLayerIfNeededListener
        ...
        if (((FragmentManagerState) (parcelable = (FragmentManagerState)parcelable)).mActive != null)
        {
            ...
            if (((FragmentManagerState) (parcelable)).mAdded != null)
            {
                ...
                for (int l = 0; l < ((FragmentManagerState) (parcelable)).mAdded.length; l++)
                {
                    ...
                    if (DEBUG)
                    {
                        (new StringBuilder("restoreAllState: added #")).append(l).append(": ").append(list);
                    }
            ...
            if (((FragmentManagerState) (parcelable)).mBackStack != null)
            {
                ...
                while (i1 < ((FragmentManagerState) (parcelable)).mBackStack.length) 
                {
                    ...
                    if (DEBUG)
                    {
                        (new StringBuilder("restoreAllState: back stack #")).append(i1).append(" (index ").append(((BackStackRecord) (list)).mIndex).append("): ").append(list);
