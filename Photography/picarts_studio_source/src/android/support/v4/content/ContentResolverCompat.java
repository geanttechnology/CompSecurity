...
public class ContentResolverCompat
{
    ...
    private class ContentResolverCompatImpl
    {
    ...
    private class ContentResolverCompatImplJB extends ContentResolverCompatImplBase
    {
        private class ContentResolverCompatImplBase
