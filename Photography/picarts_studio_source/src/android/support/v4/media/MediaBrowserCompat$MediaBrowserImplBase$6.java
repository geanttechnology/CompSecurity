    ...
    implements Runnable
{
    ...
    public void run()
    {
        Log.e("MediaBrowserCompat", (new StringBuilder("onConnectFailed for ")).append(cess._mth1400(this._cls0.this)).toString());
        ...
        {
            Log.w("MediaBrowserCompat", (new StringBuilder("onConnect from service while mState=")).append(cess._mth700(cess._mth600(this._cls0.this))).append("... ignoring").toString());
            return;
        } else
        {
