...
public final class 
{
    ...
    public final mMediaUri setDescription(CharSequence charsequence)
    {
    ...
    public final mMediaId setMediaUri(Uri uri)
    {
        mMediaUri = uri;
        return this;
    }

    public final mMediaUri setSubtitle(CharSequence charsequence)
    {
