...
public class MediaButtonReceiver extends BroadcastReceiver
{
    ...
    public void onReceive(Context context, Intent intent)
    {
        ...
        if (((List) (obj)).size() != 1)
        {
            throw new IllegalStateException((new StringBuilder("Expected 1 Service that handles android.intent.action.MEDIA_BUTTON, found ")).append(((List) (obj)).size()).toString());
        } else
        {
