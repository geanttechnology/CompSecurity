...
*/
                    ...
                    class StubCompat extends IMediaControllerCallback.Stub
                    {
                        ...
                        public void onEvent(String s, Bundle bundle)
                        {
                            class MessageHandler extends Handler
                            {
                                ...
                                public void post(int i, Object obj, Bundle bundle1)
                                {
        ...
        implements MediaControllerImpl
    {
        ...
        public void adjustVolume(int i, int j)
        {
            ...
            {
                Log.e("MediaControllerCompat", (new StringBuilder("Dead object in adjustVolume. ")).append(remoteexception).toString());
            }
        }
        ...
        public boolean dispatchMediaButtonEvent(KeyEvent keyevent)
        {
            ...
            {
                Log.e("MediaControllerCompat", (new StringBuilder("Dead object in dispatchMediaButtonEvent. ")).append(keyevent).toString());
            }
            return false;
        }
        ...
        public Bundle getExtras()
        {
            ...
            {
                Log.e("MediaControllerCompat", (new StringBuilder("Dead object in getExtras. ")).append(remoteexception).toString());
                return null;
            }
            return bundle;
        }
        ...
        public long getFlags()
        {
            ...
            {
                Log.e("MediaControllerCompat", (new StringBuilder("Dead object in getFlags. ")).append(remoteexception).toString());
                return 0L;
            }
            return l;
        }
        ...
        public String getPackageName()
        {
            ...
            {
                Log.e("MediaControllerCompat", (new StringBuilder("Dead object in getPackageName. ")).append(remoteexception).toString());
                return null;
            }
            return s;
        }
        ...
        public PlaybackInfo getPlaybackInfo()
        {
            ...
            {
                Log.e("MediaControllerCompat", (new StringBuilder("Dead object in getPlaybackInfo. ")).append(remoteexception).toString());
                return null;
            }
        ...
        public List getQueue()
        {
            ...
            {
                Log.e("MediaControllerCompat", (new StringBuilder("Dead object in getQueue. ")).append(remoteexception).toString());
                return null;
            }
            return list;
        }
        ...
        public CharSequence getQueueTitle()
        {
            ...
            {
                Log.e("MediaControllerCompat", (new StringBuilder("Dead object in getQueueTitle. ")).append(remoteexception).toString());
                return null;
            }
            return charsequence;
        }
        ...
        public int getRatingType()
        {
            ...
            {
                Log.e("MediaControllerCompat", (new StringBuilder("Dead object in getRatingType. ")).append(remoteexception).toString());
                return 0;
            }
            return i;
        }
        ...
        public PendingIntent getSessionActivity()
        {
            ...
            {
                Log.e("MediaControllerCompat", (new StringBuilder("Dead object in getSessionActivity. ")).append(remoteexception).toString());
                return null;
            }
        ...
        public void sendCommand(String s, Bundle bundle, ResultReceiver resultreceiver)
        {
            ...
            {
                Log.e("MediaControllerCompat", (new StringBuilder("Dead object in sendCommand. ")).append(s).toString());
            }
        }
        ...
        public void setVolumeTo(int i, int j)
        {
            ...
            {
                Log.e("MediaControllerCompat", (new StringBuilder("Dead object in setVolumeTo. ")).append(remoteexception).toString());
            }
        }
        ...
        public void unregisterCallback(Callback callback)
        {
            ...
            {
                Log.e("MediaControllerCompat", (new StringBuilder("Dead object in unregisterCallback. ")).append(callback).toString());
            }
        }
        ...
        private class TransportControlsBase extends TransportControls
        {
            ...
            public void fastForward()
            {
                ...
                {
                    Log.e("MediaControllerCompat", (new StringBuilder("Dead object in fastForward. ")).append(remoteexception).toString());
                }
            }
            ...
            public void playFromMediaId(String s, Bundle bundle)
            {
                ...
                {
                    Log.e("MediaControllerCompat", (new StringBuilder("Dead object in playFromMediaId. ")).append(s).toString());
                }
            }
            ...
            public void playFromSearch(String s, Bundle bundle)
            {
                ...
                {
                    Log.e("MediaControllerCompat", (new StringBuilder("Dead object in playFromSearch. ")).append(s).toString());
                }
            }
            ...
            public void playFromUri(Uri uri, Bundle bundle)
            {
                ...
                {
                    Log.e("MediaControllerCompat", (new StringBuilder("Dead object in playFromUri. ")).append(uri).toString());
                }
            }
            ...
            public void rewind()
            {
                ...
                {
                    Log.e("MediaControllerCompat", (new StringBuilder("Dead object in rewind. ")).append(remoteexception).toString());
                }
            }
            ...
            public void seekTo(long l)
            {
                ...
                {
                    Log.e("MediaControllerCompat", (new StringBuilder("Dead object in seekTo. ")).append(remoteexception).toString());
                }
            }
            ...
            public void sendCustomAction(String s, Bundle bundle)
            {
                ...
                {
                    Log.e("MediaControllerCompat", (new StringBuilder("Dead object in sendCustomAction. ")).append(s).toString());
                }
            }
            ...
            public void setRating(RatingCompat ratingcompat)
            {
                ...
                {
                    Log.e("MediaControllerCompat", (new StringBuilder("Dead object in setRating. ")).append(ratingcompat).toString());
                }
            }
            ...
            public void skipToNext()
            {
                ...
                {
                    Log.e("MediaControllerCompat", (new StringBuilder("Dead object in skipToNext. ")).append(remoteexception).toString());
                }
            }
            ...
            public void skipToPrevious()
            {
                ...
                {
                    Log.e("MediaControllerCompat", (new StringBuilder("Dead object in skipToPrevious. ")).append(remoteexception).toString());
                }
            }
            ...
            public void skipToQueueItem(long l)
            {
                ...
                {
                    Log.e("MediaControllerCompat", (new StringBuilder("Dead object in skipToQueueItem. ")).append(remoteexception).toString());
                }
            }
            ...
            public void stop()
            {
                ...
                {
                    Log.e("MediaControllerCompat", (new StringBuilder("Dead object in stop. ")).append(remoteexception).toString());
                }
            }
    ...
    private class MediaControllerImplApi23 extends MediaControllerImplApi21
    {
        ...
        private class TransportControlsApi23 extends TransportControlsApi21
        {
