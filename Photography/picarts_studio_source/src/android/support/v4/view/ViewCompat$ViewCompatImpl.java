...
interface r
{
    ...
    public abstract android.graphics.atImpl getBackgroundTintMode(View view);
    ...
    public abstract void setBackgroundTintMode(View view, android.graphics.atImpl atimpl);
