...
public class ViewCompat
{
    ...
    private class MarshmallowViewCompatImpl extends LollipopViewCompatImpl
    {
        private class LollipopViewCompatImpl extends KitKatViewCompatImpl
        {
            private class KitKatViewCompatImpl extends JbMr2ViewCompatImpl
            {
                private class JbMr2ViewCompatImpl extends JbMr1ViewCompatImpl
                {
                    ...
                    {
                        private class JBViewCompatImpl extends ICSMr1ViewCompatImpl
                        {
                            private class ICSMr1ViewCompatImpl extends ICSViewCompatImpl
                            {
...
_L3:
                                                        return true;
                                                        if (j >= k - 1) goto _L1; else goto _L4
_L4:
                                                        return true;
                                                    }
