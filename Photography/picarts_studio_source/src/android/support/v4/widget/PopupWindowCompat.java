...
public class PopupWindowCompat
{
    ...
    private class Api23PopupWindowImpl extends Api21PopupWindowImpl
    {
        private class Api21PopupWindowImpl extends KitKatPopupWindowImpl
        {
            private class KitKatPopupWindowImpl extends GingerbreadPopupWindowImpl
            {
                private class GingerbreadPopupWindowImpl extends BasePopupWindowImpl
                {
