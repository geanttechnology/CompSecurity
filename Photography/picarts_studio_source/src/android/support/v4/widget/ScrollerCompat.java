...
public class ScrollerCompat
{
    ...
    {
        return mImpl.springBack(mScroller, i, j, k, l, i1, j1);
    }
    ...
    private class ScrollerCompatImplIcs extends ScrollerCompatImplGingerbread
    {
            ...
            implements ScrollerCompatImpl
        {
            ...
            public boolean springBack(Object obj, int i, int j, int k, int l, int i1, int j1)
            {
                return ScrollerCompatGingerbread.springBack(obj, i, j, k, l, i1, j1);
            }
    ...
    private class ScrollerCompatImpl
    {
        ...
        public abstract boolean springBack(Object obj, int i, int j, int k, int l, int i1, int j1);
