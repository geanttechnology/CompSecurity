...
class AppCompatDelegateImplV14 extends AppCompatDelegateImplV11
{
    ...
    private class AppCompatWindowCallbackV14 extends AppCompatDelegateImplBase.AppCompatWindowCallbackBase
    {
        ...
        final ActionMode startAsSupportActionMode(android.view.ActionMode.Callback callback)
        {
            ...
            myobfuscated.b.a a = startSupportActionMode(callback);
            if (a != null)
            {
                return callback.getActionModeWrapper(a);
            } else
            {
                return null;
            }
