    ...
    implements az
{
    ...
    public final void a(Object obj, Class class1)
    {
        ...
        {
            b b1;
            for (obj1 = b(class1, ((CopyOnWriteArraySet) (obj1))).iterator(); ((Iterator) (obj1)).hasNext(); h.execute(new ay(this, b1, obj)))
            {
        ...
        if (obj1 != null)
        {
            for (class1 = b(class1, ((CopyOnWriteArraySet) (obj1))).iterator(); class1.hasNext(); ((b)class1.next()).trigger(obj)) { }
        }
    }
...
_L1:
        b1 = class1.getName();
        myobfuscated.i.a.c(g, String.format("Error: Attempted to add a null subscriber for eventClass %s. This subscriber is being ignored. Please check your calling code to ensure that all potential subscriptions are valid.", new Object[] {
            b1
        }));
_L3:
        obj1;
