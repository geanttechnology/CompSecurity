...
final class bq extends BroadcastReceiver
{
    ...
    public final void onReceive(Context context, Intent intent)
    {
        try
        {
            myobfuscated.i.a.a(bp.b(), String.format("Single location update received from %s: %s", new Object[] {
        ...
        {
            myobfuscated.i.a.c(bp.b(), "Failed to process location update.", context);
        }
    }
}
