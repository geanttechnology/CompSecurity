    ...
    implements bx
{
    ...
    public final cm a()
    {
        cm cm1 = b.a();
        c.a(cm1);
        myobfuscated.i.a.a(a, (new StringBuilder("Completed the openSession call. Starting or continuing session ")).append(cm1.d).toString());
        return cm1;
    }
    ...
    public final void a(Throwable throwable)
    {
        if (b(throwable))
        {
            myobfuscated.i.a.b(a, "Not logging duplicate error.");
            return;
        }
        try
        {
            a(((ci) (bo.app.ct.a(throwable, b.c()))));
            return;
        }
        catch (JSONException jsonexception)
        {
            myobfuscated.i.a.c(a, String.format("Failed to create error event from %s.", new Object[] {
                throwable
            }), jsonexception);
            return;
        }
        ...
        {
            myobfuscated.i.a.c(a, "Failed to log error.", throwable);
        }
        return;
    }
    ...
    public final void b()
    {
        ...
        do
        {
            ...
            if (!bo.app.ep.b(s))
            {
                try
                {
                    a(bo.app.ct.a(new JSONObject(s)));
                }
                catch (JSONException jsonexception)
                {
                    myobfuscated.i.a.b(a, (new StringBuilder("Could not log pending AppboyEvent from shared preferences storage. Serialized string is: ")).append(s).toString(), jsonexception);
                }
            }
        } while (true);
        obj = j.edit();
