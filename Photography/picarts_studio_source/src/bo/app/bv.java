    ...
    implements bz
{
    ...
    public bv(Context context, ca ca1, cc cc1, ea ea1, eg eg, by by1)
    {
        ...
        ca1 = a(context);
        e = new c("1.10.0", ((PackageInfo) (ca1)).versionCode, ((PackageInfo) (ca1)).versionName, context, eg);
        h = by1;
    }
...
_L2:
        ...
        myobfuscated.i.a.c(a, String.format("Unable to inspect package [%s]", new Object[] {
            s
        }), namenotfoundexception);
        s = ((String) (obj));
...
_L1:
        myobfuscated.i.a.b(a, "Unknown phone type");
        obj = null;
_L5:
...
_L4:
    ...
    public final String d()
    {
        ...
        if (s == null)
        {
            myobfuscated.i.a.c(a, "Error reading deviceId, received a null value.");
        }
        return s;
    }
