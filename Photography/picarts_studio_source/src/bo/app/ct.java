    ...
    implements ci
{
    ...
    public static ct a(String s, String s1, l l1)
    {
        ...
        {
            return b(s, s1, String.valueOf(l1.a));
        }
    }
    ...
    {
        JSONObject jsonobject = new JSONObject();
        jsonobject.put("n", bo.app.ep.a(s));
        if (a1 != null && a1.a.length() > 0)
        {
    ...
    private JSONObject g()
    {
        ...
        {
            myobfuscated.i.a.c(a, "Caught exception creating Appboy event Json.", jsonexception);
            return jsonobject;
        }
        return jsonobject;
    }
