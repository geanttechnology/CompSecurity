...
_L2:
        break; /* Loop/switch isn't completed */
_L1:
        myobfuscated.i.a.c(a, String.format("Unknown key encountered in Device createFromJson %s", new Object[] {
            obj
        }));
        arraylist1 = arraylist;
        s13 = s;
...
_L5:
        ...
        if (obj != null)
        {
            cw2 = bo.app.cw.a(((JSONObject) (obj)));
            integer1 = integer;
            s7 = s6;
            s8 = s5;
            s9 = s3;
...
_L6:
        ...
        if (obj != null)
        {
            cy2 = bo.app.cy.a(((JSONObject) (obj)));
            integer1 = integer;
            s7 = s6;
            s8 = s5;
            s9 = s3;
...
_L7:
        ...
        s13 = s;
        arraylist1 = arraylist;
        if (jsonobject.has(bo.app.ad.a.m))
        {
            integer1 = Integer.valueOf(jsonobject.optInt(bo.app.ad.a.m));
            s7 = s6;
            s8 = s5;
            s9 = s3;
            s10 = s4;
...
_L18:
        arraylist.add(bo.app.dc.a(((JSONArray) (obj)).getJSONObject(j1)));
        j1++;
          goto _L19
          goto _L15
...
label0:
        {
            ...
            try
            {
                jsonobject.putOpt(bo.app.ad.a.m, b);
            ...
            {
                myobfuscated.i.a.c(a, "Caught exception creating device Json.", ((Throwable) (obj)));
            }
            return jsonobject;
        }
