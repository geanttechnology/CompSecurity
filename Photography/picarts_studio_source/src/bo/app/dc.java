...
_L1:
        ...
        df df2;
        de de2;
        myobfuscated.i.a.c(b, String.format("Unknown key encountered in WearDevice createFromJson %s", new Object[] {
            obj
        }));
        de2 = de1;
        df2 = df1;
...
_L4:
        ...
        df2 = df1;
        de2 = de1;
        if (jsonobject.has(bo.app.am.a.f))
        {
            obj = Integer.valueOf(jsonobject.optInt(bo.app.am.a.f));
            s2 = s1;
            s3 = s;
            df2 = df1;
            de2 = de1;
...
_L5:
        ...
        de2 = de1;
          goto _L9
        s2 = ep.d(jsonobject.optString(bo.app.am.e.f));
        obj = integer;
        s3 = s;
        df2 = df1;
        de2 = de1;
    ...
    public final JSONObject a()
    {
        ...
        try
        {
            jsonobject.putOpt(bo.app.am.a.f, c);
        ...
        {
            myobfuscated.i.a.c(b, "Caught exception creating wear device Json.", jsonexception);
            return jsonobject;
        }
        return jsonobject;
    }
