...
_L5:
        boolean flag;
        if (!bo.app.kx.a(String.valueOf(obj1), String.valueOf(obj2), ky.c).a)
        {
            flag = true;
        } else
        {
...
_L6:
        ...
        obj;
        myobfuscated.i.a.c(c, "Caught exception confirming and unlocking Json objects.", ((Throwable) (obj)));
          goto _L8
_L4:
        if (obj1.equals(obj2))
        {
        ...
        {
            myobfuscated.i.a.c(c, "Caught json exception creating dirty outbound device. Returning the whole device.", jsonexception1);
            return b;
        }
        break; /* Loop/switch isn't completed */
_L2:
        ...
        try
        {
            cu1 = bo.app.cu.a(((JSONObject) (obj)));
        }
...
_L7:
    ...
    final void a(Object obj)
    {
        ...
        editor.putString("cached_device", bo.app.eo.a(((JSONObject) (obj)), ((JSONObject) (obj1))).toString());
        editor.apply();
        return;
        obj;
    }
