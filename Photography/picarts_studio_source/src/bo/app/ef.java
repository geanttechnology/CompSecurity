    ...
    implements ee
{
    ...
    private static ContentValues a(cr cr1, ci ci1)
    {
        ...
        contentvalues.put("event_type", ci1.b().s);
...
_L6:
        ...
        Object obj3;
        obj3 = c(((Cursor) (obj1)));
        obj2 = bo.app.cr.a(((String) (obj2)));
        obj3 = new cf(bo.app.gq.a(((Collection) (obj3))));
        boolean flag;
        if (!a(j))
        {
            flag = true;
...
_L4:
    ...
    private static Collection b(Cursor cursor)
    {
        ...
        while (cursor.moveToNext()) 
        {
            ...
            cf cf1 = new cf(gq.h().a());
            obj = bo.app.cr.a(((String) (obj)));
            boolean flag;
            if (!a(j1))
            {
                flag = true;
    ...
    private static Collection c(Cursor cursor)
    {
        ...
        while (cursor.moveToNext()) 
        {
            ...
            try
            {
                arraylist.add(bo.app.ct.a(s, s1, d1));
            }
            catch (JSONException jsonexception)
            {
                myobfuscated.i.a.c(a, String.format("Could not create AppboyEvent from [type=%s, data=%s, timestamp=%f] ... Skipping", new Object[] {
    ...
    public final cm a()
    {
        ...
        try
        {
            ...
            {
                myobfuscated.i.a.c(a, (new StringBuilder("Got > 1 session while trying to get stored open session. ")).append(((Cursor) (obj)).getCount()).append(" open sessions in database").toString());
            }
            obj = a(((Cursor) (obj)));
        }
        catch (Exception exception)
        {
            myobfuscated.i.a.c(a, "Failed to retrieve stored open session.", exception);
            return null;
        }
        return ((cm) (obj));
    }
    ...
    Long.valueOf(d().insert("ab_events", null, a(cm1.d, ci1)))
        ...
        d().endTransaction();
        return;
        myobfuscated.i.a.c(a, "Erroneously received upsertSession call with null session value.  Please report this result to Appboy.");
        return;
    }
    ...
    public final void a(cm cm1, ci ci1)
    {
        if (!bo.app.ct.a(ci1))
        {
            ...
            {
                myobfuscated.i.a.b(a, String.format("Failed to insert event [%s] for session with ID [%s]", new Object[] {
            ...
            if (i != 1)
            {
                myobfuscated.i.a.b(a, String.format("Attempt to update end time affected %d rows, expected just one.", new Object[] {
                    Integer.valueOf(i)
                }));
                return;
            }
    ...
    public final cm b()
    {
        ...
        try
        {
            ...
            if (((Cursor) (obj)).getCount() > 1)
            {
                myobfuscated.i.a.c(a, (new StringBuilder("Got > 1 session while trying to get stored closed session. ")).append(((Cursor) (obj)).getCount()).append(" closed sessions in database").toString());
            }
            obj = a(((Cursor) (obj)));
        }
        catch (Exception exception)
        {
            myobfuscated.i.a.c(a, "Failed to retrieve stored closed session.", exception);
            return null;
        }
        return ((cm) (obj));
    }
    ...
    public final Collection c()
    {
        ...
        Iterator iterator;
        myobfuscated.i.a.a(a, String.format("Found %d sealed session rows.", new Object[] {
...
_L1:
        ...
        cr cr1;
        Double double1;
        cf1 = new cf(bo.app.gq.a(c(((Cursor) (obj1)))));
        cr1 = cm1.d;
        d1 = cm1.e;
        double1 = cm1.a();
        boolean flag;
...
_L2:
    ...
    static 
    {
        a = String.format("%s.%s", new Object[] {
            Constants.APPBOY_LOG_TAG_PREFIX, bo/app/ef.getName()
        });
    }
}
