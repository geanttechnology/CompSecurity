...
public class eg
{
    ...
    public eg(Context context, String s)
    {
        ...
        if (s == null)
        {
            myobfuscated.i.a.c(a, "ServerConfigStorageProvider received null api key.");
            s = "";
        } else
        {
    ...
    private Set a(String s)
    {
        ...
        {
            myobfuscated.i.a.b(a, "Experienced exception retrieving blacklisted strings from local storage. Returning null.", s);
            return null;
        }
        i = 0;
        if (i >= s.length())
