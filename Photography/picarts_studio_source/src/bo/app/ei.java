...
public class ei extends dr
{
    ...
    {
        c = context.getSharedPreferences((new StringBuilder("com.appboy.storage.usercache")).append(bo.app.ep.b(s, s1)).toString(), 0);
        d = eg1;
    }
    ...
    private void a(JSONObject jsonobject, String s)
    {
        ...
        if (c.contains(s))
        {
            ...
            {
                myobfuscated.i.a.b(b, String.format("Failed to parse existing value for [%s], continuing without it.", new Object[] {
                    s
                }), ((Throwable) (obj)));
                obj = editor;
            }
        ...
        if (obj != null && ((JSONObject) (obj)).length() > 0)
        {
            for (Iterator iterator = jsonobject.keys(); iterator.hasNext();)
            {
                ...
                {
                    myobfuscated.i.a.b(b, String.format("Failed to fetch value for key [%s], ignoring.", new Object[] {
                        s1
                    }));
                }
            }
    ...
    private db c()
    {
        ...
        do
        {
            ...
            {
                myobfuscated.i.a.b(b, String.format("Failed to check outbound json key %s for null placeholders.", new Object[] {
                    s
                }));
            }
        } while (true);
        ...
        do
        {
            ...
            {
                myobfuscated.i.a.b(b, String.format("Failed to properly convert [%s] value to OutboundUser for export.", new Object[] {
                    s1
                }));
            }
        } while (true);
            ...
            do
            {
                ...
                if (map.containsKey(obj2))
                {
                    ...
                    if (obj4 instanceof JSONObject)
                    {
                        try
                        {
                            if (bo.app.kx.a(String.valueOf(obj3), obj4.toString(), ky.c).a)
                            {
                                ((android.content.SharedPreferences.Editor) (obj)).remove(((String) (obj2)));
                            }
                        }
                        ...
                        {
                            myobfuscated.i.a.c(b, "Caught exception confirming and unlocking Json objects.", ((Throwable) (obj2)));
                        }
                    } else
                    if (obj4.equals(obj3))
                    {
...
_L1:
        myobfuscated.i.a.b(b, "Month cannot be null.");
        boolean flag = false;
_L4:
        this;
        JVM INSTR monitorexit ;
        return flag;
_L2:
        month = bo.app.el.a(bo.app.el.a(j, month.getValue(), k), bo.app.ab.a);
        android.content.SharedPreferences.Editor editor = c.edit();
...
_L3:
    ...
    public final boolean a(String s, long l)
    {
        this;
        JVM INSTR monitorenter ;
        boolean flag = a(s, bo.app.el.a(l));
        this;
        JVM INSTR monitorexit ;
        return flag;
        s;
    ...
    public final boolean a(String s, Object obj)
    {
        ...
        this;
        JVM INSTR monitorenter ;
        boolean flag = myobfuscated.i.e.a(s, d.g());
...
_L2:
        ...
        myobfuscated.i.a.b(b, "Custom attribute value cannot be null.");
        flag = flag1;
        continue; /* Loop/switch isn't completed */
        s;
        throw s;
...
label3:
        {
            ...
            editor.putString(s, myobfuscated.i.e.e((String)obj));
        }
          goto _L5
label4:
        {
            ...
            editor.putString(s, bo.app.el.a((Date)obj, bo.app.ab.b));
        }
          goto _L5
        myobfuscated.i.a.b(b, "Unsupported custom attribute type");
        flag = flag1;
...
_L5:
        ...
        return flag;
_L3:
        myobfuscated.i.a.b(b, String.format("Email address is not valid: %s", new Object[] {
            s1
        }));
...
_L4:
    ...
    public final boolean g(String s)
    {
        ...
        if (s1 == null) goto _L2; else goto _L1
_L1:
        if (!myobfuscated.i.e.b(s1)) goto _L3; else goto _L2
_L2:
        s = c.edit();
...
_L5:
        ...
        return flag;
_L3:
        myobfuscated.i.a.b(b, String.format("Phone number contains invalid characters (allowed are digits, spaces, or any of the following +.-()): %s", new Object[] {
            s1
        }));
        if (true) goto _L5; else goto _L4
_L4:
...
_L1:
        myobfuscated.i.a.b(b, "Custom attribute key cannot be null.");
_L4:
        this;
        JVM INSTR monitorexit ;
        return flag;
