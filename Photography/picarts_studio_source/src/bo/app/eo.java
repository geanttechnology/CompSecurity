...
public final class eo extends JSONObject
{
...
_L3:
    ...
    public static JSONArray a(Collection collection)
    {
        ...
        for (collection = collection.iterator(); collection.hasNext(); jsonarray.put(((e)collection.next()).forJsonPut())) { }
        return jsonarray;
    }
    ...
    public static JSONObject a(JSONObject jsonobject, JSONObject jsonobject1)
    {
        ...
        {
            myobfuscated.i.a.c(a, "Caught exception merging Json objects.", jsonobject);
            return null;
        }
        String s;
    ...
    static 
    {
        a = String.format("%s.%s", new Object[] {
            Constants.APPBOY_LOG_TAG_PREFIX, bo/app/eo.getName()
        });
    }
}
