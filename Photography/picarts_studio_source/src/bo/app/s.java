...
public final class s
{
    ...
    public s(Context context, az az1, y y1, AlarmManager alarmmanager, r r1)
    {
        ...
        h = ak.b;
        i = -1L;
        if (b.getPackageManager().queryIntentServices((new Intent()).setClass(b, com/appboy/services/AppboyDataSyncService), 0x10000).size() == 0)
        {
            myobfuscated.i.a.c(a, String.format("Appboy periodic data flushing is not available. Declare <service android:name=\"com.appboy.services.AppboyDataSyncService\"/> in your AndroidManifest.xml to enable Appboy periodic data flushing.", new Object[0]));
        }
