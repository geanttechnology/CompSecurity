...
_L6:
        return false;
_L4:
        a.a(TAG, String.format("GCM deleted %d messages. Fetch them from Appboy.", new Object[] {
            Integer.valueOf(i)
        }));
        return false;
_L2:
...
_L5:
    ...
    final boolean handleRegistrationEventIfEnabled(b b1, Context context, Intent intent)
    {
        if (b1.c())
        {
    ...
    final boolean handleRegistrationIntent(Context context, Intent intent)
    {
        ...
        if (s != null)
        {
            ...
            {
                a.b(TAG, String.format("Received an unrecognised GCM registration error type. Ignoring. Error: %s", new Object[] {
                    s
                }));
            }
        } else
        ...
        {
            a.b(TAG, "The GCM registration message is missing error information, registration id, and unregistration confirmation. Ignoring.");
            return false;
        }
        return true;
    }
    ...
    {
        a.a(TAG, String.format("Received broadcast message. Message: %s", new Object[] {
            intent.toString()
        }));
        String s = intent.getAction();
        if ("com.google.android.c2dm.intent.REGISTRATION".equals(s))
        {
            handleRegistrationEventIfEnabled(new b(context), context, intent);
            return;
        }
        ...
        {
            a.b(TAG, String.format("The GCM receiver received a message not sent from Appboy. Ignoring the message.", new Object[0]));
            return;
        }
    }
    ...
    private class HandleAppboyGcmMessageTask extends AsyncTask
    {
