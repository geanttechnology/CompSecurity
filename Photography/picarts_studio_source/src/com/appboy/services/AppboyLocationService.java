...
public class AppboyLocationService extends Service
{
    ...
    public int onStartCommand(Intent intent, int i, int j)
    {
        if (intent == null)
        {
            myobfuscated.i.a.a(a, "Null intent received. Initializing Appboy and restarting Appboy location service.");
        ...
        if (s == null)
        {
            myobfuscated.i.a.b(a, (new StringBuilder("Null intent action received in Appboy location service: ")).append(intent.getDataString()).toString());
            return 1;
        }
        if (s.contains((new StringBuilder()).append(getApplicationContext().getPackageName()).append(".INIT_APPBOY_LOCATION_SERVICE").toString()))
        {
            myobfuscated.i.a.a(a, (new StringBuilder("Setting up Appboy location service: ")).append(intent.getAction()).toString());
        ...
        {
            myobfuscated.i.a.a(a, (new StringBuilder("Requesting background location updates: ")).append(intent.getAction()).toString());
            if (b == null)
            {
                myobfuscated.i.a.a(a, "Could not request background location updates. Android location provider was null.");
                return 1;
            }
            ...
            if (c != null)
            {
                ...
                myobfuscated.i.a.a(a, String.format("Collecting locations using %s provider with time interval %ds and update distance %.1fm.", new Object[] {
                    b, Long.valueOf(l / 1000L), Float.valueOf(f)
                }));
                return 1;
            } else
            {
                myobfuscated.i.a.b(a, "Could not request background location updates. Appboy location listener was null.");
                return 1;
            }
        }
        if (s.contains((new StringBuilder()).append(e).append(".REQUEST_REMOVE_APPBOY_LOCATION_UPDATES").toString()))
        {
            myobfuscated.i.a.a(a, (new StringBuilder("Removing current location updates: ")).append(intent.getAction()).toString());
            b();
            return 1;
        } else
        {
            myobfuscated.i.a.b(a, (new StringBuilder("Unknown intent received: ")).append(intent.getAction()).toString());
            return 1;
        }
    }
