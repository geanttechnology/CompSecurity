...
public final class z
{
    ...
    public static Bitmap a(g g1, Bitmap bitmap, int i)
    {
...
_L9:
        ...
        } else
        {
            ...
            g1 = g1.a(Math.round(((RectF) (obj)).width()), Math.round(((RectF) (obj)).height()), a(bitmap));
...
_L7:
    ...
    public static Bitmap a(g g1, Bitmap bitmap, int i, int j)
    {
        float f = 0.0F;
        ...
        g1 = g1.a(i, j, a(bitmap));
        a(bitmap, ((Bitmap) (g1)));
        canvas = new Canvas(g1);
    ...
    public static Bitmap b(g g1, Bitmap bitmap, int i, int j)
    {
        if (bitmap.getWidth() == i && bitmap.getHeight() == j)
        {
        ...
        if (Log.isLoggable("TransformationUtils", 2))
        {
            ...
            (new StringBuilder("toReuse: ")).append(g1.getWidth()).append("x").append(g1.getHeight());
        }
    ...
    public static Bitmap c(g g1, Bitmap bitmap, int i, int j)
    {
        int k = Math.min(i, j);
        ...
        {
            bitmap1 = g1.a(bitmap.getWidth(), bitmap.getHeight(), android.graphics.Bitmap.Config.ARGB_8888);
            (new Canvas(bitmap1)).drawBitmap(bitmap, 0.0F, 0.0F, null);
        }
        bitmap2 = g1.a(i, j, a(bitmap1));
        a(bitmap2, true);
