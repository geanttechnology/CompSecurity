...
public class FacebookActivity extends FragmentActivity
{
    ...
    public void onConfigurationChanged(Configuration configuration)
    {
        ...
        if (getCallingActivity() != null && "com.picsart.studio.ImagePickerActivity".equals(getCallingActivity().getClassName()))
        {
            finish();
        }
    ...
    public void onCreate(Bundle bundle)
    {
        ...
        setContentView(com.facebook.android.R.layout.com_facebook_activity_layout);
        Intent intent = getIntent();
        ...
        if (fragment == null)
        {
            ...
            } else
            {
                ...
                bundle.setRetainInstance(true);
                fragmentmanager.beginTransaction().add(com.facebook.android.R.id.com_facebook_fragment_container, bundle, FRAGMENT_TAG).commit();
            }
        }
