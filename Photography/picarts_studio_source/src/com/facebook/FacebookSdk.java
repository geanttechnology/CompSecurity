        ...
        if (context != null)
        {
            ...
            if (context != null && ((ApplicationInfo) (context)).metaData != null)
            {
                if (applicationId == null)
                {
                    ...
                    {
                        String s = (String)obj;
                        if (s.toLowerCase(Locale.ROOT).startsWith("fb"))
                        {
                            applicationId = s.substring(2);
                        } else
                        {
                            applicationId = s;
                        }
...
_L5:
    ...
    public static void sdkInitialize(Context context, final InitializeCallback callback)
    {
        com/facebook/FacebookSdk;
        JVM INSTR monitorenter ;
