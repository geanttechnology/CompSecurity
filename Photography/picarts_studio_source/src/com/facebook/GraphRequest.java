...
_L8:
        ...
        if (!java/util/Date.isAssignableFrom(((Class) (obj1)))) goto _L5; else goto _L9
_L9:
        obj = (Date)obj;
...
_L1:
    ...
    static final boolean shouldWarnOnMissingFieldsParam(GraphRequest graphrequest)
    {
        ...
        return graphrequest.length >= 2 && Integer.parseInt(graphrequest[0]) > 2 || Integer.parseInt(graphrequest[0]) >= 2 && Integer.parseInt(graphrequest[1]) >= 4;
    }
