    ...
    implements FacebookDialog
{
    ...
    public FacebookDialogBase(Activity activity1, int i)
    {
    ...
    public FacebookDialogBase(Fragment fragment1, int i)
    {
...
_L3:
    ...
    public boolean canShowImpl(Object obj, Object obj1)
    {
        Iterator iterator;
        boolean flag;
        if (obj1 == BASE_AUTOMATIC_MODE)
    ...
    public abstract void registerCallbackImpl(CallbackManagerImpl callbackmanagerimpl, FacebookCallback facebookcallback);
    ...
    public void showImpl(Object obj, Object obj1)
    {
