    ...
    implements lh.a
{
    ...
    private final Runnable c = new lr() {
    ...
    public id()
    {
        ...
        i = new jv(jo.a().c().getFileStreamPath(o()), ".yflurryprotonconfig.", 1, new la() {
        ...
        j = new jv(jo.a().c().getFileStreamPath(p()), ".yflurryprotonreport.", 1, new la() {
...
_L12:
        ...
        kj1.b(new kt());
        kj1.a(abyte0);
        kj1.a(new kj.a(l1, flag) {

            final long a;
            final boolean b;
            final id c;

            public volatile void a(kj kj2, Object obj1)
            {
                a(kj2, (byte[])obj1);
            }

            public void a(kj kj2, byte abyte1[])
            {
                Object obj1;
                int i1;
                obj1 = null;
...
_L2:
            ...
            
            {
                ...
                try
                {
                    abyte1 = (hq)id.e(c).d(abyte1);
                }
                // Misplaced declaration of an exception variable
                catch (byte abyte1[])
                {
                    kc.a(5, id.e(), (new StringBuilder("Failed to decode proton config response: ")).append(abyte1).toString());
                    abyte1 = null;
                }
                hq1 = abyte1;
                if (!id.a(c, abyte1))
...
_L5:
                kj2 = kj2.b("Retry-After");
                if (kj2.isEmpty()) goto _L6; else goto _L7
_L7:
                kj2 = (String)kj2.get(0);
                kc.a(3, id.e(), (new StringBuilder("Server returned retry time: ")).append(kj2).toString());
                l3 = Long.parseLong(kj2);
                l2 = l3 * 1000L;
_L9:
                id.a(c, l2);
