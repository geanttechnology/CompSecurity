...
public class if extends ko
{
    ...
    protected jv a()
    {
        return new jv(jo.a().c().getFileStreamPath(".yflurryanpulsecallbackreporter"), ".yflurryanpulsecallbackreporter", 2, new la() {
    ...
    protected void a(ig ig1)
    {
        ...
        kj1.b(false);
        kj1.a(new kj.a(ig1, ih1) {

            final ig a;
            final ih b;
            final if c;

            public volatile void a(kj kj2, Object obj)
            {
                a(kj2, (String)obj);
            }

            public void a(kj kj2, String s1)
            {
                kc.a(3, if.b(), (new StringBuilder("Pulse report to ")).append(a.i()).append(" for ").append(a.m()).append(", HTTP status code is: ").append(kj2.h()).toString());
                int i = kj2.h();
                b.a((int)kj2.c());
                b.e = i;
                if (!kj2.f())
                {
                    Exception exception = kj2.j();
                    if (kj2.d())
                    {
                        if (kj2.i())
                        {
                            kc.a(3, if.b(), (new StringBuilder("Timeout occured when trying to connect to: ")).append(a.i()).append(". Exception: ").append(kj2.j().getMessage()).toString());
                        } else
                        {
