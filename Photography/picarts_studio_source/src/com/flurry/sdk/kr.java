...
public class kr
{
    ...
    private void a(String s, List list, String s1)
    {
        ...
        s = new jv(jo.a().c().getFileStreamPath(g(s)), s1, 1, new la() {
    ...
    private void a(String s, byte abyte0[])
    {
        ...
        (new jv(jo.a().c().getFileStreamPath(kq.a(s)), ".yflurrydatasenderblock.", 1, new la() {
...
_L7:
        ...
        do
        {
          ...
          goto _L3
_L2:
        s = (List)(new jv(jo.a().c().getFileStreamPath(g(b)), s, 1, new la() {
...
_L6:
    ...
    private List h(String s)
    {
        ...
        Object obj = (List)(new jv(jo.a().c().getFileStreamPath(g(s)), ".YFlurrySenderIndex.info.", 1, new la() {
...
_L5:
    ...
    void b()
    {
        (new jv(jo.a().c().getFileStreamPath(g(b)), ".YFlurrySenderIndex.info.", 1, new la() {
    ...
    boolean b(String s)
    {
        return (new jv(jo.a().c().getFileStreamPath(kq.a(s)), ".yflurrydatasenderblock.", 1, new la() {
    ...
    public boolean d(String s)
    {
        ...
        Object obj;
        lp.b();
        jv1 = new jv(jo.a().c().getFileStreamPath(g(s)), ".YFlurrySenderIndex.info.", 1, new la() {
