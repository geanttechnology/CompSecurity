...
_L3:
    ...
    protected void zza(com.google.android.gms.internal.zzhs.zza zza1, zzcg zzcg)
    {
        ...
        {
            zzid.zzIE.post(new Runnable(zza1, zzcg) {
                ...
                public void run()
                {
                    ...
                    zziz1.setOnTouchListener(new android.view.View.OnTouchListener(this, zze1) {
            ...
            
            {
                ...
                super();
                    ...
                    zziz1.setOnClickListener(new android.view.View.OnClickListener(this, zze1) {
