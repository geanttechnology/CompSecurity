    ...
    private class zza extends ViewSwitcher
    {
        ...
        public void removeAllViews()
        {
            ...
            for (int i = 0; i < getChildCount(); i++)
            {
                ...
                if (view != null && (view instanceof zziz))
                {
                    ((List) (obj)).add((zziz)view);
                }
            }

            super.removeAllViews();
            for (obj = ((List) (obj)).iterator(); ((Iterator) (obj)).hasNext(); ((zziz)((Iterator) (obj)).next()).destroy()) { }
        }
        ...
        {
            super(context1);
            zzqQ = new zzif(context1);
            if (context1 instanceof Activity)
            {
                zzqR = new zzim((Activity)context1, ongloballayoutlistener, onscrollchangedlistener);
                zzqR.zzgO();
                return;
            } else
            {
