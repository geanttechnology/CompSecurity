...
public class AppInviteReferral
{
    ...
    private static Bundle zzh(Intent intent)
    {
        ...
        {
            Log.e("AppInviteReferral", (new StringBuilder("Error parsing Play Store referrer URL: ")).append(s).toString());
            return null;
        }
        obj = Uri.parse((new StringBuilder("s://a.b.c?")).append(intent).toString());
        s = ((Uri) (obj)).getQueryParameter("invitation_id");
        obj = ((Uri) (obj)).getQueryParameter("deep_link_id");
        if (s == null && obj == null)
        {
            Log.w("AppInviteReferral", (new StringBuilder("Missing  Referrer query params: ")).append(intent).toString());
            return null;
        } else
        {
