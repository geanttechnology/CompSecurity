    ...
    implements SafeParcelable
{
    ...
    public final boolean equals(Object obj)
    {
        if (obj != this)
        {
            ...
            if (zzYm != ((ConnectionResult) (obj)).zzYm || !zzw.equal(mPendingIntent, ((ConnectionResult) (obj)).mPendingIntent) || !zzw.equal(zzZZ, ((ConnectionResult) (obj)).zzZZ))
            {
                return false;
            }
        }
    ...
    {
        return zzYm != 0 && mPendingIntent != null;
    }

    public final int hashCode()
    {
        return zzw.hashCode(new Object[] {
            Integer.valueOf(zzYm), mPendingIntent, zzZZ
        });
    }
    ...
    {
        return zzw.zzv(this).zzg("statusCode", getStatusString(zzYm)).zzg("resolution", mPendingIntent).zzg("message", zzZZ).toString();
    }
