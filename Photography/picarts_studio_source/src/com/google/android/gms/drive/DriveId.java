...
label0:
    ...
    {
        zzx.zzb(s.startsWith("DriveId:"), (new StringBuilder("Invalid DriveId: ")).append(s).toString());
        return zzk(Base64.decode(s.substring(8), 10));
    }
    ...
    public final String encodeToString()
    {
        if (zzaix == null)
        {
            ...
            zzaix = (new StringBuilder("DriveId:")).append(s).toString();
        }
        return zzaix;
    }
...
_L2:
        ...
        if (((DriveId) (obj)).zzaiN != zzaiN) goto _L1; else goto _L3
_L3:
        return true;
        if (((DriveId) (obj)).zzaiN != zzaiN) goto _L1; else goto _L4
_L4:
