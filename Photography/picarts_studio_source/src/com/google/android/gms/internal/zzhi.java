...
label0:
    ...
    public void zzbn()
    {
        ...
        zza.zzJt.post(new Runnable(zzen1, adrequestparcel) {
...
_L1:
        ...
        try
        {
            zza.zzJt.post(new Runnable(zzen1, adrequestparcel, zzhl1) {
                ...
                public void run()
                {
                    ...
                    {
                        com.google.android.gms.ads.internal.util.client.zzb.zzd((new StringBuilder("Fail to initialize adapter ")).append(com.google.android.gms.internal.zzhi.zzb(zzHl)).toString(), remoteexception1);
                    }
                    zzHl.zzb(com.google.android.gms.internal.zzhi.zzb(zzHl), 0);
                }
