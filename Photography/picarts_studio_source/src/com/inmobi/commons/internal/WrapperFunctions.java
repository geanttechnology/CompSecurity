...
public class WrapperFunctions
{
    ...
    private static void a(WebView webview, int i)
    {
        ...
        {
            Log.internal("[InMobi]-4.5.2", "Cannot set hardware accl", webview);
            return;
        }
        // Misplaced declaration of an exception variable
        catch (WebView webview)
    ...
    {
        Object obj = android/view/Display.getMethod("getSize", new Class[] {
...
_L2:
        ...
        try
        {
            ...
            ((Method) (obj)).invoke(display, new Object[] {
                point
            });
            i = point.y;
        }
        ...
        {
            Log.internal("[InMobi]-4.5.2", "Cannot get display height", display);
            return 0;
        }
        // Misplaced declaration of an exception variable
        catch (Display display)
        ...
        return i;
        obj;
        obj = android/view/Display.getMethod("getHeight", null);
        i = 0;
        continue; /* Loop/switch isn't completed */
        obj;
        Log.internal("[InMobi]-4.5.2", "Cannot get display height", ((Throwable) (obj)));
        obj = null;
        i = 0;
        if (true) goto _L2; else goto _L1
_L1:
        i = ((Integer)((Method) (obj)).invoke(display, null)).intValue();
        return i;
    }
...
_L2:
        ...
        {
            Log.internal("[InMobi]-4.5.2", "Cannot get display width", display);
            return 0;
        }
        // Misplaced declaration of an exception variable
        catch (Display display)
        ...
        return i;
        obj;
        obj = android/view/Display.getMethod("getWidth", null);
        i = 0;
        continue; /* Loop/switch isn't completed */
        obj;
        Log.internal("[InMobi]-4.5.2", "Cannot get display width", ((Throwable) (obj)));
        obj = null;
        i = 0;
        if (true) goto _L2; else goto _L1
_L1:
    ...
    public static int getParamConfigScreenSize()
    {
        ...
        {
            Log.internal("[InMobi]-4.5.2", "Cannot get screen size", nosuchfieldexception);
            return 0;
        }
        catch (Exception exception)
        {
            Log.internal("[InMobi]-4.5.2", "Cannot get screen size", exception);
            return 0;
        }
        if (field == null)
        {
    ...
    public static int getParamConfigSmallestScreenSize()
    {
        ...
        {
            Log.internal("[InMobi]-4.5.2", "Cannot get smallest screen size", nosuchfieldexception);
            return 0;
        }
        catch (Exception exception)
        {
            Log.internal("[InMobi]-4.5.2", "Cannot get smallest screen size", exception);
            return 0;
        }
        if (field == null)
        {
...
_L2:
        ...
        Log.internal("[InMobi]-4.5.2", "Cannot get fill parent param", ((Throwable) (obj)));
        obj = null;
        continue; /* Loop/switch isn't completed */
        obj;
        Log.internal("[InMobi]-4.5.2", "Cannot get fill parent param", ((Throwable) (obj)));
...
_L6:
    ...
    public static int getParamLandscapeOrientation(int i)
    {
        ...
        {
            Log.internal("[InMobi]-4.5.2", "Cannot get landscape orientation", nosuchfieldexception);
            return 0;
        }
        catch (Exception exception)
        {
            Log.internal("[InMobi]-4.5.2", "Cannot get landscape orientation", exception);
            return 0;
        }
        j = ((flag) ? 1 : 0);
        if (field == null)
    ...
    public static int getParamPortraitOrientation(int i)
    {
        ...
        {
            Log.internal("[InMobi]-4.5.2", "Cannot get portrait orientation", nosuchfieldexception);
            return 1;
        }
        catch (Exception exception)
        {
            Log.internal("[InMobi]-4.5.2", "Cannot get portrait orientation", exception);
            return 1;
        }
        j = ((flag) ? 1 : 0);
        if (field == null)
    ...
    public static String getSSLErrorUrl(SslError sslerror)
    {
        ...
        {
            Log.internal("[InMobi]-4.5.2", "Cannot get SSL Url", sslerror);
            return null;
        }
        return sslerror;
    }
    ...
    public static Bitmap getVideoBitmap(String s)
    {
        ...
        {
            Log.internal("[InMobi]-4.5.2", "Cannot get video bitmap", s);
            throw s;
        }
        return s;
    }
