...
public class JSDisplayController extends JSController
{
    ...
    private JSController.ExpandProperties a(JSController.ExpandProperties expandproperties)
    {
        ...
        Log.debug("[InMobi]-[RE]-4.5.2", (new StringBuilder("Device current rotation: ")).append(j).toString());
        Log.debug("[InMobi]-[RE]-4.5.2", (new StringBuilder("Density of device: ")).append(b).toString());
        ...
        Log.debug("[InMobi]-[RE]-4.5.2", (new StringBuilder("Device Width: ")).append(k).append(" Device height: ").append(l).toString());
        ...
        if (expandproperties.y < 0)
        {
            ...
            Log.debug("[InMobi]-[RE]-4.5.2", (new StringBuilder("topStuff: ")).append(expandproperties.topStuff).append(" ,bottomStuff: ").append(expandproperties.bottomStuff).toString());
        }
        Log.debug("[InMobi]-[RE]-4.5.2", (new StringBuilder("loc 0: ")).append(ai[0]).append(" loc 1: ").append(ai[1]).toString());
    ...
    public void close()
    {
        ...
        try
        {
            ...
            Log.debug("[InMobi]-[RE]-4.5.2", "JSDisplayController-> close");
        ...
        {
            Log.internal("[InMobi]-[RE]-4.5.2", "Exception while closing the ad. ", exception);
            return;
        }
        if (activity == null)
        {
    ...
    public void expand(String s)
    {
        ...
        Log.debug("[InMobi]-[RE]-4.5.2", (new StringBuilder("JSDisplayController-> expand: url: ")).append(s).toString());
        try
        {
            ...
            {
                Log.debug("[InMobi]-[RE]-4.5.2", "JSDisplayController-> Already expanded state");
                return;
            }
        }
        ...
        {
            Log.debug("[InMobi]-[RE]-4.5.2", "Exception while expanding the ad. ", s);
            return;
        }
        if (imWebView.getStateVariable() == com.inmobi.re.container.IMWebView.ViewState.HIDDEN)
        {
            Log.debug("[InMobi]-[RE]-4.5.2", "JSDisplayController-> Expand cannot be called in hidden state. Doing nothing.");
            return;
        }
        ...
        Log.debug("[InMobi]-[RE]-4.5.2", (new StringBuilder("JSDisplayController-> At the time of expand the properties are: Expandable width: ")).append(temporaryexpProps.width).append(" Expandable height: ").append(temporaryexpProps.height).append(" Expandable orientation: ").append(temporaryexpProps.orientation).append(" Expandable lock orientation: ").append(temporaryexpProps.lockOrientation).append(" Expandable Modality: ").append(temporaryexpProps.isModal).append(" Expandable Use custom close ").append(temporaryexpProps.useCustomClose).toString());
        expProps = a(expProps);
...
_L2:
    ...
    public String getOrientation()
    {
        ...
        try
        {
            ...
            Log.debug("[InMobi]-[RE]-4.5.2", (new StringBuilder("JSDisplayController-> getOrientation: ")).append(s).toString());
        }
        catch (Exception exception)
        {
            Log.debug("[InMobi]-[RE]-4.5.2", (new StringBuilder("Error getOrientation: ")).append("-1").toString(), exception);
            return "-1";
        }
        return s;
    }
    ...
    public boolean isViewable()
    {
        ...
        Log.debug("[InMobi]-[RE]-4.5.2", (new StringBuilder("JSDisplayController-> isViewable")).append(imWebView.isViewable()).toString());
    ...
    public void open(String s)
    {
        ...
        Log.debug("[InMobi]-[RE]-4.5.2", (new StringBuilder("JSDisplayController-> open: url: ")).append(s).toString());
        imWebView.openURL(s);
    }
    ...
    public void resize()
    {
        ...
        {
            Log.debug("[InMobi]-[RE]-4.5.2", "Exception while expanding the ad. ", exception);
            return;
        }
        if (imWebView.getStateVariable() == com.inmobi.re.container.IMWebView.ViewState.HIDDEN)
        {
        ...
        Log.debug("[InMobi]-[RE]-4.5.2", (new StringBuilder("JSDisplayController-> At the time of resize the properties are: Resize width: ")).append(resizeproperties.width).append(" Resize height: ").append(resizeproperties.height).append(" Resize offsetX: ").append(resizeproperties.offsetX).append(" Resize offsetY: ").append(resizeproperties.offsetY).append(" customClosePosition: ").append(resizeproperties.customClosePosition).append(" allowOffscreen: ").append(resizeproperties.allowOffscreen).toString());
    ...
    public void setExpandProperties(String s)
    {
        ...
        Log.debug("[InMobi]-[RE]-4.5.2", (new StringBuilder("JSDisplayController-> ExpandProperties is set: Expandable Width: ")).append(expProps.width).append(" Expandable height: ").append(expProps.height).append(" Expandable orientation: ").append(expProps.orientation).append(" Expandable lock orientation: ").append(expProps.lockOrientation).append(" Expandable Modality: ").append(expProps.isModal).append(" Expandable Use Custom close: ").append(expProps.useCustomClose).toString());
        ...
        return;
        s;
        Log.debug("[InMobi]-[RE]-4.5.2", (new StringBuilder("Exception while setting the expand properties ")).append(s).toString());
        return;
    }
    ...
    public void setOrientationProperties(String s)
    {
        ...
        try
        {
            ...
            Log.debug("[InMobi]-[RE]-4.5.2", (new StringBuilder("JSDisplayController-> OrientationProperties is set: Expandable orientation: ")).append(expProps.orientation).append(" Expandable lock orientation: ").append(expProps.lockOrientation).toString());
    ...
    public void setResizeProperties(String s)
    {
        ...
        try
        {
            ...
            Log.debug("[InMobi]-[RE]-4.5.2", (new StringBuilder("JSDisplayController-> ResizeProperties is set: Resize Width: ")).append(d.width).append(" Resize height: ").append(d.height).append(" Resize offsetX: ").append(d.offsetX).append(" Resize offsetY: ").append(d.offsetY).append(" customClosePosition: ").append(d.customClosePosition).append(" allowOffscreen: ").append(d.allowOffscreen).toString());
            return;
        }
        // Misplaced declaration of an exception variable
        catch (String s)
    ...
    public void useCustomClose(boolean flag)
    {
        ...
        Log.debug("[InMobi]-[RE]-4.5.2", (new StringBuilder("JSDisplayController-> useCustomClose")).append(flag).toString());
