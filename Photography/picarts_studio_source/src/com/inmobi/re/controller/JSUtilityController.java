...
_L1:
    ...
    public void asyncPing(String s)
    {
        ...
        try
        {
            Log.debug("[InMobi]-[RE]-4.5.2", (new StringBuilder("JSUtilityController-> asyncPing: url: ")).append(s).toString());
    ...
    public void closeVideo(String s)
    {
        ...
        Log.debug("[InMobi]-[RE]-4.5.2", (new StringBuilder("JSUtilityController-> closeVideo: id :")).append(s).toString());
            ...
            String s7, String s8, String s9)
    {
        ...
        Log.debug("[InMobi]-[RE]-4.5.2", (new StringBuilder("JSUtilityController-> createEvent: date: ")).append(s1).append(" location: ").append(s3).append(" body: ").append(s4).toString());
        if (!supports("calendar"))
        {
            Log.internal("[InMobi]-[RE]-4.5.2", "createCalendarEvent called even if it is not supported");
        ...
        if (gregoriancalendar == null || s2 == null)
        {
            try
            {
                Log.debug("[InMobi]-[RE]-4.5.2", "exception");
            ...
            {
                Log.internal("[InMobi]-[RE]-4.5.2", "Error creating reminder event", s);
            }
            return;
        }
        Intent intent;
    ...
    public int getAudioVolume(String s)
    {
        ...
        Log.debug("[InMobi]-[RE]-4.5.2", "JSUtilityController-> getAudioVolume: ");
    ...
    public String getCurrentPosition()
    {
        ...
        Log.debug("[InMobi]-[RE]-4.5.2", "JSUtilityController-> getCurrentPosition");
...
_L1:
        ...
        Object obj1;
        obj1;
        Log.debug("[InMobi]-[RE]-4.5.2", "mutexcPos failed ", ((Throwable) (obj1)));
          goto _L1
        obj1;
        obj;
    ...
    public String getDefaultPosition()
    {
        ...
        Log.debug("[InMobi]-[RE]-4.5.2", "JSUtilityController-> getDefaultPosition");
...
_L1:
        ...
        Object obj1;
        obj1;
        Log.debug("[InMobi]-[RE]-4.5.2", "mutexdPos failed ", ((Throwable) (obj1)));
          goto _L1
        obj1;
        obj;
        JVM INSTR monitorexit ;
        ...
        obj;
        JVM INSTR monitorexit ;
        Log.debug("[InMobi]-[RE]-4.5.2", (new StringBuilder("mutexdPassed")).append(imWebView.defPosition).toString());
    ...
    public String getGalleryImage()
    {
        ...
        {
            Log.internal("[InMobi]-[RE]-4.5.2", "getGalleryImage called even if it is not supported");
        } else
        {
    ...
    public String getScreenSize()
    {
        ...
        Log.debug("[InMobi]-[RE]-4.5.2", "JSUtilityController-> getScreenSize");
        ...
        {
            Log.debug("[InMobi]-[RE]-4.5.2", "Failed to get screen size");
        }
    ...
    public int getVideoVolume(String s)
    {
        ...
        Log.debug("[InMobi]-[RE]-4.5.2", "JSUtilityController-> getVideoVolume: ");
    ...
    public void hideVideo(String s)
    {
        ...
        Log.debug("[InMobi]-[RE]-4.5.2", (new StringBuilder("JSUtilityController-> hideVideo: id :")).append(s).toString());
...
_L1:
        ...
        catch (String s)
        {
            ...
            {
                Log.internal("[InMobi]-[RE]-4.5.2", "JSON error");
            }
    ...
    public boolean isAudioMuted(String s)
    {
        ...
        Log.debug("[InMobi]-[RE]-4.5.2", "JSUtilityController-> isAudioMuted: ");
    ...
    public boolean isVideoMuted(String s)
    {
        ...
        Log.debug("[InMobi]-[RE]-4.5.2", "JSUtilityController-> isVideoMuted: ");
        return imWebView.isVideoMuted(s);
    }

    public void log(String s)
    {
        Log.debug("[InMobi]-[RE]-4.5.2", (new StringBuilder("Ad Log Message: ")).append(s).toString());
    }
    ...
    public void makeCall(String s)
    {
        ...
        Log.debug("[InMobi]-[RE]-4.5.2", (new StringBuilder("JSUtilityController-> makeCall: number: ")).append(s).toString());
        s = b(s);
        if (s == null)
        {
            try
            ...
            {
                Log.debug("[InMobi]-[RE]-4.5.2", "Exception in making call ", s);
            }
    ...
    public void muteAudio(String s)
    {
        ...
        Log.debug("[InMobi]-[RE]-4.5.2", "JSUtilityController-> muteAudio: ");
    ...
    public void muteVideo(String s)
    {
        ...
        Log.debug("[InMobi]-[RE]-4.5.2", "JSUtilityController-> muteVideo: ");
...
_L1:
    ...
    public void openExternal(String s)
    {
        ...
        Log.debug("[InMobi]-[RE]-4.5.2", (new StringBuilder("JSUtilityController-> openExternal: url: ")).append(s).toString());
    ...
    public void pauseAudio(String s)
    {
        ...
        Log.debug("[InMobi]-[RE]-4.5.2", (new StringBuilder("JSUtilityController-> pauseAudio: id :")).append(s).toString());
    ...
    public void pauseVideo(String s)
    {
        ...
        Log.debug("[InMobi]-[RE]-4.5.2", (new StringBuilder("JSUtilityController-> pauseVideo: id :")).append(s).toString());
    ...
    public void playAudio(String s, boolean flag, boolean flag1, boolean flag2, String s1, String s2, String s3)
    {
        ...
        Log.debug("[InMobi]-[RE]-4.5.2", (new StringBuilder("playAudio: url: ")).append(s).append(" autoPlay: ").append(flag).append(" controls: ").append(flag1).append(" loop: ").append(flag2).append(" startStyle: ").append(s1).append(" stopStyle: ").append(s2).append(" id:").append(s3).toString());
    ...
    public void registerBroadcastListener()
    {
        ...
        {
            Log.internal("[InMobi]-[RE]-4.5.2", "JSUtilityController-> registerBroadcastListener. Unable to register download listener", exception);
            return;
        }
        b = null;
        return;
    ...
    {
        Object obj = InternalSDKUtil.getContext();
        ...
        obj = new File(((File) (obj)), stringbuilder.toString());
        imWebView.saveFile(((File) (obj)), s1, s);
    }
    ...
    public void seekAudio(String s, int j)
    {
        ...
        Log.debug("[InMobi]-[RE]-4.5.2", "JSUtilityController-> seekAudio: ");
    ...
    public void seekVideo(String s, int j)
    {
        ...
        Log.debug("[InMobi]-[RE]-4.5.2", "JSUtilityController-> seekVideo: ");
    ...
    public void sendMail(String s, String s1, String s2)
    {
        ...
        Log.debug("[InMobi]-[RE]-4.5.2", (new StringBuilder("JSUtilityController-> sendMail: recipient: ")).append(s).append(" subject: ").append(s1).append(" body: ").append(s2).toString());
        try
        {
        ...
        {
            Log.debug("[InMobi]-[RE]-4.5.2", "Exception in sending mail ", s);
        }
    ...
    public void sendSMS(String s, String s1)
    {
        ...
        Log.debug("[InMobi]-[RE]-4.5.2", (new StringBuilder("JSUtilityController-> sendSMS: recipient: ")).append(s).append(" body: ").append(s1).toString());
        try
        {
            s = new Intent("android.intent.action.SENDTO", Uri.parse((new StringBuilder("smsto:")).append(Uri.encode(s)).toString()));
        ...
        {
            Log.debug("[InMobi]-[RE]-4.5.2", "Exception in sending SMS ", s);
        }
    ...
    public void setAudioVolume(String s, int j)
    {
        ...
        Log.debug("[InMobi]-[RE]-4.5.2", (new StringBuilder("JSUtilityController-> setAudioVolume: ")).append(s).append(" ").append(j).toString());
...
_L1:
        ...
        catch (JSONException jsonexception)
        {
            try
            {
                Log.internal("[InMobi]-[RE]-4.5.2", (new StringBuilder("Playable Ads Settings map key ")).append(s1).append(" has invalid value").toString());
            }
            // Misplaced declaration of an exception variable
            catch (String s)
            {
                Log.internal("[InMobi]-[RE]-4.5.2", "Exception setting playable settings", s);
                return;
            }
        }
          goto _L1
    ...
    public void setVideoVolume(String s, int j)
    {
        ...
        Log.debug("[InMobi]-[RE]-4.5.2", "JSUtilityController-> setVideoVolume: ");
    ...
    public void showVideo(String s)
    {
        ...
        Log.debug("[InMobi]-[RE]-4.5.2", (new StringBuilder("JSUtilityController-> showVideo: id :")).append(s).toString());
    ...
    public void storePicture(String s)
    {
        ...
        Log.debug("[InMobi]-[RE]-4.5.2", (new StringBuilder("Store picture called on URL: ")).append(s).toString());
...
_L5:
        if (!((Boolean) (obj)).booleanValue() || !vibrator.hasVibrator()) goto _L4; else goto _L7
_L7:
        flag4 = flag5;
_L8:
        obj = Boolean.valueOf(flag4);
...
_L2:
    ...
    public String takeCameraPicture()
    {
        ...
        {
            Log.internal("[InMobi]-[RE]-4.5.2", "takeCameraPicture called even if it is not supported");
        } else
        {
            Intent intent = new Intent(imWebView.getActivity(), com/inmobi/androidsdk/IMBrowserActivity);
            intent.putExtra("extra_browser_type", 100);
    ...
    public void unMuteAudio(String s)
    {
        ...
        Log.debug("[InMobi]-[RE]-4.5.2", "JSUtilityController-> unMuteAudio: ");
    ...
    public void unMuteVideo(String s)
    {
        ...
        Log.debug("[InMobi]-[RE]-4.5.2", "JSUtilityController-> unMuteVideo: ");
    ...
    public void unRegisterBroadcastListener()
    {
        ...
        {
            Log.internal("[InMobi]-[RE]-4.5.2", "JSUtilityController-> unregisterBroadcastListener. Unable to unregister download listener");
        }
    }
    ...
    public void vibrate()
    {
        ...
        {
            Log.internal("[InMobi]-[RE]-4.5.2", "vibrate called even if it is not supported");
            return;
        }
    }
    ...
    public void vibrate(String s, int j)
    {
        ...
        {
            Log.internal("[InMobi]-[RE]-4.5.2", "vibrate exception", s);
            return;
        }
...
_L1:
        ...
        {
            Log.internal("[InMobi]-[RE]-4.5.2", (new StringBuilder("vibration pattern exceeds max length. Will be truncated to max ")).append(Initializer.getConfigParams().getMaxVibPatternLength()).append("ms").toString());
...
_L3:
        ...
        {
            Log.internal("[InMobi]-[RE]-4.5.2", (new StringBuilder("vibration duration exceeds max. Will only vibrate for max ")).append(Initializer.getConfigParams().getMaxVibDuration()).append("ms").toString());
