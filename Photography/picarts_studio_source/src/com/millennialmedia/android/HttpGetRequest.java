...
_L6:
        inputstream = ((InputStream) (obj));
        MMLog.a("HttpGetRequest", "Out of Memeory: ", ((Throwable) (obj1)));
        inputstream = ((InputStream) (obj));
...
_L4:
        if (obj != null)
        {
            ...
            {
                MMLog.a("HttpGetRequest", "Error closing file", ((Throwable) (obj)));
            }
        }
        throw inputstream;
_L1:
        ...
        {
            MMLog.a("HttpGetRequest", "Error closing file", inputstream);
        }
...
_L5:
    ...
    final HttpResponse a(String s)
    {
        ...
        if (!TextUtils.isEmpty(s))
        {
            ...
            {
                MMLog.a("HttpGetRequest", "Out of memory!", s);
                return null;
            }
            // Misplaced declaration of an exception variable
            catch (String s)
            {
                MMLog.a("HttpGetRequest", "Error connecting:", s);
                return null;
            }
        }
        return httpresponse;
