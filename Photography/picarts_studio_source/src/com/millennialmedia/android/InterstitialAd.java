    ...
    implements Parcelable, Externalizable
{
    ...
    InterstitialAd(Parcel parcel)
    {
        ...
        {
            MMLog.a(TAG, "Interstitial problem reading parcel: ", parcel);
        }
    }
    ...
    private Intent getExpandExtrasIntent(Context context, long l)
    {
        ...
        overlaysettings.q = l;
        overlaysettings.l = content;
        overlaysettings.m = adUrl;
        overlaysettings.n = mmHeaders;
...
_L1:
        if (content == null || content.length() <= 0 || adUrl == null || adUrl.length() <= 0 || !HandShake.a(context).a(mmadimpl.e, deferredViewStart)) goto _L4; else goto _L3
_L3:
        return true;
_L4:
        return false;
...
_L5:
    ...
    {
        Utils.IntentUtils.a(context, getExpandExtrasIntent(context, l));
    }
