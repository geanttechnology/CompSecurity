...
public class MMBroadcastReceiver extends BroadcastReceiver
{
    ...
    public void intentStarted(MMAd mmad, String s)
    {
        if (s != null)
        {
            MMLog.c("MMBroadcastReceiver", (new StringBuilder("Millennial Media started intent: ")).append(s).toString());
        }
    }
    ...
    public void onReceive(Context context, Intent intent)
    {
        ...
        if (context.getPackageName().equals(s2))
        {
            ...
            if (l != -4L)
            {
                MMAdImpl mmadimpl = MMAdImplController.a(l);
                context = s;
                if (mmadimpl != null)
                {
                    context = mmadimpl.d();
            ...
            MMLog.a("MMBroadcastReceiver", stringbuilder.append(s).toString());
