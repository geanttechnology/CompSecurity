...
label0:
        {
            location2 = LocationService.getLastKnownLocation(mContext, MoPub.getLocationPrecision(), MoPub.getLocationAwareness());
            location1 = location;
            if (location2 == null)
            {
                break label0;
        ...
        if (location1 != null)
        {
            addParam("ll", (new StringBuilder()).append(location1.getLatitude()).append(",").append(location1.getLongitude()).toString());
            addParam("lla", String.valueOf((int)location1.getAccuracy()));
            addParam("llf", String.valueOf(calculateLocationStalenessInMilliseconds(location1)));
    ...
    public void setMraidFlag(boolean flag)
    {
        if (flag)
        {
            addParam("mr", "1");
