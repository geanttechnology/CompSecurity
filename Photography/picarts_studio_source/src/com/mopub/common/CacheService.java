...
public class CacheService
{
    ...
    public static String getFilePathDiskCache(String s)
    {
        ...
        {
            return (new StringBuilder()).append(sDiskLruCache.getDirectory()).append(File.separator).append(createValidDiskCacheKey(s)).append(".0").toString();
        }
    }
...
_L3:
    ...
    private class DiskLruCacheGetTask extends AsyncTask
    {
        ...
        private class DiskLruCacheGetListener
        {
    ...
    private class DiskLruCachePutTask extends AsyncTask
    {
