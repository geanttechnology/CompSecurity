...
public abstract class UrlAction extends Enum
{
    ...
    {
        MoPubLog.d((new StringBuilder("Ad event URL: ")).append(uri).toString());
    ...
    static 
    {
        HANDLE_MOPUB_SCHEME = new UrlAction("HANDLE_MOPUB_SCHEME", 0, false) {
            ...
            protected final void performAction(Context context, Uri uri, UrlHandler urlhandler)
            {
                ...
                {
                    throw new IntentNotResolvableException((new StringBuilder("Could not handle MoPub Scheme url: ")).append(uri).toString());
                }
            }
