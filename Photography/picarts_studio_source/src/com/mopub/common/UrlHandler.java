...
public class UrlHandler
{
    ...
    private static final ResultActions EMPTY_CLICK_LISTENER = new ResultActions() {
        ...
        public final void urlHandlingFailed(String s, UrlAction urlaction)
        {
        }

        public final void urlHandlingSucceeded(String s, UrlAction urlaction)
        {
        }
...
_L1:
        failUrlHandling(s, ((UrlAction) (obj)), (new StringBuilder("Link ignored. Unable to handle url: ")).append(s).toString(), null);
        return false;
    }
