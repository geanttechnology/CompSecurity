...
public class AdRequestStatusMapping
{
    ...
    boolean isLoading(String s)
    {
        ...
        return ((AdRequestStatus)mAdUnitToAdRequestStatus.get(s)).getStatus() == LoadingStatus.LOADING;
    }
    ...
    private class LoadingStatus extends Enum
    {
