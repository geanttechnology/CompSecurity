...
interface NativeAdInterface
{
    ...
    public abstract String getDaaIconClickthroughUrl();
    ...
    public abstract void setNativeEventListener(BaseForwardingNativeAd.NativeEventListener nativeeventlistener);
}
