    ...
    implements com.mopub.volley.toolbox.HurlStack.UrlRewriter
{
    ...
    public String rewriteUrl(String s)
    {
        ...
        obj1 = new com.mopub.common.GpsHelper.AdvertisingInfo(deviceIdentifier, false);
        if (!GpsHelper.isPlayServicesAvailable(applicationContext)) goto _L2; else goto _L1
_L1:
        Object obj = GpsHelper.fetchAdvertisingInfoSync(applicationContext);
