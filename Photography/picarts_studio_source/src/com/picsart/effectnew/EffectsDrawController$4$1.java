...
_L9:
            ...
            throw obj2;
_L7:
            f.runOnUiThread(new EffectsDrawController._cls4._cls1(this, ((Allocation) (obj2))));
            return;
_L4:
            ...
            {
                f.runOnUiThread(new EffectsDrawController._cls4._cls2(((ByteBuffer) (obj2))));
                return;
            }
            obj2;
            obj1 = null;
...
_L8:
        ...
        // Unreferenced inner class com/picsart/effectnew/EffectsDrawController$4$2

/* anonymous class */
        final class EffectsDrawController._cls4._cls2
            implements Runnable
        {
