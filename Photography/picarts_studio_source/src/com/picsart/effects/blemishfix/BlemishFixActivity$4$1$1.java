    ...
    implements Runnable
{
    ...
    public final void run()
    {
        ...
        a.a.a.findViewById(0x7f1001aa).setEnabled(false);
        a.a.a.findViewById(0x7f1001a8).setEnabled(false);
...
_L1:
            if (flag)
            {
                b.a.runOnUiThread(new BlemishFixActivity._cls4._cls1._cls1(this));
                return;
            } else
            {
                b.a.runOnUiThread(new BlemishFixActivity._cls4._cls1._cls2());
                return;
            }
            flag = true;
              goto _L1
        ...
        // Unreferenced inner class com/picsart/effects/blemishfix/BlemishFixActivity$4$1$2

/* anonymous class */
        final class BlemishFixActivity._cls4._cls1._cls2
            implements Runnable
        {
