...
/* anonymous class */
    final class ColorSplashActivity._cls1 extends Handler
    {
        ...
        public final void handleMessage(Message message)
        {
            ...
            case 0: // '\0'
                message.arg1 = -1;
                a.runOnUiThread(new ColorSplashActivity._cls1._cls1(this));
                return;

            case 1: // '\001'
                (new Handler()).postDelayed(new ColorSplashActivity._cls1._cls2(), 100L);
                break;
            }
            message.arg1 = -1;
        }
        ...
        // Unreferenced inner class com/picsart/effects/colorsplash/ColorSplashActivity$1$2

/* anonymous class */
        final class ColorSplashActivity._cls1._cls2
            implements Runnable
        {
