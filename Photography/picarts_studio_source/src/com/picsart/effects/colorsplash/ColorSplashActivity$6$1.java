...
//            ColorSplashActivity, MyGLSurfaceView, ColorSplashForegroundView, a
    ...
    implements Runnable
{
    ...
    {
        ColorSplashActivity.h(a.a).queueEvent(new Runnable() {
            ...
            {
                a = ColorSplashActivity._cls6._cls1.this;
                super();
            }
        });
    }
