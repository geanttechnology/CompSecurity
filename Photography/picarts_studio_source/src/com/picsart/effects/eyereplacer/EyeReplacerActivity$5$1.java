...
final class a extends ModernAsyncTask
{
    ...
    // Unreferenced inner class com/picsart/effects/eyereplacer/EyeReplacerActivity$5

/* anonymous class */
    final class EyeReplacerActivity._cls5
        implements android.widget.SeekBar.OnSeekBarChangeListener
    {
        ...
        {
            b.setText((new StringBuilder()).append(a.getString(0x7f0801e4)).append(" : ").append(i).toString());
        }
        ...
        public final void onStopTrackingTouch(SeekBar seekbar)
        {
            ...
            } else
            {
                ...
                (new EyeReplacerActivity._cls5._cls1(this, seekbar)).executeOnExecutor(EyeReplacerActivity.o(a), new Void[] {
                    null
                });
