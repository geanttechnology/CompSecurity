...
final class a
    implements android.view.y._cls4._cls1
{
...
/* anonymous class */
        ...
        implements c
    {
        ...
        {
            view.findViewById(0x7f10037e).setOnClickListener(new ImagePickerActivity._cls4._cls1(this));
            view.findViewById(0x7f10037d).setOnClickListener(new ImagePickerActivity._cls4._cls2());
        }
        ...
        // Unreferenced inner class com/picsart/studio/ImagePickerActivity$4$2

/* anonymous class */
        final class ImagePickerActivity._cls4._cls2
