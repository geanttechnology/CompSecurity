    ...
    implements Runnable
{
    ...
    {
        m.b(c.c, ImagePickerActivity.f(c.c));
        ImagePickerActivity.h(c.c);
        ImagePickerActivity.a(c.c, a, 0, 3, null, x.a("Remote album", b), "Remote album");
    }

    init>(init> init>, String s, String s1)
    {
        c = init>;
        a = s;
        b = s1;
    ...
    final class ImagePickerActivity._cls7 extends ModernAsyncTask
    {
        ...
        private transient Void a()
        {
            ...
            if (obj1 != null)
            {
                try
                {
                    a.runOnUiThread(new ImagePickerActivity._cls7._cls1(this, ((String) (obj1)), ((String) (obj))));
                }
