    ...
    implements Runnable
{
    ...
    {
        m.b(d.d, ImagePickerActivity.f(d.d));
        ImagePickerActivity.h(d.d);
        ImagePickerActivity.a(d.d, a, b, 2, null, x.a("gallery", c), "gallery");
    }

    init>(init> init>, String s, int i, String s1)
    {
        d = init>;
        a = s;
        b = i;
    ...
    final class ImagePickerActivity._cls7 extends ModernAsyncTask
    {
        ...
        private transient Void a()
        {
            ...
            if (obj1 != null)
            {
                ...
                {
                    com.socialin.android.d.b(ImagePickerActivity.a(), new Object[] {
            ...
            if (w.e(((String) (obj))))
            {
                a.runOnUiThread(new ImagePickerActivity._cls7._cls2(((String) (obj))));
            }
            break MISSING_BLOCK_LABEL_335;
            if (w.e(((String) (obj))))
            {
                if (ImagePickerActivity.g(a))
                {
                    ...
                    a.runOnUiThread(new ImagePickerActivity._cls7._cls3(this, s1, i, ((String) (obj))));
                } else
                {
...
/* anonymous class */
        ...
        // Unreferenced inner class com/picsart/studio/ImagePickerActivity$7$2

/* anonymous class */
        final class ImagePickerActivity._cls7._cls2
            implements Runnable
        {
