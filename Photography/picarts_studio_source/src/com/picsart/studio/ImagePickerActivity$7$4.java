    ...
    implements Runnable
{
    ...
    public final void run()
    {
        ...
        ImagePickerActivity.a(c.c, a, b, 2, null, x.a("gallery", a), "gallery");
    }

    init>(init> init>, String s, int i)
    {
        c = init>;
        a = s;
        b = i;
        ...
        private transient Void a()
        {
            ...
            if (w.e(((String) (obj))))
            {
                ...
                } else
                {
                    ...
                    a.runOnUiThread(new ImagePickerActivity._cls7._cls4(this, ((String) (obj)), j));
                }
            } else
            {
