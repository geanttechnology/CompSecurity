    ...
    implements Runnable
{
    ...
    public final void run()
    {
        ...
        } else
        {
            activity.runOnUiThread(new Runnable() {
                ...
                private SelectionFragment._cls10 a;
                ...
                public final void run()
                {
                    ...
                    SelectionFragment.a(a.b, false);
                    SelectionFragment.p(a.b).a();
                    b b1 = SelectionFragment.p(a.b).l;
                    c c1 = new c(b1);
                    c1.d = 3;
                    b1.a.add(c1);
                    if (!b1.b)
            ...
            {
                a = SelectionFragment._cls10.this;
                super();
            }
            });
            return;
    ...
    _cls1.a(SelectionFragment selectionfragment, ByteBuffer bytebuffer, int i, int j)
    {
        b = selectionfragment;
        a = bytebuffer;
        c = i;
