    ...
    implements Runnable
{
    ...
    public final void run()
    {
        ...
        SelectionFragment.a(b.b, false);
        b.b.d();
        Object obj1 = SelectionFragment.p(b.b);
        Object obj = a;
        ...
        obj = SelectionFragment.p(b.b).q();
        if (((ArrayList) (obj)).size() > 0)
        {
            SelectionFragment.y(b.b).b(((ArrayList) (obj)));
        }
        if (SelectionFragment.p(b.b).n == com.socialin.android.photo.select..FILL_TYPE.CLEAR)
        {
            SelectionFragment.p(b.b).a(com.socialin.android.photo.select..FILL_TYPE.ADD);
            SelectionFragment.z(b.b);
        }
        SelectionFragment.p(b.b).t.invalidate();
        SelectionFragment.A(b.b);
        SelectionFragment.B(b.b);
    }

    FILL_TYPE(FILL_TYPE fill_type, Bitmap bitmap)
    {
        b = fill_type;
        a = bitmap;
        super();
    ...
    // Unreferenced inner class com/picsart/studio/editor/fragment/SelectionFragment$32

/* anonymous class */
    final class SelectionFragment._cls32
        implements Runnable
    {
...
_L1:
            ...
            obj1 = com.socialin.android.util.c.a(i, j, android.graphics.Bitmap.Config.ARGB_8888);
...
_L4:
            ...
            obj = com.socialin.android.util.c.a(i, j, android.graphics.Bitmap.Config.ARGB_8888);
...
_L9:
            ...
            if (obj != null)
            {
                Bitmap bitmap = com.socialin.android.util.c.a(i, j, android.graphics.Bitmap.Config.ARGB_8888);
                if (bitmap != null)
                {
                    bitmap.eraseColor(0);
            ...
            {
                ((Activity) (obj1)).runOnUiThread(new SelectionFragment._cls32._cls1(this, ((Bitmap) (obj))));
            } else
            if (obj != null && !((Bitmap) (obj)).isRecycled())
            {
                com.socialin.android.util.c.a(((Bitmap) (obj)));
