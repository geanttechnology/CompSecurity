    ...
    implements android.view.
{
    ...
    public final void onClick(View view)
    {
        ...
        view.track((new com.socialin.android.apiv3.events.iftTryEvent(s, "linear_tab_click", i, TiltShiftFragment.b(a).getHeight(), TiltShiftFragment.b(a).getWidth(), TiltShiftFragment.d(a).k)).setBlurSliderValue((int)TiltShiftFragment.k(a).a()));
        TiltShiftFragment.l(a).setSelected(true);
        TiltShiftFragment.m(a).setSelected(false);
        TiltShiftFragment.a(a, ltShiftMode.LINEAR);
    }
