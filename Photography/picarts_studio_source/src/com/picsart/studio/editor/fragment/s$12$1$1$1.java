    ...
    implements Runnable
{
    ...
    {
        s.a(b.b.b.b, b.b.b.b.getActivity(), a);
        ((EditorActivity)b.b.b.b.getActivity()).e();
    }

    ity(ity ity, Mask mask)
    {
        b = ity;
        a = mask;
        super();
...
/* anonymous class */
    ...
    // Unreferenced inner class com/picsart/studio/editor/fragment/s$12$1$1

/* anonymous class */
    final class s._cls12._cls1._cls1
        implements c
    {

        final s._cls12._cls1 a;
        ...
        public final void a(Mask mask)
        {
            ...
            {
                a.a.a.getActivity().runOnUiThread(new s._cls12._cls1._cls1._cls1(this, mask));
                return;
            }
        }
