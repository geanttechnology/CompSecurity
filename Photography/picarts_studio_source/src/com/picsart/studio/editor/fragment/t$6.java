    ...
    implements android.view..OnClickListener
{
    ...
    public final void onClick(View view)
    {
        ...
        if (perspectiveview.i == null && !perspectiveview.h)
        {
            ...
            if (perspectiveview.g == com.picsart.studio.editor.view.pectiveView.PerspectiveMode.HORIZONTAL)
            {
                f = perspectiveview.d;
            } else
            {
            ...
            perspectiveview.i.addUpdateListener(new com.picsart.studio.editor.view.pectiveView._cls1(perspectiveview));
            perspectiveview.i.addListener(new com.picsart.studio.editor.view.pectiveView._cls2(perspectiveview, null));
        ...
        if (flag)
        {
            ...
            view.animate().alpha(0.0F).setListener(new ag() {
