...
/* anonymous class */
        ...
        implements Runnable
    {
        ...
        public final void run()
        {
            ...
            CropEditorView.j(a).addUpdateListener(new CropEditorView._cls10._cls1(rectf, rectf1, rectf2, rectf3));
            CropEditorView.j(a).addListener(new CropEditorView._cls10._cls2(this));
        ...
        // Unreferenced inner class com/picsart/studio/editor/view/CropEditorView$10$1

/* anonymous class */
        final class CropEditorView._cls10._cls1
