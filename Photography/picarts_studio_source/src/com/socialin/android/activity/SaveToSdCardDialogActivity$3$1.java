    ...
    implements android.content.
{
    ...
    {
        SaveToSdCardDialogActivity.access$600(c.c, a, b);
    }

    ent(ent ent, String s, String s1)
    {
        c = ent;
        a = s;
        b = s1;
...
/* anonymous class */
        ...
        implements android.view.View.OnClickListener
    {
        ...
        public final void onClick(View view)
        {
            ...
            if (!TextUtils.isEmpty(view))
            {
                ...
                if (((File) (obj)).exists())
                {
                    ...
                    ((AlertDialog) (obj)).setButton(-1, a.getString(0x7f080311), new SaveToSdCardDialogActivity._cls3._cls1(this, s, view));
        ...
        // Unreferenced inner class com/socialin/android/activity/SaveToSdCardDialogActivity$3$2

/* anonymous class */
        final class SaveToSdCardDialogActivity._cls3._cls2
