...
final class c extends Thread
{
    ...
    public final void run()
    {
        ...
        if (SaveToSdCardDialogActivity.access$700(a))
        {
            ...
            if (android.os.rdDialogActivity._cls5.c >= 19)
            {
        ...
        } else
        {
            ...
            if (bitmap != null)
            {
                ...
                if (android.graphics.ogActivity._cls5.a.a(SaveToSdCardDialogActivity.access$400(a)))
                {
        ...
        if (obj != null)
        {
            ...
            AnalyticUtils.getInstance(a).track(new com.socialin.android.apiv3.events.ent("sdcard_done", "bin"));
            return;
        } else
        {
            ...
            a.runOnUiThread(new Runnable() {
                ...
                private SaveToSdCardDialogActivity._cls5 a;
            ...
            {
                a = SaveToSdCardDialogActivity._cls5.this;
                super();
            }
            });
            return;
    ...
    _cls1.a(SaveToSdCardDialogActivity savetosdcarddialogactivity, String s, String s1)
    {
