...
_L14:
        com.socialin.android.apiv3.model.atsNewItem atsnewitem = new com.socialin.android.apiv3.model.atsNewItem();
        atsnewitem.data = new com.socialin.android.apiv3.model.ta();
        atsnewitem.data.title = s3;
        atsnewitem.data.text = s1;
        atsnewitem.data.link = s2;
        atsnewitem.data.linkName = ((String) (obj));
        atsnewitem.data.photoUrl = s;
        arraylist.add(atsnewitem);
_L4:
        i++;
...
_L2:
        b.runOnUiThread(new Runnable(arraylist) {

            private ArrayList a;
            private WhatsNewActivity._cls2 b;
...
_L15:
    ...
    _cls1.a(WhatsNewActivity whatsnewactivity, String s)
    {
        b = whatsnewactivity;
        a = s;
        super();
