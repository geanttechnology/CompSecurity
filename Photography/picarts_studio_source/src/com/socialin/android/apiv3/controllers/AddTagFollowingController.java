...
public class AddTagFollowingController extends BaseSocialinApiRequestController
{

    int requestId;

    public AddTagFollowingController()
    {
        requestId = -1;
    ...
    public void doRequest(String s, ParamWithTagName paramwithtagname)
    {
        ...
        {
            status = 0;
            requestId = SocialinApiV3.getInstance().addTagFollowing(paramwithtagname.userId, paramwithtagname.tagName, s, this);
            return;
        }
    }
