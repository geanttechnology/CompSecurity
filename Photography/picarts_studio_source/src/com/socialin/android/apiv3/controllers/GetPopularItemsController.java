...
public class GetPopularItemsController extends BaseSocialinApiRequestController
{

    private static long validPeriod = 60000L;
    private int requestId;

    public GetPopularItemsController()
    {
        requestId = -1;
    ...
    public void doRequest(String s, GetItemsParams getitemsparams)
    {
        ...
        requestId = SocialinApiV3.getInstance().getPopularItems(getitemsparams.offset, getitemsparams.limit, getitemsparams.contentRating, s, this, cacheConfig, validPeriod);
    }
