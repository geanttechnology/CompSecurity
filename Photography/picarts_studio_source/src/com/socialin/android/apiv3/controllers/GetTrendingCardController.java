...
public class GetTrendingCardController extends BaseSocialinApiRequestController
{
    ...
    public GetTrendingCardController()
    {
        requestId = -1;
        tag = null;
    ...
    public void doRequest(String s, GetItemsParams getitemsparams)
    {
        ...
        } else
        {
            ...
            requestId = SocialinApiV3.getInstance().getUserCards(getitemsparams, s, this, cacheConfig, loadDataForTabletLandscape);
            return;
        }
    }
