...
public class GetUsersGroupedController extends BaseSocialinApiRequestController
{
    ...
    public void doRequest(String s, GetItemsParams getitemsparams)
    {
        ...
        } else
        {
            ...
            requestId = SocialinApiV3.getInstance().getUsers(getitemsparams.type, getitemsparams.offset, getitemsparams.limit, getitemsparams.contentRating, s, this, cacheConfig, validPeriod);
            return;
        }
    }
    ...
    {
        onSuccess((ViewerUsersResponse)response, request);
    }

    public void onSuccess(ViewerUsersResponse viewerusersresponse, Request request)
    {
        super.onSuccess(viewerusersresponse, request);
        while (viewerusersresponse == null || "error".equals(viewerusersresponse.status) || request.g.a != 2 || request.g.e || !"success".equals(viewerusersresponse.status)) 
        {
            return;
        }
        cacheConfig = 3;
    ...
    {
        onSuccess((ViewerUsersResponse)obj, request);
    }
