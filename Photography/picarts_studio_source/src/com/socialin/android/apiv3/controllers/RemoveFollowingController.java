...
public class RemoveFollowingController extends BaseSocialinApiRequestController
{
    ...
    public void doRequest(String s, ParamWithUserData paramwithuserdata)
    {
        ...
        {
            status = 0;
            requestId = SocialinApiV3.getInstance().removeFollowing(paramwithuserdata.userId, s, this);
            return;
        }
    }
