...
public class RemoveStreamController extends BaseSocialinApiRequestController
{

    int requestId;

    public RemoveStreamController()
    {
        requestId = -1;
    }
    ...
    public void doRequest(String s, StreamParams streamparams)
    {
        ...
        {
            status = 0;
            requestId = SocialinApiV3.getInstance().removeStream(streamparams.streamId, s, this);
            return;
        }
    }
