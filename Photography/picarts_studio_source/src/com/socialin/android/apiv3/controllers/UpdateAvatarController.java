...
public class UpdateAvatarController extends BaseSocialinApiRequestController
{
    ...
    public void doRequest(String s, ParamWithImage paramwithimage)
    {
        ...
        {
            status = 0;
            requestId = SocialinApiV3.getInstance().updateAvatar(paramwithimage.imagePath, s, this);
            return;
        }
    }
