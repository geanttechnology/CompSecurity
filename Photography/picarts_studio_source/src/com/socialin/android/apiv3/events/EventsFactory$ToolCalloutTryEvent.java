...
public class addParam extends addParam
{
    ...
    public I(String s, String s1, String s2, int i, int j, int k, int l, 
            String s3, int i1)
    {
        super("tool_callout_try");
        addParam(EventParam.UID, s);
        addParam(EventParam.CALLOUT_NAME, s1);
        addParam(EventParam.ACTION, s2);
        ...
        addParam(EventParam.BLEND_MODE, Integer.valueOf(i1));
        addParam(EventParam.OPACITY_VALUE, Integer.valueOf(l));
        addParam(EventParam.SESSION_ID, s3);
    }
}
