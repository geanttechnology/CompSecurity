    ...
    implements Runnable
{
    ...
    {
        Toast.makeText(a.a.getContext(), a.a.getResources().getString(0x7f08009c, new Object[] {
            a.a.getDisplayName()
        }), 0).show();
    }
...
/* anonymous class */
    public final class DrawingView._cls10 extends ModernAsyncTask
    {
        ...
        private transient Void a()
        {
            ...
            {
                b.post(new DrawingView._cls10._cls1(this));
                b.b(true);
            ...
            } else
            {
                ...
                DrawingView.f(b);
                ((Activity)b.getContext()).runOnUiThread(new DrawingView._cls10._cls2(snapshot));
                return null;
            }
        }
        ...
        // Unreferenced inner class com/socialin/android/brushlib/view/DrawingView$10$2

/* anonymous class */
        final class DrawingView._cls10._cls2
            implements Runnable
        {

            private Snapshot a;
            private DrawingView._cls10 b;

            public final void run()
            {
                com.socialin.android.brushlib.view.DrawingView.a(b.b, DrawingView.State.INITIALIZED);
                DrawingView.g(b.b);
