    ...
    implements b
{
    ...
    private void b()
    {
        int i = Color.rgb(0, Color.green(h.b), Color.blue(h.b));
        int j = Color.rgb(255, Color.green(h.b), Color.blue(h.b));
    ...
    private void c()
    {
        c = Math.round(((float)Color.red(h.b) * a.width()) / 255F + a.left);
    }
