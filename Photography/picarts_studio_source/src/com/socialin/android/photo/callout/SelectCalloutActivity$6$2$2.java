...
final class a
    implements android.view.CalloutActivity._cls6._cls2._cls2
{
    ...
    {
        view = new Intent(b.b.b, com/socialin/android/activity/LocationListActivity);
        b.b.b.startActivityForResult(view, 1);
        AnalyticUtils.getInstance(b.b.b).trackLocalAction("callout:text_loc_based");
        a.dismiss();
    }
...
/* anonymous class */
        ...
        implements c
    {
        ...
        public final void onViewCreated(View view, DialogFragment dialogfragment)
        {
            ...
            view.findViewById(0x7f100831).setOnClickListener(new SelectCalloutActivity._cls6._cls2._cls1(dialogfragment));
            view.findViewById(0x7f100832).setOnClickListener(new SelectCalloutActivity._cls6._cls2._cls2(this, dialogfragment));
        ...
        // Unreferenced inner class com/socialin/android/photo/callout/SelectCalloutActivity$6$2$1

/* anonymous class */
        final class SelectCalloutActivity._cls6._cls2._cls1
            implements android.view.View.OnClickListener
        {
