...
final class a
    implements android.view.CalloutActivity._cls6._cls2._cls3
{
    ...
    {
        view = new Intent(b.b.b, com/socialin/android/photo/main/DateAndTimeListActivity);
        b.b.b.startActivityForResult(view, 2);
        AnalyticUtils.getInstance(b.b.b).trackLocalAction("callout:text_date");
        a.dismiss();
    }
...
/* anonymous class */
        ...
        implements c
    {
        ...
        public final void onViewCreated(View view, DialogFragment dialogfragment)
        {
            ...
            view.findViewById(0x7f100833).setOnClickListener(new SelectCalloutActivity._cls6._cls2._cls3(this, dialogfragment));
        }
