    ...
    implements TextWatcher
{
    ...
    public final void afterTextChanged(Editable editable)
    {
        ...
        b.b.setLength(0);
        b.b.append(editable);
        b.b.setOutputPath((new StringBuilder()).append(a.a).append(editable).append(".").append(b.b.getFormat()).toString());
    }
    ...
    ator.VideoOptions(ator.VideoOptions videooptions, EditText edittext)
    {
        b = videooptions;
        a = edittext;
        super();
...
/* anonymous class */
        ...
        implements c
    {
        ...
        public final void onViewCreated(View view, DialogFragment dialogfragment)
        {
            ...
            b.append(as[0]);
            edittext.addTextChangedListener(new DrawingActivity._cls38._cls1(this, edittext));
...
/* anonymous class */
            ...
            implements android.widget.AdapterView.OnItemSelectedListener
        {
            ...
            public final void onItemSelected(AdapterView adapterview, View view, int i, long l)
            {
                ...
                c.a.setOutputPath((new StringBuilder()).append(a.a).append(b[0]).append(".").append(c.a.getFormat()).toString());
            }
