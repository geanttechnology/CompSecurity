    ...
    implements android.widget.ectedListener
{
    ...
    {
        b.b.setResolution(com.socialin.android.videogenerator..VideoResolution.fromString(a.getSelectedItem().toString()));
        if (b.b.getFormat() == com.socialin.android.videogenerator..VideoFormat.mp4 && b.b.getResolution() == com.socialin.android.videogenerator..VideoResolution.p1080)
        {
            b.b.setResolution(com.socialin.android.videogenerator..VideoResolution.p1072);
        }
    }
    ...
    ator.VideoOptions(ator.VideoOptions videooptions, Spinner spinner)
    {
        b = videooptions;
        a = spinner;
        super();
...
/* anonymous class */
        ...
        implements c
    {
        ...
        public final void onViewCreated(View view, DialogFragment dialogfragment)
        {
            ...
            spinner.setOnItemSelectedListener(new DrawingActivity._cls38._cls2(this, spinner));
            ...
            ((RadioGroup)view.findViewById(0x7f100838)).setOnCheckedChangeListener(new DrawingActivity._cls38._cls5(dialogfragment, seekbar));
        }
...
/* anonymous class */
        ...
        // Unreferenced inner class com/socialin/android/photo/draw/DrawingActivity$38$5

/* anonymous class */
        final class DrawingActivity._cls38._cls5
