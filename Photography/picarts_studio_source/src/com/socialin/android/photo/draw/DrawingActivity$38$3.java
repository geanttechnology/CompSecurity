    ...
    implements android.widget.ectedListener
{
    ...
    {
        c.c.setFormat(com.socialin.android.videogenerator..VideoFormat.formatFromString(a.getSelectedItem().toString()));
        c.c.setOutputPath((new StringBuilder()).append(a.a).append(b[0]).append(".").append(c.c.getFormat()).toString());
    }
    ...
    ator.VideoOptions(ator.VideoOptions videooptions, Spinner spinner, String as[])
    {
        c = videooptions;
        a = spinner;
        b = as;
...
/* anonymous class */
        ...
        implements c
    {
        ...
        public final void onViewCreated(View view, DialogFragment dialogfragment)
        {
            ...
            spinner1.setOnItemSelectedListener(new DrawingActivity._cls38._cls3(this, spinner1, as));
...
/* anonymous class */
            ...
            implements TextWatcher
        {
            ...
            public final void afterTextChanged(Editable editable)
            {
                ...
                b.b.setLength(0);
                b.b.append(editable);
                b.a.setOutputPath((new StringBuilder()).append(a.a).append(editable).append(".").append(b.a.getFormat()).toString());
            }
