    ...
    implements android.widget.geListener
{
    ...
    {
        b.b.setDuration(i + 15);
        a.setText((new StringBuilder()).append(i + 15).append(b.b.getString(0x7f080661)).toString());
    }
    ...
    ator.VideoOptions(ator.VideoOptions videooptions, TextView textview)
    {
        b = videooptions;
        a = textview;
        super();
...
/* anonymous class */
        ...
        implements c
    {
        ...
        public final void onViewCreated(View view, DialogFragment dialogfragment)
        {
            ...
            seekbar.setOnSeekBarChangeListener(new DrawingActivity._cls38._cls4(this, dialogfragment));
