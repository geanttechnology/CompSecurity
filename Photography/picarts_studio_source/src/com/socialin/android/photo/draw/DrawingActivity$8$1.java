...
/* anonymous class */
        ...
        implements d
    {
        ...
        public final void a()
        {
            ...
            DrawingActivity.k(a).findViewById(0x7f1003a3).setEnabled(((a) (obj)).e());
            DrawingActivity.k(a).findViewById(0x7f1003a4).setEnabled(((a) (obj)).f());
            com.socialin.android.photo.draw.DrawingActivity.b(a).c.f.a(new DrawingActivity._cls8._cls1(this));
            com.socialin.android.photo.draw.DrawingActivity.b(a).c.a(new DrawingActivity._cls8._cls2());
        ...
        // Unreferenced inner class com/socialin/android/photo/draw/DrawingActivity$8$2

/* anonymous class */
        final class DrawingActivity._cls8._cls2
            implements com.socialin.android.brushlib.state.b
        {

            final DrawingActivity._cls8 a;
            ...
            {
                DrawingActivity.z(a.a).a(b1, new DrawingActivity._cls8._cls2._cls1(this));
            }
            ...
            public final void d(com.socialin.android.brushlib.layer.b b1)
            {
                DrawingActivity.r(a.a).notifyDataSetChanged();
                DrawingActivity.y(a.a);
                DrawingActivity.z(a.a).a(b1, new DrawingActivity._cls8._cls2._cls2(this));
            }
        ...
        // Unreferenced inner class com/socialin/android/photo/draw/DrawingActivity$8$2$1

/* anonymous class */
        final class DrawingActivity._cls8._cls2._cls1
            implements com.socialin.android.brushlib.util.d
        {
            ...
            public final void a(com.socialin.android.brushlib.layer.b b1)
            {
                ...
                {
                    int i = com.socialin.android.photo.draw.b.a(DrawingActivity.r(a.a.a)).indexOf(b1) - DrawingActivity.A(a.a.a).getFirstVisiblePosition();
                    if (i >= 0)
                    {
                        b1 = DrawingActivity.A(a.a.a).getChildAt(i);
                        if (b1 != null)
                        {
                            b1.invalidate();
                        }
        ...
        // Unreferenced inner class com/socialin/android/photo/draw/DrawingActivity$8$2$2

/* anonymous class */
        final class DrawingActivity._cls8._cls2._cls2
            implements com.socialin.android.brushlib.util.d
        {
