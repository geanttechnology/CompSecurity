    ...
    implements d
{
    ...
    public final void a()
    {
        ...
        com.socialin.android.photo.draw.DrawingActivity.b(a).c.f.a(new b() {
        ...
        com.socialin.android.photo.draw.DrawingActivity.b(a).c.a(new com.socialin.android.brushlib.state.b() {
        ...
        com.socialin.android.photo.draw.DrawingActivity.b(a).post(new Runnable() {
    ...
    _cls3.a(DrawingActivity drawingactivity)
    {
        a = drawingactivity;
        super();
    }
