    ...
    implements b
{
    ...
    public final c a(ArrayList arraylist, d d, a a1)
    {
        ...
        int j = com.socialin.android.photo.effects.factory.a.a(arraylist);
        ...
        {
            arraylist.a = EffectsFactory.access$400((RenderScript)a1.j, (Allocation)a1.k, (Allocation)a1.l, i, j);
        } else
        if (a1.n == com.photo.effect.Type.EffectApplyTypeNative)
        {
            ...
            ImageOp.crossprocess4buf(d, bytebuffer, k, l, k, l, j, i, flag, i1);
            arraylist.a = true;
            return arraylist;
        }
        return arraylist;
