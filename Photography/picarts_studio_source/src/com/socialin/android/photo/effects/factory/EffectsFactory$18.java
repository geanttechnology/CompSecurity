    ...
    implements b
{
    ...
    public final c a(ArrayList arraylist, d d, a a1)
    {
        ...
        int j = com.socialin.android.photo.effects.factory.a.c(arraylist);
        ...
        {
            arraylist.a = EffectsFactory.access$900((RenderScript)a1.j, (Allocation)a1.k, (Allocation)a1.l, f, j, i);
        } else
        if (a1.n == com.photo.effect.Type.EffectApplyTypeNative)
        {
            ...
            ImageOp.vintage4buf(d, bytebuffer, k, l, k, l, f, j, i, flag, i1);
            arraylist.a = true;
            return arraylist;
        }
        return arraylist;
