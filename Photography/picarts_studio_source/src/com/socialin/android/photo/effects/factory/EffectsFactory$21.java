    ...
    implements b
{
    ...
    public final c a(ArrayList arraylist, d d, a a1)
    {
        ...
        {
            arraylist.a = EffectsFactory.access$1200((RenderScript)a1.j, (Allocation)a1.k, (Allocation)a1.l, f, f1, 0);
        } else
        if (a1.n == com.photo.effect.Type.EffectApplyTypeNative)
        {
            ...
            ImageOp.crossprocessing4buf(bytebuffer, bytebuffer, i, j, i, j, f, f1, 1, 0, flag, k);
            arraylist.a = true;
            return arraylist;
        }
        return arraylist;
