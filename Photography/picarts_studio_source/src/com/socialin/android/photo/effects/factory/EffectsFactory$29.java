    ...
    implements b
{
    ...
    {
        int i = EffectParameter.b(arraylist, "Max blur");
        int j = 100 - EffectParameter.b(arraylist, "Hardness");
        ...
        Log.e("ex1", (new StringBuilder("amount = ")).append(j).toString());
        arraylist = new c();
        if (a1.n == com.photo.effect.Type.EffectApplyTypeRenderScript)
        {
            arraylist.a = EffectsFactory.access$1800((RenderScript)a1.j, (Allocation)a1.k, (Allocation)a1.l, i, j, k);
        } else
        if (a1.n == com.photo.effect.Type.EffectApplyTypeNative)
        {
            ...
            ImageOp.smartblur4buf(d, bytebuffer, l, i1, l, i1, i, j, k, flag, j1);
            arraylist.a = true;
            return arraylist;
        }
        return arraylist;
