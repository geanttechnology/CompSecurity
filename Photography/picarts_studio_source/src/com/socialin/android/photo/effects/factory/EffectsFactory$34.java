    ...
    implements b
{
    ...
    {
        int i = EffectParameter.b(arraylist, "Contrast");
        int j = EffectParameter.b(arraylist, "Brightness");
        int k = EffectParameter.b(arraylist, "Fade");
        Log.e("ex1", (new StringBuilder("contrast = ")).append(i).toString());
        ...
        {
            arraylist.a = EffectsFactory.access$000((RenderScript)a1.j, (Allocation)a1.k, (Allocation)a1.l, i, j, k);
        } else
        if (a1.n == com.photo.effect.Type.EffectApplyTypeNative)
        {
            ...
            ImageOp.tranquil4buf(d, bytebuffer, l, i1, l, i1, i, j, k, flag, j1);
            arraylist.a = true;
            return arraylist;
        }
        return arraylist;
