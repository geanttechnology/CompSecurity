    ...
    implements b
{
    ...
    public final c a(ArrayList arraylist, d d, a a1)
    {
        ...
        {
            arraylist.a = EffectsFactory.access$2500((RenderScript)a1.j, (Allocation)a1.k, (Allocation)a1.l, a1.a, i, j, k, s, l);
        } else
        if (a1.n == com.photo.effect.Type.EffectApplyTypeNative)
        {
            ...
            if (a1 != null)
            {
                ImageOp.pastelperfect4buf(d, bytebuffer, i1, j1, i1, j1, a1, i1, j1, i, j, k, l, flag, k1);
                e.a(a1);
                arraylist.a = true;
                return arraylist;
            }
