    ...
    implements b
{
    ...
    public final c a(ArrayList arraylist, d d, a a1)
    {
        ...
        {
            arraylist.a = EffectsFactory.access$3200((RenderScript)a1.j, (Allocation)a1.k, (Allocation)a1.l, i, j, k, l);
        } else
        if (a1.n == com.photo.effect.Type.EffectApplyTypeNative)
        {
            ...
            ImageOp.contours4buf(d, bytebuffer, i1, j1, i1, j1, i, j, k, l, flag, k1);
            arraylist.a = true;
            return arraylist;
        }
        return arraylist;
