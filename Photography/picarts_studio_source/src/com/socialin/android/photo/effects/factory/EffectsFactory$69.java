    ...
    implements b
{
    ...
    {
        int i = com.socialin.android.photo.effects.factory.a.k(EffectParameter.f(arraylist, "Mode"));
        int j = Integer.parseInt(EffectParameter.f(arraylist, "Color1"));
        int k = Integer.parseInt(EffectParameter.f(arraylist, "Color2"));
        j = com.socialin.android.photo.effects.factory.a.d(j);
        k = com.socialin.android.photo.effects.factory.a.e(k);
        int l = EffectParameter.b(arraylist, "Fade");
        Log.e("ex1", (new StringBuilder("mode = ")).append(i).toString());
        Log.e("ex1", (new StringBuilder("color1 = ")).append(j).toString());
        Log.e("ex1", (new StringBuilder("color2 = ")).append(k).toString());
        Log.e("ex1", (new StringBuilder("fade = ")).append(l).toString());
        arraylist = new c();
        if (a1.n == com.photo.effect.Type.EffectApplyTypeRenderScript)
        {
            arraylist.a = EffectsFactory.access$3900((RenderScript)a1.j, (Allocation)a1.k, (Allocation)a1.l, i, j, k, l);
        } else
        if (a1.n == com.photo.effect.Type.EffectApplyTypeNative)
        {
            ...
            ImageOp.unitedcolors4buf(d, bytebuffer, i1, j1, i1, j1, i, j, k, l, flag, k1);
            arraylist.a = true;
            return arraylist;
        }
        return arraylist;
