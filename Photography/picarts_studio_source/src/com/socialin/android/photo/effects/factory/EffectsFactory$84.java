    ...
    implements b
{
    ...
    public final c a(ArrayList arraylist, d d, a a1)
    {
        ...
        int j = com.socialin.android.photo.effects.factory.a.l(EffectParameter.f(arraylist, "Mode"));
        Log.e("ex1", (new StringBuilder("fade = ")).append(i).toString());
        Log.e("ex1", (new StringBuilder("sunTanMode = ")).append(j).toString());
        arraylist = new c();
        if (a1.n == com.photo.effect.Type.EffectApplyTypeRenderScript)
        {
            arraylist.a = EffectsFactory.access$4900((RenderScript)a1.j, (Allocation)a1.k, (Allocation)a1.l, j, i);
        } else
        if (a1.n == com.photo.effect.Type.EffectApplyTypeNative)
        {
            ...
            ImageOp.sunlesstan4buf(d, bytebuffer, k, l, k, l, j, i, flag, i1);
            arraylist.a = true;
            return arraylist;
        }
        return arraylist;
