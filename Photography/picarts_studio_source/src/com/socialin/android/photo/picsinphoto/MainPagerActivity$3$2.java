...
label0:
            {
                if (Inventory.isAdsEnabled())
                {
                    ...
                    a.runOnUiThread(new MainPagerActivity._cls3._cls2(this));
                }
                return;
            }
            a.runOnUiThread(new MainPagerActivity._cls3._cls3());
        }
...
/* anonymous class */
        ...
        // Unreferenced inner class com/socialin/android/photo/picsinphoto/MainPagerActivity$3$3

/* anonymous class */
        final class MainPagerActivity._cls3._cls3
            implements Runnable
        {
