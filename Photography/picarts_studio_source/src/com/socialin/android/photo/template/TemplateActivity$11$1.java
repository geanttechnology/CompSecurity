    ...
    implements Runnable
{
    ...
    // Unreferenced inner class com/socialin/android/photo/template/TemplateActivity$11

/* anonymous class */
    final class TemplateActivity._cls11 extends Thread
    {
...
label0:
                ...
                a.runOnUiThread(new TemplateActivity._cls11._cls1(this));
                return;
            } while (true);
        }
