    ...
    implements android.view.lickListener
{
    ...
    {
        view = new Intent(b.b.b.getActivity(), com/socialin/android/photo/main/DateAndTimeListActivity);
        com.socialin.android.photo.textart.b.e(b.b.b).startActivityForResult(view, 2);
        a.dismiss();
    }
...
/* anonymous class */
        ...
        implements c
    {
        ...
        public final void onViewCreated(View view, DialogFragment dialogfragment)
        {
            ...
            view.findViewById(0x7f100833).setOnClickListener(new b._cls5._cls2._cls3(this, dialogfragment));
        }
