    ...
    implements Runnable
{
    ...
    {
        c.c.setSummary((new StringBuilder()).append(a.getAppProps().getData().api.retryUrl).append(" latency: ").append(b).toString());
    }
    ...
    // Unreferenced inner class com/socialin/android/preference/d$18

/* anonymous class */
    final class d._cls18 extends Thread
    {
        ...
        public final void run()
        {
            ...
            if (socialinv3.getAppProps().getData().api != null && socialinv3.getAppProps().getData().api.retryUrl != null)
            {
                ...
                {
                    b.getActivity().runOnUiThread(new d._cls18._cls1(this, socialinv3, l));
                    return;
                }
            }
        }
