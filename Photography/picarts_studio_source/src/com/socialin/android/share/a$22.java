    ...
    implements d
{
    ...
    {
        a.getActivity().sendBroadcast((new Intent()).setAction("com.picsart.studio.action.repost").putExtra("extra.item.id", com.socialin.android.share.a.f(a).id));
        request = com.socialin.android.share.a.q(a).findViewWithTag("picsartRepost");
        if (request != null)
        {
            obj = (ImageView)request.findViewById(0x7f100a6b);
            request = (TextView)request.findViewById(0x7f100a6c);
            if (obj != null)
            {
                ((ImageView) (obj)).setImageDrawable(a.getResources().getDrawable(0x7f0205f1));
            }
            if (request != null)
            {
        ...
        com.socialin.android.share.a.f(a).isReposted = true;
        m.b(a.getActivity(), com.socialin.android.share.a.l(a));
