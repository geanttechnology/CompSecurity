    ...
    implements g
{
    ...
    public final void a(String s, m m)
    {
        ...
        m.setType("text/*");
        m.putExtra("android.intent.extra.SUBJECT", b.getString(0x7f0808af));
        m.putExtra("android.intent.extra.TEXT", com.socialin.android.share.a.b(b, s));
        m.setFlags(0x10000000);
        s = com.socialin.android.share.a.a(a.queryIntentActivities(m, 0x10000), "com.tencent.mobileqqi");
        if (!TextUtils.isEmpty(s))
        {
            m.setClassName("com.tencent.mobileqqi", s);
            b.startActivity(m);
        }
    }
