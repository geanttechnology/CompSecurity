...
package com.socialin.gson.reflect;
...
public class TypeToken
{
    ...
    protected TypeToken()
    {
        ...
        rawType = com.socialin.gson.internal..Gson.Types.getRawType(type);
        hashCode = type.hashCode();
    }

    TypeToken(Type type1)
    {
        type = com.socialin.gson.internal..Gson.Types.canonicalize((Type)com.socialin.gson.internal..Gson.Preconditions.checkNotNull(type1));
        rawType = com.socialin.gson.internal..Gson.Types.getRawType(type);
        hashCode = type.hashCode();
    }
    ...
    static Type getSuperclassTypeParameter(Class class1)
    {
        ...
        {
            return com.socialin.gson.internal..Gson.Types.canonicalize(((ParameterizedType)class1).getActualTypeArguments()[0]);
        }
    }
...
_L3:
    ...
    private static boolean isAssignableFrom(Type type1, ParameterizedType parameterizedtype, Map map)
    {
        do
        {
            ...
            Class class1 = com.socialin.gson.internal..Gson.Types.getRawType(type1);
            int k;
...
_L4:
    ...
    {
        return (obj instanceof TypeToken) && com.socialin.gson.internal..Gson.Types.equals(type, ((TypeToken)obj).type);
    }
    ...
    public boolean isAssignableFrom(Type type1)
    {
        ...
        {
            return rawType.isAssignableFrom(com.socialin.gson.internal..Gson.Types.getRawType(type1));
        }
        ...
        {
            return rawType.isAssignableFrom(com.socialin.gson.internal..Gson.Types.getRawType(type1)) && isAssignableFrom(type1, (GenericArrayType)type);
        } else
        {
    ...
    {
        return com.socialin.gson.internal..Gson.Types.typeToString(type);
    }
}
