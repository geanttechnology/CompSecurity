...
_L1:
        class _cls4
        {
            ...
            static 
            {
                $SwitchMap$com$stripe$android$compat$AsyncTask$Status = new int[Status.values().length];
                try
                {
                    $SwitchMap$com$stripe$android$compat$AsyncTask$Status[Status.RUNNING.ordinal()] = 1;
                }
                catch (NoSuchFieldError nosuchfielderror1) { }
                try
                {
                    $SwitchMap$com$stripe$android$compat$AsyncTask$Status[Status.FINISHED.ordinal()] = 2;
                }
        ...
        _cls4..SwitchMap.com.stripe.android.compat.AsyncTask.Status[mStatus.ordinal()];
...
_L4:
    ...
    static 
    {
        ...
        SERIAL_EXECUTOR = new ThreadPoolExecutor(1, 1, 1L, TimeUnit.SECONDS, sPoolWorkQueue, sThreadFactory);
    ...
    private class Status extends Enum
    {
        ...
        {
            return (Status)Enum.valueOf(com/stripe/android/compat/AsyncTask$Status, s);
        }
