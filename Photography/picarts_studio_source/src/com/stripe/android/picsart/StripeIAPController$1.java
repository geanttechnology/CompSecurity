    ...
    implements d
{
    ...
    {
        StripeIAPController.access$002(StripeIAPController.this, shopitemslistresponse.response);
        StripeIAPController.access$102(StripeIAPController.this, System.currentTimeMillis());
        if (val$listener != null)
        {
            val$listener.a(StripeIAPController.access$000(StripeIAPController.this));
        }
    }
