...
public final class a extends ScriptC
{
    ...
    {
        this(renderscript, renderscript.getApplicationContext().getResources(), renderscript.getApplicationContext().getResources().getIdentifier("rs_bathroom12", "raw", renderscript.getApplicationContext().getPackageName()));
    }
    ...
    public final void a(Allocation allocation, float f, float f1)
    {
