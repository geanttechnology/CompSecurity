...
public final class b extends ScriptC
{
    ...
    {
        this(renderscript, renderscript.getApplicationContext().getResources(), renderscript.getApplicationContext().getResources().getIdentifier("rs_bathroom23", "raw", renderscript.getApplicationContext().getPackageName()));
    }
    ...
    public final void a(Allocation allocation, float f, int i, int j, int k)
    {
