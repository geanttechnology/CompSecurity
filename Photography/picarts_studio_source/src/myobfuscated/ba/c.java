...
public final class c extends ScriptC
{
    ...
    {
        this(renderscript, renderscript.getApplicationContext().getResources(), renderscript.getApplicationContext().getResources().getIdentifier("rs_circularblur", "raw", renderscript.getApplicationContext().getPackageName()));
    }
