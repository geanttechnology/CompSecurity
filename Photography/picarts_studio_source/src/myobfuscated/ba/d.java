...
public final class d extends ScriptC
{
    ...
    {
        this(renderscript, renderscript.getApplicationContext().getResources(), renderscript.getApplicationContext().getResources().getIdentifier("rs_cylinder_mirror", "raw", renderscript.getApplicationContext().getPackageName()));
    }
