...
public final class f extends ScriptC
{
    ...
    {
        this(renderscript, renderscript.getApplicationContext().getResources(), renderscript.getApplicationContext().getResources().getIdentifier("rs_invert_color_inplace", "raw", renderscript.getApplicationContext().getPackageName()));
    }

    private f(RenderScript renderscript, Resources resources, int i)
    {
