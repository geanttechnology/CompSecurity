...
public final class g extends ScriptC
{
    ...
    {
        this(renderscript, renderscript.getApplicationContext().getResources(), renderscript.getApplicationContext().getResources().getIdentifier("rs_mirrors", "raw", renderscript.getApplicationContext().getPackageName()));
    }

    private g(RenderScript renderscript, Resources resources, int i)
    {
        super(renderscript, resources, i);
        a = Element.U8_4(renderscript);
    }

    public final void a(Allocation allocation, int i, int j, float f, int k, int l)
    {
