...
public final class h extends ScriptC
{
    ...
    {
        this(renderscript, renderscript.getApplicationContext().getResources(), renderscript.getApplicationContext().getResources().getIdentifier("rs_pixelize", "raw", renderscript.getApplicationContext().getPackageName()));
    }

    private h(RenderScript renderscript, Resources resources, int i)
    {
