...
public final class a extends ScriptC
{
    ...
    {
        this(renderscript, renderscript.getApplicationContext().getResources(), renderscript.getApplicationContext().getResources().getIdentifier("rs_acquarello", "raw", renderscript.getApplicationContext().getPackageName()));
    }
