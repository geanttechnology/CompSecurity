...
public final class aa extends ScriptC
{

    private Element a;

    public aa(RenderScript renderscript)
    {
        this(renderscript, renderscript.getApplicationContext().getResources(), renderscript.getApplicationContext().getResources().getIdentifier("rs_holgaart1", "raw", renderscript.getApplicationContext().getPackageName()));
    }

    private aa(RenderScript renderscript, Resources resources, int i)
    {
        super(renderscript, resources, i);
        a = Element.U8_4(renderscript);
    }

    public final void a(Allocation allocation, int i, int j, int k)
    {
