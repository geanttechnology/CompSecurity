...
public final class ac extends ScriptC
{

    private Element a;

    public ac(RenderScript renderscript)
    {
        this(renderscript, renderscript.getApplicationContext().getResources(), renderscript.getApplicationContext().getResources().getIdentifier("rs_holgaart4_2", "raw", renderscript.getApplicationContext().getPackageName()));
    }

    private ac(RenderScript renderscript, Resources resources, int i)
    {
