...
public final class ae extends ScriptC
{
    ...
    {
        this(renderscript, renderscript.getApplicationContext().getResources(), renderscript.getApplicationContext().getResources().getIdentifier("rs_lomo", "raw", renderscript.getApplicationContext().getPackageName()));
    }

    private ae(RenderScript renderscript, Resources resources, int i)
    {
        super(renderscript, resources, i);
        a = Element.U8_4(renderscript);
    }

    public final void a(int i, int j, float f, float f1, float f2, int k, int l)
    {
