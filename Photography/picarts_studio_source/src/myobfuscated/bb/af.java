...
public final class af extends ScriptC
{

    private Element a;

    public af(RenderScript renderscript)
    {
        this(renderscript, renderscript.getApplicationContext().getResources(), renderscript.getApplicationContext().getResources().getIdentifier("rs_motionblur_1", "raw", renderscript.getApplicationContext().getPackageName()));
    }

    private af(RenderScript renderscript, Resources resources, int i)
    {
