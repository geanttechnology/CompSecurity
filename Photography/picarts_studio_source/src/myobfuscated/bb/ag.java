...
public final class ag extends ScriptC
{
    ...
    {
        this(renderscript, renderscript.getApplicationContext().getResources(), renderscript.getApplicationContext().getResources().getIdentifier("rs_motionblur_2", "raw", renderscript.getApplicationContext().getPackageName()));
    }

    private ag(RenderScript renderscript, Resources resources, int i)
    {
