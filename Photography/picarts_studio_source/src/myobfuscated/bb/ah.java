...
public final class ah extends ScriptC
{

    private Element a;

    public ah(RenderScript renderscript)
    {
        this(renderscript, renderscript.getApplicationContext().getResources(), renderscript.getApplicationContext().getResources().getIdentifier("rs_neoncola", "raw", renderscript.getApplicationContext().getPackageName()));
    }

    private ah(RenderScript renderscript, Resources resources, int i)
    {
