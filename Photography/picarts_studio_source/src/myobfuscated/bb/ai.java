...
public final class ai extends ScriptC
{
    ...
    {
        this(renderscript, renderscript.getApplicationContext().getResources(), renderscript.getApplicationContext().getResources().getIdentifier("rs_orton_1", "raw", renderscript.getApplicationContext().getPackageName()));
    }

    private ai(RenderScript renderscript, Resources resources, int i)
    {
