...
public final class aj extends ScriptC
{

    private Element a;

    public aj(RenderScript renderscript)
    {
        this(renderscript, renderscript.getApplicationContext().getResources(), renderscript.getApplicationContext().getResources().getIdentifier("rs_orton_2", "raw", renderscript.getApplicationContext().getPackageName()));
    }

    private aj(RenderScript renderscript, Resources resources, int i)
    {
