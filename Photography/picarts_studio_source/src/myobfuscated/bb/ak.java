...
public final class ak extends ScriptC
{
    ...
    {
        this(renderscript, renderscript.getApplicationContext().getResources(), renderscript.getApplicationContext().getResources().getIdentifier("rs_pastelperfect", "raw", renderscript.getApplicationContext().getPackageName()));
    }

    private ak(RenderScript renderscript, Resources resources, int i)
    {
