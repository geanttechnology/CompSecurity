...
public final class an extends ScriptC
{

    private Element a;

    public an(RenderScript renderscript)
    {
        this(renderscript, renderscript.getApplicationContext().getResources(), renderscript.getApplicationContext().getResources().getIdentifier("rs_posterize", "raw", renderscript.getApplicationContext().getPackageName()));
    }

    private an(RenderScript renderscript, Resources resources, int i)
    {
        super(renderscript, resources, i);
        a = Element.U8_4(renderscript);
    }

    public final void a(Allocation allocation, int i)
    {
