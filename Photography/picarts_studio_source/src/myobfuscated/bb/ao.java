...
public final class ao extends ScriptC
{
    ...
    {
        this(renderscript, renderscript.getApplicationContext().getResources(), renderscript.getApplicationContext().getResources().getIdentifier("rs_seafoam_light_cross", "raw", renderscript.getApplicationContext().getPackageName()));
    }

    private ao(RenderScript renderscript, Resources resources, int i)
    {
