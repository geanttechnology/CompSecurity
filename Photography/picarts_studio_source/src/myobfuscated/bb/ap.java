...
public final class ap extends ScriptC
{

    private Element a;

    public ap(RenderScript renderscript)
    {
        this(renderscript, renderscript.getApplicationContext().getResources(), renderscript.getApplicationContext().getResources().getIdentifier("rs_sharpen_dodger", "raw", renderscript.getApplicationContext().getPackageName()));
    }

    private ap(RenderScript renderscript, Resources resources, int i)
    {
