...
public final class ar extends ScriptC
{

    private Element a;
    private Element b;

    public ar(RenderScript renderscript)
    {
        this(renderscript, renderscript.getApplicationContext().getResources(), renderscript.getApplicationContext().getResources().getIdentifier("rs_sketcher_2", "raw", renderscript.getApplicationContext().getPackageName()));
    }

    private ar(RenderScript renderscript, Resources resources, int i)
    {
