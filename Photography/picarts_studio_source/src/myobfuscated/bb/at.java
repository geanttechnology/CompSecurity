...
public final class at extends ScriptC
{

    private Element a;

    public at(RenderScript renderscript)
    {
        this(renderscript, renderscript.getApplicationContext().getResources(), renderscript.getApplicationContext().getResources().getIdentifier("rs_sketchup", "raw", renderscript.getApplicationContext().getPackageName()));
    }

    private at(RenderScript renderscript, Resources resources, int i)
    {
    ...
    public final void a(Allocation allocation, Allocation allocation1, int i, int j, int k, int l)
    {
