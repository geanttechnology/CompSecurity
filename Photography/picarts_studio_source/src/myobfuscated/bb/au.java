...
public final class au extends ScriptC
{
    ...
    {
        this(renderscript, renderscript.getApplicationContext().getResources(), renderscript.getApplicationContext().getResources().getIdentifier("rs_smartblur", "raw", renderscript.getApplicationContext().getPackageName()));
    }

    private au(RenderScript renderscript, Resources resources, int i)
    {
