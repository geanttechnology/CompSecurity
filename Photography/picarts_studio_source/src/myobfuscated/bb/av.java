...
public final class av extends ScriptC
{

    private Element a;

    public av(RenderScript renderscript)
    {
        this(renderscript, renderscript.getApplicationContext().getResources(), renderscript.getApplicationContext().getResources().getIdentifier("rs_soften", "raw", renderscript.getApplicationContext().getPackageName()));
    }

    private av(RenderScript renderscript, Resources resources, int i)
    {
