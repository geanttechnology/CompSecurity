...
public final class ax extends ScriptC
{

    private Element a;

    public ax(RenderScript renderscript)
    {
        this(renderscript, renderscript.getApplicationContext().getResources(), renderscript.getApplicationContext().getResources().getIdentifier("rs_stenciler_2", "raw", renderscript.getApplicationContext().getPackageName()));
    }

    private ax(RenderScript renderscript, Resources resources, int i)
    {
