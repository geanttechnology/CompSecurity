...
public final class ay extends ScriptC
{

    private Element a;

    public ay(RenderScript renderscript)
    {
        this(renderscript, renderscript.getApplicationContext().getResources(), renderscript.getApplicationContext().getResources().getIdentifier("rs_sunlesstan", "raw", renderscript.getApplicationContext().getPackageName()));
    }

    private ay(RenderScript renderscript, Resources resources, int i)
    {
