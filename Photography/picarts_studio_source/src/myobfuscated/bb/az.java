...
public final class az extends ScriptC
{

    private Element a;

    public az(RenderScript renderscript)
    {
        this(renderscript, renderscript.getApplicationContext().getResources(), renderscript.getApplicationContext().getResources().getIdentifier("rs_tranquil", "raw", renderscript.getApplicationContext().getPackageName()));
    }

    private az(RenderScript renderscript, Resources resources, int i)
    {
