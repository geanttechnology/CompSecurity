...
public final class b extends ScriptC
{
    ...
    {
        this(renderscript, renderscript.getApplicationContext().getResources(), renderscript.getApplicationContext().getResources().getIdentifier("rs_blackandwhite", "raw", renderscript.getApplicationContext().getPackageName()));
    }
