...
public final class ba extends ScriptC
{

    private Element a;

    public ba(RenderScript renderscript)
    {
        this(renderscript, renderscript.getApplicationContext().getResources(), renderscript.getApplicationContext().getResources().getIdentifier("rs_unitedcolors", "raw", renderscript.getApplicationContext().getPackageName()));
    }

    private ba(RenderScript renderscript, Resources resources, int i)
    {
