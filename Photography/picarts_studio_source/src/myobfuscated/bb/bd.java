...
public final class bd extends ScriptC
{

    private Element a;

    public bd(RenderScript renderscript)
    {
        this(renderscript, renderscript.getApplicationContext().getResources(), renderscript.getApplicationContext().getResources().getIdentifier("rs_utils_box_convolve", "raw", renderscript.getApplicationContext().getPackageName()));
    }

    private bd(RenderScript renderscript, Resources resources, int i)
    {
