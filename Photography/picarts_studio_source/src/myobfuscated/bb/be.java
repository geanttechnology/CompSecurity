...
public final class be extends ScriptC
{

    private Element a;

    public be(RenderScript renderscript)
    {
        this(renderscript, renderscript.getApplicationContext().getResources(), renderscript.getApplicationContext().getResources().getIdentifier("rs_utils_box_convolve_gray", "raw", renderscript.getApplicationContext().getPackageName()));
    }

    private be(RenderScript renderscript, Resources resources, int i)
    {
