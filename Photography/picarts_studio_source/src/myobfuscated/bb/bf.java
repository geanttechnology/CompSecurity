...
public final class bf extends ScriptC
{

    private Element a;

    public bf(RenderScript renderscript)
    {
        this(renderscript, renderscript.getApplicationContext().getResources(), renderscript.getApplicationContext().getResources().getIdentifier("rs_utils_const_alpha_blend", "raw", renderscript.getApplicationContext().getPackageName()));
    }

    private bf(RenderScript renderscript, Resources resources, int i)
    {
