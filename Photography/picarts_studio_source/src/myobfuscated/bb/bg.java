...
public final class bg extends ScriptC
{
    ...
    {
        this(renderscript, renderscript.getApplicationContext().getResources(), renderscript.getApplicationContext().getResources().getIdentifier("rs_utils_convert_rgba_to_yuv", "raw", renderscript.getApplicationContext().getPackageName()));
    }

    private bg(RenderScript renderscript, Resources resources, int i)
    {
