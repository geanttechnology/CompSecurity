...
public final class bj extends ScriptC
{

    private Element a;

    public bj(RenderScript renderscript)
    {
        this(renderscript, renderscript.getApplicationContext().getResources(), renderscript.getApplicationContext().getResources().getIdentifier("rs_utils_correct_saturation", "raw", renderscript.getApplicationContext().getPackageName()));
    }

    private bj(RenderScript renderscript, Resources resources, int i)
    {
