...
public final class bm extends ScriptC
{

    private Element a;

    public bm(RenderScript renderscript)
    {
        this(renderscript, renderscript.getApplicationContext().getResources(), renderscript.getApplicationContext().getResources().getIdentifier("rs_utils_draw_circular_gradient", "raw", renderscript.getApplicationContext().getPackageName()));
    }

    private bm(RenderScript renderscript, Resources resources, int i)
    {
