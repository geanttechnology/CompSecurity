...
public final class by extends ScriptC
{

    private Element a;

    public by(RenderScript renderscript)
    {
        this(renderscript, renderscript.getApplicationContext().getResources(), renderscript.getApplicationContext().getResources().getIdentifier("rs_vignette", "raw", renderscript.getApplicationContext().getPackageName()));
    }

    private by(RenderScript renderscript, Resources resources, int i)
    {
