...
public final class bz extends ScriptC
{

    private Element a;

    public bz(RenderScript renderscript)
    {
        this(renderscript, renderscript.getApplicationContext().getResources(), renderscript.getApplicationContext().getResources().getIdentifier("rs_vintage", "raw", renderscript.getApplicationContext().getPackageName()));
    }

    private bz(RenderScript renderscript, Resources resources, int i)
    {
        super(renderscript, resources, i);
        a = Element.U8_4(renderscript);
    }

    public final void a(float f, int i, int j)
    {
