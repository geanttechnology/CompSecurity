...
public final class c extends ScriptC
{
    ...
    {
        this(renderscript, renderscript.getApplicationContext().getResources(), renderscript.getApplicationContext().getResources().getIdentifier("rs_bleaching", "raw", renderscript.getApplicationContext().getPackageName()));
    }

    private c(RenderScript renderscript, Resources resources, int i)
    {
