...
public final class ca extends ScriptC
{

    private Element a;

    public ca(RenderScript renderscript)
    {
        this(renderscript, renderscript.getApplicationContext().getResources(), renderscript.getApplicationContext().getResources().getIdentifier("rs_vintage_ivory", "raw", renderscript.getApplicationContext().getPackageName()));
    }

    private ca(RenderScript renderscript, Resources resources, int i)
    {
