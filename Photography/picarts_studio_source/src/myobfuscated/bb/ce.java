...
public final class ce extends ScriptC
{

    private Element a;

    public ce(RenderScript renderscript)
    {
        this(renderscript, renderscript.getApplicationContext().getResources(), renderscript.getApplicationContext().getResources().getIdentifier("rs_yestercolor", "raw", renderscript.getApplicationContext().getPackageName()));
    }

    private ce(RenderScript renderscript, Resources resources, int i)
    {
