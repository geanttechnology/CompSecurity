...
public final class d extends ScriptC
{
    ...
    {
        this(renderscript, renderscript.getApplicationContext().getResources(), renderscript.getApplicationContext().getResources().getIdentifier("rs_cinerama", "raw", renderscript.getApplicationContext().getPackageName()));
    }
