...
public final class f extends ScriptC
{
    ...
    {
        this(renderscript, renderscript.getApplicationContext().getResources(), renderscript.getApplicationContext().getResources().getIdentifier("rs_contours", "raw", renderscript.getApplicationContext().getPackageName()));
    }
