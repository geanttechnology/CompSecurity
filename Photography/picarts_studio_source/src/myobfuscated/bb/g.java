...
public final class g extends ScriptC
{
    ...
    {
        this(renderscript, renderscript.getApplicationContext().getResources(), renderscript.getApplicationContext().getResources().getIdentifier("rs_crossprocess", "raw", renderscript.getApplicationContext().getPackageName()));
    }
