...
public final class i extends ScriptC
{
    ...
    {
        this(renderscript, renderscript.getApplicationContext().getResources(), renderscript.getApplicationContext().getResources().getIdentifier("rs_dusk", "raw", renderscript.getApplicationContext().getPackageName()));
    }
    ...
    public final void a(Allocation allocation, int j)
    {
