...
public final class j extends ScriptC
{
    ...
    {
        this(renderscript, renderscript.getApplicationContext().getResources(), renderscript.getApplicationContext().getResources().getIdentifier("rs_effect_12", "raw", renderscript.getApplicationContext().getPackageName()));
    }
