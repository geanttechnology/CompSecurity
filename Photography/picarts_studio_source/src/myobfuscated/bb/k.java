...
public final class k extends ScriptC
{
    ...
    {
        this(renderscript, renderscript.getApplicationContext().getResources(), renderscript.getApplicationContext().getResources().getIdentifier("rs_effect_13", "raw", renderscript.getApplicationContext().getPackageName()));
    }
