...
public final class l extends ScriptC
{
    ...
    {
        this(renderscript, renderscript.getApplicationContext().getResources(), renderscript.getApplicationContext().getResources().getIdentifier("rs_effect_14", "raw", renderscript.getApplicationContext().getPackageName()));
    }

    private l(RenderScript renderscript, Resources resources, int i)
    {
