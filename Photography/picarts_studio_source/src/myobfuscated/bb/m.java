...
public final class m extends ScriptC
{
    ...
    {
        this(renderscript, renderscript.getApplicationContext().getResources(), renderscript.getApplicationContext().getResources().getIdentifier("rs_effect_24_1", "raw", renderscript.getApplicationContext().getPackageName()));
    }

    private m(RenderScript renderscript, Resources resources, int i)
    {
