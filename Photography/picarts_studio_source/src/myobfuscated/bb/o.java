...
public final class o extends ScriptC
{
    ...
    {
        this(renderscript, renderscript.getApplicationContext().getResources(), renderscript.getApplicationContext().getResources().getIdentifier("rs_effect_24_3", "raw", renderscript.getApplicationContext().getPackageName()));
    }

    private o(RenderScript renderscript, Resources resources, int i)
    {
