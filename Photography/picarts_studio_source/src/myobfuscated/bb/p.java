...
public final class p extends ScriptC
{
    ...
    {
        this(renderscript, renderscript.getApplicationContext().getResources(), renderscript.getApplicationContext().getResources().getIdentifier("rs_effect_40", "raw", renderscript.getApplicationContext().getPackageName()));
    }

    private p(RenderScript renderscript, Resources resources, int i)
    {
