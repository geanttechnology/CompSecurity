...
public final class r extends ScriptC
{
    ...
    {
        this(renderscript, renderscript.getApplicationContext().getResources(), renderscript.getApplicationContext().getResources().getIdentifier("rs_effect_4_2", "raw", renderscript.getApplicationContext().getPackageName()));
    }

    private r(RenderScript renderscript, Resources resources, int i)
    {
