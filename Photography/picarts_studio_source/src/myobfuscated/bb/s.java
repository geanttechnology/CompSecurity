...
public final class s extends ScriptC
{
    ...
    {
        this(renderscript, renderscript.getApplicationContext().getResources(), renderscript.getApplicationContext().getResources().getIdentifier("rs_effect_4_3", "raw", renderscript.getApplicationContext().getPackageName()));
    }

    private s(RenderScript renderscript, Resources resources, int i)
    {
