...
public final class t extends ScriptC
{
    ...
    {
        this(renderscript, renderscript.getApplicationContext().getResources(), renderscript.getApplicationContext().getResources().getIdentifier("rs_effect_7", "raw", renderscript.getApplicationContext().getPackageName()));
    }

    private t(RenderScript renderscript, Resources resources, int i)
    {
