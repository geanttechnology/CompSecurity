...
public final class u extends ScriptC
{
    ...
    {
        this(renderscript, renderscript.getApplicationContext().getResources(), renderscript.getApplicationContext().getResources().getIdentifier("rs_focalzoom", "raw", renderscript.getApplicationContext().getPackageName()));
    }

    private u(RenderScript renderscript, Resources resources, int i)
    {
