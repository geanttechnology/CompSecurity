...
public final class v extends ScriptC
{
    ...
    {
        this(renderscript, renderscript.getApplicationContext().getResources(), renderscript.getApplicationContext().getResources().getIdentifier("rs_grannyspaper", "raw", renderscript.getApplicationContext().getPackageName()));
    }

    private v(RenderScript renderscript, Resources resources, int i)
    {
    ...
    public final void a(Allocation allocation, Allocation allocation1, Allocation allocation2, int i, int j, int k, int l)
    {
