...
public final class x extends ScriptC
{
    ...
    {
        this(renderscript, renderscript.getApplicationContext().getResources(), renderscript.getApplicationContext().getResources().getIdentifier("rs_halftonedots_2", "raw", renderscript.getApplicationContext().getPackageName()));
    }

    private x(RenderScript renderscript, Resources resources, int i)
    {
