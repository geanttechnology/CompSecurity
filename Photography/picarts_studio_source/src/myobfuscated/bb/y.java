...
public final class y extends ScriptC
{
    ...
    {
        this(renderscript, renderscript.getApplicationContext().getResources(), renderscript.getApplicationContext().getResources().getIdentifier("rs_hdr_1", "raw", renderscript.getApplicationContext().getPackageName()));
    }

    private y(RenderScript renderscript, Resources resources, int i)
    {
