...
public final class z extends ScriptC
{
    ...
    {
        this(renderscript, renderscript.getApplicationContext().getResources(), renderscript.getApplicationContext().getResources().getIdentifier("rs_hdr_2", "raw", renderscript.getApplicationContext().getPackageName()));
    }

    private z(RenderScript renderscript, Resources resources, int i)
    {
