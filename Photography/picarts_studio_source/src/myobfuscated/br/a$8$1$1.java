    ...
    implements Runnable
{
    ...
    {
        myobfuscated.br.a.a(a.a.a).c.c(myobfuscated.br.a.a(a.a.a));
        if (a.a.a != null)
        {
            a.a.a.run();
        }
...
_L3:
    ...
    // Unreferenced inner class myobfuscated/br/a$8$1
...
/* anonymous class */
        ...
        implements Runnable
    {
        ...
        public final void run()
        {
            RandomAccessFile randomaccessfile = new RandomAccessFile(new File(myobfuscated.br.a.a(a.c).c.k.getRootFolder(), b), "rw");
            c.rewind();
            myobfuscated.br.d.a(c, randomaccessfile);
            myobfuscated.br.a.b(a.c).post(new a._cls8._cls1._cls1(this));
_L1:
            return;
