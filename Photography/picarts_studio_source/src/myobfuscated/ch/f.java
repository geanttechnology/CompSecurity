...
public final class f extends c
{
    ...
    {
        a(3, 1, 0, 0);
        LinearLayout linearlayout = (LinearLayout)((LayoutInflater)a.getSystemService("layout_inflater")).inflate(0x7f0300c9, null);
        ...
        d.add(layoutparams);
        layoutparams = new myobfuscated.cg.f();
        layoutparams.a = (RadioGroup)linearlayout.findViewById(0x7f100405);
        ArrayList arraylist = new ArrayList(2);
        arraylist.add(Integer.valueOf(0x7f100426));
        arraylist.add(Integer.valueOf(0x7f100427));
        layoutparams.b = arraylist;
        arraylist = new ArrayList(2);
        arraylist.add("Mode 1");
        arraylist.add("Mode 2");
