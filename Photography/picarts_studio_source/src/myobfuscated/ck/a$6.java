    ...
    public final void a(c c1, boolean flag, long l, boolean flag1)
    {
        if (flag)
        {
            ...
            if (obj1 != null)
            {
                ...
                flag1 = myobfuscated.ck.a.M(b);
                obj1 = a;
                myobfuscated.ck.c c2 = myobfuscated.ck.a.a(b);
                b.getActivity().getApplicationContext();
                myobfuscated.ay.e.a(((android.content.Context) (obj)), c1, i, j, flag1, true, l, true, ((JSONArray) (obj1)), c2.j());
            }
        }
