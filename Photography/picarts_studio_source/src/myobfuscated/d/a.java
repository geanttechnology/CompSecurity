...
public class a
{
    ...
    protected boolean readBooleanResourceValue(String s, boolean flag)
    {
        ...
        int i = b.getResources().getIdentifier(s, "bool", c.a(b));
        if (i == 0)
        {
    ...
    protected int readIntegerResourceValue(String s, int i)
    {
        ...
        int j = b.getResources().getIdentifier(s, "integer", c.a(b));
        if (j == 0)
        {
    ...
    protected String[] readStringArrayResourceValue(String s, String as[])
    {
        ...
        int i = b.getResources().getIdentifier(s, "array", c.a(b));
        if (i == 0)
        {
    ...
    protected String readStringResourceValue(String s, String s1)
    {
        ...
        int i = b.getResources().getIdentifier(s, "string", c.a(b));
        if (i == 0)
        {
    ...
    static 
    {
        a = String.format("%s.%s", new Object[] {
            Constants.APPBOY_LOG_TAG_PREFIX, myobfuscated/d/a.getName()
        });
    }
}
