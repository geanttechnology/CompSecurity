...
_L4:
        j = a(motionevent);
        if (j <= 10F) goto _L1; else goto _L5
_L5:
        f.set(rectf1);
        e.set(rectf);
        a(g, motionevent);
        ...
        return true;
_L3:
        if (a != c && a != d) goto _L1; else goto _L6
_L6:
        f2 = a(motionevent);
        if (f2 > 10F && a == c)
        {
        ...
        return true;
_L2:
        if (a != d && a != c) goto _L1; else goto _L7
_L7:
        if (motionevent.getPointerCount() != 1) goto _L9; else goto _L8
_L8:
        a = 0;
_L11:
        return true;
