...
_L1:
        ...
        Object obj;
        obj;
        myobfuscated.i.a.a(a, "Could not find resource for package identification, returning Context#getPackageName().");
_L2:
        context = context.getPackageName();
        b = context;
        return context;
        obj;
        myobfuscated.i.a.c(a, "Got null pointer exception getting resource package name, returning Context#getPackageName().", ((Throwable) (obj)));
        continue; /* Loop/switch isn't completed */
        obj;
        myobfuscated.i.a.c(a, "General exception getting resource package name, returning Context#getPackageName().", ((Throwable) (obj)));
...
_L4:
    ...
    static 
    {
        a = String.format("%s.%s", new Object[] {
            Constants.APPBOY_LOG_TAG_PREFIX, myobfuscated/i/c.getName()
        });
    }
}
