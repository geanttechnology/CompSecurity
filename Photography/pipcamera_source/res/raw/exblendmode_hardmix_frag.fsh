...
{
	float r = BlendHardMixf(base.r, blend.r);
	float g = BlendHardMixf(base.g, blend.g);
	float b = BlendHardMixf(base.b, blend.b);
	vec3 c = vec3(r, g, b);
...
void main()
{
	...
	lowp vec3 color = BlendHardMix(baseColor, blendColor, opacity);
