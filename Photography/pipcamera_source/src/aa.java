    ...
    implements ar
{
    ...
    public aa(Context context, int k, int l)
    {
        a = context;
    ...
    public at a(ViewGroup viewgroup)
    {
        if (f == null)
        {
            f = (at)d.inflate(h, viewgroup, false);
            f.initialize(c);
            a(true);
        }
        return f;
    ...
    public abstract void a(MenuItemImpl menuitemimpl, au au1);
            ...
            if (c != null)
            {
                ...
                do
                {
                    ...
                    if (a(k, menuitemimpl1))
                    {
                        ...
                        if (view instanceof au)
                        {
                            menuitemimpl = ((au)view).getItemData();
                        } else
                        {
                            menuitemimpl = null;
                        }
    ...
    {
        return (au)d.inflate(i, viewgroup, false);
    }
