...
public class aau
{
    ...
    protected String b(Context context)
    {
        ...
        {
            zw.h().a("Fabric", (new StringBuilder()).append("Caught non-fatal exception while retrieving apiKey: ").append(context).toString());
            return s;
        }
        s = s1;
        ...
        s = s1;
        zw.h().a("Fabric", "Falling back to Crashlytics key lookup from Manifest");
        s = s1;
    ...
    protected String c(Context context)
    {
        ...
        if (j == 0)
        {
            zw.h().a("Fabric", "Falling back to Crashlytics key lookup from Strings");
