    ...
    implements acm
{
    ...
    public final ach filesManager;
    volatile int rolloverIntervalSeconds;
    final AtomicReference scheduledRolloverFutureRef = new AtomicReference();

    public acf(Context context1, ScheduledExecutorService scheduledexecutorservice, ach ach1)
    {
    ...
    void scheduleTimeBasedFileRollOver(long l, long l1)
    {
        ...
        scheduledRolloverFutureRef.set(executorService.scheduleAtFixedRate(acr1, l, l1, TimeUnit.SECONDS));
        return;
    ...
    {
        aco aco1 = getFilesSender();
        if (aco1 != null) goto _L2; else goto _L1
_L1:
