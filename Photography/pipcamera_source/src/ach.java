...
public abstract class ach
{
    ...
    public final aaz currentTimeProvider;
    private final int defaultMaxFilesToKeep;
    protected final ack eventStorage;
    protected volatile long lastRollOverTime;
    protected final List rollOverListeners = new CopyOnWriteArrayList();
    protected final acg transform;

    public ach(Context context1, acg acg1, aaz aaz1, ack ack1, int i)
    {
    ...
    public void deleteOldestInRollOverIfOverMax()
    {
        ...
        Object obj = new TreeSet(new Comparator() {
            ...
            public int a(aci aci1, aci aci2)
            {
                return (int)(aci1.b - aci2.b);
            }

            public int compare(Object obj2, Object obj3)
            {
                return a((aci)obj2, (aci)obj3);
            }
        ...
        File file;
        for (obj1 = ((List) (obj1)).iterator(); ((Iterator) (obj1)).hasNext(); ((TreeSet) (obj)).add(new aci(file, parseCreationTimestampFromFileName(file.getName()))))
        {
        ...
        do
        {
            ...
            ((ArrayList) (obj1)).add(((aci)((Iterator) (obj)).next()).a);
    ...
    public void registerRollOverListener(acl acl1)
    {
        if (acl1 != null)
        {
            rollOverListeners.add(acl1);
        }
    }
