...
final class acs
{
    ...
    public static X509Certificate[] a(X509Certificate ax509certificate[], adc adc1)
    {
        boolean flag2 = true;
        ...
        ax509certificate = adc1.b(ax509certificate[i - 1]);
