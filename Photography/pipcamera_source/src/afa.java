...
public class afa extends aeo
{
    ...
    static int a(afa afa1)
    {
        return afa1.A;
    }

    static int a(afa afa1, int i)
    {
        afa1.A = i;
        return i;
    }
            ...
            a(new Runnable() {
                ...
                public void run()
                {
                    if (afa.a(a) == -1)
                    {
                        ...
                        afa.a(a, OpenGlUtils.a(afa.b(a), -1, true));
                    }
                }
    ...
    public void a(int i, FloatBuffer floatbuffer, FloatBuffer floatbuffer1)
    {
        ...
        GLES20.glUniform4fv(B.b("colorFill_multiply"), 1, p);
        GLES20.glUniform4fv(B.b("colorFill_exclusion"), 1, q);
        GLES20.glUniform4fv(B.b("colorFill_screen"), 1, r);
        GLES20.glUniform4fv(B.b("colorFill_darken"), 1, s);
        GLES20.glUniform4fv(B.b("colorFill_lighten"), 1, t);
        GLES20.glUniform4fv(B.b("colorFill_vividlight"), 1, u);
        GLES20.glUniform4fv(B.b("colorFill_softlight"), 1, v);
        ...
        GLES20.glUniform1f(B.b("filterLevel"), n);
