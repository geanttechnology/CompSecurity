...
public class afi extends aeo
{
    ...
    static int a(afi afi1)
    {
        return afi1.t;
    }

    static int a(afi afi1, int i)
    {
        afi1.t = i;
        return i;
    }
            ...
            a(new Runnable() {
                ...
                public void run()
                {
                    if (afi.a(a) == -1)
                    {
                        ...
                        afi.a(a, OpenGlUtils.a(afi.b(a), -1, true));
                    }
                }
