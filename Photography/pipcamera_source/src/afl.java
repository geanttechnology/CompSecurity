...
public class afl extends aeo
{
    ...
    static int a(afl afl1)
    {
        return afl1.t;
    }

    static int a(afl afl1, int i)
    {
        afl1.t = i;
        return i;
    }
            ...
            a(new Runnable() {
                ...
                public void run()
                {
                    if (afl.a(a) == -1)
                    {
                        ...
                        afl.a(a, OpenGlUtils.a(afl.b(a), -1, true));
                    }
                }
