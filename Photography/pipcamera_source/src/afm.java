...
public class afm extends aeo
{
    ...
    static int a(afm afm1)
    {
        return afm1.t;
    }

    static int a(afm afm1, int i)
    {
        afm1.t = i;
        return i;
    }
            ...
            a(new Runnable() {
                ...
                public void run()
                {
                    if (afm.a(a) == -1)
                    {
                        ...
                        afm.a(a, OpenGlUtils.a(afm.b(a), -1, true));
                    }
                }
    ...
    public void a(int i, FloatBuffer floatbuffer, FloatBuffer floatbuffer1)
    {
        ...
        GLES20.glUniform4fv(u.b("colorFill_overlay"), 1, p);
        v.a(33988);
