...
public class afo extends aeo
{
            ...
            a(new Runnable() {
                ...
                public void run()
                {
                    if (afo.a(a) == -1)
                    {
                        ...
                        afo.a(a, OpenGlUtils.a(afo.b(a), -1, true));
                    }
                }
    ...
    public void a(int i, FloatBuffer floatbuffer, FloatBuffer floatbuffer1)
    {
        ...
        GLES20.glUniform3fv(v.b("bceShift"), 1, q);
        w.a(33988);
