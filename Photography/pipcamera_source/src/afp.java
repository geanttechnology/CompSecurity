...
public class afp extends aeo
{
            ...
            a(new Runnable() {
                ...
                public void run()
                {
                    if (afp.a(a) == -1)
                    {
                        ...
                        afp.a(a, OpenGlUtils.a(afp.b(a), -1, true));
                    }
                }
    ...
    public void a(int i, FloatBuffer floatbuffer, FloatBuffer floatbuffer1)
    {
        ...
        GLES20.glUniform4fv(u.b("colorFill_multiply"), 1, p);
        v.a(33988);
