...
public class afq extends aeo
{
    ...
    static int a(afq afq1)
    {
        return afq1.t;
    }

    static int a(afq afq1, int i)
    {
        afq1.t = i;
        return i;
    }
            ...
            a(new Runnable() {
                ...
                public void run()
                {
                    if (afq.a(a) == -1)
                    {
                        ...
                        afq.a(a, OpenGlUtils.a(afq.b(a), -1, true));
                    }
                }
