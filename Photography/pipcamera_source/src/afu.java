...
public class afu extends aeo
{
    ...
    static int a(afu afu1)
    {
        return afu1.u;
    }

    static int a(afu afu1, int i)
    {
        afu1.u = i;
        return i;
    }
            ...
            a(new Runnable() {
                ...
                public void run()
                {
                    if (afu.a(a) == -1)
                    {
                        ...
                        afu.a(a, OpenGlUtils.a(afu.b(a), -1, true));
                    }
                }
