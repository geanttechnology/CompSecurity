...
public class afx extends aeo
{
    ...
    static int a(afx afx1)
    {
        return afx1.s;
    }

    static int a(afx afx1, int i)
    {
        afx1.s = i;
        return i;
    }
            ...
            a(new Runnable() {
                ...
                public void run()
                {
                    if (afx.a(a) == -1)
                    {
                        ...
                        afx.a(a, OpenGlUtils.a(afx.b(a), -1, true));
                    }
                }
