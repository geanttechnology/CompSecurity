...
public class agb extends aeo
{
    ...
    protected int q;
    private Bitmap r;
    private GPUImageBeautyBlendMode s;
    private float t;
    private int u;
    private boolean v;
    private boolean w;
    ...
    static int a(agb agb1)
    {
        return agb1.u;
    }

    static int a(agb agb1, int i)
    {
        agb1.u = i;
        return i;
    }
    ...
    private int b(GPUImageBeautyBlendMode gpuimagebeautyblendmode)
    {
        ...
        switch (_cls2.a[gpuimagebeautyblendmode.ordinal()])
        {
        default:
            return -1;
    ...
    static boolean b(agb agb1)
    {
        return agb1.z;
    }

    static Bitmap c(agb agb1)
    {
        return agb1.r;
    }
...
label0:
                    {
                        if (agb.a(a) == -1)
                        {
                            ...
                            agb.a(a, OpenGlUtils.a(agb.c(a), -1, jp.co.cyberagent.android.gpuimage.OpenGlUtils.Direction.VERTICAL, true));
                        }
                        return;
                    }
                    agb.a(a, OpenGlUtils.a(agb.c(a), -1, true));
                }
    ...
    public void a(int i, FloatBuffer floatbuffer, FloatBuffer floatbuffer1)
    {
        ...
        GLES20.glUniform1i(y.b("blendMode"), b(s));
        GLES20.glUniform1f(y.b("blendAlpha"), t);
