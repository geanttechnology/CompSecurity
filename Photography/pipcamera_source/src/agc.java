...
public class agc extends aeo
{
    ...
    static int a(agc agc1, int i)
    {
        agc1.N = i;
        return i;
    }

    static Bitmap a(agc agc1)
    {
        return agc1.M;
    }
    ...
    static int b(agc agc1)
    {
        return agc1.N;
    }

    static int b(agc agc1, int i)
    {
        agc1.K = i;
        return i;
    }

    static Bitmap c(agc agc1)
    {
        return agc1.J;
    }
    ...
    private void c(int i, FloatBuffer floatbuffer, FloatBuffer floatbuffer1)
    {
        ...
        GLES20.glVertexAttribPointer(y.a("position"), 2, 5126, false, 0, r);
    ...
    private void d(int i, FloatBuffer floatbuffer, FloatBuffer floatbuffer1)
    {
        ...
        u.position(0);
        GLES20.glEnableVertexAttribArray(y.a("position"));
        GLES20.glVertexAttribPointer(y.a("position"), 2, 5126, false, 0, u);
        floatbuffer1.position(0);
        GLES20.glEnableVertexAttribArray(y.a("inputTextureCoordinate"));
        GLES20.glVertexAttribPointer(y.a("inputTextureCoordinate"), 2, 5126, false, 0, floatbuffer1);
        GLES20.glDrawArrays(5, 0, 4);
    ...
    private void j()
    {
        q = ByteBuffer.allocateDirect(D.length * 4).order(ByteOrder.nativeOrder()).asFloatBuffer();
        q.put(D).position(0);
        r = ByteBuffer.allocateDirect(H.length * 4).order(ByteOrder.nativeOrder()).asFloatBuffer();
        r.put(H).position(0);
    }
    ...
    private void k()
    {
        ...
        a(a(rect1, 0.75F), rect1, t);
        u = ByteBuffer.allocateDirect(t.length * 4).order(ByteOrder.nativeOrder()).asFloatBuffer();
        u.put(t).position(0);
        a(rect1, rect, s);
        v = ByteBuffer.allocateDirect(s.length * 4).order(ByteOrder.nativeOrder()).asFloatBuffer();
        v.put(s).position(0);
    }
        ...
        } else
        {
            a(new Runnable() {
                ...
                public void run()
                {
                    synchronized (a.p)
                    {
                        if (agc.a(a) != null && !agc.a(a).isRecycled() && agc.b(a) == -1)
                        {
                            GLES20.glActiveTexture(33985);
                            agc.a(a, OpenGlUtils.a(agc.a(a), true));
                        }
                        if (agc.c(a) != null && !agc.c(a).isRecycled() && agc.d(a) == -1)
                        {
                            GLES20.glActiveTexture(33984);
                            agc.b(a, OpenGlUtils.a(agc.c(a), true));
                        }
                    }
                    return;
                    exception;
    ...
    public void a(int i, FloatBuffer floatbuffer, FloatBuffer floatbuffer1)
    {
        ...
        if (this.i)
        {
            ...
            if (N != -1)
            {
                ...
                GLES20.glVertexAttribPointer(B.a("position"), 2, 5126, false, 0, v);
                floatbuffer1.position(0);
            ...
            if (K != -1)
            {
                ...
                q.position(0);
                GLES20.glEnableVertexAttribArray(y.a("position"));
                GLES20.glVertexAttribPointer(y.a("position"), 2, 5126, false, 0, q);
                floatbuffer1.position(0);
                GLES20.glEnableVertexAttribArray(y.a("inputTextureCoordinate"));
                GLES20.glVertexAttribPointer(y.a("inputTextureCoordinate"), 2, 5126, false, 0, floatbuffer1);
                GLES20.glDrawArrays(5, 0, 4);
