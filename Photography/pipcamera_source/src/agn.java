...
public class agn extends aeo
{
    ...
    static int a(agn agn1)
    {
        return agn1.t;
    }

    static int a(agn agn1, int i)
    {
        agn1.t = i;
        return i;
    }
            ...
            a(new Runnable() {
                ...
                public void run()
                {
                    if (agn.a(a) == -1)
                    {
                        ...
                        agn.a(a, OpenGlUtils.a(agn.b(a), -1, true));
                    }
                }
    ...
    private void n()
    {
        ...
        PointF pointf1 = new PointF(0.3137255F, 0.4862745F);
        PointF pointf2 = new PointF(0.6F, 0.8313726F);
        PointF pointf3 = new PointF(1.0F, 1.0F);
        PointF pointf4 = new PointF(0.0F, 0.0F);
        PointF pointf5 = new PointF(0.2588235F, 0.2196078F);
        PointF pointf6 = new PointF(0.6078432F, 0.6901961F);
        PointF pointf7 = new PointF(1.0F, 1.0F);
        PointF pointf8 = new PointF(0.0F, 0.0F);
        PointF pointf9 = new PointF(0.2470588F, 0.2745098F);
        PointF pointf10 = new PointF(0.7215686F, 0.7019608F);
        PointF pointf11 = new PointF(1.0F, 1.0F);
        PointF pointf12 = new PointF(0.0F, 0.0F);
        PointF pointf13 = new PointF(0.2470588F, 0.3529412F);
        PointF pointf14 = new PointF(0.6901961F, 0.6901961F);
