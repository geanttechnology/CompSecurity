...
public class agq extends aeo
{
    ...
    static int a(agq agq1)
    {
        return agq1.u;
    }

    static int a(agq agq1, int i)
    {
        agq1.u = i;
        return i;
    }
            ...
            a(new Runnable() {
                ...
                public void run()
                {
                    if (agq.a(a) == -1)
                    {
                        ...
                        agq.a(a, OpenGlUtils.a(agq.b(a), -1, true));
                    }
                }
    ...
    private void m()
    {
        ...
        q = FloatBuffer.wrap(new float[] {
            0.5019608F, 0.8392157F, 1.0F, 1.0F
        });
    }
    ...
    private void n()
    {
        ...
        PointF pointf1 = new PointF(0.3843137F, 0.3647059F);
        PointF pointf2 = new PointF(0.6117647F, 0.7215686F);
        PointF pointf3 = new PointF(1.0F, 1.0F);
        PointF pointf4 = new PointF(0.0F, 0.0F);
        PointF pointf5 = new PointF(0.2980392F, 0.3607843F);
        PointF pointf6 = new PointF(0.6862745F, 0.6117647F);
        PointF pointf7 = new PointF(1.0F, 1.0F);
        PointF pointf8 = new PointF(0.0F, 0.0F);
        PointF pointf9 = new PointF(0.254902F, 0.2313726F);
        PointF pointf10 = new PointF(0.6588235F, 0.6666667F);
        PointF pointf11 = new PointF(1.0F, 1.0F);
        PointF pointf12 = new PointF(0.0F, 0.0F);
        PointF pointf13 = new PointF(0.3568628F, 0.4705882F);
        PointF pointf14 = new PointF(0.6862745F, 0.654902F);
        PointF pointf15 = new PointF(0.7764706F, 0.7176471F);
