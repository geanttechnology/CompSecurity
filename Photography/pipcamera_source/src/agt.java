...
public class agt extends aeo
{
    ...
    static int a(agt agt1)
    {
        return agt1.t;
    }

    static int a(agt agt1, int i)
    {
        agt1.t = i;
        return i;
    }
            ...
            a(new Runnable() {
                ...
                public void run()
                {
                    if (agt.a(a) == -1)
                    {
                        ...
                        agt.a(a, OpenGlUtils.a(agt.b(a), -1, true));
                    }
                }
    ...
    private void n()
    {
        ...
        PointF pointf1 = new PointF(0.2901961F, 0.454902F);
        PointF pointf2 = new PointF(0.6117647F, 0.7490196F);
        PointF pointf3 = new PointF(1.0F, 1.0F);
        PointF pointf4 = new PointF(0.0F, 0.0F);
        PointF pointf5 = new PointF(0.2980392F, 0.1686275F);
        PointF pointf6 = new PointF(0.6784314F, 0.6196079F);
        PointF pointf7 = new PointF(1.0F, 1.0F);
        PointF pointf8 = new PointF(0.0F, 0.0F);
        PointF pointf9 = new PointF(0.4156863F, 0.3333333F);
        PointF pointf10 = new PointF(0.6901961F, 0.682353F);
        PointF pointf11 = new PointF(1.0F, 1.0F);
        PointF pointf12 = new PointF(0.0F, 0.0F);
        PointF pointf13 = new PointF(0.254902F, 0.4F);
        PointF pointf14 = new PointF(0.5882353F, 0.6078432F);
        PointF pointf15 = new PointF(0.7568628F, 0.7098039F);
