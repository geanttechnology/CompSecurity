    ...
    implements MenuItem
{
    ...
    ai(Context context, SupportMenuItem supportmenuitem)
    {
        super(context, supportmenuitem);
    }

    aj a(ActionProvider actionprovider)
    {
        return new aj(this, a, actionprovider);
    }
    ...
    public ActionProvider getActionProvider()
    {
        ...
        if (actionprovider instanceof aj)
        {
            return ((aj)actionprovider).a;
        } else
        {
            return null;
        }
    ...
    public MenuItem setActionView(int i)
    {
        ...
        {
            ((SupportMenuItem)b).setActionView(new ak(view));
        }
        return this;
    }
    ...
    public MenuItem setOnActionExpandListener(android.view.MenuItem.OnActionExpandListener onactionexpandlistener)
    {
        ...
        {
            onactionexpandlistener = new al(this, onactionexpandlistener);
        } else
        {
    ...
    public MenuItem setOnMenuItemClickListener(android.view.MenuItem.OnMenuItemClickListener onmenuitemclicklistener)
    {
        ...
        {
            onmenuitemclicklistener = new am(this, onmenuitemclicklistener);
        } else
        {
