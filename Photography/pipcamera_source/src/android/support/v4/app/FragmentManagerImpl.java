...
_L15:
    ...
    public View onCreateView(String s, Context context, AttributeSet attributeset)
    {
        ...
        if (DEBUG)
        {
            Log.v("FragmentManager", (new StringBuilder()).append("onCreateView: id=0x").append(Integer.toHexString(j)).append(" fname=").append(s1).append(" existing=").append(obj).toString());
        }
        if (obj == null)
        {
        ...
        if (mCurState < 1 && ((Fragment) (obj)).mFromLayout)
        {
            moveToState(((Fragment) (obj)), 1, 0, 0, false);
        } else
        {
            moveToState(((Fragment) (obj)));
        }
        ...
        if (j != 0)
        {
            ((Fragment) (obj)).mView.setId(j);
        }
        if (((Fragment) (obj)).mView.getTag() == null)
        {
            ((Fragment) (obj)).mView.setTag(s2);
        }
        return ((Fragment) (obj)).mView;
    }
