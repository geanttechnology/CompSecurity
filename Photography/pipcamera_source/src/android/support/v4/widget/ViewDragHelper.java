...
_L11:
        ...
        return;
_L12:
        if (checkTouchSlop(view = findTopChildUnder((int)f1, (int)f3), f4, f5) && tryCaptureViewForDrag(view, j)) goto _L11; else goto _L13
_L13:
        i++;
          goto _L14
_L7:
        j = MotionEventCompat.getPointerId(motionevent, k);
        if (mDragState != 1 || j != mActivePointerId) goto _L16; else goto _L15
_L15:
        k = MotionEventCompat.getPointerCount(motionevent);
_L21:
...
_L17:
        ...
        if (l != mActivePointerId) goto _L20; else goto _L19
_L19:
        i++;
          goto _L21
_L20:
        f1 = MotionEventCompat.getX(motionevent, i);
        f3 = MotionEventCompat.getY(motionevent, i);
        if (findTopChildUnder((int)f1, (int)f3) != mCapturedView || !tryCaptureViewForDrag(mCapturedView, l)) goto _L19; else goto _L22
_L22:
        i = mActivePointerId;
_L24:
        if (i == -1)
...
_L10:
        ...
        if (i2 != 0 && (i2 <= 0 || j1 != i1) || j2 != 0 && (j2 <= 0 || l1 != k1)) goto _L11; else goto _L9
_L9:
        saveLastMotion(motionevent);
          goto _L7
_L11:
        reportNewEdgeDrags(f6, f7, l);
        if (mDragState == 1 || j && tryCaptureViewForDrag(view, l)) goto _L9; else goto _L12
_L12:
        i++;
          goto _L13
_L6:
