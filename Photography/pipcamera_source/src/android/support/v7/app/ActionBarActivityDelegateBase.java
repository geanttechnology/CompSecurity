    ...
    implements af
{
    ...
    private final Runnable z = new Runnable() {
        ...
        public void run()
        {
            ...
            {
                a = ActionBarActivityDelegateBase.this;
                super();
            }
    };
...
_L3:
        obj = m();
        if (obj != null && !((l) (obj)).c(panelfeaturestate.a, panelfeaturestate.d))
        {
...
_L3:
        ...
        if (h != null && (h.getLayoutParams() instanceof android.view.ViewGroup.MarginLayoutParams))
        {
            ...
            if (h.isShown())
            {
                ...
                if (((android.view.ViewGroup.MarginLayoutParams) (obj)).topMargin != j1)
                {
                    ...
                    {
                        q = new View(a);
                        q.setBackgroundColor(a.getResources().getColor(android.support.v7.appcompat.R.color.abc_input_method_navigation_guard));
    ...
    private void r()
    {
        ...
        TypedArray typedarray = a.obtainStyledAttributes(android.support.v7.appcompat.R.styleable.Theme);
    ...
    cn a(co co1)
    {
        ...
        if (h == null)
        {
            if (e)
            {
                ...
                i = new PopupWindow(context, null, android.support.v7.appcompat.R.attr.actionModePopupWindowStyle);
                i.setContentView(h);
                i.setWidth(-1);
                TypedValue typedvalue = new TypedValue();
                a.getTheme().resolveAttribute(android.support.v7.appcompat.R.attr.actionBarSize, typedvalue, true);
            ...
            {
                ViewStubCompat viewstubcompat = (ViewStubCompat)a.findViewById(android.support.v7.appcompat.R.id.action_mode_bar_stub);
        ...
        if (h != null)
        {
            ...
            obj = new r(context, actionbarcontextview, ((co) (obj)), flag);
            if (co1.a(((cn) (obj)), ((cn) (obj)).b()))
            {
                ((cn) (obj)).d();
                h.initForMode(((cn) (obj)));
                h.setVisibility(0);
                g = ((cn) (obj));
                if (i != null)
                {
...
_L3:
    ...
    public boolean a(MenuBuilder menubuilder, MenuItem menuitem)
    {
        ...
        if (l1 != null && !o())
        {
            ...
            if (menubuilder != null)
            {
                return l1.a(((PanelFeatureState) (menubuilder)).a, menuitem);
            }
        }
        return false;
    }
...
_L3:
    ...
    final void p()
    {
        if (!n)
        {
            if (b)
            {
                ...
                a.getTheme().resolveAttribute(android.support.v7.appcompat.R.attr.actionBarTheme, ((TypedValue) (obj)), true);
                ...
                p = (ViewGroup)LayoutInflater.from(((Context) (obj))).inflate(android.support.v7.appcompat.R.layout.abc_screen_toolbar, null);
                k = (bq)p.findViewById(android.support.v7.appcompat.R.id.decor_content_parent);
            ...
            } else
            {
                if (d)
                {
                    p = (ViewGroup)LayoutInflater.from(a).inflate(android.support.v7.appcompat.R.layout.abc_screen_simple_overlay_action_mode, null);
                } else
                {
                    p = (ViewGroup)LayoutInflater.from(a).inflate(android.support.v7.appcompat.R.layout.abc_screen_simple, null);
                }
                if (android.os.Build.VERSION.SDK_INT >= 21)
                {
                    ViewCompat.setOnApplyWindowInsetsListener(p, new OnApplyWindowInsetsListener() {
                        ...
                        public WindowInsetsCompat onApplyWindowInsets(View view, WindowInsetsCompat windowinsetscompat)
                        {
                            ...
                            int j1 = ActionBarActivityDelegateBase.c(a, i1);
                            view = windowinsetscompat;
                            if (i1 != j1)
                            {
                                view = windowinsetscompat.replaceSystemWindowInsets(windowinsetscompat.getSystemWindowInsetLeft(), j1, windowinsetscompat.getSystemWindowInsetRight(), windowinsetscompat.getSystemWindowInsetBottom());
                            }
                            return view;
                        }
            ...
            
            {
                ...
                {
                    ((bt)p).setOnFitSystemWindowsListener(new bu() {
    ...
    private class PanelFeatureState
    {
        ...
        at a(as as)
        {
            ...
            if (e == null)
            {
                e = new ad(f, android.support.v7.appcompat.R.layout.abc_list_menu_item_layout);
                e.a(as);
                d.a(e);
            }
            return e.a(b);
