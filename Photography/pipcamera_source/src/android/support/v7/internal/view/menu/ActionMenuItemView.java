...
public class ActionMenuItemView extends CompatTextView
    implements android.view.View.OnClickListener, android.view.View.OnLongClickListener, au, cw
{
    ...
    private db mForwardingListener;
    private Drawable mIcon;
    private MenuItemImpl mItemData;
    private ag mItemInvoker;
    private int mMaxIconSize;
    private int mMinWidth;
    private z mPopupCallback;
    ...
    public ActionMenuItemView(Context context, AttributeSet attributeset, int i)
    {
        ...
        attributeset = context.obtainStyledAttributes(attributeset, android.support.v7.appcompat.R.styleable.ActionMenuItemView, i, 0);
        mMinWidth = attributeset.getDimensionPixelSize(android.support.v7.appcompat.R.styleable.ActionMenuItemView_android_minWidth, 0);
        attributeset.recycle();
        mMaxIconSize = (int)(resources.getDisplayMetrics().density * 32F + 0.5F);
        setOnClickListener(this);
        setOnLongClickListener(this);
        setTransformationMethod(new o(context));
        mSavedPaddingLeft = -1;
    }
...
label0:
    ...
    public void initialize(MenuItemImpl menuitemimpl, int i)
    {
        ...
        {
            mForwardingListener = new y(this);
        }
    }
    ...
    public void setItemInvoker(ag ag1)
    {
        mItemInvoker = ag1;
    }
    ...
    public void setPopupCallback(z z)
    {
        mPopupCallback = z;
    }
