...
_L5:
    ...
    private boolean a(SubMenuBuilder submenubuilder, ar ar1)
    {
        boolean flag = false;
        if (w.isEmpty())
        {
        ...
        do
        {
            ...
            WeakReference weakreference = (WeakReference)ar1.next();
            ar ar2 = (ar)weakreference.get();
            if (ar2 == null)
            {
...
_L4:
    ...
    public void a(ar ar1, Context context)
    {
        w.add(new WeakReference(ar1));
        ar1.a(context, this);
        o = true;
    }
    ...
    {
        return a(menuitem, ((ar) (null)), i1);
    }

    public boolean a(MenuItem menuitem, ar ar1, int i1)
    {
        Object obj;
        boolean flag1;
        boolean flag2;
...
_L5:
        if (((MenuItemImpl) (obj)).hasSubMenu() || flag)
        {
            ...
            boolean flag4 = a(((SubMenuBuilder) (obj)), ar1) | flag1;
            flag1 = flag4;
            if (!flag4)
            {
                a(true);
