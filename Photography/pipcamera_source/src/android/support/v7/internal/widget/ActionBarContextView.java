    ...
    implements ViewPropertyAnimatorListener
{
    ...
    public ActionBarContextView(Context context, AttributeSet attributeset, int i)
    {
        ...
        context = cj.a(context, attributeset, android.support.v7.appcompat.R.styleable.ActionMode, i, 0);
        setBackgroundDrawable(context.a(android.support.v7.appcompat.R.styleable.ActionMode_background));
        mTitleStyleRes = context.f(android.support.v7.appcompat.R.styleable.ActionMode_titleTextStyle, 0);
        mSubtitleStyleRes = context.f(android.support.v7.appcompat.R.styleable.ActionMode_subtitleTextStyle, 0);
        mContentHeight = context.e(android.support.v7.appcompat.R.styleable.ActionMode_height, 0);
        mSplitBackground = context.a(android.support.v7.appcompat.R.styleable.ActionMode_backgroundSplit);
        mCloseItemLayout = context.f(android.support.v7.appcompat.R.styleable.ActionMode_closeItemLayout, android.support.v7.appcompat.R.layout.abc_action_mode_close_item_material);
        context.b();
    }

    private void finishAnimation()
    {
        x x1 = mCurrentAnimation;
        if (x1 != null)
        {
...
label0:
        ...
        if (mMenuView != null)
        {
            ...
            if (i > 0)
            {
                ...
                for (int j = 0; k >= 0; j++)
                {
                    ...
                    x1.a(((ViewPropertyAnimatorCompat) (obj)));
                    k--;
                }
    ...
    public void initForMode(cn cn1)
    {
        ...
        mClose.findViewById(android.support.v7.appcompat.R.id.action_mode_close_button).setOnClickListener(new android.view.View.OnClickListener(cn1) {
        ...
        if (!mSplitActionBar)
        {
            cn1.a(mActionMenuPresenter, mPopupContext);
