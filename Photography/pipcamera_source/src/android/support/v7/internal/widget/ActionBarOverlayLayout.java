    ...
    implements bq
{
    ...
    private bb mActionBarVisibilityCallback;
    ...
    public ActionBarOverlayLayout(Context context)
    {
        ...
        mTopAnimatorListener = new ViewPropertyAnimatorListenerAdapter() {
            ...
            {
                a.mCurrentActionBarTopAnimator = null;
                a.mAnimatingForFling = false;
            }
        ...
        mBottomAnimatorListener = new ViewPropertyAnimatorListenerAdapter() {
            ...
            public void onAnimationCancel(View view)
            {
                a.mCurrentActionBarBottomAnimator = null;
                a.mAnimatingForFling = false;
            }
        ...
        mRemoveActionBarHideOffset = new Runnable() {
            ...
            public void run()
            {
                a.haltActionBarHideOffsetAnimations();
                a.mCurrentActionBarTopAnimator = ViewCompat.animate(a.mActionBarTop).translationY(0.0F).setListener(a.mTopAnimatorListener);
                if (a.mActionBarBottom != null && a.mActionBarBottom.getVisibility() != 8)
                {
                    a.mCurrentActionBarBottomAnimator = ViewCompat.animate(a.mActionBarBottom).translationY(0.0F).setListener(a.mBottomAnimatorListener);
                }
            }
        ...
        mAddActionBarHideOffset = new Runnable() {
            ...
            {
                a.haltActionBarHideOffsetAnimations();
                a.mCurrentActionBarTopAnimator = ViewCompat.animate(a.mActionBarTop).translationY(-a.mActionBarTop.getHeight()).setListener(a.mTopAnimatorListener);
                if (a.mActionBarBottom != null && a.mActionBarBottom.getVisibility() != 8)
                {
                    a.mCurrentActionBarBottomAnimator = ViewCompat.animate(a.mActionBarBottom).translationY(a.mActionBarBottom.getHeight()).setListener(a.mBottomAnimatorListener);
                }
            }
    ...
    private br getDecorToolbar(View view)
    {
    ...
    protected boolean fitSystemWindows(Rect rect)
    {
        ...
        cm.a(this, mBaseInnerInsets, mBaseContentInsets);
    ...
    protected void onLayout(boolean flag, int i, int j, int l, int i1)
    {
        ...
        while (i < j1) 
        {
            ...
            if (view.getVisibility() != 8)
            {
                ...
                int l2 = layoutparams.leftMargin + k1;
                if (view == mActionBarBottom)
                {
                    l = i1 - j - i2 - k2 - layoutparams.bottomMargin;
                } else
                {
                    l = layoutparams.topMargin + l1;
                }
                view.layout(l2, l, j2 + l2, k2 + l);
            }
            i++;
        }
    }
    ...
    protected void onMeasure(int i, int j)
    {
        ...
        int l1 = Math.max(0, mActionBarTop.getMeasuredWidth() + ((LayoutParams) (obj)).leftMargin + ((LayoutParams) (obj)).rightMargin);
        int l = mActionBarTop.getMeasuredHeight();
        int i1 = ((LayoutParams) (obj)).topMargin;
        int k1 = Math.max(0, ((LayoutParams) (obj)).bottomMargin + (l + i1));
        int j1 = cm.a(0, ViewCompat.getMeasuredState(mActionBarTop));
        if (mActionBarBottom != null)
        {
            measureChildWithMargins(mActionBarBottom, i, 0, j, 0);
            obj = (LayoutParams)mActionBarBottom.getLayoutParams();
            l1 = Math.max(l1, mActionBarBottom.getMeasuredWidth() + ((LayoutParams) (obj)).leftMargin + ((LayoutParams) (obj)).rightMargin);
            l = mActionBarBottom.getMeasuredHeight();
            i1 = ((LayoutParams) (obj)).topMargin;
            k1 = Math.max(k1, ((LayoutParams) (obj)).bottomMargin + (l + i1));
            j1 = cm.a(j1, ViewCompat.getMeasuredState(mActionBarBottom));
        }
        boolean flag;
        if ((ViewCompat.getWindowSystemUiVisibility(this) & 0x100) != 0)
        {
        ...
        if (flag)
        {
            ...
            if (mHasNonEmbeddedTabs)
            {
                ...
                {
                    l = i1 + mActionBarHeight;
                }
            }
        } else
        if (mActionBarTop.getVisibility() != 8)
        {
            l = mActionBarTop.getMeasuredHeight();
        } else
        {
            l = 0;
        }
        if (mDecorToolbar.c() && mActionBarBottom != null)
        {
            ...
            {
                i1 = mActionBarBottom.getMeasuredHeight();
            }
        } else
        {
            i1 = 0;
        ...
        {
            obj = mContentInsets;
            obj.top = l + ((Rect) (obj)).top;
            obj = mContentInsets;
            obj.bottom = i1 + ((Rect) (obj)).bottom;
        } else
        {
        ...
        l = Math.max(l1, mContent.getMeasuredWidth() + ((LayoutParams) (obj)).leftMargin + ((LayoutParams) (obj)).rightMargin);
        i1 = mContent.getMeasuredHeight();
        l1 = ((LayoutParams) (obj)).topMargin;
        i1 = Math.max(k1, ((LayoutParams) (obj)).bottomMargin + (i1 + l1));
        j1 = cm.a(j1, ViewCompat.getMeasuredState(mContent));
        k1 = getPaddingLeft();
        l1 = getPaddingRight();
        i1 = Math.max(i1 + (getPaddingTop() + getPaddingBottom()), getSuggestedMinimumHeight());
        setMeasuredDimension(ViewCompat.resolveSizeAndState(Math.max(l + (k1 + l1), getSuggestedMinimumWidth()), i, j1), ViewCompat.resolveSizeAndState(i1, j, j1 << 16));
    }
    ...
    public void onNestedScroll(View view, int i, int j, int l, int i1)
    {
    ...
    public void onWindowSystemUiVisibilityChanged(int i)
    {
        ...
        if (mActionBarVisibilityCallback != null)
        {
            bb bb1 = mActionBarVisibilityCallback;
            if (flag1)
            {
                flag2 = false;
            }
    ...
    public void setActionBarVisibilityCallback(bb bb1)
    {
        mActionBarVisibilityCallback = bb1;
    ...
    public void setMenu(Menu menu, as as)
    {
        pullChildren();
        mDecorToolbar.a(menu, as);
    }
    ...
    public void setWindowCallback(l l)
    {
        pullChildren();
        mDecorToolbar.a(l);
    }
