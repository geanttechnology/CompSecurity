...
public class ActivityChooserView extends ViewGroup
{
    ...
    private final bj mAdapter;
    private final bk mCallbacks;
    ...
    public ActivityChooserView(Context context, AttributeSet attributeset, int i)
    {
        ...
        mModelDataSetOberver = new DataSetObserver() {
            ...
            {
                super.onInvalidated();
                a.mAdapter.notifyDataSetInvalidated();
            }
        ...
        mOnGlobalLayoutListener = new android.view.ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout()
            {
                if (a.isShowingPopup())
                {
                    if (!a.isShown())
                    {
                        a.getListPopupWindow().a();
                    } else
                    {
                        a.getListPopupWindow().c();
                        if (a.mProvider != null)
                        {
    ...
    protected void onAttachedToWindow()
    {
        ...
        if (bc1 != null)
        {
            bc1.registerObserver(mModelDataSetOberver);
        }
    ...
    protected void onDetachedFromWindow()
    {
        ...
        if (obj != null)
        {
            ((bc) (obj)).unregisterObserver(mModelDataSetOberver);
        }
    ...
    public void setActivityChooserModel(bc bc1)
    {
        mAdapter.a(bc1);
        if (isShowingPopup())
        {
