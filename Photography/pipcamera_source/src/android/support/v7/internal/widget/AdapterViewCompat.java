...
public abstract class AdapterViewCompat extends ViewGroup
{
    ...
    public bm mOnItemClickListener;
    bn mOnItemLongClickListener;
    bo mOnItemSelectedListener;
    public int mSelectedPosition;
    public long mSelectedRowId;
    private bp mSelectionNotifier;
    int mSpecificTop;
    long mSyncHeight;
    int mSyncMode;
    int mSyncPosition;
...
_L5:
    ...
    public final bn getOnItemLongClickListener()
    {
        return mOnItemLongClickListener;
    }

    public final bo getOnItemSelectedListener()
    {
    ...
    void selectionChanged()
    {
        if (mOnItemSelectedListener != null)
        {
            if (mInLayout || mBlockLayoutRequests)
            {
                ...
                {
                    mSelectionNotifier = new bp(this);
                }
...
_L6:
    ...
    public void setOnItemClickListener(bm bm1)
    {
        mOnItemClickListener = bm1;
    }

    public void setOnItemLongClickListener(bn bn)
    {
        if (!isLongClickable())
        {
            setLongClickable(true);
        }
        mOnItemLongClickListener = bn;
    }

    public void setOnItemSelectedListener(bo bo1)
    {
        mOnItemSelectedListener = bo1;
    }
