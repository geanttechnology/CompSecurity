    ...
    implements bm
{
    ...
    private ca createTabView(b b1, boolean flag)
    {
        b1 = new ca(this, getContext(), b1, flag);
        if (flag)
        {
    ...
    public void addTab(b b1, int i, boolean flag)
    {
        ...
        if (mTabSpinner != null)
        {
            ((by)mTabSpinner.c()).notifyDataSetChanged();
        }
        if (flag)
        {
            b1.setSelected(true);
