    ...
    implements ag, at
{
    ...
    private cz mOnMenuItemClickListener;
...
_L7:
    ...
    protected boolean hasSupportDividerBeforeChildAt(int i)
    {
        ...
        if (i < getChildCount())
        {
            ...
            {
                flag = false | ((cw)view).needsDividerAfter();
            }
        }
        if (i > 0 && (view1 instanceof cw))
        {
            return ((cw)view1).needsDividerBefore() | flag;
        } else
        {
            return flag;
        }
...
_L5:
    ...
    public void setOnMenuItemClickListener(cz cz)
    {
        mOnMenuItemClickListener = cz;
    }
