...
public class h extends android.view.LayoutParams
{
    ...
    public g(Context context, AttributeSet attributeset)
    {
        ...
        g = context.getFloat(android.support.v7.appcompat.ayout_android_layout_weight, 0.0F);
        h = context.getInt(android.support.v7.appcompat.ayout_android_layout_gravity, -1);
        context.recycle();
    }
