...
public class LinearLayoutCompat extends ViewGroup
{
    ...
    public LinearLayoutCompat(Context context, AttributeSet attributeset, int i)
    {
        ...
        mBaselineChildTop = 0;
        mGravity = 0x800033;
        context = cj.a(context, attributeset, android.support.v7.appcompat.R.styleable.LinearLayoutCompat, i, 0);
        i = context.a(android.support.v7.appcompat.R.styleable.LinearLayoutCompat_android_orientation, -1);
        if (i >= 0)
        {
            setOrientation(i);
        }
        i = context.a(android.support.v7.appcompat.R.styleable.LinearLayoutCompat_android_gravity, -1);
        if (i >= 0)
        {
            setGravity(i);
        }
        boolean flag = context.a(android.support.v7.appcompat.R.styleable.LinearLayoutCompat_android_baselineAligned, true);
        if (!flag)
        {
            setBaselineAligned(flag);
        }
        mWeightSum = context.a(android.support.v7.appcompat.R.styleable.LinearLayoutCompat_android_weightSum, -1F);
        mBaselineAlignedChildIndex = context.a(android.support.v7.appcompat.R.styleable.LinearLayoutCompat_android_baselineAlignedChildIndex, -1);
        mUseLargestChild = context.a(android.support.v7.appcompat.R.styleable.LinearLayoutCompat_measureWithLargestChild, false);
        setDividerDrawable(context.a(android.support.v7.appcompat.R.styleable.LinearLayoutCompat_divider));
        mShowDividers = context.a(android.support.v7.appcompat.R.styleable.LinearLayoutCompat_showDividers, 0);
        mDividerPadding = context.d(android.support.v7.appcompat.R.styleable.LinearLayoutCompat_dividerPadding, 0);
        context.b();
    }
    ...
    void measureHorizontal(int i, int j)
    {
        ...
        while (k2 < l5) 
        {
            ...
            } else
            {
                ...
                int k4;
                int i5;
                if (j6 == 0x40000000 && layoutparams.width == 0 && layoutparams.g > 0.0F)
                {
                    int j5;
                    int k5;
                    if (flag)
                ...
                j5 = cm.a(l, ViewCompat.getMeasuredState(view1));
                if (flag1)
                {
                ...
                if (view1 != null)
                {
                    ...
                    } else
                    {
                        ...
                        if (f1 > 0.0F)
                        {
                            ...
                            k1 = cm.a(k1, ViewCompat.getMeasuredState(view1) & 0xff000000);
                            f -= f1;
                            j1 = j2;
                        }
                        if (flag)
...
label0:
        ...
        layoutparams = (LayoutParams)view.getLayoutParams();
        f += layoutparams.g;
        if (j6 != 0x40000000 || layoutparams.height != 0 || layoutparams.g <= 0.0F) goto _L5; else goto _L4
_L4:
        int k3;
        int k4;
        k1 = mTotalLength;
...
_L6:
        ...
        k5 = Math.max(l, i5);
        j5 = cm.a(k, ViewCompat.getMeasuredState(view));
...
label1:
                ...
                while (i2 < l5) 
                {
                    ...
                    } else
                    {
                        ...
                        if (f1 > 0.0F)
                        {
                            ...
                            k = cm.a(k, ViewCompat.getMeasuredState(view) & 0xffffff00);
                            l1 = k1 - k2;
                            k1 = k;
                            f -= f1;
                            k = l1;
    ...
    private class LayoutParams extends android.view.ViewGroup.MarginLayoutParams
    {
        ...
        public LayoutParams(Context context, AttributeSet attributeset)
        {
            ...
            g = context.getFloat(android.support.v7.appcompat.R.styleable.LinearLayoutCompat_Layout_android_layout_weight, 0.0F);
            h = context.getInt(android.support.v7.appcompat.R.styleable.LinearLayoutCompat_Layout_android_layout_gravity, -1);
            context.recycle();
        }
