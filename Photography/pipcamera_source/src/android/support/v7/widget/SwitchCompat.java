...
public class SwitchCompat extends CompoundButton
{
    ...
    public SwitchCompat(Context context, AttributeSet attributeset, int i)
    {
        ...
        attributeset = cj.a(context, attributeset, android.support.v7.appcompat.R.styleable.SwitchCompat, i, 0);
        mThumbDrawable = attributeset.a(android.support.v7.appcompat.R.styleable.SwitchCompat_android_thumb);
        mTrackDrawable = attributeset.a(android.support.v7.appcompat.R.styleable.SwitchCompat_track);
        mTextOn = attributeset.b(android.support.v7.appcompat.R.styleable.SwitchCompat_android_textOn);
        mTextOff = attributeset.b(android.support.v7.appcompat.R.styleable.SwitchCompat_android_textOff);
        mShowText = attributeset.a(android.support.v7.appcompat.R.styleable.SwitchCompat_showText, true);
        mThumbTextPadding = attributeset.d(android.support.v7.appcompat.R.styleable.SwitchCompat_thumbTextPadding, 0);
        mSwitchMinWidth = attributeset.d(android.support.v7.appcompat.R.styleable.SwitchCompat_switchMinWidth, 0);
        mSwitchPadding = attributeset.d(android.support.v7.appcompat.R.styleable.SwitchCompat_switchPadding, 0);
        mSplitTrack = attributeset.a(android.support.v7.appcompat.R.styleable.SwitchCompat_splitTrack, false);
        i = attributeset.f(android.support.v7.appcompat.R.styleable.SwitchCompat_switchTextAppearance, 0);
        if (i != 0)
        {
    ...
    private void animateThumbToCheckedState(boolean flag)
    {
        ...
        mPositionAnimator = new Animation(f1, f - f1) {
...
_L3:
        if (!cm.a(this)) goto _L6; else goto _L5
_L5:
        if (f >= 0.0F)
        {
            flag1 = false;
...
_L5:
    ...
    public void setSwitchTextAppearance(Context context, int i)
    {
        ...
        {
            mSwitchTransformationMethod = new o(getContext());
        } else
        {
