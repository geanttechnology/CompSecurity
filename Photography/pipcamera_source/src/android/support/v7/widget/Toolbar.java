...
public class Toolbar extends ViewGroup
{
    ...
    private as mActionMenuPresenterCallback;
    private int mButtonGravity;
    private ImageButton mCollapseButtonView;
    private CharSequence mCollapseDescription;
    private Drawable mCollapseIcon;
    private boolean mCollapsible;
    private final bx mContentInsets;
    private boolean mEatingTouch;
    public View mExpandedActionView;
    private dq mExpandedMenuPresenter;
    private int mGravity;
    private ImageView mLogoView;
    private int mMaxButtonHeight;
    private af mMenuBuilderCallback;
    private ActionMenuView mMenuView;
    private final cz mMenuViewItemClickListener;
    private int mMinHeight;
    private ImageButton mNavButtonView;
    private dr mOnMenuItemClickListener;
    ...
    public Toolbar(Context context, AttributeSet attributeset, int i)
    {
        ...
        mContentInsets = new bx();
        mGravity = 0x800013;
        mTempViews = new ArrayList();
        mTempMargins = new int[2];
        mMenuViewItemClickListener = new cz() {

            final Toolbar a;

            public boolean a(MenuItem menuitem)
            {
                if (a.mOnMenuItemClickListener != null)
                {
                    return a.mOnMenuItemClickListener.a(menuitem);
                } else
                {
                    return false;
                }
        ...
        context = cj.a(getContext(), attributeset, android.support.v7.appcompat.R.styleable.Toolbar, i, 0);
        mTitleTextAppearance = context.f(android.support.v7.appcompat.R.styleable.Toolbar_titleTextAppearance, 0);
        mSubtitleTextAppearance = context.f(android.support.v7.appcompat.R.styleable.Toolbar_subtitleTextAppearance, 0);
        mGravity = context.b(android.support.v7.appcompat.R.styleable.Toolbar_android_gravity, mGravity);
        mButtonGravity = 48;
        i = context.c(android.support.v7.appcompat.R.styleable.Toolbar_titleMargins, 0);
        mTitleMarginBottom = i;
        mTitleMarginTop = i;
        mTitleMarginEnd = i;
        mTitleMarginStart = i;
        i = context.c(android.support.v7.appcompat.R.styleable.Toolbar_titleMarginStart, -1);
        if (i >= 0)
        {
            mTitleMarginStart = i;
        }
        i = context.c(android.support.v7.appcompat.R.styleable.Toolbar_titleMarginEnd, -1);
        if (i >= 0)
        {
            mTitleMarginEnd = i;
        }
        i = context.c(android.support.v7.appcompat.R.styleable.Toolbar_titleMarginTop, -1);
        if (i >= 0)
        {
            mTitleMarginTop = i;
        }
        i = context.c(android.support.v7.appcompat.R.styleable.Toolbar_titleMarginBottom, -1);
        if (i >= 0)
        {
            mTitleMarginBottom = i;
        }
        mMaxButtonHeight = context.d(android.support.v7.appcompat.R.styleable.Toolbar_maxButtonHeight, -1);
        i = context.c(android.support.v7.appcompat.R.styleable.Toolbar_contentInsetStart, 0x80000000);
        int j = context.c(android.support.v7.appcompat.R.styleable.Toolbar_contentInsetEnd, 0x80000000);
        int k = context.d(android.support.v7.appcompat.R.styleable.Toolbar_contentInsetLeft, 0);
        int l = context.d(android.support.v7.appcompat.R.styleable.Toolbar_contentInsetRight, 0);
        mContentInsets.b(k, l);
        if (i != 0x80000000 || j != 0x80000000)
        {
            mContentInsets.a(i, j);
        }
        mCollapseIcon = context.a(android.support.v7.appcompat.R.styleable.Toolbar_collapseIcon);
        mCollapseDescription = context.b(android.support.v7.appcompat.R.styleable.Toolbar_collapseContentDescription);
        attributeset = context.b(android.support.v7.appcompat.R.styleable.Toolbar_title);
        if (!TextUtils.isEmpty(attributeset))
        {
            setTitle(attributeset);
        }
        attributeset = context.b(android.support.v7.appcompat.R.styleable.Toolbar_subtitle);
        if (!TextUtils.isEmpty(attributeset))
        {
            setSubtitle(attributeset);
        }
        mPopupContext = getContext();
        setPopupTheme(context.f(android.support.v7.appcompat.R.styleable.Toolbar_popupTheme, 0));
        attributeset = context.a(android.support.v7.appcompat.R.styleable.Toolbar_navigationIcon);
        if (attributeset != null)
        {
            setNavigationIcon(attributeset);
        }
        attributeset = context.b(android.support.v7.appcompat.R.styleable.Toolbar_navigationContentDescription);
        if (!TextUtils.isEmpty(attributeset))
        {
            setNavigationContentDescription(attributeset);
        }
        mMinHeight = context.d(android.support.v7.appcompat.R.styleable.Toolbar_android_minHeight, 0);
        context.b();
    ...
    private void addCustomViewsWithGravity(List list, int i)
    {
        ...
        if (flag)
        {
            for (i = k - 1; i >= 0; i--)
            {
                ...
                if (layoutparams.b == 0 && shouldLayout(view) && getChildHorizontalGravity(layoutparams.a) == j)
                {
                    list.add(view);
                }
            }
        ...
        } else
        {
            for (; i < k; i++)
            {
                ...
                if (layoutparams1.b == 0 && shouldLayout(view1) && getChildHorizontalGravity(layoutparams1.a) == j)
                {
                    list.add(view1);
                }
            }
    ...
    private void ensureCollapseButtonView()
    {
        if (mCollapseButtonView == null)
        {
            ...
            layoutparams.a = 0x800003 | mButtonGravity & 0x70;
            layoutparams.b = 2;
    ...
    private void ensureMenu()
    {
        ...
        if (mMenuView.peekMenu() == null)
        {
            ...
            {
                mExpandedMenuPresenter = new dq(this);
            }
    ...
    private void ensureMenuView()
    {
        if (mMenuView == null)
        {
            ...
            LayoutParams layoutparams = generateDefaultLayoutParams();
            layoutparams.a = 0x800005 | mButtonGravity & 0x70;
...
label0:
    ...
    private int getChildTop(View view, int i)
    {
        ...
        getChildVerticalGravity(layoutparams.a);
...
_L6:
    ...
    private void setChildVisibilityForExpandedActionView(boolean flag)
    {
        ...
        {
            View view = getChildAt(i);
            if (((LayoutParams)view.getLayoutParams()).b != 2 && view != mMenuView)
            {
                byte byte0;
                if (flag)
                {
...
_L3:
    ...
    public void collapseActionView()
    {
        ...
        {
            menuitemimpl = mExpandedMenuPresenter.b;
        }
    ...
    {
        return mContentInsets.d();
    }

    public int getContentInsetLeft()
    {
        return mContentInsets.a();
    }

    public int getContentInsetRight()
    {
        return mContentInsets.b();
    }

    public int getContentInsetStart()
    {
        return mContentInsets.c();
    }
    ...
    public br getWrapper()
    {
        if (mWrapper == null)
        {
            mWrapper = new ck(this, true);
        }
        return mWrapper;
    }
...
_L11:
    ...
    protected void onMeasure(int i, int j)
    {
        ...
        if (shouldLayout(mNavButtonView))
        {
            ...
            i1 = cm.a(0, ViewCompat.getMeasuredState(mNavButtonView));
        }
        i2 = k;
        k = i1;
        l = j1;
        if (shouldLayout(mCollapseButtonView))
        {
            ...
            k = cm.a(i1, ViewCompat.getMeasuredState(mCollapseButtonView));
        }
        ...
        if (shouldLayout(mMenuView))
        {
            ...
            i1 = cm.a(k, ViewCompat.getMeasuredState(mMenuView));
        }
        ...
        if (shouldLayout(mExpandedActionView))
        {
            ...
            k = cm.a(i1, ViewCompat.getMeasuredState(mExpandedActionView));
        }
        i1 = l1;
        j1 = k;
        k1 = l;
        if (shouldLayout(mLogoView))
        {
            ...
            j1 = cm.a(k, ViewCompat.getMeasuredState(mLogoView));
        }
        i2 = getChildCount();
        l1 = 0;
        l = k1;
        ...
        if (shouldLayout(mTitleTextView))
        {
            ...
            i1 = cm.a(k, ViewCompat.getMeasuredState(mTitleTextView));
        }
        j2 = j1;
        i2 = k1;
        k = i1;
        if (shouldLayout(mSubtitleTextView))
        {
            ...
            k = cm.a(i1, ViewCompat.getMeasuredState(mSubtitleTextView));
        }
        l = Math.max(l, j2);
        k1 = getPaddingLeft();
        j2 = getPaddingRight();
    ...
    protected void onRestoreInstanceState(Parcelable parcelable)
    {
        ...
        if (savedstate.a != 0 && mExpandedMenuPresenter != null && parcelable != null)
        {
    ...
    protected Parcelable onSaveInstanceState()
    {
        ...
        if (mExpandedMenuPresenter != null && mExpandedMenuPresenter.b != null)
        {
            savedstate.a = mExpandedMenuPresenter.b.getItemId();
        }
...
_L3:
    ...
    public void setMenu(MenuBuilder menubuilder, ActionMenuPresenter actionmenupresenter)
    {
        if (menubuilder != null || mMenuView != null)
        {
            ...
            if (menubuilder1 != menubuilder)
            {
                ...
                {
                    actionmenupresenter.a(mPopupContext, null);
                    mExpandedMenuPresenter.a(mPopupContext, null);
                    actionmenupresenter.a(true);
                    mExpandedMenuPresenter.a(true);
                }
                mMenuView.setPopupTheme(mPopupTheme);
    ...
    public void setMenuCallbacks(as as, af af)
    {
        mActionMenuPresenterCallback = as;
        mMenuBuilderCallback = af;
    }
    ...
    {
        setNavigationIcon(mTintManager.a(i));
    }
...
_L3:
    ...
    public void setOnMenuItemClickListener(dr dr)
    {
        mOnMenuItemClickListener = dr;
    }
