...
public class ap
    implements android.view.View.OnKeyListener, android.view.ViewTreeObserver.OnGlobalLayoutListener, android.widget.AdapterView.OnItemClickListener, android.widget.PopupWindow.OnDismissListener, ar
{
    ...
    public ap(Context context, MenuBuilder menubuilder, View view)
    {
        this(context, menubuilder, view, false, android.support.v7.appcompat.R.attr.popupMenuStyle);
    }

    public ap(Context context, MenuBuilder menubuilder, View view, boolean flag, int i1)
    {
        this(context, menubuilder, view, flag, i1, 0);
    }

    public ap(Context context, MenuBuilder menubuilder, View view, boolean flag, int i1, int j1)
    {
        r = 0;
        c = context;
        ...
        h = Math.max(resources.getDisplayMetrics().widthPixels / 2, resources.getDimensionPixelSize(android.support.v7.appcompat.R.dimen.abc_config_prefDialogWidth));
        k = view;
...
_L2:
    ...
    {
        adapterview = f;
        aq.a(adapterview).a(adapterview.a(i1), 0);
    }
    ...
    static 
    {
        a = android.support.v7.appcompat.R.layout.abc_popup_menu_item_layout;
    }
}
