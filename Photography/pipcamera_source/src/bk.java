    ...
    implements android.view.View.OnClickListener, android.view.View.OnLongClickListener, android.widget.AdapterView.OnItemClickListener, android.widget.PopupWindow.OnDismissListener
{
    ...
    private bk(ActivityChooserView activitychooserview)
    {
        a = activitychooserview;
        super();
    }

    public bk(ActivityChooserView activitychooserview, android.support.v7.internal.widget.ActivityChooserView._cls1 _pcls1)
    {
    ...
    {
        ((bj)adapterview.getAdapter()).getItemViewType(i);
