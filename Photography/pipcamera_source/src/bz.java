    ...
    implements android.view.View.OnClickListener
{
    ...
    private bz(ScrollingTabContainerView scrollingtabcontainerview)
    {
        a = scrollingtabcontainerview;
        super();
    }

    public bz(ScrollingTabContainerView scrollingtabcontainerview, android.support.v7.internal.widget.ScrollingTabContainerView._cls1 _pcls1)
    {
