...
public class ca extends LinearLayoutCompat
    implements android.view.View.OnLongClickListener
{
    ...
    public ca(ScrollingTabContainerView scrollingtabcontainerview, Context context, b b1, boolean flag)
    {
        a = scrollingtabcontainerview;
        super(context, null, android.support.v7.appcompat.R.attr.actionBarTabStyle);
        c = b1;
        scrollingtabcontainerview = cj.a(context, null, b, android.support.v7.appcompat.R.attr.actionBarTabStyle, 0);
