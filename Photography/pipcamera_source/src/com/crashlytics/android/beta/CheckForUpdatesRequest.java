...
class CheckForUpdatesRequest extends aam
{
    ...
    public CheckForUpdatesRequest(aad aad1, String s, String s1, acy acy, CheckForUpdatesResponseTransform checkforupdatesresponsetransform)
    {
        super(aad1, s, s1, acy, HttpMethod.GET);
    ...
    public CheckForUpdatesResponse invoke(String s, String s1, BuildProperties buildproperties)
    {
        ...
        buildproperties = s;
        obj = s;
        zw.h().a("Beta", (new StringBuilder()).append("Checking for updates from ").append(getUrl()).toString());
        buildproperties = s;
        obj = s;
        zw.h().a("Beta", (new StringBuilder()).append("Checking for updates query params are: ").append(map).toString());
        buildproperties = s;
        obj = s;
...
_L1:
        buildproperties = s;
        obj = s;
        zw.h().a("Beta", "Checking for updates was successful");
        buildproperties = s;
        obj = s;
        ...
        {
            s = s.b("X-REQUEST-ID");
            zw.h().a("Fabric", (new StringBuilder()).append("Checking for updates request ID: ").append(s).toString());
            buildproperties = s1;
        }
_L4:
...
_L2:
        buildproperties = s;
        obj = s;
        zw.h().e("Beta", (new StringBuilder()).append("Checking for updates failed. Response code: ").append(s.b()).toString());
...
_L8:
        ...
        zw.h().e("Beta", (new StringBuilder()).append("Error while checking for updates from ").append(getUrl()).toString(), s);
        buildproperties = obj1;
...
_L7:
        if (buildproperties != null)
        {
            ...
            zw.h().a("Fabric", (new StringBuilder()).append("Checking for updates request ID: ").append(s1).toString());
        }
        throw s;
        s;
