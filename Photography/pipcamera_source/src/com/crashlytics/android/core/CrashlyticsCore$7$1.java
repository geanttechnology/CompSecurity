        ...
        implements Runnable
    {
        ...
        public void run()
        {
            ...
            if (promptData.d)
            {
                ...
                builder.setNegativeButton(stringResolver.getCancelButtonTitle(), onclicklistener);
            }
            if (promptData.f)
            {
                android.content.DialogInterface.OnClickListener onclicklistener1 = new CrashlyticsCore._cls7._cls3();
                builder.setPositiveButton(stringResolver.getAlwaysSendButtonTitle(), onclicklistener1);
            }
            builder.show();
        }
