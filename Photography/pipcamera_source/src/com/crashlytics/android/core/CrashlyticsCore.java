...
public class CrashlyticsCore extends aad
{
    ...
    {
        this(f, crashlyticslistener, pinninginfoprovider, flag, abb.a("Crashlytics Exception Handler"));
    }
    ...
    private static boolean ensureFabricWithCalled(String s)
    {
        ...
        {
            zw.h().e("CrashlyticsCore", (new StringBuilder()).append("Crashlytics must be initialized by calling Fabric.with(Context) ").append(s).toString(), null);
            return false;
        } else
        {
            return true;
    ...
    private void finishInitSynchronously()
    {
        ...
        for (Iterator iterator = getDependencies().iterator(); iterator.hasNext(); ((abs) (obj)).addDependency((aby)iterator.next())) { }
        obj = getFabric().f().submit(((Callable) (obj)));
        zw.h().a("CrashlyticsCore", "Crashlytics detected incomplete initialization on previous app launch. Will initialize synchronously.");
        try
        {
        ...
        {
            zw.h().e("CrashlyticsCore", "Crashlytics was interrupted during initialization.", interruptedexception);
            return;
        }
        catch (ExecutionException executionexception)
        {
            zw.h().e("CrashlyticsCore", "Problem encountered during Crashlytics initialization.", executionexception);
            return;
        }
        catch (TimeoutException timeoutexception)
        {
            zw.h().e("CrashlyticsCore", "Crashlytics timed out during initialization.", timeoutexception);
        }
    }
    ...
    {
        return (CrashlyticsCore)zw.a(com/crashlytics/android/core/CrashlyticsCore);
    }

    private boolean getSendDecisionFromUser(final Activity activity, final adv promptData)
    {
        ...
        zw.h().a("CrashlyticsCore", "Waiting for user opt-in.");
        latch.await();
    ...
    {
        Answers answers = (Answers)zw.a(com/crashlytics/android/answers/Answers);
        if (answers != null)
        {
            answers.onException(new aax(s));
        }
    }
    ...
    private void setAndValidateKitProperties(Context context, String s)
    {
        ...
        httpRequestFactory = new act(zw.h());
        httpRequestFactory.a(((ada) (obj)));
        packageName = context.getPackageName();
        installerPackageName = getIdManager().h();
        zw.h().a("CrashlyticsCore", (new StringBuilder()).append("Installer package name is: ").append(installerPackageName).toString());
...
_L1:
        ...
        {
            zw.h().e("CrashlyticsCore", "Error setting up app properties", exception);
        }
        getIdManager().o();
    ...
    {
        return ((Boolean)adx.a().a(new adz() {
            ...
            public Boolean usingSettings(aeb aeb1)
            {
                ...
                if (activity != null)
                {
                    ...
                    if (!activity.isFinishing())
                    {
                        ...
                        {
                            flag = getSendDecisionFromUser(activity, aeb1.c);
                        }
                    }
                }
    ...
    protected Void doInBackground()
    {
        ...
        flag = flag2;
        zw.h().d("CrashlyticsCore", "Received null settings, skipping initialization!");
        markInitializationComplete();
        return null;
        flag = flag2;
        if (!((aeb) (obj)).d.c) goto _L2; else goto _L1
_L1:
        flag2 = false;
        flag1 = false;
        flag = flag2;
        ...
        flag = flag2;
        obj = getCreateReportSpiCall(((aeb) (obj)));
...
_L2:
        ...
        zw.h().a("CrashlyticsCore", "Crash reporting disabled.");
        markInitializationComplete();
        return null;
_L4:
        flag = flag2;
        zw.h().d("CrashlyticsCore", "Unable to create a call to upload reports.");
          goto _L2
        Object obj1;
        obj1;
        zw.h().e("CrashlyticsCore", "Error dealing with settings", ((Throwable) (obj1)));
        flag1 = flag;
          goto _L2
        obj1;
        zw.h().e("CrashlyticsCore", "Problem encountered during Crashlytics initialization.", ((Throwable) (obj1)));
        markInitializationComplete();
        return null;
        obj1;
        markInitializationComplete();
    ...
    CreateReportSpiCall getCreateReportSpiCall(aeb aeb1)
    {
        if (aeb1 != null)
        {
            return new DefaultCreateReportSpiCall(this, getOverridenSpiEndpoint(), aeb1.a.d, httpRequestFactory);
        } else
        {
            return null;
        }
    ...
    File getSdkDirectory()
    {
        if (sdkDir == null)
        {
            sdkDir = (new ade(this)).a();
        }
        return sdkDir;
    }

    adw getSessionSettingsData()
    {
        aeb aeb1 = adx.a().b();
        if (aeb1 == null)
        {
    ...
    {
        doLog(i, s, s1);
        zw.h().a(i, (new StringBuilder()).append("").append(s).toString(), (new StringBuilder()).append("").append(s1).toString(), true);
    }
    ...
    public void logException(Throwable throwable)
    {
        ...
        if (throwable == null)
        {
            zw.h().a(5, "CrashlyticsCore", "Crashlytics is ignoring a request to log a null exception.");
            return;
        } else
        {
    ...
    boolean onPreExecute(Context context)
    {
        ...
        obj = (new aau()).a(context);
        if (obj == null)
        {
            return false;
        }
        zw.h().c("CrashlyticsCore", (new StringBuilder()).append("Initializing Crashlytics ").append(getVersion()).toString());
        ...
        {
            zw.h().e("CrashlyticsCore", "Crashlytics was not started due to an exception during initialization", context);
            return false;
        }
        obj = new SessionDataWriter(getContext(), buildId, getPackageName());
        zw.h().a("CrashlyticsCore", "Installing exception handler...");
        ...
        zw.h().a("CrashlyticsCore", "Successfully installed exception handler.");
_L2:
        if (!flag)
        {
        ...
        return false;
_L3:
        zw.h().e("CrashlyticsCore", "There was a problem installing the exception handler.", exception);
...
_L1:
    ...
    public void setListener(CrashlyticsListener crashlyticslistener)
    {
        ...
        zw.h().d("CrashlyticsCore", "Use of setListener is deprecated.");
    ...
    {
        adg adg1 = new adg(this);
        adg1.a(adg1.b().putBoolean("always_send_reports_opt_in", flag));
    }
    ...
    public void setString(String s, String s1)
    {
        ...
        if (s == null)
        {
            ...
            {
                zw.h().e("CrashlyticsCore", "Attempting to set custom attribute with null key, ignoring.", null);
                return;
            }
        }
        ...
        {
            zw.h().a("CrashlyticsCore", "Exceeded maximum number of custom attributes (64)");
            return;
        }
    }
    ...
    {
        return (new adg(this)).a().getBoolean("always_send_reports_opt_in", false);
    }
    ...
    public boolean verifyPinning(URL url)
    {
        ...
        {
            zw.h().e("CrashlyticsCore", "Could not verify SSL pinning", url);
            return false;
        }
        return flag;
    }
