    ...
    implements Thread.UncaughtExceptionHandler
{
    ...
    private void closeWithoutRenamingOrLog(ClsFileOutputStream clsfileoutputstream)
    {
        ...
        return;
        clsfileoutputstream;
        zw.h().e("CrashlyticsCore", "Error closing session file stream in the presence of an exception", clsfileoutputstream);
        return;
    }
    ...
    private void doCloseSessions(boolean flag)
    {
        ...
        if (afile.length > i)
        {
            ...
            adw adw1 = crashlyticsCore.getSessionSettingsData();
            if (adw1 != null)
            {
                int j = adw1.c;
                zw.h().a("CrashlyticsCore", "Closing open sessions.");
                for (; i < afile.length; i++)
                {
                    File file = afile[i];
                    String s = getSessionIdFromSessionFile(file);
                    zw.h().a("CrashlyticsCore", (new StringBuilder()).append("Closing session: ").append(s).toString());
                    writeSessionPartsToSessionFile(file, s, j);
                }

            } else
            {
                zw.h().a("CrashlyticsCore", "Unable to close session. Settings are not loaded.");
            }
            return;
        } else
        {
            zw.h().a("CrashlyticsCore", "No open sessions to be closed.");
            return;
        }
    }
    ...
    private void doOpenSession()
    {
        ...
        zw.h().a("CrashlyticsCore", (new StringBuilder()).append("Opening an new session with ID ").append(s).toString());
...
_L1:
        ...
        Object obj;
        zw.h().a("CrashlyticsCore", (new StringBuilder()).append("Crashlytics is logging non-fatal exception \"").append(throwable).append("\" from thread ").append(thread.getName()).toString());
        ...
        date = null;
_L6:
        zw.h().e("CrashlyticsCore", "An error occurred in the non-fatal exception logger", thread);
...
_L3:
        ...
        {
            zw.h().e("CrashlyticsCore", "An error occurred when trimming non-fatal files.", date);
        }
        return;
_L2:
        zw.h().e("CrashlyticsCore", "Tried to write a non-fatal exception while no session was open.", null);
        return;
        thread;
        date = ((Date) (obj));
...
_L4:
    ...
    {
        zw.h().a("CrashlyticsCore", "Checking for previous crash marker.");
        ...
        return;
        crashlyticslistener;
        zw.h().e("CrashlyticsCore", "Exception thrown by CrashlyticsListener while notifying of previous crash.", crashlyticslistener);
        return;
    }
            ...
            executorServiceWrapper.executeAsync(new Runnable() {
                ...
                public void run()
                {
                    if (CommonUtils.n(crashlyticsCore.getContext()))
                    {
                        ...
                        Object obj = adx.a().b();
                        obj = crashlyticsCore.getCreateReportSpiCall(((aeb) (obj)));
                        if (obj != null)
                        {
    ...
    private void trimOpenSessions(int i)
    {
        ...
        for (i = ((flag) ? 1 : 0); i < j; i++)
        {
            ...
            {
                zw.h().a("CrashlyticsCore", (new StringBuilder()).append("Trimming open session file: ").append(s).toString());
                file.delete();
            }
        }
...
_L4:
        ...
        return;
_L2:
        zw.h().e("CrashlyticsCore", "Tried to write a native crash while no session was open.", null);
        obj = null;
        if (true) goto _L4; else goto _L3
_L3:
        sessioneventdata;
        ...
        obj = null;
_L8:
        zw.h().e("CrashlyticsCore", "An error occurred in the native crash logger", sessioneventdata);
...
_L4:
        ...
        return;
_L2:
        zw.h().e("CrashlyticsCore", "Tried to write a fatal exception while no session was open.", null);
        obj = null;
        obj1 = clsfileoutputstream;
        if (true) goto _L4; else goto _L3
_L3:
...
_L8:
        codedoutputstream = codedoutputstream1;
        clsfileoutputstream = ((ClsFileOutputStream) (obj));
        zw.h().e("CrashlyticsCore", "An error occurred in the fatal exception logger", date);
        codedoutputstream = codedoutputstream1;
        clsfileoutputstream = ((ClsFileOutputStream) (obj));
...
_L7:
    ...
    private void writeInitialPartsTo(CodedOutputStream codedoutputstream, String s)
    {
        ...
        while (i < j) 
        {
            ...
            if (afile.length == 0)
            {
                zw.h().e("CrashlyticsCore", (new StringBuilder()).append("Can't find ").append(s1).append(" data for session ID ").append(s).toString(), null);
            } else
            {
                zw.h().a("CrashlyticsCore", (new StringBuilder()).append("Collecting ").append(s1).append(" data for session ID ").append(s).toString());
    ...
    private void writeNonFatalEventsTo(CodedOutputStream codedoutputstream, File afile[], String s)
    {
        ...
        while (i < j) 
        {
            ...
            try
            {
                zw.h().a("CrashlyticsCore", String.format(Locale.US, "Found Non Fatal for session ID %s in %s ", new Object[] {
                    s, file.getName()
                }));
            ...
            {
                zw.h().e("CrashlyticsCore", "Error writting non-fatal to session.", exception);
            }
            i++;
        }
    }
...
_L3:
    ...
    private void writeSessionPartsToSessionFile(File file, String s, int i)
    {
        ...
        Object obj1;
        codedoutputstream = null;
        zw.h().a("CrashlyticsCore", (new StringBuilder()).append("Collecting session parts for ID ").append(s).toString());
        ...
        zw.h().a("CrashlyticsCore", String.format(Locale.US, "Session %s has fatal exception: %s", new Object[] {
        ...
        zw.h().a("CrashlyticsCore", String.format(Locale.US, "Session %s has non-fatal exceptions: %s", new Object[] {
...
_L1:
        ...
        zw.h().a("CrashlyticsCore", (new StringBuilder()).append("Collecting SessionStart data for session ID ").append(s).toString());
        writeToCosFromFile(codedoutputstream, file);
...
_L3:
        ...
        zw.h().a("CrashlyticsCore", String.format(Locale.US, "Trimming down to %d logged exceptions.", new Object[] {
            Integer.valueOf(i)
        }));
...
_L5:
        zw.h().a("CrashlyticsCore", (new StringBuilder()).append("Removing session part files for ID ").append(s).toString());
...
_L7:
        zw.h().e("CrashlyticsCore", (new StringBuilder()).append("Failed to write session file for session ID: ").append(s).toString(), ((Throwable) (obj1)));
...
_L6:
        ...
        throw s;
_L2:
        zw.h().a("CrashlyticsCore", (new StringBuilder()).append("No events present for session ID ").append(s).toString());
          goto _L5
        s;
        file = null;
          goto _L6
...
_L2:
        zw.h().e("CrashlyticsCore", (new StringBuilder()).append("Tried to include a file that doesn't exist: ").append(file.getName()).toString(), null);
        return;
        codedoutputstream;
        if (true) goto _L6; else goto _L5
_L5:
    ...
    void doCleanInvalidTempFiles(File afile[])
    {
        ...
        for (int i = 0; i < k; i++)
        {
            ...
            zw.h().a("CrashlyticsCore", (new StringBuilder()).append("Found invalid session part file: ").append(sessionId).toString());
            ...
            zw.h().a("CrashlyticsCore", (new StringBuilder()).append("Deleting all part files for invalid session: ").append(sessionId).toString());
            File afile1[] = listFilesMatching(filenamefilter);
            int l = afile1.length;
            for (int j = 0; j < l; j++)
            {
                File file = afile1[j];
                zw.h().a("CrashlyticsCore", (new StringBuilder()).append("Deleting session file: ").append(file).toString());
                file.delete();
            }
    ...
    public void uncaughtException(final Thread thread, final Throwable ex)
    {
        ...
        zw.h().a("CrashlyticsCore", (new StringBuilder()).append("Crashlytics is handling uncaught exception \"").append(ex).append("\" from thread ").append(thread.getName()).toString());
        if (!receiversRegistered.getAndSet(true))
        {
            zw.h().a("CrashlyticsCore", "Unregistering power receivers.");
        ...
        zw.h().a("CrashlyticsCore", "Crashlytics completed exception processing. Invoking default exception handler.");
...
_L2:
        ...
        Object obj;
        obj;
        zw.h().e("CrashlyticsCore", "An error occurred in the uncaught exception handler", ((Throwable) (obj)));
        zw.h().a("CrashlyticsCore", "Crashlytics completed exception processing. Invoking default exception handler.");
        defaultHandler.uncaughtException(thread, ex);
        isHandlingException.set(false);
        if (true) goto _L2; else goto _L1
