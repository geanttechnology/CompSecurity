...
_L4:
        s = fileinputstream;
        zw.h().e("CrashlyticsCore", "Error deserializing user metadata.", exception1);
        CommonUtils.a(fileinputstream, "Failed to close user metadata file.");
        return Collections.emptyMap();
        Exception exception;
        exception;
...
_L4:
        s = map;
        zw.h().e("CrashlyticsCore", "Error serializing key/value metadata.", ((Throwable) (obj)));
        CommonUtils.a(map, "Failed to close key/value metadata file.");
        return;
        obj;
        map = s;
...
_L4:
        s = usermetadata;
        zw.h().e("CrashlyticsCore", "Error serializing user metadata.", ((Throwable) (obj)));
        CommonUtils.a(usermetadata, "Failed to close user metadata file.");
        return;
        obj;
        usermetadata = s;
