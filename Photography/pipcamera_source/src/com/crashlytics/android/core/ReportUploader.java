...
class ReportUploader
{
    ...
    List findReports()
    {
        zw.h().a("CrashlyticsCore", "Checking for crash reports...");
        File afile[];
        ...
        {
            File file = afile[i];
            zw.h().a("CrashlyticsCore", (new StringBuilder()).append("Found crash report ").append(file.getPath()).toString());
        ...
        if (((List) (obj)).isEmpty())
        {
            zw.h().a("CrashlyticsCore", "No reports found.");
        }
        return ((List) (obj));
    }
    ...
    boolean forceUpload(Report report)
    {
        ...
        obj = new CreateReportRequest((new aau()).a(((android.content.Context) (obj))), report);
        ...
        aag1.c("CrashlyticsCore", stringbuilder.append(s).append(report.getFileName()).toString());
        flag = flag1;
        if (!flag2)
        {
            break MISSING_BLOCK_LABEL_122;
...
_L2:
        ...
        Exception exception;
        exception;
        zw.h().e("CrashlyticsCore", (new StringBuilder()).append("Error occurred sending report ").append(report).toString(), exception);
        flag = flag1;
...
*/
    ...
    private class Worker extends aav
    {
        ...
        private void attemptUploadWithRetry()
        {
            ...
            zw.h().a("CrashlyticsCore", (new StringBuilder()).append("Starting report processing in ").append(delay).append(" second(s)...").toString());
...
_L2:
            ...
            zw.h().a("CrashlyticsCore", (new StringBuilder()).append("User declined to send. Removing ").append(((List) (obj)).size()).append(" Report(s).").toString());
...
_L3:
            ...
            {
                zw.h().a("CrashlyticsCore", (new StringBuilder()).append("Attempting to send ").append(((List) (obj)).size()).append(" report(s)").toString());
                Report report;
                ...
                if (!((List) (obj)).isEmpty())
                {
                    ...
                    zw.h().a("CrashlyticsCore", (new StringBuilder()).append("Report submisson: scheduling delayed retry in ").append(l).append(" seconds").toString());
                    try
                    {
...
_L4:
        ...
        public void onRun()
        {
            ...
            {
                zw.h().e("CrashlyticsCore", "An unexpected error occurred while attempting to upload crash reports.", exception);
            }
            uploadThread = null;
        }
