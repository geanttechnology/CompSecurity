...
//            NativeAdsManager, NativeAdViewAttributes
...
public class NativeAdScrollView extends LinearLayout
{
    ...
    private NativeAdScrollView(Context context, NativeAdsManager nativeadsmanager, AdViewProvider adviewprovider, NativeAdView.Type type, NativeAdViewAttributes nativeadviewattributes, int i)
    {
        ...
        } else
        {
            a = context;
            b = nativeadsmanager;
            g = nativeadviewattributes;
            c = adviewprovider;
            d = type;
            e = i;
            nativeadsmanager = new a();
            f = new b(context);
            f.setAdapter(nativeadsmanager);
            setInset(20);
            nativeadsmanager.a();
            addView(f);
            return;
