    ...
    implements ll.a
{
    ...
    public ig()
    {
        ...
        i = new jz(js.a().c().getFileStreamPath(o()), ".yflurryprotonconfig.", 1, new le() {
        ...
        j = new jz(js.a().c().getFileStreamPath(p()), ".yflurryprotonreport.", 1, new le() {
...
_L12:
        ...
        kn1.b(new kx());
        kn1.a(abyte0);
        kn1.a(new kn.a(l1, flag) {

            final long a;
            final boolean b;
            final ig c;

            public volatile void a(kn kn2, Object obj1)
            {
                a(kn2, (byte[])obj1);
            }

            public void a(kn kn2, byte abyte1[])
            {
                Object obj1;
                int i1;
                obj1 = null;
...
_L2:
            ...
            
            {
                ...
                try
                {
                    abyte1 = (ht)ig.e(c).d(abyte1);
                }
                // Misplaced declaration of an exception variable
                catch (byte abyte1[])
                {
                    kg.a(5, ig.e(), (new StringBuilder()).append("Failed to decode proton config response: ").append(abyte1).toString());
                    abyte1 = null;
                }
                ht1 = abyte1;
                if (!ig.a(c, abyte1))
...
_L5:
                kn2 = kn2.b("Retry-After");
                if (kn2.isEmpty()) goto _L6; else goto _L7
_L7:
                kn2 = (String)kn2.get(0);
                kg.a(3, ig.e(), (new StringBuilder()).append("Server returned retry time: ").append(kn2).toString());
                l3 = Long.parseLong(kn2);
                l2 = l3 * 1000L;
_L9:
                ig.a(c, l2);
