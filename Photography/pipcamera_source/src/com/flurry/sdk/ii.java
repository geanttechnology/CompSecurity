...
public class ii extends ks
{
    ...
    protected jz a()
    {
        return new jz(js.a().c().getFileStreamPath(".yflurryanpulsecallbackreporter"), ".yflurryanpulsecallbackreporter", 2, new le() {
    ...
    protected void a(ij ij1)
    {
        ...
        kn1.a(new kn.a(ij1, ik1) {
            ...
            public void a(kn kn2, String s1)
            {
                kg.a(3, ii.b(), (new StringBuilder()).append("Pulse report to ").append(a.i()).append(" for ").append(a.m()).append(", HTTP status code is: ").append(kn2.h()).toString());
                int i = kn2.h();
                b.a((int)kn2.c());
                b.e = i;
                if (!kn2.f())
                {
                    Exception exception = kn2.j();
                    if (kn2.d())
                    {
                        if (kn2.i())
                        {
                            kg.a(3, ii.b(), (new StringBuilder()).append("Timeout occured when trying to connect to: ").append(a.i()).append(". Exception: ").append(kn2.j().getMessage()).toString());
                        } else
                        {
