...
public class kp extends lz
{
    ...
    private static final String a = com/flurry/sdk/kp.getSimpleName();
    private String b;
    private a c;
    private int d;
    private int e;
    ...
    static HttpURLConnection a(kp kp1)
    {
        return kp1.m;
    }
...
_L6:
    ...
    public void a()
    {
        ...
        kg.a(3, a, (new StringBuilder()).append("Network not available, aborting http request: ").append(b).toString());
        y.a();
        s();
        return;
        ...
        r();
        kg.a(4, a, (new StringBuilder()).append("HTTP status: ").append(t).append(" for url: ").append(b).toString());
        y.a();
        s();
        return;
        Object obj;
        obj;
        kg.a(4, a, (new StringBuilder()).append("HTTP status: ").append(t).append(" for url: ").append(b).toString());
        kg.a(3, a, (new StringBuilder()).append("Exception during http request: ").append(b).toString(), ((Throwable) (obj)));
        g = m.getReadTimeout();
    ...
    public void k()
    {
        ...
        long l2 = q;
        kg.a(3, a, (new StringBuilder()).append("Timeout (").append(l1 - l2).append("MS) for url: ").append(b).toString());
        t = 629;
        z = true;
        s();
        l();
    ...
    public void l()
    {
        kg.a(3, a, (new StringBuilder()).append("Cancelling http request: ").append(b).toString());
        synchronized (v)
        {
            o = true;
        }
    ...
    // Unreferenced inner class com/flurry/sdk/kp$2
...
/* anonymous class */
    ...
    private class c
    {
        ...
        public abstract void a(kp kp1);

        public abstract void a(kp kp1, InputStream inputstream);

        public abstract void a(kp kp1, OutputStream outputstream);
    }
    ...
    private class a extends Enum
    {
        ...
        {
            return (a)Enum.valueOf(com/flurry/sdk/kp$a, s1);
        }
