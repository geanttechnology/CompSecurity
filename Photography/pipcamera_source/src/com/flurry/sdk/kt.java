...
public abstract class kt
{
    ...
    protected void d(byte abyte0[], String s, String s1)
    {
        ...
        s1 = abyte0.a();
        (new jz(js.a().c().getFileStreamPath(ku.a(s1)), ".yflurrydatasenderblock.", 1, new le() {
...
_L9:
        ku ku1 = (ku)(new jz(js.a().c().getFileStreamPath(ku.a(s1)), ".yflurrydatasenderblock.", 1, new le() {
