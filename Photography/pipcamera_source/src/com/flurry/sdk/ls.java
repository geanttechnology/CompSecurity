...
public final class ls
{
    ...
    private static String a = com/flurry/sdk/ls.getSimpleName();
...
label0:
    ...
    public static void a(File file, String s)
    {
        ...
        if (s == null)
        {
            kg.a(4, a, (new StringBuilder()).append("No data specified; deleting persistent file: ").append(file.getAbsolutePath()).toString());
            file.delete();
            return;
        }
        kg.a(4, a, (new StringBuilder()).append("Writing persistent data: ").append(file.getAbsolutePath()).toString());
...
_L4:
        file = s;
        kg.a(6, a, "Error writing persistent file", throwable);
        lt.a(s);
        return;
        s;
        file = null;
...
_L3:
    ...
    public static boolean a(File file)
    {
        ...
        {
            kg.a(6, a, (new StringBuilder()).append("Unable to create persistent dir: ").append(file).toString());
            return false;
        } else
        {
            return true;
...
_L5:
        return null;
_L2:
        kg.a(4, a, (new StringBuilder()).append("Loading persistent data: ").append(file.getAbsolutePath()).toString());
...
_L9:
        file = ((File) (obj));
        kg.a(6, a, "Error when loading persistent file", ((Throwable) (obj1)));
