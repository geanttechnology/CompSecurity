...
public final class lt
{
    ...
    private static final String a = com/flurry/sdk/lt.getSimpleName();
...
_L1:
        ...
        return false;
_L2:
        if ((j = context.getPackageManager().checkPermission(s, context.getPackageName())) != 0) goto _L1; else goto _L3
_L3:
        return true;
        context;
        kg.a(6, a, (new StringBuilder()).append("Error occured when checking if app has permission.  Error: ").append(context.getMessage()).toString());
        return false;
    }

    public static boolean a(Intent intent)
    {
        return js.a().e().queryIntentActivities(intent, 0x10000).size() > 0;
    }
    ...
    public static String b(byte abyte0[])
    {
        ...
        {
            kg.a(5, a, (new StringBuilder()).append("Unsupported ISO-8859-1:").append(abyte0.getMessage()).toString());
            return null;
        }
        return abyte0;
    }
    ...
    public static String c(String s)
    {
        ...
        {
            kg.a(5, a, (new StringBuilder()).append("Cannot encode '").append(s).append("'").toString());
            return "";
        }
        return s1;
    }
    ...
    public static String d(String s)
    {
        ...
        {
            kg.a(5, a, (new StringBuilder()).append("Cannot decode '").append(s).append("'").toString());
            return "";
        }
        return s1;
    }
    ...
    public static byte[] e(String s)
    {
        ...
        {
            kg.a(5, a, (new StringBuilder()).append("Unsupported UTF-8: ").append(s.getMessage()).toString());
            return null;
        }
        return s;
    }
    ...
    public static byte[] f(String s)
    {
        ...
        {
            kg.a(6, a, (new StringBuilder()).append("Unsupported SHA1: ").append(s.getMessage()).toString());
            return null;
        }
        return s;
    }
