...
_L3:
        try
        {
            ...
            (new FotoAdMediationUpdateRequest()).download(s, new FotoAdMediationUpdateRequest.requestCallback() {
                ...
                public void onRequestSuccess(String s3)
                {
...
_L2:
                    String s4;
                    Object obj;
                    obj = new JSONObject(s3);
                    s4 = ((JSONObject) (obj)).getString("banner");
                    String s5 = ((JSONObject) (obj)).getString("video");
                    s3 = ((JSONObject) (obj)).getString("fullscreen");
                    String s6;
                    String s7;
                    String s8;
                    s8 = s3;
                    ...
                    {
                        FotoAdMediationDB.setValueWithKeyAndValue(context, FotoAdMediationDB.FOTO_BANNER_ID, s4);
                    }
                    if (s5 != null && s5.length() > 5)
                    {
                        FotoAdMediationDB.setValueWithKeyAndValue(context, FotoAdMediationDB.FOTO_SPECIAL_INTERSTITAL_ID, s5);
                    }
                    if (s3 != null && s3.length() > 5)
                    {
                        FotoAdMediationDB.setValueWithKeyAndValue(context, FotoAdMediationDB.FOTO_INTERSTITIAL_ID, s3);
                    }
...
label0:
    ...
    public static int getdfBannerResource(Context context)
    {
        ...
        if (context.compareTo("com.wantu.activity") == 0)
        {
            if (Locale.getDefault().getLanguage().compareTo("zh") == 0)
            {
                ...
                {
                    return com.fotoable.fotoadpackage.R.drawable.magbanner_cn;
                } else
                {
                    return com.fotoable.fotoadpackage.R.drawable.magbanner_en;
                }
            } else
            {
                return com.fotoable.fotoadpackage.R.drawable.magbanner_en;
        ...
        if (context.compareTo("com.instamag.activity") == 0)
        {
            if (Locale.getDefault().getLanguage().compareTo("zh") == 0)
            {
                return com.fotoable.fotoadpackage.R.drawable.wantubanner_cn;
            } else
            {
                return com.fotoable.fotoadpackage.R.drawable.wantubanner_en;
            }
        }
        if (context.compareTo("com.pipcamera.activity") != 0)
        {
        ...
        i = com.fotoable.fotoadpackage.R.drawable.wantubanner_en;
        return i;
        context;
        if (Locale.getDefault().getLanguage().compareTo("zh") == 0)
        {
    ...
    static 
    {
        ...
        InstaMag_BundleName = es.a;
        Wantu_BundleName = es.b;
        InstaBeauty_BundleName = es.c;
        PIP_BundleName = es.e;
        PhotoEditor_BundleName = es.j;
        Hicollage_BundleName = es.d;
    }
}
