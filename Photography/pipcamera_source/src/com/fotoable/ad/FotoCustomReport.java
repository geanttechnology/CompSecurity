...
_L1:
        ...
        eu.a(((WifiManager)context.getSystemService("wifi")).getConnectionInfo().getMacAddress());
_L2:
        if (obj == null)
        {
...
_L1:
    ...
    {
        if (kv.b(jsonobject, "adBtnId").length() > 0)
        {
            adBtnId.clear();
        }
        if (kv.b(jsonobject, "clickedAdBtnId").length() > 0)
        {
            clickedAdBtnId.clear();
        }
        if (kv.b(jsonobject, "pipfilterUsed").length() > 0)
        {
            pipfilterUsed.clear();
        }
        if (kv.b(jsonobject, "instamagfilterUsed").length() > 0)
        {
            instamagfilterUsed.clear();
        }
        if (kv.b(jsonobject, "collagefilterUsed").length() > 0)
        {
            collagefilterUsed.clear();
        }
        if (kv.b(jsonobject, "userUsedFunction").length() > 0)
        {
            userUsedFunction.clear();
        }
        if (kv.b(jsonobject, "userSavedFunction").length() > 0)
        {
