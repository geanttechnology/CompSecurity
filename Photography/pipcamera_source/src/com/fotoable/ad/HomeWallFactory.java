...
//            NativeAdWrapper, StaticFlurryEvent
...
public class HomeWallFactory
{
    ...
    private static kp NativeSize = new kp(300, 207);
    ...
    private static ks gifListener = new ks() {
        ...
        public void GifViewDisplayed(kp kp1)
        {
            ...
            {
                ((fotoHomeWalladListener)HomeWallFactory.mListenerWeakRef.get()).onHomeWallReceived(kp1);
        ...
        public void GifViewSizeChanged(kp kp1)
        {
            ...
            if (f1 <= (float)kp1.a())
            {
                f = HomeWallFactory.dip2px(((Context) (obj)), kp1.a());
            }
...
_L5:
    ...
    public static kp nativeAdViewSize = null;
...
_L6:
        ...
        view.addSize(new kp(160, 120));
        view.addSize(new kp(300, 207));
...
_L12:
    ...
    private static int getAppBannerImage(String s, int i)
    {
        ...
        {
            return com.fotoable.fotoadpackage.R.drawable.home_fotorus_cn;
        }
        ...
        if (((Activity)mActivityWeakRef.get()).getPackageName().compareToIgnoreCase(PIP_BundleName) == 0 && s.compareToIgnoreCase(InstaBeauty_BundleName) == 0)
        {
            if (ew.a() && i == 1)
            {
                return com.fotoable.fotoadpackage.R.drawable.beauty_in_pip_cn;
            }
            if (!ew.a() && i == 1)
            {
                return com.fotoable.fotoadpackage.R.drawable.beauty_in_pip_en;
            }
        }
        if (s.compareToIgnoreCase(Wantu_BundleName) == 0)
        {
            ...
            if (ew.a() && i == 2)
            {
                return com.fotoable.fotoadpackage.R.drawable.savewall_fotorus_cn;
            }
            if (!ew.a() && i == 1)
            {
                return com.fotoable.fotoadpackage.R.drawable.home_fotorus_en;
            }
            if (!ew.a() && i == 2)
            {
                return com.fotoable.fotoadpackage.R.drawable.savewall_fotorus_en;
            }
        } else
        if (s.compareToIgnoreCase(InstaMag_BundleName) == 0)
        {
            if (ew.a() && i == 1)
            {
                return com.fotoable.fotoadpackage.R.drawable.home_instamag_cn;
            }
            if (ew.a() && i == 2)
            {
                return com.fotoable.fotoadpackage.R.drawable.savewall_instamag_cn;
            }
            if (!ew.a() && i == 1)
            {
                return com.fotoable.fotoadpackage.R.drawable.home_instamag_en;
            }
            if (!ew.a() && i == 2)
            {
                return com.fotoable.fotoadpackage.R.drawable.savewall_instamag_en;
            }
        } else
        if (s.compareToIgnoreCase(InstaBeauty_BundleName) == 0)
        {
            if (ew.a() && i == 1)
            {
                return com.fotoable.fotoadpackage.R.drawable.home_instabeauty_cn;
            }
            if (ew.a() && i == 2)
            {
                return com.fotoable.fotoadpackage.R.drawable.savewall_instabeauty_cn;
            }
            if (!ew.a() && i == 1)
            {
                return com.fotoable.fotoadpackage.R.drawable.home_instabeauty_en;
            }
            if (!ew.a() && i == 2)
            {
                return com.fotoable.fotoadpackage.R.drawable.savewall_instabeauty_en;
            }
        }
        return com.fotoable.fotoadpackage.R.drawable.home_fotorus_cn;
    }
    ...
    private static void loadDefaultWall()
    {
        ...
        ((ImageView)defaultAdWallViewRef.get()).setOnClickListener(new android.view.View.OnClickListener() {
...
_L3:
    ...
    public static void requestFBAdView(Context context)
    {
        ...
        try
        {
            ...
            NativeAdWrapper.createThirdPartNativeView(context, new NativeAdWrapper.NativeAdWrapperListener() {
                ...
                public void onAdLoaded(View view, kp kp1)
                {
                    HomeWallFactory.hasNativeAd = true;
                    HomeWallFactory.nativeAdView = view;
                    HomeWallFactory.nativeAdViewSize = kp1;
    ...
    private class fotoHomeWalladListener
    {
        ...
        public abstract void onHomeWallReceived(kp kp1);
    }
