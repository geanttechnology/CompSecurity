...
_L1:
    ...
    {
        if (context != null && gb.e())
        {
            mNativeWall = ix.a(context, new iz() {
                ...
                public void adLoaded(FotoNativeBaseWall fotonativebasewall)
                {
                    ...
                    if (NativeAdWrapper.mListener != null)
                    {
                        NativeAdWrapper.mListener.onAdLoaded(fotonativebasewall, new kp(300, 207));
                        NativeAdWrapper.adState = 0;
                    }
                ...
                private class NativeAdWrapperListener
                {
                    ...
                    public abstract void onAdLoaded(View view, kp kp1);
                }
...
_L4:
    ...
    private static void handleDataToListener()
    {
        ...
        do
        {
            ...
            if (fotonativebasewall != null)
            {
                mListener.onAdLoaded(fotonativebasewall, new kp(300, 207));
            }
        } while (true);
        adState = 0;
    }
    ...
    public static boolean nativeAdHandleResult(int i, int j, Intent intent, Activity activity)
    {
        ...
        if (activity != null)
        {
            if ((jb1 = ix.c(activity)) != null)
            {
                return jb1.a(i, j, intent, activity);
            }
        }
        return false;
    }
