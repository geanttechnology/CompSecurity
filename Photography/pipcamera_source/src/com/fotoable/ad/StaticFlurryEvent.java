...
public class StaticFlurryEvent
{
    ...
    public static void logADEventWithKV(String s, String s1)
    {
        ...
        hashmap.put(s, s1);
        FlurryAgent.logEvent("HomeNativeAD", hashmap);
        Log.e("HomeNativeAd", (new StringBuilder()).append("key:").append(s).append(" value:").append(s1).toString());
    }
    ...
    public static void logEventUnique(Context context, String s, String s1)
    {
