...
_L1:
    ...
    private int getAppBannerImage(String s)
    {
        ...
        if (s.compareTo(InstaBeauty_BundleName) == 0)
        {
            if (ew.a())
            {
                return com.fotoable.fotoadpackage.R.drawable.beautybanner_cn;
            } else
            {
                return com.fotoable.fotoadpackage.R.drawable.beautybanner_en;
            }
        }
        if (s.compareTo(PIP_BundleName) == 0)
        {
            if (ew.a())
            {
                return com.fotoable.fotoadpackage.R.drawable.pipbanner_cn;
            } else
            {
                return com.fotoable.fotoadpackage.R.drawable.pipbanner_en;
            }
        }
        if (s.compareTo(Helpr_BundleName) == 0)
        {
            return com.fotoable.fotoadpackage.R.drawable.helprbanner;
        } else
        {
            return com.fotoable.fotoadpackage.R.drawable.wantubanner_cn;
        }
