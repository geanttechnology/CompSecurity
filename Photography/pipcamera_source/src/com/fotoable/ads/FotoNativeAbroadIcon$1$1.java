    ...
    implements AdListener
{
    ...
    public void onAdClicked(Ad ad)
    {
        ...
        StaticFlurryEvent.logADClickedEvent(a.a.getContext(), StaticFlurryEvent.FBNativeIconAD_Click);
    }
    ...
    public void onAdLoaded(Ad ad)
    {
        ...
        {
            (new Handler(a.a.getContext().getMainLooper())).post(new Runnable() {

                final FotoNativeAbroadIcon._cls1._cls1 a;
            ...
            {
                a = FotoNativeAbroadIcon._cls1._cls1.this;
                super();
            }
            });
        }
