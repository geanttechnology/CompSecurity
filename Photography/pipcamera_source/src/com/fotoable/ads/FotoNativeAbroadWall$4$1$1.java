    ...
    implements Runnable
{
    ...
    public void run()
    {
        ...
        StaticFlurryEvent.logADClickedEvent(a.a.a, StaticFlurryEvent.FBNativeAD_Click);
    }
...
/* anonymous class */
        ...
        implements AdListener
    {
        ...
        public void onAdClicked(Ad ad)
        {
            if (b.a != null)
            {
                (new Handler(b.a.getMainLooper())).post(new FotoNativeAbroadWall._cls4._cls1._cls1(this));
            }
        }
