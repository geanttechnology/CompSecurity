    ...
    class ProEditFilterActivity._cls6 extends Handler
    {
        ...
        public void handleMessage(Message message)
        {
            ...
            if (message != null)
            {
                ...
                {
                    kf.b("filter");
                    gm.c().a(new ProEditFilterActivity._cls6._cls1(), message, a);
                    return;
                }
            ...
            a.runOnUiThread(new ProEditFilterActivity._cls6._cls2(this));
            return;
            a.c();
            return;
        }
        ...
        // Unreferenced inner class com/fotoable/fotoproedit/activity/ProEditFilterActivity$6$1

/* anonymous class */
        class ProEditFilterActivity._cls6._cls1
            implements go
        {
