...
_L3:
    ...
    // Unreferenced inner class com/fotoable/fotoproedit/activity/ProEditMainActivity$6

/* anonymous class */
    class ProEditMainActivity._cls6
        implements Runnable
    {
        ...
        public void run()
        {
            try
            {
                gm.c().a(new ProEditMainActivity._cls6._cls1(this));
                return;
            }
