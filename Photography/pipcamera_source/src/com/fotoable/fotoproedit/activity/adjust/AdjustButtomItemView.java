...
public class AdjustButtomItemView extends FrameLayout
{
    ...
    private void init()
    {
        ...
        imageview = (ImageView)findViewById(0x7f0c0269);
        textview = (TextView)findViewById(0x7f0c026a);
    }
    ...
    public void setSelected(boolean flag)
    {
        ...
        if (flag)
        {
            imageview.setColorFilter(getResources().getColor(0x7f0b0020), android.graphics.PorterDuff.Mode.MULTIPLY);
            textview.setTextColor(getResources().getColor(0x7f0b0020));
            return;
        } else
        {
