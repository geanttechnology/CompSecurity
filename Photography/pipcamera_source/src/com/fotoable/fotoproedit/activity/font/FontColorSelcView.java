...
public class FontColorSelcView extends FrameLayout
{
    ...
    public FontColorSelcView(Context context, AttributeSet attributeset)
    {
        ...
        itemWidth = 0;
        itemHeight = 0;
        ((LayoutInflater)getContext().getSystemService("layout_inflater")).inflate(0x7f0300b5, this, true);
...
_L4:
    ...
    public void setMaxWeidth(int i, int j)
    {
        ...
        {
            Object obj = (ml)colorItems.get(j);
    ...
    public void setOnColorSelectorListener(gz gz1)
    {
        listener = gz1;
    }
}
