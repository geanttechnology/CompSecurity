    ...
    implements android.view.View.OnClickListener
{
    ...
    {
        e = (TextView)view.findViewById(com.fotoable.fotophotoselector.R.id.pwdinput);
        f = (TextView)view.findViewById(com.fotoable.fotophotoselector.R.id.passwrodNote);
        view.findViewById(com.fotoable.fotophotoselector.R.id.Button00).setOnClickListener(this);
        view.findViewById(com.fotoable.fotophotoselector.R.id.button01).setOnClickListener(this);
        view.findViewById(com.fotoable.fotophotoselector.R.id.button02).setOnClickListener(this);
        view.findViewById(com.fotoable.fotophotoselector.R.id.button03).setOnClickListener(this);
        view.findViewById(com.fotoable.fotophotoselector.R.id.Button04).setOnClickListener(this);
        view.findViewById(com.fotoable.fotophotoselector.R.id.Button05).setOnClickListener(this);
        view.findViewById(com.fotoable.fotophotoselector.R.id.Button06).setOnClickListener(this);
        view.findViewById(com.fotoable.fotophotoselector.R.id.Button07).setOnClickListener(this);
        view.findViewById(com.fotoable.fotophotoselector.R.id.Button08).setOnClickListener(this);
        view.findViewById(com.fotoable.fotophotoselector.R.id.Button09).setOnClickListener(this);
        g = (Button)view.findViewById(com.fotoable.fotophotoselector.R.id.ButtonBackSpace);
...
_L1:
        b = "";
        e.setText(b);
        f.setText(com.fotoable.fotophotoselector.R.string.enter_your_passcode);
_L4:
        return;
_L2:
        ...
        b = "";
        e.setText(b);
        f.setText(com.fotoable.fotophotoselector.R.string.reenter_your_passcode);
...
_L6:
        ...
        if (b.length() >= 5 && c.compareTo(b) == 0)
        {
            ...
            Toast.makeText(getActivity(), getActivity().getResources().getString(com.fotoable.fotophotoselector.R.string.passcode_set), 0).show();
            return;
        }
        continue; /* Loop/switch isn't completed */
_L2:
...
_L9:
        Toast.makeText(getActivity(), getActivity().getResources().getString(com.fotoable.fotophotoselector.R.string.wrong_passcode), 0).show();
        b = "";
        e.setText(b);
        return;
        if (b.length() < 5 || c.compareTo(b) == 0) goto _L3; else goto _L10
_L10:
        Toast.makeText(getActivity(), getActivity().getResources().getString(com.fotoable.fotophotoselector.R.string.passcode_try_again), 0).show();
...
_L11:
    ...
    {
        layoutinflater = layoutinflater.inflate(com.fotoable.fotophotoselector.R.layout.view_fullscreenpinquery, viewgroup, false);
        a(layoutinflater);
        getDialog().setTitle(getActivity().getResources().getString(com.fotoable.fotophotoselector.R.string.passcode_title));
