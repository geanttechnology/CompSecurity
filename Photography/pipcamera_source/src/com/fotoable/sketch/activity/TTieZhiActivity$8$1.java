    ...
    implements Runnable
{
    ...
    {
        a.a.F = false;
        if (a.a.o.getVisibility() == 0 && TTieZhiActivity.i(a.a).size() > 0)
        {
            Log.e("TTieZhiActivity", "mainLibrary handleData");
            a.a.o.setIsFinishLoad(a.a.t);
            a.a.o.handleData(TTieZhiActivity.i(a.a));
        }
    }
...
_L5:
            ...
            if (!flag1)
            {
                ...
                {
                    c.runOnUiThread(new TTieZhiActivity._cls8._cls3());
                    return;
                }
            }
...
_L7:
            ...
            c.runOnUiThread(new TTieZhiActivity._cls8._cls1(this));
            i = ((flag) ? 1 : 0);
_L15:
            if (i == 0)
            {
...
/* anonymous class */
        ...
        // Unreferenced inner class com/fotoable/sketch/activity/TTieZhiActivity$8$3

/* anonymous class */
        class TTieZhiActivity._cls8._cls3
            implements Runnable
        {
