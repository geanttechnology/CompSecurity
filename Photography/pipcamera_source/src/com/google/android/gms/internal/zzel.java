...
public final class zzel extends zzeg.zza
{
    ...
    private final pv zzyh;
    private final qb zzyi;

    public zzel(pv pv1, qb qb)
    {
        zzyh = pv1;
        zzyi = qb;
    }
...
_L3:
    ...
    public void zza(zzd zzd, AdRequestParcel adrequestparcel, String s, String s1, zzeh zzeh)
    {
        ...
        try
        {
            ((py)zzyh).a(new zzem(zzeh), (Activity)zze.zzn(zzd), zzb(s, adrequestparcel.zzsb, s1), zzen.zzg(adrequestparcel), zzyi);
            return;
        }
        // Misplaced declaration of an exception variable
        catch (zzd zzd)
    ...
    public void zza(zzd zzd, AdSizeParcel adsizeparcel, AdRequestParcel adrequestparcel, String s, String s1, zzeh zzeh)
    {
        ...
        try
        {
            ((pw)zzyh).a(new zzem(zzeh), (Activity)zze.zzn(zzd), zzb(s, adrequestparcel.zzsb, s1), com.google.android.gms.internal.zzen.zzb(adsizeparcel), zzen.zzg(adrequestparcel), zzyi);
            return;
        }
        // Misplaced declaration of an exception variable
        catch (zzd zzd)
