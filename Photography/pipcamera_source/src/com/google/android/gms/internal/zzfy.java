    ...
    implements Callable
{
        ...
        } else
        {
            ...
            obj = new zzdg(((zzf) (obj))) {
                ...
                public void zza(zzid zzid, Map map)
                {
                    ...
                    com.google.android.gms.internal.zzfy.zza(zzBO, zzBR, zzid);
                }
    ...
    protected zza zzd(JSONObject jsonobject)
    {
        ...
        if ("3".equals(s))
        {
            ...
            zzhl.zzGk.post(new Runnable(zzhs1, s1) {
                ...
                public void run()
                {
                    zzBP.zzf(com.google.android.gms.internal.zzfy.zza(zzBO).zzbo().get(zzBQ));
                }
    ...
    public zzhv zze(JSONObject jsonobject)
    {
        ...
        } else
        {
            ...
            return com.google.android.gms.internal.zzhu.zza(zza(jsonobject, "image", false, false), new zzhu.zza(s, integer1, integer, i) {
