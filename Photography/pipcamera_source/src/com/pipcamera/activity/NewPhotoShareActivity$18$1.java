    ...
    implements Runnable
{
    ...
    public void run()
    {
        ...
        NewPhotoShareActivity.a(a.a, android.provider.Bitmap(a.a.getContentResolver(), NewPhotoShareActivity.c(a.a)));
        ...
        ((android.content.y.getSharedPreferences) (obj1)).tString("imageString", ((String) (obj)));
        ((android.content.tString) (obj1)).mmit();
_L1:
        return;
        obj;
    ...
    // Unreferenced inner class com/pipcamera/activity/NewPhotoShareActivity$18

/* anonymous class */
    class NewPhotoShareActivity._cls18
        implements Runnable
    {
        ...
        public void run()
        {
            ...
            a.runOnUiThread(new NewPhotoShareActivity._cls18._cls1(this));
        }
