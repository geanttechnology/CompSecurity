    ...
    implements od
{
    ...
    {
        android.content.ity ity;
        NewPhotoShareActivity.b(a);
        ity = a.getSharedPreferences("shareStyle", 0).edit();
        ity.putString("shareName", "sync_instagram");
        if (!flag || flag1) goto _L2; else goto _L1
_L1:
        ity.putInt("ShareState", 1);
_L4:
        ity.commit();
        return;
_L2:
