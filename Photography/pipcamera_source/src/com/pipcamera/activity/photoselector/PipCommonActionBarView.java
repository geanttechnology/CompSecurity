...
public class PipCommonActionBarView extends FrameLayout
{
    ...
    public PipCommonActionBarView(Context context, AttributeSet attributeset)
    {
        super(context, attributeset);
        ((LayoutInflater)getContext().getSystemService("layout_inflater")).inflate(0x7f0300c8, this, true);
    ...
    public void setOnAcceptListener(st st)
    {
        listener = st;
    }
    ...
    private class ENextBottonMode extends Enum
    {
        ...
        {
            return (ENextBottonMode)Enum.valueOf(com/pipcamera/activity/photoselector/PipCommonActionBarView$ENextBottonMode, s);
        }
