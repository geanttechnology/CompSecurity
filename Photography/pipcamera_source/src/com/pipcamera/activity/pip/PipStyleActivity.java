...
public class PipStyleActivity extends PipStyleBaseActivity
{
    ...
    {
        yg.a().a("pipbgsourceimage", bitmap);
    }
    ...
    public void d()
    {
        if (getSupportFragmentManager().getBackStackEntryCount() < 1)
        {
            ...
            fragmenttransaction.replace(0x7f0c0221, pipprocessfragment);
    ...
    public Bitmap f()
    {
        return yg.a().a("pipbgsourceimage");
    }
...
_L2:
        ...
        if (bundle != null)
        {
            h = bundle.getStringExtra("SelectedImageUri");
            a = bundle.getIntExtra("defaultIndex", 0);
        }
...
_L3:
    ...
    public void onSaveInstanceState(Bundle bundle)
    {
        ...
        bundle.putString("SelectedImageUri", h);
    }
