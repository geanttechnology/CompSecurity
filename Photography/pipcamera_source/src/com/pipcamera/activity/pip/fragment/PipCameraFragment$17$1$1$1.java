    ...
    implements Runnable
{
    ...
    public void run()
    {
        ...
        arraylist.add(a.a.a.a);
        so1.a(arraylist);
        PipCameraFragment.e(a.a.a.a, PipCameraFragment.u(a.a.a.a));
        so1.b(PipCameraFragment.v(a.a.a.a));
        so1.a(a.a.a.a);
        so1.a(3000);
...
/* anonymous class */
    ...
    // Unreferenced inner class com/pipcamera/activity/pip/fragment/PipCameraFragment$17$1$1

/* anonymous class */
    class PipCameraFragment._cls17._cls1._cls1
        implements Runnable
    {

        final PipCameraFragment._cls17._cls1 a;

        public void run()
        {
            PipCameraFragment.d(a.a.e).runOnUiThread(new PipCameraFragment._cls17._cls1._cls1._cls1(this));
        }
