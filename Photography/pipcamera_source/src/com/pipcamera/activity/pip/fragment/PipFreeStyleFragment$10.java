...
class a extends Handler
{
    ...
    public void handleMessage(Message message)
    {
        ...
        PipFreeStyleFragment.i(a).runOnUiThread(new Runnable() {
        ...
        PipFreeStyleFragment.i(a).runOnUiThread(new Runnable(message, ((Uri) (obj))) {
    ...
    _cls2.b(PipFreeStyleFragment pipfreestylefragment)
    {
