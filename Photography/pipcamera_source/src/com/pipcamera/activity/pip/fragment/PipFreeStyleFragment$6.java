...
class a
    implements android.view.PipFreeStyleFragment._cls6
{
    ...
    public void onClick(View view)
    {
        if (PipFreeStyleFragment.c(a).hasDrawing())
        {
            ...
            if (bitmap != null)
            {
                PipFreeStyleFragment.b(a).processImage(bitmap, "gaussian_12", new Handler() {

                    final PipFreeStyleFragment._cls6 a;
                    ...
                    public void handleMessage(Message message)
                    {
                        if (message != null)
                        {
                            ...
                            Bitmap bitmap1 = PipFreeStyleFragment.a(a.a, message);
                            PipFreeStyleFragment.i(a.a).b(bitmap1);
            ...
            {
                a = PipFreeStyleFragment._cls6.this;
                super();
            }
                });
    ...
    _cls1.a(PipFreeStyleFragment pipfreestylefragment)
    {
