...
public final class InstaMagType extends Enum
{
    ...
    static 
    {
        SQ_LIB_SIZE_TYPE = new InstaMagType("SQ_LIB_SIZE_TYPE", 0);
        RECT_LIB_SIZE_TYPE = new InstaMagType("RECT_LIB_SIZE_TYPE", 1);
        LANDSCAPE_LIB_SIZE_TYPE = new InstaMagType("LANDSCAPE_LIB_SIZE_TYPE", 2);
        LINK_LIB_SIZE_TYPE = new InstaMagType("LINK_LIB_SIZE_TYPE", 3);
        $VALUES = (new InstaMagType[] {
            SQ_LIB_SIZE_TYPE, RECT_LIB_SIZE_TYPE, LANDSCAPE_LIB_SIZE_TYPE, LINK_LIB_SIZE_TYPE
        });
    }
}
