...
class gifFaceStrechProcess extends commenProcess
{

    gifFaceStrechProcess()
    {
    }
    ...
    {
        CxImage cximage;
        for (cximage = new CxImage(sourceImage); !cximage.a(2) || cximage.a() == null || cximage.a().isRecycled();)
        {
            return;
        }
