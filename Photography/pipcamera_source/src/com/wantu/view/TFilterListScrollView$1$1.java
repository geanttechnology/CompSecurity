    ...
    implements Runnable
{
    ...
    // Unreferenced inner class com/wantu/view/TFilterListScrollView$1
        ...
        implements android.widget.AdapterView.OnItemClickListener
    {
        ...
        public void onItemClick(AdapterView adapterview, View view, int i, long l)
        {
            if (TFilterListScrollView.access$200(a) != null)
            {
                ...
                TFilterListScrollView.access$200(a).a(((yt)TFilterListScrollView.access$400(a).get(i)).b);
                a.requestLayout();
