...
public class do extends ResourceCursorAdapter
    implements android.view.View.OnClickListener
{
    ...
    public do(Context context, SearchView searchview, SearchableInfo searchableinfo, WeakHashMap weakhashmap)
    {
...
_L1:
    ...
    public void bindView(View view, Context context, Cursor cursor)
    {
        ...
        if (((dp) (context)).a != null)
        {
            view = a(cursor, j);
            a(((dp) (context)).a, view);
        }
        if (((dp) (context)).b == null) goto _L2; else goto _L1
_L1:
        view = a(cursor, l);
        if (view != null)
        {
...
_L3:
        if (((dp) (context)).a != null)
        {
            ((dp) (context)).a.setSingleLine(false);
            ((dp) (context)).a.setMaxLines(2);
        }
_L6:
        a(((dp) (context)).b, view);
_L2:
        if (((dp) (context)).c != null)
        {
            a(((dp) (context)).c, b(cursor), 4);
        }
        if (((dp) (context)).d != null)
        {
            a(((dp) (context)).d, c(cursor), 8);
        }
        if (h == 2 || h == 1 && (i1 & 1) != 0)
        {
            ((dp) (context)).e.setVisibility(0);
            ((dp) (context)).e.setTag(((dp) (context)).a.getText());
            ((dp) (context)).e.setOnClickListener(this);
            return;
        } else
        {
            ((dp) (context)).e.setVisibility(8);
            return;
        }
_L4:
        if (((dp) (context)).a != null)
        {
            ((dp) (context)).a.setSingleLine(true);
            ((dp) (context)).a.setMaxLines(1);
        }
...
_L3:
    ...
    public View getView(int i1, View view, ViewGroup viewgroup)
    {
        ...
        catch (View view)
        {
            ...
            if (viewgroup != null)
            {
                ((dp)viewgroup.getTag()).a.setText(view.toString());
            }
            return viewgroup;
        }
        return view;
    ...
    public View newView(Context context, Cursor cursor, ViewGroup viewgroup)
    {
        ...
        context.setTag(new dp(context));
        ((ImageView)context.findViewById(android.support.v7.appcompat.R.id.edit_query)).setImageResource(f);
        return context;
    }
    ...
    public void onClick(View view)
    {
        ...
        {
            b.onQueryRefine((CharSequence)view);
        }
    }
