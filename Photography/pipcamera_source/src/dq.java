    ...
    implements ar
{
    ...
    private dq(Toolbar toolbar)
    {
        c = toolbar;
        super();
    }

    public dq(Toolbar toolbar, android.support.v7.widget.Toolbar._cls1 _pcls1)
    {
        this(toolbar);
    }
...
_L8:
    ...
    public boolean a(MenuBuilder menubuilder, MenuItemImpl menuitemimpl)
    {
        ...
        c.requestLayout();
        menuitemimpl.e(true);
        if (c.mExpandedActionView instanceof cp)
        {
            ((cp)c.mExpandedActionView).onActionViewExpanded();
        }
        return true;
    }
    ...
    public boolean b(MenuBuilder menubuilder, MenuItemImpl menuitemimpl)
    {
        if (c.mExpandedActionView instanceof cp)
        {
            ((cp)c.mExpandedActionView).onActionViewCollapsed();
        }
