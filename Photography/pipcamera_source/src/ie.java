...
public class ie
{
    ...
    private int a(if if1, float af[], float af1[], float af2[])
    {
        int l1 = if1.b.length / 2;
        PointF pointf = a(if1.e);
        int i1 = 0;
        for (int j1 = 0; j1 < l1; j1++)
        {
            int k1 = j1 * 2;
            PointF pointf4 = new PointF(if1.b[k1], if1.b[k1 + 1]);
    ...
    private int b(if if1, float af[], float af1[], float af2[])
    {
        int l1 = if1.b.length / 2;
        float f3 = if1.e / 2;
        if (e)
        ...
        {
            int k1 = j1 * 2;
            PointF pointf = new PointF(if1.b[k1], if1.b[k1 + 1]);
    ...
    private int c(if if1, float af[], float af1[], float af2[])
    {
        int l1 = if1.b.length / 2;
        float f3 = if1.e / 2;
        if (e)
