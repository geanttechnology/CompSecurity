...
public class IdManager
{
    ...
    public IdManager(Context context, String s, String s1, Collection collection)
    {
        ...
        if (!h)
        {
            zw.h().a("Fabric", (new StringBuilder()).append("Device ID collection disabled for ").append(context.getPackageName()).toString());
        }
        i = CommonUtils.a(context, "com.crashlytics.CollectUserIdentifiers", true);
        if (!i)
        {
            zw.h().a("Fabric", (new StringBuilder()).append("User information collection disabled for ").append(context.getPackageName()).toString());
        }
    }
    ...
    private void a(JSONObject jsonobject)
    {
        ...
        {
            zw.h().e("Fabric", "Could not write application id to JSON", jsonobject);
        }
    }
    ...
    private void b(JSONObject jsonobject)
    {
        for (Iterator iterator = g().entrySet().iterator(); iterator.hasNext();)
        {
            ...
            {
                zw.h().e("Fabric", (new StringBuilder()).append("Could not write value to JSON: ").append(((DeviceIdentifierType)entry.getKey()).name()).toString(), exception);
            }
        }
    ...
    private void c(JSONObject jsonobject)
    {
        ...
        {
            zw.h().e("Fabric", "Could not write OS version to JSON", jsonobject);
        }
    }
    ...
    private void d(JSONObject jsonobject)
    {
        ...
        {
            zw.h().e("Fabric", "Could not write model to JSON", jsonobject);
        }
    }
    ...
    public String a(String s, String s1)
    {
        ...
        {
            zw.h().e("Fabric", "Could not create cipher to encrypt headers.", s);
            return "";
        }
        ...
        if (jsonobject.length() > 0)
        {
            ...
            {
                zw.h().e("Fabric", "Could not encrypt IDs", s);
                return "";
            }
        }
        return s;
    ...
    public Map g()
    {
        ...
        do
        {
            ...
            Object obj = (aad)iterator.next();
            if (obj instanceof aba)
            {
                obj = ((aba)obj).getDeviceIdentifiers().entrySet().iterator();
    ...
    public Boolean j()
    {
        ...
        if (h)
        {
            ...
            if (aan1 != null)
            {
                boolean1 = Boolean.valueOf(aan1.b);
            }
        }
        return boolean1;
    }
    ...
    public String o()
    {
        ...
        if (bluetoothadapter != null)
        {
            ...
            {
                zw.h().e("Fabric", "Utils#getBluetoothMacAddress failed, returning null. Requires prior call to BluetoothAdatpter.getDefaultAdapter() on thread that has called Looper.prepare()", exception);
            }
        }
        return null;
    }
    ...
    public String p()
    {
        ...
        Exception exception;
        exception;
        zw.h().e("Fabric", "Could not retrieve android.os.Build.SERIAL value", exception);
        return null;
    }
