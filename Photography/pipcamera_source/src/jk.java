...
public class jk
{
    ...
    public static transient String a(jl jl1, GeocodingTypes ageocodingtypes[])
    {
        ArrayList arraylist = new ArrayList();
        Collections.addAll(arraylist, ageocodingtypes);
        for (int i = 0; i < jl1.b().size(); i++)
        {
            if (((jt)jl1.b().get(i)).b().containsAll(arraylist))
            {
                return ((jt)jl1.b().get(i)).a();
            }
        }
    ...
    public static String a(jn jn1)
    {
        ...
        if (jn1.b() == GeocodingType.BY_ADDRESS)
        {
        ...
        if (s1.length() == 4)
        {
            jn1 = (new StringBuilder()).append(s1.substring(0, 1)).append("-").append(s1.substring(2, 3)).toString();
        }
        return (new StringBuilder()).append(s).append("&").append("language").append("=").append(jn1).toString();
    }
