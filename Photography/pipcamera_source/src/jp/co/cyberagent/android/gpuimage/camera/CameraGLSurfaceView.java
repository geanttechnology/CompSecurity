    ...
    implements android.graphics.SurfaceTexture.OnFrameAvailableListener
{
    ...
    private void releaseCamera()
    {
        ...
        {
            ((aeu)mCallbackWeakRef.get()).a("release camera failed", ((Exception) (obj1)));
        }
        mCamera = null;
        return;
        obj1;
...
_L8:
    ...
    public aeu getCameraCallback()
    {
        if (mCallbackWeakRef != null)
        {
            return (aeu)mCallbackWeakRef.get();
        } else
        {
            return null;
        }
    ...
    protected android.hardware.Camera.ShutterCallback getShuttercallack()
    {
        if (mSoundOn)
        {
            return new android.hardware.Camera.ShutterCallback() {
...
_L6:
        if (mCamera == null)
        {
            if (mCallbackWeakRef != null && mCallbackWeakRef.get() != null)
            {
                ((aeu)mCallbackWeakRef.get()).a("camera open failed", null);
                return;
            }
            continue; /* Loop/switch isn't completed */
        }
        ...
        catch (Exception exception)
        {
            if (mCallbackWeakRef != null && mCallbackWeakRef.get() != null)
            {
                ((aeu)mCallbackWeakRef.get()).a("camera open failed", exception);
                return;
            }
        }
        continue; /* Loop/switch isn't completed */
...
_L5:
        ...
        catch (Object obj1)
        {
            if (mCallbackWeakRef != null && mCallbackWeakRef.get() != null)
            {
                ((aeu)mCallbackWeakRef.get()).a((new StringBuilder()).append("camera getinfo ").append(String.valueOf(i)).toString(), ((Exception) (obj1)));
                return;
            }
            continue; /* Loop/switch isn't completed */
        }
...
_L7:
        ...
        if (mCallbackWeakRef != null && mCallbackWeakRef.get() != null)
        {
            ((aeu)mCallbackWeakRef.get()).a((new StringBuilder()).append("camera open failed ").append(String.valueOf(i)).toString(), ((Exception) (obj1)));
            return;
        }
        continue; /* Loop/switch isn't completed */
        exception3;
        ...
        if (mCallbackWeakRef != null && mCallbackWeakRef.get() != null)
        {
            ((aeu)mCallbackWeakRef.get()).a("camera setparams failed", exception1);
            return;
        }
...
_L9:
    ...
    public void setCameraCallBack(aeu aeu1)
    {
        mCallbackWeakRef = new WeakReference(aeu1);
        if (mRender == null)
        {
            return;
        } else
        {
            queueEvent(new Runnable(aeu1) {
...
_L6:
    ...
    protected void setCameraParam(int i, int j)
    {
        ...
        android.hardware.Camera.Size size = aex.a(parameters.getSupportedPreviewSizes(), i, j);
        ...
        float f = aeh.a(mContext);
        if (f < 0.7F)
        {
            takePicSize = aex.a(parameters.getSupportedPictureSizes(), i, j);
        } else
        if (f > 0.7F && f < 1.7F)
        {
            takePicSize = aex.a(parameters.getSupportedPictureSizes(), i * 2, j * 2);
        } else
        if (f > 1.7F)
        {
            takePicSize = aex.a(parameters.getSupportedPictureSizes(), i * 3, j * 3);
        }
        if (mCameraCaptureState == EnumCameraCaptureState.STATE_CONTINUOUS_PHOTO)
        {
            ...
            {
                takePicSize = aex.a(parameters.getSupportedPictureSizes(), (int)((double)i * 1.5D), (int)((double)j * 1.5D));
            }
        }
        if (takePicSize != null)
        {
...
_L1:
        ...
        if (mCallbackWeakRef != null && mCallbackWeakRef.get() != null)
        {
            ((aeu)mCallbackWeakRef.get()).a("camera setparams failed", exception);
            return;
        }
          goto _L1
    }
    ...
    public void takePhoto()
    {
        ...
        if (mCallbackWeakRef != null && mCallbackWeakRef.get() != null)
        {
            ((aeu)mCallbackWeakRef.get()).b(isFrontFacing);
        }
        mIsTakingPhoto = true;
        try
        {
            android.hardware.Camera.ShutterCallback shuttercallback = getShuttercallack();
            mCamera.takePicture(shuttercallback, null, null, new android.hardware.Camera.PictureCallback() {
