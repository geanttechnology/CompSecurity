    ...
    implements android.view.View.OnClickListener
{
    ...
    public lf(CollageHandleView collagehandleview)
    {
        a = collagehandleview;
        super();
    }
    ...
    {
        CollageHandleView.access$000(a).setTextColor(0xff007aff);
        CollageHandleView.access$100(a).setTextColor(-1);
        CollageHandleView.access$200(a).setTextColor(-1);
        CollageHandleView.access$300(a).setVisibility(4);
        CollageHandleView.access$400(a).setVisibility(4);
        CollageHandleView.access$500(a).setVisibility(0);
    }
}
