...
public class mq extends FrameLayout
{
    ...
    public mq(TabPageIndicator tabpageindicator, Context context)
    {
        a = tabpageindicator;
        super(context, null, 0x7f0100ce);
        ((LayoutInflater)getContext().getSystemService("layout_inflater")).inflate(0x7f030090, this, true);
        c = (TextView)findViewById(0x7f0c0251);
    }

    public static int a(mq mq1, int i)
    {
        mq1.b = i;
        return i;
    }
    ...
    public void setSelected(boolean flag)
    {
        ...
        if (d == null)
        {
            ...
            obj = new android.widget.FrameLayout.LayoutParams((int)Layout.getDesiredWidth(c.getText(), ((android.text.TextPaint) (obj))) + ew.a(getContext(), 20F), ew.a(getContext(), 2.0F), 81);
