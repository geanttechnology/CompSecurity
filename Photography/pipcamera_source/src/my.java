...
public class my
{
    ...
    my(MediaStoreScannerService mediastorescannerservice)
    {
    ...
    protected void a(mx mx1)
    {
        ...
        String s = (String)a.get(mx1.a);
        if (s != null)
        {
            mu1.b(Uri.withAppendedPath(android.provider.MediaStore.Images.Thumbnails.EXTERNAL_CONTENT_URI, (new StringBuilder()).append("").append(s).toString()));
        }
        mx1 = (String)b.get(mx1.a);
        if (mx1 != null)
        {
            mu1.c(Uri.withAppendedPath(android.provider.MediaStore.Images.Thumbnails.EXTERNAL_CONTENT_URI, (new StringBuilder()).append("").append(mx1).toString()));
        }
        MediaStorePhotosDB.a().a(mu1);
    }
...
_L7:
        ...
        mx mx1 = new mx(d);
        obj1 = obj;
        mx1.a = ((Cursor) (obj)).getString(l);
        obj1 = obj;
        mx1.c = ((Cursor) (obj)).getString(j);
        obj1 = obj;
        mx1.b = ((Cursor) (obj)).getString(i);
        obj1 = obj;
...
_L15:
        obj1 = obj;
        mx1.i = Integer.parseInt(((Cursor) (obj)).getString(l1));
_L17:
        obj1 = obj;
        mx1.f = ContentUris.withAppendedId(android.provider.MediaStore.Images.Media.EXTERNAL_CONTENT_URI, Long.parseLong(mx1.a));
        obj1 = obj;
        a(mx1);
          goto _L5
_L3:
