...
public class rm extends rl
{
    ...
    public rm(rj rj1)
    {
        ...
        obj = rc.a(((String) (obj)), j1);
        c.setTypeface(((android.graphics.Typeface) (obj)));
        l = a(rj1.u) * TPhotoComposeInfo.scale * rl.f();
        c.setTextSize(l);
        if (rj1.B)
        {
    ...
    {
        return ((float)PIPCameraApplication.a.getResources().getDisplayMetrics().densityDpi / 160F) * f;
    }

    private String a(rj rj1)
    {
        return a(rj1, new Date());
    }

    public static String a(rj rj1, Date date)
    {
        String s = rj1.x;
        if (rj1.q == 2)
        {
