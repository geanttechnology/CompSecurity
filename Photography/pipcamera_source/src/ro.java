...
public class ro extends rn
{
    ...
    protected void b(Canvas canvas)
    {
        ...
        {
            m = new StaticLayout(e, d, (int)((float)pb.a(context, 32F) * TPhotoComposeInfo.scale), android.text.Layout.Alignment.ALIGN_NORMAL, 1.0F, 0.0F, false);
        ...
        {
            n = new StaticLayout(l, k, (int)((float)pb.a(context, 32F) * TPhotoComposeInfo.scale), android.text.Layout.Alignment.ALIGN_NORMAL, 1.0F, 0.0F, false);
    ...
    void g()
    {
        ...
        typeface = rc.a("PTSans-Narrow", 0);
        k.setTypeface(typeface);
        k.setColor(-1);
        k.setTextSize((float)pb.a(context, 14F) * TPhotoComposeInfo.scale * rl.f());
