    ...
    implements android.opengl.GLSurfaceView.Renderer
{
    ...
    public vb(Context context)
    {
        ...
        c = context;
        a = new we(context);
        f = context.getResources().getString(0x7f060181);
    }
    ...
    public void b(Bitmap bitmap, String s, float f1, Handler handler, boolean flag)
    {
        ...
        } else
        {
            ...
            b.a(handler);
            bitmap = ev.b(bitmap);
            Log.d("debug", (new StringBuilder()).append("Bitmap size").append(bitmap.getWidth()).append(":").append(bitmap.getHeight()).toString());
            int i1 = vu.a(bitmap);
            bitmap.recycle();
            b.b(i1);
