    ...
    implements android.opengl.GLSurfaceView.Renderer
{
    ...
    public void a(Bitmap bitmap)
    {
        ...
        int i1 = Math.max(bitmap.getWidth(), bitmap.getHeight());
        b = vu.a(bitmap, i1, false);
        if (a != null)
        {
            a.a(i1, bitmap.getWidth(), bitmap.getHeight());
        }
    }
    ...
    public void a(TDFSceneInfo tdfsceneinfo)
    {
        ...
        vz1.f.e = rectf1.width();
        vz1.f.f = rectf1.height();
        a(rectf2, rectf1, vz1.f.a, false);
        a(rectf1, rectf, vz1.f.c, true);
        vz1.e = a(d);
        i = (float)((double)vz1.f.a[0] + 1.0D);
        j = (float)((double)(-vz1.f.a[0]) - 1.0D);
        k = (float)((double)(-vz1.f.a[1]) + 1.0D);
        l = (float)((double)vz1.f.a[1] - 1.0D);
        if (tdfsceneinfo.getResType() != EResType.NETWORK) goto _L2; else goto _L1
_L1:
        vz1.i = EResType.NETWORK;
        if (tdfsceneinfo.alphaTexturePath != null)
        {
            vz1.g = tdfsceneinfo.alphaTexturePath;
        }
_L4:
        vz1.h = tdfsceneinfo.getMode().ordinal();
