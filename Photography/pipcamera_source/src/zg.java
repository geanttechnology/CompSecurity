...
public class zg extends zf
{
    ...
    public String a(zj zj, String s, String s1, String s2, String s3)
    {
        return a(zj, s, s1, s2, "", "", s3);
    }

    public String a(zj zj, String s, String s1, String s2, String s3, String s4, String s5)
    {
        ...
        return a("http://open.t.qq.com/api/t/add_pic", ((List) (arraylist)), ((List) (s)), zj);
    }

    public String a(zj zj, String s, String s1, String s2, String s3, String s4, byte abyte0[])
    {
        ArrayList arraylist = new ArrayList();
        arraylist.add(new QParameter("format", s));
        arraylist.add(new QParameter("content", s1));
        ...
        return b("http://open.t.qq.com/api/t/add_pic", arraylist, s, zj);
    }
}
