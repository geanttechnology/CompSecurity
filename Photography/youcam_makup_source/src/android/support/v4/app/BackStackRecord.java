...
_L10:
    ...
    private boolean configureTransitions(int i, TransitionState transitionstate, boolean flag, SparseArray sparsearray, SparseArray sparsearray1)
    {
        ...
        Object obj = (Fragment)sparsearray1.get(i);
        Object obj2 = (Fragment)sparsearray.get(i);
        Object obj1 = getEnterTransition(((Fragment) (obj)), flag);
        sparsearray1 = ((SparseArray) (getSharedElementTransition(((Fragment) (obj)), ((Fragment) (obj2)), flag)));
        Object obj3 = getExitTransition(((Fragment) (obj2)), flag);
        sparsearray = null;
        ArrayList arraylist1 = new ArrayList();
        if (sparsearray1 != null)
        {
            ArrayMap arraymap = remapSharedElements(transitionstate, ((Fragment) (obj2)), flag);
            if (arraymap.isEmpty())
            {
                sparsearray = null;
                sparsearray1 = null;
            } else
            {
                ...
                prepareSharedElementTransition(transitionstate, viewgroup, sparsearray1, ((Fragment) (obj)), ((Fragment) (obj2)), flag, arraylist1);
        ...
        obj2 = captureExitingViews(obj3, ((Fragment) (obj2)), arraylist, sparsearray, transitionstate.nonExistentView);
        ...
        if (obj != null)
        {
            if (flag)
            {
                flag1 = ((Fragment) (obj)).getAllowReturnTransitionOverlap();
            } else
            {
                flag1 = ((Fragment) (obj)).getAllowEnterTransitionOverlap();
            }
        }
        obj = FragmentTransitionCompat21.mergeTransitions(obj1, obj2, sparsearray1, flag1);
        if (obj != null)
        {
            FragmentTransitionCompat21.addTransitionTargets(obj1, sparsearray1, viewgroup, ((FragmentTransitionCompat21.ViewRetriever) (obj3)), transitionstate.nonExistentView, transitionstate.enteringEpicenterView, transitionstate.nameOverrides, arraylist2, sparsearray, arraymap1, arraylist1);
            excludeHiddenFragmentsAfterEnter(viewgroup, transitionstate, i, obj);
            FragmentTransitionCompat21.excludeTarget(obj, transitionstate.nonExistentView, true);
            excludeHiddenFragments(transitionstate, i, obj);
            FragmentTransitionCompat21.beginDelayedTransition(viewgroup, obj);
            FragmentTransitionCompat21.cleanupTransitions(viewgroup, transitionstate.nonExistentView, obj1, arraylist2, obj2, arraylist, sparsearray1, arraylist1, obj, transitionstate.hiddenFragmentViews, arraymap1);
        }
        return obj != null;
    }
