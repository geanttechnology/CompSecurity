...
_L1:
        ...
        obj = CommonUtils.padWithZerosToMaxIntWidth(eventCounter.getAndIncrement());
        ...
        date = null;
_L6:
        Fabric.getLogger().e("CrashlyticsCore", "An error occurred in the non-fatal exception logger", thread);
        ExceptionUtils.writeStackTraceIfNotNull(thread, date);
        CommonUtils.flushOrLog(codedoutputstream1, "Failed to flush to non-fatal file.");
        CommonUtils.closeOrLog(date, "Failed to close non-fatal file output stream.");
          goto _L3
        thread;
        date = null;
_L5:
...
_L2:
        ...
        CommonUtils.closeOrLog(date, "Failed to close begin session file.");
        throw s;
        s;
        date = null;
        continue; /* Loop/switch isn't completed */
...
_L3:
        ...
        obj = null;
_L8:
        Fabric.getLogger().e("CrashlyticsCore", "An error occurred in the native crash logger", sessioneventdata);
...
_L8:
        codedoutputstream = codedoutputstream1;
        clsfileoutputstream = ((ClsFileOutputStream) (obj));
        Fabric.getLogger().e("CrashlyticsCore", "An error occurred in the fatal exception logger", date);
        codedoutputstream = codedoutputstream1;
        clsfileoutputstream = ((ClsFileOutputStream) (obj));
        ExceptionUtils.writeStackTraceIfNotNull(date, ((java.io.OutputStream) (obj)));
        CommonUtils.flushOrLog(codedoutputstream1, "Failed to flush to session begin file.");
        CommonUtils.closeOrLog(((java.io.Closeable) (obj)), "Failed to close fatal exception file output stream.");
        return;
        date;
        clsfileoutputstream = null;
...
_L7:
    ...
    private void writeSessionApp(String s)
    {
        ...
        s = ((String) (obj3));
        obj = obj3;
        String s4 = idManager.getAppInstallIdentifier();
        s = ((String) (obj3));
        obj = obj3;
...
_L3:
    ...
    private void writeSessionDevice(String s)
    {
        ...
        CommonUtils.flushOrLog(((java.io.Flushable) (obj3)), "Failed to flush session device info.");
...
_L4:
        ...
        CommonUtils.closeOrLog(((java.io.Closeable) (obj)), "Failed to close CLS file");
_L5:
...
_L7:
        Fabric.getLogger().e("CrashlyticsCore", (new StringBuilder()).append("Failed to write session file for session ID: ").append(s).toString(), ((Throwable) (obj1)));
