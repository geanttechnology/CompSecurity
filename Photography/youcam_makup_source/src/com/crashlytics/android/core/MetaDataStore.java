...
class MetaDataStore
{
    ...
    public Map readKeyData(String s)
    {
        ...
        s = fileinputstream;
        Map map = jsonToKeysData(CommonUtils.streamToString(fileinputstream));
...
_L4:
        s = fileinputstream;
        Fabric.getLogger().e("CrashlyticsCore", "Error deserializing user metadata.", exception1);
        CommonUtils.closeOrLog(fileinputstream, "Failed to close user metadata file.");
        return Collections.emptyMap();
        Exception exception;
        exception;
...
_L3:
    ...
    public UserMetaData readUserData(String s)
    {
        ...
        FileInputStream fileinputstream = new FileInputStream(s);
        s = fileinputstream;
        UserMetaData usermetadata = jsonToUserData(CommonUtils.streamToString(fileinputstream));
        CommonUtils.closeOrLog(fileinputstream, "Failed to close user metadata file.");
        return usermetadata;
        Exception exception1;
        exception1;
