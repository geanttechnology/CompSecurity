...
class ReportUploader
{
    ...
    boolean forceUpload(Report report)
    {
        ...
        logger.i("CrashlyticsCore", stringbuilder.append(s).append(report.getFileName()).toString());
        flag = flag1;
        if (!flag2)
        {
            break MISSING_BLOCK_LABEL_122;
...
_L2:
        ...
        Exception exception;
        exception;
        Fabric.getLogger().e("CrashlyticsCore", (new StringBuilder()).append("Error occurred sending report ").append(report).toString(), exception);
        flag = flag1;
