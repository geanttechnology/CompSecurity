...
label0:
    ...
    {
        return 0 + CodedOutputStream.computeBytesSize(1, ByteString.copyFromUtf8((new ApiKey()).getValue(context)));
    }
...
label0:
    ...
    public void writeSessionApp(CodedOutputStream codedoutputstream, String s, String s1, String s2, String s3, int i)
    {
        ...
        codedoutputstream.writeString(1, (new ApiKey()).getValue(context));
