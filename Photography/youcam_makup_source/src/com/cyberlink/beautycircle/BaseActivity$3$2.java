    ...
    implements android.content.nCancelListener
{
    ...
    {
        a.a.onClick(BaseActivity.a(a.a), 0);
    }
        ...
        implements Runnable
    {
        ...
        public void run()
        {
            ...
            if (BaseActivity.a(e) == null)
            {
                ...
                BaseActivity.a(e).setOnDismissListener(new BaseActivity._cls3._cls1());
                if (c != null)
                {
                    BaseActivity.a(e).setCancelable(true);
                    ((UploadProgressDialog)BaseActivity.a(e)).a(c);
                    BaseActivity.a(e).setOnCancelListener(new BaseActivity._cls3._cls2(this));
                } else
                {
        ...
        // Unreferenced inner class com/cyberlink/beautycircle/BaseActivity$3$1

/* anonymous class */
        class BaseActivity._cls3._cls1
