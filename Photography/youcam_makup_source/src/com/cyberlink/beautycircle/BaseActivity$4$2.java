    ...
    implements android.content.nCancelListener
{
    ...
    {
        a.a.onClick(BaseActivity.a(a.a), -2);
    }
        ...
        public void run()
        {
            ...
            if (BaseActivity.a(e) == null)
            {
                ...
                if (c != null)
                {
                    ...
                    BaseActivity.a(e).setOnCancelListener(new BaseActivity._cls4._cls2(this));
                } else
                {
            ...
            if (a != null)
            {
                ...
                objectanimator.addListener(new BaseActivity._cls4._cls3());
...
/* anonymous class */
        ...
        // Unreferenced inner class com/cyberlink/beautycircle/BaseActivity$4$3

/* anonymous class */
        class BaseActivity._cls4._cls3
