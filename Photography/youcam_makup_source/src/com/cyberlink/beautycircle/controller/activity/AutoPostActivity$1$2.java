...
/* anonymous class */
        ...
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            {
                DialogUtils.a(a, null, a.getResources().getString(m.bc_write_post_message_must_sign_in), null, null, a.getResources().getString(m.bc_dialog_button_ok), new AutoPostActivity._cls1._cls1());
                return;
            }
            if (AutoPostActivity.b(a).getSelectedCircles().isEmpty())
            {
                DialogUtils.a(a, null, a.getResources().getString(m.bc_write_post_message_need_circle), null, null, a.getResources().getString(m.bc_dialog_button_ok), new AutoPostActivity._cls1._cls2(this));
                return;
            } else
            {
        ...
        // Unreferenced inner class com/cyberlink/beautycircle/controller/activity/AutoPostActivity$1$1

/* anonymous class */
        class AutoPostActivity._cls1._cls1
            implements Runnable
        {
