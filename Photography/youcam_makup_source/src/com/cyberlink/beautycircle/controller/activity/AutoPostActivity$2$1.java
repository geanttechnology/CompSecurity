...
/* anonymous class */
        ...
        implements g
    {
        ...
        public void a(int i)
        {
            if (i == 32769)
            {
                DialogUtils.a(a, null, a.getResources().getString(m.bc_write_post_message_must_sign_in), null, null, a.getResources().getString(m.bc_dialog_button_ok), new AutoPostActivity._cls2._cls1(this));
                return;
            } else
            {
                String s1 = (new StringBuilder()).append(a.getResources().getString(m.bc_register_error_network_unavailabe)).append(s.a(i)).toString();
                DialogUtils.a(a, null, s1, null, null, a.getResources().getString(m.bc_dialog_button_ok), new AutoPostActivity._cls2._cls2());
                return;
            }
        }
        ...
        // Unreferenced inner class com/cyberlink/beautycircle/controller/activity/AutoPostActivity$2$2

/* anonymous class */
        class AutoPostActivity._cls2._cls2
            implements Runnable
        {
