    ...
    implements Runnable
{
    ...
    public void run()
    {
        if (a == null || !b)
        {
            BeautyProfileActivity.g(c.c).scrollTo(0, 0);
            return;
        } else
        {
            BeautyProfileActivity.g(c.c).scrollTo(0, a.getTop());
            return;
        }
    }

    b(b b1, View view, boolean flag)
    {
        c = b1;
        a = view;
        b = flag;
...
/* anonymous class */
    class BeautyProfileActivity._cls4 extends AsyncTask
    {
        ...
        protected void a(b b1)
        {
            ...
            if (!flag)
            {
                (new Handler()).post(new BeautyProfileActivity._cls4._cls1(this, b1, flag4));
            }
            if (!flag4)
            {
                if (!flag1)
            ...
            {
                DialogUtils.a(a, null, a.getResources().getString(m.bc_beauty_warning_message), a.getResources().getString(m.bc_dialog_button_skip), new BeautyProfileActivity._cls4._cls2(userinfo, flag3), a.getResources().getString(m.bc_dialog_button_continue), null);
                return;
            }
        }
        ...
        // Unreferenced inner class com/cyberlink/beautycircle/controller/activity/BeautyProfileActivity$4$2

/* anonymous class */
        class BeautyProfileActivity._cls4._cls2
            implements Runnable
        {
