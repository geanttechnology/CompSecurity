    ...
    class EditAboutActivity._cls1 extends AsyncTask
    {
        ...
        protected transient Void a(Void avoid[])
        {
            ...
            if (((UserInfo) (avoid)).displayName != null && ((UserInfo) (avoid)).displayName.equals(a) && (((UserInfo) (avoid)).description != null && ((UserInfo) (avoid)).description.equals(b) || ((UserInfo) (avoid)).description == null && b.isEmpty()) && ((UserInfo) (avoid)).websiteUrl != null && ((UserInfo) (avoid)).websiteUrl.equals(c))
            {
                ...
                {
                    d.runOnUiThread(new EditAboutActivity._cls1._cls1(this));
                    return null;
                }
            } else
            {
                d.k();
                NetworkUser.a(AccountManager.b(), a, null, null, b, null, null, null, null, null, null, null, null, c).a(new EditAboutActivity._cls1._cls2());
                return null;
            }
        }
        ...
        // Unreferenced inner class com/cyberlink/beautycircle/controller/activity/EditAboutActivity$1$2

/* anonymous class */
        class EditAboutActivity._cls1._cls2 extends m
        {
