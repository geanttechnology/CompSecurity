...
class b extends m
{
    ...
    protected void a(com.cyberlink.beautycircle.model.ctivity._cls6._cls2._cls1 _pcls1)
    {
        AccountManager.a(a, b, false).a(new m() {
            ...
            {
                a = FreeSampleFillDataActivity._cls6._cls2._cls1.this;
                super();
            }
        });
    }
    ...
    protected void b(Object obj)
    {
        a((com.cyberlink.beautycircle.model.ctivity._cls6._cls2._cls1.a)obj);
    }

    a(a a1, String s, UserInfo userinfo)
    {
        c = a1;
        a = s;
        b = userinfo;
...
/* anonymous class */
        class FreeSampleFillDataActivity._cls6._cls3 extends m
        {
            ...
            {
                super.a(i);
                Globals.b((new StringBuilder()).append("Join fail:").append(a.a.f.id).append(", code:").append(i).toString());
            }
