...
class b extends AsyncTask
{
    ...
    final com.cyberlink.beautycircle.model.network.y._cls6._cls2.a a;
    final com.cyberlink.beautycircle.model.aram b;
    final a c;
...
label0:
        {
            ...
            s1 = s6;
            s2 = avoid;
            if (AccountManager.f() == com.cyberlink.beautycircle.utility.am.phone)
            {
                break label0;
            }
            avoid = a.il;
...
_L1:
        if (!c.c.f.e.equals("Home".toString())) goto _L4; else goto _L3
_L3:
        s4 = b.b;
...
label1:
        {
            if (FreeSampleFillDataActivity.b(c.c) != null)
            {
                s3 = i.d(FreeSampleFillDataActivity.b(c.c).getTime());
            }
            flag = flag2;
            if (s3 == null)
            {
        ...
        if (flag)
        {
            ...
            s4 = AccountManager.b();
            NetworkUser.a(s4, null, null, null, null, null, null, s3, null, s, s1, s2, avoid, null).a(new m(s4, userinfo) {
                ...
                {
                    AccountManager.a(a, b, false).a(new m(this) {
            ...
            {
                c = FreeSampleFillDataActivity._cls6._cls2.this;
                a = s;
                b = userinfo;
                super();
            }
...
_L4:
        flag2 = flag;
        avoid = s4;
        if (!"CONSULTATION".equals(c.c.f.e))
        {
...
_L7:
    ...
    a(a a1, com.cyberlink.beautycircle.model.network.y._cls6 _pcls6, com.cyberlink.beautycircle.model.aram aram)
    {
        c = a1;
        a = _pcls6;
        b = aram;
...
_L2:
            ...
            {
                ((ScrollView)a.findViewById(com.cyberlink.beautycircle.j.free_sample_scroll_panel)).pageScroll(130);
...
_L7:
            ...
            (new FreeSampleFillDataActivity._cls6._cls2(this, joineventparam, addressinfo)).executeOnExecutor(j.q, new Void[0]);
            NetworkEvent.a(view, joineventparam).a(new FreeSampleFillDataActivity._cls6._cls3());
            return;
_L5:
...
/* anonymous class */
        ...
        // Unreferenced inner class com/cyberlink/beautycircle/controller/activity/FreeSampleFillDataActivity$6$3

/* anonymous class */
        class FreeSampleFillDataActivity._cls6._cls3 extends m
        {
            ...
            {
                super.a(k);
                Globals.b((new StringBuilder()).append("Join fail:").append(a.a.f.id).append(", code:").append(k).toString());
            }
            ...
            protected void a(Void void1)
            {
                ...
                {
                    DialogUtils.a(a.a, null, void1, null, null, a.a.getString(com.cyberlink.beautycircle.m.bc_consultation_view_reservation), null, true, new FreeSampleFillDataActivity._cls6._cls3._cls1(this));
                    return;
                } else
                {
                    DialogUtils.a(a.a, null, a.a.getString(com.cyberlink.beautycircle.m.bc_freesample_join_success_message), null, null, a.a.getString(com.cyberlink.beautycircle.m.bc_dialog_button_ok), new FreeSampleFillDataActivity._cls6._cls3._cls2(this), false, null);
                    return;
                }
            }
        ...
        // Unreferenced inner class com/cyberlink/beautycircle/controller/activity/FreeSampleFillDataActivity$6$3$1

/* anonymous class */
        class FreeSampleFillDataActivity._cls6._cls3._cls1
        ...
        // Unreferenced inner class com/cyberlink/beautycircle/controller/activity/FreeSampleFillDataActivity$6$3$2

/* anonymous class */
        class FreeSampleFillDataActivity._cls6._cls3._cls2
            implements Runnable
        {
