    ...
    implements Runnable
{
    ...
    public void run()
    {
        ProductSocialActivity.a(a.a.a, a.a.a, a.a);
    }
...
/* anonymous class */
        ...
        implements android.view.MenuItem.OnMenuItemClickListener
    {
        ...
        public boolean onMenuItemClick(MenuItem menuitem)
        {
            DialogUtils.a(b.b, "", b.b.getResources().getString(m.bc_product_review_delete_confirm_text), b.b.getResources().getString(m.bc_review_cancel), new ProductSocialActivity._cls13._cls1._cls1(), b.b.getResources().getString(m.bc_review_delete), new ProductSocialActivity._cls13._cls1._cls2(this));
            return true;
        }
