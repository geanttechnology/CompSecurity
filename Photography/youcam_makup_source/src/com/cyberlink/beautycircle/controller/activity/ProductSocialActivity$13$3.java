    ...
    implements android.view.tener
{
    ...
    {
        ((ClipboardManager)a.a.getSystemService("clipboard")).setPrimaryClip(ClipData.newPlainText(null, a.a.comment));
        return true;
    }
...
_L1:
            menu.add(m.bc_post_comment_menu_delete).setOnMenuItemClickListener(new ProductSocialActivity._cls13._cls1(view));
_L4:
            if (e.a)
            {
                menu.add(m.bc_post_comment_menu_copy).setOnMenuItemClickListener(new ProductSocialActivity._cls13._cls3(this));
            }
...
/* anonymous class */
            ...
            implements android.view.MenuItem.OnMenuItemClickListener
        {
            ...
            public boolean onMenuItemClick(MenuItem menuitem)
            {
                DialogUtils.a(b.b, "", b.b.getResources().getString(m.bc_product_review_delete_confirm_text), b.b.getResources().getString(m.bc_review_cancel), new ProductSocialActivity._cls13._cls1._cls1(this), b.b.getResources().getString(m.bc_review_delete), new ProductSocialActivity._cls13._cls1._cls2(this));
                return true;
            }
        ...
        // Unreferenced inner class com/cyberlink/beautycircle/controller/activity/ProductSocialActivity$13$1$1

/* anonymous class */
        class ProductSocialActivity._cls13._cls1._cls1
            implements Runnable
        {
