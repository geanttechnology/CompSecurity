...
/* anonymous class */
        ...
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            {
                a.k();
                NetworkUser.c(AccountManager.b(), view, s1).a(new RegisterChangePasswordActivity._cls1._cls1(this));
                return;
            }
        }
    ...
    // Unreferenced inner class com/cyberlink/beautycircle/controller/activity/RegisterChangePasswordActivity$1$1

/* anonymous class */
    class RegisterChangePasswordActivity._cls1._cls1 extends com.perfectcorp.utility.m
    {

        final RegisterChangePasswordActivity._cls1 a;
        ...
        {
            a.a.l();
            DialogUtils.a(a.a, a.a.getResources().getString(m.bc_dialog_title_notification), a.a.getResources().getString(m.bc_register_change_password_success), new RegisterChangePasswordActivity._cls1._cls1._cls1(this));
        }
