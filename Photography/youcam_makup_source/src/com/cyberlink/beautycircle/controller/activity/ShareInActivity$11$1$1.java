    ...
    implements Runnable
{
    ...
    public void run()
    {
        ...
        if (ShareInActivity.f(a.a.a) != null)
        {
            ...
            c.a(a.a.a, com.cyberlink.beautycircle.controller.activity.a);
        }
        a.a.a.setResult(-1);
        a.a.a.finish();
    }
...
/* anonymous class */
    class ShareInActivity._cls11 extends com.perfectcorp.utility.j
    {
    ...
    // Unreferenced inner class com/cyberlink/beautycircle/controller/activity/ShareInActivity$11$1

/* anonymous class */
    class ShareInActivity._cls11._cls1 extends com.perfectcorp.utility.m
    {
        ...
        protected void a(com.cyberlink.beautycircle.model.network.NetworkPost.CreatePostsResult createpostsresult)
        {
            if (!c())
            {
                ...
                a.a.a(m.bc_sharein_dialog_title, Float.valueOf(1.0F), ShareInActivity.s(a.a), new ShareInActivity._cls11._cls1._cls1(this));
                return;
            } else
            {
                e.b(new Object[] {
