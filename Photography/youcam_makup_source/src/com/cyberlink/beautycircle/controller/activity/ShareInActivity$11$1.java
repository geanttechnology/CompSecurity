...
class a extends m
{
    ...
    public void a(int i)
    {
        ...
        a.a.l();
        ShareInActivity.a(a.a, com.cyberlink.beautycircle.m.bc_write_post_message_create_post_fail, null);
    }

    protected void a(com.cyberlink.beautycircle.model.network.tsResult tsresult)
    {
        if (!c())
        {
            e.b(new Object[] {
            ...
            a.a.a(com.cyberlink.beautycircle.m.bc_sharein_dialog_title, Float.valueOf(1.0F), ShareInActivity.s(a.a), new Runnable() {

                final ShareInActivity._cls11._cls1 a;
                ...
                public void run()
                {
                    ...
                    {
                        Globals.a(a.a.a.getResources().getString(com.cyberlink.beautycircle.m.bc_sharein_success));
            ...
            {
                a = ShareInActivity._cls11._cls1.this;
                super();
            }
            });
            return;
    ...
    {
        a((com.cyberlink.beautycircle.model.network.tsResult)obj);
    }
    ...
    // Unreferenced inner class com/cyberlink/beautycircle/controller/activity/ShareInActivity$11

/* anonymous class */
    class ShareInActivity._cls11 extends j
    {
        ...
        protected Void a(Void void1)
        {
            ...
            } else
            {
                ...
                {
                    ShareInActivity.E(a).a(new ShareInActivity._cls11._cls1(this));
                    return null;
                }
            }
            return null;
        ...
        public void a(int i)
        {
            ...
            a.l();
            ShareInActivity.a(a, com.cyberlink.beautycircle.m.bc_write_post_message_create_post_fail, null);
        }
