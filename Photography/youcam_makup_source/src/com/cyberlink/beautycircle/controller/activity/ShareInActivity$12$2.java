    ...
    implements Runnable
{
    ...
    final TextView a;
    final TextView b;
    final InParam.description c;

    public void run()
    {
        a.setText(ShareInActivity.f(c.c).title);
        b.setText(ShareInActivity.f(c.c).description);
    }

    a(a a1, TextView textview, TextView textview1)
    {
        c = a1;
        a = textview;
        b = textview1;
...
/* anonymous class */
        ...
        implements b
    {
        ...
        public void a()
        {
            a.runOnUiThread(new ShareInActivity._cls12._cls3());
        }
        ...
        public void a(String s)
        {
            ...
            a.runOnUiThread(new ShareInActivity._cls12._cls2(this, s, textview));
        }
...
/* anonymous class */
        ...
        // Unreferenced inner class com/cyberlink/beautycircle/controller/activity/ShareInActivity$12$3$1

/* anonymous class */
        class ShareInActivity._cls12._cls3._cls1
            implements Runnable
        {

            final ShareInActivity._cls12._cls3 a;
