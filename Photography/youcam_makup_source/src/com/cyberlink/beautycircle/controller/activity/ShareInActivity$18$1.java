        ...
        implements g
    {
        ...
        public void a(int i)
        {
            ...
            default:
                ...
                DialogUtils.a(a, a.getResources().getString(m.bc_dialog_title_warning), s1, new ShareInActivity._cls18._cls2());
                return;
            ...
            DialogUtils.a(a, a.getResources().getString(m.bc_sharein_dialog_title), a.getResources().getString(m.bc_write_post_message_must_sign_in), new ShareInActivity._cls18._cls1(this));
        }
        ...
        // Unreferenced inner class com/cyberlink/beautycircle/controller/activity/ShareInActivity$18$2

/* anonymous class */
        class ShareInActivity._cls18._cls2
            implements Runnable
        {
