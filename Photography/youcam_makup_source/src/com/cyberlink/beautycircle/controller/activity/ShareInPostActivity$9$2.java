        ...
        implements g
    {
        ...
        public void a(int i)
        {
            ...
            default:
                ...
                DialogUtils.a(a, a.getResources().getString(m.bc_dialog_title_warning), s1, new ShareInPostActivity._cls9._cls2(this));
                return;
            ...
            DialogUtils.a(a, a.getResources().getString(m.bc_sharein_dialog_title), a.getResources().getString(m.bc_write_post_message_must_sign_in), new ShareInPostActivity._cls9._cls1());
        }
        ...
        // Unreferenced inner class com/cyberlink/beautycircle/controller/activity/ShareInPostActivity$9$1

/* anonymous class */
        class ShareInPostActivity._cls9._cls1
            implements Runnable
        {
