...
/* anonymous class */
        ...
        implements Runnable
    {
        ...
        {
            a.k();
            Globals.f().a(new UserProfileActivity._cls10._cls2()).a(new UserProfileActivity._cls10._cls1(this));
        }
        ...
        // Unreferenced inner class com/cyberlink/beautycircle/controller/activity/UserProfileActivity$10$2

/* anonymous class */
        class UserProfileActivity._cls10._cls2 extends j
        {
