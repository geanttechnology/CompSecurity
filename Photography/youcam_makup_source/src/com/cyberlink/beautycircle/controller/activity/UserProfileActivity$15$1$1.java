...
class a extends AsyncTask
{
    ...
    protected transient Void a(UserInfo auserinfo[])
    {
        if (auserinfo.length >= 1 && auserinfo[0] != null)
        {
            ...
            if (auserinfo != null)
            {
                ...
                try
                {
                    AccountManager.a(s, auserinfo, new c() {
            ...
            {
                a = UserProfileActivity._cls15._cls1._cls1.this;
                super();
            }
                    }, false).d();
                }
    ...
    {
        b.b.b.l();
        com.cyberlink.beautycircle.controller.activity.UserProfileActivity.c(b.b.b);
    }
