...
class b extends AsyncTask
{
    ...
    protected transient Void a(Void avoid[])
    {
        ...
        } else
        {
            ...
            String s1 = c.c.c.getResources().getString(m.bc_user_edit_confirm_locale_change);
            DialogUtils.a(c.c.c, "", String.format(Locale.getDefault(), s1, new Object[] {
                c.c.get(a)
            }), null, null, c.c.c.getResources().getString(m.bc_dialog_button_ok), new Runnable(avoid) {
            ...
            {
                b = UserProfileActivity._cls15._cls1._cls2.this;
                a = userinfo;
                super();
            }
            });
    ...
    a(a a1, int i, AsyncTask asynctask)
    {
        c = a1;
        a = i;
        b = asynctask;
