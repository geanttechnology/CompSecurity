...
/* anonymous class */
        ...
        implements g
    {
        ...
        public void a(int i)
        {
            if (i == 32769)
            {
                DialogUtils.a(a, a.getResources().getString(m.bc_sharein_dialog_title), a.getResources().getString(m.bc_write_post_message_must_sign_in), new WritePostActivity._cls12._cls1());
                return;
            } else
            {
                String s1 = (new StringBuilder()).append(a.getResources().getString(m.bc_register_error_network_unavailabe)).append(s.a(i)).toString();
                DialogUtils.a(a, a.getResources().getString(m.bc_dialog_title_warning), s1, new WritePostActivity._cls12._cls2(this));
                return;
            }
        }
        ...
        // Unreferenced inner class com/cyberlink/beautycircle/controller/activity/WritePostActivity$12$1

/* anonymous class */
        class WritePostActivity._cls12._cls1
            implements Runnable
        {
