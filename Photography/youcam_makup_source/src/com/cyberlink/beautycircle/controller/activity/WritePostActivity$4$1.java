    ...
    implements Runnable
{
    ...
    // Unreferenced inner class com/cyberlink/beautycircle/controller/activity/WritePostActivity$4

/* anonymous class */
    class WritePostActivity._cls4 extends com.perfectcorp.utility.m
    {
        ...
        protected void a(int i)
        {
            ...
            String s1 = (new StringBuilder()).append(a.getResources().getString(m.bc_write_post_message_create_post_fail)).append(s.a(i)).toString();
            DialogUtils.a(a, s1);
            a.l();
            WritePostActivity.a(a, false);
        }
        ...
        protected void a(com.cyberlink.beautycircle.model.network.NetworkPost.CreatePostsResult createpostsresult)
        {
            ...
            a.a(m.bc_write_post_dialog_title, Float.valueOf(1.0F), WritePostActivity.x(a), new WritePostActivity._cls4._cls1(this));
        }
