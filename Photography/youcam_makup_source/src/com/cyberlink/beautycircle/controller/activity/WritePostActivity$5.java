...
class a extends m
{
    ...
    protected void a(int i)
    {
        ...
        String s1 = (new StringBuilder()).append(a.getResources().getString(com.cyberlink.beautycircle.m.bc_write_post_message_edit_post_fail)).append(s.a(i)).toString();
        DialogUtils.a(a, s1);
        a.l();
        WritePostActivity.a(a, false);
    }
    ...
    protected void a(com.cyberlink.beautycircle.model.network.stsResult stsresult)
    {
        ...
        a.a(com.cyberlink.beautycircle.m.bc_write_post_dialog_title, Float.valueOf(1.0F), WritePostActivity.x(a), new Runnable() {
            ...
            final WritePostActivity._cls5 a;

            public void run()
            {
                a.a.l();
                WritePostActivity.a(a.a, false);
                Globals.a(a.a.getResources().getString(com.cyberlink.beautycircle.m.bc_write_post_edit_success));
                t.b.a();
            ...
            {
                a = WritePostActivity._cls5.this;
                super();
            }
        });
    }
