    ...
    implements android.view.m.OnMenuItemClickListener
{
    ...
    {
        ((ClipboardManager)a.a.b.getSystemService("clipboard")).setPrimaryClip(ClipData.newPlainText(null, a.a.comment));
        return true;
    }
...
/* anonymous class */
        ...
        implements android.view.View.OnLongClickListener
    {
        ...
        public boolean onLongClick(View view)
        {
            ...
            if (e.a)
            {
                menu.add(m.bc_post_comment_menu_copy).setOnMenuItemClickListener(new g._cls27._cls1(this));
            }
            ...
            {
                menu.add(m.bc_post_comment_menu_edit).setOnMenuItemClickListener(new g._cls27._cls3());
            }
            boolean flag = flag1;
            if (a.creator != null)
            {
...
/* anonymous class */
        ...
        // Unreferenced inner class com/cyberlink/beautycircle/controller/activity/g$27$3

/* anonymous class */
        class g._cls27._cls3
            implements android.view.MenuItem.OnMenuItemClickListener
        {
