...
class a extends m
{
    ...
    protected void a()
    {
        PostCommentActivity.d(a.a.a).setEnabled(true);
    }
...
_L3:
    ...
    {
        PostCommentActivity.c(a.a.a).setText("");
        PostCommentActivity.d(a.a.a).setEnabled(true);
        j.a(a.a, 2);
        ...
        j.a(a.a, j.f(a.a).creator.userId, comment);
        a.a.a.setResult(-1);
    }
...
/* anonymous class */
        ...
        implements b
    {
        ...
        public void a(String s)
        {
            ...
            {
                j.f(b).a(Long.valueOf(j.f(b).commentCount.longValue() + 1L), new j._cls13._cls1());
                NetworkPost.a(s, "Post", j.f(b).postId.longValue(), a, new Tags()).a(new j._cls13._cls2(this));
                return;
            }
        }
        ...
        // Unreferenced inner class com/cyberlink/beautycircle/controller/activity/j$13$1

/* anonymous class */
        class j._cls13._cls1
            implements r
        {
