    ...
    implements b
{
    ...
    public void a(String s)
    {
        ...
        {
            j.f(b).a(Long.valueOf(j.f(b).commentCount.longValue() + 1L), new r() {
            ...
            NetworkPost.a(s, "Post", j.f(b).postId.longValue(), a, new Tags()).a(new m() {
...
_L3:
    ...
    _cls2.a(com.cyberlink.beautycircle.controller.activity.j j1, String s)
    {
        b = j1;
        a = s;
        super();
