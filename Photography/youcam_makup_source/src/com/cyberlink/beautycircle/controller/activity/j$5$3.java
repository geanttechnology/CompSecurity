    ...
    implements android.view.em.OnMenuItemClickListener
{
    ...
    {
        PostCommentActivity.a(a.a.a, a.a);
        return true;
    }
...
/* anonymous class */
        ...
        implements android.view.View.OnLongClickListener
    {
        ...
        public boolean onLongClick(View view)
        {
            ...
            if (e.a)
            {
                menu.add(m.bc_post_comment_menu_copy).setOnMenuItemClickListener(new j._cls5._cls1());
            }
            ...
            {
                menu.add(m.bc_post_comment_menu_edit).setOnMenuItemClickListener(new j._cls5._cls3(this));
            }
            boolean flag = flag1;
            if (a.creator != null)
            {
        ...
        // Unreferenced inner class com/cyberlink/beautycircle/controller/activity/j$5$1
