...
/* anonymous class */
        ...
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            {
                menu.add(m.bc_post_comment_menu_report).setOnMenuItemClickListener(new a._cls6._cls1(this));
            }
            if (flag)
            {
                menu.add(m.bc_post_delete).setOnMenuItemClickListener(new a._cls6._cls2());
            }
            view.show();
        }
        ...
        // Unreferenced inner class com/cyberlink/beautycircle/controller/adapter/a$6$2
