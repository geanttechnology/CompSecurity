...
/* anonymous class */
        ...
        implements android.view.View.OnClickListener
    {
                ...
                if (view.equals(((java.util.Map.Entry) (obj)).getValue()))
                {
                    ...
                    if (obj != null)
                    {
                        ...
                        if (obj instanceof ListView)
                        {
                            ...
                            ((ListView)obj).postDelayed(new BottomBarFragment._cls17._cls1(this, ((View) (obj))), 300L);
                        } else
                        ...
                        if (obj instanceof CLMultiColumnListView)
                        {
                            ...
                            ((CLMultiColumnListView)obj).postDelayed(new BottomBarFragment._cls17._cls2(((View) (obj))), 300L);
                        }
                    }
                }
            } while (true);
        ...
        // Unreferenced inner class com/cyberlink/beautycircle/controller/fragment/BottomBarFragment$17$2

/* anonymous class */
        class BottomBarFragment._cls17._cls2
            implements Runnable
        {
