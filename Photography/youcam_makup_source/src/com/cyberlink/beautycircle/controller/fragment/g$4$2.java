        ...
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            } else
            {
                ...
                obj = view.getMenu();
                ((Menu) (obj)).add(m.bc_me_create_circle).setOnMenuItemClickListener(new g._cls4._cls1());
                ((Menu) (obj)).add(m.bc_me_create_post).setOnMenuItemClickListener(new g._cls4._cls2(this));
                view.show();
                return;
            }
        }
        ...
        // Unreferenced inner class com/cyberlink/beautycircle/controller/fragment/g$4$1
