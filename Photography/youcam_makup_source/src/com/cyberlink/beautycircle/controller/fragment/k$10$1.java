    ...
    implements android.widget.View.OnItemClickListener
{
    ...
    public void onItemClick(AdapterView adapterview, View view, int i, long l)
    {
        ...
        if (adapterview != null && tivity(a).length > i)
        {
            view = e.a();
            if (view != null && !view.isEmpty())
            {
                adapterview.k();
                String s = a(a)[i];
                (new k()).d(new u(s)).a(new j(view, s) {
                    ...
                    {
                        String s1 = h.a(new String[] {
                            a, "Looks", b.substring(b.lastIndexOf('/'))
                        });
                        h.a(abyte0, s1);
                        return new i(s1, s1.substring(0, s1.lastIndexOf('.')));
                    }
            ...
            
            {
                ...
                }).a(h.b(Globals.n())).a(new m(adapterview) {
