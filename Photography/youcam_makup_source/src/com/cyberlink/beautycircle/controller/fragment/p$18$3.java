    ...
    implements Runnable
{
    ...
    public void run()
    {
        if (b.b.g != null)
        {
            ((CLMultiColumnListView)b.b.g).setAdapter(null);
        }
        b.b.c(0);
        p.c(b.b, 0);
        p.d(b.b, 0);
        ...
        q q1 = (q)p.o(b.b).get(Integer.valueOf(0));
        if (q1 != null && q1.b().equals(com.cyberlink.beautycircle.model.er.DisplayType.b))
        {
            q1.a(null, p.h(b.b), false);
        }
    }
...
_L18:
            ...
            {
                avoid.runOnUiThread(new p._cls18._cls2());
            }
            p.c(a, true);
_L19:
            obj;
...
_L12:
            ...
            if (avoid instanceof MainActivity)
            {
                avoid.runOnUiThread(new p._cls18._cls3(this, avoid));
            }
            p.c(a, false);
              goto _L19
_L10:
...
/* anonymous class */
        ...
        // Unreferenced inner class com/cyberlink/beautycircle/controller/fragment/p$18$2

/* anonymous class */
        class p._cls18._cls2
            implements Runnable
        {
