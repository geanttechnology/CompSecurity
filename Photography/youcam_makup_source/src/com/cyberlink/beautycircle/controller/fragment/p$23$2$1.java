    ...
    implements b
{
    ...
    public void a(String s)
    {
        ...
        if (com.cyberlink.beautycircle.controller.fragment.p.e(a.a.a).isBlocked.booleanValue())
        {
            i = m.bc_post_more_menu_unblock_msg;
            j = m.bc_post_more_menu_unblock_btn;
        }
        DialogUtils.a(a.a, null, a.a.a.getResources().getString(i), a.a.a.getResources().getString(m.bc_dialog_button_cancel), null, a.a.a.getResources().getString(j), new Runnable(s) {
