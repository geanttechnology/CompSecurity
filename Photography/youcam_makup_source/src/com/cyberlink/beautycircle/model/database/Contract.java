...
public final class Contract extends a
{
    ...
    protected static Contract a = new Contract();
    ...
    private Contract()
    {
        ...
        while (i < j) 
        {
            ...
            if (Modifier.isStatic(k) && Modifier.isPublic(k) && com/cyberlink/beautycircle/model/database/Contract$TABLE.isAssignableFrom(field.getType()))
            {
                try
                {
                    ((TABLE)field.get(this)).a(((Field)field.getClass().cast(field)).get(this), field.getName());
                }
...
_L1:
    ...
    private class PostsTable extends TABLE
    {

        public final com.cyberlink.beautycircle.model.database.a lastModified = com.cyberlink.beautycircle.model.database.a.c();
        public final com.cyberlink.beautycircle.model.database.a postId = com.cyberlink.beautycircle.model.database.a.c().a();
        public final com.cyberlink.beautycircle.model.database.a postJSON = com.cyberlink.beautycircle.model.database.a.d();
