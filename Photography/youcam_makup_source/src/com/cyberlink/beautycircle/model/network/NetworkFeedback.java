...
public class NetworkFeedback
{
    ...
    public static j a(String s, g g)
    {
        return NetworkManager.a(NetworkManager.b).a(new j(s, g) {
            ...
            protected FeedbackResult a(String s1)
            {
                return (FeedbackResult)Model.a(com/cyberlink/beautycircle/model/network/NetworkFeedback$FeedbackResult, s1);
            }
            ...
            private class FeedbackResult extends Model
            {
