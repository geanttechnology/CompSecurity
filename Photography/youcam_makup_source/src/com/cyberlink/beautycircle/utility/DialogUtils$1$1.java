...
/* anonymous class */
        ...
        implements Runnable
    {
        ...
        public void run()
        {
            ...
            if (obj != null)
            {
                ...
                if (c != null)
                {
                    ...
                    ((TextView) (obj)).setOnClickListener(new DialogUtils._cls1._cls1(this, dialog));
                }
            }
            ...
            if (obj != null)
            {
                ...
                if (e != null)
                {
                    ...
                    ((TextView) (obj)).setVisibility(0);
                    ((TextView) (obj)).setOnClickListener(new DialogUtils._cls1._cls2(dialog));
                }
            }
        ...
        // Unreferenced inner class com/cyberlink/beautycircle/utility/DialogUtils$1$2

/* anonymous class */
        class DialogUtils._cls1._cls2
