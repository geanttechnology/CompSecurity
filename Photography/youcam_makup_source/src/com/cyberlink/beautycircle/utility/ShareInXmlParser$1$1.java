...
/* anonymous class */
        ...
        implements Runnable
    {
        ...
        public void run()
        {
            ...
            ShareInXmlParser.p(a).setWebViewClient(new ShareInXmlParser._cls1._cls1(this));
            ShareInXmlParser.p(a).setWebChromeClient(new ShareInXmlParser._cls1._cls2());
        ...
        // Unreferenced inner class com/cyberlink/beautycircle/utility/ShareInXmlParser$1$2

/* anonymous class */
        class ShareInXmlParser._cls1._cls2 extends WebChromeClient
        {
