    ...
    implements Runnable
{
    ...
    public void run()
    {
        ...
        ShareInXmlParser.p(a).setWebViewClient(new WebViewClient() {
        ...
        ShareInXmlParser.p(a).setWebChromeClient(new WebChromeClient() {
    ...
    _cls2.a(ShareInXmlParser shareinxmlparser)
    {
        a = shareinxmlparser;
        super();
    }
