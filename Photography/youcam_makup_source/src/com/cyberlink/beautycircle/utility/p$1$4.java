    ...
    implements Runnable
{
    ...
    public void run()
    {
        c.c.isFollowed = Boolean.valueOf(false);
        if (c.c.followerCount != null)
        {
            Object obj = c.c.followerCount;
            obj = c.c;
            obj.followerCount = Integer.valueOf(((UserInfo) (obj)).followerCount.intValue() - 1);
        }
        NetworkUser.b(a, c.c.id).a(new com.perfectcorp.utility.m() {
            ...
            {
                a = p._cls1._cls4.this;
                super();
            }
        });
        com.cyberlink.beautycircle.utility._cls1.a(c, b);
        t.c.a();
    }
