...
class a extends m
{
    ...
    protected void a(d d1)
    {
        if (d1 != null && d1.b != null)
        {
            ...
            if (a && !CircleList.a(b))
            {
                CircleList.a().a(new m() {

                    final CircleList._cls3 a;
...
label0:
                        {
                            ...
                            do
                            {
                                ...
                                circlebasic1 = (CircleBasic)iterator.next();
                            } while (!arraylist.contains(circlebasic1.id));
                            CircleList.a(a.b, circlebasic1);
                        }
                        if (CircleList.b(a.b).isEmpty())
                        {
                            CircleList.a(a.b, (CircleBasic)CircleList.c(a.b).get(0));
                        }
                    }
    ...
    _cls1.a(CircleList circlelist, boolean flag)
    {
        b = circlelist;
        a = flag;
        super();
