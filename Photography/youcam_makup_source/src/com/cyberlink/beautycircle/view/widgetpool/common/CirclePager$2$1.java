...
_L3:
            ...
            b.postDelayed(new CirclePager._cls2._cls2(this), 5000L);
_L5:
            return;
_L2:
...
_L7:
            CircleList.a().a(new CirclePager._cls2._cls1(this, d1));
            return;
        }
        ...
        // Unreferenced inner class com/cyberlink/beautycircle/view/widgetpool/common/CirclePager$2$2

/* anonymous class */
        class CirclePager._cls2._cls2
            implements Runnable
        {
