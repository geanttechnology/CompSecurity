    ...
    implements Runnable
{
    ...
    public void run()
    {
        NetworkCircle.a(b.b.longValue(), b.b.longValue()).a(a);
    }
    ...
    // Unreferenced inner class com/cyberlink/beautycircle/view/widgetpool/common/CirclePager$2

/* anonymous class */
    class CirclePager._cls2 extends m
    {
...
_L3:
            ...
            b.postDelayed(new CirclePager._cls2._cls2(this, this), 5000L);
_L5:
            return;
_L2:
...
_L2:
            ...
            if (CirclePager.a(b) != CirclePager.CreateCircleBtnPos.b) goto _L4; else goto _L3
_L3:
            d1.b.add(0, null);
_L6:
...
_L4:
            if (CirclePager.a(b) == CirclePager.CreateCircleBtnPos.c)
            {
                d1.b.add(null);
            }
...
_L7:
            CircleList.a().a(new CirclePager._cls2._cls1(d1));
            return;
        }
        ...
        // Unreferenced inner class com/cyberlink/beautycircle/view/widgetpool/common/CirclePager$2$1

/* anonymous class */
        class CirclePager._cls2._cls1 extends m
        {
