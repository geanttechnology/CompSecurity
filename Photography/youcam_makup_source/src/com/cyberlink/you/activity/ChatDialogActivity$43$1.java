    ...
    implements Runnable
{
    ...
    // Unreferenced inner class com/cyberlink/you/activity/ChatDialogActivity$43

/* anonymous class */
    class ChatDialogActivity._cls43
        implements Runnable
    {
...
_L5:
            i = j + 1;
            b.runOnUiThread(new ChatDialogActivity._cls43._cls1(this, list1, i1 - 1));
            try
            {
