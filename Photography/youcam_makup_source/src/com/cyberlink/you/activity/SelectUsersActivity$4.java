...
class a
    implements android.view.ersActivity._cls4
{
    ...
    {
        SelectUsersActivity.m(a).runOnUiThread(new Runnable() {

            final SelectUsersActivity._cls4 a;
            ...
            {
                a = SelectUsersActivity._cls4.this;
                super();
            }
        });
        view = new Intent();
    ...
    _cls1.a(SelectUsersActivity selectusersactivity)
    {
