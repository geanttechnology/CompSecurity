...
_L3:
        ...
        if (flag)
        {
            if (obj != null)
            {
                ...
                AbsListView.a(a, j, 0, a.getScrollX(), 0, 0, 0, a.O, 0, false);
            }
            if (flag1)
            {
                c(i);
...
_L4:
        ...
        if (((u) (obj)).d())
        {
            k = a.getScrollX();
            i1 = ((u) (obj)).b();
            if (AbsListView.b(a, i1 - k, 0, k, 0, 0, 0, a.O, 0, false))
            {
                if (k <= 0 && i1 > 0)
                {
                    j = 1;
