...
class o extends AccessibilityDelegateCompat
{
    ...
    public void onInitializeAccessibilityEvent(View view, AccessibilityEvent accessibilityevent)
    {
        ...
        accessibilityevent.setClassName(com/cyberlink/you/widgetpool/clhorizontalgridview/AdapterView.getName());
    ...
    public void onInitializeAccessibilityNodeInfo(View view, AccessibilityNodeInfoCompat accessibilitynodeinfocompat)
    {
        ...
        accessibilitynodeinfocompat.setClassName(com/cyberlink/you/widgetpool/clhorizontalgridview/AdapterView.getName());
