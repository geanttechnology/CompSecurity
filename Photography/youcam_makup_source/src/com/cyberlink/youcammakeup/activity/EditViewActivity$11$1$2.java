    ...
    implements r
{
    ...
    public void a()
    {
        EditViewActivity.t(a.a.a).dismiss();
        a.a.a.I();
    }
    ...
    public void a(PointF apointf[])
    {
        ...
        int i = EditViewActivity.u(a.a.a).a(((ImageBufferWrapper) (obj)).j(), ((ah) (obj3)), ((ah) (obj4)), ((ah) (obj1)), apointf);
        com.cyberlink.youcammakeup.activity.EditViewActivity.a(a.a.a, (new StringBuilder()).append("[ManualAdjustDialog] uiVenus.ManualGetFaceAlignmentData iRet=").append(i).toString());
        if (obj != null)
        {
        ...
        obj1.c = apointf;
        obj = new aj();
        i = EditViewActivity.u(a.a.a).a(1, ((aj) (obj)));
        com.cyberlink.youcammakeup.activity.EditViewActivity.a(a.a.a, (new StringBuilder()).append("[ManualAdjustDialog] uiVenus.GetFaceInfos iRet=").append(i).toString());
        if (((aj) (obj)).b() == 0L)
        {
            com.cyberlink.youcammakeup.activity.EditViewActivity.a(a.a.a, "[ManualAdjustDialog] faceRectList.size() == 0");
            a.a.a.I();
            return;
        }
        obj2 = new ai(((aj) (obj)).a(0));
        obj = new ax();
        i = EditViewActivity.u(a.a.a).a(((ai) (obj2)), ((ax) (obj)));
        com.cyberlink.youcammakeup.activity.EditViewActivity.a(a.a.a, (new StringBuilder()).append("[ManualAdjustDialog] face : uiVenus.GetIrisRadius iRet=").append(i).append(" iris radius = ").append(((ax) (obj)).b()).toString());
        obj3 = new bn();
        i = EditViewActivity.u(a.a.a).a(((ai) (obj2)), ((bn) (obj3)));
        com.cyberlink.youcammakeup.activity.EditViewActivity.a(a.a.a, (new StringBuilder()).append("[ManualAdjustDialog] face : uiVenus.GetAutoWigLuminanceParameter iRet=").append(i).append(" wig luminance = ").append(((bn) (obj3)).b()).toString());
        boolean flag = EditViewActivity.u(a.a.a).a(((ai) (obj2)));
        com.cyberlink.youcammakeup.activity.EditViewActivity.a(a.a.a, (new StringBuilder()).append("[ManualAdjustDialog] face : uiVenus.DetectOpenMouth boolean = ").append(flag).toString());
        obj1.b = ((ai) (obj2));
        obj1.c = apointf;
        obj1.d = ((ax) (obj));
        obj1.e = ((bn) (obj3));
...
/* anonymous class */
        ...
        implements Runnable
    {
        ...
        public void run()
        {
            ...
            EditViewActivity.t(a.b).setOnCancelListener(new EditViewActivity._cls11._cls1._cls1());
            Object obj = new EditViewActivity._cls11._cls1._cls2(this);
        ...
        // Unreferenced inner class com/cyberlink/youcammakeup/activity/EditViewActivity$11$1$1

/* anonymous class */
        class EditViewActivity._cls11._cls1._cls1
