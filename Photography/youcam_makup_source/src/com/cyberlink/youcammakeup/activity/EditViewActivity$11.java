    ...
    implements w
{
    ...
    {
        YMKSavingPageEvent.a(com.cyberlink.youcammakeup.clflurry.acedetectionClick.a);
        com.cyberlink.youcammakeup.clflurry.b.a(new YMKSavingPageEvent(YMKSavingPageEvent.b, System.currentTimeMillis(), com.cyberlink.youcammakeup.clflurry.peration.f, false, false));
        (new Handler()).post(new Runnable() {
            ...
            public void run()
            {
                ...
                EditViewActivity.t(a.b).setOnCancelListener(new android.content.DialogInterface.OnCancelListener(this) {
    ...
    public void b(boolean flag)
    {
        if (a)
        {
            YMKSavingPageEvent.a(com.cyberlink.youcammakeup.clflurry.acedetectionClick.c);
        } else
        {
            YMKSavingPageEvent.a(com.cyberlink.youcammakeup.clflurry.acedetectionClick.b);
        }
        com.cyberlink.youcammakeup.clflurry.b.a(new YMKSavingPageEvent(YMKSavingPageEvent.b, System.currentTimeMillis(), com.cyberlink.youcammakeup.clflurry.peration.f, false, false));
        (new Handler()).post(new Runnable() {
    ...
    _cls2.a(EditViewActivity editviewactivity, boolean flag)
    {
        b = editviewactivity;
        a = flag;
        super();
