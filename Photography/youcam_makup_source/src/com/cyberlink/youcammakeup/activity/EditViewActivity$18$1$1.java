    ...
    implements f
{
    ...
    public void a(BeautifierTaskInfo beautifiertaskinfo)
    {
        ...
        (e. new <init>(d, c, b)).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, new ImageBufferWrapper[] {
            c, beautifiertaskinfo
        });
    }

    wer(wer wer, BeautifierManager beautifiermanager, int i, ImageBufferWrapper imagebufferwrapper, ImageViewer imageviewer)
    {
        e = wer;
        a = beautifiermanager;
        b = i;
...
label2:
                    {
                        ...
                        if (obj != null)
                        {
                            ...
                            (new EditViewActivity._cls18._cls1.a(imageviewer, ((ImageBufferWrapper) (obj)), i)).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, new ImageBufferWrapper[] {
                                obj
                            });
                        }
                        return;
                    ...
                    beautifiermanager.c(new EditViewActivity._cls18._cls1._cls1(this, beautifiermanager, i, ((ImageBufferWrapper) (obj)), imageviewer));
        ...
        class EditViewActivity._cls18._cls1.a extends AsyncTask
        {
            ...
            protected void onPostExecute(Object obj)
            {
                a((List)obj);
                    ...
                    EditViewActivity._cls18._cls1.a(ImageViewer imageviewer, ImageBufferWrapper imagebufferwrapper, int i)
                    {
        ...
        // Unreferenced inner class com/cyberlink/youcammakeup/activity/EditViewActivity$18$1$a$1

/* anonymous class */
        class EditViewActivity._cls18._cls1.a._cls1
            implements d
        {

            final EditViewActivity._cls18._cls1.a b;
