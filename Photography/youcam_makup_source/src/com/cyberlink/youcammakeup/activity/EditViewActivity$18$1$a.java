...
class c extends AsyncTask
{
    ...
    protected void a(List list)
    {
        ...
        a1 = StatusManager.j().f(d.d);
        list1 = j.a().g();
        if (a1 == null)
        {
            a1 = new a(d.d, a.m.b, a.m.c, a.m.d, j.a(a.m.i), list1, ((ar)list1.get(d.d)).c.b(), ((ar)list1.get(d.d)).c.c(), d.d, s, new v(BeautyMode.D), list);
        }
        list = new a(d.d, b.b(), b.c(), a1.d, j.a(a.m.i), list1, ((ar)list1.get(c)).c.b(), ((ar)list1.get(c)).c.c(), c, s, new v(BeautyMode.D), list);
        StatusManager.j().a(list, b, new d() {
            ...
            {
                b = EditViewActivity._cls18._cls1.a.this;
                super();
            }
        });
    }
    ...
    Wrapper(Wrapper wrapper, ImageViewer imageviewer, ImageBufferWrapper imagebufferwrapper, int i)
    {
        d = wrapper;
        a = imageviewer;
...
/* anonymous class */
    class EditViewActivity._cls18._cls1
        implements com.cyberlink.youcammakeup.widgetpool.dialogs.j
    {
