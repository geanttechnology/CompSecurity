    ...
    implements j
{
    ...
    public void a(com.cyberlink.youcammakeup.widgetpool.dialogs.missType misstype, int i)
    {
label0:
        {
label1:
...
label2:
                {
                    if (misstype != com.cyberlink.youcammakeup.widgetpool.dialogs.missType.b)
                    {
                        break label0;
                    }
                    Globals.d().i().b(c.c);
                    ...
                    EditViewActivity.e(c.c).p();
                    misstype = BeautifierEditCenter.a().d();
                    ...
                    if (obj != null)
                    {
                        ...
                        class a extends AsyncTask
                        {
                            ...
                            protected void a(List list)
                            {
                                ...
                                StatusManager.j().a(list, b, new d(this) {
            ...
            a(ImageViewer imageviewer, ImageBufferWrapper imagebufferwrapper, int i)
            {
                d = EditViewActivity._cls18._cls1.this;
                a = imageviewer;
                ...
                super();
                        ...
                        imageviewer = (ImageViewer)c.c.findViewById(0x7f0c0720);
                        if (imageviewer == null)
                        {
                        ...
                        (new a(imageviewer, ((ImageBufferWrapper) (obj)), i)).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, new ImageBufferWrapper[] {
                            obj
                        });
                    }
                    return;
                ...
                beautifiermanager.c(new f(beautifiermanager, i, ((ImageBufferWrapper) (obj)), imageviewer) {
                    ...
                    public void a(BeautifierTaskInfo beautifiertaskinfo)
                    {
                        ...
                        (e. new a(d, c, b)).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, new ImageBufferWrapper[] {
            ...
            
            {
                ...
                beautifiermanager.a(misstype, false, false);
                return;
            }
            Globals.d().i().h(c.c);
            com.cyberlink.youcammakeup.activity.EditViewActivity.f(c.c, false);
            return;
        }
        com.cyberlink.youcammakeup.activity.EditViewActivity.f(c.c, false);
    }

    a.c(a.c c1, long l, int i)
    {
        c = c1;
        a = l;
        b = i;
