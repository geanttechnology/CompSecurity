    ...
    implements android.view.
{
    ...
    public void onClick(View view)
    {
        ...
        s.a().a(a, view, new j(l, i) {

            final long a;
            final int b;
            final EditViewActivity._cls18 c;

            public void a(com.cyberlink.youcammakeup.widgetpool.dialogs.FaceSwitcherDialog.DismissType dismisstype, int k)
            {
label0:
                {
label1:
...
label2:
            ...
            a(_cls1 _pcls1, ImageViewer imageviewer, ImageBufferWrapper imagebufferwrapper, int i)
            {
                d = _pcls1;
                a = imageviewer;
                ...
                super();
                                ...
                                ((EditViewActivity) (obj)).a(-1, -1, -1, -1, -1, -1, i1, -1);
                                ...
                                (new a(this, imageviewer, ((ImageBufferWrapper) (obj)), k)).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, new ImageBufferWrapper[] {
                                    obj
                                });
                            }
                            return;
                        ...
                        beautifiermanager.c(new f(this, beautifiermanager, k, ((ImageBufferWrapper) (obj)), imageviewer) {
            ...
            {
                c = EditViewActivity._cls18.this;
                a = l;
                b = i;
                super();
            }
    ...
    _cls1.b(EditViewActivity editviewactivity)
    {
        a = editviewactivity;
        super();
    }
