    ...
    implements e
{
    ...
    public void a(ImageStateChangedEvent imagestatechangedevent)
    {
        ...
        if (StatusManager.j().s() != BeautyMode.D || StatusManager.j().r() != MakeupMode.g)
        {
            ...
            for (l = 0; l < j1; l++)
            {
                obj[l].a(imagestatechangedevent);
            }
    ...
    // Unreferenced inner class com/cyberlink/youcammakeup/activity/EditViewActivity$22

/* anonymous class */
    class EditViewActivity._cls22
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            {
                Globals.d().i().b(a);
                (new aq(view, new EditViewActivity._cls22._cls1(this, view))).executeOnExecutor(view.c(), new Void[0]);
                return;
            }
        }
