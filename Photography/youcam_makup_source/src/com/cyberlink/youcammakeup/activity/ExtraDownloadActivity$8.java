...
_L4:
        Activity activity = Globals.d().a(com.cyberlink.youcammakeup.tivity._cls8.a);
        if (activity == null) goto _L1; else goto _L6
_L6:
        activity.runOnUiThread(new Runnable(a1.b()) {

            final String a;
            final ExtraDownloadActivity._cls8 b;
            ...
            {
                b = ExtraDownloadActivity._cls8.this;
                a = s;
                super();
            }
        });
