...
class a
    implements com.facebook.ookSharingActivity._cls5._cls1
{
    ...
    // Unreferenced inner class com/cyberlink/youcammakeup/activity/FacebookSharingActivity$5

/* anonymous class */
    class FacebookSharingActivity._cls5
        implements Runnable
    {
...
_L7:
            ...
            
            {
                ...
                super();
                a = new FacebookSharingActivity._cls5._cls1(this);
            }
    }
