    ...
    implements w
{
    ...
    private List a(int i)
    {
        ...
        obj = camera;
        List list = camera.getParameters().pportedPreviewSizes();
        obj = list;
        if (camera != null)
        {
            camera.release();
...
_L3:
    ...
    public void a(float f)
    {
        ...
        {
            a.runOnUiThread(new Runnable(f) {

                final float a;
                final GpuBenchmarkActivity._cls1 b;
                ...
                public void run()
                {
                    ...
                    obj = GpuBenchmarkActivity._cls1.a(b, 1);
                    Object obj1;
                    Exception exception;
                    if (obj != null)
                    {
                    ...
                    obj1 = GpuBenchmarkActivity._cls1.a(b, 0);
                    if (obj1 != null)
                    {
...
_L2:
            ...
            {
                b = GpuBenchmarkActivity._cls1.this;
                a = f;
                super();
            }
            });
    ...
    _cls1.a(GpuBenchmarkActivity gpubenchmarkactivity)
    {
