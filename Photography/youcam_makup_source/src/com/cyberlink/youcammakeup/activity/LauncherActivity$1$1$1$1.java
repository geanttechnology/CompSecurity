    ...
    implements Runnable
{
    ...
    public void run()
    {
        com.cyberlink.youcammakeup.activity.a(a.a.a);
    }
...
/* anonymous class */
        ...
        implements b
    {
        ...
        private void a()
        {
            b.animate().alpha(1.0F).setDuration(1000L).setListener(new LauncherActivity._cls1._cls1(this)).start();
        }

        private void b()
        {
            b.animate().alpha(0.0F).setDuration(1000L).setListener(new LauncherActivity._cls1._cls2()).start();
        }
        ...
        // Unreferenced inner class com/cyberlink/youcammakeup/activity/LauncherActivity$1$2

/* anonymous class */
        class LauncherActivity._cls1._cls2
            implements android.animation.Animator.AnimatorListener
        {
            ...
            {
                Globals.d(new LauncherActivity._cls1._cls2._cls1(this));
            }
        ...
        // Unreferenced inner class com/cyberlink/youcammakeup/activity/LauncherActivity$1$2$1

/* anonymous class */
        class LauncherActivity._cls1._cls2._cls1
            implements Runnable
        {
