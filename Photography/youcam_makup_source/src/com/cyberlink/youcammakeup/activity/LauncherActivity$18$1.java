...
class a extends ch
{
    ...
    {
        com.cyberlink.youcammakeup.activity.a(b, a);
    }
        ...
        implements android.view.View.OnTouchListener
    {
        ...
        private void a(View view)
        {
            ...
            } else
            {
                ...
                animatorset.addListener(new LauncherActivity._cls18._cls2());
                animatorset.start();
                return;
            }
        }
        ...
        public boolean onTouch(View view, MotionEvent motionevent)
        {
            ...
            if (f >= 0.0F && f <= (float)view.getWidth() && f1 >= 0.0F && f1 <= (float)view.getHeight())
            {
                ...
                {
                    b.addListener(new LauncherActivity._cls18._cls1(this, view));
                    return true;
                } else
                {
                    a(view);
        ...
        // Unreferenced inner class com/cyberlink/youcammakeup/activity/LauncherActivity$18$2

/* anonymous class */
        class LauncherActivity._cls18._cls2 extends ch
        {
