...
class a extends ch
{
    ...
    {
        com.cyberlink.youcammakeup.flurry.a.a(new LauncherGotoEvent(com.cyberlink.youcammakeup.flurry.Name.b));
        b.a(new YMKLauncherTileClicksEvent(com.cyberlink.youcammakeup.clflurry.vent.LauncherTileName.b));
        b.a(new YMKLauncherEvent(com.cyberlink.youcammakeup.clflurry.ype.a, com.cyberlink.youcammakeup.clflurry.tion.b));
        YMKLiveCamEvent.b(com.cyberlink.youcammakeup.clflurry..a.a());
    ...
    // Unreferenced inner class com/cyberlink/youcammakeup/activity/LauncherActivity$18

/* anonymous class */
    class LauncherActivity._cls18
        implements android.view.View.OnTouchListener
    {
        ...
        private void a(View view)
        {
            ...
            } else
            {
                ...
                animatorset.addListener(new LauncherActivity._cls18._cls2(this));
                animatorset.start();
                return;
            }
        }
        ...
        static void a(LauncherActivity._cls18 _pcls18, View view)
        {
            _pcls18.a(view);
        }
        ...
        public boolean onTouch(View view, MotionEvent motionevent)
        {
            ...
            if (f >= 0.0F && f <= (float)view.getWidth() && f1 >= 0.0F && f1 <= (float)view.getHeight())
            {
                ...
                {
                    b.addListener(new LauncherActivity._cls18._cls1(view));
                    return true;
                } else
                {
                    a(view);
        ...
        // Unreferenced inner class com/cyberlink/youcammakeup/activity/LauncherActivity$18$1

/* anonymous class */
        class LauncherActivity._cls18._cls1 extends ch
        {
