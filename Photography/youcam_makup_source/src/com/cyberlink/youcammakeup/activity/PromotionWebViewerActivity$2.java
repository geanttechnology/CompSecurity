    ...
    implements ae
{
    ...
    public void a(ab ab1)
    {
        ...
        } else
        {
            ...
            b.runOnUiThread(new Runnable(ab1) {
                ...
                public void run()
                {
                    String s1 = Uri.parse(a.a(b.a).c.toString()).buildUpon().appendQueryParameter("HideTopBar", "true").build().toString();
                    if (PromotionWebViewerActivity.c(b.b) != null)
                    {
                        PromotionWebViewerActivity.d(b.b).loadUrl(s1);
                    }
                }
    ...
    _cls2.a(PromotionWebViewerActivity promotionwebvieweractivity, String s)
    {
