...
/* anonymous class */
        ...
        implements z
    {
        ...
        public void a()
        {
            CameraCtrl.a(a).post(new CameraCtrl._cls28._cls2());
        }
        ...
        public void a(ImageBufferWrapper imagebufferwrapper, List list)
        {
            ...
            CameraCtrl.a(a).post(new CameraCtrl._cls28._cls1(this));
        }
        ...
        // Unreferenced inner class com/cyberlink/youcammakeup/camera/CameraCtrl$28$2

/* anonymous class */
        class CameraCtrl._cls28._cls2
            implements Runnable
        {
