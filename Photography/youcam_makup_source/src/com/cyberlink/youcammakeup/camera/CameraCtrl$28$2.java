    ...
    implements Runnable
{
    ...
    // Unreferenced inner class com/cyberlink/youcammakeup/camera/CameraCtrl$28

/* anonymous class */
    class CameraCtrl._cls28
        implements z
    {
        ...
        public void a()
        {
            CameraCtrl.a(a).post(new CameraCtrl._cls28._cls2(this));
        }
        ...
        public void a(ImageBufferWrapper imagebufferwrapper, List list)
        {
            ...
            CameraCtrl.a(a).post(new CameraCtrl._cls28._cls1());
        }
        ...
        public void c()
        {
            CameraCtrl.a(a).post(new CameraCtrl._cls28._cls3());
        }
        ...
        // Unreferenced inner class com/cyberlink/youcammakeup/camera/CameraCtrl$28$1

/* anonymous class */
        class CameraCtrl._cls28._cls1
            implements Runnable
        {
        ...
        // Unreferenced inner class com/cyberlink/youcammakeup/camera/CameraCtrl$28$3

/* anonymous class */
        class CameraCtrl._cls28._cls3
            implements Runnable
        {
            ...
            public void run()
            {
                Globals.d().i().a(CameraCtrl.u(a.a), true, false, false, new CameraCtrl._cls28._cls3._cls1(this));
            }
        ...
        // Unreferenced inner class com/cyberlink/youcammakeup/camera/CameraCtrl$28$3$1

/* anonymous class */
        class CameraCtrl._cls28._cls3._cls1
            implements w
        {

            final CameraCtrl._cls28._cls3 a;
