...
public class YMKRatingCardEvent extends BaseEvent
{
    ...
    private class Operation extends Enum
    {
        ...
        {
            return (Operation)Enum.valueOf(com/cyberlink/youcammakeup/clflurry/YMKRatingCardEvent$Operation, s);
        }
