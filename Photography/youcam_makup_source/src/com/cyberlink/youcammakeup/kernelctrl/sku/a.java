    ...
    implements com.cyberlink.youcammakeup.kernelctrl.sku.d
{
    ...
    private a(SkuInfo skuinfo)
    {
        a = skuinfo;
        super();
    }

    a(SkuInfo skuinfo, SkuInfo._cls1 _pcls1)
    {
        this(skuinfo);
    }
    ...
    public g a(d d1)
    {
        return new g(a, d1.a(), (new StringBuilder()).append(d1.d()).append("_").append(SkuInfo.DownloadType.a).toString(), "sku", d1.h(), d1);
    }
}
