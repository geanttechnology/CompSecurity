    ...
    implements com.cyberlink.youcammakeup.kernelctrl.sku.d
{
    ...
    private c(SkuInfo skuinfo)
    {
        a = skuinfo;
        super();
    }

    c(SkuInfo skuinfo, SkuInfo._cls1 _pcls1)
    {
        this(skuinfo);
    }
    ...
    public g a(d d1)
    {
        return new g(a, d1.a(), (new StringBuilder()).append(d1.d()).append("_").append(SkuInfo.DownloadType.b).toString(), "sku", d1.i(), d1);
    }
}
