    ...
    implements Runnable
{
    ...
    public void run()
    {
        ...
        } else
        {
            ...
            com.cyberlink.youcammakeup.pages.editview.savemylook.a.a.a(b, (new AsyncTask(b1) {
...
_L3:
            ...
            a(_cls1 _pcls1)
            {
                ...
                super();
                    ...
                    e.a().a(com.cyberlink.youcammakeup.pages.editview.savemylook.a.a.e(b.b), com.cyberlink.youcammakeup.pages.editview.savemylook.a.a.b(b.b), f, new a(this));
                    return null;
                }
            ...
            }).executeOnExecutor(com.cyberlink.youcammakeup.pages.editview.savemylook.a.a.c(b), new Void[0]));
            return;
        }
    }

    _cls2.a(a a1, Handler handler)
    {
        b = a1;
        a = handler;
        super();
