...
public abstract class AsyncTask
{
    ...
    private static final com.cyberlink.youcammakeup.pages.librarypicker.photozoompage.kernel.b f = new com.cyberlink.youcammakeup.pages.librarypicker.photozoompage.kernel.b();
    ...
    public AsyncTask()
    {
        ...
        i = new FutureTask(h) {
            ...
            protected void done()
            {
                try
                {
                    com.cyberlink.youcammakeup.pages.librarypicker.photozoompage.kernel.AsyncTask.b(a, get());
                    return;
                }
                ...
                {
                    com.cyberlink.youcammakeup.pages.librarypicker.photozoompage.kernel.AsyncTask.b(a, null);
                }
            }
    ...
    {
        f.obtainMessage(1, new a(this, new Object[] {
            obj
        })).sendToTarget();
        return obj;
    }
    ...
    {
        if (j == Status.a) goto _L2; else goto _L1
_L1:
        class _cls4
        {
            ...
            static 
            {
                ...
                try
                {
                    a[com.cyberlink.youcammakeup.pages.librarypicker.photozoompage.kernel.Status.b.ordinal()] = 1;
                }
    ...
    //                   2 85;
           goto _L2 _L3 _L4
_L2:
        j = com.cyberlink.youcammakeup.pages.librarypicker.photozoompage.kernel.Status.b;
        a();
        h.b = aobj;
        executor.execute(i);
        return this;
...
_L4:
    ...
    private class Status extends Enum
    {
        ...
        {
            return (Status)Enum.valueOf(com/cyberlink/youcammakeup/pages/librarypicker/photozoompage/kernel/AsyncTask$Status, s);
        }
