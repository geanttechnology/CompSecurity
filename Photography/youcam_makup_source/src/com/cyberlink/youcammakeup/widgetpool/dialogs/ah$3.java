    ...
    implements android.view.OnClickListener
{
    ...
    public void onClick(View view)
    {
        ...
        ah.a(a, false);
        b.a(new YMKClicksSaveMyLookEvent(com.cyberlink.youcammakeup.clflurry.icksSaveMyLookEvent.ButtonName.b));
        b.a(new YMKSavingPageEvent(0L, 0L, com.cyberlink.youcammakeup.clflurry.vingPageEvent.Operation.d, false, false));
        ...
        if (as1 == null || as1.f() != com.cyberlink.youcammakeup.utility.DataCenter.SourceType.c)
        {
            ah.a(a, null);
            obj = PanelDataCenter.a().a(com.cyberlink.youcammakeup.utility.DataCenter.SourceType.c);
            do
            {
                int j;
                if (i < 10)
        ...
        obj = new bl(i, new aq() {
            ...
            public void b(String s)
            {
                ...
                i k = ah.k(d.a).a();
                PanelDataCenter.a().a(ah.j(d.a), s, ah.l(d.a), k, b);
                s = StatusManager.j().d();
                if (s != null)
                {
