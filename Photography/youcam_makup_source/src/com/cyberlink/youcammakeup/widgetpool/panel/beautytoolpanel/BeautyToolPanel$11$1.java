...
/* anonymous class */
        ...
        implements a
    {
            ...
            } else
            {
                ...
                if (BeautyToolPanel.g(b) != null && BeautyToolPanel.g(b).m != null)
                {
                    ...
                    if (b.b.p() && StatusManager.j().s() != BeautyMode.x)
                    {
                        ...
                        b.b.runOnUiThread(new BeautyToolPanel._cls11._cls1(this));
                        return;
                    } else
                    {
                        StatusManager.j().a(((com.cyberlink.youcammakeup.kernelctrl.status.a) (obj)), q1.a(), new BeautyToolPanel._cls11._cls2());
                        return;
                    }
                }
            }
        ...
        // Unreferenced inner class com/cyberlink/youcammakeup/widgetpool/panel/beautytoolpanel/BeautyToolPanel$11$2

/* anonymous class */
        class BeautyToolPanel._cls11._cls2
            implements d
        {

            final BeautyToolPanel._cls11 b;
