    ...
    implements Runnable
{
    ...
    // Unreferenced inner class com/cyberlink/youcammakeup/widgetpool/panel/beautytoolpanel/BeautyToolPanel$12

/* anonymous class */
    class BeautyToolPanel._cls12
        implements Runnable
    {
        ...
        public void run()
        {
            ...
            obj = new BeautyToolPanel._cls12._cls1(this);
