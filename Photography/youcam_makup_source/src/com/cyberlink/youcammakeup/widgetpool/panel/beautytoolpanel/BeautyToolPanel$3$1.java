...
_L7:
        ...
        private void a(String s)
        {
            ...
            if (beautymode == BeautyMode.x && a.c != null && (a.c instanceof r))
            {
                Globals.a(new BeautyToolPanel._cls3._cls2(s), 300L);
            }
        }
        ...
        public void onClick(View view)
        {
            ...
            if (paneldatacenter.g(view))
            {
                ...
                o1.a(new BeautyToolPanel._cls3._cls1(this, o1, view));
                return;
            } else
            {
                a(view);
        ...
        // Unreferenced inner class com/cyberlink/youcammakeup/widgetpool/panel/beautytoolpanel/BeautyToolPanel$3$2

/* anonymous class */
        class BeautyToolPanel._cls3._cls2
            implements Runnable
        {
