...
//            TemplateButton, BeautyToolPanel, BeautyToolPanelItemAdapter, p, 
//            r, b
    ...
    implements Runnable
{
    ...
    tType(tType ttype, View view, int i)
    {
        c = ttype;
        a = view;
        b = i;
    ...
    // Unreferenced inner class com/cyberlink/youcammakeup/widgetpool/panel/beautytoolpanel/BeautyToolPanel$4

/* anonymous class */
    class BeautyToolPanel._cls4
        implements p
    {
...
_L2:
            ...
            adapterview = TemplateButton.LayoutType.b;
            if (view instanceof TemplateButton)
            {
                adapterview = ((TemplateButton)view).getLayoutType();
            }
            if (i != 0 || adapterview != TemplateButton.LayoutType.a || a != BeautyMode.l && a != BeautyMode.m && a != BeautyMode.x && !BeautyMode.d(a)) goto _L4; else goto _L3
_L3:
            String s;
            l = -1L;
            s = null;
...
_L4:
            ...
            if (adapterview == null || !adapterview.equals(s1))
            {
                ...
                view.post(new BeautyToolPanel._cls4._cls1(this, view, i));
                return;
            }
