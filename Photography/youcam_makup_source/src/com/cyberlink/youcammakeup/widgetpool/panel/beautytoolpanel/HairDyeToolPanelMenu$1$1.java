        ...
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            } else
            {
                ...
                view = new HairDyeToolPanelMenu._cls1._cls2(new HairDyeToolPanelMenu._cls1._cls1(this, view));
                a.h.post(view);
                return;
            }
        }
        ...
        // Unreferenced inner class com/cyberlink/youcammakeup/widgetpool/panel/beautytoolpanel/HairDyeToolPanelMenu$1$2

/* anonymous class */
        class HairDyeToolPanelMenu._cls1._cls2
            implements Runnable
        {
