    ...
    implements android.view.nClickListener
{
    ...
    {
        if (com.cyberlink.youcammakeup.widgetpool.panel.beautytoolpanel.c.a(a.a) == null)
        {
            return;
        } else
        {
            com.cyberlink.youcammakeup.widgetpool.panel.beautytoolpanel.c.a(a.a).S();
            return;
        }
    }
    ...
    class c._cls1 extends AsyncTask
    {
        ...
        protected void a(Boolean boolean1)
        {
            if (com.cyberlink.youcammakeup.widgetpool.panel.beautytoolpanel.c.a(d) != null)
            {
                ...
                {
                    com.cyberlink.youcammakeup.widgetpool.panel.beautytoolpanel.c.n(d).setOnClickListener(new c._cls1._cls2(this));
