    ...
    implements Runnable
{
    ...
    public void run()
    {
        BeautyToolPanel beautytoolpanel = com.cyberlink.youcammakeup.widgetpool.panel.beautytoolpanel.c.c(b.b.b);
        boolean flag;
        if (com.cyberlink.youcammakeup.widgetpool.panel.beautytoolpanel.c.c(b.b.b).r() != 0)
        {
            flag = true;
        } else
        {
...
/* anonymous class */
    class c._cls1 extends AsyncTask
    {
        ...
        void a()
        {
            d.getActivity().runOnUiThread(new c._cls1._cls4());
        }
        ...
        protected void a(Boolean boolean1)
        {
            if (com.cyberlink.youcammakeup.widgetpool.panel.beautytoolpanel.c.a(d) != null)
            {
                ...
                if (com.cyberlink.youcammakeup.widgetpool.panel.beautytoolpanel.c.n(d) != null)
                {
                    ...
                    com.cyberlink.youcammakeup.widgetpool.panel.beautytoolpanel.c.o(d).setOnClickListener(new c._cls1._cls3(this));
                    return;
                }
            }
        }
...
/* anonymous class */
        ...
        // Unreferenced inner class com/cyberlink/youcammakeup/widgetpool/panel/beautytoolpanel/c$1$4
...
/* anonymous class */
        ...
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            view.post(new c._cls1._cls3._cls2(this, new c._cls1._cls3._cls1(view)));
        }
