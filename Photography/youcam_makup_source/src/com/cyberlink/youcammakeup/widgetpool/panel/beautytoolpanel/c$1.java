...
class c extends AsyncTask
{
    ...
    protected transient Boolean a(Void avoid[])
    {
        ...
        if (c)
        {
            if (MotionControlHelper.e().a(null, c))
            {
                ...
                com.cyberlink.youcammakeup.widgetpool.panel.beautytoolpanel.c.a(d).a(new c() {
    ...
    void a()
    {
        d.getActivity().runOnUiThread(new Runnable() {
    ...
    protected void a(Boolean boolean1)
    {
        if (com.cyberlink.youcammakeup.widgetpool.panel.beautytoolpanel.c.a(d) != null)
        {
            ...
            {
                com.cyberlink.youcammakeup.widgetpool.panel.beautytoolpanel.c.n(d).setOnClickListener(new android.view.View.OnClickListener() {
            ...
            
            {
                ...
                com.cyberlink.youcammakeup.widgetpool.panel.beautytoolpanel.c.o(d).setOnClickListener(new android.view.View.OnClickListener() {
    ...
    protected void onPreExecute()
    {
        ...
        com.cyberlink.youcammakeup.widgetpool.panel.beautytoolpanel.c.a(d, com.cyberlink.youcammakeup.widgetpool.common.onControlHelper.SwitcherMode.a);
        ...
        if (obj != null && ((i) (obj)).b() != null && ((i) (obj)).b().f().size() != 0 && ((i) (obj)).b().c() != null && PanelDataCenter.f(((i) (obj)).b().c()))
        {
            ...
            int i1 = com.cyberlink.youcammakeup.widgetpool.common.onControlHelper.SwitcherMode.values().length - 1;
            com.cyberlink.youcammakeup.widgetpool.panel.beautytoolpanel.c c1 = d;
            com.cyberlink.youcammakeup.widgetpool.common.onControlHelper.SwitcherMode aswitchermode[] = com.cyberlink.youcammakeup.widgetpool.common.onControlHelper.SwitcherMode.values();
            if (j > i1)
            {
                j = i1;
            }
    ...
    _cls4.a(com.cyberlink.youcammakeup.widgetpool.panel.beautytoolpanel.c c1)
    {
        d = c1;
        super();
        a = null;
