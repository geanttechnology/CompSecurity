    ...
    implements Runnable
{
    ...
    public void run()
    {
        ...
        if (a != null)
        {
            ...
            {
                obj1 = ((v) (obj)).c();
                float f1 = ((v) (obj)).b(com.cyberlink.youcammakeup.widgetpool.common.onControlHelper.SwitcherMode.a).intValue();
                Float afloat[] = {
                    Float.valueOf(f1)
                };
                obj2 = obj;
        ...
        } else
        {
            ...
            {
                obj = new Float[1];
                obj[0] = Float.valueOf(((v) (obj2)).b(com.cyberlink.youcammakeup.widgetpool.common.onControlHelper.SwitcherMode.a).intValue());
            } else
            {
                obj = new Float[1];
