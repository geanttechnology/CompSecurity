    ...
    implements Runnable
{
    ...
    // Unreferenced inner class com/cyberlink/youcammakeup/widgetpool/panel/beautytoolpanel/i$1
        ...
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            } else
            {
                ...
                view = new i._cls1._cls2(this, new i._cls1._cls1(view));
                a.h.post(view);
                return;
            }
        }
        ...
        // Unreferenced inner class com/cyberlink/youcammakeup/widgetpool/panel/beautytoolpanel/i$1$1

/* anonymous class */
        class i._cls1._cls1 extends ch
        {
