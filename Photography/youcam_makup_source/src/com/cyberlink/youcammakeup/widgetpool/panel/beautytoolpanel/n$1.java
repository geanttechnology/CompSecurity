    ...
    implements Runnable
{
    ...
    public void run()
    {
        ...
        if (a != null)
        {
            ...
            {
                obj1 = ((v) (obj)).c();
                float f = ((v) (obj)).b(com.cyberlink.youcammakeup.widgetpool.common.onControlHelper.SwitcherMode.a).intValue();
                Float afloat[] = {
                    Float.valueOf(f)
                };
                obj2 = obj;
        ...
        } else
        {
            ...
            {
                obj1 = new Float[1];
                obj1[0] = Float.valueOf(((v) (obj2)).b(com.cyberlink.youcammakeup.widgetpool.common.onControlHelper.SwitcherMode.a).intValue());
            } else
            {
                obj1 = new Float[1];
