    ...
    implements Runnable
{
    ...
    {
        a.a.a(true, true);
        com.cyberlink.youcammakeup.widgetpool.panel.c.x.a(a.a, a.a, false);
    }
...
/* anonymous class */
        ...
        implements j
    {
        ...
        public void a(bn bn1)
        {
            if (a == ((Integer)b.getTag()).intValue())
            {
                c.runOnUiThread(new x._cls7._cls2());
            }
        }
        ...
        public void a(Void void1)
        {
            if (a == ((Integer)b.getTag()).intValue())
            {
                c.runOnUiThread(new x._cls7._cls1(this));
            }
        }
...
/* anonymous class */
        ...
        // Unreferenced inner class com/cyberlink/youcammakeup/widgetpool/panel/c/x$7$2$1

/* anonymous class */
        class x._cls7._cls2._cls1
            implements android.view.View.OnClickListener
        {

            final x._cls7._cls2 a;
