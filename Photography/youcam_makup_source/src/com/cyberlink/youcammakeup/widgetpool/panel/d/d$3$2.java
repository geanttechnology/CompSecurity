        ...
        implements a
    {
        ...
        public void a(com.cyberlink.youcammakeup.kernelctrl.viewengine.q q1, Object obj)
        {
            ...
            if (com.cyberlink.youcammakeup.widgetpool.panel.d.d.i(b).p())
            {
                ...
                com.cyberlink.youcammakeup.widgetpool.panel.d.d.i(b).runOnUiThread(new d._cls3._cls1());
                return;
            } else
            {
                StatusManager.j().a(((com.cyberlink.youcammakeup.kernelctrl.status.a) (obj)), q1.a(), new d._cls3._cls2(this));
                return;
            }
        }
        ...
        // Unreferenced inner class com/cyberlink/youcammakeup/widgetpool/panel/d/d$3$1
