    ...
    implements e
{
    ...
    // Unreferenced inner class com/cyberlink/youcammakeup/widgetpool/toolbar/FineTuneToolBar$8

/* anonymous class */
    class FineTuneToolBar._cls8
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            {
                FineTuneToolBar.f(a);
                (new aq(view, new FineTuneToolBar._cls8._cls1(this, view))).executeOnExecutor(view.c(), new Void[0]);
                return;
            }
        }
