...
/* anonymous class */
        ...
        implements j
    {
        ...
        public void a(a a1)
        {
            ...
            a.runOnUiThread(new MakeupLooksBottomToolbar._cls2._cls3(this, i));
        }
        ...
        {
            a.runOnUiThread(new MakeupLooksBottomToolbar._cls2._cls1());
        }
        ...
        // Unreferenced inner class com/cyberlink/youcammakeup/widgetpool/toolbar/MakeupLooksBottomToolbar$2$1

/* anonymous class */
        class MakeupLooksBottomToolbar._cls2._cls1
            implements Runnable
        {
