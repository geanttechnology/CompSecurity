...
/* anonymous class */
        ...
        implements q
    {
        ...
        private final android.content.DialogInterface.OnDismissListener b = new MakeupLooksBottomToolbar._cls3._cls1(this);
        private final a c = new MakeupLooksBottomToolbar._cls3._cls2();
...
/* anonymous class */
            ...
            implements a
        {
            ...
            public void a(View view, com.cyberlink.youcammakeup.pages.editview.savemylook.LookItemPopupMenu.Action action)
            {
                ...
                } else
                {
                    ...
                    {
                        action = MakeupLooksBottomToolbar.b(a.a).a(i);
                        view.post(new MakeupLooksBottomToolbar._cls3._cls2._cls2(this, action, new MakeupLooksBottomToolbar._cls3._cls2._cls1(this, s, action, looksgriditem, list)));
                        return;
                    }
                    if (action == com.cyberlink.youcammakeup.pages.editview.savemylook.LookItemPopupMenu.Action.c)
                    {
                        ...
                        if (view instanceof EditViewActivity)
                        {
                            ...
                            {
                                (new Handler()).post(new MakeupLooksBottomToolbar._cls3._cls2._cls3(this, view));
                                return;
                            } else
                            {
        ...
        // Unreferenced inner class com/cyberlink/youcammakeup/widgetpool/toolbar/MakeupLooksBottomToolbar$3$2$1

/* anonymous class */
        class MakeupLooksBottomToolbar._cls3._cls2._cls1
            implements bl
        {
            ...
            final List d;
            final MakeupLooksBottomToolbar._cls3._cls2 e;
