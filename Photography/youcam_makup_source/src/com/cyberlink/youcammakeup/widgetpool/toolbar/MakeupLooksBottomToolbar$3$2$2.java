    ...
    implements Runnable
{
    ...
    public void run()
    {
        SoftInputUtils.b(null, c.c.c.getFragmentManager(), a.b(), b);
    }
        ...
        implements a
    {
        ...
        public void a(View view, com.cyberlink.youcammakeup.pages.editview.savemylook.LookItemPopupMenu.Action action)
        {
            ...
            } else
            {
                ...
                {
                    action = MakeupLooksBottomToolbar.b(a.a).a(i);
                    view.post(new MakeupLooksBottomToolbar._cls3._cls2._cls2(this, action, new MakeupLooksBottomToolbar._cls3._cls2._cls1(s, action, looksgriditem, list)));
                    return;
                }
