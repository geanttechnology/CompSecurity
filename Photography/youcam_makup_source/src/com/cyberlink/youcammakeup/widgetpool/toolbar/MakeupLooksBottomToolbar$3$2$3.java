    ...
    implements Runnable
{
    ...
    b(b b1, EditViewActivity editviewactivity)
    {
        b = b1;
        a = editviewactivity;
        super();
        ...
        implements a
    {
        ...
        public void a(View view, com.cyberlink.youcammakeup.pages.editview.savemylook.LookItemPopupMenu.Action action)
        {
            ...
            } else
            {
                ...
                {
                    action = MakeupLooksBottomToolbar.b(a.a).a(i);
                    view.post(new MakeupLooksBottomToolbar._cls3._cls2._cls2(action, new MakeupLooksBottomToolbar._cls3._cls2._cls1(s, action, looksgriditem, list)));
                    return;
                }
            ...
            implements bl
        {
            ...
            public String c()
            {
                return null;
                    ...
                    {
                        e = MakeupLooksBottomToolbar._cls3._cls2.this;
                        a = s;
                        b = as1;
                        c = looksgriditem;
                        d = list;
