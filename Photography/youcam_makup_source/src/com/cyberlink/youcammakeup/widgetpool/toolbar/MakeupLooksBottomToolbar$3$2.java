    ...
    implements a
{
    ...
    public void a(View view, com.cyberlink.youcammakeup.pages.editview.savemylook. )
    {
        ...
        List list = PanelDataCenter.a().a(com.cyberlink.youcammakeup.utility.oolbar._cls3.a);
        list.remove(MakeupLooksBottomToolbar.b(a.a).a(i).b());
        if ( == com.cyberlink.youcammakeup.pages.editview.savemylook.)
        {
             = MakeupLooksBottomToolbar.b(a.a).a(i);
            if (.h().booleanValue())
            {
                .a(Boolean.valueOf(false));
                looksgriditem.d(true);
            }
            MakeupLooksBottomToolbar.p(a.a).a(view);
            a.a.c(true);
        } else
        {
            if ( == com.cyberlink.youcammakeup.pages.editview.savemylook.)
            {
                 = MakeupLooksBottomToolbar.b(a.a).a(i);
                view.post(new Runnable(, new bl(s, , looksgriditem, list) {
            ...
            if ( == com.cyberlink.youcammakeup.pages.editview.savemylook.Manager)
            {
