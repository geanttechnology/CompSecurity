...
class a extends h
{
    ...
    public Fragment a()
    {
        com.cyberlink.youcammakeup.flurry.a.a(new UsageOfEyeFeatureEvent(com.cyberlink.youcammakeup.flurry.ureName.f));
        com.cyberlink.youcammakeup.flurry.a.a(new UsageOfAllFeaturesEvent(com.cyberlink.youcammakeup.flurry.tureName.q));
        b.a(new o(com.cyberlink.youcammakeup.clflurry.reName.q));
        b.a(new aa(com.cyberlink.youcammakeup.clflurry.reName.q));
        b.a(new am(com.cyberlink.youcammakeup.clflurry.reName.q));
