...
class a extends h
{
    ...
    public Fragment a()
    {
        com.cyberlink.youcammakeup.flurry.a.a(new UsageOfFaceFeatureEvent(com.cyberlink.youcammakeup.flurry.tureName.c));
        com.cyberlink.youcammakeup.flurry.a.a(new UsageOfAllFeaturesEvent(com.cyberlink.youcammakeup.flurry.tureName.d));
        b.a(new o(com.cyberlink.youcammakeup.clflurry.reName.d));
        b.a(new ab(com.cyberlink.youcammakeup.clflurry.reName.d));
        b.a(new am(com.cyberlink.youcammakeup.clflurry.reName.d));
        StatusManager.j().a(BeautyMode.a);
        com.cyberlink.youcammakeup.widgetpool.toolbar.MakeupMenuBottomToolbar.b(a);
        n n1 = new n();
        ((BeautyToolPanel)n1).a(com.cyberlink.youcammakeup.widgetpool.panel.beautytoolpanel.Mode.c);
        return n1;
    }
