...
class a extends h
{
    ...
    public Fragment a()
    {
        com.cyberlink.youcammakeup.flurry.a.a(new UsageOfFaceFeatureEvent(com.cyberlink.youcammakeup.flurry.tureName.e));
        com.cyberlink.youcammakeup.flurry.a.a(new UsageOfAllFeaturesEvent(com.cyberlink.youcammakeup.flurry.tureName.f));
        b.a(new o(com.cyberlink.youcammakeup.clflurry.reName.f));
        b.a(new ab(com.cyberlink.youcammakeup.clflurry.reName.f));
        b.a(new am(com.cyberlink.youcammakeup.clflurry.reName.f));
