...
class a extends h
{
    ...
    public Fragment a()
    {
        com.cyberlink.youcammakeup.flurry.a.a(new UsageOfFaceFeatureEvent(com.cyberlink.youcammakeup.flurry.tureName.f));
        com.cyberlink.youcammakeup.flurry.a.a(new UsageOfAllFeaturesEvent(com.cyberlink.youcammakeup.flurry.tureName.g));
        b.a(new o(com.cyberlink.youcammakeup.clflurry.reName.g));
        b.a(new ab(com.cyberlink.youcammakeup.clflurry.reName.g));
        b.a(new am(com.cyberlink.youcammakeup.clflurry.reName.g));
