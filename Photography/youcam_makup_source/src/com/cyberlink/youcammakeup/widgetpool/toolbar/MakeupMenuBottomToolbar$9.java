...
class a extends com.cyberlink.youcammakeup.widgetpool.toolbar.h
{
    ...
    public Fragment a()
    {
        com.cyberlink.youcammakeup.flurry.a.a(new UsageOfEyeFeatureEvent(com.cyberlink.youcammakeup.flurry.tureName.d));
        com.cyberlink.youcammakeup.flurry.a.a(new UsageOfAllFeaturesEvent(com.cyberlink.youcammakeup.flurry.atureName.o));
        b.a(new o(com.cyberlink.youcammakeup.clflurry.ureName.o));
        b.a(new aa(com.cyberlink.youcammakeup.clflurry.ureName.o));
        b.a(new am(com.cyberlink.youcammakeup.clflurry.ureName.o));
        StatusManager.j().a(BeautyMode.r);
        com.cyberlink.youcammakeup.widgetpool.toolbar.MakeupMenuBottomToolbar.b(a);
        h h1 = new h();
        ((BeautyToolPanel)h1).a(com.cyberlink.youcammakeup.widgetpool.panel.beautytoolpanel.rMode.c);
        return h1;
    }
