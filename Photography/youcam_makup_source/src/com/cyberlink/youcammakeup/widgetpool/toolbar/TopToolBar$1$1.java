...
/* anonymous class */
        ...
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            {
                b.a(new YMKSavingPageEvent(YMKSavingPageEvent.b, l, com.cyberlink.youcammakeup.clflurry.YMKSavingPageEvent.Operation.b, true, true));
            } else
            {
                b.a(new YMKSavingPageEvent(YMKSavingPageEvent.b, l, com.cyberlink.youcammakeup.clflurry.YMKSavingPageEvent.Operation.b, true, false));
            }
            b.a(new YMKSavingPageEvent(YMKSavingPageEvent.b, l, com.cyberlink.youcammakeup.clflurry.YMKSavingPageEvent.Operation.e, false, false));
            view = ca.b().a("%d");
            b.a(new YMKEditStayTimeEvent(com.cyberlink.youcammakeup.clflurry.YMKEditStayTimeEvent.Button.b, view));
            ...
            ((com.cyberlink.youcammakeup.camera.ag) (obj)).a(new TopToolBar._cls1._cls1(this));
            ...
            obj = new TopToolBar._cls1._cls2(globals, l, baseactivity, ((com.cyberlink.youcammakeup.camera.ag) (obj)));
            if (com.cyberlink.youcammakeup.kernelctrl.viewengine.i.a(l))
            {
                if (l == -7L)
                {
...
/* anonymous class */
            ...
            implements c
        {
            ...
            {
                e.a.getActivity().runOnUiThread(new TopToolBar._cls1._cls2._cls1(this, b1));
            }
...
/* anonymous class */
        ...
        // Unreferenced inner class com/cyberlink/youcammakeup/widgetpool/toolbar/TopToolBar$1$2$2

/* anonymous class */
        class TopToolBar._cls1._cls2._cls2
            implements Runnable
        {
