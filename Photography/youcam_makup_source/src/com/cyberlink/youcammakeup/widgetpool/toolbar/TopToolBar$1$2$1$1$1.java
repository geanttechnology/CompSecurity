    ...
    implements Runnable
{
    ...
    public void run()
    {
        FragmentManager fragmentmanager = a.a.a.a.a.getFragmentManager();
        o.a(fragmentmanager, a.a.a.a, "SharePageDialog");
...
/* anonymous class */
        ...
        implements c
    {
        ...
        {
            e.a.getActivity().runOnUiThread(new TopToolBar._cls1._cls2._cls2(error));
        }
