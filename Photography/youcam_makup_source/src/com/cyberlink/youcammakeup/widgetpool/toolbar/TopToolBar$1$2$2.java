    ...
    implements Runnable
{
    ...
    final com.cyberlink.youcammakeup.masteraccess.a a;
    final b b;

    public void run()
    {
        String s;
        if (a.a() != com.cyberlink.youcammakeup.masteraccess.vaError.a)
        {
            if (a.a() == com.cyberlink.youcammakeup.masteraccess.vaError.j)
            {
        ...
        {
            s = (new StringBuilder()).append("").append(a.a().toString()).toString();
        }
        if (com.cyberlink.youcammakeup.widgetpool.toolbar.TopToolBar.a(b.b.b) != null)
        {
            com.cyberlink.youcammakeup.widgetpool.toolbar.TopToolBar.a(b.b.b).cancel();
            com.cyberlink.youcammakeup.widgetpool.toolbar.TopToolBar.a(b.b.b, null);
        }
        com.cyberlink.youcammakeup.widgetpool.toolbar.TopToolBar.a(b.b.b, Toast.makeText(b.b.b.getActivity(), s, 1));
        com.cyberlink.youcammakeup.widgetpool.toolbar.TopToolBar.a(b.b.b).show();
        b.b.i();
        b.b.b.a(Boolean.valueOf(false));
    }

    a(a a1, com.cyberlink.youcammakeup.masteraccess._cls1._cls2 _pcls2)
    {
        b = a1;
        a = _pcls2;
        super();
...
/* anonymous class */
        ...
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            ((com.cyberlink.youcammakeup.camera.ag) (obj)).a(new TopToolBar._cls1._cls1());
            ...
            obj = new TopToolBar._cls1._cls2(this, globals, l, baseactivity, ((com.cyberlink.youcammakeup.camera.ag) (obj)));
            if (com.cyberlink.youcammakeup.kernelctrl.viewengine.i.a(l))
            {
                if (l == -7L)
                {
...
/* anonymous class */
    ...
    // Unreferenced inner class com/cyberlink/youcammakeup/widgetpool/toolbar/TopToolBar$1$2

/* anonymous class */
    class TopToolBar._cls1._cls2
        implements c
    {
        ...
        {
            e.a.getActivity().runOnUiThread(new TopToolBar._cls1._cls2._cls2(this, error));
        }

        public void a(com.cyberlink.youcammakeup.masteraccess.b b1)
        {
            e.a.getActivity().runOnUiThread(new TopToolBar._cls1._cls2._cls1(b1));
        }
        ...
        // Unreferenced inner class com/cyberlink/youcammakeup/widgetpool/toolbar/TopToolBar$1$2$1

/* anonymous class */
        class TopToolBar._cls1._cls2._cls1
            implements Runnable
        {
            ...
            public void run()
            {
                ...
                view.postDelayed(new TopToolBar._cls1._cls2._cls1._cls1(this, view), 500L);
        ...
        // Unreferenced inner class com/cyberlink/youcammakeup/widgetpool/toolbar/TopToolBar$1$2$1$1

/* anonymous class */
        class TopToolBar._cls1._cls2._cls1._cls1
            implements Runnable
        {

            final View a;
            final TopToolBar._cls1._cls2._cls1 b;

            public void run()
            {
                a.setVisibility(8);
                ((BaseActivity)b.b.e.a.getActivity()).a(new TopToolBar._cls1._cls2._cls1._cls1._cls1(this));
            }
        ...
        // Unreferenced inner class com/cyberlink/youcammakeup/widgetpool/toolbar/TopToolBar$1$2$1$1$1

/* anonymous class */
        class TopToolBar._cls1._cls2._cls1._cls1._cls1
            implements Runnable
        {

            final TopToolBar._cls1._cls2._cls1._cls1 a;
