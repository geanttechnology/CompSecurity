...
class _cls1
{
    ...
    static void onResume(Context context, appSessionInfoMap appsessioninfomap, AppEventsLogger appeventslogger, long l)
    {
        synchronized (staticLock)
        {
            getTimeSpentData(context, appsessioninfomap).onResume(appeventslogger, l);
...
_L3:
        obj1 = obj;
        Log.d(AppEventsLogger.access$1300(), (new StringBuilder()).append("Got unexpected exception: ").append(exception.toString()).toString());
        Utility.closeQuietly(((java.io.Closeable) (obj)));
        context.deleteFile("AppEventsLogger.persistedsessioninfo");
        if (appSessionInfoMap == null)
        {
...
_L4:
        context = objectoutputstream;
        Log.d(AppEventsLogger.access$1300(), (new StringBuilder()).append("Got unexpected exception: ").append(exception1.toString()).toString());
        Utility.closeQuietly(objectoutputstream);
          goto _L1
        context;
        obj;
