...
//            HttpMethod, AccessToken, RequestBatch, Response, 
//            Session
...
_L5:
    ...
    private class WebViewAuthHandler extends AuthHandler
    {
        ...
        void onWebDialogComplete(AuthorizationRequest authorizationrequest, Bundle bundle, FacebookException facebookexception)
        {
            ...
            {
                e2e = null;
                authorizationrequest = facebookexception.getMessage();
                if (facebookexception instanceof FacebookServiceException)
                {
                    authorizationrequest = ((FacebookServiceException)facebookexception).getRequestError();
                    bundle = String.format("%d", new Object[] {
                        Integer.valueOf(authorizationrequest.getErrorCode())
                    });
                    authorizationrequest = authorizationrequest.toString();
                } else
                {
                    bundle = null;
                }
                authorizationrequest = Result.createErrorResult(pendingRequest, null, authorizationrequest, bundle);
            }
        ...
        boolean tryAuthorize(final AuthorizationRequest request)
        {
            ...
            obj = new com.facebook.widget.WebDialog.OnCompleteListener() {
