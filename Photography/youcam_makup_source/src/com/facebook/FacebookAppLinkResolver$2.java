    ...
    implements val.urisToRequest
{
    ...
    public void onCompleted(Response response)
    {
        ...
        if (obj != null)
        {
            val$taskCompletionSource.b(((FacebookRequestError) (obj)).getException());
            return;
        }
...
_L2:
        ...
        b = FacebookAppLinkResolver.access$000(((JSONArray) (obj1)).getJSONObject(i));
        if (b == null)
        {
        ...
        arraylist.add(b);
        break MISSING_BLOCK_LABEL_263;
        obj1 = new a(uri, arraylist, FacebookAppLinkResolver.access$100(uri, jsonobject));
