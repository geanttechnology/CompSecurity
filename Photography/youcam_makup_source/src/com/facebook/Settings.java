...
public final class Settings
{
    ...
    public static final boolean isLoggingBehaviorEnabled(LoggingBehavior loggingbehavior)
    {
        ...
        JVM INSTR monitorenter ;
        boolean flag;
        if (isLoggingEnabled() && loggingBehaviors.contains(loggingbehavior))
        {
            flag = true;
        } else
        {
...
_L3:
    ...
    {
        context = context.getSharedPreferences("com.facebook.sdk.appEventPreferences", 0).edit();
        context.putBoolean("limitEventUsage", flag);
        context.commit();
    }
