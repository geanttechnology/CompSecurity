...
_L6:
        return i;
_L2:
        nativeappinfo = new HashSet();
        for (; context.moveToNext(); nativeappinfo.add(Integer.valueOf(context.getInt(context.getColumnIndex("version"))))) { }
          goto _L3
        Exception exception;
        exception;
...
_L5:
        ...
        if (!nativeappinfo.contains(integer)) goto _L5; else goto _L4
_L4:
        j = integer.intValue();
        i = j;
        if (context != null)
