...
_L1:
            ...
            if (confirmLogout)
            {
                ...
                ((android.app.AlertDialog.Builder) (obj2)).setMessage(((CharSequence) (obj))).setCancelable(true).setPositiveButton(((CharSequence) (obj1)), new android.content.DialogInterface.OnClickListener() {
