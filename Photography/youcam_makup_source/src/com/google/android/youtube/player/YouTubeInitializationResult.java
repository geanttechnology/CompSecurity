...
_L4:
        oncancellistener = new a(activity, oncancellistener, i);
        activity = new m(activity);
        ...
        case 1: // '\001'
            return builder.setTitle(((m) (activity)).b).setMessage(((m) (activity)).c).setPositiveButton(((m) (activity)).d, oncancellistener).create();

        case 2: // '\002'
            return builder.setTitle(((m) (activity)).e).setMessage(((m) (activity)).f).setPositiveButton(((m) (activity)).g, oncancellistener).create();

        case 3: // '\003'
            return builder.setTitle(((m) (activity)).h).setMessage(((m) (activity)).i).setPositiveButton(((m) (activity)).j, oncancellistener).create();
        }
_L2:
        oncancellistener = z.b(z.a(activity));
          goto _L4
        oncancellistener = z.a(z.a(activity));
          goto _L4
    }
    ...
    static 
    {
        ...
        a = (new YouTubeInitializationResult[] {
