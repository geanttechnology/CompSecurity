    ...
    implements Filterable, WrapperListAdapter
{
    ...
    public q(ArrayList arraylist, ArrayList arraylist1, ListAdapter listadapter)
    {
        e = listadapter;
