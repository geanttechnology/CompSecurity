    ...
    implements TextWatcher
{
    ...
    {
        if (TextUtils.isEmpty(MobileRegisterActivity.access$0(MobileRegisterActivity.this).getText().toString()))
        {
            MobileRegisterActivity.access$4(MobileRegisterActivity.this).setVisibility(4);
            return;
        } else
        {
            MobileRegisterActivity.access$4(MobileRegisterActivity.this).setVisibility(0);
            return;
        }
    }
