...
_L3:
        ...
        implements r
    {
        ...
        private final d readBuffer;
        private final d receiveBuffer;
        final SpdyStream this$0;
...
label0:
            ...
            l = readBuffer.read(d1, Math.min(l, readBuffer.a()));
            d1 = SpdyStream.this;
            d1.unacknowledgedBytesRead = ((SpdyStream) (d1)).unacknowledgedBytesRead + l;
...
_L3:
            ...
            JVM INSTR monitorexit ;
            l1 -= l;
            connection.writeData(id, false, d, l);
_L1:
            if (l1 <= 0L)
            {
