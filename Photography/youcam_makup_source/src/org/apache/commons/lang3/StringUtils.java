...
_L5:
    ...
    public static int getLevenshteinDistance(CharSequence charsequence, CharSequence charsequence1, int i)
    {
        ...
        Arrays.fill(charsequence1, k1, charsequence1.length, 0x7fffffff);
        ...
        do
        {
            ...
            char c = charsequence2.charAt(j1 - 1);
            charsequence[0] = j1;
            int j2 = Math.max(1, j1 - i);
            int l1;
            if (j1 > 0x7fffffff - i)
            {
                l1 = j;
            ...
            if (j2 > 1)
            {
                charsequence[j2 - 1] = 0x7fffffff;
                i2 = j2;
            }
            while (i2 <= l1) 
            {
                if (charsequence3.charAt(i2 - 1) == c)
                {
                    charsequence[i2] = charsequence4[i2 - 1];
                } else
                {
                    charsequence[i2] = Math.min(Math.min(charsequence[i2 - 1], charsequence4[i2]), charsequence4[i2 - 1]) + 1;
                }
                i2++;
            }
            j1++;
...
label0:
                    {
                        for (int j = ((flag1) ? 1 : 0); j < charsequence.length() && j < charsequence1.length() && charsequence.charAt(j) == charsequence1.charAt(j); j++)
                        {
                            break label0;
                        }
...
_L2:
        ...
        while (l1 < k2) 
        {
            ...
            {
                l = Math.min(acharsequence[l1].length(), k1);
                j1 = Math.max(acharsequence[l1].length(), j1);
                j = i;
                k1 = 0;
                i = l;
                l = k1;
...
_L3:
        ...
        k = -1;
_L8:
        if (i >= k1) goto _L6; else goto _L5
_L5:
        int i2;
        c = acharsequence[0].charAt(i);
        i2 = 1;
_L7:
        int i1;
        i1 = k;
        if (i2 < k2)
        {
            if (acharsequence[i2].charAt(i) == c)
            {
...
_L4:
        obj = s;
        if (as.length == 0) goto _L2; else goto _L5
_L5:
        obj = s;
        if (as1 == null) goto _L2; else goto _L6
_L6:
        if (as1.length != 0) goto _L8; else goto _L7
_L7:
        obj = s;
_L2:
        return ((String) (obj));
_L8:
        ...
        if (i2 != j)
        {
            throw new IllegalArgumentException((new StringBuilder()).append("Search and Replace array lengths don't match: ").append(i2).append(" vs ").append(j).toString());
        }
...
_L12:
        i1 = byte0;
        j1 = j;
        if (k1 >= j) goto _L11; else goto _L13
_L13:
        i1 = l;
        j1 = k1;
          goto _L11
        ...
        obj = new StringBuilder(Math.min(i1, s.length() / 5) + s.length());
        l = byte0;
        i1 = 0;
        byte0 = j;
        j = i1;
_L20:
        ...
        ((StringBuilder) (obj)).append(as1[l]);
        k1 = byte0 + as[l].length();
        j = 0;
        l = -1;
        byte0 = -1;
_L15:
...
label1:
        {
          ...
          goto _L16
        if (byte0 == -1) goto _L18; else goto _L17
_L17:
        i1 = l;
        j1 = byte0;
        if (l1 >= byte0) goto _L16; else goto _L18
_L18:
        i1 = j;
        j1 = l1;
          goto _L16
