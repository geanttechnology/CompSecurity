...
{
    public static final class CompressionOption extends Enum
    {
        ...
        {
            return (CompressionOption)Enum.valueOf(amazon/communication/connection/ConnectionPolicy$CompressionOption, s);
        }
    ...
    public abstract CompressionOption getCompressionOption();

    public abstract Priority getPriority();

    public abstract boolean isAnonymousCredentialsAllowed();

    public abstract boolean isClearText();

    public abstract boolean isLowLatencyNecessary();

    public abstract boolean isRequestResponseOnly();

    public abstract boolean isWiFiNecessary();
}
