...
_L1:
    ...
    public static int getDefaultFactoryMaxApiLevelSupported()
    {
        ...
        try
        {
            s1 = getExternalFactoryName();
        }
        catch (Exception exception)
        {
            throw new RuntimeException("Unable to determine implementation api level", exception);
        }
        if (s1 == null)
        {
...
_L6:
        i = detectApiLevelForFactory(as[j]);
        if (i == -1) goto _L7; else goto _L5
_L5:
        if (i == -1)
        {
...
_L8:
    ...
    public static void setDefaultFactory(String s)
