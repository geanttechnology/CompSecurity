...
//            AmazonPictureReadyListener, AmazonWebBackForwardList, AmazonWebSettings, AmazonValueCallback, 
//            AmazonDownloadDelegate, AmazonDownloadListener, AmazonFindListener, AmazonSelectPopupHandler, 
...
public abstract class AmazonWebViewDelegate
{
    ...
    protected abstract boolean canGoBackOrForward(int i);
    ...
    protected abstract boolean canZoomIn();

    protected abstract boolean canZoomOut();

    protected abstract Picture capturePicture();

    public abstract void capturePicture(int i, int j, int k, int l, int i1, AmazonPictureReadyListener amazonpicturereadylistener);

    protected abstract void capturePicture(int i, int j, int k, AmazonPictureReadyListener amazonpicturereadylistener);

    protected abstract void clearCache(boolean flag);

    protected abstract void clearFormData();

    protected abstract void clearHistory();

    protected abstract void clearMatches();

    protected abstract void clearSslPreferences();

    protected abstract void clearView();

    protected abstract void computeScroll();

    protected abstract AmazonWebBackForwardList copyBackForwardList();

    protected abstract void debugDump();

    protected abstract void destroy();

    protected abstract void documentHasImages(Message message);

    protected abstract void dumpDisplayTree();

    protected abstract void dumpDomTree(boolean flag);

    protected abstract void dumpRenderTree(boolean flag);

    protected abstract void dumpV8Counters();

    protected abstract void exitFullscreen();

    protected abstract int findAll(String s);

    protected abstract void findAllAsync(String s);

    protected abstract void findNext(boolean flag);

    protected abstract void flingScroll(int i, int j);
    ...
    protected abstract String[] getHttpAuthUsernamePassword(String s, String s1);
    ...
    protected abstract void goBackOrForward(int i);

    protected abstract void goForward();

    protected abstract void invokeZoomPicker();

    protected abstract boolean isHorizontalScrollBarEnabled();

    protected abstract boolean isPrivateBrowsingEnabled();

    protected abstract boolean isVerticalScrollBarEnabled();

    protected abstract void loadData(String s, String s1, String s2);

    protected abstract void loadDataWithBaseURL(String s, String s1, String s2, String s3, String s4);

    protected abstract void loadUrl(String s);

    protected abstract void loadUrl(String s, Map map);

    protected abstract void loadWebArchive(String s);

    protected abstract void notifyFindDialogDismissed();
    ...
    protected abstract boolean overlayHorizontalScrollbar();

    protected abstract boolean overlayVerticalScrollbar();

    protected abstract boolean pageDown(boolean flag);

    protected abstract boolean pageUp(boolean flag);
    ...
    protected abstract void postUrl(String s, byte abyte0[]);
    ...
    protected abstract void removeJavascriptInterface(String s);

    protected abstract boolean requestFocus(int i, Rect rect);

    protected abstract void requestFocusNodeHref(Message message);

    protected abstract void requestImageRef(Message message);

    protected abstract AmazonWebBackForwardList restoreState(Bundle bundle);

    protected abstract void resumeTimers();

    protected abstract void savePassword(String s, String s1, String s2);

    protected abstract void saveState(Bundle bundle);

    protected abstract void saveWebArchive(String s);

    protected abstract void saveWebArchive(String s, boolean flag, AmazonValueCallback amazonvaluecallback);
    ...
    protected abstract void setHttpAuthUsernamePassword(String s, String s1, String s2, String s3);
    ...
    protected abstract void setNetworkType(String s, String s1);
    ...
    protected abstract boolean showFindDialog(String s, boolean flag);

    protected abstract void stopLoading();

    protected abstract boolean zoomIn();
