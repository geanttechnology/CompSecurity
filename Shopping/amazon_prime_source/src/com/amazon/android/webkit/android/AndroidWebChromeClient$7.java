...
class val.jsPromptResult extends AmazonJsPromptResult
{
    ...
    public void cancel()
    {
        val$jsPromptResult.cancel();
    }

    public void confirm()
    {
        val$jsPromptResult.confirm();
    }

    public void confirm(String s)
    {
        val$jsPromptResult.confirm(s);
    }

    ()
    {
        this$0 = final_androidwebchromeclient;
        val$jsPromptResult = JsPromptResult.this;
        super();
    }
}
