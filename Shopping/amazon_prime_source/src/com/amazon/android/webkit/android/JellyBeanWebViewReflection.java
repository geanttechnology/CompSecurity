...
class JellyBeanWebViewReflection extends AndroidWebViewReflection
{
    ...
    {
        Reflect.invokeMethod(DUMP_DISPLAY_TREE_METHOD, webviewClassicDelegate, new Object[0]);
    }

    public void dumpDomTree(boolean flag)
    {
        Reflect.invokeMethod(DUMP_DOM_TREE_METHOD, webviewClassicDelegate, new Object[] {
    ...
    {
        Reflect.invokeMethod(DUMP_RENDER_TREE_METHOD, webviewClassicDelegate, new Object[] {
            Boolean.valueOf(flag)
        });
    }
    ...
    {
        Reflect.invokeMethod(NOTIFY_FIND_DIALOG_DISMISSED_METHOD, webviewClassicDelegate, new Object[0]);
    }
    ...
    {
        Reflect.invokeMethod(SET_NETWORK_TYPE_METHOD, webviewClassicDelegate, new Object[] {
            s, s1
        });
    }
