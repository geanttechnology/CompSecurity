...
public class LoaderContext
{
    public static class Builder
    {
        ...
        public Builder setCallbackExecutor(Executor executor1)
        {
        ...
        public Builder setMaxPrimaryCacheMemSize(int i)
        {
            maxPrimaryCacheMemSize = i;
            return this;
        }

        public Builder setPrimaryCacheFactory(ResourceCacheFactory resourcecachefactory)
        {
            primaryCacheFactory = resourcecachefactory;
            return this;
        }

        public Builder setQueue(BlockingQueue blockingqueue)
        {
            queue = blockingqueue;
            return this;
        }

        public Builder setReadCache(boolean flag)
        {
            readCache = flag;
            return this;
        }

        public Builder setReadPrimaryCache(boolean flag)
        {
            readPrimaryCache = flag;
            return this;
        }

        public Builder setRemovalInvalidates(boolean flag)
        {
            removalInvalidates = flag;
            return this;
        }

        public Builder setSendCallbacksToUiThread(boolean flag)
        {
            sendCallbacksToUiThread = flag;
            return this;
        }

        public Builder setTrackReferences(boolean flag)
        {
            trackReferences = flag;
            return this;
        }

        public Builder setUseCache(boolean flag)
        {
            useCache = flag;
            return this;
        }

        public Builder setUsePrimaryCache(boolean flag)
        {
        ...
        public Builder setWriteCache(boolean flag)
        {
            writeCache = flag;
            return this;
        }

        public Builder setWritePrimaryCache(boolean flag)
        {
    ...
    public boolean getRemovalInvalidates()
    {
        return removalInvalidates;
    }
...
_L6:
    ...
    public void removeReference(Object obj, ObjectReference objectreference)
    {
        if (!trackReferences || obj == null || objectreference == null)
        {
            return;
