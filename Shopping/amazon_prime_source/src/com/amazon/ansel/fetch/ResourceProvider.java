...
//            LoaderGroup, ImageLoader, ImageRequest, LoaderContext, 
//            ResourceListener
...
public class ResourceProvider extends LoaderGroup
{
    ...
    public void getImage(String s, ResourceListener resourcelistener)
    {
        getImage(new ImageRequest(s), resourcelistener);
    }
}
