...
//            BasicMetricEvent, MetricEventType, DataPoint, DataPointType

public abstract class AbstractClickStreamMetricEvent extends BasicMetricEvent
    implements GenericClickStreamMetricEvent
{

    private final Map mInfoStructures;
    private final String mRequestId;

    public AbstractClickStreamMetricEvent(String s, String s1)
    {
        this(s, s1, MetricEventType.getDefault());
    }

    public AbstractClickStreamMetricEvent(String s, String s1, MetricEventType metriceventtype)
    {
    ...
    public AbstractClickStreamMetricEvent(String s, String s1, MetricEventType metriceventtype, boolean flag)
    {
        ...
        mInfoStructures = new HashMap();
        mRequestId = ClickStreamHelper.generateRequestId();
    }
