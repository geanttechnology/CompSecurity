    ...
    implements ClickStreamMetricsEvent
{
    ...
    public void setECommerceInfo(ECommerceInfo ecommerceinfo)
    {
        ...
        {
            removeClickStreamInfo(com/amazon/client/metrics/clickstream/ECommerceInfo);
            return;
        } else
        {
    ...
    public void setEventBasedUsageInfo(EventBasedUsageInfo eventbasedusageinfo)
    {
        ...
        {
            removeClickStreamInfo(com/amazon/client/metrics/clickstream/EventBasedUsageInfo);
            return;
        } else
        {
    ...
    public void setImpressionTrackingData(ImpressionTrackingData impressiontrackingdata)
    {
        ...
        {
            removeClickStreamInfo(com/amazon/client/metrics/clickstream/ImpressionTrackingData);
            return;
        } else
        {
