...
public interface MetricEvent
{
    ...
    public abstract String getNonAnonymousCustomerId();

    public abstract String getNonAnonymousSessionId();
    ...
    public abstract void setAnonymous(boolean flag);

    public abstract void setNonAnonymousCustomerId(String s);

    public abstract void setNonAnonymousSessionId(String s);
