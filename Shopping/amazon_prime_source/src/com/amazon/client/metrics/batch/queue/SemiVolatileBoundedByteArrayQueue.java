...
_L3:
    ...
    public long getNumEntriesInQueue()
    {
        ...
        long l;
        long l1;
        l = mVolatileQueue.getNumEntriesInQueue();
        l1 = mNonVolatileQueue.getNumEntriesInQueue();
        this;
        JVM INSTR monitorexit ;
        return l + l1;
        Exception exception;
...
_L3:
    ...
    public void removeListener(ByteArrayQueueListener bytearrayqueuelistener)
    {
        this;
        JVM INSTR monitorenter ;
        mVolatileQueue.removeListener(bytearrayqueuelistener);
        this;
        JVM INSTR monitorexit ;
        return;
        bytearrayqueuelistener;
    ...
    {
        mVolatileQueue.shutdown();
        mNonVolatileQueue.shutdown();
    }
