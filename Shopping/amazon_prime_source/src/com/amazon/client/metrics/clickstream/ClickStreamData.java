...
public final class ClickStreamData extends Enum
{
    ...
    public static final ClickStreamData ANONYMOUS;
    ...
    public static final ClickStreamData NON_ANONYMOUS_CUSTOMER_ID;
    public static final ClickStreamData NON_ANONYMOUS_SESSION_ID;
    ...
    public static final ClickStreamData WEBLAB;
    public static final ClickStreamData WEBLAB_CLIENT_ID;
    ...
    static 
    {
        ...
        NON_ANONYMOUS_SESSION_ID = new ClickStreamData("NON_ANONYMOUS_SESSION_ID", 12, "nonAnonymousSessionId");
        NON_ANONYMOUS_CUSTOMER_ID = new ClickStreamData("NON_ANONYMOUS_CUSTOMER_ID", 13, "nonAnonymousCustomerId");
        ANONYMOUS = new ClickStreamData("ANONYMOUS", 14, "anonymous");
        PAGE_TYPE = new ClickStreamData("PAGE_TYPE", 15, "page-type");
        HIT_TYPE = new ClickStreamData("HIT_TYPE", 16, "hitType");
        TEAM_NAME = new ClickStreamData("TEAM_NAME", 17, "team-name");
        SITE_VARIANT = new ClickStreamData("SITE_VARIANT", 18, "site_variant");
        PAGE_ACTION = new ClickStreamData("PAGE_ACTION", 19, "page-action");
        SUB_PAGE_TYPE = new ClickStreamData("SUB_PAGE_TYPE", 20, "sub-page-type");
        PAGE_TYPE_ID = new ClickStreamData("PAGE_TYPE_ID", 21, "page-type-id");
        TAB_ID = new ClickStreamData("TAB_ID", 22, "tab-id");
        PAGE_ASSEMBLY_TYPE = new ClickStreamData("PAGE_ASSEMBLY_TYPE", 23, "pageAssemblyType");
        IS_CUSTOMER_HIT = new ClickStreamData("IS_CUSTOMER_HIT", 24, "is-customer-hit");
        IS_PRIME_CUSTOMER = new ClickStreamData("IS_PRIME_CUSTOMER", 25, "is-prime-customer");
        GROUPING_ASIN = new ClickStreamData("GROUPING_ASIN", 26, "groupingASIN");
        PRODUCT_GLID = new ClickStreamData("PRODUCT_GLID", 27, "ProductGlId");
        WEBLAB_CLIENT_ID = new ClickStreamData("WEBLAB_CLIENT_ID", 28, "wl-client-id");
        WEBLAB = new ClickStreamData("WEBLAB", 29, "wl");
        ECOMMERCE_PAGE_ACTION = new ClickStreamData("ECOMMERCE_PAGE_ACTION", 30, "ecommerce-page-action");
        ORDER_DATA = new ClickStreamData("ORDER_DATA", 31, "order-data");
        IS_PRIME_ELIGIBLE_ITEM = new ClickStreamData("IS_PRIME_ELIGIBLE_ITEM", 32, "is-prime-eligible-item");
        IS_GLANCE_VIEW = new ClickStreamData("IS_GLANCE_VIEW", 33, "is-glance-view");
        IMPRESSION_PROGRAM_GROUP = new ClickStreamData("IMPRESSION_PROGRAM_GROUP", 34, "programGroup");
        IMPRESSION_TYPE = new ClickStreamData("IMPRESSION_TYPE", 35, "impressionType");
        IMPRESSION_DATA = new ClickStreamData("IMPRESSION_DATA", 36, "impressionData");
        IMPRESSION_METADATA = new ClickStreamData("IMPRESSION_METADATA", 37, "impressionMetadata");
        $VALUES = (new ClickStreamData[] {
            ...
            INFO, COUNTRY_OF_RESIDENCE, NON_ANONYMOUS_SESSION_ID, NON_ANONYMOUS_CUSTOMER_ID, ANONYMOUS, PAGE_TYPE, HIT_TYPE, TEAM_NAME, SITE_VARIANT, PAGE_ACTION, 
            SUB_PAGE_TYPE, PAGE_TYPE_ID, TAB_ID, PAGE_ASSEMBLY_TYPE, IS_CUSTOMER_HIT, IS_PRIME_CUSTOMER, GROUPING_ASIN, PRODUCT_GLID, WEBLAB_CLIENT_ID, WEBLAB, 
            ECOMMERCE_PAGE_ACTION, ORDER_DATA, IS_PRIME_ELIGIBLE_ITEM, IS_GLANCE_VIEW, IMPRESSION_PROGRAM_GROUP, IMPRESSION_TYPE, IMPRESSION_DATA, IMPRESSION_METADATA
        });
    }
}
