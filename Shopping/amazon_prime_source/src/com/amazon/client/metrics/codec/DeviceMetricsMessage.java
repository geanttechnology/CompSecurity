...
_L1:
        ...
        public DataPointMessage.Builder setNameBytes(ByteString bytestring)
        {
            if (bytestring == null)
            {
                throw new NullPointerException();
        ...
        public DataPointMessage.Builder setValueBytes(ByteString bytestring)
        {
            if (bytestring == null)
            {
                throw new NullPointerException();
        ...
        implements KeyValueOrBuilder
    {
        ...
        public static KeyValue parseFrom(byte abyte0[])
            throws InvalidProtocolBufferException
        {
            return (KeyValue)PARSER.parseFrom(abyte0);
        }

        public static KeyValue parseFrom(byte abyte0[], ExtensionRegistryLite extensionregistrylite)
            throws InvalidProtocolBufferException
        {
            return (KeyValue)PARSER.parseFrom(abyte0, extensionregistrylite);
        }
...
_L1:
        ...
        public KeyValue.Builder setKeyBytes(ByteString bytestring)
        {
            if (bytestring == null)
            {
                throw new NullPointerException();
        ...
        public KeyValue.Builder setValueBytes(ByteString bytestring)
        {
            if (bytestring == null)
            {
                throw new NullPointerException();
...
_L1:
        ...
        public MetricBatchMessage.Builder setDeviceSerialNumberBytes(ByteString bytestring)
        {
            if (bytestring == null)
            {
                throw new NullPointerException();
        ...
        public MetricBatchMessage.Builder setDeviceTypeBytes(ByteString bytestring)
        {
            if (bytestring == null)
            {
                throw new NullPointerException();
        ...
        public MetricBatchMessage.Builder setTagBytes(ByteString bytestring)
        {
            if (bytestring == null)
            {
                throw new NullPointerException();
...
_L1:
        ...
        public MetricEntryMessage.Builder setProgramBytes(ByteString bytestring)
        {
            if (bytestring == null)
            {
                throw new NullPointerException();
        ...
        public MetricEntryMessage.Builder setSourceBytes(ByteString bytestring)
        {
            if (bytestring == null)
            {
                throw new NullPointerException();
