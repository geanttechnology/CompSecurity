...
_L1:
        ...
        throws MetricsConfigurationException
    {
        ...
        if (!((JSONObject) (obj)).has(((String) (obj1))) || !Build.TYPE.equals("userdebug") && !mIsDebuggable) goto _L2; else goto _L1
_L1:
...
label0:
        {
            if (!((JSONObject) (obj)).has(((String) (obj2))) || !Build.TYPE.equals("user") || !Build.TAGS.equals("test-keys"))
            {
                break label0;
            }
