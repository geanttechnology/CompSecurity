    ...
    implements Parcelable
{
    ...
    public ErrorCodeWithDataPointsEnvelope(int i, List list)
    {
        mErrorCodeWithDataPoints = new ErrorCodeWithDataPoints(i, DataPointEnvelope.convertToEnvelopes(list));
    }
    ...
    public ErrorCodeWithDataPoints toErrorCodeWithDataPoints()
    {
        ErrorCodeWithDataPoints errorcodewithdatapoints = mErrorCodeWithDataPoints;
        mErrorCodeWithDataPoints = null;
        return errorcodewithdatapoints;
    }
