...
_L4:
    ...
    public static IConnection asInterface(IBinder ibinder)
    {
        ...
        android.os.IInterface iinterface = ibinder.queryLocalInterface("com.amazon.communication.IConnection");
        ...
        throws RemoteException
    {
        ...
        case 2: // '\002'
            ...
            parcel = sendRequest(messageenvelope1, com.amazon.communication.Stub.asInterface(parcel.readStrongBinder()));
            parcel1.writeNoException();
            if (parcel != null)
            {
                parcel1.writeInt(1);
