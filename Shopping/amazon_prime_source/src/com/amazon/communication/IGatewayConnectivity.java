...
public interface IGatewayConnectivity
    extends IInterface
{
        ...
        implements IGatewayConnectivity
    {
        ...
        public static IGatewayConnectivity asInterface(IBinder ibinder)
        {
            ...
            IInterface iinterface = ibinder.queryLocalInterface("com.amazon.communication.IGatewayConnectivity");
    ...
    public abstract int getGatewayConnectionState()
        throws RemoteException;
}
