    ...
    extends IInterface
{
        ...
        implements IMessageHandler
    {
        ...
        public static IMessageHandler asInterface(IBinder ibinder)
        {
            ...
            IInterface iinterface = ibinder.queryLocalInterface("com.amazon.communication.IMessageHandler");
            ...
            throws RemoteException
        {
            ...
            case 1: // '\001'
                ...
                if (parcel.readInt() != 0)
                {
                    parcel1 = (ParcelableEndpointIdentity)ParcelableEndpointIdentity.CREATOR.createFromParcel(parcel);
                } else
                {
                    parcel1 = null;
                }
                if (parcel.readInt() != 0)
                {
                    parcel = (MessageEnvelope)MessageEnvelope.CREATOR.createFromParcel(parcel);
                } else
                {
                    parcel = null;
                }
...
_L2:
    ...
    public abstract void onMessage(ParcelableEndpointIdentity parcelableendpointidentity, MessageEnvelope messageenvelope)
        throws RemoteException;

    public abstract void onMessageFragment(ParcelableEndpointIdentity parcelableendpointidentity, MessageEnvelope messageenvelope, int i, boolean flag)
        throws RemoteException;
}
