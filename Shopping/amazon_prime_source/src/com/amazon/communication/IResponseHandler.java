    ...
    extends IInterface
{
        ...
        implements IResponseHandler
    {
        ...
        public static IResponseHandler asInterface(IBinder ibinder)
        {
            ...
            IInterface iinterface = ibinder.queryLocalInterface("com.amazon.communication.IResponseHandler");
...
_L1:
    ...
    public abstract void onResponse(MessageEnvelope messageenvelope, List list)
        throws RemoteException;
}
