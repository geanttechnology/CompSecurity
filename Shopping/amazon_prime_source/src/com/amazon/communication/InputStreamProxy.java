...
public class InputStreamProxy extends IInputStream.Stub
{
    ...
    public int available()
    {
        ...
        {
            log.error("readBytes", "Caught exception from mInputStream.available()", new Object[] {
                exception
            });
            return -3;
        }
    ...
    public boolean close()
    {
        ...
        {
            log.error("readBytes", "Caught exception from mInputStream.close()", new Object[] {
                exception
            });
            return false;
        }
    ...
    public int readByte()
    {
        ...
        {
            log.error("readBytes", "Caught exception from mInputStream.read()", new Object[] {
                exception
            });
            return -3;
        }
    ...
    public int readBytes(byte abyte0[])
    {
        ...
        {
            log.error("readBytes", "Caught exception from mInputStream.read(data)", new Object[] {
                abyte0
            });
            return -3;
        }
    ...
    public int readBytesIntoOffset(byte abyte0[], int i, int j)
    {
        ...
        {
            log.error("readBytes", "Caught exception from mInputStream.read(data, offset, length)", new Object[] {
                abyte0
            });
            return -3;
        }
