    ...
    implements ConnectionPolicy
{
    ...
    public amazon.communication.connection.ConnectionPolicy.CompressionOption getCompressionOption()
    {
    ...
    {
        return mIsRoamingAllowed;
    }

    public boolean isShortLived()
    {
        return mIsShortLived;
    }
    ...
    public void setIsAnonymousCredentialsAllowed(boolean flag)
    {
