...
public interface ISessionUserChanger
    extends IInterface
{
        ...
        implements ISessionUserChanger
    {
        ...
        public static ISessionUserChanger asInterface(IBinder ibinder)
        {
            ...
            IInterface iinterface = ibinder.queryLocalInterface("com.amazon.dcp.sso.ISessionUserChanger");
    ...
    public abstract String[] addSessionUserDirectedIds(String as[])
        throws RemoteException;

    public abstract ParcelableAccount[] addSessionUsers(ParcelableAccount aparcelableaccount[])
        throws RemoteException;

    public abstract String[] changeSessionUserDirectedIds(String as[])
        throws RemoteException;

    public abstract ParcelableAccount[] changeSessionUsers(ParcelableAccount aparcelableaccount[])
        throws RemoteException;

    public abstract String[] removeSessionUserDirectedIds(String as[])
        throws RemoteException;

    public abstract ParcelableAccount[] removeSessionUsers(ParcelableAccount aparcelableaccount[])
        throws RemoteException;
}
