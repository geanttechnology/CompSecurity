...
//            ISubAuthenticatorResponse, IAmazonAccountAuthenticator

public interface ISubAuthenticator
    extends IInterface
{
        ...
        implements ISubAuthenticator
    {
        ...
        public static ISubAuthenticator asInterface(IBinder ibinder)
        {
            ...
            IInterface iinterface = ibinder.queryLocalInterface("com.amazon.dcp.sso.ISubAuthenticator");
            ...
            throws RemoteException
        {
            ...
            case 1: // '\001'
                ...
                ISubAuthenticatorResponse isubauthenticatorresponse = ISubAuthenticatorResponse.Stub.asInterface(parcel.readStrongBinder());
                ...
                getAuthToken(isubauthenticatorresponse, s, s2, s4, bundle, IAmazonAccountAuthenticator.Stub.asInterface(parcel.readStrongBinder()));
            ...
            case 3: // '\003'
                parcel.enforceInterface("com.amazon.dcp.sso.ISubAuthenticator");
                isubauthenticatorresponse1 = ISubAuthenticatorResponse.Stub.asInterface(parcel.readStrongBinder());
            ...
            updateAuthToken(isubauthenticatorresponse1, s1, s3, s5, bundle1, IAmazonAccountAuthenticator.Stub.asInterface(parcel.readStrongBinder()));
            parcel1.writeNoException();
            return true;
        }
...
_L4:
        ...
        {
            return "com.amazon.dcp.sso.ISubAuthenticator";
        }
...
_L4:
    ...
    public abstract void getAccountRemovalAllowed(ISubAuthenticatorResponse isubauthenticatorresponse, String s, String s1)
        throws RemoteException;

    public abstract void getAuthToken(ISubAuthenticatorResponse isubauthenticatorresponse, String s, String s1, String s2, Bundle bundle, IAmazonAccountAuthenticator iamazonaccountauthenticator)
        throws RemoteException;

    public abstract void updateAuthToken(ISubAuthenticatorResponse isubauthenticatorresponse, String s, String s1, String s2, Bundle bundle, IAmazonAccountAuthenticator iamazonaccountauthenticator)
        throws RemoteException;
}
