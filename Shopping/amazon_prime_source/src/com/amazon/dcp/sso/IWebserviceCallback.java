    ...
    extends IInterface
{
        ...
        implements IWebserviceCallback
    {
        ...
        public static IWebserviceCallback asInterface(IBinder ibinder)
        {
            ...
            IInterface iinterface = ibinder.queryLocalInterface("com.amazon.dcp.sso.IWebserviceCallback");
        ...
        implements IWebserviceCallback
    {
        ...
        {
            return "com.amazon.dcp.sso.IWebserviceCallback";
        }
    ...
    public abstract void onResponseReceived(long l, Map map, byte abyte0[])
        throws RemoteException;
}
