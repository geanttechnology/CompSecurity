...
//            AdsIdentity, Configuration, DebugProperties, PreferredMarketplaceRetriever, 
//            Settings, SystemTime, TrustedPackageManager, AdsIdentityUserIdentifier, 
//            MobileAdsInfoStore
...
abstract class AdsIdentityContainer
{
    ...
    {
        userIdentifier = adsidentityuseridentifier;
        return this;
    }
}
