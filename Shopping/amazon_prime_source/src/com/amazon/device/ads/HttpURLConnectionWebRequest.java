...
//            WebRequest, MobileAdsLogger, WebUtils

class HttpURLConnectionWebRequest extends WebRequest
{

    private static final String LOGTAG = com/amazon/device/ads/HttpURLConnectionWebRequest.getSimpleName();
...
_L2:
        ...
        {
            for (obj = postParameters.entrySet().iterator(); ((Iterator) (obj)).hasNext(); stringbuilder.append((String)((java.util.Map.Entry) (obj1)).getKey()).append("=").append(WebUtils.getURLEncodedString((String)((java.util.Map.Entry) (obj1)).getValue())).append("&"))
            {
...
_L3:
        httpurlconnection;
        getLogger().e("Problem while closing output stream writer for request body: %s", new Object[] {
...
_L8:
        ...
        getLogger().e("Problem while creating output steam for request body: %s", new Object[] {
...
_L7:
        ...
        throws WebRequest.WebRequestException
    {
        ...
        {
            getLogger().e("Problem while opening the URL connection: %s", new Object[] {
                url.getMessage()
            });
        ...
        {
            getLogger().e("Socket timed out while connecting to URL: %s", new Object[] {
                url.getMessage()
            });
        ...
        {
            getLogger().e("Problem while connecting to URL: %s", new Object[] {
                url.getMessage()
            });
            throw new WebRequest.WebRequestException(this, WebRequest.WebRequestStatus.NETWORK_FAILURE, "Probem while connecting to URL", url);
        }
        ...
        throws WebRequest.WebRequestException
    {
        ...
        {
            getLogger().e("Socket Timeout while getting the response status code: %s", new Object[] {
                httpurlconnection.getMessage()
            });
        ...
        {
            getLogger().e("IOException while getting the response status code: %s", new Object[] {
                httpurlconnection.getMessage()
            });
        ...
        {
            getLogger().e("IndexOutOfBoundsException while getting the response status code: %s", new Object[] {
                httpurlconnection.getMessage()
            });
