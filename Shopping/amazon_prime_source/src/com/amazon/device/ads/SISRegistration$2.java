...
//            SISRegistration, MobileAdsLogger
    ...
    implements igurationListener
{
    ...
    {
        SISRegistration.access$000(SISRegistration.this).w("Configuration fetching failed so device registration will not proceed.");
        val$latch.countDown();
    }
