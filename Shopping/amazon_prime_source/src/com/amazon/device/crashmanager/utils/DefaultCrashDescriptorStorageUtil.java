...
public class DefaultCrashDescriptorStorageUtil
    implements CrashDescriptorStorageUtil
{
    ...
    public DefaultCrashDescriptorStorageUtil(SharedPreferences sharedpreferences, int i, long l)
    {
...
_L1:
    ...
    {
        mCache.clear();
        mLastCacheCleanupMs = System.currentTimeMillis();
        persistCrashDescriptors();
    }
    ...
    public void clearPersistentStorage()
    {
        ...
        editor.clear();
        editor.commit();
        log.info("clearPersistentStorage", "Cleared Shared Preferences", new Object[0]);
    }
    ...
    {
        return Arrays.asList(mCache.keySet().toArray(new String[0]));
    }
