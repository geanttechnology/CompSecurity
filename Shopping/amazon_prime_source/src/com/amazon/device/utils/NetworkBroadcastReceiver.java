...
_L3:
    ...
    public void registerNetworkListener(NetworkListener networklistener)
    {
        this;
        JVM INSTR monitorenter ;
        if (!mNetworkListenerList.contains(networklistener))
        {
            mNetworkListenerList.add(networklistener);
        }
        tryRegister();
        this;
        JVM INSTR monitorexit ;
    ...
    public void unregisterNetworkListener(NetworkListener networklistener)
    {
        ...
        if (mNetworkListenerList.contains(networklistener))
        {
            mNetworkListenerList.remove(networklistener);
        }
        tryUnregister();
        this;
        JVM INSTR monitorexit ;
