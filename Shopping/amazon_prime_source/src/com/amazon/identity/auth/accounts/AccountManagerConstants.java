...
public final class AccountManagerConstants
{
    ...
    public static final class GetCookiesParams.COOKIE_TYPE extends Enum
    {
        ...
        {
            return (GetCookiesParams.COOKIE_TYPE)Enum.valueOf(com/amazon/identity/auth/accounts/AccountManagerConstants$GetCookiesParams$COOKIE_TYPE, s);
        }
    ...
    public static final class GetTokenParams.TOKEN_TYPE extends Enum
    {
        ...
        {
            return (GetTokenParams.TOKEN_TYPE)Enum.valueOf(com/amazon/identity/auth/accounts/AccountManagerConstants$GetTokenParams$TOKEN_TYPE, s);
        }
    ...
    public static final class LOCALE extends Enum
    {
        ...
        {
            return (LOCALE)Enum.valueOf(com/amazon/identity/auth/accounts/AccountManagerConstants$LOCALE, s);
        }
    ...
    public static class REGION_HINT extends Enum
    {
        ...
        {
            return (REGION_HINT)Enum.valueOf(com/amazon/identity/auth/accounts/AccountManagerConstants$REGION_HINT, s);
        }
    ...
    public static final class TOKEN_EXCHANGER_TYPE extends Enum
    {
        ...
        {
            return (TOKEN_EXCHANGER_TYPE)Enum.valueOf(com/amazon/identity/auth/accounts/AccountManagerConstants$TOKEN_EXCHANGER_TYPE, s);
        }
