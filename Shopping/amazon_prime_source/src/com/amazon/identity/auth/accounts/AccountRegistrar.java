...
//            AccountRegistrarAuthenticator, AccountDataCollector
...
_L1:
    ...
    {
        return !StringUtil.isEmptyOrWhitespace(mDeviceInfo.getDeviceSecret());
    }
...
_L14:
    ...
    public void updateCredentials$11350a19(Listener listener, String s, String s1, Bundle bundle, Tracer tracer)
    {
        ...
        {
            doUpdateCredentials(bundle.getString("com.amazon.dcp.sso.AddAccount.options.URL"), s, s1, listener, tracer);
            return;
        }
    }
