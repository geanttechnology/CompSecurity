    ...
    implements Runnable
{
    ...
    public void run()
    {
        ...
        bundle = ((Bundle) (obj));
_L2:
        CentralCustomerAttributeStoreCommunication.access$200$556cb143$6c7269f3(val$callbackFuture, bundle, 5, String.format("Unable to set the attribute for key: %s.", new Object[] {
            val$key
        }));
        return;
        RemoteMAPException remotemapexception;
        remotemapexception;
        MAPLog.e(CentralCustomerAttributeStoreCommunication.access$300(), "Failed to setAttribute in central customer attribute store", remotemapexception);
