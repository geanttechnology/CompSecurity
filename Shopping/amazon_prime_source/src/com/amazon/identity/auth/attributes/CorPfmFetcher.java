...
public class CorPfmFetcher
{
        ...
        throws IOException
    {
        ...
        obj = inputstream1;
        obj1 = inputstream1;
        Object obj2 = new JSONObject(new String(StreamUtils.readInputStream(inputstream1)));
        inputstream = inputstream1;
        obj = inputstream1;
        obj1 = inputstream1;
        ...
        obj = inputstream1;
        obj1 = inputstream1;
        String s = JSONHelpers.getStringOrDefault(((JSONObject) (obj3)), "pfm", null);
        inputstream = inputstream1;
        obj = inputstream1;
        obj1 = inputstream1;
        ...
        obj = inputstream1;
        obj1 = inputstream1;
        MAPLog.i(TAG, String.format("Received response with: %nCoR: %s %nPFM:%s %nSource Of Computation CoR: %s %n Source Of Computation PFM: %s %n Computation Confidence Value: %s", new Object[] {
            obj2, s, s1, s2, obj3
        }));
        inputstream = inputstream1;
        obj = inputstream1;
