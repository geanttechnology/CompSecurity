...
public class KindleStoreCredentialsRequestAction
{
        ...
        throws IOException
    {
        ...
        inputstream = inputstream2;
        inputstream1 = inputstream2;
        ((XMLParser) (obj1)).parseChunk(abyte0, abyte0.length);
        inputstream = inputstream2;
        inputstream1 = inputstream2;
    ...
    public boolean updateStoreCredentialCookies(String s)
    {
        ...
        {
            s = new AccountTransaction(s, null, null);
            s.setUserData("com.amazon.dcp.sso.token.cookie.xmain", cookiejar.getXmain());
            s.setUserData("com.amazon.dcp.sso.token.cookie.xmainAndXabcCookies", cookiejar.getInternationalXMainAndXAcbCookies());
            mBackCompatDataStorage.setData(s);
            return true;
        }
    }
