...
private class <init> extends TimerTask
{
    ...
    public void run()
    {
        if (AuthPortalUIActivity.access$000(AuthPortalUIActivity.this) != null)
        {
            String s = (new StringBuilder()).append(AuthPortalUIActivity.access$100(AuthPortalUIActivity.this)).append(":NetworkState:").append(MetricUtils.isNetworkAvailable(AuthPortalUIActivity.access$200(AuthPortalUIActivity.this))).toString();
            AuthPortalUIActivity.access$000(AuthPortalUIActivity.this).incrementCounter(s);
        }
