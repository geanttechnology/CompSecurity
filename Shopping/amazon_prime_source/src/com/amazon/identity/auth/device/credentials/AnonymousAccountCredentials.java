...
public class AnonymousAccountCredentials extends AccountCredentials
{
    ...
    public boolean isStale$faab209()
    {
        ...
        {
            String s = mDataStorage.getDeviceData(ANONYMOUS_CREDENTIALS_NAMESPACE, "com.amazon.dcp.sso.token.device.adptoken");
            String s1 = mDataStorage.getDeviceData(ANONYMOUS_CREDENTIALS_NAMESPACE, "com.amazon.dcp.sso.token.device.privatekey");
            if (mAdpToken != null && mAdpToken.equals(s) && mPrivateKey != null && mPrivateKey.equals(s1))
            {
                return false;
            }
        }
