    ...
    implements ContentProviderClientCallback
{
    ...
    public DeviceDataInfo useContentProviderClient(ContentProviderClient contentproviderclient)
        throws Exception
    {
        contentproviderclient = contentproviderclient.query(DeviceDataCommunication.DEVICE_DATA_STORE_URI, DeviceDataCommunication.access$000(), val$key, null, null);
        ...
        throw exception;
        Object obj;
        DeviceDataCommunication.access$200$7e2d3e40(contentproviderclient);
