...
public class OpenIdRequest
{
    public static final class REQUEST_TYPE extends Enum
    {
        ...
        public static final REQUEST_TYPE FORGOT_PASSWORD;
        ...
        static 
        {
            ...
            FORGOT_PASSWORD = new REQUEST_TYPE("FORGOT_PASSWORD", 4);
...
label0:
        ...
        if (!TextUtils.isEmpty(s1) && !TextUtils.isEmpty(s1.trim()))
        {
            ...
            if (TextUtils.isEmpty(mUriBuilder.build().getPath()))
            {
                ...
                if (mType == REQUEST_TYPE.FORGOT_PASSWORD)
                {
                    mUriBuilder.path("/ap/forgotpassword");
                } else
                {
