    ...
    implements Runnable
{
    ...
    final val.arg1 this$1;
    final byte val$arg0[];
    final int val$arg1;

    public void run()
    {
        callback.onBodyChunkReceived(val$arg0, val$arg1);
    }
...
/* anonymous class */
        ...
        implements IAmazonWebServiceCallback
    {
        ...
        {
            HandlerHelpers.postAndWait(AsyncAmazonWebserviceCall.access$000(AsyncAmazonWebserviceCall.this), i. new AsyncAmazonWebserviceCall._cls1._cls1());
        }
