...
public class AuthEndpointErrorParser
{
    ...
    public static final class AuthErrorType extends Enum
    {
        ...
        static 
        {
            ...
            GenericError = new AuthErrorType("GenericError", 13);
            ...
            BuildRequestFailure = new AuthErrorType("BuildRequestFailure", 16, "BuildRequestFailure", false, com.amazon.identity.auth.device.api.MAPAccountManager.RegistrationError.BAD_REQUEST);
            NetworkFailure = new AuthErrorType("NetworkFailure", 17, "NetworkFailure", true, com.amazon.identity.auth.device.api.MAPAccountManager.RegistrationError.NETWORK_FAILURE);
        ...
        private AuthErrorType(String s, int i)
        {
            this(s, i, "GenericError", false, com.amazon.identity.auth.device.api.MAPAccountManager.RegistrationError.UNRECOGNIZED);
        }
    ...
    private AuthEndpointError getAuthEndpointError(JSONObject jsonobject)
        throws JSONException
    {
        ...
        } else
        {
            ...
            return new AuthEndpointError(AuthErrorType.getAuthErrorTypeFromCode(jsonobject1.getString("code")), JSONHelpers.getStringOrDefault(jsonobject1, "message", null), JSONHelpers.getStringOrDefault(jsonobject1, "detail", null), jsonobject);
        }
    }

    public String getServerErrorCode(JSONObject jsonobject)
    {
        jsonobject = getAuthEndpointError(jsonobject);
        if (jsonobject == null)
        {
            break MISSING_BLOCK_LABEL_21;
        }
        jsonobject = jsonobject.getAuthTypeError().getCode();
        return jsonobject;
        jsonobject;
        return null;
    }
