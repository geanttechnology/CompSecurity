...
_L4:
        componentname = mComponentName;
          goto _L3
        (new StringBuilder("Found service ")).append(mComponentName);
          goto _L4
        Exception exception;
        exception;
        throw exception;
    ...
    public void onServiceConnected(ComponentName componentname, IBinder ibinder)
    {
        this;
        JVM INSTR monitorenter ;
        (new StringBuilder("onServiceConnected: ")).append(mComponentName);
    ...
    public void onServiceDisconnected(ComponentName componentname)
    {
        this;
        JVM INSTR monitorenter ;
        (new StringBuilder("onServiceDisconnected: ")).append(mComponentName);
        mBoundService = null;
    ...
    public boolean tryToBind()
    {
        ...
        if (mBoundService == null) goto _L2; else goto _L1
_L1:
        (new StringBuilder("already bound: ")).append(mComponentName);
_L4:
        this;
        JVM INSTR monitorexit ;
        return flag;
_L2:
        if (mBindInitiated)
        {
            (new StringBuilder("bind already initiated: ")).append(mComponentName);
        ...
        {
            (new StringBuilder("binding: ")).append(mComponentName);
            mBindInitiated = true;
            continue; /* Loop/switch isn't completed */
        }
        ...
        MAPLog.w(TAG, (new StringBuilder("bind failed: ")).append(mComponentName).toString(), componentname);
        flag = false;
        continue; /* Loop/switch isn't completed */
        MetricsHelper.incrementCounter("BindFailed", new String[0]);
