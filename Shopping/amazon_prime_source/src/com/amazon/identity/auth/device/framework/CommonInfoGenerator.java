...
//            ServiceWrappingContext, MAPApplicationInformationQueryer, DeviceInfoHolder, AESCipher

public class CommonInfoGenerator
{

    private static final String TAG = com/amazon/identity/auth/device/framework/CommonInfoGenerator.getName();
    ...
    {
        com/amazon/identity/auth/device/framework/CommonInfoGenerator;
    ...
    public int generateCommonInfo()
    {
        ...
        {
            String s = AESCipher.generateAesSecureStorageKeyForDevice(DeviceInfoHolder.getInstance(mContext));
