...
//            ServiceWrappingContext, CommonInfoGenerator, RemoteMAPException, MAPApplicationInformationQueryer, 
//            RemoteMapInfo

public class CommonInfoGetter
{

    private static final String TAG = com/amazon/identity/auth/device/framework/CommonInfoGetter.getName();
...
_L1:
    ...
    {
        com/amazon/identity/auth/device/framework/CommonInfoGetter;
    ...
    {
        return !CentralApkUtils.hasCentralAPK(context) || CentralApkUtils.isRunningInCentralAPK(context);
    }
