...
_L2:
        ...
        return ((Map) (obj));
_L4:
        ((Map) (obj)).put(s, new RemoteMapInfo(mContext));
          goto _L5
        obj;
        throw obj;
...
_L1:
        ...
        if (((RemoteMapInfo) (obj1)).compareLatest(((RemoteMapInfo) (obj))) <= 0) goto _L4; else goto _L3
_L3:
        String s = ((RemoteMapInfo) (obj1)).getPackageName();
        if (obj == null)
        {
