...
public class MAPSmsReceiver extends BroadcastReceiver
{
    ...
    private static final String TAG = com/amazon/identity/auth/device/framework/MAPSmsReceiver.getName();
                ...
                public void run()
                {
                    if (intent.getAction().equals("android.provider.Telephony.SMS_RECEIVED"))
                    {
                        ...
                        if (obj != null)
                        {
                            ...
                            (new StringBuilder("Receiving message from: ")).append(((String) (obj))).append(". Message body:").append(s);
