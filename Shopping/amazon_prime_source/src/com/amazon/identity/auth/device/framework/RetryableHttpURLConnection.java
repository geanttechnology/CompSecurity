...
class RetryableHttpURLConnection extends WrappableHttpURLConnection
{
        ...
        throws IOException
    {
        ...
        tracer = mTracer;
        obj = ((HttpURLConnection) (obj)).getURL();
        tracer.incrementCounter((new StringBuilder()).append(MetricUtils.getUrlPathAndDomain(((URL) (obj)))).append(":AllRetriesFailed").toString());
