...
public final class CentralLocalDataStorage extends DataStorage
{
    ...
    {
        MAPLog.i(TAG, (new StringBuilder("Setting ")).append(s).append(" as initialized in CentralLocalDataStorage").toString());
...
_L2:
        ...
        MAPLog.i(TAG, (new StringBuilder("Is CentralLocalDataStorage account data initialized in shared preferences:")).append(sAccountDataInitialized).toString());
...
_L4:
        ...
        MAPLog.i(TAG, (new StringBuilder("Is CentralLocalDataStorage device data initialized in shared preferences:")).append(sDeviceDataInitialized).toString());
