...
public class LocalDataStorage
{
    ...
    static class LocalDataStorageDBHelper extends SQLiteOpenHelper
    {
        ...
        public LocalDataStorageDBHelper(Context context, String s)
        {
    ...
    private static final String NON_SENSITIVE_KEYS[] = {
        "com.amazon.dcp.sso.property.account.ACCOUNT_STATUS", "has.notified.server.of.deregister"
    };
    ...
    {
        mContext = context;
        mLocalDataStorageHelper = new LocalDataStorageDBHelper(context, "map_data_storage");
...
label1:
    ...
    private void appendToStringBuilder(StringBuilder stringbuilder, Object obj)
    {
    ...
    private void getCommonDataForSnapshot(StringBuilder stringbuilder, DatabaseValue databasevalue)
    {
        appendToStringBuilder(stringbuilder, TimeUtil.serialize(databasevalue.getDateTime()));
        appendToStringBuilder(stringbuilder, String.valueOf(databasevalue.isDeleted()));
        appendToStringBuilder(stringbuilder, String.valueOf(databasevalue.isDirty()));
        stringbuilder.append("\n");
    }
...
_L1:
    ...
    private void putTableRowInSnapshot(StringBuilder stringbuilder, String s, String s1, DatabaseValue databasevalue)
    {
        boolean flag1 = false;
        appendToStringBuilder(stringbuilder, s);
        appendToStringBuilder(stringbuilder, s1);
        s = NON_SENSITIVE_KEYS;
        int j = s.length;
        int i = 0;
        do
        {
label0:
            {
                ...
                if (flag)
                {
                    appendToStringBuilder(stringbuilder, databasevalue.getValue());
                } else
                {
                    appendToStringBuilder(stringbuilder, "");
                }
                getCommonDataForSnapshot(stringbuilder, databasevalue);
                return;
            }
            i++;
        } while (true);
    ...
    private void setTableItemBeforeTimeNotDirty(SQLiteDatabase sqlitedatabase, String s, String s1, String s2, Date date)
    {
        ...
        String.format("Update %d items not dirty in table %s.", new Object[] {
            Integer.valueOf(sqlitedatabase.update(s, contentvalues, String.format("%s <= ?", new Object[] {
                s1
            }), new String[] {
...
_L8:
    ...
    public String getDBSnapshot()
    {
        ...
        iterator1 = getAccountInfos().entrySet().iterator();
_L1:
        Object obj1;
        int i;
        ...
        DatabaseValue databasevalue = (DatabaseValue)((java.util.Map.Entry)iterator1.next()).getValue();
        obj1 = (AccountInfo)databasevalue.getValue();
        if (!arraylist.contains(((AccountInfo) (obj1)).directedId))
        {
            arraylist.add(((AccountInfo) (obj1)).directedId);
        }
        i = arraylist.indexOf(((AccountInfo) (obj1)).directedId);
        appendToStringBuilder(((StringBuilder) (obj)), Integer.valueOf(i));
        appendToStringBuilder(((StringBuilder) (obj)), "");
        getCommonDataForSnapshot(((StringBuilder) (obj)), databasevalue);
        java.util.Map.Entry entry3;
        for (Iterator iterator3 = ((AccountInfo) (obj1)).userdata.entrySet().iterator(); iterator3.hasNext(); putTableRowInSnapshot(((StringBuilder) (obj)), String.valueOf(i), (String)entry3.getKey(), (DatabaseValue)entry3.getValue()))
        {
        ...
        obj;
        throw obj;
        obj1 = ((AccountInfo) (obj1)).tokens.entrySet().iterator();
        while (((Iterator) (obj1)).hasNext()) 
        {
            java.util.Map.Entry entry1 = (java.util.Map.Entry)((Iterator) (obj1)).next();
            putTableRowInSnapshot(((StringBuilder) (obj)), String.valueOf(i), (String)entry1.getKey(), (DatabaseValue)entry1.getValue());
        }
          goto _L1
        for (Iterator iterator = getDeviceData().entrySet().iterator(); iterator.hasNext();)
        {
            ...
            while (iterator2.hasNext()) 
            {
                ...
                putTableRowInSnapshot(((StringBuilder) (obj)), (String)entry.getKey(), (String)entry2.getKey(), (DatabaseValue)entry2.getValue());
            }
        }
