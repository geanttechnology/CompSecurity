...
public class AmazonWebviewSharedPrefCookieUtils
{
    ...
    public void addCookiesToSharedPrefs(String s, String as[])
    {
        ...
        s1 = mSharedPrefs.getString("com.amazon.identity.auth.device.utils.CookieAuthorityInfo.URL", null);
        s2 = mSharedPrefs.getString(s, null);
        s3 = getCurrentRegistrationUUID();
        s4 = mSharedPrefs.getString("com.amazon.identity.auth.device.utils.CookieAuthorityInfo.REGISTRATION_UUID", null);
        ...
        if (!TextUtils.equals(s3, s4))
        {
            editor.putString("com.amazon.identity.auth.device.utils.CookieAuthorityInfo.REGISTRATION_UUID", s3);
        }
        editor.commit();
    }
