...
_L1:
        ...
        throws InvalidKeySpecException
    {
        ...
        (new StringBuilder("Key Factory created using the algorithm as ")).append(keyfactory.getAlgorithm());
        Object obj = new PKCS8EncodedKeySpec(Base64.decode(replacePrivateKeyHeaderAndFooter(s).getBytes(), 0));
        try
        {
