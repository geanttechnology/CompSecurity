...
_L1:
    ...
    RegisterDeviceResponse parseErrorResponse(Document document)
    {
        ...
        KindleWebserviceError kindlewebserviceerror;
        FIRSError firserror;
        ...
        kindlewebserviceerror = KindleWebserviceErrorParser.parseError(document);
...
_L2:
        if (kindlewebserviceerror == null) goto _L9; else goto _L10
_L10:
        switch (_cls1..SwitchMap.com.amazon.identity.kcpsdk.common.KindleWebserviceErrorType[kindlewebserviceerror.getErrorType().ordinal()])
        {
        default:
