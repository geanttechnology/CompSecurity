    ...
    private void initalizeWebView()
    {
        ...
        mWebView.setWebViewClient(new MASHWebViewClient(mActivity, mWebView, null, null) {
            ...
            public void onPageFinished(WebView webview, String s)
            {
                ...
                updateNavigationButtons(mWebView);
                findViewById(com.amazon.mobile.mash.R.id.embedded_browser_spinner).setVisibility(4);
            ...
            public void onPageStarted(WebView webview, String s, Bitmap bitmap)
            {
                ...
                updateNavigationButtons(mWebView);
                findViewById(com.amazon.mobile.mash.R.id.refresh_button).setVisibility(4);
