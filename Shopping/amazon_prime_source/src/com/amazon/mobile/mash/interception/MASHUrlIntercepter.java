...
public class MASHUrlIntercepter
{
    protected static final class UrlDestination extends Enum
    {
        ...
        public static final UrlDestination order_status;
        public static final UrlDestination prime_sign_up;
        public static final UrlDestination search;
        public static final UrlDestination your_account;
        ...
        static 
        {
            ...
            order_status = new UrlDestination("order_status", 7);
            your_account = new UrlDestination("your_account", 8);
            prime_sign_up = new UrlDestination("prime_sign_up", 9);
    ...
    public UrlIntercepterConfigEntry getConfigEntryForUri(Uri uri)
    {
        ...
        Uri uri1 = uri.buildUpon().path(MASHUtil.removeEverythingAfterRefMarker(uri.getPath())).build();
        for (obj = ((ArrayList) (obj)).iterator(); ((Iterator) (obj)).hasNext();)
        {
            ...
            if (urlintercepterconfigentry.matches(uri1.toString()))
            {
