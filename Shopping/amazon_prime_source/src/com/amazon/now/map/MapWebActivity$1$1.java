...
class this._cls1
    implements com.amazon.geo.mapsv2.lickListener
{
    ...
    {
        if (MapWebActivity.access$000(_fld0) != null)
        {
            MapWebActivity.access$000(_fld0).hideInfoWindow();
            if (MapWebActivity.access$000(_fld0).equals(marker))
            {
        ...
        MapWebActivity.access$002(_fld0, marker);
        return true;
    }
...
/* anonymous class */
        ...
        implements OnMapReadyCallback
    {
        ...
        // Unreferenced inner class com/amazon/now/map/MapWebActivity$1$2

/* anonymous class */
        class MapWebActivity._cls1._cls2
            implements com.amazon.geo.mapsv2.AmazonMap.OnMapClickListener
        {
