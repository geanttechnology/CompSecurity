    ...
    implements com.amazon.now.cart.lback
{
    ...
    // Unreferenced inner class com/amazon/now/mash/api/MASHHoudiniPlugin$5

/* anonymous class */
    class MASHHoudiniPlugin._cls5
        implements Runnable
    {
        ...
        public void run()
        {
            ...
            {
                CartController.getInstance().removeItem(activity, s, i, s1, new MASHHoudiniPlugin._cls5._cls1());
            }
        }
