    ...
    implements Runnable
{
    ...
    final l.returnUrl this$1;
    final Activity val$activity;

    public void run()
    {
        ((WebActivity)val$activity).loadUrl(returnUrl);
    }

    l.returnUrl()
    {
        this$1 = final_returnurl;
...
/* anonymous class */
        ...
        implements com.amazon.now.account.SSO.SignInCallback
    {
        ...
        public void success(Activity activity1)
        {
            if (!TextUtils.isEmpty(returnUrl) && (activity1 instanceof WebActivity))
            {
                runOnUiThread(activity1. new WebActivity._cls2._cls1());
            }
        }
        ...
        // Unreferenced inner class com/amazon/now/web/WebActivity$2$2

/* anonymous class */
        class WebActivity._cls2._cls2
            implements Runnable
        {
