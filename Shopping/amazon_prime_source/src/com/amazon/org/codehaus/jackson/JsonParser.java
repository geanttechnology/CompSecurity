    ...
    implements Versioned, Closeable
{
    public static final class Feature extends Enum
    {
        ...
        {
            return (Feature)Enum.valueOf(com/amazon/org/codehaus/jackson/JsonParser$Feature, s);
        }
    ...
    public static final class NumberType extends Enum
    {
        ...
        {
            return (NumberType)Enum.valueOf(com/amazon/org/codehaus/jackson/JsonParser$NumberType, s);
        }
