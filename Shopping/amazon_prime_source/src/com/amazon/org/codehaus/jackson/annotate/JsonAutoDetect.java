...
// Referenced classes of package com.amazon.org.codehaus.jackson.annotate:
//            JsonMethod
    ...
    extends Annotation
{
    public static final class Visibility extends Enum
    {
        ...
        {
            return (Visibility)Enum.valueOf(com/amazon/org/codehaus/jackson/annotate/JsonAutoDetect$Visibility, s);
        }
        ...
        public boolean isVisible(Member member)
        {
            ...
            static class _cls1
            {
                ...
                static final int $SwitchMap$com$amazon$org$codehaus$jackson$annotate$JsonAutoDetect$Visibility[];

                static 
                {
                    $SwitchMap$com$amazon$org$codehaus$jackson$annotate$JsonAutoDetect$Visibility = new int[Visibility.values().length];
                    try
                    {
            ...
            _cls1..SwitchMap.com.amazon.org.codehaus.jackson.annotate.JsonAutoDetect.Visibility[ordinal()];
