...
static class 
{
    ...
    static 
    {
        ...
        $SwitchMap$com$amazon$org$codehaus$jackson$JsonParser$NumberType = new int[com.amazon.org.codehaus.jackson.e.values().length];
        try
        {
            $SwitchMap$com$amazon$org$codehaus$jackson$JsonParser$NumberType[com.amazon.org.codehaus.jackson.e.INT.ordinal()] = 1;
        }
        catch (NoSuchFieldError nosuchfielderror3) { }
        try
        {
            $SwitchMap$com$amazon$org$codehaus$jackson$JsonParser$NumberType[com.amazon.org.codehaus.jackson.e.BIG_INTEGER.ordinal()] = 2;
        }
        catch (NoSuchFieldError nosuchfielderror2) { }
        try
        {
            $SwitchMap$com$amazon$org$codehaus$jackson$JsonParser$NumberType[com.amazon.org.codehaus.jackson.e.BIG_DECIMAL.ordinal()] = 3;
        }
        catch (NoSuchFieldError nosuchfielderror1) { }
        try
        {
            $SwitchMap$com$amazon$org$codehaus$jackson$JsonParser$NumberType[com.amazon.org.codehaus.jackson.e.FLOAT.ordinal()] = 4;
        }
