...
label0:
    ...
    {
        while (isEnabled(com.amazon.org.codehaus.jackson.JsonParser.Feature.ALLOW_BACKSLASH_ESCAPING_ANY_CHARACTER) || c == '\'' && isEnabled(com.amazon.org.codehaus.jackson.JsonParser.Feature.ALLOW_SINGLE_QUOTES)) 
        {
            return c;
        }
    ...
    protected void _throwUnquotedSpace(int i, String s)
        throws JsonParseException
    {
        if (!isEnabled(com.amazon.org.codehaus.jackson.JsonParser.Feature.ALLOW_UNQUOTED_CONTROL_CHARS) || i >= 32)
        {
            i = (char)i;
