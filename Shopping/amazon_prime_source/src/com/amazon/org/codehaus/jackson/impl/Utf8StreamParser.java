...
//            JsonParserBase, JsonReadContext
...
public final class Utf8StreamParser extends JsonParserBase
{
            ...
            int k, boolean flag)
    {
        ...
        if (!com.amazon.org.codehaus.jackson.JsonParser.Feature.CANONICALIZE_FIELD_NAMES.enabledIn(i))
        {
            _throwInternal();
        }
    }
...
_L4:
    ...
    private final void _skipComment()
        throws IOException, JsonParseException
    {
        if (!isEnabled(com.amazon.org.codehaus.jackson.JsonParser.Feature.ALLOW_COMMENTS))
        {
...
_L2:
        ...
        if (!isEnabled(com.amazon.org.codehaus.jackson.JsonParser.Feature.ALLOW_NUMERIC_LEADING_ZEROS))
        {
...
_L3:
        ...
        throws IOException
    {
        ...
        {
            if (_ioContext.isResourceManaged() || isEnabled(com.amazon.org.codehaus.jackson.JsonParser.Feature.AUTO_CLOSE_SOURCE))
            {
                _inputStream.close();
            }
            _inputStream = null;
...
_L3:
        ...
        _matchToken(s, 3);
        if (isEnabled(com.amazon.org.codehaus.jackson.JsonParser.Feature.ALLOW_NON_NUMERIC_NUMBERS))
        {
            if (!flag)
            {
                d = (1.0D / 0.0D);
...
_L1:
        ...
        return null;
_L2:
        if (isEnabled(com.amazon.org.codehaus.jackson.JsonParser.Feature.ALLOW_SINGLE_QUOTES))
        {
...
_L3:
    ...
    protected final Name _handleUnusualFieldName(int i)
        throws IOException, JsonParseException
    {
        if (i != 39 || !isEnabled(com.amazon.org.codehaus.jackson.JsonParser.Feature.ALLOW_SINGLE_QUOTES)) goto _L2; else goto _L1
_L1:
        Name name = _parseApostropheFieldName();
_L4:
        return name;
_L2:
        if (!isEnabled(com.amazon.org.codehaus.jackson.JsonParser.Feature.ALLOW_UNQUOTED_FIELD_NAMES))
        {
...
_L3:
        ...
        throws IOException, JsonParseException
    {
        ...
        _cls1..SwitchMap.com.amazon.org.codehaus.jackson.JsonToken[_currToken.ordinal()];
...
_L3:
        _parsingContext = _parsingContext.createChildObjectContext(_tokenInputRow, _tokenInputCol);
        return null;
        switch (_cls1..SwitchMap.com.amazon.org.codehaus.jackson.JsonToken[nextToken().ordinal()])
        {
        default:
            return null;
