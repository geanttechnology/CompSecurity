...
protected static final class ateRootContext extends JsonParserMinimalBase
{
        ...
        throws IOException, JsonParseException
    {
        ...
        switch (chMap.com.amazon.org.codehaus.jackson.JsonParser.NumberType[getNumberType().ordinal()])
        {
        default:
    ...
    public com.amazon.org.codehaus.jackson.pe getNumberType()
        throws IOException, JsonParseException
    {
        Number number = getNumberValue();
        if (number instanceof Integer)
        {
            return com.amazon.org.codehaus.jackson.pe.INT;
        }
        if (number instanceof Long)
        {
            return com.amazon.org.codehaus.jackson.pe.LONG;
        }
        if (number instanceof Double)
        {
            return com.amazon.org.codehaus.jackson.pe.DOUBLE;
        }
        if (number instanceof BigDecimal)
        {
            return com.amazon.org.codehaus.jackson.pe.BIG_DECIMAL;
        }
        if (number instanceof Float)
        {
            return com.amazon.org.codehaus.jackson.pe.FLOAT;
        }
        if (number instanceof BigInteger)
        {
            return com.amazon.org.codehaus.jackson.pe.BIG_INTEGER;
        } else
        {
            return null;
        }
...
_L2:
        ...
        {
            Object obj2;
            switch (chMap.com.amazon.org.codehaus.jackson.JsonToken[_currToken.ordinal()])
            {
            default:
