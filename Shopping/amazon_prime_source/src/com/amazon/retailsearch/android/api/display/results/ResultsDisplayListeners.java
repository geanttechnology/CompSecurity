...
public interface ResultsDisplayListeners
{
    ...
    public abstract void addListener(SearchQuerySubmitListener searchquerysubmitlistener);

    public abstract void addListener(UrlLoadListener urlloadlistener);

    public abstract void addListener(AddToCartInteractionListener addtocartinteractionlistener);
    ...
    public abstract void removeListener(SearchQuerySubmitListener searchquerysubmitlistener);

    public abstract void removeListener(UrlLoadListener urlloadlistener);

    public abstract void removeListener(AddToCartInteractionListener addtocartinteractionlistener);
}
