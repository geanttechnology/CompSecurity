...
public static class 
{
    ...
    public RetailSearchResultItem build(String s, String s1, String s2, String s3)
    {
        ...
        RetailSearchResultItem.access$000(retailsearchresultitem, s);
        if (!TextUtils.isEmpty(s1))
        {
            RetailSearchResultItem.access$100(retailsearchresultitem, s1.replaceFirst(".*?/dp/", ""));
        }
        RetailSearchResultItem.access$200(retailsearchresultitem, s2);
        RetailSearchResultItem.access$300(retailsearchresultitem, s3);
