    ...
    implements MembersInjector, Provider
{
    ...
    private Binding searchDataStore;
    ...
    public void attach(Linker linker)
    {
        ...
        dataSource = linker.requestBinding("dagger.Lazy<com.amazon.retailsearch.interaction.SearchDataSource>", com/amazon/retailsearch/android/api/init/RetailSearchInitializer, getClass().getClassLoader());
        searchDataStore = linker.requestBinding("com.amazon.retailsearch.android.api.debug.SearchDebugDataStore", com/amazon/retailsearch/android/api/init/RetailSearchInitializer, getClass().getClassLoader());
    ...
    public void injectMembers(RetailSearchInitializer retailsearchinitializer)
    {
        ...
        retailsearchinitializer.dataSource = (Lazy)dataSource.get();
        retailsearchinitializer.searchDataStore = (SearchDebugDataStore)searchDataStore.get();
