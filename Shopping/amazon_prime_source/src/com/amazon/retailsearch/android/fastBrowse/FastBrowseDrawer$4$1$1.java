...
/* anonymous class */
    ...
    // Unreferenced inner class com/amazon/retailsearch/android/fastBrowse/FastBrowseDrawer$4$1

/* anonymous class */
    class FastBrowseDrawer._cls4._cls1
        implements RefinementsLoader.RefinementResultListener
    {

        final FastBrowseDrawer._cls4 this$1;
        ...
        public void onResult(SearchResult searchresult)
        {
            ...
            } else
            {
                ...
                searchresult = FastBrowseDrawer.access$1000(this$0).getRefinements().getDepartments().getCategories();
                java.util.List list = FastBrowseDrawer.access$1000(this$0).getRefinements().getDepartments().getAncestry();
                FastBrowseDrawer.access$1200(this$0, list, searchresult, null, null);
                FastBrowseDrawer.access$1100(this$0);
                if (searchresult == null)
                {
                    platform.invokeLater(new FastBrowseDrawer._cls4._cls1._cls1());
                    return;
                }
            }
        }
            ...
            {
                this$1 = FastBrowseDrawer._cls4.this;
                super();
            }
    }
