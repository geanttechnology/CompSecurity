...
_L6:
        if (!badgeID.equals(BadgeType.PRIME.getBadgeId()) && !badgeID.equals(BadgeType.PRIME_FRESH.getBadgeId()) && !badgeID.equals(BadgeType.PRIME_ONE_DAY.getBadgeId())) goto _L8; else goto _L7
_L7:
...
_L2:
        ...
        return;
_L8:
        if (!badgeID.equals(BadgeType.ADD_ON.getBadgeId()))
        {
            i = j;
            if (!badgeID.equals(BadgeType.PRIME_STANDARD.getBadgeId()))
            {
