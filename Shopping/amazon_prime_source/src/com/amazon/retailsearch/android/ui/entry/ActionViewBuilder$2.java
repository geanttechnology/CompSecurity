    ...
    implements android.view.
{
    ...
    {
        ActionViewBuilder.access$000(ActionViewBuilder.this).onQuerySubmit(new RetailSearchQuery("BARCODE_SEARCH_QUERY_KEYWORD"));
        ActionViewBuilder.access$100(ActionViewBuilder.this).recordScanItInvoked();
    }
