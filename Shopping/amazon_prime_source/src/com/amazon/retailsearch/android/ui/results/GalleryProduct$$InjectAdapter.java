    ...
    implements MembersInjector
{
    ...
    public void attach(Linker linker)
    {
        ...
        dataProvider = linker.requestBinding("dagger.Lazy<com.amazon.retailsearch.data.IRetailSearchDataProvider>", com/amazon/retailsearch/android/ui/results/GalleryProduct, getClass().getClassLoader());
    ...
    public void injectMembers(GalleryProduct galleryproduct)
    {
        ...
        galleryproduct.dataProvider = (Lazy)dataProvider.get();
