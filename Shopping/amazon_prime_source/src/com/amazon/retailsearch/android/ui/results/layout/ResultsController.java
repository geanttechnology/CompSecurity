...
//            LayoutElement, LayoutElementModel, StackLayoutState
...
label0:
            {
                if (i < size())
                {
                    LayoutElement layoutelement1 = get(i);
                    if (i > 0)
                    {
                        LayoutElement layoutelement2 = get(i - 1);
                    ...
                    if (stacklayoutstate != null && stacklayoutstate.getNextPosition() == layoutelement1.getPosition() && layoutelement.getSection() == 1)
                    {
                        stacklayoutstate.setNextPosition(layoutelement1.getPosition() + layoutelement1.getSpan());
                    }
    ...
    public void addAfter(LayoutElement layoutelement, LayoutElement layoutelement1, StackLayoutState stacklayoutstate)
    {
        Integer integer;
        if (layoutelement1 != null && layoutelement != null && layoutelement.getLayoutElementModel() != null && layoutelement.getLayoutElementModel().getCanonicalModel() != null)
        {
            if ((integer = (Integer)modelMap.get(layoutelement.getLayoutElementModel().getCanonicalModel())) != null)
            {
                layoutelement1.setSection(layoutelement.getSection());
                layoutelement1.setRequestedPosition(layoutelement.getRequestedPosition());
                layoutelement1.setPriority(layoutelement.getPriority());
                add(integer.intValue() + 1, layoutelement1, stacklayoutstate);
                return;
            }
        }
    }
