    ...
    implements MembersInjector
{
    ...
    public void attach(Linker linker)
    {
        ...
        userInteractionListener = linker.requestBinding("com.amazon.retailsearch.interaction.UserInteractionListener", com/amazon/retailsearch/android/ui/results/layout/view/NoResultsSetView, getClass().getClassLoader());
    }
    ...
    public void injectMembers(NoResultsSetView noresultssetview)
    {
        ...
        noresultssetview.userInteractionListener = (UserInteractionListener)userInteractionListener.get();
    }
