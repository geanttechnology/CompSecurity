    ...
    implements Runnable
{
    ...
    public void run()
    {
        MultiStoreOfferView.access$000(_fld0).setVisibility(0);
        MultiStoreOfferView.access$100(_fld0).setVisibility(8);
    }
    ...
    // Unreferenced inner class com/amazon/retailsearch/android/ui/results/views/MultiStoreOfferView$1

/* anonymous class */
    class MultiStoreOfferView._cls1
        implements InlineActionsListener
    {
        ...
        public void onAddToCartSuccess()
        {
            ...
            platform.invokeLater(new MultiStoreOfferView._cls1._cls1(), 800L);
        }
