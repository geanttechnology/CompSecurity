...
public class ImageWrapperConsumableList extends ImageWrapper
{

    public ImageWrapperConsumableList(Context context, AttributeSet attributeset)
    {
    ...
    protected void postInflate()
    {
        ...
        overlayMessage = (CartQuantityMessage)findViewById(com.amazon.retailsearch.R.id.rs_results_image_overlay_message);
    }
}
