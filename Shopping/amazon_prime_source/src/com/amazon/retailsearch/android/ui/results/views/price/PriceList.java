...
public class PriceList extends Price
{
    ...
    protected void postInflate()
    {
        ...
        savingsLine = (TextView)findViewById(com.amazon.retailsearch.R.id.rs_results_price_savings);
        somePrimeLine = (TextView)findViewById(com.amazon.retailsearch.R.id.rs_results_price_some_prime);
        inAppPurchaseLine = (TextView)findViewById(com.amazon.retailsearch.R.id.rs_results_in_app_purchase);
    }
}
