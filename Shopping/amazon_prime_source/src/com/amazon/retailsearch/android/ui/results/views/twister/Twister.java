    ...
    implements InteractiveRetailSearchResultView
{
    ...
    public void buildView(TwisterModel twistermodel, ResultLayoutType resultlayouttype)
    {
        ...
        {
            resultlayouttype.append(list, com.amazon.retailsearch.R.style.Results_Twister);
            resultlayouttype.append((new StringBuilder()).append(getResources().getString(com.amazon.retailsearch.R.string.twister_colon)).append(" ").toString(), com.amazon.retailsearch.R.style.Results_Twister);
            resultlayouttype.append(twistermodel, com.amazon.retailsearch.R.style.Results_Twister);
        } else
        {
            resultlayouttype.append(list, com.amazon.retailsearch.R.style.Results_TwisterLink);
        }
    ...
    {
        buildView((TwisterModel)obj, resultlayouttype);
    }
