...
public class TwisterDialog extends Dialog
{
    ...
    private static final MessageLogger log = AppLog.getLog(com/amazon/retailsearch/android/ui/results/views/twister/TwisterDialog);
    ...
    public void init(TwisterModel twistermodel)
    {
        ...
        mClose.setOnClickListener(new android.view.View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                ...
                {
                    TwisterDialog.log.error("Could not dismiss dialog", view);
                }
            }
