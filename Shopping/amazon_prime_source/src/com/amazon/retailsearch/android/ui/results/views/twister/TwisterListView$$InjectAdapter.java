    ...
    implements MembersInjector
{
    ...
    public void attach(Linker linker)
    {
        ...
        featureConfig = linker.requestBinding("com.amazon.retailsearch.android.api.experimentation.FeatureConfiguration", com/amazon/retailsearch/android/ui/results/views/twister/TwisterListView, getClass().getClassLoader());
    }
    ...
    public void injectMembers(TwisterListView twisterlistview)
    {
        ...
        twisterlistview.featureConfig = (FeatureConfiguration)featureConfig.get();
    }
