    ...
    implements MembersInjector
{
    ...
    public void attach(Linker linker)
    {
        ...
        dataProvider = linker.requestBinding("com.amazon.retailsearch.data.IRetailSearchDataProvider", com/amazon/retailsearch/android/ui/search/SearchResultView, getClass().getClassLoader());
    }
    ...
    public void injectMembers(SearchResultView searchresultview)
    {
        ...
        searchresultview.dataProvider = (IRetailSearchDataProvider)dataProvider.get();
    }
