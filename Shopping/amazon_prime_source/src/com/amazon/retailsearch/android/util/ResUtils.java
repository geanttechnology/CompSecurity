...
public class ResUtils
{
    ...
    public static String getSearchInDepartmentString(Context context, String s)
    {
        return context.getResources().getString(com.amazon.retailsearch.R.string.rs_search_in_department, new Object[] {
            s
        });
    }
