...
public class AndroidRetailSearchClient
{
    ...
    {
        com.amazon.searchapp.retailsearch.client.RetailSearchClient.Builder builder = (new com.amazon.searchapp.retailsearch.client.RetailSearchClient.Builder()).setWebClientFactory(getWebClientFactory()).setServiceCallInterceptor(getServiceCallInterceptor()).setUserAgent(getUserAgent()).setApiVersion(getDataVersion());
        if (clientId != null)
        {
    ...
    public static void setDataVersion(String s)
    {
        dataVersion = s;
    }
