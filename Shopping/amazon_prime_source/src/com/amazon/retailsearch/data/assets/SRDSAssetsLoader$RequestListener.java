...
private class <init> extends AbstractServiceCallListener
{
    ...
    public void endRequest()
    {
        ...
        {
            SRDSAssetsLoader.access$500(SRDSAssetsLoader.this).searchSRDSAssetsCompleted(logEventHandler);
            return;
        }
    }
    ...
    public void startRequest()
    {
        if (!cancelled)
        {
            logEventHandler = SRDSAssetsLoader.access$500(SRDSAssetsLoader.this).searchSRDSAssetsStarted(SRDSAssetsLoader.access$400(SRDSAssetsLoader.this));
        }
    }
