...
//            ResultStream, SearchLoader, SearchLoaderLogger, ResultEvent, 
//            ResultStreamListener, ResultModel
...
public class RequestListener extends AbstractSearchListener
{
    ...
    {
        searchLogger.searchSRDSResponseEndParse(searchLoader.getLogger().getSrdsLogEventHandler());
        searchLoader.getLogger().completeSRDSLogging();
...
label0:
    ...
    {
        addRecord(new ResultModel(quartzbacklink) {

            final RequestListener this$0;

            public void send(ResultStreamListener resultstreamlistener)
            {
                resultstreamlistener.quartzBackLink((QuartzBacklink)get());
            }

            
            {
                this$0 = RequestListener.this;
                super(quartzbacklink);
            }
        });
    }
    ...
    {
        searchLogger.searchSRDSRefinementsEndParse(searchLoader.getLogger().getSrdsLogEventHandler());
    ...
    {
        searchLogger.searchFirstByteReceived(searchLoader.getLogger().getSearchLogEventHandler());
        searchLogger.searchSRDSFirstByteReceived(searchLoader.getLogger().getSrdsLogEventHandler());
        searchLogger.searchSRDSResponseBeginParse(searchLoader.getLogger().getSrdsLogEventHandler());
        addRecord(new ResultEvent() {
    ...
    {
        searchLoader.getLogger().setSrdsLogEventHandler(searchLogger.searchSRDSStarted());
    ...
    {
        addRecord(new ResultModel(list) {

            final RequestListener this$0;

            public void send(ResultStreamListener resultstreamlistener)
            {
                resultstreamlistener.widgets((List)get());
            }
