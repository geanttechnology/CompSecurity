...
public class RetailSearchInternalModule
{
    ...
    LatencyAdaptiveManager provideLatencyAdaptiveManager()
    {
    ...
    PrefetchingManager providePrefetchingManager(Context context1)
    {
        return new PrefetchingManager(context1);
    }
    ...
    SearchDebugDataStore provideSearchDebugDataStore(Context context1)
    {
        return new SearchDebugDataStore(context1);
    }
