...
public final class ProgramName extends Enum
{
    ...
    public static final ProgramName AMAZON_NOW_ANDROID;
    public static final ProgramName ANDROID;
    public static final ProgramName BODHI_EBOOKS;
    public static final ProgramName BODHI_UNIFIED_SEARCH;
    public static final ProgramName DUKE;
    public static final ProgramName HOUDINI;
    ...
    static 
    {
        ...
        HOUDINI = new ProgramName("HOUDINI", 5, "MShopHoudiniSearch", "MShopHoudiniISS", "MShopHoudiniBrowse");
        BODHI_UNIFIED_SEARCH = new ProgramName("BODHI_UNIFIED_SEARCH", 6, "BodhiUnifiedSearch", "BodhiUnifiedISS", "BodhiUnifiedBrowse");
        BODHI_EBOOKS = new ProgramName("BODHI_EBOOKS", 7, "BodhiEbooksSearch", "BodhiEbooksISS", "BodhiEbooksBrowse");
        AMAZON_NOW_ANDROID = new ProgramName("AMAZON_NOW_ANDROID", 8, "AmazonNowAndroidSearch", "AmazonNowAndroidISS", "AmazonNowAndroidBrowse");
        $VALUES = (new ProgramName[] {
            ANDROID, KINDLE_LEGACY, KINDLE, TABLET, DUKE, HOUDINI, BODHI_UNIFIED_SEARCH, BODHI_EBOOKS, AMAZON_NOW_ANDROID
        });
    }
}
