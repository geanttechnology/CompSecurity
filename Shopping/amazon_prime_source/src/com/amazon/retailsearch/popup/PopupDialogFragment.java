...
public class PopupDialogFragment extends DialogFragment
{
    ...
    private static final MessageLogger log = AppLog.getLog(com/amazon/retailsearch/popup/PopupDialogFragment);
...
/*
    static int access$402(PopupDialogFragment popupdialogfragment, int i)
    {
        popupdialogfragment.height = i;
        return i;
    }
