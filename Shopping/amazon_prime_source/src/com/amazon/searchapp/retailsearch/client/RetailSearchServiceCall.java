...
//            RetailSearchClient, SearchParameterName, UndefinedClientIdException, RandomStringUtil, 
//            SearchRealm, SearchHeaderName, WeblabUtil
...
public abstract class RetailSearchServiceCall extends ServiceCall
{
        ...
        throws ServiceException
    {
        ...
        String s1 = (String)collectionmap.get(SearchParameterName.CLIENT_ID.getName());
        String s = s1;
        if (s1 == null)
        {
            s = retailsearchclient.getClientId();
            collectionmap.set(SearchParameterName.CLIENT_ID.getName(), s);
        }
        if (s == null || "".equals(s))
        {
    ...
    public final void setWeblabs(Map map)
    {
        weblabs = map;
    }
}
