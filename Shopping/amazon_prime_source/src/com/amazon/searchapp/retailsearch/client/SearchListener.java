    ...
    extends ServiceCallListener
{
    ...
    public abstract void airstream(AirstreamResult airstreamresult);
    ...
    public abstract void quartzBackLink(QuartzBacklink quartzbacklink);
    ...
    public abstract void widgets(List list);
