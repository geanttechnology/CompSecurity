...
//            ValidatingParser, StandardParser

public class SearchParser
    implements SearchResponseParser
{
    ...
    public SearchParser(boolean flag)
    {
        validate = flag;
    }
    ...
    private ObjectMapper getMapper()
    {
        if (validate)
        {
            return ValidatingParser.getMapper();
        } else
        {
...
_L1:
        ...
        {
            jsonparser.nextToken();
            searchresultentity.setWidgets((List)jsonparser.readValueAs(new TypeReference() {

                final SearchParser this$0;

            
            {
                this$0 = SearchParser.this;
                super();
            }
            }));
            if (searchresultentity.getWidgets() != null && searchlistener != null)
            {
                searchlistener.widgets(searchresultentity.getWidgets());
            }
            continue; /* Loop/switch isn't completed */
        }
        jsonparser.nextToken();
...
_L6:
        ...
        if (com/amazon/searchapp/retailsearch/entity/AirstreamResultEntity.equals(obj2))
        {
            searchresultentity.setAirstream((AirstreamResult)jsonparser.readValueAs(((Class) (obj2))));
            flag = flag1;
            if (searchlistener != null)
            {
                searchlistener.airstream(searchresultentity.getAirstream());
                flag = flag1;
            }
        } else
        if (com/amazon/searchapp/retailsearch/entity/QuartzBacklinkEntity.equals(obj2))
        {
            searchresultentity.setQuartzBacklink((QuartzBacklinkEntity)jsonparser.readValueAs(((Class) (obj2))));
            flag = flag1;
            if (searchlistener != null)
            {
                searchlistener.quartzBackLink(searchresultentity.getQuartzBacklink());
                flag = flag1;
            }
        } else
        {
...
_L7:
    ...
    static 
    {
        ...
        hashmap.put("resources", com/amazon/searchapp/retailsearch/entity/SearchResourcesEntity);
        hashmap.put("airstream", com/amazon/searchapp/retailsearch/entity/AirstreamResultEntity);
        hashmap.put("quartzBacklink", com/amazon/searchapp/retailsearch/entity/QuartzBacklinkEntity);
