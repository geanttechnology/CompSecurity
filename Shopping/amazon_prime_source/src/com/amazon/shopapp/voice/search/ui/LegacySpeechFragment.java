...
public class LegacySpeechFragment extends DialogFragment
    implements SpeechPanel
{

    private static final String TAG = com/amazon/shopapp/voice/search/ui/LegacySpeechFragment.getSimpleName();
    private VoiceSearchController mVoiceSearchController;

    public LegacySpeechFragment()
    {
    }

    public static LegacySpeechFragment newInstance(boolean flag)
    {
        LegacySpeechFragment legacyspeechfragment = new LegacySpeechFragment();
        Bundle bundle = new Bundle();
        bundle.putBoolean("suggestionsFlow", flag);
        legacyspeechfragment.setArguments(bundle);
