...
public final class FailFast
{
    ...
    public static transient void expectFalse(boolean flag, Object aobj[])
    {
        if (!flag)
        {
            flag = true;
    ...
    public static transient void expectNotNull(Object obj, Object aobj[])
    {
        boolean flag;
        if (obj != null)
        {
    ...
    public static void expectTrue(boolean flag)
    {
        failFastInternal(flag, new Object[0]);
    }
