    ...
    implements ConfigFeature
{
    ...
    static 
    {
        ...
        $VALUES = (new SerializationFeature[] {
            ...
            WRITE_ENUMS_USING_INDEX, WRITE_NULL_MAP_VALUES, WRITE_EMPTY_JSON_ARRAYS, WRITE_SINGLE_ELEM_ARRAYS_UNWRAPPED, ORDER_MAP_ENTRIES_BY_KEYS, EAGER_SERIALIZER_FETCH
        });
    }
}
