    ...
    implements Serializable
{
        ...
        throws IOException, JsonProcessingException
    {
        ...
        {
            throw new JsonMappingException((new StringBuilder()).append("Can not instantiate value of type ").append(getValueTypeDesc()).append(" from String value; no single-String constructor/factory method").toString());
        }
    }
...
label0:
        ...
        throw new JsonMappingException((new StringBuilder()).append("Can not instantiate value of type ").append(getValueTypeDesc()).append(" from Boolean value; no single-boolean/Boolean-arg constructor/factory method").toString());
    }
...
label0:
        ...
        throw new JsonMappingException((new StringBuilder()).append("Can not instantiate value of type ").append(getValueTypeDesc()).append(" from Floating-point number; no one-double/Double-arg constructor/factory method").toString());
    }
...
label0:
        ...
        throw new JsonMappingException((new StringBuilder()).append("Can not instantiate value of type ").append(getValueTypeDesc()).append(" from Integral number; no single-int-arg constructor/factory method").toString());
    }
...
label0:
        ...
        throw new JsonMappingException((new StringBuilder()).append("Can not instantiate value of type ").append(getValueTypeDesc()).append(" from Long integral number; no single-long-arg constructor/factory method").toString());
    }
