    ...
    implements BeanProperty
{
    ...
    public void depositSchemaProperty(JsonObjectFormatVisitor jsonobjectformatvisitor)
        throws JsonMappingException
    {
        if (isRequired(jsonobjectformatvisitor.getProvider().getAnnotationIntrospector()))
        {
        ...
        throws JsonMappingException
    {
        ...
        if (!isRequired(serializerprovider.getAnnotationIntrospector()))
        {
            flag = true;
        } else
        {
        ...
        objectnode.put(getName(), serializerprovider);
    }
    ...
    {
        annotationintrospector = annotationintrospector.hasRequiredMarker(_member);
        if (annotationintrospector == null)
        {
            return false;
        } else
        {
            return annotationintrospector.booleanValue();
        }
    }
