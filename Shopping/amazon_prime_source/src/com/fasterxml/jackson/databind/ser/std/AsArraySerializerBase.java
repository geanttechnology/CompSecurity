    ...
    public void acceptJsonFormatVisitor(JsonFormatVisitorWrapper jsonformatvisitorwrapper, JavaType javatype)
    {
        ...
        if (javatype != null)
        {
            ...
            if (javatype2 == null)
            {
                ...
                {
                    javatype = ((ParameterizedType)javatype).getActualTypeArguments();
                    javatype1 = javatype2;
                    if (javatype.length == 1)
                    {
                        javatype1 = jsonformatvisitorwrapper.getProvider().constructType(javatype[0]);
                    }
                }
            }
        }
        jsonformatvisitorwrapper = javatype1;
        if (javatype1 == null)
        {
            jsonformatvisitorwrapper = javatype1;
            if (_elementType != null)
            {
                jsonformatvisitorwrapper = _elementType;
            }
        }
        if (jsonformatvisitorwrapper != null)
        {
            jsonarrayformatvisitor.itemsFormat(jsonformatvisitorwrapper);
        }
    }
