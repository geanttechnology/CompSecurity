...
public final class MediaType
{
    ...
    private static MediaType create(String s, String s1, Multimap multimap)
    {
        ...
        return (MediaType)Objects.firstNonNull(KNOWN_TYPES.get(s), s);
    }
...
_L3:
        tokenizer.consumeCharacter('\\');
        s.append(tokenizer.consumeCharacter(CharMatcher.ASCII));
          goto _L5
_L4:
        try
        {
            s.append(tokenizer.consumeToken(QUOTED_TEXT_MATCHER));
        }
...
_L7:
        builder.put(s3, s);
          goto _L6
        s = tokenizer.consumeToken(TOKEN_MATCHER);
          goto _L7
        s = create(s1, s2, builder.build());
        return s;
    }
