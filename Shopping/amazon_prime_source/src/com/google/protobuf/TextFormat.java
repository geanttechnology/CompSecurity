...
//            ByteString, WireFormat, UnknownFieldSet, MessageOrBuilder, 
//            Message
...
public final class TextFormat
{
    ...
    private static final class Printer
    {
            ...
            throws IOException
        {
            ...
            for (Iterator iterator = messageorbuilder.getAllFields().entrySet().iterator(); iterator.hasNext(); printField((Descriptors.FieldDescriptor)entry.getKey(), entry.getValue(), textgenerator))
            {
            ...
            throws IOException
        {
            ...
            case 14: // '\016'
                ...
                if (escapeNonAscii)
                {
                    fielddescriptor = TextFormat.escapeText((String)obj);
                } else
                {
                    fielddescriptor = (String)obj;
                }
        ...
        private Printer setEscapeNonAscii(boolean flag)
        {
            escapeNonAscii = flag;
            return this;
        }

        private Printer setSingleLineMode(boolean flag)
        {
            singleLineMode = flag;
            return this;
        }
...
label0:
    ...
    public static String printToString(MessageOrBuilder messageorbuilder)
    {
        try
        {
            ...
            messageorbuilder = stringbuilder.toString();
        }
        // Misplaced declaration of an exception variable
        catch (MessageOrBuilder messageorbuilder)
        {
            throw new IllegalStateException(messageorbuilder);
        }
