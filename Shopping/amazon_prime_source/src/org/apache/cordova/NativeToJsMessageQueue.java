...
public class NativeToJsMessageQueue
{
    ...
    private static class JsMessage
    {
        ...
        void encodeAsJsMessage(StringBuilder stringbuilder)
        {
            ...
            stringbuilder.append("try{cordova.callbackFromNative('").append(jsPayloadOrCallbackId).append("',").append(flag).append(",").append(i).append(",[");
...
_L5:
            stringbuilder.append("],").append(pluginResult.getKeepCallback()).append(");}catch(e){}");
            return;
_L3:
...
_L6:
        ...
        ((StringBuilder) (obj)).append("window.setTimeout(function(){try{cordova.require('cordova/plugin/android/polling').pollOnce();}catch(e){}},0);");
        break MISSING_BLOCK_LABEL_256;
_L10:
        if (i >= j)
        {
