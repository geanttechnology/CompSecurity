...
public class PluginManager
{
    ...
    public PluginManager(CordovaWebView cordovawebview, CordovaInterface cordovainterface, List list)
    {
...
_L3:
    ...
    public void onDestroy()
    {
        ...
        do
        {
            ...
            CordovaPlugin cordovaplugin = (CordovaPlugin)iterator.next();
            if (cordovaplugin != null)
            {
...
label0:
    ...
    public Object postMessage(String s, Object obj)
    {
        ...
        {
            Object obj2 = (CordovaPlugin)iterator.next();
            if (obj2 != null)
            {
                obj2 = ((CordovaPlugin) (obj2)).onMessage(s, obj);
                if (obj2 != null)
                {
                    return obj2;
                }
    ...
    Uri remapUri(Uri uri)
    {
        for (Iterator iterator = pluginMap.values().iterator(); iterator.hasNext();)
        {
            Object obj = (CordovaPlugin)iterator.next();
            if (obj != null)
            {
                obj = ((CordovaPlugin) (obj)).remapUri(uri);
                if (obj != null)
                {
                    return ((Uri) (obj));
                }
    ...
    {
        for (Iterator iterator = entryMap.values().iterator(); iterator.hasNext();)
        {
            ...
            {
                pluginMap.put(pluginentry.service, null);
            }
        }
