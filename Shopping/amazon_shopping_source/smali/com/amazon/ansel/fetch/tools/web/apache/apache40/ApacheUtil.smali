.class public Lcom/amazon/ansel/fetch/tools/web/apache/apache40/ApacheUtil;
.super Ljava/lang/Object;
.source "ApacheUtil.java"
...
.method public static configureClient(Lorg/apache/http/impl/client/AbstractHttpClient;)V
    ...
    invoke-static {p0, v0, v1, v2}, Lcom/amazon/ansel/fetch/tools/web/apache/apache40/ApacheUtil;->configureClient(Lorg/apache/http/impl/client/AbstractHttpClient;ZILcom/amazon/ansel/fetch/tools/collection/CollectionMap;)V

    .line 137
    return-void
.end method

.method public static configureClient(Lorg/apache/http/impl/client/AbstractHttpClient;ZILcom/amazon/ansel/fetch/tools/collection/CollectionMap;)V
    .locals 4
    .param p0, "client"    # Lorg/apache/http/impl/client/AbstractHttpClient;
    ...
    invoke-virtual {p3}, Lcom/amazon/ansel/fetch/tools/collection/CollectionMap;->size()I
    ...
    new-instance v0, Lcom/amazon/ansel/fetch/tools/collection/CollectionMap;

    invoke-direct {v0, p3}, Lcom/amazon/ansel/fetch/tools/collection/CollectionMap;-><init>(Lcom/amazon/ansel/fetch/tools/collection/CollectionMap;)V

    .line 155
    .local v0, "requestHeaders":Lcom/amazon/ansel/fetch/tools/collection/CollectionMap;, "Lcom/amazon/ansel/fetch/tools/collection/CollectionMap<Ljava/lang/String;Ljava/lang/String;>;"
    :goto_0
    new-instance v1, Lcom/amazon/ansel/fetch/tools/web/apache/apache40/ApacheUtil$1;

    invoke-direct {v1, p1, v0}, Lcom/amazon/ansel/fetch/tools/web/apache/apache40/ApacheUtil$1;-><init>(ZLcom/amazon/ansel/fetch/tools/collection/CollectionMap;)V
    ...
    .line 179
    .end local v0    # "requestHeaders":Lcom/amazon/ansel/fetch/tools/collection/CollectionMap;, "Lcom/amazon/ansel/fetch/tools/collection/CollectionMap<Ljava/lang/String;Ljava/lang/String;>;"
    :cond_1
    if-eqz p1, :cond_2

    .line 180
    new-instance v1, Lcom/amazon/ansel/fetch/tools/web/apache/apache40/ApacheUtil$2;

    invoke-direct {v1}, Lcom/amazon/ansel/fetch/tools/web/apache/apache40/ApacheUtil$2;-><init>()V
    ...
    .line 212
    new-instance v1, Lcom/amazon/ansel/fetch/tools/web/apache/apache40/KeepAliveStrategy;

    int-to-long v2, p2

    invoke-direct {v1, v2, v3}, Lcom/amazon/ansel/fetch/tools/web/apache/apache40/KeepAliveStrategy;-><init>(J)V
...
.method public static createConnectionManager(Lorg/apache/http/params/HttpParams;)Lorg/apache/http/conn/ClientConnectionManager;
    ...
    sget-object v2, Lcom/amazon/ansel/fetch/tools/web/HttpScheme;->HTTP:Lcom/amazon/ansel/fetch/tools/web/HttpScheme;

    invoke-virtual {v2}, Lcom/amazon/ansel/fetch/tools/web/HttpScheme;->getName()Ljava/lang/String;
    ...
    sget-object v2, Lcom/amazon/ansel/fetch/tools/web/HttpScheme;->HTTPS:Lcom/amazon/ansel/fetch/tools/web/HttpScheme;
...
.method public static createHttpClient(Lorg/apache/http/params/HttpParams;Lorg/apache/http/conn/ClientConnectionManager;)Lorg/apache/http/client/HttpClient;
    ...
    invoke-static {v0}, Lcom/amazon/ansel/fetch/tools/web/apache/apache40/ApacheUtil;->configureClient(Lorg/apache/http/impl/client/AbstractHttpClient;)V
