...
.method protected final _copyTo(Ljava/lang/Object;I[Ljava/lang/Object;I)V
    ...
    .line 203
    .local v3, "ptr":I
    iget-object v2, p0, Lcom/fasterxml/jackson/databind/util/ObjectBuffer;->_bufferHead:Lcom/fasterxml/jackson/databind/util/ObjectBuffer$Node;

    .local v2, "n":Lcom/fasterxml/jackson/databind/util/ObjectBuffer$Node;
    :goto_0
    if-eqz v2, :cond_0
...
.method public appendCompletedChunk([Ljava/lang/Object;)[Ljava/lang/Object;
    ...
    .prologue
    .line 96
    new-instance v1, Lcom/fasterxml/jackson/databind/util/ObjectBuffer$Node;

    invoke-direct {v1, p1}, Lcom/fasterxml/jackson/databind/util/ObjectBuffer$Node;-><init>([Ljava/lang/Object;)V

    .line 97
    .local v1, "next":Lcom/fasterxml/jackson/databind/util/ObjectBuffer$Node;
    iget-object v2, p0, Lcom/fasterxml/jackson/databind/util/ObjectBuffer;->_bufferHead:Lcom/fasterxml/jackson/databind/util/ObjectBuffer$Node;

    if-nez v2, :cond_0

    .line 98
    iput-object v1, p0, Lcom/fasterxml/jackson/databind/util/ObjectBuffer;->_bufferTail:Lcom/fasterxml/jackson/databind/util/ObjectBuffer$Node;

    iput-object v1, p0, Lcom/fasterxml/jackson/databind/util/ObjectBuffer;->_bufferHead:Lcom/fasterxml/jackson/databind/util/ObjectBuffer$Node;
    ...
    .line 104
    .local v0, "len":I
    iget v2, p0, Lcom/fasterxml/jackson/databind/util/ObjectBuffer;->_bufferedEntryCount:I

    add-int/2addr v2, v0

    iput v2, p0, Lcom/fasterxml/jackson/databind/util/ObjectBuffer;->_bufferedEntryCount:I
    ...
    .end local v0    # "len":I
    :cond_0
    iget-object v2, p0, Lcom/fasterxml/jackson/databind/util/ObjectBuffer;->_bufferTail:Lcom/fasterxml/jackson/databind/util/ObjectBuffer$Node;

    invoke-virtual {v2, v1}, Lcom/fasterxml/jackson/databind/util/ObjectBuffer$Node;->linkNext(Lcom/fasterxml/jackson/databind/util/ObjectBuffer$Node;)V
...
.method public completeAndClearBuffer([Ljava/lang/Object;ILjava/util/List;)V
    ...
    iget-object v3, p0, Lcom/fasterxml/jackson/databind/util/ObjectBuffer;->_bufferHead:Lcom/fasterxml/jackson/databind/util/ObjectBuffer$Node;

    .local v3, "n":Lcom/fasterxml/jackson/databind/util/ObjectBuffer$Node;
    :goto_0
    if-eqz v3, :cond_1

    .line 153
    invoke-virtual {v3}, Lcom/fasterxml/jackson/databind/util/ObjectBuffer$Node;->getData()[Ljava/lang/Object;
    ...
    .line 152
    :cond_0
    invoke-virtual {v3}, Lcom/fasterxml/jackson/databind/util/ObjectBuffer$Node;->next()Lcom/fasterxml/jackson/databind/util/ObjectBuffer$Node;
