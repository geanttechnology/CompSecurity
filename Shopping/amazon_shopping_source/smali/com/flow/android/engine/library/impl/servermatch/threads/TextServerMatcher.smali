.class public Lcom/flow/android/engine/library/impl/servermatch/threads/TextServerMatcher;
.super Lcom/flow/android/engine/library/impl/servermatch/threads/FlowServerRequestThread;
.source "TextServerMatcher.java"
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/flow/android/engine/library/impl/servermatch/threads/TextServerMatcher;->sLockObject:Ljava/lang/Object;
...
.method private sendImageToServer()Ljava/lang/String;
    ...
    invoke-virtual {p0, v0, v1}, Lcom/flow/android/engine/library/impl/servermatch/threads/TextServerMatcher;->getResponseFromServer(Ljava/lang/String;Z)Ljava/lang/String;
...
.method public run()V
    ...
    .prologue
    .line 26
    iget-object v7, p0, Lcom/flow/android/engine/library/impl/servermatch/threads/TextServerMatcher;->mThreadPoolManagerInterface:Lcom/flow/android/engine/library/impl/servermatch/threads/ThreadPoolManagerInterface;

    iget v8, p0, Lcom/flow/android/engine/library/impl/servermatch/threads/TextServerMatcher;->mId:I
    ...
    sget-object v8, Lcom/flow/android/engine/library/impl/servermatch/threads/TextServerMatcher;->sLockObject:Ljava/lang/Object;

    monitor-enter v8

    .line 31
    :try_start_0
    invoke-direct {p0}, Lcom/flow/android/engine/library/impl/servermatch/threads/TextServerMatcher;->sendImageToServer()Ljava/lang/String;
    ...
    iget-object v7, p0, Lcom/flow/android/engine/library/impl/servermatch/threads/TextServerMatcher;->mHttpManagerInterface:Lcom/flow/android/engine/library/impl/servermatch/HttpManagerInterface;

    if-eqz v7, :cond_0

    iget-boolean v7, p0, Lcom/flow/android/engine/library/impl/servermatch/threads/TextServerMatcher;->m_isCancelled:Z
    ...
    iget-object v8, p0, Lcom/flow/android/engine/library/impl/servermatch/threads/TextServerMatcher;->mResponseType:Lcom/a9/vs/mobile/library/impl/jni/ServerResponse$Type;

    invoke-interface {v7, v4, v8, v2, v3}, Lcom/flow/android/engine/library/impl/servermatch/HttpManagerInterface;->didReceiveTextMatchResponse(Ljava/lang/String;Lcom/a9/vs/mobile/library/impl/jni/ServerResponse$Type;D)V
