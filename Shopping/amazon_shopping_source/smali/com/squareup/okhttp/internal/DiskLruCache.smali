...
.method private declared-synchronized completeEdit(Lcom/squareup/okhttp/internal/DiskLruCache$Editor;Z)V
    ...
    .line 543
    iget-object v8, p0, Lcom/squareup/okhttp/internal/DiskLruCache;->journalWriter:Lcom/squareup/okhttp/internal/okio/BufferedSink;
    ...
    invoke-interface {v8, v9}, Lcom/squareup/okhttp/internal/okio/BufferedSink;->writeUtf8(Ljava/lang/String;)Lcom/squareup/okhttp/internal/okio/BufferedSink;
    ...
    invoke-interface {v8}, Lcom/squareup/okhttp/internal/okio/BufferedSink;->flush()V
...
.method private declared-synchronized edit(Ljava/lang/String;J)Lcom/squareup/okhttp/internal/DiskLruCache$Editor;
    ...
    .line 467
    iget-object v2, p0, Lcom/squareup/okhttp/internal/DiskLruCache;->journalWriter:Lcom/squareup/okhttp/internal/okio/BufferedSink;
    ...
    invoke-interface {v2, v3}, Lcom/squareup/okhttp/internal/okio/BufferedSink;->writeUtf8(Ljava/lang/String;)Lcom/squareup/okhttp/internal/okio/BufferedSink;

    .line 468
    iget-object v2, p0, Lcom/squareup/okhttp/internal/DiskLruCache;->journalWriter:Lcom/squareup/okhttp/internal/okio/BufferedSink;

    invoke-interface {v2}, Lcom/squareup/okhttp/internal/okio/BufferedSink;->flush()V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method private static inputStreamToString(Ljava/io/InputStream;)Ljava/lang/String;
    ...
    invoke-static {v1}, Lcom/squareup/okhttp/internal/Util;->readFully(Lcom/squareup/okhttp/internal/okio/Source;)Lcom/squareup/okhttp/internal/okio/OkBuffer;
    ...
    invoke-virtual {v0, v1, v2}, Lcom/squareup/okhttp/internal/okio/OkBuffer;->readUtf8(J)Ljava/lang/String;
...
.method private readJournal()V
    ...
    invoke-static {v8}, Lcom/squareup/okhttp/internal/okio/Okio;->source(Ljava/io/InputStream;)Lcom/squareup/okhttp/internal/okio/Source;

    move-result-object v8

    invoke-static {v8}, Lcom/squareup/okhttp/internal/okio/Okio;->buffer(Lcom/squareup/okhttp/internal/okio/Source;)Lcom/squareup/okhttp/internal/okio/BufferedSource;

    move-result-object v5

    .line 246
    .local v5, "source":Lcom/squareup/okhttp/internal/okio/BufferedSource;
    const/4 v8, 0x1

    :try_start_0
    invoke-interface {v5, v8}, Lcom/squareup/okhttp/internal/okio/BufferedSource;->readUtf8Line(Z)Ljava/lang/String;
...
.method private declared-synchronized rebuildJournal()V
    ...
    :try_start_0
    iget-object v3, p0, Lcom/squareup/okhttp/internal/DiskLruCache;->journalWriter:Lcom/squareup/okhttp/internal/okio/BufferedSink;
    ...
    invoke-static {v3}, Lcom/squareup/okhttp/internal/okio/Okio;->sink(Ljava/io/OutputStream;)Lcom/squareup/okhttp/internal/okio/Sink;

    move-result-object v3

    invoke-static {v3}, Lcom/squareup/okhttp/internal/okio/Okio;->buffer(Lcom/squareup/okhttp/internal/okio/Sink;)Lcom/squareup/okhttp/internal/okio/BufferedSink;
    :try_end_0
    ...
    .line 348
    .local v2, "writer":Lcom/squareup/okhttp/internal/okio/BufferedSink;
    :try_start_1
    ...
    .line 342
    .end local v2    # "writer":Lcom/squareup/okhttp/internal/okio/BufferedSink;
    :catchall_1
    move-exception v3
    ...
    .restart local v2    # "writer":Lcom/squareup/okhttp/internal/okio/BufferedSink;
    :cond_1
    :try_start_3
    new-instance v3, Ljava/lang/StringBuilder;
    ...
    iput-object v3, p0, Lcom/squareup/okhttp/internal/DiskLruCache;->journalWriter:Lcom/squareup/okhttp/internal/okio/BufferedSink;
    :try_end_4
...
.method public declared-synchronized close()V
    ...
    :try_start_0
    iget-object v6, p0, Lcom/squareup/okhttp/internal/DiskLruCache;->journalWriter:Lcom/squareup/okhttp/internal/okio/BufferedSink;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-interface {v6}, Lcom/squareup/okhttp/internal/okio/BufferedSink;->close()V

    .line 632
    const/4 v6, 0x0

    iput-object v6, p0, Lcom/squareup/okhttp/internal/DiskLruCache;->journalWriter:Lcom/squareup/okhttp/internal/okio/BufferedSink;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public declared-synchronized remove(Ljava/lang/String;)Z
    ...
    invoke-interface {v3, v4}, Lcom/squareup/okhttp/internal/okio/BufferedSink;->writeUtf8(Ljava/lang/String;)Lcom/squareup/okhttp/internal/okio/BufferedSink;
