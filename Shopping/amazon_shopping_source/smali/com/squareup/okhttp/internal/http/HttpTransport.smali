...
.method public canReuseConnection()Z
    ...
    invoke-virtual {v2}, Lcom/squareup/okhttp/internal/http/HttpEngine;->getRequest()Lcom/squareup/okhttp/internal/http/Request;

    move-result-object v2

    const-string/jumbo v3, "Connection"

    invoke-virtual {v2, v3}, Lcom/squareup/okhttp/internal/http/Request;->header(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v2, v3}, Lcom/squareup/okhttp/internal/http/Response;->header(Ljava/lang/String;)Ljava/lang/String;
...
.method public createRequestBody(Lcom/squareup/okhttp/internal/http/Request;)Lcom/squareup/okhttp/internal/okio/Sink;
    ...
    invoke-virtual {v2}, Lcom/squareup/okhttp/internal/http/HttpConnection;->newChunkedSink()Lcom/squareup/okhttp/internal/okio/Sink;
    ...
    invoke-virtual {v2, v0, v1}, Lcom/squareup/okhttp/internal/http/HttpConnection;->newFixedLengthSink(J)Lcom/squareup/okhttp/internal/okio/Sink;
...
.method public getTransferStream(Ljava/net/CacheRequest;)Lcom/squareup/okhttp/internal/okio/Source;
    ...
    invoke-virtual {v2, p1, v3, v4}, Lcom/squareup/okhttp/internal/http/HttpConnection;->newFixedLengthSource(Ljava/net/CacheRequest;J)Lcom/squareup/okhttp/internal/okio/Source;
    ...
    invoke-virtual {v3, v4}, Lcom/squareup/okhttp/internal/http/Response;->header(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v2, p1, v3}, Lcom/squareup/okhttp/internal/http/HttpConnection;->newChunkedSource(Ljava/net/CacheRequest;Lcom/squareup/okhttp/internal/http/HttpEngine;)Lcom/squareup/okhttp/internal/okio/Source;
    ...
    invoke-static {v2}, Lcom/squareup/okhttp/internal/http/OkHeaders;->contentLength(Lcom/squareup/okhttp/internal/http/Response;)J
    ...
    invoke-virtual {v2, p1}, Lcom/squareup/okhttp/internal/http/HttpConnection;->newUnknownLengthSource(Ljava/net/CacheRequest;)Lcom/squareup/okhttp/internal/okio/Source;
...
.method public writeRequestHeaders(Lcom/squareup/okhttp/internal/http/Request;)V
    ...
    invoke-static {p1, v1, v2}, Lcom/squareup/okhttp/internal/http/RequestLine;->get(Lcom/squareup/okhttp/internal/http/Request;Ljava/net/Proxy$Type;I)Ljava/lang/String;
    ...
    invoke-virtual {v1, v2, v0}, Lcom/squareup/okhttp/internal/http/HttpConnection;->writeRequest(Lcom/squareup/okhttp/internal/http/Headers;Ljava/lang/String;)V
