...
.method public compact()V
    ...
    iget-object v1, p0, Lcom/squareup/okhttp/internal/okio/Segment;->prev:Lcom/squareup/okhttp/internal/okio/Segment;

    iget v1, v1, Lcom/squareup/okhttp/internal/okio/Segment;->pos:I

    sub-int/2addr v0, v1

    iget v1, p0, Lcom/squareup/okhttp/internal/okio/Segment;->limit:I
    ...
    invoke-virtual {p0, v0, v1}, Lcom/squareup/okhttp/internal/okio/Segment;->writeTo(Lcom/squareup/okhttp/internal/okio/Segment;I)V
...
.method public pop()Lcom/squareup/okhttp/internal/okio/Segment;
    ...
    .line 53
    iget-object v2, p0, Lcom/squareup/okhttp/internal/okio/Segment;->next:Lcom/squareup/okhttp/internal/okio/Segment;
    ...
    .line 54
    .local v0, "result":Lcom/squareup/okhttp/internal/okio/Segment;
    :goto_0
    ...
    iget-object v3, p0, Lcom/squareup/okhttp/internal/okio/Segment;->prev:Lcom/squareup/okhttp/internal/okio/Segment;

    iput-object v3, v2, Lcom/squareup/okhttp/internal/okio/Segment;->prev:Lcom/squareup/okhttp/internal/okio/Segment;
    ...
    .end local v0    # "result":Lcom/squareup/okhttp/internal/okio/Segment;
    :cond_0
    move-object v0, v1
...
.method public push(Lcom/squareup/okhttp/internal/okio/Segment;)Lcom/squareup/okhttp/internal/okio/Segment;
    .locals 1
    .param p1, "segment"    # Lcom/squareup/okhttp/internal/okio/Segment;
...
.method public split(I)Lcom/squareup/okhttp/internal/okio/Segment;
    ...
    .line 83
    .local v0, "aSize":I
    iget v4, p0, Lcom/squareup/okhttp/internal/okio/Segment;->limit:I

    iget v5, p0, Lcom/squareup/okhttp/internal/okio/Segment;->pos:I
    ...
    .line 89
    sget-object v4, Lcom/squareup/okhttp/internal/okio/SegmentPool;->INSTANCE:Lcom/squareup/okhttp/internal/okio/SegmentPool;

    invoke-virtual {v4}, Lcom/squareup/okhttp/internal/okio/SegmentPool;->take()Lcom/squareup/okhttp/internal/okio/Segment;

    move-result-object v3

    .line 90
    .local v3, "before":Lcom/squareup/okhttp/internal/okio/Segment;
    iget-object v4, p0, Lcom/squareup/okhttp/internal/okio/Segment;->data:[B

    iget v5, p0, Lcom/squareup/okhttp/internal/okio/Segment;->pos:I

    iget-object v6, v3, Lcom/squareup/okhttp/internal/okio/Segment;->data:[B
    ...
    .line 91
    iget v4, p0, Lcom/squareup/okhttp/internal/okio/Segment;->pos:I

    add-int/2addr v4, v0

    iput v4, p0, Lcom/squareup/okhttp/internal/okio/Segment;->pos:I

    .line 92
    iget v4, v3, Lcom/squareup/okhttp/internal/okio/Segment;->limit:I

    add-int/2addr v4, v0

    iput v4, v3, Lcom/squareup/okhttp/internal/okio/Segment;->limit:I

    .line 93
    iget-object v4, p0, Lcom/squareup/okhttp/internal/okio/Segment;->prev:Lcom/squareup/okhttp/internal/okio/Segment;

    invoke-virtual {v4, v3}, Lcom/squareup/okhttp/internal/okio/Segment;->push(Lcom/squareup/okhttp/internal/okio/Segment;)Lcom/squareup/okhttp/internal/okio/Segment;

    .line 102
    .end local v3    # "before":Lcom/squareup/okhttp/internal/okio/Segment;
    :goto_0
    return-object v3
    ...
    .line 98
    .local v1, "after":Lcom/squareup/okhttp/internal/okio/Segment;
    iget-object v4, p0, Lcom/squareup/okhttp/internal/okio/Segment;->data:[B
    ...
    iget-object v6, v1, Lcom/squareup/okhttp/internal/okio/Segment;->data:[B

    iget v7, v1, Lcom/squareup/okhttp/internal/okio/Segment;->pos:I
    ...
    iput v4, p0, Lcom/squareup/okhttp/internal/okio/Segment;->limit:I
    ...
    iput v4, v1, Lcom/squareup/okhttp/internal/okio/Segment;->limit:I
...
.method public writeTo(Lcom/squareup/okhttp/internal/okio/Segment;I)V
    .locals 6
    .param p1, "sink"    # Lcom/squareup/okhttp/internal/okio/Segment;
    ...
    .line 126
    iget-object v0, p1, Lcom/squareup/okhttp/internal/okio/Segment;->data:[B
    ...
    iget v4, p1, Lcom/squareup/okhttp/internal/okio/Segment;->pos:I
    ...
    .line 128
    iput v5, p1, Lcom/squareup/okhttp/internal/okio/Segment;->pos:I
    ...
    .line 133
    iget v0, p0, Lcom/squareup/okhttp/internal/okio/Segment;->pos:I

    add-int/2addr v0, p2

    iput v0, p0, Lcom/squareup/okhttp/internal/okio/Segment;->pos:I
