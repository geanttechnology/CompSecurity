...
.method constructor <init>(Lcom/squareup/okhttp/internal/okio/BufferedSource;IZ)V
    ...
    invoke-direct {v0, v1}, Lcom/squareup/okhttp/internal/spdy/Http20Draft09$ContinuationSource;-><init>(Lcom/squareup/okhttp/internal/okio/BufferedSource;)V
    ...
    .line 83
    new-instance v0, Lcom/squareup/okhttp/internal/spdy/HpackDraft05$Reader;

    iget-object v1, p0, Lcom/squareup/okhttp/internal/spdy/Http20Draft09$Reader;->continuation:Lcom/squareup/okhttp/internal/spdy/Http20Draft09$ContinuationSource;

    invoke-direct {v0, p3, p2, v1}, Lcom/squareup/okhttp/internal/spdy/HpackDraft05$Reader;-><init>(ZILcom/squareup/okhttp/internal/okio/Source;)V

    iput-object v0, p0, Lcom/squareup/okhttp/internal/spdy/Http20Draft09$Reader;->hpackReader:Lcom/squareup/okhttp/internal/spdy/HpackDraft05$Reader;
...
.method private readData(Lcom/squareup/okhttp/internal/spdy/FrameReader$Handler;SBI)V
    ...
    invoke-interface {p1, v0, p4, v1, p2}, Lcom/squareup/okhttp/internal/spdy/FrameReader$Handler;->data(ZILcom/squareup/okhttp/internal/okio/BufferedSource;I)V
...
.method private readGoAway(Lcom/squareup/okhttp/internal/spdy/FrameReader$Handler;SBI)V
    ...
    # invokes: Lcom/squareup/okhttp/internal/spdy/Http20Draft09;->ioException(Ljava/lang/String;[Ljava/lang/Object;)Ljava/io/IOException;
    invoke-static {v5, v6}, Lcom/squareup/okhttp/internal/spdy/Http20Draft09;->access$100(Ljava/lang/String;[Ljava/lang/Object;)Ljava/io/IOException;
    ...
    .line 264
    :cond_1
    iget-object v5, p0, Lcom/squareup/okhttp/internal/spdy/Http20Draft09$Reader;->source:Lcom/squareup/okhttp/internal/okio/BufferedSource;
    ...
    .line 271
    :cond_2
    sget-object v0, Lcom/squareup/okhttp/internal/okio/ByteString;->EMPTY:Lcom/squareup/okhttp/internal/okio/ByteString;

    .line 272
    .local v0, "debugData":Lcom/squareup/okhttp/internal/okio/ByteString;
    if-lez v4, :cond_3
    ...
    invoke-interface {v5, v6, v7}, Lcom/squareup/okhttp/internal/okio/BufferedSource;->readByteString(J)Lcom/squareup/okhttp/internal/okio/ByteString;

    move-result-object v0

    .line 275
    :cond_3
    invoke-interface {p1, v3, v1, v0}, Lcom/squareup/okhttp/internal/spdy/FrameReader$Handler;->goAway(ILcom/squareup/okhttp/internal/spdy/ErrorCode;Lcom/squareup/okhttp/internal/okio/ByteString;)V
...
.method private readHeaderBlock(SBI)Ljava/util/List;
    ...
    iput p1, v1, Lcom/squareup/okhttp/internal/spdy/Http20Draft09$ContinuationSource;->left:I
    ...
    .line 179
    iget-object v0, p0, Lcom/squareup/okhttp/internal/spdy/Http20Draft09$Reader;->hpackReader:Lcom/squareup/okhttp/internal/spdy/HpackDraft05$Reader;

    invoke-virtual {v0}, Lcom/squareup/okhttp/internal/spdy/HpackDraft05$Reader;->readHeaders()V

    .line 180
    iget-object v0, p0, Lcom/squareup/okhttp/internal/spdy/Http20Draft09$Reader;->hpackReader:Lcom/squareup/okhttp/internal/spdy/HpackDraft05$Reader;

    invoke-virtual {v0}, Lcom/squareup/okhttp/internal/spdy/HpackDraft05$Reader;->emitReferenceSet()V

    .line 183
    iget-object v0, p0, Lcom/squareup/okhttp/internal/spdy/Http20Draft09$Reader;->hpackReader:Lcom/squareup/okhttp/internal/spdy/HpackDraft05$Reader;

    invoke-virtual {v0}, Lcom/squareup/okhttp/internal/spdy/HpackDraft05$Reader;->getAndReset()Ljava/util/List;
...
.method private readHeaders(Lcom/squareup/okhttp/internal/spdy/FrameReader$Handler;SBI)V
    ...
    .line 169
    .local v6, "headerBlock":Ljava/util/List;, "Ljava/util/List<Lcom/squareup/okhttp/internal/spdy/Header;>;"
    const/4 v4, -0x1
    ...
    .end local v6    # "headerBlock":Ljava/util/List;, "Ljava/util/List<Lcom/squareup/okhttp/internal/spdy/Header;>;"
    :cond_2
    move v2, v1
...
.method private readPing(Lcom/squareup/okhttp/internal/spdy/FrameReader$Handler;SBI)V
    ...
    # invokes: Lcom/squareup/okhttp/internal/spdy/Http20Draft09;->ioException(Ljava/lang/String;[Ljava/lang/Object;)Ljava/io/IOException;
    invoke-static {v4, v5}, Lcom/squareup/okhttp/internal/spdy/Http20Draft09;->access$100(Ljava/lang/String;[Ljava/lang/Object;)Ljava/io/IOException;
    ...
    # invokes: Lcom/squareup/okhttp/internal/spdy/Http20Draft09;->ioException(Ljava/lang/String;[Ljava/lang/Object;)Ljava/io/IOException;
    invoke-static {v4, v3}, Lcom/squareup/okhttp/internal/spdy/Http20Draft09;->access$100(Ljava/lang/String;[Ljava/lang/Object;)Ljava/io/IOException;
    ...
    .line 254
    :cond_1
    iget-object v4, p0, Lcom/squareup/okhttp/internal/spdy/Http20Draft09$Reader;->source:Lcom/squareup/okhttp/internal/okio/BufferedSource;
...
.method private readPriority(Lcom/squareup/okhttp/internal/spdy/FrameReader$Handler;SBI)V
    ...
    # invokes: Lcom/squareup/okhttp/internal/spdy/Http20Draft09;->ioException(Ljava/lang/String;[Ljava/lang/Object;)Ljava/io/IOException;
    invoke-static {v2, v3}, Lcom/squareup/okhttp/internal/spdy/Http20Draft09;->access$100(Ljava/lang/String;[Ljava/lang/Object;)Ljava/io/IOException;
...
.method private readPushPromise(Lcom/squareup/okhttp/internal/spdy/FrameReader$Handler;SBI)V
    ...
    .line 242
    const-string/jumbo v2, "PROTOCOL_ERROR: TYPE_PUSH_PROMISE streamId == 0"
...
.method private readSettings(Lcom/squareup/okhttp/internal/spdy/FrameReader$Handler;SBI)V
    ...
    .line 231
    .local v1, "id":I
    invoke-virtual {v2, v1, v8, v3}, Lcom/squareup/okhttp/internal/spdy/Settings;->set(III)Lcom/squareup/okhttp/internal/spdy/Settings;
    ...
    .line 235
    iget-object v5, p0, Lcom/squareup/okhttp/internal/spdy/Http20Draft09$Reader;->hpackReader:Lcom/squareup/okhttp/internal/spdy/HpackDraft05$Reader;

    invoke-virtual {v2}, Lcom/squareup/okhttp/internal/spdy/Settings;->getHeaderTableSize()I

    move-result v6

    invoke-virtual {v5, v6}, Lcom/squareup/okhttp/internal/spdy/HpackDraft05$Reader;->maxHeaderTableByteCount(I)V
...
.method public nextFrame(Lcom/squareup/okhttp/internal/spdy/FrameReader$Handler;)Z
    ...
    .line 98
    :try_start_0
    iget-object v7, p0, Lcom/squareup/okhttp/internal/spdy/Http20Draft09$Reader;->source:Lcom/squareup/okhttp/internal/okio/BufferedSource;

    invoke-interface {v7}, Lcom/squareup/okhttp/internal/okio/BufferedSource;->readInt()I
    ...
    invoke-interface {v7, v8, v9}, Lcom/squareup/okhttp/internal/okio/BufferedSource;->skip(J)V
    ...
    :pswitch_1
    invoke-direct {p0, p1, v2, v1, v3}, Lcom/squareup/okhttp/internal/spdy/Http20Draft09$Reader;->readData(Lcom/squareup/okhttp/internal/spdy/FrameReader$Handler;SBI)V

    goto :goto_0

    .line 117
    :pswitch_2
    invoke-direct {p0, p1, v2, v1, v3}, Lcom/squareup/okhttp/internal/spdy/Http20Draft09$Reader;->readHeaders(Lcom/squareup/okhttp/internal/spdy/FrameReader$Handler;SBI)V

    goto :goto_0

    .line 121
    :pswitch_3
    invoke-direct {p0, p1, v2, v1, v3}, Lcom/squareup/okhttp/internal/spdy/Http20Draft09$Reader;->readPriority(Lcom/squareup/okhttp/internal/spdy/FrameReader$Handler;SBI)V

    goto :goto_0

    .line 125
    :pswitch_4
    invoke-direct {p0, p1, v2, v1, v3}, Lcom/squareup/okhttp/internal/spdy/Http20Draft09$Reader;->readRstStream(Lcom/squareup/okhttp/internal/spdy/FrameReader$Handler;SBI)V

    goto :goto_0

    .line 129
    :pswitch_5
    invoke-direct {p0, p1, v2, v1, v3}, Lcom/squareup/okhttp/internal/spdy/Http20Draft09$Reader;->readSettings(Lcom/squareup/okhttp/internal/spdy/FrameReader$Handler;SBI)V

    goto :goto_0

    .line 133
    :pswitch_6
    invoke-direct {p0, p1, v2, v1, v3}, Lcom/squareup/okhttp/internal/spdy/Http20Draft09$Reader;->readPushPromise(Lcom/squareup/okhttp/internal/spdy/FrameReader$Handler;SBI)V

    goto :goto_0

    .line 137
    :pswitch_7
    invoke-direct {p0, p1, v2, v1, v3}, Lcom/squareup/okhttp/internal/spdy/Http20Draft09$Reader;->readPing(Lcom/squareup/okhttp/internal/spdy/FrameReader$Handler;SBI)V

    goto :goto_0

    .line 141
    :pswitch_8
    invoke-direct {p0, p1, v2, v1, v3}, Lcom/squareup/okhttp/internal/spdy/Http20Draft09$Reader;->readGoAway(Lcom/squareup/okhttp/internal/spdy/FrameReader$Handler;SBI)V

    goto :goto_0

    .line 145
    :pswitch_9
    invoke-direct {p0, p1, v2, v1, v3}, Lcom/squareup/okhttp/internal/spdy/Http20Draft09$Reader;->readWindowUpdate(Lcom/squareup/okhttp/internal/spdy/FrameReader$Handler;SBI)V
...
.method public readConnectionHeader()V
    ...
    .prologue
    .line 87
    iget-boolean v1, p0, Lcom/squareup/okhttp/internal/spdy/Http20Draft09$Reader;->client:Z
    ...
    # getter for: Lcom/squareup/okhttp/internal/spdy/Http20Draft09;->CONNECTION_HEADER:Lcom/squareup/okhttp/internal/okio/ByteString;
    ...
    .line 89
    .local v0, "connectionHeader":Lcom/squareup/okhttp/internal/okio/ByteString;
    # getter for: Lcom/squareup/okhttp/internal/spdy/Http20Draft09;->CONNECTION_HEADER:Lcom/squareup/okhttp/internal/okio/ByteString;
    invoke-static {}, Lcom/squareup/okhttp/internal/spdy/Http20Draft09;->access$000()Lcom/squareup/okhttp/internal/okio/ByteString;
    ...
    # invokes: Lcom/squareup/okhttp/internal/spdy/Http20Draft09;->ioException(Ljava/lang/String;[Ljava/lang/Object;)Ljava/io/IOException;
    invoke-static {v1, v2}, Lcom/squareup/okhttp/internal/spdy/Http20Draft09;->access$100(Ljava/lang/String;[Ljava/lang/Object;)Ljava/io/IOException;
