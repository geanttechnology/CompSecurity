...
.method static constructor <clinit>()V
    ...
    const-string/jumbo v3, "com.sun.tools.javac.code.Symbol$CompletionFailure"
...
.method private processCompleteModule(Ljavax/lang/model/element/TypeElement;Z)Ljava/util/Map;
    ...
    const-string/jumbo v5, "overrides"
    ...
    .end local v31    # "providerKey":Ljava/lang/String;
    :cond_4
    const-string/jumbo v5, "staticInjections"
    ...
    const-string/jumbo v7, "Unknown @Provides type "
    ...
    const-string/jumbo v6, "Duplicate bindings for "
    ...
    const-string/jumbo v6, " in override module(s) - cannot override an override"
...
.method collectIncludesRecursively(Ljavax/lang/model/element/TypeElement;Ljava/util/Map;Ljava/util/Deque;)V
    ...
    const-string/jumbo v16, "No @Module on "
    ...
    const-string/jumbo v14, "Module Inclusion Cycle: "
    ...
    const-string/jumbo v15, " includes itself directly."
    ...
    const-string/jumbo v15, " included by "
    ...
    const-string/jumbo v14, "includes"
    ...
    const-string/jumbo v17, "Unexpected value for include: "
...
.method public process(Ljava/util/Set;Ljavax/annotation/processing/RoundEnvironment;)Z
    ...
    const-string/jumbo v10, "@Module applies to a type, "
    ...
    .line 114
    const-string/jumbo v9, "Missing @Module annotation."
    ...
    const-string/jumbo v10, "Graph validation failed: "
    ...
    const-string/jumbo v10, " thrown by javac in graph validation: "
    ...
    const-string/jumbo v12, "Graph visualization failed. Please report this as a bug.\n\n"
