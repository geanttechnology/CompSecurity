...
.method private createInjectedClass(Ljava/lang/String;)Ldagger/internal/codegen/InjectAdapterProcessor$InjectedClass;
    ...
    const-string/jumbo v8, "Cannot inject "
    ...
    const-string/jumbo v8, "Too many injectable constructors on "
    ...
    const-string/jumbo v8, "Abstract class "
    ...
    const-string/jumbo v8, " must not have an @Inject-annotated constructor."
...
.method private generateInjectAdapter(Ljavax/lang/model/element/TypeElement;Ljavax/lang/model/element/ExecutableElement;Ljava/util/List;)V
    ...
    const-string/jumbo v5, "$$InjectAdapter"
    ...
    :goto_2
    const-string/jumbo v5, "Code generated by dagger-compiler.  Do not edit."
...
.method private generateStaticInjection(Ljavax/lang/model/element/TypeElement;Ljava/util/List;)V
    ...
    const-string/jumbo v2, "Code generated by dagger-compiler.  Do not edit."
    ...
    .line 305
    const-string/jumbo v2, "A manager for {@code %s}\'s injections into static fields."
...
.method private parameterName(ZLjavax/lang/model/element/Element;)Ljava/lang/String;
    ...
    const-string/jumbo v0, "parameter_"
...
.method private validateInjectable(Ljavax/lang/model/element/Element;)Z
    ...
    const-string/jumbo v6, "@Inject is not valid on a class: "
    ...
    const-string/jumbo v6, "Method injection is not supported: "
    ...
    const-string/jumbo v6, "Can\'t inject a final field: "
    ...
    const-string/jumbo v6, "Can\'t inject a private field: "
    ...
    const-string/jumbo v6, "Can\'t inject a private constructor: "
    ...
    const-string/jumbo v6, "Can\'t inject a non-static inner class: "
...
.method private writeAttachMethod(Lcom/squareup/javawriter/JavaWriter;Ljavax/lang/model/element/ExecutableElement;Ljava/util/List;ZLjava/lang/String;Ljavax/lang/model/type/TypeMirror;Z)V
    ...
    const-string/jumbo v5, "unchecked"
    ...
    .line 381
    const-string/jumbo v4, "%s = (%s) linker.requestBinding(%s, %s.class, getClass().getClassLoader(), false, true)"
...
.method private writeGetDependenciesMethod(Lcom/squareup/javawriter/JavaWriter;Ljavax/lang/model/element/ExecutableElement;Ljava/util/List;ZLjavax/lang/model/type/TypeMirror;Z)V
    ...
    const-string/jumbo v5, "getDependencies"
    ...
    const-string/jumbo v9, "getBindings"
    ...
    const-string/jumbo v9, "injectMembersBindings"
    ...
    const-string/jumbo v4, "injectMembersBindings.add(%s)"
...
.method private writeGetMethod(Lcom/squareup/javawriter/JavaWriter;Ljavax/lang/model/element/ExecutableElement;ZZLjava/lang/String;)V
    ...
    const-string/jumbo v5, " result = new "
    ...
    .line 435
    const-string/jumbo v4, "injectMembers(result)"
    ...
    .line 437
    :cond_2
    const-string/jumbo v4, "return result"
...
.method private writeInjectAdapterConstructor(Lcom/squareup/javawriter/JavaWriter;Ljavax/lang/model/element/ExecutableElement;Ljavax/lang/model/element/TypeElement;Ljava/lang/String;Ljava/lang/String;)V
    ...
    :goto_0
    const-string/jumbo v5, "super(%s, %s, %s, %s.class)"
    ...
    const-string/jumbo v3, "IS_SINGLETON"
    ...
    :cond_2
    const-string/jumbo v3, "NOT_SINGLETON"
...
.method private writeMembersInjectMethod(Lcom/squareup/javawriter/JavaWriter;Ljava/util/List;ZLjava/lang/String;Ljavax/lang/model/type/TypeMirror;)V
    ...
    .line 445
    const-string/jumbo v2, "Injects any {@code @Inject} annotated fields in the given instance,\nsatisfying the contract for {@code Provider<%s>}."
    ...
    const-string/jumbo v3, "injectMembers"
    ...
    .line 449
    .local v0, "field":Ljavax/lang/model/element/Element;
    const-string/jumbo v2, "object.%s = %s.get()"
    ...
    .line 454
    const-string/jumbo v2, "supertype.injectMembers(object)"
...
.method private writeStaticInjectMethod(Lcom/squareup/javawriter/JavaWriter;Ljava/util/List;Ljava/lang/String;)V
    ...
    .line 463
    const-string/jumbo v2, "Performs the injections of dependencies into static fields when requested by\nthe {@code dagger.ObjectGraph}."
    ...
    .line 467
    .local v0, "field":Ljavax/lang/model/element/Element;
    const-string/jumbo v2, "%s.%s = %s.get()"
...
.method public process(Ljava/util/Set;Ljavax/annotation/processing/RoundEnvironment;)Z
    ...
    const-string/jumbo v6, "Code gen failed: "
    ...
    const-string/jumbo v8, "Could not find injection type required by "
