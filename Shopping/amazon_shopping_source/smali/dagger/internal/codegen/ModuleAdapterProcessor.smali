...
.method private bindingClassName(Ljavax/lang/model/element/ExecutableElement;Ljava/util/Map;Ljava/util/Map;)Ljava/lang/String;
    ...
    const-string/jumbo v7, "ProvidesAdapter"
...
.method private generateModuleAdapter(Ljava/io/Writer;Ljava/lang/String;Ljavax/lang/model/element/TypeElement;Ljava/util/Map;Ljava/util/List;)V
    ...
    const-string/jumbo v5, " has @Provides methods but no @Module annotation"
    ...
    .line 244
    :cond_0
    const-string/jumbo v4, "staticInjections"
    ...
    const-string/jumbo v4, "Code generated by dagger-compiler.  Do not edit."
    ...
    .line 264
    const-string/jumbo v4, "A manager of modules and provides adapters allowing for proper linking and\ninstance provision of types served by {@code @Provides} methods."
    ...
    const-string/jumbo v5, "STATIC_INJECTIONS"
    ...
    const-string/jumbo v32, "Unexpected value: "
    ...
    const-string/jumbo v32, " in includes of "
    ...
    .line 306
    const-string/jumbo v4, "super(%s.class, INJECTS, STATIC_INJECTIONS, %s /*overrides*/, INCLUDES, %s /*complete*/, %s /*library*/)"
    ...
    .line 314
    const-string/jumbo v4, "newModule"
    ...
    .line 315
    const-string/jumbo v4, "return new %s()"
    ...
    .line 325
    const-string/jumbo v4, "Used internally obtain dependency information, such as for cyclical\ngraph detection."
    ...
    const-string/jumbo v5, "getBindings"
    ...
    const-string/jumbo v34, "bindings"
    ...
    const-string/jumbo v31, "Unknown @Provides type "
    ...
    const-string/jumbo v4, "bindings.contributeProvidesBinding(%s, new %s(module))"
    ...
    .line 342
    .restart local v19    # "key":Ljava/lang/String;
    const-string/jumbo v4, "SetBinding.add(bindings, %s, new %s(module))"
...
.method private generateProvidesAdapter(Lcom/squareup/javawriter/JavaWriter;Ljavax/lang/model/element/ExecutableElement;Ljava/util/Map;Ljava/util/Map;Z)V
    ...
    const-string/jumbo v6, "super(%s, %s, %s, %s)"
    ...
    const-string/jumbo v4, "IS_SINGLETON"
    ...
    .line 462
    const-string/jumbo v4, "this.module = module"
    ...
    .line 463
    const-string/jumbo v4, "setLibrary(%s)"
    ...
    .line 468
    const-string/jumbo v4, "Used internally to link bindings/providers together at run time\naccording to their dependency graph."
    ...
    const-string/jumbo v4, "%s = (%s) linker.requestBinding(%s, %s.class, getClass().getClassLoader())"
    ...
    :cond_3
    const-string/jumbo v4, "NOT_SINGLETON"
    ...
    const-string/jumbo v6, "getDependencies"
    ...
    const-string/jumbo v24, "getBindings"
    ...
    const-string/jumbo v24, "injectMembersBindings"
    ...
    .line 491
    .local v17, "parameter":Ljavax/lang/model/element/Element;
    const-string/jumbo v4, "getBindings.add(%s)"
    ...
    .line 497
    const-string/jumbo v4, "Returns the fully provisioned instance satisfying the contract for\n{@code Provider<%s>}."
    ...
    .end local v17    # "parameter":Ljavax/lang/model/element/Element;
    :cond_8
    const-string/jumbo v4, "return module.%s(%s)"
...
.method private parameterName(Ljavax/lang/model/element/Element;)Ljava/lang/String;
    ...
    const-string/jumbo v1, "parameter_"
...
.method private providerMethodsByClass(Ljavax/annotation/processing/RoundEnvironment;)Ljava/util/Map;
    ...
    const-string/jumbo v22, "Unexpected @Provides on "
    ...
    const-string/jumbo v22, "Classes declaring @Provides methods must not be private or abstract: "
    ...
    const-string/jumbo v22, "@Provides methods must not be private, abstract or static: "
    ...
    const-string/jumbo v22, "@Provides methods must not have a throws clause: "
    ...
    .line 188
    const-string/jumbo v21, "@Provides method must not return %s directly: %s.%s"
    ...
    :cond_8
    const-string/jumbo v21, "java.lang.Object"
    ...
    const-string/jumbo v22, "Modules must be classes: "
    ...
    const-string/jumbo v22, "Modules must not extend from other classes: "
...
.method public process(Ljava/util/Set;Ljavax/annotation/processing/RoundEnvironment;)Z
    ...
    const-string/jumbo v12, "Code gen failed: "
    ...
    const-string/jumbo v14, "Could not find types required by provides methods for "
