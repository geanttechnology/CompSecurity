...
.method private validateProvides(Ljavax/lang/model/element/Element;)V
    ...
    const-string/jumbo v1, "@Provides methods must be declared in modules: "
...
.method private validateQualifiers(Ljavax/lang/model/element/Element;Ljava/util/Map;)V
    ...
    const-string/jumbo v6, "qualifiers"
    ...
    const-string/jumbo v6, "Qualifier annotations are only allowed on fields, methods, and parameters: "
    ...
    const-string/jumbo v6, "Dagger will ignore qualifier annotations on fields that are not annotated with @Inject: "
    ...
    const-string/jumbo v6, "Dagger will ignore qualifier annotations on methods that are not @Provides methods: "
    ...
    const-string/jumbo v6, "Dagger will ignore qualifier annotations on parameters that are not @Inject constructor parameters or @Provides method parameters: "
    ...
    const-string/jumbo v5, "Only one qualifier annotation is allowed per element: "
...
.method private validateScoping(Ljavax/lang/model/element/Element;)V
    ...
    const-string/jumbo v6, "Scoping annotations are only allowed on concrete types and @Provides methods: "
    ...
    const-string/jumbo v6, "Dagger will ignore scoping annotations on methods that are not @Provides methods: "
    ...
    const-string/jumbo v5, "Only one scoping annotation is allowed per element: "
