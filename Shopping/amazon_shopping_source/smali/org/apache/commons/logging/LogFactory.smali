...
.method protected static createFactory(Ljava/lang/String;Ljava/lang/ClassLoader;)Ljava/lang/Object;
    ...
    const-string/jumbo v5, "org.apache.commons.logging.LogFactory"
    ...
    const-string/jumbo v6, "Loaded class "
    ...
    const-string/jumbo v6, " from classloader "
    ...
    const-string/jumbo v6, "Factory class "
    ...
    const-string/jumbo v6, " loaded from classloader "
    ...
    const-string/jumbo v6, " does not extend \'"
    ...
    const-string/jumbo v6, "\' as loaded by this classloader."
    ...
    .line 1156
    const-string/jumbo v5, "[BAD CL TREE] "
    ...
    const-string/jumbo v6, "Unable to locate any class called \'"
    ...
    const-string/jumbo v6, "\' via classloader "
    ...
    .line 1266
    const-string/jumbo v5, "Unable to create LogFactory instance."
    ...
    const-string/jumbo v6, "The chosen LogFactory implementation does not extend LogFactory. Please check your configuration."
    ...
    const-string/jumbo v6, "\' cannot be loaded"
    ...
    const-string/jumbo v6, " - it depends on some other class that cannot"

    invoke-virtual {v5, v6}, Ljava/lang/StringBuffer;->append(Ljava/lang/String;)Ljava/lang/StringBuffer;

    move-result-object v5

    const-string/jumbo v6, " be found."
    ...
    const-string/jumbo v6, "The application has specified that a custom LogFactory implementation should be used but Class \'"
    ...
    const-string/jumbo v6, "\' cannot be converted to \'"
    ...
    const-string/jumbo v6, "The conflict is caused by the presence of multiple LogFactory classes in incompatible classloaders. "

    invoke-virtual {v5, v6}, Ljava/lang/StringBuffer;->append(Ljava/lang/String;)Ljava/lang/StringBuffer;

    move-result-object v5

    const-string/jumbo v6, "Background can be found in http://commons.apache.org/logging/tech.html. "

    invoke-virtual {v5, v6}, Ljava/lang/StringBuffer;->append(Ljava/lang/String;)Ljava/lang/StringBuffer;

    move-result-object v5

    const-string/jumbo v6, "If you have not explicitly specified a custom LogFactory then it is likely that "

    invoke-virtual {v5, v6}, Ljava/lang/StringBuffer;->append(Ljava/lang/String;)Ljava/lang/StringBuffer;

    move-result-object v5

    const-string/jumbo v6, "the container has set one without your knowledge. "

    invoke-virtual {v5, v6}, Ljava/lang/StringBuffer;->append(Ljava/lang/String;)Ljava/lang/StringBuffer;

    move-result-object v5

    const-string/jumbo v6, "In this case, consider using the commons-logging-adapters.jar file or "

    invoke-virtual {v5, v6}, Ljava/lang/StringBuffer;->append(Ljava/lang/String;)Ljava/lang/StringBuffer;

    move-result-object v5

    const-string/jumbo v6, "specifying the standard LogFactory from the command line. "
    ...
    const-string/jumbo v6, "Help can be found @http://commons.apache.org/logging/troubleshooting.html."
    ...
    const-string/jumbo v6, "Please check the custom implementation. "
    ...
    const-string/jumbo v6, "Unable to load factory class via classloader "
    ...
    const-string/jumbo v6, " - trying the classloader associated with this LogFactory."
...
.method private static final createFactoryStore()Ljava/util/Hashtable;
    ...
    :try_start_0
    const-string/jumbo v6, "org.apache.commons.logging.LogFactory.HashtableImpl"
    ...
    .line 354
    const-string/jumbo v4, "org.apache.commons.logging.impl.WeakHashtable"
    ...
    const-string/jumbo v6, "org.apache.commons.logging.impl.WeakHashtable"
    ...
    const-string/jumbo v7, "[ERROR] LogFactory: Load of custom hashtable failed"
...
.method protected static directGetContextClassLoader()Ljava/lang/ClassLoader;
    ...
    :goto_0
    const-string/jumbo v6, "getContextClassLoader"
    ...
    const-string/jumbo v4, "org.apache.commons.logging.LogFactory"
    ...
    const-string/jumbo v5, "Unexpected InvocationTargetException"
...
.method public static getFactory()Lorg/apache/commons/logging/LogFactory;
    ...
    .line 430
    const-string/jumbo v17, "Context classloader is null."
    ...
    const-string/jumbo v18, "[LOOKUP] LogFactory implementation requested for the first time for context classloader "
    ...
    .line 457
    :cond_2
    const-string/jumbo v17, "commons-logging.properties"
    ...
    .line 463
    const-string/jumbo v17, "use_tccl"
    ...
    .line 483
    const-string/jumbo v17, "[LOOKUP] Looking for system property [org.apache.commons.logging.LogFactory] to define the LogFactory subclass to use..."
    ...
    :cond_4
    :try_start_0
    const-string/jumbo v17, "org.apache.commons.logging.LogFactory"
    ...
    const-string/jumbo v18, "[LOOKUP] Creating an instance of LogFactory class \'"
    ...
    const-string/jumbo v18, "\' as specified by system property "
    ...
    .line 539
    const-string/jumbo v17, "[LOOKUP] Looking for a resource file of name [META-INF/services/org.apache.commons.logging.LogFactory] to define the LogFactory subclass to use..."
    ...
    :cond_7
    :try_start_1
    const-string/jumbo v17, "META-INF/services/org.apache.commons.logging.LogFactory"
    ...
    const-string/jumbo v18, " as specified by file \'"
    ...
    const-string/jumbo v18, "\' which was present in the path of the context"

    invoke-virtual/range {v17 .. v18}, Ljava/lang/StringBuffer;->append(Ljava/lang/String;)Ljava/lang/StringBuffer;

    move-result-object v17

    const-string/jumbo v18, " classloader."
    ...
    .line 600
    const-string/jumbo v17, "[LOOKUP] Looking in properties file for entry with key \'org.apache.commons.logging.LogFactory\' to define the LogFactory subclass to use..."
    ...
    const-string/jumbo v18, "[LOOKUP] Properties file specifies LogFactory subclass \'"
    ...
    .line 635
    const-string/jumbo v17, "[LOOKUP] Loading the default LogFactory implementation \'org.apache.commons.logging.impl.LogFactoryImpl\' via the same classloader that loaded this LogFactory class (ie not looking in the context classloader)."

    invoke-static/range {v17 .. v17}, Lorg/apache/commons/logging/LogFactory;->logDiagnostic(Ljava/lang/String;)V

    .line 650
    :cond_d
    const-string/jumbo v17, "org.apache.commons.logging.impl.LogFactoryImpl"
    ...
    .line 500
    const-string/jumbo v17, "[LOOKUP] No system property [org.apache.commons.logging.LogFactory] defined."
    ...
    const-string/jumbo v18, "[LOOKUP] A security exception occurred while trying to create an instance of the custom factory class: ["
    ...
    const-string/jumbo v18, "]. Trying alternative implementations..."
    ...
    const-string/jumbo v18, "[LOOKUP] An exception occurred while trying to create an instance of the custom factory class: ["
    ...
    const-string/jumbo v18, "] as specified by a system property."
    ...
    .line 574
    const-string/jumbo v17, "[LOOKUP] No resource file with name \'META-INF/services/org.apache.commons.logging.LogFactory\' found."
    ...
    .line 617
    const-string/jumbo v17, "[LOOKUP] Properties file has no entry specifying LogFactory subclass."
    ...
    .line 623
    const-string/jumbo v17, "[LOOKUP] No properties file available to determine LogFactory subclass from.."
...
.method private static implementsLogFactory(Ljava/lang/Class;)Z
    ...
    .line 1298
    const-string/jumbo v4, "[CUSTOM LOG FACTORY] was loaded by the boot classloader"
    ...
    :cond_1
    const-string/jumbo v4, "[CUSTOM LOG FACTORY] "
    ...
    const-string/jumbo v5, "[CUSTOM LOG FACTORY] "
    ...
    const-string/jumbo v5, " implements LogFactory but was loaded by an incompatible classloader."
    ...
    const-string/jumbo v5, "[CUSTOM LOG FACTORY] SecurityException thrown whilst trying to determine whether the compatibility was caused by a classloader conflict: "
    ...
    const-string/jumbo v5, " does not implement LogFactory."
    ...
    const-string/jumbo v5, "[CUSTOM LOG FACTORY] LinkageError thrown whilst trying to determine whether the compatibility was caused by a classloader conflict: "
    ...
    const-string/jumbo v4, "[CUSTOM LOG FACTORY] LogFactory class cannot be loaded by classloader which loaded the custom LogFactory implementation. Is the custom factory in the right classloader?"
...
.method private static initDiagnostics()V
    ...
    .line 1575
    :try_start_0
    const-string/jumbo v6, "org.apache.commons.logging.diagnostics.dest"
    ...
    const-string/jumbo v7, "[LogFactory from "
