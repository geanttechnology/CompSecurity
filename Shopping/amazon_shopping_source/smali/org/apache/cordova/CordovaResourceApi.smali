...
.method private assertBackgroundThread()V
    ...
    const-string/jumbo v2, "Do not perform IO operations on the UI thread. Use CordovaInterface.getThreadPool() instead."
    ...
    const-string/jumbo v2, "Tried to perform an IO operation on the WebCore thread. Use CordovaInterface.getThreadPool() instead."
...
.method public openForRead(Landroid/net/Uri;Z)Lorg/apache/cordova/CordovaResourceApi$OpenForReadResult;
    ...
    const-string/jumbo v8, "URI not supported by CordovaResourceApi: "
...
.method public openOutputStream(Landroid/net/Uri;Z)Ljava/io/OutputStream;
    ...
    const-string/jumbo v5, "URI not supported by CordovaResourceApi: "
