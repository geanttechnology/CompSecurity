...
.method private popAndEncodeAsJs()Ljava/lang/String;
    ...
    .line 210
    const-string/jumbo v12, "}finally{"
    ...
    .line 214
    :try_start_1
    const-string/jumbo v12, "window.setTimeout(function(){cordova.require(\'cordova/plugin/android/polling\').pollOnce();},0);"
...
.method public addPluginResult(Lorg/apache/cordova/PluginResult;Ljava/lang/String;)V
    ...
    .line 236
    const-string/jumbo v3, "JsMessageQueue"

    const-string/jumbo v4, "Got plugin result with no callbackId"
...
.method public setBridgeMode(I)V
    ...
    const-string/jumbo v3, "Invalid NativeToJsBridgeMode: "
    ...
    const-string/jumbo v3, "Set native->JS mode to "
