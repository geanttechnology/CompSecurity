...
.method private copyDirectory(Ljava/io/File;Ljava/io/File;)Lorg/json/JSONObject;
    ...
    const-string/jumbo v6, "Can\'t rename a file to a directory"
    ...
    const-string/jumbo v6, "Can\'t copy itself into itself"
    ...
    const-string/jumbo v6, "Couldn\'t create the destination directory"
...
.method private copyFile(Ljava/io/File;Ljava/io/File;)Lorg/json/JSONObject;
    ...
    const-string/jumbo v1, "Can\'t rename a file to a directory"
...
.method private moveDirectory(Ljava/io/File;Ljava/io/File;)Lorg/json/JSONObject;
    ...
    const-string/jumbo v1, "Can\'t move itself into itself"
    ...
    const-string/jumbo v1, "directory is not empty"
    ...
    const-string/jumbo v1, "moved failed"
...
.method protected URLforFullPath(Ljava/lang/String;)Lorg/apache/cordova/file/LocalFilesystemURL;
    ...
    const-string/jumbo v2, "cdvfile://localhost/"
...
.method public copyFileToURL(Lorg/apache/cordova/file/LocalFilesystemURL;Ljava/lang/String;Lorg/apache/cordova/file/Filesystem;Lorg/apache/cordova/file/LocalFilesystemURL;Z)Lorg/json/JSONObject;
    ...
    const-string/jumbo v8, "The source does not exist"
    ...
    const-string/jumbo v8, "Can\'t copy a file onto itself"
...
.method public getFileForLocalURL(Lorg/apache/cordova/file/LocalFilesystemURL;Ljava/lang/String;Lorg/json/JSONObject;Z)Lorg/json/JSONObject;
    ...
    .line 159
    const-string/jumbo v4, "exclusive"
    ...
    const-string/jumbo v5, "This path has an invalid \":\" in it."
    ...
    const-string/jumbo v5, "create/exclusive fails"
    ...
    const-string/jumbo v5, "create fails"
    ...
    const-string/jumbo v5, "path does not exist"
    ...
    const-string/jumbo v5, "path doesn\'t exist or is file"
    ...
    const-string/jumbo v5, "path doesn\'t exist or is directory"
...
.method protected removeDirRecursively(Ljava/io/File;)Z
    ...
    const-string/jumbo v6, "could not delete: "
...
.method public removeFileAtLocalURL(Lorg/apache/cordova/file/LocalFilesystemURL;)Z
    ...
    const-string/jumbo v2, "You can\'t delete a directory that is not empty."
