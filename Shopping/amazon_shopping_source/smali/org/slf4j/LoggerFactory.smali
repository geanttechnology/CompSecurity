...
.method private static final bind()V
    ...
    .line 128
    const-string/jumbo v4, "Failed to load class \"org.slf4j.impl.StaticLoggerBinder\"."

    invoke-static {v4}, Lorg/slf4j/helpers/Util;->report(Ljava/lang/String;)V

    .line 130
    const-string/jumbo v4, "Defaulting to no-operation (NOP) logger implementation"

    invoke-static {v4}, Lorg/slf4j/helpers/Util;->report(Ljava/lang/String;)V

    .line 131
    const-string/jumbo v4, "See http://www.slf4j.org/codes.html#StaticLoggerBinder for further details."
    ...
    .line 141
    const-string/jumbo v4, "slf4j-api 1.6.x (or later) is incompatible with this binding."

    invoke-static {v4}, Lorg/slf4j/helpers/Util;->report(Ljava/lang/String;)V

    .line 142
    const-string/jumbo v4, "Your binding is version 1.5.5 or earlier."

    invoke-static {v4}, Lorg/slf4j/helpers/Util;->report(Ljava/lang/String;)V

    .line 143
    const-string/jumbo v4, "Upgrade your binding to version 1.6.x. or 2.0.x"
...
.method private static final emitSubstituteLoggerWarning()V
    ...
    .line 162
    :cond_1
    const-string/jumbo v3, "The following loggers will not work becasue they were created"

    invoke-static {v3}, Lorg/slf4j/helpers/Util;->report(Ljava/lang/String;)V

    .line 164
    const-string/jumbo v3, "during the default configuration phase of the underlying logging system."

    invoke-static {v3}, Lorg/slf4j/helpers/Util;->report(Ljava/lang/String;)V

    .line 166
    const-string/jumbo v3, "See also http://www.slf4j.org/codes.html#substituteLogger"
...
.method private static singleImplementationSanityCheck()V
    ...
    const-string/jumbo v6, "Error getting resources from path"
    ...
    .line 221
    const-string/jumbo v6, "Class path contains multiple SLF4J bindings."
    ...
    const-string/jumbo v7, "Found binding in ["
    ...
    .line 225
    :cond_3
    const-string/jumbo v6, "See http://www.slf4j.org/codes.html#multiple_bindings for an explanation."
...
.method private static final versionSanityCheck()V
    ...
    const-string/jumbo v5, "The requested version "
    ...
    const-string/jumbo v5, " by your slf4j binding is not compatible with "
    ...
    .line 187
    const-string/jumbo v4, "See http://www.slf4j.org/codes.html#version_mismatch for further details."
    ...
    const-string/jumbo v4, "Unexpected problem occured during version sanity check"
