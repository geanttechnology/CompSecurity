...
//            BaseMetricsServiceFactory, MetricsService, MetricEntry, Priority, 
//            IMetricsService, DataPointEnvelope

public class GenericMetricsServiceAdapter
{

    private static final long SHUTDOWN_TIMEOUT_MS = 0x1d4c0L;
    ...
    {
        mMetricsServiceFactory.shutdown();
        mMetricsService.shutdown();
        if (mMainThread == null)
        {
        ...
        try
        {
            mMainThread.join(0x1d4c0L);
            log.debug("shutdown", "(super) Shutting down...", new Object[0]);
            return;
        }
        catch (InterruptedException interruptedexception)
        {
            throw new RuntimeException("System service shutdown failed", interruptedexception);
        }
    }
    ...
    public static void shutdownInstance()
    {
        if (sGenericMetricsServiceAdapter != null)
        {
            sGenericMetricsServiceAdapter.shutdown();
    ...
    public void setCountryOfResidence(String s)
    {
        ...
        {
            mDeviceUtil.setCountryOfResidence(s);
            return;
        }
    }
    ...
    public void setPreferredMarketplace(String s)
    {
        ...
        {
            mDeviceUtil.setPreferredMarketplace(s);
            return;
        }
    }
