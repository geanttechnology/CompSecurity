    ...
    implements BatchPipelineConfiguration
{
    ...
    public MetricsBatchPipelineConfiguration(long l, long l1, int i, int j, int k, 
            int i1, long l2, long l3, long l4, 
            BatchTransmitterType batchtransmittertype)
    {
        this(null, null, l, l1, i, j, k, i1, l2, l3, l4, batchtransmittertype);
    }
