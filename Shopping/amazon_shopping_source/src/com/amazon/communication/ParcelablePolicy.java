    ...
    implements Parcelable
{
    ...
    public static final android.os.Parcelable.Creator CREATOR = new android.os.Parcelable.Creator() {
        ...
        public ParcelablePolicy createFromParcel(Parcel parcel)
        {
            ...
            if (i == 2)
            {
                ...
                return new ParcelablePolicy((new amazon.communication.connection.Policy.Builder()).setCompressionOption(compressionoption1).setPriority(priority1).setIsLowLatencyNecessary(flag1).setIsRequestResponseOnly(flag3).setIsClearText(flag5).setIsWiFiNecessary(flag7).setIsAnonymousCredentialsAllowed(flag9).setIsDedicated(flag11).setPurpose(new Purpose(s)).setReconnectOnFailure(flag12).setKeepAlive(parcel).build());
            } else
            {
    ...
    public void writeToParcel(Parcel parcel, int i)
    {
        ...
        parcel.writeByte((byte)i);
        parcel.writeString(mPolicy.getPurpose().getPurpose());
