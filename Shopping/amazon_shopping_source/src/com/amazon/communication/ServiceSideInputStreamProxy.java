...
_L4:
        ...
        log.debug("read(byte[],int,int)", "About to read", new Object[] {
            "bytesToRead", Integer.valueOf(l), "Size of buffer", Integer.valueOf(abyte0.length), "totalBytesRead", Integer.valueOf(j), "remainingBytesToRead", Integer.valueOf(k)
        });
        k1 = iinputstream.readBytesIntoOffset(abyte0, i + j, l);
        int i1;
        int j1;
        if (k1 == -2)
        {
