    ...
    private static final class AccountAuthenticatorAsyncToSyncTask extends AsyncToSyncAdapter
    {
        ...
        protected void startAsyncOperation()
        {
            Callback callback = new Callback() {
                ...
                {
                    MAPLog.i(AccountAuthenticatorQueue.TAG, "Popping task %s off AccountAuthenticatorQueue.", new Object[] {
                        mOperation
                    });
            ...
            MAPLog.i(AccountAuthenticatorQueue.TAG, "Pushing task %s on AccountAuthenticatorQueue.", new Object[] {
                mOperation
            });
