...
public interface AccountManagerDefinition
{
    ...
    public abstract MAPFuture registerChildApplication(String s, String s1, Bundle bundle, Callback callback, Tracer tracer);

    public abstract MAPFuture renameDevice(String s, String s1, Bundle bundle, Callback callback, Tracer tracer);

    public abstract MAPFuture updateAccountWithKey(String s, KeyInfo keyinfo, Bundle bundle, Callback callback, Tracer tracer);
}
