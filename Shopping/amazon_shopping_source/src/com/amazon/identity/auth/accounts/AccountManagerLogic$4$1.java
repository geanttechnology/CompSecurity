    ...
    implements Runnable
{
    ...
    public void run()
    {
        AccountManagerLogic.access$500(_fld0, regType, regData, callback, val$accountType, val$accountName, val$extras);
    }
...
/* anonymous class */
        ...
        implements AccountRegistrar.Listener
    {
        ...
        {
            AccountManagerLogic.access$600(AccountManagerLogic.this, registrationerror, callback, bundle);
        }
