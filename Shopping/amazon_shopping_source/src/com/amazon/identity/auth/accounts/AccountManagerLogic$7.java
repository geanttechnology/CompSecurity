...
//            AccountManagerLogic, AccountsCallbackHelpers, AccountStateBroadcasts
    ...
    implements egisterAccount
{
    ...
    {
        String s2 = AccountManagerLogic.access$700();
        String s1;
        if (s != null)
        {
            s1 = s;
        ...
        AccountsCallbackHelpers.onError(val$callback, i, s, null);
    }
