    ...
    implements Callback
{
    ...
    // Unreferenced inner class com/amazon/identity/auth/accounts/AccountRegistrar$4

/* anonymous class */
    class AccountRegistrar._cls4 extends AccountRegistrar.RegisterDeviceAmazonWebserviceCallListener
    {
        ...
        protected void cleanupDeviceState(RegisterDeviceErrorType registerdeviceerrortype)
        {
            ...
            {
                mMAPAccountManager.deregisterDevice(registerdeviceerrortype. new AccountRegistrar._cls4._cls1());
                return;
            }
        }
