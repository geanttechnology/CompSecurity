...
class init> extends AccountManagerFutureAdapter
{
        ...
        throws MAPCallbackErrorException
    {
        ...
        {
            throw new MAPCallbackErrorException(CentralAccountManagerCommunication.access$100(CentralAccountManagerCommunication.this));
        } else
        {
            return CentralAccountManagerCommunication.access$200(CentralAccountManagerCommunication.this);
        }
    }
