    ...
    implements MultipleAccountPlugin
{
    ...
    {
        MAPLog.w(TAG, "Cannot send broadcasts to multiple profiles on a platform where multiple profiles are not supported. (Only 1P GEN6+ Devices after Android 4.2 supporting the multiple profiles)");
    }
