...
public final class SubAuthenticatorDescription
{
    ...
    {
        if (TextUtils.isEmpty(s) || StringUtil.isEmpty(s1) || TextUtils.isEmpty(s2))
        {
    ...
    public static String getDeviceNameFromPackageName(String s)
    {
        if (s == null)
        {
            return null;
        ...
        {
            return (new StringBuilder()).append(s).append(".tokens.device_name").toString();
        }
    }

    public static String getUserNameFromPackageName(String s)
    {
        if (s == null)
        {
            return null;
        ...
        {
            return (new StringBuilder()).append(s).append(".tokens.user_name").toString();
        }
    }
