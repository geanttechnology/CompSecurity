...
_L9:
    ...
    public CORPFMResponse fetchCorPfm(String s)
    {
...
_L1:
        obj = new CorPfmFetcherTask(null);
...
_L3:
        Object obj2 = TAG;
        obj2 = (new CorPfmFetcher(mContext, s)).fetch();
        if (obj2 == null) goto _L6; else goto _L5
_L5:
        obj1 = obj2;
        LinkedHashMap linkedhashmap = new LinkedHashMap();
        obj1 = obj2;
        boolean flag1 = saveCorPfmResponse(s, ((CORPFMResponse) (obj2)), linkedhashmap);
        if (s == null)
        {
            break MISSING_BLOCK_LABEL_128;
        }
        obj1 = obj2;
        mDataStorage.setUserData(s, linkedhashmap);
...
_L6:
        obj.mResponse = ((CORPFMResponse) (obj2));
...
_L9:
    ...
    public CORPFMResponse fetchCorPfmIfNotSet(String s)
    {
        Object obj1 = null;
        boolean flag = true;
        Object obj;
        ...
        {
            String s1 = TAG;
            return fetchCorPfm(s);
        }
    }

    public void setCORPFM(String s, Value value, Value value1)
    {
        if (s == null)
        {
        ...
        if (value != null)
        {
            hashmap.put("com.amazon.dcp.sso.property.account.cor", value.getValue());
        }
        if (value1 != null)
        {
            hashmap.put("com.amazon.dcp.sso.property.account.pfm", value1.getValue());
        }
        mDataStorage.setUserData(s, hashmap);
        notifyChange(s, MultipleAccountPluginHolder.getMultipleAccountPlugin(mContext));
    }
