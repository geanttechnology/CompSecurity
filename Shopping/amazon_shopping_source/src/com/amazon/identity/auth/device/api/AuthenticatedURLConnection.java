...
public class AuthenticatedURLConnection extends HttpsURLConnection
{
    ...
    AuthenticatedURLConnection(URL url, HttpsURLConnection httpsurlconnection, AuthenticationMethod authenticationmethod)
    {
        super(url);
        mInnerHttpsUrlConnection = new AuthenticatedHttpsURLConnection(url, httpsurlconnection, authenticationmethod);
    }
    ...
    byte[] getCurrentBody()
    {
        return mInnerHttpsUrlConnection.getCurrentBody();
    }
