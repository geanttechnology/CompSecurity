...
class t> extends SyncBoundServiceCaller
{
    ...
    protected void useService(IBinder ibinder)
    {
        ...
        val$bindTimer.stop();
        platformmetricstimer = MetricsHelper.startVerboseTimer(CentralDcpAuthenticationMethod.access$000(), "getAuthenticationParams");
        byte abyte0[];
        Object obj;
        Object obj1;
        Uri uri;
...
_L5:
        ...
        return;
_L2:
        obj1 = BackwardsCompatiabilityHelper.getAccountWithDirectedId(CentralDcpAuthenticationMethod.access$200(CentralDcpAuthenticationMethod.this), ((String) (obj1)));
...
_L4:
        ...
        obj1 = null;
          goto _L7
        ibinder;
        MAPLog.e(CentralDcpAuthenticationMethod.access$100(), "Could not receive request authentication from dcp!", ibinder);
        ...
        return;
        ibinder;
        MAPLog.e(CentralDcpAuthenticationMethod.access$100(), "Unknown error during getAuthenticationBundle execution.", ibinder);
