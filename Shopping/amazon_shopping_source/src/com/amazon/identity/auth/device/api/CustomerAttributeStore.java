...
public final class CustomerAttributeStore
{
    public static final class GetAttributeOptions extends Enum
    {
        ...
        static 
        {
            ForceRefresh = new GetAttributeOptions("ForceRefresh", "forceRefresh");
            $VALUES = (new GetAttributeOptions[] {
                ForceRefresh
            });
        }

        private GetAttributeOptions(String s, String s1)
        {
            super(s, 0);
            mUniqueValue = s1;
        }
    ...
    private final CustomerAttributeStoreFactory mFactory;

    CustomerAttributeStore(Context context)
    {
        mContext = ServiceWrappingContext.create(context);
        mFactory = (CustomerAttributeStoreFactory)mContext.getSystemService("sso_customer_attribute_store_factory");
    ...
    private CustomerAttributeStoreDefinition getCustomerAttributeStore()
    {
        ...
        {
            mCustomerAttributeStore = mFactory.createCustomerAttributeStore();
        }
    ...
    public MAPFuture getAttribute(String s, String s1, Callback callback, Bundle bundle, EnumSet enumset)
    {
        ...
        return getCustomerAttributeStore().getAttribute(s, s1, MetricsHelper.wrapCallback(tracer, platformmetricstimer, callback), bundle, enumset, tracer);
    }
    ...
    public MAPFuture renameDevice(String s, String s1, Bundle bundle, Callback callback)
    {
        ...
        MAPLog.i(TAG, "renameDevice called by %s", new Object[] {
