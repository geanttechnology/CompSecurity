...
public final class MAPWebViewHelper
{
    ...
    {
        if (TextUtils.isEmpty(s) || !s.contains("/ap/signin"))
        {
    ...
    {
        Object obj = URLEncodedUtils.parse(URI.create(s), null);
        mParams = new Parameters();
        ...
        obj = getCookieDomainFromUrl(s);
        String s3 = LOG_TAG;
        (new StringBuilder("Domain used for parameters : ")).append(((String) (obj))).toString();
