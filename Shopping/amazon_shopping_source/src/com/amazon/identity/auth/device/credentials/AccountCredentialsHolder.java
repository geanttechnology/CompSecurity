...
public final class AccountCredentialsHolder
{
    ...
    private AccountCredentialsHolder()
    {
    }
...
_L3:
        ...
        context = ((Context) (obj));
        if (validCredentials(((AccountCredentials) (obj)), context1))
        {
...
_L4:
    ...
    public static AccountCredentials getInstance(Context context)
    {
        ...
        if (!validCredentials(sMainCredentials, context)) goto _L2; else goto _L1
_L1:
...
_L3:
    ...
    {
        return accountcredentials != null && !accountcredentials.isStale(context);
    }
