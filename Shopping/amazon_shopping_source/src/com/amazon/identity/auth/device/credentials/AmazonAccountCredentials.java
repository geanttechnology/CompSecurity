...
public class AmazonAccountCredentials extends AccountCredentials
{
    ...
    {
        for (context = getValidatorString(); context == null || !context.equals(mValidatorString) || !TextUtils.equals(mEncryptedAdpToken, getCurrentUserData("com.amazon.dcp.sso.token.device.adptoken")) || !TextUtils.equals(mEncryptedPrivateKey, getCurrentUserData("com.amazon.dcp.sso.token.device.privatekey"));)
        {
            return true;
        }
