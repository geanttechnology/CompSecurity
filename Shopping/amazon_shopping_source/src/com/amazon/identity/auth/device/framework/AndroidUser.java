...
public final class AndroidUser
{
    ...
    public static int getCallingUserId()
    {
        ...
        {
            MAPLog.e(TAG, "Cannot get getCallingUserId static field. Error: %s", new Object[] {
    ...
    public static int getMyUserId()
    {
        ...
        {
            MAPLog.e(TAG, "Cannot get myUserId static field. Error: %s", new Object[] {
                cannotcallmethodexception.getMessage()
            });
            return 0;
        }
    ...
    private static Integer getOwnerId(Class class1)
    {
        ...
        {
            MAPLog.e(TAG, "Cannot get USER_OWNER static field. Error: %s", new Object[] {
                class1.getMessage()
            });
            return null;
        }
    ...
    {
        return getOwnerId() == mUserHandleId;
    }
