    ...
    implements Runnable
{
    ...
    public void run()
    {
        callback.onHeadersReceived(val$arg0);
    }

    l.callback()
    {
        this$1 = final_callback;
        val$arg0 = WebResponseHeaders.this;
        super();
    }
...
/* anonymous class */
        ...
        implements IAmazonWebServiceCallback
    {
        ...
        {
            HandlerHelpers.postAndWait(AsyncAmazonWebserviceCall.access$000(AsyncAmazonWebserviceCall.this), webresponseheaders. new AsyncAmazonWebserviceCall._cls1._cls2());
        }
...
/* anonymous class */
        ...
        // Unreferenced inner class com/amazon/identity/auth/device/framework/AsyncAmazonWebserviceCall$1$4

/* anonymous class */
        class AsyncAmazonWebserviceCall._cls1._cls4
            implements Runnable
        {
