    ...
    implements IAmazonWebserviceCaller
{
    ...
    public AsyncAmazonWebserviceCaller(Context context, Tracer tracer)
    {
        this(context, AccountCredentialsHolder.getInstance(context), tracer);
    }
    ...
    {
        if (mCredentials == null || !mCredentials.isStale(mContext))
        {
            return;
        } else
        {
    ...
    public AsyncAmazonWebserviceCall createCall(WebRequest webrequest, IAmazonWebServiceCallback iamazonwebservicecallback)
    {
        ...
        return new AsyncAmazonWebserviceCall(mContext, webrequest, iamazonwebservicecallback, mRequestSigner, mTracer);
    }
    ...
    public volatile IAmazonWebserviceCall createCall(WebRequest webrequest, IAmazonWebServiceCallback iamazonwebservicecallback)
    {
        return createCall(webrequest, iamazonwebservicecallback);
    }

    public volatile IAmazonWebserviceCall createCall(WebRequest webrequest, IWebResponseParser iwebresponseparser, IAmazonWebserviceCallListener iamazonwebservicecalllistener)
    {
        return createCall(webrequest, iwebresponseparser, iamazonwebservicecalllistener);
    }
