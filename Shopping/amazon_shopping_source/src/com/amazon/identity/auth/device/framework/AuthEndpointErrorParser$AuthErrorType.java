...
public static final class mError extends Enum
{
    ...
    static 
    {
        ...
        GenericError = new <init>("GenericError");
        ...
        NetworkFailure = new <init>("NetworkFailure", 16, "NetworkFailure", true, com.amazon.identity.auth.device.api.TWORK_FAILURE);
        $VALUES = (new .VALUES[] {
    ...
    private (String s)
    {
        this(s, 13, "GenericError", false, com.amazon.identity.auth.device.api.RECOGNIZED);
    }
