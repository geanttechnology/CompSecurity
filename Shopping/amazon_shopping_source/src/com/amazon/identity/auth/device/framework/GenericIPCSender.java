...
//            SecureContentResolver, BoundServiceManager, ContentProviderClientCallback
...
_L3:
        ...
        implements Callback
    {
        ...
        public void onError()
        {
            onError(GenericIPCSender.getIpcErrorBundle(500, "Got an error while calling Generic IPC central store."));
        }
    ...
    public static final long SYNC_IPC_TIMEOUT_MS = 500L;
    ...
    {
        this(context, s, s1, integer, new SecureContentResolver(context), getGenericIpcManager(context));
    }

    public GenericIPCSender(Context context, String s, String s1, Integer integer, SecureContentResolver securecontentresolver, BoundServiceManager boundservicemanager)
    {
...
_L3:
    ...
    public static Bundle getIpcErrorBundle(int i, String s)
    {
    ...
    public static void performIpcErrorCallback(Callback callback, int i, String s)
    {
        if (callback == null)
        {
            return;
        ...
        {
            callback.onError(getIpcErrorBundle(i, s));
            return;
        }
    }
    ...
    public Bundle call(Class class1, Bundle bundle)
    {
        ...
        boolean flag;
        simplecallbackfuture = new SimpleCallbackFuture();
        flag = mBoundServiceManager.useServiceIfAlreadyBound(new GenericIPCServiceCallback(simplecallbackfuture, bundle, class1, mBoundServiceManager));
        Bundle bundle1;
        bundle1 = bundle2;
        if (!flag)
        {
        ...
        bundle1 = simplecallbackfuture.get(500L, TimeUnit.MILLISECONDS);
_L1:
        bundle2 = bundle1;
        if (bundle1 != null)
        {
        ...
        obj = getIpcErrorBundle(500, "Got an error while calling Generic IPC central store.");
          goto _L1
        obj;
    ...
    public void call(Class class1, Bundle bundle, Callback callback)
    {
        ...
        callback = MetricsHelper.wrapCallback(MetricsHelper.startVerboseTimer(METRICS_COMPONENT_NAME, class1.getSimpleName()), new ErrorCodeMapperCallback(callback));
        mBoundServiceManager.useService(new GenericIPCServiceCallback(callback, bundle, class1, mBoundServiceManager));
    }
