...
public class PlatformWrapper
{
    ...
    public boolean isGen6Tablet()
    {
        return PlatformUtils.isGen6Tablet(mContext);
    }

    public boolean isGen7Tablet()
    {
        return PlatformUtils.isGen7Tablet(mContext);
    }
    ...
    {
        return PlatformUtils.unSecureCheckHasContentProviderWithAuthority(mContext, uri);
    }
