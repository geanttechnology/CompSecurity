    ...
    implements ContentProviderClientCallback
{
        ...
        throws Exception
    {
        ...
        RemoteMapInfo.access$502(RemoteMapInfo.this, DBHelpers.getString(contentproviderclient, "current_device_type"));
        if (RemoteMapInfo.access$500(RemoteMapInfo.this) == null)
        {
            MAPLog.e(RemoteMapInfo.access$000(), "Package %s has a null device type. Defaulting to the central device type", new Object[] {
                getPackageName()
            });
            RemoteMapInfo.access$502(RemoteMapInfo.this, Platform.getDeviceAttribute(RemoteMapInfo.access$600(RemoteMapInfo.this), DeviceAttribute.CentralDeviceType));
        }
        if (!DBHelpers.containsColumn(contentproviderclient, "dsn_override"))
        {
            break MISSING_BLOCK_LABEL_235;
        }
        RemoteMapInfo.access$702(RemoteMapInfo.this, DBHelpers.getString(contentproviderclient, "dsn_override"));
_L1:
        RemoteMapInfo.access$802(RemoteMapInfo.this, StringConversionHelpers.toInteger(DBHelpers.getString(contentproviderclient, "map_init_version")));
        DBHelpers.closeCursor(contentproviderclient);
        return null;
        MAPLog.i(RemoteMapInfo.access$000(), "Package %s does not provide a custom DSN override", new Object[] {
            RemoteMapInfo.access$100(RemoteMapInfo.this)
        });
          goto _L1
        Exception exception;
