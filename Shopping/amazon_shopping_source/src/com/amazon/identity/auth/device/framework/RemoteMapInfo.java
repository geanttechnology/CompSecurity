...
//            ServiceWrappingContext, RemoteMAPException, SecureContentResolver, ContentProviderClientCallback
...
public class RemoteMapInfo
{
    ...
    private boolean mForceQueryRemote;
        ...
        throws RemoteMAPException
    {
        ...
        securecontentresolver.acquireContentProviderClient(mapVersionInfoUri, new ContentProviderClientCallback() {
                ...
                throws Exception
            {
                ...
                if (mDeviceType == null)
                {
                    MAPLog.e(RemoteMapInfo.TAG, "Package %s has a null device type. Defaulting to the central device type", new Object[] {
                        getPackageName()
                    });
...
_L1:
                ...
                DBHelpers.closeCursor(contentproviderclient);
                return null;
                MAPLog.i(RemoteMapInfo.TAG, "Package %s does not provide a custom DSN override", new Object[] {
                    mPackageName
                });
                  goto _L1
                Exception exception;
        ...
        MetricsHelper.increasePeriodicCounter((new StringBuilder("RemoteMapInfoFailure:")).append(getPackageName()).toString(), new String[0]);
...
_L1:
    ...
    private boolean shouldQueryRemoteContentProvider()
    {
        return Platform.hasFeature(mContext, Feature.OverrideDeviceAttributes) || mForceQueryRemote;
    }
    ...
    public int compareLatest(RemoteMapInfo remotemapinfo)
    {
        ...
        } else
        {
            ...
            if (k == 0)
            {
                ...
                {
                    return StringHelpers.compareTo(getPackageName(), remotemapinfo.getPackageName());
                }
            }
        }
        return i;
    ...
    public String getDeviceType()
        throws RemoteMAPException
    {
        if (!shouldQueryRemoteContentProvider() || !ChildApplicationHelpers.isOverridingDeviceAttributes(mContext, getPackageName()))
        {
        ...
        throw exception;
        String s1 = TAG;
        return DeviceTypeHelpers.getDeviceTypeForAPackageFromMetadata(mContext, getPackageName());
    }
    ...
    public void setForceQueryRemote(boolean flag)
    {
        mForceQueryRemote = flag;
    }
...
/*
    static String access$702(RemoteMapInfo remotemapinfo, String s)
    {
...
/*
    static Integer access$802(RemoteMapInfo remotemapinfo, Integer integer)
    {
