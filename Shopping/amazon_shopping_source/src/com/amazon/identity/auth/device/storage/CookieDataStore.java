...
public abstract class CookieDataStore
{
    ...
    public static final String COOKIE_STORAGE_NAMESPACE = "com.amazon.identity.auth.device.cookiekeys.namespace";
    public static final String NON_AUTH_COOKIE_STORAGE_NAMESPACE = "com.amazon.identity.auth.device.cookiekeys.namespace.nonAuth";
