...
public abstract class DataStorage
{
    ...
    public abstract String getDirectedId(String s);

    public abstract String getDisplayName(String s);
    ...
    public void setUserData(String s, Map map)
    {
        setData(new AccountTransaction(s, map, null));
    }
