...
public class LambortishClock
{
    public static class ChangeTimestampsBroadcastReceiver extends BroadcastReceiver
    {
        ...
        public void onReceive(Context context, Intent intent)
        {
            ...
            {
                MAPLog.e(LambortishClock.TAG, "Cannot Handle intent with action %s", new Object[] {
                    intent
                });
                return;
            }
            context = ServiceWrappingContext.create(context);
            if (!isValidOnThisPlatform((PlatformWrapper)context.getSystemService("sso_platform")))
            {
...
_L2:
        ...
        {
            String s = TAG;
            (new StringBuilder("Saving greatest timestamp seen : ")).append(l).toString();
...
_L3:
    ...
    public void notifySystemTimeChanged()
    {
        ...
        MAPLog.w(TAG, "Users clock moved. System time is %s and timestamp is %s", new Object[] {
