...
public class LocalDataStorageV2
{
    static class LocalDataStorageDBHelper extends SQLiteOpenHelper
    {
        ...
        {
            MAPLog.i(LocalDataStorageV2.TAG, "Creating Local DataStore");
        ...
        public LocalDataStorageDBHelper(Context context, String s, int i, LocalKeyValueStore localkeyvaluestore)
        {
    ...
    static final String ACCOUNTS_COLUMN_DIRECTED_ID = "directed_id";
    static final String ACCOUNTS_COLUMN_DISPLAY_NAME = "display_name";
    static final String ACCOUNT_DATA_COLUMN_DATA_KEY = "account_data_key";
    static final String ACCOUNT_DATA_COLUMN_DATA_VALUE = "account_data_value";
    static final String ACCOUNT_DATA_COLUMN_DIRECTED_ID = "account_data_directed_id";
    static final String COLUMN_ID = "_id";
    static final String DEVICE_DATA_COLUMN_DEVICE_DATA_KEY = "device_data_key";
    static final String DEVICE_DATA_COLUMN_DEVICE_DATA_NAMESPACE = "device_data_namespace";
    static final String DEVICE_DATA_COLUMN_DEVICE_DATA_VALUE = "device_data_value";
    static final String LOCAL_DATA_STORAGE_DB_NAME = "map_data_storage_v2";
    static final int LOCAL_DATA_STORAGE_DB_VERSION = 1;
    static final String TABLE_ACCOUNTS = "accounts";
    static final String TABLE_ACCOUNT_DATA = "account_data";
    ...
    {
        this(context, "map_data_storage_v2", 1);
    }

    LocalDataStorageV2(Context context, String s, int i)
    {
        mContext = context;
        ...
        mLocalDataStorageHelper = new LocalDataStorageDBHelper(context, s, i, mKeyValueStore);
        mAESCipher = null;
    }
    ...
    {
        cleanDb(context, "map_data_storage_v2");
    }

    public static void cleanDb(Context context, String s)
    {
        if (context == null)
        {
            return;
        }
        if (context.deleteDatabase((new StringBuilder()).append(s).append(".db").toString()))
        {
            context = "successful";
        } else
        {
...
_L2:
        ...
        MetricsHelper.increasePeriodicCounter("DecryptionFailure", new String[] {
            "decryptCBCModeReturnNull"
        });
        cleanDb(mContext, "map_data_storage_v2");
...
_L6:
        ...
        MetricsHelper.increasePeriodicCounter("EncryptionFailure", new String[] {
...
_L1:
        String s = mKeyValueStore.getValue("com.amazon.identity.auth.device.storage.LocalOnlySQLDB.encrypt.key");
        Object obj = s;
...
_L5:
        obj = mKeyValueStore.getValue("com.amazon.identity.auth.device.storage.LocalOnlySQLDB.encrypt.key");
_L4:
...
_L7:
    ...
    public static LocalDataStorageV2 getInstance(Context context)
    {
...
_L6:
        ...
        return ((String) (obj));
_L2:
        Object obj2 = getAndCacheAllAccounts();
        obj = obj1;
        if (obj2 == null)
        {
            continue; /* Loop/switch isn't completed */
...
_L4:
        ...
        obj = (AccountInfoV2)((Iterator) (obj2)).next();
        if (!TextUtils.equals(((AccountInfoV2) (obj)).displayName, s)) goto _L4; else goto _L3
_L3:
        obj = ((AccountInfoV2) (obj)).directedId;
...
_L4:
        ...
        return s1;
_L2:
        Map map = getAndCacheAllAccounts();
        s1 = obj;
        if (map == null)
        {
            continue; /* Loop/switch isn't completed */
        ...
        s = (AccountInfoV2)map.get(s);
        s1 = obj;
        if (s == null)
        {
            continue; /* Loop/switch isn't completed */
        }
        s1 = ((AccountInfoV2) (s)).displayName;
        if (true) goto _L4; else goto _L3
_L3:
        s;
        throw s;
...
_L2:
        ...
        sqlitedatabase = sqlitedatabase2;
        sqlitedatabase1 = sqlitedatabase2;
        ((ContentValues) (obj)).put("device_data_namespace", s);
        sqlitedatabase = sqlitedatabase2;
        sqlitedatabase1 = sqlitedatabase2;
        ((ContentValues) (obj)).put("device_data_key", s1);
        sqlitedatabase = sqlitedatabase2;
        sqlitedatabase1 = sqlitedatabase2;
        ((ContentValues) (obj)).put("device_data_value", encode(s2));
        sqlitedatabase = sqlitedatabase2;
        sqlitedatabase1 = sqlitedatabase2;
        if (DBHelpers.ifCannotUpdateThenInsert(sqlitedatabase2, "device_data", ((ContentValues) (obj)), String.format("%s = ? and %s = ?", new Object[] {
    "device_data_namespace", "device_data_key"
}), new String[] {
    s, s1
}))
        ...
        sqlitedatabase = sqlitedatabase2;
        sqlitedatabase1 = sqlitedatabase2;
        if (mDeviceData == null) goto _L3; else goto _L4
_L4:
        sqlitedatabase = sqlitedatabase2;
        sqlitedatabase1 = sqlitedatabase2;
