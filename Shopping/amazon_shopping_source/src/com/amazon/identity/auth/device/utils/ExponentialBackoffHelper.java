...
class ExponentialBackoffHelper
{
    ...
    private static final String TAG = com/amazon/identity/auth/device/utils/ExponentialBackoffHelper.getName();
    ...
    public ExponentialBackoffHelper(int i, int j, int k, int l)
    {
        ...
        if (mFirstRetryIntervalMs <= 0)
        {
            ...
            MAPLog.w(TAG, String.format("ExponentialBackoffHelper: was constructed with a first retry interval value less than or equal to zero. It has been set to a default value (%d ms)", new Object[] {
        ...
        {
            mJitterRange = 10;
            MAPLog.w(TAG, String.format("ExponentialBackoffHelper: was constructed with a jitter percent range less than or equal to zero. It has been set to a default value (%d percent)", new Object[] {
