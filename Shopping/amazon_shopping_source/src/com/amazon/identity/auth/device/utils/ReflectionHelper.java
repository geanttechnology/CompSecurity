...
public class ReflectionHelper
{
    ...
    public Method getHiddenMethod(Class class1, String s)
    {
...
label0:
            {
                ...
                if (method == null)
                {
                    MAPLog.e(TAG, (new StringBuilder("Failed to find method ")).append(s).append(" in class ").append(class1.getName()).toString());
                }
                return method;
            }
            i++;
    ...
    public transient Object invoke(Method method, Object obj, Object aobj[])
