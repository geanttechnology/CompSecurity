...
_L5:
        ...
        throws IOException, ParseErrorException
    {
        ...
        obj4 = httpurlconnection;
        tracer2 = obj8;
        (new StringBuilder("X-Amzn-RequestId:")).append(httpurlconnection.getRequestProperty("X-Amzn-RequestId")).toString();
        obj2 = httpurlconnection;
        obj5 = abyte0;
        obj = httpurlconnection;
        obj1 = obj6;
...
_L2:
        ...
        if (tracer != null)
        {
            ...
            {
                MAPLog.e(TAG, (new StringBuilder("Error closing stream to ")).append(getLogSafeUrl(webrequest)).toString());
...
_L1:
        ...
        obj = obj2;
        obj1 = obj5;
        MAPLog.e(TAG, (new StringBuilder("IOException making request to ")).append(getLogSafeUrl(webrequest)).toString());
        obj = obj2;
        obj1 = obj5;
        printStackTrace(amazonwebservicecallresponseparser);
        obj = obj2;
        obj1 = obj5;
        ...
        obj = obj3;
        obj1 = tracer1;
        MAPLog.e(TAG, (new StringBuilder("UnsupportedOperationException making request to ")).append(getLogSafeUrl(webrequest)).toString());
        obj = obj3;
        obj1 = tracer1;
        printStackTrace(context);
        obj = obj3;
    ...
    public static byte[] getInput(InputStream inputstream)
        throws IOException
    {
...
label0:
    ...
    {
        MAPLog.e(TAG, exception.getMessage());
        exception = exception.getStackTrace();
        int j = exception.length;
        for (int i = 0; i < j; i++)
        {
            StackTraceElement stacktraceelement = exception[i];
            MAPLog.e(TAG, (new StringBuilder("Log Exception: ")).append(stacktraceelement.toString()).toString());
        }
    ...
    public static URLConnection setAmazonWebRequestSettings(URLConnection urlconnection)
    {
        ...
        urlconnection.setRequestProperty("X-Amzn-RequestId", s);
        String s1 = TAG;
        (new StringBuilder("RequestId: ")).append(s).toString();
