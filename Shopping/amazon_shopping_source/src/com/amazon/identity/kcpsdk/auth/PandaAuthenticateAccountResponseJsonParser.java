...
public class PandaAuthenticateAccountResponseJsonParser extends PandaResponseJsonParser
{
        ...
        throws JSONException
    {
        ...
        {
            return new PandaAuthenticateAccountResponse(AuthenticateAccountError.AuthenticateAccountErrorCredentialError);
        } else
        {
    ...
    {
        MAPLog.i(TAG, " PandaAuthenticateResponseParser: response received an unknown error: %s", new Object[] {
            jsonobject.toString()
        });
