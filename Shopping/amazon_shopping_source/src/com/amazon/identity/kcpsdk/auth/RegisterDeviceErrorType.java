...
public final class RegisterDeviceErrorType extends Enum
{
    ...
    static 
    {
        RegisterDeviceErrorTypeCustomerNotFound = new RegisterDeviceErrorType("RegisterDeviceErrorTypeCustomerNotFound", 0, "Customer Not Found. The credential is invalid e.g. The input email/password does not match our record");
