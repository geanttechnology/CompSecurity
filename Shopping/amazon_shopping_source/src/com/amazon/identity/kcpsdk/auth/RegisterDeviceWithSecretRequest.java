...
public class RegisterDeviceWithSecretRequest extends RegisterRequest
{
    ...
    public static boolean isValidRadioId(String s)
    {
    ...
    public WebRequest getWebRequest()
    {
        ...
        MAPLog.i(s2, "getWebRequest: constructed a web request with:\nDevice Type: %s\nReason: %s\nVersion Number: %s\nSoftware Component Id: %s\nLocale: %s", new Object[] {
            s3, s4, obj, s, s1
        });
        obj = TAG;
    ...
    public boolean setSecondaryRadioId(String s)
    {
        if (!isValidRadioId(s))
        {
            MAPLog.e(TAG, "setSecondaryRadioId: radio id was invalid. Cannot set.");
            return false;
        } else
        {
            mSecondaryRadioId = s;
