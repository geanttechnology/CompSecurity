    ...
    implements IAmazonWebServiceCallback
{
    ...
    public void onRequestComplete()
    {
        ...
        {
            Object obj = TAG;
            mResponseString.toString();
            obj = mResponseParser.getParseError();
            mListener.onParseError(((ParseError) (obj)));
            return;
        }
        ...
        Object obj1 = mResponseParser.getParsedResponse();
        if (responseHasError(obj1))
        {
            String s = TAG;
            mResponseString.toString();
        }
        mListener.onResponseComplete(obj1);
    }
