...
public class PandaTokenExchangeRequestBuilder
{
    ...
    public PandaTokenExchangeRequestBuilder()
    {
        ...
        mOsName = "defaultOS";
        mHwVersion = "defaultHwVersion";
        mOsVersion = "defaultOsVersion";
        mSdkVersion = "defaultSDKVersion";
        mAppName = "defaultAppName";
        mAppVersion = "defaultAppVersion";
    }
    ...
    public PandaTokenExchangeRequest build()
    {
        ...
        ((JSONObject) (obj)).put("device_os_name", mOsName);
        ((JSONObject) (obj)).put("device_hw_version", mHwVersion);
        ((JSONObject) (obj)).put("device_os_version", mOsVersion);
        ((JSONObject) (obj)).put("device_sdk_version", mSdkVersion);
        ((JSONObject) (obj)).put("app_name", mAppName);
        ((JSONObject) (obj)).put("app_version", mAppVersion);
    ...
    public PandaTokenExchangeRequestBuilder setHwVersion(String s)
    {
        if (!TextUtils.isEmpty(s))
        {
            mHwVersion = s;
    ...
    public PandaTokenExchangeRequestBuilder setOsName(String s)
    {
        if (!TextUtils.isEmpty(s))
        {
            mOsName = s;
    ...
    public PandaTokenExchangeRequestBuilder setOsVersion(String s)
    {
        if (!TextUtils.isEmpty(s))
        {
            mOsVersion = s;
    ...
    public PandaTokenExchangeRequestBuilder setSDKVersion(String s)
    {
        if (!TextUtils.isEmpty(s))
        {
            mSdkVersion = s;
