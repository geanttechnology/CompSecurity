...
_L1:
    ...
    public String getBody()
    {
        ...
        try
        {
            s = new String(getBodyBytes(), "UTF-8");
        }
        catch (UnsupportedEncodingException unsupportedencodingexception)
        {
            MAPLog.e(TAG, (new StringBuilder("getBody: UnsupportedEncodingException error: ")).append(unsupportedencodingexception.getMessage()).toString());
            return "";
        }
        return s;
    }
