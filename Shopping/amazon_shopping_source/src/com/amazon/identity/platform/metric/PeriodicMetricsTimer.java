...
class PeriodicMetricsTimer extends PlatformMetricsTimer
{
    ...
    private static final String TAG = com/amazon/identity/platform/metric/PeriodicMetricsTimer.getName();
    ...
    PeriodicMetricsTimer(MetricEvent metricevent, String s)
    {
        mStartTimeNanos = -1L;
        mEndTimeNanos = -1L;
        mDiscard = false;
        mPeriodicMetricEvent = metricevent;
        mTimerName = s;
    }
    ...
    public void stop()
    {
        ...
        mStartTimeNanos = -1L;
        mEndTimeNanos = -1L;
        mPeriodicMetricEvent.addTimer(mTimerName, (double)l / 1000000D);
    }
