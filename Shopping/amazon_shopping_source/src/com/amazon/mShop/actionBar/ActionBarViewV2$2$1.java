    ...
    implements Runnable
{
    ...
    public void run()
    {
        ActivityUtils.startHomeActivity(ActionBarViewV2.access$100(_fld0));
    ...
    // Unreferenced inner class com/amazon/mShop/actionBar/ActionBarViewV2$2

/* anonymous class */
    class ActionBarViewV2._cls2
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            {
                GNODrawerHelper.closeDrawerAndExecute(ActionBarViewV2.access$100(ActionBarViewV2.this), true, new ActionBarViewV2._cls2._cls1());
                return;
            }
        }
