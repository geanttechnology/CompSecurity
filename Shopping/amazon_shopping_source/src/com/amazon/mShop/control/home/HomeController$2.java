    ...
    implements Runnable
{
    ...
    public void run()
    {
        HomeController.access$102(HomeController.this, val$value);
        for (Iterator iterator = (new ArrayList(HomeController.access$200(HomeController.this))).iterator(); iterator.hasNext(); ((HomeSubscriber)iterator.next()).onPromoSlot0Received(val$value)) { }
    }
