    ...
    implements Runnable
{
    ...
    public void run()
    {
        if (NotificationSettingController.access$500(NotificationSettingController.this, val$sc))
        {
            NotificationSettingController.access$100(NotificationSettingController.this).onDeviceTokenUpdated();
            NotificationSettingController.access$600(NotificationSettingController.this);
        }
    }
