    ...
    implements Runnable
{
    ...
    public void run()
    {
        ...
        for (Iterator iterator = (new ArrayList(RecommendationsController.access$200(RecommendationsController.this))).iterator(); iterator.hasNext(); ((RecommendationsRatingSubscriber)iterator.next()).onRecsRatingCallCancelled()) { }
    }
