...
class this._cls0 extends NonZeroLengthTextWatcher
{
    ...
    public void update()
    {
        CVSDMapActivity.access$2000(CVSDMapActivity.this).setEnabled(CVSDMapActivity.access$1900(CVSDMapActivity.this).isWatchedNonZeroLength());
    }
