    ...
    implements lickListener
{
    ...
    {
        String s = mRes.getString(val$stringId);
        gnodrawer = s;
        ...
        AppNavigator.navigate(amazonactivity, com.amazon.mShop.navigation.w, Maps.of("url", gnodrawer, "forceClearHistory", Boolean.valueOf(false)));
    }
