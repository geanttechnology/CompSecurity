...
class this._cls0
    implements android.view.ultsView._cls2
{
    ...
    {
        view = new Intent(NoMatchSearchResultsView.access$000(NoMatchSearchResultsView.this), com/amazon/mShop/recommendations/RecommendationsActivity);
