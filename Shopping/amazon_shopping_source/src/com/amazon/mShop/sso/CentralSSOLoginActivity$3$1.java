    ...
    implements this._cls1
{
    ...
    // Unreferenced inner class com/amazon/mShop/sso/CentralSSOLoginActivity$3

/* anonymous class */
    class CentralSSOLoginActivity._cls3
        implements Callback
    {
        ...
        public void onError(Bundle bundle)
        {
            ...
            if (i == com.amazon.identity.auth.device.api.MAPAccountManager.RegistrationError.REGISTER_FAILED.value() && bundle.getInt("errorCode") == 4)
            {
        ...
        public void onSuccess(Bundle bundle)
        {
            ...
            (new MShopCheckLogin(getApplicationContext(), CentralSSOLoginActivity.access$600(CentralSSOLoginActivity.this), new CentralSSOLoginActivity._cls3._cls1(), false)).checkLogin();
            setResult(-1);
