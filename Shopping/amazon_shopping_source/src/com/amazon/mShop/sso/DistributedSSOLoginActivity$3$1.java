...
class val.newAccount
    implements Runnable
{

    final val.startTime this$1;
    ...
    public void run()
    {
        if (DistributedSSOLoginActivity.access$500())
        {
            ...
            Log.d(DistributedSSOLoginActivity.access$400(), (new StringBuilder()).append("before addAccountCustomeKey:").append(l - val$startTime).toString());
        }
        SSOUtil.addAccountCustomKeyMapping(val$newAccount);
        if (DistributedSSOLoginActivity.access$600())
        {
            long l1 = SystemClock.elapsedRealtime();
            Log.d(DistributedSSOLoginActivity.access$400(), (new StringBuilder()).append("after addAccountCustomKey:").append(l1 - val$startTime).toString());
        }
    }

    l.prevAtMain()
    {
        this$1 = final_prevatmain;
        val$startTime = l;
        val$newAccount = String.this;
        super();
    }
...
/* anonymous class */
        ...
        implements Callback
    {
        ...
        public void onSuccess(Bundle bundle)
        {
            ...
            DistributedSSOLoginActivity.access$700().execute(((DistributedSSOLoginActivity._cls3._cls1) (obj)). new DistributedSSOLoginActivity._cls3._cls1());
            if (SSOUtil.DEBUG)
            {
                long l1 = SystemClock.elapsedRealtime();
        ...
        // Unreferenced inner class com/amazon/mShop/sso/DistributedSSOLoginActivity$3$2

/* anonymous class */
        class DistributedSSOLoginActivity._cls3._cls2
            implements MShopCheckLogin.Subscriber
        {
