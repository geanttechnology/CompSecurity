    ...
    implements Callback
{
    ...
    public void onError(Bundle bundle)
    {
        ...
        if (i == com.amazon.identity.auth.device.api.Error.ACCOUNT_ALREADY_EXISTS.value())
        {
            onSuccess(bundle);
            return;
        } else
        {
            ...
            CookieBridge.setCookies(getApplicationContext(), val$secureCookies, true);
            CookieBridge.setCookies(getApplicationContext(), val$nonSecureCookies, false);
    ...
    public void onSuccess(Bundle bundle)
    {
        ...
        DistributedSSOLoginActivity.access$700().execute(new Runnable() {
            ...
            public void run()
            {
                if (DistributedSSOLoginActivity.access$500())
                {
                    ...
                    Log.d(DistributedSSOLoginActivity.access$400(), (new StringBuilder()).append("before addAccountCustomeKey:").append(l6 - startTime).toString());
                }
                ...
                if (DistributedSSOLoginActivity.access$600())
                {
                    ...
                    Log.d(DistributedSSOLoginActivity.access$400(), (new StringBuilder()).append("after addAccountCustomKey:").append(l7 - startTime).toString());
                }
            }
        ...
        if (Util.isEmpty(s) || s.equals(val$prevAtMain))
        {
        ...
        (new MShopCheckLogin(getApplicationContext(), DistributedSSOLoginActivity.access$800(DistributedSSOLoginActivity.this), new MShopCheckLogin.Subscriber() {
    ...
    _cls2.this._cls1()
    {
        ...
        val$secureCookies = s;
        val$nonSecureCookies = s1;
        val$prevAtMain = String.this;
        super();
    }
}
