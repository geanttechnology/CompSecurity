    ...
    implements android.view.r
{
    ...
    public void onClick(View view)
    {
        ...
        {
            SSOUtil.getCurrentIdentityType().handleSSOLogin(SigninPromptView.access$000(SigninPromptView.this), true, false, true, null);
        } else
        {
            ActivityUtils.startLoginActivityForResult(SigninPromptView.access$000(SigninPromptView.this), 0, null, false, true, true, null);
        }
