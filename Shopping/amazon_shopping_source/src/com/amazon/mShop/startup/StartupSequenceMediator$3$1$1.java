...
/* anonymous class */
    ...
    // Unreferenced inner class com/amazon/mShop/startup/StartupSequenceMediator$3$1

/* anonymous class */
    class StartupSequenceMediator._cls3._cls1
        implements Runnable
    {
        ...
        public void run()
        {
            ...
            com.amazon.mShop.platform.Platform.Factory.getInstance().runOnUiThread(new StartupSequenceMediator._cls3._cls1._cls1());
        }
