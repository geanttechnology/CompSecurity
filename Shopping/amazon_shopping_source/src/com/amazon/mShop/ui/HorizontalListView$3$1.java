    ...
    implements Runnable
{
    ...
    public void run()
    {
        HorizontalListView.access$400(_fld0);
    }
    ...
    // Unreferenced inner class com/amazon/mShop/ui/HorizontalListView$3

/* anonymous class */
    class HorizontalListView._cls3 extends android.view.GestureDetector.SimpleOnGestureListener
    {
...
label1:
        ...
        {
            HorizontalListView.access$300(HorizontalListView.this, motionevent);
            postDelayed(new HorizontalListView._cls3._cls1(), 300L);
            return false;
        }
