...
class val.listener
    implements AddListIdeasResponseListener
{
    ...
    public void error(Exception exception, ServiceCall servicecall)
    {
        ...
        val$listener.onError(WearableServiceImpl.access$100(WearableServiceImpl.this, "add text to wishlist", exception), exception);
    }
