...
class it> extends android.view.eOnGestureListener
{
...
label1:
    ...
    public boolean onSingleTapUp(MotionEvent motionevent)
    {
        ...
        postDelayed(new Runnable() {
            ...
            final HorizontalListView._cls2 this$1;

            public void run()
            {
                HorizontalListView.access$500(this$0);
            }

            
            {
                this$1 = HorizontalListView._cls2.this;
                super();
            }
        }, 300L);
        return false;
