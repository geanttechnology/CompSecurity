    ...
    implements Runnable
{
    ...
    final val.deleteURL this$3;
    final String val$deleteURL;
    final String val$id;

    public void run()
    {
        synchronized (RetailSearchEditTextWatcher.access$100())
        {
            ._mth700(_fld1).deletePastSearches(val$id, val$deleteURL);
        }
