...
//            SuggestionsItemListener, RetailSearchEditTextWatcher, RetailSearchEditText, RetailSearchSuggestionCursorAdapter
    ...
    implements SuggestionsItemListener
{
    ...
    {
        synchronized (RetailSearchEditTextWatcher.access$800(_fld0))
        {
            if (!RetailSearchEditTextWatcher.access$900(_fld0))
            {
                RetailSearchEditTextWatcher.access$600(_fld0).searchSuggestionsFirstEntryShowed();
                RetailSearchEditTextWatcher.access$902(_fld0, true);
            }
        }
        return;
        exception;
    ...
    public void onDeletePastSearchesClick(final String id, final String deleteURL)
    {
        (new Thread(new Runnable() {
            ...
            {
                this$3 = RetailSearchEditTextWatcher.CursorFilter._cls2._cls1.this;
                id = s;
                deleteURL = s1;
                super();
            }
        })).start();
        RetailSearchEditTextWatcher.access$600(_fld0).recordRecentSearchCleared();
    }
    ...
    public void onQueryBuilderClick(String s)
    {
        if (s != null && !s.equals(mSearchEditText.getText().toString()))
        {
            ...
            RetailSearchEditTextWatcher.access$600(_fld0).recordQueryBuilderUsage();
        }
    }
...
/* anonymous class */
        ...
        // Unreferenced inner class com/amazon/retailsearch/android/ui/entry/RetailSearchEditTextWatcher$CursorFilter$2$3

/* anonymous class */
        class RetailSearchEditTextWatcher.CursorFilter._cls2._cls3
