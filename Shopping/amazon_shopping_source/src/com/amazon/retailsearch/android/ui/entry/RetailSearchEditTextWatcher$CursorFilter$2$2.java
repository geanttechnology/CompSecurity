    ...
    implements QuerySubmitListener
{
    ...
    {
        if (RetailSearchEditTextWatcher.access$1000(_fld0) != null)
        {
            UIUtils.closeSoftKeyboard(mSearchEditText);
            RetailSearchEditTextWatcher.access$1000(_fld0).onQuerySubmit(retailsearchquery);
        }
    }
