    ...
    implements IRefinementsMenuListener
{
    ...
    public void onHide()
    {
        ...
        {
            RefinementMenu.access$100(RefinementMenu.this).onHide();
        }
    }
    ...
    public void onRefinementClick(String s)
    {
        ...
        if (RefinementMenu.access$100(RefinementMenu.this) != null)
        {
            RefinementMenu.access$100(RefinementMenu.this).onRefinementClick(s);
        }
    }
    ...
    public void onUpdate(Refinements refinements)
    {
        ...
        if (RefinementMenu.access$100(RefinementMenu.this) != null)
        {
            RefinementMenu.access$100(RefinementMenu.this).onUpdate(refinements);
        }
        RefinementMenu.access$200(RefinementMenu.this).hide();
    }
    ...
    public void onViewSizeChanged()
    {
        ...
        if (RefinementMenu.access$100(RefinementMenu.this) != null)
        {
            RefinementMenu.access$100(RefinementMenu.this).onViewSizeChanged();
        }
    }
