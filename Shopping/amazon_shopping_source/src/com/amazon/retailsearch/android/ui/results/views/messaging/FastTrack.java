    ...
    implements RetailSearchResultView
{
    ...
    public void buildView(FastTrackModel fasttrackmodel, ViewType viewtype)
    {
        ...
        viewtype.append(fasttrackmodel.getFastTrackSyledText(), com.amazon.retailsearch.R.style.Results_FastTrack);
    ...
    {
        buildView((FastTrackModel)obj, viewtype);
    }
}
