    ...
    public static class Builder
    {
        ...
        public SubscribeAndSaveModel build(PriceInfo priceinfo, boolean flag, ViewType viewtype, Resources resources)
        {
            ...
            } else
            {
                ...
                viewtype.setPrice(priceinfo.getPrice());
                if (priceinfo.getLink() == null || TextUtils.isEmpty(priceinfo.getLink().getText()))
                {
                    return null;
                }
                viewtype.setPriceLabel(priceinfo.getLink().getText());
                priceinfo = viewtype;
                if (flag)
                {
                    viewtype.setSaveMoreText(resources.getString(com.amazon.retailsearch.R.string.subscribe_and_save));
                    return viewtype;
                }
            }
            return priceinfo;
