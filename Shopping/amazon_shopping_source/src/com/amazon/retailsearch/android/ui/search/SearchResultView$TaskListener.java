...
private class <init> extends com.amazon.retailsearch.data.TaskListener
{
    ...
    {
        if (displaysettings != null && !SearchResultView.access$100(SearchResultView.this) && DisplaySettingsUtil.displaySettingsEnabled(getResources(), featureConfig))
        {
            if ((displaysettings = ViewType.findByNameIgnoreCase(displaysettings.getResultLayout())) != null)
            {
                SearchResultView.access$102(SearchResultView.this, true);
    ...
    public void endPage()
    {
        ViewSelector viewselector = SearchResultView.access$200(SearchResultView.this).getViewSelector();
        if (viewselector != null && !SearchResultView.access$100(SearchResultView.this) && DisplaySettingsUtil.displaySettingsEnabled(getResources(), featureConfig))
        {
            SearchResultView.access$102(SearchResultView.this, true);
