...
//            Position, DialogSizeChangedListener
...
_L2:
    ...
    {
        bundle = new Dialog(getActivity(), 0x1030010) {
        ...
        } else
        {
            ...
            setCancelable(true);
            bundle.getWindow().clearFlags(1024);
            bundle.getWindow().setLayout(-2, -2);
            bundle.getWindow().setGravity(51);
            bundle.getWindow().getAttributes().windowAnimations = com.amazon.retailsearch.R.style.PopupDialogFragmentAnimation;
            setDialogBounds(bundle);
            return bundle;
        }
    }
