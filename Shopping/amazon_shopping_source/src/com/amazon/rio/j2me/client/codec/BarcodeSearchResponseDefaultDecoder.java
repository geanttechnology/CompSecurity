...
//            Decoder, SearchResultDefaultDecoder, StreamedResponseListener, DefaultDecoder, 
//            QueryDescriptorDefaultDecoder, SearchResultsCountsDefaultDecoder

public class BarcodeSearchResponseDefaultDecoder
    implements Decoder
{
        ...
        implements StreamedResponseListener
    {
        ...
        final BarcodeSearchResponseDefaultDecoder this$0;
        ...
        {
            this$0 = BarcodeSearchResponseDefaultDecoder.this;
            fieldPath = ai;
    ...
    public BarcodeSearchResponseDefaultDecoder()
    {
    }
        ...
        throws IOException
    {
        ...
        {
            callback.receivedObject((new SearchResultDefaultDecoder()).decode(datainputstream, null), fieldPath);
        }
        ...
        fieldPath[0] = fieldPath[0] + 1;
        callback.receivedObject((Boolean)DefaultDecoder.getBooleanInstance().decode(datainputstream, null), fieldPath);
        fieldPath[0] = fieldPath[0] + 1;
        if (!datainputstream.readBoolean())
        {
        ...
        if (!datainputstream.readBoolean())
        {
            callback.receivedObject((new QueryDescriptorDefaultDecoder()).decode(datainputstream, null), fieldPath);
        }
        fieldPath[0] = fieldPath[0] + 1;
        callback.receivedObject((new SearchResultsCountsDefaultDecoder()).decode(datainputstream, null), fieldPath);
        fieldPath[0] = fieldPath[0] + 1;
