...
public class CreditCardTypeDefaultDecoder
    implements Decoder
{

    public CreditCardTypeDefaultDecoder()
    {
    }

    public CreditCardType decode(DataInputStream datainputstream, StreamedResponseListener streamedresponselistener)
        throws IOException
    {
        streamedresponselistener = new CreditCardType();
