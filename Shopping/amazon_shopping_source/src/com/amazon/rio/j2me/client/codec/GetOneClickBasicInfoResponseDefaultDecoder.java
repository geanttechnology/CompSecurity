...
public class GetOneClickBasicInfoResponseDefaultDecoder
    implements Decoder
{

    public GetOneClickBasicInfoResponseDefaultDecoder()
    {
    }

    public GetOneClickBasicInfoResponse decode(DataInputStream datainputstream, StreamedResponseListener streamedresponselistener)
        throws IOException
    {
        streamedresponselistener = new GetOneClickBasicInfoResponse();
