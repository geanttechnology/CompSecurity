...
public class MinimalItemDefaultDecoder
    implements Decoder
{

    public MinimalItemDefaultDecoder()
    {
    }

    public MinimalItem decode(DataInputStream datainputstream, StreamedResponseListener streamedresponselistener)
        throws IOException
    {
        streamedresponselistener = new MinimalItem();
