...
import com.amazon.rio.j2me.client.codec.AddListIdeasRequestDefaultEncoder;
import com.amazon.rio.j2me.client.codec.AddListIdeasResponseDefaultDecoder;
...
//            AddListIdeasResponseListener, AddListIdeasRequest

public class AddListIdeasClientRequestReply extends BaseClientRequestReply
{

    private final AddListIdeasResponseListener callback;
    private final AddListIdeasRequest request;

    public AddListIdeasClientRequestReply(ServiceCallImpl servicecallimpl, AddListIdeasRequest addlistideasrequest, AddListIdeasResponseListener addlistideasresponselistener)
    {
        super(servicecallimpl);
        request = addlistideasrequest;
        callback = addlistideasresponselistener;
    }
        ...
        throws IOException
    {
        ...
        {
            inputstream = (new AddListIdeasResponseDefaultDecoder()).decode(inputstream, null);
        ...
        throws IOException
    {
        ...
        (new AddListIdeasRequestDefaultEncoder()).encode(request, outputstream);
    }
}
