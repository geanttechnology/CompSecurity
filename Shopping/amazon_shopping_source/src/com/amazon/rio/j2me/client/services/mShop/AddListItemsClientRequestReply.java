...
import com.amazon.rio.j2me.client.codec.AddListItemsRequestDefaultEncoder;
import com.amazon.rio.j2me.client.codec.AddListItemsResponseDefaultDecoder;
...
//            AddListItemsResponseListener, AddListItemsRequest

public class AddListItemsClientRequestReply extends BaseClientRequestReply
{

    private final AddListItemsResponseListener callback;
    private final AddListItemsRequest request;

    public AddListItemsClientRequestReply(ServiceCallImpl servicecallimpl, AddListItemsRequest addlistitemsrequest, AddListItemsResponseListener addlistitemsresponselistener)
    {
        super(servicecallimpl);
        request = addlistitemsrequest;
        callback = addlistitemsresponselistener;
    }
        ...
        throws IOException
    {
        ...
        {
            inputstream = (new AddListItemsResponseDefaultDecoder()).decode(inputstream, null);
        ...
        throws IOException
    {
        ...
        (new AddListItemsRequestDefaultEncoder()).encode(request, outputstream);
    }
}
