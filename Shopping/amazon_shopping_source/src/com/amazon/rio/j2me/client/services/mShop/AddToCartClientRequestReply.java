...
import com.amazon.rio.j2me.client.codec.CartAdditionRequestDefaultEncoder;
...
//            AddToCartResponseListener, CartAdditionRequest

public class AddToCartClientRequestReply extends BaseClientRequestReply
{

    private final AddToCartResponseListener callback;
    private final CartAdditionRequest request;

    public AddToCartClientRequestReply(ServiceCallImpl servicecallimpl, CartAdditionRequest cartadditionrequest, AddToCartResponseListener addtocartresponselistener)
    {
        super(servicecallimpl);
        request = cartadditionrequest;
        callback = addtocartresponselistener;
    }
        ...
        throws IOException
    {
        ...
        (new CartAdditionRequestDefaultEncoder()).encode(request, outputstream);
    }
}
