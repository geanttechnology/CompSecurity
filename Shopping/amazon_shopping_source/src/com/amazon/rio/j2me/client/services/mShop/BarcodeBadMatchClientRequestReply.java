...
import com.amazon.rio.j2me.client.codec.BarcodeBadMatchDefaultEncoder;
import com.amazon.rio.j2me.client.codec.DefaultDecoder;
import com.amazon.rio.j2me.client.codec.NullDefaultDecoder;
...
//            BarcodeBadMatchResponseListener, BarcodeBadMatch

public class BarcodeBadMatchClientRequestReply extends BaseClientRequestReply
{

    private final BarcodeBadMatchResponseListener callback;
    private final BarcodeBadMatch request;

    public BarcodeBadMatchClientRequestReply(ServiceCallImpl servicecallimpl, BarcodeBadMatch barcodebadmatch, BarcodeBadMatchResponseListener barcodebadmatchresponselistener)
    {
        super(servicecallimpl);
        request = barcodebadmatch;
        callback = barcodebadmatchresponselistener;
    }
        ...
        throws IOException
    {
        ...
        {
            inputstream = (new NullDefaultDecoder()).decode(inputstream, null);
        ...
        throws IOException
    {
        ...
        (new BarcodeBadMatchDefaultEncoder()).encode(request, outputstream);
    }
}
