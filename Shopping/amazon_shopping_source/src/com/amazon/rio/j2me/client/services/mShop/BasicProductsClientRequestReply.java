...
import com.amazon.rio.j2me.client.codec.BasicProductsRequestDefaultEncoder;
import com.amazon.rio.j2me.client.codec.BasicProductsResponseDefaultDecoder;
...
//            BasicProductsResponseListener, BasicProductsRequest

public class BasicProductsClientRequestReply extends BaseClientRequestReply
{

    private final BasicProductsResponseListener callback;
    private final BasicProductsRequest request;

    public BasicProductsClientRequestReply(ServiceCallImpl servicecallimpl, BasicProductsRequest basicproductsrequest, BasicProductsResponseListener basicproductsresponselistener)
    {
        super(servicecallimpl);
        request = basicproductsrequest;
        callback = basicproductsresponselistener;
    }
        ...
        throws IOException
    {
        ...
        {
            inputstream = (new BasicProductsResponseDefaultDecoder()).decode(inputstream, null);
        ...
        throws IOException
    {
        ...
        (new BasicProductsRequestDefaultEncoder()).encode(request, outputstream);
    }
}
