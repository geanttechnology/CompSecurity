...
import com.amazon.rio.j2me.client.codec.BuyAsinRequestDefaultEncoder;
import com.amazon.rio.j2me.client.codec.DefaultDecoder;
import com.amazon.rio.j2me.client.codec.PurchaseOrderResponseDefaultDecoder;
...
//            BuyAsinResponseListener, BuyAsinRequest

public class BuyAsinClientRequestReply extends BaseClientRequestReply
{

    private final BuyAsinResponseListener callback;
    private final BuyAsinRequest request;

    public BuyAsinClientRequestReply(ServiceCallImpl servicecallimpl, BuyAsinRequest buyasinrequest, BuyAsinResponseListener buyasinresponselistener)
    {
        super(servicecallimpl);
        request = buyasinrequest;
        callback = buyasinresponselistener;
    }
        ...
        throws IOException
    {
        ...
        {
            inputstream = (new PurchaseOrderResponseDefaultDecoder()).decode(inputstream, null);
        ...
        throws IOException
    {
        ...
        (new BuyAsinRequestDefaultEncoder()).encode(request, outputstream);
    }
}
