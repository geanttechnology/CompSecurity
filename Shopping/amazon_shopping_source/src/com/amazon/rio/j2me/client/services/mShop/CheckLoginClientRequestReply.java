...
import com.amazon.rio.j2me.client.codec.CheckLoginRequestDefaultEncoder;
import com.amazon.rio.j2me.client.codec.DefaultDecoder;
import com.amazon.rio.j2me.client.codec.LoginResponseDefaultDecoder;
...
//            CheckLoginResponseListener, CheckLoginRequest

public class CheckLoginClientRequestReply extends BaseClientRequestReply
{

    private final CheckLoginResponseListener callback;
    private final CheckLoginRequest request;

    public CheckLoginClientRequestReply(ServiceCallImpl servicecallimpl, CheckLoginRequest checkloginrequest, CheckLoginResponseListener checkloginresponselistener)
    {
        super(servicecallimpl);
        request = checkloginrequest;
        callback = checkloginresponselistener;
    }
        ...
        throws IOException
    {
        ...
        {
            inputstream = (new LoginResponseDefaultDecoder()).decode(inputstream, null);
        ...
        throws IOException
    {
        ...
        (new CheckLoginRequestDefaultEncoder()).encode(request, outputstream);
    }
}
