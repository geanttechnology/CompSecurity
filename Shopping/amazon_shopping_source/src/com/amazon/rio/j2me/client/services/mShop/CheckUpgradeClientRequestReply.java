...
import com.amazon.rio.j2me.client.codec.UpgradeRequestDefaultEncoder;
import com.amazon.rio.j2me.client.codec.UpgradeResponseDefaultDecoder;
...
//            CheckUpgradeResponseListener, UpgradeRequest

public class CheckUpgradeClientRequestReply extends BaseClientRequestReply
{

    private final CheckUpgradeResponseListener callback;
    private final UpgradeRequest request;

    public CheckUpgradeClientRequestReply(ServiceCallImpl servicecallimpl, UpgradeRequest upgraderequest, CheckUpgradeResponseListener checkupgraderesponselistener)
    {
        super(servicecallimpl);
        request = upgraderequest;
        callback = checkupgraderesponselistener;
    }
        ...
        throws IOException
    {
        ...
        {
            inputstream = (new UpgradeResponseDefaultDecoder()).decode(inputstream, null);
        ...
        throws IOException
    {
        ...
        (new UpgradeRequestDefaultEncoder()).encode(request, outputstream);
    }
}
