...
//            DisableOneClickResponseListener, Null

public class DisableOneClickClientRequestReply extends BaseClientRequestReply
{

    private final DisableOneClickResponseListener callback;
    private final Null request;

    public DisableOneClickClientRequestReply(ServiceCallImpl servicecallimpl, Null null1, DisableOneClickResponseListener disableoneclickresponselistener)
    {
        super(servicecallimpl);
        request = null1;
        callback = disableoneclickresponselistener;
    }
