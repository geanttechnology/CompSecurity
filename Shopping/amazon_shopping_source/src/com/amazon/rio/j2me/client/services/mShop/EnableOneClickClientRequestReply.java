...
import com.amazon.rio.j2me.client.codec.Encoder;
...
//            EnableOneClickResponseListener

public class EnableOneClickClientRequestReply extends BaseClientRequestReply
{

    private final EnableOneClickResponseListener callback;
    private final String request;

    public EnableOneClickClientRequestReply(ServiceCallImpl servicecallimpl, String s, EnableOneClickResponseListener enableoneclickresponselistener)
    {
        super(servicecallimpl);
        request = s;
        callback = enableoneclickresponselistener;
    }
        ...
        throws IOException
    {
        ...
        {
            inputstream = (Boolean)DefaultDecoder.getBooleanInstance().decode(inputstream, null);
        ...
        throws IOException
    {
        ...
        DefaultEncoder.getStringInstance().encode(request, outputstream);
    }
}
