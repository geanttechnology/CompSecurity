...
import com.amazon.rio.j2me.client.codec.GetListListsRequestDefaultEncoder;
import com.amazon.rio.j2me.client.codec.ListListDefaultDecoder;
...
//            GetListListsResponseListener, GetListListsRequest

public class GetListListsClientRequestReply extends BaseClientRequestReply
{

    private final GetListListsResponseListener callback;
    private final GetListListsRequest request;

    public GetListListsClientRequestReply(ServiceCallImpl servicecallimpl, GetListListsRequest getlistlistsrequest, GetListListsResponseListener getlistlistsresponselistener)
    {
        super(servicecallimpl);
        request = getlistlistsrequest;
        callback = getlistlistsresponselistener;
    }
        ...
        throws IOException
    {
        ...
        {
            inputstream = (List)DefaultDecoder.getArrayInstance(new ListListDefaultDecoder()).decode(inputstream, null);
        ...
        throws IOException
    {
        ...
        (new GetListListsRequestDefaultEncoder()).encode(request, outputstream);
    }
}
