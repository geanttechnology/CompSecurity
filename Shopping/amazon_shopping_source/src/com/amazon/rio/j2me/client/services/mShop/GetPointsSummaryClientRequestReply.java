...
import com.amazon.rio.j2me.client.codec.PointsSummaryResponseDefaultDecoder;
...
//            GetPointsSummaryResponseListener, Null

public class GetPointsSummaryClientRequestReply extends BaseClientRequestReply
{

    private final GetPointsSummaryResponseListener callback;
    private final Null request;

    public GetPointsSummaryClientRequestReply(ServiceCallImpl servicecallimpl, Null null1, GetPointsSummaryResponseListener getpointssummaryresponselistener)
    {
        super(servicecallimpl);
        request = null1;
        callback = getpointssummaryresponselistener;
    }
        ...
        throws IOException
    {
        ...
        {
            inputstream = (new PointsSummaryResponseDefaultDecoder()).decode(inputstream, null);
