...
import com.amazon.rio.j2me.client.codec.KiangRegisterRequestDefaultEncoder;
import com.amazon.rio.j2me.client.codec.KiangRegisterResponseDefaultDecoder;
...
//            KiangRegisterResponseListener, KiangRegisterRequest

public class KiangRegisterClientRequestReply extends BaseClientRequestReply
{

    private final KiangRegisterResponseListener callback;
    private final KiangRegisterRequest request;

    public KiangRegisterClientRequestReply(ServiceCallImpl servicecallimpl, KiangRegisterRequest kiangregisterrequest, KiangRegisterResponseListener kiangregisterresponselistener)
    {
        super(servicecallimpl);
        request = kiangregisterrequest;
        callback = kiangregisterresponselistener;
    }
        ...
        throws IOException
    {
        ...
        {
            inputstream = (new KiangRegisterResponseDefaultDecoder()).decode(inputstream, null);
        ...
        throws IOException
    {
        ...
        (new KiangRegisterRequestDefaultEncoder()).encode(request, outputstream);
    }
}
