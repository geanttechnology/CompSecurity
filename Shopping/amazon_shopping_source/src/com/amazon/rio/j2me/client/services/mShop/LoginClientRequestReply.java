...
import com.amazon.rio.j2me.client.codec.LoginRequestDefaultEncoder;
...
//            LoginResponseListener, LoginRequest

public class LoginClientRequestReply extends BaseClientRequestReply
{

    private final LoginResponseListener callback;
    private final LoginRequest request;

    public LoginClientRequestReply(ServiceCallImpl servicecallimpl, LoginRequest loginrequest, LoginResponseListener loginresponselistener)
    {
        ...
        throws IOException
    {
        ...
        (new LoginRequestDefaultEncoder()).encode(request, outputstream);
    }
}
