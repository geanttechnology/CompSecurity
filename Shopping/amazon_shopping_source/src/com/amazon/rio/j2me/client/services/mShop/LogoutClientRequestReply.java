...
import com.amazon.rio.j2me.client.codec.LogoutRequestDefaultEncoder;
import com.amazon.rio.j2me.client.codec.LogoutResponseDefaultDecoder;
...
//            LogoutResponseListener, LogoutRequest

public class LogoutClientRequestReply extends BaseClientRequestReply
{

    private final LogoutResponseListener callback;
    private final LogoutRequest request;

    public LogoutClientRequestReply(ServiceCallImpl servicecallimpl, LogoutRequest logoutrequest, LogoutResponseListener logoutresponselistener)
    {
        super(servicecallimpl);
        request = logoutrequest;
        callback = logoutresponselistener;
    }
        ...
        throws IOException
    {
        ...
        {
            inputstream = (new LogoutResponseDefaultDecoder()).decode(inputstream, null);
        ...
        throws IOException
    {
        ...
        (new LogoutRequestDefaultEncoder()).encode(request, outputstream);
    }
}
