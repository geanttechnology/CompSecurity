...
import com.amazon.rio.j2me.client.codec.NavigationMenuRequestDefaultEncoder;
import com.amazon.rio.j2me.client.codec.NavigationMenuResponseDefaultDecoder;
...
//            NavigationMenuResponseListener, NavigationMenuRequest

public class NavigationMenuClientRequestReply extends BaseClientRequestReply
{

    private final NavigationMenuResponseListener callback;
    private final NavigationMenuRequest request;

    public NavigationMenuClientRequestReply(ServiceCallImpl servicecallimpl, NavigationMenuRequest navigationmenurequest, NavigationMenuResponseListener navigationmenuresponselistener)
    {
        super(servicecallimpl);
        request = navigationmenurequest;
        callback = navigationmenuresponselistener;
    }
        ...
        throws IOException
    {
        ...
        {
            inputstream = (new NavigationMenuResponseDefaultDecoder()).decode(inputstream, null);
        ...
        throws IOException
    {
        ...
        (new NavigationMenuRequestDefaultEncoder()).encode(request, outputstream);
    }
}
