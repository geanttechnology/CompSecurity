...
import com.amazon.rio.j2me.client.codec.NewAccountRequestDefaultEncoder;
...
//            NewAccountResponseListener, NewAccountRequest

public class NewAccountClientRequestReply extends BaseClientRequestReply
{

    private final NewAccountResponseListener callback;
    private final NewAccountRequest request;

    public NewAccountClientRequestReply(ServiceCallImpl servicecallimpl, NewAccountRequest newaccountrequest, NewAccountResponseListener newaccountresponselistener)
    {
        super(servicecallimpl);
        request = newaccountrequest;
        callback = newaccountresponselistener;
    }
        ...
        throws IOException
    {
        ...
        (new NewAccountRequestDefaultEncoder()).encode(request, outputstream);
    }
}
