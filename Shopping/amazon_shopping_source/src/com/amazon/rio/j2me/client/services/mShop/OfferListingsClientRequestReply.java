...
import com.amazon.rio.j2me.client.codec.OfferListingsRequestDefaultEncoder;
import com.amazon.rio.j2me.client.codec.OfferListingsResponseDefaultDecoder;
...
//            OfferListingsResponseListener, PrimeOneClickStatus, OfferListing, OfferListingsRequest

public class OfferListingsClientRequestReply extends BaseClientRequestReply
    implements StreamedResponseListener
{

    private final OfferListingsResponseListener callback;
    private final OfferListingsRequest request;

    public OfferListingsClientRequestReply(ServiceCallImpl servicecallimpl, OfferListingsRequest offerlistingsrequest, OfferListingsResponseListener offerlistingsresponselistener)
    {
        super(servicecallimpl);
        request = offerlistingsrequest;
        callback = offerlistingsresponselistener;
    }
        ...
        throws IOException
    {
        ...
        {
            (new OfferListingsResponseDefaultDecoder()).decode(inputstream, this);
            return;
        }
    }
        ...
        throws IOException
    {
        ...
        (new OfferListingsRequestDefaultEncoder()).encode(request, outputstream);
    }
    ...
    public void receivedObject(Object obj, int ai[])
    {
        ...
        } else
        {
            ...
            {
            default:
                throw new RuntimeException((new StringBuilder()).append("Unexpected field number ").append(ai[0]).append(" for record of Rio type 'Offer_Listings_Response'").toString());
            ...
            if (ai.length > 1)
            {
                callback.receivedOfferListing((OfferListing)obj, ai[1], serviceCall);
                return;
            }
        }
    }
