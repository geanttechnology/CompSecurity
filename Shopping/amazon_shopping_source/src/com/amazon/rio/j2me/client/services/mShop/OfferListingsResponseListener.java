...
//            OfferListing, PrimeOneClickStatus

public interface OfferListingsResponseListener
    extends ResponseListener
{
    ...
    public abstract void receivedOfferListing(OfferListing offerlisting, int i, ServiceCall servicecall);
