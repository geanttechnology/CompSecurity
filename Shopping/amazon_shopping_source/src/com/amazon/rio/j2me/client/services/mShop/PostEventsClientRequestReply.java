...
import com.amazon.rio.j2me.client.codec.PostEventsRequestDefaultEncoder;
import com.amazon.rio.j2me.client.codec.PostEventsResponseDefaultDecoder;
...
//            PostEventsResponseListener, PostEventsRequest

public class PostEventsClientRequestReply extends BaseClientRequestReply
{

    private final PostEventsResponseListener callback;
    private final PostEventsRequest request;

    public PostEventsClientRequestReply(ServiceCallImpl servicecallimpl, PostEventsRequest posteventsrequest, PostEventsResponseListener posteventsresponselistener)
    {
        super(servicecallimpl);
        request = posteventsrequest;
        callback = posteventsresponselistener;
    }
        ...
        throws IOException
    {
        ...
        {
            inputstream = (new PostEventsResponseDefaultDecoder()).decode(inputstream, null);
        ...
        throws IOException
    {
        ...
        (new PostEventsRequestDefaultEncoder()).encode(request, outputstream);
    }
}
