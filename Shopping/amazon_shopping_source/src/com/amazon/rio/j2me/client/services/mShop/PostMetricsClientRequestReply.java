...
import com.amazon.rio.j2me.client.codec.ClientMetricsDefaultEncoder;
...
//            PostMetricsResponseListener, ClientMetrics

public class PostMetricsClientRequestReply extends BaseClientRequestReply
{

    private final PostMetricsResponseListener callback;
    private final ClientMetrics request;

    public PostMetricsClientRequestReply(ServiceCallImpl servicecallimpl, ClientMetrics clientmetrics, PostMetricsResponseListener postmetricsresponselistener)
    {
        super(servicecallimpl);
        request = clientmetrics;
        callback = postmetricsresponselistener;
    }
        ...
        throws IOException
    {
        ...
        (new ClientMetricsDefaultEncoder()).encode(request, outputstream);
    }
}
