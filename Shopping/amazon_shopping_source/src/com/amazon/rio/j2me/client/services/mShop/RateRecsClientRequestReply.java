...
import com.amazon.rio.j2me.client.codec.RateRecsRequestDefaultEncoder;
import com.amazon.rio.j2me.client.codec.RateRecsResponseDefaultDecoder;
...
//            RateRecsResponseListener, RateRecsRequest

public class RateRecsClientRequestReply extends BaseClientRequestReply
{

    private final RateRecsResponseListener callback;
    private final RateRecsRequest request;

    public RateRecsClientRequestReply(ServiceCallImpl servicecallimpl, RateRecsRequest raterecsrequest, RateRecsResponseListener raterecsresponselistener)
    {
        super(servicecallimpl);
        request = raterecsrequest;
        callback = raterecsresponselistener;
    }
        ...
        throws IOException
    {
        ...
        {
            inputstream = (new RateRecsResponseDefaultDecoder()).decode(inputstream, null);
        ...
        throws IOException
    {
        ...
        (new RateRecsRequestDefaultEncoder()).encode(request, outputstream);
    }
}
