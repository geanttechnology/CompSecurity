...
//            SearchResponseListener, SearchResultsCounts, SearchResult, CategoryResult, 
//            QueryDescriptor, SearchRequest

public class SearchClientRequestReply extends BaseClientRequestReply
    implements StreamedResponseListener
{
    ...
    public SearchClientRequestReply(ServiceCallImpl servicecallimpl, SearchRequest searchrequest, SearchResponseListener searchresponselistener)
    {
        ...
        callback = searchresponselistener;
    }
