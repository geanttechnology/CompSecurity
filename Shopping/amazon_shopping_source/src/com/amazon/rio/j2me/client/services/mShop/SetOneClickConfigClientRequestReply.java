...
import com.amazon.rio.j2me.client.codec.SetOneClickConfigRequestDefaultEncoder;
...
//            SetOneClickConfigResponseListener, SetOneClickConfigRequest

public class SetOneClickConfigClientRequestReply extends BaseClientRequestReply
{

    private final SetOneClickConfigResponseListener callback;
    private final SetOneClickConfigRequest request;

    public SetOneClickConfigClientRequestReply(ServiceCallImpl servicecallimpl, SetOneClickConfigRequest setoneclickconfigrequest, SetOneClickConfigResponseListener setoneclickconfigresponselistener)
    {
        super(servicecallimpl);
        request = setoneclickconfigrequest;
        callback = setoneclickconfigresponselistener;
    }
        ...
        throws IOException
    {
        ...
        (new SetOneClickConfigRequestDefaultEncoder()).encode(request, outputstream);
    }
}
