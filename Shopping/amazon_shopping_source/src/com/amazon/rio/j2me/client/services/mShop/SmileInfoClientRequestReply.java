...
import com.amazon.rio.j2me.client.codec.SmileInfoRequestDefaultEncoder;
import com.amazon.rio.j2me.client.codec.SmileInfoResponseDefaultDecoder;
...
//            SmileInfoResponseListener, SmileInfoRequest

public class SmileInfoClientRequestReply extends BaseClientRequestReply
{

    private final SmileInfoResponseListener callback;
    private final SmileInfoRequest request;

    public SmileInfoClientRequestReply(ServiceCallImpl servicecallimpl, SmileInfoRequest smileinforequest, SmileInfoResponseListener smileinforesponselistener)
    {
        super(servicecallimpl);
        request = smileinforequest;
        callback = smileinforesponselistener;
    }
        ...
        throws IOException
    {
        ...
        {
            inputstream = (new SmileInfoResponseDefaultDecoder()).decode(inputstream, null);
        ...
        throws IOException
    {
        ...
        (new SmileInfoRequestDefaultEncoder()).encode(request, outputstream);
    }
}
