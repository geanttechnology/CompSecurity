    ...
    implements android.content.ener
{
    ...
    {
        CreditCardScanActivity.access$302(_fld0, true);
        CreditCardScanActivity.access$402(_fld0, false);
        CreditCardScanActivity.access$800(_fld0).recordTimeoutCancel();
        CreditCardScanActivity.access$1200(_fld0).post(new Runnable() {
...
/* anonymous class */
        ...
        implements Runnable
    {
        ...
        // Unreferenced inner class com/creditcardreader/activities/CreditCardScanActivity$9$1

/* anonymous class */
        class CreditCardScanActivity._cls9._cls1
