...
_L2:
        ...
        jsonparser.nextToken();
        obj = _beanProperties.find(((String) (obj1)));
        if (obj == null)
        {
            break; /* Loop/switch isn't completed */
        }
...
_L1:
        ...
        if (_anySetter != null)
        {
            _anySetter.deserializeAndSet(jsonparser, deserializationcontext, obj2, ((String) (obj1)));
        } else
        {
            handleUnknownProperty(jsonparser, deserializationcontext, obj2, ((String) (obj1)));
        }
          goto _L3
        return obj2;
    }
