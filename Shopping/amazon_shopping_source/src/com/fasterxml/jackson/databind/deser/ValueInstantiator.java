...
public abstract class ValueInstantiator
{
    ...
    {
        throw new JsonMappingException((new StringBuilder()).append("Can not instantiate value of type ").append(getValueTypeDesc()).append(" from Boolean value").toString());
    }

    public Object createFromDouble(DeserializationContext deserializationcontext, double d)
        throws IOException, JsonProcessingException
    {
        throw new JsonMappingException((new StringBuilder()).append("Can not instantiate value of type ").append(getValueTypeDesc()).append(" from Floating-point number (double)").toString());
    }

    public Object createFromInt(DeserializationContext deserializationcontext, int i)
        throws IOException, JsonProcessingException
    {
        throw new JsonMappingException((new StringBuilder()).append("Can not instantiate value of type ").append(getValueTypeDesc()).append(" from Integer number (int)").toString());
    }

    public Object createFromLong(DeserializationContext deserializationcontext, long l)
        throws IOException, JsonProcessingException
    {
        throw new JsonMappingException((new StringBuilder()).append("Can not instantiate value of type ").append(getValueTypeDesc()).append(" from Integer number (long)").toString());
    }
    ...
    public Object createFromString(DeserializationContext deserializationcontext, String s)
        throws IOException, JsonProcessingException
    {
        throw new JsonMappingException((new StringBuilder()).append("Can not instantiate value of type ").append(getValueTypeDesc()).append(" from String value").toString());
    }
