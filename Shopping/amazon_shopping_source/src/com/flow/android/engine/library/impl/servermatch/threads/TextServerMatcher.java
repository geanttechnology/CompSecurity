...
public class TextServerMatcher extends FlowServerRequestThread
{

    protected static Object sLockObject = new Object();

    public TextServerMatcher(HttpManagerInterface httpmanagerinterface, ThreadPoolManagerInterface threadpoolmanagerinterface, ClientDeviceInfo clientdeviceinfo, String s, com.a9.vs.mobile.library.impl.jni.ServerResponse.Type type, ByteArrayInputStream bytearrayinputstream, Map map, 
            Map map1)
    {
    ...
    {
        return getResponseFromServer("POST", true);
    }
    ...
    public void run()
    {
        ...
        {
            mHttpManagerInterface.didReceiveTextMatchResponse(s, mResponseType, d);
        }
