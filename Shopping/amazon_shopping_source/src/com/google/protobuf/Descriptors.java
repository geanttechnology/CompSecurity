...
public final class Descriptors
{
    ...
    private static final class DescriptorPool
    {
        ...
        {
            GenericDescriptor genericdescriptor = (GenericDescriptor)descriptorsByName.get(s);
            if (genericdescriptor == null) goto _L2; else goto _L1
_L1:
            return genericdescriptor;
_L2:
            DescriptorPool adescriptorpool[] = dependencies;
            int j = adescriptorpool.length;
            int i = 0;
label0:
            do
            {
label1:
                {
                    ...
                    GenericDescriptor genericdescriptor1 = (GenericDescriptor)adescriptorpool[i].descriptorsByName.get(s);
...
_L3:
        ...
        GenericDescriptor lookupSymbol(String s, GenericDescriptor genericdescriptor)
            throws DescriptorValidationException
        {
...
label0:
                {
                    ...
                    GenericDescriptor genericdescriptor1 = findSymbol(stringbuilder.toString());
                    if (genericdescriptor1 == null)
                    {
                        break label0;
                    }
...
_L3:
        ...
        DescriptorPool(FileDescriptor afiledescriptor[])
        {
            boolean flag = false;
            super();
            dependencies = new DescriptorPool[afiledescriptor.length];
            for (int i = 0; i < afiledescriptor.length; i++)
            {
                dependencies[i] = afiledescriptor[i].pool;
            }
        ...
        implements GenericDescriptor, FieldSet.FieldDescriptorLite, Comparable
    {
            ...
            throws DescriptorValidationException
        {
            ...
            {
                GenericDescriptor genericdescriptor = file.pool.lookupSymbol(proto.getExtendee(), this);
...
_L1:
            GenericDescriptor genericdescriptor1;
            genericdescriptor1 = file.pool.lookupSymbol(proto.getTypeName(), this);
            if (!proto.hasType())
            {
...
_L21:
        ...
        implements GenericDescriptor
    {
        ...
        private void crossLink()
            throws DescriptorValidationException
        {
            GenericDescriptor genericdescriptor = file.pool.lookupSymbol(proto.getInputType(), this);
            if (!(genericdescriptor instanceof Descriptor))
            {
            ...
            genericdescriptor = file.pool.lookupSymbol(proto.getOutputType(), this);
            if (!(genericdescriptor instanceof Descriptor))
            {
