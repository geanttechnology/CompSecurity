...
private static final class type extends type
{
    ...
    public Object getRepeated(getValueDescriptorMethod getvaluedescriptormethod, int i)
    {
        return GeneratedMessage.access$1400(getValueDescriptorMethod, super.epeated(getvaluedescriptormethod, i), new Object[0]);
    }

    public Object getRepeated(GeneratedMessage generatedmessage, int i)
    {
        return GeneratedMessage.access$1400(getValueDescriptorMethod, super.epeated(generatedmessage, i), new Object[0]);
    }

    public void setRepeated(epeated epeated, int i, Object obj)
    {
        super.epeated(epeated, i, GeneratedMessage.access$1400(valueOfMethod, null, new Object[] {
            obj
        }));
    }
