    ...
    implements Variant
{
        ...
        implements FrameReader
    {
        ...
        private void readHeaders(FrameReader.Handler handler, int i, int j)
            throws IOException
        {
            handler.headers(false, false, source.readInt() & 0x7fffffff, -1, -1, headerBlockReader.readNameValueBlock(j - 4), HeadersMode.SPDY_HEADERS);
        }
            ...
            throws IOException
        {
            ...
            handler.headers(false, flag, k & 0x7fffffff, -1, -1, list, HeadersMode.SPDY_REPLY);
        }
            ...
            throws IOException
        {
            ...
            handler.headers(flag1, flag, k & 0x7fffffff, l & 0x7fffffff, (0xe000 & word0) >>> 13, list, HeadersMode.SPDY_SYN_STREAM);
        }
...
_L2:
            ...
            sink.writeInt(((flag2 | byte0) & 0xff) << 24 | 0xffffff & i1);
            sink.writeInt(0x7fffffff & i);
            sink.writeInt(0x7fffffff & j);
            sink.writeShort((k & 7) << 13 | 0 | l & 0xff);
            sink.write(headerBlockBuffer, headerBlockBuffer.size());
            sink.flush();
            this;
            JVM INSTR monitorexit ;
