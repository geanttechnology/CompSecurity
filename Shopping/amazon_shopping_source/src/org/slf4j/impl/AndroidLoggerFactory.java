    ...
    implements ILoggerFactory
{
    ...
    public AndroidLogger getLogger(String s)
    {
        ...
        if (!s1.equals(s))
        {
            Log.i(org/slf4j/impl/AndroidLoggerFactory.getSimpleName(), (new StringBuilder()).append("Logger name '").append(s).append("' exceeds maximum length of ").append(23).append(" characters, using '").append(s1).append("' instead.").toString());
        }
