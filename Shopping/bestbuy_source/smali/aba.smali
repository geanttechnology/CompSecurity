...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-static {v8, v3}, Laba;->a(Landroid/content/pm/PackageManager;Ljava/lang/String;)Landroid/content/pm/ResolveInfo;
    ...
    :goto_1
    iput-boolean v3, p0, Laba;->c:Z

    invoke-virtual {v2}, Landroid/telephony/TelephonyManager;->getNetworkOperator()Ljava/lang/String;

    move-result-object v3

    iput-object v3, p0, Laba;->d:Ljava/lang/String;

    invoke-virtual {v7}, Ljava/util/Locale;->getCountry()Ljava/lang/String;

    move-result-object v3

    iput-object v3, p0, Laba;->e:Ljava/lang/String;

    invoke-static {}, Laca;->a()Z

    move-result v3

    iput-boolean v3, p0, Laba;->f:Z

    invoke-virtual {v0}, Landroid/media/AudioManager;->isMusicActive()Z

    move-result v3

    iput-boolean v3, p0, Laba;->g:Z

    invoke-virtual {v0}, Landroid/media/AudioManager;->isSpeakerphoneOn()Z

    move-result v3

    iput-boolean v3, p0, Laba;->h:Z

    invoke-virtual {v7}, Ljava/util/Locale;->getLanguage()Ljava/lang/String;

    move-result-object v3

    iput-object v3, p0, Laba;->i:Ljava/lang/String;

    invoke-static {v8}, Laba;->a(Landroid/content/pm/PackageManager;)Ljava/lang/String;

    move-result-object v3

    iput-object v3, p0, Laba;->j:Ljava/lang/String;
    ...
    invoke-static {p1, v1, v8}, Laba;->a(Landroid/content/Context;Landroid/net/ConnectivityManager;Landroid/content/pm/PackageManager;)I
    ...
    iput-boolean v5, p0, Laba;->u:Z

    goto :goto_3

    :cond_5
    iput v10, p0, Laba;->w:I

    goto :goto_4

    :cond_6
    iput-boolean v5, p0, Laba;->v:Z
...
.method private static a(Landroid/content/Context;Landroid/net/ConnectivityManager;Landroid/content/pm/PackageManager;)I
    ...
    invoke-static {p2, v1, v2}, Labq;->a(Landroid/content/pm/PackageManager;Ljava/lang/String;Ljava/lang/String;)Z
...
.method private static a(Landroid/content/pm/PackageManager;)Ljava/lang/String;
    ...
    invoke-static {p0, v1}, Laba;->a(Landroid/content/pm/PackageManager;Ljava/lang/String;)Landroid/content/pm/ResolveInfo;
