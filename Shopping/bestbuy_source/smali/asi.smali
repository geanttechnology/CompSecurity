...
.field private d:Lasj;

.field private e:Laef;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct/range {v0 .. v5}, Lasi;-><init>(Landroid/content/Context;Laef;Ljava/lang/String;ILjava/util/concurrent/Executor;)V

    return-void
.end method

.method constructor <init>(Landroid/content/Context;Laef;Ljava/lang/String;ILjava/util/concurrent/Executor;)V
    .locals 2
    ...
    iput-object p2, p0, Lasi;->e:Laef;

    iput p4, p0, Lasi;->f:I

    iput-object p5, p0, Lasi;->b:Ljava/util/concurrent/Executor;

    new-instance v0, Lasj;

    iget-object v1, p0, Lasi;->c:Landroid/content/Context;

    invoke-direct {v0, p0, v1, p3}, Lasj;-><init>(Lasi;Landroid/content/Context;Ljava/lang/String;)V

    iput-object v0, p0, Lasi;->d:Lasj;
...
.method private a(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
    ...
    :try_start_0
    iget-object v0, p0, Lasi;->d:Lasj;

    invoke-virtual {v0}, Lasj;->getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;
    :try_end_0
...
.method static synthetic a(Lasi;)Ljava/util/List;
    .locals 1

    invoke-direct {p0}, Lasi;->b()Ljava/util/List;
...
.method private a(Ljava/util/List;)Ljava/util/List;
    ...
    iget-object v4, v0, Lask;->a:Ljava/lang/String;

    iget-object v0, v0, Lask;->b:[B

    invoke-direct {p0, v0}, Lasi;->a([B)Ljava/lang/Object;

    move-result-object v0

    invoke-direct {v3, v4, v0}, Laqh;-><init>(Ljava/lang/String;Ljava/lang/Object;)V
...
.method private a(I)V
    ...
    invoke-direct {p0, v0}, Lasi;->b(I)Ljava/util/List;
...
.method private a(J)V
    ...
    invoke-direct {p0, v0}, Lasi;->a(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
...
.method static synthetic a(Lasi;Ljava/util/List;J)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lasi;->b(Ljava/util/List;J)V
...
.method static synthetic b(Lasi;)Landroid/content/Context;
    .locals 1
...
.method private b()Ljava/util/List;
    ...
    :try_start_0
    iget-object v0, p0, Lasi;->e:Laef;

    invoke-interface {v0}, Laef;->a()J

    move-result-wide v0

    invoke-direct {p0, v0, v1}, Lasi;->a(J)V

    invoke-direct {p0}, Lasi;->c()Ljava/util/List;

    move-result-object v0

    invoke-direct {p0, v0}, Lasi;->a(Ljava/util/List;)Ljava/util/List;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    move-result-object v0

    invoke-direct {p0}, Lasi;->e()V
...
.method private b(Ljava/util/List;)Ljava/util/List;
    ...
    invoke-direct {p0, v0}, Lasi;->a(Ljava/lang/Object;)[B

    move-result-object v0

    invoke-direct {v3, v4, v0}, Lask;-><init>(Ljava/lang/String;[B)V
...
.method private declared-synchronized b(Ljava/util/List;J)V
    ...
    invoke-direct {p0, v2}, Lasi;->a(I)V

    add-long/2addr v0, p2

    invoke-direct {p0, p1, v0, v1}, Lasi;->c(Ljava/util/List;J)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private c()Ljava/util/List;
    ...
    invoke-direct {v0, v2, v3}, Lask;-><init>(Ljava/lang/String;[B)V
...
.method private c(Ljava/util/List;J)V
    ...
    iget-object v5, v0, Lask;->a:Ljava/lang/String;
...
.method private d()I
    ...
    invoke-direct {p0, v2}, Lasi;->a(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
...
.method public a(Laqk;)V
    ...
    iget-object v0, p0, Lasi;->b:Ljava/util/concurrent/Executor;

    new-instance v1, Lasi$2;

    invoke-direct {v1, p0, p1}, Lasi$2;-><init>(Lasi;Laqk;)V
...
.method public a(Ljava/util/List;J)V
    ...
    invoke-direct {p0, p1}, Lasi;->b(Ljava/util/List;)Ljava/util/List;

    move-result-object v0

    iget-object v1, p0, Lasi;->b:Ljava/util/concurrent/Executor;

    new-instance v2, Lasi$1;

    invoke-direct {v2, p0, v0, p2, p3}, Lasi$1;-><init>(Lasi;Ljava/util/List;J)V
