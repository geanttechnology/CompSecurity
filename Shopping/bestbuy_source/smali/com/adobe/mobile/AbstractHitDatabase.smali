...
.method protected clearTrackingQueue()V
    ...
    .line 93
    const-string v2, "%s - Unable to clear tracking queue due to an unopened database (%s)"
    ...
    .line 96
    :try_start_2
    const-string v2, "%s - Unable to clear tracking queue due to a sql error (%s)"
    ...
    .line 99
    const-string v2, "%s - Unable to clear tracking queue due to an unexpected error (%s)"
...
.method protected deleteHit(Ljava/lang/String;)V
    ...
    .line 73
    :try_start_2
    const-string v2, "%s - Unable to delete hit due to an unopened database (%s)"
    ...
    .line 76
    const-string v2, "%s - Unable to delete hit due to a sql error (%s)"
    ...
    .line 80
    const-string v2, "%s - Unable to delete hit due to an unexpected error (%s)"
...
.method protected getTrackingQueueSize()J
    ...
    .line 174
    const-string v1, "%s - Unable to get tracking queue size due to an unopened database (%s)"
    ...
    .line 177
    const-string v1, "%s - Unable to get tracking queue size due to a sql error (%s)"
    ...
    .line 180
    const-string v1, "%s - Unable to get tracking queue size due to an unexpected error (%s)"
...
.method protected kick(Z)V
    ...
    .line 129
    const-string v2, "%s - Error creating referrer timer (%s)"
