.class final Lcom/exacttarget/etpushsdk/w;
...
.method constructor <init>(Ljava/lang/Thread;)V
    ...
    .prologue
    .line 1013
    iput-object p1, p0, Lcom/exacttarget/etpushsdk/w;->a:Ljava/lang/Thread;
...
.method public run()V
    ...
    const-string v1, "Waiting for activityPaused() to finish"
    ...
    const-string v1, "ETPush activityResumed() timed out waiting for state change."
    ...
    const-string v1, "activityPaused() finished.  So continue with resuming activity."
    ...
    .line 1022
    iget-object v0, p0, Lcom/exacttarget/etpushsdk/w;->a:Ljava/lang/Thread;
