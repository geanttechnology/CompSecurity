...
# direct methods
.method constructor <init>(Lcom/bestbuy/android/api/lib/models/summariesNpriceBlock/BBYProduct;Lcom/bestbuy/android/base/BBYBaseFragment;Landroid/content/Context;Lcom/bestbuy/android/api/lib/models/registry/Entities;)V
    .locals 0

    .prologue
    .line 112
    iput-object p1, p0, Lmo$1;->a:Lcom/bestbuy/android/api/lib/models/summariesNpriceBlock/BBYProduct;

    iput-object p2, p0, Lmo$1;->b:Lcom/bestbuy/android/base/BBYBaseFragment;

    iput-object p3, p0, Lmo$1;->c:Landroid/content/Context;

    iput-object p4, p0, Lmo$1;->d:Lcom/bestbuy/android/api/lib/models/registry/Entities;
...
.method public onClick(Landroid/view/View;)V
    ...
    .prologue
    .line 115
    iget-object v0, p0, Lmo$1;->a:Lcom/bestbuy/android/api/lib/models/summariesNpriceBlock/BBYProduct;
    ...
    .line 116
    iget-object v0, p0, Lmo$1;->b:Lcom/bestbuy/android/base/BBYBaseFragment;
    ...
    iget-object v1, p0, Lmo$1;->c:Landroid/content/Context;
    ...
    invoke-virtual {v0}, Lcom/bestbuy/android/activities/registry/WishListWithProductsFragment;->e()Landroid/view/View;
    ...
    .line 123
    :cond_2
    iget-object v0, p0, Lmo$1;->d:Lcom/bestbuy/android/api/lib/models/registry/Entities;

    invoke-virtual {v0}, Lcom/bestbuy/android/api/lib/models/registry/Entities;->getType()Ljava/lang/String;
    ...
    iget-object v2, p0, Lmo$1;->b:Lcom/bestbuy/android/base/BBYBaseFragment;

    iget-object v4, p0, Lmo$1;->a:Lcom/bestbuy/android/api/lib/models/summariesNpriceBlock/BBYProduct;

    invoke-virtual {v4}, Lcom/bestbuy/android/api/lib/models/summariesNpriceBlock/BBYProduct;->getSkuId()Ljava/lang/String;

    move-result-object v4

    iget-object v5, p0, Lmo$1;->d:Lcom/bestbuy/android/api/lib/models/registry/Entities;

    invoke-virtual {v5}, Lcom/bestbuy/android/api/lib/models/registry/Entities;->getUuid()Ljava/lang/String;

    move-result-object v5

    iget-object v6, p0, Lmo$1;->d:Lcom/bestbuy/android/api/lib/models/registry/Entities;
