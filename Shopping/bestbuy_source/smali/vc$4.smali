...
.method public a(Lcom/google/android/gms/internal/gu;Ljava/util/Map;)V
    ...
    :try_start_0
    invoke-virtual {p1}, Lcom/google/android/gms/internal/gu;->h()Laea;

    move-result-object v2

    if-eqz v2, :cond_1

    invoke-virtual {v2, v1}, Laea;->b(Landroid/net/Uri;)Z
    ...
    invoke-virtual {v2, v1, v3}, Laea;->a(Landroid/net/Uri;Landroid/content/Context;)Landroid/net/Uri;
    :try_end_0
    ...
    invoke-virtual {p1}, Lcom/google/android/gms/internal/gu;->i()Lcom/google/android/gms/internal/gs;

    move-result-object v3

    iget-object v3, v3, Lcom/google/android/gms/internal/gs;->b:Ljava/lang/String;

    invoke-direct {v1, v2, v3, v0}, Labz;-><init>(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
