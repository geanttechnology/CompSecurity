...
public final class ahb
{
    ...
    public static String a(aha aha1)
    {
        if (aha1 == null)
        {
            return "";
        ...
        try
        {
            a(null, aha1, new StringBuffer(), stringbuffer);
        }
        // Misplaced declaration of an exception variable
        catch (aha aha1)
        {
            return (new StringBuilder()).append("Error printing proto: ").append(aha1.getMessage()).toString();
        }
        // Misplaced declaration of an exception variable
        catch (aha aha1)
        {
...
_L1:
        return;
_L2:
        if (!(obj instanceof aha)) goto _L4; else goto _L3
_L3:
        Class class1;
        Object aobj[];
        int i;
