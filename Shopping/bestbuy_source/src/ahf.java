...
public abstract class ahf extends Binder
    implements ahe
{

    public static ahe a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof ahe))
        {
            return (ahe)iinterface;
        } else
        {
            return new ahg(ibinder);
        }
    }
