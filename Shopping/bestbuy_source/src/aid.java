...
public abstract class aid extends Binder
    implements aic
{
    ...
    public static aic a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof aic))
        {
            return (aic)iinterface;
        } else
        {
            return new aie(ibinder);
        }
    }
