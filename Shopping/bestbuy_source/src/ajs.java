...
public abstract class ajs extends Binder
    implements ajr
{

    public static ajr a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof ajr))
        {
            return (ajr)iinterface;
        } else
        {
            return new ajt(ibinder);
        }
    }
    ...
    public boolean onTransact(int i, Parcel parcel, Parcel parcel1, int j)
    {
        ...
        case 1: // '\001'
            ...
            a(alp.a(parcel.readStrongBinder()));
