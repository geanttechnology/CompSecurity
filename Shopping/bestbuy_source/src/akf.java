    ...
    implements akd
{
    ...
    public StreetViewPanoramaOrientation a(ry ry1)
    {
        Object obj;
        Parcel parcel;
        Parcel parcel1;
...
_L1:
        ...
        {
            ry1 = StreetViewPanoramaOrientation.CREATOR.a(parcel1);
        }
        parcel1.recycle();
        parcel.recycle();
        return ry1;
    ...
    public ry a(StreetViewPanoramaOrientation streetviewpanoramaorientation)
    {
        Parcel parcel;
        Parcel parcel1;
        parcel = Parcel.obtain();
...
_L1:
        ...
        parcel1.readException();
        streetviewpanoramaorientation = rz.a(parcel1.readStrongBinder());
        parcel1.recycle();
        parcel.recycle();
