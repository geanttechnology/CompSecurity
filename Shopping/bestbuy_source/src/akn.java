...
public abstract class akn extends Binder
    implements akm
{

    public static akm a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof akm))
        {
            return (akm)iinterface;
        } else
        {
            return new ako(ibinder);
        }
    }
