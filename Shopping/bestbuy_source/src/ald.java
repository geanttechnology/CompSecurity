...
public abstract class ald extends Binder
    implements alc
{

    public static alc a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof alc))
        {
            return (alc)iinterface;
        } else
        {
            return new ale(ibinder);
        }
    }
    ...
    public boolean onTransact(int i, Parcel parcel, Parcel parcel1, int j)
    {
        ...
        case 1: // '\001'
            ...
            parcel = a(aoq.a(parcel.readStrongBinder()), parcel.readInt(), parcel.readInt());
