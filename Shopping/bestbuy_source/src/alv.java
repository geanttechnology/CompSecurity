...
public abstract class alv extends Binder
    implements alu
{

    public static alu a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof alu))
        {
            return (alu)iinterface;
        } else
        {
            return new alw(ibinder);
        }
    }
