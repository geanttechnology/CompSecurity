...
public abstract class aly extends Binder
    implements alx
{

    public static alx a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof alx))
        {
            return (alx)iinterface;
        } else
        {
            return new alz(ibinder);
        }
    }
