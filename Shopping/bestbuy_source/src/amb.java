...
public abstract class amb extends Binder
    implements ama
{
    ...
    public static ama a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof ama))
        {
            return (ama)iinterface;
        } else
        {
            return new amc(ibinder);
        }
    }
    ...
    public boolean onTransact(int i, Parcel parcel, Parcel parcel1, int j)
    {
        ...
        case 1: // '\001'
            ...
            a(ajp.a(parcel.readStrongBinder()));
