...
public abstract class ame extends Binder
    implements amd
{
    ...
    public static amd a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof amd))
        {
            return (amd)iinterface;
        } else
        {
            return new amf(ibinder);
        }
    }
    ...
    public boolean onTransact(int i, Parcel parcel, Parcel parcel1, int j)
    {
        ...
        case 1: // '\001'
            ...
            flag = a(aoq.a(parcel.readStrongBinder()));
