...
public abstract class amk extends Binder
    implements amj
{

    public static amj a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof amj))
        {
            return (amj)iinterface;
        } else
        {
            return new aml(ibinder);
        }
    }
