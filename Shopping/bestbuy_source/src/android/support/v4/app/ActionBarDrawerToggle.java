    ...
    implements android.support.v4.widget.DrawerLayout.DrawerListener
{
    ...
    private class ActionBarDrawerToggleImpl
    {
    ...
    private class ActionBarDrawerToggleImplJellybeanMR2
    ...
    private class ActionBarDrawerToggleImplHC
        implements ActionBarDrawerToggleImpl
    {
    ...
    private class ActionBarDrawerToggleImplBase
        implements ActionBarDrawerToggleImpl
    {
