...
public abstract class any extends Binder
    implements anx
{

    public static anx a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof anx))
        {
            return (anx)iinterface;
        } else
        {
            return new anz(ibinder);
        }
    }
