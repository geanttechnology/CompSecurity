...
public abstract class aoq extends Binder
    implements aop
{

    public static aop a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof aop))
        {
            return (aop)iinterface;
        } else
        {
            return new aor(ibinder);
        }
    }
