...
public abstract class aot extends Binder
    implements aos
{

    public static aos a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof aos))
        {
            return (aos)iinterface;
        } else
        {
            return new aou(ibinder);
        }
    }
