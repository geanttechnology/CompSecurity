...
public abstract class aow extends Binder
    implements aov
{

    public static aov a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof aov))
        {
            return (aov)iinterface;
        } else
        {
            return new aox(ibinder);
        }
    }
