...
public abstract class aoz extends Binder
    implements aoy
{

    public static aoy a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof aoy))
        {
            return (aoy)iinterface;
        } else
        {
            return new apa(ibinder);
        }
    }
