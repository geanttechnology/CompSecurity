...
class asj extends SQLiteOpenHelper
{

    final asi a;

    asj(asi asi1, Context context, String s)
    {
        a = asi1;
...
_L1:
    ...
    private boolean a(String s, SQLiteDatabase sqlitedatabase)
    {
        ...
        sqlitedatabase = null;
_L4:
        aqv.b((new StringBuilder()).append("Error querying for table ").append(s).toString());
        if (sqlitedatabase != null)
        {
            sqlitedatabase.close();
        }
...
_L2:
        ...
        SQLiteException sqliteexception;
        sqliteexception;
        asi.b(a).getDatabasePath("google_tagmanager.db").delete();
        if (true) goto _L2; else goto _L1
_L1:
    }
