    ...
    implements rr
{
    ...
    private asw(aga aga1)
    {
        a = aga1;
    }

    asw(aga aga1, com.google.android.gms.wallet.fragment.WalletFragment._cls1 _pcls1)
    {
        this(aga1);
    }
    ...
    public static void a(asw asw1, int i, int j, Intent intent)
    {
        asw1.a(i, j, intent);
    }

    static void a(asw asw1, MaskedWallet maskedwallet)
    {
        asw1.a(maskedwallet);
    }

    static void a(asw asw1, MaskedWalletRequest maskedwalletrequest)
    {
        asw1.a(maskedwalletrequest);
    }

    static void a(asw asw1, WalletFragmentInitParams walletfragmentinitparams)
    {
        asw1.a(walletfragmentinitparams);
    }

    static void a(asw asw1, boolean flag)
    {
        asw1.a(flag);
    }
