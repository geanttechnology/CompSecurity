...
public final class Analytics
{
    ...
    public static void trackAction(final String action, final Map cdata)
    {
        if (cdata != null)
        {
            cdata = new HashMap(cdata);
        } else
        {
            cdata = null;
        }
    ...
    public static void trackBeacon(final String uuid, final String major, final String minor, final BEACON_PROXIMITY proximity, final Map cdata)
    {
        if (cdata != null)
        {
            cdata = new HashMap(cdata);
    ...
    public static void trackLifetimeValueIncrease(final BigDecimal amount, final HashMap contextData)
    {
        StaticMethods.getAnalyticsExecutor().execute(new Runnable() {
    ...
    public static void trackLocation(final Location location, final Map cdata)
    {
        if (cdata != null)
        {
            cdata = new HashMap(cdata);
    ...
    public static void trackState(final String state, final Map cdata)
    {
        if (cdata != null)
        {
            cdata = new HashMap(cdata);
    ...
    public static void trackTimedActionEnd(final String action, final TimedActionBlock logic)
    {
    ...
    public static void trackTimedActionStart(final String action, final Map cdata)
    {
        if (cdata != null)
        {
            cdata = new HashMap(cdata);
    ...
    public static void trackTimedActionUpdate(final String action, final Map cdata)
    {
        if (cdata != null)
        {
            cdata = new HashMap(cdata);
    ...
    // Unreferenced inner class com/adobe/mobile/Analytics$15
...
/* anonymous class */
    class _cls15
    {
        ...
        private class BEACON_PROXIMITY extends Enum
        {
