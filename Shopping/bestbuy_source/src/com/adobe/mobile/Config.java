...
public final class Config
{
    ...
    public static void collectLifecycleData(final Activity activity, final Map contextData)
    {
        if (StaticMethods.isWearableApp())
        {
            StaticMethods.logWarningFormat("Analytics - Method collectLifecycleData is not available for Wearable", new Object[0]);
    ...
    public static void submitAdvertisingIdentifierTask(final Callable task)
    {
        StaticMethods.getAnalyticsExecutor().execute(new Runnable() {
    ...
    private class ApplicationType extends Enum
    {
