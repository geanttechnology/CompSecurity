...
_L3:
    ...
    {
        if (!mediaitem.isSegmentByMilestones() && !mediaitem.isSegmentByOffsetMilestones()) goto _L2; else goto _L1
_L1:
        Object obj1 = mediaitem.currentMediaState;
        if (mediaitem.previousMediaState == null) goto _L4; else goto _L3
_L3:
        Object obj;
        ...
        if (mediaitem.currentMediaState.segmentNum == mediaitem.previousMediaState.segmentNum) goto _L4; else goto _L5
_L5:
