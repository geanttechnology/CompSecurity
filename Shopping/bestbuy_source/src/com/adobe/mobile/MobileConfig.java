...
final class MobileConfig
{
    ...
    private MobileConfig()
    {
        ...
        _usingTarget = null;
        startNotifier();
        JSONObject jsonobject = loadBundleConfig();
        if (jsonobject == null)
        {
            return;
        }
        try
        {
            obj = jsonobject.getJSONObject("analytics");
        }
...
_L2:
        try
        {
            obj = jsonobject.getJSONObject("target");
        }
        ...
        try
        {
            obj = jsonobject.getJSONObject("audienceManager");
        }
        ...
        try
        {
            obj = jsonobject.getJSONObject("acquisition");
        }
        ...
        try
        {
            obj = jsonobject.getJSONObject("remotes");
        }
        ...
        if (obj != null)
        {
            ...
            catch (JSONException jsonexception8)
            {
                StaticMethods.logDebugFormat("Config - No points of interest remote url loaded (%s)", new Object[] {
                    jsonexception8.getLocalizedMessage()
                });
            }
        }
        try
...
_L4:
        try
        {
            obj1 = ((JSONObject) (obj)).getString("privacyDefault");
        }
        // Misplaced declaration of an exception variable
        catch (Object obj1)
        {
        ...
        obj1 = privacyStatusFromString(((String) (obj1)));
_L6:
        _privacyStatus = ((MobilePrivacyStatus) (obj1));
          goto _L5
        obj1 = DEFAULT_PRIVACY_STATUS;
          goto _L6
    }
    ...
    {
        Object obj = StaticMethods.getSharedContext().getResources();
        if (obj == null)
        {
            return null;
        }
        obj = ((Resources) (obj)).getAssets();
        if (obj == null)
        {
            break MISSING_BLOCK_LABEL_92;
        }
        s = loadConfigFromStream(((AssetManager) (obj)).open(s));
        return s;
        s;
...
_L5:
        if (!context.isAvailable()) goto _L8; else goto _L7
_L7:
...
_L14:
    ...
    protected void startNotifier()
    {
        ...
        try
        {
            obj = StaticMethods.getSharedContext().getApplicationContext();
        }
        // Misplaced declaration of an exception variable
        catch (Object obj)
        {
        ...
        {
            ((Context) (obj)).registerReceiver(new BroadcastReceiver() {

                final MobileConfig this$0;

                public void onReceive(Context context, Intent intent)
                {
                    _networkConnectivity = getNetworkConnectivity(context);
...
_L7:
        ...
        if (fileinputstream == null) goto _L3; else goto _L4
_L4:
        try
        {
            fileinputstream.close();
...
_L2:
        FileInputStream fileinputstream = new FileInputStream(file);
        file = fileinputstream;
        JSONObject jsonobject = loadConfigFromStream(fileinputstream);
        if (jsonobject == null)
        {
            continue; /* Loop/switch isn't completed */
        }
        file = fileinputstream;
        loadPoiFromJsonArray(jsonobject.getJSONObject("analytics").getJSONArray("poi"));
