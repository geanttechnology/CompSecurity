...
final class VisitorIDService
{
    ...
    private String _generateMID()
    {
        ...
        long l2 = ((UUID) (obj)).getMostSignificantBits();
        long l1 = ((UUID) (obj)).getLeastSignificantBits();
        obj = Locale.US;
        long l = l2;
        if (l2 < 0L)
        {
        ...
        FutureTask futuretask = new FutureTask(new Callable() {
            ...
            public Void call()
            {
                if (_marketingCloudID != null)
                {
                    ...
                    if (_locationHint != null)
                    {
                        returnValue.put("aamlh", _locationHint);
                    }
                }
                return null;
            }
    ...
    protected void idSync(Map map)
    {
        idSync(map, null);
    }

    protected void idSync(final Map identifiersCopy, Map map)
    {
        final HashMap dpidsCopy = null;
...
_L2:
                ...
                if (_marketingCloudID != null && !flag1 && !flag2 && !flag) goto _L1; else goto _L3
_L3:
                ...
                if (flag1)
                {
                    for (obj1 = identifiersCopy.entrySet().iterator(); ((Iterator) (obj1)).hasNext(); ((StringBuilder) (obj)).append(StaticMethods.URLEncode((String)entry.getValue())))
                    {
                ...
                if (flag2)
                {
                    ...
                    for (Iterator iterator = dpidsCopy.entrySet().iterator(); iterator.hasNext(); ((StringBuilder) (obj)).append(StaticMethods.URLEncode((String)entry1.getValue())))
                    {
                        entry1 = (java.util.Map.Entry)iterator.next();
                        ((StringBuilder) (obj)).append("&d_cid=");
                        ((StringBuilder) (obj)).append(StaticMethods.URLEncode((String)entry1.getKey()));
                        ((StringBuilder) (obj)).append("%01");
                    }
