...
final class WearableFunctionBridge
{
    ...
    protected static boolean isGooglePlayServicesEnabled()
    {
        boolean flag = true;
        int i;
        Object obj = com/adobe/mobile/WearableFunctionBridge.getClassLoader().loadClass("com.google.android.gms.common.GoogleApiAvailability");
...
_L3:
    ...
    protected static boolean shouldSendHit()
    {
        ...
        boolean flag;
        Object obj = getWearableFunctionClass().getDeclaredMethod("shouldSendHit", new Class[0]).invoke(null, new Object[0]);
        if (!(obj instanceof Boolean))
        {
