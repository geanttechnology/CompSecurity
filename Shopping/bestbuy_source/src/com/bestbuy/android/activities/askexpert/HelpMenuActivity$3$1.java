    ...
    implements android.content.ckListener
{
    ...
    // Unreferenced inner class com/bestbuy/android/activities/askexpert/HelpMenuActivity$3

/* anonymous class */
    class HelpMenuActivity._cls3
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            } else
            {
                ...
                view.setNeutralButton(0x7f080283, new HelpMenuActivity._cls3._cls1(this));
                view.create().show();
                return;
            }
        }
