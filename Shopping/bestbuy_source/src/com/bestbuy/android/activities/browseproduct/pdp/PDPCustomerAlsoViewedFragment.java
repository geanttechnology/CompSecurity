...
public class PDPCustomerAlsoViewedFragment extends BBYBaseFragment
    implements android.view.View.OnClickListener
{
    ...
    private boolean k;
    private dy l;
    private OverviewResponse m;

    public PDPCustomerAlsoViewedFragment()
    {
        k = false;
    }

    public PDPCustomerAlsoViewedFragment(OverviewResponse overviewresponse)
    {
        k = false;
    ...
    {
        l = new dy(d, arraylist, getParentFragment(), true, "customeralsoviewed", i);
        a.setAdapter(l);
        ...
        ((HomeActivity)d).customerAlsoViewedRecommendations(arraylist);
    }
    ...
    public void onClick(View view)
    {
        if (view == b)
        {
            ...
            PLPFragment plpfragment = new PLPFragment(true, "CustomerAlsoViewed", "Customers Also Viewed", "all", h, "Home", 10);
    ...
    public View onCreateView(LayoutInflater layoutinflater, ViewGroup viewgroup, Bundle bundle)
    {
        if (g == null)
        {
            ...
            ((BBYTextView)g.findViewById(0x7f0c005c)).setText("CUSTOMERS ALSO VIEWED");
            j = new he(d, this, c, h);
