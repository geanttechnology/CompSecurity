...
/* anonymous class */
    class BBYWebView._cls2 extends WebViewClient
    {
        ...
        public void onReceivedError(WebView webview, int i, String s, String s1)
        {
            if (i == -6 || i == -2 || i == -7)
            {
                nm.a(BBYWebView.a(a), new BBYWebView._cls2._cls1(this), new BBYWebView._cls2._cls2(), lm.a(BBYWebView.a(a)), 0);
            }
        }
        ...
        public WebResourceResponse shouldInterceptRequest(WebView webview, String s)
        {
            ...
            {
                BBYWebView.a(a).runOnUiThread(new BBYWebView._cls2._cls3());
            }
...
/* anonymous class */
        ...
        // Unreferenced inner class com/bestbuy/android/bbyobjects/BBYWebView$2$3$1

/* anonymous class */
        class BBYWebView._cls2._cls3._cls1
            implements Runnable
        {

            final BBYWebView._cls2._cls3 a;
