    ...
    implements SafeParcelable
{
    ...
    public static final android.os.Parcelable.Creator CREATOR = new asz();
    public final int a;
    private int b;
    private int c;
    ...
    public WalletFragmentOptions(int i, int j, int k, WalletFragmentStyle walletfragmentstyle, int l)
    {
        a = i;
        b = j;
        c = k;
