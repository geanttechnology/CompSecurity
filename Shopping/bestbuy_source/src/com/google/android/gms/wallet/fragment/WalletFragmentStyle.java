    ...
    implements SafeParcelable
{
    ...
    public static final android.os.Parcelable.Creator CREATOR = new ata();
    public final int a;
    public Bundle b;
    public int c;
    ...
    public WalletFragmentStyle(int i, Bundle bundle, int j)
    {
        a = i;
        b = bundle;
        c = j;
    ...
    public int a(String s, DisplayMetrics displaymetrics, int i)
    {
        if (b.containsKey(s))
        {
            i = asp.a(b.getLong(s), displaymetrics);
        }
        return i;
    }
