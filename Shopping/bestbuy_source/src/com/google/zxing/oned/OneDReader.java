...
_L3:
    ...
    public static int patternMatchVariance(int ai[], int ai1[], int i)
    {
        int j;
        int i1;
        int k1;
...
_L3:
    ...
    public static void recordPattern(BitArray bitarray, int i, int ai[])
    {
        int j;
        int k;
        int i1;
...
_L4:
    ...
    public static void recordPatternInReverse(BitArray bitarray, int i, int ai[])
    {
        int j = ai.length;
