...
_L3:
        ...
        while (l < k1) 
        {
            int k = determineConsecutiveDigitCount(s, l);
            if (k >= 13)
            {
                stringbuilder.append('\u0386');
                j = 2;
                encodeNumeric(s, l, k, stringbuilder);
                i = l + k;
                k = 0;
            } else
            {
                int l1 = determineConsecutiveTextCount(s, l);
                if (l1 >= 5 || k == k1)
                {
                    k = i;
                    if (i != 0)
                    ...
                    int i1 = encodeText(s, l, l1, stringbuilder, j);
                    i = l + l1;
                    j = k;
                    k = i1;
                } else
                {
                    ...
                    k = determineConsecutiveBinaryCount(s, abyte0, l);
                    int j1 = k;
                    if (k == 0)
                    {
                        j1 = 1;
                    ...
                    if (j1 == 1 && i == 0)
                    {
                        encodeBinary(abyte0, l, 1, 0, stringbuilder);
                        k = j;
                        j = i;
                    } else
                    {
                        encodeBinary(abyte0, l, j1, i, stringbuilder);
                        j = 1;
                        k = 0;
                    }
                    compaction = abyte0;
...
_L7:
    ...
    static 
    {
        ...
        for (byte byte1 = flag; byte1 < TEXT_PUNCTUATION_RAW.length; byte1++)
        {
