...
public abstract class rz extends Binder
    implements ry
{
    ...
    public static ry a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof ry))
        {
            return (ry)iinterface;
        } else
        {
            return new sa(ibinder);
        }
    }
