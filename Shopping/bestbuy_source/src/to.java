...
public abstract class to extends Binder
    implements tn
{
    ...
    public static tn a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof tn))
        {
            return (tn)iinterface;
        } else
        {
            return new tp(ibinder);
        }
    }
