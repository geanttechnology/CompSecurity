...
public abstract class tx extends Binder
    implements tw
{
    ...
    public static tw a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof tw))
        {
            return (tw)iinterface;
        } else
        {
            return new ty(ibinder);
        }
    }
