...
public abstract class vp extends Binder
    implements vo
{

    public static vo a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof vo))
        {
            return (vo)iinterface;
        } else
        {
            return new vq(ibinder);
        }
    }
