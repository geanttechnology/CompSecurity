...
public abstract class wm extends Binder
    implements wl
{
    ...
    public static wl a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof wl))
        {
            return (wl)iinterface;
        } else
        {
            return new wn(ibinder);
        }
    }
