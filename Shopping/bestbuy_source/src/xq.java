...
public abstract class xq extends Binder
    implements xp
{

    public static xp a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof xp))
        {
            return (xp)iinterface;
        } else
        {
            return new xr(ibinder);
        }
    }
