...
public class yf
{
    ...
    public static PublicKey a(String s)
    {
        ...
        {
            acb.b("Invalid key specification.");
    ...
    public static boolean a(String s, String s1, String s2)
    {
        ...
        {
            acb.b("Purchase verification failed: missing data.");
            return false;
        } else
        {
            return a(a(s), s1, s2);
...
label0:
        {
            try
            {
                ...
                acb.b("Signature verification failed.");
            }
            // Misplaced declaration of an exception variable
            catch (PublicKey publickey)
            {
                acb.b("NoSuchAlgorithmException.");
                return false;
            }
            // Misplaced declaration of an exception variable
            catch (PublicKey publickey)
