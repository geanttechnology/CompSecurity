...
public final class ae
{
        ...
        throws s
    {
        ...
        {
            ah ah1 = l.d();
            int i1 = ((ah1.a - 1) / 2 / 16) * 2 + 1;
            ac1 = new ah(ah1.a - i1, ah1.b - i1);
            int l1 = 0;
            for (int j1 = 0; j1 < ah1.a;)
            {
                int j2 = l1;
                if ((ah1.a / 2 - j1) % 16 != 0)
                {
        ...
        while (i2 != 0) 
        {
            ...
            {
                aflag[k2 + k3] = ac1.a(i3 + j4, k3 / 2 + i3);
                aflag[((k1 * 2 + k2) - 4) + k3] = ac1.a(k3 / 2 + i3, (i3 + k1) - 1 - j4);
                j4 = (j4 + 1) % 2;
            }
            ...
            {
                aflag[((k1 * 4 + k2) - 8) + (k1 * 2 - l3) + 1] = ac1.a((i3 + k1) - 1 - j4, (l3 / 2 + i3) - 1);
                aflag[((k1 * 6 + k2) - 12) + (k1 * 2 - l3) + 1] = ac1.a((l3 / 2 + i3) - 1, i3 + j4);
                j4 = (j4 + 1) % 2;
            }
...
_L9:
        ac1 = "";
_L26:
        if (!ac1.startsWith("CTRL_")) goto _L16; else goto _L15
_L15:
        i3 = ac1.charAt(5);
        k1 = 0;
        i3;
...
_L17:
        i3 = k1;
        if (ac1.charAt(6) != 'S') goto _L25; else goto _L24
_L24:
        j5 = 1;
        i3 = k1;
        k1 = l4;
