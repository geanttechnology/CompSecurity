...
_L6:
        i = a(i, ai, j, stringbuffer);
          goto _L8
        return new am(null, stringbuffer.toString(), null, null);
    }

    private static StringBuffer a(String s1, String s2)
    {
        StringBuffer stringbuffer = new StringBuffer(5);
        StringBuffer stringbuffer1 = new StringBuffer(5);
        StringBuffer stringbuffer2 = new StringBuffer(s1.length());
        ...
        for (; j >= 0; j -= 3)
        {
            ...
            stringbuffer.append(s1.charAt(j + 1));
            stringbuffer.append(s1.charAt(j + 2));
            stringbuffer1.setLength(0);
            stringbuffer1.append(s2.charAt(j));
            stringbuffer1.append(s2.charAt(j + 1));
            stringbuffer1.append(s2.charAt(j + 2));
...
_L4:
        ...
        while (j < l) 
        {
            s1 = c[l - j - 1];
            j1 = ai1[j];
            obj = new StringBuffer(s1.length());
            ...
            for (k = 0; k < j1 % 10; k++)
            {
                obj = a(((StringBuffer) (obj)).toString(), s1);
            }

            for (k = 0; k < k1 % 10; k++)
            {
                obj = a(((StringBuffer) (obj)).toString(), (new StringBuilder()).append(s1).append('0').toString().substring(1));
            }

            for (k = 0; k < i1; k++)
            {
                obj = a(((StringBuffer) (obj)).toString(), (new StringBuilder()).append(s1).append("00").toString().substring(2));
            }
