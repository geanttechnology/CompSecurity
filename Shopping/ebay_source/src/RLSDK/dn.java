...
final class dn
{
    ...
    dn(ah ah1, int j, int k, int l, int i1, float f1, ab ab1)
    {
        a = ah1;
        c = j;
        d = k;
    ...
    private dm a(int ai[], int j, int k)
    {
        int l = ai[0];
        int i1 = ai[1];
        l = ai[2] + (l + i1);
        ...
        ai1[1] = 0;
        ai1[2] = 0;
        for (k = j; k >= 0 && ah1.a(i1, k) && ai1[1] <= j1; k--)
        {
            ai1[1] = ai1[1] + 1;
        }
        ...
        } else
        {
            ...
            {
                for (j++; j < k1 && ah1.a(i1, j) && ai1[1] <= j1; j++)
                {
                    ai1[1] = ai1[1] + 1;
                }
                ...
                {
                    for (; j < k1 && !ah1.a(i1, j) && ai1[2] <= j1; j++)
                    {
                        ai1[2] = ai1[2] + 1;
                    }
        ...
        do
        {
            if (!Float.isNaN(f1))
            {
                ...
                for (j = 0; j < k; j++)
                {
                    if (((dm)b.elementAt(j)).a(f3, f1, f2))
                    {
                        return new dm(f2, f1, f3);
                    }
                }
...
_L11:
        dm dm1 = a(ai, j2, i1);
        if (dm1 == null) goto _L12; else goto _L13
_L13:
        return dm1;
_L12:
        ai[0] = ai[2];
...
_L4:
        ...
        dm2 = a(ai, j2, l1);
        dm1 = dm2;
        if (dm2 != null) goto _L13; else goto _L16
_L16:
        l++;
          goto _L17
_L2:
