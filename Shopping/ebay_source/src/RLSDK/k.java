...
_L12:
        ...
        do
        {
            ...
            BarcodeResult barcoderesult = (BarcodeResult)iterator1.next();
            if (barcoderesult.barcodeType == ((BarcodeResult) (obj)).barcodeType && barcoderesult.barcodeString.equals(((BarcodeResult) (obj)).barcodeString))
            {
                abarcoderesultinternal[i].AssociateWith(barcoderesult);
            }
        } while (true);
          goto _L6
_L9:
...
_L5:
        ...
        RLSDK.e.get().addCallbackBuffer(((b.a) (message)).a);
        return;
_L6:
