...
class AutoSessionAnalyticsManager extends SessionAnalyticsManager
{
    ...
    public static AutoSessionAnalyticsManager build(Application application1, SessionEventMetadata sessioneventmetadata, SessionAnalyticsFilesManager sessionanalyticsfilesmanager, HttpRequestFactory httprequestfactory)
    {
        java.util.concurrent.ScheduledExecutorService scheduledexecutorservice = ExecutorUtils.buildSingleThreadScheduledExecutorService("Crashlytics Trace Manager");
        return new AutoSessionAnalyticsManager(sessioneventmetadata, new SessionEventsHandler(application1, new EnabledSessionAnalyticsManagerStrategy(application1, scheduledexecutorservice, sessionanalyticsfilesmanager, httprequestfactory), sessionanalyticsfilesmanager, scheduledexecutorservice), application1);
    }
