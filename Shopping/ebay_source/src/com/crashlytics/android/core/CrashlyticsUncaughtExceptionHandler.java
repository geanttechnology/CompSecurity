...
//            UserMetaData, MetaDataStore, CrashlyticsListener, CrashlyticsExecutorServiceWrapper, 
//            Utils, CodedOutputStream, SessionDataWriter, ExceptionUtils, 
...
_L1:
        ...
        obj = obj1;
        obj3 = obj1;
        NativeCrashWriter.writeNativeCrash(sessioneventdata, logFileManager, map, ((CodedOutputStream) (obj1)));
...
_L8:
        ...
        Fabric.getLogger().e("Fabric", "An error occurred in the native crash logger", ((Throwable) (obj2)));
        obj = obj3;
        obj1 = sessioneventdata;
...
_L5:
    ...
    public void uncaughtException(final Thread thread, final Throwable ex)
    {
        ...
        Fabric.getLogger().d("Fabric", (new StringBuilder()).append("Crashlytics is handling uncaught exception \"").append(ex).append("\" from thread ").append(thread.getName()).toString());
