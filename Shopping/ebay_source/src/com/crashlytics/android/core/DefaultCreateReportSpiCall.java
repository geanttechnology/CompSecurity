    ...
    implements CreateReportSpiCall
{
    ...
    public boolean invoke(CreateReportRequest createreportrequest)
    {
        ...
        Fabric.getLogger().d("Fabric", (new StringBuilder()).append("Sending report to: ").append(getUrl()).toString());
        int i = createreportrequest.code();
        Fabric.getLogger().d("Fabric", (new StringBuilder()).append("Create report request ID: ").append(createreportrequest.header("X-REQUEST-ID")).toString());
