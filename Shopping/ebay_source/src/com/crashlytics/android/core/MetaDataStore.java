...
_L4:
        s = ((String) (obj));
        Fabric.getLogger().e("Fabric", "Error deserializing user metadata.", ((Throwable) (obj1)));
        CommonUtils.closeOrLog(((java.io.Closeable) (obj)), "Failed to close user metadata file.");
        return Collections.emptyMap();
        obj;
_L2:
...
_L4:
        s = map;
        Fabric.getLogger().e("Fabric", "Error serializing key/value metadata.", ((Throwable) (obj)));
        CommonUtils.closeOrLog(map, "Failed to close key/value metadata file.");
        return;
        map;
_L2:
...
_L4:
        s = usermetadata;
        Fabric.getLogger().e("Fabric", "Error serializing user metadata.", ((Throwable) (obj)));
        CommonUtils.closeOrLog(usermetadata, "Failed to close user metadata file.");
        return;
        usermetadata;
_L2:
