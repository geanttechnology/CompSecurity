...
label0:
    ...
    private int getEventAppSize(Thread thread, Throwable throwable, int i, Map map)
    {
        ...
        int k = 0 + (CodedOutputStream.computeTagSize(1) + CodedOutputStream.computeRawVarint32Size(j) + j);
        j = k;
        if (map != null)
        {
            ...
            do
            {
                ...
                j = getEventAppCustomAttributeSize((String)throwable.getKey(), (String)throwable.getValue());
                k += CodedOutputStream.computeTagSize(2) + CodedOutputStream.computeRawVarint32Size(j) + j;
            } while (true);
        }
        k = j;
        if (runningAppProcessInfo != null)
        {
            ...
            k = j + CodedOutputStream.computeBoolSize(3, flag);
        }
        return k + CodedOutputStream.computeUInt32Size(4, i);
    }
