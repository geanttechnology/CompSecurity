...
public class ExtensibleItemAnimator extends android.support.v7.widget.RecyclerView.ItemAnimator
{
    private static class ChangeInfo
    {
        ...
        private ChangeInfo(android.support.v7.widget.RecyclerView.ViewHolder viewholder, android.support.v7.widget.RecyclerView.ViewHolder viewholder1)
        {
            oldHolder = viewholder;
            newHolder = viewholder1;
        }

        private ChangeInfo(android.support.v7.widget.RecyclerView.ViewHolder viewholder, android.support.v7.widget.RecyclerView.ViewHolder viewholder1, int i, int j, int k, int l)
        {
    ...
    private static class MoveInfo
    {
        ...
        private MoveInfo(android.support.v7.widget.RecyclerView.ViewHolder viewholder, int i, int j, int k, int l)
        {
            holder = viewholder;
            fromX = i;
            fromY = j;
    ...
    private void animateAddImpl(final android.support.v7.widget.RecyclerView.ViewHolder holder)
    {
        mAddAnimations.add(holder);
        final ViewPropertyAnimatorCompat animation = getAddAnimation(holder);
        animation.setDuration(getAddDuration());
        animation.setListener(new ItemAnimatorListener() {
            ...
            {
                this$0 = ExtensibleItemAnimator.this;
                holder = viewholder;
    ...
    {
        final ViewPropertyAnimatorCompat oldViewAnim = changeInfo.oldHolder.itemView;
        final View newView = changeInfo.newHolder;
        if (newView != null)
        {
            newView = ((android.support.v7.widget.RecyclerView.ViewHolder) (newView)).itemView;
        } else
        {
            newView = null;
        }
        mChangeAnimations.add(changeInfo.oldHolder);
        oldViewAnim = ViewCompat.animate(oldViewAnim).setDuration(getChangeDuration());
        oldViewAnim.translationX(changeInfo.toX - changeInfo.fromX);
        oldViewAnim.translationY(changeInfo.toY - changeInfo.fromY);
        oldViewAnim.alpha(0.0F).setListener(new ItemAnimatorListener() {
        ...
        if (newView != null)
        {
            ...
            newViewAnimation.translationX(0.0F).translationY(0.0F).setDuration(getChangeDuration()).alpha(1.0F).setListener(new ItemAnimatorListener() {
    ...
    private void animateMoveImpl(final android.support.v7.widget.RecyclerView.ViewHolder holder, final int deltaX, final int deltaY, int i, int j)
    {
        ...
        animation.setDuration(getMoveDuration()).setListener(new ItemAnimatorListener() {
    ...
    {
        final ViewPropertyAnimatorCompat animation = getRemoveAnimation(holder);
    ...
    private void endChangeAnimation(List list, android.support.v7.widget.RecyclerView.ViewHolder viewholder)
    {
    ...
    private boolean endChangeAnimationIfNecessary(ChangeInfo changeinfo, android.support.v7.widget.RecyclerView.ViewHolder viewholder)
    {
        boolean flag = false;
    ...
    public boolean animateAdd(android.support.v7.widget.RecyclerView.ViewHolder viewholder)
    {
        ...
        boolean flag = prepareHolderForAnimateAdd(viewholder);
        if (flag)
        {
    ...
    public boolean animateMove(android.support.v7.widget.RecyclerView.ViewHolder viewholder, int i, int j, int k, int l)
    {
    ...
    {
        endAnimation(viewholder);
        boolean flag = prepareHolderForAnimateRemove(viewholder);
        if (flag)
        {
    ...
    void cancelAll(List list)
    {
        for (int i = list.size() - 1; i >= 0; i--)
        {
            ViewCompat.animate(((android.support.v7.widget.RecyclerView.ViewHolder)list.get(i)).itemView).cancel();
        }
    ...
    public void endAnimation(android.support.v7.widget.RecyclerView.ViewHolder viewholder)
    {
        ...
        for (int i = mPendingMoves.size() - 1; i >= 0; i--)
        {
            if (((MoveInfo)mPendingMoves.get(i)).holder == viewholder)
            {
                ...
                ViewCompat.setTranslationX(view, 0.0F);
                dispatchMoveFinished(viewholder);
                mPendingMoves.remove(viewholder);
            }
        }
...
label1:
    ...
    public void endAnimations()
    {
        ...
        {
            dispatchRemoveFinished((android.support.v7.widget.RecyclerView.ViewHolder)mPendingRemovals.get(j));
            mPendingRemovals.remove(j);
        }

        for (int k = mPendingAdditions.size() - 1; k >= 0; k--)
        {
            android.support.v7.widget.RecyclerView.ViewHolder viewholder = (android.support.v7.widget.RecyclerView.ViewHolder)mPendingAdditions.get(k);
            ViewCompat.setAlpha(viewholder.itemView, 1.0F);
            dispatchAddFinished(viewholder);
        ...
        for (int j1 = mAdditionsList.size() - 1; j1 >= 0; j1--)
        {
            ...
            {
                android.support.v7.widget.RecyclerView.ViewHolder viewholder1 = (android.support.v7.widget.RecyclerView.ViewHolder)arraylist1.get(i2);
    ...
    protected ViewPropertyAnimatorCompat getAddAnimation(android.support.v7.widget.RecyclerView.ViewHolder viewholder)
    {
        viewholder = ViewCompat.animate(viewholder.itemView);
        viewholder.alpha(1.0F);
        return viewholder;
    }

    protected ViewPropertyAnimatorCompat getRemoveAnimation(android.support.v7.widget.RecyclerView.ViewHolder viewholder)
    {
        viewholder = ViewCompat.animate(viewholder.itemView);
        viewholder.alpha(0.0F);
        return viewholder;
    }
    ...
    protected void onAddCanceled(android.support.v7.widget.RecyclerView.ViewHolder viewholder)
    {
        ViewCompat.setAlpha(viewholder.itemView, 1.0F);
    }

    protected void onRemoveCanceled(android.support.v7.widget.RecyclerView.ViewHolder viewholder)
    {
    }

    public void onRemoveFinished(android.support.v7.widget.RecyclerView.ViewHolder viewholder)
    {
        ViewCompat.setAlpha(viewholder.itemView, 1.0F);
    }

    protected boolean prepareHolderForAnimateAdd(android.support.v7.widget.RecyclerView.ViewHolder viewholder)
    {
        ViewCompat.setAlpha(viewholder.itemView, 0.0F);
        return true;
    }

    protected boolean prepareHolderForAnimateRemove(android.support.v7.widget.RecyclerView.ViewHolder viewholder)
    {
        return true;
    }
    ...
    public void runPendingAnimations()
    {
        ...
        {
            for (Iterator iterator = mPendingRemovals.iterator(); iterator.hasNext(); animateRemoveImpl((android.support.v7.widget.RecyclerView.ViewHolder)iterator.next())) { }
            ...
            if (flag3)
            {
                ...
                runnable = new Runnable() {
                    ...
                    public void run()
                    {
                        ...
                        {
                            viewholder = (android.support.v7.widget.RecyclerView.ViewHolder)iterator1.next();
                        }
            ...
            
            {
                ...
                if (flag || flag1 || flag2)
                {
                    ...
                    l1 = Math.max(l1, l2);
                    ViewCompat.postOnAnimationDelayed(((android.support.v7.widget.RecyclerView.ViewHolder)additions.get(0)).itemView, runnable, l + l1);
                    return;
                } else
                {
                    runnable.run();
