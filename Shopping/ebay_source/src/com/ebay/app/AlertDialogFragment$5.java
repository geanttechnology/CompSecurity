...
_L1:
        ((DialogFragmentCallback)getTargetFragment()).onDialogFragmentResult(AlertDialogFragment.this, getTargetRequestCode(), i);
_L4:
...
_L2:
        ...
        {
            ((DialogFragmentCallback)getActivity()).onDialogFragmentResult(AlertDialogFragment.this, getTargetRequestCode(), i);
        }
