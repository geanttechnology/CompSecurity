...
public static class TotalCostWithSavings
...
label1:
        ...
        public TotalCostWithSavings()
        {
        }
    }

    public static final class TotalCostWithSavings.AddtionalCharges
        implements Serializable
    {
        ...
        public TotalCostWithSavings.AddtionalCharges()
        {
        }
    }

    public static final class TotalCostWithSavings.Adjustment
        implements Serializable
    {

        private static final long serialVersionUID = 1L;
        public TotalCostWithSavings.AddtionalCharges additionalCharges;

        public TotalCostWithSavings.Adjustment()
        {
        }
    }

    public static final class TotalCostWithSavings.ChargeInfo
        implements Serializable
    {
        ...
        public TotalCostWithSavings.ChargeInfo()
        {
        }
    }

    public static final class TotalCostWithSavings.ChargeInfoAttribute
        implements Serializable
    {
        ...
        public TotalCostWithSavings.ChargeInfoAttribute()
        {
        }
    }
