...
private static class <init> extends EbayResponse
{
    ...
    com.ebay.common.model.mdns.rtsData caData;
    ...
    private com.ebay.common.model.mdns.nt getOutbidEvent(JSONObject jsonobject, String s)
        throws JSONException
    {
        com.ebay.common.model.mdns.nt nt = new com.ebay.common.model.mdns.nt();
        setCommonItemEventValues(jsonobject, nt, s);
        nt.title = jsonobject.getString("Title");
        nt.highBidderUserId = jsonobject.getString("HighBidderUserID");
        nt.highBidderEiasToken = jsonobject.getString("HighBidderEIASToken");
        nt.sellerUserId = jsonobject.getString("SellerUserID");
        jsonobject = jsonobject.getJSONObject("MinimumToBid");
        nt.minimumToBid = new CurrencyAmount(jsonobject.getString("Value"), jsonobject.getString("CurrencyID"));
        return nt;
    }

    private com.ebay.common.model.mdns.ToWatchListEvent getWatchListEvent(JSONObject jsonobject, String s)
        throws JSONException
    {
        com.ebay.common.model.mdns.ToWatchListEvent towatchlistevent = new com.ebay.common.model.mdns.ToWatchListEvent();
        setCommonItemEventValues(jsonobject, towatchlistevent, s);
        towatchlistevent.quantity = jsonobject.getInt("Quantity");
        return towatchlistevent;
    }
        ...
        throws com.ebay.nautilus.kernel.net.
    {
        ...
        {
            GetUserAlerts.access$000().quantity("Exception parsing JSON", inputstream);
            return;
        }
        i = 0;
...
_L3:
        if (GetUserAlerts.access$000().sessionData)
        {
            GetUserAlerts.access$000().sessionData("Call was success but no alerts");
            return;
        }
          goto _L5
_L4:
...
_L6:
        ...
        if (GetUserAlerts.access$000().sessionData)
        {
            GetUserAlerts.access$000().sessionData((new StringBuilder()).append("Parsing event object=").append(jsonobject.toString()).toString());
        }
        inputstream = jsonobject.getString("EventType");
        if (GetUserAlerts.access$000().sessionData)
        {
            GetUserAlerts.access$000().sessionData((new StringBuilder()).append("EventType=").append(inputstream).toString());
        }
        if (!inputstream.equals(com.ebay.common.model.mdns.Bid.e())) goto _L8; else goto _L7
_L7:
        jsonobject = jsonobject.getJSONObject("Outbid");
_L12:
        if (jsonobject != null) goto _L10; else goto _L9
_L9:
        if (GetUserAlerts.access$000().)
        {
            GetUserAlerts.access$000().((new StringBuilder()).append("NULL json object, alert type: ").append(inputstream).toString());
        }
          goto _L11
_L8:
...
_L10:
        if (GetUserAlerts.access$000().)
        {
            GetUserAlerts.access$000().((new StringBuilder()).append("json object=").append(jsonobject.toString()).toString());
        }
        Object obj = null;
        String s;
        int l;
...
_L23:
        ...
        if (GetUserAlerts.access$000().events)
        {
            GetUserAlerts.access$000().events((new StringBuilder()).append("Adding event=").append(inputstream).toString());
        }
          goto _L11
_L20:
...
_L13:
    ...
    private on()
    {
        caData = new com.ebay.common.model.mdns.rtsData();
    }

    rtsData(rtsData rtsdata)
    {
        this();
    }
}
