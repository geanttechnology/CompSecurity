...
//            EbayCartRequest, InitPayment, EbayCartApi

public static final class paymentMethod extends EbayCartRequest
{
        ...
        throws com.ebay.nautilus.kernel.net.tion
    {
        ...
        {
            throw com.ebay.nautilus.kernel.net.tion.create(exception);
        }
    }
    ...
    protected (EbayCartApi ebaycartapi, String s, Address address1, boolean flag, String s1)
    {
