...
//            EbayCartRequest, UpdateCart, UpdateCartResponse, EbayCartApi

public static final class lineItemToRemove extends EbayCartRequest
{
        ...
        throws com.ebay.nautilus.kernel.net.eption
    {
        ...
        {
            throw com.ebay.nautilus.kernel.net.eption.create(((Throwable) (obj)));
        }
...
_L5:
    ...
    protected eption(EbayCartApi ebaycartapi, String s, String s1, String s2, Integer integer, List list, List list1, 
