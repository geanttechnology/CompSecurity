...
//            EbayCartRequest, UpdateDeliveryReservation, UpdateCartResponse, EbayCartApi

public static final class deliveryInstructions extends EbayCartRequest
{
    ...
    public byte[] buildRequest()
        throws com.ebay.nautilus.kernel.net.deliveryInstructions
    {
        Object obj;
        ...
        try
        {
            ...
            for (Iterator iterator = logisticsPlanOptionIds.iterator(); iterator.hasNext(); jsonarray.put(jsonobject1))
            {
                ...
                jsonobject1.put("logisticsPlanType", com.ebay.common.model.cart.t.logisticsPlanOptionIds.logisticsPlanOptionIds);
        ...
        {
            throw com.ebay.nautilus.kernel.net.deliveryInstructions(((Throwable) (obj)));
        }
        byte abyte0[];
    ...
    protected (EbayCartApi ebaycartapi, String s, List list, String s1, String s2)
    {
