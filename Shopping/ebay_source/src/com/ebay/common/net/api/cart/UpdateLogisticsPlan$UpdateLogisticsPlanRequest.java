...
//            EbayCartRequest, UpdateLogisticsPlan, UpdateLogisticsPlanParams, UpdateCartResponse, 
//            EbayCartApi

public static final class paramList extends EbayCartRequest
{
    ...
    public byte[] buildRequest()
        throws com.ebay.nautilus.kernel.net.paramList
    {
        Object obj;
        ...
        {
            throw com.ebay.nautilus.kernel.net.paramList(((Throwable) (obj)));
        }
        byte abyte0[];
    ...
    protected Q(EbayCartApi ebaycartapi, String s, List list)
    {
