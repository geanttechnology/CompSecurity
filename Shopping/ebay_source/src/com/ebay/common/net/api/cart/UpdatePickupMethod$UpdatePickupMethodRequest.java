...
//            EbayCartRequest, UpdatePickupMethod, UpdateCartResponse, EbayCartApi

public static final class logisticsPlanType extends EbayCartRequest
{

    private final String cartId;
    private final String cartLineItemId;
    private final List logisticsPlanOptionIds;
    private final com.ebay.common.model.cart.t.getResponse logisticsPlanType;
    private final String pickupStoreId;

    public byte[] buildRequest()
        throws com.ebay.nautilus.kernel.net.logisticsPlanType
    {
        Object obj;
...
_L2:
        ...
        jsonobject1.put("logisticsPlanType", logisticsPlanType.logisticsPlanType);
        jsonobject1.put("logisticsOptionIdentifier", obj1);
        obj1 = new JSONArray();
        if (!logisticsPlanType.logisticsPlanType(com.ebay.common.model.cart.t.logisticsPlanType))
        {
...
_L1:
        ...
        {
            throw com.ebay.nautilus.kernel.net.pickupStoreId(((Throwable) (obj)));
        }
          goto _L3
...
_L4:
    ...
    protected (EbayCartApi ebaycartapi, String s, String s1, List list, String s2, com.ebay.common.model.cart.t t)
    {
