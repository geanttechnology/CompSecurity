...
public static final class RootElement extends EbayResponse
{
    private final class BodyElement extends com.ebay.nautilus.kernel.util.SaxHandler.Element
    {
        ...
        final AddFavoriteSeller.AddResponse this$0;
        ...
        private BodyElement()
        {
            this$0 = AddFavoriteSeller.AddResponse.this;
            super();
        }

        BodyElement(AddFavoriteSeller._cls1 _pcls1)
        {
            this();
        }
    }
    ...
    private final class ResponseElement extends com.ebay.nautilus.kernel.util.SaxHandler.Element
    {
            ...
            throws SAXException
        {
            if ("ack".equals(s1))
            {
                return new AckElement(AddFavoriteSeller.AddResponse.this);
            } else
            {
                return super.get(s, s1, s2, attributes);
            }
        ...
        ResponseElement(AddFavoriteSeller._cls1 _pcls1)
        {
            this();
        }
    }
    ...
    private final class RootElement extends com.ebay.nautilus.kernel.util.SaxHandler.Element
    {
        ...
        RootElement(AddFavoriteSeller._cls1 _pcls1)
        {
            this();
        }
    }
