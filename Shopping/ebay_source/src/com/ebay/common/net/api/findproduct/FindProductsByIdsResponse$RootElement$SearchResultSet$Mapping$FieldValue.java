        ...
        throws SAXException
    {
        if ("value".equals(s1))
        {
            return new com.ebay.nautilus.kernel.util.SaxHandler.TextElement() {
                ...
                final FindProductsByIdsResponse.RootElement.SearchResultSet.Mapping.FieldValue this$4;

                public void text(String s3)
                    throws SAXException
                {
                    if ("PRODUCT_REFERENCE_ID".equals(FindProductsByIdsResponse.RootElement.SearchResultSet.Mapping.access$400(this$3)))
                    {
                        result.id = s3;
                    } else
                    {
                        if ("TITLE".equals(FindProductsByIdsResponse.RootElement.SearchResultSet.Mapping.access$400(this$3)))
                        {
                            result.title = s3;
                            return;
                        }
                        if ("STOCK_PHOTO_URL".equals(FindProductsByIdsResponse.RootElement.SearchResultSet.Mapping.access$400(this$3)))
                        {
                            result.stockPhotoUrl = s3;
                            return;
                        }
                        if ("ALLCATS".equals(FindProductsByIdsResponse.RootElement.SearchResultSet.Mapping.access$400(this$3)))
                        {
            ...
            {
                this$4 = FindProductsByIdsResponse.RootElement.SearchResultSet.Mapping.FieldValue.this;
                super();
            }
            };
        } else
