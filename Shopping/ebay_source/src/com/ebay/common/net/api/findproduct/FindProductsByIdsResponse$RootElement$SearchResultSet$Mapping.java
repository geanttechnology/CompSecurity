...
private final class <init> extends com.ebay.nautilus.kernel.util.pping
{
    private final class Field extends com.ebay.nautilus.kernel.util.SaxHandler.Element
    {
        ...
        final FindProductsByIdsResponse.RootElement.SearchResultSet.Mapping this$3;
        ...
        private Field()
        {
            this$3 = FindProductsByIdsResponse.RootElement.SearchResultSet.Mapping.this;
            super();
        }

        Field(FindProductsByIdsResponse._cls1 _pcls1)
        {
            this();
        }
    }
    ...
    private final class FieldValue extends com.ebay.nautilus.kernel.util.SaxHandler.Element
    {
        ...
        FieldValue(FindProductsByIdsResponse._cls1 _pcls1)
        {
            this();
        }
    }
...
/*
    static String access$402(FieldValue._cls1 _pcls1, String s)
    {
        _pcls1.name = s;
        return s;
    }
