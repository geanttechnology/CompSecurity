        ...
        throws SAXException
    {
        if ("name".equals(s1))
        {
            return new com.ebay.nautilus.kernel.util.SaxHandler.TextElement() {
                ...
                final FindProductsResponse.RootElement.SearchResultSet.Mapping.Field this$4;

                public void text(String s3)
                    throws SAXException
                {
                    FindProductsResponse.RootElement.SearchResultSet.Mapping.access$502(this$3, s3);
                }

            
            {
                this$4 = FindProductsResponse.RootElement.SearchResultSet.Mapping.Field.this;
                super();
            }
            };
        } else
