...
private final class <init> extends com.ebay.nautilus.kernel.util.init>
{
        ...
        throws SAXException
    {
        if ("ack".equals(s1))
        {
            return new AckElement(this._cls1.this);
        }
        if ("timestamp".equals(s1))
        {
            return new TimestampElement(this._cls1.this);
        }
        if ("errorMessage".equals(s1))
        {
            return new ErrorMessageElement(this._cls1.this, "http://www.ebay.com/marketplace/search/v1/services");
        }
        if ("favoriteSearchRecordResponse".equals(s1))
        {
            return new t>(this._cls1.this, null);
        } else
        {
