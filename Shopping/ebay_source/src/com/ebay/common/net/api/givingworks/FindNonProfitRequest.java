...
public final class FindNonProfitRequest extends FundRaisingRequest
{
    ...
    private final List outputSelector = Arrays.asList(new String[] {
        "Mission", "Address", "LargeLogoURL", "FavoriteCount"
    });
    private final PaginationInput paginationInput;
    private final SearchFilter searchFilter;

    public FindNonProfitRequest(EbaySite ebaysite, String s, int i, int j)
    {
        super(ebaysite, false, "findNonprofit");
        searchFilter = new SearchFilter(s);
        paginationInput = new PaginationInput(i, j);
    }
        ...
        throws IOException
    {
        ...
        if (searchFilter != null)
        {
            ...
            XmlSerializerHelper.writeSimple(xmlserializer, "http://www.ebay.com/marketplace/fundraising/v1/services", "keywords", searchFilter.keywords);
