...
static final class 
    implements android.os.ionDetailsResponseData._cls1
{

    public  createFromParcel(Parcel parcel)
    {
        return ()DataMapperFactory.readParcelJson(parcel, com/ebay/common/net/api/givingworks/SetUserDonationDetailsResponse$SetUserDonationDetailsResponseData);
    }
