...
//            EbayNowTimeSlotDataManager

static final class 
    implements android.os.anager.KeyParams._cls1
{

    public  createFromParcel(Parcel parcel)
    {
        return ()DataMapperFactory.readParcelJson(parcel, com/ebay/common/net/api/local/EbayNowTimeSlotDataManager$KeyParams);
    }
