...
static final class response extends com.ebay.nautilus.kernel.util.
{
    static final class Item extends com.ebay.nautilus.kernel.util.SaxHandler.Element
    {
        ...
        protected Item(EbaySearchListItem ebaysearchlistitem, ArrayList arraylist, IncrementingInt incrementingint, IncrementingInt incrementingint1, EbayFindingApi.EbaySearchResponse ebaysearchresponse)
        {
...
/*
        static EbayCategorySummary access$202(Item.PrimaryCategory primarycategory, EbayCategorySummary ebaycategorysummary)
        {
...
/*
        static String access$302(Item.PrimaryCategory primarycategory, String s)
        {
