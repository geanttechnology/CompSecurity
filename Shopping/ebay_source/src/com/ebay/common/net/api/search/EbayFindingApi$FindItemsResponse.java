...
private static final class response extends com.ebay.nautilus.kernel.util.
{
    ...
    private static class CategoryHistogram.CategoryElement extends com.ebay.nautilus.kernel.util.SaxHandler.Element
    {
        ...
        CategoryHistogram.CategoryElement(EbayFindingApi._cls1 _pcls1)
        {
            this();
        }
    }
    ...
    private final class CategoryHistogram.CategoryElement.FieldElement extends com.ebay.nautilus.kernel.util.SaxHandler.TextElement
    {
        ...
        CategoryHistogram.CategoryElement.FieldElement(EbayFindingApi._cls1 _pcls1)
        {
            this();
        }
    }
    ...
    private static final class CategoryHistogram.ChildCategoryElement extends CategoryHistogram.CategoryElement
    {
        ...
        CategoryHistogram.ChildCategoryElement(EbayFindingApi._cls1 _pcls1)
        {
            this();
        }
    }
    ...
    private static final class CategoryHistogram.ParentCategoryElement extends CategoryHistogram.CategoryElement
    {
        ...
        CategoryHistogram.ParentCategoryElement(EbayFindingApi._cls1 _pcls1)
        {
            this();
        }
    }
    ...
    static final class SearchResult extends com.ebay.nautilus.kernel.util.SaxHandler.Element
    {
        ...
        public final EbayFindingApi.EbaySearchResponse response;
        ...
        public SearchResult(Attributes attributes, ArrayList arraylist, IncrementingInt incrementingint, IncrementingInt incrementingint1, EbayFindingApi.EbaySearchResponse ebaysearchresponse)
        {
            count = -1;
    ...
    static final class SearchResult.Item extends com.ebay.nautilus.kernel.util.SaxHandler.Element
    {
        ...
        protected SearchResult.Item(EbaySearchListItem ebaysearchlistitem, ArrayList arraylist, IncrementingInt incrementingint, IncrementingInt incrementingint1, EbayFindingApi.EbaySearchResponse ebaysearchresponse)
        {
...
/*
        static EbayCategorySummary access$202(SearchResult.Item.PrimaryCategory primarycategory, EbayCategorySummary ebaycategorysummary)
        {
...
/*
        static String access$302(SearchResult.Item.PrimaryCategory primarycategory, String s)
        {
        ...
        if ("http://www.ebay.com/marketplace/search/v1/services".equals(s))
        {
            ...
            if ("itemSearchURL".equals(s1))
            {
                return new com.ebay.nautilus.kernel.util.SaxHandler.TextElement() {
                    ...
                    final EbayFindingApi.FindItemsResponse this$0;
            ...
            {
                this$0 = EbayFindingApi.FindItemsResponse.this;
                super();
            }
                };
            }
