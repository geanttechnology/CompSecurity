        ...
        if ("http://www.ebay.com/marketplace/search/v1/services".equals(s))
        {
            ...
            if ("shippingType".equals(s1))
            {
                return new com.ebay.nautilus.kernel.util.SaxHandler.TextElement() {
                    ...
                    final SavedSearchesApi.FindItemsResponse.SearchResult.Item.ShippingInfo this$0;
            ...
            {
                this$0 = SavedSearchesApi.FindItemsResponse.SearchResult.Item.ShippingInfo.this;
                super();
            }
                };
            }
