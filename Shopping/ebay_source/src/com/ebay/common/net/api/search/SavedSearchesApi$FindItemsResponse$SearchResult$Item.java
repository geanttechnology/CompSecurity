...
_L6:
    ...
    final class PrimaryCategory extends com.ebay.nautilus.kernel.util.SaxHandler.Element
    {
        ...
        final SavedSearchesApi.FindItemsResponse.SearchResult.Item this$0;
...
/*
        static EbayCategorySummary access$302(PrimaryCategory primarycategory, EbayCategorySummary ebaycategorysummary)
        {
...
/*
        static String access$402(PrimaryCategory primarycategory, String s)
        {
...
*/
        ...
        PrimaryCategory()
        {
            this$0 = SavedSearchesApi.FindItemsResponse.SearchResult.Item.this;
            super();
            category = null;
            categoryName = null;
        }
...
_L7:
        ...
        throws SAXException
    {
        if ("http://www.ebay.com/marketplace/search/v1/services".equals(s))
        {
            ...
            if ("primaryCategory".equals(s1) && response.es != null)
            {
