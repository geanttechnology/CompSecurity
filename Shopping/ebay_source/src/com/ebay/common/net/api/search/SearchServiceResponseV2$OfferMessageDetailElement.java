        ...
        throws SAXException
    {
        if ("legalTextMessage".equals(s1))
        {
            return new com.ebay.nautilus.kernel.util.SaxHandler.TextElement() {
                ...
                final SearchServiceResponseV2.OfferMessageDetailElement this$1;

                public void text(String s3)
                    throws SAXException
                {
                    searchResponse.sellerOfferDetail.legalTextMessage = s3;
                }

            
            {
                this$1 = SearchServiceResponseV2.OfferMessageDetailElement.this;
                super();
            }
            };
        }
        if ("textMessage".equals(s1))
        {
            return new com.ebay.nautilus.kernel.util.SaxHandler.TextElement() {
                ...
                public void text(String s3)
                    throws SAXException
                {
                    searchResponse.sellerOfferDetail.textMessage = s3;
                }
