...
private final class <init> extends com.ebay.nautilus.kernel.util.ce
{

    final GetOrderShippingInfoResponse this$0;

    public com.ebay.nautilus.kernel.util.ce get(String s, String s1, String s2, Attributes attributes)
        throws SAXException
    {
        if ("http://www.ebay.com/marketplace/shipping/v1/services".equals(s) && "deliveryEstimate".equals(s1))
        {
            return new it>(GetOrderShippingInfoResponse.this, null);
        } else
        {
