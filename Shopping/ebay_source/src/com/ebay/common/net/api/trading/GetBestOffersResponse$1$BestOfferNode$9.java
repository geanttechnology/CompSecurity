...
class this._cls2 extends com.ebay.nautilus.kernel.util._cls9
{

    final yerShippingAddress this$2;

    public com.ebay.nautilus.kernel.util._cls9 get(String s, String s1, String s2, Attributes attributes)
        throws SAXException
    {
        if ("FeedbackScore".equals(s1))
        {
            return new com.ebay.nautilus.kernel.util.SaxHandler.TextElement() {
                ...
                public void text(String s3)
                    throws SAXException
                {
                    GetBestOffersResponse._cls1.BestOfferNode.access$000(this$2).buyerFeedbackScore = s3;
                }
        ...
        if ("UserID".equals(s1))
        {
            return new com.ebay.nautilus.kernel.util.SaxHandler.TextElement() {
                ...
                public void text(String s3)
                    throws SAXException
                {
                    GetBestOffersResponse._cls1.BestOfferNode.access$000(this$2).buyerId = s3;
                }
        ...
        {
            cess._mth000(this._cls2.this).buyerAddress = new Address();
            return yerShippingAddress;
        } else
        {
            return super.buyerShippingAddress(s, s1, s2, attributes);
        }
    }
...
/* anonymous class */
        class GetBestOffersResponse._cls1.BestOfferNode._cls3 extends com.ebay.nautilus.kernel.util.SaxHandler.TextElement
        {
            ...
            public void text(String s)
                throws SAXException
            {
                GetBestOffersResponse._cls1.BestOfferNode.access$000(GetBestOffersResponse._cls1.BestOfferNode.this).buyerMessage = s;
            }
