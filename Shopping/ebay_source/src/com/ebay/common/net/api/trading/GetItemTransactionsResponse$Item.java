...
private final class <init> extends com.ebay.nautilus.kernel.util.m
{
        ...
        throws SAXException
    {
        if ("urn:ebay:apis:eBLBaseComponents".equals(s))
        {
            if ("Seller".equals(s1))
            {
                return new r(GetItemTransactionsResponse.this, null);
            }
            if ("PaymentMethods".equals(s1))
            {
                return new com.ebay.nautilus.kernel.util.SaxHandler.TextElement() {

                    final GetItemTransactionsResponse.Item this$1;

                    public void text(String s3)
                        throws SAXException
                    {
                        GetItemTransactionsResponse.access$400(this$0).add(s3);
                    }

            
            {
                this$1 = GetItemTransactionsResponse.Item.this;
                super();
            }
                };
            }
