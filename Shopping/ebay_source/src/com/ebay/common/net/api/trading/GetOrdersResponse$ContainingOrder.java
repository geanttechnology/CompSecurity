        ...
        if ("urn:ebay:apis:eBLBaseComponents".equals(s))
        {
            if ("OrderID".equals(s1))
            {
                return new com.ebay.nautilus.kernel.util.SaxHandler.TextElement() {
                    ...
                    final GetOrdersResponse.ContainingOrder this$1;

                    public void text(String s3)
                        throws SAXException
                    {
                        currentTx.orderId = s3;
                    }

            
            {
                this$1 = GetOrdersResponse.ContainingOrder.this;
                super();
            }
                };
            }
            ...
            {
                return new ls(GetOrdersResponse.this, currentTx);
            }
        }
