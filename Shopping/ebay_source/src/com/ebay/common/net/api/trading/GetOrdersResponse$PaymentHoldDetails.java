        ...
        if ("urn:ebay:apis:eBLBaseComponents".equals(s))
        {
            if ("ExpectedReleaseDate".equals(s1))
            {
                return new com.ebay.nautilus.kernel.util.SaxHandler.TextElement() {
                    ...
                    final GetOrdersResponse.PaymentHoldDetails this$1;

                    public void text(String s3)
                        throws SAXException
                    {
                        currentTx.expectedReleaseDate = EbayDateUtils.parseXml(s3);
                    }

            
            {
                this$1 = GetOrdersResponse.PaymentHoldDetails.this;
                super();
            }
                };
            }
            ...
            {
                return new nArray(GetOrdersResponse.this, currentTx);
            }
        }
