...
private final class order extends com.ebay.nautilus.kernel.util.s
{
        ...
        throws SAXException
    {
        if ("PickupMethod".equals(s1))
        {
            return new com.ebay.nautilus.kernel.util.SaxHandler.TextElement() {
                ...
                final GetOrdersResponse.PickupOptions this$1;

                public void text(String s3)
                    throws SAXException
                {
                    order.pickupMethod = s3;
                }

            
            {
                this$1 = GetOrdersResponse.PickupOptions.this;
                super();
            }
            };
        }
    ...
    public _cls2.this._cls1(EbayOrder ebayorder)
    {
