...
/* anonymous class */
    ...
    {
        class PlaceOfferResponse._cls1._cls3.SuggestedBidValues extends com.ebay.nautilus.kernel.util.SaxHandler.Element
        {
            ...
            PlaceOfferResponse._cls1._cls3.SuggestedBidValues()
            {
            ...
            throws SAXException
        {
            if ("urn:ebay:apis:eBLBaseComponents".equals(s))
            {
                ...
                {
                    return new PlaceOfferResponse._cls1.RoverRoiResultElement(this);
                }
...
/* anonymous class */
        ...
        // Unreferenced inner class com/ebay/common/net/api/trading/PlaceOfferResponse$1$3

/* anonymous class */
        class PlaceOfferResponse._cls1._cls3 extends com.ebay.nautilus.kernel.util.SaxHandler.Element
        {
                ...
                throws SAXException
            {
                if ("urn:ebay:apis:eBLBaseComponents".equals(s))
                {
                    ...
                    {
                        return new PlaceOfferResponse._cls1._cls3._cls1();
                    }
                    if ("SuggestedBidValues".equals(s1))
                    {
                        return new PlaceOfferResponse._cls1._cls3.SuggestedBidValues();
                    }
                }
                return super.get(s, s1, s2, attributes);
            }
                    ...
                    
                    {
                        this$1 = PlaceOfferResponse._cls1.this;
                        super();
                        highBidder = new PlaceOfferResponse._cls1._cls3._cls2();
                    }
        }


        // Unreferenced inner class com/ebay/common/net/api/trading/PlaceOfferResponse$1$3$1

/* anonymous class */
        class PlaceOfferResponse._cls1._cls3._cls1 extends com.ebay.nautilus.kernel.util.SaxHandler.BooleanElement
        {
...
/* anonymous class */
        class PlaceOfferResponse._cls1._cls3._cls2 extends com.ebay.nautilus.kernel.util.SaxHandler.Element
        {
                ...
                throws SAXException
            {
                ...
                {
                    return new PlaceOfferResponse._cls1._cls3._cls2._cls1();
                } else
                {
                    return super.get(s, s1, s2, attributes);
                }
        ...
        // Unreferenced inner class com/ebay/common/net/api/trading/PlaceOfferResponse$1$3$2$1

/* anonymous class */
        class PlaceOfferResponse._cls1._cls3._cls2._cls1 extends com.ebay.nautilus.kernel.util.SaxHandler.TextElement
        {

            final PlaceOfferResponse._cls1._cls3._cls2 this$3;
                ...
                throws SAXException
            {
                result.highBidder = s;
                    ...
                    {
                        this$3 = PlaceOfferResponse._cls1._cls3._cls2.this;
                        super();
                    }
        }
