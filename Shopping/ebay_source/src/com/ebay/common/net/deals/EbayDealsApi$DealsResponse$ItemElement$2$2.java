...
class this._cls1 extends com.ebay.nautilus.kernel.util.._cls1
{
        ...
        throws SAXException
    {
        try
        {
            .item = EbayDateUtils.parseIso8601DateTime(s);
            return;
        }
...
/* anonymous class */
        class EbayDealsApi.DealsResponse.ItemElement._cls2._cls3 extends com.ebay.nautilus.kernel.util.SaxHandler.TextElement
        {
