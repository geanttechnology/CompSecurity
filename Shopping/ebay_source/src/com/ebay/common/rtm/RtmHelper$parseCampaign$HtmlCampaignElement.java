        ...
        throws SAXException
    {
        if ("title".equals(s1))
        {
            return new com.ebay.nautilus.kernel.util.SaxHandler.TextElement() {
                ...
                final RtmHelper.parseCampaign.HtmlCampaignElement this$2;
            ...
            {
                this$2 = RtmHelper.parseCampaign.HtmlCampaignElement.this;
                super();
            }
            };
        }
        if ("htmlPageURL".equals(s1))
        {
            if (attributes != null)
            {
                RtmHelper.access$100(_fld1).rc.ssoScope = attributes.getValue("ssoScope");
            }
