        ...
        throws SAXException
    {
        if ("searchDescription".equals(s1))
        {
            return new com.ebay.nautilus.kernel.util.SaxHandler.TextElement() {
                ...
                final RtmHelper.parseCampaign.ThemedSearchListItemElement this$2;

                public void text(String s3)
                    throws SAXException
                {
                    RtmHelper.access$100(this$0).rc.searchDescriptions.add(s3.trim());
                }

            
            {
                this$2 = RtmHelper.parseCampaign.ThemedSearchListItemElement.this;
                super();
            }
            };
        }
