    ...
    implements DcsPropString
{
    ...
    public static pString valueOf(String s)
    {
        return (pString)Enum.valueOf(com/ebay/mobile/dcs/Dcs$Payments$S, s);
    }

    public static pString[] values()
    {
        return (pString[])$VALUES.clone();
    }
