    ...
    implements com.ebay.nautilus.domain.dcs.ain
{
        ...
        implements DcsPropBoolean
    {
        ...
        {
            return (B)Enum.valueOf(com/ebay/mobile/dcs/Dcs$Payments$B, s);
        }
        ...
        implements DcsPropInteger
    {
        ...
        {
            return (I)Enum.valueOf(com/ebay/mobile/dcs/Dcs$Payments$I, s);
        }
        ...
        implements DcsPropLong
    {
        ...
        {
            return (L)Enum.valueOf(com/ebay/mobile/dcs/Dcs$Payments$L, s);
        }
        ...
        implements DcsPropString
    {
        ...
        {
            return (S)Enum.valueOf(com/ebay/mobile/dcs/Dcs$Payments$S, s);
        }
