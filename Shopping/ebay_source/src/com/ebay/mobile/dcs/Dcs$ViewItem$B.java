    ...
    implements DcsPropBoolean
{
    ...
    private static final realtimeMtsFlush $VALUES[];
    public static final realtimeMtsFlush realtimeMtsFlush;
    private final Object defaultValue;
    private final String key;

    public static pBoolean valueOf(String s)
    {
        return (pBoolean)Enum.valueOf(com/ebay/mobile/dcs/Dcs$ViewItem$B, s);
    }
    ...
    static 
    {
        realtimeMtsFlush = new <init>("realtimeMtsFlush", 0);
        $VALUES = (new .VALUES[] {
            realtimeMtsFlush
        });
    }
