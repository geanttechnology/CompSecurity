...
public class WatchingViewModel extends ViewModel
{
    ...
    public WatchingViewModel(int i, com.ebay.nautilus.domain.data.UnifiedStream.Contents.ContentGroup contentgroup, com.ebay.mobile.common.view.ViewModel.OnClickListener onclicklistener)
    {
        super(i, onclicklistener);
        if (contentgroup.contentSource != ContentSourceEnum.WATCHING)
        {
