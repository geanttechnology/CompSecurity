    ...
    implements Runnable
{
    ...
    // Unreferenced inner class com/ebay/mobile/myebay/ComposeNewMessageFragment$2

/* anonymous class */
    class ComposeNewMessageFragment._cls2
        implements TextWatcher
    {
        ...
        public void afterTextChanged(Editable editable)
        {
            ...
            {
                (new Handler()).postDelayed(new ComposeNewMessageFragment._cls2._cls1(), 1L);
            }
        }

        public void beforeTextChanged(CharSequence charsequence, int i, int j, int k)
        {
            if (ComposeNewMessageFragment.access$400(ComposeNewMessageFragment.this).length() != k)
            {
