...
public abstract class EbayFragmentPagerAdapter extends PagerAdapter
{
    ...
    public EbayFragmentPagerAdapter(FragmentManager fragmentmanager)
    {
    ...
    public Object getItemIfExists(ViewGroup viewgroup, int i)
    {
        long l = getItemId(i);
        viewgroup = makeFragmentName(viewgroup.getId(), l);
        return mFragmentManager.findFragmentByTag(viewgroup);
    }
