...
public static abstract class <init> extends Enum
{
    ...
    private static final EBAYGIVINGWORKS $VALUES[];
    public static final EBAYGIVINGWORKS BESTOFFER;
    public static final EBAYGIVINGWORKS BUYINGFORMAT;
    public static final EBAYGIVINGWORKS COMPLETEDITEMS;
    public static final EBAYGIVINGWORKS CONDITION;
    public static final EBAYGIVINGWORKS DESCRIPTIONSEARCH;
    public static final EBAYGIVINGWORKS EBAYGIVINGWORKS;
    public static final EBAYGIVINGWORKS EBAYPLUS;
    public static final EBAYGIVINGWORKS EBN;
    public static final EBAYGIVINGWORKS EXPEDITEDSHIPPING;
    public static final EBAYGIVINGWORKS FREESHIPPING;
    public static final EBAYGIVINGWORKS INSTOREPICKUP;
    public static final EBAYGIVINGWORKS LOCALPICKUP;
    public static final EBAYGIVINGWORKS MAXDISTANCE;
    public static final EBAYGIVINGWORKS MAXPRICE;
    public static final EBAYGIVINGWORKS MINPRICE;
    private static char PRICE_TOKEN = '?';
    public static final EBAYGIVINGWORKS RETURNSACCEPTED;
    public static final EBAYGIVINGWORKS SEARCHLOCALCOUNTRY;
    public static final EBAYGIVINGWORKS SEARCHOTHERCOUNTRIES;
    public static final EBAYGIVINGWORKS SOLDITEMS;
    public static final EBAYGIVINGWORKS SORTORDER;
    public static final EBAYGIVINGWORKS ZIPCODE;

    public static <init> valueOf(String s)
    {
        return (<init>)Enum.valueOf(com/ebay/mobile/search/RefinementLocks$RefinementLockType, s);
    }
    ...
    static 
    {
        BESTOFFER = new RefinementLocks.RefinementLockType("BESTOFFER", 0) {
        ...
        BUYINGFORMAT = new RefinementLocks.RefinementLockType("BUYINGFORMAT", 1) {
        ...
        CONDITION = new RefinementLocks.RefinementLockType("CONDITION", 2) {
        ...
        MINPRICE = new RefinementLocks.RefinementLockType("MINPRICE", 3) {
        ...
        MAXPRICE = new RefinementLocks.RefinementLockType("MAXPRICE", 4) {
        ...
        SORTORDER = new RefinementLocks.RefinementLockType("SORTORDER", 5) {
        ...
        FREESHIPPING = new RefinementLocks.RefinementLockType("FREESHIPPING", 6) {
        ...
        EXPEDITEDSHIPPING = new RefinementLocks.RefinementLockType("EXPEDITEDSHIPPING", 7) {
        ...
        INSTOREPICKUP = new RefinementLocks.RefinementLockType("INSTOREPICKUP", 8) {
        ...
        LOCALPICKUP = new RefinementLocks.RefinementLockType("LOCALPICKUP", 9) {
        ...
        EBN = new RefinementLocks.RefinementLockType("EBN", 10) {
        ...
        ZIPCODE = new RefinementLocks.RefinementLockType("ZIPCODE", 11) {
        ...
        MAXDISTANCE = new RefinementLocks.RefinementLockType("MAXDISTANCE", 12) {
        ...
        COMPLETEDITEMS = new RefinementLocks.RefinementLockType("COMPLETEDITEMS", 13) {
        ...
        SOLDITEMS = new RefinementLocks.RefinementLockType("SOLDITEMS", 14) {
        ...
        EBAYPLUS = new RefinementLocks.RefinementLockType("EBAYPLUS", 15) {
        ...
        DESCRIPTIONSEARCH = new RefinementLocks.RefinementLockType("DESCRIPTIONSEARCH", 16) {
        ...
        SEARCHOTHERCOUNTRIES = new RefinementLocks.RefinementLockType("SEARCHOTHERCOUNTRIES", 17) {
        ...
        SEARCHLOCALCOUNTRY = new RefinementLocks.RefinementLockType("SEARCHLOCALCOUNTRY", 18) {
        ...
        RETURNSACCEPTED = new RefinementLocks.RefinementLockType("RETURNSACCEPTED", 19) {
        ...
        EBAYGIVINGWORKS = new RefinementLocks.RefinementLockType("EBAYGIVINGWORKS", 20) {
