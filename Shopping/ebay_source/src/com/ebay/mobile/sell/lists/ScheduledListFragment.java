...
public final class ScheduledListFragment extends SellListBaseFragment
{

    private static long lastRefreshTime;
    public static final com.ebay.nautilus.kernel.util.FwLog.LogInfo logTag = new com.ebay.nautilus.kernel.util.FwLog.LogInfo("ScheduledItemList", 3, "Log Dest Scheduled");
    ...
    {
        return new SellListAdapter(getActivity(), getLayoutResource(), 0x1020014, this, SellingListActivity.ListType.SCHEDULED);
    }
    ...
    {
        return com.ebay.common.ConstantsCommon.ItemKind.Scheduled;
    }
    ...
    {
        return resources.getString(0x7f070951);
    }

    public String getTrackingEventName()
    {
        return "MyEbayScheduledList";
    }
    ...
    protected void onInitializeDataManagers(DataManagerContainer datamanagercontainer)
    {
        ...
        dm.setObserving(this, false, false, false, false, true);
        if (restorePage != -1)
        {
            dm.loadScheduledList(restorePage);
        }
