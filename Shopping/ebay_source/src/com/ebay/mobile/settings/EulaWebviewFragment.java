...
public class EulaWebviewFragment extends BaseFragment
{

    public EulaWebviewFragment()
    {
    }
    ...
    public View onCreateView(LayoutInflater layoutinflater, ViewGroup viewgroup, Bundle bundle)
    {
        ...
        viewgroup.loadUrl(DeviceConfiguration.getAsync().get(com.ebay.mobile.dcs.Dcs.Connect.S.userAgreementUrl));
