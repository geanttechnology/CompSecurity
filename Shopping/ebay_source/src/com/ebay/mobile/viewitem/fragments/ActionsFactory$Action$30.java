...
static final class it> extends it>
{
    ...
    {
        AfterSalesWebViewActivity.startActivity(actionsfactory.fragment, ActionsFactory.access$1900(actionsfactory), com.ebay.mobile.activities..AfterSalesType.NOT_APPLICABLE);
    }
