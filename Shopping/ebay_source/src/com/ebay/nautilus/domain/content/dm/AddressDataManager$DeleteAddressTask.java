...
private final class <init> extends AsyncTask
{
    ...
    {
        as = as[0];
        as = new DeleteAddressRequest(new EbayAddressBookApi(AddressDataManager.access$700(AddressDataManager.this).site, AddressDataManager.access$800(AddressDataManager.this).iafToken), as);
        ResultStatusOwner resultstatusowner = new ResultStatusOwner();
        AddressDataManager.access$900(AddressDataManager.this, as, resultstatusowner);
    ...
    protected void onPostExecute(Content content)
    {
        ...
        AddressDataManager.access$1000(AddressDataManager.this, content);
    }
