...
private final class observer extends AsyncTask
{
    ...
    protected transient Content doInBackground(MyEbayListItem amyebaylistitem[])
    {
        ...
        try
        {
            observer observer1 = emoveFromUnsoldListRequest(ebaytradingapi.site, ebaytradingapi.iafToken, amyebaylistitem);
            amyebaylistitem = new Content(amyebaylistitem, MyEbaySellingDataManager.access$200(MyEbaySellingDataManager.this, observer1).getResultStatus());
        }
