...
public class Base64ByteArrayAdapter
    implements JsonDeserializer, JsonSerializer
{
    ...
    public JsonElement serialize(byte abyte0[], Type type, JsonSerializationContext jsonserializationcontext)
    {
        return new JsonPrimitive(Base64.encodeToString(abyte0, 2));
    }
}
