    ...
    implements in
{
        ...
        implements DcsPropBoolean
    {
        ...
        public static final B srpShow19791;
        public static final B srpShowDirectGoogleTextAd;
        private final Object defaultValue;
        private final String key;

        public static B valueOf(String s)
        {
            return (B)Enum.valueOf(com/ebay/nautilus/domain/dcs/DcsDomain$Ads$B, s);
        }
        ...
        static 
        {
            srpShow19791 = new B("srpShow19791", 0, false);
            srpShowDirectGoogleTextAd = new B("srpShowDirectGoogleTextAd", 1, false);
            $VALUES = (new B[] {
        ...
        implements DcsPropInteger
    {
        ...
        public static final I srpMaxLimitShown19791;
        public static final I srpThresholdResultCount19791;
        private final Object defaultValue;
        private final String key;

        public static I valueOf(String s)
        {
            return (I)Enum.valueOf(com/ebay/nautilus/domain/dcs/DcsDomain$Ads$I, s);
        }
        ...
        static 
        {
            srpThresholdResultCount19791 = new I("srpThresholdResultCount19791", 0, 50);
            srpMaxLimitShown19791 = new I("srpMaxLimitShown19791", 1, 10);
            $VALUES = (new I[] {
        ...
        implements DcsPropLong
    {
        ...
        {
            return (L)Enum.valueOf(com/ebay/nautilus/domain/dcs/DcsDomain$Ads$L, s);
        }
        ...
        implements DcsPropString
    {
        ...
        {
            return (S)Enum.valueOf(com/ebay/nautilus/domain/dcs/DcsDomain$Ads$S, s);
        }
