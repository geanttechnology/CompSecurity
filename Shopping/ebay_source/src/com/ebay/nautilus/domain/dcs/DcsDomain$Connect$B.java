    ...
    implements DcsPropBoolean
{
    ...
    private static final uciNotification $VALUES[];
    public static final uciNotification uciNotification;
    private final Object defaultValue;
    private final String key;

    public static defaultValue valueOf(String s)
    {
        return (defaultValue)Enum.valueOf(com/ebay/nautilus/domain/dcs/DcsDomain$Connect$B, s);
    }
    ...
    static 
    {
        uciNotification = new <init>("uciNotification", 0);
        $VALUES = (new .VALUES[] {
            uciNotification
        });
    }
