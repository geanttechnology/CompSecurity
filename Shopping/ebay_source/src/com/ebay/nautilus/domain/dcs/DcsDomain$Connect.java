    ...
    implements S.defaultValue
{
        ...
        implements DcsPropBoolean
    {
        ...
        public static final B uciNotification;
        private final Object defaultValue;
        private final String key;

        public static B valueOf(String s)
        {
            return (B)Enum.valueOf(com/ebay/nautilus/domain/dcs/DcsDomain$Connect$B, s);
        }
        ...
        static 
        {
            uciNotification = new B("uciNotification", 0);
            $VALUES = (new B[] {
                uciNotification
            });
        }
        ...
        implements DcsPropInteger
    {
        ...
        {
            return (I)Enum.valueOf(com/ebay/nautilus/domain/dcs/DcsDomain$Connect$I, s);
        }
        ...
        implements DcsPropLong
    {
        ...
        {
            return (L)Enum.valueOf(com/ebay/nautilus/domain/dcs/DcsDomain$Connect$L, s);
        }
        ...
        implements DcsPropString
    {
        ...
        {
            return (S)Enum.valueOf(com/ebay/nautilus/domain/dcs/DcsDomain$Connect$S, s);
        }
