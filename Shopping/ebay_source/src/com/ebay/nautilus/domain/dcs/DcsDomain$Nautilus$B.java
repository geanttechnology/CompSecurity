    ...
    implements DcsPropBoolean
{
    ...
    private static final appSpeed $VALUES[];
    public static final appSpeed appSpeed;
    public static final appSpeed invalidIafTokenValidation;
    private final Object defaultValue;
    private final String key;

    public static defaultValue valueOf(String s)
    {
        return (defaultValue)Enum.valueOf(com/ebay/nautilus/domain/dcs/DcsDomain$Nautilus$B, s);
    }
    ...
    static 
    {
        invalidIafTokenValidation = new <init>("invalidIafTokenValidation", 0);
        appSpeed = new <init>("appSpeed", 1);
        $VALUES = (new .VALUES[] {
