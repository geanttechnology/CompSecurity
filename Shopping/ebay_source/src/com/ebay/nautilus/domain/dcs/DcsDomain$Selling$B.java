    ...
    implements DcsPropBoolean
{
    ...
    private static final guarantee $VALUES[];
    public static final guarantee guarantee;
    private final Object defaultValue;
    private final String key;

    public static defaultValue valueOf(String s)
    {
        return (defaultValue)Enum.valueOf(com/ebay/nautilus/domain/dcs/DcsDomain$Selling$B, s);
    }
    ...
    static 
    {
        guarantee = new <init>("guarantee", 0);
        $VALUES = (new .VALUES[] {
            guarantee
        });
    }
