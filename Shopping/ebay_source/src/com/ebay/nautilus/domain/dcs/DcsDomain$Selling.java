    ...
    implements S.defaultValue
{
        ...
        implements DcsPropBoolean
    {
        ...
        public static final B guarantee;
        private final Object defaultValue;
        private final String key;

        public static B valueOf(String s)
        {
            return (B)Enum.valueOf(com/ebay/nautilus/domain/dcs/DcsDomain$Selling$B, s);
        }
        ...
        implements DcsPropInteger
    {
        ...
        {
            return (I)Enum.valueOf(com/ebay/nautilus/domain/dcs/DcsDomain$Selling$I, s);
        }
        ...
        implements DcsPropLong
    {
        ...
        {
            return (L)Enum.valueOf(com/ebay/nautilus/domain/dcs/DcsDomain$Selling$L, s);
        }
        ...
        implements DcsPropString
    {
        ...
        public static final S carsAndTrucksUrl;
        public static final S durationOverrideValueFixedPrice;
        private final String defaultValue;
        private final String key;

        public static S valueOf(String s)
        {
            return (S)Enum.valueOf(com/ebay/nautilus/domain/dcs/DcsDomain$Selling$S, s);
        }
        ...
        static 
        {
            durationOverrideValueFixedPrice = new S("durationOverrideValueFixedPrice", 0);
            carsAndTrucksUrl = new S("carsAndTrucksUrl", 1);
            $VALUES = (new S[] {
