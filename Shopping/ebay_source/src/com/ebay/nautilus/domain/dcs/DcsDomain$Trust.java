    ...
    implements 
{
        ...
        implements DcsPropBoolean
    {
        ...
        {
            return (B)Enum.valueOf(com/ebay/nautilus/domain/dcs/DcsDomain$Trust$B, s);
        }
        ...
        implements DcsPropInteger
    {
        ...
        {
            return (I)Enum.valueOf(com/ebay/nautilus/domain/dcs/DcsDomain$Trust$I, s);
        }
        ...
        implements DcsPropLong
    {
        ...
        {
            return (L)Enum.valueOf(com/ebay/nautilus/domain/dcs/DcsDomain$Trust$L, s);
        }
        ...
        implements DcsPropString
    {
        ...
        {
            return (S)Enum.valueOf(com/ebay/nautilus/domain/dcs/DcsDomain$Trust$S, s);
        }
