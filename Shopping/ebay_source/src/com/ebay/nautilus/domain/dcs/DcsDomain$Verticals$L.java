    ...
    implements DcsPropLong
{
    ...
    private static final categoryServiceMaxCacheTtl $VALUES[];
    public static final categoryServiceMaxCacheTtl categoryServiceMaxCacheTtl;
    private final Object defaultValue;
    private final String key;

    public static defaultValue valueOf(String s)
    {
        return (defaultValue)Enum.valueOf(com/ebay/nautilus/domain/dcs/DcsDomain$Verticals$L, s);
    }
    ...
    static 
    {
        categoryServiceMaxCacheTtl = new <init>("categoryServiceMaxCacheTtl", 0, 0x5265c00L);
        $VALUES = (new .VALUES[] {
