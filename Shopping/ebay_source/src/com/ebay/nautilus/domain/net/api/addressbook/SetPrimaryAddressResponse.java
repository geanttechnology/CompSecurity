...
public final class SetPrimaryAddressResponse extends EbayResponse
{
    public static class SetPrimaryAddressResponseWrapper extends BaseApiResponse
    {
        ...
        public SetPrimaryAddressResponseWrapper()
        {
        }
    }
    ...
    public SetPrimaryAddressResponse()
    {
    }
    ...
    {
        responseData = ((SetPrimaryAddressResponseWrapper)readStream(MAPPER, inputstream, com/ebay/nautilus/domain/net/api/addressbook/SetPrimaryAddressResponse$SetPrimaryAddressResponseWrapper)).data;
    }
