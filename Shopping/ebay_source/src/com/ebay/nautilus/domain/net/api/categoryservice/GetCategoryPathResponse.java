...
public final class GetCategoryPathResponse extends CategoryServiceResponse
{
    ...
    {
        inputstream = (CallWrapper)readJsonStream(inputstream, com/ebay/nautilus/domain/net/api/categoryservice/GetCategoryPathResponse$CallWrapper);
        if (inputstream != null)
        {
