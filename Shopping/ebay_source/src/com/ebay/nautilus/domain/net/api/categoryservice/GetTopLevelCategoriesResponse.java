...
public final class GetTopLevelCategoriesResponse extends CategoryServiceResponse
{
    ...
    public static final class Payload extends CategoryServiceResponse.CategoryServicePayload
    {
        ...
        public List categoryNodeDetails;
        public int numberOfTopLevelCategories;
    ...
    public GetTopLevelCategoriesResponse()
    {
    }
    ...
    {
        inputstream = (CallWrapper)readJsonStream(inputstream, com/ebay/nautilus/domain/net/api/categoryservice/GetTopLevelCategoriesResponse$CallWrapper);
        if (inputstream != null)
        {
