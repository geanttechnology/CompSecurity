...
public final class GetShoppingCartByUserIdRequest extends EcasApiRequest
{

    public GetShoppingCartByUserIdRequest(EcasApiContext ecasapicontext)
    {
        super("getShoppingCartByUserId", ecasapicontext);
    }
    ...
    {
        return new ShoppingCartResponse(com/ebay/nautilus/domain/net/api/ecas/ShoppingCartResponse$GetShoppingCartByUserId);
    }
