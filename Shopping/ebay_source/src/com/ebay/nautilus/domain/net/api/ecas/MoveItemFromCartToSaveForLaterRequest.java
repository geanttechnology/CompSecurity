...
public final class MoveItemFromCartToSaveForLaterRequest extends EcasApiRequest
{

    final long itemReferenceId;

    public MoveItemFromCartToSaveForLaterRequest(EcasApiContext ecasapicontext, long l)
    {
        super("moveItemFromCartToSaveForLater", ecasapicontext);
        itemReferenceId = l;
    }
        ...
        throws com.ebay.nautilus.kernel.net.Connector.BuildRequestDataException
    {
        ...
        obj = new JSONObject();
        ((JSONObject) (obj)).put("itemReferenceId", Long.toString(itemReferenceId));
        jsonobject.put("itemReferenceIdInput", obj);
    ...
    {
        return new ShoppingCartResponse(com/ebay/nautilus/domain/net/api/ecas/ShoppingCartResponse$MoveItemFromCartToSaveForLater);
    }
