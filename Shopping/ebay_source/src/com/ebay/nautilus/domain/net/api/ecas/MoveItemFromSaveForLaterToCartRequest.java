...
public final class MoveItemFromSaveForLaterToCartRequest extends EcasApiRequest
{

    final Long itemReferenceId;

    public MoveItemFromSaveForLaterToCartRequest(EcasApiContext ecasapicontext, Long long1)
    {
        ...
        throws com.ebay.nautilus.kernel.net.Connector.BuildRequestDataException
    {
        ...
        obj = new JSONObject();
        ((JSONObject) (obj)).put("itemReferenceId", Long.toString(itemReferenceId.longValue()));
    ...
    {
        return new ShoppingCartResponse(com/ebay/nautilus/domain/net/api/ecas/ShoppingCartResponse$MoveItemFromSaveForLaterToCart);
    }
