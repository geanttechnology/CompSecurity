...
public final class RemoveItemFromSaveForLaterRequest extends EcasApiRequest
{

    final long itemReferenceId;

    public RemoveItemFromSaveForLaterRequest(EcasApiContext ecasapicontext, long l)
    {
        super("removeItemFromSaveForLater", ecasapicontext);
        itemReferenceId = l;
    }
    ...
    {
        return new ShoppingCartResponse(com/ebay/nautilus/domain/net/api/ecas/ShoppingCartResponse$RemoveItemFromSaveForLater);
    }
