...
public final class RemoveItemFromShoppingCartRequest extends EcasApiRequest
{

    final long itemReferenceId;

    public RemoveItemFromShoppingCartRequest(EcasApiContext ecasapicontext, long l)
    {
        super("removeItemFromShoppingCart", ecasapicontext);
        itemReferenceId = l;
    }
    ...
    {
        return new ShoppingCartResponse(com/ebay/nautilus/domain/net/api/ecas/ShoppingCartResponse$RemoveItemFromShoppingCart);
    }
