...
public final class UpdateShoppingCartRequest extends EcasApiRequest
{

    final Long itemReferenceId;
    final int quantity;

    public UpdateShoppingCartRequest(EcasApiContext ecasapicontext, Long long1, Integer integer)
    {
        super("updateShoppingCart", ecasapicontext);
        ...
        throws com.ebay.nautilus.kernel.net.Connector.BuildRequestDataException
    {
        ...
        jsonobject1.put("itemReferenceId", Long.toString(itemReferenceId.longValue()));
        jsonobject1.put("quantity", Integer.toString(quantity));
        ((JSONObject) (obj)).put("itemQuantity", jsonobject1);
    ...
    {
        return new ShoppingCartResponse(com/ebay/nautilus/domain/net/api/ecas/ShoppingCartResponse$UpdateShoppingCart);
    }
