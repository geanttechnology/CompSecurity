...
private final class <init> extends com.ebay.nautilus.kernel.util.orList
{

    final this._cls1 this$1;

    public com.ebay.nautilus.kernel.util.orList get(String s, String s1, String s2, Attributes attributes)
        throws SAXException
    {
        if ("error".equals(s1))
        {
