...
public class LdsResponse extends EbayCosResponse
{
    ...
    private final class RootElement.ErrorList extends com.ebay.nautilus.kernel.util.SaxHandler.Element
    {
            ...
            throws SAXException
        {
            if ("error".equals(s1))
            {
                return new RootElement.ErrorNode();
            } else
            {
                return super.get(s, s1, s2, attributes);
            }
    ...
    private final class RootElement.ErrorNode extends com.ebay.nautilus.kernel.util.SaxHandler.Element
    {
            ...
            throws SAXException
        {
            if ("errorId".equals(s1))
            {
                return new com.ebay.nautilus.kernel.util.SaxHandler.TextElement() {
                    ...
                    final RootElement.ErrorNode this$2;
            ...
            {
                this$2 = RootElement.ErrorNode.this;
                super();
            }
                };
            }
    ...
    private final class RootElement.ErrorNode.ErrorCategory extends com.ebay.nautilus.kernel.util.SaxHandler.TextElement
    {
        ...
        private RootElement.ErrorNode.ErrorCategory()
        {
            this$2 = RootElement.ErrorNode.this;
            super();
        }
    ...
    private final class RootElement.ErrorNode.ErrorLongMessage extends com.ebay.nautilus.kernel.util.SaxHandler.TextElement
    {
        ...
        private RootElement.ErrorNode.ErrorLongMessage()
        {
            this$2 = RootElement.ErrorNode.this;
            super();
        }
    ...
    private final class RootElement.ErrorNode.ErrorParameter extends com.ebay.nautilus.kernel.util.SaxHandler.TextElement
    {
...
_L21:
        ...
        public RootElement.ErrorNode.ErrorParameter(String s)
        {
            this$2 = RootElement.ErrorNode.this;
            super();
            name = s;
    ...
    private final class RootElement.ErrorNode.Severity extends com.ebay.nautilus.kernel.util.SaxHandler.TextElement
    {
        ...
        private RootElement.ErrorNode.Severity()
        {
            this$2 = RootElement.ErrorNode.this;
            super();
        }
    ...
    private final class RootElement.Fee extends com.ebay.nautilus.kernel.util.SaxHandler.Element
    {
        ...
        public RootElement.Fee(ArrayList arraylist)
        {
            this$1 = RootElement.this;
            super();
            arraylist.add(fee);
    ...
    private final class RootElement.Fees extends com.ebay.nautilus.kernel.util.SaxHandler.Element
    {
            ...
            throws SAXException
        {
            if ("fee".equals(s1))
            {
                return new RootElement.Fee(draft.fees);
            }
            if ("currency".equals(s1))
            {
                return new RootElement.FeesCurrencyCode();
            } else
            {
                return super.get(s, s1, s2, attributes);
            }
    ...
    private final class RootElement.FeesCurrencyCode extends com.ebay.nautilus.kernel.util.SaxHandler.TextElement
    {
        ...
        private RootElement.FeesCurrencyCode()
        {
            this$1 = RootElement.this;
            super();
        }
    ...
    private final class RootElement.FieldNode extends com.ebay.nautilus.kernel.util.SaxHandler.Element
    {
            ...
            throws SAXException
        {
            ...
            if ("fieldId".equals(s1) && isRecommendation)
            {
                return new FieldRecommendationId();
            }
            ...
            if ("bMode".equals(s1))
            {
                return new com.ebay.nautilus.kernel.util.SaxHandler.TextElement() {
                    ...
                    final RootElement.FieldNode this$2;
            ...
            {
                this$2 = RootElement.FieldNode.this;
                super();
            }
                };
            }
        ...
        public RootElement.FieldNode(String s)
        {
            this$1 = RootElement.this;
            super();
    ...
    private final class RootElement.FieldNode.FieldId extends com.ebay.nautilus.kernel.util.SaxHandler.TextElement
    {
...
_L37:
        ...
        private RootElement.FieldNode.FieldId()
        {
            this$2 = RootElement.FieldNode.this;
            super();
        }
    ...
    private final class RootElement.FieldNode.FieldRecommendationId extends com.ebay.nautilus.kernel.util.SaxHandler.TextElement
    {
        ...
        private RootElement.FieldNode.FieldRecommendationId()
        {
            this$2 = RootElement.FieldNode.this;
            super();
        }
    ...
    private final class RootElement.FieldNode.OptionValue extends com.ebay.nautilus.kernel.util.SaxHandler.Element
    {
            ...
            throws SAXException
        {
            if ("caption".equals(s1))
            {
                return new com.ebay.nautilus.kernel.util.SaxHandler.TextElement() {
                    ...
                    final RootElement.FieldNode.OptionValue this$3;
            ...
            {
                this$3 = RootElement.FieldNode.OptionValue.this;
                super();
            }
                };
            }
        ...
        public RootElement.FieldNode.OptionValue()
        {
            this$2 = RootElement.FieldNode.this;
            super();
    ...
    private final class RootElement.FieldNode.OptionValue.Value extends com.ebay.nautilus.kernel.util.SaxHandler.Element
    {
            ...
            throws SAXException
        {
            if ("stringValue".equals(s1) || "intValue".equals(s1) || "doubleValue".equals(s1) || "dateValue".equals(s1) || "booleanValue".equals(s1) || "longValue".equals(s1))
            {
                return new com.ebay.nautilus.kernel.util.SaxHandler.TextElement() {
                    ...
                    final RootElement.FieldNode.OptionValue.Value this$4;
            ...
            {
                this$4 = RootElement.FieldNode.OptionValue.Value.this;
                super();
            }
                };
            } else
        ...
        private RootElement.FieldNode.OptionValue.Value()
        {
            this$3 = RootElement.FieldNode.OptionValue.this;
            super();
        }
    ...
    private final class RootElement.FieldNode.SelectedValue extends com.ebay.nautilus.kernel.util.SaxHandler.Element
    {
            ...
            throws SAXException
        {
            return new com.ebay.nautilus.kernel.util.SaxHandler.TextElement() {
                ...
                final RootElement.FieldNode.SelectedValue this$3;
            ...
            {
                this$3 = RootElement.FieldNode.SelectedValue.this;
                super();
            }
            };
        }

        private RootElement.FieldNode.SelectedValue()
        {
            this$2 = RootElement.FieldNode.this;
            super();
        }
    ...
    private final class RootElement.ListingDraftNode extends com.ebay.nautilus.kernel.util.SaxHandler.Element
    {
            ...
            throws SAXException
        {
            ...
            {
                return new RootElement.FieldNode(s1);
            }
            if ("listing".equals(s1) && bodyElement.equals("publishListingDraftResponse"))
            {
                return new RootElement.ListingNode();
            }
            if ("draftId".equals(s1))
            {
                return new com.ebay.nautilus.kernel.util.SaxHandler.TextElement() {

                    final RootElement.ListingDraftNode this$2;
            ...
            {
                this$2 = RootElement.ListingDraftNode.this;
                super();
            }
                };
            }
            ...
            if ("fees".equals(s1))
            {
                return new RootElement.Fees();
            }
            if ("lookUpFees".equals(s1))
            {
                return new RootElement.LookupFees();
            } else
            {
                return super.get(s, s1, s2, attributes);
            }
        ...
        private RootElement.ListingDraftNode()
        {
            this$1 = RootElement.this;
            super();
        }
    ...
    private final class RootElement.ListingNode extends com.ebay.nautilus.kernel.util.SaxHandler.Element
    {
            ...
            throws SAXException
        {
            if ("itemId".equals(s1))
            {
                return new com.ebay.nautilus.kernel.util.SaxHandler.TextElement() {
                    ...
                    final RootElement.ListingNode this$2;
            ...
            {
                this$2 = RootElement.ListingNode.this;
                super();
            }
                };
            } else
        ...
        private RootElement.ListingNode()
        {
            this$1 = RootElement.this;
            super();
        }
    ...
    private final class RootElement.LookupFees extends com.ebay.nautilus.kernel.util.SaxHandler.Element
    {
            ...
            throws SAXException
        {
            if ("fee".equals(s1))
            {
                return new RootElement.Fee(draft.lookupFees);
            } else
            {
                return super.get(s, s1, s2, attributes);
            }
        ...
        private RootElement.LookupFees()
        {
            this$1 = RootElement.this;
            super();
        }
    ...
    private final class RootElement.ResponseContainerNode extends com.ebay.nautilus.kernel.util.SaxHandler.Element
    {
            ...
            throws SAXException
        {
            if ("errorMessage".equals(s1))
            {
                return new RootElement.ErrorList();
            }
            if ("listingDraft".equals(s1))
            {
                return new RootElement.ListingDraftNode();
            }
            if ("field".equals(s1))
            {
                return new RootElement.FieldNode(s1);
        ...
        public RootElement.ResponseContainerNode()
        {
            this$1 = RootElement.this;
            super();
            draft = new ListingDraft();
    ...
    public LdsResponse(String s, EbaySite ebaysite, String s1)
    {
        boolean flag = false;
        super(false);
        bodyElement = s;
        site = ebaysite;
        listingMode = s1;
        if (s.equals("getListingDraftsResponse") || s.equals("getSavedListingDraftsResponse") || s.equals("deleteSavedListingDraftsResponse"))
        {
            flag = true;
        }
        isMultiDraftResponse = flag;
        ackCode = 1;
    }

    private static ArrayList buildResultMessages(ArrayList arraylist)
    {
        ArrayList arraylist1 = new ArrayList();
        if (arraylist.isEmpty()) goto _L2; else goto _L1
_L1:
        arraylist = ((ListingDraft)arraylist.get(0)).errors.iterator();
_L13:
        if (!arraylist.hasNext()) goto _L2; else goto _L3
_L3:
        com.ebay.nautilus.domain.net.EbayResponseError.LongDetails longdetails;
        Object obj;
        byte byte0;
        obj = (LdsError)arraylist.next();
        longdetails = new com.ebay.nautilus.domain.net.EbayResponseError.LongDetails();
        longdetails.code = ((LdsError) (obj)).id;
        longdetails.severity = 1;
        longdetails.domain = ((LdsError) (obj)).domain;
        longdetails.userDisplay = false;
        longdetails.shortMessage = ((LdsError) (obj)).message;
        longdetails.longMessage = ((LdsError) (obj)).longMessage;
        obj = ((LdsError) (obj)).category;
        byte0 = -1;
        ((String) (obj)).hashCode();
...
_L12:
    ...
    private void removeInvalidItemSpecifics(ArrayList arraylist)
    {
        ArrayList arraylist1 = new ArrayList();
        ...
        throws com.ebay.nautilus.kernel.net.Connector.ParseResponseDataException
    {
        ...
        if (ackCode == -1)
        {
            addResultMessage(buildResultMessages(drafts));
        } else
        {
            ListingDraft listingdraft;
            for (inputstream = drafts.iterator(); inputstream.hasNext(); removeInvalidItemSpecifics(listingdraft.selectedItemSpecifics))
            {
                listingdraft = (ListingDraft)inputstream.next();
                listingdraft.siteId = site.idInt;
                if (listingdraft.listingMode == null)
                {
                    listingdraft.listingMode = listingMode;
                }
            }

            if (ackCode == 1 && (bodyElement.equals("createListingDraftResponse") || bodyElement.equals("updateListingDraftResponse") || bodyElement.equals("getListingDraftsResponse") || bodyElement.equals("publishListingDraftResponse")) && (drafts.isEmpty() || drafts.get(0) == null || ((ListingDraft)drafts.get(0)).id == null))
            {
                inputstream = new com.ebay.nautilus.domain.net.EbayResponseError.LongDetails();
