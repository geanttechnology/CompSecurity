...
abstract class a extends Thread
{
    ...
    protected abstract BarcodeResultInternal[] ProcessFrame(RLSDK.b.a a1);

    public BarcodeResultInternal[] ProcessFrameSync(RLSDK.b.a a1)
    {
        isPhotoScan = true;
...
_L1:
                return;
_L2:
                if ((message.obj instanceof RLSDK.b.a) && ((message = (RLSDK.b.a)message.obj) != null && ((RLSDK.b.a) (message)).a != null))
                {
                    a.isPhotoScan = false;
                    ...
                    message.e = ((RLSDK.b.a) (message)).e & ~a.getInUseFlagValue();
                    if (((RLSDK.b.a) (message)).e == 0)
                    {
