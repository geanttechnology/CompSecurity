...
public abstract class TaggedFragmentPagerAdapter extends PagerAdapter
{
    ...
    private static final String TAG = "TaggedFragmentAdapter";
    ...
    public TaggedFragmentPagerAdapter(FragmentManager fragmentmanager)
    {
    ...
    public Object instantiateItem(ViewGroup viewgroup, int i)
    {
        ...
        {
            android.app.Fragment.SavedState savedstate = (android.app.Fragment.SavedState)mSavedState.get(i);
            if (savedstate != null)
            {
        ...
        String s = getFragmentTag(i);
        if (!TextUtils.isEmpty(s))
        {
            mCurTransaction.add(viewgroup.getId(), fragment1, s);
        } else
        {
    ...
    public void restoreState(Parcelable parcelable, ClassLoader classloader)
    {
        if (parcelable != null)
        {
            ...
            if (classloader != null)
            {
                ...
                {
                    mSavedState.add((android.app.Fragment.SavedState)classloader[i]);
                }
            ...
            do
            {
                ...
                if (s.startsWith("f"))
                {
                    ...
                    {
                        Log.w("TaggedFragmentAdapter", (new StringBuilder()).append("Bad fragment at key ").append(s).toString());
                    }
                }
            } while (true);
        }
    ...
    public Parcelable saveState()
    {
        ...
        {
            obj = new Bundle();
            android.app.Fragment.SavedState asavedstate[] = new android.app.Fragment.SavedState[mSavedState.size()];
