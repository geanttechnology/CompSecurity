...
_L1:
    ...
    public static com.google.android.gms.maps.internal.zzg zzco(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof com.google.android.gms.maps.internal.zzg))
        {
            return (com.google.android.gms.maps.internal.zzg)iinterface;
        } else
        {
        ...
        throws RemoteException
    {
        ...
        case 2: // '\002'
            parcel.enforceInterface("com.google.android.gms.maps.internal.IOnIndoorStateChangeListener");
            zza(com.google.android.gms.maps.model.internal.zzcN(parcel.readStrongBinder()));
            parcel1.writeNoException();
            return true;
        }
    }
