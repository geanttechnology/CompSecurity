...
//            InstallerPackageNameProvider, CommonUtils, AdvertisingInfoProvider, AdvertisingInfo, 
...
public class IdManager
{
    ...
    public String getAdvertisingId()
    {
        ...
        if (collectHardwareIds)
        {
            AdvertisingInfo advertisinginfo = (new AdvertisingInfoProvider(appContext)).getAdvertisingInfo();
            s = obj;
