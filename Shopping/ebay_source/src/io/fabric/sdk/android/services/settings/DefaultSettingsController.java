    ...
    implements SettingsController
{
        ...
        throws JSONException
    {
        ...
        if (!CommonUtils.isClsTrace(kit.getContext()))
        {
            jsonobject1 = settingsJsonTransform.sanitizeTraceInfo(jsonobject);
        }
        Fabric.getLogger().d("Fabric", (new StringBuilder()).append(s).append(jsonobject1.toString()).toString());
    }
