...
.method public final run()V
    ...
    .line 1601
    iget-object v6, p0, Landroid/support/v4/widget/j;->a:Landroid/support/v4/widget/i;

    iget-object v0, v6, Landroid/support/v4/widget/i;->b:Landroid/support/v4/widget/ah;

    iget v2, v0, Landroid/support/v4/widget/ah;->k:I

    iget v0, v6, Landroid/support/v4/widget/i;->a:I
    ...
    iget-object v0, v6, Landroid/support/v4/widget/i;->c:Landroid/support/v4/widget/DrawerLayout;
    ...
    iget-object v3, v6, Landroid/support/v4/widget/i;->b:Landroid/support/v4/widget/ah;

    invoke-virtual {v2}, Landroid/view/View;->getTop()I

    move-result v9

    invoke-virtual {v3, v2, v1, v9}, Landroid/support/v4/widget/ah;->a(Landroid/view/View;II)Z

    iput-boolean v8, v0, Landroid/support/v4/widget/g;->c:Z

    iget-object v0, v6, Landroid/support/v4/widget/i;->c:Landroid/support/v4/widget/DrawerLayout;

    invoke-virtual {v0}, Landroid/support/v4/widget/DrawerLayout;->invalidate()V

    invoke-virtual {v6}, Landroid/support/v4/widget/i;->b()V

    iget-object v9, v6, Landroid/support/v4/widget/i;->c:Landroid/support/v4/widget/DrawerLayout;
