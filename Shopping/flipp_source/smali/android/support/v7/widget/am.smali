...
.method public final a(I)Landroid/support/v7/widget/bi;
    ...
    .prologue
    .line 413
    iget-object v2, p0, Landroid/support/v7/widget/am;->a:Landroid/support/v7/widget/RecyclerView;
...
.method public final a(II)V
    ...
    iget v1, v0, Landroid/support/v7/widget/bf;->g:I

    add-int/2addr v1, p2

    iput v1, v0, Landroid/support/v7/widget/bf;->g:I
...
.method public final a(Landroid/support/v7/widget/c;)V
    ...
    .prologue
    .line 437
    invoke-direct {p0, p1}, Landroid/support/v7/widget/am;->c(Landroid/support/v7/widget/c;)V
...
.method public final c(II)V
    ...
    .line 431
    iget-object v3, p0, Landroid/support/v7/widget/am;->a:Landroid/support/v7/widget/RecyclerView;
    ...
    iget v7, v6, Landroid/support/v7/widget/bi;->b:I
    ...
    invoke-virtual {v6, v9}, Landroid/support/v7/widget/bi;->a(I)V
    ...
    invoke-virtual {v6, v7}, Landroid/support/v7/widget/bi;->a(I)V
    ...
    iput-boolean v8, v0, Landroid/support/v7/widget/av;->e:Z
    ...
    :cond_2
    iget-object v2, v3, Landroid/support/v7/widget/RecyclerView;->a:Landroid/support/v7/widget/az;
    ...
    invoke-virtual {v0, v9}, Landroid/support/v7/widget/bi;->a(I)V
...
.method public final d(II)V
    ...
    iget-object v4, v2, Landroid/support/v7/widget/RecyclerView;->m:Landroid/support/v7/widget/bf;

    iput-boolean v6, v4, Landroid/support/v7/widget/bf;->h:Z
    ...
    iget-object v1, v3, Landroid/support/v7/widget/az;->c:Ljava/util/ArrayList;
...
.method public final e(II)V
    ...
    .line 470
    iget-object v7, p0, Landroid/support/v7/widget/am;->a:Landroid/support/v7/widget/RecyclerView;
    ...
    :goto_2
    iget-object v9, v7, Landroid/support/v7/widget/RecyclerView;->m:Landroid/support/v7/widget/bf;

    iput-boolean v2, v9, Landroid/support/v7/widget/bf;->h:Z
    ...
    :goto_3
    iget-object v0, v8, Landroid/support/v7/widget/az;->c:Ljava/util/ArrayList;
