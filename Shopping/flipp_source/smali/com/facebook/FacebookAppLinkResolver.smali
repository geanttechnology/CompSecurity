...
.method static synthetic access$000(Lorg/json/JSONObject;)La/d;
    .locals 1

    .prologue
    .line 37
    invoke-static {p0}, Lcom/facebook/FacebookAppLinkResolver;->getAndroidTargetFromJson(Lorg/json/JSONObject;)La/d;
...
.method private static getAndroidTargetFromJson(Lorg/json/JSONObject;)La/d;
    .locals 5
    ...
    invoke-direct {v1, v2, v3, v0, v4}, La/d;-><init>(Ljava/lang/String;Ljava/lang/String;Landroid/net/Uri;Ljava/lang/String;)V
...
# virtual methods
.method public getAppLinkFromUrlInBackground(Landroid/net/Uri;)La/h;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 62
    invoke-virtual {p0, v0}, Lcom/facebook/FacebookAppLinkResolver;->getAppLinkFromUrlsInBackground(Ljava/util/List;)La/h;
    ...
    sget-object v2, La/h;->b:Ljava/util/concurrent/Executor;

    new-instance v3, La/m;

    invoke-direct {v3, v0, v1}, La/m;-><init>(La/h;La/g;)V

    invoke-virtual {v0, v3, v2}, La/h;->a(La/g;Ljava/util/concurrent/Executor;)La/h;
...
.method public getAppLinkFromUrlsInBackground(Ljava/util/List;)La/h;
    .locals 10
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 103
    invoke-static {v4}, La/h;->a(Ljava/lang/Object;)La/h;
    ...
    invoke-direct {v5, p0, v7, v4, v6}, Lcom/facebook/FacebookAppLinkResolver$2;-><init>(Lcom/facebook/FacebookAppLinkResolver;La/o;Ljava/util/Map;Ljava/util/HashSet;)V
