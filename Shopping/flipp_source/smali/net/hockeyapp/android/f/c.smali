.class public final Lnet/hockeyapp/android/f/c;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {p0, p1, v0}, Lnet/hockeyapp/android/f/c;-><init>(Landroid/content/Context;B)V
...
.method private constructor <init>(Landroid/content/Context;B)V
    ...
    invoke-direct {p0, p1, v0, v1}, Lnet/hockeyapp/android/f/c;-><init>(Landroid/content/Context;ZZ)V
...
.method public constructor <init>(Landroid/content/Context;ZZ)V
    ...
    iput-object v0, p0, Lnet/hockeyapp/android/f/c;->a:Landroid/widget/RelativeLayout;

    .line 63
    iput-boolean v7, p0, Lnet/hockeyapp/android/f/c;->b:Z

    .line 64
    iput-boolean v7, p0, Lnet/hockeyapp/android/f/c;->c:Z

    .line 81
    if-eqz p2, :cond_0

    .line 82
    invoke-direct {p0, p1}, Lnet/hockeyapp/android/f/c;->setLayoutHorizontally(Landroid/content/Context;)V

    .line 87
    :goto_0
    iput-boolean p3, p0, Lnet/hockeyapp/android/f/c;->c:Z
    ...
    invoke-virtual {p0, v1}, Lnet/hockeyapp/android/f/c;->setBackgroundColor(I)V

    invoke-virtual {p0, v0}, Lnet/hockeyapp/android/f/c;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V
    ...
    iget-object v0, p0, Lnet/hockeyapp/android/f/c;->a:Landroid/widget/RelativeLayout;

    const/16 v2, 0x1001

    invoke-virtual {v0, v2}, Landroid/widget/RelativeLayout;->setId(I)V

    iget-boolean v0, p0, Lnet/hockeyapp/android/f/c;->b:Z
    ...
    invoke-virtual {p0}, Lnet/hockeyapp/android/f/c;->getResources()Landroid/content/res/Resources;
    ...
    iget-object v2, p0, Lnet/hockeyapp/android/f/c;->a:Landroid/widget/RelativeLayout;
    ...
    invoke-direct {p0}, Lnet/hockeyapp/android/f/c;->getButtonSelector()Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, v0}, Lnet/hockeyapp/android/f/c;->addView(Landroid/view/View;)V
    ...
    iget-boolean v4, p0, Lnet/hockeyapp/android/f/c;->c:Z
    ...
    invoke-virtual {p0, v2}, Lnet/hockeyapp/android/f/c;->addView(Landroid/view/View;)V
    ...
    iget-boolean v3, p0, Lnet/hockeyapp/android/f/c;->b:Z
    ...
    invoke-static {}, Lnet/hockeyapp/android/e/k;->a()Landroid/graphics/drawable/Drawable;
...
.method private setLayoutHorizontally(Landroid/content/Context;)V
    ...
    iput-boolean v0, p0, Lnet/hockeyapp/android/f/c;->b:Z
