...
public final class m
{
    ...
    {
        a = context;
        e = new n(this, context.getMainLooper());
    }
...
_L2:
        ...
        {
            obj = ao[i];
            for (int j = 0; j < ((o) (obj)).b.size(); j++)
            {
                ((p)((o) (obj)).b.get(j)).b.onReceive(m1.a, ((o) (obj)).a);
            }
...
_L7:
        if (((p)arraylist1.get(i)).b != broadcastreceiver) goto _L10; else goto _L9
_L9:
        arraylist1.remove(i);
        i--;
          goto _L10
...
_L14:
    ...
    public final void a(BroadcastReceiver broadcastreceiver, IntentFilter intentfilter)
    {
        ...
        Object obj;
        p p1;
        p1 = new p(intentfilter, broadcastreceiver);
...
_L5:
        obj = (p)arraylist1.get(j);
        if (i == 0)
        {
            break MISSING_BLOCK_LABEL_209;
        }
        Log.v("LocalBroadcastManager", (new StringBuilder("Matching against filter ")).append(((p) (obj)).a).toString());
        if (!((p) (obj)).c) goto _L8; else goto _L7
_L7:
...
_L9:
        Log.v("LocalBroadcastManager", "  Filter's target already added");
          goto _L10
_L8:
        k = ((p) (obj)).a.match(s, s1, s2, uri, set, "LocalBroadcastManager");
...
_L19:
        ...
        ((p)arraylist.get(i)).c = false;
        i++;
          goto _L19
        d.add(new o(intent, arraylist));
        if (!e.hasMessages(1))
        {
