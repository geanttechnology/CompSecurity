...
public final class SlidingPaneLayout extends ViewGroup
{
    ...
    private void a(View view, float f1, int i1)
    {
        ...
        if (f1 > 0.0F && i1 != 0)
        {
            ...
            aa1.d.setColorFilter(new PorterDuffColorFilter(j1 << 24 | 0xffffff & i1, android.graphics.PorterDuff.Mode.SRC_OVER));
            if (ap.g(view) != 2)
            {
                ap.a(view, 2, aa1.d);
            }
        ...
        if (ap.g(view) != 0)
        {
            if (aa1.d != null)
            {
                aa1.d.setColorFilter(null);
            }
            view = new android.support.v4.widget.z(this, view);
            u.add(view);
            ap.a(this, view);
            return;
        }
    ...
    private boolean a(float f1)
    {
        ...
        boolean flag = b();
        Object obj = (aa)h.getLayoutParams();
        int i1;
        if (flag)
        {
            i1 = getPaddingRight();
            int j1 = ((aa) (obj)).rightMargin;
            int l1 = h.getWidth();
            i1 = (int)((float)getWidth() - ((float)(j1 + i1) + (float)k * f1 + (float)l1));
        } else
        {
            i1 = getPaddingLeft();
            i1 = (int)((float)(((aa) (obj)).leftMargin + i1) + (float)k * f1);
        }
    ...
    private boolean b(View view)
    {
        ...
        view = (aa)view.getLayoutParams();
        return g && ((aa) (view)).c && i > 0.0F;
    }
...
_L1:
        if (!aa1.c || i <= 0.0F) goto _L4; else goto _L3
_L3:
...
_L5:
        canvas.drawBitmap(bitmap, view.getLeft(), view.getTop(), aa1.d);
        flag = false;
_L7:
...
_L4:
    ...
    protected final android.view.ViewGroup.LayoutParams generateLayoutParams(android.view.ViewGroup.LayoutParams layoutparams)
    {
        ...
        {
            return new aa((android.view.ViewGroup.MarginLayoutParams)layoutparams);
        } else
        {
    ...
    protected final void onDetachedFromWindow()
    {
        ...
        {
            ((android.support.v4.widget.z)u.get(i1)).run();
        }
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionevent)
    {
        ...
        if (!g && i1 == 0 && getChildCount() > 1)
        {
            ...
            if (view != null)
            {
                if (!ah.b(view, (int)motionevent.getX(), (int)motionevent.getY()))
                {
                    flag = true;
                } else
                {
...
_L4:
        ...
        n = f1;
        o = f3;
        if (!ah.b(h, (int)f1, (int)f3) || !b(h)) goto _L3; else goto _L8
_L8:
        i1 = 1;
          goto _L9
_L5:
...
_L1:
        ...
        if (flag)
        {
            i1 = ((aa) (obj)).rightMargin;
        } else
        {
            i1 = ((aa) (obj)).leftMargin;
        }
        if (i1 > 0)
        {
            break MISSING_BLOCK_LABEL_641;
...
_L13:
        float f2 = f1;
        if (aa1.a <= 0.0F) goto _L17; else goto _L16
_L16:
        f2 = f1 + aa1.a;
        if (aa1.width == 0) goto _L18; else goto _L17
_L17:
        int i3 = aa1.leftMargin + aa1.rightMargin;
        int l3;
        int j5;
        boolean flag1;
        if (aa1.width == -2)
        ...
        {
            i3 = android.view.View.MeasureSpec.makeMeasureSpec(aa1.width, 0x40000000);
        }
        if (aa1.height == -2)
        {
        ...
        {
            l3 = android.view.View.MeasureSpec.makeMeasureSpec(aa1.height, 0x40000000);
        }
        view.measure(i3, l3);
        ...
        if (flag || f1 > 0.0F)
        {
            ...
            while (j3 < i5) 
            {
                ...
                if (view1.getVisibility() != 8)
                {
                    ...
                    if (flag && view1 != h)
                    {
                        if (aa2.width < 0 && (i4 > k4 || aa2.a > 0.0F))
                        {
                            if (k1 != 0)
                            {
                                if (aa2.height == -2)
                                ...
                                {
                                    k1 = android.view.View.MeasureSpec.makeMeasureSpec(aa2.height, 0x40000000);
                                }
                            } else
                            {
                    ...
                    if (aa2.a > 0.0F)
                    {
                        ...
                        if (flag)
                        {
                            int k5 = aa2.leftMargin;
                            k5 = l4 - (aa2.rightMargin + k5);
                        ...
                        } else
                        {
                            ...
                            view1.measure(android.view.View.MeasureSpec.makeMeasureSpec((int)((aa2.a * (float)l5) / f1) + i4, 0x40000000), k1);
                        }
                    }
                }
                j3++;
...
_L3:
        if (b(h))
        {
            ...
            float f6 = f4 - o;
            int i1 = q.b;
            if (f5 * f5 + f6 * f6 < (float)(i1 * i1) && ah.b(h, (int)f2, (int)f4))
            {
                a();
            }
        }
...
_L4:
    ...
    public final void setPanelSlideListener(ab ab)
    {
        p = ab;
    }
