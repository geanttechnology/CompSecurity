...
final class p
{
    ...
    private static final p n[] = new p[64];
    ...
    private p(Locale locale)
    {
        ...
        DateFormatSymbols dateformatsymbols = b.a.a.f.a(locale);
    ...
    public static p a(Locale locale)
    {
        ...
        locale = n[i1];
        if (locale != null && ((p) (locale)).p.get() == locale1)
        {
            return locale;
        }
        ...
        p p1 = (p)o.get(locale1);
        locale = p1;
        if (p1 != null)
        {
            break MISSING_BLOCK_LABEL_84;
        }
        locale = new p(locale1);
