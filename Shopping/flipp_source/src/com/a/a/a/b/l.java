    ...
    implements aa
{
    ...
    public final b a(InputStream inputstream, boolean flag)
    {
        return new m(inputstream, flag);
    }

    public final d a(OutputStream outputstream, boolean flag)
    {
        return new p(outputstream, flag);
    }
