...
public class AppEventsLogger
{
    ...
    public static void activateApp(final Context logger, final String sourceApplicationInfo)
    {
        ...
        Settings.publishInstallAsync(logger, sourceApplicationInfo, null);
    ...
    {
        Settings.getExecutor().execute(new _cls6());
    }
...
label0:
        ...
        if (flushreason != null)
        {
            ...
            m.a(applicationContext).a(((Intent) (obj)));
            return;
        } else
        {
            return;
...
label0:
    ...
    {
        Settings.getExecutor().execute(new _cls5());
    }
