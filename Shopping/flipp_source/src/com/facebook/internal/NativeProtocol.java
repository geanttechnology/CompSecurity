...
_L3:
    ...
    private static TreeSet getAllAvailableProtocolVersionsForAppInfo(Context context, NativeAppInfo nativeappinfo)
    {
        ...
        context = context.query(nativeappinfo, new String[] {
            "version"
        }, null, null, null);
        if (context == null) goto _L2; else goto _L1
_L1:
        for (; context.moveToNext(); ((TreeSet) (obj)).add(Integer.valueOf(context.getInt(context.getColumnIndex("version"))))) { }
          goto _L2
        obj;
        nativeappinfo = context;
        context = ((Context) (obj));
_L4:
...
_L3:
    ...
    private static int getLatestAvailableProtocolVersionForAppInfoList(Context context, List list, int ai[])
    {
        ...
        {
            int i = getLatestAvailableProtocolVersionForAppInfo(context, (NativeAppInfo)list.next(), ai);
            if (i != -1)
            {
                return i;
            }
    ...
    private class MessengerAppInfo extends NativeAppInfo
    {
        private class NativeAppInfo
        {
...
_L3:
    ...
    private class WakizashiAppInfo extends NativeAppInfo
    {
    ...
    private class KatanaAppInfo extends NativeAppInfo
    {
