...
public class LikeView extends FrameLayout
{
    ...
    private void associateWithLikeActionController(LikeActionController likeactioncontroller)
    {
        ...
        likeactioncontroller = m.a(getContext());
    ...
    private void tearDownObjectAssociations()
    {
        ...
        {
            m.a(getContext()).a(broadcastReceiver);
...
_L2:
        ...
        likeboxcountview = likeBoxCountView;
        likeboxcountviewcaretposition = com.facebook.internal.LikeBoxCountView.LikeBoxCountViewCaretPosition.BOTTOM;
_L6:
        likeboxcountview.setCaretPosition(likeboxcountviewcaretposition);
        return;
_L3:
        likeboxcountview = likeBoxCountView;
        likeboxcountviewcaretposition = com.facebook.internal.LikeBoxCountView.LikeBoxCountViewCaretPosition.TOP;
