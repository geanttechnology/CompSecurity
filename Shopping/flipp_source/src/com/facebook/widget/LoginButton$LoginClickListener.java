...
_L1:
        ...
        if (LoginButton.access$700(LoginButton.this))
        {
            ...
            ((android.app.ook) (obj2)).ook(((CharSequence) (obj))).le(true).Button(((CharSequence) (obj1)), new _cls1()).Button(s, null);
...
label0:
        {
            session = LoginButton.access$400(LoginButton.this).getSession();
            if (session != null)
            {
                session1 = session;
