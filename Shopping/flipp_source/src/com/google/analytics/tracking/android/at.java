...
final class at extends SQLiteOpenHelper
{
    ...
    at(ar ar1, Context context, String s)
    {
        a = ar1;
    ...
    private static boolean a(String s, SQLiteDatabase sqlitedatabase)
    {
        ...
        sqlitedatabase = null;
_L4:
        an.d((new StringBuilder("Error querying for table ")).append(s).toString());
        if (sqlitedatabase != null)
        {
            sqlitedatabase.close();
        }
...
_L2:
        ...
        SQLiteException sqliteexception;
        sqliteexception;
        ar.c(a).getDatabasePath(ar.b(a)).delete();
        if (true) goto _L2; else goto _L1
_L1:
    }
