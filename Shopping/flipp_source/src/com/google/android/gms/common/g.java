...
public final class g
{
    ...
    public static int a(Context context)
    {
        ...
        if (context != null)
        {
            ...
            if (i1 != 0x40ba50)
            {
                throw new IllegalStateException((new StringBuilder("The meta-data tag in your app's AndroidManifest.xml does not have the right value.  Expected 4242000 but found ")).append(i1).append(".  You must have the following declaration within the <application> element:     <meta-data android:name=\"com.google.android.gms.version\" android:value=\"@integer/google_play_services_version\" />").toString());
            }
        } else
        {
    ...
    context
        ...
        {
            Log.w("GooglePlayServicesUtil", (new StringBuilder("Google Play services out of date.  Requires 4242000 but found ")).append(packageinfo.versionCode).toString());
            return 2;
        }
        try
        {
    ...
    public static Dialog a(int i1, Activity activity)
    {
        Object obj;
        Object obj1;
        boolean flag2;
        flag2 = true;
        obj1 = new android.app.AlertDialog.Builder(activity);
        obj = activity.getResources();
        i1;
        JVM INSTR tableswitch 1 12: default 80
    //                   1 251
    //                   2 409
    //                   3 398
    //                   4 80
...
_L1:
        obj = ((Resources) (obj)).getString(b.common_google_play_services_unknown_issue);
_L16:
        obj = ((android.app.AlertDialog.Builder) (obj1)).setMessage(((CharSequence) (obj)));
        obj1 = new fv(activity, a(i1));
...
_L9:
        activity = activity.getString(0x104000a);
        break; /* Loop/switch isn't completed */
_L2:
label0:
        {
            Object obj2 = activity.getResources();
            if (obj2 == null)
            {
                break MISSING_BLOCK_LABEL_381;
            }
            boolean flag;
            if ((((Resources) (obj2)).getConfiguration().screenLayout & 0xf) > 3)
            {
                flag = true;
            } else
            {
            ...
            obj2 = ((Resources) (obj2)).getConfiguration();
            if (hx.a(13))
            {
                if ((((Configuration) (obj2)).screenLayout & 0xf) <= 3 && ((Configuration) (obj2)).smallestScreenWidthDp >= 600)
                {
                    flag = true;
                } else
                {
...
_L13:
        if (flag1)
        {
            obj = ((Resources) (obj)).getString(b.common_google_play_services_install_text_tablet);
        } else
        {
            obj = ((Resources) (obj)).getString(b.common_google_play_services_install_text_phone);
        }
        continue; /* Loop/switch isn't completed */
        flag1 = false;
          goto _L13
_L4:
        obj = ((Resources) (obj)).getString(b.common_google_play_services_enable_text);
        continue; /* Loop/switch isn't completed */
_L3:
        obj = ((Resources) (obj)).getString(b.common_google_play_services_update_text);
        continue; /* Loop/switch isn't completed */
_L7:
        obj = ((Resources) (obj)).getString(b.common_google_play_services_unsupported_text);
        continue; /* Loop/switch isn't completed */
_L6:
        obj = ((Resources) (obj)).getString(b.common_google_play_services_network_error_text);
        continue; /* Loop/switch isn't completed */
_L5:
        obj = ((Resources) (obj)).getString(b.common_google_play_services_invalid_account_text);
        continue; /* Loop/switch isn't completed */
_L8:
        obj = ((Resources) (obj)).getString(b.common_google_play_services_unsupported_date_text);
        continue; /* Loop/switch isn't completed */
_L10:
        activity = activity.getString(b.common_google_play_services_install_button);
          goto _L14
_L12:
        activity = activity.getString(b.common_google_play_services_enable_button);
          goto _L14
_L11:
        activity = activity.getString(b.common_google_play_services_update_button);
_L14:
        if (activity != null)
        {
            ((android.app.AlertDialog.Builder) (obj)).setPositiveButton(activity, ((android.content.DialogInterface.OnClickListener) (obj1)));
        }
        boolean flag1;
        switch (i1)
        {
        ...
        case 1: // '\001'
            return ((android.app.AlertDialog.Builder) (obj)).setTitle(b.common_google_play_services_install_title).create();

        case 3: // '\003'
            return ((android.app.AlertDialog.Builder) (obj)).setTitle(b.common_google_play_services_enable_title).create();

        case 2: // '\002'
            return ((android.app.AlertDialog.Builder) (obj)).setTitle(b.common_google_play_services_update_title).create();

        case 9: // '\t'
            Log.e("GooglePlayServicesUtil", "Google Play services is invalid. Cannot recover.");
            return ((android.app.AlertDialog.Builder) (obj)).setTitle(b.common_google_play_services_unsupported_title).create();

        case 7: // '\007'
            Log.e("GooglePlayServicesUtil", "Network error occurred. Please retry request later.");
            return ((android.app.AlertDialog.Builder) (obj)).setTitle(b.common_google_play_services_network_error_title).create();
        ...
        case 5: // '\005'
            ...
            return ((android.app.AlertDialog.Builder) (obj)).setTitle(b.common_google_play_services_invalid_account_title).create();
...
_L15:
    ...
    private static Intent a(int i1)
    {
        switch (i1)
        {
        default:
        ...
        case 1: // '\001'
        case 2: // '\002'
            return gl.b("com.google.android.gms");

        case 3: // '\003'
            return gl.a("com.google.android.gms");
    ...
    public static void b(Context context)
    {
        ...
        if (i1 != 0)
        {
            ...
            {
                throw new f(i1, "Google Play Services not available", context);
            }
        } else
        {
            return;
