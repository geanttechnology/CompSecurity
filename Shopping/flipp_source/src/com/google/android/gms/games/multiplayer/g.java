    ...
    implements android.os.Parcelable.Creator
{
    ...
    static void a(InvitationEntity invitationentity, Parcel parcel, int i)
    {
        ...
        c.b(parcel, 1000, invitationentity.a);
        c.a(parcel, 2, invitationentity.c, false);
        c.a(parcel, 3, invitationentity.d);
        c.b(parcel, 4, invitationentity.e);
        c.a(parcel, 5, invitationentity.f, i, false);
        c.b(parcel, 6, invitationentity.i(), false);
        c.b(parcel, 7, invitationentity.g);
        c.b(parcel, 8, invitationentity.h);
        c.b(parcel, j);
    }
