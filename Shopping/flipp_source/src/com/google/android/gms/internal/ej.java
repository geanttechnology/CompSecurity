...
_L3:
    ...
    {
        for (list = list.iterator(); list.hasNext(); eg.a(((ee) (new eq(context, s, (String)list.next()))).e)) { }
    }
    ...
    public static boolean a(Context context)
    {
        ...
        {
            et.d("Could not find com.google.android.gms.ads.AdActivity, please make sure it is declared in AndroidManifest.xml.");
            return false;
        }
        boolean flag;
        if ((((ResolveInfo) (context)).activityInfo.configChanges & 0x10) == 0)
        {
            et.d(String.format("com.google.android.gms.ads.AdActivity requires the android:configChanges value to contain \"%s\".", new Object[] {
                "keyboard"
            }));
            flag = false;
        } else
    ...
    public static void b(Context context)
    {
        ...
        } else
        {
            ...
            context.getApplicationContext().registerReceiver(new em((byte)0), intentfilter);
            d = true;
            return;
        }
    }
