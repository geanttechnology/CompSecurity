...
_L1:
    ...
    private static void a(ViewGroup viewgroup, x x1, String s, int i, int j)
    {
        ...
        } else
        {
            ...
            i = a(context, 3);
            s.addView(textview, new android.widget.FrameLayout.LayoutParams(x1.g - i, x1.d - i, 17));
            viewgroup.addView(s, x1.g, x1.d);
            return;
        }
    }

    public static void a(ViewGroup viewgroup, x x1, String s, String s1)
    {
        et.d(s1);
