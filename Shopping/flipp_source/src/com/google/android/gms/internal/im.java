...
public abstract class im extends Binder
    implements il
{

    public static il a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof il))
        {
            return (il)iinterface;
        } else
        {
            return new in(ibinder);
        }
    }
