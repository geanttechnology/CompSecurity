    ...
    implements android.os.Parcelable.Creator
{
    ...
    static void a(ig.f f, Parcel parcel)
    {
        ...
        {
            c.a(parcel, 2, f.c, true);
        }
        if (set.contains(Integer.valueOf(3)))
        {
            c.a(parcel, 3, f.d, true);
        }
        if (set.contains(Integer.valueOf(4)))
        {
            c.a(parcel, 4, f.e, true);
        }
        if (set.contains(Integer.valueOf(5)))
        {
            c.a(parcel, 5, f.f, true);
        }
        if (set.contains(Integer.valueOf(6)))
        {
            c.a(parcel, 6, f.g, true);
        }
        ...
        {
            c.a(parcel, 8, f.i, true);
        }
        if (set.contains(Integer.valueOf(9)))
        {
            c.a(parcel, 9, f.j, true);
        }
    ...
    public final Object createFromParcel(Parcel parcel)
    {
        ...
        do
        {
            ...
            } else
            {
                ...
                return new ig.f(hashset, j, s6, s5, s4, s3, s2, flag, s1, s, i);
            }
        } while (true);
    }
