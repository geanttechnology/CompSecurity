...
public final class kh
{
    ...
    public static String a(kf kf1)
    {
        ...
        try
        {
            a(null, kf1, new StringBuffer(), stringbuffer);
        }
        // Misplaced declaration of an exception variable
        catch (kf kf1)
        {
            return (new StringBuilder("Error printing proto: ")).append(kf1.getMessage()).toString();
        }
        // Misplaced declaration of an exception variable
        catch (kf kf1)
        {
...
_L1:
        if (!(obj instanceof kf)) goto _L4; else goto _L3
_L3:
        Class class1;
        Object aobj[];
        int j;
        ...
        for (int i = 0; i < l1; i++)
        {
            ...
            if ((k & 1) != 1 || (k & 8) == 8 || s1.startsWith("_") || s1.endsWith("_"))
            {
                continue;
            }
