...
final class Constants
{
    ...
    static String BLACKOUT_RULES_KEY = "blackout_rules";
    static String CAMPAIGN_ID_KEY = "campaign_id";
    ...
    static String DATES_KEY = "dates";
    static String DAYS_KEY = "days";
    ...
    static String DISPLAY_FREQUENCIES_KEY = "display_frequencies";
    static String END_KEY = "end";
    static final String EVENT_FORMAT = "%s:%s";
    static String FREQUENCY_CAPPING_KEY = "frequency_capping";
    ...
    static String MAX_DISPLAY_COUNT_KEY = "max_display_count";
    ...
    static String WEEKDAYS_KEY = "weekdays";
    static final String WIDTH_KEY = "width";
    static long dbMaxSizeForAnalytics = (long)Math.pow(2D, 24D);
    static long dbMaxSizeForProfiles = (long)Math.pow(2D, 20D);
