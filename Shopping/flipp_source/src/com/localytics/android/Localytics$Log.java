...
final class 
{
    ...
    static int d(String s, Throwable throwable)
    {
        if (Constants.IS_LOGGING_ENABLED)
        {
            return Log.d("Localytics", s, throwable);
        } else
        {
            return -1;
        }
    ...
    static int e(String s, Throwable throwable)
    {
        if (Constants.IS_LOGGING_ENABLED)
        {
            return Log.e("Localytics", s, throwable);
        } else
        {
            return -1;
        }
    ...
    static int i(String s, Throwable throwable)
    {
        if (Constants.IS_LOGGING_ENABLED)
        {
            return Log.i("Localytics", s, throwable);
        } else
        {
            return -1;
        }
    ...
    static int v(String s, Throwable throwable)
    {
        if (Constants.IS_LOGGING_ENABLED)
        {
            return Log.v("Localytics", s, throwable);
        } else
        {
            return -1;
        }
    ...
    static int w(String s, Throwable throwable)
    {
        if (Constants.IS_LOGGING_ENABLED)
        {
            return Log.w("Localytics", s, throwable);
        } else
        {
            return -1;
        }
    ...
    static int w(Throwable throwable)
    {
        if (Constants.IS_LOGGING_ENABLED)
        {
            return Log.w("Localytics", throwable);
        } else
        {
            return -1;
        }
    ...
    static int wtf(String s, Throwable throwable)
    {
        if (Constants.IS_LOGGING_ENABLED)
        {
            return Log.wtf("Localytics", s, throwable);
        } else
        {
            return -1;
        }
    ...
    static int wtf(Throwable throwable)
    {
        if (Constants.IS_LOGGING_ENABLED)
        {
            return Log.wtf("Localytics", throwable);
        } else
        {
            return -1;
        }
