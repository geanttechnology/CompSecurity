...
public class Localytics
{
    ...
    public static void setInAppMessageDisplayActivity(ac ac)
    {
        LocalyticsManager.getInstance().setInAppMessageDisplayActivity(ac);
    }
    ...
    private class ProfileScope extends Enum
    {
