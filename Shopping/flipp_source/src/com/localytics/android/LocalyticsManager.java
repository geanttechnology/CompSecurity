...
//            Constants, AnalyticsListener, MessagingListener
...
_L3:
        if (!aactivityinfo[i].name.equalsIgnoreCase(s)) goto _L5; else goto _L4
_L4:
        flag = true;
_L2:
        return flag;
...
_L6:
    ...
    public final void integrate(Context context, String s)
    {
        this;
        JVM INSTR monitorenter ;
        HandlerWrapper handlerwrapper = mHandlerWrapper;
        if (handlerwrapper == null) goto _L2; else goto _L1
_L1:
        this;
        JVM INSTR monitorexit ;
        return;
_L2:
        ...
        JVM INSTR monitorexit ;
        throw context;
        boolean flag = context.getClass().getName().equals("android.test.RenamingDelegatingContext");
...
_L4:
    ...
    public final void setInAppMessageDisplayActivity(ac ac1)
    {
        if (ac1 == null)
        {
            throw new IllegalArgumentException("attached activity cannot be null");
        }
        getMarketingHandler().setFragmentManager(ac1.getSupportFragmentManager());
    ...
    {
        getMarketingHandler().displayMarketingMessage(s, map, flag);
    }
    ...
    private class LocalyticsNotInitializedException extends RuntimeException
    {
