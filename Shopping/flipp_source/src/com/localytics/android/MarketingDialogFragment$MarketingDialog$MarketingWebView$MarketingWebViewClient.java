...
//            MarketingDialogFragment, MarketingMessage, JavaScriptClient
...
final class mActivity extends WebViewClient
{
    ...
    public final void onPageFinished(WebView webview, String s)
    {
        ...
        int j;
        int k;
        if (((String)MarketingDialogFragment.access$200(this._cls2.this.mActivity.mActivity).get("location")).equals("center"))
        {
        ...
        webview.loadUrl(MarketingDialogFragment.access$1100(_fld2).getJsGlueCode());
        this._mth2(_fld2).setVisibility(0);
        if (MarketingDialogFragment.access$1500(_fld2).getAndSet(false))
        {
            _mth2();
        }
    }
