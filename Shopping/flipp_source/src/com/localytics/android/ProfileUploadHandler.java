...
_L2:
        ...
        aobj = (Object[])(Object[])((java.util.Map.Entry)iterator.next()).getValue();
        String s1 = s;
        if (stringbuilder.length() == 0)
        {
            s1 = (String)aobj[0];
            stringbuilder.append('{').append('"').append("customer_id\":\"").append(s1).append('"').append(',').append('"').append("database\":\"").append((String)aobj[1]).append('"').append(',').append('"').append("changes\":[");
        }
