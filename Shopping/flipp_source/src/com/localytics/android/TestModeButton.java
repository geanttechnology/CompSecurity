...
public final class TestModeButton extends y
{
        ...
        private void setupViews()
        {
            ...
            class Button extends View
            {
                ...
                Button(Context context, AttributeSet attributeset)
                {
                    ...
                    setLayoutParams(new android.widget.RelativeLayout.LayoutParams((int)(65F * f + 0.5F), (int)(f * 60F + 0.5F)));
                    mPaint.setColor(BACKGROUND_COLOR);
                ...
                implements android.view.View.OnClickListener
            {
                ...
                public void onClick(View view)
                {
                    ...
                    if (mCallbacks != null)
                    {
                        view = (MarketingCallable)mCallbacks.get(Integer.valueOf(9));
                        if (view != null)
                        {
                            view.call(null);
                        }
