...
_L2:
                if (j == 1)
                {
                    ...
                    {
                        adapterview = (MarketingCallable)TestModeListView.access$200(this$0).get(Integer.valueOf(12));
                        if (adapterview != null)
                        {
                ...
                if (j == 2)
                {
                    if (TestModeListView.access$200(this$0) != null)
                    {
                        adapterview = (MarketingCallable)TestModeListView.access$200(this$0).get(Integer.valueOf(13));
                        if (adapterview != null)
                        {
                            adapterview.call(null);
                        }
                ...
                {
                    adapterview = (MarketingCallable)TestModeListView.access$200(this$0).get(Integer.valueOf(14));
                    if (adapterview != null)
                    {
                        adapterview.call(null);
                    }
