...
//            TestModeListView, MarketingCallable
...
final class adjustLayout extends Dialog
{
    ...
    private void setupViews()
    {
            ...
            implements android.view.View.OnClickListener
        {
            ...
            public void onClick(View view)
            {
                ...
                {
                    view = (MarketingCallable)TestModeListView.access$200(this$0).get(Integer.valueOf(10));
                    if (view != null)
                    {
                        view.call(null);
                    }
            ...
            implements android.widget.AdapterView.OnItemClickListener
        {
            ...
            public void onItemClick(AdapterView adapterview, View view, int l, long l1)
            {
                if (TestModeListView.access$200(this$0) != null)
                {
                    view = (MarketingCallable)TestModeListView.access$200(this$0).get(Integer.valueOf(11));
                    if (view != null)
                    {
    ...
    public final boolean onKeyDown(int i, KeyEvent keyevent)
    {
        if (i == 4)
        {
            ...
            {
                MarketingCallable marketingcallable = (MarketingCallable)TestModeListView.access$200(TestModeListView.this).get(Integer.valueOf(10));
