...
final class TestModeListView extends y
{
    ...
    public final void show(ah ah, String s)
    {
    ...
    private class TestModeDialog extends Dialog
    {
        ...
        private void setupViews()
        {
            ...
            relativelayout.setPadding((int)(8F * f + 0.5F), (int)(12F * f + 0.5F), (int)(8F * f + 0.5F), (int)(f * 12F + 0.5F));
                ...
                implements android.view.View.OnClickListener
            {
                ...
                public void onClick(View view)
                {
                    ...
                    if (mCallbacks != null)
                    {
                        view = (MarketingCallable)mCallbacks.get(Integer.valueOf(10));
                        if (view != null)
                        {
                            view.call(null);
                        }
...
_L2:
                                if (j == 1)
                                {
                                    if (mCallbacks != null)
                                    {
                                        adapterview = (MarketingCallable)mCallbacks.get(Integer.valueOf(12));
                                        if (adapterview != null)
                                        {
                                ...
                                if (j == 2)
                                {
                                    if (mCallbacks != null)
                                    {
                                        adapterview = (MarketingCallable)mCallbacks.get(Integer.valueOf(13));
                                        if (adapterview != null)
                                        {
                                            adapterview.call(null);
                                        }
                                ...
                                {
                                    adapterview = (MarketingCallable)mCallbacks.get(Integer.valueOf(14));
                                    if (adapterview != null)
                                    {
                                        adapterview.call(null);
                                    }
...
_L3:
                    ...
                    private class CancelItemAdapter extends BaseAdapter
                    {
                ...
                implements android.widget.AdapterView.OnItemClickListener
            {
                ...
                public void onItemClick(AdapterView adapterview, View view, int l, long l1)
                {
                    if (mCallbacks != null)
                    {
                        view = (MarketingCallable)mCallbacks.get(Integer.valueOf(11));
                        if (view != null)
                        {
        ...
        public final boolean onKeyDown(int i, KeyEvent keyevent)
        {
            if (i == 4)
            {
                ...
                if (mCallbacks != null)
                {
                    MarketingCallable marketingcallable = (MarketingCallable)mCallbacks.get(Integer.valueOf(10));
