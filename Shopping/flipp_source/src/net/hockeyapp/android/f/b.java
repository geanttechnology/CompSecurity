...
public final class b extends LinearLayout
{
    ...
    public b(Context context)
    {
        ...
        ((Button) (obj)).setBackgroundDrawable(getButtonSelector());
        ((Button) (obj)).setPadding(j, i, j, i);
        ((Button) (obj)).setText("Send feedback");
        ...
        ((TextView) (obj)).setText("Last Updated: ");
        ...
        ((Button) (obj)).setText("Add a Response");
        ((Button) (obj)).setTextColor(-1);
        ((Button) (obj)).setTextSize(2, 15F);
