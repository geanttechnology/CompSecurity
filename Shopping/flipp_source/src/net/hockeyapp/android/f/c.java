...
public final class c extends RelativeLayout
{
    ...
    public c(Context context, boolean flag, boolean flag1)
    {
        super(context);
        a = null;
        b = false;
        ...
        ((Button) (obj1)).setBackgroundDrawable(getButtonSelector());
        ...
        } else
        {
            ...
            ((ImageView) (obj2)).setBackgroundDrawable(k.a());
        }
        ...
        context.setBackgroundDrawable(k.a());
        addView(context);
    }
