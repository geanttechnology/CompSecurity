...
class er extends AnimatorListenerAdapter
{
    ...
    public void onAnimationEnd(Animator animator)
    {
        ...
        if (val$view == BoldChatViewManager.access$400(BoldChatViewManager.this) && ((Integer)BoldChatViewManager.access$300(BoldChatViewManager.this).get(val$view)).intValue() == 8)
        {
            BoldChatViewManager.access$400(BoldChatViewManager.this).removeAllViews();
        }
    }
