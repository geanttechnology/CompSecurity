...
_L4:
        ...
        if (!h.a(ay1.c).exists() && ay1.w.isOptmzEnabled()) goto _L6; else goto _L5
_L5:
        ...
        {
            Thread.setDefaultUncaughtExceptionHandler(new ax(ay1, context));
        }
        (new dh(ay1.o)).start();
        ay1.b = true;
        ...
        dg.b();
          goto _L3
_L6:
        ay1.x.a(ay1.w.getOptmzBlackListURLPatterns());
        ay1.x.b(ay1.w.getPreserveQueryStringPatterns());
        s = new d(ay1.c);
        s = new i(ay1.x, s);
        ay1.p = new g(ay1, new URL((new StringBuilder()).append(ay1.w.b()).append("/api/apm/network").toString()));
        ay1.x.a(ay1.p);
        ay1.x.a(ay1);
...
_L7:
    ...
    public static void setUsername(String s)
    {
        ...
        return;
        s;
        dg.b("Crittercism", "Crittercism.setUsername()", s);
        return;
    }
}
