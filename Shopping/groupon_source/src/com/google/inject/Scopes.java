...
_L2:
    ...
    public static boolean isScoped(Binding binding, Scope scope, Class class1)
    {
        do
        {
            if (((Boolean)binding.acceptScopingVisitor(new BindingScopingVisitor(class1, scope) {

        final Scope val$scope;
        final Class val$scopeAnnotation;
        ...
        public Boolean visitScope(Scope scope1)
        {
            boolean flag;
            if (scope1 == scope)
            {
        ...
        public volatile Object visitScope(Scope scope1)
        {
            return visitScope(scope1);
        }

        public Boolean visitScopeAnnotation(Class class2)
        {
            boolean flag;
            if (class2 == scopeAnnotation)
            {
                flag = true;
            } else
            {
        ...
        public volatile Object visitScopeAnnotation(Class class2)
        {
            return visitScopeAnnotation(class2);
        }
    ...
    public static boolean isSingleton(Binding binding)
    {
        do
        {
            if (((Boolean)binding.acceptScopingVisitor(IS_SINGLETON_VISITOR)).booleanValue())
            {
                return true;
            }
            if (binding instanceof LinkedBindingImpl)
