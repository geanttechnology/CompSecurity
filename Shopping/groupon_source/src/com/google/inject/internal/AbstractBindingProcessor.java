...
abstract class AbstractBindingProcessor extends AbstractProcessor
{
    ...
    private static final Set FORBIDDEN_TYPES = ImmutableSet.of(com/google/inject/AbstractModule, com/google/inject/Binder, com/google/inject/Binding, com/google/inject/Injector, com/google/inject/Key, com/google/inject/MembersInjector, new Class[] {
        com/google/inject/Module, com/google/inject/Provider, com/google/inject/Scope, com/google/inject/Stage, com/google/inject/TypeLiteral
    });
    ...
    protected void putBinding(BindingImpl bindingimpl)
    {
        ...
        injector.state.parent().blacklist(key, injector.state, bindingimpl.getSource());
