    ...
    implements HasDependencies, LinkedKeyBinding
{
    ...
    {
        return Objects.toStringHelper(com/google/inject/spi/LinkedKeyBinding).add("key", getKey()).add("source", getSource()).add("scope", getScoping()).add("target", targetKey).toString();
    }
