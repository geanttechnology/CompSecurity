...
final class MembersInjectorStore
{
        ...
        throws ErrorsException
    {
        ...
        org.roboguice.shaded.goole.common.collect.UnmodifiableIterator unmodifiableiterator;
        try
        {
        ...
        unmodifiableiterator = typeListenerBindings.iterator();
        do
        {
            ...
            TypeListenerBinding typelistenerbinding = (TypeListenerBinding)unmodifiableiterator.next();
            TypeListener typelistener = typelistenerbinding.getListener();
            if (!hashset.contains(typelistener) && typelistenerbinding.getTypeMatcher().matches(typeliteral))
            {
