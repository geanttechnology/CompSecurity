...
public class MoreTypes
{
    ...
    public static class GenericArrayTypeImpl
        implements CompositeType, Serializable, GenericArrayType
    {
    ...
    public static class ParameterizedTypeImpl
        implements CompositeType, Serializable, ParameterizedType
    {
...
_L3:
    ...
    public static class WildcardTypeImpl
        implements CompositeType, Serializable, WildcardType
    {
    ...
    private static HashMap cacheGenericSuperclass = new HashMap();
...
_L6:
        ...
        if (type instanceof TypeVariable)
        {
            ...
            if (type1 instanceof TypeVariable)
            {
                ...
                boolean flag1;
                if (type.getGenericDeclaration().equals(type1.getGenericDeclaration()) && type.getName().equals(type1.getName()))
                {
                    flag1 = flag5;
                } else
                {
...
_L7:
    ...
    {
        Type type = (Type)cacheGenericSuperclass.get(class1);
        if (type != null)
        {
            return type;
        } else
        {
            ...
            cacheGenericSuperclass.put(class1, type1);
            return type1;
        }
    }
    ...
    public static Type getGenericSupertype(Type type, Class class1, Class class2)
    {
        ...
        {
            for (HierarchyTraversalFilter hierarchytraversalfilter = Guice.createHierarchyTraversalFilter(); hierarchytraversalfilter.isWorthScanning(class1); class1 = type)
            {
                type = class1.getSuperclass();
                if (type == class2)
                {
                    return getGenericSuperclass(class1);
                }
    ...
    static 
    {
        PRIMITIVE_TO_WRAPPER = (new org.roboguice.shaded.goole.common.collect.ImmutableMap.Builder()).put(TypeLiteral.get(Boolean.TYPE), TypeLiteral.get(java/lang/Boolean)).put(TypeLiteral.get(Byte.TYPE), TypeLiteral.get(java/lang/Byte)).put(TypeLiteral.get(Short.TYPE), TypeLiteral.get(java/lang/Short)).put(TypeLiteral.get(Integer.TYPE), TypeLiteral.get(java/lang/Integer)).put(TypeLiteral.get(Long.TYPE), TypeLiteral.get(java/lang/Long)).put(TypeLiteral.get(Float.TYPE), TypeLiteral.get(java/lang/Float)).put(TypeLiteral.get(Double.TYPE), TypeLiteral.get(java/lang/Double)).put(TypeLiteral.get(Character.TYPE), TypeLiteral.get(java/lang/Character)).put(TypeLiteral.get(Void.TYPE), TypeLiteral.get(java/lang/Void)).build();
    }
