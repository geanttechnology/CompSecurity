    ...
    implements PrivateElements
{
    ...
    public void applyTo(Binder binder)
    {
        ...
        for (org.roboguice.shaded.goole.common.collect.UnmodifiableIterator unmodifiableiterator = exposedKeysToSources.entrySet().iterator(); unmodifiableiterator.hasNext(); binder.withSource(entry.getValue()).expose((Key)entry.getKey()))
        {
    ...
    {
        return Objects.toStringHelper(com/google/inject/spi/PrivateElements).add("exposedKeys", getExposedKeys()).add("source", getSource()).toString();
    }
}
