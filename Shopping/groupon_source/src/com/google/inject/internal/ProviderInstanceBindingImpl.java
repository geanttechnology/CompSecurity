    ...
    implements ProviderInstanceBinding
{
    ...
    public Provider getUserSuppliedProvider()
    {
    ...
    {
        return Objects.toStringHelper(com/google/inject/spi/ProviderInstanceBinding).add("key", getKey()).add("source", getSource()).add("scope", getScoping()).add("provider", providerInstance).toString();
    }
