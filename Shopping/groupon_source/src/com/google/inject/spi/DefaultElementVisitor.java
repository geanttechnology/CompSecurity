...
//            Message, PrivateElements, ProviderLookup, ProvisionListenerBinding, 
//            RequireAtInjectOnConstructorsOption, RequireExactBindingAnnotationsOption, RequireExplicitBindingsOption, ScopeBinding, 
//            StaticInjectionRequest, TypeConverterBinding, TypeListenerBinding, Element
    ...
    implements ElementVisitor
{
    ...
    public Object visit(ProvisionListenerBinding provisionlistenerbinding)
    {
        return visitOther(provisionlistenerbinding);
    }

    public Object visit(RequireAtInjectOnConstructorsOption requireatinjectonconstructorsoption)
    {
        return visitOther(requireatinjectonconstructorsoption);
    }

    public Object visit(RequireExactBindingAnnotationsOption requireexactbindingannotationsoption)
    {
