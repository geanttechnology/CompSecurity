...
//            PrivateElements, ProviderLookup, ProvisionListenerBinding, RequireAtInjectOnConstructorsOption, 
//            RequireExactBindingAnnotationsOption, RequireExplicitBindingsOption, ScopeBinding, StaticInjectionRequest, 
//            TypeConverterBinding, TypeListenerBinding
...
public interface ElementVisitor
{
    ...
    public abstract Object visit(ProvisionListenerBinding provisionlistenerbinding);

    public abstract Object visit(RequireAtInjectOnConstructorsOption requireatinjectonconstructorsoption);

    public abstract Object visit(RequireExactBindingAnnotationsOption requireexactbindingannotationsoption);
