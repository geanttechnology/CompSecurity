...
class val.special
    implements android.view.lPage._cls9
{
    ...
    {
        Special special1 = (Special)view.getTag();
        LoggingUtils loggingutils = BusinessDetailPage.access$500(BusinessDetailPage.this);
        if (isListOffers)
        {
            view = "offer_screen_special_click";
        } else
        {
            view = "special_click";
        }
        loggingutils.logClick("", view, val$special.remoteId, BusinessDetailPage.access$500(BusinessDetailPage.this).encodeAsJson(new MerchantPageMerchantIdMetadata(businessId)));
