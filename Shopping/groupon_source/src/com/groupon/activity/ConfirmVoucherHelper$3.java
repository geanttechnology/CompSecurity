    ...
    implements android.view.alLayoutListener
{
    ...
    public void onGlobalLayout()
    {
        ...
        ConfirmVoucherHelper.access$200(ConfirmVoucherHelper.this).getWindowManager().getDefaultDisplay().getMetrics(((DisplayMetrics) (obj)));
        int i = ((DisplayMetrics) (obj)).widthPixels;
        int j = Math.min(((DisplayMetrics) (obj)).heightPixels / 2, (int)Math.floor((val$bitmap.getHeight() * i) / val$bitmap.getWidth()));
