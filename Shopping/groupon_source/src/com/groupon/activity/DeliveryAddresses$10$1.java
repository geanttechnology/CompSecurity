...
class this._cls1
    implements android.view.es._cls10._cls1
{

    final sultAndFinish this$1;

    public void onClick(View view)
    {
        DeliveryAddresses.access$500(_fld0).store(location.id);
        setResultAndFinish();
    }
...
/* anonymous class */
        ...
        implements Function1
    {
        ...
        // Unreferenced inner class com/groupon/activity/DeliveryAddresses$10$2

/* anonymous class */
        class DeliveryAddresses._cls10._cls2
