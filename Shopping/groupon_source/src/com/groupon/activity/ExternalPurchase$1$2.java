...
/* anonymous class */
    class ExternalPurchase._cls1 extends WebChromeClient
    {
        ...
        {
            ExternalPurchase.access$002(ExternalPurchase.this, (new com.groupon.util.GrouponAlertDialog.Builder(ExternalPurchase.this)).setTitle(s).setMessage(s1).setPositiveButton(0x104000a, result. new ExternalPurchase._cls1._cls2()).setNegativeButton(0x1040000, new ExternalPurchase._cls1._cls1()).create());
