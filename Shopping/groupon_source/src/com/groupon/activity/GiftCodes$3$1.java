...
/* anonymous class */
        ...
        implements com.groupon.view.GrouponCheckMark.OnCheckedChangeListener
    {
        ...
        public void onCheckedChanged(View view, final boolean isChecked)
        {
            ...
            codeContainer.animate().setDuration(200L).alpha(f).setInterpolator(new DecelerateInterpolator()).setListener(isChecked. new GiftCodes._cls3._cls1());
            giftCardContainer.animate().setDuration(200L).alpha(f1).setInterpolator(new DecelerateInterpolator()).setListener(new GiftCodes._cls3._cls2());
            if (isChecked)
            {
                f = f2;
            } else
        ...
        // Unreferenced inner class com/groupon/activity/GiftCodes$3$2

/* anonymous class */
        class GiftCodes._cls3._cls2 extends AnimatorListenerAdapter
        {
