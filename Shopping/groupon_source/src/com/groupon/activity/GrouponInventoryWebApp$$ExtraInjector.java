...
//            GrouponInventoryWebApp

public class 
{

    public static void inject(com.f2prateek.dart.r r, GrouponInventoryWebApp grouponinventorywebapp, Object obj)
    {
        ...
        {
            grouponinventorywebapp.dealId = (String)r;
            return;
        }
    }
