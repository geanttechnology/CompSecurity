...
label0:
    ...
    public void onMapSharedElements(List list, Map map)
    {
        ...
        if (DealListTransitionController.access$000(DealListTransitionController.this))
        {
    ...
    public void onSharedElementEnd(List list, List list1, List list2)
    {
        ...
        DealListTransitionController.access$002(DealListTransitionController.this, false);
    }
