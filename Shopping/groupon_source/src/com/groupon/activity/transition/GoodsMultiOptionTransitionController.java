...
public class GoodsMultiOptionTransitionController
{

    Activity activity;
    private boolean isReentering;

    public GoodsMultiOptionTransitionController()
    {
    }
...
/*
    static boolean access$002(GoodsMultiOptionTransitionController goodsmultioptiontransitioncontroller, boolean flag)
    {
        goodsmultioptiontransitioncontroller.isReentering = flag;
        return flag;
    }
