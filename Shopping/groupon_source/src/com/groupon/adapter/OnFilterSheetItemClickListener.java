...
public interface OnFilterSheetItemClickListener
{
    ...
    public abstract void onFacetValueSelected(Facet facet, FacetValue facetvalue, boolean flag);

    public abstract void onSortMethodSelected(SortMethodWrapper sortmethodwrapper);
}
