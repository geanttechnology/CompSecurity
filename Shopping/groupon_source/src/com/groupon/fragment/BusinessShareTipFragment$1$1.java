...
class this._cls1 extends Http
{

    final issKeyboard this$1;
    ...
    is._cls0(Context context, Class class1, String s)
    {
        this$1 = this._cls1.this;
        super(context, class1, s);
    }

    // Unreferenced inner class com/groupon/fragment/BusinessShareTipFragment$1

/* anonymous class */
    class BusinessShareTipFragment._cls1
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            } else
            {
                ...
                (new BusinessShareTipFragment._cls1._cls1(getActivity(), java/lang/Void, s)).method("POST").nvps(view.toArray()).execute();
                return;
            }
        }
