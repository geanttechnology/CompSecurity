...
/* anonymous class */
        ...
        implements Function2
    {
        ...
        // Unreferenced inner class com/groupon/fragment/mygroupons/BaseMyGrouponsFragment$6$2

/* anonymous class */
        class BaseMyGrouponsFragment._cls6._cls2
            implements Function2
        {
            ...
            public void execute(Runnable runnable, Exception exception)
            {
                BaseMyGrouponsFragment.access$000(this$0, runnable, exception);
            }
