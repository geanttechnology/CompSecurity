...
//            GetawaysWidgetRecyclerViewAdapter

private class <init>
    implements android.view.iewClickListener
{
    ...
    {
        GetawaysWidgetRecyclerViewAdapter.access$200(GetawaysWidgetRecyclerViewAdapter.this).Clicked(view);
    }
