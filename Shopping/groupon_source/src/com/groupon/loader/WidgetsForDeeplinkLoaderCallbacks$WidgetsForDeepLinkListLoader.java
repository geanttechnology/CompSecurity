...
//            WidgetsForDeeplinkLoaderCallbacks

private static class dbChannel extends commonlib.loader.r
{
    ...
    public (Class class1, Class class2, Context context, DaoWidgetSummary daowidgetsummary, String s)
    {
