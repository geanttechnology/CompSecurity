...
import com.groupon.activity.OneClickPaymentPurchase;
...
public class OneClickPaymentMethod extends ECommercePaymentMethod
{
    ...
    public OneClickPaymentMethod(Activity activity, Context context, ArraySharedPreferences arraysharedpreferences, Deal deal, Option option, int i, boolean flag, 
            String s, String s1)
    {
    ...
    public void completePayment(Order order, int i)
    {
        ...
        activity.startActivityForResult(intentfactory.newECommerceIntent(order, i, com/groupon/activity/OneClickPaymentPurchase), 10135);
    }
    ...
    {
        return context.getString(0x7f0802c6);
    }
