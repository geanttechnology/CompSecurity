...
public class RedcompraPaymentMethod extends ECommercePaymentMethod
{
    ...
    public RedcompraPaymentMethod(Activity activity, Context context, ArraySharedPreferences arraysharedpreferences, Deal deal, Option option, int i, boolean flag, 
            String s, String s1)
    {
    ...
    public void completePayment(Order order, int i)
    {
        ...
        activity.startActivityForResult(intentfactory.newECommerceIntent(order, i, com/groupon/activity/RedcompraPurchase), 10136);
    }
    ...
    {
        return context.getString(0x7f08030a);
    }
