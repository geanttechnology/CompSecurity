...
public class CabWidgetsController extends RecyclerItemViewController
{
    private class OnWidgetsEventListener extends DefaultOnDealDetailsWidgetsEventListener
    {
        ...
        public void onCabWidgetsInitialized(FilterableWidgetListAdapter filterablewidgetlistadapter)
        {
            ...
            activityWidgetsCallback.onCabWidgetsInitialized(filterablewidgetlistadapter);
        }
    ...
    public CabWidgetsController(Context context)
    {
        super(context);
    }
    ...
    public void processData()
    {
        ...
        ((CabCavWidget)model).displayWidget = cabCavOnDealDetailsAbTestHelper.shouldDisplayCABWidget();
