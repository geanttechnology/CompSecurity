...
public class SubscriptionUnsubscribe extends MobileFunnelEvent
{
    ...
    public SubscriptionUnsubscribe(String s, String s1, String s2, String s3, String s4, String s5, long l, String s6, String s7, EncodedNSTField encodednstfield)
    {
        super("GRP22", s);
        subscriptionType = "";
        divisionId = "";
