    ...
    implements Function2
{
    ...
    {
        if (BaseRecyclerViewDelegate.access$600(_fld0) != null && BaseRecyclerViewDelegate.access$600(_fld0).isEnabled())
        {
            BaseRecyclerViewDelegate.access$600(_fld0).setRefreshing(true);
        }
...
/* anonymous class */
        ...
        implements Function2
    {
        ...
        // Unreferenced inner class com/groupon/util/BaseRecyclerViewDelegate$3$2

/* anonymous class */
        class BaseRecyclerViewDelegate._cls3._cls2
            implements Function2
        {
            ...
            public void execute(Runnable runnable, Exception exception)
            {
                runnable = BaseRecyclerViewDelegate.access$000(this$0).getList();
                if (runnable.size() > 0)
                {
                    ...
                    BaseRecyclerViewDelegate.access$000(this$0).setList(runnable);
                }
