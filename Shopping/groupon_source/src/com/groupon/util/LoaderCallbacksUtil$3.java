    ...
    implements android.content.kListener
{
    ...
    public void onClick(DialogInterface dialoginterface, int i)
    {
        ...
        {
            ((GrouponDialogListener)val$context).onDialogNegativeButtonClick("", dialoginterface);
        }
        val$globalBus.post(new DialogCallbackEvent("negative_click"));
    }

    nt(SyncManager syncmanager, Function2 function2, Runnable runnable, Exception exception, Context context1, Bus bus)
    {
