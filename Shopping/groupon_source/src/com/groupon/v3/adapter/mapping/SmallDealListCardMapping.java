...
public class SmallDealListCardMapping extends Mapping
{

    public SmallDealListCardMapping()
    {
    ...
    public void bindView(int i, android.support.v7.widget.RecyclerView.ViewHolder viewholder, UniversalListAdapter universallistadapter)
    {
        ...
        ((SmallDealListCard)viewholder.itemView).setInfo(universallistadapter.getDealSummary(), universallistadapter.isLastPosition(), universallistadapter.isFirstPosition(), (DealSetCallbacks)getCallback(com/groupon/view/DealSetCallbacks), null);
    }

    public View createView(Context context)
    {
        return new SmallDealListCard(context);
    }
}
