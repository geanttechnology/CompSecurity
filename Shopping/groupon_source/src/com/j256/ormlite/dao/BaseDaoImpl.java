    ...
    implements Dao
{
        ...
        throws SQLException
    {
        ...
        {
            FieldType fieldtype = afieldtype[i];
            Object obj2 = fieldtype.getFieldValueIfNotDefault(obj);
            int k = j;
            if (obj2 != null)
            {
                Object obj1 = obj2;
...
_L4:
        Object obj;
        if (i >= daoconfigarray.size())
        {
            break; /* Loop/switch isn't completed */
        }
        obj = daoconfigarray.get(i);
