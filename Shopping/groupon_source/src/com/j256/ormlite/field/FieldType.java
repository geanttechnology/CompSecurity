...
public class FieldType
{
        ...
        throws SQLException
    {
        ...
        } else
        {
            ...
            {
                connectionsource = new StringBuilder();
                connectionsource.append("Field class ").append(((Class) (obj)).getName());
                connectionsource.append(" for field ").append(this);
                connectionsource.append(" is not valid for type ").append(class1);
                s = class1.getPrimaryClass();
                if (s != null)
                {
                    connectionsource.append((new StringBuilder()).append(", maybe should be ").append(s).toString());
                }
                throw new IllegalArgumentException(connectionsource.toString());
            }
        }
        class1 = databasefieldconfig.getForeignColumnName();
        s1 = field1.getName();
        if (databasefieldconfig.isForeign() || databasefieldconfig.isForeignAutoRefresh() || class1 != null)
        {
            if (connectionsource != null && connectionsource.isPrimitive())
            {
            ...
            if (class1 == null)
            {
                class1 = (new StringBuilder()).append(s1).append("_id").toString();
            } else
            {
                class1 = (new StringBuilder()).append(s1).append("_").append(class1).toString();
            }
            if (com/j256/ormlite/dao/ForeignCollection.isAssignableFrom(((Class) (obj))))
            {
                throw new SQLException((new StringBuilder()).append("Field '").append(field1.getName()).append("' in class ").append(obj).append("' should use the @").append(com/j256/ormlite/field/ForeignCollectionField.getSimpleName()).append(" annotation not foreign=true").toString());
            }
        } else
        if (databasefieldconfig.isForeignCollection())
        {
            ...
            class1 = s1;
            if (((ParameterizedType)obj).getActualTypeArguments().length == 0)
            {
        ...
        } else
        {
            ...
            if (connectionsource == null)
            {
                ...
                if (!databasefieldconfig.isForeignCollection())
                {
                    ...
                    {
                        throw new SQLException((new StringBuilder()).append("ORMLite does not know how to store ").append(obj).append(" for field '").append(field1.getName()).append("'. byte[] fields must specify dataType=DataType.BYTE_ARRAY or SERIALIZABLE").toString());
                    }
                    if (java/io/Serializable.isAssignableFrom(((Class) (obj))))
                    {
                        throw new SQLException((new StringBuilder()).append("ORMLite does not know how to store ").append(obj).append(" for field '").append(field1.getName()).append("'.  Use another class, custom persister, or to serialize it use ").append("dataType=DataType.SERIALIZABLE").toString());
                    } else
                    {
                        throw new IllegalArgumentException((new StringBuilder()).append("ORMLite does not know how to store ").append(obj).append(" for field ").append(field1.getName()).append(". Use another class or a custom persister.").toString());
                    }
                }
            }
        }
        ...
        if (databasefieldconfig.getGeneratedIdSequence() != null)
        {
            isId = true;
            isGeneratedId = true;
            class1 = databasefieldconfig.getGeneratedIdSequence();
            s = class1;
            if (databasetype.isEntityNamesMustBeUpCase())
            {
                s = class1.toUpperCase();
            }
        ...
        {
            throw new IllegalArgumentException((new StringBuilder()).append("Field ").append(field1.getName()).append(" must have foreign = true if foreignColumnName is set").toString());
        }
        if (databasefieldconfig.isVersion() && (connectionsource == null || !connectionsource.isValidForVersion()))
        {
        ...
        {
            throw new IllegalArgumentException((new StringBuilder()).append("Field ").append(field1.getName()).append(" has maxForeignAutoRefreshLevel set but not foreignAutoRefresh is false").toString());
        } else
        {
            assignDataType(databasetype, connectionsource);
            return;
        }
    }
...
label0:
        {
            ...
            if (datapersister == null)
            {
                ...
                {
                    throw new SQLException((new StringBuilder()).append("Data persister for field ").append(this).append(" is null but the field is not a foreign or foreignCollection").toString());
                }
            } else
            {
        ...
        throws SQLException
    {
        ...
        basedaoimpl = basedaoimpl.getTableInfo().getFieldTypes();
        int j = basedaoimpl.length;
        int i = 0;
        while (i < j) 
        {
            FieldType fieldtype = basedaoimpl[i];
            if (fieldtype.getType() == class2 && (s == null || fieldtype.getField().getName().equals(s)))
            {
                ...
                {
                    throw new SQLException((new StringBuilder()).append("Foreign collection object ").append(class1).append(" for field '").append(field.getName()).append("' contains a field of class ").append(class2).append(" but it's not foreign").toString());
                } else
                {
                    return fieldtype;
                }
        ...
        basedaoimpl.append("Foreign collection class ").append(class1.getName());
        basedaoimpl.append(" for field '").append(field.getName()).append("' column-name does not contain a foreign field");
        if (s != null)
        {
            basedaoimpl.append(" named '").append(s).append('\'');
        }
        basedaoimpl.append(" of class ").append(class2.getName());
...
_L4:
        obj2 = (LevelCounters)threadLevelCounters.get();
        if (((LevelCounters) (obj2)).autoRefreshLevel == 0)
        {
            obj2.autoRefreshLevelMax = fieldConfig.getMaxForeignAutoRefreshLevel();
        }
        if (((LevelCounters) (obj2)).autoRefreshLevel < ((LevelCounters) (obj2)).autoRefreshLevelMax) goto _L6; else goto _L5
_L5:
        obj2 = foreignTableInfo.createObject();
...
_L7:
        ...
        throws SQLException
    {
        ...
        obj = new EagerForeignCollection(basedaoimpl, obj, obj1, foreignFieldType, fieldConfig.getForeignCollectionOrderColumnName(), fieldConfig.isForeignCollectionOrderAscending());
        levelcounters.foreignCollectionLevel = levelcounters.foreignCollectionLevel - 1;
        ...
        throws SQLException
    {
        ...
        if (fieldConfig.isForeignAutoRefresh() || s != null)
        {
            ...
            if (class1 == null)
            {
                connectionsource = (BaseDaoImpl)DaoManager.createDao(connectionsource, ((Class) (obj2)));
                obj1 = connectionsource.getTableInfo();
            } else
            {
            ...
            if (s == null)
            {
                class1 = ((TableInfo) (obj1)).getIdField();
                obj = class1;
                if (class1 == null)
                {
                    throw new IllegalArgumentException((new StringBuilder()).append("Foreign field ").append(obj2).append(" does not have id field").toString());
                }
            } else
            {
                class1 = ((TableInfo) (obj1)).getFieldTypeByColumnName(s);
                obj = class1;
                if (class1 == null)
                {
                    throw new IllegalArgumentException((new StringBuilder()).append("Foreign field ").append(obj2).append(" does not have field named '").append(s).append("'").toString());
                }
            }
            obj2 = MappedQueryForId.build(databasetype, ((TableInfo) (obj1)), ((FieldType) (obj)));
            class1 = null;
        } else
        if (fieldConfig.isForeign())
        {
            ...
            {
                throw new IllegalArgumentException((new StringBuilder()).append("Field ").append(this).append(" is a primitive class ").append(obj2).append(" but marked as foreign").toString());
            }
            class1 = fieldConfig.getForeignTableConfig();
            if (class1 != null)
            {
            ...
            obj1 = connectionsource.getTableInfo();
            obj = ((TableInfo) (obj1)).getIdField();
            if (obj == null)
            {
                throw new IllegalArgumentException((new StringBuilder()).append("Foreign field ").append(obj2).append(" does not have id field").toString());
            }
            if (isForeignAutoCreate() && !((FieldType) (obj)).isGeneratedId())
            {
                throw new IllegalArgumentException((new StringBuilder()).append("Field ").append(field.getName()).append(", if foreignAutoCreate = true then class ").append(((Class) (obj2)).getSimpleName()).append(" must have id field with generatedId = true").toString());
            }
            class1 = null;
            obj2 = null;
        } else
        ...
        {
            if (obj2 != java/util/Collection && !com/j256/ormlite/dao/ForeignCollection.isAssignableFrom(((Class) (obj2))))
            {
            ...
            if (obj == null)
            {
                connectionsource = (BaseDaoImpl)DaoManager.createDao(connectionsource, ((Class) (obj1)));
            } else
            {
                connectionsource = (BaseDaoImpl)DaoManager.createDao(connectionsource, ((DatabaseTableConfig) (obj)));
            }
            obj = connectionsource;
            class1 = findForeignFieldType(((Class) (obj1)), class1, connectionsource);
            obj3 = null;
            obj1 = null;
            obj2 = null;
        ...
        mappedQueryForId = ((MappedQueryForId) (obj2));
        foreignTableInfo = ((TableInfo) (obj1));
        foreignFieldType = class1;
        foreignDao = connectionsource;
        foreignIdField = ((FieldType) (obj));
    ...
    public boolean equals(Object obj)
    {
        ...
        {
            if (field.equals(((FieldType) (obj = (FieldType)obj)).field) && (parentClass != null ? parentClass.equals(((FieldType) (obj)).parentClass) : ((FieldType) (obj)).parentClass == null))
            {
                return true;
            }
        }
        ...
        throws SQLException
    {
        ...
        if (dataPersister == null)
        {
            throw new SQLException((new StringBuilder()).append("Internal error.  Data-persister is not configured for field.  Please post _full_ exception with associated data objects to mailing list: ").append(this).toString());
        } else
        {
        ...
        throws SQLException
    {
        Integer integer;
        Object obj;
        obj = (Integer)map.get(columnName);
        integer = ((Integer) (obj));
        if (obj == null)
        {
        ...
        obj = fieldConverter.resultToJava(this, databaseresults, integer.intValue());
        if (!fieldConfig.isForeign()) goto _L2; else goto _L1
_L1:
        map = ((Map) (obj));
...
_L3:
        map = ((Map) (obj));
        if (!fieldConverter.isStreamType())
        {
            map = ((Map) (obj));
            if (databaseresults.wasNull(integer.intValue()))
            {
