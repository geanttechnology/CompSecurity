...
label0:
        ...
        } else
        {
            ...
            int k1 = databasetype.length;
            int j = 0;
            while (j < k1) 
            {
                basedaoimpl = databasetype[j];
                int i1 = k;
    ...
    public FieldType getFieldTypeByColumnName(String s)
    {
        if (fieldNameMap == null)
        {
            ...
            for (int i = 0; i < k; i++)
            {
                ...
                hashmap.put(fieldtype2.getColumnName(), fieldtype2);
            }

            fieldNameMap = hashmap;
        }
        FieldType fieldtype = (FieldType)fieldNameMap.get(s);
        if (fieldtype != null)
        {
            return fieldtype;
        }
