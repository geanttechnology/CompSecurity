...
public class DetectionResult
{
    ...
    public DetectionResult(DetectionResult detectionresult)
    {
        this(jniInterfaceJNI.new_DetectionResult__SWIG_1(getCPtr(detectionresult), detectionresult), true);
    }

    public DetectionResult(boolean flag, boolean flag1, int i, boolean flag2, boolean flag3, boolean flag4, boolean flag5, 
            OcrPoint ocrpoint, OcrPoint ocrpoint1, boolean flag6, boolean flag7, OcrQuadrangle ocrquadrangle)
    {
        this(jniInterfaceJNI.new_DetectionResult__SWIG_2(flag, flag1, i, flag2, flag3, flag4, flag5, OcrPoint.getCPtr(ocrpoint), ocrpoint, OcrPoint.getCPtr(ocrpoint1), ocrpoint1, flag6, flag7, OcrQuadrangle.getCPtr(ocrquadrangle), ocrquadrangle), true);
    }
    ...
    public boolean getNeedRefocus()
    {
        return jniInterfaceJNI.DetectionResult_getNeedRefocus(a, this);
    }
