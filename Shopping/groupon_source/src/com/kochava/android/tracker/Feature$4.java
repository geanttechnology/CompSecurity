    ...
    implements Runnable
{
    ...
    public void run()
    {
        ...
        i = j;
        ((JSONObject) (obj3)).put("kochava_device_id", Feature.access$1700());
        i = j;
...
_L6:
        ...
        i = k;
        j = k;
        Feature.access$1800().edit().putString("attributionData", ((String) (obj2))).commit();
        l = k;
        i1 = k;
        j1 = k;
        i = k;
        j = k;
        if (Feature.access$1900() == null) goto _L4; else goto _L7
_L7:
        i1 = k;
        j1 = k;
        i = k;
        ...
        i = k;
        j = k;
        Feature.access$1900().sendMessage(((Message) (obj)));
        l = k;
_L4:
        if (l > 0)
        {
