...
_L6:
    ...
    public static final class PanelState extends Enum
    {
        ...
        {
            return (PanelState)Enum.valueOf(com/sothree/slidinguppanel/SlidingUpPanelLayout$PanelState, s);
        }
    ...
    static class SavedState extends android.view.View.BaseSavedState
    {
        ...
        private SavedState(Parcel parcel)
        {
            ...
            try
            {
                mSlideState = (PanelState)Enum.valueOf(com/sothree/slidinguppanel/SlidingUpPanelLayout$PanelState, parcel.readString());
                return;
            }
    ...
    public SlidingUpPanelLayout(Context context, AttributeSet attributeset, int i)
    {
        ...
        if (attributeset != null)
        {
            ...
            typedarray.recycle();
            attributeset = context.obtainStyledAttributes(attributeset, com.sothree.slidinguppanel.library.R.styleable.SlidingUpPanelLayout);
            if (attributeset != null)
            {
                mPanelHeight = attributeset.getDimensionPixelSize(com.sothree.slidinguppanel.library.R.styleable.SlidingUpPanelLayout_umanoPanelHeight, -1);
                mShadowHeight = attributeset.getDimensionPixelSize(com.sothree.slidinguppanel.library.R.styleable.SlidingUpPanelLayout_umanoShadowHeight, -1);
                mParallaxOffset = attributeset.getDimensionPixelSize(com.sothree.slidinguppanel.library.R.styleable.SlidingUpPanelLayout_umanoParalaxOffset, -1);
                mMinFlingVelocity = attributeset.getInt(com.sothree.slidinguppanel.library.R.styleable.SlidingUpPanelLayout_umanoFlingVelocity, 400);
                mCoveredFadeColor = attributeset.getColor(com.sothree.slidinguppanel.library.R.styleable.SlidingUpPanelLayout_umanoFadeColor, 0x99000000);
                mDragViewResId = attributeset.getResourceId(com.sothree.slidinguppanel.library.R.styleable.SlidingUpPanelLayout_umanoDragView, -1);
                mScrollableViewResId = attributeset.getResourceId(com.sothree.slidinguppanel.library.R.styleable.SlidingUpPanelLayout_umanoScrollableView, -1);
                mOverlayContent = attributeset.getBoolean(com.sothree.slidinguppanel.library.R.styleable.SlidingUpPanelLayout_umanoOverlay, false);
                mClipPanel = attributeset.getBoolean(com.sothree.slidinguppanel.library.R.styleable.SlidingUpPanelLayout_umanoClipPanel, true);
                mAnchorPoint = attributeset.getFloat(com.sothree.slidinguppanel.library.R.styleable.SlidingUpPanelLayout_umanoAnchorPoint, 1.0F);
                mSlideState = PanelState.values()[attributeset.getInt(com.sothree.slidinguppanel.library.R.styleable.SlidingUpPanelLayout_umanoInitialState, DEFAULT_SLIDE_STATE.ordinal())];
            }
...
label0:
        ...
        AnimatorProxy.wrap(mMainView).setTranslationY(i);
    }
...
_L5:
    ...
    protected void onLayout(boolean flag, int i, int j, int k, int l)
    {
        ...
        if (mFirstLayout)
        {
            static class _cls2
            {
                ...
                static 
                {
                    $SwitchMap$com$sothree$slidinguppanel$SlidingUpPanelLayout$PanelState = new int[PanelState.values().length];
                    try
                    {
            ...
            switch (_cls2..SwitchMap.com.sothree.slidinguppanel.SlidingUpPanelLayout.PanelState[mSlideState.ordinal()])
            {
            default:
                mSlideOffset = 0.0F;
                break;
    ...
    public void setPanelState(PanelState panelstate)
    {
        ...
        int j;
        switch (_cls2..SwitchMap.com.sothree.slidinguppanel.SlidingUpPanelLayout.PanelState[panelstate.ordinal()])
        {
        default:
            return;
