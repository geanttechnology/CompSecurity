...
_L4:
        ...
        i = 0;
_L12:
        if (i >= j || mInitialMotionX == null || mInitialMotionY == null) goto _L9; else goto _L8
_L8:
        k = MotionEventCompat.getPointerId(motionevent, i);
        if (k < mInitialMotionX.length && k < mInitialMotionY.length) goto _L11; else goto _L10
_L10:
        i++;
          goto _L12
_L11:
        ...
        f1 -= mInitialMotionX[k];
        f -= mInitialMotionY[k];
        reportNewEdgeDrags(f1, f, k);
        if (mDragState != 1) goto _L13; else goto _L9
_L9:
        saveLastMotion(motionevent);
          goto _L7
_L13:
        view = findTopChildUnder((int)mInitialMotionX[k], (int)mInitialMotionY[k]);
        if (view == null || !checkTouchSlop(view, f1, f) || !tryCaptureViewForDrag(view, k)) goto _L10; else goto _L9
_L6:
