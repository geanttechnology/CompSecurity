...
protected static class  extends 
{
        ...
        throws Exception
    {
        ...
        {
            paginatedsyncmanager.doSync(info, 0, PaginatedSyncManager.access$000(paginatedsyncmanager));
        }
    }

    public ( , Object obj, PaginatedSyncManager paginatedsyncmanager)
    {
        super(, obj, paginatedsyncmanager);
    }
}
