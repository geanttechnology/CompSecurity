...
_L1:
        g = new bx((new StringBuilder("Bad method: ")).append(i1).toString(), ((Throwable) (obj1)));
        return;
_L2:
        i1++;
          goto _L3
...
_L4:
        obj1 = "address";
_L7:
        g = new bx((new StringBuilder("No such field: ")).append(((String) (obj1))).toString(), nosuchfieldexception);
        return;
_L5:
        if (b == null)
        {
