...
label0:
        {
            ...
            if (java/util/EnumMap.isAssignableFrom(((Class) (obj2))))
            {
                ...
                if (deserializerprovider == null || !deserializerprovider.isEnum())
                {
                    throw new IllegalArgumentException("Can not construct EnumMap; generic (key) type not available");
                } else
                {
                    return new EnumMapDeserializer(constructEnumResolver(deserializerprovider, deserializationconfig), ((JsonDeserializer) (obj1)));
                }
            }
