...
//            BeanDeserializerFactory, BeanDeserializer, ValueInstantiators
...
public class StdDeserializerProvider extends DeserializerProvider
{
        ...
        throws JsonMappingException
    {
        ...
        if (obj != java/lang/String && obj != java/lang/Object) goto _L2; else goto _L1
_L1:
        obj = null;
_L4:
...
_L5:
        ...
        {
            javatype = ((ContextualKeyDeserializer)keydeserializer).createContextual(deserializationconfig, beanproperty);
        }
        return javatype;
    }
