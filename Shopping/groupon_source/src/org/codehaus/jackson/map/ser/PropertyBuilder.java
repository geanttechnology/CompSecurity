...
_L1:
        static class _cls1
        {
            ...
            static 
            {
                ...
                try
                {
                    $SwitchMap$org$codehaus$jackson$map$annotate$JsonSerialize$Inclusion[org.codehaus.jackson.map.annotate.JsonSerialize.Inclusion.NON_EMPTY.ordinal()] = 2;
                }
                catch (NoSuchFieldError nosuchfielderror2) { }
                try
                {
                    $SwitchMap$org$codehaus$jackson$map$annotate$JsonSerialize$Inclusion[org.codehaus.jackson.map.annotate.JsonSerialize.Inclusion.NON_NULL.ordinal()] = 3;
                }
                catch (NoSuchFieldError nosuchfielderror1) { }
                try
                {
                    $SwitchMap$org$codehaus$jackson$map$annotate$JsonSerialize$Inclusion[org.codehaus.jackson.map.annotate.JsonSerialize.Inclusion.ALWAYS.ordinal()] = 4;
                }
