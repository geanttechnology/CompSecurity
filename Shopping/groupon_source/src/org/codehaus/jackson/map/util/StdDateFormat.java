...
_L1:
        Object obj;
        String s1;
        SimpleDateFormat simpledateformat = _formatPlain;
        obj = simpledateformat;
        s1 = s;
        if (simpledateformat == null)
        {
            obj = (SimpleDateFormat)DATE_FORMAT_PLAIN.clone();
            _formatPlain = ((SimpleDateFormat) (obj));
            s1 = s;
        }
_L9:
        return ((SimpleDateFormat) (obj)).parse(s1, parseposition);
_L2:
        if (c == 'Z')
        {
            obj = _formatISO8601_z;
            SimpleDateFormat simpledateformat1 = ((SimpleDateFormat) (obj));
            if (obj == null)
            {
                simpledateformat1 = (SimpleDateFormat)DATE_FORMAT_ISO8601_Z.clone();
                _formatISO8601_z = simpledateformat1;
            }
            obj = simpledateformat1;
            s1 = s;
            if (s.charAt(i - 4) == ':')
            {
...
_L7:
        ...
        if (_formatISO8601 == null)
        {
            obj = (SimpleDateFormat)DATE_FORMAT_ISO8601.clone();
            _formatISO8601 = ((SimpleDateFormat) (obj));
            s1 = s;
        }
        continue; /* Loop/switch isn't completed */
_L6:
...
_L4:
        ...
        s = ((StringBuilder) (obj)).toString();
        SimpleDateFormat simpledateformat2 = _formatISO8601_z;
        obj = simpledateformat2;
        s1 = s;
        if (simpledateformat2 == null)
        {
            obj = (SimpleDateFormat)DATE_FORMAT_ISO8601_Z.clone();
            _formatISO8601_z = ((SimpleDateFormat) (obj));
            s1 = s;
        }
