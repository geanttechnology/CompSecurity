    ...
    implements CloseFrame
{
        ...
        throws InvalidFrameException
    {
        ...
        if (bytebuffer.remaining() >= 2)
        {
            ...
            {
                throw new InvalidFrameException((new StringBuilder()).append("closecode must not be sent over the wire: ").append(code).toString());
            }
        }
        bytebuffer.reset();
    }
    ...
    {
        return (new StringBuilder()).append(super.toString()).append("code: ").append(code).toString();
    }
