    ...
    static final class Cell
    {
        ...
        static 
        {
            try
            {
                ...
                valueOffset = UNSAFE.objectFieldOffset(org/roboguice/shaded/goole/common/cache/Striped64$Cell.getDeclaredField("value"));
            }
...
_L2:
        ...
        j = 1;
        busy = 0;
        if (j == 0) goto _L16; else goto _L9
_L16:
        break; /* Loop/switch isn't completed */
        hashcode;
        busy = 0;
        throw hashcode;
        l2 = base;
        if (!casBase(l2, fn(l2, l))) goto _L10; else goto _L9
        long l2;
        int j = 0;
        while (j < j1) 
        {
    ...
    static 
    {
        ...
        {
            UNSAFE = getUnsafe();
            baseOffset = UNSAFE.objectFieldOffset(org/roboguice/shaded/goole/common/cache/Striped64.getDeclaredField("base"));
            busyOffset = UNSAFE.objectFieldOffset(org/roboguice/shaded/goole/common/cache/Striped64.getDeclaredField("busy"));
        }
        catch (Exception exception)
        {
            throw new Error(exception);
