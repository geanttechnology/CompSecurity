    ...
    implements Serializable, ConcurrentMap
{
    ...
    static abstract class EntryFactory extends Enum
    {
        ...
        {
            return (EntryFactory)Enum.valueOf(org/roboguice/shaded/goole/common/collect/MapMakerInternalMap$EntryFactory, s);
        }
        ...
        implements ReferenceEntry
    {
        ...
        {
            return (NullEntry)Enum.valueOf(org/roboguice/shaded/goole/common/collect/MapMakerInternalMap$NullEntry, s);
        }
...
_L1:
    ...
    static abstract class Strength extends Enum
    {
        ...
        {
            return (Strength)Enum.valueOf(org/roboguice/shaded/goole/common/collect/MapMakerInternalMap$Strength, s);
        }
    ...
    private static final Logger logger = Logger.getLogger(org/roboguice/shaded/goole/common/collect/MapMakerInternalMap.getName());
...
_L8:
    ...
    // Unreferenced inner class org/roboguice/shaded/goole/common/collect/MapMakerInternalMap$EvictionQueue$1
...
/* anonymous class */
    ...
    // Unreferenced inner class org/roboguice/shaded/goole/common/collect/MapMakerInternalMap$ExpirationQueue$1
