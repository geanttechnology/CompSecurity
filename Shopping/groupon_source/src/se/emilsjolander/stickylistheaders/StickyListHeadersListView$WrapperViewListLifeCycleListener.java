...
label0:
        {
            ...
            if (StickyListHeadersListView.access$200(StickyListHeadersListView.this) != null)
            {
                ...
                StickyListHeadersListView.access$1200(StickyListHeadersListView.this, canvas, StickyListHeadersListView.access$200(StickyListHeadersListView.this), 0L);
                canvas.restore();
            }
            return;
        }
        StickyListHeadersListView.access$1300(StickyListHeadersListView.this, canvas, StickyListHeadersListView.access$200(StickyListHeadersListView.this), 0L);
    }
