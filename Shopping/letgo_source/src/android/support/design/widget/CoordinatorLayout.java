    ...
    implements aa
{
    ...
    public static abstract class a
    {
        ...
        public bf a(CoordinatorLayout coordinatorlayout, View view, bf bf1)
        {
            return bf1;
        }
    ...
    public static class c extends android.view.ViewGroup.MarginLayoutParams
    {
        ...
        c(Context context, AttributeSet attributeset)
        {
            ...
            f = -1;
            i = new Rect();
            TypedArray typedarray = context.obtainStyledAttributes(attributeset, android.support.v7.a.g.CoordinatorLayout_LayoutParams);
            c = typedarray.getInteger(android.support.v7.a.g.CoordinatorLayout_LayoutParams_android_layout_gravity, 0);
            f = typedarray.getResourceId(android.support.v7.a.g.CoordinatorLayout_LayoutParams_layout_anchor, -1);
            d = typedarray.getInteger(android.support.v7.a.g.CoordinatorLayout_LayoutParams_layout_anchorGravity, 0);
            e = typedarray.getInteger(android.support.v7.a.g.CoordinatorLayout_LayoutParams_layout_keyline, -1);
            b = typedarray.hasValue(android.support.v7.a.g.CoordinatorLayout_LayoutParams_layout_behavior);
            if (b)
            {
                a = CoordinatorLayout.a(context, attributeset, typedarray.getString(android.support.v7.a.g.CoordinatorLayout_LayoutParams_layout_behavior));
            }
            typedarray.recycle();
        }
    ...
    {
        if (!bf1.e()) goto _L2; else goto _L1
_L1:
        return;
_L2:
        int i1;
...
_L3:
        ...
        bf1 = ((a) (obj)).a(this, view, bf1);
        if (bf1.e()) goto _L1; else goto _L4
_L4:
        obj = ah.b(view, bf1);
        if (((bf) (obj)).e()) goto _L1; else goto _L5
_L5:
        i1++;
        bf1 = ((bf) (obj));
          goto _L6
...
label1:
    ...
    private void b(View view, int i1, int j1)
    {
        ...
        l2 = android.support.v4.view.f.a(c(c1.c), j1);
        k2 = getWidth();
        j2 = getHeight();
...
_L5:
    ...
    private void c(View view, int i1)
    {
        ...
        Rect rect1 = j;
        android.support.v4.view.f.a(b(c1.c), view.getMeasuredWidth(), view.getMeasuredHeight(), rect, rect1, i1);
...
label1:
    ...
    void a(View view, int i1, Rect rect, Rect rect1)
    {
        ...
        int j2;
        c1 = (c)view.getLayoutParams();
        j2 = android.support.v4.view.f.a(d(c1.c), i1);
        j1 = android.support.v4.view.f.a(b(c1.d), i1);
        l1 = view.getMeasuredWidth();
        i2 = view.getMeasuredHeight();
        j1 & 7;
...
_L3:
        i3 = a(c1.e);
        l5 = android.support.v4.view.f.a(c(c1.c), j4) & 7;
...
_L8:
        k1 = Math.max(0, i3 - j3);
          goto _L2
        setMeasuredDimension(ah.a(k2, i1, 0xff000000 & i2), ah.a(j2, j1, i2 << 16));
        return;
    }
...
_L9:
    ...
    public void setStatusBarBackgroundResource(int i1)
    {
        ...
        if (i1 != 0)
        {
            drawable = android.support.v7.i.a(getContext(), i1);
        } else
        {
            drawable = null;
        }
