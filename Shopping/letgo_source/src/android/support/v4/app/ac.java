...
class ac
{
        ...
        implements t, u
    {
        ...
        public Notification b()
        {
            ...
            if (obj != null)
            {
                ac.a(notification).putSparseParcelableArray("android.support.actionExtras", ((SparseArray) (obj)));
            }
            return notification;
        }
    ...
    public static Bundle a(android.app.Notification.Builder builder, y.a a1)
    {
        builder.addAction(a1.a(), a1.b(), a1.c());
        builder = new Bundle(a1.d());
        if (a1.f() != null)
        {
            builder.putParcelableArray("android.support.remoteInputs", ah.a(a1.f()));
        }
        return builder;
    }
...
_L1:
    ...
    public static void a(u u1, CharSequence charsequence, boolean flag, CharSequence charsequence1, Bitmap bitmap, Bitmap bitmap1, boolean flag1)
    {
        u1 = (new android.app.Notification.BigPictureStyle(u1.a())).setBigContentTitle(charsequence).bigPicture(bitmap);
        if (flag1)
        {
            u1.bigLargeIcon(bitmap1);
        }
        if (flag)
        {
            u1.setSummaryText(charsequence1);
        }
    }

    public static void a(u u1, CharSequence charsequence, boolean flag, CharSequence charsequence1, CharSequence charsequence2)
    {
        u1 = (new android.app.Notification.BigTextStyle(u1.a())).setBigContentTitle(charsequence).bigText(charsequence2);
        if (flag)
        {
            u1.setSummaryText(charsequence1);
        }
    ...
    public static void a(u u1, CharSequence charsequence, boolean flag, CharSequence charsequence1, ArrayList arraylist)
    {
        u1 = (new android.app.Notification.InboxStyle(u1.a())).setBigContentTitle(charsequence);
        if (flag)
        {
            u1.setSummaryText(charsequence1);
        }
        for (charsequence = arraylist.iterator(); charsequence.hasNext(); u1.addLine((CharSequence)charsequence.next())) { }
    }
