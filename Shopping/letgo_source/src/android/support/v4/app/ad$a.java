    ...
    implements t, u
{
    ...
    public android.app.ication.Builder a()
    {
        return a;
    }
    ...
    {
        android.util.SparseArray sparsearray = ac.a(c);
        if (sparsearray != null)
        {
    ...
    {
        c = new ArrayList();
        context = (new android.app.ication.Builder(context)).setWhen(notification.when).setShowWhen(flag1).setSmallIcon(notification.icon, notification.iconLevel).setContent(notification.contentView).setTicker(notification.tickerText, remoteviews).setSound(notification.sound, notification.audioStreamType).setVibrate(notification.vibrate).setLights(notification.ledARGB, notification.ledOnMS, notification.ledOffMS);
