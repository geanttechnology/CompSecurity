    ...
    implements o
{
    ...
    private void a(RuntimeException runtimeexception)
    {
        ...
        Object obj = new PrintWriter(new aw("FragmentManager"));
        if (o != null)
        {
            try
            {
...
_L10:
    ...
    public View a(View view, String s1, Context context, AttributeSet attributeset)
    {
        ...
        if (s1 == null)
        {
            ...
            view.z = true;
            view.C = this;
            view.a(o, attributeset, ((Fragment) (view)).n);
        ...
        } else
        {
            ...
            if (!((Fragment) (s1)).M)
            {
                s1.a(o, attributeset, ((Fragment) (s1)).n);
            }
            view = s1;
        }
            ...
            if (((FragmentManagerState) (parcelable)).c != null)
            {
                ...
                while (i2 < ((FragmentManagerState) (parcelable)).c.length) 
                {
                    ...
                    if (a)
                    {
                        ...
                        arraylist.a("  ", new PrintWriter(new aw("FragmentManager")), false);
                    }
                    i.add(arraylist);
                    if (((e) (arraylist)).p >= 0)
                    {
...
_L4:
        ...
        if (!fragment.P)
        {
            throw new aj((new StringBuilder()).append("Fragment ").append(fragment).append(" did not call through to super.onAttach()").toString());
        }
        if (fragment.F == null)
        {
            o.a(fragment);
        ...
        if (fragment.y)
        {
            ...
            if (fragment.S != null)
            {
                ...
                {
                    ah.a(fragment.S, false);
                } else
                {
                    fragment.S = android.support.v4.app.s.a(fragment.S);
                }
                if (fragment.J)
                {
            ...
            if (!fragment.y)
            {
                ...
                if (fragment.H != 0)
                {
                    ...
                    if (obj1 == null)
                    {
                        ...
                        if (!fragment.A)
                        {
                            a(((RuntimeException) (new IllegalArgumentException((new StringBuilder()).append("No view found for id 0x").append(Integer.toHexString(fragment.H)).append(" (").append(fragment.k().getResourceName(fragment.H)).append(") for fragment ").append(fragment).toString()))));
                            obj = obj1;
                        }
                    }
                } else
...
_L14:
        ...
        if (!fragment.P)
        {
            throw new aj((new StringBuilder()).append("Fragment ").append(fragment).append(" did not call through to super.onDetach()").toString());
        }
        i2 = i1;
        if (!flag)
        {
...
_L15:
    ...
    public void a(g g1, h h1, Fragment fragment)
    {
        if (o != null)
        {
...
label0:
    ...
    public String toString()
    {
        ...
        if (q != null)
        {
            av.a(q, stringbuilder);
        } else
        {
            av.a(o, stringbuilder);
        }
