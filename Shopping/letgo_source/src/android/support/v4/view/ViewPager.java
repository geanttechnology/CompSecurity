...
public class ViewPager extends ViewGroup
{
    public static class LayoutParams extends android.view.ViewGroup.LayoutParams
    {
        ...
        public LayoutParams(Context context, AttributeSet attributeset)
        {
            ...
            c = 0.0F;
            context = context.obtainStyledAttributes(attributeset, android.support.v4.view.ViewPager.g());
    ...
    public static class SavedState extends android.view.View.BaseSavedState
    {
        ...
        public static final android.os.Parcelable.Creator CREATOR = ak.a(new al() {
    ...
    class c extends android.support.v4.view.a
    {
        ...
        public void onInitializeAccessibilityNodeInfo(View view, be be1)
        {
            ...
            be1.b(android/support/v4/view/ViewPager.getName());
            be1.i(a());
    ...
    static interface d
    {
        ...
        public abstract void a(ad ad1, ad ad2);
    }
    ...
    static ad a(ViewPager viewpager)
    {
        return viewpager.h;
    }
    ...
    {
        int i1 = android.support.v4.view.u.b(motionevent);
        if (android.support.v4.view.u.b(motionevent, i1) == J)
        {
            if (i1 == 0)
            {
                i1 = 1;
            ...
            F = android.support.v4.view.u.c(motionevent, i1);
            J = android.support.v4.view.u.b(motionevent, i1);
            if (K != null)
            {
                K.clear();
            }
...
label0:
        {
            ...
            if (flag1)
            {
                ...
                android.support.v4.view.ah.a(this, ai);
            }
            return;
        }
        ai.run();
    ...
    private void b(boolean flag)
    {
        ...
        while (i1 < j1) 
        {
            ...
            android.support.v4.view.ah.a(getChildAt(i1), byte0, null);
            i1++;
        }
    }
...
label1:
    ...
    void a()
    {
        ...
        E = ar.a(viewconfiguration);
        L = (int)(400F * f1);
        M = viewconfiguration.getScaledMaximumFlingVelocity();
        Q = new android.support.v4.widget.g(context);
        R = new android.support.v4.widget.g(context);
        N = (int)(25F * f1);
        O = (int)(2.0F * f1);
        C = (int)(16F * f1);
        android.support.v4.view.ah.a(this, new c());
        if (android.support.v4.view.ah.e(this) == 0)
        {
            android.support.v4.view.ah.c(this, 1);
        }
    }
...
_L2:
        if (flag && android.support.v4.view.ah.a(view, -i1)) goto _L4; else goto _L6
_L6:
        return false;
...
_L3:
    ...
    public void draw(Canvas canvas)
    {
        ...
        int j1 = 0;
        int i1 = 0;
        int k1 = android.support.v4.view.ah.a(this);
...
_L7:
        ...
        j1 = android.support.v4.view.u.a(motionevent, j1);
        f3 = android.support.v4.view.u.c(motionevent, j1);
        f1 = f3 - F;
        f5 = Math.abs(f1);
        f4 = android.support.v4.view.u.d(motionevent, j1);
        f6 = Math.abs(f4 - I);
...
_L6:
        ...
        I = f2;
        G = f2;
        J = android.support.v4.view.u.b(motionevent, 0);
        B = false;
...
_L4:
        if (!A)
        {
            i1 = android.support.v4.view.u.a(motionevent, J);
            float f2 = android.support.v4.view.u.c(motionevent, i1);
            float f4 = Math.abs(f2 - F);
            float f3 = android.support.v4.view.u.d(motionevent, i1);
        ...
        if (A)
        {
            i1 = false | b(android.support.v4.view.u.c(motionevent, android.support.v4.view.u.a(motionevent, J)));
        }
        continue; /* Loop/switch isn't completed */
_L3:
        i1 = j1;
        if (A)
        {
            ...
            i1 = (int)android.support.v4.view.af.a(((VelocityTracker) (obj)), J);
            y = true;
            j1 = getClientWidth();
            int k1 = getScrollX();
            obj = j();
            a(a(((b) (obj)).b, ((float)k1 / (float)j1 - ((b) (obj)).e) / ((b) (obj)).d, i1, (int)(android.support.v4.view.u.c(motionevent, android.support.v4.view.u.a(motionevent, J)) - H)), true, true, i1);
            J = -1;
            k();
            boolean flag = Q.c();
            i1 = R.c() | flag;
...
_L5:
        ...
        continue; /* Loop/switch isn't completed */
_L7:
        i1 = android.support.v4.view.u.b(motionevent);
        F = android.support.v4.view.u.c(motionevent, i1);
        J = android.support.v4.view.u.b(motionevent, i1);
        i1 = j1;
        continue; /* Loop/switch isn't completed */
_L8:
        a(motionevent);
        F = android.support.v4.view.u.c(motionevent, android.support.v4.view.u.a(motionevent, J));
        i1 = j1;
