...
public class e
{
        ...
        implements a
    {
        ...
        public boolean a(MotionEvent motionevent)
        {
            ...
            if (flag)
            {
                l1 = android.support.v4.view.u.b(motionevent);
            } else
            {
                l1 = -1;
            }
            i3 = android.support.v4.view.u.c(motionevent);
            k2 = 0;
            f1 = 0.0F;
            f2 = 0.0F;
            while (k2 < i3) 
            {
                if (l1 != k2)
                {
                    f2 += android.support.v4.view.u.c(motionevent, k2);
                    f1 += android.support.v4.view.u.d(motionevent, k2);
                }
                k2++;
            }
            int i1;
...
_L7:
            ...
            i2 = android.support.v4.view.u.b(motionevent);
            j1 = android.support.v4.view.u.b(motionevent, i2);
            f1 = af.a(x, j1);
            f2 = af.b(x, j1);
            j1 = 0;
_L11:
...
_L10:
            float f3;
            int l2;
            l2 = android.support.v4.view.u.b(motionevent, j1);
            f3 = af.a(x, l2);
            if (af.b(x, l2) * f2 + f3 * f1 >= 0.0F) goto _L9; else goto _L12
_L12:
            x.clear();
            return false;
_L2:
...
_L3:
            ...
            {
                velocitytracker = x;
                k1 = android.support.v4.view.u.b(motionevent, 0);
                velocitytracker.computeCurrentVelocity(1000, d);
                f1 = af.b(velocitytracker, k1);
                f2 = af.a(velocitytracker, k1);
