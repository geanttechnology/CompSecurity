...
public class SwipeRefreshLayout extends ViewGroup
{
    ...
    {
        i1 = android.support.v4.view.u.a(motionevent, i1);
        if (i1 < 0)
        {
            return -1F;
        } else
        {
            return android.support.v4.view.u.d(motionevent, i1);
        }
    }
    ...
    private void a(MotionEvent motionevent)
    {
        ...
        if (android.support.v4.view.u.b(motionevent, i1) == o)
        {
            if (i1 == 0)
            {
                i1 = 1;
            ...
            o = android.support.v4.view.u.b(motionevent, i1);
        }
    }
...
label0:
    ...
    static k b(SwipeRefreshLayout swiperefreshlayout)
    {
...
_L4:
        float f1;
        a(b - t.getTop(), true);
        o = android.support.v4.view.u.b(motionevent, 0);
        n = false;
        f1 = a(motionevent, o);
...
_L4:
        i1 = android.support.v4.view.u.a(motionevent, o);
        if (i1 < 0)
        {
            Log.e(c, "Got ACTION_MOVE event but have an invalid active pointer id.");
            return false;
        }
        float f3 = 0.5F * (android.support.v4.view.u.d(motionevent, i1) - l);
        if (!n)
        {
            continue; /* Loop/switch isn't completed */
        }
...
_L5:
        o = android.support.v4.view.u.b(motionevent, android.support.v4.view.u.b(motionevent));
        continue; /* Loop/switch isn't completed */
_L6:
        a(motionevent);
...
_L3:
        ...
        float f2 = android.support.v4.view.u.d(motionevent, android.support.v4.view.u.a(motionevent, o));
        float f4 = l;
        n = false;
        if ((f2 - f4) * 0.5F > h)
        {
