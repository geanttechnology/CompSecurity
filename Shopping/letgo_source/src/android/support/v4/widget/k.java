    ...
    implements Animatable
{
    ...
    private static final Interpolator c = new bp();
    boolean a;
    private final int d[] = {
        0xff000000
    };
    ...
    private void a(float f1, a a1)
    {
        if (f1 > 0.75F)
        {
            a1.b(a((f1 - 0.75F) / 0.25F, a1.h(), a1.a()));
        }
    }

    static void a(k k1, float f1, a a1)
    {
        k1.b(f1, a1);
    }
    ...
    {
        a a1 = f;
        Animation animation = new Animation(a1) {
    ...
    static void b(k k1, float f1, a a1)
    {
        k1.a(f1, a1);
    }
