...
public class u
{
    ...
    private u(Context context, ViewGroup viewgroup, a a1)
    {
        c = -1;
        if (viewgroup == null)
        {
        ...
        } else
        {
            ...
            q = android.support.v4.widget.o.a(context, v);
            return;
        }
    }
    ...
    public static u a(ViewGroup viewgroup, float f1, a a1)
    {
        viewgroup = a(viewgroup, a1);
        viewgroup.b = (int)((float)((u) (viewgroup)).b * (1.0F / f1));
        return viewgroup;
    }

    public static u a(ViewGroup viewgroup, a a1)
    {
        return new u(viewgroup.getContext(), viewgroup, a1);
    }
...
_L6:
    ...
    {
        int j1 = android.support.v4.view.u.c(motionevent);
        for (int i1 = 0; i1 < j1; i1++)
        {
            int k1 = android.support.v4.view.u.b(motionevent, i1);
            float f1 = android.support.v4.view.u.c(motionevent, i1);
            float f2 = android.support.v4.view.u.d(motionevent, i1);
            f[k1] = f1;
            g[k1] = f2;
        }
    ...
    private void g()
    {
        ...
        a(a(af.a(l, c), n, m), a(af.b(l, c), n, m));
    }
    ...
    public boolean a(MotionEvent motionevent)
    {
        int i1;
        int j1;
        j1 = android.support.v4.view.u.a(motionevent);
...
_L2:
        f1 = motionevent.getX();
        f4 = motionevent.getY();
        i1 = android.support.v4.view.u.b(motionevent, 0);
        a(f1, f4, i1);
        ...
        if ((p & j1) != 0)
        {
          ...
          goto _L7
_L5:
        j1 = android.support.v4.view.u.b(motionevent, i1);
        float f2 = android.support.v4.view.u.c(motionevent, i1);
        float f5 = android.support.v4.view.u.d(motionevent, i1);
        a(f2, f5, j1);
        if (a == 0)
        {
            i1 = h[j1];
...
_L8:
        k1 = android.support.v4.view.u.c(motionevent);
        i1 = 0;
_L14:
        if (i1 >= k1) goto _L10; else goto _L9
_L9:
        l1 = android.support.v4.view.u.b(motionevent, i1);
        float f3 = android.support.v4.view.u.c(motionevent, i1);
        float f6 = android.support.v4.view.u.d(motionevent, i1);
        f7 = f3 - d[l1];
        f8 = f6 - e[l1];
...
_L11:
        i2 = view.getLeft();
        j2 = (int)f7;
        j2 = r.a(view, j2 + i2, (int)f7);
        k2 = view.getTop();
        l2 = (int)f8;
        l2 = r.b(view, l2 + k2, (int)f8);
        i3 = r.a(view);
        j3 = r.b(view);
...
_L13:
        i1++;
          goto _L14
_L6:
        e(android.support.v4.view.u.b(motionevent, i1));
          goto _L7
        e();
          goto _L7
    }
    ...
    public void b(MotionEvent motionevent)
    {
        ...
        i1 = 0;
        j1 = 0;
        l1 = android.support.v4.view.u.a(motionevent);
        k1 = android.support.v4.view.u.b(motionevent);
        if (l1 == 0)
        {
            e();
        }
...
_L6:
        float f2;
        float f4;
        i1 = android.support.v4.view.u.b(motionevent, k1);
        f2 = android.support.v4.view.u.c(motionevent, k1);
        f4 = android.support.v4.view.u.d(motionevent, k1);
        a(f2, f4, i1);
        if (a != 0)
        {
...
_L4:
        if (a == 1)
        {
            i1 = android.support.v4.view.u.a(motionevent, c);
            f2 = android.support.v4.view.u.c(motionevent, i1);
            f4 = android.support.v4.view.u.d(motionevent, i1);
            i1 = (int)(f2 - f[c]);
            j1 = (int)(f4 - g[c]);
...
_L13:
        i1++;
          goto _L14
_L7:
        j1 = android.support.v4.view.u.b(motionevent, k1);
