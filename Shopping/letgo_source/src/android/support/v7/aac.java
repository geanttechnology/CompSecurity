    ...
    extends IInterface
{
        ...
        implements aac
    {
        ...
        public static aac a(IBinder ibinder)
        {
            if (ibinder == null)
            {
                return null;
            ...
            if (iinterface != null && (iinterface instanceof aac))
            {
                return (aac)iinterface;
            } else
            {
...
_L1:
    ...
    public abstract boolean a(aac aac1)
        throws RemoteException;
