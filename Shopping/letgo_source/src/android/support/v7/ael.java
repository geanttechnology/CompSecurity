...
_L2:
            ...
            SQLiteException sqliteexception;
            sqliteexception;
            ael.b(a).getDatabasePath("google_tagmanager.db").delete();
            if (true) goto _L2; else goto _L1
_L1:
        }
    ...
    {
        this(context, vo.d(), "google_tagmanager.db", 2000, ((Executor) (Executors.newSingleThreadExecutor())));
    }

    ael(Context context, vn vn1, String s, int i, Executor executor)
    {
        c = context;
        e = vn1;
        f = i;
...
_L7:
    ...
    private List a(List list)
    {
        ...
        b b1;
        for (list = list.iterator(); list.hasNext(); arraylist.add(new aah.a(b1.a, a(b1.b))))
        {
            b1 = (b)list.next();
        }
    ...
    private void a(int i)
    {
        ...
        {
            List list = b(i);
            abo.c((new StringBuilder()).append("DataLayer store full, deleting ").append(list.size()).append(" entries to make room.").toString());
    ...
    private void a(long l)
    {
        ...
        try
        {
            ...
            abo.d((new StringBuilder()).append("Deleted ").append(i).append(" expired items").toString());
            return;
        }
        catch (SQLiteException sqliteexception)
        {
            abo.b("Error deleting old entries.");
        }
    }

    static void a(ael ael1, String s)
    {
        ael1.b(s);
    }

    static void a(ael ael1, List list, long l)
    {
        ael1.b(list, l);
    }
    ...
    private void a(String as[])
    {
        ...
        if (as != null && as.length != 0)
        {
            if ((sqlitedatabase = c("Error opening database for deleteEntries.")) != null)
            {
                ...
                {
                    abo.b((new StringBuilder()).append("Error deleting entries ").append(Arrays.toString(as)).toString());
                }
                return;
            }
        }
...
_L5:
    ...
    private List b(int i)
    {
        ...
        if (i <= 0)
        {
            abo.b("Invalid maxEntries specified. Skipping.");
            return arraylist;
        }
...
_L6:
        obj = obj1;
        abo.b((new StringBuilder()).append("Error in peekEntries fetching entryIds: ").append(sqliteexception.getMessage()).toString());
        if (obj1 != null)
        {
            ((Cursor) (obj1)).close();
        }
...
_L4:
    ...
    private void b(String s)
    {
        ...
        abo.d((new StringBuilder()).append("Cleared ").append(i).append(" items").toString());
        e();
        return;
        SQLiteException sqliteexception;
        sqliteexception;
        abo.b((new StringBuilder()).append("Error deleting entries with key prefix: ").append(s).append(" (").append(sqliteexception).append(").").toString());
        e();
        return;
        s;
        e();
...
_L3:
        obj;
        obj = cursor;
        abo.b("Error getting numStoredEntries");
