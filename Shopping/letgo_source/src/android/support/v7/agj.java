...
public final class agj
    implements afm
{
    private final class a extends afl
    {
        ...
        public a(aeu aeu1, Type type, afl afl1, Type type1, afl afl2, afz afz1)
        {
            a = agj.this;
            super();
            b = new ago(aeu1, afl1, type);
            c = new ago(aeu1, afl2, type1);
            d = afz1;
        }
    }
    ...
    public agj(afu afu1, boolean flag)
    {
        a = afu1;
        b = flag;
    }

    private afl a(aeu aeu1, Type type)
    {
        ...
        {
            return aeu1.a(agq.a(type));
        }
    }

    static boolean a(agj agj1)
    {
        return agj1.b;
    }
    ...
    {
        Type type = agq1.b();
        if (!java/util/Map.isAssignableFrom(agq1.a()))
        {
            return null;
        } else
        {
            Type atype[] = aft.b(type, aft.e(type));
            afl afl = a(aeu1, atype[0]);
            afl afl1 = aeu1.a(agq.a(atype[1]));
            agq1 = a.a(agq1);
            return new a(aeu1, atype[0], afl, atype[1], afl1, agq1);
        }
    }
}
