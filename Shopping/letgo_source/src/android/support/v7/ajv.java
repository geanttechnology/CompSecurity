...
public final class ajv
{
    ...
    public static File a(Context context, boolean flag)
    {
        ...
        if (obj == null)
        {
            ...
            ajt.c("Can't define system cache directory! '%s' will be used.", new Object[] {
                context
            });
...
label0:
        {
            ...
            if (!file.exists())
            {
                ...
                ajt.c("Unable to create external cache directory", new Object[0]);
                context = null;
            }
            return context;
        }
        ...
        {
            ajt.b("Can't create \".nomedia\" file in application external cache directory", new Object[0]);
            return file;
        }
        return file;
    }
