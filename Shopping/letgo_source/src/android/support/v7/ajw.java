...
final class ajw
{
    ...
    static Map a(Object obj)
    {
        ...
        if (!((Map) (obj1)).isEmpty())
        {
            ...
            aka aka1;
            for (obj1 = ((Map) (obj1)).entrySet().iterator(); ((Iterator) (obj1)).hasNext(); hashmap.put(entry.getKey(), aka1))
            {
                entry = (java.util.Map.Entry)((Iterator) (obj1)).next();
                aka1 = new aka(obj, (Method)entry.getValue());
            }
    ...
    private static void a(Class class1)
    {
        ...
        while (i < j) 
        {
            ...
            if (!method.isBridge())
            {
                if (method.isAnnotationPresent(android/support/v7/akd))
                {
                ...
                if (method.isAnnotationPresent(android/support/v7/akc))
                {
    ...
    static Map b(Object obj)
    {
        ...
        if (!((Map) (obj1)).isEmpty())
        {
            ...
            for (obj1 = ((Map) (obj1)).entrySet().iterator(); ((Iterator) (obj1)).hasNext(); hashmap.put(entry.getKey(), hashset))
            {
                entry = (java.util.Map.Entry)((Iterator) (obj1)).next();
                hashset = new HashSet();
                for (Iterator iterator = ((Set)entry.getValue()).iterator(); iterator.hasNext(); hashset.add(new ajz(obj, (Method)iterator.next()))) { }
            }
