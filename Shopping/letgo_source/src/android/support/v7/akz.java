...
final class akz extends BitmapDrawable
{
    ...
    private final aky.d h;

    akz(Context context, Bitmap bitmap, Drawable drawable, aky.d d1, boolean flag, boolean flag1)
    {
    ...
    static void a(ImageView imageview, Context context, Bitmap bitmap, aky.d d1, boolean flag, boolean flag1)
    {
        ...
        imageview.setImageDrawable(new akz(context, bitmap, drawable, d1, flag, flag1));
    }
