...
public class amq
{
    static final class a extends Enum
    {
        ...
        static a a()
        {
            ...
            {
                alt.h().a("Fabric", "Architecture#getValue()::Build.CPU_ABI returned null or empty");
                obj = h;
            } else
            {
        ...
        {
            return (a)Enum.valueOf(android/support/v7/amq$a, s);
        }
...
_L7:
        obj = s;
        alt.h().e("Fabric", (new StringBuilder()).append("Error parsing ").append(file).toString(), exception);
...
label0:
        {
            ...
            {
                alt.h().e("Fabric", "Could not calculate hash for app icon.", inputstream);
                return "";
            }
        }
          goto _L1
    ...
    private static String a(byte abyte0[], String s)
    {
        ...
        {
            alt.h().e("Fabric", (new StringBuilder()).append("Could not create hashing algorithm: ").append(s).append(", returning empty string.").toString(), abyte0);
            return "";
        }
        ...
        throws InvalidKeyException
    {
        ...
        {
            alt.h().e("Fabric", "Could not create Cipher for AES/ECB/PKCS7Padding - should never happen.", s);
...
label1:
        {
          ...
          goto _L4
        alt.h().a("Fabric", (new StringBuilder()).append("Unexpected meminfo format while computing RAM: ").append(s).toString());
        l1 = l2;
          goto _L4
        NumberFormatException numberformatexception;
        numberformatexception;
        alt.h().e("Fabric", (new StringBuilder()).append("Unexpected meminfo format while computing RAM: ").append(s).toString(), numberformatexception);
        l1 = l2;
          goto _L4
        Exception exception;
        exception;
...
_L4:
        obj = context;
        alt.h().e("Fabric", "Could not calculate hash for app icon.", exception);
        a(context, "Failed to close icon input stream.");
        return null;
        context;
        obj = null;
...
_L3:
    ...
    public static String m(Context context)
    {
        ...
        if (i1 != 0)
        {
            ...
            alt.h().a("Fabric", (new StringBuilder()).append("Build ID is: ").append(s).toString());
        }
        return s;
    }
