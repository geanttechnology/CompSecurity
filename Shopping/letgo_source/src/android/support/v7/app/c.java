...
class android.support.v7.app.c
{
    public static class a
    {
        ...
        private void b(android.support.v7.app.c c1)
        {
            ListView listview = (ListView)b.inflate(android.support.v7.app.c.i(c1), null);
            Object obj;
            if (D)
            {
                if (H == null)
                {
                    obj = new ArrayAdapter(this, a, android.support.v7.app.c.j(c1), 0x1020014, s, listview) {
            ...
            
            {
                ...
                {
                    obj = new CursorAdapter(this, a, H, false, listview, c1) {
            ...
            } else
            {
                ...
                if (E)
                {
                    i1 = android.support.v7.app.c.k(c1);
                } else
                {
                    i1 = android.support.v7.app.c.l(c1);
                }
                if (H == null)
                {
                    if (t != null)
            ...
            android.support.v7.app.c.a(c1, F);
            if (u != null)
            {
                listview.setOnItemClickListener(new android.widget.AdapterView.OnItemClickListener(this, c1) {
            ...
            if (G != null)
            {
                listview.setOnItemClickListener(new android.widget.AdapterView.OnItemClickListener(this, listview, c1) {
        ...
        public void a(android.support.v7.app.c c1)
        {
...
_L9:
    ...
    public android.support.v7.app.c(Context context, l l1, Window window)
    {
        m = false;
        x = 0;
        E = -1;
        ...
        c = window;
        M = new b(l1);
        context = context.obtainStyledAttributes(null, android.support.v7.br.k.AlertDialog, android.support.v7.br.a.alertDialogStyle, 0);
        F = context.getResourceId(android.support.v7.br.k.AlertDialog_android_layout, 0);
        G = context.getResourceId(android.support.v7.br.k.AlertDialog_buttonPanelSideLayout, 0);
        H = context.getResourceId(android.support.v7.br.k.AlertDialog_listLayout, 0);
        I = context.getResourceId(android.support.v7.br.k.AlertDialog_multiChoiceItemLayout, 0);
        J = context.getResourceId(android.support.v7.br.k.AlertDialog_singleChoiceItemLayout, 0);
        K = context.getResourceId(android.support.v7.br.k.AlertDialog_listItemLayout, 0);
        context.recycle();
    }
    ...
    private static boolean a(Context context)
    {
        ...
        context.getTheme().resolveAttribute(android.support.v7.br.a.alertDialogCenterButtons, typedvalue, true);
    ...
    private boolean a(ViewGroup viewgroup)
    {
        if (C != null)
        {
            ...
            c.findViewById(android.support.v7.br.f.title_template).setVisibility(8);
            return true;
        }
        ...
        if (flag)
        {
            A = (TextView)c.findViewById(android.support.v7.br.f.alertTitle);
            A.setText(d);
            if (x != 0)
            {
    ...
    {
        w = (ScrollView)c.findViewById(android.support.v7.br.f.scrollView);
    ...
    {
        boolean flag = false;
        b((ViewGroup)c.findViewById(android.support.v7.br.f.contentPanel));
        boolean flag1 = d();
        Object obj = (ViewGroup)c.findViewById(android.support.v7.br.f.topPanel);
        q q1 = android.support.v7.internal.widget.q.a(a, null, android.support.v7.br.k.AlertDialog, android.support.v7.br.a.alertDialogStyle, 0);
        a(((ViewGroup) (obj)));
        obj = c.findViewById(android.support.v7.br.f.buttonPanel);
        if (!flag1)
        {
            ((View) (obj)).setVisibility(8);
            obj = c.findViewById(android.support.v7.br.f.textSpacerNoButtons);
            if (obj != null)
            {
                ((View) (obj)).setVisibility(0);
            }
        }
        FrameLayout framelayout = (FrameLayout)c.findViewById(android.support.v7.br.f.customPanel);
        if (g != null)
        {
            obj = g;
        } else
        ...
        if (flag)
        {
            FrameLayout framelayout1 = (FrameLayout)c.findViewById(android.support.v7.br.f.custom);
    ...
    static l g(android.support.v7.app.c c1)
    {
        return c1.b;
    }
