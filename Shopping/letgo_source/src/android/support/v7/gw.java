...
public class gw extends gx
{
    ...
    public gw(gh gh, String s, ParseUser parseuser)
    {
        super(gh, parseuser);
        c = s;
    }
    ...
    {
        b(context, "dummy-product-edit-start", b(c));
    }

    public void a(Context context, ProductInserted productinserted, String s)
    {
        a(context, "dummy-product-edit-complete", a(productinserted.getProductId(), productinserted.getSelectedCategoryId(), s));
    }

    public void a(Context context, String s)
    {
        a(context, "dummy-product-edit-form-validation-failed", a(s));
    }

    public void b(Context context, String s)
    {
        a.a(context, "dummy-product-edit-shared-fb", b(s), b);
    }
}
