...
{
    private class a extends android.support.v7.widget.ListPopupWindow.ForwardingListener
    {
    ...
    public ActionMenuItemView(Context context, AttributeSet attributeset, int l)
    {
        ...
        g = resources.getBoolean(android.support.v7.br.b.abc_config_allowActionMenuItemTextWithIcon);
        context = context.obtainStyledAttributes(attributeset, android.support.v7.br.k.ActionMenuItemView, l, 0);
        i = context.getDimensionPixelSize(android.support.v7.br.k.ActionMenuItemView_android_minWidth, 0);
        context.recycle();
...
label0:
    ...
    public void onConfigurationChanged(Configuration configuration)
    {
        ...
        g = getContext().getResources().getBoolean(android.support.v7.br.b.abc_config_allowActionMenuItemTextWithIcon);
        c();
    }
