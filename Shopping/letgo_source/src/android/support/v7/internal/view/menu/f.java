    ...
    implements af
{
    ...
    private h a(int i1, int j1, int k1, int l1, CharSequence charsequence, int i2)
    {
        return new h(this, i1, j1, k1, l1, charsequence, i2);
    }
...
_L5:
    ...
    {
        boolean flag1 = true;
        if (flag && f.getConfiguration().keyboard != 1 && f.getBoolean(android.support.v7.br.b.abc_config_showMenuShortcutsWhenKeyboardPresent))
        {
            flag = flag1;
        } else
        {
...
_L4:
    ...
    public void a(Bundle bundle)
    {
        ...
        for (sparsearray = null; i1 < j1; sparsearray = sparsearray2)
        {
            ...
            View view = android.support.v4.view.r.a(menuitem);
            ...
            if (view != null)
            {
                ...
                if (view.getId() != -1)
                {
                    ...
                    if (android.support.v4.view.r.c(menuitem))
                    {
    ...
    public void a(l l1, Context context)
    {
    ...
    {
        return a(menuitem, ((l) (null)), i1);
    }

    public boolean a(MenuItem menuitem, l l1, int i1)
    {
        Object obj;
        boolean flag1;
        boolean flag2;
...
_L5:
        if (((h) (obj)).hasSubMenu() || flag)
        {
            ...
            boolean flag4 = a(((p) (obj)), l1) | flag1;
            flag1 = flag4;
            if (!flag4)
            {
                a(true);
    ...
    public void b(Bundle bundle)
    {
        if (bundle != null)
        {
            ...
            if (j1 > 0)
            {
                ...
                if (bundle != null)
                {
                    android.support.v4.view.r.b(bundle);
                    return;
                }
            }
        }
    ...
    public boolean c(h h1)
    {
        ...
        if (!w.isEmpty())
        {
            ...
            do
            {
                ...
                flag1 = l1.expandItemActionView(this, h1);
                flag = flag1;
                if (!flag1)
                {
                    continue;
        ...
        if (!w.isEmpty())
        {
            ...
            } else
            {
                ...
                do
                {
                    ...
                    flag2 = l1.collapseItemActionView(this, h1);
                    flag1 = flag2;
                    if (!flag2)
                    {
                        continue;
