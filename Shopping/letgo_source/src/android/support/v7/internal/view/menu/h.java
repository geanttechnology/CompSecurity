    ...
    implements ag
{
    ...
    private int k;
    private f l;
    private android.support.v7.internal.view.menu.p m;
    private Runnable n;
    ...
    private View r;
    private d s;
    private android.support.v4.view.r.e t;
    private boolean u;
    ...
    public ag a(d d1)
    {
        ...
        if (s != null)
        {
            s.setVisibilityListener(new android.support.v4.view.d.b() {
    ...
    public ag a(android.support.v4.view.r.e e1)
    {
        t = e1;
        return this;
    }
    ...
    void a(android.support.v7.internal.view.menu.p p1)
    {
        m = p1;
...
_L5:
    ...
    public Drawable getIcon()
    {
        ...
        if (k != 0)
        {
            Drawable drawable = android.support.v7.internal.widget.p.a(l.e(), k);
            k = 0;
            j = drawable;
            return drawable;
        } else
