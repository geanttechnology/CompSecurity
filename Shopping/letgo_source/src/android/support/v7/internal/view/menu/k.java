    ...
    implements l, android.view.View.OnKeyListener, android.view.ViewTreeObserver.OnGlobalLayoutListener, android.widget.AdapterView.OnItemClickListener, android.widget.PopupWindow.OnDismissListener
{
    ...
    {
        this(context, f1, null, false, android.support.v7.br.a.popupMenuStyle);
    }

    public k(Context context, f f1, View view)
    {
        this(context, f1, view, false, android.support.v7.br.a.popupMenuStyle);
    }
    ...
    public k(Context context, f f1, View view, boolean flag, int i, int j)
    {
        ...
        mPopupMaxWidth = Math.max(resources.getDisplayMetrics().widthPixels / 2, resources.getDimensionPixelSize(android.support.v7.br.d.abc_config_prefDialogWidth));
        mAnchorView = view;
        f1.a(this, context);
    }
...
label0:
    ...
    public void onItemClick(AdapterView adapterview, View view, int i, long l1)
    {
        ...
        a.a(adapterview).a(adapterview.a(i), 0);
    }
...
_L2:
    ...
    static 
    {
        ITEM_LAYOUT = android.support.v7.br.h.abc_popup_menu_item_layout;
    }
