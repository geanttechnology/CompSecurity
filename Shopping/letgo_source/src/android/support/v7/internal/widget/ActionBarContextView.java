    ...
    implements bc
{
    ...
    {
        this(context, attributeset, android.support.v7.br.a.actionModeStyle);
    }

    public ActionBarContextView(Context context, AttributeSet attributeset, int i)
    {
        super(context, attributeset, i);
        context = android.support.v7.internal.widget.q.a(context, attributeset, android.support.v7.br.k.ActionMode, i, 0);
        setBackgroundDrawable(context.a(android.support.v7.br.k.ActionMode_background));
        q = context.f(android.support.v7.br.k.ActionMode_titleTextStyle, 0);
        r = context.f(android.support.v7.br.k.ActionMode_subtitleTextStyle, 0);
        h = context.e(android.support.v7.br.k.ActionMode_height, 0);
        s = context.a(android.support.v7.br.k.ActionMode_backgroundSplit);
        u = context.f(android.support.v7.br.k.ActionMode_closeItemLayout, android.support.v7.br.h.abc_action_mode_close_item_material);
        context.b();
    }
...
label0:
        {
            ...
            if (n == null)
            {
                LayoutInflater.from(getContext()).inflate(android.support.v7.br.h.abc_action_bar_title_item, this);
                n = (LinearLayout)getChildAt(getChildCount() - 1);
                o = (TextView)n.findViewById(android.support.v7.br.f.action_bar_title);
                p = (TextView)n.findViewById(android.support.v7.br.f.action_bar_subtitle);
                if (q != 0)
                {
    ...
    private cf g()
    {
        ah.a(l, -l.getWidth() - ((android.view.ViewGroup.MarginLayoutParams)l.getLayoutParams()).leftMargin);
        ay ay1 = ah.q(l).b(0.0F);
        ay1.a(200L);
        ay1.a(this);
        ay1.a(new DecelerateInterpolator());
        cf cf1 = new cf();
        cf1.a(ay1);
        if (c != null)
        {
    ...
    private cf h()
    {
        ay ay1 = ah.q(l).b(-l.getWidth() - ((android.view.ViewGroup.MarginLayoutParams)l.getLayoutParams()).leftMargin);
        ay1.a(200L);
        ay1.a(this);
        ay1.a(new DecelerateInterpolator());
        cf cf1 = new cf();
    ...
    public void a(cj cj1)
    {
        ...
        l.findViewById(android.support.v7.br.f.action_mode_close_button).setOnClickListener(new android.view.View.OnClickListener(cj1) {
        ...
        d.setReserveOverflow(true);
        layoutparams = new android.view.ViewGroup.LayoutParams(-2, -1);
        if (!f)
        {
            cj1.a(d, b);
            c = (ActionMenuView)d.getMenuView(this);
            c.setBackgroundDrawable(null);
            addView(c, layoutparams);
        } else
        {
            d.setWidthLimit(getContext().getResources().getDisplayMetrics().widthPixels, true);
            d.setItemLimit(0x7fffffff);
...
label0:
    ...
    {
        flag = android.support.v7.internal.widget.s.a(this);
        int l1;
        int i2;
        int j2;
        if (flag)
