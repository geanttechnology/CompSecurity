...
//            f, g, ActionBarContainer, ContentFrameLayout, 
//            s
    ...
    implements aa, f
{
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attributeset)
    {
        ...
        C = new Runnable() {
            ...
            public void run()
            {
                ...
                ActionBarOverlayLayout.a(a, ah.q(ActionBarOverlayLayout.c(a)).c(0.0F).a(ActionBarOverlayLayout.b(a)));
                if (ActionBarOverlayLayout.d(a) != null && ActionBarOverlayLayout.d(a).getVisibility() != 8)
                {
                    ActionBarOverlayLayout.b(a, ah.q(ActionBarOverlayLayout.d(a)).c(0.0F).a(ActionBarOverlayLayout.e(a)));
                }
            }
    ...
    static ay a(ActionBarOverlayLayout actionbaroverlaylayout, ay ay1)
    {
        actionbaroverlaylayout.y = ay1;
        return ay1;
    }
    ...
    private void a(Context context)
    {
        ...
        i = flag;
        x = android.support.v4.widget.o.a(context);
    }
    ...
    static ay b(ActionBarOverlayLayout actionbaroverlaylayout, ay ay1)
    {
        actionbaroverlaylayout.z = ay1;
        return ay1;
    }

    static bc b(ActionBarOverlayLayout actionbaroverlaylayout)
    {
    ...
    static bc e(ActionBarOverlayLayout actionbaroverlaylayout)
    {
    ...
    void c()
    {
        if (d == null)
        {
            d = (ContentFrameLayout)findViewById(android.support.v7.br.f.action_bar_activity_content);
            f = (ActionBarContainer)findViewById(android.support.v7.br.f.action_bar_container);
            g = a(findViewById(android.support.v7.br.f.action_bar));
            e = (ActionBarContainer)findViewById(android.support.v7.br.f.split_action_bar);
        }
    }
    ...
    public void draw(Canvas canvas)
    {
        ...
        if (h != null && !i)
        {
            ...
            {
                i1 = (int)((float)f.getBottom() + ah.n(f) + 0.5F);
            } else
            {
                i1 = 0;
            }
    ...
    protected boolean fitSystemWindows(Rect rect)
    {
        ...
        s.set(rect);
        android.support.v7.internal.widget.s.a(this, s, p);
        if (!q.equals(p))
        {
            q.set(p);
            flag = true;
    ...
    protected void onMeasure(int i1, int j1)
    {
        ...
        int k2 = Math.max(0, f.getMeasuredWidth() + ((LayoutParams) (obj)).leftMargin + ((LayoutParams) (obj)).rightMargin);
        int k1 = f.getMeasuredHeight();
        int l1 = ((LayoutParams) (obj)).topMargin;
        int j2 = Math.max(0, ((LayoutParams) (obj)).bottomMargin + (k1 + l1));
        int i2 = android.support.v7.internal.widget.s.a(0, ah.j(f));
        if (e != null)
        {
            measureChildWithMargins(e, i1, 0, j1, 0);
            obj = (LayoutParams)e.getLayoutParams();
            k2 = Math.max(k2, e.getMeasuredWidth() + ((LayoutParams) (obj)).leftMargin + ((LayoutParams) (obj)).rightMargin);
            k1 = e.getMeasuredHeight();
            l1 = ((LayoutParams) (obj)).topMargin;
            j2 = Math.max(j2, ((LayoutParams) (obj)).bottomMargin + (k1 + l1));
            i2 = android.support.v7.internal.widget.s.a(i2, ah.j(e));
        }
        boolean flag;
        if ((ah.t(this) & 0x100) != 0)
        {
        ...
        k1 = Math.max(k2, d.getMeasuredWidth() + ((LayoutParams) (obj)).leftMargin + ((LayoutParams) (obj)).rightMargin);
        l1 = d.getMeasuredHeight();
        k2 = ((LayoutParams) (obj)).topMargin;
        l1 = Math.max(j2, ((LayoutParams) (obj)).bottomMargin + (l1 + k2));
        i2 = android.support.v7.internal.widget.s.a(i2, ah.j(d));
        j2 = getPaddingLeft();
        k2 = getPaddingRight();
        l1 = Math.max(l1 + (getPaddingTop() + getPaddingBottom()), getSuggestedMinimumHeight());
        setMeasuredDimension(ah.a(Math.max(k1 + (j2 + k2), getSuggestedMinimumWidth()), i1, i2), ah.a(l1, j1, i2 << 16));
    }
    ...
    {
        a = (new int[] {
            android.support.v7.br.a.actionBarSize, 0x1010059
        });
    }
}
