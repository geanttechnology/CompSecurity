...
_L2:
        ...
        aobj;
        Log.e(d.d(), (new StringBuilder()).append("Error writing historical recrod file: ").append(((String) (obj1))).toString(), ((Throwable) (aobj)));
_L3:
        return null;
_L1:
        ...
        Object obj;
        obj;
        Log.e(d.d(), (new StringBuilder()).append("Error writing historical recrod file: ").append(d.b(a)).toString(), ((Throwable) (obj)));
        d.a(a, true);
        if (aobj != null)
        {
            try
