...
public class q
{
    ...
    public static q a(Context context, AttributeSet attributeset, int ai[])
    {
        return new q(context, context.obtainStyledAttributes(attributeset, ai));
    }

    public static q a(Context context, AttributeSet attributeset, int ai[], int i, int j)
    {
        return new q(context, context.obtainStyledAttributes(attributeset, ai, i, j));
    }
