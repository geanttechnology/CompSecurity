...
public class jb
{
    private class a
    {
        ...
        private String a()
        {
            ...
            try
            {
                s = jb.a(a).getPackageManager().getPackageInfo(jb.a(a).getPackageName(), 0).versionName;
            }
        ...
        private String g()
        {
            return ((TelephonyManager)jb.a(a).getSystemService("phone")).getNetworkOperatorName();
        }
...
_L1:
        ...
        {
            Object obj;
            obj = (TelephonyManager)jb.a(a).getSystemService("phone");
