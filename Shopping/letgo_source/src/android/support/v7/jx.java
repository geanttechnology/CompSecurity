...
public final class jx
{
    ...
    private static abstract class c
    {
        ...
        private void a(boolean flag)
        {
            ...
            b = android.support.v7.jx.a(this);
            this;
...
label1:
                {
                    ...
                    s = android.support.v7.kb.a(context[l].toByteArray());
                    if (a.contains(s))
                    {
                        break label0;
                    }
...
_L2:
        ...
        do
        {
            ...
            s1 = (c)iterator.next();
            intent = a(context, (new Intent()).setAction(s).setPackage(s1.a()).addCategory("android.intent.category.DEFAULT"), ((c) (s1)));
            s1 = intent;
        } while (intent == null);
...
_L3:
    ...
    {
        context = a(context, "com.facebook.platform.PLATFORM_ACTIVITY", s1);
        if (context == null)
        {
            return null;
        } else
        {
            a(((Intent) (context)), s, s1, j, bundle);
            return context;
        }
    }
    ...
    public static Intent a(Context context, String s, Collection collection, String s1, boolean flag, boolean flag1, com.facebook.login.a a1)
    {
        for (Iterator iterator = b.iterator(); iterator.hasNext();)
        {
            ...
            if (!android.support.v7.kb.a(collection))
            {
                intent.putExtra("scope", TextUtils.join(",", collection));
            }
            if (!android.support.v7.kb.a(s1))
            {
    ...
    public static void a(Intent intent, String s, String s1, int j, Bundle bundle)
    {
        ...
        if (a(j))
        {
            ...
            android.support.v7.kb.a(s1, "app_name", s2);
    ...
    private static TreeSet b(c c1)
    {
        ...
        obj1 = null;
        treeset = new TreeSet();
        obj = k.f().getContentResolver();
        uri = c(c1);
        if (k.f().getPackageManager().resolveContentProvider((new StringBuilder()).append(c1.a()).append(".provider.PlatformProvider").toString(), 0) == null) goto _L2; else goto _L1
_L1:
    ...
    public static void b()
    {
        ...
        } else
        {
            k.d().execute(new Runnable() {
                ...
                public void run()
                {
                    for (Iterator iterator = jx.c().iterator(); iterator.hasNext(); android.support.v7.c.a((c)iterator.next(), true)) { }
