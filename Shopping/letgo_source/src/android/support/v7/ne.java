...
public class ne
{
    ...
    public static void a(String as[], int i, int j, PriorityQueue priorityqueue)
    {
        ...
        {
            l = a(nc.a(as[k - 1]), nc.a(as[(k + j) - 1]), l, l1, 0x1001fffL);
    ...
    {
        long l = ((long)nc.a(as[i]) + 0x7fffffffL) % 0x4000ffffL;
        for (int k = i + 1; k < i + j; k++)
        {
            l = ((l * 0x1001fffL) % 0x4000ffffL + ((long)nc.a(as[k]) + 0x7fffffffL) % 0x4000ffffL) % 0x4000ffffL;
        }
