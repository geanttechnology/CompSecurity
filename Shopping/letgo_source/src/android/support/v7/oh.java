    ...
    extends IInterface
{
        ...
        implements oh
    {
        ...
        public static oh zzy(IBinder ibinder)
        {
            if (ibinder == null)
            {
                return null;
            ...
            if (iinterface != null && (iinterface instanceof oh))
            {
                return (oh)iinterface;
            } else
            {
        ...
        implements oh
    {
            ...
            throws RemoteException
        {
            ...
            parcel1.readException();
            s = nz.a.zzt(parcel1.readStrongBinder());
            parcel1.recycle();
            parcel.recycle();
            return s;
            s;
    ...
    public abstract nz zzT(String s)
        throws RemoteException;
}
