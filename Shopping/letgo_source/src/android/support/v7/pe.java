...
_L2:
    ...
    public pe(oz oz1, zze zze1, qo qo1)
    {
        a = oz1;
        b = zze1;
        c = qo1;
    ...
    private static void a(ul ul1, Map map)
    {
    ...
    public void zza(ul ul1, Map map)
    {
        ...
        } else
        {
            ...
            {
                ul1 = (String)map.get("u");
                a(false);
                if (ul1 != null)
                {
                    um1.a(a(map), b(map), ul1);
                    return;
                } else
                {
                    um1.a(a(map), b(map), (String)map.get("html"), (String)map.get("baseurl"));
                    return;
                }
            }
            if ("in_app_purchase".equalsIgnoreCase(s))
            {
                ul1 = (String)map.get("product_id");
                ...
                if (a != null)
                {
                    ...
                    {
                        map = map.split(" ");
                        a.zza(ul1, new ArrayList(Arrays.asList(map)));
                        return;
                    } else
                    {
                        a.zza(ul1, new ArrayList());
                        return;
                    }
                }
            } else
            {
                ...
                if (!TextUtils.isEmpty(s))
                {
                    ...
                    {
                        s1 = s;
                        if (mc1.b(Uri.parse(s)))
                        {
                            s1 = zzp.zzbx().b(ul1.getContext(), s, ul1.r());
                        }
                    }
                    ul1 = zzp.zzbx().a(ul1, s1);
                } else
                {
                    ul1 = s;
                }
                um1.a(new AdLauncherIntentInfoParcel((String)map.get("i"), ul1, (String)map.get("m"), (String)map.get("p"), (String)map.get("c"), (String)map.get("f"), (String)map.get("e")));
                return;
            }
        }
    }
