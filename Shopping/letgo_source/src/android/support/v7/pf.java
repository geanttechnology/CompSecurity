...
_L2:
        ...
        if (flag || flag1)
        {
            ...
            if (flag && ((zzd) (obj)).zzew() == null)
            {
                ...
                if (a.containsKey(ul1))
                {
                    j = ((Integer)a.get(ul1)).intValue();
        ...
        } else
        {
            ...
            if (obj == null)
            {
                com.google.android.gms.ads.internal.overlay.zzk.zzd(ul1);
                return;
            }
            if ("click".equals(obj1))
            {
                ul1 = ul1.getContext();
                int k = a(ul1, map, "x", 0);
                int i1 = a(ul1, map, "y", 0);
                long l2 = SystemClock.uptimeMillis();
                ul1 = MotionEvent.obtain(l2, l2, 0, k, i1, 0);
                ((com.google.android.gms.ads.internal.overlay.zzk) (obj)).zzd(ul1);
                ul1.recycle();
                return;
            }
            if ("currentTime".equals(obj1))
            {
                ul1 = (String)map.get("time");
                if (ul1 == null)
                {
                ...
                try
                {
                    ((com.google.android.gms.ads.internal.overlay.zzk) (obj)).seekTo((int)(Float.parseFloat(ul1) * 1000F));
                    return;
                }
                // Misplaced declaration of an exception variable
                catch (Map map)
                {
                    zzb.zzaE((new StringBuilder()).append("Could not parse time parameter from currentTime video GMSG: ").append(ul1).toString());
                }
                return;
            }
            if ("hide".equals(obj1))
            ...
            if ("volume".equals(obj1))
            {
                ...
                try
                {
                    ((com.google.android.gms.ads.internal.overlay.zzk) (obj)).zza(Float.parseFloat(ul1));
                    return;
                }
                // Misplaced declaration of an exception variable
                catch (Map map)
                {
                    zzb.zzaE((new StringBuilder()).append("Could not parse volume parameter from volume video GMSG: ").append(ul1).toString());
                }
                return;
            }
