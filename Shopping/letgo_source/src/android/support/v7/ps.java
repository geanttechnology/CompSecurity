...
public final class ps
{
        ...
        throws JSONException
    {
        ...
        {
            pq pq1 = new pq(jsonarray.getJSONObject(l));
            arraylist.add(pq1);
            int j1 = i1;
            if (i1 < 0)
            {
    ...
    private boolean a(pq pq1)
    {
        for (pq1 = pq1.c.iterator(); pq1.hasNext();)
        {
            if (((String)pq1.next()).equals("com.google.ads.mediation.admob.AdMobAdapter"))
            {
                return true;
            }
        }
