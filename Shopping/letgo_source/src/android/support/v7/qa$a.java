...
_L1:
            ...
            throws RemoteException
        {
            ...
            parcel1.readException();
            qc1 = qc.a.a(parcel1.readStrongBinder());
            parcel1.recycle();
            parcel.recycle();
            return qc1;
            Exception exception;
            ...
            throws RemoteException
        {
            ...
            parcel1.readException();
            qd1 = qd.a.a(parcel1.readStrongBinder());
            parcel1.recycle();
            parcel.recycle();
            return qd1;
            Exception exception;
        ...
        throws RemoteException
    {
        ...
        case 1: // '\001'
            ...
            a(lk3, ((AdSizeParcel) (obj)), ((AdRequestParcel) (obj1)), parcel.readString(), a(parcel.readStrongBinder()));
        ...
        case 3: // '\003'
            ...
            a(lk3, ((AdRequestParcel) (obj)), parcel.readString(), a(parcel.readStrongBinder()));
            parcel1.writeNoException();
            return true;
        ...
        case 6: // '\006'
            ...
            a(lk3, ((AdSizeParcel) (obj)), adrequestparcel, parcel.readString(), parcel.readString(), a(parcel.readStrongBinder()));
            parcel1.writeNoException();
            return true;

        case 7: // '\007'
            parcel.enforceInterface("com.google.android.gms.ads.internal.mediation.client.IMediationAdapter");
            lk lk1 = a(parcel.readStrongBinder());
            if (parcel.readInt() != 0)
            {
                obj = AdRequestParcel.CREATOR.zzb(parcel);
            } else
            ...
            a(lk1, ((AdRequestParcel) (obj)), parcel.readString(), parcel.readString(), a(parcel.readStrongBinder()));
            parcel1.writeNoException();
            return true;
        ...
        case 10: // '\n'
            parcel.enforceInterface("com.google.android.gms.ads.internal.mediation.client.IMediationAdapter");
            lk lk2 = a(parcel.readStrongBinder());
            if (parcel.readInt() != 0)
            {
                obj = AdRequestParcel.CREATOR.zzb(parcel);
            } else
            ...
            a(lk2, ((AdRequestParcel) (obj)), parcel.readString(), com.google.android.gms.ads.internal.reward.mediation.client.za.zzad(parcel.readStrongBinder()), parcel.readString());
            parcel1.writeNoException();
            return true;
