    ...
    implements Thread.UncaughtExceptionHandler
{
    ...
    public sd(Context context, VersionInfoParcel versioninfoparcel, Thread.UncaughtExceptionHandler uncaughtexceptionhandler, Thread.UncaughtExceptionHandler uncaughtexceptionhandler1)
    {
    ...
    public static sd a(Context context, Thread thread, VersionInfoParcel versioninfoparcel)
    {
        ...
        context = new sd(context, versioninfoparcel, uncaughtexceptionhandler, Thread.getDefaultUncaughtExceptionHandler());
        if (uncaughtexceptionhandler == null || !(uncaughtexceptionhandler instanceof sd))
        {
            try
            {
        ...
        {
            return (sd)uncaughtexceptionhandler;
        }
    }

    private static boolean a(Context context)
    {
        return ((Boolean)nn.g.c()).booleanValue();
    }

    private Throwable b(Throwable throwable)
    {
        if (((Boolean)nn.h.c()).booleanValue())
        {
            return throwable;
        }
    ...
    protected boolean a(String s)
    {
        ...
        try
        {
            flag = Class.forName(s).isAnnotationPresent(android/support/v7/se);
        }
