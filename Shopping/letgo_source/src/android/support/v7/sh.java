...
_L16:
        obj = android.support.v7.sg.a(adrequestinfoparcel, context, adrequestinfoparcel.zzqb.zzIz, s2, null, null, null, null);
...
_L1:
        if (s.a().f()) goto _L3; else goto _L2
_L2:
...
_L7:
    ...
    public static JSONObject a(Context context, AdRequestInfoParcel adrequestinfoparcel, sl sl1, sn.a a1, Location location, ng ng1, String s, String s1, 
            List list)
    {
...
_L1:
        int j = (int)((float)adsizeparcel.widthPixels / sl1.r);
_L4:
        list.append(j);
        list.append("x");
        ...
        j = (int)((float)adsizeparcel.heightPixels / sl1.r);
_L5:
        list.append(j);
        i++;
          goto _L3
_L2:
        ...
        a(((HashMap) (location)), sl1, a1);
        location.put("fdz", Integer.valueOf(ng1.b()));
...
_L11:
        if (((Boolean)nn.V.c()).booleanValue() && adrequestinfoparcel.zzDM)
        {
...
_L7:
        location.put("u_sd", Float.valueOf(sl1.r));
        location.put("sh", Integer.valueOf(sl1.t));
        location.put("sw", Integer.valueOf(sl1.s));
          goto _L10
        context;
    ...
    {
        if (!((Boolean)nn.P.c()).booleanValue())
        {
...
_L4:
        bundle.putString("app_uri", android.support.v7.lh.a(s, Uri.parse(((DocumentSection) (usageinfo)).c)).toString());
        return;
    }
    ...
    private static void a(HashMap hashmap, Location location)
    {
        ...
        hashmap1.put("radius", Float.valueOf(f1 * 1000F));
    ...
    private static void a(HashMap hashmap, sl sl1, sn.a a1)
    {
        hashmap.put("am", Integer.valueOf(sl1.a));
        hashmap.put("cog", a(sl1.b));
        hashmap.put("coh", a(sl1.c));
        if (!TextUtils.isEmpty(sl1.d))
        {
            hashmap.put("carrier", sl1.d);
        }
        hashmap.put("gl", sl1.e);
        if (sl1.f)
        {
        ...
        hashmap.put("ma", a(sl1.h));
        hashmap.put("sp", a(sl1.i));
        hashmap.put("hl", sl1.j);
        if (!TextUtils.isEmpty(sl1.k))
        {
            hashmap.put("mv", sl1.k);
        }
        hashmap.put("muv", Integer.valueOf(sl1.l));
        if (sl1.m != -2)
        {
            hashmap.put("cnt", Integer.valueOf(sl1.m));
        }
        hashmap.put("gnt", Integer.valueOf(sl1.n));
        hashmap.put("pt", Integer.valueOf(sl1.o));
        hashmap.put("rm", Integer.valueOf(sl1.p));
        hashmap.put("riv", Integer.valueOf(sl1.q));
        Bundle bundle = new Bundle();
        bundle.putString("build", sl1.y);
        Bundle bundle1 = new Bundle();
        bundle1.putBoolean("is_charging", sl1.v);
        bundle1.putDouble("battery_level", sl1.u);
        bundle.putBundle("battery", bundle1);
        bundle1 = new Bundle();
        bundle1.putInt("active_network_state", sl1.x);
        bundle1.putBoolean("active_network_metered", sl1.w);
        if (a1 != null)
        {
            sl1 = new Bundle();
            sl1.putInt("predicted_latency_micros", a1.a);
            sl1.putLong("predicted_down_throughput_bps", a1.b);
            sl1.putLong("predicted_up_throughput_bps", a1.c);
            bundle1.putBundle("predictions", sl1);
        }
    ...
    {
        String s = android.support.v7.tk.a();
        if (s != null)
        {
            hashmap.put("abf", s);
        }
