...
public class uo extends WebView
    implements ul, android.view.ViewTreeObserver.OnGlobalLayoutListener, DownloadListener
{
    ...
    protected uo(a a1, AdSizeParcel adsizeparcel, boolean flag, boolean flag1, mc mc1, VersionInfoParcel versioninfoparcel, com.google.android.gms.ads.internal.zzd zzd1)
    {
        super(a1);
        o = true;
        p = "";
        ...
        if (vs.e())
        {
            addJavascriptInterface(new up(this), "googleAdsJsInterface");
        }
        s = new tz(b.a(), this, null);
    }

    static uo a(Context context, AdSizeParcel adsizeparcel, boolean flag, boolean flag1, mc mc1, VersionInfoParcel versioninfoparcel, com.google.android.gms.ads.internal.zzd zzd1)
    {
        return new uo(new a(context), adsizeparcel, flag, flag1, mc1, versioninfoparcel, zzd1);
    }

    static void a(uo uo1)
    {
        uo1.WebView.destroy();
    }
...
label0:
    ...
    private void y()
    {
        ...
        if (x != null)
        {
            for (Iterator iterator = x.values().iterator(); iterator.hasNext(); ((pi)iterator.next()).b()) { }
        }
    ...
    public void a(mn mn, boolean flag)
    {
    ...
    public boolean s()
    {
        if (i().b())
        {
            ...
            if (u != k1 || t != l1 || v != i1 || w != j1)
            {
                ...
                v = i1;
                w = j1;
                (new qu(this)).a(k1, l1, i1, j1, displaymetrics.density, y.getDefaultDisplay().getRotation());
                return flag;
            }
        }
        return false;
