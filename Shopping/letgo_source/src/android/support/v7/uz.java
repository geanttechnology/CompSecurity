        ...
        implements uz
    {
            ...
            throws RemoteException
        {
            ...
            case 1: // '\001'
                ...
                a(android.support.v7.va.a.a(parcel.readStrongBinder()), parcel.readString(), (UsageInfo[])parcel.createTypedArray(UsageInfo.CREATOR));
                parcel1.writeNoException();
                return true;

            case 2: // '\002'
                parcel.enforceInterface("com.google.android.gms.appdatasearch.internal.ILightweightAppDataSearch");
                a(android.support.v7.va.a.a(parcel.readStrongBinder()));
                parcel1.writeNoException();
                return true;

            case 3: // '\003'
                parcel.enforceInterface("com.google.android.gms.appdatasearch.internal.ILightweightAppDataSearch");
                b(android.support.v7.va.a.a(parcel.readStrongBinder()));
                parcel1.writeNoException();
                return true;

            case 4: // '\004'
                parcel.enforceInterface("com.google.android.gms.appdatasearch.internal.ILightweightAppDataSearch");
                va va = android.support.v7.va.a.a(parcel.readStrongBinder());
                boolean flag;
                if (parcel.readInt() != 0)
                {
                    flag = true;
            ...
            case 5: // '\005'
                ...
                if (parcel.readInt() != 0)
                {
                    request = com.google.android.gms.appdatasearch.GetRecentContextCall.Request.CREATOR.a(parcel);
                } else
                {
                    request = null;
                }
                a(request, android.support.v7.va.a.a(parcel.readStrongBinder()));
                parcel1.writeNoException();
                return true;

            case 6: // '\006'
                parcel.enforceInterface("com.google.android.gms.appdatasearch.internal.ILightweightAppDataSearch");
                a(android.support.v7.va.a.a(parcel.readStrongBinder()), parcel.readString(), parcel.readString());
                parcel1.writeNoException();
                return true;
            }
        }
...
_L1:
    ...
    public abstract void a(va va, String s, String s1)
        throws RemoteException;

    public abstract void a(va va, String s, UsageInfo ausageinfo[])
        throws RemoteException;

    public abstract void a(va va, boolean flag)
        throws RemoteException;

    public abstract void a(com.google.android.gms.appdatasearch.GetRecentContextCall.Request request, va va)
        throws RemoteException;

    public abstract void b(va va)
        throws RemoteException;
}
