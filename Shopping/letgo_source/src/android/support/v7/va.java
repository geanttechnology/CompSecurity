    ...
    extends IInterface
{
        ...
        implements va
    {
        ...
        public static va a(IBinder ibinder)
        {
            if (ibinder == null)
            {
                return null;
            ...
            if (iinterface != null && (iinterface instanceof va))
            {
                return (va)iinterface;
            } else
            {
            ...
            throws RemoteException
        {
            ...
            if (parcel.readInt() != 0)
            {
                parcel1 = com.google.android.gms.appdatasearch.GetRecentContextCall.Response.CREATOR.a(parcel);
            }
            a(parcel1);
            return true;
        }
        ...
        implements va
    {
        ...
        public void a(com.google.android.gms.appdatasearch.GetRecentContextCall.Response response)
            throws RemoteException
        {
