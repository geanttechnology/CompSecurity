...
abstract class vj
{
        ...
        implements Set
    {
        ...
        public boolean contains(Object obj)
        {
            if (obj instanceof java.util.Map.Entry)
            {
                ...
                if (i >= 0)
                {
                    return vi.a(a.a(i, 1), ((java.util.Map.Entry) (obj)).getValue());
                }
            }
            return false;
        }
        ...
        implements Set
    {
        ...
        public boolean removeAll(Collection collection)
        {
            return vj.b(a.b(), collection);
        }

        public boolean retainAll(Collection collection)
        {
            return vj.c(a.b(), collection);
        }
        ...
        implements Iterator, java.util.Map.Entry
    {
        ...
        public final boolean equals(Object obj)
        {
            ...
            obj = (java.util.Map.Entry)obj;
            if (!vi.a(((java.util.Map.Entry) (obj)).getKey(), d.a(b, 0)) || !vi.a(((java.util.Map.Entry) (obj)).getValue(), d.a(b, 1)))
            {
                flag = false;
            }
            return flag;
