...
public class AppCompatRatingBar extends RatingBar
{
    ...
    {
        this(context, attributeset, android.support.v7.br.a.ratingBarStyle);
    }
    ...
    {
        boolean flag1 = false;
        if (!(drawable instanceof aa)) goto _L2; else goto _L1
_L1:
        Drawable drawable1 = ((aa)drawable).a();
        if (drawable1 != null)
        {
            drawable1 = tileify(drawable1, flag);
            ((aa)drawable).a(drawable1);
        }
_L4:
        return drawable;
_L2:
...
_L6:
    ...
    protected void onMeasure(int i, int j)
    {
        ...
        if (mSampleTile != null)
        {
            setMeasuredDimension(ah.a(mSampleTile.getWidth() * getNumStars(), i, 0), getMeasuredHeight());
        }
        this;
