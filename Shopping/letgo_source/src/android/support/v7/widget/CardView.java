    ...
    implements CardViewDelegate
{
    ...
    {
        attributeset = context.obtainStyledAttributes(attributeset, android.support.v7.bs.d.CardView, i, android.support.v7.bs.c.CardView_Light);
        i = attributeset.getColor(android.support.v7.bs.d.CardView_cardBackgroundColor, 0);
        float f3 = attributeset.getDimension(android.support.v7.bs.d.CardView_cardCornerRadius, 0.0F);
        float f1 = attributeset.getDimension(android.support.v7.bs.d.CardView_cardElevation, 0.0F);
        float f2 = attributeset.getDimension(android.support.v7.bs.d.CardView_cardMaxElevation, 0.0F);
        mCompatPadding = attributeset.getBoolean(android.support.v7.bs.d.CardView_cardUseCompatPadding, false);
        mPreventCornerOverlap = attributeset.getBoolean(android.support.v7.bs.d.CardView_cardPreventCornerOverlap, true);
        int j = attributeset.getDimensionPixelSize(android.support.v7.bs.d.CardView_contentPadding, 0);
        mContentPadding.left = attributeset.getDimensionPixelSize(android.support.v7.bs.d.CardView_contentPaddingLeft, j);
        mContentPadding.top = attributeset.getDimensionPixelSize(android.support.v7.bs.d.CardView_contentPaddingTop, j);
        mContentPadding.right = attributeset.getDimensionPixelSize(android.support.v7.bs.d.CardView_contentPaddingRight, j);
        mContentPadding.bottom = attributeset.getDimensionPixelSize(android.support.v7.bs.d.CardView_contentPaddingBottom, j);
        float f = f2;
        if (f1 > f2)
        {
            f = f1;
