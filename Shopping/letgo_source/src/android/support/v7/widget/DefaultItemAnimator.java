...
public class DefaultItemAnimator extends RecyclerView.ItemAnimator
{
    ...
    {
        final ay animation = ah.q(holder.itemView);
    ...
    private void animateChangeImpl(final ChangeInfo changeInfo)
    {
        ...
        if (oldViewAnim != null)
        {
            oldViewAnim = ah.q(((View) (oldViewAnim))).a(getChangeDuration());
            mChangeAnimations.add(changeInfo.oldHolder);
            ((ay) (oldViewAnim)).b(changeInfo.toX - changeInfo.fromX);
            ((ay) (oldViewAnim)).c(changeInfo.toY - changeInfo.fromY);
            ((ay) (oldViewAnim)).a(0.0F).a(new VpaListenerAdapter() {
        ...
        if (newView != null)
        {
            oldViewAnim = ah.q(newView);
            mChangeAnimations.add(changeInfo.newHolder);
            ((ay) (oldViewAnim)).b(0.0F).c(0.0F).a(getChangeDuration()).a(1.0F).a(new VpaListenerAdapter() {
    ...
    {
        final ay animation = holder.itemView;
        deltaX = i - deltaX;
        deltaY = j - deltaY;
        if (deltaX != 0)
        {
            ah.q(animation).b(0.0F);
        }
        if (deltaY != 0)
        {
            ah.q(animation).c(0.0F);
        }
        animation = ah.q(animation);
...
_L6:
        ah.c(viewholder.itemView, 1.0F);
        ah.a(viewholder.itemView, 0.0F);
        ah.b(viewholder.itemView, 0.0F);
...
_L5:
    ...
    {
        float f = ah.m(viewholder.itemView);
        float f1 = ah.n(viewholder.itemView);
        float f2 = ah.f(viewholder.itemView);
        endAnimation(viewholder);
        int i1 = (int)((float)(k - i) - f);
        int j1 = (int)((float)(l - j) - f1);
        ah.a(viewholder.itemView, f);
        ah.b(viewholder.itemView, f1);
        ah.c(viewholder.itemView, f2);
        if (viewholder1 != null && viewholder1.itemView != null)
        {
            endAnimation(viewholder1);
            ah.a(viewholder1.itemView, -i1);
            ah.b(viewholder1.itemView, -j1);
            ah.c(viewholder1.itemView, 0.0F);
        }
    ...
    public boolean animateMove(RecyclerView.ViewHolder viewholder, int i, int j, int k, int l)
    {
        ...
        i = (int)((float)i + ah.m(viewholder.itemView));
        j = (int)((float)j + ah.n(viewholder.itemView));
        endAnimation(viewholder);
        int i1 = k - i;
        int j1 = l - j;
        if (i1 == 0 && j1 == 0)
    ...
    void cancelAll(List list)
    {
        for (int i = list.size() - 1; i >= 0; i--)
        {
            ah.q(((RecyclerView.ViewHolder)list.get(i)).itemView).a();
        }
    ...
    public void endAnimations()
    {
        ...
        for (int j1 = mAdditionsList.size() - 1; j1 >= 0; j1--)
        {
            ...
            for (int i2 = arraylist1.size() - 1; i2 >= 0; i2--)
            {
                ...
                ah.c(viewholder1.itemView, 1.0F);
    ...
    public void runPendingAnimations()
    {
        ...
        if (flag || flag1 || flag3 || flag2)
        {
            ...
            
            {
                ...
                if (flag)
                {
                    ah.a(((MoveInfo)moves.get(0)).holder.itemView, runnable, getRemoveDuration());
                } else
                {
                    runnable.run();
                }
            ...
            
            {
                ...
                if (flag)
                {
                    ah.a(((ChangeInfo)changes.get(0)).oldHolder.itemView, runnable, getRemoveDuration());
                } else
                {
                    runnable.run();
                }
            ...
            
            {
                ...
                if (flag || flag1 || flag2)
                {
                    ...
                    l1 = Math.max(l1, l2);
                    ah.a(((RecyclerView.ViewHolder)additions.get(0)).itemView, runnable, l + l1);
                    return;
                } else
                {
                    runnable.run();
