...
_L5:
        ...
        while (k < j2) 
        {
            ...
            if (mOrientationHelper.getDecoratedMeasurement(recycler) != j)
            {
                ...
                if (mOrientation == 1)
                {
                    measureChildWithDecorationsAndMargin(recycler, l1, j1);
                } else
                {
                    measureChildWithDecorationsAndMargin(recycler, j1, l1);
                }
            }
            k++;
        }
    ...
    public void onInitializeAccessibilityNodeInfoForItem(RecyclerView.Recycler recycler, RecyclerView.State state, View view, be be1)
    {
        android.view.ViewGroup.LayoutParams layoutparams = view.getLayoutParams();
        if (!(layoutparams instanceof LayoutParams))
        {
            super.onInitializeAccessibilityNodeInfoForItem(view, be1);
            return;
        }
        ...
        if (mOrientation == 0)
        {
            ...
            be1.c(android.support.v7.be.j.a(j, l, i, 1, flag, false));
            return;
        }
        ...
        be1.c(android.support.v7.be.j.a(i, 1, k, i1, flag1, false));
    }
