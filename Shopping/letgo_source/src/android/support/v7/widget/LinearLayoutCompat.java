...
public class LinearLayoutCompat extends ViewGroup
{
    ...
    public static class LayoutParams extends android.view.ViewGroup.MarginLayoutParams
    {
        ...
        public LayoutParams(Context context, AttributeSet attributeset)
        {
            ...
            gravity = -1;
            context = context.obtainStyledAttributes(attributeset, android.support.v7.br.k.LinearLayoutCompat_Layout);
            weight = context.getFloat(android.support.v7.br.k.LinearLayoutCompat_Layout_android_layout_weight, 0.0F);
            gravity = context.getInt(android.support.v7.br.k.LinearLayoutCompat_Layout_android_layout_gravity, -1);
            context.recycle();
        }
    ...
    public LinearLayoutCompat(Context context, AttributeSet attributeset, int i)
    {
        ...
        mBaselineChildTop = 0;
        mGravity = 0x800033;
        context = q.a(context, attributeset, android.support.v7.br.k.LinearLayoutCompat, i, 0);
        i = context.a(android.support.v7.br.k.LinearLayoutCompat_android_orientation, -1);
        if (i >= 0)
        {
            setOrientation(i);
        }
        i = context.a(android.support.v7.br.k.LinearLayoutCompat_android_gravity, -1);
        if (i >= 0)
        {
            setGravity(i);
        }
        boolean flag = context.a(android.support.v7.br.k.LinearLayoutCompat_android_baselineAligned, true);
        if (!flag)
        {
            setBaselineAligned(flag);
        }
        mWeightSum = context.a(android.support.v7.br.k.LinearLayoutCompat_android_weightSum, -1F);
        mBaselineAlignedChildIndex = context.a(android.support.v7.br.k.LinearLayoutCompat_android_baselineAlignedChildIndex, -1);
        mUseLargestChild = context.a(android.support.v7.br.k.LinearLayoutCompat_measureWithLargestChild, false);
        setDividerDrawable(context.a(android.support.v7.br.k.LinearLayoutCompat_divider));
        mShowDividers = context.a(android.support.v7.br.k.LinearLayoutCompat_showDividers, 0);
        mDividerPadding = context.d(android.support.v7.br.k.LinearLayoutCompat_dividerPadding, 0);
        context.b();
    }
...
_L14:
    ...
    void measureHorizontal(int i, int j)
    {
        ...
        i5 = ah.a(Math.max(mTotalLength, getSuggestedMinimumWidth()), i, 0);
        i1 = (0xffffff & i5) - mTotalLength;
        if (k1 == 0 && (i1 == 0 || f1 <= 0.0F)) goto _L2; else goto _L1
_L1:
label0:
        {
            if (mWeightSum > 0.0F)
                ...
                if (view1 != null)
                {
                    ...
                    } else
                    {
                        ...
                        if (f2 > 0.0F)
                        {
                            ...
                            k1 = s.a(k1, ah.j(view1) & 0xff000000);
                            f1 -= f2;
                            j1 = j2;
                        }
                        if (flag)
...
_L4:
        ...
        setMeasuredDimension(0xff000000 & k | i5, ah.a(Math.max(i1 + (getPaddingTop() + getPaddingBottom()), getSuggestedMinimumHeight()), j, k << 16));
        if (i2 != 0)
        {
        ...
        {
            {
                ...
                k4 = ah.a(Math.max(mTotalLength, getSuggestedMinimumHeight()), j, 0);
                i2 = (0xffffff & k4) - mTotalLength;
                if (k1 == 0 && (i2 == 0 || f1 <= 0.0F))
                {
                    break label1;
                }
                if (mWeightSum > 0.0F)
            ...
            setMeasuredDimension(ah.a(Math.max(l + (getPaddingLeft() + getPaddingRight()), getSuggestedMinimumWidth()), i, k), k4);
            if (j2 != 0)
            {
