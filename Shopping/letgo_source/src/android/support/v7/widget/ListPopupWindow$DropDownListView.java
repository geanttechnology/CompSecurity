...
label0:
            {
                i = (int)motionevent.getX(l);
                l = (int)motionevent.getY(l);
                i1 = pointToPosition(i, l);
                if (i1 != -1)
                {
                    break label0;
                }
        ...
        setPressedItem(view, i1, i, l);
        if (k == 1)
        {
            clickPressedItem(view, i1);
        }
          goto _L1
_L6:
...
*/
    ...
    {
        super(context, null, android.support.v7.nit>);
        mHijackFocus = flag;
        setCacheColorHint(0);
    }
}
