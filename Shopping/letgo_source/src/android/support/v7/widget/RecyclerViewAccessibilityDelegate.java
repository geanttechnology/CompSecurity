...
public class RecyclerViewAccessibilityDelegate extends a
{
    ...
    final a mItemDelegate = new a() {
        ...
        public void onInitializeAccessibilityNodeInfo(View view, be be1)
        {
            ...
            {
                mRecyclerView.getLayoutManager().onInitializeAccessibilityNodeInfoForItem(view, be1);
            }
        }
    ...
    {
        super.onInitializeAccessibilityNodeInfo(view, be1);
        be1.b(android/support/v7/widget/RecyclerView.getName());
        if (!shouldIgnore() && mRecyclerView.getLayoutManager() != null)
        {
            mRecyclerView.getLayoutManager().onInitializeAccessibilityNodeInfo(be1);
        }
    }
