...
class RoundRectDrawableWithShadow extends Drawable
{
    ...
    RoundRectDrawableWithShadow(Resources resources, int i, float f, float f1, float f2)
    {
        ...
        mShadowStartColor = resources.getColor(android.support.v7.bs.a.cardview_shadow_start_color);
        mShadowEndColor = resources.getColor(android.support.v7.bs.a.cardview_shadow_end_color);
        mInsetShadow = resources.getDimensionPixelSize(android.support.v7.bs.b.cardview_compat_inset_shadow);
        mPaint = new Paint(5);
        mPaint.setColor(i);
    ...
    void setShadowSize(float f, float f1)
    {
        ...
        } else
        {
            ...
            mMaxShadowSize = (float)mInsetShadow + f1;
            mDirty = true;
            invalidateSelf();
            return;
        }
