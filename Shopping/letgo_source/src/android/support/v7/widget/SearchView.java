    ...
    implements ck
{
    ...
    android.view.View.OnKeyListener mTextKeyListener = new android.view.View.OnKeyListener() {
        ...
        public boolean onKey(View view, int j, KeyEvent keyevent)
        {
            if (mSearchable != null)
            {
                ...
                if (!mSearchSrcTextView.isEmpty() && h.a(keyevent) && keyevent.getAction() == 1 && j == 66)
                {
    ...
    {
        this(context, attributeset, android.support.v7.br.a.searchViewStyle);
    }
    ...
    public SearchView(Context context, AttributeSet attributeset, int i)
    {
        ...
        attributeset = q.a(context, attributeset, android.support.v7.br.k.SearchView, i, 0);
        mTintManager = attributeset.c();
        LayoutInflater.from(context).inflate(attributeset.f(android.support.v7.br.k.SearchView_layout, android.support.v7.br.h.abc_search_view), this, true);
        mSearchSrcTextView = (SearchAutoComplete)findViewById(android.support.v7.br.f.search_src_text);
        mSearchSrcTextView.setSearchView(this);
        mSearchEditFrame = findViewById(android.support.v7.br.f.search_edit_frame);
        mSearchPlate = findViewById(android.support.v7.br.f.search_plate);
        mSubmitArea = findViewById(android.support.v7.br.f.submit_area);
        mSearchButton = (ImageView)findViewById(android.support.v7.br.f.search_button);
        mGoButton = (ImageView)findViewById(android.support.v7.br.f.search_go_btn);
        mCloseButton = (ImageView)findViewById(android.support.v7.br.f.search_close_btn);
        mVoiceButton = (ImageView)findViewById(android.support.v7.br.f.search_voice_btn);
        mCollapsedIcon = (ImageView)findViewById(android.support.v7.br.f.search_mag_icon);
        mSearchPlate.setBackgroundDrawable(attributeset.a(android.support.v7.br.k.SearchView_queryBackground));
        mSubmitArea.setBackgroundDrawable(attributeset.a(android.support.v7.br.k.SearchView_submitBackground));
        mSearchButton.setImageDrawable(attributeset.a(android.support.v7.br.k.SearchView_searchIcon));
        mGoButton.setImageDrawable(attributeset.a(android.support.v7.br.k.SearchView_goIcon));
        mCloseButton.setImageDrawable(attributeset.a(android.support.v7.br.k.SearchView_closeIcon));
        mVoiceButton.setImageDrawable(attributeset.a(android.support.v7.br.k.SearchView_voiceIcon));
        mCollapsedIcon.setImageDrawable(attributeset.a(android.support.v7.br.k.SearchView_searchIcon));
        mSearchHintIcon = attributeset.a(android.support.v7.br.k.SearchView_searchHintIcon);
        mSuggestionRowLayout = attributeset.f(android.support.v7.br.k.SearchView_suggestionRowLayout, android.support.v7.br.h.abc_search_dropdown_item_icons_2line);
        mSuggestionCommitIconResId = attributeset.f(android.support.v7.br.k.SearchView_commitIcon, 0);
        ...
        setIconifiedByDefault(attributeset.a(android.support.v7.br.k.SearchView_iconifiedByDefault, true));
        i = attributeset.d(android.support.v7.br.k.SearchView_android_maxWidth, -1);
        if (i != -1)
        {
            setMaxWidth(i);
        }
        mDefaultQueryHint = attributeset.c(android.support.v7.br.k.SearchView_defaultQueryHint);
        mQueryHint = attributeset.c(android.support.v7.br.k.SearchView_queryHint);
        i = attributeset.a(android.support.v7.br.k.SearchView_android_imeOptions, -1);
        if (i != -1)
        {
            setImeOptions(i);
        }
        i = attributeset.a(android.support.v7.br.k.SearchView_android_inputType, -1);
        if (i != -1)
        {
            setInputType(i);
        }
        setFocusable(attributeset.a(android.support.v7.br.k.SearchView_android_focusable, true));
        attributeset.b();
    ...
    private void adjustDropDownSizeAndPosition()
    {
        if (mDropDownAnchor.getWidth() > 1)
        {
            ...
            {
                i = resources.getDimensionPixelSize(android.support.v7.br.d.abc_dropdownitem_icon_width);
                i = resources.getDimensionPixelSize(android.support.v7.br.d.abc_dropdownitem_text_padding_left) + i;
            } else
            {
                i = 0;
            }
    ...
    private Intent createIntent(String s1, Uri uri, String s2, String s3, int i, String s4)
    {
        s1 = new Intent(s1);
        ...
        s1.putExtra("user_query", mUserQuery);
        if (s3 != null)
        {
        ...
        {
            s1.putExtra("app_data", mAppSearchData);
        }
        if (i != 0)
        {
            s1.putExtra("action_key", i);
            s1.putExtra("action_msg", s4);
        }
        if (IS_AT_LEAST_FROYO)
        {
            s1.setComponent(mSearchable.getSearchActivity());
        }
        return s1;
    }

    private Intent createIntentFromSuggestion(Cursor cursor, int i, String s1)
    {
        Object obj;
        Object obj1;
        Object obj2;
        ...
        catch (String s1)
        {
            ...
            Log.w("SearchView", (new StringBuilder()).append("Search suggestions cursor at row ").append(i).append(" returned exception.").toString(), s1);
            return null;
        }
        obj = obj1;
...
_L6:
        ...
        return createIntent(((String) (obj1)), ((Uri) (obj)), SuggestionsAdapter.getColumnString(cursor, "suggest_intent_extra_data"), ((String) (obj2)), i, s1);
_L9:
...
_L8:
    ...
    {
        return getContext().getResources().getDimensionPixelSize(android.support.v7.br.d.abc_search_view_preferred_width);
    }
...
_L6:
    ...
    private void launchQuerySearch(int i, String s1, String s2)
    {
        s1 = createIntent("android.intent.action.SEARCH", null, null, s2, i, s1);
        getContext().startActivity(s1);
    }

    private boolean launchSuggestion(int i, int j, String s1)
    {
        Cursor cursor = mSuggestionsAdapter.getCursor();
        if (cursor != null && cursor.moveToPosition(i))
        {
            launchIntent(createIntentFromSuggestion(cursor, j, s1));
            return true;
        } else
        {
            return false;
    ...
    private boolean onItemClicked(int i, int j, String s1)
    {
        boolean flag = false;
    ...
    {
        if (mSearchable != null && mSuggestionsAdapter != null && keyevent.getAction() == 0 && h.a(keyevent))
        {
            if (i == 66 || i == 84 || i == 61)
            {
