...
label0:
    ...
    public void onInitializeAccessibilityNodeInfoForItem(RecyclerView.Recycler recycler, RecyclerView.State state, View view, be be1)
    {
        ...
        if (mOrientation == 0)
        {
            ...
            be1.c(android.support.v7.be.j.a(k, i, -1, -1, ((LayoutParams) (recycler)).mFullSpan, false));
            return;
        }
        ...
        be1.c(android.support.v7.be.j.a(-1, -1, l, j, ((LayoutParams) (recycler)).mFullSpan, false));
    }
