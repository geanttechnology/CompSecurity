...
class SuggestionsAdapter extends n
    implements android.view.View.OnClickListener
{
    private static final class ChildViewCache
    {
        ...
        public ChildViewCache(View view)
        {
            ...
            mIconRefine = (ImageView)view.findViewById(android.support.v7.br.f.edit_query);
        }
    }
    ...
    private CharSequence formatUrl(CharSequence charsequence)
    {
        if (mUrlColor == null)
        {
            ...
            mContext.getTheme().resolveAttribute(android.support.v7.br.a.textColorSearchUrl, typedvalue, true);
    ...
    private Drawable getActivityIcon(ComponentName componentname)
    {
        ...
        j = activityinfo.getIconResource();
        if (j == 0)
        {
            return null;
        }
        obj = ((PackageManager) (obj)).getDrawable(componentname.getPackageName(), j, activityinfo.applicationInfo);
        if (obj == null)
        {
            Log.w("SuggestionsAdapter", (new StringBuilder()).append("Invalid icon resource ").append(j).append(" for ").append(componentname.flattenToShortString()).toString());
            return null;
        } else
        {
            return ((Drawable) (obj));
...
_L2:
        ...
        s1 = (new StringBuilder()).append("android.resource://").append(mProviderContext.getPackageName()).append("/").append(j).toString();
...
_L3:
    ...
    private static String getStringOrNull(Cursor cursor, int j)
    {
        if (j == -1)
        {
            return null;
    ...
    private void setViewDrawable(ImageView imageview, Drawable drawable, int j)
    {
...
_L3:
        ...
        throws FileNotFoundException
    {
        ...
        if (j == 1)
        {
            try
            {
                j = Integer.parseInt((String)list.get(0));
            }
            // Misplaced declaration of an exception variable
            catch (Object obj)
            {
        ...
        if (j == 2)
        {
            j = resources.getIdentifier((String)list.get(1), (String)list.get(0), ((String) (obj)));
        } else
        {
    ...
    Cursor getSearchManagerSuggestions(SearchableInfo searchableinfo, String s, int j)
    {
        Object obj;
        if (searchableinfo != null)
        {
            if ((obj = searchableinfo.getSuggestAuthority()) != null)
            {
                ...
                if (j > 0)
                {
                    ((android.net.Uri.Builder) (obj)).appendQueryParameter("limit", String.valueOf(j));
                }
    ...
    public View newView(Context context, Cursor cursor, ViewGroup viewgroup)
    {
        ...
        ((ImageView)context.findViewById(android.support.v7.br.f.edit_query)).setImageResource(mCommitIconResId);
        return context;
    }
    ...
    public void setQueryRefinement(int j)
    {
        mQueryRefinement = j;
    }
}
