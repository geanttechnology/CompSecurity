...
public class SwitchCompat extends CompoundButton
{
    ...
    {
        this(context, attributeset, android.support.v7.br.a.switchStyle);
    }
    ...
    public SwitchCompat(Context context, AttributeSet attributeset, int i)
    {
        ...
        attributeset = q.a(context, attributeset, android.support.v7.br.k.SwitchCompat, i, 0);
        mThumbDrawable = attributeset.a(android.support.v7.br.k.SwitchCompat_android_thumb);
        if (mThumbDrawable != null)
        {
            mThumbDrawable.setCallback(this);
        }
        mTrackDrawable = attributeset.a(android.support.v7.br.k.SwitchCompat_track);
        if (mTrackDrawable != null)
        {
            mTrackDrawable.setCallback(this);
        }
        mTextOn = attributeset.c(android.support.v7.br.k.SwitchCompat_android_textOn);
        mTextOff = attributeset.c(android.support.v7.br.k.SwitchCompat_android_textOff);
        mShowText = attributeset.a(android.support.v7.br.k.SwitchCompat_showText, true);
        mThumbTextPadding = attributeset.d(android.support.v7.br.k.SwitchCompat_thumbTextPadding, 0);
        mSwitchMinWidth = attributeset.d(android.support.v7.br.k.SwitchCompat_switchMinWidth, 0);
        mSwitchPadding = attributeset.d(android.support.v7.br.k.SwitchCompat_switchPadding, 0);
        mSplitTrack = attributeset.a(android.support.v7.br.k.SwitchCompat_splitTrack, false);
        i = attributeset.f(android.support.v7.br.k.SwitchCompat_switchTextAppearance, 0);
        if (i != 0)
        {
...
_L7:
    ...
    public void drawableHotspotChanged(float f, float f1)
    {
        ...
        if (mThumbDrawable != null)
        {
            u.a(mThumbDrawable, f, f1);
        }
        if (mTrackDrawable != null)
        {
            u.a(mTrackDrawable, f, f1);
        }
    }
...
_L4:
    ...
    public void onMeasure(int i, int j)
    {
        ...
        {
            setMeasuredDimension(ah.i(this), k);
        }
    }
    ...
    public boolean onTouchEvent(MotionEvent motionevent)
    {
        ...
        android.support.v4.view.u.a(motionevent);
...
_L5:
    ...
    public void setSwitchTextAppearance(Context context, int i)
    {
        ...
        ColorStateList colorstatelist = context.getColorStateList(android.support.v7.br.k.TextAppearance_android_textColor);
        ...
        i = context.getDimensionPixelSize(android.support.v7.br.k.TextAppearance_android_textSize, 0);
        if (i != 0 && (float)i != mTextPaint.getTextSize())
        {
            mTextPaint.setTextSize(i);
            requestLayout();
        }
        setSwitchTypefaceByIndex(context.getInt(android.support.v7.br.k.TextAppearance_android_typeface, -1), context.getInt(android.support.v7.br.k.TextAppearance_android_textStyle, -1));
        if (context.getBoolean(android.support.v7.br.k.TextAppearance_textAllCaps, false))
        {
            mSwitchTransformationMethod = new by(getContext());
        } else
        {
    ...
    {
        setThumbDrawable(mTintManager.a(i));
    }
    ...
    {
        setTrackDrawable(mTintManager.a(i));
    }
