...
public class Toolbar extends ViewGroup
{
        ...
        implements l
    {
        ...
        {
            if (mExpandedActionView instanceof ck)
            {
                ((ck)mExpandedActionView).onActionViewCollapsed();
            }
        ...
        public boolean expandItemActionView(android.support.v7.internal.view.menu.f f1, h h1)
        {
            ...
            if (mExpandedActionView instanceof ck)
            {
                ((ck)mExpandedActionView).onActionViewExpanded();
            }
            return true;
        }
        ...
        public boolean onSubMenuSelected(android.support.v7.internal.view.menu.p p1)
        {
            return false;
        }
...
_L8:
    ...
    public static class LayoutParams extends android.support.v7.app.ActionBar.LayoutParams
    {
        ...
        public LayoutParams(int i, int j, int l)
        {
            super(i, j);
            mViewType = 0;
            gravity = l;
    ...
    private final k mContentInsets;
    ...
    private final android.support.v7.internal.widget.p mTintManager;
    ...
    {
        this(context, attributeset, android.support.v7.br.a.toolbarStyle);
    }

    public Toolbar(Context context, AttributeSet attributeset, int i)
    {
        super(context, attributeset, i);
        mContentInsets = new k();
        mGravity = 0x800013;
        ...
        context = q.a(getContext(), attributeset, android.support.v7.br.k.Toolbar, i, 0);
        mTitleTextAppearance = context.f(android.support.v7.br.k.Toolbar_titleTextAppearance, 0);
        mSubtitleTextAppearance = context.f(android.support.v7.br.k.Toolbar_subtitleTextAppearance, 0);
        mGravity = context.b(android.support.v7.br.k.Toolbar_android_gravity, mGravity);
        mButtonGravity = 48;
        i = context.c(android.support.v7.br.k.Toolbar_titleMargins, 0);
        mTitleMarginBottom = i;
        mTitleMarginTop = i;
        mTitleMarginEnd = i;
        mTitleMarginStart = i;
        i = context.c(android.support.v7.br.k.Toolbar_titleMarginStart, -1);
        if (i >= 0)
        {
            mTitleMarginStart = i;
        }
        i = context.c(android.support.v7.br.k.Toolbar_titleMarginEnd, -1);
        if (i >= 0)
        {
            mTitleMarginEnd = i;
        }
        i = context.c(android.support.v7.br.k.Toolbar_titleMarginTop, -1);
        if (i >= 0)
        {
            mTitleMarginTop = i;
        }
        i = context.c(android.support.v7.br.k.Toolbar_titleMarginBottom, -1);
        if (i >= 0)
        {
            mTitleMarginBottom = i;
        }
        mMaxButtonHeight = context.d(android.support.v7.br.k.Toolbar_maxButtonHeight, -1);
        i = context.c(android.support.v7.br.k.Toolbar_contentInsetStart, 0x80000000);
        int j = context.c(android.support.v7.br.k.Toolbar_contentInsetEnd, 0x80000000);
        int l = context.d(android.support.v7.br.k.Toolbar_contentInsetLeft, 0);
        int i1 = context.d(android.support.v7.br.k.Toolbar_contentInsetRight, 0);
        mContentInsets.b(l, i1);
        if (i != 0x80000000 || j != 0x80000000)
        {
            mContentInsets.a(i, j);
        }
        mCollapseIcon = context.a(android.support.v7.br.k.Toolbar_collapseIcon);
        mCollapseDescription = context.c(android.support.v7.br.k.Toolbar_collapseContentDescription);
        attributeset = context.c(android.support.v7.br.k.Toolbar_title);
        if (!TextUtils.isEmpty(attributeset))
        {
            setTitle(attributeset);
        }
        attributeset = context.c(android.support.v7.br.k.Toolbar_subtitle);
        if (!TextUtils.isEmpty(attributeset))
        {
            setSubtitle(attributeset);
        }
        mPopupContext = getContext();
        setPopupTheme(context.f(android.support.v7.br.k.Toolbar_popupTheme, 0));
        attributeset = context.a(android.support.v7.br.k.Toolbar_navigationIcon);
        if (attributeset != null)
        {
            setNavigationIcon(attributeset);
        }
        attributeset = context.c(android.support.v7.br.k.Toolbar_navigationContentDescription);
        if (!TextUtils.isEmpty(attributeset))
        {
    ...
    private void ensureCollapseButtonView()
    {
        ...
        {
            mCollapseButtonView = new ImageButton(getContext(), null, android.support.v7.br.a.toolbarNavigationButtonStyle);
    ...
    private void ensureNavButtonView()
    {
        ...
        {
            mNavButtonView = new ImageButton(getContext(), null, android.support.v7.br.a.toolbarNavigationButtonStyle);
            LayoutParams layoutparams = generateDefaultLayoutParams();
            layoutparams.gravity = 0x800003 | mButtonGravity & 0x70;
...
_L6:
    ...
    private int layoutChildLeft(View view, int i, int ai[], int j)
    {
        ...
        view.layout(i, j, i + l, view.getMeasuredHeight() + j);
    ...
    private int measureChildCollapseMargins(View view, int i, int j, int l, int i1, int ai[])
    {
        ...
        ai[0] = Math.max(0, -j1);
        ai[1] = Math.max(0, -k1);
        view.measure(getChildMeasureSpec(i, getPaddingLeft() + getPaddingRight() + l1 + j, marginlayoutparams.width), getChildMeasureSpec(l, getPaddingTop() + getPaddingBottom() + marginlayoutparams.topMargin + marginlayoutparams.bottomMargin + i1, marginlayoutparams.height));
        return view.getMeasuredWidth() + l1;
    }

    private void measureChildConstrained(View view, int i, int j, int l, int i1, int j1)
    {
        android.view.ViewGroup.MarginLayoutParams marginlayoutparams = (android.view.ViewGroup.MarginLayoutParams)view.getLayoutParams();
        ...
        j = getChildMeasureSpec(l, getPaddingTop() + getPaddingBottom() + marginlayoutparams.topMargin + marginlayoutparams.bottomMargin + i1, marginlayoutparams.height);
...
_L8:
        if (l1 != 0)
        {
            ...
            if (flag2)
            {
                ...
                mSubtitleTextView.layout(j - l1, i, j, i2);
                i = mTitleMarginEnd;
...
_L11:
    ...
    protected void onMeasure(int i, int j)
    {
        ...
        if (shouldLayout(mCollapseButtonView))
        {
            ...
            l = s.a(j1, ah.j(mCollapseButtonView));
        }
        ...
        if (shouldLayout(mExpandedActionView))
        {
            ...
            l = s.a(j1, ah.j(mExpandedActionView));
        }
        j1 = i2;
        k1 = l;
        l1 = i1;
        ...
        {
            measureChildCollapseMargins(mTitleTextView, i, i2 + i3, j, l2, ai);
        ...
        {
            j2 = Math.max(l1, measureChildCollapseMargins(mSubtitleTextView, i, i2 + i3, j, l2 + k1, ai));
            k2 = k1 + (mSubtitleTextView.getMeasuredHeight() + getVerticalMargins(mSubtitleTextView));
            l = s.a(j1, ah.j(mSubtitleTextView));
        }
        i1 = Math.max(i1, k2);
        l1 = getPaddingLeft();
        k2 = getPaddingRight();
        j1 = getPaddingTop();
        k1 = getPaddingBottom();
        l1 = ah.a(Math.max(j2 + i2 + (l1 + k2), getSuggestedMinimumWidth()), i, 0xff000000 & l);
        i = ah.a(Math.max(i1 + (j1 + k1), getSuggestedMinimumHeight()), j, l << 16);
        if (shouldCollapse())
        {
            i = 0;
        }
    ...
    protected void onRestoreInstanceState(Parcelable parcelable)
    {
        ...
        if (savedstate.expandedMenuItemId != 0 && mExpandedMenuPresenter != null && parcelable != null)
        {
            ...
            if (parcelable != null)
            {
                android.support.v4.view.r.b(parcelable);
            }
        }
