    ...
    implements android.support.v7.widget.RecyclerView.OnChildAttachStateChangeListener
{
    public static abstract class Callback
    {
        ...
        private int getMaxDragScroll(RecyclerView recyclerview)
        {
            ...
            {
                mCachedMaxScrollSpeed = recyclerview.getResources().getDimensionPixelSize(android.support.v7.ch.a.item_touch_helper_max_drag_scroll_per_frame);
            }
...
_L1:
        ...
        {
            return convertToAbsoluteDirection(getMovementFlags(recyclerview, viewholder), ah.g(recyclerview));
        }
...
_L1:
            return;
            if (obj != null && mCallback.hasDragFlag(mRecyclerView, ((android.support.v7.widget.RecyclerView.ViewHolder) (obj))) && u.b(motionevent, 0) == mActivePointerId)
            {
                int i = u.a(motionevent, mActivePointerId);
                float f = u.c(motionevent, i);
                float f1 = u.d(motionevent, i);
                mInitialTouchX = f;
                mInitialTouchY = f1;
        ...
        implements c
    {
                ...
                float f3)
        {
            ...
            mTargetX = f2;
            mTargetY = f3;
            mValueAnimator.a(new _cls1());
            mValueAnimator.a(viewholder.itemView);
    ...
    private final android.support.v7.widget.RecyclerView.OnItemTouchListener mOnItemTouchListener = new android.support.v7.widget.RecyclerView.OnItemTouchListener() {
        ...
        public boolean onInterceptTouchEvent(RecyclerView recyclerview, MotionEvent motionevent)
        {
            ...
            if (i == 0)
            {
                mActivePointerId = u.b(motionevent, 0);
            ...
            {
                int j = u.a(motionevent, mActivePointerId);
                if (j >= 0)
                {
...
_L2:
            ...
            int k;
            j = u.a(motionevent);
            k = u.a(motionevent, mActivePointerId);
            if (k >= 0)
            {
...
_L4:
            if (u.b(motionevent, j) != mActivePointerId) goto _L1; else goto _L5
_L5:
            if (mVelocityTracker != null)
            {
                mVelocityTracker.computeCurrentVelocity(1000, mRecyclerView.getMaxFlingVelocity());
            ...
            mActivePointerId = u.b(motionevent, i);
...
_L3:
        float f = af.a(mVelocityTracker, mActivePointerId);
        if (f <= 0.0F)
        {
            byte1 = 4;
        }
...
_L1:
        ...
        float f = u.c(motionevent, j);
        f1 = u.d(motionevent, j);
        f -= mInitialTouchX;
        f1 -= mInitialTouchY;
        float f2 = Math.abs(f);
...
_L1:
        ...
        if (mVelocityTracker == null || mActivePointerId <= -1) goto _L4; else goto _L3
_L3:
        float f = af.b(mVelocityTracker, mActivePointerId);
        if (f <= 0.0F)
        {
            byte1 = 1;
        }
...
_L1:
    ...
    private android.support.v7.widget.RecyclerView.ViewHolder findSwipedView(MotionEvent motionevent)
    {
        ...
        {
            int i = u.a(motionevent, mActivePointerId);
            float f2 = u.c(motionevent, i);
            float f3 = mInitialTouchX;
            float f = u.d(motionevent, i);
    ...
    private void getSelectedDxDy(float af1[])
    {
        if ((mSelectedFlags & 0xc) != 0)
        {
            af1[0] = (mSelectedStartX + mDx) - (float)mSelected.itemView.getLeft();
        } else
        {
            af1[0] = ah.m(mSelected.itemView);
        }
        if ((mSelectedFlags & 3) != 0)
        {
            af1[1] = (mSelectedStartY + mDy) - (float)mSelected.itemView.getTop();
            return;
        } else
        {
            af1[1] = ah.n(mSelected.itemView);
            return;
        }
    }
    ...
    private void initGestureDetector()
    {
        ...
        {
            mGestureDetector = new e(mRecyclerView.getContext(), new ItemTouchHelperGestureListener());
            return;
        }
    }
...
_L6:
        ...
        final_viewholder = new RecoverAnimation(k, f2, f3, f, f1, j, ((android.support.v7.widget.RecyclerView.ViewHolder) (final_viewholder))) {
            ...
            public void onAnimationEnd(h h)
            {
                super.onAnimationEnd(h);
...
_L2:
        ...
        i = (mCallback.convertToAbsoluteDirection(j, ah.g(mRecyclerView)) & 0xff00) >> 8;
        if (i == 0)
        {
            continue; /* Loop/switch isn't completed */
        }
        ...
        if (k > 0)
        {
            if ((j & k) == 0)
            {
                return Callback.convertToRelativeDirection(k, ah.g(mRecyclerView));
            } else
            {
                return k;
            }
...
_L3:
        ...
        if (i > 0)
        {
            if ((j & i) == 0)
            {
                return Callback.convertToRelativeDirection(i, ah.g(mRecyclerView));
            } else
            {
                return i;
            }
...
/* anonymous class */
    class RecoverAnimation._cls1
        implements android.support.v7.e
    {
