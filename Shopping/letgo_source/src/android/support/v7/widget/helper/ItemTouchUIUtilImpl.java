...
class ItemTouchUIUtilImpl
{
    ...
    static class Lollipop extends Honeycomb
    {
        ...
        public void clearView(View view)
        {
            Object obj = view.getTag(android.support.v7.ch.b.item_touch_helper_previous_elevation);
            if (obj != null && (obj instanceof Float))
            {
                ah.f(view, ((Float)obj).floatValue());
            }
            view.setTag(android.support.v7.ch.b.item_touch_helper_previous_elevation, null);
            super.clearView(view);
        }

        public void onDraw(Canvas canvas, RecyclerView recyclerview, View view, float f, float f1, int i, boolean flag)
        {
            if (flag && view.getTag(android.support.v7.ch.b.item_touch_helper_previous_elevation) == null)
            {
                float f2 = ah.s(view);
                ah.f(view, 1.0F + findMaxElevation(recyclerview, view));
                view.setTag(android.support.v7.ch.b.item_touch_helper_previous_elevation, Float.valueOf(f2));
            }
