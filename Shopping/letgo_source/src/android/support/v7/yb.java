...
public final class yb
{
    ...
    public static String a(ya ya1)
    {
        ...
        try
        {
            a(null, ya1, new StringBuffer(), stringbuffer);
        }
        // Misplaced declaration of an exception variable
        catch (ya ya1)
        {
            return (new StringBuilder()).append("Error printing proto: ").append(ya1.getMessage()).toString();
        }
        // Misplaced declaration of an exception variable
        catch (ya ya1)
        {
...
_L1:
        return;
_L2:
        if (!(obj instanceof ya)) goto _L4; else goto _L3
_L3:
        Class class1;
        Object aobj[];
        int i;
