...
_L5:
            ...
            throws Throwable
        {
            if (!c)
            {
                ...
                yd.c("Marker log finalized without finish() - uncaught exit point for request", new Object[0]);
            }
        }
...
_L3:
        ...
        if (aobj[i].getClass().equals(android/support/v7/yd)) goto _L2; else goto _L1
_L1:
