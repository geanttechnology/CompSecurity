...
public class MultipleInstallBroadcastReceiver extends BroadcastReceiver
{
    ...
    {
        Log.i("AppsFlyer_1.18", "MultipleInstallBroadcastReceiver called");
        ...
        do
        {
            ...
            {
                Log.i("AppsFlyer_1.18", (new StringBuilder()).append("trigger onReceive: class: ").append(resolveinfo.activityInfo.name).toString());
                try
                {
                ...
                {
                    Log.e("AppsFlyer_1.18", (new StringBuilder()).append("error in BroadcastReceiver ").append(resolveinfo.activityInfo.name).toString(), throwable);
                }
            }
        } while (true);
