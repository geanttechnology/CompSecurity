...
public class Crashlytics extends alz
    implements ama
{
    ...
    Crashlytics(Answers answers1, Beta beta1, CrashlyticsCore crashlyticscore)
    {
        ...
        beta = beta1;
        core = crashlyticscore;
        kits = Collections.unmodifiableCollection(Arrays.asList(new alz[] {
    ...
    {
        return (Crashlytics)alt.a(com/crashlytics/android/Crashlytics);
    }
    ...
    {
        alt.h().d("Crashlytics", "Use of Crashlytics.setPinningInfoProvider is deprecated");
    }
    ...
    {
        alt.h().d("Crashlytics", "Use of Crashlytics.getDebugMode is deprecated.");
        getFabric();
        return alt.i();
    }
    ...
    {
        alt.h().d("Crashlytics", "Use of Crashlytics.setDebugMode is deprecated.");
    }
