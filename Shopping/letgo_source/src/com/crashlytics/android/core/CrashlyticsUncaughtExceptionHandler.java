    ...
    implements Thread.UncaughtExceptionHandler
{
    ...
    CrashlyticsUncaughtExceptionHandler(Thread.UncaughtExceptionHandler uncaughtexceptionhandler, CrashlyticsListener crashlyticslistener, CrashlyticsExecutorServiceWrapper crashlyticsexecutorservicewrapper, amw amw1, SessionDataWriter sessiondatawriter, CrashlyticsCore crashlyticscore)
    {
    ...
    private void closeWithoutRenamingOrLog(ClsFileOutputStream clsfileoutputstream)
    {
        ...
        return;
        clsfileoutputstream;
        alt.h().e("CrashlyticsCore", "Error closing session file stream in the presence of an exception", clsfileoutputstream);
        return;
    }
        ...
        throws Exception
    {
        ...
        if (afile.length > i)
        {
            ...
            apj apj1 = crashlyticsCore.getSessionSettingsData();
            if (apj1 != null)
            {
                int j = apj1.c;
                alt.h().a("CrashlyticsCore", "Closing open sessions.");
                for (; i < afile.length; i++)
                {
                    File file = afile[i];
                    String s = getSessionIdFromSessionFile(file);
                    alt.h().a("CrashlyticsCore", (new StringBuilder()).append("Closing session: ").append(s).toString());
                    writeSessionPartsToSessionFile(file, s, j);
                }

            } else
            {
                alt.h().a("CrashlyticsCore", "Unable to close session. Settings are not loaded.");
            }
            return;
        } else
        {
            alt.h().a("CrashlyticsCore", "No open sessions to be closed.");
            return;
        }
    }
        ...
        throws Exception
    {
        ...
        alt.h().a("CrashlyticsCore", (new StringBuilder()).append("Opening an new session with ID ").append(s).toString());
...
_L1:
        ...
        Object obj;
        alt.h().a("CrashlyticsCore", (new StringBuilder()).append("Crashlytics is logging non-fatal exception \"").append(throwable).append("\" from thread ").append(thread.getName()).toString());
        obj = amq.a(eventCounter.getAndIncrement());
        ...
        amq.a(codedoutputstream2, "Failed to flush to non-fatal file.");
        amq.a(((java.io.Closeable) (obj)), "Failed to close non-fatal file output stream.");
        break MISSING_BLOCK_LABEL_177;
        thread;
        date = null;
_L6:
        alt.h().e("CrashlyticsCore", "An error occurred in the non-fatal exception logger", thread);
        ExceptionUtils.writeStackTraceIfNotNull(thread, date);
        amq.a(codedoutputstream1, "Failed to flush to non-fatal file.");
        amq.a(date, "Failed to close non-fatal file output stream.");
          goto _L3
        thread;
        date = null;
_L5:
        amq.a(codedoutputstream, "Failed to flush to non-fatal file.");
        amq.a(date, "Failed to close non-fatal file output stream.");
        throw thread;
_L3:
        try
        ...
        {
            alt.h().e("CrashlyticsCore", "An error occurred when trimming non-fatal files.", date);
        }
        return;
_L2:
        alt.h().e("CrashlyticsCore", "Tried to write a non-fatal exception while no session was open.", null);
        return;
        thread;
        date = ((Date) (obj));
...
_L4:
    ...
    {
        alt.h().a("CrashlyticsCore", "Checking for previous crash marker.");
        ...
        return;
        crashlyticslistener;
        alt.h().e("CrashlyticsCore", "Exception thrown by CrashlyticsListener while notifying of previous crash.", crashlyticslistener);
        return;
    }
    ...
    private void sendSessionReports()
    {
        ...
        for (int i = 0; i < j; i++)
        {
            ...
            executorServiceWrapper.executeAsync(new Runnable() {
                ...
                public void run()
                {
                    if (amq.n(crashlyticsCore.getContext()))
                    {
                        alt.h().a("CrashlyticsCore", "Attempting to send crash report at time of crash...");
                        Object obj = apk.a().b();
                        obj = crashlyticsCore.getCreateReportSpiCall(((android.support.v7.apn) (obj)));
                        if (obj != null)
                        {
    ...
    private void trimOpenSessions(int i)
    {
        ...
        for (i = ((flag) ? 1 : 0); i < j; i++)
        {
            ...
            {
                alt.h().a("CrashlyticsCore", (new StringBuilder()).append("Trimming open session file: ").append(s).toString());
                file.delete();
            }
        }
        ...
        throws Exception
    {
        ...
        codedoutputstream = codedoutputstream2;
        codedoutputstream1 = codedoutputstream2;
        sessionDataWriter.writeBeginSession(codedoutputstream2, s, s1, l);
        amq.a(codedoutputstream2, "Failed to flush to session begin file.");
        amq.a(((java.io.Closeable) (obj)), "Failed to close begin session file.");
        return;
        date;
        s = null;
_L4:
        ...
        s = ((String) (obj));
_L2:
        amq.a(codedoutputstream, "Failed to flush to session begin file.");
        amq.a(date, "Failed to close begin session file.");
        throw s;
        s;
        date = null;
        continue; /* Loop/switch isn't completed */
...
_L1:
        ...
        obj = new ClsFileOutputStream(filesDir, (new StringBuilder()).append(s).append("SessionCrash").toString());
        Map map;
        try
        {
...
_L4:
        amq.a(((java.io.Flushable) (obj1)), "Failed to flush to session begin file.");
        amq.a(((java.io.Closeable) (obj)), "Failed to close fatal exception file output stream.");
        return;
_L2:
        alt.h().e("CrashlyticsCore", "Tried to write a native crash while no session was open.", null);
        obj = null;
        if (true) goto _L4; else goto _L3
_L3:
        sessioneventdata;
        ...
        obj = null;
_L8:
        alt.h().e("CrashlyticsCore", "An error occurred in the native crash logger", sessioneventdata);
        ExceptionUtils.writeStackTraceIfNotNull(sessioneventdata, ((java.io.OutputStream) (obj1)));
        amq.a(((java.io.Flushable) (obj)), "Failed to flush to session begin file.");
        amq.a(((java.io.Closeable) (obj1)), "Failed to close fatal exception file output stream.");
        return;
        sessioneventdata;
        obj1 = null;
        obj = null;
...
_L4:
        ...
        return;
_L2:
        alt.h().e("CrashlyticsCore", "Tried to write a fatal exception while no session was open.", null);
        obj = null;
        obj1 = clsfileoutputstream;
        if (true) goto _L4; else goto _L3
_L3:
...
_L8:
        codedoutputstream = codedoutputstream1;
        clsfileoutputstream = ((ClsFileOutputStream) (obj));
        alt.h().e("CrashlyticsCore", "An error occurred in the fatal exception logger", date);
        codedoutputstream = codedoutputstream1;
        clsfileoutputstream = ((ClsFileOutputStream) (obj));
        ExceptionUtils.writeStackTraceIfNotNull(date, ((java.io.OutputStream) (obj)));
        amq.a(codedoutputstream1, "Failed to flush to session begin file.");
        amq.a(((java.io.Closeable) (obj)), "Failed to close fatal exception file output stream.");
        return;
        date;
        clsfileoutputstream = null;
_L6:
        amq.a(codedoutputstream, "Failed to flush to session begin file.");
        amq.a(clsfileoutputstream, "Failed to close fatal exception file output stream.");
        throw date;
        date;
        if (true) goto _L6; else goto _L5
_L5:
...
_L7:
        ...
        throws IOException
    {
        ...
        while (i < j) 
        {
            ...
            if (afile.length == 0)
            {
                alt.h().e("CrashlyticsCore", (new StringBuilder()).append("Can't find ").append(s1).append(" data for session ID ").append(s).toString(), null);
            } else
            {
                alt.h().a("CrashlyticsCore", (new StringBuilder()).append("Collecting ").append(s1).append(" data for session ID ").append(s).toString());
    ...
    private void writeNonFatalEventsTo(CodedOutputStream codedoutputstream, File afile[], String s)
    {
        ...
        while (i < j) 
        {
            ...
            try
            {
                alt.h().a("CrashlyticsCore", String.format(Locale.US, "Found Non Fatal for session ID %s in %s ", new Object[] {
                    s, file.getName()
                }));
            ...
            {
                alt.h().e("CrashlyticsCore", "Error writting non-fatal to session.", exception);
            }
            i++;
        }
    }
        ...
        throws Exception
    {
        ...
        s = ((String) (obj3));
        obj = obj3;
        int i = amt.a(crashlyticsCore.getInstallerPackageName()).a();
        s = ((String) (obj3));
        obj = obj3;
        sessionDataWriter.writeSessionApp(((CodedOutputStream) (obj3)), s1, s2, s3, s4, i);
        amq.a(((java.io.Flushable) (obj3)), "Failed to flush to session app file.");
        amq.a(((java.io.Closeable) (obj2)), "Failed to close session app file.");
        return;
        obj2;
        s = null;
_L4:
        ...
        obj1 = obj3;
_L2:
        amq.a(s, "Failed to flush to session app file.");
        amq.a(((java.io.Closeable) (obj2)), "Failed to close session app file.");
        throw obj1;
        obj1;
        obj2 = null;
...
_L3:
        ...
        throws Exception
    {
        ...
        s = ((String) (obj3));
        obj = obj3;
        sessionDataWriter.writeSessionDevice(((CodedOutputStream) (obj3)), s1, i, Build.MODEL, j, l, l1 * l2, flag, ((Map) (obj4)), k, Build.MANUFACTURER, Build.PRODUCT);
        amq.a(((java.io.Flushable) (obj3)), "Failed to flush session device info.");
        amq.a(((java.io.Closeable) (obj2)), "Failed to close session device file.");
        return;
        obj2;
        s = context;
_L4:
        ...
        obj1 = obj3;
_L2:
        amq.a(s, "Failed to flush session device info.");
        amq.a(((java.io.Closeable) (obj2)), "Failed to close session device file.");
        throw obj1;
        obj1;
        obj2 = null;
...
_L3:
        ...
        throws Exception
    {
        ...
        f = amq.c(context);
        j = amq.a(context, powerConnected);
        flag1 = amq.d(context);
        k = context.getResources().getConfiguration().orientation;
        l1 = amq.b();
        l2 = amq.b(context);
        l3 = amq.b(Environment.getDataDirectory().getPath());
        runningappprocessinfo = amq.a(context.getPackageName(), context);
        ...
        if (amq.a(context, "com.crashlytics.CollectCustomKeys", true)) goto _L2; else goto _L1
_L1:
        date = new TreeMap();
_L4:
...
_L3:
        ...
        throws Exception
    {
        ...
        obj = clsfileoutputstream;
        obj1 = codedoutputstream;
        boolean flag = amq.g(crashlyticsCore.getContext());
        s = codedoutputstream;
        obj = clsfileoutputstream;
        obj1 = codedoutputstream;
        sessionDataWriter.writeSessionOS(codedoutputstream, flag);
        amq.a(codedoutputstream, "Failed to flush to session OS file.");
        amq.a(clsfileoutputstream, "Failed to close session OS file.");
        return;
...
_L4:
        ...
        s = exception;
_L2:
        amq.a(((java.io.Flushable) (obj)), "Failed to flush to session OS file.");
        amq.a(((java.io.Closeable) (obj1)), "Failed to close session OS file.");
        throw s;
        s;
        obj1 = null;
        if (true) goto _L2; else goto _L1
...
_L3:
    ...
    private void writeSessionPartsToSessionFile(File file, String s, int i)
    {
        ...
        Object obj1;
        codedoutputstream = null;
        alt.h().a("CrashlyticsCore", (new StringBuilder()).append("Collecting session parts for ID ").append(s).toString());
        ...
        alt.h().a("CrashlyticsCore", String.format(Locale.US, "Session %s has fatal exception: %s", new Object[] {
        ...
        alt.h().a("CrashlyticsCore", String.format(Locale.US, "Session %s has non-fatal exceptions: %s", new Object[] {
...
_L1:
        ...
        alt.h().a("CrashlyticsCore", (new StringBuilder()).append("Collecting SessionStart data for session ID ").append(s).toString());
        writeToCosFromFile(codedoutputstream, file);
...
_L3:
        ...
        alt.h().a("CrashlyticsCore", String.format(Locale.US, "Trimming down to %d logged exceptions.", new Object[] {
            Integer.valueOf(i)
        }));
...
_L4:
        ...
        amq.a(codedoutputstream, "Error flushing session file stream");
        amq.a(((java.io.Closeable) (obj)), "Failed to close CLS file");
_L5:
        alt.h().a("CrashlyticsCore", (new StringBuilder()).append("Removing session part files for ID ").append(s).toString());
...
_L7:
        alt.h().e("CrashlyticsCore", (new StringBuilder()).append("Failed to write session file for session ID: ").append(s).toString(), ((Throwable) (obj1)));
        ExceptionUtils.writeStackTraceIfNotNull(((Throwable) (obj1)), ((java.io.OutputStream) (obj)));
        amq.a(file, "Error flushing session file stream");
...
_L6:
        ...
        throw s;
_L2:
        alt.h().a("CrashlyticsCore", (new StringBuilder()).append("No events present for session ID ").append(s).toString());
          goto _L5
        s;
        file = null;
          goto _L6
        ...
        throws Exception
    {
        ...
        if (flag)
        {
            amq.a(codedoutputstream2, "Failed to flush session user file.");
            amq.a(clsfileoutputstream, "Failed to close session user file.");
            return;
        }
        codedoutputstream = codedoutputstream2;
        obj = clsfileoutputstream;
...
_L4:
        ...
        s;
_L2:
        amq.a(codedoutputstream, "Failed to flush session user file.");
        amq.a(((java.io.Closeable) (obj)), "Failed to close session user file.");
        throw s;
        s;
        obj = null;
        if (true) goto _L2; else goto _L1
...
_L4:
        ...
        if (true) goto _L4; else goto _L3
_L3:
        amq.a(file, "Failed to close file input stream.");
...
_L2:
        alt.h().e("CrashlyticsCore", (new StringBuilder()).append("Tried to include a file that doesn't exist: ").append(file.getName()).toString(), null);
        return;
        codedoutputstream;
        if (true) goto _L6; else goto _L5
_L5:
    ...
    void doCleanInvalidTempFiles(File afile[])
    {
        ...
        for (int i = 0; i < k; i++)
        {
            ...
            alt.h().a("CrashlyticsCore", (new StringBuilder()).append("Found invalid session part file: ").append(sessionId).toString());
            ...
            alt.h().a("CrashlyticsCore", (new StringBuilder()).append("Deleting all part files for invalid session: ").append(sessionId).toString());
            File afile1[] = listFilesMatching(filenamefilter);
            int l = afile1.length;
            for (int j = 0; j < l; j++)
            {
                File file = afile1[j];
                alt.h().a("CrashlyticsCore", (new StringBuilder()).append("Deleting session file: ").append(file).toString());
                file.delete();
            }
    ...
    boolean finalizeSessions()
    {
        return ((Boolean)executorServiceWrapper.executeSyncLoggingException(new Callable() {
                ...
                throws Exception
            {
                ...
                {
                    alt.h().a("CrashlyticsCore", "Finalizing previously open sessions.");
                    ...
                    alt.h().a("CrashlyticsCore", "Closed all previously open sessions");
                    return Boolean.valueOf(true);
                } else
                {
                    alt.h().a("CrashlyticsCore", "Skipping session finalization because a crash has already occurred.");
    ...
    public void uncaughtException(final Thread thread, final Throwable ex)
    {
        ...
        alt.h().a("CrashlyticsCore", (new StringBuilder()).append("Crashlytics is handling uncaught exception \"").append(ex).append("\" from thread ").append(thread.getName()).toString());
        if (!receiversRegistered.getAndSet(true))
        {
            alt.h().a("CrashlyticsCore", "Unregistering power receivers.");
        ...
        alt.h().a("CrashlyticsCore", "Crashlytics completed exception processing. Invoking default exception handler.");
...
_L2:
        ...
        Object obj;
        obj;
        alt.h().e("CrashlyticsCore", "An error occurred in the uncaught exception handler", ((Throwable) (obj)));
        alt.h().a("CrashlyticsCore", "Crashlytics completed exception processing. Invoking default exception handler.");
        defaultHandler.uncaughtException(thread, ex);
        isHandlingException.set(false);
        if (true) goto _L2; else goto _L1
