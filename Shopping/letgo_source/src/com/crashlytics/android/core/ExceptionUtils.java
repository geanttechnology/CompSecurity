...
final class ExceptionUtils
{
    ...
    public static void writeStackTrace(Context context, Throwable throwable, String s)
    {
        ...
        amq.a(s, "Failed to close stack trace writer.");
        return;
        Exception exception;
        exception;
        throwable = null;
_L4:
        context = throwable;
        alt.h().e("CrashlyticsCore", "Failed to create PrintWriter", exception);
        amq.a(throwable, "Failed to close stack trace writer.");
        return;
        throwable;
        context = null;
_L2:
        amq.a(context, "Failed to close stack trace writer.");
        throw throwable;
        throwable;
...
_L3:
    ...
    private static void writeStackTrace(Throwable throwable, OutputStream outputstream)
    {
        ...
        amq.a(printwriter, "Failed to close stack trace writer.");
        return;
        Exception exception;
        exception;
        throwable = null;
_L4:
        ...
        outputstream = null;
_L2:
        amq.a(outputstream, "Failed to close stack trace writer.");
        throw throwable;
        throwable;
        if (true) goto _L2; else goto _L1
_L1:
...
_L1:
        ...
        if (true) goto _L4; else goto _L3
        throwable;
        alt.h().e("CrashlyticsCore", "Could not write stack trace", throwable);
_L3:
        return;
        if (i != 0)
        {
