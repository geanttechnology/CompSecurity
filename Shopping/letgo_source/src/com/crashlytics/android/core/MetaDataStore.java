...
class MetaDataStore
{
        ...
        throws JSONException
    {
        ...
        {
            return JSONObjectInstrumentation.toString((JSONObject)map);
        }
    }
    ...
    public Map readKeyData(String s)
    {
        ...
        s = fileinputstream;
        Map map = jsonToKeysData(amq.a(fileinputstream));
        amq.a(fileinputstream, "Failed to close user metadata file.");
        return map;
...
_L4:
        s = fileinputstream;
        alt.h().e("CrashlyticsCore", "Error deserializing user metadata.", exception1);
        amq.a(fileinputstream, "Failed to close user metadata file.");
        return Collections.emptyMap();
        Exception exception;
        exception;
        s = null;
_L2:
        amq.a(s, "Failed to close user metadata file.");
        throw exception;
        exception;
...
_L3:
    ...
    public UserMetaData readUserData(String s)
    {
        ...
        FileInputStream fileinputstream = new FileInputStream(s);
        s = fileinputstream;
        UserMetaData usermetadata = jsonToUserData(amq.a(fileinputstream));
        amq.a(fileinputstream, "Failed to close user metadata file.");
        return usermetadata;
        Exception exception1;
        exception1;
...
_L3:
    ...
    public void writeKeyData(String s, Map map)
    {
        ...
        s = map;
        map.flush();
        amq.a(map, "Failed to close key/value metadata file.");
        return;
        Object obj;
        obj;
        map = null;
_L4:
        s = map;
        alt.h().e("CrashlyticsCore", "Error serializing key/value metadata.", ((Throwable) (obj)));
        amq.a(map, "Failed to close key/value metadata file.");
        return;
        obj;
        map = s;
...
_L3:
    ...
    public void writeUserData(String s, UserMetaData usermetadata)
    {
        ...
        s = usermetadata;
        usermetadata.flush();
        amq.a(usermetadata, "Failed to close user metadata file.");
        return;
        Object obj;
        obj;
        usermetadata = null;
_L4:
        s = usermetadata;
        alt.h().e("CrashlyticsCore", "Error serializing user metadata.", ((Throwable) (obj)));
        amq.a(usermetadata, "Failed to close user metadata file.");
        return;
        obj;
        usermetadata = s;
