...
{
    private class Worker extends amp
    {
...
_L4:
    ...
    List findReports()
    {
        alt.h().a("CrashlyticsCore", "Checking for crash reports...");
        File afile[];
        ...
        {
            File file = afile[i];
            alt.h().a("CrashlyticsCore", (new StringBuilder()).append("Found crash report ").append(file.getPath()).toString());
        ...
        if (((List) (obj)).isEmpty())
        {
            alt.h().a("CrashlyticsCore", "No reports found.");
        }
        return ((List) (obj));
    }
    ...
    boolean forceUpload(Report report)
    {
        ...
        obj = new CreateReportRequest((new amo()).a(((android.content.Context) (obj))), report);
        ...
        amc1.c("CrashlyticsCore", stringbuilder.append(s).append(report.getFileName()).toString());
        flag = flag1;
        if (!flag2)
        {
            break MISSING_BLOCK_LABEL_122;
...
_L2:
        ...
        Exception exception;
        exception;
        alt.h().e("CrashlyticsCore", (new StringBuilder()).append("Error occurred sending report ").append(report).toString(), exception);
        flag = flag1;
