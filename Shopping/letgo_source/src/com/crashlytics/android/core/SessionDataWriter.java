...
class SessionDataWriter
{
    ...
    private int getDeviceIdentifierSize(android.support.v7.amw.a a, String s)
    {
...
label0:
        {
            ...
            for (k = 0; k < l;)
            {
                ...
                int j1 = CodedOutputStream.computeTagSize(4);
    ...
    private int getEventAppExecutionSize(Thread thread, Throwable throwable)
    {
        ...
        int l = CodedOutputStream.computeTagSize(1);
        ...
        for (; j < k; j++)
        {
            l = getThreadSize(threads[j], (StackTraceElement[])stacks.get(j), 0, false);
            i += l + (CodedOutputStream.computeTagSize(1) + CodedOutputStream.computeRawVarint32Size(l));
        }

        j = getEventAppExecutionExceptionSize(throwable, 1);
        k = CodedOutputStream.computeTagSize(2);
        l = CodedOutputStream.computeRawVarint32Size(j);
        i1 = getEventAppExecutionSignalSize();
        int j1 = CodedOutputStream.computeTagSize(3);
        int k1 = CodedOutputStream.computeRawVarint32Size(i1);
        int l1 = getBinaryImageSize();
        return j + (k + l) + i + (i1 + (j1 + k1)) + (l1 + (CodedOutputStream.computeTagSize(3) + CodedOutputStream.computeRawVarint32Size(l1)));
    }
    ...
    {
        return 0 + CodedOutputStream.computeBytesSize(1, ByteString.copyFromUtf8((new amo()).a(context)));
    }
    ...
    private int getSessionAppSize(ByteString bytestring, ByteString bytestring1, ByteString bytestring2, ByteString bytestring3, int i)
    {
        ...
        return 0 + j + k + l + (i1 + (CodedOutputStream.computeTagSize(5) + CodedOutputStream.computeRawVarint32Size(i1))) + CodedOutputStream.computeBytesSize(6, bytestring3) + CodedOutputStream.computeEnumSize(10, i);
    }
    ...
    private int getSessionDeviceSize(int i, ByteString bytestring, ByteString bytestring1, int j, long l, long l1, boolean flag, Map map, int k, ByteString bytestring2, ByteString bytestring3)
    {
        ...
        i = i + (j1 + (0 + i1)) + CodedOutputStream.computeUInt32Size(5, j) + CodedOutputStream.computeUInt64Size(6, l) + CodedOutputStream.computeUInt64Size(7, l1) + CodedOutputStream.computeBoolSize(10, flag);
        if (map != null)
        {
            ...
            do
            {
                ...
                j = getDeviceIdentifierSize((android.support.v7.amw.a)bytestring1.getKey(), (String)bytestring1.getValue());
    ...
    private int getThreadSize(Thread thread, StackTraceElement astacktraceelement[], int i, boolean flag)
    {
        ...
        for (i = 0; i < k; i++)
        {
            ...
            j += l + (CodedOutputStream.computeTagSize(3) + CodedOutputStream.computeRawVarint32Size(l));
        }
...
label0:
        ...
        throws Exception
    {
        ...
        codedoutputstream.writeString(1, (new amo()).a(context));
        codedoutputstream.writeBytes(6, s3);
        codedoutputstream.writeEnum(10, i);
    }

    public void writeSessionDevice(CodedOutputStream codedoutputstream, String s, int i, String s1, int j, long l, 
        ...
        throws Exception
    {
        ...
        for (s = map.entrySet().iterator(); s.hasNext(); codedoutputstream.writeBytes(2, ByteString.copyFromUtf8((String)map.getValue())))
        {
            ...
            codedoutputstream.writeRawVarint32(getDeviceIdentifierSize((android.support.v7.amw.a)map.getKey(), (String)map.getValue()));
            codedoutputstream.writeEnum(1, ((android.support.v7.amw.a)map.getKey()).h);
        }
    ...
    public void writeSessionEvent(CodedOutputStream codedoutputstream, long l, Thread thread, Throwable throwable, String s, Thread athread[], 
            float f, int i, boolean flag, int j, long l1, long l2, android.app.ActivityManager.RunningAppProcessInfo runningappprocessinfo, List list, StackTraceElement astacktraceelement[], LogFileManager logfilemanager, Map map)
        throws Exception
    {
        ...
        if (athread == null)
        {
            alt.h().a("CrashlyticsCore", "No log data to include with this event.");
        }
        logfilemanager.clearLog();
        codedoutputstream.writeTag(10, 2);
        codedoutputstream.writeRawVarint32(getSessionEventSize(thread, throwable, s, l, map, f, i, flag, j, l1, l2, athread));
        codedoutputstream.writeUInt64(1, l);
        codedoutputstream.writeBytes(2, ByteString.copyFromUtf8(s));
        writeSessionEventApp(codedoutputstream, thread, throwable, j, map);
        writeSessionEventDevice(codedoutputstream, f, i, flag, j, l1, l2);
