...
public class FacebookContentProvider extends ContentProvider
{
    ...
    public static String a(String s, UUID uuid, String s1)
    {
        ...
        throws FileNotFoundException
    {
        ...
        try
        {
            uri = ParcelFileDescriptor.open(jw.a((UUID)((Pair) (uri)).first, (String)((Pair) (uri)).second), 0x10000000);
        }
        // Misplaced declaration of an exception variable
        catch (Uri uri)
        {
            Log.e(a, (new StringBuilder()).append("Got unexpected exception:").append(uri).toString());
            throw uri;
        }
        return uri;
    }
