...
//            LoginMethodHandler, e, c, GetTokenLoginMethodHandler, 
//            KatanaProxyLoginMethodHandler, WebViewLoginMethodHandler, a, f
    ...
    implements Parcelable
{
        ...
        implements Parcelable
    {
        ...
        boolean g()
        {
            ...
            {
                if (com.facebook.login.f.a((String)iterator.next()))
                {
                    return true;
                }
            }
        ...
        Request(c c1, Set set, com.facebook.login.a a1, String s, String s1)
        {
            f = false;
            a = c1;
            if (set == null)
    ...
    public static int d()
    {
        return android.support.v7.jn.b.a.a();
    }
