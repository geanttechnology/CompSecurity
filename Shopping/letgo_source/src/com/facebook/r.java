...
final class r
{
    ...
    public r(Context context, String s1)
    {
        kc.a(context, "context");
        String s2 = s1;
        if (kb.a(s1))
        {
            s2 = "com.facebook.SharedPreferencesTokenCachingStrategy.DEFAULT_KEY";
        }
        b = s2;
        ...
        throws JSONException
    {
        ...
        flag5 = false;
        i = 0;
        obj = JSONObjectInstrumentation.init(c.getString(s1, "{}"));
...
_L5:
    ...
    public Bundle a()
    {
        ...
        do
        {
            ...
            {
                jv.a(s.d, 5, a, (new StringBuilder()).append("Error reading cached value for key: '").append(s1).append("' -- ").append(obj).toString());
                return null;
            }
        } while (true);
        return ((Bundle) (obj));
