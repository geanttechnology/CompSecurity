...
public final class o
{
    ...
    private static final byte i[][] = a(new byte[][][] {
        a, b, c, d
    });
    ...
    public static int a(Context context)
    {
        ...
        try
        {
            context.getResources().getString(k.a.a);
        }
        ...
        abyte0 = a(packageinfo, a);
        if (abyte0 == null)
        {
            Log.w("GooglePlayServicesUtil", "Google Play Store signature invalid.");
            return 9;
        }
        if (a(((PackageInfo) (context)), new byte[][] {
    abyte0
}) == null)
        {
    ...
    public static Intent a(Context context, int i1, int j1)
    {
        ...
        case 2: // '\002'
            if (a(j1))
            {
                ...
                {
                    return r.b("com.google.android.apps.bazaar");
                }
            } else
            {
                return r.b("com.google.android.gms");
            }
...
_L4:
        ...
        throws n, m
    {
        ...
        if (i1 != 0)
        {
            ...
            {
                throw new n(i1, "Google Play Services not available", context);
            }
        } else
        {
            return;
