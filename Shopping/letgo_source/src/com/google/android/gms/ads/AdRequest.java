...
public final class AdRequest
{
    public static final class Builder
    {
        ...
        public Builder addNetworkExtrasBundle(Class class1, Bundle bundle)
        {
            ...
            if (class1.equals(android/support/v7/kr) && bundle.getBoolean("_emulatorLiveAds"))
            {
        ...
        {
            x.a(s, "Content URL must be non-null.");
            x.a(s, "Content URL must be non-empty.");
            boolean flag;
            if (s.length() <= 512)
            {
                flag = true;
            ...
            x.a(flag, "Content URL must not exceed %d in length.  Provided length was %d.", new Object[] {
