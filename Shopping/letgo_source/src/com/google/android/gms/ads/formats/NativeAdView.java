...
public abstract class NativeAdView extends FrameLayout
{
    ...
    private ob zzaI()
    {
        x.a(zznY, "createDelegate must be called after mOverlayFrame has been created");
        return zzk.zzcI().a(zznY.getContext(), this, zznY);
    }
