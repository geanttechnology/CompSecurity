    ...
    implements android.os.Parcelable.Creator
{
    ...
    static void zza(AdRequestParcel adrequestparcel, Parcel parcel, int i)
    {
        ...
        b.b(parcel, 5, adrequestparcel.zzss, false);
        ...
        b.b(parcel, 15, adrequestparcel.zzsC, false);
    ...
    public AdRequestParcel zzb(Parcel parcel)
    {
        ...
        do
        {
            if (parcel.dataPosition() < l)
            {
                ...
                case 13: // '\r'
                    bundle1 = a.m(parcel, i1);
                    break;

                case 14: // '\016'
                    bundle = a.m(parcel, i1);
                    break;

                case 15: // '\017'
                    arraylist = a.r(parcel, i1);
                    break;
