...
public final class zzj
{
    ...
    public zzj(Context context, AttributeSet attributeset)
    {
        boolean flag1 = true;
        super();
        context = context.getResources().obtainAttributes(attributeset, android.support.v7.ks.c.AdsAttrs);
        attributeset = context.getString(android.support.v7.ks.c.AdsAttrs_adSize);
        String s = context.getString(android.support.v7.ks.c.AdsAttrs_adSizes);
        boolean flag;
        ...
        zzoZ = context.getString(android.support.v7.ks.c.AdsAttrs_adUnitId);
    ...
    private static AdSize[] zzE(String s)
    {
        String as[];
        AdSize aadsize[];
        int i;
