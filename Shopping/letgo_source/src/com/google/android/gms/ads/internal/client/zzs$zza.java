...
_L4:
        ...
        throws RemoteException
    {
        ...
        case 1: // '\001'
            ...
            lk = android.support.v7.terface(parcel.readStrongBinder());
            if (parcel.readInt() != 0)
            {
                obj = AdSizeParcel.CREATOR.zzc(parcel);
            }
            parcel = zza(lk, ((AdSizeParcel) (obj)), parcel.readString(), android.support.v7.g(parcel.readStrongBinder()), parcel.readInt());
        ...
        case 2: // '\002'
            parcel.enforceInterface("com.google.android.gms.ads.internal.client.IAdManagerCreator");
            lk1 = android.support.v7.terface(parcel.readStrongBinder());
            obj = lk;
            break;
        }
        if (parcel.readInt() != 0)
        ...
        parcel = zza(lk1, ((AdSizeParcel) (obj)), parcel.readString(), android.support.v7.g(parcel.readStrongBinder()), parcel.readInt(), parcel.readInt());
        parcel1.writeNoException();
        parcel1.writeStrongBinder(parcel);
        return true;
    }
