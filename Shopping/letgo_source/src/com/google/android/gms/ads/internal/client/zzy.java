...
public class zzy
{
    ...
    private void zzcR()
    {
        android.support.v7.lk lk = zztm.zzaM();
        if (lk == null)
        {
            return;
        }
...
_L1:
        ...
        inapppurchaselistener = new rk(inapppurchaselistener);
_L3:
...
_L1:
        ...
        oncustomrenderedadloadedlistener = new ny(oncustomrenderedadloadedlistener);
_L3:
...
_L1:
        ...
        playstorepurchaselistener = new ro(playstorepurchaselistener);
_L3:
...
_L2:
        ...
        throws RemoteException
    {
        ...
        if (zztp != null)
        {
            zztm.zza(new rk(zztp));
        }
        if (zztq != null)
        {
            zztm.zza(new ro(zztq), zztn);
        }
        if (zztr != null)
        {
            zztm.zza(new ny(zztr));
        }
        zztm.zza(zzk.zzcG());
        zztm.setManualImpressionsEnabled(zzoM);
        zzcR();
