...
public class zzf extends android.support.v7.oh.a
    implements zzh.zza
{
    ...
    private final vk zzvX;
    private final vk zzvY;

    public zzf(String s, vk vk1, vk vk2, zza zza1)
    {
        zzvW = s;
        zzvX = vk1;
        zzvY = vk2;
