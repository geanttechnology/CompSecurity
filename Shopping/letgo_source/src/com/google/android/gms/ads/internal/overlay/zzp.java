...
public class zzp
{
    ...
    private final ns zzBn;
    private final nt zzBo;
    private final VersionInfoParcel zzBp;
    private final ts zzBq = (new android.support.v7.ts.b()).a("min_1", 4.9406564584124654E-324D, 1.0D).a("1_5", 1.0D, 5D).a("5_10", 5D, 10D).a("10_20", 10D, 20D).a("20_30", 20D, 30D).a("30_max", 30D, 1.7976931348623157E+308D).a();
    ...
    public zzp(Context context, VersionInfoParcel versioninfoparcel, String s, nt nt1, ns ns)
    {
        zzBB = -1L;
        mContext = context;
...
_L2:
    ...
    public void onStop()
    {
        if (((Boolean)nn.u.c()).booleanValue() && !zzBz)
        {
            ...
            {
                a = (android.support.v7.ts.a)iterator.next();
