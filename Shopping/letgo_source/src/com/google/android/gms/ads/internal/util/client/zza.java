...
public class zza
{
    ...
    private void zza(ViewGroup viewgroup, AdSizeParcel adsizeparcel, String s, int i, int j)
    {
    ...
    {
        zza(viewgroup, adsizeparcel, s, 0xff000000, -1);
    }

    public void zza(ViewGroup viewgroup, AdSizeParcel adsizeparcel, String s, String s1)
    {
        com.google.android.gms.ads.internal.util.client.zzb.zzaE(s1);
        zza(viewgroup, adsizeparcel, s, 0xffff0000, 0xff000000);
    }
