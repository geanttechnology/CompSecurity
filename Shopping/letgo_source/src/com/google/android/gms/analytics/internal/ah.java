...
public class ah extends p
{
    ...
    {
        Intent intent = new Intent(o(), android/support/v7/kt);
    ...
    protected void a()
    {
        ...
        try
        {
            ...
            activityinfo = o().getPackageManager().getReceiverInfo(new ComponentName(o(), android/support/v7/kt), 2);
        }
