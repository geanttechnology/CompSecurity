...
public final class ak
{
    public static final class a
    {
        ...
        {
            return new a(vf.a(s1, Float.valueOf(f2)), Float.valueOf(f1));
        }
        ...
        {
            return new a(vf.a(s1, Integer.valueOf(j1)), Integer.valueOf(i1));
        }
        ...
        {
            return new a(vf.a(s1, Long.valueOf(l2)), Long.valueOf(l1));
        }
        ...
        {
            return new a(vf.a(s1, flag1), Boolean.valueOf(flag));
        }
        ...
        private a(vf vf1, Object obj)
        {
            com.google.android.gms.common.internal.x.a(vf1);
            b = vf1;
            a = obj;
        }
    }
    ...
    static 
    {
        ...
        w = a.a("analytics.compression_strategy.k", aa.b.name());
    }
}
