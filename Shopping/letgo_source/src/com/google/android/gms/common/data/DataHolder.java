    ...
    implements SafeParcelable
{
    ...
    private DataHolder(a a1, int i1, Bundle bundle)
    {
        this(a.a(a1), a(a1, -1), i1, bundle);
    }
    ...
    public DataHolder(String as[], CursorWindow acursorwindow[], int i1, Bundle bundle)
    {
        ...
        e = 1;
        f = (String[])x.a(as);
        g = (CursorWindow[])x.a(acursorwindow);
        h = i1;
        i = bundle;
        a();
    }
    ...
    private static CursorWindow[] a(a a1, int i1)
    {
        ...
        int l1;
        if (i1 < 0 || i1 >= a.b(a1).size())
        {
            obj1 = a.b(a1);
        } else
        {
            obj1 = a.b(a1).subList(0, i1);
        }
        l1 = ((List) (obj1)).size();
...
_L4:
        ...
        Object obj2;
        long l2;
        for (boolean flag1 = true; k1 >= a.a(a1).length || !flag1; k1++)
        {
...
label0:
    ...
    public boolean b(String s, int i1, int j1)
    {
        a(s, i1);
