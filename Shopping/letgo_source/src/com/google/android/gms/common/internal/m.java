    ...
    implements android.os.Handler.Callback
{
    ...
    public void a(int j)
    {
        ...
        x.a(flag, "onUnintentionalDisconnection must only be called on the Handler thread");
        h.removeMessages(1);
        Object obj = i;
        obj;
...
_L4:
    ...
    public void a(Bundle bundle)
    {
        ...
        x.a(flag, "onConnectionSuccess must only be called on the Handler thread");
        obj = i;
        obj;
        JVM INSTR monitorenter ;
        if (!g)
...
_L4:
    ...
    public void a(ConnectionResult connectionresult)
    {
        ...
        x.a(flag, "onConnectionFailure must only be called on the Handler thread");
        h.removeMessages(1);
        obj = i;
        obj;
        JVM INSTR monitorenter ;
