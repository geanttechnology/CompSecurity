...
public class b
{
    ...
    private b()
    {
        ...
        f = ((List) (obj));
        h = new e(1024, ((Long)com.google.android.gms.common.stats.c.a.f.c()).longValue());
    }
        ...
        if (f.a)
        {
            if (a(context, s, intent, s1 = a(serviceconnection), j))
            {
                ...
                } else
                {
                    ...
                    serviceconnection = new ConnectionEvent(l1, j, vt.a(context), s, ((ServiceInfo) (intent)).processName, ((ServiceInfo) (intent)).name, serviceconnection, s1, SystemClock.elapsedRealtime(), l);
                }
    ...
    private boolean a(Context context, Intent intent)
    {
        ...
        if (intent == null || f.a && "com.google.android.gms".equals(intent.getPackageName()))
        {
            return false;
        } else
        {
            return vm.a(context, intent.getPackageName());
        }
    }
...
_L3:
        ...
        context = vt.a(context);
        intent = ((ServiceInfo) (obj)).processName;
        obj = ((ServiceInfo) (obj)).name;
        if (!c.contains(context) && !d.contains(s) && !e.contains(intent) && !f.contains(obj) && (!intent.equals(context) || (k & com.google.android.gms.common.stats.d.f) == 0))
        {
            h.a(s1);
            return true;
        }
...
_L1:
        if (!vm.a()) goto _L4; else goto _L3
_L3:
