...
public class h
{
    ...
    public static h a(Intent intent)
    {
        ...
        {
            return new h(intent.getIntExtra("gms_error_code", -1), b(intent), c(intent), (Location)intent.getParcelableExtra("com.google.android.location.intent.extra.triggering_location"));
        }
    }
    ...
    private static List c(Intent intent)
    {
        ...
        for (obj = ((ArrayList) (obj)).iterator(); ((Iterator) (obj)).hasNext(); intent.add(ParcelableGeofence.a((byte[])((Iterator) (obj)).next()))) { }
        return intent;
    }
