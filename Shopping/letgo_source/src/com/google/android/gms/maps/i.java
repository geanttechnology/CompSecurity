    ...
    implements android.os.Parcelable.Creator
{
    ...
    static void a(StreetViewPanoramaOptions streetviewpanoramaoptions, Parcel parcel, int j)
    {
        ...
        b.a(parcel, 2, streetviewpanoramaoptions.g(), j, false);
        b.a(parcel, 3, streetviewpanoramaoptions.j(), false);
        b.a(parcel, 4, streetviewpanoramaoptions.h(), j, false);
    ...
    public StreetViewPanoramaOptions a(Parcel parcel)
    {
        ...
        do
        {
            if (parcel.dataPosition() < k)
            {
                ...
                case 5: // '\005'
                    integer = com.google.android.gms.common.internal.safeparcel.a.g(parcel, l);
                    break;
    ...
    public StreetViewPanoramaOptions[] a(int j)
    {
