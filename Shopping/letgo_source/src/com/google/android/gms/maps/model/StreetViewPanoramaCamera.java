...
//            p, StreetViewPanoramaOrientation
    ...
    implements SafeParcelable
{
    ...
    StreetViewPanoramaCamera(int i, float f, float f1, float f2)
    {
        ...
        c = f % 360F;
        e = (new StreetViewPanoramaOrientation.a()).a(f1).b(f2).a();
    }
    ...
    {
        return w.a(this).a("zoom", Float.valueOf(a)).a("tilt", Float.valueOf(b)).a("bearing", Float.valueOf(c)).toString();
    }
