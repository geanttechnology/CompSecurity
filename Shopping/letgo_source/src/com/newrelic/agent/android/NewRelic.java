...
public class NewRelic
{
    ...
    {
        log.debug((new StringBuilder()).append("NewRelic.noticeNetworkFailure invoke - url: ").append(s).append(", httpMethod: ").append(s1).append(", startTime: ").append(l).append(", endTime: ").append(l1).append(", failure: ").append(networkfailure).toString());
        TaskQueue.queue(new HttpTransactionMeasurement(s, s1, 0, networkfailure.getErrorCode(), l, l1, 0L, 0L, null));
    }
    ...
    public static void noticeNetworkFailure(String s, String s1, long l, long l1, Exception exception)
    {
        ...
        noticeNetworkFailure(s, s1, l, l1, NetworkFailure.exceptionToNetworkFailure(exception));
    }
