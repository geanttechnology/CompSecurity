...
public interface HarvestErrorCodes
{
    ...
    public static final int NSURLErrorFileIOException = -1302;
    public static final int NSURLErrorIOException = -1300;
    public static final int NSURLErrorRuntimeException = -1301;
