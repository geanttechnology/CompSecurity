    ...
    implements TypeAdapterFactory
{
    ...
    public TypeAdapter create(Gson gson, TypeToken typetoken)
    {
        ...
        {
            typetoken = com.newrelic.com.google.gson.internal.yComponentType(typetoken);
            return new ArrayTypeAdapter(gson, gson.getAdapter(TypeToken.get(typetoken)), com.newrelic.com.google.gson.internal.ype(typetoken));
        }
    }
