...
public final class TypeAdapters
{
    private static final class EnumTypeAdapter extends TypeAdapter
    {
        ...
        public EnumTypeAdapter(Class class1)
        {
            ...
            enum = aenum[i];
            s = enum.name();
            serializedname = (SerializedName)class1.getField(s).getAnnotation(com/newrelic/com/google/gson/annotations/SerializedName);
...
_L3:
        ...
        JSON_ELEMENT_FACTORY = newTypeHierarchyFactory(com/newrelic/com/google/gson/JsonElement, JSON_ELEMENT);
    }
}
