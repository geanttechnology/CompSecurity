...
class GcmRegistrar
{
    ...
    private cu getLocalDeviceTokenLastModifiedAsync()
    {
...
_L1:
    ...
    private cu sendRegistrationRequestAsync()
    {
label0:
        {
            cu cu1;
...
_L2:
        ...
        obj = request.getTask().a(new ct() {
            ...
            public Void then(cu cu2)
            {
                ...
                if (cu2 != null)
                {
                    PLog.e("com.parse.GcmRegistrar", "Got error when trying to register for GCM push", cu2);
                }
                synchronized (lock)
                {
                    request = null;
...
_L1:
    ...
    public cu handleRegistrationIntentAsync(Intent intent)
    {
    ...
    cu isLocalDeviceTokenStaleAsync()
    {
        return getLocalDeviceTokenLastModifiedAsync().d(new ct() {
...
_L1:
        obj = ((cu) (obj)).d(new ct() {
                ...
                throws Exception
            {
                ...
                if (installation.getPushType() != PushType.GCM)
                {
                    ...
                    cu1 = installation.saveInBackground();
                } else
                {
                    cu1 = cu.a(null);
                }
    ...
    cu updateLocalDeviceTokenLastModifiedAsync()
    {
        return cu.a(new Callable() {
