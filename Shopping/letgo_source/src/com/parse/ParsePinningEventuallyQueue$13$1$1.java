...
/* anonymous class */
        ...
        implements ct
    {
            ...
            throws Exception
        {
            ...
            {
                return eventuallyPin.unpinInBackground("_eventuallyPin").b(new ParsePinningEventuallyQueue._cls13._cls1._cls2()).b(executeTask. new ParsePinningEventuallyQueue._cls13._cls1._cls1());
            }
        }
