...
//            InstallationId, ParseHttpClient, ParseNetworkInterceptor, ManifestInfo, 
//            ParseHttpRequest, ParseHttpResponse
...
class ParsePlugins
{
    static class Android extends ParsePlugins
    {
        ...
        String userAgent()
        {
            ...
            s = s1;
_L2:
            return (new StringBuilder()).append("Parse Android SDK 1.9.4 (").append(s).append(") API Level ").append(android.os.Build.VERSION.SDK_INT).toString();
...
_L1:
    ...
    private static void set(ParsePlugins parseplugins)
    {
        Object obj = LOCK;
        obj;
            ...
            if (restClient == null)
            {
                ...
                restClient.addInternalInterceptor(new ParseNetworkInterceptor() {
                        ...
                        throws IOException
                    {
                        ...
                        ParseHttpRequest.Builder builder = (new ParseHttpRequest.Builder(parsehttprequest)).addHeader("X-Parse-Application-Id", applicationId).addHeader("X-Parse-Client-Key", clientKey).addHeader("X-Parse-Client-Version", "a1.9.4").addHeader("X-Parse-App-Build-Version", String.valueOf(ManifestInfo.getVersionCode())).addHeader("X-Parse-App-Display-Version", ManifestInfo.getVersionName()).addHeader("X-Parse-OS-Version", android.os.Build.VERSION.RELEASE).addHeader("User-Agent", userAgent());
