...
public class ParseQuery
{
    ...
    private static interface CacheThenNetworkCallable
    {
        ...
        public abstract Object call(State state, ParseUser parseuser, cu cu1);
    }
...
_L4:
    ...
    private android.support.v7.cu.a cts;
    ...
    private cu countAsync(final State state)
    {
        return doWithRunningCheck(new Callable() {
            ...
            public cu call()
                throws Exception
            {
                return getUserAsync(state).d(new ct() {
                    ...
                    {
                        cu1 = (ParseUser)cu1.e();
                        return countAsync(state, cu1, cts.a());
                    }
    ...
    private cu countAsync(State state, ParseUser parseuser, cu cu1)
    {
        return getQueryController().countAsync(state, parseuser, cu1);
    }

    private cu doCacheThenNetwork(final State state, final ParseCallback2 callback, final CacheThenNetworkCallable delegate)
    {
        return doWithRunningCheck(new Callable() {
                ...
                throws Exception
            {
                return getUserAsync(state).d(new ct() {
                        ...
                        throws Exception
                    {
                        ...
                        return ParseTaskUtils.callbackOnMainThreadAsync((cu)_flddelegate.call(state, cu1, cts.a()), callback).b(cu1. new ct() {
                                ...
                                throws Exception
                            {
                                ...
                                {
                                    return (cu)_flddelegate.call(networkState, user, cts.a());
                                }
                            }
    ...
    private cu doWithRunningCheck(Callable callable)
    {
        checkIfRunning(true);
        try
        {
            callable = (cu)callable.call();
        }
        // Misplaced declaration of an exception variable
        catch (Callable callable)
        {
            callable = cu.a(callable);
        }
        return callable.b(new ct() {
    ...
    private cu findAsync(final State state)
    {
        return doWithRunningCheck(new Callable() {
                ...
                throws Exception
            {
                return getUserAsync(state).d(new ct() {
                    ...
                    {
                        cu1 = (ParseUser)cu1.e();
                        return findAsync(state, cu1, cts.a());
                    }
    ...
    private cu getFirstAsync(final State state)
    {
        return doWithRunningCheck(new Callable() {
                ...
                throws Exception
            {
                return getUserAsync(state).d(new ct() {
                    ...
                    {
                        cu1 = (ParseUser)cu1.e();
                        return getFirstAsync(state, cu1, cts.a());
                    }
    ...
    private cu getFirstAsync(State state, ParseUser parseuser, cu cu1)
    {
        return getQueryController().getFirstAsync(state, parseuser, cu1);
    }
    ...
    public void countInBackground(final CountCallback callback)
    {
        ...
        } else
        {
            obj = doCacheThenNetwork(((State) (obj)), callback, new CacheThenNetworkCallable() {
                ...
                public cu call(State state, ParseUser parseuser, cu cu1)
                {
                    return countAsync(state, parseuser, cu1);
                }

                public volatile Object call(State state, ParseUser parseuser, cu cu1)
                {
                    return call(state, parseuser, cu1);
                }
        ...
        ParseTaskUtils.callbackOnMainThreadAsync(((cu) (obj)), callback);
    }
    ...
    cu findAsync(State state, ParseUser parseuser, cu cu1)
    {
        return getQueryController().findAsync(state, parseuser, cu1);
    }

    public cu findInBackground()
    {
    ...
    public void findInBackground(FindCallback findcallback)
    {
        ...
        } else
        {
            obj = doCacheThenNetwork(((State) (obj)), findcallback, new CacheThenNetworkCallable() {
                ...
                public cu call(State state, ParseUser parseuser, cu cu1)
                {
                    return findAsync(state, parseuser, cu1);
                }
        ...
        ParseTaskUtils.callbackOnMainThreadAsync(((cu) (obj)), findcallback);
    }
    ...
    public cu getFirstInBackground()
    {
    ...
    public void getFirstInBackground(GetCallback getcallback)
    {
        ...
        } else
        {
            obj = doCacheThenNetwork(((State) (obj)), getcallback, new CacheThenNetworkCallable() {
                ...
                public cu call(State state, ParseUser parseuser, cu cu1)
                {
                    return getFirstAsync(state, parseuser, cu1);
                }
        ...
        ParseTaskUtils.callbackOnMainThreadAsync(((cu) (obj)), getcallback);
    }

    public cu getInBackground(String s)
    {
    ...
    {
        checkIfRunning();
        builder.addCondition(s, "$nearSphere", parsegeopoint);
        return this;
    }
    ...
    public ParseQuery whereWithinGeoBox(String s, ParseGeoPoint parsegeopoint, ParseGeoPoint parsegeopoint1)
    {
        ...
        builder.addCondition(s, "$within", parsegeopoint);
        return this;
    }
    ...
    {
        checkIfRunning();
        builder.addCondition(s, "$nearSphere", parsegeopoint).addCondition(s, "$maxDistance", Double.valueOf(d));
        return this;
    }
...
/*
    static android.support.v7.cu.a access$1902(ParseQuery parsequery, android.support.v7.cu.a a)
    {
        parsequery.cts = a;
        return a;
    }
