...
class ParseRESTAnalyticsCommand extends ParseRESTCommand
{
    ...
    public ParseRESTAnalyticsCommand(String s, ParseRequest.Method method, Map map, String s1)
    {
    ...
    static ParseRESTAnalyticsCommand trackEventCommand(String s, Map map, String s1)
    {
        ...
        return new ParseRESTAnalyticsCommand(s, ParseRequest.Method.POST, hashmap, s1);
    }
