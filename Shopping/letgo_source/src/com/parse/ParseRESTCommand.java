...
//            ParseRequest, NoObjectsEncoder, ParseObject, LocalIdManager, 
//            ParseByteArrayHttpBody, ParseHttpResponse, ParseIOUtils, ParseHttpClient, 
//            ProgressCallback, ParseHttpBody, ParseHttpRequest
...
class ParseRESTCommand extends ParseRequest
{
    ...
    static abstract class Init
    {
        ...
        private ParseRequest.Method method;
        ...
        public Init method(ParseRequest.Method method1)
        {
            method = method1;
            return self();
        }
    ...
    public ParseRESTCommand(String s, ParseRequest.Method method, Map map, String s1)
    {
        if (map != null)
        {
    ...
    protected ParseRESTCommand(String s, ParseRequest.Method method, JSONObject jsonobject, String s1)
    {
        this(s, method, jsonobject, null, s1);
    }

    private ParseRESTCommand(String s, ParseRequest.Method method, JSONObject jsonobject, String s1, String s2)
    {
    ...
    public static ParseRESTCommand fromJSONObject(JSONObject jsonobject)
    {
        ...
        ParseRequest.Method method = ParseRequest.Method.fromString(jsonobject.optString("httpMethod"));
...
_L5:
        ...
        throws JSONException
    {
        if (localId != null)
        {
            ...
            if (s != null)
            {
                ...
                if (httpPath.startsWith("classes") && method == ParseRequest.Method.POST)
                {
                    method = ParseRequest.Method.PUT;
                }
            }
        }
    }
    ...
    {
        resolveLocalIds();
        return super.executeAsync(parsehttpclient, progresscallback, progresscallback1, cu1);
    }
    ...
    public String getCacheKey()
    {
        ...
        return String.format("ParseRESTCommand.%s.%s.%s", new Object[] {
            method.toString(), DigestUtils.md5Hex(httpPath), DigestUtils.md5Hex(((String) (obj1)))
        });
    }
    ...
    protected ParseHttpRequest newRequest(ParseRequest.Method method, String s, ProgressCallback progresscallback)
    {
        if (jsonParameters != null && method != ParseRequest.Method.POST && method != ParseRequest.Method.PUT)
        {
            method = super.newRequest(ParseRequest.Method.POST, s, progresscallback);
        } else
        {
            method = super.newRequest(method, s, progresscallback);
        }
        method = new ParseHttpRequest.Builder(method);
    ...
    protected cu onResponseAsync(ParseHttpResponse parsehttpresponse, ProgressCallback progresscallback)
    {
        ...
        try
        {
            progresscallback = new String(ParseIOUtils.toByteArray(parsehttpresponse.getContent()));
        }
        // Misplaced declaration of an exception variable
        catch (ParseHttpResponse parsehttpresponse)
        {
            return cu.a(parsehttpresponse);
        }
        i = parsehttpresponse.getStatusCode();
        if (i < 200 || i >= 600)
        {
        ...
        try
        {
            parsehttpresponse = JSONObjectInstrumentation.init(progresscallback);
        }
        // Misplaced declaration of an exception variable
        catch (ParseHttpResponse parsehttpresponse)
        {
        ...
        parsehttpresponse = cu.a(newPermanentException(parsehttpresponse.optInt("code"), parsehttpresponse.optString("error")));
        return parsehttpresponse;
        if (i < 500)
        {
            break MISSING_BLOCK_LABEL_112;
        }
        return cu.a(newTemporaryException(parsehttpresponse.optInt("code"), parsehttpresponse.optString("error")));
        parsehttpresponse = cu.a(parsehttpresponse);
        return parsehttpresponse;
        return cu.a(newPermanentException(-1, progresscallback));
    }
    ...
    public void releaseLocalIds()
    {
        ...
        try
        {
            ...
            String s;
            for (obj = ((ArrayList) (obj)).iterator(); ((Iterator) (obj)).hasNext(); LocalIdManager.getDefaultInstance().releaseLocalIdOnDisk(s))
            {
...
_L1:
    ...
    public void retainLocalIds()
    {
        ...
        try
        {
            ...
            getLocalPointersIn(jsonParameters, ((ArrayList) (obj)));
            String s;
            for (obj = ((ArrayList) (obj)).iterator(); ((Iterator) (obj)).hasNext(); LocalIdManager.getDefaultInstance().retainLocalIdOnDisk(s))
            {
                s = (String)((JSONObject)((Iterator) (obj)).next()).get("localId");
            }
