...
class ParseRESTQueryCommand extends ParseRESTCommand
{
    ...
    private ParseRESTQueryCommand(String s, ParseRequest.Method method, Map map, String s1)
    {
    ...
    public static ParseRESTQueryCommand countCommand(ParseQuery.State state, String s)
    {
        ...
        return new ParseRESTQueryCommand(s1, ParseRequest.Method.GET, state, s);
    }
