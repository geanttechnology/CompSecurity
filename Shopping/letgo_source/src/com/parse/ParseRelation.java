...
//            ParseDecoder, ParseObject, ParseRelationOperation, ParseEncoder, 
//            ParseQuery
...
_L1:
    ...
    public ParseQuery getQuery()
    {
        ...
        obj = (new ParseQuery.State.Builder(parent.getClassName())).redirectClassNameForKey(key);
_L1:
        ((ParseQuery.State.Builder) (obj)).whereRelatedTo(parent, key);
