...
//            ParseException, ParseUser, ParseAnonymousUtils, TaskQueue
...
label0:
                {
                    synchronized (((ParseUser) (user)).mutex)
                    {
                        ...
                        user = ((ParseUser) (user)).taskQueue.enqueue(new ParseUser._cls19._cls1());
                    }
                    return ((cu) (user));
                }
            }
              goto _L1
            user = ((ParseUser) (user)).linkWithAsync(authType, authData, ((ParseUser) (user)).getSessionToken()).b(((ParseUser._cls19._cls2) (user)). new ParseUser._cls19._cls2());
            cu1;
...
label0:
        ...
        // Unreferenced inner class com/parse/ParseUser$19$1$2

/* anonymous class */
        class ParseUser._cls19._cls1._cls2
            implements ct
        {
