...
//            PushConnection, ParseWakeLock, ParseRESTCommand, PLog
...
class val.readIntent extends BroadcastReceiver
{
    ...
    public void onReceive(final Context wl, Intent intent)
    {
        ...
        {
            cess._mth1302(this._cls1.this, cu.a(null).j());
        }
        cess._mth1302(this._cls1.this, cess._mth1300(this._cls1.this).a(new ct() {
            ...
            public Void then(cu cu1)
            {
                ...
                if (!flag)
                {
                    cu1 = PendingIntent.getBroadcast(appContext, System.identityHashCode(this), readIntent, 0x50000000);
                    PushConnection.KeepAliveMonitor.access$1500(this$1).set(2, SystemClock.elapsedRealtime() + PushConnection.KEEP_ALIVE_ACK_INTERVAL, cu1);
                } else
                {
