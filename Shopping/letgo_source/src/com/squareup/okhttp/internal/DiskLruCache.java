...
_L1:
            ...
            throws IOException
        {
            ...
            obj1 = new FaultHidingSink(((aqj) (obj1))) {
            ...
            throws IOException
        {
            ...
            JVM INSTR monitorexit ;
            return null;
            aqk aqk = fileSystem.source(entry.cleanFiles[i]);
            disklrucache;
            JVM INSTR monitorexit ;
            return aqk;
            aqk;
...
_L2:
            ...
            aaqk[i] = fileSystem.source(cleanFiles[i]);
            i++;
            if (true) goto _L2; else goto _L1
_L1:
            Snapshot snapshot1 = new Snapshot(key, sequenceNumber, aaqk, al);
            return snapshot1;
_L4:
            for (; i < valueCount && aaqk[i] != null; i++)
            {
...
*/
        ...
        implements Closeable
    {
        ...
        private Snapshot(String s, long l, aqk aaqk[], long al[])
        {
            this$0 = DiskLruCache.this;
            super();
            key = s;
        ...
        Snapshot(String s, long l, aqk aaqk[], long al[], _cls1 _pcls1)
        {
            this(s, l, aaqk, al);
        }
    }
    ...
    private static final aqj NULL_SINK = new aqj() {
...
_L6:
    ...
    private apw newJournalWriter()
        throws FileNotFoundException
    {
        return aqe.a(new FaultHidingSink(fileSystem.appendingSink(journalFile)) {
    ...
    private void readJournal()
        throws IOException
    {
        apx apx1 = aqe.a(fileSystem.source(journalFile));
        String s = apx1.r();
        String s1 = apx1.r();
        String s2 = apx1.r();
        String s3 = apx1.r();
...
_L5:
        ...
        throws IOException
    {
        ...
        obj = aqe.a(fileSystem.sink(journalFileTmp));
        Iterator iterator;
        ((apw) (obj)).b("libcore.io.DiskLruCache").g(10);
        ((apw) (obj)).b("1").g(10);
        ((apw) (obj)).k(appVersion).g(10);
        ((apw) (obj)).k(valueCount).g(10);
        ((apw) (obj)).g(10);
...
_L1:
        ...
        JVM INSTR monitorexit ;
        throw obj;
        ((apw) (obj)).b("CLEAN").g(32);
        ((apw) (obj)).b(entry.key);
        entry.writeLengths(((apw) (obj)));
        ((apw) (obj)).g(10);
          goto _L1
        ((apw) (obj)).close();
