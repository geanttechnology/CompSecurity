    ...
    implements FrameReader
{
        ...
        throws IOException
    {
        ...
        {
            andler.goAway(i & 0x7fffffff, errorcode, apy.b);
            return;
        }
    }
    ...
    private void readHeaders(andler andler, int i, int j)
        throws IOException
    {
        andler.headers(false, false, source.k() & 0x7fffffff, -1, headerBlockReader.readNameValueBlock(j - 4), HeadersMode.SPDY_HEADERS);
    }
