    ...
    implements <init>
{
        ...
        throws IOException
    {
        ...
        {
            SpdyConnection.access$1200(SpdyConnection.this, i, apx1, j, flag);
        } else
        {
...
_L3:
    ...
    public void goAway(int i, ErrorCode errorcode, apy apy1)
    {
        ...
        {
            apy1 = (SpdyStream[])SpdyConnection.access$1700(SpdyConnection.this).values().toArray(new SpdyStream[SpdyConnection.access$1700(SpdyConnection.this).size()]);
