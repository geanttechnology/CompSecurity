...
public class RealmResults extends AbstractList
{
        ...
        implements Iterator
    {
        ...
        public RealmObject next()
        {
            ...
            if (pos >= size())
            {
                throw new IndexOutOfBoundsException((new StringBuilder()).append("Cannot access index ").append(pos).append(" when size is ").append(size()).append(". Remember to check hasNext() before using next().").toString());
            } else
            {
                return get(pos);
            }
        ...
        implements ListIterator
    {
        ...
        public RealmObject previous()
        {
            ...
            if (pos < 0)
            {
                throw new IndexOutOfBoundsException((new StringBuilder()).append("Cannot access index less than zero. This was ").append(pos).append(". Remember to check hasPrevious() before using previous().").toString());
            } else
            {
                return get(pos);
            }
        ...
        RealmResultsListIterator(int i)
        {
            ...
            {
                throw new IndexOutOfBoundsException((new StringBuilder()).append("Starting location must be a valid index: [0, ").append(size() - 1).append("]. Yours was ").append(i).toString());
            }
        }
    }
    ...
    private long getColumnIndex(String s)
    {
        if (s.contains("."))
        {
            throw new IllegalArgumentException((new StringBuilder()).append("Sorting using child object properties is not supported: ").append(s).toString());
        }
