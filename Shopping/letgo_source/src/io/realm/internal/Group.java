...
//            RealmCore, Context, OutOfMemoryError, Table
    ...
    implements Closeable
{
    ...
    public Table getTable(String s)
    {
        ...
        {
            throw new IllegalStateException((new StringBuilder()).append("Requested table is not in this Realm. Creating it requires a transaction: ").append(s).toString());
        }
    ...
    public String getTableName(int i)
    {
        ...
        if (i < 0 || (long)i >= l)
        {
            throw new IndexOutOfBoundsException((new StringBuilder()).append("Table index argument is out of range. possible range is [0, ").append(l - 1L).append("]").toString());
        } else
        {
