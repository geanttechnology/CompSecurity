...
public class Mixed
{
    ...
    public static Mixed mixedValue(Object obj)
    {
        ...
        {
            return new Mixed((byte[])(byte[])obj);
        }
        if (obj instanceof Mixed)
        {
            return (Mixed)(Mixed)obj;
        } else
        {
            throw new IllegalArgumentException((new StringBuilder()).append("The value is of unsupported type: ").append(obj.getClass()).toString());
        }
    }
...
_L3:
        if (value instanceof byte[])
        {
            ...
            byte abyte0[] = (byte[])(byte[])value;
            obj = (byte[])(byte[])((Mixed) (obj)).value;
...
_L4:
    ...
    public byte[] getBinaryByteArray()
    {
        if (!(value instanceof byte[]))
        {
            throw new IllegalMixedTypeException((new StringBuilder()).append("Can't get a byte[] from a Mixed containg a ").append(getType()).toString());
        } else
        {
    ...
    public ByteBuffer getBinaryValue()
    {
        if (!(value instanceof ByteBuffer))
        {
            throw new IllegalMixedTypeException((new StringBuilder()).append("Can't get a ByteBuffer from a Mixed containg a ").append(getType()).toString());
        } else
        {
    ...
    public boolean getBooleanValue()
    {
        ...
        {
            throw new IllegalMixedTypeException((new StringBuilder()).append("Can't get a boolean from a Mixed containg a ").append(getType()).toString());
        } else
        {
    ...
    public Date getDateValue()
    {
        ...
        {
            throw new IllegalMixedTypeException((new StringBuilder()).append("Can't get a Date from a Mixed containg a ").append(getType()).toString());
        } else
        {
            return (Date)value;
        }
    ...
    public double getDoubleValue()
    {
        ...
        {
            throw new IllegalMixedTypeException((new StringBuilder()).append("Can't get a double from a Mixed containg a ").append(getType()).toString());
        } else
        {
    ...
    public float getFloatValue()
    {
        ...
        {
            throw new IllegalMixedTypeException((new StringBuilder()).append("Can't get a float from a Mixed containg a ").append(getType()).toString());
        } else
        {
    ...
    public long getLongValue()
    {
        ...
        {
            throw new IllegalMixedTypeException((new StringBuilder()).append("Can't get a long from a Mixed containg a ").append(getType()).toString());
        } else
        {
    ...
    public String getReadableValue()
    {
        ...
        int i = _cls1..SwitchMap.io.realm.internal.ColumnType[columntype.ordinal()];
        i;
...
_L10:
    ...
    public String getStringValue()
    {
        ...
        {
            throw new IllegalMixedTypeException((new StringBuilder()).append("Can't get a String from a Mixed containg a ").append(getType()).toString());
        } else
        {
            return (String)value;
        }
