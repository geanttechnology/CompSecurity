...
_L1:
    ...
    public static void loadLibrary()
    {
        ...
        {
            String s = System.getenv("REALM_JAVA_DEBUG");
            if (s == null || s.isEmpty())
            {
                s = "realm-jni";
            } else
    ...
    private static String loadLibraryWindows()
    {
        ...
        } else
        {
            String s1 = loadCorrectLibrary(new String[] {
                "realm_jni32", "realm_jni64"
            });
            s = s1;
            if (s1 == null)
            {
                System.err.println((new StringBuilder()).append("Searched java.library.path=").append(System.getProperty("java.library.path")).toString());
    ...
    static 
    {
        ...
        BINARIES_PATH = (new StringBuilder()).append("lib").append(PATH_SEP).append("..").append(FILE_SEP).append("lib").toString();
    }
}
