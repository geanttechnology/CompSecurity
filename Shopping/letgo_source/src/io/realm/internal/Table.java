...
//            TableOrView, TableSchema, RealmCore, Context, 
//            Group, ColumnType, Mixed, Row, 
//            TableView, SubtableSchema, TableQuery, TableSpec
    ...
    implements TableOrView, TableSchema, Closeable
{
    ...
    public Table()
    {
        ...
        if (DEBUG)
        {
            ...
            TableCount = i;
            tableNo = i;
            System.err.println((new StringBuilder()).append("====== New Tablebase ").append(tableNo).append(" : ptr = ").append(nativePtr).toString());
        }
    }
    ...
    Table(Context context1, Object obj, long l)
    {
        ...
        if (DEBUG)
        {
            ...
            TableCount = i;
            tableNo = i;
            System.err.println((new StringBuilder()).append("===== New Tablebase(ptr) ").append(tableNo).append(" : ptr = ").append(nativePtr).toString());
        }
    }
    ...
    private void checkHasPrimaryKey()
    {
        if (!hasPrimaryKey())
        {
            throw new IllegalStateException((new StringBuilder()).append(getName()).append(" has no primary key defined").toString());
        } else
        {
            return;
        }
    ...
    private Table getPrimaryKeyTable()
    {
        ...
        Table table = group.getTable("pk");
        if (table.getColumnCount() == 0L)
        {
            table.addColumn(ColumnType.STRING, "pk_table");
            table.addColumn(ColumnType.STRING, "pk_property");
            return table;
        } else
        {
            migratePrimaryKeyTableIfNeeded(group, table);
            return table;
        }
    }
    ...
    private void insertSubtableValues(long l, long l1, Object obj)
    {
        if (obj != null)
        {
            ...
            int j = ((Object[])(Object[])obj).length;
            for (int i = 0; i < j; i++)
            {
                Object obj1 = ((Object[])(Object[])obj)[i];
                table.addAt(i, (Object[])(Object[])obj1);
            }
    ...
    private native void nativeMigratePrimaryKeyTableIfNeeded(long l, long l1);

    private native long nativeSetPrimaryKey(long l, long l1, String s);

    private void throwDuplicatePrimaryKeyException(Object obj)
    {
        throw new RealmException((new StringBuilder()).append("Primary key constraint broken. Value already exists: ").append(obj).toString());
    }
    ...
    public transient void addAt(long l, Object aobj[])
    {
        ...
        if (l > l1)
        {
            throw new IllegalArgumentException((new StringBuilder()).append("rowIndex ").append(String.valueOf(l)).append(" must be <= table.size() ").append(String.valueOf(l1)).append(".").toString());
        }
        j = (int)getColumnCount();
        if (j != aobj.length)
        {
            throw new IllegalArgumentException((new StringBuilder()).append("The number of value parameters (").append(String.valueOf(aobj.length)).append(") does not match the number of columns in the table (").append(String.valueOf(j)).append(").").toString());
        }
        ...
        for (int i = 0; i < j; i++)
        {
            ...
            if (!columntype.matchObject(obj1))
            {
                ...
                throw new IllegalArgumentException((new StringBuilder()).append("Invalid argument no ").append(String.valueOf(i + 1)).append(". Expected a value compatible with column type ").append(columntype).append(", but got ").append(((String) (aobj))).append(".").toString());
            }
        }
...
_L12:
        ...
        JVM INSTR tableswitch 1 9: default 356
    //                   1 499
    //                   2 420
    //                   3 392
    //                   4 455
...
_L1:
        throw new RuntimeException((new StringBuilder()).append("Unexpected columnType: ").append(String.valueOf(acolumntype[(int)l1])).toString());
_L4:
...
_L8:
        nativeInsertMixed(nativePtr, l1, l, Mixed.mixedValue(obj));
          goto _L13
_L9:
        nativeInsertByteArray(nativePtr, l1, l, (byte[])(byte[])obj);
          goto _L13
...
_L1:
    ...
    //                   2 110;
           goto _L3 _L4 _L5
_L3:
        throw new RealmException((new StringBuilder()).append("Cannot check for duplicate rows for unsupported primary key type: ").append(columntype).toString());
_L4:
...
_L6:
    ...
    public long addEmptyRowWithPrimaryKey(Object obj)
    {
        checkImmutable();
        checkHasPrimaryKey();
        long l = getPrimaryKey();
        ColumnType columntype = getColumnType(l);
        switch (_cls1..SwitchMap.io.realm.internal.ColumnType[columntype.ordinal()])
        {
        default:
            throw new RealmException((new StringBuilder()).append("Cannot check for duplicate rows for unsupported primary key type: ").append(columntype).toString());
        ...
        case 1: // '\001'
            ...
            {
                throw new IllegalArgumentException((new StringBuilder()).append("Primary key value is not a String: ").append(obj).toString());
            }
            if (findFirstString(l, (String)obj) != -1L)
            {
                throwDuplicatePrimaryKeyException(obj);
            }
            long l1 = nativeAddEmptyRow(nativePtr, 1L);
            getRow(l1).setString(l, (String)obj);
            return l1;
        ...
        try
        {
            l2 = (new Long(obj.toString())).longValue();
        }
        catch (RuntimeException runtimeexception)
        {
            throw new IllegalArgumentException((new StringBuilder()).append("Primary key value is not a long: ").append(obj).toString());
        }
        if (findFirstLong(l, l2) != -1L)
        {
            throwDuplicatePrimaryKeyException(Long.valueOf(l2));
        }
        l3 = nativeAddEmptyRow(nativePtr, 1L);
        getRow(l3).setLong(l, l2);
        return l3;
    }
    ...
    {
        checkImmutable();
        nativeAddSearchIndex(nativePtr, l);
    }
    ...
    public void close()
    {
        synchronized (context)
        {
            if (nativePtr != 0L)
            {
                ...
                {
                    TableCount--;
                    System.err.println((new StringBuilder()).append("==== CLOSE ").append(tableNo).append(" ptr= ").append(nativePtr).append(" remaining ").append(TableCount).toString());
                }
                nativePtr = 0L;
            }
        }
    ...
    protected void finalize()
    {
        ...
        if (DEBUG)
        {
            System.err.println((new StringBuilder()).append("==== FINALIZE ").append(tableNo).append("...").toString());
        }
        return;
        Exception exception;
        exception;
    ...
    public long getPrimaryKey()
    {
        ...
        } else
        {
            ...
            if (table != null)
            {
                ...
                if (l1 != -1L)
                {
                    cachedPrimaryKeyColumnIndex = getColumnIndex(table.getRow(l1).getString(1L));
                } else
                {
    ...
    {
        return nativeHasSearchIndex(nativePtr, l);
    }
    ...
    protected native void nativeAddSearchIndex(long l, long l1);
    ...
    protected native boolean nativeHasSearchIndex(long l, long l1);
    ...
    protected native void nativeRemoveSearchIndex(long l, long l1);
    ...
    public void removeSearchIndex(long l)
    {
        checkImmutable();
        nativeRemoveSearchIndex(nativePtr, l);
    }
    ...
    public transient void set(long l, Object aobj[])
    {
        ...
        for (int i = 0; i < j; i++)
        {
            ...
            {
                throw new IllegalArgumentException((new StringBuilder()).append("Invalid argument no ").append(String.valueOf(i + 1)).append(". Expected a value compatible with column type ").append(columntype).append(", but got ").append(obj.getClass()).append(".").toString());
            }
        }
