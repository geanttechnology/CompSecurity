...
{
    public static final class PivotType extends Enum
    {

        private static final PivotType $VALUES[];
        public static final PivotType AVG;
        public static final PivotType COUNT;
        public static final PivotType MAX;
        public static final PivotType MIN;
        public static final PivotType SUM;
        final int value;

        public static PivotType valueOf(String s)
        {
            return (PivotType)Enum.valueOf(io/realm/internal/TableOrView$PivotType, s);
        }
        ...
        static 
        {
            COUNT = new PivotType("COUNT", 0, 0);
            SUM = new PivotType("SUM", 1, 1);
            AVG = new PivotType("AVG", 2, 2);
            MIN = new PivotType("MIN", 3, 3);
            MAX = new PivotType("MAX", 4, 4);
            $VALUES = (new PivotType[] {
                COUNT, SUM, AVG, MIN, MAX
            });
        }

        private PivotType(String s, int i, int j)
        {
            super(s, i);
            value = j;
        }
