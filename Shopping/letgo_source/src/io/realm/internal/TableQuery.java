    ...
    implements Closeable
{
    ...
    public TableQuery(Context context1, Table table, long l)
    {
        ...
        if (DEBUG)
        {
            System.err.println((new StringBuilder()).append("++++++ new TableQuery, ptr= ").append(l).toString());
        }
        context = context1;
        parent = table;
        nativePtr = l;
...
label0:
    ...
    public void close()
    {
        synchronized (context)
        {
            if (nativePtr != 0L)
            {
                ...
                if (DEBUG)
                {
                    System.err.println((new StringBuilder()).append("++++ Query CLOSE, ptr= ").append(nativePtr).toString());
                }
                nativePtr = 0L;
            }
        }
    ...
    public TableQuery isNull(long l)
    {
        nativeIsNull(nativePtr, l);
        return this;
    }
    ...
    protected native void nativeIsNull(long l, long l1);
