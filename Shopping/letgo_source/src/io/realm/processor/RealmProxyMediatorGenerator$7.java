    ...
    implements oxySwitchStatement
{
    ...
    public void emitStatement(int i, JavaWriter javawriter)
        throws IOException
    {
        javawriter.emitStatement("return (E) %s.copyOrUpdate(realm, (%s) obj, update, cache)", new Object[] {
            RealmProxyMediatorGenerator.access$000(RealmProxyMediatorGenerator.this).get(i), RealmProxyMediatorGenerator.access$100(RealmProxyMediatorGenerator.this).get(i)
        });
    }
