...
public class RealmVersionChecker
{
    ...
    private static final String REALM_VERSION = "0.80.3";
    ...
    private String checkLatestVersion()
    {
        ...
        try
        {
            obj = (HttpURLConnection)HttpInstrumentation.openConnection((new URL("http://static.realm.io/update/java?0.80.3")).openConnection());
    ...
    private void launchRealmCheck()
    {
        ...
        if (!s.equals("0.80.3"))
        {
            printMessage((new StringBuilder()).append("Version ").append(s).append(" of Realm is now available: ").append("http://static.realm.io/downloads/java/latest").toString());
        }
    }
