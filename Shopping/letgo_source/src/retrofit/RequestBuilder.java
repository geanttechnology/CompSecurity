    ...
    implements RequestInterceptor.RequestFacade
{
    ...
    private void addQueryParam(String s, String s1, boolean flag, boolean flag1)
    {
        ...
        {
            throw new RuntimeException((new StringBuilder()).append("Unable to convert query parameter \"").append(s3).append("\" value to UTF-8: ").append(s4).toString(), s);
        }
    ...
    private void addQueryParamMap(int i, Map map, boolean flag, boolean flag1)
    {
        ...
        do
        {
            ...
            if (obj == null)
            {
                throw new IllegalArgumentException((new StringBuilder()).append("Parameter #").append(i + 1).append(" query map contained null key.").toString());
            }
        ...
        if (aobj != null)
        {
            ...
            while (j < i) 
            {
                ...
                if (obj2 == retrofit/http/Path)
                {
                    ...
                    if (obj == null)
                    {
                        throw new IllegalArgumentException((new StringBuilder()).append("Path parameter \"").append(((String) (obj2))).append("\" value must not be null.").toString());
                    }
                ...
                if (obj2 == retrofit/http/EncodedPath)
                {
                    ...
                    if (obj == null)
                    {
                        throw new IllegalArgumentException((new StringBuilder()).append("Path parameter \"").append(((String) (obj1))).append("\" value must not be null.").toString());
                    }
                ...
                if (obj2 == retrofit/http/FieldMap)
                {
                    if (obj != null)
                    {
                        ...
                        while (((Iterator) (obj)).hasNext()) 
                        {
                            ...
                            if (obj1 == null)
                            {
                                throw new IllegalArgumentException((new StringBuilder()).append("Parameter #").append(j + 1).append(" field map contained null key.").toString());
                            }
                ...
                if (obj2 == retrofit/http/PartMap)
                {
                    if (obj != null)
                    {
                        ...
                        while (((Iterator) (obj)).hasNext()) 
                        {
                            ...
                            if (obj3 == null)
                            {
                                throw new IllegalArgumentException((new StringBuilder()).append("Parameter #").append(j + 1).append(" part map contained null key.").toString());
                            }
                            obj3 = obj3.toString();
                            obj2 = ((java.util.Map.Entry) (obj2)).getValue();
                            if (obj2 != null)
                ...
                {
                    throw new IllegalArgumentException((new StringBuilder()).append("Unknown annotation: ").append(((Class) (obj2)).getCanonicalName()).toString());
                }
                j++;
            }
        }
