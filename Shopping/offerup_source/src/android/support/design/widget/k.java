...
final class k
{
    ...
    private void f()
    {
        ...
        flag = true;
        f3 = e;
        h.left = a(f.left, g.left, f3, ((Interpolator) (null)));
        h.top = a(o, p, f3, ((Interpolator) (null)));
        h.right = a(f.right, g.right, f3, ((Interpolator) (null)));
        h.bottom = a(f.bottom, g.bottom, f3, ((Interpolator) (null)));
        s = a(q, r, f3, ((Interpolator) (null)));
        t = a(o, p, f3, ((Interpolator) (null)));
        f4 = a(k, l, f3, G);
...
_L1:
        ...
        if (v == null || i1 != 0)
        {
            ...
            w = ((h) (obj)).a(charsequence1, 0, charsequence1.length());
        }
        if (!a || C == 1.0F)
        {
            flag = false;
...
_L1:
        ...
        i1 = android.support.v4.view.s.a(j1, i1);
        i1 & 0x70;
...
_L14:
    ...
    final void e(int i1)
    {
        TypedArray typedarray = c.getContext().obtainStyledAttributes(i1, a.ak);
        if (typedarray.hasValue(a.al))
        {
            n = typedarray.getColor(a.al, n);
        }
        if (typedarray.hasValue(a.am))
        {
            l = typedarray.getDimensionPixelSize(a.am, (int)l);
        }
        typedarray.recycle();
        c();
    }
    ...
    final void f(int i1)
    {
        ...
        if (typedarray.hasValue(a.al))
        {
            m = typedarray.getColor(a.al, m);
        }
        if (typedarray.hasValue(a.am))
        {
            k = typedarray.getDimensionPixelSize(a.am, (int)k);
        }
        typedarray.recycle();
        c();
    }
