    ...
    implements android.content.DialogInterface.OnCancelListener, android.content.DialogInterface.OnDismissListener
{
    ...
    public LayoutInflater getLayoutInflater(Bundle bundle)
    {
        ...
        {
            return (LayoutInflater)mHost.a.getSystemService("layout_inflater");
        }
    }
    ...
    public int show(an an1, String s)
    {
        mDismissed = false;
        mShownByMe = true;
        an1.a(this, s);
    ...
    public void show(aa aa1, String s)
    {
        mDismissed = false;
        mShownByMe = true;
        aa1 = aa1.a();
