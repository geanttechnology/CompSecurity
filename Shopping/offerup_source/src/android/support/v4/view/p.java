    ...
    implements o
{
    ...
    public p(Context context, android.view.GestureDetector.OnGestureListener ongesturelistener, Handler handler)
    {
        if (handler != null)
        {
            h = new q(this, handler);
        } else
        {
            h = new q(this);
        }
    ...
    static android.view.GestureDetector.OnGestureListener b(p p1)
    {
        return p1.i;
    }
    ...
    static void c(p p1)
    {
        p1.h.removeMessages(3);
        p1.l = false;
        p1.m = true;
        p1.i.onLongPress(p1.p);
    }

    static android.view.GestureDetector.OnDoubleTapListener d(p p1)
    {
        return p1.j;
    }

    static boolean e(p p1)
    {
        return p1.k;
    }
    ...
    public final boolean a(MotionEvent motionevent)
    {
        ...
        for (f2 = 0.0F; i3 < k3; f2 = f3)
        {
            ...
            if (i2 != i3)
            {
                f3 = f2 + at.c(motionevent, i3);
                f6 = f1 + at.d(motionevent, i3);
            }
            i3++;
            f1 = f6;
        }
...
_L7:
        ...
        int j2 = at.b(motionevent);
        int j1 = at.b(motionevent, j2);
        f1 = be.a(x, j1);
        f2 = be.b(x, j1);
        j1 = 0;
        while (j1 < k3) 
        {
            if (j1 != j2)
            {
                int j3 = at.b(motionevent, j1);
                float f4 = be.a(x, j3);
                if (be.b(x, j3) * f2 + f4 * f1 < 0.0F)
                {
                    x.clear();
                    return false;
                }
...
_L3:
        ...
        {
            velocitytracker = x;
            l1 = at.b(motionevent, 0);
            velocitytracker.computeCurrentVelocity(1000, d);
            f1 = be.b(velocitytracker, l1);
            f2 = be.a(velocitytracker, l1);
