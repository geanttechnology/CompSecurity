...
label0:
        {
            ...
            j = AppCompatDelegateImplV7.access$700(appcompatdelegateimplv7, j);
            if (j != null)
            {
                if (!flag1)
                {
                ...
                AppCompatDelegateImplV7.access$800(AppCompatDelegateImplV7.this, ((this._cls0) (j))., j, k);
                AppCompatDelegateImplV7.access$900(AppCompatDelegateImplV7.this, j, true);
            }
            return;
        }
        AppCompatDelegateImplV7.access$900(AppCompatDelegateImplV7.this, j, flag);
    }
