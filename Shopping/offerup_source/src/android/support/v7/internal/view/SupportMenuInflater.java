...
_L8:
        ...
        if (s1.equals("item"))
        {
            ...
            {
                if (menustate.itemActionProvider != null && menustate.itemActionProvider.e())
                {
...
_L3:
    ...
    private class MenuState
    {
        ...
        private void setItem(MenuItem menuitem)
        {
            ...
            {
                al.a(menuitem, itemShowAsAction);
            }
            ...
            {
                al.a(menuitem, (View)newInstance(itemActionViewClassName, SupportMenuInflater.ACTION_VIEW_CONSTRUCTOR_SIGNATURE, mActionViewConstructorArguments));
            } else
            {
                flag = false;
            }
            if (itemActionViewLayout > 0)
            {
                if (!flag)
                {
                    al.b(menuitem, itemActionViewLayout);
                } else
                {
            ...
            {
                al.a(menuitem, itemActionProvider);
            }
        }
        ...
        public void readItem(AttributeSet attributeset)
        {
            ...
            {
                itemActionProvider = (k)newInstance(itemActionProviderClassName, SupportMenuInflater.ACTION_PROVIDER_CONSTRUCTOR_SIGNATURE, mActionProviderConstructorArguments);
            } else
            {
                if (i != 0)
                {
