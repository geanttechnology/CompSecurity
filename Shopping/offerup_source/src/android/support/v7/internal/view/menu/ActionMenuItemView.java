...
public class ActionMenuItemView extends AppCompatTextView
    implements aa, android.support.v7.widget.ActionMenuView.ActionMenuChildView, android.view.View.OnClickListener, android.view.View.OnLongClickListener
{
...
label0:
    ...
    public final void a(m m1, int l)
    {
        a = m1;
        setIcon(m1.getIcon());
        setTitle(m1.a(this));
    ...
    public void setItemInvoker(k k1)
    {
        d = k1;
    }
