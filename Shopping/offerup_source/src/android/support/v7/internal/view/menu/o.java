    ...
    implements MenuItem
{
    ...
    {
        return new p(this, a, actionprovider);
    }
    ...
    {
        android.support.v4.view.k k = ((b)b).a();
        if (k instanceof p)
        {
            return ((p)k).a;
        } else
    ...
    public MenuItem setOnActionExpandListener(android.view.MenuItem.OnActionExpandListener onactionexpandlistener)
    {
        ...
        {
            onactionexpandlistener = new r(this, onactionexpandlistener);
        } else
        {
    ...
    public MenuItem setOnMenuItemClickListener(android.view.MenuItem.OnMenuItemClickListener onmenuitemclicklistener)
    {
        ...
        {
            onmenuitemclicklistener = new s(this, onmenuitemclicklistener);
        } else
        {
