...
public class ActivityChooserView extends ViewGroup
{
    ...
    {
        mActivityChooserContent.layout(0, 0, l - i, i1 - j);
        if (!isShowingPopup())
        {
            dismissPopup();
        }
    ...
    protected void onMeasure(int i, int j)
    {
        ...
        if (mDefaultActivityButton.getVisibility() != 0)
        {
            l = android.view.View.MeasureSpec.makeMeasureSpec(android.view.View.MeasureSpec.getSize(j), 0x40000000);
        }
        measureChild(linearlayoutcompat, i, l);
