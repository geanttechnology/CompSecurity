...
class AppCompatCompoundButtonHelper
{
    ...
    void loadFromAttributes(AttributeSet attributeset, int i)
    {
        ...
        {
            f.a(mView, attributeset.getColorStateList(android.support.v7.appcompat.R.styleable.CompoundButton_buttonTint));
        }
        if (attributeset.hasValue(android.support.v7.appcompat.R.styleable.CompoundButton_buttonTintMode))
        {
            f.a(mView, DrawableUtils.parseTintMode(attributeset.getInt(android.support.v7.appcompat.R.styleable.CompoundButton_buttonTintMode, -1), null));
        }
