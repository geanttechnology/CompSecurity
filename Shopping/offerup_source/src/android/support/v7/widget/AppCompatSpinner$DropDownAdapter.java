    ...
    implements ListAdapter, SpinnerAdapter
{
    ...
    public (SpinnerAdapter spinneradapter, android.content.res.apter apter)
    {
        ...
        if (apter != null)
        {
            if (AppCompatSpinner.access$100() && (spinneradapter instanceof ThemedSpinnerAdapter))
            {
                ...
                if (spinneradapter.getDropDownViewTheme() != apter)
                {
                    spinneradapter.setDropDownViewTheme(apter);
                }
            } else
