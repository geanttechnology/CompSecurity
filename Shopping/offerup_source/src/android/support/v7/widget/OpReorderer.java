...
_L4:
        ...
        if (updateop.positionStart < updateop1.positionStart + updateop1.itemCount)
        {
            ...
            updateop2 = mCallback.obtainUpdateOp(1, updateop.positionStart + 1, (k + l) - i1, null);
...
_L3:
    ...
    void swapMoveUpdate(List list, int i, AdapterHelper.UpdateOp updateop, int j, AdapterHelper.UpdateOp updateop1)
    {
        ...
        {
            updateop1.itemCount = updateop1.itemCount - 1;
            updateop2 = mCallback.obtainUpdateOp(2, updateop.positionStart, 1, updateop1.payload);
        } else
        {
            updateop2 = null;
        }
        ...
        if (updateop.positionStart < updateop1.positionStart + updateop1.itemCount)
        {
            ...
            updateop3 = mCallback.obtainUpdateOp(2, updateop.positionStart + 1, k, updateop1.payload);
