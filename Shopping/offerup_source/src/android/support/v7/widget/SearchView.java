    ...
    implements CollapsibleActionView
{
    ...
    public SearchView(Context context, AttributeSet attributeset, int i)
    {
        ...
        mSearchSrcTextView.setOnFocusChangeListener(new _cls4());
    ...
    private void adjustDropDownSizeAndPosition()
    {
        if (mDropDownAnchor.getWidth() > 1)
        {
            ...
            int l = mSearchPlate.getPaddingLeft();
            Rect rect = new Rect();
            ...
            i1 = rect.left;
            j1 = rect.right;
            mSearchSrcTextView.setDropDownWidth((i + (j + i1 + j1)) - l);
        }
    }
...
_L6:
    ...
    {
        if (mSearchable != null && mSuggestionsAdapter != null && keyevent.getAction() == 0 && w.a(keyevent))
        {
            if (i == 66 || i == 84 || i == 61)
            {
...
_L5:
    ...
    public void setSuggestionsAdapter(k k1)
    {
        mSuggestionsAdapter = k1;
        mSearchSrcTextView.setAdapter(mSuggestionsAdapter);
    }
        ...
        implements android.view.View.OnKeyListener
    {
        ...
        public boolean onKey(View view, int i, KeyEvent keyevent)
        {
            if (mSearchable != null)
            {
                ...
                if (!mSearchSrcTextView.isEmpty() && w.a(keyevent) && keyevent.getAction() == 1 && i == 66)
                {
