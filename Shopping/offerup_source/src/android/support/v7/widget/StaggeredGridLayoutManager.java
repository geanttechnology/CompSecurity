...
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager
{
    ...
    private final Runnable mCheckForGapsRunnable = new _cls1();
    ...
    private boolean checkForGaps()
    {
            ...
            implements Parcelable
        {
                ...
                implements android.os.Parcelable.Creator
            {
                ...
                public final LazySpanLookup.FullSpanItem createFromParcel(Parcel parcel)
                {
                ...
                public final LazySpanLookup.FullSpanItem[] newArray(int k)
                {
        ...
        LazySpanLookup.FullSpanItem fullspanitem1 = mLazySpanLookup.getFirstFullSpanItemInRange(j, fullspanitem.mPosition, -byte0, true);
...
label0:
        {
            ...
            if (getChildCount() > 0)
            {
                accessibilityevent = a.a(accessibilityevent);
    ...
    public void onInitializeAccessibilityNodeInfoForItem(RecyclerView.Recycler recycler, RecyclerView.State state, View view, f f1)
    {
        int k = -1;
        recycler = view.getLayoutParams();
        if (!(recycler instanceof LayoutParams))
        {
            super.onInitializeAccessibilityNodeInfoForItem(view, f1);
            return;
        }
        ...
        f1.b(p.a(i, j, l, k, ((LayoutParams) (recycler)).mFullSpan, false));
    }
