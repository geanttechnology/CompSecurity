...
public final class w extends ThreadPoolExecutor
{
    ...
    private w(int i, int j, long l, TimeUnit timeunit, m m1, ThreadFactory threadfactory)
    {
    ...
    public static w a()
    {
        return new w(b, c, 1L, TimeUnit.SECONDS, new m(), new x(10));
    }
