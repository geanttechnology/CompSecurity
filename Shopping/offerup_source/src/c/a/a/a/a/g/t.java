...
public class t
{
    ...
    public s a(r r1, JSONObject jsonobject)
    {
        int i = jsonobject.optInt("settings_version", 0);
        int k = jsonobject.optInt("cache_duration", 3600);
        ...
        obj5 = new f(((JSONObject) (obj5)).optString("update_endpoint", null), ((JSONObject) (obj5)).optInt("update_suspend_duration", 3600));
        long l1 = k;
        ...
        return new s(l1, ((e) (obj)), ((m) (obj1)), ((l) (obj2)), ((j) (obj3)), ((b) (obj4)), ((f) (obj5)), i, k);
    }
}
