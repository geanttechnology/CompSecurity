...
public class MultipleInstallBroadcastReceiver extends BroadcastReceiver
{
    ...
    {
        Log.i("AppsFlyer_1.17", "MultipleInstallBroadcastReceiver called");
        ...
        do
        {
            ...
            {
                Log.i("AppsFlyer_1.17", (new StringBuilder("trigger onReceive: class: ")).append(resolveinfo.activityInfo.name).toString());
                try
                {
                ...
                {
                    Log.e("AppsFlyer_1.17", (new StringBuilder("error in BroadcastReceiver ")).append(resolveinfo.activityInfo.name).toString(), throwable);
                }
            }
        } while (true);
