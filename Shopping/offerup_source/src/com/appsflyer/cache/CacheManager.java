...
public class CacheManager
{
    ...
    public void deleteRequest(String s, Context context)
    {
        ...
        Log.i("AppsFlyer_1.17", (new StringBuilder("Deleting ")).append(s).append(" from cache").toString());
        if (!context.exists())
        {
        ...
        return;
        context;
        Log.i("AppsFlyer_1.17", (new StringBuilder("Could not delete ")).append(s).append(" from cache").toString(), context);
        return;
    }
...
_L2:
        ...
        file = context[i];
        Log.i("AppsFlyer_1.17", (new StringBuilder("Found cached request")).append(file.getName()).toString());
