...
public class AboutModule
{
    ...
    void doShow(final Activity activity)
    {
        ...
        ((TextView)activity.findViewById(R.id.about_description_link)).setOnClickListener(new _cls1());
        ((TextView)activity.findViewById(R.id.privacy_link)).setOnClickListener(new _cls2());
