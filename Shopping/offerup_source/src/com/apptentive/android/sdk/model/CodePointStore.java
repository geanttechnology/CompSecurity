...
_L15:
        if (jsonobject.isNull(s1)) goto _L10; else goto _L9
_L9:
        i = jsonobject.getInt(s1);
_L17:
        jsonobject.put(s1, i + 1);
        if (((JSONObject) (obj)).isNull("build")) goto _L12; else goto _L11
_L11:
...
_L10:
    ...
    {
        return (new StringBuilder("CodePointStore:  ")).append(getInstance(context).toString()).toString();
    }
}
