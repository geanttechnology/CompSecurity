...
_L1:
    ...
    private class State extends Enum
    {
        ...
        public static State parse(String s)
        {
            ...
            {
                Log.v((new StringBuilder("Error parsing unknown Message.State: ")).append(s).toString(), new Object[0]);
                return unknown;
            }
            return state1;
        }
    ...
    private class Type extends Enum
    {
        ...
        public static Type parse(String s)
        {
            ...
            {
                Log.v((new StringBuilder("Error parsing unknown Message.Type: ")).append(s).toString(), new Object[0]);
                return unknown;
            }
            return type;
        }
