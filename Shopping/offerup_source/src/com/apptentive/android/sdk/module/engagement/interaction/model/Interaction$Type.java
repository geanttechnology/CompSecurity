...
public final class  extends Enum
{
    ...
    public static final unknown NavigateToLink;
    public static final unknown RatingDialog;
    public static final unknown Survey;
    public static final unknown TextModal;
    ...
    static 
    {
        ...
        TextModal = new <init>("TextModal", 7);
        NavigateToLink = new <init>("NavigateToLink", 8);
        unknown = new <init>("unknown", 9);
        $VALUES = (new .VALUES[] {
