...
public class AndroidPay
{
    ...
    private GoogleApiClient getConnectedApiClient(Context context)
    {
        ...
        if (!mGoogleApiClient.isConnected())
        {
            ...
            {
                throw new UnexpectedException((new StringBuilder("GoogleApiClient failed to connect with error code")).append(context.getErrorCode()).toString());
            }
        }
