    ...
    implements android.view.View.OnClickListener
{
    ...
    {
        PaymentMethodListAdapter paymentmethodlistadapter = new PaymentMethodListAdapter(mActivity, this, mBraintree.getCachedPaymentMethods());
        ContextThemeWrapper contextthemewrapper;
        if (android.os.Build.VERSION.SDK_INT >= 11)
        {
            contextthemewrapper = new ContextThemeWrapper(mActivity, 0x1030075);
        } else
        {
            contextthemewrapper = new ContextThemeWrapper(mActivity, 0x103000d);
        }
