...
public final class mCanonicalName extends Enum
{
    ...
    public static final UNKNOWN ANDROID_PAY;
    public static final UNKNOWN COINBASE;
    ...
    static 
    {
        ...
        COINBASE = new <init>("COINBASE", 8, com.braintreepayments.api.dropin.Type, com.braintreepayments.api.dropin.e, "Coinbase");
        ANDROID_PAY = new <init>("ANDROID_PAY", 9, com.braintreepayments.api.dropin.Type, com.braintreepayments.api.dropin._pay, "Google Wallet");
        UNKNOWN = new <init>("UNKNOWN", 10, -1, com.braintreepayments.api.dropin., "unknown");
        $VALUES = (new .VALUES[] {
