...
public class PaymentMethodView extends RelativeLayout
{
    ...
    public void setPaymentMethodDetails(PaymentMethod paymentmethod)
    {
        ...
        if (paymentmethod instanceof CoinbaseAccount)
        {
    ...
    private class PaymentType extends Enum
    {
        ...
        public static final PaymentType ANDROID_PAY;
        public static final PaymentType COINBASE;
        ...
        static 
        {
            ...
            COINBASE = new PaymentType("COINBASE", 8, com.braintreepayments.api.dropin.R.drawable.bt_coinbase, com.braintreepayments.api.dropin.R.string.bt_descriptor_coinbase, "Coinbase");
            ANDROID_PAY = new PaymentType("ANDROID_PAY", 9, com.braintreepayments.api.dropin.R.drawable.bt_android_pay, com.braintreepayments.api.dropin.R.string.bt_descriptor_android_pay, "Google Wallet");
            UNKNOWN = new PaymentType("UNKNOWN", 10, -1, com.braintreepayments.api.dropin.R.string.bt_descriptor_unknown, "unknown");
            $VALUES = (new PaymentType[] {
                VISA, MASTERCARD, DISCOVER, AMEX, JCB, DINERS, MAESTRO, PAYPAL, COINBASE, ANDROID_PAY, 
                UNKNOWN
            });
        }
