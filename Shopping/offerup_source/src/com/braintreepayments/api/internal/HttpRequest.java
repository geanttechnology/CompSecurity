...
public class HttpRequest
{
    ...
    {
        return "braintree/android/1.7.3";
    }
    ...
    private HttpResponse parseResponse(HttpURLConnection httpurlconnection)
    {
        ...
        log((new StringBuilder("Received response code: ")).append(i).toString());
        switch (i)
        {
        default:
        ...
        case 202: 
            ...
            log((new StringBuilder("Received response body: ")).append(httpurlconnection).toString());
        ...
        case 422: 
            ...
            log((new StringBuilder("Received error response body: ")).append(httpurlconnection).toString());
...
_L3:
    ...
    {
        log((new StringBuilder("Opening url: ")).append(s).toString());
