...
public class Crashlytics extends n
    implements o
{
    ...
    Crashlytics(Answers answers1, Beta beta1, CrashlyticsCore crashlyticscore)
    {
        ...
        kits = Collections.unmodifiableCollection(Arrays.asList(new n[] {
    ...
    {
        return (Crashlytics)e.a(com/crashlytics/android/Crashlytics);
    }
    ...
    {
        e.d().d("Crashlytics", "Use of Crashlytics.setPinningInfoProvider is deprecated");
    }
    ...
    {
        e.d().d("Crashlytics", "Use of Crashlytics.getDebugMode is deprecated.");
        getFabric();
        return e.e();
    }
    ...
    {
        e.d().d("Crashlytics", "Use of Crashlytics.setDebugMode is deprecated.");
    }
