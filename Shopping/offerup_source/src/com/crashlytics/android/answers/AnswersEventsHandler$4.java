    ...
    implements Runnable
{
    ...
    public void run()
    {
        try
        {
            ...
            strategy = new EnabledSessionAnalyticsManagerStrategy(AnswersEventsHandler.access$200(AnswersEventsHandler.this), AnswersEventsHandler.access$300(AnswersEventsHandler.this), executor, sessionanalyticsfilesmanager, AnswersEventsHandler.access$400$6814389c(AnswersEventsHandler.this), sessioneventmetadata);
            return;
        }
