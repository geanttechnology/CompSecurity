...
public abstract class PredefinedEvent extends AnswersEvent
{
    ...
    {
        return (new StringBuilder("{type:\"")).append(getPredefinedType()).append('"').append(", predefinedAttributes:").append(predefinedAttributes).append(", customAttributes:").append(customAttributes).append("}").toString();
    }
}
