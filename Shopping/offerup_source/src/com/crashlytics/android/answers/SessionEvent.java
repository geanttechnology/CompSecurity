...
final class SessionEvent
{
    ...
    public final String toString()
    {
        ...
        {
            stringRepresentation = (new StringBuilder("[")).append(getClass().getSimpleName()).append(": timestamp=").append(timestamp).append(", type=").append(type).append(", details=").append(details.toString()).append(", customType=").append(customType).append(", customAttributes=").append(customAttributes.toString()).append(", predefinedType=").append(predefinedType).append(", predefinedAttributes=").append(predefinedAttributes.toString()).append(", metadata=[").append(sessionEventMetadata).append("]]").toString();
        }
    ...
    private class Builder
    {
        ...
        {
            return new SessionEvent(sessioneventmetadata, timestamp, type, details, customType, customAttributes, predefinedType, predefinedAttributes, null);
        }
