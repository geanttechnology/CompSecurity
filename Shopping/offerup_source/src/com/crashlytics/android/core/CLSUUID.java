...
class CLSUUID
{
    ...
    public CLSUUID(x x1)
    {
        ...
        _clsId = String.format(Locale.US, "%s-%s-%s-%s", new Object[] {
            s.substring(0, 12), s.substring(12, 16), s.subSequence(16, 20), x1.substring(0, 12)
        }).toUpperCase(Locale.US);
    }

    private static byte[] convertLongToFourByteBuffer(long l1)
    {
    ...
    private static byte[] convertLongToTwoByteBuffer(long l1)
    {
    ...
    private void populateTime(byte abyte0[])
    {
        ...
        byte abyte1[] = convertLongToFourByteBuffer(l1 / 1000L);
        abyte0[0] = abyte1[0];
        abyte0[1] = abyte1[1];
        abyte0[2] = abyte1[2];
        abyte0[3] = abyte1[3];
        abyte1 = convertLongToTwoByteBuffer(l1 % 1000L);
        abyte0[4] = abyte1[0];
        abyte0[5] = abyte1[1];
    }
