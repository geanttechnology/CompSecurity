...
class ClsFileOutputStream extends FileOutputStream
{
    ...
    public static final FilenameFilter TEMP_FILENAME_FILTER = new _cls1();
...
_L7:
        throw new IOException((new StringBuilder("Could not rename temp file: ")).append(inProgress).append(" -> ").append(file).append(s).toString());
_L5:
