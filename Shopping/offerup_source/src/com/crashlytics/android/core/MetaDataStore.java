...
class MetaDataStore
{
    ...
    {
        return new File(filesDir, (new StringBuilder()).append(s).append("keys.meta").toString());
    }

    private File getUserDataFileForSession(String s)
    {
        return new File(filesDir, (new StringBuilder()).append(s).append("user.meta").toString());
    }
    ...
    private static String userDataToJson(final UserMetaData userData)
    {
        return (new _cls1()).toString();
    }
    ...
    public Map readKeyData(String s)
    {
        ...
        s = fileinputstream;
        Map map = jsonToKeysData(l.a(fileinputstream));
...
_L4:
        s = fileinputstream;
        e.d().c("CrashlyticsCore", "Error deserializing user metadata.", exception1);
        l.a(fileinputstream, "Failed to close user metadata file.");
        return Collections.emptyMap();
        Exception exception;
        exception;
        s = null;
_L2:
        l.a(s, "Failed to close user metadata file.");
        throw exception;
        exception;
...
_L3:
    ...
    public UserMetaData readUserData(String s)
    {
        ...
        FileInputStream fileinputstream = new FileInputStream(s);
        s = fileinputstream;
        UserMetaData usermetadata = jsonToUserData(l.a(fileinputstream));
        l.a(fileinputstream, "Failed to close user metadata file.");
        return usermetadata;
        Exception exception1;
        exception1;
...
_L3:
    ...
    public void writeKeyData(String s, Map map)
    {
        ...
        s = map;
        map.flush();
        l.a(map, "Failed to close key/value metadata file.");
        return;
        Object obj;
        obj;
        map = null;
_L4:
        s = map;
        e.d().c("CrashlyticsCore", "Error serializing key/value metadata.", ((Throwable) (obj)));
        l.a(map, "Failed to close key/value metadata file.");
        return;
        obj;
        map = s;
...
_L3:
    ...
    public void writeUserData(String s, UserMetaData usermetadata)
    {
        ...
        s = usermetadata;
        usermetadata.flush();
        l.a(usermetadata, "Failed to close user metadata file.");
        return;
        Object obj;
        obj;
        usermetadata = null;
_L4:
        s = usermetadata;
        e.d().c("CrashlyticsCore", "Error serializing user metadata.", ((Throwable) (obj)));
        l.a(usermetadata, "Failed to close user metadata file.");
        return;
        obj;
        usermetadata = s;
...
_L3:
    ...
    private class _cls1 extends JSONObject
    {
