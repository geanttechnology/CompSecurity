...
_L4:
        return (new StringBuilder("{Response: ")).append(" responseCode: ").append(((String) (obj))).append(", graphObject: ").append(graphObject).append(", error: ").append(error).append("}").toString();
_L2:
        i = 200;
          goto _L3
