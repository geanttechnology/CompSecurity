...
_L10:
        ...
        context = ((Context) (obj));
        int j = ((Cursor) (obj)).getColumnIndex("androidid");
        context = ((Context) (obj));
        int k = ((Cursor) (obj)).getColumnIndex("limit_tracking");
        context = ((Context) (obj));
        obj1.attributionId = ((Cursor) (obj)).getString(i);
        if (j <= 0 || k <= 0)
        {
            break MISSING_BLOCK_LABEL_236;
        }
        context = ((Context) (obj));
        if (((AttributionIdentifiers) (obj1)).getAndroidAdvertiserId() != null)
        {
            break MISSING_BLOCK_LABEL_236;
        }
        context = ((Context) (obj));
        obj1.androidAdvertiserId = ((Cursor) (obj)).getString(j);
        context = ((Context) (obj));
        obj1.limitTracking = Boolean.parseBoolean(((Cursor) (obj)).getString(k));
        if (obj != null)
        {
            ((Cursor) (obj)).close();
        }
        obj1.fetchTime = System.currentTimeMillis();
        recentlyFetchedIdentifiers = ((AttributionIdentifiers) (obj1));
        return ((AttributionIdentifiers) (obj1));
        obj1;
        obj = null;
_L8:
        context = ((Context) (obj));
        Log.d(TAG, (new StringBuilder("Caught unexpected exception in getAttributionId(): ")).append(((Exception) (obj1)).toString()).toString());
        if (obj != null)
        {
            ((Cursor) (obj)).close();
        }
...
_L9:
        ...
        implements ServiceConnection
    {
        ...
        GoogleAdServiceConnection(_cls1 _pcls1)
        {
            this();
        }
    }
