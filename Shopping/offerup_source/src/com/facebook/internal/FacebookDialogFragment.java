...
public class FacebookDialogFragment extends p
{
    ...
    {
        t t1 = getActivity();
        bundle = NativeProtocol.createProtocolResultIntent(t1.getIntent(), bundle, facebookexception);
        byte byte0;
...
_L2:
        return;
_L6:
        bundle = (new WebDialog.Builder(bundle, s, bundle1)).setOnCompleteListener(new _cls1()).build();
_L8:
        dialog = bundle;
        return;
_L4:
        ...
        bundle.setOnCompleteListener(new _cls2());
...
_L7:
        ...
        implements WebDialog.OnCompleteListener
    {
        ...
        {
            onCompleteWebDialog(bundle, facebookexception);
        }
        ...
        implements WebDialog.OnCompleteListener
    {
        ...
        public void onComplete(Bundle bundle, FacebookException facebookexception)
        {
            onCompleteWebFallbackDialog(bundle);
        }
