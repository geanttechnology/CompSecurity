...
_L3:
        ...
        if (k1 >= k) goto _L5; else goto _L4
_L4:
...
_L10:
        i1 = l + 1;
        ai2[l] = k;
        if (j == 0x7fffffff) goto _L13; else goto _L12
_L12:
        l = i1 + 1;
        ai2[i1] = j;
        i1 = k1;
...
_L3:
    ...
    private static int refreshBestGuessNumberOfCPUCores()
    {
        ...
        try
        {
            numCPUCores = (new File("/sys/devices/system/cpu/")).listFiles(new _cls3()).length;
        }
        catch (Exception exception) { }
        if (numCPUCores <= 0)
        {
...
_L2:
    ...
    private class FetchedAppSettings
    {
        ...
        FetchedAppSettings(boolean flag, String s, boolean flag1, Map map1, FacebookRequestErrorClassification facebookrequesterrorclassification, _cls1 _pcls1)
        {
