...
_L3:
    ...
    public void registerCallback(CallbackManager callbackmanager, final FacebookCallback callback)
    {
        ...
        {
            ((CallbackManagerImpl)callbackmanager).registerCallback(com.facebook.internal.CallbackManagerImpl.RequestCodeOffset.Login.toRequestCode(), new _cls1());
            return;
        }
    }
    ...
    private class _cls2 extends HashSet
    {
