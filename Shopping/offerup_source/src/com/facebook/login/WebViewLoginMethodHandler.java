...
class WebViewLoginMethodHandler extends LoginMethodHandler
{
    ...
    boolean tryAuthorize(final LoginClient.Request request)
    {
        ...
        loginDialog = (new AuthDialogBuilder(((Context) (obj)), request.getApplicationId(), bundle)).setE2E(e2e).setIsRerequest(request.isRerequest()).setOnCompleteListener(_lcls1).setTheme(FacebookSdk.getWebDialogTheme()).build();
        request = new FacebookDialogFragment();
        request.setRetainInstance(true);
        request.setDialog(loginDialog);
        request.show(((t) (obj)).getSupportFragmentManager(), "FacebookDialogFragment");
        return true;
    }
    ...
    private class _cls1
        implements com.facebook.internal.WebDialog.OnCompleteListener
    {
    ...
    private class AuthDialogBuilder extends com.facebook.internal.WebDialog.Builder
    {
