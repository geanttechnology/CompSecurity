...
_L1:
        arraylist.add(ShareInternalUtility.newUploadPhotoRequest(getGraphPath("photos"), accesstoken, bitmap, sharephotocontent, sharephoto.getParameters(), _lcls3));
          goto _L3
        try
        {
...
_L4:
        arraylist.add(ShareInternalUtility.newUploadPhotoRequest(getGraphPath("photos"), accesstoken, uri, sharephotocontent, sharephoto.getParameters(), _lcls3));
          goto _L3
    }
    ...
    private void stageArrayList(final ArrayList arrayList, final com.facebook.internal.CollectionMapper.OnMapValueCompleteListener onArrayListStagedListener)
    {
        ...
        stageCollectionValues(new _cls5(), new _cls6());
    }
    ...
    {
        CollectionMapper.iterate(collection, new _cls7(), onmappercompletelistener);
    }
    ...
    {
        stageCollectionValues(new _cls8(), onmappercompletelistener);
    }
    ...
    private void stageOpenGraphObject(final ShareOpenGraphObject object, final com.facebook.internal.CollectionMapper.OnMapValueCompleteListener onOpenGraphObjectStagedListener)
    {
        ...
        } else
        {
            ...
            stageCollectionValues(new _cls9(), new _cls11());
            return;
        }
    }
    ...
    public final void setGraphNode(String s)
    {
        graphNode = s;
    }
        ...
        implements com.facebook.internal.CollectionMapper.OnMapperCompleteListener
    {
        ...
        public void onComplete()
        {
            ...
            try
            {
                (new GraphRequest(AccessToken.getCurrentAccessToken(), getGraphPath((new StringBuilder("objects/")).append(URLEncoder.encode(ogType, "UTF-8")).toString()), ((Bundle) (obj)), HttpMethod.POST, requestCallback)).executeAsync();
                return;
            }
            catch (UnsupportedEncodingException unsupportedencodingexception)
            {
