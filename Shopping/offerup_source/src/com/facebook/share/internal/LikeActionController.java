...
public class LikeActionController
{
    ...
    private static void broadcastAction(LikeActionController likeactioncontroller, String s, Bundle bundle)
    {
        ...
        h.a(FacebookSdk.getApplicationContext()).a(intent);
    }
...
_L1:
    ...
    private void fetchVerifiedObjectId(final RequestCompletionCallback completionHandler)
    {
        ...
        } else
        {
            ...
            graphrequestbatch.addCallback(new _cls11());
    ...
    public static boolean handleOnActivityResult(final int requestCode, final int resultCode, final Intent data)
    {
        ...
        {
            getControllerForObjectId(objectIdForPendingController, com.facebook.share.widget.LikeView.ObjectType.UNKNOWN, new _cls1());
            return true;
        }
    }
...
_L2:
        ...
        CallbackManagerImpl.registerStaticCallback(com.facebook.internal.CallbackManagerImpl.RequestCodeOffset.Like.toRequestCode(), new _cls3());
        isInitialized = true;
...
_L3:
    ...
    private void publishLikeAsync(final Bundle analyticsParameters)
    {
        ...
        fetchVerifiedObjectId(new _cls7());
    }
    ...
    private void publishUnlikeAsync(final Bundle analyticsParameters)
    {
        ...
        graphrequestbatch.addCallback(new _cls8());
        graphrequestbatch.executeAsync();
    }
    ...
    private void refreshStatusAsync()
    {
        ...
        {
            fetchVerifiedObjectId(new _cls9());
            return;
        }
    }
    ...
    private void refreshStatusViaService()
    {
        ...
        {
            likestatusclient.setCompletedListener(new _cls10());
            return;
        }
    }
...
_L1:
    ...
    public void toggleLike(Activity activity, Fragment fragment, Bundle bundle)
    {
        ...
        boolean flag1;
        flag1 = true;
        getAppEventsLogger().logSdkEvent("fb_like_control_did_tap", null, bundle);
        if (!isObjectLiked)
        {
            flag = true;
        } else
...
*/
        ...
        implements com.facebook.GraphRequestBatch.Callback
    {
        ...
        public void onBatchCompleted(GraphRequestBatch graphrequestbatch)
        {
            ...
            if (Utility.isNullOrEmpty(verifiedObjectId))
            {
                ...
                {
                    graphrequestbatch = pageIdRequest.error;
                } else
                {
                    graphrequestbatch = objectIdRequest.error;
                }
                likeactioncontroller.logAppEventForError("get_verified_id", graphrequestbatch);
            }
            if (completionHandler != null)
            {
                completionHandler.onComplete();
    ...
    private class _cls6 extends ResultProcessor
    {
        ...
        public void onSuccess(AppCall appcall, Bundle bundle)
        {
            ...
            getAppEventsLogger().logSdkEvent("fb_like_control_dialog_did_succeed", null, bundle1);
        ...
        implements RequestCompletionCallback
    {
        ...
        public void onComplete()
        {
            final GetOGObjectLikesRequestWrapper objectLikesRequest = new GetOGObjectLikesRequestWrapper(verifiedObjectId, objectType);
            final GetEngagementRequestWrapper engagementRequest = new GetEngagementRequestWrapper(verifiedObjectId, objectType);
            GraphRequestBatch graphrequestbatch = new GraphRequestBatch();
            objectLikesRequest.addToBatch(graphrequestbatch);
    ...
    private class _cls5 extends AccessTokenTracker
    {

        protected final void onCurrentAccessTokenChanged(AccessToken accesstoken, AccessToken accesstoken1)
        {
