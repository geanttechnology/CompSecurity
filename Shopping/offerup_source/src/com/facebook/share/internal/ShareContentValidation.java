...
public class ShareContentValidation
{
    ...
    private static void validateOpenGraphContent(ShareOpenGraphContent shareopengraphcontent, Validator validator)
    {
        ...
        {
            throw new FacebookException((new StringBuilder("Property \"")).append(validator).append("\" was not found on the action. The name of the preview property must match the name of an ").append("action property.").toString());
        } else
        {
            return;
        }
    ...
    private static void validateVideo(ShareVideo sharevideo, Validator validator)
    {
        ...
        if (!Utility.isContentUri(sharevideo) && !Utility.isFileUri(sharevideo))
        {
    ...
    private class ApiValidator extends Validator
    {
