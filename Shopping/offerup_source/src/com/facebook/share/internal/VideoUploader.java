...
label0:
    ...
    public static void uploadAsync(ShareVideoContent sharevideocontent, String s, FacebookCallback facebookcallback)
    {
        ...
        sharevideocontent = new UploadContext(sharevideocontent, s, facebookcallback, null);
    ...
    private class UploadContext
    {
        ...
        UploadContext(ShareVideoContent sharevideocontent, String s, FacebookCallback facebookcallback, _cls1 _pcls1)
        {
            ...
            implements Runnable
        {
            ...
            private boolean attemptRetry(int i)
            {
                if (completedRetries < 2 && getTransientErrorCodes().contains(Integer.valueOf(i)))
                {
                    ...
                    VideoUploader.getHandler().postDelayed(new _cls1(), i * 5000);
                    return true;
                } else
                {
                    return false;
            ...
            protected void issueResponseOnMainThread(final FacebookException error, final String videoId)
            {
                ...
                VideoUploader.getHandler().post(new _cls2());
            }
    ...
    private class _cls1 extends AccessTokenTracker
    {
