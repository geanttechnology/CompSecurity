...
public final class  extends 
{
    ...
    public final volatile imageUrl readFrom(ShareMedia sharemedia)
    {
    ...
    public final on setBitmap(Bitmap bitmap1)
    {
        bitmap = bitmap1;
        return this;
    }

    public final bitmap setCaption(String s)
    {
        caption = s;
        return this;
    }

    public final caption setImageUrl(Uri uri)
    {
        imageUrl = uri;
        return this;
    }
