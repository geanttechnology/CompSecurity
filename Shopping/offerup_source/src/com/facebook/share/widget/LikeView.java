...
public class LikeView extends FrameLayout
{
    ...
    private void associateWithLikeActionController(LikeActionController likeactioncontroller)
    {
        ...
        likeactioncontroller = h.a(getContext());
    ...
    private void initializeLikeButton(Context context)
    {
        ...
        likeButton.setOnClickListener(new _cls1());
    ...
    private void tearDownObjectAssociations()
    {
        ...
        {
            h.a(getContext()).a(broadcastReceiver);
...
_L2:
        ...
        likeboxcountview = likeBoxCountView;
        likeboxcountviewcaretposition = com.facebook.share.internal.LikeBoxCountView.LikeBoxCountViewCaretPosition.BOTTOM;
_L6:
        likeboxcountview.setCaretPosition(likeboxcountviewcaretposition);
        return;
_L3:
        likeboxcountview = likeBoxCountView;
        likeboxcountviewcaretposition = com.facebook.share.internal.LikeBoxCountView.LikeBoxCountViewCaretPosition.TOP;
...
_L4:
        ...
        LikeControllerBroadcastReceiver(_cls1 _pcls1)
        {
            this();
        }
        ...
        implements com.facebook.share.internal.LikeActionController.CreationCallback
    {
        ...
        LikeActionControllerCreationCallback(_cls1 _pcls1)
        {
            this();
        }
    }
