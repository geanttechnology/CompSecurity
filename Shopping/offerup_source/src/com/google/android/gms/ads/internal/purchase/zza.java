    ...
    public GInAppPurchaseManagerInfoParcel zzh(Parcel parcel)
    {
        ...
        do
        {
            if (parcel.dataPosition() < j)
            {
                ...
                case 3: // '\003'
                    ibinder3 = com.google.android.gms.common.internal.safeparcel.zza.zzq(parcel, k);
                    break;

                case 4: // '\004'
                    ibinder2 = com.google.android.gms.common.internal.safeparcel.zza.zzq(parcel, k);
                    break;
