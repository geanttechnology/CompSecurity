...
public class zzaf extends zzd
{
    ...
    public void zza(zzab zzab1, String s)
    {
        ...
        zzd((new StringBuilder("Discarding hit. ")).append(s1).toString(), zzab1);
    }
    ...
    public void zzb(int i, String s, Object obj, Object obj1, Object obj2)
    {
        ...
        if (!zziv().zzjB()) goto _L2; else goto _L1
_L1:
        char c;
        if (zziv().zzjA())
        {
...
_L4:
        obj = (new StringBuilder()).append(zzPr).append(zzPs.charAt(i)).append(c).append(zze.VERSION).append(":").append(zzc(s, zzk(obj), zzk(obj1), zzk(obj2))).toString();
        s = ((String) (obj));
        ...
        ((zzai) (obj)).zzkT().zzbn(s);
        this;
        JVM INSTR monitorexit ;
        return;
_L2:
        boolean flag1 = zziv().zzjA();
        if (flag1)
        {
            c = 'p';
        } else
...
_L3:
    ...
    public void zzh(Map map, String s)
    {
        ...
        zzd((new StringBuilder("Discarding hit. ")).append(s1).toString(), map);
    }
