...
public class zzf
{
    ...
    protected zzf(com.google.android.gms.analytics.internal.zzg zzg1)
    {
        ...
        if (zziv().zzjA())
        {
            zziu().zzbc((new StringBuilder("Google Analytics ")).append(zze.VERSION).append(" is starting up.").toString());
        } else
        {
            zziu().zzbc((new StringBuilder("Google Analytics ")).append(zze.VERSION).append(" is starting up. To enable debug logging on a device run:\n").append("  adb shell setprop log.tag.GAv4 DEBUG\n  adb logcat -s GAv4").toString());
        }
        obj1 = zzg1.zzq(this);
        ((zzai) (obj1)).zza();
        zzMQ = ((zzai) (obj1));
