...
public final class zzg
{
    ...
    public static String zzc(Context context, int i, String s)
    {
    ...
    public static String zzd(Context context, int i, String s)
    {
        context = context.getResources();
        switch (i)
        {
        ...
        case 42: // '*'
            return context.getString(com.google.android.gms.R.string.common_android_wear_notification_needs_update_text, new Object[] {
                s
            });
