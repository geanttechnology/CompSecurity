...
class zza
{
    ...
    {
        Object obj = zzc(bundle, s);
        if (!TextUtils.isEmpty(((CharSequence) (obj))))
        {
            return ((String) (obj));
        }
        obj = zzc(bundle, (new StringBuilder()).append(s).append("_loc_key").toString());
        if (TextUtils.isEmpty(((CharSequence) (obj))))
        {
            return null;
        }
        ...
        if (j == 0)
        {
            throw new zza((new StringBuilder()).append(zzdj((new StringBuilder()).append(s).append("_loc_key").toString())).append(" resource not found: ").append(((String) (obj))).toString(), null);
        }
        ...
        {
            throw new zza((new StringBuilder("Malformed ")).append(zzdj((new StringBuilder()).append(s).append("_loc_args").toString())).append(": ").append(bundle).toString(), null);
        }
        ...
        {
            throw new zza((new StringBuilder("Missing format argument for ")).append(((String) (obj))).append(": ").append(bundle).toString(), null);
        }
        return bundle;
    }
    ...
    private int zzdk(String s)
    {
        ...
        if (i == 0)
        {
            ...
            if (j == 0)
            {
                throw new zza((new StringBuilder("Icon resource not found: ")).append(s).toString(), null);
            }
        }
        return i;
    }
    ...
    private Uri zzdl(String s)
    {
        ...
        {
            throw new zza((new StringBuilder("Invalid sound: ")).append(s).toString(), null);
        }
    }
    ...
    private Notification zzw(Bundle bundle)
    {
        ...
        bundle = (new bl(mContext)).a(i).a(true).a(bundle).a(((CharSequence) (obj))).b(s);
        if (uri != null)
        {
            bundle.a(uri);
        }
