...
public class zzd
{
    ...
    {
        context = context1;
        zzaEa = context1.getSharedPreferences(s, 4);
        zzdo((new StringBuilder()).append(s).append("-no-backup").toString());
    }

    private void zzdo(String s)
    {
        new a();
        s = new File(a.a(context), s);
...
_L2:
        ...
        catch (String s)
        {
            ...
            {
                Log.d("InstanceID/Store", (new StringBuilder("Error creating file in no backup dir: ")).append(s.getMessage()).toString());
                return;
            }
        }
...
_L3:
    ...
    String get(String s, String s1)
    {
        this;
        JVM INSTR monitorenter ;
        s = zzaEa.getString((new StringBuilder()).append(s).append("|S|").append(s1).toString(), null);
        this;
        JVM INSTR monitorexit ;
        return s;
        s;
    ...
    public void zzdp(String s)
    {
        ...
        editor = zzaEa.edit();
        Iterator iterator = zzaEa.getAll().keySet().iterator();
        do
        {
            if (!iterator.hasNext())
            {
    ...
    void zzdr(String s)
    {
        zzdp((new StringBuilder()).append(s).append("|").toString());
    }

    public void zzds(String s)
    {
        zzdp((new StringBuilder()).append(s).append("|T|").toString());
    }

    KeyPair zzdt(String s)
    {
        String s1;
        Object obj;
        s1 = get(s, "|P|");
...
_L1:
    ...
    KeyPair zze(String s, long l)
    {
        ...
        JVM INSTR monitorenter ;
        KeyPair keypair;
        keypair = com.google.android.gms.iid.zza.zzwl();
        android.content.SharedPreferences.Editor editor = zzaEa.edit();
