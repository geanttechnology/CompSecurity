...
public class zzbp
{
    ...
    public static void zza(String as[], int i, int j, PriorityQueue priorityqueue)
    {
        ...
        {
            l = zza(zzbn.zzC(as[k - 1]), zzbn.zzC(as[(k + j) - 1]), l, l1, 0x1001fffL);
    ...
    {
        long l = ((long)zzbn.zzC(as[i]) + 0x7fffffffL) % 0x4000ffffL;
        for (int k = i + 1; k < i + j; k++)
        {
            l = ((l * 0x1001fffL) % 0x4000ffffL + ((long)zzbn.zzC(as[k]) + 0x7fffffffL) % 0x4000ffffL) % 0x4000ffffL;
        }
