...
_L1:
        ...
        if (iinterface != null && (iinterface instanceof zzfu))
        {
            return (zzfu)iinterface;
        } else
        {
    ...
    public boolean onTransact(int i, Parcel parcel, Parcel parcel1, int j)
    {
        ...
        case 1: // '\001'
            ...
            parcel = zzf(com.google.android.gms.dynamic.zbk(parcel.readStrongBinder()));
