...
public class zzja extends WebViewClient
{
    ...
    {
        com.google.android.gms.ads.internal.util.client.zzb.v((new StringBuilder("Loading resource: ")).append(s).toString());
        webview = Uri.parse(s);
...
label0:
    ...
    {
        Uri uri;
        com.google.android.gms.ads.internal.util.client.zzb.v((new StringBuilder("AdWebView shouldOverrideUrlLoading: ")).append(s).toString());
        uri = Uri.parse(s);
...
_L2:
        ...
        if (zzan1 != null)
        {
            ...
            {
                com.google.android.gms.ads.internal.util.client.zzb.zzaH((new StringBuilder("Unable to append parameter to URL: ")).append(s).toString());
                webview = uri;
            }
        }
        ...
        com.google.android.gms.ads.internal.util.client.zzb.zzaH((new StringBuilder("AdWebView unable to handle URL: ")).append(s).toString());
...
_L3:
    ...
    public void zzh(Uri uri)
    {
        ...
        if (obj != null)
        {
            ...
            {
                com.google.android.gms.ads.internal.util.client.zzb.v((new StringBuilder("Received GMSG: ")).append(s).toString());
                String s1;
                for (Iterator iterator = uri.keySet().iterator(); iterator.hasNext(); com.google.android.gms.ads.internal.util.client.zzb.v((new StringBuilder("  ")).append(s1).append(": ").append((String)uri.get(s1)).toString()))
                {
        ...
        implements zzg
    {
        ...
        public zzc(zziz zziz1, zzg zzg1)
        {
            zzKj = zziz1;
            zzJX = zzg1;
        }
        ...
        implements zzdk
    {
        ...
        public void zza(zziz zziz1, Map map)
        {
            ...
            {
                com.google.android.gms.internal.zzja.zza(zzKi);
            } else
            {
                if (map.keySet().contains("stop"))
                {
                    com.google.android.gms.internal.zzja.zzb(zzKi);
                    return;
                }
        ...
        implements Runnable
    {
        ...
        {
            zzKi.zzoM.zzho();
            com.google.android.gms.ads.internal.overlay.zzd zzd1 = zzKi.zzoM.zzhc();
            if (zzd1 != null)
            {
                zzd1.zzeG();
            }
            ...
            {
                zzja.zzd(zzKi).zzbf();
                com.google.android.gms.internal.zzja.zza(zzKi, null);
            }
        }
    ...
    private class zza
    {
        ...
        public abstract void zza(zziz zziz1, boolean flag);
    }
