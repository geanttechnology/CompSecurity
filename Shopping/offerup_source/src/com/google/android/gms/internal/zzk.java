    ...
    implements Comparable
{
    ...
    {
        String s1 = (new StringBuilder("0x")).append(Integer.toHexString(zzg())).toString();
...
_L5:
    ...
    public String zzp()
    {
        return (new StringBuilder("application/x-www-form-urlencoded; charset=")).append(zzo()).toString();
    }
