...
_L4:
        ...
        if (iinterface != null && (iinterface instanceof zzrh))
        {
            return (zzrh)iinterface;
        } else
        {
    ...
    public boolean onTransact(int i, Parcel parcel, Parcel parcel1, int j)
    {
        ...
        case 1: // '\001'
            ...
            zzd zzd1 = com.google.android.gms.dynamic.zbk(parcel.readStrongBinder());
            if (parcel.readInt() != 0)
            {
        ...
        case 3: // '\003'
            parcel.enforceInterface("com.google.android.gms.wallet.fragment.internal.IWalletFragmentDelegate");
            zzd zzd2 = com.google.android.gms.dynamic.zbk(parcel.readStrongBinder());
            zzd zzd3 = com.google.android.gms.dynamic.zbk(parcel.readStrongBinder());
            if (parcel.readInt() != 0)
            {
                parcel = (Bundle)Bundle.CREATOR.createFromParcel(parcel);
            } else
