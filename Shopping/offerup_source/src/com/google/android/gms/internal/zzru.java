...
public final class zzru extends zzry
{
    ...
    public final boolean equals(Object obj)
    {
        if (obj != this)
        {
            ...
            obj = (zzru)obj;
            if (!zzsc.equals(zzbhU, ((zzru) (obj)).zzbhU))
            {
                return false;
            }
            if (!zzsc.equals(zzbhV, ((zzru) (obj)).zzbhV))
            {
                return false;
            }
            if (!zzsc.zza(zzbhW, ((zzru) (obj)).zzbhW))
            {
                return false;
            }
            if (zzbik == null || zzbik.isEmpty())
            {
                if (((zzru) (obj)).zzbik != null && !((zzru) (obj)).zzbik.isEmpty())
                {
                    return false;
                }
            } else
    ...
    public final zzru zzE(zzrw zzrw1)
    {
        do
        {
            int i = zzrw1.zzFo();
