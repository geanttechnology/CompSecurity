    ...
    implements SafeParcelable
{
    ...
    public static final Comparator zzaEf = new _cls1();
    ...
    public boolean equals(Object obj)
    {
        if (this != obj)
        {
            ...
            if (zzaEg != ((DetectedActivity) (obj)).zzaEg || zzaEh != ((DetectedActivity) (obj)).zzaEh)
            {
                return false;
            }
        }
    ...
    public int hashCode()
    {
        return zzw.hashCode(new Object[] {
            Integer.valueOf(zzaEg), Integer.valueOf(zzaEh)
        });
    }

    public String toString()
    {
        return (new StringBuilder("DetectedActivity [type=")).append(zzgL(getType())).append(", confidence=").append(zzaEh).append("]").toString();
    }
        ...
        implements Comparator
    {
        ...
        public final int zza(DetectedActivity detectedactivity, DetectedActivity detectedactivity1)
        {
