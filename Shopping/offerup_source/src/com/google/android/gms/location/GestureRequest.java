    ...
    implements SafeParcelable
{
    ...
    private static final List zzaEv = Collections.unmodifiableList(Arrays.asList(new Integer[] {
    ...
    private static final List zzaEw = Collections.unmodifiableList(Arrays.asList(new Integer[] {
        Integer.valueOf(1)
    }));
    private static final List zzaEx = Collections.unmodifiableList(Arrays.asList(new Integer[] {
    ...
    private static final List zzaEy = Collections.unmodifiableList(Arrays.asList(new Integer[] {
