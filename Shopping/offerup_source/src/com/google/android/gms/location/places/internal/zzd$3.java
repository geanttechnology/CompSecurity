...
class zzaGZ extends com.google.android.gms.location.places.a
{
    ...
    ter(zzd zzd, com.google.android.gms.common.api.c c, GoogleApiClient googleapiclient, String s, LatLngBounds latlngbounds, AutocompleteFilter autocompletefilter)
    {
        zzaGW = zzd;
        zzaxk = s;
        zzaGY = latlngbounds;
