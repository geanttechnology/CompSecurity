...
_L1:
        StreetViewPanoramaCamera streetviewpanoramacamera = StreetViewPanoramaCamera.CREATOR.zzfq(parcel1);
_L4:
        parcel1.recycle();
        parcel.recycle();
...
_L3:
    ...
    public StreetViewPanoramaLocation getStreetViewPanoramaLocation()
    {
        ...
        if (parcel1.readInt() == 0) goto _L2; else goto _L1
_L1:
        StreetViewPanoramaLocation streetviewpanoramalocation = StreetViewPanoramaLocation.CREATOR.zzfs(parcel1);
_L4:
        parcel1.recycle();
        parcel.recycle();
...
_L1:
        ...
        parcel1.readException();
        streetviewpanoramaorientation = com.google.android.gms.dynamic.a.zza.zznJ(parcel1.readStrongBinder());
        parcel1.recycle();
        parcel.recycle();
...
_L1:
        ...
        {
            zzd1 = StreetViewPanoramaOrientation.CREATOR.zzft(parcel1);
        }
        parcel1.recycle();
        parcel.recycle();
        return zzd1;
