    ...
    implements SafeParcelable
{
    ...
    private StreetViewPanoramaOrientation zzaKy;
    ...
    StreetViewPanoramaCamera(int i, float f, float f1, float f2)
    {
        ...
        bearing = f % 360F;
        zzaKy = (new StreetViewPanoramaOrientation.Builder()).tilt(f1).bearing(f2).build();
    }
    ...
    {
        return zzw.zzv(this).zzg("zoom", Float.valueOf(zoom)).zzg("tilt", Float.valueOf(tilt)).zzg("bearing", Float.valueOf(bearing)).toString();
    }
