...
_L2:
        ...
        do
        {
            ...
            bundle1.putString(as[i << 1], as[(i << 1) + 1]);
            i++;
        } while (true);
...
_L3:
    ...
    public String toString()
    {
        ...
        stringbuilder.append("eventTime=").append(zzaRG).append(",");
        stringbuilder.append("eventUptime=").append(zzaRH).append(",");
        if (zzaRJ != null && !zzaRJ.isEmpty())
        {
            stringbuilder.append("keyValues=");
            for (Iterator iterator = zzaRJ.keySet().iterator(); iterator.hasNext(); stringbuilder.append(" "))
            {
                String s = (String)iterator.next();
                stringbuilder.append("(").append(s).append(",");
                stringbuilder.append(zzaRJ.getString(s)).append(")");
            }
