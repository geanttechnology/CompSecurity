...
//            zzf, CheckServerAuthResult, RecordConsentRequest

public abstract class nsentRequest extends Binder
    implements zzf
{
...
_L1:
    ...
    public boolean onTransact(int i, Parcel parcel, Parcel parcel1, int j)
    {
        ...
        case 2: // '\002'
            ...
            zza(authaccountrequest, zzdM(parcel.readStrongBinder()));
        ...
        case 8: // '\b'
            ...
            zza(i, account, zzdM(parcel.readStrongBinder()));
            parcel1.writeNoException();
            return true;
        ...
        case 10: // '\n'
            ...
            zza(recordconsentrequest, zzdM(parcel.readStrongBinder()));
            parcel1.writeNoException();
            return true;

        case 11: // '\013'
            parcel.enforceInterface("com.google.android.gms.signin.internal.ISignInService");
            zza(zzdM(parcel.readStrongBinder()));
            parcel1.writeNoException();
            return true;
        }
    }
