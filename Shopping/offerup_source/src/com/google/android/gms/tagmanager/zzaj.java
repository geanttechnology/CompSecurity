...
class zzaj
{
    ...
    private static Map zzc(com.google.android.gms.internal.zzag.zza zza1)
    {
        ...
        {
            zzbg.zzaH((new StringBuilder("value: ")).append(zza1).append(" is not a map value, ignored.").toString());
            return null;
        } else
        {
            return (Map)zza1;
...
label0:
        {
            ...
            datalayer.zzeI(zzc1.key);
            zzd = datalayer.zzk(zzc1.key, obj);
            if (zzc1.zzhY > 0L)
            {
