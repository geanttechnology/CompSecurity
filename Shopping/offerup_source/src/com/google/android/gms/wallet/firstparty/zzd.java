    ...
    implements android.os.Parcelable.Creator
{
    ...
    static void zza(GetInstrumentsRequest getinstrumentsrequest, Parcel parcel, int i)
    {
        ...
        zzb.zza(parcel, 2, getinstrumentsrequest.zzbdQ, false);
        zzb.zzI(parcel, i);
    }
    ...
    public GetInstrumentsRequest zzhp(Parcel parcel)
    {
        ...
        do
        {
            if (parcel.dataPosition() < j)
            {
                ...
                case 2: // '\002'
                    ai = com.google.android.gms.common.internal.safeparcel.zza.zzv(parcel, k);
                    break;
                }
            } else
            if (parcel.dataPosition() != j)
    ...
    public GetInstrumentsRequest[] zzks(int i)
    {
