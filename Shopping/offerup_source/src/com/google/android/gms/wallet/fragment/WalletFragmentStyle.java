...
_L1:
        throw new IllegalStateException((new StringBuilder("Unexpected unit or type: ")).append(i).toString());
_L9:
        return j;
_L8:
...
_L10:
    ...
    private static long zza(int i, float f)
    {
        ...
        {
        default:
            throw new IllegalArgumentException((new StringBuilder("Unrecognized unit: ")).append(i).toString());
    ...
    private static long zza(TypedValue typedvalue)
    {
        ...
        {
        default:
            throw new IllegalArgumentException((new StringBuilder("Unexpected dimension type: ")).append(typedvalue.type).toString());
    ...
    private static long zzkx(int i)
    {
        if (i < 0)
        {
            ...
            {
                throw new IllegalArgumentException((new StringBuilder("Unexpected dimension value: ")).append(i).toString());
            }
        } else
        {
            return zza(0, i);
    ...
    public final int zza(String s, DisplayMetrics displaymetrics, int i)
    {
        if (zzbes.containsKey(s))
        {
