    ...
    implements android.os.Parcelable.Creator
{
    ...
    static void zza(CommonWalletObject commonwalletobject, Parcel parcel, int i)
    {
        ...
        zzb.zza(parcel, 3, commonwalletobject.zzbcW, false);
        zzb.zza(parcel, 4, commonwalletobject.name, false);
        zzb.zza(parcel, 5, commonwalletobject.zzbcQ, false);
        zzb.zza(parcel, 6, commonwalletobject.zzbcS, false);
        zzb.zza(parcel, 7, commonwalletobject.zzbcT, false);
        zzb.zza(parcel, 8, commonwalletobject.zzbcU, false);
        zzb.zza(parcel, 9, commonwalletobject.zzbcV, false);
        zzb.zzc(parcel, 10, commonwalletobject.state);
        zzb.zzc(parcel, 11, commonwalletobject.zzbcX, false);
        zzb.zza(parcel, 12, commonwalletobject.zzbcY, i, false);
        zzb.zzc(parcel, 13, commonwalletobject.zzbcZ, false);
        zzb.zza(parcel, 14, commonwalletobject.zzbda, false);
        zzb.zza(parcel, 15, commonwalletobject.zzbdb, false);
        zzb.zza(parcel, 17, commonwalletobject.zzbdd);
        zzb.zzc(parcel, 16, commonwalletobject.zzbdc, false);
        zzb.zzc(parcel, 19, commonwalletobject.zzbdf, false);
        zzb.zzc(parcel, 18, commonwalletobject.zzbde, false);
        zzb.zzc(parcel, 20, commonwalletobject.zzbdg, false);
        zzb.zzI(parcel, j);
    }
    ...
    public CommonWalletObject zzhv(Parcel parcel)
    {
    ...
    public CommonWalletObject[] zzkB(int i)
    {
