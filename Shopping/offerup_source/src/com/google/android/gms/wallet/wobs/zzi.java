    ...
    implements android.os.Parcelable.Creator
{
    ...
    static void zza(WalletObjectMessage walletobjectmessage, Parcel parcel, int i)
    {
        ...
        zzb.zza(parcel, 2, walletobjectmessage.zzbeM, false);
        zzb.zza(parcel, 3, walletobjectmessage.body, false);
        zzb.zza(parcel, 4, walletobjectmessage.zzbeP, i, false);
        zzb.zza(parcel, 5, walletobjectmessage.zzbeQ, i, false);
        zzb.zza(parcel, 6, walletobjectmessage.zzbeR, i, false);
        zzb.zzI(parcel, j);
    }
    ...
    public WalletObjectMessage zzhD(Parcel parcel)
    {
    ...
    public WalletObjectMessage[] zzkJ(int i)
    {
