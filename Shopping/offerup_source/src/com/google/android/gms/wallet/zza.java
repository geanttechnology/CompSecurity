    ...
    implements android.os.Parcelable.Creator
{
    ...
    static void zza(Address address, Parcel parcel, int i)
    {
        ...
        zzb.zza(parcel, 3, address.zzaDk, false);
        zzb.zza(parcel, 4, address.zzaDl, false);
        zzb.zza(parcel, 5, address.zzaDm, false);
        zzb.zza(parcel, 6, address.zzGw, false);
        zzb.zza(parcel, 7, address.zzbcg, false);
        zzb.zza(parcel, 8, address.zzbch, false);
        zzb.zza(parcel, 9, address.zzaDr, false);
        zzb.zza(parcel, 10, address.phoneNumber, false);
        zzb.zza(parcel, 11, address.zzaDt);
        zzb.zza(parcel, 12, address.zzaDu, false);
        zzb.zzI(parcel, i);
    }
