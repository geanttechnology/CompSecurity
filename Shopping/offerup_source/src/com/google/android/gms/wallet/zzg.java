    ...
    implements android.os.Parcelable.Creator
{
    ...
    static void zza(GiftCardWalletObject giftcardwalletobject, Parcel parcel, int i)
    {
        ...
        zzb.zza(parcel, 2, giftcardwalletobject.zzbcC, i, false);
        zzb.zza(parcel, 3, giftcardwalletobject.zzbcD, false);
        zzb.zza(parcel, 4, giftcardwalletobject.pin, false);
        zzb.zza(parcel, 5, giftcardwalletobject.zzbcE, false);
        zzb.zza(parcel, 6, giftcardwalletobject.zzbcF);
        zzb.zza(parcel, 7, giftcardwalletobject.zzbcG, false);
        zzb.zza(parcel, 8, giftcardwalletobject.zzbcH);
        zzb.zza(parcel, 9, giftcardwalletobject.zzbcI, false);
        zzb.zzI(parcel, j);
    }
    ...
    public GiftCardWalletObject zzhc(Parcel parcel)
    {
        long l = 0L;
        String s = null;
    ...
    public GiftCardWalletObject[] zzkf(int i)
    {
