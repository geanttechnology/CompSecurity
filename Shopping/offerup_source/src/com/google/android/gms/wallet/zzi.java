    ...
    implements android.os.Parcelable.Creator
{
    ...
    static void zza(LineItem lineitem, Parcel parcel, int i)
    {
        ...
        zzb.zza(parcel, 3, lineitem.zzbcL, false);
        zzb.zza(parcel, 4, lineitem.zzbcM, false);
        zzb.zza(parcel, 5, lineitem.zzbci, false);
        zzb.zzc(parcel, 6, lineitem.zzbcN);
        zzb.zza(parcel, 7, lineitem.zzbcj, false);
        zzb.zzI(parcel, i);
    }
    ...
    public LineItem zzhe(Parcel parcel)
    {
        int i = 0;
        String s = null;
