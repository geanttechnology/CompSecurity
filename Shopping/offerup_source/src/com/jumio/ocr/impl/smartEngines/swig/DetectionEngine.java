...
public class DetectionEngine
{
    ...
    public DetectionResult processRawYUVImage(byte abyte0[], int i, int j, int k, int l)
    {
        return new DetectionResult(jniInterfaceJNI.DetectionEngine_processRawYUVImage(a, this, abyte0, i, j, k, l), true);
    }
