...
public class ResultAcceptorInterfaceSettings
{
    ...
    public void setAllOcrEnabledFlag(boolean flag)
    {
        jniInterfaceJNI.ResultAcceptorInterfaceSettings_setAllOcrEnabledFlag(a, this, flag);
    }
    ...
    private class FieldName
    {
        ...
        static 
        {
            ...
            AMEX_CVV = new FieldName("AMEX_CVV");
            a = (new FieldName[] {
