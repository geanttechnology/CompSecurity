...
_L4:
    ...
    private void c(Bundle bundle)
    {
        ...
        obj = (new bl(this)).a(getApplicationInfo().icon).a(((CharSequence) (obj))).a((new bk()).c(bundle.getString("lp_message"))).b(bundle.getString("lp_message"));
        ((bl) (obj)).a(true);
        ((bl) (obj)).a(((PendingIntent) (obj1)));
        if (a != null)
        {
            a.customize(((bl) (obj)), bundle);
        }
...
_L4:
        notificationmanager.notify(i, ((bl) (obj)).a());
        return;
_L2:
