    ...
    implements co
{
    ...
    private ch(FirstQuestionHelpActivity firstquestionhelpactivity)
    {
        a = firstquestionhelpactivity;
        super();
    }

    ch(FirstQuestionHelpActivity firstquestionhelpactivity, byte byte0)
    {
        this(firstquestionhelpactivity);
    }
