...
_L6:
    ...
    public final String b()
    {
        ...
        jsonobject1.accumulate("device_info", dd.a(dn.a().toString()));
        jsonobject1.accumulate("app_info", dd.a(dl.a().toString()));
        jsonobject1.accumulate("risk_data", dd.a(z.a().b().toString()));
