...
public final class eh extends er
{
    ...
    public final String b()
    {
        ...
        jsonobject1.accumulate("payment_method", "paypal");
        jsonobject.accumulate("payer", jsonobject1);
        jsonobject1 = new JSONObject();
        jsonobject1.accumulate("cancel_url", "http://cancelurl");
        jsonobject1.accumulate("return_url", "http://returnurl");
        jsonobject.accumulate("redirect_urls", jsonobject1);
        new JSONObject();
