...
public abstract class eo extends ci
{
    ...
    public eo(cp cp, ck ck, ac ac, String s)
    {
        super(new co(cp), ck, ac, s);
    ...
    protected static String a(JSONObject jsonobject)
    {
        ...
        return dd.a(jsonarray.toString());
    }
    ...
    static 
    {
        com/paypal/android/sdk/eo.getSimpleName();
    }
}
