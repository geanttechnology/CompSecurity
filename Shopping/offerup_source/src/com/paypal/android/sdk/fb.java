...
public final class fb
{
    ...
    public fb(Context context)
    {
        ...
        for (int i1 = 0; i1 < 10; i1++)
        {
            ...
            cm.a(textview, -1, -2);
            cm.a(textview, null, "10dip");
            atextview[i1] = textview;
            c[i1].setFocusable(false);
        ...
        cm.a(e, -1, -2);
        cm.b(e, null, "20dip", null, "10dip");
        e.setVisibility(8);
        h = cm.a(context, 1, linearlayout);
        h.setNextFocusLeftId(2);
        h.setNextFocusRightId(3);
        i = new TextView(context);
        cm.a(i);
        i.setText("Agree");
        h.addView(i, new android.view.ViewGroup.LayoutParams(-2, -2));
        g = new Button(context);
        g.setId(3);
        cm.a(g);
        linearlayout.addView(g);
        cm.b(g, null, null, null, "16dip");
        cm.a(g, -2, -2);
        cm.a(g, 17, 1.0F);
