...
final class is
{
    ...
    private static final is c = new is();
    ...
    private void b()
    {
        for (int i = 0; i < 256; i++)
        {
            int k = a[i];
            byte byte0 = b[i];
            it it2 = new it(i, byte0);
            it it1;
            int l;
            for (it1 = d; byte0 > 8; it1 = it.a(it1)[l])
            {
                byte0 -= 8;
                l = k >>> byte0 & 0xff;
                if (it.a(it1) == null)
    ...
    final byte[] a(byte abyte0[])
    {
        ...
        do
        {
            ...
            for (i += 8; i >= 8;)
            {
                it1 = it.a(it1)[k >>> i - 8 & 0xff];
                if (it.a(it1) == null)
                {
                    bytearrayoutputstream.write(it.b(it1));
                    i -= it.c(it1);
                    it1 = d;
                } else
                {
        ...
        do
        {
            ...
            abyte0 = it.a(it2)[k << 8 - l & 0xff];
            if (it.a(abyte0) != null || it.c(abyte0) > l)
            {
                break;
            }
            bytearrayoutputstream.write(it.b(abyte0));
            l -= it.c(abyte0);
            it2 = d;
        } while (true);
