    ...
    implements jf
{
    ...
    public final ho a(ks ks, boolean flag)
    {
        return new jd(ks, flag);
    }

    public final hq a(kr kr, boolean flag)
    {
        return new je(kr, flag);
    }
