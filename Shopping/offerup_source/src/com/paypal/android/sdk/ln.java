    ...
    implements ig
{
    ...
    public ln()
    {
        ...
        a.put(fa.X, "Enable display of your funding options to allow you to make a choice.");
        a.put(fa.Y, "<a href='%1$s'>Authorize charges</a> for future %2$s purchases paid for with PayPal. You instruct PayPal to pay all amounts requested by %3$s.");
        ...
        a.put(fa.aL, "Please log in again to PayPal.");
        ...
        a.put(fa.bc, "Unauthorized Device");
        ...
        a.put(fa.bg, "Unrecognized Source");
