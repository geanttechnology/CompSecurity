    ...
    implements ig
{
    ...
    public lp()
    {
        ...
        a.put(fa.v, "Visa");
        a.put(fa.w, "Change Funding Source");
        a.put(fa.x, "Current");
        a.put(fa.y, "Checking this device\u2026");
        a.put(fa.z, "Clear card details");
        a.put(fa.A, "Confirm");
        a.put(fa.B, "Are you sure you want to clear your card details?");
        ...
        a.put(fa.W, "Share the <a href='%1$s'>funding sources</a> linked to your PayPal account.");
        ...
        a.put(fa.Z, "Allow them to add and manage their loyalty card in your PayPal wallet.");
        ...
        a.put(fa.aA, "Phone");
        a.put(fa.aB, "PIN");
        a.put(fa.aC, "Preferred Funding Source");
        ...
        a.put(fa.aT, "Verification Code");
        a.put(fa.aU, "Send a text message to your phone. The 6-digit code you receive will be valid for 5 minutes.");
        a.put(fa.aV, "Sending Text");
        a.put(fa.aW, "Enter the 6-digit verification code");
        a.put(fa.aX, "Your mobile number");
        a.put(fa.aY, "Send Text");
        a.put(fa.aZ, "Send Text Again");
