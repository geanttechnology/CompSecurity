    ...
    implements Parcelable
{
    ...
    {
        java.util.concurrent.ExecutorService executorservice = com.paypal.android.sdk.payments.PayPalService.a;
        new br();
        return bd.a(executorservice, context, new a(context, "AndroidBasePrefs"), "2.11.1");
    }
    ...
    final boolean n()
    {
        boolean flag1 = dd.a(a, b(), "environment");
        a(flag1, "environment");
        boolean flag;
        if (flag1)
        {
