...
//            PayPalProfileSharingActivity, be, PayPalService, ax
    ...
    implements ServiceConnection
{
    ...
    au(PayPalProfileSharingActivity paypalprofilesharingactivity)
    {
    ...
    public final void onServiceConnected(ComponentName componentname, IBinder ibinder)
    {
        ...
        PayPalProfileSharingActivity.a(a, ((be)ibinder).a);
        ...
        componentname = new ax(a.getIntent(), PayPalProfileSharingActivity.b(a).e(), true);
        if (!componentname.e())
        {
