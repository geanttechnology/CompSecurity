...
final class l
{
    ...
    l(Context context, k k1)
    {
        d = new ScrollView(context);
        d.setBackgroundColor(cl.d);
        ...
        s = (new StringBuilder("body { color: #515151; line-height: 26px; font-size: 18px; font-family: sans-serif-light, DroidSans, sans-serif; font-weight: 300; ")).append(s).append("} h1, strong { font-family: DroidSans, sans-serif; font-weight: 500; }h1 { font-size: 18px }h1, p { margin: 0 0 13px 0 }").append("ul { margin: 0; padding-left: 1.1em; list-style-position: outside; }").toString();
        stringbuilder = (new StringBuilder("<html><meta name='viewport' content='width=device-width; initial-scale=1.0;'/><head><style type=\"text/css\">")).append(s).append("</style></head><body>");
        m.a[k1.ordinal()];
...
_L1:
        k1 = null;
_L7:
        webview.loadData(stringbuilder.append(k1).append("</body><html>").toString(), "text/html; charset=UTF-8", null);
        webview.setClickable(true);
        linearlayout.addView(webview);
        cm.a(webview, -1, -2);
        cm.b(webview, null, null, null, "10dip");
        c = new Button(context);
        linearlayout.addView(c);
        cm.a(c, true, context);
        cm.b(c, null, "20dip", null, "4dip");
        a = d;
        return;
_L2:
        String s2 = ex.a(fa.am);
    ...
    "nl", "de", "it", "fr", "gb", "us"
        ...
        {
            k1 = String.format("https://www.paypal.com/%s/webapps/mpp/ua/useragreement-full", new Object[] {
                k1
            });
        } else
        {
        ...
        k1 = String.format(s2, new Object[] {
            k1
        });
...
_L3:
        ...
        continue; /* Loop/switch isn't completed */
_L4:
        k1 = String.format(ex.a(fa.aH), new Object[] {
            ex.a(fa.aG)
        });
        continue; /* Loop/switch isn't completed */
_L5:
