...
_L1:
    ...
    private static int readInt(j j1)
    {
        ...
        throw new IOException((new StringBuilder("expected an int but was \"")).append(l).append(j1).append("\"").toString());
        return (int)l;
    }
...
_L3:
            ...
            f1 = new f();
            f1.a(k.b(((String) (obj))));
            arraylist.add(certificatefactory.generateCertificate(f1.f()));
            l++;
...
_L1:
        ...
        {
            boolean flag = false;
            editor = q.a(editor.newSink(0));
            editor.b(url);
            editor.g(10);
            editor.b(requestMethod);
            editor.g(10);
            editor.j(varyHeaders.size());
            editor.g(10);
...
_L2:
            ...
            ((Headers.Builder) (obj1)).addLenient(((j) (obj)).o());
            l++;
            if (true) goto _L2; else goto _L1
_L1:
            varyHeaders = ((Headers.Builder) (obj1)).build();
            obj1 = StatusLine.parse(((j) (obj)).o());
...
_L3:
            ...
            ab1.close();
            throw obj;
            handshake = Handshake.get(((j) (obj)).o(), readCertificateList(((j) (obj))), readCertificateList(((j) (obj))));
_L5:
            ab1.close();
            return;
            handshake = null;
    ...
    private class CacheResponseBody extends ResponseBody
    {
        ...
        public CacheResponseBody(com.squareup.okhttp.internal.DiskLruCache.Snapshot snapshot1, String s, String s1)
        {
            ...
            bodySource = q.a(new _cls1(snapshot1));
        }
    }
...
_L2:
            ...
            nextUrl = q.a(snapshot.getSource(0)).o();
            snapshot.close();
            return true;
            Object obj;
            obj;
