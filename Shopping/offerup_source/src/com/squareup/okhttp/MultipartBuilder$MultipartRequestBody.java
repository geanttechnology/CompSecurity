...
_L1:
        ...
        j.b(MultipartBuilder.access$000());
        j.b(boundary);
        j.b(MultipartBuilder.access$100());
        if (obj != null)
        {
            j1 = 0;
            for (l1 = ((Headers) (obj)).size(); j1 < l1; j1++)
            {
                j.b(((Headers) (obj)).name(j1)).b(MultipartBuilder.access$200()).b(((Headers) (obj)).value(j1)).b(MultipartBuilder.access$100());
            }
        ...
        if (obj != null)
        {
            j.b("Content-Type: ").b(((MediaType) (obj)).toString()).b(MultipartBuilder.access$100());
        }
        l3 = requestbody.contentLength();
        if (l3 == -1L) goto _L4; else goto _L3
_L3:
        j.b("Content-Length: ").j(l3).b(MultipartBuilder.access$100());
_L6:
        j.b(MultipartBuilder.access$100());
        if (flag)
        {
