...
final class <init>
{
    ...
    final ot snapshot()
    {
        ...
        aab = new ab[DiskLruCache.access$2300(DiskLruCache.this)];
...
_L2:
        ...
        aab[j] = DiskLruCache.access$2400(DiskLruCache.this).source(cleanFiles[j]);
        j++;
        if (true) goto _L2; else goto _L1
_L1:
        ot ot = new ot(DiskLruCache.this, key, sequenceNumber, aab, al, null);
        return ot;
_L4:
        for (; j < DiskLruCache.access$2300(DiskLruCache.this) && aab[j] != null; j++)
        {
            Util.closeQuietly(aab[j]);
        }
