    ...
    implements Closeable
{
    ...
    private static final aa NULL_SINK = new _cls4();
...
_L4:
        ...
        {
            editor.abort();
            throw new IllegalStateException((new StringBuilder("Newly created entry didn't create value for index ")).append(k).toString());
        }
...
_L6:
    ...
    {
        return q.a(new _cls2(fileSystem.appendingSink(journalFile)));
    }
    ...
    {
        j j1 = q.a(fileSystem.source(journalFile));
        String s = j1.o();
        String s1 = j1.o();
        String s2 = j1.o();
        String s3 = j1.o();
...
_L1:
        ...
        if (k != 6 || !s.startsWith("REMOVE")) goto _L4; else goto _L3
_L3:
...
_L4:
        ...
        if (i1 != -1 && k == 5 && s.startsWith("CLEAN"))
        {
        ...
        if (i1 == -1 && k == 5 && s.startsWith("DIRTY"))
        {
            entry.currentEditor = new Editor(entry, null);
            return;
        }
        if (i1 != -1 || k != 4 || !s.startsWith("READ"))
        {
            throw new IOException((new StringBuilder("unexpected journal line: ")).append(s).toString());
        }
...
_L5:
    ...
    private void rebuildJournal()
    {
        ...
        obj = q.a(fileSystem.sink(journalFileTmp));
        Iterator iterator;
        ((i) (obj)).b("libcore.io.DiskLruCache").g(10);
        ((i) (obj)).b("1").g(10);
        ((i) (obj)).j(appVersion).g(10);
        ((i) (obj)).j(valueCount).g(10);
        ((i) (obj)).g(10);
...
_L2:
                ...
                aab[k] = fileSystem.source(cleanFiles[k]);
                k++;
                if (true) goto _L2; else goto _L1
_L1:
                Snapshot snapshot1 = new Snapshot(key, sequenceNumber, aab, al, null);
                return snapshot1;
_L4:
                for (; k < valueCount && aab[k] != null; k++)
                {
                    Util.closeQuietly(aab[k]);
                }
...
*/
                ...
                implements Closeable
            {
                ...
                public final long getLength(int k)
                {
                    return lengths[k];
                }

                public final ab getSource(int k)
                {
                    return sources[k];
                }
                ...
                private Snapshot(String s, long l, ab aab[], long al[])
                {
                    this$0 = DiskLruCache.this;
                    super();
                    key = s;
                ...
                Snapshot(String s, long l, ab aab[], long al[], _cls1 _pcls1)
                {
                    this(s, l, aab, al);
                }
            }
...
_L1:
        ...
        public final ab newSource(int k)
        {
            DiskLruCache disklrucache = DiskLruCache.this;
            disklrucache;
            JVM INSTR monitorenter ;
            ...
            JVM INSTR monitorexit ;
            return null;
            ab ab = fileSystem.source(entry.cleanFiles[k]);
            disklrucache;
            JVM INSTR monitorexit ;
            return ab;
            ab;
