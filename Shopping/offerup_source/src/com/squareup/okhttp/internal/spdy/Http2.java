    ...
    implements Variant
{
    ...
    {
        return (j1.g() & 0xff) << 16 | (j1.g() & 0xff) << 8 | j1.g() & 0xff;
    }
    ...
    public final FrameReader newReader(j j1, boolean flag)
    {
        return new Reader(j1, 4096, flag);
    }

    public final FrameWriter newWriter(i l, boolean flag)
    {
...
_L6:
            ...
            private class FrameLogger
            {
                ...
                static 
                {
                    ...
                    do
                    {
                        ...
                        {
                            int j2 = ai[l1];
                            FLAGS[j2 | i2] = (new StringBuilder()).append(FLAGS[j2]).append('|').append(FLAGS[i2]).toString();
                            FLAGS[j2 | i2 | 8] = (new StringBuilder()).append(FLAGS[j2]).append('|').append(FLAGS[i2]).append("|PADDED").toString();
                        }

                        j1++;
                    } while (true);
                    for (; l1 < FLAGS.length; l1++)
                    {
                        if (FLAGS[l1] == null)
                        {
                            FLAGS[l1] = BINARY[l1];
        ...
        private void readPriority(FrameReader.Handler handler, int l)
        {
            ...
            handler.priority(l, i1 & 0x7fffffff, (source.g() & 0xff) + 1, flag);
        }
        ...
        private void readPushPromise(FrameReader.Handler handler, int l, byte byte0, int i1)
        {
            ...
            handler.pushPromise(i1, source.i() & 0x7fffffff, readHeaderBlock(Http2.lengthWithoutPadding(l - 4, byte0, word0), word0, byte0, i1));
        }
...
_L14:
        ...
        private void readWindowUpdate(FrameReader.Handler handler, int l, byte byte0, int i1)
        {
            ...
            long l1 = (long)source.i() & 0x7fffffffL;
            if (l1 == 0L)
            {
        ...
        public final void readConnectionPreface()
        {
            if (!client)
            {
                k k1 = source.c(Http2.CONNECTION_PREFACE.e());
                if (Http2.logger.isLoggable(Level.FINE))
                {
...
_L1:
            ...
            {
                Http2.logger.fine(String.format(">> CONNECTION %s", new Object[] {
                    Http2.CONNECTION_PREFACE.c()
                }));
            }
            sink.b(Http2.CONNECTION_PREFACE.f());
            sink.flush();
              goto _L1
        }

        public final void data(boolean flag, int l, f f1, int i1)
        {
            this;
            JVM INSTR monitorenter ;
            if (closed)
        ...
        final void dataFrame(int l, byte byte0, f f1, int i1)
        {
        ...
        final void frameHeader(int l, int i1, byte byte0, byte byte1)
        {
            if (Http2.logger.isLoggable(Level.FINE))
            {
        ...
        public final void goAway(int l, ErrorCode errorcode, byte abyte0[])
        {
            this;
            JVM INSTR monitorenter ;
            if (closed)
        ...
        public final void headers(int l, List list)
        {
            this;
            JVM INSTR monitorenter ;
            if (closed)
        ...
        final void headers(boolean flag, int l, List list)
        {
            if (closed)
            {
                throw new IOException("closed");
        ...
        public final void ping(boolean flag, int l, int i1)
        {
            byte byte0 = 0;
            this;
            JVM INSTR monitorenter ;
        ...
        public final void pushPromise(int l, int i1, List list)
        {
            this;
            JVM INSTR monitorenter ;
            if (closed)
        ...
        public final void rstStream(int l, ErrorCode errorcode)
        {
            this;
            JVM INSTR monitorenter ;
            if (closed)
...
_L3:
            if (l != 4) goto _L6; else goto _L5
_L5:
            int i1 = 3;
_L7:
            sink.f(i1);
            sink.e(settings1.get(l));
              goto _L4
_L2:
            sink.flush();
            this;
...
_L9:
        ...
        public final void synReply(boolean flag, int l, List list)
        {
            this;
            JVM INSTR monitorenter ;
            if (closed)
        ...
        public final void synStream(boolean flag, boolean flag1, int l, int i1, List list)
        {
            this;
            JVM INSTR monitorenter ;
            if (!flag1)
        ...
        public final void windowUpdate(int l, long l1)
        {
            this;
            JVM INSTR monitorenter ;
            if (closed)
