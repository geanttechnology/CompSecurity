    ...
    implements FrameReader
{
    ...
    private void readGoAway(andler andler, int i, int l)
    {
        ...
        {
            andler.goAway(i & 0x7fffffff, errorcode, k.a);
            return;
        }
    }
    ...
    {
        andler.headers(false, false, source.i() & 0x7fffffff, -1, headerBlockReader.readNameValueBlock(l - 4), HeadersMode.SPDY_HEADERS);
    }
