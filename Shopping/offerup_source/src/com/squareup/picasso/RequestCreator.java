...
public class RequestCreator
{
    ...
    private Request createRequest(long l)
    {
        ...
        if (request1 != request)
        {
            ...
            if (flag)
            {
                Utils.log("Main", "changed", request1.logId(), (new StringBuilder("into ")).append(request1).toString());
            }
        }
        return request1;
    }
...
_L2:
        ...
        {
            Utils.log("Main", "completed", request.plainId(), (new StringBuilder("from ")).append(Picasso.LoadedFrom.MEMORY).toString());
        }
        if (callback != null)
        {
            callback.onSuccess();
