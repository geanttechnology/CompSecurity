...
public final class UrbanAirshipProvider extends ContentProvider
{
    ...
    {
        return Uri.parse((new StringBuilder("content://")).append(getAuthorityString()).append("/preferences").toString());
    }
    ...
    {
        return Uri.parse((new StringBuilder("content://")).append(getAuthorityString()).append("/richpush").toString());
    }
