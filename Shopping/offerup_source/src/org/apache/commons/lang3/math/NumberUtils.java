...
_L2:
    ...
    private static String getMantissa(String s)
    {
        return getMantissa(s, s.length());
    }

    private static String getMantissa(String s, int i)
    {
        char c = s.charAt(0);
        boolean flag;
        if (c == '-' || c == '+')
...
label0:
    ...
    private static void validateArray(Object obj)
    {
        ...
        Validate.isTrue(flag, "Array cannot be empty.", new Object[0]);
    }
