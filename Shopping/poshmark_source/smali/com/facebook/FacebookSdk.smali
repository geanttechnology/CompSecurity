...
.method static publishInstallAndWaitForResponse(Landroid/content/Context;Ljava/lang/String;)Lcom/facebook/GraphResponse;
    ...
    .line 513
    new-instance v18, Lcom/facebook/GraphResponse;
    ...
    invoke-direct/range {v18 .. v21}, Lcom/facebook/GraphResponse;-><init>(Lcom/facebook/GraphRequest;Ljava/net/HttpURLConnection;Lcom/facebook/FacebookRequestError;)V
    ...
    .line 452
    .local v7, "identifiers":Lcom/facebook/internal/AttributionIdentifiers;
    ...
    :try_start_2
    sget-object v18, Lcom/facebook/internal/AppEventsLoggerUtility$GraphAPIActivityType;->MOBILE_INSTALL_EVENT:Lcom/facebook/internal/AppEventsLoggerUtility$GraphAPIActivityType;
    ...
    invoke-static {v0, v7, v1, v2, v3}, Lcom/facebook/internal/AppEventsLoggerUtility;->getJSONObjectForGraphAPICall(Lcom/facebook/internal/AppEventsLoggerUtility$GraphAPIActivityType;Lcom/facebook/internal/AttributionIdentifiers;Ljava/lang/String;ZLandroid/content/Context;)Lorg/json/JSONObject;
    :try_end_2
    ...
    .line 470
    .local v14, "publishParams":Lorg/json/JSONObject;
    :try_start_3
    ...
    invoke-static {v0, v1, v14, v2}, Lcom/facebook/GraphRequest;->newPostRequest(Lcom/facebook/AccessToken;Ljava/lang/String;Lorg/json/JSONObject;Lcom/facebook/GraphRequest$Callback;)Lcom/facebook/GraphRequest;
    :try_end_3
    ...
    .line 473
    .local v15, "publishRequest":Lcom/facebook/GraphRequest;
    const-wide/16 v18, 0x0
    ...
    new-instance v20, Lcom/facebook/GraphRequestBatch;
    ...
    invoke-direct/range {v20 .. v21}, Lcom/facebook/GraphRequestBatch;-><init>([Lcom/facebook/GraphRequest;)V

    invoke-static/range {v18 .. v20}, Lcom/facebook/GraphResponse;->createResponsesFromString(Ljava/lang/String;Ljava/net/HttpURLConnection;Lcom/facebook/GraphRequestBatch;)Ljava/util/List;
    ...
    check-cast v18, Lcom/facebook/GraphResponse;

    goto/16 :goto_0

    .line 466
    .end local v6    # "graphObject":Lorg/json/JSONObject;
    .end local v14    # "publishParams":Lorg/json/JSONObject;
    .end local v15    # "publishRequest":Lcom/facebook/GraphRequest;
    ...
    const-string v19, "An error occurred while publishing install."
    ...
    .restart local v14    # "publishParams":Lorg/json/JSONObject;
    .restart local v15    # "publishRequest":Lcom/facebook/GraphRequest;
    ...
    .end local v6    # "graphObject":Lorg/json/JSONObject;
    :cond_4
    invoke-virtual {v15}, Lcom/facebook/GraphRequest;->executeAndWait()Lcom/facebook/GraphResponse;

    move-result-object v16

    .line 498
    .local v16, "publishResponse":Lcom/facebook/GraphResponse;
    ...
    .line 500
    invoke-interface {v5, v12, v10, v11}, Landroid/content/SharedPreferences$Editor;->putLong(Ljava/lang/String;J)Landroid/content/SharedPreferences$Editor;

    .line 503
    invoke-virtual/range {v16 .. v16}, Lcom/facebook/GraphResponse;->getJSONObject()Lorg/json/JSONObject;
    ...
    .end local v16    # "publishResponse":Lcom/facebook/GraphResponse;
    .restart local v6    # "graphObject":Lorg/json/JSONObject;
    :catch_2
    move-exception v18
