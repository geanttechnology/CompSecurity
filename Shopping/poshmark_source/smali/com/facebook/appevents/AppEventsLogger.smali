...
.method private static handleResponse(Lcom/facebook/appevents/AppEventsLogger$AccessTokenAppIdPair;Lcom/facebook/GraphRequest;Lcom/facebook/GraphResponse;Lcom/facebook/appevents/AppEventsLogger$SessionEventsState;Lcom/facebook/appevents/AppEventsLogger$FlushStatistics;)V
    ...
    .line 962
    .local v9, "resultDescription":Ljava/lang/String;
    sget-object v6, Lcom/facebook/appevents/AppEventsLogger$FlushResult;->SUCCESS:Lcom/facebook/appevents/AppEventsLogger$FlushResult;

    .line 964
    .local v6, "flushResult":Lcom/facebook/appevents/AppEventsLogger$FlushResult;
    if-eqz v3, :cond_0
    ...
    .line 966
    .local v2, "NO_CONNECTIVITY_ERROR_CODE":I
    ...
    .line 967
    const-string v9, "Failed: No Connectivity"

    .line 968
    sget-object v6, Lcom/facebook/appevents/AppEventsLogger$FlushResult;->NO_CONNECTIVITY:Lcom/facebook/appevents/AppEventsLogger$FlushResult;

    .line 977
    .end local v2    # "NO_CONNECTIVITY_ERROR_CODE":I
    :cond_0
    :goto_0
    ...
    .line 982
    .local v4, "eventsJsonString":Ljava/lang/String;
    :try_start_0
    ...
    invoke-virtual {v7, v10}, Lorg/json/JSONArray;->toString(I)Ljava/lang/String;
    :try_end_0
    ...
    .local v8, "prettyPrintedEvents":Ljava/lang/String;
    :goto_1
    sget-object v11, Lcom/facebook/LoggingBehavior;->APP_EVENTS:Lcom/facebook/LoggingBehavior;

    sget-object v12, Lcom/facebook/appevents/AppEventsLogger;->TAG:Ljava/lang/String;

    const-string v13, "Flush completed\nParams: %s\n  Result: %s\n  Events JSON: %s"
    ...
    .line 988
    invoke-static {v11, v12, v13, v14}, Lcom/facebook/internal/Logger;->log(Lcom/facebook/LoggingBehavior;Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    .line 995
    .end local v4    # "eventsJsonString":Ljava/lang/String;
    .end local v8    # "prettyPrintedEvents":Ljava/lang/String;
    :cond_1
    if-eqz v3, :cond_7
    ...
    invoke-virtual {v0, v10}, Lcom/facebook/appevents/AppEventsLogger$SessionEventsState;->clearInFlightAndStats(Z)V
    ...
    .line 1003
    sget-object v10, Lcom/facebook/appevents/AppEventsLogger;->applicationContext:Landroid/content/Context;

    move-object/from16 v0, p0

    move-object/from16 v1, p3

    invoke-static {v10, v0, v1}, Lcom/facebook/appevents/AppEventsLogger$PersistedEvents;->persistEvents(Landroid/content/Context;Lcom/facebook/appevents/AppEventsLogger$AccessTokenAppIdPair;Lcom/facebook/appevents/AppEventsLogger$SessionEventsState;)V

    .line 1006
    :cond_2
    sget-object v10, Lcom/facebook/appevents/AppEventsLogger$FlushResult;->SUCCESS:Lcom/facebook/appevents/AppEventsLogger$FlushResult;
    ...
    iget-object v10, v0, Lcom/facebook/appevents/AppEventsLogger$FlushStatistics;->result:Lcom/facebook/appevents/AppEventsLogger$FlushResult;

    sget-object v11, Lcom/facebook/appevents/AppEventsLogger$FlushResult;->NO_CONNECTIVITY:Lcom/facebook/appevents/AppEventsLogger$FlushResult;
    ...
    iput-object v6, v0, Lcom/facebook/appevents/AppEventsLogger$FlushStatistics;->result:Lcom/facebook/appevents/AppEventsLogger$FlushResult;
    ...
    .line 970
    .restart local v2    # "NO_CONNECTIVITY_ERROR_CODE":I
    :cond_4
    ...
    .line 973
    sget-object v6, Lcom/facebook/appevents/AppEventsLogger$FlushResult;->SERVER_ERROR:Lcom/facebook/appevents/AppEventsLogger$FlushResult;

    goto :goto_0

    .line 983
    .end local v2    # "NO_CONNECTIVITY_ERROR_CODE":I
    .restart local v4    # "eventsJsonString":Ljava/lang/String;
    ...
    .end local v7    # "jsonArray":Lorg/json/JSONArray;
    invoke-static {v7, v10}, Lcom/newrelic/agent/android/instrumentation/JSONArrayInstrumentation;->toString(Lorg/json/JSONArray;I)Ljava/lang/String;
    :try_end_1
    ...
    .line 985
    .local v5, "exc":Lorg/json/JSONException;
    const-string v8, "<Can\'t encode events for debug logging>"

    .restart local v8    # "prettyPrintedEvents":Ljava/lang/String;
    goto :goto_1

    .line 990
    .end local v5    # "exc":Lorg/json/JSONException;
    :cond_6
