...
.method private validateColumnsPresent(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    .prologue
    .line 692
    const-string v6, "SELECT * FROM hits2 WHERE 0"

    const/4 v7, 0x0

    instance-of v5, p1, Landroid/database/sqlite/SQLiteDatabase;
    ...
    .end local v2    # "columns":Ljava/util/Set;, "Ljava/util/Set<Ljava/lang/String;>;"
    .end local v3    # "i":I
    :cond_0
    move-object v5, p1
    ...
    invoke-static {v5, v6, v7}, Lcom/newrelic/agent/android/instrumentation/SQLiteInstrumentation;->rawQuery(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;[Ljava/lang/String;)Landroid/database/Cursor;
    ...
    .restart local v2    # "columns":Ljava/util/Set;, "Ljava/util/Set<Ljava/lang/String;>;"
    ...
    .end local p1    # "db":Landroid/database/sqlite/SQLiteDatabase;
    invoke-static {p1, v5}, Lcom/newrelic/agent/android/instrumentation/SQLiteInstrumentation;->execSQL(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)V
