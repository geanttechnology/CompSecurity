...
.method private writeHitToDatabase(Ljava/util/Map;JLjava/lang/String;)V
    ...
    .end local v3    # "db":Landroid/database/sqlite/SQLiteDatabase;
    invoke-static {v3, v5, v6, v2}, Lcom/newrelic/agent/android/instrumentation/SQLiteInstrumentation;->insert(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Ljava/lang/String;Landroid/content/ContentValues;)J
    :try_end_2
...
.method public clearHits(J)V
    ...
    .end local v0    # "db":Landroid/database/sqlite/SQLiteDatabase;
    invoke-static {v0, v4, v6, v6}, Lcom/newrelic/agent/android/instrumentation/SQLiteInstrumentation;->delete(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    .end local v0    # "db":Landroid/database/sqlite/SQLiteDatabase;
    invoke-static {v0, v4, v5, v1}, Lcom/newrelic/agent/android/instrumentation/SQLiteInstrumentation;->delete(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)I
...
.method public peekHits(I)Ljava/util/List;
    ...
    .line 316
    .local v25, "hits":Ljava/util/List;, "Ljava/util/List<Lcom/google/analytics/tracking/android/Hit;>;"
    ...
    .line 339
    .end local v25    # "hits":Ljava/util/List;, "Ljava/util/List<Lcom/google/analytics/tracking/android/Hit;>;"
    .local v26, "hits":Ljava/util/List;, "Ljava/util/List<Lcom/google/analytics/tracking/android/Hit;>;"
    :try_start_1
    ...
    .end local v26    # "hits":Ljava/util/List;, "Ljava/util/List<Lcom/google/analytics/tracking/android/Hit;>;"
    .restart local v25    # "hits":Ljava/util/List;, "Ljava/util/List<Lcom/google/analytics/tracking/android/Hit;>;"
    goto/16 :goto_0
    ...
    .restart local v26    # "hits":Ljava/util/List;, "Ljava/util/List<Lcom/google/analytics/tracking/android/Hit;>;"
    :cond_a
    :try_start_5
    move-object v0, v2
    ...
    .line 393
    .local v28, "partialHits":Ljava/util/List;, "Ljava/util/List<Lcom/google/analytics/tracking/android/Hit;>;"
    const/16 v24, 0x0
    ...
    .end local v28    # "partialHits":Ljava/util/List;, "Ljava/util/List<Lcom/google/analytics/tracking/android/Hit;>;"
    :catchall_1
    move-exception v3
