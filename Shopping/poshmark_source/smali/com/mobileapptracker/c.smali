...
.method public static a(Landroid/content/Context;Z)V
    ...
    const-string v2, "com.facebook.AppEventsLogger"
    ...
    const-string v2, "com.facebook.Settings"

    invoke-static {v2}, Ljava/lang/Class;->forName(Ljava/lang/String;)Ljava/lang/Class;

    move-result-object v2

    const-string v4, "setLimitEventAndDataUsage"
    ...
    const-string v1, "com.facebook.AppEventsLogger"
...
.method public static a(Lcom/mobileapptracker/MATEvent;)V
    ...
    invoke-virtual {v4}, Lcom/mobileapptracker/MATParameters;->getEventContentId()Ljava/lang/String;
    ...
    invoke-virtual {v4}, Lcom/mobileapptracker/MATParameters;->getEventContentType()Ljava/lang/String;

    move-result-object v7

    invoke-static {v5, v6, v7}, Lcom/mobileapptracker/c;->a(Landroid/os/Bundle;Ljava/lang/String;Ljava/lang/String;)V

    const-string v6, "fb_search_string"

    invoke-virtual {v4}, Lcom/mobileapptracker/MATParameters;->getEventSearchString()Ljava/lang/String;

    move-result-object v7

    invoke-static {v5, v6, v7}, Lcom/mobileapptracker/c;->a(Landroid/os/Bundle;Ljava/lang/String;Ljava/lang/String;)V

    const-string v6, "fb_num_items"

    invoke-virtual {v4}, Lcom/mobileapptracker/MATParameters;->getEventQuantity()Ljava/lang/String;

    move-result-object v7

    invoke-static {v5, v6, v7}, Lcom/mobileapptracker/c;->a(Landroid/os/Bundle;Ljava/lang/String;Ljava/lang/String;)V

    const-string v6, "fb_level"

    invoke-virtual {v4}, Lcom/mobileapptracker/MATParameters;->getEventLevel()Ljava/lang/String;

    move-result-object v7

    invoke-static {v5, v6, v7}, Lcom/mobileapptracker/c;->a(Landroid/os/Bundle;Ljava/lang/String;Ljava/lang/String;)V

    const-string v6, "tune_referral_source"
    ...
    const-string v4, "tune_source_sdk"

    const-string v6, "TUNE-MAT"
    ...
    :try_start_2
    invoke-virtual {v4}, Lcom/mobileapptracker/MATParameters;->getEventRating()Ljava/lang/String;
    ...
    :cond_7
    :try_start_3
    const-string v6, "tutorial_complete"
    ...
    :cond_a
    const-string v6, "checkout_initiated"
    ...
    :cond_d
    const-string v6, "level_achieved"
    ...
    :cond_e
    const-string v6, "achievement_unlocked"
