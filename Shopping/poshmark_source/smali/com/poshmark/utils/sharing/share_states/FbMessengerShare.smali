.class public Lcom/poshmark/utils/sharing/share_states/FbMessengerShare;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/poshmark/utils/sharing/share_states/FbMessengerShare;->id:Ljava/util/UUID;
...
.method public constructor <init>(Lcom/poshmark/utils/sharing/StateCompletionListener;Lcom/poshmark/utils/ShareManager;)V
    ...
    .line 85
    new-instance v0, Lcom/poshmark/utils/sharing/share_states/FbMessengerShare$1;

    invoke-direct {v0, p0}, Lcom/poshmark/utils/sharing/share_states/FbMessengerShare$1;-><init>(Lcom/poshmark/utils/sharing/share_states/FbMessengerShare;)V

    iput-object v0, p0, Lcom/poshmark/utils/sharing/share_states/FbMessengerShare;->fbDialogCallback:Lcom/facebook/FacebookCallback;
    ...
    iput-object v0, p0, Lcom/poshmark/utils/sharing/share_states/FbMessengerShare;->callbackManager:Lcom/facebook/CallbackManager;
...
.method public executeState()V
    ...
    .prologue
    .line 40
    iget-object v10, p0, Lcom/poshmark/utils/sharing/share_states/FbMessengerShare;->shareManager:Lcom/poshmark/utils/ShareManager;
    ...
    .line 41
    .local v7, "pmContent":Lcom/poshmark/utils/sharing/PMShareContent;
    invoke-virtual {v7}, Lcom/poshmark/utils/sharing/PMShareContent;->getShareTitle()Ljava/lang/String;

    move-result-object v9

    .line 42
    .local v9, "title":Ljava/lang/String;
    invoke-virtual {v7}, Lcom/poshmark/utils/sharing/PMShareContent;->getShareDescription()Ljava/lang/String;

    move-result-object v1

    .line 43
    .local v1, "description":Ljava/lang/String;
    invoke-virtual {v7}, Lcom/poshmark/utils/sharing/PMShareContent;->getShareUrl()Ljava/lang/String;

    move-result-object v2

    .line 44
    .local v2, "link":Ljava/lang/String;
    invoke-virtual {v7}, Lcom/poshmark/utils/sharing/PMShareContent;->getShareMessage()Ljava/lang/String;

    move-result-object v4

    .line 45
    .local v4, "message":Ljava/lang/String;
    invoke-virtual {v7}, Lcom/poshmark/utils/sharing/PMShareContent;->getPlaceHolderString()Ljava/lang/String;

    move-result-object v6

    .line 46
    .local v6, "placeholderTxt":Ljava/lang/String;
    invoke-virtual {v7}, Lcom/poshmark/utils/sharing/PMShareContent;->getSubject()Ljava/lang/String;

    move-result-object v8

    .line 47
    .local v8, "subject":Ljava/lang/String;
    invoke-virtual {v7}, Lcom/poshmark/utils/sharing/PMShareContent;->getBody()Ljava/lang/String;

    move-result-object v0

    .line 51
    .local v0, "body":Ljava/lang/String;
    new-instance v5, Lcom/facebook/share/widget/MessageDialog;
    ...
    invoke-direct {v5, v10}, Lcom/facebook/share/widget/MessageDialog;-><init>(Landroid/support/v4/app/Fragment;)V

    .line 52
    .local v5, "messenger":Lcom/facebook/share/widget/MessageDialog;
    iget-object v10, p0, Lcom/poshmark/utils/sharing/share_states/FbMessengerShare;->callbackManager:Lcom/facebook/CallbackManager;

    iget-object v11, p0, Lcom/poshmark/utils/sharing/share_states/FbMessengerShare;->fbDialogCallback:Lcom/facebook/FacebookCallback;

    invoke-virtual {v5, v10, v11}, Lcom/facebook/share/widget/MessageDialog;->registerCallback(Lcom/facebook/CallbackManager;Lcom/facebook/FacebookCallback;)V

    .line 54
    const-class v10, Lcom/facebook/share/model/ShareLinkContent;

    invoke-static {v10}, Lcom/facebook/share/widget/MessageDialog;->canShow(Ljava/lang/Class;)Z
    ...
    invoke-virtual {v5, v3}, Lcom/facebook/share/widget/MessageDialog;->show(Ljava/lang/Object;)V
...
.method public getId()Ljava/util/UUID;
    ...
    .prologue
    .line 36
    sget-object v0, Lcom/poshmark/utils/sharing/share_states/FbMessengerShare;->id:Ljava/util/UUID;
...
.method public handleNotification(Landroid/content/Intent;)V
    ...
    .line 78
    iget-object v5, p0, Lcom/poshmark/utils/sharing/share_states/FbMessengerShare;->callbackManager:Lcom/facebook/CallbackManager;
