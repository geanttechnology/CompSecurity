...
_L3:
    ...
    public NavigationResult navigate(Context context)
    {
        ...
        do
        {
            ...
            ((Intent) (obj)).putExtra("al_applink_data", bundle);
        } while (((PackageManager) (obj2)).resolveActivity(((Intent) (obj)), 0x10000) == null);
        obj1 = null;
        obj2 = NavigationResult.FAILED;
        if (obj == null) goto _L2; else goto _L1
_L1:
        obj2 = NavigationResult.APP;
        obj1 = obj;
_L4:
        sendAppLinkNavigateEventBroadcast(context, ((Intent) (obj1)), ((NavigationResult) (obj2)), null);
        if (obj1 != null)
        {
            context.startActivity(((Intent) (obj1)));
        }
        return ((NavigationResult) (obj2));
_L2:
        ...
        if (uri != null)
        {
            try
            {
                obj2 = getJSONForBundle(bundle);
            }
            catch (JSONException jsonexception)
            {
                sendAppLinkNavigateEventBroadcast(context, ((Intent) (obj)), NavigationResult.FAILED, jsonexception);
            ...
            {
                obj = JSONObjectInstrumentation.toString((JSONObject)obj2);
            }
            obj1 = new Intent("android.intent.action.VIEW", ((android.net.Uri.Builder) (obj1)).appendQueryParameter("al_applink_data", ((String) (obj))).build());
            obj2 = NavigationResult.WEB;
        }
        if (true) goto _L4; else goto _L3
_L3:
    }
