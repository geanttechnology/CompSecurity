...
//            DefaultRetryPolicy, InternalUtils, RequestQueue, AuthFailureError, 
    ...
    implements Comparable
{
    ...
    private static String createIdentifier(int i, String s)
    {
        ...
        long l = sCounter;
        sCounter = 1L + l;
        return InternalUtils.sha1Hash(s.append(l).toString());
    }
...
label0:
    ...
    {
        return (new StringBuilder()).append(mMethod).append(":").append(mUrl).toString();
    }
