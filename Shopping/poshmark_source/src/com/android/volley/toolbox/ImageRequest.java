...
public class ImageRequest extends Request
{
    ...
    private Response doParse(NetworkResponse networkresponse)
    {
        ...
        if (mMaxWidth == 0 && mMaxHeight == 0)
        {
            ...
            obj = BitmapFactoryInstrumentation.decodeByteArray(((byte []) (obj)), 0, obj.length, options);
        } else
        {
            options.inJustDecodeBounds = true;
            BitmapFactoryInstrumentation.decodeByteArray(((byte []) (obj)), 0, obj.length, options);
