...
public class Hex
{
    ...
    public static byte[] decode(String s)
    {
        ...
        {
            throw new RuntimeException((new StringBuilder()).append("exception decoding Hex string: ").append(s).toString());
        }
    ...
    public static byte[] decode(byte abyte0[])
    {
        ...
        {
            throw new RuntimeException((new StringBuilder()).append("exception decoding Hex string: ").append(abyte0).toString());
        }
        return bytearrayoutputstream.toByteArray();
    }
    ...
    public static byte[] encode(byte abyte0[], int i, int j)
    {
        ...
        {
            throw new RuntimeException((new StringBuilder()).append("exception encoding Hex string: ").append(abyte0).toString());
        }
        return bytearrayoutputstream.toByteArray();
    }
