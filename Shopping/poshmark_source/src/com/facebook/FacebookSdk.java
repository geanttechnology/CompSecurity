...
public final class FacebookSdk
{
    ...
    static GraphResponse publishInstallAndWaitForResponse(Context context, String s)
    {
        ...
        Object obj1;
        long l;
        obj1 = AttributionIdentifiers.getAttributionIdentifiers(context);
        ...
        context = AppEventsLoggerUtility.getJSONObjectForGraphAPICall(com.facebook.internal.AppEventsLoggerUtility.GraphAPIActivityType.MOBILE_INSTALL_EVENT, ((AttributionIdentifiers) (obj1)), AppEventsLogger.getAnonymousAppDeviceGUID(context), getLimitEventAndDataUsage(context), context);
        obj1 = GraphRequest.newPostRequest(null, String.format("%s/activities", new Object[] {
            s
        }), context, null);
...
_L1:
        ...
        context = JSONObjectInstrumentation.init(((String) (obj)));
_L9:
        if (context != null)
        {
...
_L2:
        s = ((GraphRequest) (obj1)).executeAndWait();
        obj = sharedpreferences.edit();
        ((android.content.SharedPreferences.Editor) (obj)).putLong(s2, System.currentTimeMillis());
        if (s.getJSONObject() == null) goto _L4; else goto _L3
_L3:
        context = s.getJSONObject();
        if (context instanceof JSONObject) goto _L6; else goto _L5
_L5:
