...
_L5:
    ...
    private AccessToken getAccessTokenForUser(List list, Mode mode, String s)
    {
        ...
        {
            list = createTestAccount(list1, mode, s);
        } else
        {
            list = findOrCreateSharedTestAccount(list1, mode, s);
        }
        return new AccessToken(list.optString("access_token"), testApplicationId, list.optString("id"), list1, null, AccessTokenSource.TEST_USER, null, null);
    }
