...
public class AppEventsLogger
{
        ...
        implements Serializable
    {
        ...
        private Object writeReplace()
        {
            ...
            return new SerializationProxyV1(((String) (obj)), isImplicit);
        }
...
_L2:
            if (isImplicit) goto _L5; else goto _L6
_L6:
            s1 = LoggingBehavior.APP_EVENTS;
            s = jsonObject;
            ...
            s = s.toString();
_L8:
            Logger.log(s1, "AppEvents", "Created app event '%s'", new Object[] {
                s
            });
            return;
...
_L1:
    ...
    private static void handleResponse(AccessTokenAppIdPair accesstokenappidpair, GraphRequest graphrequest, GraphResponse graphresponse, SessionEventsState sessioneventsstate, FlushStatistics flushstatistics)
    {
        ...
        if (!FacebookSdk.isLoggingBehaviorEnabled(LoggingBehavior.APP_EVENTS)) goto _L2; else goto _L1
_L1:
        graphresponse = (String)graphrequest.getTag();
        graphresponse = JSONArrayInstrumentation.init(graphresponse);
        if (graphresponse instanceof JSONArray)
        {
            break MISSING_BLOCK_LABEL_221;
        }
        graphresponse = graphresponse.toString(2);
_L3:
        loggingbehavior = LoggingBehavior.APP_EVENTS;
        s1 = TAG;
        graphrequest = graphrequest.getGraphObject();
...
_L2:
        ...
        try
        {
            graphresponse = JSONArrayInstrumentation.toString((JSONArray)graphresponse, 2);
        }
        // Misplaced declaration of an exception variable
