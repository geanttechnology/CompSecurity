...
_L7:
        obj = obj2;
        obj1 = obj2;
        int k = ((Cursor) (obj2)).getColumnIndex("aid");
        obj = obj2;
        obj1 = obj2;
        int j = ((Cursor) (obj2)).getColumnIndex("androidid");
        obj = obj2;
        obj1 = obj2;
        int i = ((Cursor) (obj2)).getColumnIndex("limit_tracking");
        obj = obj2;
        obj1 = obj2;
        attributionidentifiers.attributionId = ((Cursor) (obj2)).getString(k);
        if (j <= 0 || i <= 0)
        {
        ...
        obj = obj2;
        obj1 = obj2;
        attributionidentifiers.limitTracking = Boolean.parseBoolean(((Cursor) (obj2)).getString(i));
        if (obj2 != null)
        {
            ((Cursor) (obj2)).close();
        }
