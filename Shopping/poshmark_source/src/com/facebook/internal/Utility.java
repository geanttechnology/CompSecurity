...
_L3:
    ...
    public static void loadAppSettingsAsync(Context context, String s)
    {
        ...
        if (isNullOrEmpty(s) || fetchedAppSettings.containsKey(s) || !flag)
        {
            return;
        } else
        {
            ...
            FacebookSdk.getExecutor().execute(new Runnable(context, s1, s) {
                ...
                public void run()
                {
                    Object obj1;
                    Object obj2;
                    obj2 = context.getSharedPreferences("com.facebook.internal.preferences.APP_SETTINGS", 0);
                    obj1 = ((SharedPreferences) (obj2)).getString(settingsKey, null);
                    if (Utility.isNullOrEmpty(((String) (obj1)))) goto _L2; else goto _L1
_L1:
...
_L2:
                    Object obj = Utility.getAppSettingsQueryResponse(applicationId);
                    if (obj != null)
                    {
                        Utility.parseAppSettingsFromJSON(applicationId, ((JSONObject) (obj)));
                        android.content.SharedPreferences.Editor editor = ((SharedPreferences) (obj2)).edit();
                        obj2 = settingsKey;
                        ...
                        editor.putString(((String) (obj2)), ((String) (obj))).apply();
                    }
                    Utility.loadingSettings.set(false);
                    return;
                    jsonexception;
                    Utility.logd("FacebookSDK", jsonexception);
