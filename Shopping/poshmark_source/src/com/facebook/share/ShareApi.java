...
_L1:
        JSONArray jsonarray = JSONArrayInstrumentation.init(s);
        int i = 0;
_L11:
...
_L6:
        ...
        bundle.putString(String.format(Locale.ROOT, "image[%d][url]", new Object[] {
          ...
          goto _L7
_L9:
        putImageInBundleWithArrayFormat(bundle, 0, JSONObjectInstrumentation.init(s));
        bundle.remove("image");
_L2:
        return;
_L4:
        ...
        } else
        {
            ...
            
            {
                ...
                public void onComplete()
                {
                    ...
                    obj1 = new Bundle();
                    ((Bundle) (obj1)).putString("object", ((String) (obj)));
                    try
                    {
                        (new GraphRequest(AccessToken.getCurrentAccessToken(), getGraphPath((new StringBuilder()).append("objects/").append(URLEncoder.encode(ogType, "UTF-8")).toString()), ((Bundle) (obj1)), HttpMethod.POST, requestCallback)).executeAsync();
                        return;
                    }
                    catch (UnsupportedEncodingException unsupportedencodingexception)
                    {
                        obj1 = unsupportedencodingexception.getLocalizedMessage();
                    }
