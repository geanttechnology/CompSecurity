    ...
    private void logAppEventForError(String s, FacebookRequestError facebookrequesterror)
    {
        ...
        if (facebookrequesterror != null)
        {
            ...
            if (facebookrequesterror != null)
            {
                ...
                {
                    facebookrequesterror = facebookrequesterror.toString();
                } else
                {
                    facebookrequesterror = JSONObjectInstrumentation.toString((JSONObject)facebookrequesterror);
                }
                bundle.putString("error", facebookrequesterror);
            }
        }
