...
public class WebDialogParameters
{
    ...
    public static Bundle create(AppGroupCreationContent appgroupcreationcontent)
    {
        ...
        {
            Utility.putNonEmptyString(bundle, "privacy", appgroupcreationcontent.toString().toLowerCase(Locale.ENGLISH));
        }
        return bundle;
    }
...
_L1:
        Utility.putNonEmptyString(bundle, "action_properties", shareopengraphcontent);
        return bundle;
