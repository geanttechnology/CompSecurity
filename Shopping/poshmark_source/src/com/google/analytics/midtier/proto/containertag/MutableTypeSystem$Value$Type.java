    ...
    implements com.google.tagmanager.protobuf.ystem.Value.Type
{
    ...
    private static com.google.tagmanager.protobuf.ystem.Value.Type internalValueMap = new com.google.tagmanager.protobuf.Internal.EnumLiteMap() {
        ...
        public MutableTypeSystem.Value.Type findValueByNumber(int i)
        {
            return MutableTypeSystem.Value.Type.valueOf(i);
        }
    ...
    {
        return (BOOLEAN)Enum.valueOf(com/google/analytics/midtier/proto/containertag/MutableTypeSystem$Value$Type, s);
    }
