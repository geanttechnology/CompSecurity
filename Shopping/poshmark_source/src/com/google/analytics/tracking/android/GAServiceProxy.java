...
_L4:
        ...
        for (; !queue.isEmpty(); store.putHit(hitparams.getWireFormatParams(), hitparams.getHitTimeInMilliseconds(), hitparams.getPath(), hitparams.getCommands()))
        {
            ...
            Log.v((new StringBuilder()).append("Sending hit to store  ").append(hitparams).toString());
        }
...
_L9:
        ...
        hitparams1 = (HitParams)queue.peek();
        Log.v((new StringBuilder()).append("Sending hit to service   ").append(hitparams1).toString());
