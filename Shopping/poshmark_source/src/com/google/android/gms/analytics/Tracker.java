...
public class Tracker
{
        ...
        implements GoogleAnalytics.a
    {
        ...
        public void f(Activity activity)
        {
            ...
            if (uB)
            {
                ...
                {
                    activity = Tracker.c(uG).h(activity);
                } else
                {
        ...
        public a()
        {
            ...
            uD = -1L;
            uE = false;
            rJ = new _cls1(this, Tracker.this);
        }
    }
    ...
    void a(Context context, aj aj1)
    {
        ...
        if (ux.cB())
        {
            aj1 = ux.cC();
            set("&tid", aj1);
            aa.v((new StringBuilder()).append("[Tracker] trackingId loaded: ").append(aj1).toString());
        }
        if (ux.cD())
        {
            aj1 = Double.toString(ux.cE());
            set("&sf", aj1);
            aa.v((new StringBuilder()).append("[Tracker] sample frequency loaded: ").append(aj1).toString());
        }
        if (ux.cF())
        {
    ...
    public void send(Map map)
    {
        ...
        if (!map.equals("transaction") && !map.equals("item") && !ur.cl())
        {
