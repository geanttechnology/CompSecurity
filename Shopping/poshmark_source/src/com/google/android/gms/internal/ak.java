...
public final class ak
{
    ...
    public ak(ViewGroup viewgroup, AttributeSet attributeset, boolean flag)
    {
        ...
        try
        {
            ...
            lr = attributeset.c(flag);
            ls = attributeset.getAdUnitId();
        }
        // Misplaced declaration of an exception variable
        catch (AttributeSet attributeset)
        {
            cz.a(viewgroup, new ab(context, AdSize.BANNER), attributeset.getMessage(), attributeset.getMessage());
            return;
        }
    ...
    public transient void a(AdSize aadsize[])
    {
        ...
        {
            da.b("Failed to set the ad size.", aadsize);
        }
        lH.requestLayout();
    }
