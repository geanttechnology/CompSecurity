...
public final class cj
{
    ...
    public static cf a(Context context, cd cd1, String s)
    {
        ...
        try
        {
            obj4 = JSONObjectInstrumentation.init(s);
...
_L2:
        ...
        {
            cd1 = cv.m(location);
            if (!(cd1 instanceof JSONObject))
            {
                cd1 = cd1.toString(2);
            } else
            {
                cd1 = JSONObjectInstrumentation.toString((JSONObject)cd1, 2);
            }
        ...
        cd1 = JSONObjectInstrumentation.toString((JSONObject)cd1);
        return cd1;
        cd1;
