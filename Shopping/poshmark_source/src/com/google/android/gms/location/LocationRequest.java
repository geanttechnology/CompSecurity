    ...
    implements SafeParcelable
{
    ...
    public boolean equals(Object obj)
    {
        if (this != obj)
        {
            ...
            if (mPriority != ((LocationRequest) (obj)).mPriority || Lc != ((LocationRequest) (obj)).Lc || Ld != ((LocationRequest) (obj)).Ld || Le != ((LocationRequest) (obj)).Le || KV != ((LocationRequest) (obj)).KV || Lf != ((LocationRequest) (obj)).Lf || Lg != ((LocationRequest) (obj)).Lg)
            {
                return false;
            }
        }
    ...
    public int hashCode()
    {
        return ep.hashCode(new Object[] {
            Integer.valueOf(mPriority), Long.valueOf(Lc), Long.valueOf(Ld), Boolean.valueOf(Le), Long.valueOf(KV), Integer.valueOf(Lf), Float.valueOf(Lg)
        });
    }
