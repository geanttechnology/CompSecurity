...
public final class PlusOneButton extends FrameLayout
{
        ...
        implements android.view.View.OnClickListener, OnPlusOneClickListener
    {
        ...
        {
            view = (Intent)PlusOneButton.a(Ra).getTag();
            if (QZ != null)
            {
                QZ.onPlusOneClick(view);
                return;
            } else
            {
                onPlusOneClick(view);
    ...
    {
        byte byte0 = 0;
        context = eu.a("http://schemas.android.com/apk/lib/com.google.android.gms.plus", "annotation", context, attributeset, true, false, "PlusOneButton");
    ...
    {
        context = eu.a("http://schemas.android.com/apk/lib/com.google.android.gms.plus", "size", context, attributeset, true, false, "PlusOneButton");
