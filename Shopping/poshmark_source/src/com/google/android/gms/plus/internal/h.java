    ...
    implements SafeParcelable
{
    ...
    public boolean equals(Object obj)
    {
        if (obj instanceof h)
        {
            if (wj == ((h) (obj = (h)obj)).wj && ep.equal(vi, ((h) (obj)).vi) && Arrays.equals(Rm, ((h) (obj)).Rm) && Arrays.equals(Rn, ((h) (obj)).Rn) && Arrays.equals(Ro, ((h) (obj)).Ro) && ep.equal(Rp, ((h) (obj)).Rp) && ep.equal(Rq, ((h) (obj)).Rq) && ep.equal(Rr, ((h) (obj)).Rr) && ep.equal(Rs, ((h) (obj)).Rs) && ep.equal(Rt, ((h) (obj)).Rt))
            {
                return true;
            }
        }
    ...
    public int hashCode()
    {
        return ep.hashCode(new Object[] {
            Integer.valueOf(wj), vi, Rm, Rn, Ro, Rp, Rq, Rr, Rs, Rt
        });
    }
