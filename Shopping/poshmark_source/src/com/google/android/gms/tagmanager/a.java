...
class com.google.android.gms.tagmanager.a
{
    ...
    private a Tz = new a() {
        ...
        public com.google.android.gms.ads.identifier.AdvertisingIdClient.Info ix()
        {
            ...
            {
                TB = com.google.android.gms.tagmanager.a.this;
                super();
            }
    };
    ...
    com.google.android.gms.tagmanager.a(Context context, a a1, fl fl1)
    {
        Tv = 0xdbba0L;
        Tw = 30000L;
        mClosed = false;
    ...
    static com.google.android.gms.tagmanager.a E(Context context)
    {
        if (TA == null)
        {
            synchronized (qI)
            {
                if (TA == null)
                {
                    TA = new com.google.android.gms.tagmanager.a(context);
                    TA.start();
                }
            }
        }
