...
class ServiceManagerImpl extends ServiceManager
{
        ...
        handler = new Handler(ctx.getMainLooper(), new android.os.Handler.Callback() {
            ...
            public boolean handleMessage(Message message)
            {
                if (1 == message.what && ServiceManagerImpl.MSG_OBJECT.equals(message.obj))
                {
                    ...
                    {
                        handler.sendMessageDelayed(handler.obtainMessage(1, ServiceManagerImpl.MSG_OBJECT), dispatchPeriodInSeconds * 1000);
                    }
                }
                return true;
            }
    ...
    public void dispatch()
    {
        ...
        if (readyToDispatch) goto _L2; else goto _L1
_L1:
...
_L2:
        ...
        Log.v(stringbuilder.append(((String) (obj))).toString());
        storeIsEmpty = flag;
        connected = flag1;
