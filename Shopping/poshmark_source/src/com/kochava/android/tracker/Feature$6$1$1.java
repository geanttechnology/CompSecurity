...
//            KochavaWebAdView, Feature, Global
    ...
    implements android.view.stener
{
    ...
    public boolean onTouch(View view, MotionEvent motionevent)
    {
        ...
        {
            view = new Intent(val$context, com/kochava/android/tracker/KochavaWebAdView);
            motionevent = new Bundle();
            motionevent.putString("URL", val$clickUrl);
            view.putExtras(motionevent);
            val$context.startActivity(view);
            if (val$context.getResources().getIdentifier("kochava_slide_up", "anim", val$context.getPackageName()) != 0)
            {
                val$context.overridePendingTransition(val$context.getResources().getIdentifier("kochava_slide_up", "anim", val$context.getPackageName()), val$context.getResources().getIdentifier("kochava_stay", "anim", val$context.getPackageName()));
            } else
            {
                val$context.overridePendingTransition(0x10a0002, 0x10a0001);
            }
        }
        return true;
    }
...
_L9:
    ...
    // Unreferenced inner class com/kochava/android/tracker/Feature$6$1

/* anonymous class */
    class Feature._cls6._cls1 extends Thread
    {

        final Feature._cls6 this$1;
        private final WebView val$adWebview;
        private final String val$clickUrl;
        private final Activity val$context;
        ...
        public void run()
        {
            ...
            adWebview.setOnTouchListener(clickUrl. new Feature._cls6._cls1._cls1());
