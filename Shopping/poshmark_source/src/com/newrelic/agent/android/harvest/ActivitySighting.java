...
public class ActivitySighting extends HarvestableArray
{
    ...
    public JsonArray asJsonArray()
    {
        ...
        jsonarray.add(SafeJsonPrimitive.factory(name));
        jsonarray.add(SafeJsonPrimitive.factory(Long.valueOf(timestampMs)));
        jsonarray.add(SafeJsonPrimitive.factory(Long.valueOf(durationMs)));
        this;
