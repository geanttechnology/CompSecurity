...
public class Harvest
{
    ...
    public static void addHttpError(HttpError httperror)
    {
        ...
        } else
        {
            ...
            log.verbose((new StringBuilder()).append("Harvest: ").append(instance).append(" now contains ").append(httperrors.count()).append(" errors.").toString());
            return;
        }
    }
    ...
    public static void harvestNow()
    {
        ...
        {
            long l = getMillisecondsSinceSessionStart();
            StatsEngine.get().sampleTimeMs("Session/Duration", l);
            log.debug((new StringBuilder()).append("Harvest.harvestNow - Generating sessionDuration attribute with value ").append(l).toString());
            AnalyticsControllerImpl analyticscontrollerimpl = AnalyticsControllerImpl.getInstance();
            analyticscontrollerimpl.setAttribute("sessionDuration", l, false);
