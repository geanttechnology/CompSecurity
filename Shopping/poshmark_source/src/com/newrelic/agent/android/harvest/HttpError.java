...
public class HttpError extends HarvestableArray
{
    ...
    public JsonArray asJsonArray()
    {
        ...
        jsonarray.add(SafeJsonPrimitive.factory(Integer.valueOf(httpStatusCode)));
        jsonarray.add(SafeJsonPrimitive.factory(Long.valueOf(count)));
        Object obj = "";
        ...
        jsonarray.add(SafeJsonPrimitive.factory(Agent.getEncoder().encode(((String) (obj)).getBytes())));
        jsonarray.add(SafeJsonPrimitive.factory(optional(stackTrace)));
        obj = new JsonObject();
        if (params == null)
        {
        ...
        jsonarray.add(SafeJsonPrimitive.factory(optional(appData)));
        return jsonarray;
    }
