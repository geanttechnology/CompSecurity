...
public class ApplicationInfo extends HarvestableObject
{
    ...
    public JsonObject asJsonObject()
    {
        ...
        jsonobject.add("appName", SafeJsonPrimitive.factory(applicationName));
        jsonobject.add("appVersion", SafeJsonPrimitive.factory(applicationVersion));
        jsonobject.add("appBuild", SafeJsonPrimitive.factory(applicationBuild));
        jsonobject.add("bundleId", SafeJsonPrimitive.factory(bundleId));
        jsonobject.add("processId", SafeJsonPrimitive.factory(Integer.valueOf(processId)));
        return jsonobject;
    }
}
