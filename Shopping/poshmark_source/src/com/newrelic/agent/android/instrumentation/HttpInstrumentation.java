...
public final class HttpInstrumentation
{
    ...
    private static void httpClientError(TransactionState transactionstate, Exception exception)
    {
        if (!transactionstate.isComplete())
        {
            ...
            {
                TaskQueue.queue(new HttpTransactionMeasurement(transactionstate.getUrl(), transactionstate.getHttpMethod(), transactionstate.getStatusCode(), transactionstate.getErrorCode(), transactionstate.getTimestamp(), transactionstate.getTime(), transactionstate.getBytesSent(), transactionstate.getBytesReceived(), transactionstate.getAppData()));
            }
        }
    }
