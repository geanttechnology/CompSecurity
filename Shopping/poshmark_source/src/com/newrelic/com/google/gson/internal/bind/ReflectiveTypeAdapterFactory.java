...
_L3:
        ...
        java.lang.reflect.Type type1 = com.newrelic.com.google.gson.internal..Gson.Types.resolve(typetoken.getType(), class1, ((Field) (obj)).getGenericType());
...
_L5:
        ...
        typetoken = TypeToken.get(com.newrelic.com.google.gson.internal..Gson.Types.resolve(typetoken.getType(), class1, class1.getGenericSuperclass()));
