...
private final class <init>
{
    ...
    {
        return new File(DiskLruCache.access$2000(DiskLruCache.this), (new StringBuilder()).append(key).append(".").append(i).toString());
    }

    public File getDirtyFile(int i)
    {
        return new File(DiskLruCache.access$2000(DiskLruCache.this), (new StringBuilder()).append(key).append(".").append(i).append(".tmp").toString());
    }
...
/*
    static long access$1302( , long l)
    {
        .sequenceNumber = l;
        return l;
    }
...
/*
    static boolean access$702(sequenceNumber sequencenumber, boolean flag)
    {
...
*/
    ...
    ._cls1900(String s, ._cls1900 _pcls1900)
    {
        this(s);
    }
}
