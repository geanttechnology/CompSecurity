...
public class CustomMatrixCursor extends AbstractCursor
{
    ...
    private static int initialCursorCapacity = 16;
    private final int columnCount;
    private final String columnNames[];
    private Object data[];
    private int rowCount;

    public CustomMatrixCursor(String as[])
    {
        this(as, initialCursorCapacity);
    }

    public CustomMatrixCursor(String as[], int i)
    {
        rowCount = 0;
        columnNames = as;
