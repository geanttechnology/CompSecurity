...
public class MyBundles extends PMData
{
    ...
    public void append(PMData pmdata)
    {
        ...
        {
            pmdata = (MyBundles)pmdata;
            data.addAll(((MyBundles) (pmdata)).data);
            more = ((MyBundles) (pmdata)).more;
        }
    }
...
_L1:
    ...
    Integer.valueOf(0), (PMBundle)iterator.next()
})) { }
