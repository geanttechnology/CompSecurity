...
public class ShowroomListings extends PMData
{
    ...
    public void append(PMData pmdata)
    {
        ...
        {
            pmdata = (ShowroomListings)pmdata;
            data.addAll(((ShowroomListings) (pmdata)).data);
            more = ((ShowroomListings) (pmdata)).more;
        }
    }
