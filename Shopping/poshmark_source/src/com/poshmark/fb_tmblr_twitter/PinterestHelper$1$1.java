    ...
    implements PMApiResponseHandler
{
    ...
    public void handleResponse(PMApiResponse pmapiresponse)
    {
        ...
        if (!pmapiresponse.hasError())
        {
            ...
            {
                callingFragment = PinterestHelper.access$000(_fld0);
    ...
    // Unreferenced inner class com/poshmark/fb_tmblr_twitter/PinterestHelper$1

/* anonymous class */
    class PinterestHelper._cls1 extends PDKCallback
    {
        ...
        public void onSuccess(PDKResponse pdkresponse)
        {
            ...
            PMApi.pinterestLink(pdkresponse, StringUtils.join(scopes, ","), new PinterestHelper._cls1._cls1());
        }
