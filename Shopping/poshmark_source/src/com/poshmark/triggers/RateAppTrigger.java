...
public class RateAppTrigger extends PMTrigger
{
        ...
        if (PMApplicationSession.GetPMSession().getUserId() != null)
        {
            ...
            if (savedTriggers != null)
            {
                ...
                if (s1 != null)
                {
                    ...
                    appVersion = savedTriggers.getString((new StringBuilder()).append(s).append("_version").toString(), null);
                }
            }
        }
    }
    ...
    {
        TriggerThresholds triggerthresholds = FeatureManager.getGlobalFeatureManager().getRateAppTriggerFeature();
...
_L6:
    ...
    public void saveTrigger()
    {
        ...
        if (savedTriggers != null)
        {
            ...
            appVersion = AppInfo.getInstance().versionName;
            editor.putString((new StringBuilder()).append(s).append("_version").toString(), appVersion);
            editor.commit();
        }
    }
    ...
    public boolean shouldFireTrigger()
    {
        ...
        if (currentCount >= i)
        {
            return currentState != PMTrigger.TriggerState.INTERACTED || appVersion != null && !appVersion.equals(AppInfo.getInstance().versionName);
        } else
        {
            return false;
        }
