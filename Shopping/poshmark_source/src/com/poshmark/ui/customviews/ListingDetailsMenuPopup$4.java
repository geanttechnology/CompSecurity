...
class this._cls0
    implements android.view.ilsMenuPopup._cls4
{
    ...
    {
        if (listingDetails.getListingStatus() == com.poshmark.data_model.models.inner_models.LD && !PMApplicationSession.GetPMSession().isUserAdmin())
        {
        ...
        } else
        {
            parentFragment.showConfirmationMessage(context.getString(0x7f0600b8), context.getString(0x7f0600b9), new android.content.DialogInterface.OnClickListener() {
                ...
                final ListingDetailsMenuPopup._cls4 this$1;
            ...
            {
                this$1 = ListingDetailsMenuPopup._cls4.this;
                super();
            }
            });
            return;
