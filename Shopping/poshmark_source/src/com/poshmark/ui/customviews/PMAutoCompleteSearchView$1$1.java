...
class val.newText
    implements com.poshmark.utils.rTaskCallback
{
    ...
    // Unreferenced inner class com/poshmark/ui/customviews/PMAutoCompleteSearchView$1

/* anonymous class */
    class PMAutoCompleteSearchView._cls1
        ...
        public Cursor runQuery(CharSequence charsequence)
        {
            ...
            if (s != null)
            {
                ...
                if (s.length() > 0)
                {
                    ...
                    new PMSearchBoxTimer(50, true, s, s. new PMAutoCompleteSearchView._cls1._cls1());
                    return charsequence;
                }
