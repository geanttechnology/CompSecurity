...
class val.input
    implements android.content.gment._cls1._cls1
{
        ...
        implements android.widget.AdapterView.OnItemClickListener
    {
        ...
        public void onItemClick(AdapterView adapterview, View view, int i, long l)
        {
            ...
            } else
            {
                ...
                adapterview.setPositiveButton(getString(0x7f0601e1), view. new BrandsMetaItemListViewFragment._cls1._cls1());
        ...
        // Unreferenced inner class com/poshmark/ui/fragments/BrandsMetaItemListViewFragment$1$2

/* anonymous class */
        class BrandsMetaItemListViewFragment._cls1._cls2
