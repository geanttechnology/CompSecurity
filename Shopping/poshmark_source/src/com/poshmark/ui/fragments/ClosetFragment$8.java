...
label0:
        {
            if (isAdded())
            {
                ...
                ClosetFragment.access$100(ClosetFragment.this).setBlockedFlag(true);
        ...
        showError(new ActionErrorContext(pmapiresponse.apiError, com.poshmark.ui.model.t.ActionContext.BLOCK_USER, getString(0x7f0600d4)));
    }
