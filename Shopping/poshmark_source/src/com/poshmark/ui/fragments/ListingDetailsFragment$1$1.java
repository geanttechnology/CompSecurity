    ...
    implements android.content.ener
{
    ...
    public void onClick(DialogInterface dialoginterface, int i)
    {
        if (i == -1)
        {
            ...
            PMApi.deleteComment(listingId, val$comment.id, new PMApiResponseHandler() {

                final ListingDetailsFragment._cls1._cls1 this$2;
            ...
            {
                this$2 = ListingDetailsFragment._cls1._cls1.this;
                super();
            }
            });
        }
