...
class this._cls0
    implements android.view.sFragment._cls18
{
    ...
    {
        if (listingDetails.getListingStatus() == com.poshmark.data_model.models.inner_models.LD && !PMApplicationSession.GetPMSession().canPerformActionForRole("admin"))
        {
