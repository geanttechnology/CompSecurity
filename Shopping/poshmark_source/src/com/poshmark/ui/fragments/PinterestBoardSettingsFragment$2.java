    ...
    implements android.view.gsFragment._cls2
{
    ...
    public void onClick(View view)
    {
        ...
        case 2131493478: 
            view = new android.app.ngsFragment(getActivity());
            break;
        }
        view.getActivity((new StringBuilder()).append(getString(0x7f0602a6)).append("?").toString());
        view.getString(String.format(getString(0x7f0602aa), new Object[] {
            PMApplicationSession.GetPMSession().getTwitterUsername()
        }));
        view.tton(0x7f06006d, new android.content.DialogInterface.OnClickListener() {
        ...
        view.tton(0x7f0602a6, new android.content.DialogInterface.OnClickListener() {
