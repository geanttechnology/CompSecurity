    ...
    implements ExtServiceConnectInterface
{
    ...
    public void error(PMApiError pmapierror)
    {
        ...
        {
            hideProgressDialog();
            showError(new ActionErrorContext(pmapierror, com.poshmark.ui.model.text.LINK_TUMBLR));
        }
    }
...
/* anonymous class */
        ...
        // Unreferenced inner class com/poshmark/ui/fragments/SharingSettingsFragment$6$2

/* anonymous class */
        class SharingSettingsFragment._cls6._cls2
            implements android.content.DialogInterface.OnClickListener
        {
            ...
            public void onClick(DialogInterface dialoginterface, int i)
            {
                ...
                PMApi.unlinkExternalService("gp", new SharingSettingsFragment._cls6._cls2._cls1());
            }
        ...
        // Unreferenced inner class com/poshmark/ui/fragments/SharingSettingsFragment$6$2$1

/* anonymous class */
        class SharingSettingsFragment._cls6._cls2._cls1
