    ...
    implements ExtServiceUserInfoInterface
{
    ...
    {
        hideProgressDialog();
        showError(new ActionErrorContext(pmapierror, com.poshmark.ui.model.ext.USER_SIGNUP));
    }
    ...
    // Unreferenced inner class com/poshmark/ui/fragments/SignInSignUpWallFragment$7

/* anonymous class */
    class SignInSignUpWallFragment._cls7
        ...
        public void handleResponse(PMApiResponse pmapiresponse)
        {
            if (isAdded())
            {
                ...
                if (pmapiresponse.apiError.pmError != null && pmapiresponse.apiError.pmErrorType == PMErrorType.HTTP_NOT_FOUND)
                {
                    ...
                    FbHelper.getInstance().getMe(new SignInSignUpWallFragment._cls7._cls1());
                    return;
                }
            }
        }
