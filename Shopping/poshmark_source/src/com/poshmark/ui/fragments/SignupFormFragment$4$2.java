...
label0:
        {
            SignupFormFragment.access$1702(_fld0, false);
            if (isAdded())
            {
                hideProgressDialog();
        ...
        {
            showError(new ActionErrorContext(pmapiresponse.apiError, com.poshmark.ui.model.onContext.USER_SIGNUP, PMApplication.getContext().getString(0x7f0600d7), com.poshmark.ui.model.rity.HIGH));
            return;
        }
    }
...
_L5:
        ...
        // Unreferenced inner class com/poshmark/ui/fragments/SignupFormFragment$4$1

/* anonymous class */
        class SignupFormFragment._cls4._cls1 extends TypeToken
        {
