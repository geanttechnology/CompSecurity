    ...
    implements PMApiResponseHandler
{
    ...
    public void handleResponse(PMApiResponse pmapiresponse)
    {
        ...
        {
            GlobalDbController.getGlobalDbController().followBrand(val$brand.canonical_name);
            return;
        } else
        {
            SuggestedBrandsPickerFragment.access$300(_fld0, val$parent, 4);
        ...
        implements PMImageViewOnClickListener
    {
        ...
        public void onClick(final PMImageView parent, final Bundle brand)
        {
            ...
            if (GlobalDbController.getGlobalDbController().isFollowingBrand(((Brand) (brand)).canonical_name))
            {
                ...
                PMApi.unFollowBrand(((Brand) (brand)).canonical_name, new SuggestedBrandsPickerFragment._cls5._cls1());
            ...
            } else
            {
                ...
                PMApi.followBrand(((Brand) (brand)).canonical_name, parent. new SuggestedBrandsPickerFragment._cls5._cls2());
        ...
        // Unreferenced inner class com/poshmark/ui/fragments/SuggestedBrandsPickerFragment$5$1

/* anonymous class */
        class SuggestedBrandsPickerFragment._cls5._cls1
            implements PMApiResponseHandler
        {
