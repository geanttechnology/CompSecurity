...
//            ImageUtils, FeedItemLinearLayout
    ...
    implements ImageLoadingListener
{
    ...
    public void onLoadingComplete(String s, View view, Bitmap bitmap)
    {
        ...
        view = new Bundle();
        view.putString("MODE", DE.SHARE_MODE_LISTING.name());
    ...
    {
        s = new Bundle();
        s.putString("MODE", DE.SHARE_MODE_LISTING.name());
    ...
    // Unreferenced inner class com/poshmark/utils/FeedItemLinearLayout$3

/* anonymous class */
    class FeedItemLinearLayout._cls3
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(final View v)
        {
            ...
            ImageLoader.getInstance().loadImage(listingsocial.getCovershot(), listingsocial. new FeedItemLinearLayout._cls3._cls1());
        }
