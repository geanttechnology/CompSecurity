...
public class FeedItem_Mifu_4_Grid_LinearLayout extends FeedItemLinearLayout
{

    public FeedItem_Mifu_4_Grid_LinearLayout(Context context, AttributeSet attributeset)
    {
        super(context, attributeset);
    }

    public FeedItem_Mifu_4_Grid_LinearLayout(Context context, AttributeSet attributeset, int i)
    {
    ...
    public void populateViewHolder(ListingViewHolder listingviewholder)
    {
        ...
        listingviewholder.coverShotViewSmall3 = (PMCovershotImageView)((LinearLayout) (obj)).findViewById(0x7f0c0125);
