...
public static final class  extends Enum
{
    ...
    public static final DEFAULT EMAIL_SHARE;
    public static final DEFAULT EMAIL_SHARE_BODY;
    public static final DEFAULT EMAIL_SHARE_SUBJECT;
    public static final DEFAULT FB_DIALOG_SHARE;
    public static final DEFAULT FB_MESSENGER_SHARE;
    public static final DEFAULT FB_SHARE;
    public static final DEFAULT INSTAGRAM_SHARE;
    public static final DEFAULT PINTEREST_SHARE;
    public static final DEFAULT SMS_SHARE;
    public static final DEFAULT TM_SHARE;
    public static final DEFAULT TW_SHARE;

    public static  valueOf(String s)
    {
        return ()Enum.valueOf(com/poshmark/utils/ShareManager$SHARE_TYPE, s);
    }
