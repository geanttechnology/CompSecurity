...
static class 
{
    ...
    static 
    {
        ...
        try
        {
            $SwitchMap$com$poshmark$utils$ShareManager$SHARE_TYPE[com.poshmark.utils.PE.EMAIL_SHARE_BODY.ordinal()] = 9;
        }
        catch (NoSuchFieldError nosuchfielderror1) { }
        try
        {
            $SwitchMap$com$poshmark$utils$ShareManager$SHARE_TYPE[com.poshmark.utils.PE.EMAIL_SHARE_SUBJECT.ordinal()] = 10;
        }
