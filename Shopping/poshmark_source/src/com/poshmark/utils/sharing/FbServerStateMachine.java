...
import com.poshmark.utils.sharing.share_states.FbInit;
...
public class FbServerStateMachine extends PM_State_Machine
    implements StateCompletionListener
{

    ShareManager shareManager;

    public FbServerStateMachine(ShareManager sharemanager)
    {
        shareManager = sharemanager;
        transitions.addStateObject(new FbInit(this, sharemanager));
        ...
        transitions.addTransition(FbInit.id, GetServerContent.id, FSMTransition.CONDITION.OK);
        ...
        currentState = transitions.getState(FbInit.id);
    }
