...
import com.poshmark.utils.sharing.share_states.TumblrInit;

// Referenced classes of package com.poshmark.utils.sharing:
//            PM_State_Machine, StateCompletionListener, FSMTransition

public class TumblrServerShareStateMachine extends PM_State_Machine
    implements StateCompletionListener
{

    ShareManager shareManager;

    public TumblrServerShareStateMachine(ShareManager sharemanager)
    {
        shareManager = sharemanager;
        transitions.addStateObject(new TumblrInit(this, sharemanager));
        ...
        transitions.addTransition(TumblrInit.id, GetServerContent.id, FSMTransition.CONDITION.OK);
        ...
        currentState = transitions.getState(TumblrInit.id);
    }
