...
public class FbMessengerShare extends ShareState
    implements PMNotificationListener
{
    ...
    public void executeState()
    {
        ...
        obj = new MessageDialog(shareManager.getFragment());
        ((MessageDialog) (obj)).registerCallback(callbackManager, fbDialogCallback);
        if (MessageDialog.canShow(com/facebook/share/model/ShareLinkContent))
        {
            PMNotificationManager.getNotificationManager().registerForEvent("com.poshmark.intents.FBDIALOG_SHARE_RESULTS", this);
            ((MessageDialog) (obj)).show(((com.facebook.share.model.ShareLinkContent.Builder)(new com.facebook.share.model.ShareLinkContent.Builder()).setContentTitle(s).setContentDescription(s1).setContentUrl(Uri.parse(s2))).build());
