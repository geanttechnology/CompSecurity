    ...
    implements ExtServiceConnectInterface
{
    ...
    // Unreferenced inner class com/poshmark/utils/sharing/share_states/PinterestConnect$1

/* anonymous class */
    class PinterestConnect._cls1
...
_L2:
            ...
            ExtServiceConnectManager.getGlobalConnectManager().pinterestLink(shareManager.getFragment(), new PinterestConnect._cls1._cls1());
