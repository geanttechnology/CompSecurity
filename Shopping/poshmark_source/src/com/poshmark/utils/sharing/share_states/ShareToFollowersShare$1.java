    ...
    implements PMApiResponseHandler
{
    ...
    public void handleResponse(PMApiResponse pmapiresponse)
    {
        ...
        if (val$isFragmentAdded)
        {
            val$callingFragment.showError(new ActionErrorContext(pmapiresponse.apiError, com.poshmark.ui.model.nContext.SHARE_LISTING, PMApplication.getContext().getString(0x7f0600fa)));
        }
    ...
    ()
    {
        this$0 = final_sharetofollowersshare;
