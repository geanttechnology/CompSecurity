...
//            Branch, PrefHelper, SystemObserver
...
class this._cls1 extends TimerTask
{
    ...
    public void run()
    {
        if (!Branch.access$100(_fld1).keepDebugConnection())
        {
            Branch.access$200(_fld1).post(_fld1);
        }
    }
    ...
    // Unreferenced inner class io/branch/referral/Branch$1
...
_L6:
            ...
            
            {
                this$0 = Branch.this;
                super();
                _longPressed = new Branch._cls1._cls1();
            }

        // Unreferenced inner class io/branch/referral/Branch$1$1

/* anonymous class */
        class Branch._cls1._cls1
            implements Runnable
        {
            ...
            public void run()
            {
                ...
                if (!started)
                {
                    ...
                    timer = new Timer();
                    timer.scheduleAtFixedRate(new Branch._cls1.KeepDebugConnectionTask(), new Date(), 20000L);
                } else
                {
