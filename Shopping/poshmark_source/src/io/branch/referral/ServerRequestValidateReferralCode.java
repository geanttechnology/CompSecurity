...
class ServerRequestValidateReferralCode extends ServerRequest
{
    ...
    public ServerRequestValidateReferralCode(Context context, Branch.BranchReferralInitListener branchreferralinitlistener, String s)
    {
    ...
    public ServerRequestValidateReferralCode(String s, JSONObject jsonobject, Context context)
    {
...
_L1:
    ...
    public boolean handleErrors(Context context)
    {
        if (!super.doesAppHasInternetPermission(context))
        {
            if (callback_ != null)
            {
                callback_.onInitFinished(null, new BranchError("Trouble validating the referral code.", -102));
            }
            return true;
        } else
        {
    ...
    public void handleFailure(int i, String s)
    {
        if (callback_ != null)
        {
            callback_.onInitFinished(null, new BranchError((new StringBuilder()).append("Trouble validating the referral code. ").append(s).toString(), i));
        }
    }
...
_L1:
        ...
        serverresponse = new BranchError("Trouble validating the referral code.", -103);
_L3:
