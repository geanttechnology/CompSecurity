...
_L5:
    ...
    private static void showDialog(WeakReference weakreference, CrashManagerListener crashmanagerlistener, boolean flag)
    {
        ...
        } else
        {
            ...
            ((android.app.AlertDialog.Builder) (obj)).setPositiveButton(Strings.get(crashmanagerlistener, 3), new android.content.DialogInterface.OnClickListener(weakreference, crashmanagerlistener, flag) {
...
_L3:
        Object obj2 = as[i];
        String s = contentsOfFile(weakreference, ((String) (obj2)));
        Object obj1 = obj;
...
_L4:
        ...
        httppost = new HttpPost(getURLString());
        ArrayList arraylist = new ArrayList();
        arraylist.add(new BasicNameValuePair("raw", s));
        arraylist.add(new BasicNameValuePair("userID", contentsOfFile(weakreference, ((String) (obj2)).replace(".stacktrace", ".user"))));
        arraylist.add(new BasicNameValuePair("contact", contentsOfFile(weakreference, ((String) (obj2)).replace(".stacktrace", ".contact"))));
        arraylist.add(new BasicNameValuePair("description", contentsOfFile(weakreference, ((String) (obj2)).replace(".stacktrace", ".description"))));
        arraylist.add(new BasicNameValuePair("sdk", "HockeySDK"));
        arraylist.add(new BasicNameValuePair("sdk_version", "3.0.0"));
        httppost.setEntity(new UrlEncodedFormEntity(arraylist, "UTF-8"));
        if (obj1 instanceof HttpClient) goto _L7; else goto _L6
_L6:
...
_L5:
        ...
        continue; /* Loop/switch isn't completed */
_L7:
        HttpInstrumentation.execute((HttpClient)obj1, httppost);
        if (true) goto _L9; else goto _L8
_L8:
        obj1;
        ...
        Exception exception;
        exception;
        if (!((Boolean) (obj)).booleanValue()) goto _L11; else goto _L10
_L10:
        deleteStackTrace(weakreference, as[i]);
        if (crashmanagerlistener != null)
        {
