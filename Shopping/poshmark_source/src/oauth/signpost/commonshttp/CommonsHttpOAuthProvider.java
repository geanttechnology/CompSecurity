...
public class CommonsHttpOAuthProvider extends AbstractOAuthProvider
{
        ...
        throws Exception
    {
        ...
        httprequest = (HttpUriRequest)httprequest.unwrap();
        if (!(httpclient instanceof HttpClient))
        {
            httprequest = httpclient.execute(httprequest);
        } else
        {
            httprequest = HttpInstrumentation.execute((HttpClient)httpclient, httprequest);
        }
        return new HttpResponseAdapter(httprequest);
    }
