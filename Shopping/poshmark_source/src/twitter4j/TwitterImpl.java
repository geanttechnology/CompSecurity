...
//            PagableResponseList, Trends, OEmbed, RelatedResults, 
//            SimilarPlaces, QueryResult, Relationship
    ...
    implements Twitter
{
    ...
    public RelatedResults getRelatedResults(long l)
        throws TwitterException
    {
        return factory.createRelatedResults(get((new StringBuilder()).append("https://api.twitter.com/1/related_results/show.json?id=").append(Long.toString(l)).toString()));
    }
    ...
    public ResponseList lookupUsers(long al[])
        throws TwitterException
    {
        return factory.createUserList(post((new StringBuilder()).append(conf.getRestBaseURL()).append("users/lookup.json").toString(), new HttpParameter[] {
    ...
    public Status showStatus(long l)
        throws TwitterException
    {
        return factory.createStatus(get((new StringBuilder()).append(conf.getRestBaseURL()).append("statuses/show/").append(l).append(".json").toString()));
    }
