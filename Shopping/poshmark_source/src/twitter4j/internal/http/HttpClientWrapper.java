    ...
    implements Serializable
{
    ...
    {
        return (new StringBuilder()).append("HttpClientWrapper{wrapperConf=").append(wrapperConf).append(", http=").append(http).append(", requestHeaders=").append(requestHeaders).append(", httpResponseListener=").append(httpResponseListener).append('}').toString();
    }
}
