...
public class h
{
    ...
    {
        a = context;
        e = new _cls1(context.getMainLooper());
    }
...
_L2:
    ...
    class b {}
                ...
                ((b)((a) (obj)).b.get(j)).b.onReceive(a, ((a) (obj)).a);
            }
...
_L5:
        ...
        Log.v("LocalBroadcastManager", (new StringBuilder()).append("Matching against filter ").append(((b) (obj)).a).toString());
