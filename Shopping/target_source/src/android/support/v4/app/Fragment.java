    ...
    implements ComponentCallbacks, android.view.View.OnCreateContextMenuListener
{
    ...
    private static final j sClassMap = new j();
    f mActivity;
    boolean mAdded;
    ...
    public static Fragment instantiate(Context context, String s, Bundle bundle)
    {
        ...
        {
            throw new a((new StringBuilder()).append("Unable to instantiate fragment ").append(s).append(": make sure class name exists, is public, and has an").append(" empty constructor that is public").toString(), context);
        }
        // Misplaced declaration of an exception variable
        catch (Context context)
        {
...
_L5:
    ...
    public LayoutInflater getLayoutInflater(Bundle bundle)
    {
        ...
        android.support.v4.view.j.a(bundle, mChildFragmentManager.w());
        return bundle;
    }
    ...
    {
        return getResources().getString(k);
    }

    public final transient String getString(int k, Object aobj[])
    {
        return getResources().getString(k, aobj);
    }
    ...
    public final CharSequence getText(int k)
    {
        return getResources().getText(k);
    }
    ...
    {
        mChildFragmentManager = new i();
        mChildFragmentManager.a(mActivity, new g() {
    ...
    void performActivityCreated(Bundle bundle)
    {
        ...
        if (!mCalled)
        {
            throw new ai((new StringBuilder()).append("Fragment ").append(this).append(" did not call through to super.onActivityCreated()").toString());
        }
        if (mChildFragmentManager != null)
        {
            mChildFragmentManager.n();
    ...
    void performCreate(Bundle bundle)
    {
        ...
        if (!mCalled)
        {
            throw new ai((new StringBuilder()).append("Fragment ").append(this).append(" did not call through to super.onCreate()").toString());
        }
        if (bundle != null)
        {
    ...
    void performDestroy()
    {
        ...
        if (!mCalled)
        {
            throw new ai((new StringBuilder()).append("Fragment ").append(this).append(" did not call through to super.onDestroy()").toString());
        } else
        {
            return;
        }
    ...
    void performDestroyView()
    {
        ...
        if (!mCalled)
        {
            throw new ai((new StringBuilder()).append("Fragment ").append(this).append(" did not call through to super.onDestroyView()").toString());
        }
        if (mLoaderManager != null)
        {
            mLoaderManager.f();
    ...
    void performPause()
    {
        ...
        if (!mCalled)
        {
            throw new ai((new StringBuilder()).append("Fragment ").append(this).append(" did not call through to super.onPause()").toString());
        } else
        {
            return;
        }
...
label0:
    ...
    void performResume()
    {
        ...
        if (!mCalled)
        {
            throw new ai((new StringBuilder()).append("Fragment ").append(this).append(" did not call through to super.onResume()").toString());
        }
        if (mChildFragmentManager != null)
        {
            mChildFragmentManager.p();
    ...
    void performStart()
    {
        ...
        if (!mCalled)
        {
            throw new ai((new StringBuilder()).append("Fragment ").append(this).append(" did not call through to super.onStart()").toString());
        }
        if (mChildFragmentManager != null)
        {
            mChildFragmentManager.o();
    ...
    void performStop()
    {
        ...
        if (!mCalled)
        {
            throw new ai((new StringBuilder()).append("Fragment ").append(this).append(" did not call through to super.onStop()").toString());
        } else
        {
            return;
        }
    ...
    final void restoreViewState(Bundle bundle)
    {
        ...
        if (!mCalled)
        {
            throw new ai((new StringBuilder()).append("Fragment ").append(this).append(" did not call through to super.onViewStateRestored()").toString());
        } else
        {
            return;
        }
    ...
    final void setIndex(int k, Fragment fragment)
    {
        mIndex = k;
        if (fragment != null)
        {
    ...
    public void setTargetFragment(Fragment fragment, int k)
    {
        mTarget = fragment;
        mTargetRequestCode = k;
    }
