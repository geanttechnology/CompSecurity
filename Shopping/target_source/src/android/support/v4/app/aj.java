    ...
    implements Iterable
{
    ...
    public aj a(Activity activity)
    {
        ...
        if (obj == null)
        {
            activity = android.support.v4.app.p.a(activity);
        } else
        {
    ...
    public aj a(ComponentName componentname)
    {
        ...
        try
        {
            componentname = android.support.v4.app.p.a(c, componentname);
        }
        ...
        componentname = android.support.v4.app.p.a(c, componentname.getComponent());
...
_L1:
    ...
    // Unreferenced inner class android/support/v4/app/aj$b
    /* block-local class not found */
    class b {}
