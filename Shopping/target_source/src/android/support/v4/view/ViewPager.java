...
public class ViewPager extends ViewGroup
{
    ...
    private static final Interpolator d = new _cls2();
    private boolean A;
    private boolean B;
    private int C;
    private int D;
    ...
    static ac a(ViewPager viewpager)
    {
        return viewpager.h;
    }
    ...
    private void a(MotionEvent motionevent)
    {
        ...
        if (android.support.v4.view.t.b(motionevent, i1) == J)
        {
            if (i1 == 0)
            {
                i1 = 1;
            ...
            F = android.support.v4.view.t.c(motionevent, i1);
            J = android.support.v4.view.t.b(motionevent, i1);
            if (K != null)
            {
                K.clear();
            }
...
label0:
        {
            ...
            if (flag1)
            {
                ...
                android.support.v4.view.ai.a(this, ai);
            }
            return;
        }
        ai.run();
    ...
    private void b(boolean flag)
    {
        ...
        while (i1 < j1) 
        {
            ...
            android.support.v4.view.ai.a(getChildAt(i1), byte0, null);
            i1++;
        }
    }
...
label1:
    ...
    class d {}
        ...
        android.support.v4.view.ai.a(this, new d());
        if (android.support.v4.view.ai.e(this) == 0)
        {
            android.support.v4.view.ai.c(this, 1);
        }
    }
...
_L2:
        if (flag && android.support.v4.view.ai.a(view, -i1)) goto _L4; else goto _L6
_L6:
        return false;
...
_L3:
    ...
    public void draw(Canvas canvas)
    {
        ...
        int j1 = 0;
        int i1 = 0;
        int k1 = android.support.v4.view.ai.a(this);
...
_L7:
        ...
        j1 = android.support.v4.view.t.a(motionevent, j1);
        f3 = android.support.v4.view.t.c(motionevent, j1);
        f1 = f3 - F;
        f5 = Math.abs(f1);
        f4 = android.support.v4.view.t.d(motionevent, j1);
        f6 = Math.abs(f4 - I);
...
_L6:
        ...
        I = f2;
        G = f2;
        J = android.support.v4.view.t.b(motionevent, 0);
        B = false;
...
_L4:
        if (!A)
        {
            i1 = android.support.v4.view.t.a(motionevent, J);
            float f2 = android.support.v4.view.t.c(motionevent, i1);
            float f4 = Math.abs(f2 - F);
            float f3 = android.support.v4.view.t.d(motionevent, i1);
        ...
        if (A)
        {
            i1 = false | b(android.support.v4.view.t.c(motionevent, android.support.v4.view.t.a(motionevent, J)));
        }
        continue; /* Loop/switch isn't completed */
_L3:
        i1 = j1;
        if (A)
        {
            ...
            i1 = (int)android.support.v4.view.ag.a(((VelocityTracker) (obj)), J);
            y = true;
            j1 = getClientWidth();
            int k1 = getScrollX();
            obj = i();
            a(a(((b) (obj)).b, ((float)k1 / (float)j1 - ((b) (obj)).e) / ((b) (obj)).d, i1, (int)(android.support.v4.view.t.c(motionevent, android.support.v4.view.t.a(motionevent, J)) - H)), true, true, i1);
            J = -1;
            j();
            boolean flag = Q.c();
            i1 = R.c() | flag;
...
_L8:
        a(motionevent);
        F = android.support.v4.view.t.c(motionevent, android.support.v4.view.t.a(motionevent, J));
        i1 = j1;
...
_L9:
    ...
    // Unreferenced inner class android/support/v4/view/ViewPager$j
    /* block-local class not found */
    class j {}
