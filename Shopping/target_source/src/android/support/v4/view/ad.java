...
_L4:
    ...
    void a(ac ac1, ac ac2)
    {
        ...
        {
            ac2.a(l);
            m = new WeakReference(ac2);
        }
        if (a != null)
        {
            f = -1;
            g = -1F;
            a(a.getCurrentItem(), ac2);
            requestLayout();
        }
    }
    ...
    protected void onAttachedToWindow()
    {
        ...
        obj = (ViewPager)obj;
        ac ac1 = ((ViewPager) (obj)).getAdapter();
        ((ViewPager) (obj)).a(l);
