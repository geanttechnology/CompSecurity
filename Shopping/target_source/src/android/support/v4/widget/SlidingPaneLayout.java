...
label0:
    ...
    boolean a(float f1, int i1)
    {
        ...
        boolean flag = f();
        b b1 = (b)h.getLayoutParams();
        if (flag)
        {
            i1 = getPaddingRight();
            int j1 = b1.rightMargin;
            int k1 = h.getWidth();
            i1 = (int)((float)getWidth() - ((float)(j1 + i1) + (float)k * f1 + (float)k1));
        } else
        {
            i1 = getPaddingLeft();
            i1 = (int)((float)(b1.leftMargin + i1) + (float)k * f1);
        }
...
_L8:
        ...
        {
            k3 = android.view.View.MeasureSpec.makeMeasureSpec(b1.height, 0x40000000);
        }
        view.measure(i3, k3);
                ...
                if (view1.getVisibility() != 8)
                {
                    ...
                    if (view1.getVisibility() != 8)
                    {
                        ...
                        if (b2.a > 0.0F)
                        {
                            ...
                            if (flag)
                            {
                                int j5 = b2.leftMargin;
                                j5 = k4 - (b2.rightMargin + j5);
                            ...
                            } else
                            {
                                ...
                                view1.measure(android.view.View.MeasureSpec.makeMeasureSpec((int)((b2.a * (float)k5) / f1) + l3, 0x40000000), k1);
                            }
                        }
                    }
                }
...
_L15:
    ...
    public void setPanelSlideListener(c c1)
    {
        p = c1;
    }
    ...
    // Unreferenced inner class android/support/v4/widget/SlidingPaneLayout$c
    /* block-local class not found */
    class c {}
