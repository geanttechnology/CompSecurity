...
public class SwipeRefreshLayout extends ViewGroup
{
    ...
    private int F;
    private boolean G;
    private android.view.animation.Animation.AnimationListener H;
    ...
    {
        i1 = android.support.v4.view.t.a(motionevent, i1);
        if (i1 < 0)
        {
            return -1F;
        } else
        {
            return android.support.v4.view.t.d(motionevent, i1);
        }
    }
    ...
    private Animation a(int i1, int j1)
    {
        ...
        {
            _cls4 _lcls4 = new _cls4(i1, j1);
            _lcls4.setDuration(300L);
            t.a(null);
            t.clearAnimation();
            t.startAnimation(_lcls4);
            return _lcls4;
        }
    }
    ...
    private void a(MotionEvent motionevent)
    {
        ...
        if (android.support.v4.view.t.b(motionevent, i1) == o)
        {
            if (i1 == 0)
            {
                i1 = 1;
            ...
            o = android.support.v4.view.t.b(motionevent, i1);
        }
    }
...
label0:
    ...
    static l b(SwipeRefreshLayout swiperefreshlayout)
    {
    ...
    private void b()
    {
        t = new b(getContext(), 0xfffafafa, 20F);
        w = new l(getContext(), this);
        w.b(0xfffafafa);
...
_L6:
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionevent)
    {
        int i1;
        f();
        i1 = android.support.v4.view.t.a(motionevent);
        if (q && i1 == 0)
        {
            q = false;
        }
...
_L4:
        float f1;
        a(b - t.getTop(), true);
        o = android.support.v4.view.t.b(motionevent, 0);
        n = false;
        f1 = a(motionevent, o);
...
_L4:
        i1 = android.support.v4.view.t.a(motionevent, o);
        if (i1 < 0)
        {
            Log.e(c, "Got ACTION_MOVE event but have an invalid active pointer id.");
            return false;
        }
        float f3 = 0.5F * (android.support.v4.view.t.d(motionevent, i1) - l);
        if (!n)
        {
            continue; /* Loop/switch isn't completed */
        }
...
_L5:
        o = android.support.v4.view.t.b(motionevent, android.support.v4.view.t.b(motionevent));
        continue; /* Loop/switch isn't completed */
_L6:
        a(motionevent);
...
_L3:
        ...
        float f2 = android.support.v4.view.t.d(motionevent, android.support.v4.view.t.a(motionevent, o));
        float f4 = l;
        n = false;
        if ((f2 - f4) * 0.5F > h)
        {
    ...
    public transient void setColorScheme(int ai1[])
    {
        setColorSchemeResources(ai1);
    }

    public transient void setColorSchemeColors(int ai1[])
    {
        f();
        w.a(ai1);
    }

    public transient void setColorSchemeResources(int ai1[])
    {
        Resources resources = getResources();
        int ai2[] = new int[ai1.length];
        for (int i1 = 0; i1 < ai1.length; i1++)
        {
            ai2[i1] = resources.getColor(ai1[i1]);
        }

        setColorSchemeColors(ai2);
    }
    ...
    // Unreferenced inner class android/support/v4/widget/SwipeRefreshLayout$a
