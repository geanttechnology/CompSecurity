    ...
    implements m.a
{
    ...
    public ListMenuItemView(Context context, AttributeSet attributeset, int i1)
    {
        ...
        l = context;
        attributeset = context.obtainStyledAttributes(attributeset, android.support.v7.a.a.k.MenuView, i1, 0);
        g = attributeset.getDrawable(android.support.v7.a.a.k.MenuView_android_itemBackground);
        h = attributeset.getResourceId(android.support.v7.a.a.k.MenuView_android_itemTextAppearance, -1);
        j = attributeset.getBoolean(android.support.v7.a.a.k.MenuView_preserveIconSpacing, false);
        i = context;
    ...
    private void b()
    {
        b = (ImageView)getInflater().inflate(android.support.v7.a.a.h.abc_list_menu_item_icon, this, false);
        addView(b, 0);
    }

    private void c()
    {
        c = (RadioButton)getInflater().inflate(android.support.v7.a.a.h.abc_list_menu_item_radio, this, false);
        addView(c);
    }

    private void d()
    {
        e = (CheckBox)getInflater().inflate(android.support.v7.a.a.h.abc_list_menu_item_checkbox, this, false);
        addView(e);
    }
