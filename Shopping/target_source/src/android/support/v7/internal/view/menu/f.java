...
_L2:
        ...
        b = android.support.v4.a.a.a(e(), j1);
_L6:
        c = null;
...
_L6:
    ...
    public void c(Bundle bundle)
    {
        ...
        for (sparsearray = null; i1 < j1; sparsearray = sparsearray2)
        {
            ...
            View view = android.support.v4.view.q.a(menuitem);
            ...
            if (view != null)
            {
                ...
                if (view.getId() != -1)
                {
                    ...
                    if (android.support.v4.view.q.d(menuitem))
                    {
    ...
    public void d(Bundle bundle)
    {
        if (bundle != null)
        {
            ...
            if (j1 > 0)
            {
                ...
                if (bundle != null)
                {
                    android.support.v4.view.q.b(bundle);
                    return;
                }
            }
        }
