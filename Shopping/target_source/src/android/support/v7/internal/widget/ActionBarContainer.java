...
public class ActionBarContainer extends FrameLayout
{
    ...
    public ActionBarContainer(Context context, AttributeSet attributeset)
    {
        ...
        context = context.obtainStyledAttributes(attributeset, android.support.v7.a.a.k.ActionBar);
        a = context.getDrawable(android.support.v7.a.a.k.ActionBar_background);
        b = context.getDrawable(android.support.v7.a.a.k.ActionBar_backgroundStacked);
        j = context.getDimensionPixelSize(android.support.v7.a.a.k.ActionBar_height, -1);
        if (getId() == android.support.v7.a.a.f.split_action_bar)
        {
            d = true;
            c = context.getDrawable(android.support.v7.a.a.k.ActionBar_backgroundSplit);
        }
        context.recycle();
        if (d)
        {
...
_L3:
    ...
    public void setTabContainer(n n1)
    {
        if (g != null)
        {
            removeView(g);
        ...
        {
            addView(n1);
            android.view.ViewGroup.LayoutParams layoutparams = n1.getLayoutParams();
            layoutparams.width = -1;
            layoutparams.height = -2;
            n1.setAllowCollapse(false);
        }
    }
