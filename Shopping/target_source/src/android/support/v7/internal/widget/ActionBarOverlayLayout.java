...
//            g, h, ActionBarContainer, ContentFrameLayout, 
//            u
    ...
    implements z, g
{
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attributeset)
    {
        ...
        D = new Runnable() {
            ...
            {
                ActionBarOverlayLayout.a(a);
                ActionBarOverlayLayout.a(a, ai.s(ActionBarOverlayLayout.c(a)).c(-ActionBarOverlayLayout.c(a).getHeight()).a(ActionBarOverlayLayout.b(a)));
                if (ActionBarOverlayLayout.d(a) != null && ActionBarOverlayLayout.d(a).getVisibility() != 8)
                {
                    ActionBarOverlayLayout.b(a, ai.s(ActionBarOverlayLayout.d(a)).c(ActionBarOverlayLayout.d(a).getHeight()).a(ActionBarOverlayLayout.e(a)));
                }
            }
    ...
    static ba a(ActionBarOverlayLayout actionbaroverlaylayout, ba ba1)
    {
        actionbaroverlaylayout.y = ba1;
        return ba1;
    }
    ...
    private void a(Context context)
    {
        ...
        i = flag;
        x = android.support.v4.widget.p.a(context);
    }
    ...
    {
        boolean flag = false;
        x.a(0, 0, 0, (int)f2, 0, 0, 0x80000000, 0x7fffffff);
        if (x.e() > f.getHeight())
        {
            flag = true;
        }
    ...
    static ba b(ActionBarOverlayLayout actionbaroverlaylayout, ba ba1)
    {
        actionbaroverlaylayout.z = ba1;
        return ba1;
    }

    static be b(ActionBarOverlayLayout actionbaroverlaylayout)
    {
    ...
    static be e(ActionBarOverlayLayout actionbaroverlaylayout)
    {
    ...
    void c()
    {
        if (d == null)
        {
            d = (ContentFrameLayout)findViewById(android.support.v7.a.a.f.action_bar_activity_content);
            f = (ActionBarContainer)findViewById(android.support.v7.a.a.f.action_bar_container);
            g = a(findViewById(android.support.v7.a.a.f.action_bar));
            e = (ActionBarContainer)findViewById(android.support.v7.a.a.f.split_action_bar);
        }
    }
    ...
    public void draw(Canvas canvas)
    {
        ...
        if (h != null && !i)
        {
            ...
            {
                i1 = (int)((float)f.getBottom() + ai.p(f) + 0.5F);
            } else
            {
                i1 = 0;
            }
    ...
    protected boolean fitSystemWindows(Rect rect)
    {
        ...
        s.set(rect);
        android.support.v7.internal.widget.u.a(this, s, p);
        if (!q.equals(p))
        {
            q.set(p);
            flag = true;
    ...
    protected void onMeasure(int i1, int j1)
    {
        ...
        Object obj = (b)f.getLayoutParams();
        int k2 = Math.max(0, f.getMeasuredWidth() + ((b) (obj)).leftMargin + ((b) (obj)).rightMargin);
        int k1 = f.getMeasuredHeight();
        int l1 = ((b) (obj)).topMargin;
        int j2 = Math.max(0, ((b) (obj)).bottomMargin + (k1 + l1));
        int i2 = android.support.v7.internal.widget.u.a(0, ai.l(f));
        if (e != null)
        {
            measureChildWithMargins(e, i1, 0, j1, 0);
            obj = (b)e.getLayoutParams();
            k2 = Math.max(k2, e.getMeasuredWidth() + ((b) (obj)).leftMargin + ((b) (obj)).rightMargin);
            k1 = e.getMeasuredHeight();
            l1 = ((b) (obj)).topMargin;
            j2 = Math.max(j2, ((b) (obj)).bottomMargin + (k1 + l1));
            i2 = android.support.v7.internal.widget.u.a(i2, ai.l(e));
        }
        boolean flag;
        if ((ai.u(this) & 0x100) != 0)
        {
        ...
        k1 = Math.max(k2, d.getMeasuredWidth() + ((b) (obj)).leftMargin + ((b) (obj)).rightMargin);
        l1 = d.getMeasuredHeight();
        k2 = ((b) (obj)).topMargin;
        l1 = Math.max(j2, ((b) (obj)).bottomMargin + (l1 + k2));
        i2 = android.support.v7.internal.widget.u.a(i2, ai.l(d));
        j2 = getPaddingLeft();
        k2 = getPaddingRight();
        l1 = Math.max(l1 + (getPaddingTop() + getPaddingBottom()), getSuggestedMinimumHeight());
        setMeasuredDimension(ai.a(Math.max(k1 + (j2 + k2), getSuggestedMinimumWidth()), i1, i2), ai.a(l1, j1, i2 << 16));
    }
