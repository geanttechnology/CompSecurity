...
public class s
{
    ...
    public static s a(Context context, AttributeSet attributeset, int ai[])
    {
        return new s(context, context.obtainStyledAttributes(attributeset, ai));
    }

    public static s a(Context context, AttributeSet attributeset, int ai[], int i, int j)
    {
        return new s(context, context.obtainStyledAttributes(attributeset, ai, i, j));
    }
