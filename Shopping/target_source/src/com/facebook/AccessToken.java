    ...
    implements Parcelable
{
    ...
    public AccessToken(String s, String s1, String s2, Collection collection, Collection collection1, c c1, Date date, 
            Date date1)
    {
        p.a(s, "accessToken");
        p.a(s1, "applicationId");
        p.a(s2, "userId");
        if (date == null)
        {
            date = b;
    ...
    static AccessToken a(Bundle bundle)
    {
        ...
        return new AccessToken(s1, s, ((String) (obj)), list, list1, p.c(bundle), p.a(bundle, "com.facebook.TokenCachingStrategy.ExpirationDate"), p.a(bundle, "com.facebook.TokenCachingStrategy.LastRefreshDate"));
    }
        ...
        throws JSONException
    {
        ...
        } else
        {
            ...
            return new AccessToken(s, jsonobject.getString("application_id"), jsonobject.getString("user_id"), o.a(jsonarray), o.a(jsonarray1), c1, date, date1);
        }
    }

    static List a(Bundle bundle, String s)
    {
