    ...
    implements Serializable
{
    ...
    void a(a a1, long l)
    {
        ...
        if (!d)
        {
            com.facebook.internal.j.a(q.e, a, "Suspend for inactive app");
            return;
        }
        long l2 = l - f;
        if (l2 < 0L)
        {
            com.facebook.internal.j.a(q.e, a, "Clock skew detected");
        } else
        {
            l1 = l2;
        }
    ...
    void a(a a1, long l, String s)
    {
        ...
        if (d)
        {
            com.facebook.internal.j.a(q.e, a, "Resume for active app");
            return;
        }
        if (b())
        {
