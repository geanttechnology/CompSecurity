...
public final class h
{
    public static final class a extends Enum
    {
        ...
        {
            return (a)Enum.valueOf(com/facebook/h$a, s);
        }
    ...
    private final com.facebook.f o;

    private h(int i1, int j1, int k1, String s, String s1, String s2, String s3, 
            boolean flag, JSONObject jsonobject, JSONObject jsonobject1, Object obj, HttpURLConnection httpurlconnection, com.facebook.f f1)
    {
        c = i1;
        d = j1;
        e = k1;
    ...
    public h(int i1, String s, String s1)
    {
        this(-1, i1, -1, s, s1, null, null, false, null, null, null, null, null);
    }

    h(HttpURLConnection httpurlconnection, Exception exception)
    {
        if (exception instanceof com.facebook.f)
        {
            exception = (com.facebook.f)exception;
        } else
        {
            exception = new com.facebook.f(exception);
        }
        this(-1, -1, -1, null, null, null, null, false, null, null, null, httpurlconnection, ((com.facebook.f) (exception)));
    }

    static h a(JSONObject jsonobject, Object obj, HttpURLConnection httpurlconnection)
    {
...
_L1:
        ...
        obj1 = com.facebook.internal.o.a(jsonobject, "body", "FACEBOOK_NON_JSON_RESULT");
...
_L6:
        ...
        String s1;
        boolean flag1;
        jsonobject1 = (JSONObject)com.facebook.internal.o.a(jsonobject2, "error", null);
...
_L10:
        ...
        return new h(k1, i1, j1, ((String) (obj1)), s, s1, ((String) (obj2)), flag1, jsonobject2, jsonobject, obj, httpurlconnection, null);
_L7:
...
_L11:
        ...
        obj1 = (JSONObject)com.facebook.internal.o.a(jsonobject, "body", "FACEBOOK_NON_JSON_RESULT");
_L12:
        jsonobject = new h(k1, -1, -1, null, null, null, null, false, ((JSONObject) (obj1)), jsonobject, obj, httpurlconnection, null);
        return jsonobject;
        jsonobject;
_L2:
        return null;
    ...
    static f f()
    {
        ...
        Object obj = com.facebook.internal.o.c(com.facebook.i.i());
...
_L4:
        ...
        return ((f) (obj));
_L2:
        obj = ((com.facebook.internal.o.b) (obj)).b();
