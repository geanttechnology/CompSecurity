...
class GetTokenLoginMethodHandler extends LoginMethodHandler
{
    ...
    boolean a(LoginClient.Request request)
    {
        ...
        {
            b.j();
            request = new com.facebook.internal.l.a(request) {
    ...
    void c(LoginClient.Request request, Bundle bundle)
    {
        ...
        {
            b.j();
            o.a(bundle.getString("com.facebook.platform.extra.ACCESS_TOKEN"), new com.facebook.internal.o.c(bundle, request) {
                ...
                public void a(f f1)
                {
                    c.b.b(LoginClient.Result.a(c.b.c(), "Caught exception", f1.getMessage()));
                }
