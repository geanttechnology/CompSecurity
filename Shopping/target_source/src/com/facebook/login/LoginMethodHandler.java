    ...
    implements Parcelable
{
    ...
    {
        Date date = o.a(bundle, "com.facebook.platform.extra.EXPIRES_SECONDS_SINCE_EPOCH", new Date(0L));
    ...
    public static AccessToken a(Collection collection, Bundle bundle, c c1, String s)
        throws f
    {
        Date date = o.a(bundle, "expires_in", new Date());
        ...
        throws f
    {
        if (s == null || s.isEmpty())
        {
            throw new f("Authorization response does not contain the signed_request");
        }
        s = s.split("\\.");
        if (s.length != 2)
        {
        ...
        s;
_L2:
        throw new f("Failed to retrieve user_id from signed_request");
        s;
...
_L1:
    ...
    {
        String s1 = b.c().d();
        a a1 = com.facebook.a.a.c(b.b(), s1);
