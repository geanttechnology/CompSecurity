    ...
    implements SafeParcelable
{
    ...
    public boolean equals(Object obj)
    {
        if (this != obj)
        {
            ...
            obj = (PlaceImpl)obj;
            if (!c.equals(((PlaceImpl) (obj)).c) || !com.google.android.gms.common.internal.t.a(x, ((PlaceImpl) (obj)).x) || n != ((PlaceImpl) (obj)).n)
            {
                return false;
            }
        }
    ...
    public int hashCode()
    {
        return com.google.android.gms.common.internal.t.a(new Object[] {
            c, x, Long.valueOf(n)
        });
    }
    ...
    {
        return com.google.android.gms.common.internal.t.a(this).a("id", c).a("placeTypes", p).a("locale", x).a("name", q).a("address", r).a("phoneNumber", s).a("latlng", f).a("viewport", h).a("websiteUri", j).a("isPermanentlyClosed", Boolean.valueOf(k)).a("priceLevel", Integer.valueOf(m)).a("timestampSecs", Long.valueOf(n)).toString();
    }
