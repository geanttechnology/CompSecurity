    ...
    implements android.view.View.OnLayoutChangeListener
{
            ...
            int k1, int l1)
    {
        ...
        try
        {
            obj = e.e().p().getClass().getMethod("getSupportFragmentManager", new Class[0]).invoke(e.e().p(), new Object[0]);
...
_L5:
        ...
        com.j.a.g.a.a((ViewGroup)view, (ViewGroup)obj, i2, (String)s, obj1.getClass().getSimpleName(), flag1, flag);
        return;
_L2:
        s = obj.toString();
