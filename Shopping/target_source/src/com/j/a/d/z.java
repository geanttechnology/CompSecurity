    ...
    implements android.view.View.OnLayoutChangeListener
{
    ...
    public void onLayoutChange(View view, int i, int j, int k, int l, int i1, int j1, 
            int k1, int l1)
    {
        if (e.e().p().getFragmentManager().findFragmentById(view.getId()) == null || !(view instanceof ViewGroup)) goto _L2; else goto _L1
_L1:
        Object obj;
        String s;
        ViewGroup viewgroup;
        ...
        } else
        {
          ...
          goto _L3
_L11:
        fragment = e.e().p().getFragmentManager().findFragmentById(view.getId());
...
_L10:
        try
        {
            com.j.a.g.a.a((ViewGroup)view, (ViewGroup)obj, fragment.getId(), (String)s, fragment.getClass().getSimpleName(), flag, flag1);
            return;
        }
        // Misplaced declaration of an exception variable
        catch (View view)
        {
            w.b("F Ex, reg, lc: ", view);
        }
        return;
        throwable;
