...
_L1:
        ...
        return ((Dao) (obj));
_L2:
        Dao dao = (Dao)createDaoFromConfig(connectionsource, class1);
        obj = dao;
        if (dao != null) goto _L1; else goto _L3
_L3:
...
_L10:
        registerDao(connectionsource, ((Dao) (obj)));
          goto _L1
_L8:
...
_L6:
        ...
        obj = (Dao)((Constructor) (obj)).newInstance(aobj);
        ...
        throws SQLException
    {
        ...
        class1 = (DatabaseTableConfig)configMap.get(class1);
        if (class1 == null)
        {
            return null;
        } else
        ...
        throws SQLException
    {
        ...
        } else
        {
            ...
            Object obj = lookupDao(classconnectionsource);
            if (obj != null)
            {
                addDaoToTableMap(tableconfigconnectionsource, ((Dao) (obj)));
                return ((Dao) (obj));
            }
            obj = (DatabaseTable)databasetableconfig.getDataClass().getAnnotation(com/j256/ormlite/table/DatabaseTable);
            if (obj == null || ((DatabaseTable) (obj)).daoClass() == java/lang/Void || ((DatabaseTable) (obj)).daoClass() == com/j256/ormlite/dao/BaseDaoImpl)
            {
            ...
            } else
            {
                ...
                connectionsource = findConstructor(((Class) (obj)), aobj);
                if (connectionsource == null)
                {
                    throw new SQLException((new StringBuilder()).append("Could not find public constructor with ConnectionSource, DatabaseTableConfig parameters in class ").append(obj).toString());
                }
                try
                {
...
_L5:
        ...
        if (aclass[j].isAssignableFrom(aobj[j].getClass())) goto _L4; else goto _L3
_L3:
        j = 0;
_L7:
        if (j != 0)
...
_L2:
    ...
    public static Dao lookupDao(ConnectionSource connectionsource, Class class1)
    {
        ...
        JVM INSTR monitorexit ;
        throw connectionsource;
        connectionsource = lookupDao(new ClassConnectionSource(connectionsource, class1));
        com/j256/ormlite/dao/DaoManager;
        JVM INSTR monitorexit ;
        return connectionsource;
    }
