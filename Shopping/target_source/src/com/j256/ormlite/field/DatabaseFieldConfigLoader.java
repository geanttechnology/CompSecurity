...
label1:
        ...
        s = databasefieldconfig.getUniqueIndexName(s);
        if (s != null)
        {
            bufferedwriter.append("uniqueIndexName").append('=').append(s);
            bufferedwriter.newLine();
        }
        ...
        s = databasefieldconfig.getForeignColumnName();
        if (s != null)
        {
            bufferedwriter.append("foreignColumnName").append('=').append(s);
            bufferedwriter.newLine();
        }
