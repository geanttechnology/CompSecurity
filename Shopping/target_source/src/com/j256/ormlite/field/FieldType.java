...
public class FieldType
{
        ...
        throws SQLException
    {
        ...
        if (databasefieldconfig.isForeign() || databasefieldconfig.isForeignAutoRefresh() || s1 != null)
        {
            ...
            {
                connectionsource = (new StringBuilder()).append(connectionsource).append("_").append(s1).toString();
            }
        ...
        if (class1 == null && !databasefieldconfig.isForeignCollection())
        {
        ...
        {
            columnName = connectionsource;
        } else
        {
            columnName = databasefieldconfig.getColumnName();
        }
        fieldConfig = databasefieldconfig;
        if (!databasefieldconfig.isId()) goto _L2; else goto _L1
_L1:
...
_L3:
        ...
        obj2 = foreignDao.getObjectCache();
        if (obj2 == null)
        {
            obj2 = null;
        } else
        {
            obj2 = ((ObjectCache) (obj2)).get(getType(), obj1);
        }
        if (obj2 == null) goto _L4; else goto _L2
_L2:
...
_L5:
        ...
        if (((LevelCounters) (obj2)).autoRefreshLevel < ((LevelCounters) (obj2)).autoRefreshLevelMax) goto _L7; else goto _L6
_L6:
...
_L7:
        ...
        throws SQLException
    {
        ...
        if (fieldConfig.isForeignAutoRefresh() || s != null)
        {
            ...
            if (s == null)
            {
                FieldType fieldtype = ((TableInfo) (obj1)).getIdField();
                class1 = fieldtype;
                if (fieldtype == null)
                {
            ...
            {
                FieldType fieldtype1 = ((TableInfo) (obj1)).getFieldTypeByColumnName(s);
                class1 = fieldtype1;
                if (fieldtype1 == null)
                {
            ...
            obj2 = MappedQueryForId.build(databasetype, ((TableInfo) (obj1)), class1);
            obj = class1;
            class1 = connectionsource;
            connectionsource = ((ConnectionSource) (obj2));
        } else
        ...
        if (fieldConfig.isForeignCollection())
        {
            ...
            {
                throw new SQLException((new StringBuilder()).append("Field class for '").append(field.getName()).append("' must be a parameterized Collection whose generic argument is an entity class not: ").append(obj[0]).toString());
            }
            obj1 = (Class)obj[0];
            obj = fieldConfig.getForeignTableConfig();
            if (obj == null)
            {
                obj = (BaseDaoImpl)DaoManager.createDao(connectionsource, ((Class) (obj1)));
            } else
            {
                obj = (BaseDaoImpl)DaoManager.createDao(connectionsource, ((DatabaseTableConfig) (obj)));
            }
            fieldtype2 = findForeignFieldType(((Class) (obj1)), class1, ((BaseDaoImpl) (obj)));
            obj2 = null;
            obj1 = null;
            connectionsource = null;
            class1 = ((Class) (obj));
    ...
    public Object resultToJava(DatabaseResults databaseresults, Map map)
        throws SQLException
    {
        Integer integer1 = (Integer)map.get(columnName);
