...
_L5:
    ...
    public static HttpRequest inspectAndInstrument(TransactionState transactionstate, HttpHost httphost, HttpRequest httprequest)
    {
        ...
        if (requestline != null)
        {
            ...
            {
                obj = httphost.toURI().toString();
                stringbuilder = (new StringBuilder()).append(((String) (obj)));
                if (((String) (obj)).endsWith("/") || s.startsWith("/"))
                {
                    obj = "";
                } else
                {
                ...
                obj = stringbuilder.append(((String) (obj))).append(s).toString();
            } else
            {
                obj = stringbuilder;
                if (flag)
        ...
        {
            inspectAndInstrument(transactionstate, ((String) (obj)), requestline.getMethod());
