    ...
    implements TraceLifecycleAware
{
    ...
    {
        activitytrace = activitytrace.rootTrace;
        Object obj2 = metrics.removeAllWithScope(((Trace) (activitytrace)).metricName);
        Object obj1 = metrics.removeAllWithScope(((Trace) (activitytrace)).metricBackgroundName);
        ...
        double d2 = (double)(((Trace) (activitytrace)).exitTimestamp - ((Trace) (activitytrace)).entryTimestamp) / 1000D;
        ...
        while (((Iterator) (obj)).hasNext()) 
        {
            ...
            metric.setScope((new StringBuilder()).append("Mobile/Activity/Summary/Name/").append(((Trace) (activitytrace)).displayName).toString());
