...
public class NetworkMeasurementProducer extends BaseMeasurementProducer
{
    ...
    public void produceMeasurement(String s, String s1, int i, int j, long l, double d, long l1, long l2, String s2)
    {
        ...
        {
            produceMeasurement(new HttpTransactionMeasurement(s, s1, i, j, l, d, l1, l2, s2));
            return;
        }
    }
}
