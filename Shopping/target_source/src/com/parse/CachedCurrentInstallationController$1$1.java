...
//            CachedCurrentInstallationController, ParseInstallation, InstallationId, ParseExecutors, 
//            ParseObjectStore
    ...
    implements i
{
    ...
    public j then(j j)
        throws Exception
    {
        CachedCurrentInstallationController.access$000(_fld0).set(installation.getInstallationId());
        return j;
    }
...
/* anonymous class */
        ...
        implements i
    {
        ...
        // Unreferenced inner class com/parse/CachedCurrentInstallationController$1$2

/* anonymous class */
        class CachedCurrentInstallationController._cls1._cls2
            implements i
        {
