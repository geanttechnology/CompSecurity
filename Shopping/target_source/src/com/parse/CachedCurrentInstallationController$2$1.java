...
//            ParseInstallation, ParseObject, CachedCurrentInstallationController, InstallationId, 
//            PLog, ParseExecutors, ParseObjectStore
    ...
    implements i
{
        ...
        throws Exception
    {
        ...
        if (j1 == null)
        {
            ...
            j1.updateDeviceInfo(CachedCurrentInstallationController.access$000(_fld0));
        } else
        {
            CachedCurrentInstallationController.access$000(_fld0).set(j1.getInstallationId());
            PLog.v("com.parse.CachedCurrentInstallationController", "Successfully deserialized Installation object");
        }
        synchronized (CachedCurrentInstallationController.access$200(_fld0))
        {
...
/* anonymous class */
        ...
        implements i
    {
        ...
        // Unreferenced inner class com/parse/CachedCurrentInstallationController$2$2

/* anonymous class */
        class CachedCurrentInstallationController._cls2._cls2
            implements i
        {
