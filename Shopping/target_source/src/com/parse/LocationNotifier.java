...
class LocationNotifier
{
    ...
    static j getCurrentLocationAsync(Context context, long l, Criteria criteria)
    {
        a.j.a a = j.a();
        h h1 = new h();
        context = (LocationManager)context.getSystemService("location");
        LocationListener locationlistener = new LocationListener(h1, a, context) {

            final LocationManager val$manager;
            final a.j.a val$tcs;
            final h val$timeoutFuture;
        ...
        h1.a(ParseExecutors.scheduled().schedule(new Runnable(a, context, locationlistener) {
