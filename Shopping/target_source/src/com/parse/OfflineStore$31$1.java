...
/* anonymous class */
        ...
        implements i
    {
            ...
            throws Exception
        {
            ...
            j1 = new ArrayList();
            String s;
            for (obj = ((List) (obj)).iterator(); ((Iterator) (obj)).hasNext(); j1.add(OfflineStore.access$600(OfflineStore.this, s, db).d(new OfflineStore._cls31._cls2()).b(s. new OfflineStore._cls31._cls1())))
            {
