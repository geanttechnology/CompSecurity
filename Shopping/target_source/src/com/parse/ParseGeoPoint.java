...
public class ParseGeoPoint
{
    ...
    public static j getCurrentLocationInBackground(long l)
    {
        Criteria criteria = new Criteria();
        criteria.setAccuracy(0);
        criteria.setPowerRequirement(0);
        return LocationNotifier.getCurrentLocationAsync(Parse.getApplicationContext(), l, criteria).c(new i() {
    ...
    public static j getCurrentLocationInBackground(long l, Criteria criteria)
    {
        return LocationNotifier.getCurrentLocationAsync(Parse.getApplicationContext(), l, criteria).c(new i() {
    ...
    {
        return String.format(Locale.US, "ParseGeoPoint[%.6f,%.6f]", new Object[] {
