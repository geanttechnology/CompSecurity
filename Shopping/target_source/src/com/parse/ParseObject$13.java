    ...
    implements i
{
    ...
    public j then(j j)
        throws Exception
    {
        j = new KnownParseObjectDecoder(ParseObject.access$700(ParseObject.this));
        return ParseObject.access$800().saveAsync(getState(), val$operations, val$sessionToken, j);
    }
