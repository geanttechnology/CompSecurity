...
//            ParseCorePlugins, LocalIdManager, ParseRole, ParseInstallation, 
//            ParseSession, ParsePin, EventuallyPin, ParseCurrentUserController, 
//            ParseCurrentInstallationController, ParseAddOperation, ParseAddUniqueOperation, ParseDateFormat, 
//            ParseObjectController, ParseRESTCommand, ParseEventuallyQueue, ParseRelation, 
//            PointerOrLocalIdEncoder, ParseGeoPoint, KnownParseObjectDecoder, ParseObjectCoder, 
//            ParseIncrementOperation, ParseJSONUtils, ParseEncoder, ParseDeleteOperation, 
//            ParseRemoveOperation, PointerEncoder, DeleteCallback, FindCallback, 
//            SaveCallback, GetCallback, RefreshCallback
...
public class ParseObject
{
    static class State
    {
        ...
        public static Init newBuilder(String s)
        {
            if ("_User".equals(s))
            {
    ...
    private boolean canBeSerialized()
    {
        ...
        synchronized (mutex)
        {
            final h result = new h(Boolean.valueOf(true));
            (new ParseTraverser() {
...
_L4:
    ...
    private ParseRESTObjectCommand currentSaveEventuallyCommand(ParseOperationSet parseoperationset, ParseEncoder parseencoder, String s)
    ...
    private static j deepSaveAsync(Object obj, String s)
    {
        ...
        obj3 = j.a(((Collection) (obj4))).a(new i(((AtomicBoolean) (obj))) {
        ...
        obj2 = j.a(arraylist).a(new i(((AtomicBoolean) (obj4))) {
        ...
        return j.a(Arrays.asList(new j[] {
            obj3, obj2, j.a(null).a(new Callable(((h) (obj1))) {
            ...
            
            {
            ...
            }, new i(((h) (obj1)), ((AtomicBoolean) (obj)), ((AtomicBoolean) (obj4)), s) {
                    ...
                    throws Exception
                {
                    ...
                    {
                        return ParseObject.enqueueForAll(j1, j1. new i() {
                            ...
                            public j then(j j1)
                                throws Exception
                            {
                                return ParseObject.saveAllAsync(current, sessionToken, j1);
                            }
    ...
    private static j deleteAllAsync(List list, String s)
    {
        if (list.size() == 0)
        {
            return j.a(null);
        ...
        for (int k = 0; k < l; k++)
        {
            ParseObject parseobject = (ParseObject)list.get(k);
        ...
        return enqueueForAll(arraylist, new i(arraylist, s) {
            ...
            public j then(j j1)
                throws Exception
            {
                return ParseObject.deleteAllAsync(uniqueObjects, sessionToken, j1);
            }
    ...
    private static j deleteAllAsync(List list, String s, j j1)
    {
        return j1.b(new i(list, s) {
                ...
                throws Exception
            {
                ...
                for (int k = 0; k < i1; k++)
                {
                    ...
                    j2.add(parseobject.getState());
                }

                j2 = ParseObject.getObjectController().deleteAllAsync(j2, sessionToken);
                ArrayList arraylist = new ArrayList(i1);
                for (int l = 0; l < i1; l++)
                {
                    arraylist.add(((j)j2.get(l)).d(((ParseObject)uniqueObjects.get(l)). new i() {
                        ...
                        public j then(j j1)
                            throws Exception
                        {
                            return object.handleDeleteResultAsync().b(j1. new i() {
    ...
    public static j deleteAllInBackground(List list)
    {
        return ParseUser.getCurrentSessionTokenAsync().d(new i(list) {
            ...
            {
                j1 = (String)j1.e();
                return ParseObject.deleteAllAsync(objects, j1);
            }
    ...
    private j deleteAsync(final String sessionToken, j j1)
    {
        validateDelete();
        return j1.d(new i() {
    ...
    static j enqueueForAll(List list, i k)
    {
        Object obj;
        a.j.a a;
        a = j.a();
        ...
        for (list = list.iterator(); list.hasNext(); ((ParseObject)list.next()).taskQueue.enqueue(new i(arraylist, k) {
        ...
        j.a(arraylist).a(new i(a) {

            final a.j.a val$readyToStart;
    ...
    private j enqueueSaveEventuallyOperationAsync(final ParseOperationSet operationSet)
    {
    ...
    private static j fetchAllAsync(List list, ParseUser parseuser, boolean flag, j j1)
    {
        String s;
        ArrayList arraylist;
label0:
...
label1:
        ...
        {
            return j1.b(new i(ParseQuery.getQuery(s).whereContainedIn("objectId", arraylist), parseuser) {
            ...
            
            {
                    ...
                    throws Exception
                {
                    ...
                    for (j2 = ((List)j2.e()).iterator(); j2.hasNext(); hashmap.put(parseobject1.getObjectId(), parseobject1))
                    {
                        parseobject1 = (ParseObject)j2.next();
                    }
                    ...
                    do
                    {
                        ...
                        ParseObject parseobject2 = (ParseObject)j2.next();
                        if (!onlyIfNeeded || !parseobject2.isDataAvailable())
                        {
                            ...
                            {
                                throw new ParseException(101, (new StringBuilder()).append("Object id ").append(parseobject2.getObjectId()).append(" does not exist").toString());
                            }
    ...
    private static j fetchAllAsync(List list, boolean flag)
    {
        return ParseUser.getCurrentUserAsync().d(new i(list, flag) {
            ...
            {
                j1 = (ParseUser)j1.e();
                return ParseObject.enqueueForAll(objects, j1. new i() {
                    ...
                    public j then(j j1)
                        throws Exception
                    {
                        return ParseObject.fetchAllAsync(objects, user, onlyIfNeeded, j1);
                    }
    ...
    public static j fetchAllIfNeededInBackground(List list)
    {
    ...
    public static j fetchAllInBackground(List list)
    {
    ...
    static ParseObject from(State state1)
    {
        ParseObject parseobject = createWithoutData(state1.className(), state1.objectId());
        Object obj = parseobject.mutex;
        obj;
        JVM INSTR monitorenter ;
...
_L1:
        parseobject.setState(state1);
        return parseobject;
        state1 = parseobject.getState().newBuilder().apply(state1).build();
          goto _L1
        state1;
        obj;
        JVM INSTR monitorexit ;
...
label0:
    ...
    private void notifyObjectIdChanged(String s, String s1)
    {
        ...
        if (localId != null)
        {
            getLocalIdManager().setObjectId(localId, s1);
            localId = null;
        }
        obj;
        JVM INSTR monitorexit ;
    ...
    public static j pinAllInBackground(String s, List list)
    {
        return pinAllInBackground(s, list, true);
    }

    private static j pinAllInBackground(String s, List list, boolean flag)
    {
        if (!Parse.isLocalDatastoreEnabled())
        {
        ...
        {
            j1 = j1.d(new i((ParseObject)iterator.next()) {
                    ...
                    throws Exception
                {
                    ...
                    j2 = object.getACL(false);
                    if (j2 == null)
                    {
                        return j.a(null);
                    }
                    j2 = j2.getUnresolvedUser();
                    if (j2 == null || !j2.isCurrentUser())
                    {
                        return j.a(null);
                    } else
                    {
                        return ParseUser.pinCurrentUserIfNeededAsync(j2);
                    }
                }
        ...
        return j1.d(new i(s, list, flag) {
                ...
                throws Exception
            {
                ...
                return offlinestore.pinAllObjectsAsync(j2, objects, includeAllChildren);
            }
    ...
    public static j pinAllInBackground(List list)
    {
    ...
    private static j saveAllAsync(List list, String s, j j1)
    {
        return j1.b(new i(list, s) {
                ...
                throws Exception
            {
                ...
                for (int k = 0; k < i1; k++)
                {
                    ...
                    j2.add(parseobject.startSave());
                    arraylist.add(new KnownParseObjectDecoder(parseobject.collectFetchedObjects()));
                }

                obj = ParseObject.getObjectController().saveAllAsync(((List) (obj)), j2, sessionToken, arraylist);
                arraylist = new ArrayList(i1);
                for (int l = 0; l < i1; l++)
                {
                    arraylist.add(((j)((List) (obj)).get(l)).b(((ParseOperationSet)j2.get(l)). new i() {
                        ...
                        public j then(j j1)
                            throws Exception
                        {
                            State state1 = (State)j1.e();
                            return object.handleSaveResultAsync(state1, operations).b(j1. new i() {
    ...
    public static j saveAllInBackground(List list)
    {
        return ParseUser.getCurrentUserAsync().d(new i(list) {
                ...
                for (j1 = objects.iterator(); j1.hasNext();)
                {
                    ...
                    if (acl.isDataAvailable("ACL"))
                    {
                        ...
                        if (acl != null)
                        {
                            ...
                            {
                                return parseuser.saveAsync(null).c(parseuser. new i() {
            ...
            {
                j1 = (String)j1.e();
                return ParseObject.deepSaveAsync(objects, j1);
            }
    ...
    public static j unpinAllInBackground()
    {
        return unpinAllInBackground("_default");
    }

    public static j unpinAllInBackground(String s)
    {
        if (!Parse.isLocalDatastoreEnabled())
        {
            throw new IllegalStateException("Method requires Local Datastore. Please refer to `Parse#enableLocalDatastore(Context)`.");
    ...
    public static j unpinAllInBackground(String s, List list)
    {
        if (!Parse.isLocalDatastoreEnabled())
        {
            throw new IllegalStateException("Method requires Local Datastore. Please refer to `Parse#enableLocalDatastore(Context)`.");
    ...
    public static j unpinAllInBackground(List list)
    {
...
label2:
    ...
    j deleteAsync(String s)
        throws ParseException
    {
        return getObjectController().deleteAsync(getState(), s);
    }

    public final j deleteEventually()
    {
        Object obj1 = mutex;
        obj1;
        JVM INSTR monitorenter ;
    ...
    public final j deleteInBackground()
    {
        return ParseUser.getCurrentSessionTokenAsync().d(new i() {
            ...
            {
                j1 = (String)j1.e();
                return taskQueue.enqueue(j1. new i() {
                    ...
                    public j then(j j1)
                        throws Exception
                    {
                        return deleteAsync(sessionToken, j1);
                    }
    ...
    j fetchAsync(final String sessionToken, j j1)
    {
        return j1.d(new i() {
                ...
                throws Exception
            {
                ...
                j2 = new KnownParseObjectDecoder(map);
                return ParseObject.getObjectController().fetchAsync(state1, sessionToken, j2);
                exception;
                j2;
                JVM INSTR monitorexit ;
                throw exception;
            ...
            {
                j2 = (State)j2.e();
                return handleFetchResultAsync(j2);
            }
    ...
    public final j fetchIfNeededInBackground()
    {
        if (isDataAvailable())
        {
            return j.a(this);
    ...
    public final j fetchInBackground()
    {
        return ParseUser.getCurrentSessionTokenAsync().d(new i() {
...
label0:
    ...
    j handleDeleteEventuallyResultAsync()
    {
        synchronized (mutex)
        {
            isDeletingEventually = isDeletingEventually - 1;
        }
        return handleDeleteResultAsync().d(new i() {
...
label0:
                    {
                        ...
                        synchronized (mutex)
                        {
                            ...
                            j3 = store.deleteDataForObjectAsync(ParseObject.this);
                        }
                        return j3;
                    }
                    j j4 = store.updateDataForObjectAsync(ParseObject.this);
                    j2;
                    JVM INSTR monitorexit ;
                    return j4;
                    exception1;
    ...
    j handleFetchResultAsync(final State result)
    {
        j j2 = j.a((Void)null);
        final OfflineStore store = Parse.getLocalDatastore();
        j j1 = j2;
        if (store != null)
        {
            j1 = j2.d(new i() {
                ...
                public volatile Object then(j j3)
                    throws Exception
                {
                    return then(j3);
                }
            ...
            
            {
                ...
                {
                    j j4 = j3;
                    if (j3.f() instanceof ParseException)
                    {
                        j4 = j3;
                        if (((ParseException)j3.f()).getCode() == 120)
                        {
                            j4 = null;
                        }
                    }
...
_L1:
                setState(j3);
                return null;
                j3 = getState().newBuilder().apply(result).build();
                  goto _L1
                j3;
                obj;
                JVM INSTR monitorexit ;
    ...
    j handleSaveEventuallyResultAsync(JSONObject jsonobject, ParseOperationSet parseoperationset)
    {
        ...
        return handleSaveResultAsync(jsonobject, parseoperationset).d(new i() {
    ...
    j handleSaveResultAsync(final State result, final ParseOperationSet operationsBeforeSave)
    {
        j j1 = j.a((Void)null);
        final Object store;
        ...
        store;
        JVM INSTR monitorenter ;
        listiterator = operationSetQueue.listIterator(operationSetQueue.indexOf(operationsBeforeSave));
        listiterator.next();
        listiterator.remove();
        if (flag)
        {
        ...
        ((ParseOperationSet)listiterator.next()).mergeFrom(operationsBeforeSave);
        store;
        JVM INSTR monitorexit ;
        return j1;
        store;
        ...
        operationsBeforeSave = j1.a(new i() {
...
_L1:
                setState(j2);
                return null;
                j2 = getState().newBuilder().apply(operationsBeforeSave).apply(result).build();
                  goto _L1
                j2;
                obj;
                JVM INSTR monitorexit ;
        ...
        if (store != null)
        {
            result = operationsBeforeSave.d(new i() {
    ...
    j handleSaveResultAsync(JSONObject jsonobject, ParseOperationSet parseoperationset)
    {
        Object obj = null;
        if (jsonobject != null)
        {
            synchronized (mutex)
            {
                ...
                obj = ParseObjectCoder.get().decode(getState().newBuilder().clear(), jsonobject, ((ParseDecoder) (obj))).isComplete(false).build();
            }
        }
    ...
    boolean isDataAvailable(String s)
    {
        Object obj = mutex;
        obj;
        JVM INSTR monitorenter ;
        boolean flag;
        if (isDataAvailable() || estimatedData.containsKey(s))
        {
            flag = true;
        } else
        {
...
_L1:
        ParseOperationSet parseoperationset = ParseOperationSet.fromRest(jsonarray.getJSONObject(k), parsedecoder);
...
_L10:
        ...
        k = (new Date(state1.updatedAt())).compareTo(((Date) (obj)));
        if (k < 0)
        {
            k = 1;
            continue; /* Loop/switch isn't completed */
...
_L1:
    ...
    public j pinInBackground(String s)
    {
        return pinAllInBackground(s, Collections.singletonList(this));
    }

    j pinInBackground(String s, boolean flag)
    {
        return pinAllInBackground(s, Collections.singletonList(this), flag);
    }
    ...
    j saveAsync(ParseOperationSet parseoperationset, String s)
        throws ParseException
    {
        return currentSaveEventuallyCommand(parseoperationset, PointerEncoder.get(), s).executeAsync();
    }

    j saveAsync(final String sessionToken)
    {
        return taskQueue.enqueue(new i() {
            ...
            public j then(j j1)
                throws Exception
            {
                return saveAsync(sessionToken, j1);
            }
    ...
    j saveAsync(final String sessionToken, j j1)
    {
        if (!isDirty())
        {
            return j.a(null);
        ...
        synchronized (mutex)
        {
            j2 = deepSaveAsync(estimatedData, sessionToken);
        }
        return j2.d(TaskQueue.waitFor(j1)).d(new i() {
            ...
            public j then(j j3)
                throws Exception
            {
                j3 = new KnownParseObjectDecoder(collectFetchedObjects());
                return ParseObject.getObjectController().saveAsync(getState(), operations, sessionToken, j3);
            }
            ...
            public j then(j j3)
                throws Exception
            {
                State state1 = (State)j3.e();
                return handleSaveResultAsync(state1, operations).b(j3. new i() {
    ...
    public final j saveEventually()
    {
        ...
        obj3 = ParseUser.getCurrentSessionToken();
        obj3 = currentSaveEventuallyCommand(operationSet, PointerOrLocalIdEncoder.get(), ((String) (obj3)));
        ((ParseRESTCommand) (obj3)).setLocalId(((String) (obj)));
        ((ParseRESTCommand) (obj3)).setOperationSetUUID(operationSet.getUUID());
        ((ParseRESTCommand) (obj3)).retainLocalIds();
        for (obj = arraylist.iterator(); ((Iterator) (obj)).hasNext(); ((ParseObject)((Iterator) (obj)).next()).saveEventually()) { }
        break MISSING_BLOCK_LABEL_175;
        Object obj1;
        obj1;
        throw new IllegalStateException("Unable to saveEventually.", ((Throwable) (obj1)));
        obj1;
        obj2;
        JVM INSTR monitorexit ;
        throw obj1;
        obj1;
        obj1 = j.a(((Exception) (obj1)));
        obj2;
        JVM INSTR monitorexit ;
        return ((j) (obj1));
        obj2;
        JVM INSTR monitorexit ;
        j j1 = Parse.getEventuallyQueue().enqueueEventuallyAsync(((ParseRESTCommand) (obj3)), this);
        enqueueSaveEventuallyOperationAsync(operationSet);
        ((ParseRESTCommand) (obj3)).releaseLocalIds();
        if (Parse.isLocalDatastoreEnabled())
        {
            return j1.j();
        } else
        {
            return j1.d(new i() {
                ...
                {
                    j2 = (JSONObject)j2.e();
                    return handleSaveEventuallyResultAsync(j2, operationSet);
                }
    ...
    public final j saveInBackground()
    {
        return ParseUser.getCurrentUserAsync().d(new i() {
...
_L2:
        ...
        arraylist.add(new ParseOperationSet((ParseOperationSet)operationSetQueue.get(k)));
        k++;
        if (true) goto _L2; else goto _L1
_L1:
        obj;
        JVM INSTR monitorexit ;
        return toRest(state1, ((List) (arraylist)), parseencoder);
        parseencoder;
        obj;
        JVM INSTR monitorexit ;
        throw parseencoder;
    ...
    public j unpinInBackground(String s)
    {
