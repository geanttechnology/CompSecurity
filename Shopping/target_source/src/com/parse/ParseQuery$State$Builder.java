...
//            ParseQuery, ParseObject, ParseGeoPoint

static class className
{

    private addCondition cachePolicy;
...
_L4:
    ...
    public isFromLocalDatastore maxDistance(String s, double d)
    {
        return addCondition(s, "$maxDistance", Double.valueOf(d));
    }

    public addCondition orderByAscending(String s)
    {
        return setOrder(s);
    }
    ...
    public addConditionInternal whereNear(String s, ParseGeoPoint parsegeopoint)
    {
        return addCondition(s, "$nearSphere", parsegeopoint);
    }

    addCondition whereObjectIdEquals(String s)
    {
        where.clear();
    ...
    public aint whereWithin(String s, ParseGeoPoint parsegeopoint, ParseGeoPoint parsegeopoint1)
    {
        ArrayList arraylist = new ArrayList();
