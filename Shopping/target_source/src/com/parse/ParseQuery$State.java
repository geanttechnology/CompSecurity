...
_L4:
        ...
        public Builder maxDistance(String s, double d)
        {
        ...
        public Builder whereNear(String s, ParseGeoPoint parsegeopoint)
        {
        ...
        public Builder whereWithin(String s, ParseGeoPoint parsegeopoint, ParseGeoPoint parsegeopoint1)
        {
            ArrayList arraylist = new ArrayList();
