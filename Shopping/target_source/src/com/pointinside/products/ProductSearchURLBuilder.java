...
public class ProductSearchURLBuilder extends SearchURLBuilder
{
    ...
    public ProductSearchURLBuilder(String s, Location location)
    {
    ...
    public ProductSearchURLBuilder(HashMap hashmap, Location location)
    {
        this("", location);
        facets = hashmap;
    }
    ...
    public void onPrepareURL()
    {
        ...
        if (flag)
        {
            LogUtils.logW("ProductSearchURLBuilder", "KeywordToSearch or facet - both are not set. HTTP error may occur because of invalid URL");
        }
        ...
        if (!ParameterCheck.isNullOrEmpty(overrideDate))
        {
            parameters.put("overrideDate", overrideDate);
        }
        if (!ParameterCheck.isNullOrEmpty(Boolean.valueOf(eventLocationOnly)))
        {
            parameters.put("eventLocationOnly", String.valueOf(eventLocationOnly));
        }
    }
}
