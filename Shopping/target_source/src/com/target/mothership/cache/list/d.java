...
public class d
{
    ...
    public static g getMigrationSet()
    {
        g g1 = new g();
        g1.add(new f(5) {
...
_L7:
                if (sqlitedatabase instanceof SQLiteDatabase) goto _L4; else goto _L3
_L3:
                sqlitedatabase.execSQL("CREATE TABLE `list_item` (`mLastModifiedDate` VARCHAR , `mLastModifiedTs` VARCHAR , `mListId` VARCHAR , `mListItemId` VARCHAR , `mNote` VARCHAR , `mTcinString` VARCHAR , `mTitle` VARCHAR , `mDesiredQuantity` INTEGER , `mItemPosition` BIGINT , `mKey` INTEGER PRIMARY KEY AUTOINCREMENT , `mListKey` INTEGER , `mPurchasedQuantity` INTEGER )");
_L8:
                if (sqlitedatabase instanceof SQLiteDatabase) goto _L6; else goto _L5
_L5:
                sqlitedatabase.execSQL("INSERT INTO list_item (mLastModifiedDate, mListId, mListItemId, mNote, mTcinString, mTitle, mDesiredQuantity, mItemPosition, mKey, mListKey, mPurchasedQuantity) SELECT mLastModifiedDate, mListId, mListItemId, mNote, mTcinString, mTitle, mDesiredQuantity, mItemPosition, mKey, mListKey, mPurchasedQuantity FROM list_item_backup WHERE mIsDeleting=0");
_L9:
                if (sqlitedatabase instanceof SQLiteDatabase)
                {
                    break MISSING_BLOCK_LABEL_108;
...
_L2:
                ...
                throw exception;
_L4:
                SQLiteInstrumentation.execSQL((SQLiteDatabase)sqlitedatabase, "CREATE TABLE `list_item` (`mLastModifiedDate` VARCHAR , `mLastModifiedTs` VARCHAR , `mListId` VARCHAR , `mListItemId` VARCHAR , `mNote` VARCHAR , `mTcinString` VARCHAR , `mTitle` VARCHAR , `mDesiredQuantity` INTEGER , `mItemPosition` BIGINT , `mKey` INTEGER PRIMARY KEY AUTOINCREMENT , `mListKey` INTEGER , `mPurchasedQuantity` INTEGER )");
                  goto _L8
_L6:
                SQLiteInstrumentation.execSQL((SQLiteDatabase)sqlitedatabase, "INSERT INTO list_item (mLastModifiedDate, mListId, mListItemId, mNote, mTcinString, mTitle, mDesiredQuantity, mItemPosition, mKey, mListKey, mPurchasedQuantity) SELECT mLastModifiedDate, mListId, mListItemId, mNote, mTcinString, mTitle, mDesiredQuantity, mItemPosition, mKey, mListKey, mPurchasedQuantity FROM list_item_backup WHERE mIsDeleting=0");
                  goto _L9
