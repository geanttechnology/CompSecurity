...
public class k extends b
{
        ...
        implements j
    {
        ...
        {
            return (a)Enum.valueOf(com/target/mothership/model/cart/interfaces/a/k$a, s);
        }
        ...
        static 
        {
            ...
            $VALUES = (new a[] {
                ERR_TOKEN_EXPIRED, ERR_REAUTH_REQUIRED, ERR_ACCOUNT_IN_USE, ERR_CART_EMPTY, ERR_TOO_MANY_REQUESTS, ERR_CART_UNKNOWN
            });
        }
