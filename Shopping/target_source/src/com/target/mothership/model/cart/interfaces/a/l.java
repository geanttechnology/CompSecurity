...
public class l extends b
{
        ...
        implements j
    {
        ...
        public static final a ERR_SAVED_FOR_LATER_LIST_EMPTY;
        ...
        {
            return (a)Enum.valueOf(com/target/mothership/model/cart/interfaces/a/l$a, s);
        }
        ...
        static 
        {
            ERR_SAVED_FOR_LATER_LIST_EMPTY = new a("ERR_SAVED_FOR_LATER_LIST_EMPTY", 0, new c[] {
            ...
            $VALUES = (new a[] {
                ERR_SAVED_FOR_LATER_LIST_EMPTY, ERR_TOKEN_EXPIRED, ERR_ACCOUNT_IN_USE, ERR_TOO_MANY_REQUESTS, ERR_CART_UNKNOWN
            });
        }
