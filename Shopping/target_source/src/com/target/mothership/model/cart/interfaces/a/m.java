...
public class m extends b
{
        ...
        implements j
    {
        ...
        {
            return (a)Enum.valueOf(com/target/mothership/model/cart/interfaces/a/m$a, s);
        }
        ...
        static 
        {
            ...
            ERR_REAUTH_REQUIRED = new a("ERR_REAUTH_REQUIRED", 2, new c[] {
                c.SCOPE_1_ACCESS_LEVEL_REQUIRED
            });
            ERR_ACCOUNT_IN_USE = new a("ERR_ACCOUNT_IN_USE", 3, new c[] {
            ...
            $VALUES = (new a[] {
                ERR_CART_EMPTY, ERR_TOKEN_EXPIRED, ERR_REAUTH_REQUIRED, ERR_ACCOUNT_IN_USE, ERR_TOO_MANY_REQUESTS, ERR_CART_UNKNOWN
            });
        }
