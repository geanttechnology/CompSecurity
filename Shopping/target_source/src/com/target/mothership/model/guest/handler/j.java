...
import com.target.mothership.model.guest.a.g;
...
//            TGTGuestAddress, TGTPersonName, TGTPhoneNumber, l, 
//            TGTGuestPaymentCardExpiration
...
public class j extends b
{
    ...
    private final aa mSuccessTransformer = new aa() {
        ...
        public List a(k k1)
        {
            ...
            while (k1.hasNext()) 
            {
                ...
                if (m1.i() != -1)
                {
                    tgtpaymentcardtender.a(new TGTGuestPaymentCardExpiration(com.target.mothership.common.tender.b.a(String.valueOf(m1.i())), m1.j()));
                } else
                {
    ...
    protected List a(k k1)
    {
        return (List)mSuccessTransformer.a(k1);
    }
