...
public class com.target.mothership.model.guest.interfaces.a.a extends b
{
        ...
        implements j
    {
        ...
        public static final a ERR_GIFT_CARD_ACCESS_NUMBER_INVALID;
        public static final a ERR_GIFT_CARD_ACCESS_NUMBER_PATTERN;
        public static final a ERR_GIFT_CARD_ACCESS_NUMBER_REQUIRED;
        public static final a ERR_GIFT_CARD_ALREADY_ADDED;
        public static final a ERR_GIFT_CARD_NUMBER_INVALID;
        ...
        {
            return (a)Enum.valueOf(com/target/mothership/model/guest/interfaces/a/a$a, s);
        }
        ...
        static 
        {
            ERR_GIFT_CARD_NUMBER_REQUIRED = new a("ERR_GIFT_CARD_NUMBER_REQUIRED", 0, new c[] {
                c._ERR_REQUIRED_GIFTCARDNUMBER
            });
            ERR_GIFT_CARD_NUMBER_INVALID = new a("ERR_GIFT_CARD_NUMBER_INVALID", 1, new c[] {
                c._ERR_AMZ_GIFTCARD_NUMBER
            });
            ERR_GIFT_CARD_NUMBER_PATTERN = new a("ERR_GIFT_CARD_NUMBER_PATTERN", 2, new c[] {
                c._ERR_PATTERN_GIFTCARDNUMBER, c._ERR_MAX_LENGTH_GIFTCARDNUMBER, c._ERR_MIN_LENGTH_GIFTCARDNUMBER
            });
            ERR_GIFT_CARD_ACCESS_NUMBER_REQUIRED = new a("ERR_GIFT_CARD_ACCESS_NUMBER_REQUIRED", 3, new c[] {
                c._ERR_REQUIRED_ACCESSNUMBER
            });
            ERR_GIFT_CARD_ACCESS_NUMBER_INVALID = new a("ERR_GIFT_CARD_ACCESS_NUMBER_INVALID", 4, new c[] {
                c._ERR_INVALID_GIFTCARD_ACCESS_NUMBER
            });
            ERR_GIFT_CARD_ACCESS_NUMBER_PATTERN = new a("ERR_GIFT_CARD_ACCESS_NUMBER_PATTERN", 5, new c[] {
                c._ERR_PATTERN_ACCESSNUMBER, c._ERR_LENGTH_ACCESSNUMBER
            });
            ERR_GIFT_CARD_ALREADY_ADDED = new a("ERR_GIFT_CARD_ALREADY_ADDED", 6, new c[] {
            ...
            ERR_REAUTH_REQUIRED = new a("ERR_REAUTH_REQUIRED", 8, new c[] {
                c.SCOPE_1_ACCESS_LEVEL_REQUIRED
            });
            ERR_ACCOUNT_IN_USE = new a("ERR_ACCOUNT_IN_USE", 9, new c[] {
                c._ERR_INVALID_COOKIE
            });
            ERR_TOO_MANY_REQUESTS = new a("ERR_TOO_MANY_REQUESTS", 10, new c[] {
                c.TAPI_VPA
            });
            ERR_UNKNOWN = new a("ERR_UNKNOWN", 11, new c[] {
                c._ERR_UNKNOWN
            });
            $VALUES = (new a[] {
    ...
    public com.target.mothership.model.guest.interfaces.a.a()
    {
    }
