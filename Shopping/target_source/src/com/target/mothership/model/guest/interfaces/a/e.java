...
public class e extends b
{
        ...
        implements j
    {
        ...
        {
            return (a)Enum.valueOf(com/target/mothership/model/guest/interfaces/a/e$a, s);
        }
        ...
        static 
        {
            ERR_FIRSTNAME_REQUIRED = new a("ERR_FIRSTNAME_REQUIRED", 0, new c[] {
                c._ERR_REQUIRED_FIRSTNAME
            });
            ERR_FIRSTNAME_MAX_LENGTH = new a("ERR_FIRSTNAME_MAX_LENGTH", 1, new c[] {
                c._ERR_MAX_LENGTH_FIRSTNAME
            });
            ERR_FIRSTNAME_PATTERN = new a("ERR_FIRSTNAME_PATTERN", 2, new c[] {
                c._ERR_PATTERN_FIRSTNAME
            });
            ERR_MIDDLENAME_PATTERN = new a("ERR_MIDDLENAME_PATTERN", 3, new c[] {
                c._ERR_PATTERN_MIDDLENAME
            });
            ERR_MIDDLENAME_MAX_LENGTH = new a("ERR_MIDDLENAME_MAX_LENGTH", 4, new c[] {
                c._ERR_MAX_LENGTH_MIDDLENAME
            });
            ERR_LASTNAME_REQUIRED = new a("ERR_LASTNAME_REQUIRED", 5, new c[] {
                c._ERR_REQUIRED_LASTNAME
            });
            ERR_LASTNAME_PATTERN = new a("ERR_LASTNAME_PATTERN", 6, new c[] {
                c._ERR_PATTERN_LASTNAME
            });
            ERR_LASTNAME_MAX_LENGTH = new a("ERR_LASTNAME_MAX_LENGTH", 7, new c[] {
                c._ERR_MAX_LENGTH_LASTNAME
            });
            ERR_ADDRESS_LINE1_REQUIRED = new a("ERR_ADDRESS_LINE1_REQUIRED", 8, new c[] {
                c._ERR_REQUIRED_ADDRESS1
            });
            ERR_ADDRESS_LINE1_PATTERN = new a("ERR_ADDRESS_LINE1_PATTERN", 9, new c[] {
                c._ERR_PATTERN_ADDRESS1
            });
            ERR_ADDRESS_LINE1_MAX_LENGTH = new a("ERR_ADDRESS_LINE1_MAX_LENGTH", 10, new c[] {
                c._ERR_MAX_LENGTH_ADDRESS1
            });
            ERR_ADDRESS_LINE2_PATTERN = new a("ERR_ADDRESS_LINE2_PATTERN", 11, new c[] {
                c._ERR_PATTERN_ADDRESS2
            });
            ERR_ADDRESS_LINE2_MAX_LENGTH = new a("ERR_ADDRESS_LINE2_MAX_LENGTH", 12, new c[] {
                c._ERR_MAX_LENGTH_ADDRESS2
            });
            ERR_CITY_REQUIRED = new a("ERR_CITY_REQUIRED", 13, new c[] {
                c._ERR_REQUIRED_CITY
            });
            ERR_CITY_PATTERN = new a("ERR_CITY_PATTERN", 14, new c[] {
                c._ERR_PATTERN_CITY
            });
            ERR_CITY_MAX_LENGTH = new a("ERR_CITY_MAX_LENGTH", 15, new c[] {
                c._ERR_MAX_LENGTH_CITY
            });
            ERR_STATE_REQUIRED = new a("ERR_STATE_REQUIRED", 16, new c[] {
                c._ERR_REQUIRED_STATE
            });
            ERR_STATE_PATTERN = new a("ERR_STATE_PATTERN", 17, new c[] {
                c._ERR_MAX_LENGTH_STATE
            });
            ERR_ZIPCODE_REQUIRED = new a("ERR_ZIPCODE_REQUIRED", 18, new c[] {
                c._ERR_REQUIRED_ZIPCODE
            });
            ERR_ZIPCODE_PATTERN = new a("ERR_ZIPCODE_PATTERN", 19, new c[] {
                c._ERR_PATTERN_ZIPCODE
            });
            ERR_ZIPCODE_MAX_LENGTH = new a("ERR_ZIPCODE_MAX_LENGTH", 20, new c[] {
                c._ERR_MAX_LENGTH_ZIPCODE
            });
            ERR_PHONE_REQUIRED = new a("ERR_PHONE_REQUIRED", 21, new c[] {
                c._ERR_REQUIRED_PHONE
            });
            ERR_PHONE_PATTERN = new a("ERR_PHONE_PATTERN", 22, new c[] {
                c._ERR_PATTERN_PHONE
            });
            ERR_TOKEN_EXPIRED = new a("ERR_TOKEN_EXPIRED", 23, new c[] {
                c.INVALID_ACCESS_TOKEN, c.EXPIRED_ACCESS_TOKEN
            });
            ERR_REAUTH_REQUIRED = new a("ERR_REAUTH_REQUIRED", 24, new c[] {
                c.SCOPE_1_ACCESS_LEVEL_REQUIRED
            });
            ERR_ACCOUNT_IN_USE = new a("ERR_ACCOUNT_IN_USE", 25, new c[] {
                c._ERR_INVALID_COOKIE
            });
            ERR_TOO_MANY_REQUESTS = new a("ERR_TOO_MANY_REQUESTS", 26, new c[] {
                c.TAPI_VPA
            });
            UNKNOWN = new a("UNKNOWN", 27, new c[] {
                c._ERR_UNKNOWN
            });
            $VALUES = (new a[] {
