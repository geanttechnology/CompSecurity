    ...
    implements j
{
    ...
    public static final UNKNOWN ERR_INVALID_ORDER_NUMBER;
    public static final UNKNOWN ERR_REAUTH_REQUIRED;
    public static final UNKNOWN ERR_REQUIRED_ORDER_NUMBER;
    ...
    {
        return (mCodes)Enum.valueOf(com/target/mothership/model/guest/interfaces/a/h$a, s);
    }
    ...
    static 
    {
        ERR_REQUIRED_ORDER_NUMBER = new <init>("ERR_REQUIRED_ORDER_NUMBER", 0, new c[] {
            c._ERR_REQUIRED_CUSTORDERNUMBER
        });
        ERR_INVALID_ORDER_NUMBER = new <init>("ERR_INVALID_ORDER_NUMBER", 1, new c[] {
