    ...
    implements j
{
    ...
    {
        return (mCodes)Enum.valueOf(com/target/mothership/model/guest/interfaces/a/l$a, s);
    }
    ...
    static 
    {
        ERR_INVALID_ADDRESS_OWNER = new <init>("ERR_INVALID_ADDRESS_OWNER", 0, new c[] {
            c._ERR_INVALID_ADDRESS_OWNER
        });
        ERR_INVALID_ADDRESS_ID = new <init>("ERR_INVALID_ADDRESS_ID", 1, new c[] {
            c._ERR_CMD_INVALID_PARAM
        });
        ERR_FIRSTNAME_REQUIRED = new <init>("ERR_FIRSTNAME_REQUIRED", 2, new c[] {
            c._ERR_REQUIRED_FIRSTNAME
        });
        ERR_FIRSTNAME_MAX_LENGTH = new <init>("ERR_FIRSTNAME_MAX_LENGTH", 3, new c[] {
            c._ERR_MAX_LENGTH_FIRSTNAME
        });
        ERR_FIRSTNAME_PATTERN = new <init>("ERR_FIRSTNAME_PATTERN", 4, new c[] {
            c._ERR_PATTERN_FIRSTNAME
        });
        ERR_MIDDLENAME_PATTERN = new <init>("ERR_MIDDLENAME_PATTERN", 5, new c[] {
            c._ERR_PATTERN_MIDDLENAME
        });
        ERR_MIDDLENAME_MAX_LENGTH = new <init>("ERR_MIDDLENAME_MAX_LENGTH", 6, new c[] {
            c._ERR_MAX_LENGTH_MIDDLENAME
        });
        ERR_LASTNAME_REQUIRED = new <init>("ERR_LASTNAME_REQUIRED", 7, new c[] {
            c._ERR_REQUIRED_LASTNAME
        });
        ERR_LASTNAME_PATTERN = new <init>("ERR_LASTNAME_PATTERN", 8, new c[] {
            c._ERR_PATTERN_LASTNAME
        });
        ERR_LASTNAME_MAX_LENGTH = new <init>("ERR_LASTNAME_MAX_LENGTH", 9, new c[] {
            c._ERR_MAX_LENGTH_LASTNAME
        });
        ERR_ADDRESS_LINE1_REQUIRED = new <init>("ERR_ADDRESS_LINE1_REQUIRED", 10, new c[] {
            c._ERR_REQUIRED_ADDRESS1
        });
        ERR_ADDRESS_LINE1_PATTERN = new <init>("ERR_ADDRESS_LINE1_PATTERN", 11, new c[] {
            c._ERR_PATTERN_ADDRESS1
        });
        ERR_ADDRESS_LINE1_MAX_LENGTH = new <init>("ERR_ADDRESS_LINE1_MAX_LENGTH", 12, new c[] {
            c._ERR_MAX_LENGTH_ADDRESS1
        });
        ERR_ADDRESS_LINE2_PATTERN = new <init>("ERR_ADDRESS_LINE2_PATTERN", 13, new c[] {
            c._ERR_PATTERN_ADDRESS2
        });
        ERR_ADDRESS_LINE2_MAX_LENGTH = new <init>("ERR_ADDRESS_LINE2_MAX_LENGTH", 14, new c[] {
            c._ERR_MAX_LENGTH_ADDRESS2
        });
        ERR_CITY_REQUIRED = new <init>("ERR_CITY_REQUIRED", 15, new c[] {
            c._ERR_REQUIRED_CITY
        });
        ERR_CITY_PATTERN = new <init>("ERR_CITY_PATTERN", 16, new c[] {
            c._ERR_PATTERN_CITY
        });
        ERR_CITY_MAX_LENGTH = new <init>("ERR_CITY_MAX_LENGTH", 17, new c[] {
            c._ERR_MAX_LENGTH_CITY
        });
        ERR_STATE_REQUIRED = new <init>("ERR_STATE_REQUIRED", 18, new c[] {
            c._ERR_REQUIRED_STATE
        });
        ERR_STATE_PATTERN = new <init>("ERR_STATE_PATTERN", 19, new c[] {
            c._ERR_MAX_LENGTH_STATE
        });
        ERR_ZIPCODE_REQUIRED = new <init>("ERR_ZIPCODE_REQUIRED", 20, new c[] {
            c._ERR_REQUIRED_ZIPCODE
        });
        ERR_ZIPCODE_PATTERN = new <init>("ERR_ZIPCODE_PATTERN", 21, new c[] {
            c._ERR_PATTERN_ZIPCODE
        });
        ERR_ZIPCODE_MAX_LENGTH = new <init>("ERR_ZIPCODE_MAX_LENGTH", 22, new c[] {
            c._ERR_MAX_LENGTH_ZIPCODE
        });
        ERR_PHONE_REQUIRED = new <init>("ERR_PHONE_REQUIRED", 23, new c[] {
            c._ERR_REQUIRED_PHONE
        });
        ERR_PHONE_PATTERN = new <init>("ERR_PHONE_PATTERN", 24, new c[] {
            c._ERR_PATTERN_PHONE
        });
        ERR_TOKEN_EXPIRED = new <init>("ERR_TOKEN_EXPIRED", 25, new c[] {
            c.INVALID_ACCESS_TOKEN, c.EXPIRED_ACCESS_TOKEN
        });
        ERR_REAUTH_REQUIRED = new <init>("ERR_REAUTH_REQUIRED", 26, new c[] {
            c.SCOPE_1_ACCESS_LEVEL_REQUIRED
        });
        ERR_ACCOUNT_IN_USE = new <init>("ERR_ACCOUNT_IN_USE", 27, new c[] {
            c._ERR_INVALID_COOKIE
        });
        ERR_TOO_MANY_REQUESTS = new <init>("ERR_TOO_MANY_REQUESTS", 28, new c[] {
            c.TAPI_VPA
        });
        UNKNOWN = new <init>("UNKNOWN", 29, new c[] {
            c._ERR_UNKNOWN
        });
        $VALUES = (new .VALUES[] {
