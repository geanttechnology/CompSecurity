...
public class m extends b
{
        ...
        implements j
    {
        ...
        {
            return (a)Enum.valueOf(com/target/mothership/model/guest/interfaces/a/m$a, s);
        }
        ...
        static 
        {
            ...
            ERR_TOKEN_EXPIRED = new a("ERR_TOKEN_EXPIRED", 34, new c[] {
                c.INVALID_ACCESS_TOKEN, c.EXPIRED_ACCESS_TOKEN
            });
            ERR_REAUTH_REQUIRED = new a("ERR_REAUTH_REQUIRED", 35, new c[] {
                c.SCOPE_1_ACCESS_LEVEL_REQUIRED
            });
            ERR_ACCOUNT_IN_USE = new a("ERR_ACCOUNT_IN_USE", 36, new c[] {
                c._ERR_INVALID_COOKIE
            });
            ERR_TOO_MANY_REQUESTS = new a("ERR_TOO_MANY_REQUESTS", 37, new c[] {
                c.TAPI_VPA
            });
            ERR_UNKNOWN = new a("ERR_UNKNOWN", 38, new c[] {
                c._ERR_UNKNOWN
            });
            $VALUES = (new a[] {
