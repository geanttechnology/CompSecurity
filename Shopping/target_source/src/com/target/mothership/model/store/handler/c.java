...
//            TGTStoreDetail, TGTStoreAddress, TGTAddress, TGTStorePhoneNumber, 
//            TGTStoreOperatingHours, TGTAlternateStoreOperatingHours, TGTStoreCapability
...
public class c extends f
{
    ...
    private final aa mTransformer = new aa() {
        ...
        {
            list = (com.target.mothership.services.e.h.b.h)list.get(0);
    ...
    protected StoreDetail a(List list)
    {
        return (StoreDetail)mTransformer.a(list);
    }
