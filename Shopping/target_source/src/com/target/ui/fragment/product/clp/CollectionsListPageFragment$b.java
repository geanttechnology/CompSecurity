...
private class <init> extends e
{
    ...
    {
        CollectionsListPageFragment.a(CollectionsListPageFragment.this).c(s);
    }

    public void a(String s, ListSummary listsummary)
    {
        ad.a(getActivity(), s, CollectionsListPageFragment.a(CollectionsListPageFragment.this), listsummary, m());
    }
