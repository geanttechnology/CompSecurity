    ...
    implements Runnable
{
    ...
    public void run()
    {
        ...
        {
            WeeklyAdFragment.b(_fld0).weeklyAdListLayout.setEnabled(false);
            WeeklyAdFragment.b(_fld0).weeklyAdHeaderView.c();
            return;
        }
    }
...
/* anonymous class */
    class WeeklyAdFragment._cls1._cls1 extends com.target.ui.f.e
    {
        ...
        // Unreferenced inner class com/target/ui/fragment/weekly_ad/WeeklyAdFragment$1$1$2

/* anonymous class */
        class WeeklyAdFragment._cls1._cls1._cls2
            implements Runnable
        {
