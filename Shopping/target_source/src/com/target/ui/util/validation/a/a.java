...
public final class com.target.ui.util.validation.a.a
    implements l
{
    public static final class a extends Enum
    {
        ...
        {
            return (a)Enum.valueOf(com/target/ui/util/validation/a/a$a, s);
        }
    ...
    public com.target.ui.util.validation.a.a(String s, boolean flag, List list)
    {
        addressLine = s;
        isValid = flag;
        reasons = list;
