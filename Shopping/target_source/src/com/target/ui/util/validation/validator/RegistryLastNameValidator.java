    ...
    implements a
{
    ...
    public RegistryLastNameValidator(Context context)
    {
    ...
    public k a(String s)
    {
        ...
        {
            return new i(false, c.a(mApplicationContext, s, 2, 40));
        }
    }
}
