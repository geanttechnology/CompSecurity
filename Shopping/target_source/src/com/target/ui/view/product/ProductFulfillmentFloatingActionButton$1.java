...
//            ProductFulfillmentFloatingActionButton, a
...
static class I
{
    ...
    static 
    {
        $SwitchMap$com$target$ui$view$product$ProductFulfillmentFloatingActionButton$FulfillmentState = new int[values().length];
        try
        {
            $SwitchMap$com$target$ui$view$product$ProductFulfillmentFloatingActionButton$FulfillmentState[INACTIVE.ordinal()] = 1;
        }
        catch (NoSuchFieldError nosuchfielderror9) { }
        try
        {
            $SwitchMap$com$target$ui$view$product$ProductFulfillmentFloatingActionButton$FulfillmentState[ACTIVE.ordinal()] = 2;
        }
        catch (NoSuchFieldError nosuchfielderror8) { }
        $SwitchMap$com$target$ui$view$product$FulfillmentType = new int[a.values().length];
        try
        {
