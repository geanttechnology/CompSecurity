...
public class RefineGenericView extends BaseRefineFacetsContainer
{
    private class a
    ...
    public static final String TAG = com/target/ui/view/refine/RefineGenericView.getSimpleName();

    public RefineGenericView(Context context)
    {
        super(context);
    }

    public RefineGenericView(Context context, AttributeSet attributeset)
    {
        super(context, attributeset);
    }

    public RefineGenericView(Context context, AttributeSet attributeset, int i)
    {
    ...
    protected void a(List list)
    {
        ...
        for (list = list.iterator(); list.hasNext(); addView(refinecheckboxview))
        {
            ...
            refinecheckboxview = (RefineCheckBoxView)LayoutInflater.from(getContext()).inflate(0x7f0301cd, this, false);
            refinecheckboxview.a(productentry, a(productentry), true);
