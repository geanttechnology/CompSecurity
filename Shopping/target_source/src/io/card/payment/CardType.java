...
_L1:
        if (cardtype == UNKNOWN || cardtype == INSUFFICIENT_DIGITS || !s.equalsIgnoreCase(cardtype.toString())) goto _L5; else goto _L4
_L4:
        return cardtype;
_L2:
        return UNKNOWN;
    ...
    class _anm1 {}
        ...
        switch (_cls1..SwitchMap.io.card.payment.CardType[ordinal()])
        {
        default:
            return -1;
    ...
    public String getDisplayName(String s)
    {
        ...
        case 1: // '\001'
            return LocalizedStrings.getString(StringKey.CARDTYPE_AMERICANEXPRESS, s);

        case 2: // '\002'
        case 3: // '\003'
            return LocalizedStrings.getString(StringKey.CARDTYPE_DISCOVER, s);

        case 4: // '\004'
            return LocalizedStrings.getString(StringKey.CARDTYPE_JCB, s);

        case 5: // '\005'
            return LocalizedStrings.getString(StringKey.CARDTYPE_MASTERCARD, s);

        case 6: // '\006'
            return LocalizedStrings.getString(StringKey.CARDTYPE_VISA, s);
        }
    }
    ...
    {
        Bitmap bitmap = null;
        _cls1..SwitchMap.io.card.payment.CardType[ordinal()];
...
_L8:
        if (s != null)
        {
            bitmap = ViewUtil.base64ToBitmap(s, context);
        }
        return bitmap;
_L2:
