    ...
    implements TextWatcher, TraceFieldInterface
{
    ...
    private void validateAndEnableDoneButtonIfValid()
    {
        ...
        Log.d(TAG, (new StringBuilder()).append("setting doneBtn.enabled=").append(doneBtn.isEnabled()).toString());
...
_L3:
    ...
    protected void onCreate(Bundle bundle)
    {
        ...
        TraceMachine.enterMethod(_nr_trace, "DataEntryActivity#onCreate", null);
_L2:
